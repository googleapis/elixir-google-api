...
defmodule GoogleApi.Reseller.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.Reseller.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://www.googleapis.com/apps/reseller/v1"
