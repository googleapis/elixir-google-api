  ...
  *   `{:error, info}` on failure
  ...
  def reseller_resellernotify_getwatchdetails(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/apps/reseller/v1/resellernotify/getwatchdetails", %{})
  ...
  *   `{:error, info}` on failure
  ...
  def reseller_resellernotify_register(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/apps/reseller/v1/resellernotify/register", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def reseller_resellernotify_unregister(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/apps/reseller/v1/resellernotify/unregister", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
