...
defmodule GoogleApi.Reseller.V1.Api.Subscriptions do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.Reseller.V1.Model.ChangePlanRequest.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.Reseller.V1.Model.RenewalSettings.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.Reseller.V1.Model.Seats.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.Reseller.V1.Model.Subscription.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :customerNamePrefix (String.t): When retrieving all of your subscriptions and filtering for specific customers, you can enter a prefix for a customer name. Using an example customer group that includes exam.com, example20.com and example.com:  
