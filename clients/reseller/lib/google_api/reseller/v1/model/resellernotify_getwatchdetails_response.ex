...
defmodule GoogleApi.Reseller.V1.Model.ResellernotifyGetwatchdetailsResponse do
  ...
  - serviceAccountEmailAddresses (list(String.t)): List of registered service accounts. Defaults to `nil`.
  - topicName (String.t): Topic name of the PubSub Defaults to `nil`.
  """
