...
defmodule GoogleApi.Reseller.V1.Model.ResellernotifyGetwatchdetailsResponse do
  ...
  - serviceAccountEmailAddresses ([String.t]): List of registered service accounts. Defaults to: `null`.
  - topicName (String.t): Topic name of the PubSub Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :serviceAccountEmailAddresses => list(any()),
          :topicName => any()
        }
