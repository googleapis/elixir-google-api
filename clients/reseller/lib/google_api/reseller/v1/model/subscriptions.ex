...
defmodule GoogleApi.Reseller.V1.Model.Subscriptions do
  ...
  - kind (String.t): Identifies the resource as a collection of subscriptions. Value: reseller#subscriptions Defaults to: `null`.
  ...
  - subscriptions ([Subscription]): The subscriptions in this page of results. Defaults to: `null`.
  """
