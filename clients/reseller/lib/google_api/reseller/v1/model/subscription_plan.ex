...
defmodule GoogleApi.Reseller.V1.Model.SubscriptionPlan do
  ...
  - commitmentInterval (GoogleApi.Reseller.V1.Model.SubscriptionPlanCommitmentInterval.t): In this version of the API, annual commitment plan's interval is one year.  Note: When billingMethod value is OFFLINE, the subscription property object plan.commitmentInterval is omitted in all API responses. Defaults to `nil`.
  ...
  - false — The plan is not an annual commitment plan. Defaults to `nil`.
  - planName (String.t): The planName property is required. This is the name of the subscription's plan. For more information about the Google payment plans, see the API concepts.
  ...
  - FREE — The free plan is exclusive to the Cloud Identity SKU and does not incur any billing. Defaults to `nil`.
  """
