...
defmodule GoogleApi.Reseller.V1.Model.SubscriptionPlanCommitmentInterval do
  ...
  - endTime (String.t): An annual commitment plan's interval's endTime in milliseconds using the UNIX Epoch format. See an example Epoch converter. Defaults to `nil`.
  - startTime (String.t): An annual commitment plan's interval's startTime in milliseconds using UNIX Epoch format. See an example Epoch converter. Defaults to `nil`.
  """
