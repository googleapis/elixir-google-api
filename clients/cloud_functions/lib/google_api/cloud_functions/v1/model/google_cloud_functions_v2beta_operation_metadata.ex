...
defmodule GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaOperationMetadata do
  @moduledoc """
  ...
  *   `stages` (*type:* `list(GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaStage.t)`, *default:* `nil`) - Mechanism for reporting in-progress stages
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :stages =>
            list(GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaStage.t()) | nil,
  ...
  field(:stages,
    as: GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaStage,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2betaOperationMetadata.decode(
      value,
      options
    )
  end
