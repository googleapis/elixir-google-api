...
defmodule GoogleApi.CloudFunctions.V1.Model.ListOperationsResponse do
  ...
  *   `operations` (*type:* `list(GoogleApi.CloudFunctions.V1.Model.Operation.t)`, *default:* `nil`) - A list of operations that matches the specified filter in the request.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :operations => list(GoogleApi.CloudFunctions.V1.Model.Operation.t()) | nil
        }
