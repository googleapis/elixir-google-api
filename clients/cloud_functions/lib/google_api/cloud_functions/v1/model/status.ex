...
defmodule GoogleApi.CloudFunctions.V1.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.CloudFunctions.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.CloudFunctions.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.CloudFunctions.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudFunctions.V1.Model.Status do
