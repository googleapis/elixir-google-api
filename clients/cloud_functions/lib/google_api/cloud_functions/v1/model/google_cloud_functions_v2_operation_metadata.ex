...
defmodule GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2OperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V1.Model.GoogleCloudFunctionsV2OperationMetadata.decode(
      value,
      options
    )
  end
