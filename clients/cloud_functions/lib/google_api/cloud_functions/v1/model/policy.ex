...
defmodule GoogleApi.CloudFunctions.V1.Model.Policy do
  ...
  **YAML Example**
  ...
  - auditConfigs (list(GoogleApi.CloudFunctions.V1.Model.AuditConfig.t)): Specifies cloud audit logging configuration for this policy. Defaults to `nil`.
  - bindings (list(GoogleApi.CloudFunctions.V1.Model.Binding.t)): Associates a list of `members` to a `role`.
