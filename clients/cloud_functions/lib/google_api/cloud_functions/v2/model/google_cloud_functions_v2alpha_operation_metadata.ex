...
defmodule GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaOperationMetadata do
  @moduledoc """
  ...
  *   `stages` (*type:* `list(GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaStage.t)`, *default:* `nil`) - Mechanism for reporting in-progress stages
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :stages =>
            list(GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaStage.t()) | nil,
  ...
  field(:stages,
    as: GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaStage,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2alphaOperationMetadata.decode(
      value,
      options
    )
  end
