...
defmodule GoogleApi.CloudFunctions.V2.Model.SecretEnvVar do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudFunctions.V2.Model.SecretEnvVar do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.SecretEnvVar.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudFunctions.V2.Model.SecretEnvVar do
