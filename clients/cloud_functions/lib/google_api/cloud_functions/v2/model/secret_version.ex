...
defmodule GoogleApi.CloudFunctions.V2.Model.SecretVersion do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudFunctions.V2.Model.SecretVersion do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.SecretVersion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudFunctions.V2.Model.SecretVersion do
