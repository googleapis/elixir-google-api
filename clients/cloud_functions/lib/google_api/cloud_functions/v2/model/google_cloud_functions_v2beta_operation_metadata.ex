...
defmodule GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2betaOperationMetadata do
  @moduledoc """
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :stages =>
            list(GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2betaStage.t()) | nil,
  ...
  field(:stages,
    as: GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2betaStage,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2betaOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.GoogleCloudFunctionsV2betaOperationMetadata.decode(
      value,
      options
    )
  end
