...
defmodule GoogleApi.CloudFunctions.V2.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudFunctions.V2.Model.Date do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudFunctions.V2.Model.Date do
