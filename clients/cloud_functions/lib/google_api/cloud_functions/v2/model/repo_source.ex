...
defmodule GoogleApi.CloudFunctions.V2.Model.RepoSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudFunctions.V2.Model.RepoSource do
  def decode(value, options) do
    GoogleApi.CloudFunctions.V2.Model.RepoSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudFunctions.V2.Model.RepoSource do
