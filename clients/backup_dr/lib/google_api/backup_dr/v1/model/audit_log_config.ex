...
defmodule GoogleApi.BackupDR.V1.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BackupDR.V1.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.BackupDR.V1.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BackupDR.V1.Model.AuditLogConfig do
