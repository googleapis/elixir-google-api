...
defmodule GoogleApi.BackupDR.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BackupDR.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.BackupDR.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BackupDR.V1.Model.Expr do
