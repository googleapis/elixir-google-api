...
defmodule GoogleApi.BackupDR.V1.Model.OperationMetadata do
  @moduledoc """
  Represents the metadata of the long-running operation.

  ## Attributes

  *   `additionalInfo` (*type:* `map()`, *default:* `nil`) - Output only. AdditionalInfo contains additional Info related to backup plan association resource.
...
defimpl Poison.Decoder, for: GoogleApi.BackupDR.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.BackupDR.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BackupDR.V1.Model.OperationMetadata do
