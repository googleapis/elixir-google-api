...
defmodule GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceGettokenRequestSite do
  ...
  - type (String): The type of resource to be verified. Can be SITE or INET_DOMAIN (domain name). Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceGettokenRequestSite do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceGettokenRequestSite do
