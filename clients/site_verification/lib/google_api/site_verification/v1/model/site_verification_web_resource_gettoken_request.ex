...
defmodule GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceGettokenRequest do
  ...
  - site (GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceGettokenRequestSite.t): The site for which a verification token will be generated. Defaults to `nil`.
  - verificationMethod (String.t): The verification method that will be used to verify this site. For sites, 'FILE' or 'META' methods may be used. For domains, only 'DNS' may be used. Defaults to `nil`.
  """
