...
defmodule GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceResource do
  ...
  - id (String.t): The string used to identify this site. This value should be used in the "id" portion of the REST URL for the Get, Update, and Delete operations. Defaults to `nil`.
  - owners (list(String.t)): The email addresses of all verified owners. Defaults to `nil`.
  - site (GoogleApi.SiteVerification.V1.Model.SiteVerificationWebResourceResourceSite.t): The address and type of a site that is verified or will be verified. Defaults to `nil`.
  """
