...
defmodule GoogleApi.Notebooks.V2.Model.Snapshot do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V2.Model.Snapshot do
  def decode(value, options) do
    GoogleApi.Notebooks.V2.Model.Snapshot.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V2.Model.Snapshot do
