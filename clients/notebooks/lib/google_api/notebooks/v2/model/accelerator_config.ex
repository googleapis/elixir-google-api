...
defmodule GoogleApi.Notebooks.V2.Model.AcceleratorConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V2.Model.AcceleratorConfig do
  def decode(value, options) do
    GoogleApi.Notebooks.V2.Model.AcceleratorConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V2.Model.AcceleratorConfig do
