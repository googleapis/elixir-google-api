...
defmodule GoogleApi.Notebooks.V1.Model.ReservationAffinity do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.ReservationAffinity do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.ReservationAffinity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.ReservationAffinity do
