...
defmodule GoogleApi.Notebooks.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.OperationMetadata do
