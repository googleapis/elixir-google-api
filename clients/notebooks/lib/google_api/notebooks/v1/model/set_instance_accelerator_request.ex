...
defmodule GoogleApi.Notebooks.V1.Model.SetInstanceAcceleratorRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.SetInstanceAcceleratorRequest do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.SetInstanceAcceleratorRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.SetInstanceAcceleratorRequest do
