...
defmodule GoogleApi.Notebooks.V1.Model.ListInstancesResponse do
  @moduledoc """
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - Locations that could not be reached. For example, `['us-west1-a', 'us-central1-b']`. A ListInstancesResponse will only contain either instances or unreachables,
  ...
  @type t :: %__MODULE__{
          :instances => list(GoogleApi.Notebooks.V1.Model.Instance.t()) | nil,
          :nextPageToken => String.t() | nil,
          :unreachable => list(String.t()) | nil
        }

  field(:instances, as: GoogleApi.Notebooks.V1.Model.Instance, type: :list)
  field(:nextPageToken)
  field(:unreachable, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.ListInstancesResponse do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.ListInstancesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.ListInstancesResponse do
