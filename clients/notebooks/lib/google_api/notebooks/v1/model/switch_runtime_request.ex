...
defmodule GoogleApi.Notebooks.V1.Model.SwitchRuntimeRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.SwitchRuntimeRequest do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.SwitchRuntimeRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.SwitchRuntimeRequest do
