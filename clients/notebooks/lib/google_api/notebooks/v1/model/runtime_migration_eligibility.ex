...
defmodule GoogleApi.Notebooks.V1.Model.RuntimeMigrationEligibility do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.RuntimeMigrationEligibility do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.RuntimeMigrationEligibility.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.RuntimeMigrationEligibility do
