...
defmodule GoogleApi.Notebooks.V1.Model.RuntimeAcceleratorConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.RuntimeAcceleratorConfig do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.RuntimeAcceleratorConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.RuntimeAcceleratorConfig do
