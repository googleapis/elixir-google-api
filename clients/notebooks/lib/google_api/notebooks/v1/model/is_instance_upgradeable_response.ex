...
defmodule GoogleApi.Notebooks.V1.Model.IsInstanceUpgradeableResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.IsInstanceUpgradeableResponse do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.IsInstanceUpgradeableResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.IsInstanceUpgradeableResponse do
