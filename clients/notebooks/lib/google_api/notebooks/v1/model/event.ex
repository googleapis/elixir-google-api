...
defmodule GoogleApi.Notebooks.V1.Model.Event do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Notebooks.V1.Model.Event do
  def decode(value, options) do
    GoogleApi.Notebooks.V1.Model.Event.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Notebooks.V1.Model.Event do
