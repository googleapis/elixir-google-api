...
defmodule GoogleApi.Logging.V2.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Logging.V2.Model.Expr do
  def decode(value, options) do
    GoogleApi.Logging.V2.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Logging.V2.Model.Expr do
