...
defmodule GoogleApi.Logging.V2.Model.Policy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Logging.V2.Model.Policy do
  def decode(value, options) do
    GoogleApi.Logging.V2.Model.Policy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Logging.V2.Model.Policy do
