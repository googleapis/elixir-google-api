...
defmodule GoogleApi.Logging.V2.Model.LogMetric do
  ...
  - createTime (DateTime.t): Output only. The creation timestamp of the metric.This field may not be present for older metrics. Defaults to: `null`.
  ...
  - updateTime (DateTime.t): Output only. The last update timestamp of the metric.This field may not be present for older metrics. Defaults to: `null`.
