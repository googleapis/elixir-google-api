...
defmodule GoogleApi.Logging.V2.Model.ListRecentQueriesResponse do
  @moduledoc """
  ...
  *   `recentQueries` (*type:* `list(GoogleApi.Logging.V2.Model.RecentQuery.t)`, *default:* `nil`) - A list of recent queries.
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - The unreachable resources. Each resource can be either 1) a saved query if a specific query is unreachable or 2) a location if a specific location is unreachable. "projects/[PROJECT_ID]/locations/[LOCATION_ID]/recentQueries/[QUERY_ID]" "projects/[PROJECT_ID]/locations/[LOCATION_ID]" For example:"projects/my-project/locations/global/recentQueries/12345678" "projects/my-project/locations/global"If there are unreachable resources, the response will first return pages that contain recent queries, and then return pages that contain the unreachable resources.
  ...
  @type t :: %__MODULE__{
          ...
          :recentQueries => list(GoogleApi.Logging.V2.Model.RecentQuery.t()) | nil,
          :unreachable => list(String.t()) | nil
        }

  field(:nextPageToken)
  field(:recentQueries, as: GoogleApi.Logging.V2.Model.RecentQuery, type: :list)
  field(:unreachable, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Logging.V2.Model.ListRecentQueriesResponse do
  def decode(value, options) do
    GoogleApi.Logging.V2.Model.ListRecentQueriesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Logging.V2.Model.ListRecentQueriesResponse do
