...
defmodule GoogleApi.Logging.V2.Api.Folders do
  ...
  def logging_folders_exclusions_create(connection, folders_id, opts \\ []) do
    optional_params = %{
      :access_token => :query,
      :key => :query,
  ...
  def logging_folders_exclusions_delete(connection, folders_id, exclusions_id, opts \\ []) do
    optional_params = %{
      :access_token => :query,
      :key => :query,
      :upload_protocol => :query,
  ...
  @spec logging_folders_exclusions_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Logging.V2.Model.LogExclusion.t()} | {:error, Tesla.Env.t()}
  def logging_folders_exclusions_get(connection, folders_id, exclusions_id, opts \\ []) do
    optional_params = %{
      :access_token => :query,
      :key => :query,
      :upload_protocol => :query,
  ...
  def logging_folders_exclusions_list(connection, folders_id, opts \\ []) do
    optional_params = %{
      :access_token => :query,
      :key => :query,
      :upload_protocol => :query,
  ...
  @spec logging_folders_exclusions_patch(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Logging.V2.Model.LogExclusion.t()} | {:error, Tesla.Env.t()}
  def logging_folders_exclusions_patch(connection, folders_id, exclusions_id, opts \\ []) do
    optional_params = %{
      :access_token => :query,
      :key => :query,
      :upload_protocol => :query,
