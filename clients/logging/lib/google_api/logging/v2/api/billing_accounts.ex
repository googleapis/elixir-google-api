...
defmodule GoogleApi.Logging.V2.Api.BillingAccounts do
  ...
  *   `billing_accounts_id` (*type:* `String.t`) - Part of `name`. Required. The resource name of the bucket:
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `billing_accounts_id` (*type:* `String.t`) - Part of `parent`. Required. The parent resource whose buckets are to be listed:
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `billing_accounts_id` (*type:* `String.t`) - Part of `name`. Required. The full resource name of the bucket to update.
      "projects/[PROJECT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]"
      "organizations/[ORGANIZATION_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]"
      "billingAccounts/[BILLING_ACCOUNT_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]"
      "folders/[FOLDER_ID]/locations/[LOCATION_ID]/buckets/[BUCKET_ID]"
