...
defmodule GoogleApi.Logging.V2.Api.BillingAccounts do
  ...
  *   `{:error, info}` on failure
  """
  @spec logging_billing_accounts_buckets_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def logging_billing_accounts_buckets_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v2/billingAccounts/{billingAccountsId}/buckets/{bucketsId}", %{
        "billingAccountsId" => URI.encode(billing_accounts_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec logging_billing_accounts_buckets_views_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def logging_billing_accounts_buckets_views_get(
        connection,
        billing_accounts_id,
        buckets_id,
        views_id,
    ...
    request =
      ...
      |> Request.method(:get)
      |> Request.url(
        "/v2/billingAccounts/{billingAccountsId}/buckets/{bucketsId}/views/{viewsId}",
        %{
          "billingAccountsId" => URI.encode(billing_accounts_id, &URI.char_unreserved?/1),
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `billing_accounts_id` (*type:* `String.t`) - Part of `parent`. Required. The resource name that owns the logs: projects/[PROJECT_ID] organizations/[ORGANIZATION_ID] billingAccounts/[BILLING_ACCOUNT_ID] folders/[FOLDER_ID]
  *   `locations_id` (*type:* `String.t`) - Part of `parent`. See documentation of `billingAccountsId`.
  *   `buckets_id` (*type:* `String.t`) - Part of `parent`. See documentation of `billingAccountsId`.
  ...
  *   `{:error, info}` on failure
  """
  @spec logging_billing_accounts_operations_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def logging_billing_accounts_operations_get(
        connection,
        billing_accounts_id,
        operations_id,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v2/billingAccounts/{billingAccountsId}/operations/{operationsId}", %{
        "billingAccountsId" => URI.encode(billing_accounts_id, &URI.char_unreserved?/1),
