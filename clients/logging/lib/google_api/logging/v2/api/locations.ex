...
defmodule GoogleApi.Logging.V2.Api.Locations do
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `v2_id` (*type:* `String.t`) - Part of `resource`. REQUIRED: The resource for which the policy is being requested. See Resource names (https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
  *   `v2_id1` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `locations_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `buckets_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `views_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  ...
  def logging_locations_buckets_views_get_iam_policy(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/{v2Id}/{v2Id1}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:getIamPolicy",
        %{
          "v2Id" => URI.encode(v2_id, &URI.char_unreserved?/1),
          "v2Id1" => URI.encode(v2_id1, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `v2_id` (*type:* `String.t`) - Part of `resource`. REQUIRED: The resource for which the policy is being specified. See Resource names (https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
  *   `v2_id1` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `locations_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `buckets_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `views_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  ...
  *   `{:error, info}` on failure
  ...
  def logging_locations_buckets_views_set_iam_policy(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/{v2Id}/{v2Id1}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:setIamPolicy",
        %{
          "v2Id" => URI.encode(v2_id, &URI.char_unreserved?/1),
          "v2Id1" => URI.encode(v2_id1, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
  ...
  *   `connection` (*type:* `GoogleApi.Logging.V2.Connection.t`) - Connection to server
  *   `v2_id` (*type:* `String.t`) - Part of `resource`. REQUIRED: The resource for which the policy detail is being requested. See Resource names (https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
  *   `v2_id1` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `locations_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `buckets_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  *   `views_id` (*type:* `String.t`) - Part of `resource`. See documentation of `v2Id`.
  ...
  *   `{:error, info}` on failure
  ...
  def logging_locations_buckets_views_test_iam_permissions(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/{v2Id}/{v2Id1}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:testIamPermissions",
        %{
          "v2Id" => URI.encode(v2_id, &URI.char_unreserved?/1),
          "v2Id1" => URI.encode(v2_id1, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
