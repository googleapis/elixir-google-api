...
defmodule GoogleApi.Logging.V2.Api.Entries do
  ...
  """
  @spec logging_entries_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Logging.V2.Model.ListLogEntriesResponse.t} | {:error, Tesla.Env.t}
  def logging_entries_list(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.Logging.V2.Model.ListLogEntriesResponse{})
  end
  ...
  {:error, info} on failure
  """
  @spec logging_entries_write(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Logging.V2.Model.WriteLogEntriesResponse.t} | {:error, Tesla.Env.t}
  def logging_entries_write(connection, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v2/entries:write")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Logging.V2.Model.WriteLogEntriesResponse{})
  end
end
