...
defmodule GoogleApi.Logging.V2.Api.Projects do
  ...
  *   `buckets_id` (*type:* `String.t`) - Part of `resource`. See documentation of `projectsId`.
  *   `views_id` (*type:* `String.t`) - Part of `resource`. See documentation of `projectsId`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  ...
  def logging_projects_locations_buckets_views_get_iam_policy(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/projects/{projectsId}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:getIamPolicy",
        %{
          "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
          "bucketsId" => URI.encode(buckets_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def logging_projects_locations_buckets_views_set_iam_policy(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/projects/{projectsId}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:setIamPolicy",
        %{
          "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
          "bucketsId" => URI.encode(buckets_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def logging_projects_locations_buckets_views_test_iam_permissions(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v2/projects/{projectsId}/locations/{locationsId}/buckets/{bucketsId}/views/{viewsId}:testIamPermissions",
        %{
          "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
          "bucketsId" => URI.encode(buckets_id, &URI.char_unreserved?/1),
