...
defmodule GoogleApi.Logging.V2.Api.Projects do
  ...
  - projects_id (String.t): Part of `parent`. Required. The parent resource in which to create the exclusion:
  "projects/[PROJECT_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `name`. Required. The resource name of an existing exclusion to delete:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `name`. Required. The resource name of an existing exclusion:
  "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
  "folders/[FOLDER_ID]/exclusions/[EXCLUSION_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. Required. The parent resource whose exclusions are to be listed.
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `name`. Required. The resource name of the exclusion to update:
  "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
  "folders/[FOLDER_ID]/exclusions/[EXCLUSION_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `logName`. Required. The resource name of the log to delete:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. Required. The resource name that owns the logs:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. The resource name of the project in which to create the metric:
  "projects/[PROJECT_ID]"
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.Logging.V2.Model.LogMetric.t): 
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `metricName`. The resource name of the metric to delete:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `metricName`. The resource name of the desired metric:
  "projects/[PROJECT_ID]/metrics/[METRIC_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. Required. The name of the project containing the metrics:
  "projects/[PROJECT_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `metricName`. The resource name of the metric to update:
  "projects/[PROJECT_ID]/metrics/[METRIC_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. Required. The resource in which to create the sink:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `sinkName`. Required. The full resource name of the sink to delete, including the parent resource and the sink identifier:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `sinkName`. Required. The resource name of the sink:
  "projects/[PROJECT_ID]/sinks/[SINK_ID]"
  "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/sinks/[SINK_ID]"
  "folders/[FOLDER_ID]/sinks/[SINK_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. Required. The parent resource whose sinks are to be listed:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - projects_id (String.t): Part of `sinkName`. Required. The full resource name of the sink to update, including the parent resource and the sink identifier:
  "projects/[PROJECT_ID]/sinks/[SINK_ID]"
  "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/sinks/[SINK_ID]"
  "folders/[FOLDER_ID]/sinks/[SINK_ID]"
