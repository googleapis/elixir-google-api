...
defmodule GoogleApi.Logging.V2.Api.Organizations do
  ...
  - organizations_id (String.t): Part of `parent`. Required. The parent resource in which to create the exclusion:
  "projects/[PROJECT_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `name`. Required. The resource name of an existing exclusion to delete:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `name`. Required. The resource name of an existing exclusion:
  "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
  "folders/[FOLDER_ID]/exclusions/[EXCLUSION_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `parent`. Required. The parent resource whose exclusions are to be listed.
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `name`. Required. The resource name of the exclusion to update:
  "projects/[PROJECT_ID]/exclusions/[EXCLUSION_ID]"
  "organizations/[ORGANIZATION_ID]/exclusions/[EXCLUSION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/exclusions/[EXCLUSION_ID]"
  "folders/[FOLDER_ID]/exclusions/[EXCLUSION_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `logName`. Required. The resource name of the log to delete:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `parent`. Required. The resource name that owns the logs:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `parent`. Required. The resource in which to create the sink:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `sinkName`. Required. The full resource name of the sink to delete, including the parent resource and the sink identifier:
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `sinkName`. Required. The resource name of the sink:
  "projects/[PROJECT_ID]/sinks/[SINK_ID]"
  "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/sinks/[SINK_ID]"
  "folders/[FOLDER_ID]/sinks/[SINK_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `parent`. Required. The parent resource whose sinks are to be listed:
  "projects/[PROJECT_ID]"
  "organizations/[ORGANIZATION_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]"
  "folders/[FOLDER_ID]"
  ...
  - connection (GoogleApi.Logging.V2.Connection): Connection to server
  - organizations_id (String.t): Part of `sinkName`. Required. The full resource name of the sink to update, including the parent resource and the sink identifier:
  "projects/[PROJECT_ID]/sinks/[SINK_ID]"
  "organizations/[ORGANIZATION_ID]/sinks/[SINK_ID]"
  "billingAccounts/[BILLING_ACCOUNT_ID]/sinks/[SINK_ID]"
  "folders/[FOLDER_ID]/sinks/[SINK_ID]"
