...
defmodule GoogleApi.Memcache.V1.Model.Instance do
  @moduledoc """
  ...
  *   `zones` (*type:* `list(String.t)`, *default:* `nil`) - Zones where Memcached nodes should be provisioned in.
  ...
  @type t :: %__MODULE__{
          ...
          :instanceMessages => list(GoogleApi.Memcache.V1.Model.InstanceMessage.t()),
          :labels => map(),
          :memcacheFullVersion => String.t(),
          :memcacheNodes => list(GoogleApi.Memcache.V1.Model.Node.t()),
          :memcacheVersion => String.t(),
          :name => String.t(),
          :nodeConfig => GoogleApi.Memcache.V1.Model.NodeConfig.t(),
          :nodeCount => integer(),
...
defimpl Poison.Decoder, for: GoogleApi.Memcache.V1.Model.Instance do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.Instance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1.Model.Instance do
