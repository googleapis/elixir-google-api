...
defmodule GoogleApi.Memcache.V1.Model.MaintenanceSchedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Memcache.V1.Model.MaintenanceSchedule do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.MaintenanceSchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1.Model.MaintenanceSchedule do
