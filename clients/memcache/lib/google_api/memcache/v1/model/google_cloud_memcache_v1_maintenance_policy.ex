...
defmodule GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1MaintenancePolicy do
  @moduledoc """
  ...
  *   `weeklyMaintenanceWindow` (*type:* `list(GoogleApi.Memcache.V1.Model.WeeklyMaintenanceWindow.t)`, *default:* `nil`) - Required. Maintenance window that is applied to resources covered by this policy. Minimum 1. For the current version, the maximum number of weekly_maintenance_windows is expected to be one.
  ...
  @type t :: %__MODULE__{
          ...
          :weeklyMaintenanceWindow =>
            list(GoogleApi.Memcache.V1.Model.WeeklyMaintenanceWindow.t()) | nil
        }
  ...
  field(:weeklyMaintenanceWindow,
    as: GoogleApi.Memcache.V1.Model.WeeklyMaintenanceWindow,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1MaintenancePolicy do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1MaintenancePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1MaintenancePolicy do
