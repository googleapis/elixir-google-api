...
defmodule GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1OperationMetadata do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1.Model.GoogleCloudMemcacheV1OperationMetadata do
