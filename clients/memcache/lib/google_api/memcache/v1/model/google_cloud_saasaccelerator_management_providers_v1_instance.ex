...
defmodule GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance do
  ...
  *   `maintenancePolicyNames` (*type:* `map()`, *default:* `nil`) - The MaintenancePolicies that have been attached to the instance.
      ...
      go/cloud-saas-mw-ug.
  *   `maintenanceSchedules` (*type:* `%{optional(String.t) => GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule.t}`, *default:* `nil`) - The MaintenanceSchedule contains the scheduling information of published
  ...
  *   `provisionedResources` (*type:* `list(GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource.t)`, *default:* `nil`) - Output only. The list of data plane resources provisioned for this
  ...
  *   `sloMetadata` (*type:* `GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata.t`, *default:* `nil`) - Output only. SLO metadata for instance classification in the
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Timestamp when the resource was last modified.
  ...
  @type t :: %__MODULE__{
          ...
          :maintenanceSchedules => %{
            optional(String.t()) =>
              GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule.t()
          },
          :maintenanceSettings =>
            GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings.t(),
          :name => String.t(),
          :producerMetadata => map(),
          :provisionedResources =>
            list(
              GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource.t()
            ),
          :slmInstanceTemplate => String.t(),
          :sloMetadata =>
            GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata.t(),
  ...
  field(:maintenanceSchedules,
    as:
      GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule,
    type: :map
  )

  field(:maintenanceSettings,
    as:
      GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
  )
  ...
  field(:provisionedResources,
    as:
      GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource,
    type: :list
  )
  ...
  field(:sloMetadata,
    as: GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance.decode(
      value,
      options
    )
  end
