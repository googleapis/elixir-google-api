...
defmodule GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings do
  @moduledoc """
  ...
  *   `maintenancePolicies` (*type:* `%{optional(String.t) => GoogleApi.Memcache.V1.Model.MaintenancePolicy.t}`, *default:* `nil`) - Optional. The MaintenancePolicies that have been attached to the instance. The key must be of the type name of the oneof policy name defined in MaintenancePolicy, and the embedded policy must define the same policy type. For complete details of MaintenancePolicy, please refer to go/cloud-saas-mw-ug. If only the name is needed, then only populate MaintenancePolicy.name.
  ...
  @type t :: %__MODULE__{
          ...
          :maintenancePolicies =>
            %{optional(String.t()) => GoogleApi.Memcache.V1.Model.MaintenancePolicy.t()} | nil
        }

  field(:exclude)
  field(:isRollback)
  field(:maintenancePolicies, as: GoogleApi.Memcache.V1.Model.MaintenancePolicy, type: :map)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings do
  def decode(value, options) do
    GoogleApi.Memcache.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings.decode(
      value,
      options
    )
  end
