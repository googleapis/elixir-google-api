...
defmodule GoogleApi.Memcache.V1.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.Memcache.V1.Connection
  ...
  *   `{:ok, %GoogleApi.Memcache.V1.Model.Location{}}` on success
  *   `{:error, info}` on failure
  ...
  def memcache_projects_locations_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.Location{}])
  end
  ...
  *   `{:ok, %GoogleApi.Memcache.V1.Model.ListLocationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def memcache_projects_locations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.ListLocationsResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Memcache.V1.Model.ApplyParametersRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def memcache_projects_locations_instances_apply_parameters(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+name}:applyParameters", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.Memcache.V1.Model.Instance{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def memcache_projects_locations_instances_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.Instance{}])
  end
  ...
  *   `{:ok, %GoogleApi.Memcache.V1.Model.ListInstancesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def memcache_projects_locations_instances_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.ListInstancesResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Memcache.V1.Model.RescheduleMaintenanceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def memcache_projects_locations_instances_reschedule_maintenance(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+instance}:rescheduleMaintenance", %{
  ...
  *   `{:error, info}` on failure
  ...
  def memcache_projects_locations_instances_update_parameters(
    ...
    request =
      Request.new()
      |> Request.method(:patch)
      |> Request.url("/v1/{+name}:updateParameters", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Memcache.V1.Model.CancelOperationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Memcache.V1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def memcache_projects_locations_operations_cancel(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.Memcache.V1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def memcache_projects_locations_operations_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Memcache.V1.Model.ListOperationsResponse{}])
  end
end
