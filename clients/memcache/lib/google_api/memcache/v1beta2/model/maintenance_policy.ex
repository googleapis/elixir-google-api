...
defmodule GoogleApi.Memcache.V1beta2.Model.MaintenancePolicy do
  @moduledoc """
  ...
  *   `updatePolicy` (*type:* `GoogleApi.Memcache.V1beta2.Model.UpdatePolicy.t`, *default:* `nil`) - Maintenance policy applicable to instance update.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time when the resource was updated.
  ...
  field(:name)
  field(:state)
  field(:updatePolicy, as: GoogleApi.Memcache.V1beta2.Model.UpdatePolicy)
  field(:updateTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.Memcache.V1beta2.Model.MaintenancePolicy do
  def decode(value, options) do
    GoogleApi.Memcache.V1beta2.Model.MaintenancePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1beta2.Model.MaintenancePolicy do
