...
defmodule GoogleApi.Memcache.V1beta2.Model.GoogleCloudMemcacheV1beta2OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Memcache.V1beta2.Model.GoogleCloudMemcacheV1beta2OperationMetadata do
  def decode(value, options) do
    GoogleApi.Memcache.V1beta2.Model.GoogleCloudMemcacheV1beta2OperationMetadata.decode(
      value,
      options
    )
  end
