...
defmodule GoogleApi.Memcache.V1beta2.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion do
  @moduledoc """
  ...
  *   `sliName` (*type:* `String.t`, *default:* `nil`) - Name of an SLI that this exclusion applies to. Can be left empty, signaling that the instance should be excluded from all SLIs.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Memcache.V1beta2.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion do
  def decode(value, options) do
    GoogleApi.Memcache.V1beta2.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion.decode(
      value,
      options
    )
  end
