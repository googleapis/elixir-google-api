...
defmodule GoogleApi.Memcache.V1beta2.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Memcache.V1beta2.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.Memcache.V1beta2.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1beta2.Model.TimeOfDay do
