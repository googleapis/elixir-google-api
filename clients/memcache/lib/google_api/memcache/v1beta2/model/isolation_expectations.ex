...
defmodule GoogleApi.Memcache.V1beta2.Model.IsolationExpectations do
  @moduledoc """


  ## Attributes

  *   `requirementOverride` (*type:* `GoogleApi.Memcache.V1beta2.Model.RequirementOverride.t`, *default:* `nil`) - Explicit overrides for ZI and ZS requirements to be used for resources that should be excluded from ZI/ZS verification logic.
  ...
  *   `zsRegionState` (*type:* `String.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          :requirementOverride => GoogleApi.Memcache.V1beta2.Model.RequirementOverride.t() | nil,
  ...
  field(:requirementOverride, as: GoogleApi.Memcache.V1beta2.Model.RequirementOverride)
  field(:ziOrgPolicy)
...
defimpl Poison.Decoder, for: GoogleApi.Memcache.V1beta2.Model.IsolationExpectations do
  def decode(value, options) do
    GoogleApi.Memcache.V1beta2.Model.IsolationExpectations.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Memcache.V1beta2.Model.IsolationExpectations do
