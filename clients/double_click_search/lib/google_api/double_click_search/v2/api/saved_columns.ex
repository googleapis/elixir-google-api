...
defmodule GoogleApi.DoubleClickSearch.V2.Api.SavedColumns do
  ...
  - agency_id (String): DS ID of the agency.
  - advertiser_id (String): DS ID of the advertiser.
  ...
  """
  @spec doubleclicksearch_saved_columns_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DoubleClickSearch.V2.Model.SavedColumnList.t} | {:error, Tesla.Env.t}
  def doubleclicksearch_saved_columns_list(connection, agency_id, advertiser_id, opts \\ []) do
    ...
    |> decode(%GoogleApi.DoubleClickSearch.V2.Model.SavedColumnList{})
  end
end
