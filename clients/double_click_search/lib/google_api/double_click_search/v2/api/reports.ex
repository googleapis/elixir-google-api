...
defmodule GoogleApi.DoubleClickSearch.V2.Api.Reports do
  ...
  """
  @spec doubleclicksearch_reports_generate(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.DoubleClickSearch.V2.Model.Report.t} | {:error, Tesla.Env.t}
  def doubleclicksearch_reports_generate(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.DoubleClickSearch.V2.Model.Report{})
  end
  ...
  {:error, info} on failure
  """
  @spec doubleclicksearch_reports_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DoubleClickSearch.V2.Model.Report.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec doubleclicksearch_reports_get_file(Tesla.Env.client, String.t, Integer.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec doubleclicksearch_reports_request(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.DoubleClickSearch.V2.Model.Report.t} | {:error, Tesla.Env.t}
