...
defmodule GoogleApi.DoubleClickSearch.V2.Model.ReportRequestFilters do
  ...
  - column (GoogleApi.DoubleClickSearch.V2.Model.ReportApiColumnSpec.t): Column to perform the filter on. This can be a DoubleClick Search column or a saved column. Defaults to `nil`.
  - operator (String.t): Operator to use in the filter. See the filter reference for a list of available operators. Defaults to `nil`.
  - values (list(any())): A list of values to filter the column value against.
  The maximum number of filter values per request is 300. Defaults to `nil`.
  """
