...
defmodule GoogleApi.DoubleClickSearch.V2.Model.ReportRequest do
  ...
  *   `filters` (*type:* `list(GoogleApi.DoubleClickSearch.V2.Model.ReportRequestFilters.t)`, *default:* `nil`) - A list of filters to be applied to the report.\\ The maximum number of filters per request is 300.
  *   `includeDeletedEntities` (*type:* `boolean()`, *default:* `nil`) - Determines if removed entities should be included in the report. Defaults to `false`. Deprecated, please use `includeRemovedEntities` instead.
  *   `includeRemovedEntities` (*type:* `boolean()`, *default:* `nil`) - Determines if removed entities should be included in the report. Defaults to `false`.
  ...
  *   `orderBy` (*type:* `list(GoogleApi.DoubleClickSearch.V2.Model.ReportRequestOrderBy.t)`, *default:* `nil`) - Synchronous report only. A list of columns and directions defining sorting to be performed on the report rows.\\ The maximum number of orderings per request is 300.
  ...
  *   `reportType` (*type:* `String.t`, *default:* `nil`) - Determines the type of rows that are returned in the report. For example, if you specify `reportType: keyword`, each row in the report will contain data about a keyword. See the [Types of Reports](/search-ads/v2/report-types/) reference for the columns that are available for each type.
  *   `rowCount` (*type:* `integer()`, *default:* `nil`) - Synchronous report only. The maximum number of rows to return; additional rows are dropped. Acceptable values are `0` to `10000`, inclusive. Defaults to `10000`.
  *   `startRow` (*type:* `integer()`, *default:* `nil`) - Synchronous report only. Zero-based index of the first row to return. Acceptable values are `0` to `50000`, inclusive. Defaults to `0`.
  ...
  *   `verifySingleTimeZone` (*type:* `boolean()`, *default:* `nil`) - If `true`, the report would only be created if all the requested stat data are sourced from a single timezone. Defaults to `false`.
  """
