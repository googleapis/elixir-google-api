...
defmodule GoogleApi.DoubleClickSearch.V2.Model.SavedColumnList do
  ...
  - items (List[SavedColumn]): The saved columns being requested. Defaults to: `null`.
  - kind (String): Identifies this as a SavedColumnList resource. Value: the fixed string doubleclicksearch#savedColumnList. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickSearch.V2.Model.SavedColumnList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.DoubleClickSearch.V2.Model.SavedColumn, options)
  end
end
