...
defmodule GoogleApi.DoubleClickSearch.V2.Model.CustomDimension do
  ...
  - name (String.t): Custom dimension name. Defaults to: `null`.
  - value (String.t): Custom dimension value. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickSearch.V2.Model.CustomDimension do
  def decode(value, options) do
    GoogleApi.DoubleClickSearch.V2.Model.CustomDimension.decode(value, options)
  end
end
