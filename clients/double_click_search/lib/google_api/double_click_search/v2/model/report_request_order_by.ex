...
defmodule GoogleApi.DoubleClickSearch.V2.Model.ReportRequestOrderBy do
  ...
  - column (GoogleApi.DoubleClickSearch.V2.Model.ReportApiColumnSpec.t): Column to perform the sort on. This can be a DoubleClick Search-defined column or a saved column. Defaults to `nil`.
  - sortOrder (String.t): The sort direction, which is either ascending or descending. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickSearch.V2.Model.ReportRequestOrderBy do
  def decode(value, options) do
    GoogleApi.DoubleClickSearch.V2.Model.ReportRequestOrderBy.decode(value, options)
  end
end
