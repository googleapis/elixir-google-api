...
defmodule GoogleApi.DoubleClickSearch.V2.Model.Conversion do
  ...
  *   `currencyCode` (*type:* `String.t`, *default:* `nil`) - The currency code for the conversion's revenue. Should be in ISO 4217
  ...
  *   `inventoryAccountId` (*type:* `String.t`, *default:* `nil`) - ID that DS generates and uses to uniquely identify the inventory account
  ...
  *   `customDimension` (*type:* `list(GoogleApi.DoubleClickSearch.V2.Model.CustomDimension.t)`, *default:* `nil`) - Custom dimensions for the conversion, which can be used to filter data in a
      report.
  *   `conversionId` (*type:* `String.t`, *default:* `nil`) - For offline conversions, advertisers provide this ID. Advertisers can
  ...
  *   `countMillis` (*type:* `String.t`, *default:* `nil`) - Available to advertisers only after contacting DoubleClick Search customer
      support.
  ...
  *   `revenueMicros` (*type:* `String.t`, *default:* `nil`) - The revenue amount of this `TRANSACTION` conversion, in micros
  ...
  *   `productCountry` (*type:* `String.t`, *default:* `nil`) - The country registered for the Merchant Center feed that contains the
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - The state of the conversion, that is, either `ACTIVE` or
  ...
  *   `storeId` (*type:* `String.t`, *default:* `nil`) - The ID of the local store for which the product was advertised. Applicable
      only when the channel is "`local`".
  *   `channel` (*type:* `String.t`, *default:* `nil`) - Sales channel for the product. Acceptable values are: <ul>
      <li>"`local`": a physical store</li> <li>"`online`":
      an online store</li> </ul>
  *   `agencyId` (*type:* `String.t`, *default:* `nil`) - DS agency ID.
  *   `type` (*type:* `String.t`, *default:* `nil`) - The type of the conversion, that is, either `ACTION` or
  ...
  *   `productLanguage` (*type:* `String.t`, *default:* `nil`) - The language registered for the Merchant Center feed that contains the
      product. Use an ISO 639 code to specify a language.
  *   `productGroupId` (*type:* `String.t`, *default:* `nil`) - DS product group ID.
  *   `segmentationType` (*type:* `String.t`, *default:* `nil`) - The segmentation type of this conversion (for example,
      `FLOODLIGHT`).
  *   `attributionModel` (*type:* `String.t`, *default:* `nil`) - Available to advertisers only after contacting DoubleClick Search customer
      support.
  """
