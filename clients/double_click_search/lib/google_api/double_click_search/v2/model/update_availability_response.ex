...
defmodule GoogleApi.DoubleClickSearch.V2.Model.UpdateAvailabilityResponse do
  ...
  *   `availabilities` (*type:* `list(GoogleApi.DoubleClickSearch.V2.Model.Availability.t)`, *default:* `nil`) - The availabilities being returned.
  """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickSearch.V2.Model.UpdateAvailabilityResponse do
  def decode(value, options) do
    GoogleApi.DoubleClickSearch.V2.Model.UpdateAvailabilityResponse.decode(value, options)
  end
end
