...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1CrashRateMetricSet do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Identifier. The resource name. Format: apps/{app}/crashRateMetricSet
  """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1CrashRateMetricSet do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1CrashRateMetricSet.decode(
      value,
      options
    )
  end
