...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Identifier. The resource name. Format: apps/{app}/slowStartRateMetricSet
  """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowStartRateMetricSet.decode(
      value,
      options
    )
  end
