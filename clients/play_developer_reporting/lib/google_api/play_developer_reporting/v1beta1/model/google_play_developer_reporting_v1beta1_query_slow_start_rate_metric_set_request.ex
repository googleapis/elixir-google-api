...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowStartRateMetricSetRequest.decode(
      value,
      options
    )
  end
