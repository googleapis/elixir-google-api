...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Identifier. The resource name. Format: apps/{app}/slowRenderingRateMetricSet
  """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1SlowRenderingRateMetricSet.decode(
      value,
      options
    )
  end
