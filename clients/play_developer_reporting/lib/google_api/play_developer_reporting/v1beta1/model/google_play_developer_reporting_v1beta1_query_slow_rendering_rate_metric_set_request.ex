...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1QuerySlowRenderingRateMetricSetRequest.decode(
      value,
      options
    )
  end
