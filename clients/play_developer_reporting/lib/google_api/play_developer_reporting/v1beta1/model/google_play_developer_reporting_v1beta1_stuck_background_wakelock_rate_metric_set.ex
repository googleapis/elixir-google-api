...
defmodule GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Identifier. The resource name. Format: apps/{app}/stuckBackgroundWakelockRateMetricSet
  """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet do
  def decode(value, options) do
    GoogleApi.PlayDeveloperReporting.V1beta1.Model.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet.decode(
      value,
      options
    )
  end
