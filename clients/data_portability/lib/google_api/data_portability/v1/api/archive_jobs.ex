...
defmodule GoogleApi.DataPortability.V1.Api.ArchiveJobs do
  @moduledoc """
  API calls for all endpoints tagged `ArchiveJobs`.
  """
  ...
  *   `{:error, info}` on failure
  """
  @spec dataportability_archive_jobs_get_portability_archive_state(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.DataPortability.V1.Model.PortabilityArchiveState.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dataportability_archive_jobs_get_portability_archive_state(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DataPortability.V1.Model.PortabilityArchiveState{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dataportability_archive_jobs_retry(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DataPortability.V1.Model.RetryPortabilityArchiveResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dataportability_archive_jobs_retry(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DataPortability.V1.Model.RetryPortabilityArchiveResponse{}]
    )
  end
end
