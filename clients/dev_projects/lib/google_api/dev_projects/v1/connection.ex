...
defmodule GoogleApi.DevProjects.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.DevProjects.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://www.googleapis.com/devprojects/v1"
