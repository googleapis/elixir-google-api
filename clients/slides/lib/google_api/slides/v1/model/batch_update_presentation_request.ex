...
defmodule GoogleApi.Slides.V1.Model.BatchUpdatePresentationRequest do
  ...
  - requests (list(GoogleApi.Slides.V1.Model.Request.t)): A list of updates to apply to the presentation. Defaults to `nil`.
  - writeControl (GoogleApi.Slides.V1.Model.WriteControl.t): Provides control over how write requests are executed. Defaults to `nil`.
  """
