...
defmodule GoogleApi.Slides.V1.Model.TextContent do
  ...
  - lists (%{optional(String.t) => GoogleApi.Slides.V1.Model.List.t}): The bulleted lists contained in this text, keyed by list ID. Defaults to `nil`.
  - textElements (list(GoogleApi.Slides.V1.Model.TextElement.t)): The text contents broken down into its component parts, including styling
  information. This property is read-only. Defaults to `nil`.
  """
