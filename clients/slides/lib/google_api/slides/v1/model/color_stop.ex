...
defmodule GoogleApi.Slides.V1.Model.ColorStop do
  ...
  fully opaque. Defaults to `nil`.
  - color (GoogleApi.Slides.V1.Model.OpaqueColor.t): The color of the gradient stop. Defaults to `nil`.
  - position (number()): The relative position of the color stop in the gradient band measured
  in percentage. The value should be in the interval [0.0, 1.0]. Defaults to `nil`.
  """
