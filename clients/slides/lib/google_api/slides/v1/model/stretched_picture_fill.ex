...
defmodule GoogleApi.Slides.V1.Model.StretchedPictureFill do
  ...
  - contentUrl (String.t): Reading the content_url:
  ...
  The provided URL can be at most 2 kB in length. Defaults to `nil`.
  - size (GoogleApi.Slides.V1.Model.Size.t): The original size of the picture fill. This field is read-only. Defaults to `nil`.
  """
