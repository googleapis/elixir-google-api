...
defmodule GoogleApi.Slides.V1.Model.InsertTableRowsRequest do
  ...
  - cellLocation (GoogleApi.Slides.V1.Model.TableCellLocation.t): The reference table cell location from which rows will be inserted.

  A new row will be inserted above (or below) the row where the reference
  cell is. If the reference cell is a merged cell, a new row will be
  inserted above (or below) the merged cell. Defaults to `nil`.
  - insertBelow (boolean()): Whether to insert new rows below the reference cell location.

  - `True`: insert below the cell.
  - `False`: insert above the cell. Defaults to `nil`.
  - number (integer()): The number of rows to be inserted. Maximum 20 per request. Defaults to `nil`.
  - tableObjectId (String.t): The table to insert rows into. Defaults to `nil`.
  """
