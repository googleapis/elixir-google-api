...
defmodule GoogleApi.Slides.V1.Model.LineConnection do
  ...
  *   `connectedObjectId` (*type:* `String.t`, *default:* `nil`) - The object ID of the connected page element.

      Some page elements, such as groups, tables, and lines
      do not have connection sites and therefore cannot be connected to a
      connector line.
  *   `connectionSiteIndex` (*type:* `integer()`, *default:* `nil`) - The index of the connection site on the connected page element.
