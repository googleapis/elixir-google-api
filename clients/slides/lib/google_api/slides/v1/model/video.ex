...
defmodule GoogleApi.Slides.V1.Model.Video do
  ...
  - id (String.t): The video source&#39;s unique identifier for this video. Defaults to: `null`.
  - source (String.t): The video source. Defaults to: `null`.
    - Enum - one of [SOURCE_UNSPECIFIED, YOUTUBE, DRIVE]
  - url (String.t): An URL to a video. The URL is valid as long as the source video exists and sharing settings do not change. Defaults to: `null`.
