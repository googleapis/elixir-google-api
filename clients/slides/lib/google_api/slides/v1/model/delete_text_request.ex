...
defmodule GoogleApi.Slides.V1.Model.DeleteTextRequest do
  ...
  - cellLocation (GoogleApi.Slides.V1.Model.TableCellLocation.t): The optional table cell location if the text is to be deleted from a table
  cell. If present, the object_id must refer to a table. Defaults to `nil`.
  - objectId (String.t): The object ID of the shape or table from which the text will be deleted. Defaults to `nil`.
  - textRange (GoogleApi.Slides.V1.Model.Range.t): The range of text to delete, based on TextElement indexes.
  ...
  include both code units. Defaults to `nil`.
  """
