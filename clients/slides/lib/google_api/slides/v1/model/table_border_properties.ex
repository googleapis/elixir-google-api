...
defmodule GoogleApi.Slides.V1.Model.TableBorderProperties do
  ...
  - dashStyle (String.t): The dash style of the border. Defaults to `nil`.
  - tableBorderFill (GoogleApi.Slides.V1.Model.TableBorderFill.t): The fill of the table border. Defaults to `nil`.
  - weight (GoogleApi.Slides.V1.Model.Dimension.t): The thickness of the border. Defaults to `nil`.
  """
