...
defmodule GoogleApi.Slides.V1.Model.UpdateSlidesPositionRequest do
  ...
  *   `insertionIndex` (*type:* `integer()`, *default:* `nil`) - The index where the slides should be inserted, based on the slide
      arrangement before the move takes place. Must be between zero and the
      number of slides in the presentation, inclusive.
  *   `slideObjectIds` (*type:* `list(String.t)`, *default:* `nil`) - The IDs of the slides in the presentation that should be moved.
