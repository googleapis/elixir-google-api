...
defmodule GoogleApi.Slides.V1.Model.DeleteTableColumnRequest do
  ...
  - cellLocation (GoogleApi.Slides.V1.Model.TableCellLocation.t): The reference table cell location from which a column will be deleted.

  The column this cell spans will be deleted. If this is a merged cell,
  multiple columns will be deleted. If no columns remain in the table after
  this deletion, the whole table is deleted. Defaults to `nil`.
  - tableObjectId (String.t): The table to delete columns from. Defaults to `nil`.
  """
