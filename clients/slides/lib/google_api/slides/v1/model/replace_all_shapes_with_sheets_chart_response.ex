...
defmodule GoogleApi.Slides.V1.Model.ReplaceAllShapesWithSheetsChartResponse do
  ...
  *   `occurrencesChanged` (*type:* `integer()`, *default:* `nil`) - The number of shapes replaced with charts.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Slides.V1.Model.ReplaceAllShapesWithSheetsChartResponse do
  def decode(value, options) do
    GoogleApi.Slides.V1.Model.ReplaceAllShapesWithSheetsChartResponse.decode(value, options)
  end
end
