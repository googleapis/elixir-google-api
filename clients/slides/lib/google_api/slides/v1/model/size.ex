...
defmodule GoogleApi.Slides.V1.Model.Size do
  ...
  - height (GoogleApi.Slides.V1.Model.Dimension.t): The height of the object. Defaults to `nil`.
  - width (GoogleApi.Slides.V1.Model.Dimension.t): The width of the object. Defaults to `nil`.
  """
