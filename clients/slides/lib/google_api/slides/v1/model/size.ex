...
defmodule GoogleApi.Slides.V1.Model.Size do
  ...
  *   `height` (*type:* `GoogleApi.Slides.V1.Model.Dimension.t`, *default:* `nil`) - The height of the object.
  *   `width` (*type:* `GoogleApi.Slides.V1.Model.Dimension.t`, *default:* `nil`) - The width of the object.
  """
