...
defmodule GoogleApi.Slides.V1.Model.CreateSlideRequest do
  ...
  *   `insertionIndex` (*type:* `integer()`, *default:* `nil`) - The optional zero-based index indicating where to insert the slides. If you don't specify an index, the new slide is created at the end.
  ...
  *   `placeholderIdMappings` (*type:* `list(GoogleApi.Slides.V1.Model.LayoutPlaceholderIdMapping.t)`, *default:* `nil`) - An optional list of object ID mappings from the placeholder(s) on the layout to the placeholder(s) that will be created on the new slide from that specified layout. Can only be used when `slide_layout_reference` is specified.
