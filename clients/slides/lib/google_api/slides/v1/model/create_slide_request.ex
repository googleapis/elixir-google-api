...
defmodule GoogleApi.Slides.V1.Model.CreateSlideRequest do
  ...
  - placeholderIdMappings ([LayoutPlaceholderIdMapping]): An optional list of object ID mappings from the placeholder(s) on the layout to the placeholder(s) that will be created on the new slide from that specified layout. Can only be used when &#x60;slide_layout_reference&#x60; is specified. Defaults to: `null`.
