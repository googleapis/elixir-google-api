...
defmodule GoogleApi.Slides.V1.Model.TableRowProperties do
  ...
  - minRowHeight (Dimension): Minimum height of the row. The row will be rendered in the Slides editor at a height equal to or greater than this value in order to show all the text in the row&#39;s cell(s). Defaults to: `null`.
  """
