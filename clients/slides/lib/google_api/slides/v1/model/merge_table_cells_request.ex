...
defmodule GoogleApi.Slides.V1.Model.MergeTableCellsRequest do
  ...
  - tableRange (GoogleApi.Slides.V1.Model.TableRange.t): The table range specifying which cells of the table to merge.
  ...
  already merged), a 400 bad request error is returned. Defaults to `nil`.
  """
