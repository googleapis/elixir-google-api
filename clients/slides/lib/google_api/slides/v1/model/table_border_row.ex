...
defmodule GoogleApi.Slides.V1.Model.TableBorderRow do
  ...
  - tableBorderCells (list(GoogleApi.Slides.V1.Model.TableBorderCell.t)): Properties of each border cell. When a border's adjacent table cells are
  merged, it is not included in the response. Defaults to `nil`.
  """
