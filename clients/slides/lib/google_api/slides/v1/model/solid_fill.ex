...
defmodule GoogleApi.Slides.V1.Model.SolidFill do
  ...
  a value of 0.0 corresponds to a completely transparent color. Defaults to `nil`.
  - color (GoogleApi.Slides.V1.Model.OpaqueColor.t): The color value of the solid fill. Defaults to `nil`.
  """
