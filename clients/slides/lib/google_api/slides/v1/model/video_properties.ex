...
defmodule GoogleApi.Slides.V1.Model.VideoProperties do
  ...
  mode. Defaults to false. Defaults to `nil`.
  ...
  the video will be played until its end. Defaults to `nil`.
  - mute (boolean()): Whether to mute the audio during video playback. Defaults to false. Defaults to `nil`.
  - outline (GoogleApi.Slides.V1.Model.Outline.t): The outline of the video. The default outline matches the defaults for new
  videos created in the Slides editor. Defaults to `nil`.
  ...
  If not set, the video will be played from the beginning. Defaults to `nil`.
  """
