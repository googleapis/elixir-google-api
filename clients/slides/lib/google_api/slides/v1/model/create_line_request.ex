...
defmodule GoogleApi.Slides.V1.Model.CreateLineRequest do
  ...
  - category (String.t): The category of the line to be created.
  ...
  If you do not specify either, then STRAIGHT is used. Defaults to `nil`.
  - elementProperties (GoogleApi.Slides.V1.Model.PageElementProperties.t): The element properties for the line. Defaults to `nil`.
  - lineCategory (String.t): The category of the line to be created.
  ...
  If you specify both a `category` and a `line_category`, the `category`
  takes precedence. Defaults to `nil`.
