...
defmodule GoogleApi.Slides.V1.Model.Outline do
  ...
  - dashStyle (String.t): The dash style of the outline. Defaults to `nil`.
  - outlineFill (GoogleApi.Slides.V1.Model.OutlineFill.t): The fill of the outline. Defaults to `nil`.
  - propertyState (String.t): The outline property state.
  ...
  - weight (GoogleApi.Slides.V1.Model.Dimension.t): The thickness of the outline. Defaults to `nil`.
  """
