...
defmodule GoogleApi.Slides.V1.Model.ThemeColorPair do
  ...
  - color (GoogleApi.Slides.V1.Model.RgbColor.t): The concrete color corresponding to the theme color type above. Defaults to `nil`.
  - type (String.t): The type of the theme color. Defaults to `nil`.
  """
