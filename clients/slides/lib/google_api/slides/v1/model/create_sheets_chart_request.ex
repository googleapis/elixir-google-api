...
defmodule GoogleApi.Slides.V1.Model.CreateSheetsChartRequest do
  ...
  - elementProperties (GoogleApi.Slides.V1.Model.PageElementProperties.t): The element properties for the chart.
  ...
  If empty, a unique identifier will be generated. Defaults to `nil`.
