...
defmodule GoogleApi.Slides.V1.Model.List do
  ...
  - listId (String.t): The ID of the list. Defaults to `nil`.
  - nestingLevel (%{optional(String.t) => GoogleApi.Slides.V1.Model.NestingLevel.t}): A map of nesting levels to the properties of bullets at the associated
  level. A list has at most nine levels of nesting, so the possible values
  for the keys of this map are 0 through 8, inclusive. Defaults to `nil`.
  """
