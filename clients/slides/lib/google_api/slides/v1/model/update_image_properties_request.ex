...
defimpl Poison.Decoder, for: GoogleApi.Slides.V1.Model.UpdateImagePropertiesRequest do
  def decode(value, options) do
    GoogleApi.Slides.V1.Model.UpdateImagePropertiesRequest.decode(value, options)
  end
end
