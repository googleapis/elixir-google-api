...
defmodule GoogleApi.Slides.V1.Model.UpdateImagePropertiesRequest do
  ...
  - imageProperties (GoogleApi.Slides.V1.Model.ImageProperties.t): The image properties to update. Defaults to `nil`.
  - objectId (String.t): The object ID of the image the updates are applied to. Defaults to `nil`.
  """
