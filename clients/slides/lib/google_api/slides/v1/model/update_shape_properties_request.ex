...
defmodule GoogleApi.Slides.V1.Model.UpdateShapePropertiesRequest do
  ...
  - objectId (String.t): The object ID of the shape the updates are applied to. Defaults to `nil`.
  - shapeProperties (GoogleApi.Slides.V1.Model.ShapeProperties.t): The shape properties to update. Defaults to `nil`.
  """
