...
defmodule GoogleApi.Slides.V1.Model.ImageProperties do
  ...
  [-1.0, 1.0], where 0 means no effect. This property is read-only. Defaults to `nil`.
  - contrast (number()): The contrast effect of the image. The value should be in the interval
  [-1.0, 1.0], where 0 means no effect. This property is read-only. Defaults to `nil`.
  - cropProperties (GoogleApi.Slides.V1.Model.CropProperties.t): The crop properties of the image. If not set, the image is not cropped.
  This property is read-only. Defaults to `nil`.
  - link (GoogleApi.Slides.V1.Model.Link.t): The hyperlink destination of the image. If unset, there is no link. Defaults to `nil`.
  - outline (GoogleApi.Slides.V1.Model.Outline.t): The outline of the image. If not set, the image has no outline. Defaults to `nil`.
  - recolor (GoogleApi.Slides.V1.Model.Recolor.t): The recolor effect of the image. If not set, the image is not recolored.
  This property is read-only. Defaults to `nil`.
  - shadow (GoogleApi.Slides.V1.Model.Shadow.t): The shadow of the image. If not set, the image has no shadow. This property
  is read-only. Defaults to `nil`.
