...
defmodule GoogleApi.Slides.V1.Model.ReplaceAllTextRequest do
  ...
  - containsText (GoogleApi.Slides.V1.Model.SubstringMatchCriteria.t): Finds text in a shape matching this substring. Defaults to `nil`.
  - pageObjectIds (list(String.t)): If non-empty, limits the matches to page elements only on the given pages.

  Returns a 400 bad request error if given the page object ID of a
  notes master,
  or if a page with that object ID doesn't exist in the presentation. Defaults to `nil`.
  - replaceText (String.t): The text that will replace the matched text. Defaults to `nil`.
  """
