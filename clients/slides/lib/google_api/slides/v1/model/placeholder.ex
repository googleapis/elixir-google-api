...
defmodule GoogleApi.Slides.V1.Model.Placeholder do
  ...
  the same page, they would have different index values. Defaults to `nil`.
  - parentObjectId (String.t): The object ID of this shape's parent placeholder.
  If unset, the parent placeholder shape does not exist, so the shape does
  not inherit properties from any other shape. Defaults to `nil`.
  - type (String.t): The type of the placeholder. Defaults to `nil`.
  """
