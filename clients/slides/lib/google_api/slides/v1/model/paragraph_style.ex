...
defmodule GoogleApi.Slides.V1.Model.ParagraphStyle do
  ...
  - alignment (String.t): The text alignment for this paragraph. Defaults to: `null`.
    - Enum - one of [ALIGNMENT_UNSPECIFIED, START, CENTER, END, JUSTIFIED]
  - direction (String.t): The text direction of this paragraph. If unset, the value defaults to LEFT_TO_RIGHT since text direction is not inherited. Defaults to: `null`.
  ...
  - spaceBelow (Dimension): The amount of extra space below the paragraph. If unset, the value is inherited from the parent. Defaults to: `null`.
  - spacingMode (String.t): The spacing mode for the paragraph. Defaults to: `null`.
