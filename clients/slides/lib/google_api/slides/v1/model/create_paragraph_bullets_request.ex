...
defmodule GoogleApi.Slides.V1.Model.CreateParagraphBulletsRequest do
  ...
  - bulletPreset (String.t): The kinds of bullet glyphs to be used. Defaults to the
  `BULLET_DISC_CIRCLE_SQUARE` preset. Defaults to `nil`.
  ...
  - objectId (String.t): The object ID of the shape or table containing the text to add bullets to. Defaults to `nil`.
  - textRange (GoogleApi.Slides.V1.Model.Range.t): The range of text to apply the bullet presets to, based on TextElement indexes. Defaults to `nil`.
  """
