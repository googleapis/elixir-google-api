...
defmodule GoogleApi.Slides.V1.Model.GroupObjectsRequest do
  ...
  - childrenObjectIds (list(String.t)): The object IDs of the objects to group.
  ...
  elements, such as videos, tables and placeholder shapes cannot be grouped. Defaults to `nil`.
  - groupObjectId (String.t): A user-supplied object ID for the group to be created.
