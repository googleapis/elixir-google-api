...
defmodule GoogleApi.Slides.V1.Model.GroupObjectsRequest do
  ...
  *   `childrenObjectIds` (*type:* `list(String.t)`, *default:* `nil`) - The object IDs of the objects to group. Only page elements can be grouped. There should be at least two page elements on the same page that are not already in another group. Some page elements, such as videos, tables and placeholder shapes cannot be grouped.
