...
defmodule GoogleApi.Slides.V1.Model.InsertTextRequest do
  ...
  - cellLocation (GoogleApi.Slides.V1.Model.TableCellLocation.t): The optional table cell location if the text is to be inserted into a table
  ...
  grapheme cluster. Defaults to `nil`.
  - objectId (String.t): The object ID of the shape or table where the text will be inserted. Defaults to `nil`.
  ...
  will be stripped out of the inserted text. Defaults to `nil`.
  """
