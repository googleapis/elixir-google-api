...
defmodule GoogleApi.CloudKMS.V1.Model.ListCryptoKeyVersionsResponse do
  ...
  - cryptoKeyVersions ([CryptoKeyVersion]): The list of CryptoKeyVersions. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve next page of results. Pass this value in ListCryptoKeyVersionsRequest.page_token to retrieve the next page of results. Defaults to: `null`.
  - totalSize (integer()): The total number of CryptoKeyVersions that matched the query. Defaults to: `null`.
  """
