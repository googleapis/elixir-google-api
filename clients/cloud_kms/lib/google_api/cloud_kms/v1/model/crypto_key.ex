...
defmodule GoogleApi.CloudKMS.V1.Model.CryptoKey do
  ...
  *   `versionTemplate` (*type:* `GoogleApi.CloudKMS.V1.Model.CryptoKeyVersionTemplate.t`, *default:* `nil`) - A template describing settings for new CryptoKeyVersion instances. The properties of new CryptoKeyVersion instances created by either CreateCryptoKeyVersion or auto-rotation are controlled by this template.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :keyAccessJustificationsPolicy =>
            GoogleApi.CloudKMS.V1.Model.KeyAccessJustificationsPolicy.t() | nil,
          :labels => map() | nil,
          :name => String.t() | nil,
  ...
  field(:keyAccessJustificationsPolicy,
    as: GoogleApi.CloudKMS.V1.Model.KeyAccessJustificationsPolicy
  )
