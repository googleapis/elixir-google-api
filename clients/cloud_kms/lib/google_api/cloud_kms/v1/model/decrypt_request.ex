...
defmodule GoogleApi.CloudKMS.V1.Model.DecryptRequest do
  ...
  - additionalAuthenticatedData (binary()): Optional data that must match the data originally supplied in EncryptRequest.additional_authenticated_data. Defaults to: `null`.
  - ciphertext (binary()): Required. The encrypted data originally returned in EncryptResponse.ciphertext. Defaults to: `null`.
  """
