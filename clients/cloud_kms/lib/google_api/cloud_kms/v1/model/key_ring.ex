...
defmodule GoogleApi.CloudKMS.V1.Model.KeyRing do
  ...
  - createTime (DateTime.t): Output only. The time at which this KeyRing was created. Defaults to: `null`.
  - name (String.t): Output only. The resource name for the KeyRing in the format &#x60;projects/*/locations/*/keyRings/*&#x60;. Defaults to: `null`.
  """
