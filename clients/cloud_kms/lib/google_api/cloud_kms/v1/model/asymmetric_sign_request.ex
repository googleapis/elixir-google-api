...
defmodule GoogleApi.CloudKMS.V1.Model.AsymmetricSignRequest do
  ...
  - digest (Digest): Required. The digest of the data to sign. The digest must be produced with the same digest algorithm as specified by the key version&#39;s algorithm. Defaults to: `null`.
  """
