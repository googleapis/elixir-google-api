...
defmodule GoogleApi.CloudKMS.V1.Model.CertificateChains do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudKMS.V1.Model.CertificateChains do
  def decode(value, options) do
    GoogleApi.CloudKMS.V1.Model.CertificateChains.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudKMS.V1.Model.CertificateChains do
