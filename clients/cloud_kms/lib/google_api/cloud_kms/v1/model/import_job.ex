...
defmodule GoogleApi.CloudKMS.V1.Model.ImportJob do
  ...
  *   `expireEventTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time this ImportJob expired. Only present if state is EXPIRED.
  *   `expireTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time at which this ImportJob is scheduled for expiration and can no longer be used to import key material.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name for this ImportJob in the format `projects/*/locations/*/keyRings/*/importJobs/*`.
  *   `protectionLevel` (*type:* `String.t`, *default:* `nil`) - Required. Immutable. The protection level of the ImportJob. This must match the protection_level of the version_template on the CryptoKey you attempt to import into.
  *   `publicKey` (*type:* `GoogleApi.CloudKMS.V1.Model.WrappingPublicKey.t`, *default:* `nil`) - Output only. The public key with which to wrap key material prior to import. Only returned if state is ACTIVE.
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The current state of the ImportJob, indicating if it can be used.
  """
