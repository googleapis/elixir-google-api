...
defmodule GoogleApi.CloudKMS.V1.Model.ListKeyRingsResponse do
  ...
  - keyRings ([KeyRing]): The list of KeyRings. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve next page of results. Pass this value in ListKeyRingsRequest.page_token to retrieve the next page of results. Defaults to: `null`.
  - totalSize (integer()): The total number of KeyRings that matched the query. Defaults to: `null`.
  """
