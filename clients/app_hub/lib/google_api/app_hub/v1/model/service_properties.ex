...
defmodule GoogleApi.AppHub.V1.Model.ServiceProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AppHub.V1.Model.ServiceProperties do
  def decode(value, options) do
    GoogleApi.AppHub.V1.Model.ServiceProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AppHub.V1.Model.ServiceProperties do
