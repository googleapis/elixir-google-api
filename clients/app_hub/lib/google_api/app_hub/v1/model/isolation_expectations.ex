...
defmodule GoogleApi.AppHub.V1.Model.IsolationExpectations do
  @moduledoc """
  ...
  *   `zsRegionState` (*type:* `String.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          :requirementOverride => GoogleApi.AppHub.V1.Model.RequirementOverride.t() | nil,
  ...
  field(:requirementOverride, as: GoogleApi.AppHub.V1.Model.RequirementOverride)
  field(:ziOrgPolicy)
...
defimpl Poison.Decoder, for: GoogleApi.AppHub.V1.Model.IsolationExpectations do
  def decode(value, options) do
    GoogleApi.AppHub.V1.Model.IsolationExpectations.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AppHub.V1.Model.IsolationExpectations do
