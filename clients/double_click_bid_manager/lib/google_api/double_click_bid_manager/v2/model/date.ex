...
defmodule GoogleApi.DoubleClickBidManager.V2.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V2.Model.Date do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V2.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V2.Model.Date do
