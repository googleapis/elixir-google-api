...
defmodule GoogleApi.DoubleClickBidManager.V2.Model.Report do
  ...
  *   `key` (*type:* `GoogleApi.DoubleClickBidManager.V2.Model.ReportKey.t`, *default:* `nil`) - Key used to identify a report.
  *   `metadata` (*type:* `GoogleApi.DoubleClickBidManager.V2.Model.ReportMetadata.t`, *default:* `nil`) - Report metadata.
  *   `params` (*type:* `GoogleApi.DoubleClickBidManager.V2.Model.Parameters.t`, *default:* `nil`) - Report parameters.
  """
