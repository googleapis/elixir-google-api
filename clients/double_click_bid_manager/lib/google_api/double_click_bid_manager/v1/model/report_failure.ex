...
defmodule GoogleApi.DoubleClickBidManager.V1.Model.ReportFailure do
  ...
  - errorCode (String.t): Error code that shows why the report was not created. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V1.Model.ReportFailure do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V1.Model.ReportFailure.decode(value, options)
  end
end
