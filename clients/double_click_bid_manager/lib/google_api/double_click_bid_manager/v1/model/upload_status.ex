...
defmodule GoogleApi.DoubleClickBidManager.V1.Model.UploadStatus do
  ...
  *   `rowStatus` (*type:* `list(GoogleApi.DoubleClickBidManager.V1.Model.RowStatus.t)`, *default:* `nil`) - Per-row upload status.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :rowStatus => list(GoogleApi.DoubleClickBidManager.V1.Model.RowStatus.t()) | nil
        }
