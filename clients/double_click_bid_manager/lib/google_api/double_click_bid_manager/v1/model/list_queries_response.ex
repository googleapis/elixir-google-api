...
defmodule GoogleApi.DoubleClickBidManager.V1.Model.ListQueriesResponse do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "doubleclickbidmanager#listQueriesResponse". Defaults to `doubleclickbidmanager#listQueriesResponse`.
  - queries (list(GoogleApi.DoubleClickBidManager.V1.Model.Query.t)): Retrieved queries. Defaults to `nil`.
  """
