...
defmodule GoogleApi.DoubleClickBidManager.V1.Model.ReportStatus do
  ...
  - failure (GoogleApi.DoubleClickBidManager.V1.Model.ReportFailure.t): If the report failed, this records the cause. Defaults to `nil`.
  - finishTimeMs (String.t): The time when this report either completed successfully or failed. Defaults to `nil`.
  - format (String.t): The file type of the report. Defaults to `nil`.
  - state (String.t): The state of the report. Defaults to `nil`.
  """
