...
defmodule GoogleApi.DoubleClickBidManager.V1.Api.Reports do
  ...
  """
  @spec doubleclickbidmanager_reports_listreports(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def doubleclickbidmanager_reports_listreports(connection, query_id, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.DoubleClickBidManager.V1.Model.ListReportsResponse{})
  end
end
