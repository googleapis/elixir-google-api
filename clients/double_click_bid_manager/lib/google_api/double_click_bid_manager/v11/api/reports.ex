...
defmodule GoogleApi.DoubleClickBidManager.V11.Api.Reports do
  @moduledoc """
  ...
  *   `query_id` (*type:* `String.t`) - Query ID with which the reports are associated.
  ...
  *   `{:ok, %GoogleApi.DoubleClickBidManager.V11.Model.ListReportsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec doubleclickbidmanager_reports_listreports(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.DoubleClickBidManager.V11.Model.ListReportsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def doubleclickbidmanager_reports_listreports(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/doubleclickbidmanager/v1.1/queries/{queryId}/reports", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DoubleClickBidManager.V11.Model.ListReportsResponse{}]
    )
  end
end
