...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.RunQueryRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.RunQueryRequest do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.RunQueryRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.RunQueryRequest do
