...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.DownloadRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadRequest do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.DownloadRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadRequest do
