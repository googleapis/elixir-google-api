...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.Options do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.Options do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.Options.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.Options do
