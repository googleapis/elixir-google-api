...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.DownloadResponse do
  @moduledoc """
  Download response.
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadResponse do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.DownloadResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadResponse do
