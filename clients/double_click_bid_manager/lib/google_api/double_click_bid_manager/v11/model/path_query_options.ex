...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.PathQueryOptions do
  @moduledoc """
  ...
  *   `pathFilters` (*type:* `list(GoogleApi.DoubleClickBidManager.V11.Model.PathFilter.t)`, *default:* `nil`) - Path Filters. There is a limit of 100 path filters that can be set per
  ...
  field(:pathFilters, as: GoogleApi.DoubleClickBidManager.V11.Model.PathFilter, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.PathQueryOptions do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.PathQueryOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.PathQueryOptions do
