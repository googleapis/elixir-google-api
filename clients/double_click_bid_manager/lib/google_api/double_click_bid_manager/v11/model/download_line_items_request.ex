...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.DownloadLineItemsRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadLineItemsRequest do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.DownloadLineItemsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.DownloadLineItemsRequest do
