...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.RowStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.RowStatus do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.RowStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.RowStatus do
