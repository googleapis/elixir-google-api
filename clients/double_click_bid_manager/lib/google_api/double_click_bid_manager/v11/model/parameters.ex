...
defmodule GoogleApi.DoubleClickBidManager.V11.Model.Parameters do
  @moduledoc """
  Parameters of a query or report.

  ## Attributes

  *   `filters` (*type:* `list(GoogleApi.DoubleClickBidManager.V11.Model.FilterPair.t)`, *default:* `nil`) - Filters used to match traffic data in your report.
...
defimpl Poison.Decoder, for: GoogleApi.DoubleClickBidManager.V11.Model.Parameters do
  def decode(value, options) do
    GoogleApi.DoubleClickBidManager.V11.Model.Parameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DoubleClickBidManager.V11.Model.Parameters do
