...
defmodule GoogleApi.Storage.V1.Model.BucketEncryption do
  ...
  - defaultKmsKeyName (String.t): A Cloud KMS key that will be used to encrypt objects inserted into this bucket, if no encryption method is specified. Defaults to `nil`.
  """
