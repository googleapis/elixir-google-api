...
defmodule GoogleApi.Storage.V1.Model.BucketEncryption do
  ...
  *   `defaultKmsKeyName` (*type:* `String.t`, *default:* `nil`) - A Cloud KMS key that will be used to encrypt objects inserted into this bucket, if no encryption method is specified.
  """
