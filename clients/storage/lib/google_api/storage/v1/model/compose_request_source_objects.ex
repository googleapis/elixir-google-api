...
defmodule GoogleApi.Storage.V1.Model.ComposeRequestSourceObjects do
  ...
  - generation (String.t): The generation of this object to use as the source. Defaults to `nil`.
  - name (String.t): The source object's name. All source objects must reside in the same bucket. Defaults to `nil`.
  - objectPreconditions (GoogleApi.Storage.V1.Model.ComposeRequestSourceObjectsObjectPreconditions.t): Conditions that must be met for this operation to execute. Defaults to `nil`.
  """
