...
defmodule GoogleApi.Storage.V1.Model.BucketLifecycleRule do
  ...
  - action (GoogleApi.Storage.V1.Model.BucketLifecycleRuleAction.t): The action to take. Defaults to `nil`.
  - condition (GoogleApi.Storage.V1.Model.BucketLifecycleRuleCondition.t): The condition(s) under which the action will be taken. Defaults to `nil`.
  """
