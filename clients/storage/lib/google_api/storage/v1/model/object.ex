...
defimpl Poison.Decoder, for: GoogleApi.Storage.V1.Model.Object do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"customerEncryption", :struct, GoogleApi.Storage.V1.Model.Object_customerEncryption, options)
    |> deserialize(:"owner", :struct, GoogleApi.Storage.V1.Model.Object_owner, options)
  end
end
