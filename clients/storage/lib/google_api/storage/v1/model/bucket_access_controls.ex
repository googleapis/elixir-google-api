...
defmodule GoogleApi.Storage.V1.Model.BucketAccessControls do
  ...
  - items (list(GoogleApi.Storage.V1.Model.BucketAccessControl.t)): The list of items. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For lists of bucket access control entries, this is always storage#bucketAccessControls. Defaults to `storage#bucketAccessControls`.
  """
