...
defmodule GoogleApi.Storage.V1.Model.BucketLogging do
  ...
  - logBucket (String.t): The destination bucket where the current bucket's logs should be placed. Defaults to `nil`.
  - logObjectPrefix (String.t): A prefix for log object names. Defaults to `nil`.
  """
