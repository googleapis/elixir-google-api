...
defmodule GoogleApi.Storage.V1.Model.Objects do
  ...
  - items (list(GoogleApi.Storage.V1.Model.Object.t)): The list of items. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For lists of objects, this is always storage#objects. Defaults to `storage#objects`.
  ...
  - prefixes (list(String.t)): The list of prefixes of objects matching-but-not-listed up to and including the requested delimiter. Defaults to `nil`.
  """
