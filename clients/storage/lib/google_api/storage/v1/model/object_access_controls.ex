...
defmodule GoogleApi.Storage.V1.Model.ObjectAccessControls do
  ...
  - items (list(GoogleApi.Storage.V1.Model.ObjectAccessControl.t)): The list of items. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For lists of object access control entries, this is always storage#objectAccessControls. Defaults to `storage#objectAccessControls`.
  """
