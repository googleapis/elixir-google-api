...
defmodule GoogleApi.Storage.V1.Model.GoogleLongrunningOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Storage.V1.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.Storage.V1.Model.GoogleLongrunningOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Storage.V1.Model.GoogleLongrunningOperation do
