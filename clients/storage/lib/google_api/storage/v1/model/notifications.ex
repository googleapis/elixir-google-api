...
defmodule GoogleApi.Storage.V1.Model.Notifications do
  ...
  - items (list(GoogleApi.Storage.V1.Model.Notification.t)): The list of items. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For lists of notifications, this is always storage#notifications. Defaults to `storage#notifications`.
  """
