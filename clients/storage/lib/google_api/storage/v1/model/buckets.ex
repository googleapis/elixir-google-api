...
defmodule GoogleApi.Storage.V1.Model.Buckets do
  ...
  - items (list(GoogleApi.Storage.V1.Model.Bucket.t)): The list of items. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For lists of buckets, this is always storage#buckets. Defaults to `storage#buckets`.
