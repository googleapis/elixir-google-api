...
defmodule GoogleApi.Storage.V1.Model.Policy do
  ...
  - bindings (list(GoogleApi.Storage.V1.Model.PolicyBindings.t)): An association between a role, which comes with a set of permissions, and members who may assume that role. Defaults to `nil`.
  - etag (String.t): HTTP 1.1  Entity tag for the policy. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For policies, this is always storage#policy. This field is ignored on input. Defaults to `storage#policy`.
  - resourceId (String.t): The ID of the resource to which this policy belongs. Will be of the form projects/_/buckets/bucket for buckets, and projects/_/buckets/bucket/objects/object for objects. A specific generation may be specified by appending #generationNumber to the end of the object name, e.g. projects/_/buckets/my-bucket/objects/data.txt#17. The current generation can be denoted with #0. This field is ignored on input. Defaults to `nil`.
  """
