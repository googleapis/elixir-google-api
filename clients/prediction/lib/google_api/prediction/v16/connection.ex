...
defmodule GoogleApi.Prediction.V16.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.Prediction.V16.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://www.googleapis.com/prediction/v1.6/projects"
