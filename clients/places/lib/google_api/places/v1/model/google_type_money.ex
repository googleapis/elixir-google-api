...
defmodule GoogleApi.Places.V1.Model.GoogleTypeMoney do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Places.V1.Model.GoogleTypeMoney do
  def decode(value, options) do
    GoogleApi.Places.V1.Model.GoogleTypeMoney.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Places.V1.Model.GoogleTypeMoney do
