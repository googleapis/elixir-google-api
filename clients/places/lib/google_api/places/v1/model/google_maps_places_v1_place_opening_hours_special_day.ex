...
defmodule GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlaceOpeningHoursSpecialDay do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlaceOpeningHoursSpecialDay do
  def decode(value, options) do
    GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlaceOpeningHoursSpecialDay.decode(value, options)
  end
end
