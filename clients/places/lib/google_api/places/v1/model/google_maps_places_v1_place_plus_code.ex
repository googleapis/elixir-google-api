...
defmodule GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlacePlusCode do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlacePlusCode do
  def decode(value, options) do
    GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlacePlusCode.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Places.V1.Model.GoogleMapsPlacesV1PlacePlusCode do
