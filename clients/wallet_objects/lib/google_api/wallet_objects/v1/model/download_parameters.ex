...
defmodule GoogleApi.WalletObjects.V1.Model.DownloadParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.DownloadParameters do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.DownloadParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.DownloadParameters do
