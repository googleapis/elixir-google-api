...
defmodule GoogleApi.WalletObjects.V1.Model.FlightObject do
  @moduledoc """
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Deprecated
  ...
  @type t :: %__MODULE__{
          ...
          :boardingAndSeatingInfo =>
            GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingInfo.t() | nil,
          :classId => String.t() | nil,
          :classReference => GoogleApi.WalletObjects.V1.Model.FlightClass.t() | nil,
  ...
  field(:boardingAndSeatingInfo, as: GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingInfo)
  field(:classId)
  field(:classReference, as: GoogleApi.WalletObjects.V1.Model.FlightClass)
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.FlightObject do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.FlightObject.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.FlightObject do
