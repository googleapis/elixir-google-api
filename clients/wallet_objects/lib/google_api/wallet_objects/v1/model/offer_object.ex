...
defmodule GoogleApi.WalletObjects.V1.Model.OfferObject do
  @moduledoc """
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Deprecated
  ...
  @type t :: %__MODULE__{
          ...
          :classReference => GoogleApi.WalletObjects.V1.Model.OfferClass.t() | nil,
  ...
  field(:classId)
  field(:classReference, as: GoogleApi.WalletObjects.V1.Model.OfferClass)
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.OfferObject do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.OfferObject.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.OfferObject do
