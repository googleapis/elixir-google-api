...
defmodule GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingPolicy do
  @moduledoc """
  ...
  *   `seatClassPolicy` (*type:* `String.t`, *default:* `nil`) - Seating policy which dictates how we display the seat class. If unset, Google will default to `cabinBased`.
  ...
  field(:kind)
  field(:seatClassPolicy)
end

defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingPolicy do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.BoardingAndSeatingPolicy do
