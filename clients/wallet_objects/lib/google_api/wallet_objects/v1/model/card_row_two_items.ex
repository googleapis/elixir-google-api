...
defmodule GoogleApi.WalletObjects.V1.Model.CardRowTwoItems do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.CardRowTwoItems do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.CardRowTwoItems.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.CardRowTwoItems do
