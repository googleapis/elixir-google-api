...
defmodule GoogleApi.WalletObjects.V1.Model.DiffVersionResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.DiffVersionResponse do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.DiffVersionResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.DiffVersionResponse do
