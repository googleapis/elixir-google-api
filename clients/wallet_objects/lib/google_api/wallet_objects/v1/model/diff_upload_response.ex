...
defmodule GoogleApi.WalletObjects.V1.Model.DiffUploadResponse do
  @moduledoc """
  ...
  *   `originalObject` (*type:* `GoogleApi.WalletObjects.V1.Model.CompositeMedia.t`, *default:* `nil`) - The location of the original file for a diff upload request. Must be filled in if responding to an upload start notification.
  ...
  field(:objectVersion)
  field(:originalObject, as: GoogleApi.WalletObjects.V1.Model.CompositeMedia)
end

defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.DiffUploadResponse do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.DiffUploadResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.DiffUploadResponse do
