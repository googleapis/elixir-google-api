...
defmodule GoogleApi.WalletObjects.V1.Model.LabelValue do
  @moduledoc """
  ...
  *   `value` (*type:* `String.t`, *default:* `nil`) - The value for a specific row and column. Recommended maximum is 15 characters for a two-column layout and 30 characters for a one-column layout.
  ...
  field(:localizedValue, as: GoogleApi.WalletObjects.V1.Model.LocalizedString)
  field(:value)
end

defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.LabelValue do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.LabelValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.LabelValue do
