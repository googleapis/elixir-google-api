...
defmodule GoogleApi.WalletObjects.V1.Model.EventReservationInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WalletObjects.V1.Model.EventReservationInfo do
  def decode(value, options) do
    GoogleApi.WalletObjects.V1.Model.EventReservationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WalletObjects.V1.Model.EventReservationInfo do
