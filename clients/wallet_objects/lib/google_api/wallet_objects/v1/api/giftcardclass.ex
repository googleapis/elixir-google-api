...
defmodule GoogleApi.WalletObjects.V1.Api.Giftcardclass do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec walletobjects_giftcardclass_addmessage(
          ...
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_addmessage(
        connection,
        resource_id,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/walletobjects/v1/giftCardClass/{resourceId}/addMessage", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.WalletObjects.V1.Model.GiftCardClassAddMessageResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec walletobjects_giftcardclass_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.WalletObjects.V1.Model.GiftCardClass.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_get(connection, resource_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/walletobjects/v1/giftCardClass/{resourceId}", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.WalletObjects.V1.Model.GiftCardClass{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  @spec walletobjects_giftcardclass_insert(Tesla.Env.client(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_insert(connection, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/walletobjects/v1/giftCardClass", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  @spec walletobjects_giftcardclass_list(Tesla.Env.client(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_list(connection, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.WalletObjects.V1.Model.GiftCardClassListResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec walletobjects_giftcardclass_patch(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.WalletObjects.V1.Model.GiftCardClass.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_patch(
        connection,
        resource_id,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec walletobjects_giftcardclass_update(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.WalletObjects.V1.Model.GiftCardClass.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def walletobjects_giftcardclass_update(
        connection,
        resource_id,
        optional_params \\ [],
        opts \\ []
