...
defmodule GoogleApi.Books.V1.Model.Annotations do
  ...
  - items ([Annotation]): A list of annotations. Defaults to: `null`.
  ...
  - totalItems (integer()): Total number of annotations found. This may be greater than the number of notes returned in this response if results have been paginated. Defaults to: `null`.
  """
