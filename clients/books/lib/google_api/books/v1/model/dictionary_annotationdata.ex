...
defmodule GoogleApi.Books.V1.Model.DictionaryAnnotationdata do
  @moduledoc """
  ...
  *   `volumeId` (*type:* `String.t`, *default:* `nil`) - The volume id for this data. *
  ...
  field(:data, as: GoogleApi.Books.V1.Model.Dictlayerdata)
  field(:encodedData)
  field(:id)
  field(:kind)
  field(:layerId)
...
defimpl Poison.Decoder, for: GoogleApi.Books.V1.Model.DictionaryAnnotationdata do
  def decode(value, options) do
    GoogleApi.Books.V1.Model.DictionaryAnnotationdata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Books.V1.Model.DictionaryAnnotationdata do
