...
defmodule GoogleApi.Books.V1.Model.VolumeAccessInfo do
  ...
  *   `accessViewStatus` (*type:* `String.t`, *default:* `nil`) - Combines the access and viewability of this volume into a single status
      field for this user. Values can be FULL_PURCHASED, FULL_PUBLIC_DOMAIN,
      SAMPLE or NONE. (In LITE projection.)
  *   `country` (*type:* `String.t`, *default:* `nil`) - The two-letter ISO_3166-1 country code for which this access information
  ...
  *   `driveImportedContentLink` (*type:* `String.t`, *default:* `nil`) - URL to the Google Drive viewer if this volume is uploaded by the user by
      selecting the file from Google Drive.
  *   `embeddable` (*type:* `boolean()`, *default:* `nil`) - Whether this volume can be embedded in a viewport using the Embedded
      Viewer API.
  *   `epub` (*type:* `GoogleApi.Books.V1.Model.VolumeAccessInfoEpub.t`, *default:* `nil`) - Information about epub content. (In LITE projection.)
  *   `explicitOfflineLicenseManagement` (*type:* `boolean()`, *default:* `nil`) - Whether this volume requires that the client explicitly request offline
  ...
  *   `textToSpeechPermission` (*type:* `String.t`, *default:* `nil`) - Whether text-to-speech is permitted for this volume. Values can be
      ALLOWED, ALLOWED_FOR_ACCESSIBILITY, or NOT_ALLOWED.
  *   `viewOrderUrl` (*type:* `String.t`, *default:* `nil`) - For ordered but not yet processed orders, we give a URL that can be used
      to go to the appropriate Google Wallet page.
  *   `viewability` (*type:* `String.t`, *default:* `nil`) - The read access of a volume. Possible values are PARTIAL, ALL_PAGES,
      ...
      ALL_PAGES.
  *   `webReaderLink` (*type:* `String.t`, *default:* `nil`) - URL to read this volume on the Google Books site. Link will not allow
