...
defmodule GoogleApi.Books.V1.Model.GeolayerdataGeo do
  ...
  *   `boundary` (*type:* `list(String.t)`, *default:* `nil`) - The boundary of the location as a set of loops containing pairs of
      latitude, longitude coordinates.
  *   `cachePolicy` (*type:* `String.t`, *default:* `nil`) - The cache policy active for this data. EX: UNRESTRICTED, RESTRICTED,
      NEVER
  ...
  *   `mapType` (*type:* `String.t`, *default:* `nil`) - The type of map that should be used for this location. EX: HYBRID,
      ROADMAP, SATELLITE, TERRAIN
  *   `viewport` (*type:* `GoogleApi.Books.V1.Model.GeolayerdataGeoViewport.t`, *default:* `nil`) - The viewport for showing this location. This is a latitude, longitude
      rectangle.
  *   `zoom` (*type:* `integer()`, *default:* `nil`) - The Zoom level to use for the map. Zoom levels between 0 (the lowest zoom
