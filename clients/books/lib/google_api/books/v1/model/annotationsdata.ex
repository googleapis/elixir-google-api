...
defmodule GoogleApi.Books.V1.Model.Annotationsdata do
  @moduledoc """


  ## Attributes

  - items ([Annotationdata]): A list of Annotation Data. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Books.V1.Model.Annotationsdata do
  def decode(value, options) do
    GoogleApi.Books.V1.Model.Annotationsdata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Books.V1.Model.Annotationsdata do
