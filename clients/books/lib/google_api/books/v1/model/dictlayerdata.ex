...
defimpl Poison.Decoder, for: GoogleApi.Books.V1.Model.Dictlayerdata do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"common", :struct, GoogleApi.Books.V1.Model.Dictlayerdata_common, options)
    |> deserialize(:"dict", :struct, GoogleApi.Books.V1.Model.Dictlayerdata_dict, options)
  end
end
