...
defmodule GoogleApi.Books.V1.Model.DictlayerdataDictWordsSensesDefinitionsExamples do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Books.V1.Model.DictlayerdataDictWordsSensesDefinitionsExamples do
  def decode(value, options) do
    GoogleApi.Books.V1.Model.DictlayerdataDictWordsSensesDefinitionsExamples.decode(
      value,
      options
    )
  end
