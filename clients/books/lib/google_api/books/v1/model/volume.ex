...
defmodule GoogleApi.Books.V1.Model.Volume do
  ...
  *   `accessInfo` (*type:* `GoogleApi.Books.V1.Model.VolumeAccessInfo.t`, *default:* `nil`) - Any information about a volume related to reading or obtaining that volume
      text. This information can depend on country (books may be public domain in
      one country but not in another, e.g.).
  *   `etag` (*type:* `String.t`, *default:* `nil`) - Opaque identifier for a specific version of a volume resource. (In LITE
      projection)
  *   `id` (*type:* `String.t`, *default:* `nil`) - Unique identifier for a volume. (In LITE projection.)
  *   `kind` (*type:* `String.t`, *default:* `nil`) - Resource type for a volume. (In LITE projection.)
  ...
  *   `saleInfo` (*type:* `GoogleApi.Books.V1.Model.VolumeSaleInfo.t`, *default:* `nil`) - Any information about a volume related to the eBookstore and/or
  ...
  *   `userInfo` (*type:* `GoogleApi.Books.V1.Model.VolumeUserInfo.t`, *default:* `nil`) - User specific information related to this volume. (e.g. page this user last
