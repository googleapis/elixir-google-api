...
defmodule GoogleApi.Books.V1.Api.Personalizedstream do
  ...
  """
  @spec books_personalizedstream_get(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Books.V1.Model.Discoveryclusters.t} | {:error, Tesla.Env.t}
  def books_personalizedstream_get(connection, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/personalizedstream/get")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Books.V1.Model.Discoveryclusters{})
  end
end
