...
defimpl Poison.Decoder, for: GoogleApi.Dataform.V1beta1.Model.Notebook do
  def decode(value, options) do
    GoogleApi.Dataform.V1beta1.Model.Notebook.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataform.V1beta1.Model.Notebook do
