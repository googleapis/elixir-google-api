...
defmodule GoogleApi.Dataform.V1beta1.Model.CommitMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataform.V1beta1.Model.CommitMetadata do
  def decode(value, options) do
    GoogleApi.Dataform.V1beta1.Model.CommitMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataform.V1beta1.Model.CommitMetadata do
