...
defmodule GoogleApi.BigtableAdmin.V2.Model.UpdateAuthorizedViewMetadata do
  @moduledoc """
  ...
  *   `requestTime` (*type:* `DateTime.t`, *default:* `nil`) - The time at which the original request was received.
  ...
  field(:originalRequest, as: GoogleApi.BigtableAdmin.V2.Model.UpdateAuthorizedViewRequest)
  field(:requestTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.BigtableAdmin.V2.Model.UpdateAuthorizedViewMetadata do
  def decode(value, options) do
    GoogleApi.BigtableAdmin.V2.Model.UpdateAuthorizedViewMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigtableAdmin.V2.Model.UpdateAuthorizedViewMetadata do
