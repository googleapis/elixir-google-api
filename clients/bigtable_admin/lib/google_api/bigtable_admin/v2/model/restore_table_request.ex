...
defimpl Poison.Decoder, for: GoogleApi.BigtableAdmin.V2.Model.RestoreTableRequest do
  def decode(value, options) do
    GoogleApi.BigtableAdmin.V2.Model.RestoreTableRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigtableAdmin.V2.Model.RestoreTableRequest do
