...
defmodule GoogleApi.BigtableAdmin.V2.Model.CreateClusterRequest do
  ...
  *   `cluster` (*type:* `GoogleApi.BigtableAdmin.V2.Model.Cluster.t`, *default:* `nil`) - Required. The cluster to be created.
      Fields marked `OutputOnly` must be left blank.
  *   `clusterId` (*type:* `String.t`, *default:* `nil`) - Required. The ID to be used when referring to the new cluster within its instance,
      e.g., just `mycluster` rather than
      `projects/myproject/instances/myinstance/clusters/mycluster`.
  *   `parent` (*type:* `String.t`, *default:* `nil`) - Required. The unique name of the instance in which to create the new cluster.
