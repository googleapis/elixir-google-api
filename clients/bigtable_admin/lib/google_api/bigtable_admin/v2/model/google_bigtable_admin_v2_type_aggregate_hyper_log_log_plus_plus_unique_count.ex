...
defmodule GoogleApi.BigtableAdmin.V2.Model.GoogleBigtableAdminV2TypeAggregateHyperLogLogPlusPlusUniqueCount do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BigtableAdmin.V2.Model.GoogleBigtableAdminV2TypeAggregateHyperLogLogPlusPlusUniqueCount do
  def decode(value, options) do
    GoogleApi.BigtableAdmin.V2.Model.GoogleBigtableAdminV2TypeAggregateHyperLogLogPlusPlusUniqueCount.decode(
      value,
      options
    )
  end
