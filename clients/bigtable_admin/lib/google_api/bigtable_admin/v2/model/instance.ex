...
defmodule GoogleApi.BigtableAdmin.V2.Model.Instance do
  ...
  *   `createTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. A commit timestamp representing when this Instance was created. For instances created before this field was added (August 2021), this value is `seconds: 0, nanos: 1`.
