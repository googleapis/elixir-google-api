...
defmodule GoogleApi.BigtableAdmin.V2.Api.Operations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec bigtableadmin_operations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def bigtableadmin_operations_get(connection, name, optional_params \\ [], opts \\ []) do
  ...
  *   `{:ok, %GoogleApi.BigtableAdmin.V2.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec bigtableadmin_operations_projects_operations_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def bigtableadmin_operations_projects_operations_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.BigtableAdmin.V2.Model.ListOperationsResponse{}]
    )
  end
end
