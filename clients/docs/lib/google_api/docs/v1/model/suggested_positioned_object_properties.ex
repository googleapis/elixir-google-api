...
defmodule GoogleApi.Docs.V1.Model.SuggestedPositionedObjectProperties do
  @moduledoc """
  ...
  *   `positionedObjectPropertiesSuggestionState` (*type:* `GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState.t`, *default:* `nil`) - A mask that indicates which of the fields on the base PositionedObjectProperties have been changed in this suggestion.
  ...
  field(:positionedObjectPropertiesSuggestionState,
    as: GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState
  )
end

defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.SuggestedPositionedObjectProperties do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.SuggestedPositionedObjectProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.SuggestedPositionedObjectProperties do
