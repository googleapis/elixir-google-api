...
defmodule GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState do
  ...
  *   `positioningSuggestionState` (*type:* `GoogleApi.Docs.V1.Model.PositionedObjectPositioningSuggestionState.t`, *default:* `nil`) - A mask that indicates which of the fields in positioning have been changed in this suggestion.
  ...
  field(:positioningSuggestionState,
    as: GoogleApi.Docs.V1.Model.PositionedObjectPositioningSuggestionState
  )
end

defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.PositionedObjectPropertiesSuggestionState do
