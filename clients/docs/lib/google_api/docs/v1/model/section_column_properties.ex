...
defmodule GoogleApi.Docs.V1.Model.SectionColumnProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.SectionColumnProperties do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.SectionColumnProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.SectionColumnProperties do
