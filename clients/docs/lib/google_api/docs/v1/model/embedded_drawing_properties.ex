...
defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.EmbeddedDrawingProperties do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.EmbeddedDrawingProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.EmbeddedDrawingProperties do
