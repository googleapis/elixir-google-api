...
defmodule GoogleApi.Docs.V1.Model.Document do
  ...
  *   `revisionId` (*type:* `String.t`, *default:* `nil`) - Output only. The revision ID of the document. Can be used in update
  ...
  *   `suggestedDocumentStyleChanges` (*type:* `%{optional(String.t) => GoogleApi.Docs.V1.Model.SuggestedDocumentStyle.t}`, *default:* `nil`) - Output only. The suggested changes to the style of the document, keyed by
      suggestion ID.
  *   `suggestedNamedStylesChanges` (*type:* `%{optional(String.t) => GoogleApi.Docs.V1.Model.SuggestedNamedStyles.t}`, *default:* `nil`) - Output only. The suggested changes to the named styles of the document,
      keyed by suggestion ID.
  *   `suggestionsViewMode` (*type:* `String.t`, *default:* `nil`) - Output only. The suggestions view mode applied to the document.
