...
defmodule GoogleApi.Docs.V1.Model.InsertInlineImageRequest do
  ...
  *   `endOfSegmentLocation` (*type:* `GoogleApi.Docs.V1.Model.EndOfSegmentLocation.t`, *default:* `nil`) - Inserts the text at the end of a header, footer or the document body.

      Inline images cannot be inserted inside a footnote.
  *   `location` (*type:* `GoogleApi.Docs.V1.Model.Location.t`, *default:* `nil`) - Inserts the image at a specific index in the document.
  ...
  *   `objectSize` (*type:* `GoogleApi.Docs.V1.Model.Size.t`, *default:* `nil`) - The size that the image should appear as in the document. This property is
  ...
  *   `uri` (*type:* `String.t`, *default:* `nil`) - The image URI.
