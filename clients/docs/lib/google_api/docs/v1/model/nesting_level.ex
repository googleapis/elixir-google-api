...
defmodule GoogleApi.Docs.V1.Model.NestingLevel do
  ...
  *   `bulletAlignment` (*type:* `String.t`, *default:* `nil`) - The alignment of the bullet within the space allotted for rendering the
      bullet.
  *   `glyphFormat` (*type:* `String.t`, *default:* `nil`) - The format string used by bullets at this level of nesting.
  ...
  *   `glyphSymbol` (*type:* `String.t`, *default:* `nil`) - A custom glyph symbol used by bullets when paragraphs at this level of
  ...
  *   `glyphType` (*type:* `String.t`, *default:* `nil`) - The type of glyph used by bullets when paragraphs at this level of
      nesting are ordered.
  ...
  *   `indentFirstLine` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of indentation for the first line of paragraphs at this level of
      nesting.
  *   `indentStart` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of indentation for paragraphs at this level of nesting. Applied
      to the side that corresponds to the start of the text, based on the
      paragraph's content direction.
  *   `startNumber` (*type:* `integer()`, *default:* `nil`) - The number of the first list item at this nesting level.
