...
defmodule GoogleApi.Docs.V1.Model.ParagraphStyle do
  ...
  *   `avoidWidowAndOrphan` (*type:* `boolean()`, *default:* `nil`) - Whether to avoid widows and orphans for the paragraph. If unset, the value
      is inherited from the parent.
  *   `borderBetween` (*type:* `GoogleApi.Docs.V1.Model.ParagraphBorder.t`, *default:* `nil`) - The border between this paragraph and the next and previous paragraphs.
      ...
      its entirety.
  *   `borderBottom` (*type:* `GoogleApi.Docs.V1.Model.ParagraphBorder.t`, *default:* `nil`) - The border at the bottom of this paragraph. If unset, the value is
      ...
      changes to a paragraph border the new border must be specified in
      its entirety.
  *   `borderLeft` (*type:* `GoogleApi.Docs.V1.Model.ParagraphBorder.t`, *default:* `nil`) - The border to the left of this paragraph. If unset, the value is inherited
      from the parent.

      Paragraph borders cannot be partially updated. When making
      changes to a paragraph border the new border must be specified in
      its entirety.
  *   `borderRight` (*type:* `GoogleApi.Docs.V1.Model.ParagraphBorder.t`, *default:* `nil`) - The border to the right of this paragraph. If unset, the value is inherited
      from the parent.

      Paragraph borders cannot be partially updated. When making
      changes to a paragraph border the new border must be specified in
      its entirety.
  *   `borderTop` (*type:* `GoogleApi.Docs.V1.Model.ParagraphBorder.t`, *default:* `nil`) - The border at the top of this paragraph. If unset, the value is inherited
      from the parent.
  ...
  *   `headingId` (*type:* `String.t`, *default:* `nil`) - The heading ID of the paragraph. If empty, then this paragraph is not a
      heading.

      This property is read-only.
  *   `indentEnd` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of indentation for the paragraph on the side that corresponds to
      the end of the text, based on the current paragraph direction. If unset,
      the value is inherited from the parent.
  *   `indentFirstLine` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of indentation for the first line of the paragraph. If unset,
      the value is inherited from the parent.
  *   `indentStart` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of indentation for the paragraph on the side that corresponds to
      the start of the text, based on the current paragraph direction. If unset,
      the value is inherited from the parent.
  *   `keepLinesTogether` (*type:* `boolean()`, *default:* `nil`) - Whether all lines of the paragraph should be laid out on the same page or
      column if possible. If unset, the value is inherited from the parent.
  *   `keepWithNext` (*type:* `boolean()`, *default:* `nil`) - Whether at least a part of this paragraph should be laid out on the same
  ...
  *   `namedStyleType` (*type:* `String.t`, *default:* `nil`) - The named style type of the paragraph.
      ...
      are updated.
  *   `shading` (*type:* `GoogleApi.Docs.V1.Model.Shading.t`, *default:* `nil`) - The shading of the paragraph. If unset, the value is inherited from the
      parent.
  *   `spaceAbove` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of extra space above the paragraph. If unset, the value is
      inherited from the parent.
  *   `spaceBelow` (*type:* `GoogleApi.Docs.V1.Model.Dimension.t`, *default:* `nil`) - The amount of extra space below the paragraph. If unset, the value is
      inherited from the parent.
  *   `spacingMode` (*type:* `String.t`, *default:* `nil`) - The spacing mode for the paragraph.
  *   `tabStops` (*type:* `list(GoogleApi.Docs.V1.Model.TabStop.t)`, *default:* `nil`) - A list of the tab stops for this paragraph. The list of tab stops is not
      inherited.
