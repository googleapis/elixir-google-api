...
defmodule GoogleApi.Docs.V1.Model.Paragraph do
  ...
  *   `bullet` (*type:* `GoogleApi.Docs.V1.Model.Bullet.t`, *default:* `nil`) - The bullet for this paragraph. If not present, the paragraph does not
      belong to a list.
  ...
  *   `suggestedParagraphStyleChanges` (*type:* `%{optional(String.t) => GoogleApi.Docs.V1.Model.SuggestedParagraphStyle.t}`, *default:* `nil`) - The suggested paragraph style changes to this paragraph, keyed by
      suggestion ID.
  *   `suggestedPositionedObjectIds` (*type:* `%{optional(String.t) => GoogleApi.Docs.V1.Model.ObjectReferences.t}`, *default:* `nil`) - The IDs of the positioned objects that are suggested to be attached to this
