...
defmodule GoogleApi.Docs.V1.Model.HorizontalRule do
  @moduledoc """
  ...
  *   `suggestedDeletionIds` (*type:* `list(String.t)`, *default:* `nil`) - The suggested deletion IDs. If empty, then there are no suggested deletions
      of this content.
  *   `suggestedInsertionIds` (*type:* `list(String.t)`, *default:* `nil`) - The suggested insertion IDs. A HorizontalRule may have multiple insertion IDs if it
      is a nested suggested change. If empty, then this is not a suggested
      insertion.
  *   `suggestedTextStyleChanges` (*type:* `%{optional(String.t) => GoogleApi.Docs.V1.Model.SuggestedTextStyle.t}`, *default:* `nil`) - The suggested text style changes to this HorizontalRule, keyed by
      suggestion ID.
  *   `textStyle` (*type:* `GoogleApi.Docs.V1.Model.TextStyle.t`, *default:* `nil`) - The text style of this HorizontalRule.
...
defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.HorizontalRule do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.HorizontalRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.HorizontalRule do
