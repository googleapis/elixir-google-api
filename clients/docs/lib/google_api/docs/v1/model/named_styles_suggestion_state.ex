...
defmodule GoogleApi.Docs.V1.Model.NamedStylesSuggestionState do
  ...
  *   `stylesSuggestionStates` (*type:* `list(GoogleApi.Docs.V1.Model.NamedStyleSuggestionState.t)`, *default:* `nil`) - A mask that indicates which of the fields on the corresponding NamedStyle in styles have been changed in this suggestion. The order of these named style suggestion states matches the order of the corresponding named style within the named styles suggestion.
  ...
  field(:stylesSuggestionStates,
    as: GoogleApi.Docs.V1.Model.NamedStyleSuggestionState,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.NamedStylesSuggestionState do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.NamedStylesSuggestionState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.NamedStylesSuggestionState do
