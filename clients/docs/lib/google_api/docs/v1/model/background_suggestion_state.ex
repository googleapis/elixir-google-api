...
defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.BackgroundSuggestionState do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.BackgroundSuggestionState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.BackgroundSuggestionState do
