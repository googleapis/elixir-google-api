...
defmodule GoogleApi.Docs.V1.Model.EmbeddedObjectBorder do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Docs.V1.Model.EmbeddedObjectBorder do
  def decode(value, options) do
    GoogleApi.Docs.V1.Model.EmbeddedObjectBorder.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Docs.V1.Model.EmbeddedObjectBorder do
