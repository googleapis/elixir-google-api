...
defmodule GoogleApi.Docs.V1.Model.DocumentStyle do
  ...
  *   `background` (*type:* `GoogleApi.Docs.V1.Model.Background.t`, *default:* `nil`) - The background of the document. Documents cannot have a transparent
      background color.
  ...
  *   `defaultHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the default header. If not set, there is no default header.
      ...
      This property is read-only.
  *   `evenPageFooterId` (*type:* `String.t`, *default:* `nil`) - The ID of the footer used only for even pages. The value of
      ...
      This property is read-only.
  *   `evenPageHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the header used only for even pages. The value of
      use_even_page_header_footer determines
      whether to use the default_header_id or this value for the
      header on even pages. If not set, there is no even page header.

      This property is read-only.
  *   `firstPageFooterId` (*type:* `String.t`, *default:* `nil`) - The ID of the footer used only for the first page. If not set then
      ...
      This property is read-only.
  *   `firstPageHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the header used only for the first page. If not set then
