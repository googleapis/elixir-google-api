...
defmodule GoogleApi.Docs.V1.Model.DocumentStyle do
  ...
  *   `defaultFooterId` (*type:* `String.t`, *default:* `nil`) - The ID of the default footer. If not set, there is no default footer. This property is read-only.
  *   `defaultHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the default header. If not set, there is no default header. This property is read-only.
  *   `evenPageFooterId` (*type:* `String.t`, *default:* `nil`) - The ID of the footer used only for even pages. The value of use_even_page_header_footer determines whether to use the default_footer_id or this value for the footer on even pages. If not set, there is no even page footer. This property is read-only.
  *   `evenPageHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the header used only for even pages. The value of use_even_page_header_footer determines whether to use the default_header_id or this value for the header on even pages. If not set, there is no even page header. This property is read-only.
  ...
  *   `firstPageHeaderId` (*type:* `String.t`, *default:* `nil`) - The ID of the header used only for the first page. If not set then a unique header for the first page does not exist. The value of use_first_page_header_footer determines whether to use the default_header_id or this value for the header on the first page. If not set, there is no first page header. This property is read-only.
