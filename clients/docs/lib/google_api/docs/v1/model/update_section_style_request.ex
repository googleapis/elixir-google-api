...
defmodule GoogleApi.Docs.V1.Model.UpdateSectionStyleRequest do
  ...
  *   `range` (*type:* `GoogleApi.Docs.V1.Model.Range.t`, *default:* `nil`) - The range overlapping the sections to style.

      Because section breaks can only be inserted inside the body, the segment
      ID field must be empty.
  *   `sectionStyle` (*type:* `GoogleApi.Docs.V1.Model.SectionStyle.t`, *default:* `nil`) - The styles to  be set on the section.
