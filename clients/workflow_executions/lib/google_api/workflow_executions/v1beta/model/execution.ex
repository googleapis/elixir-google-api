...
defmodule GoogleApi.WorkflowExecutions.V1beta.Model.Execution do
  ...
  *   `workflowRevisionId` (*type:* `String.t`, *default:* `nil`) - Output only. Revision of the workflow this execution is using.
  ...
  @type t :: %__MODULE__{
          ...
          :state => String.t() | nil,
          :status => GoogleApi.WorkflowExecutions.V1beta.Model.Status.t() | nil,
  ...
  field(:state)
  field(:status, as: GoogleApi.WorkflowExecutions.V1beta.Model.Status)
