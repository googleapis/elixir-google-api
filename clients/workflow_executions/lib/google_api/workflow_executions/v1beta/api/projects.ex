...
defmodule GoogleApi.WorkflowExecutions.V1beta.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.WorkflowExecutions.V1beta.Connection
  ...
  *   `connection` (*type:* `GoogleApi.WorkflowExecutions.V1beta.Connection.t`) - Connection to server
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.WorkflowExecutions.V1beta.Model.CancelExecutionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.WorkflowExecutions.V1beta.Model.Execution{}}` on success
  *   `{:error, info}` on failure
  ...
  def workflowexecutions_projects_locations_workflows_executions_cancel(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.WorkflowExecutions.V1beta.Model.Execution{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.WorkflowExecutions.V1beta.Model.Execution.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def workflowexecutions_projects_locations_workflows_executions_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1beta/{+parent}/executions", %{
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:pageSize` (*type:* `integer()`) - Maximum number of executions to return per call. Max supported value depends on the selected Execution view: it's 10000 for BASIC and 100 for FULL. The default value used if the field is not specified is 100, regardless of the selected view. Values greater than the max value will be coerced down to it.
  ...
  *   `{:ok, %GoogleApi.WorkflowExecutions.V1beta.Model.ListExecutionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def workflowexecutions_projects_locations_workflows_executions_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.WorkflowExecutions.V1beta.Model.ListExecutionsResponse{}]
    )
  end
end
