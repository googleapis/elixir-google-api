...
defmodule GoogleApi.WorkflowExecutions.V1.Model.StepEntryMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WorkflowExecutions.V1.Model.StepEntryMetadata do
  def decode(value, options) do
    GoogleApi.WorkflowExecutions.V1.Model.StepEntryMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WorkflowExecutions.V1.Model.StepEntryMetadata do
