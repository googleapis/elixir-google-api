...
defmodule GoogleApi.WorkflowExecutions.V1.Model.PubsubMessage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WorkflowExecutions.V1.Model.PubsubMessage do
  def decode(value, options) do
    GoogleApi.WorkflowExecutions.V1.Model.PubsubMessage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WorkflowExecutions.V1.Model.PubsubMessage do
