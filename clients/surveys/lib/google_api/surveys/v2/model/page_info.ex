...
defmodule GoogleApi.Surveys.V2.Model.PageInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Surveys.V2.Model.PageInfo do
  def decode(value, options) do
    GoogleApi.Surveys.V2.Model.PageInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Surveys.V2.Model.PageInfo do
