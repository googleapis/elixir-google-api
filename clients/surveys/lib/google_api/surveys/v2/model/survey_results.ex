...
defmodule GoogleApi.Surveys.V2.Model.SurveyResults do
  ...
  - status (String.t): Human readable string describing the status of the request. Defaults to `nil`.
  - surveyUrlId (String.t): External survey ID as viewable by survey owners in the editor view. Defaults to `nil`.
  """
