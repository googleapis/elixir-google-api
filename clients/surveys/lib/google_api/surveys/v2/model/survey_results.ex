...
defmodule GoogleApi.Surveys.V2.Model.SurveyResults do
  ...
  *   `status` (*type:* `String.t`, *default:* `nil`) - Human readable string describing the status of the request.
  *   `surveyUrlId` (*type:* `String.t`, *default:* `nil`) - External survey ID as viewable by survey owners in the editor view.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Surveys.V2.Model.SurveyResults do
  def decode(value, options) do
    GoogleApi.Surveys.V2.Model.SurveyResults.decode(value, options)
  end
end
