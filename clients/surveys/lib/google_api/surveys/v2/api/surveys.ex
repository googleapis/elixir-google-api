...
defmodule GoogleApi.Surveys.V2.Api.Surveys do
  ...
  *   `connection` (*type:* `GoogleApi.Surveys.V2.Connection.t`) - Connection to server
  *   `survey_url_id` (*type:* `String.t`) - External URL ID for the survey.
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_delete(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.Surveys.V2.Model.Survey.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_insert(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.Surveys.V2.Model.Survey.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_list(Tesla.Env.client(), keyword(), keyword()) ::
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.Surveys.V2.Model.SurveysStartRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_start(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_stop(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec surveys_surveys_update(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Surveys.V2.Model.Survey.t()} | {:error, Tesla.Env.t()}
