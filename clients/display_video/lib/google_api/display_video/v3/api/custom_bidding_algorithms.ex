...
defmodule GoogleApi.DisplayVideo.V3.Api.CustomBiddingAlgorithms do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_custom_bidding_algorithms_create(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithm.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_create(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/customBiddingAlgorithms", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithm{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_custom_bidding_algorithms_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/customBiddingAlgorithms/{+customBiddingAlgorithmId}", %{
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_custom_bidding_algorithms_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingAlgorithmsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_list(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingAlgorithmsResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec displayvideo_custom_bidding_algorithms_upload_rules(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_upload_rules(
        connection,
        custom_bidding_algorithm_id,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadRules", %{
        "customBiddingAlgorithmId" =>
          URI.encode(custom_bidding_algorithm_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_custom_bidding_algorithms_upload_script(
          ...
          {:ok, GoogleApi.DisplayVideo.V3.Model.CustomBiddingScriptRef.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_upload_script(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/customBiddingAlgorithms/{+customBiddingAlgorithmId}:uploadScript", %{
        "customBiddingAlgorithmId" =>
          URI.encode(custom_bidding_algorithm_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CustomBiddingScriptRef{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec displayvideo_custom_bidding_algorithms_rules_create(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRules.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_rules_create(
        connection,
        custom_bidding_algorithm_id,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/customBiddingAlgorithms/{+customBiddingAlgorithmId}/rules", %{
        "customBiddingAlgorithmId" =>
          URI.encode(custom_bidding_algorithm_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRules{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec displayvideo_custom_bidding_algorithms_rules_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_rules_get(
        connection,
        custom_bidding_algorithm_id,
      ...
      |> Request.url(
        ...
        %{
          ...
          "customBiddingAlgorithmRulesId" =>
            URI.encode(custom_bidding_algorithm_rules_id, &URI.char_unreserved?/1)
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:pageSize` (*type:* `integer()`) - Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
      *   `:pageToken` (*type:* `String.t`) - A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListCustomBiddingAlgorithmRules` method. If not specified, the first page of results will be returned.
      *   `:partnerId` (*type:* `String.t`) - The ID of the partner that owns the parent custom bidding algorithm.
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec displayvideo_custom_bidding_algorithms_rules_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingAlgorithmRulesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_rules_list(
        connection,
        custom_bidding_algorithm_id,
        optional_params \\ [],
        opts \\ []
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingAlgorithmRulesResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_custom_bidding_algorithms_scripts_create(
          ...
          {:ok, GoogleApi.DisplayVideo.V3.Model.CustomBiddingScript.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_scripts_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/customBiddingAlgorithms/{+customBiddingAlgorithmId}/scripts", %{
        "customBiddingAlgorithmId" =>
          URI.encode(custom_bidding_algorithm_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CustomBiddingScript{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_custom_bidding_algorithms_scripts_list(
          ...
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingScriptsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_custom_bidding_algorithms_scripts_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListCustomBiddingScriptsResponse{}]
    )
  end
end
