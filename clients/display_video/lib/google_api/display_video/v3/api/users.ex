...
defmodule GoogleApi.DisplayVideo.V3.Api.Users do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V3.Model.BulkEditAssignedUserRolesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.BulkEditAssignedUserRolesResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_users_bulk_edit_assigned_user_roles(
          ...
          {:ok, GoogleApi.DisplayVideo.V3.Model.BulkEditAssignedUserRolesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_users_bulk_edit_assigned_user_roles(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/users/{+userId}:bulkEditAssignedUserRoles", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.BulkEditAssignedUserRolesResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V3.Model.User.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.User{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_users_create(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.User.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_users_create(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/users", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.User{}])
  end
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.ListUsersResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_users_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListUsersResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_users_list(connection, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListUsersResponse{}])
  end
