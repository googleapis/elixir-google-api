...
defmodule GoogleApi.DisplayVideo.V3.Api.Sdfdownloadtasks do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V3.Model.CreateSdfDownloadTaskRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_sdfdownloadtasks_create(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/sdfdownloadtasks", %{})
