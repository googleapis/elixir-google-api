...
defmodule GoogleApi.DisplayVideo.V3.Api.Partners do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V3.Model.BulkEditPartnerAssignedTargetingOptionsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.BulkEditPartnerAssignedTargetingOptionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_partners_edit_assigned_targeting_options(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          {:ok,
           GoogleApi.DisplayVideo.V3.Model.BulkEditPartnerAssignedTargetingOptionsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_partners_edit_assigned_targeting_options(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/partners/{+partnerId}:editAssignedTargetingOptions", %{
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.DisplayVideo.V3.Model.BulkEditPartnerAssignedTargetingOptionsResponse{}
        ]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.Partner{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_partners_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.Partner.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_partners_get(connection, partner_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/partners/{+partnerId}", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.Partner{}])
  end
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.ListPartnersResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_partners_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListPartnersResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_partners_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/partners", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListPartnersResponse{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/partners/{+partnerId}/channels", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/partners/{+partnerId}/channels/{+channelId}", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_sites_bulk_edit(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/partners/{partnerId}/channels/{+channelId}/sites:bulkEdit", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1),
        "channelId" => URI.encode(channel_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_sites_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/partners/{partnerId}/channels/{+channelId}/sites", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1),
        "channelId" => URI.encode(channel_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_sites_delete(
    ...
    request =
      ...
      |> Request.url("/v3/partners/{partnerId}/channels/{+channelId}/sites/{+urlOrAppId}", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1),
        "channelId" => URI.encode(channel_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def displayvideo_partners_channels_sites_replace(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/partners/{partnerId}/channels/{+channelId}/sites:replace", %{
        "partnerId" => URI.encode(partner_id, &URI.char_unreserved?/1),
        "channelId" => URI.encode(channel_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.ListPartnerAssignedTargetingOptionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_partners_targeting_types_assigned_targeting_options_list(
          ...
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListPartnerAssignedTargetingOptionsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_partners_targeting_types_assigned_targeting_options_list(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.DisplayVideo.V3.Model.ListPartnerAssignedTargetingOptionsResponse{}]
    )
  end
end
