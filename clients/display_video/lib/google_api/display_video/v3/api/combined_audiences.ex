...
defmodule GoogleApi.DisplayVideo.V3.Api.CombinedAudiences do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.CombinedAudience{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_combined_audiences_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.CombinedAudience.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_combined_audiences_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/combinedAudiences/{+combinedAudienceId}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.CombinedAudience{}])
  end
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V3.Model.ListCombinedAudiencesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec displayvideo_combined_audiences_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DisplayVideo.V3.Model.ListCombinedAudiencesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def displayvideo_combined_audiences_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v3/combinedAudiences", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DisplayVideo.V3.Model.ListCombinedAudiencesResponse{}]
    )
  end
end
