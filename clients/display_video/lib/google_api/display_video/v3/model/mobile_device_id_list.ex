...
defmodule GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList do
