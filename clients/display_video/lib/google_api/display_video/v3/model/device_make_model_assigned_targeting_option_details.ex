...
defmodule GoogleApi.DisplayVideo.V3.Model.DeviceMakeModelAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.DeviceMakeModelAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.DeviceMakeModelAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
