...
defmodule GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsRequest.decode(value, options)
  end
end
