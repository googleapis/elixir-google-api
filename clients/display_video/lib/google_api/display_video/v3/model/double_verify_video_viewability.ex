...
defmodule GoogleApi.DisplayVideo.V3.Model.DoubleVerifyVideoViewability do
  @moduledoc """
  ...
  *   `videoViewableRate` (*type:* `String.t`, *default:* `nil`) - Target web inventory to maximize fully viewable rate.
  ...
  field(:videoIab)
  field(:videoViewableRate)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.DoubleVerifyVideoViewability do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.DoubleVerifyVideoViewability.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.DoubleVerifyVideoViewability do
