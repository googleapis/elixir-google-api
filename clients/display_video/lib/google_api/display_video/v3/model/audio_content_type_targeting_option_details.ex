...
defmodule GoogleApi.DisplayVideo.V3.Model.AudioContentTypeTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.AudioContentTypeTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.AudioContentTypeTargetingOptionDetails.decode(value, options)
  end
end
