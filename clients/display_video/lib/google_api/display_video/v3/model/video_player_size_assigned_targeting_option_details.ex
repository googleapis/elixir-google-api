...
defmodule GoogleApi.DisplayVideo.V3.Model.VideoPlayerSizeAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.VideoPlayerSizeAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.VideoPlayerSizeAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
