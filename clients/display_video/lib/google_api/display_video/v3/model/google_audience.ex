...
defmodule GoogleApi.DisplayVideo.V3.Model.GoogleAudience do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name of the google audience.
  ...
  field(:googleAudienceType)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.GoogleAudience do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.GoogleAudience.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.GoogleAudience do
