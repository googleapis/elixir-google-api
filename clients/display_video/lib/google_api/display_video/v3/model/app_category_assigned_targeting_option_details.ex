...
defmodule GoogleApi.DisplayVideo.V3.Model.AppCategoryAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.AppCategoryAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.AppCategoryAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
