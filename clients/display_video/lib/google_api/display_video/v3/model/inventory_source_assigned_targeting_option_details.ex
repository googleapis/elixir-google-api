...
defmodule GoogleApi.DisplayVideo.V3.Model.InventorySourceAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.InventorySourceAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.InventorySourceAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
