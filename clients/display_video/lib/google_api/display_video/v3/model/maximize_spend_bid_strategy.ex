...
defmodule GoogleApi.DisplayVideo.V3.Model.MaximizeSpendBidStrategy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.MaximizeSpendBidStrategy do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.MaximizeSpendBidStrategy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.MaximizeSpendBidStrategy do
