...
defmodule GoogleApi.DisplayVideo.V3.Model.NonSkippableAd do
  @moduledoc """
  ...
  *   `customParameters` (*type:* `map()`, *default:* `nil`) - The custom parameters to pass custom values to tracking URL template.
  ...
  field(:commonInStreamAttribute, as: GoogleApi.DisplayVideo.V3.Model.CommonInStreamAttribute)
  field(:customParameters, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.NonSkippableAd do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.NonSkippableAd.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.NonSkippableAd do
