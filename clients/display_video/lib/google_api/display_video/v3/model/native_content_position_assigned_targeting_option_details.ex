...
defmodule GoogleApi.DisplayVideo.V3.Model.NativeContentPositionAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.NativeContentPositionAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.NativeContentPositionAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
