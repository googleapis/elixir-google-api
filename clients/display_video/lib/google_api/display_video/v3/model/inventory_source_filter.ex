...
defmodule GoogleApi.DisplayVideo.V3.Model.InventorySourceFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.InventorySourceFilter do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.InventorySourceFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.InventorySourceFilter do
