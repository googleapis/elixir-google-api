...
defmodule GoogleApi.DisplayVideo.V3.Model.DateRange do
  @moduledoc """
  A date range.
  ...
  *   `startDate` (*type:* `GoogleApi.DisplayVideo.V3.Model.Date.t`, *default:* `nil`) - The lower bound of the date range, inclusive. Must specify a positive value for `year`, `month`, and `day`.
  ...
  field(:endDate, as: GoogleApi.DisplayVideo.V3.Model.Date)
  field(:startDate, as: GoogleApi.DisplayVideo.V3.Model.Date)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.DateRange do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.DateRange.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.DateRange do
