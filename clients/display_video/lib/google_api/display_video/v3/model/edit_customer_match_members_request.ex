...
defmodule GoogleApi.DisplayVideo.V3.Model.EditCustomerMatchMembersRequest do
  @moduledoc """
  ...
  *   `removedMobileDeviceIdList` (*type:* `GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList.t`, *default:* `nil`) - Input only. A list of mobile device IDs to define the members to be removed.
  ...
  @type t :: %__MODULE__{
          :addedContactInfoList => GoogleApi.DisplayVideo.V3.Model.ContactInfoList.t() | nil,
          :addedMobileDeviceIdList =>
            GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList.t() | nil,
          :advertiserId => String.t() | nil,
          :removedContactInfoList => GoogleApi.DisplayVideo.V3.Model.ContactInfoList.t() | nil,
          :removedMobileDeviceIdList =>
            GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList.t() | nil
        }

  field(:addedContactInfoList, as: GoogleApi.DisplayVideo.V3.Model.ContactInfoList)
  field(:addedMobileDeviceIdList, as: GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList)
  field(:advertiserId)
  field(:removedContactInfoList, as: GoogleApi.DisplayVideo.V3.Model.ContactInfoList)
  field(:removedMobileDeviceIdList, as: GoogleApi.DisplayVideo.V3.Model.MobileDeviceIdList)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.EditCustomerMatchMembersRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.EditCustomerMatchMembersRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.EditCustomerMatchMembersRequest do
