...
defmodule GoogleApi.DisplayVideo.V3.Model.ViewabilityAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.ViewabilityAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.ViewabilityAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
