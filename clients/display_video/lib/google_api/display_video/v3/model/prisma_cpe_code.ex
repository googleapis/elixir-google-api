...
defmodule GoogleApi.DisplayVideo.V3.Model.PrismaCpeCode do
  @moduledoc """
  ...
  *   `prismaProductCode` (*type:* `String.t`, *default:* `nil`) - The Prisma product code.
  ...
  field(:prismaClientCode)
  field(:prismaEstimateCode)
  field(:prismaProductCode)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.PrismaCpeCode do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.PrismaCpeCode.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.PrismaCpeCode do
