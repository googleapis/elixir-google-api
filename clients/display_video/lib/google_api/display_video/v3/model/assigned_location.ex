...
defmodule GoogleApi.DisplayVideo.V3.Model.AssignedLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.AssignedLocation do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.AssignedLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.AssignedLocation do
