...
defmodule GoogleApi.DisplayVideo.V3.Model.BulkListAdGroupAssignedTargetingOptionsResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A token identifying the next page of results. This value should be specified as the pageToken in a subsequent call to `BulkListAdGroupAssignedTargetingOptions` to fetch the next page of results. This token will be absent if there are no more AdGroupAssignedTargetingOption resources to return.
  ...
  @type t :: %__MODULE__{
          :adGroupAssignedTargetingOptions =>
            list(GoogleApi.DisplayVideo.V3.Model.AdGroupAssignedTargetingOption.t()) | nil,
          :nextPageToken => String.t() | nil
        }

  field(:adGroupAssignedTargetingOptions,
    as: GoogleApi.DisplayVideo.V3.Model.AdGroupAssignedTargetingOption,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.BulkListAdGroupAssignedTargetingOptionsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.BulkListAdGroupAssignedTargetingOptionsResponse.decode(
      value,
      options
    )
  end
