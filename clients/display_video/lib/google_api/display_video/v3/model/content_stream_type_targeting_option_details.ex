...
defmodule GoogleApi.DisplayVideo.V3.Model.ContentStreamTypeTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.ContentStreamTypeTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.ContentStreamTypeTargetingOptionDetails.decode(value, options)
  end
end
