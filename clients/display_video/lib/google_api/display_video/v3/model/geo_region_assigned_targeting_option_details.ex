...
defmodule GoogleApi.DisplayVideo.V3.Model.GeoRegionAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.GeoRegionAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.GeoRegionAssignedTargetingOptionDetails.decode(value, options)
  end
end
