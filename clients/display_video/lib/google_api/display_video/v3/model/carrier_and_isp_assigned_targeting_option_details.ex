...
defmodule GoogleApi.DisplayVideo.V3.Model.CarrierAndIspAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.CarrierAndIspAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.CarrierAndIspAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
