...
defmodule GoogleApi.DisplayVideo.V3.Model.ContentInstreamPositionAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.ContentInstreamPositionAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.ContentInstreamPositionAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
