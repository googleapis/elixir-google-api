...
defmodule GoogleApi.DisplayVideo.V3.Model.Pacing do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.Pacing do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.Pacing.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.Pacing do
