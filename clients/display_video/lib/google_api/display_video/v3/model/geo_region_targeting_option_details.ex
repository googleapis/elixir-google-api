...
defmodule GoogleApi.DisplayVideo.V3.Model.GeoRegionTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.GeoRegionTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.GeoRegionTargetingOptionDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.GeoRegionTargetingOptionDetails do
