...
defmodule GoogleApi.DisplayVideo.V3.Model.BrowserAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.BrowserAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.BrowserAssignedTargetingOptionDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.BrowserAssignedTargetingOptionDetails do
