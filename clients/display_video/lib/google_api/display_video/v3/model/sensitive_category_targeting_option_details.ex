...
defmodule GoogleApi.DisplayVideo.V3.Model.SensitiveCategoryTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.SensitiveCategoryTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.SensitiveCategoryTargetingOptionDetails.decode(value, options)
  end
end
