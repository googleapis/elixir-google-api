...
defmodule GoogleApi.DisplayVideo.V3.Model.LanguageAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.LanguageAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.LanguageAssignedTargetingOptionDetails.decode(value, options)
  end
end
