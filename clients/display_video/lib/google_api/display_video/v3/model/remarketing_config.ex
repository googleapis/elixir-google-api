...
defmodule GoogleApi.DisplayVideo.V3.Model.RemarketingConfig do
  @moduledoc """
  ...
  *   `remarketingEnabled` (*type:* `boolean()`, *default:* `nil`) - Output only. Whether the Floodlight activity remarketing user list is available to the identified advertiser.
  ...
  field(:advertiserId)
  field(:remarketingEnabled)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.RemarketingConfig do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.RemarketingConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.RemarketingConfig do
