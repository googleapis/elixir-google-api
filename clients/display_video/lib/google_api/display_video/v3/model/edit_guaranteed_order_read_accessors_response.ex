...
defmodule GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.EditGuaranteedOrderReadAccessorsResponse.decode(
      value,
      options
    )
  end
