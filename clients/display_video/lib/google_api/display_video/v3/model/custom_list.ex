...
defmodule GoogleApi.DisplayVideo.V3.Model.CustomList do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.CustomList do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.CustomList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.CustomList do
