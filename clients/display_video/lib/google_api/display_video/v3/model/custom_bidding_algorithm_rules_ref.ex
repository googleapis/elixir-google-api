...
defmodule GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V3.Model.CustomBiddingAlgorithmRulesRef do
