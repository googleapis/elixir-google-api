...
defmodule GoogleApi.DisplayVideo.V3.Model.NegativeKeywordListAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.NegativeKeywordListAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.NegativeKeywordListAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
