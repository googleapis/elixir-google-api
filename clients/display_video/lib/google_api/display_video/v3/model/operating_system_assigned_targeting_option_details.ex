...
defmodule GoogleApi.DisplayVideo.V3.Model.OperatingSystemAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V3.Model.OperatingSystemAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V3.Model.OperatingSystemAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
