...
defmodule GoogleApi.DisplayVideo.V1.Model.ListLineItemAssignedTargetingOptionsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ListLineItemAssignedTargetingOptionsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListLineItemAssignedTargetingOptionsResponse.decode(
      value,
      options
    )
  end
