...
defmodule GoogleApi.DisplayVideo.V1.Model.BusinessChainAssignedTargetingOptionDetails do
  @moduledoc """
  ...
  *   `targetingOptionId` (*type:* `String.t`, *default:* `nil`) - Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_BUSINESS_CHAIN`.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BusinessChainAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BusinessChainAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
