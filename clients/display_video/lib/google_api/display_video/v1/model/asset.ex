...
defmodule GoogleApi.DisplayVideo.V1.Model.Asset do
  @moduledoc """
  A single asset.
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.Asset do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.Asset.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.Asset do
