...
defmodule GoogleApi.DisplayVideo.V1.Model.PartnerCost do
  @moduledoc """
  ...
  *   `feeAmount` (*type:* `String.t`, *default:* `nil`) - The CPM fee amount in micros of advertiser's currency.
  ...
  *   `feePercentageMillis` (*type:* `String.t`, *default:* `nil`) - The media fee percentage in millis (1/1000 of a percent).
  ...
  *   `invoiceType` (*type:* `String.t`, *default:* `nil`) - The invoice type for this partner cost.
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.PartnerCost do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.PartnerCost.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.PartnerCost do
