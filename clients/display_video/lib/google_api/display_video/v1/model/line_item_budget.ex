...
defmodule GoogleApi.DisplayVideo.V1.Model.LineItemBudget do
  ...
  *   `budgetAllocationType` (*type:* `String.t`, *default:* `nil`) - Required. The type of the budget allocation.
  ...
  *   `budgetUnit` (*type:* `String.t`, *default:* `nil`) - Output only. The budget unit specifies whether the budget is currency based
      or impression based. This value is inherited from the parent insertion
      order.
  *   `maxAmount` (*type:* `String.t`, *default:* `nil`) - The maximum budget amount the line item will spend. Must be greater than 0.
