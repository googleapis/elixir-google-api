...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BulkListInsertionOrderAssignedTargetingOptionsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BulkListInsertionOrderAssignedTargetingOptionsResponse.decode(
      value,
      options
    )
  end
