...
defmodule GoogleApi.DisplayVideo.V1.Model.ListCampaignAssignedTargetingOptionsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ListCampaignAssignedTargetingOptionsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListCampaignAssignedTargetingOptionsResponse.decode(
      value,
      options
    )
  end
