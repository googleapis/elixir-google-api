...
defmodule GoogleApi.DisplayVideo.V1.Model.IdFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.IdFilter do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.IdFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.IdFilter do
