...
defmodule GoogleApi.DisplayVideo.V1.Model.ListSitesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListSitesResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListSitesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListSitesResponse do
