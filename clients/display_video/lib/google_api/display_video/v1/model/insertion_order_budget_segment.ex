...
defmodule GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudgetSegment do
  ...
  *   `budgetAmountMicros` (*type:* `String.t`, *default:* `nil`) - Required. The budget amount the insertion order will spend for the given
      date_range.
  ...
  *   `description` (*type:* `String.t`, *default:* `nil`) - The budget segment description. It can be used to enter Purchase Order
