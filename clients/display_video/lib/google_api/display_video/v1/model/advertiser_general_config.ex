...
defmodule GoogleApi.DisplayVideo.V1.Model.AdvertiserGeneralConfig do
  ...
  *   `currencyCode` (*type:* `String.t`, *default:* `nil`) - Required. Immutable. Advertiser's currency in ISO 4217 format.
  ...
  *   `domainUrl` (*type:* `String.t`, *default:* `nil`) - Required. The domain URL of the advertiser's primary website.
  ...
  *   `timeZone` (*type:* `String.t`, *default:* `nil`) - Output only. The standard TZ database name of the advertiser's time zone.
