...
defmodule GoogleApi.DisplayVideo.V1.Model.BulkListCampaignAssignedTargetingOptionsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BulkListCampaignAssignedTargetingOptionsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BulkListCampaignAssignedTargetingOptionsResponse.decode(
      value,
      options
    )
  end
