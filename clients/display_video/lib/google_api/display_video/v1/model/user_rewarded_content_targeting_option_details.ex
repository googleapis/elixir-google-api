...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.UserRewardedContentTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.UserRewardedContentTargetingOptionDetails.decode(
      value,
      options
    )
  end
