...
defmodule GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudget do
  @moduledoc """
  ...
  *   `budgetUnit` (*type:* `String.t`, *default:* `nil`) - Required. Immutable. The budget unit specifies whether the budget is currency based or
  ...
  field(:budgetSegments,
    as: GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudgetSegment,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudget do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudget.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.InsertionOrderBudget do
