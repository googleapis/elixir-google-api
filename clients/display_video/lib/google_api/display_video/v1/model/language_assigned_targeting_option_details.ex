...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.LanguageAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.LanguageAssignedTargetingOptionDetails.decode(value, options)
  end
end
