...
defmodule GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceGroup do
  ...
  *   `settings` (*type:* `list(GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceTargetingSetting.t)`, *default:* `nil`) - Required. All first and third party audience targeting settings in first and
  ...
  field(:settings,
    as: GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceTargetingSetting,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceGroup do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceGroup do
