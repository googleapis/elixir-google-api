...
defmodule GoogleApi.DisplayVideo.V1.Model.ListAdvertisersResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListAdvertisersResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListAdvertisersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListAdvertisersResponse do
