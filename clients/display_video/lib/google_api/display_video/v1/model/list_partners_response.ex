...
defmodule GoogleApi.DisplayVideo.V1.Model.ListPartnersResponse do
  @moduledoc """
  ...
  *   `partners` (*type:* `list(GoogleApi.DisplayVideo.V1.Model.Partner.t)`, *default:* `nil`) - The list of partners. This list will be absent if empty.
  ...
  field(:nextPageToken)
  field(:partners, as: GoogleApi.DisplayVideo.V1.Model.Partner, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListPartnersResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListPartnersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListPartnersResponse do
