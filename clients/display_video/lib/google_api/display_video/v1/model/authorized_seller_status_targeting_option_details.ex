...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.AuthorizedSellerStatusTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.AuthorizedSellerStatusTargetingOptionDetails.decode(
      value,
      options
    )
  end
