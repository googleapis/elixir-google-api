...
defmodule GoogleApi.DisplayVideo.V1.Model.ListCustomListsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListCustomListsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListCustomListsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListCustomListsResponse do
