...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ExchangeAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ExchangeAssignedTargetingOptionDetails.decode(value, options)
  end
end
