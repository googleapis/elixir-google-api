...
defmodule GoogleApi.DisplayVideo.V1.Model.EditInventorySourceReadWriteAccessorsRequest do
  ...
  *   `partnerId` (*type:* `String.t`, *default:* `nil`) - Required. The partner context by which the accessors change is being made.
  ...
  @type t :: %__MODULE__{
          :advertisersUpdate =>
            GoogleApi.DisplayVideo.V1.Model.EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate.t()
            | nil,
  ...
  field(:advertisersUpdate,
    as:
      GoogleApi.DisplayVideo.V1.Model.EditInventorySourceReadWriteAccessorsRequestAdvertisersUpdate
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.EditInventorySourceReadWriteAccessorsRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.EditInventorySourceReadWriteAccessorsRequest.decode(
      value,
      options
    )
  end
