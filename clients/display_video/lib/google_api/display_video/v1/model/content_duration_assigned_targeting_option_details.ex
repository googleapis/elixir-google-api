...
defmodule GoogleApi.DisplayVideo.V1.Model.ContentDurationAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ContentDurationAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ContentDurationAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
