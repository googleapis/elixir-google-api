...
defmodule GoogleApi.DisplayVideo.V1.Model.AudioContentTypeTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.AudioContentTypeTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.AudioContentTypeTargetingOptionDetails.decode(value, options)
  end
end
