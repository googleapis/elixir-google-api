...
defmodule GoogleApi.DisplayVideo.V1.Model.ListUsersResponse do
  @moduledoc """
  ...
  *   `users` (*type:* `list(GoogleApi.DisplayVideo.V1.Model.User.t)`, *default:* `nil`) - The list of users. This list will be absent if empty.
  ...
  field(:nextPageToken)
  field(:users, as: GoogleApi.DisplayVideo.V1.Model.User, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListUsersResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListUsersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListUsersResponse do
