...
defmodule GoogleApi.DisplayVideo.V1.Model.ChannelAssignedTargetingOptionDetails do
  ...
  *   `channelId` (*type:* `String.t`, *default:* `nil`) - Required. ID of the channel. Should refer to the channel ID
      field on a
      ...
      resource.
  *   `negative` (*type:* `boolean()`, *default:* `nil`) - Indicates if this option is being negatively targeted. For advertiser
