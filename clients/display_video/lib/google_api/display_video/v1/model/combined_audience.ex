...
defmodule GoogleApi.DisplayVideo.V1.Model.CombinedAudience do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CombinedAudience do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CombinedAudience.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CombinedAudience do
