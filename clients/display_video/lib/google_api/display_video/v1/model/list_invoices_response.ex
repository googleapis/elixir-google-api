...
defmodule GoogleApi.DisplayVideo.V1.Model.ListInvoicesResponse do
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListInvoices` method to retrieve the next page of results. This token will be absent if there are no more invoices to return.
  ...
  @type t :: %__MODULE__{
          :invoices => list(GoogleApi.DisplayVideo.V1.Model.Invoice.t()) | nil,
          :nextPageToken => String.t() | nil
        }

  field(:invoices, as: GoogleApi.DisplayVideo.V1.Model.Invoice, type: :list)
  field(:nextPageToken)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListInvoicesResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListInvoicesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListInvoicesResponse do
