...
defmodule GoogleApi.DisplayVideo.V1.Model.Pacing do
  ...
  *   `dailyMaxImpressions` (*type:* `String.t`, *default:* `nil`) - Maximum number of impressions to serve every day.

      Applicable when the budget is impression based. Must be greater than 0.
  *   `dailyMaxMicros` (*type:* `String.t`, *default:* `nil`) - Maximum currency amount to spend every day in micros of
      ...
      0.01.
  *   `pacingPeriod` (*type:* `String.t`, *default:* `nil`) - Required. The time period in which the pacing budget will be spent.
  ...
  *   `pacingType` (*type:* `String.t`, *default:* `nil`) - Required. The type of pacing that defines how the budget amount will be
