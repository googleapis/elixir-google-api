...
defmodule GoogleApi.DisplayVideo.V1.Model.Creative do
  ...
  *   `cmPlacementId` (*type:* `String.t`, *default:* `nil`) - Output only. The unique ID of the Campaign Manager placement associated with the creative. This field is only applicable for creatives that are synced from Campaign Manager.
  ...
  *   `vastTagUrl` (*type:* `String.t`, *default:* `nil`) - Optional. The URL of the VAST tag for a third-party VAST tag creative. Required and only valid for third-party VAST tag creatives. Third-party VAST tag creatives are creatives with following hosting_source: * `HOSTING_SOURCE_THIRD_PARTY` combined with following creative_type: * `CREATIVE_TYPE_VIDEO`
