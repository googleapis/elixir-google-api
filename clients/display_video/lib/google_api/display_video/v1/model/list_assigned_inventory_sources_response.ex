...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListAssignedInventorySourcesResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListAssignedInventorySourcesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListAssignedInventorySourcesResponse do
