...
defmodule GoogleApi.DisplayVideo.V1.Model.LocationList do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.LocationList do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.LocationList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.LocationList do
