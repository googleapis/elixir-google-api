...
defmodule GoogleApi.DisplayVideo.V1.Model.ListCustomBiddingAlgorithmsResponse do
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListCustomBiddingAlgorithmsRequest` method to retrieve the next page of results. If this field is null, it means this is the last page.
  ...
  field(:customBiddingAlgorithms,
    as: GoogleApi.DisplayVideo.V1.Model.CustomBiddingAlgorithm,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListCustomBiddingAlgorithmsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListCustomBiddingAlgorithmsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListCustomBiddingAlgorithmsResponse do
