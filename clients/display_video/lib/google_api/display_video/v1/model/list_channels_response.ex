...
defmodule GoogleApi.DisplayVideo.V1.Model.ListChannelsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListChannelsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListChannelsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListChannelsResponse do
