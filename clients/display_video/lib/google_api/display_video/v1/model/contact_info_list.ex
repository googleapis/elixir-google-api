...
defmodule GoogleApi.DisplayVideo.V1.Model.ContactInfoList do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ContactInfoList do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ContactInfoList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ContactInfoList do
