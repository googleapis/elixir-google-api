...
defmodule GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesResponse.decode(
      value,
      options
    )
  end
