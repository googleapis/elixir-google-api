...
defmodule GoogleApi.DisplayVideo.V1.Model.MobileApp do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.MobileApp do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.MobileApp.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.MobileApp do
