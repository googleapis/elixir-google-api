...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.SensitiveCategoryTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.SensitiveCategoryTargetingOptionDetails.decode(value, options)
  end
end
