...
defmodule GoogleApi.DisplayVideo.V1.Model.CustomBiddingScript do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The state of the custom bidding script.
  ...
  @type t :: %__MODULE__{
          ...
          :errors => list(GoogleApi.DisplayVideo.V1.Model.ScriptError.t()) | nil,
          :name => String.t() | nil,
  ...
  field(:errors, as: GoogleApi.DisplayVideo.V1.Model.ScriptError, type: :list)
  field(:name)
  field(:script, as: GoogleApi.DisplayVideo.V1.Model.CustomBiddingScriptRef)
  field(:state)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CustomBiddingScript do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CustomBiddingScript.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CustomBiddingScript do
