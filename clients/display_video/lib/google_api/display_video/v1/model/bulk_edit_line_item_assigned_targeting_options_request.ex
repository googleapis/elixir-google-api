...
defmodule GoogleApi.DisplayVideo.V1.Model.BulkEditLineItemAssignedTargetingOptionsRequest do
  @moduledoc """
  Request message for
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BulkEditLineItemAssignedTargetingOptionsRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BulkEditLineItemAssignedTargetingOptionsRequest.decode(
      value,
      options
    )
  end
