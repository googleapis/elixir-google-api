...
defmodule GoogleApi.DisplayVideo.V1.Model.ScriptError do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ScriptError do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ScriptError.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ScriptError do
