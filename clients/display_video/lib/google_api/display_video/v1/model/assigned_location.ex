...
defmodule GoogleApi.DisplayVideo.V1.Model.AssignedLocation do
  ...
  *   `assignedLocationId` (*type:* `String.t`, *default:* `nil`) - Output only. The unique ID of the assigned location. The ID is only unique within a
  ...
  *   `targetingOptionId` (*type:* `String.t`, *default:* `nil`) - Required. The ID of the targeting option assigned to the location list. Must be of
