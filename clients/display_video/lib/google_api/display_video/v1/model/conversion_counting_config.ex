...
defmodule GoogleApi.DisplayVideo.V1.Model.ConversionCountingConfig do
  ...
  *   `floodlightActivityConfigs` (*type:* `list(GoogleApi.DisplayVideo.V1.Model.TrackingFloodlightActivityConfig.t)`, *default:* `nil`) - The Floodlight activity configs used to track conversions.
  ...
  *   `postViewCountPercentageMillis` (*type:* `String.t`, *default:* `nil`) - The percentage of post-view conversions to count, in millis (1/1000 of a
