...
defmodule GoogleApi.DisplayVideo.V1.Model.GuaranteedOrderStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.GuaranteedOrderStatus do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.GuaranteedOrderStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.GuaranteedOrderStatus do
