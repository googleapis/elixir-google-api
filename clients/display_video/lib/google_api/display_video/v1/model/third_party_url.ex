...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ThirdPartyUrl do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ThirdPartyUrl.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ThirdPartyUrl do
