...
defmodule GoogleApi.DisplayVideo.V1.Model.ListNegativeKeywordListsResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A token to retrieve the next page of results. Pass this value in the page_token field in the subsequent call to `ListNegativeKeywordLists` method to retrieve the next page of results.
  ...
  field(:negativeKeywordLists,
    as: GoogleApi.DisplayVideo.V1.Model.NegativeKeywordList,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListNegativeKeywordListsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListNegativeKeywordListsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListNegativeKeywordListsResponse do
