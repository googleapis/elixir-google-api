...
defmodule GoogleApi.DisplayVideo.V1.Model.CampaignGoal do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CampaignGoal do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CampaignGoal.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CampaignGoal do
