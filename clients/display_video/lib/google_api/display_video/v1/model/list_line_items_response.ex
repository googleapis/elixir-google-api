...
defmodule GoogleApi.DisplayVideo.V1.Model.ListLineItemsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListLineItemsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListLineItemsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListLineItemsResponse do
