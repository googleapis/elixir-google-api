...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.OnScreenPositionTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.OnScreenPositionTargetingOptionDetails.decode(value, options)
  end
end
