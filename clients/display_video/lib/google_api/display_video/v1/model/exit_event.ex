...
defmodule GoogleApi.DisplayVideo.V1.Model.ExitEvent do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of the click tag of the exit event.

      The name must be unique within one creative.

      Leave it empty or unset for creatives containing image assets only.
  *   `reportingName` (*type:* `String.t`, *default:* `nil`) - The name used to identify this event in reports.
      Leave it empty or unset for creatives containing image assets only.
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. The type of the exit event.
  *   `url` (*type:* `String.t`, *default:* `nil`) - Required. The click through URL of the exit event.
