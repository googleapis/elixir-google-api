...
defmodule GoogleApi.DisplayVideo.V1.Model.EditGuaranteedOrderReadAccessorsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.EditGuaranteedOrderReadAccessorsResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.EditGuaranteedOrderReadAccessorsResponse.decode(
      value,
      options
    )
  end
