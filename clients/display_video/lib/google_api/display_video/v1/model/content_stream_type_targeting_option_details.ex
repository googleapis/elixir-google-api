...
defmodule GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeTargetingOptionDetails.decode(value, options)
  end
end
