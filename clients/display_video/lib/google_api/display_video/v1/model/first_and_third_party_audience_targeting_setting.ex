...
defmodule GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceTargetingSetting do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceTargetingSetting do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.FirstAndThirdPartyAudienceTargetingSetting.decode(
      value,
      options
    )
  end
