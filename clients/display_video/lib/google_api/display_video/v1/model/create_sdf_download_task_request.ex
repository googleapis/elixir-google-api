...
defmodule GoogleApi.DisplayVideo.V1.Model.CreateSdfDownloadTaskRequest do
  @moduledoc """
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Required. The SDF version of the downloaded file. If set to `SDF_VERSION_UNSPECIFIED`, this will default to the version specified by the advertiser or partner identified by `root_id`. An advertiser inherits its SDF version from its partner unless configured otherwise.
  ...
  field(:advertiserId)
  field(:idFilter, as: GoogleApi.DisplayVideo.V1.Model.IdFilter)
  field(:inventorySourceFilter, as: GoogleApi.DisplayVideo.V1.Model.InventorySourceFilter)
  field(:parentEntityFilter, as: GoogleApi.DisplayVideo.V1.Model.ParentEntityFilter)
  field(:partnerId)
  field(:version)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CreateSdfDownloadTaskRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CreateSdfDownloadTaskRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CreateSdfDownloadTaskRequest do
