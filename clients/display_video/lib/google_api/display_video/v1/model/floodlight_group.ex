...
defmodule GoogleApi.DisplayVideo.V1.Model.FloodlightGroup do
  @moduledoc """
  ...
  *   `webTagType` (*type:* `String.t`, *default:* `nil`) - Required. The web tag type enabled for the Floodlight group.
  ...
  field(:activeViewConfig,
    as: GoogleApi.DisplayVideo.V1.Model.ActiveViewVideoViewabilityMetricConfig
  )

  field(:customVariables, type: :map)
  field(:displayName)
  field(:floodlightGroupId)
  field(:lookbackWindow, as: GoogleApi.DisplayVideo.V1.Model.LookbackWindow)
  field(:name)
  field(:webTagType)
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.FloodlightGroup do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.FloodlightGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.FloodlightGroup do
