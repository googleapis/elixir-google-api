...
defmodule GoogleApi.DisplayVideo.V1.Model.ListManualTriggersResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListManualTriggersResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListManualTriggersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListManualTriggersResponse do
