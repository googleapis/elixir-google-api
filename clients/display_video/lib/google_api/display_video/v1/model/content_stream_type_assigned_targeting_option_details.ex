...
defmodule GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeAssignedTargetingOptionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeAssignedTargetingOptionDetails do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ContentStreamTypeAssignedTargetingOptionDetails.decode(
      value,
      options
    )
  end
