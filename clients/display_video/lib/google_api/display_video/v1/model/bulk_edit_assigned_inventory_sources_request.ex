...
defmodule GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesRequest do
  @moduledoc """
  ...
  *   `partnerId` (*type:* `String.t`, *default:* `nil`) - The ID of the partner that owns the inventory source group. Only this partner has write access to these assigned inventory sources.
  ...
  field(:createdAssignedInventorySources,
    as: GoogleApi.DisplayVideo.V1.Model.AssignedInventorySource,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesRequest do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.BulkEditAssignedInventorySourcesRequest.decode(value, options)
  end
end
