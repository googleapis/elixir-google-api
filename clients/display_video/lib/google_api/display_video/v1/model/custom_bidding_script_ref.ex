...
defmodule GoogleApi.DisplayVideo.V1.Model.CustomBiddingScriptRef do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CustomBiddingScriptRef do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CustomBiddingScriptRef.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CustomBiddingScriptRef do
