...
defmodule GoogleApi.DisplayVideo.V1.Model.ListInventorySourcesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.ListInventorySourcesResponse do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.ListInventorySourcesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.ListInventorySourcesResponse do
