...
defmodule GoogleApi.DisplayVideo.V1.Model.CreativeConfig do
  @moduledoc """
  ...
  *   `videoCreativeConfig` (*type:* `GoogleApi.DisplayVideo.V1.Model.InventorySourceVideoCreativeConfig.t`, *default:* `nil`) - The configuration for video creatives. Applicable when creative_type is `CREATIVE_TYPE_VIDEO`.
  ...
  field(:displayCreativeConfig,
    as: GoogleApi.DisplayVideo.V1.Model.InventorySourceDisplayCreativeConfig
  )

  field(:videoCreativeConfig,
    as: GoogleApi.DisplayVideo.V1.Model.InventorySourceVideoCreativeConfig
  )
end

defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.CreativeConfig do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.CreativeConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.CreativeConfig do
