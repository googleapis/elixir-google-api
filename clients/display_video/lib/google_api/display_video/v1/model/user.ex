...
defmodule GoogleApi.DisplayVideo.V1.Model.User do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DisplayVideo.V1.Model.User do
  def decode(value, options) do
    GoogleApi.DisplayVideo.V1.Model.User.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DisplayVideo.V1.Model.User do
