...
defmodule GoogleApi.DisplayVideo.V1.Api.TargetingTypes do
  ...
  *   `targeting_type` (*type:* `String.t`) - Required. The type of targeting option to retrieve.
  ...
  *   `connection` (*type:* `GoogleApi.DisplayVideo.V1.Connection.t`) - Connection to server
  *   `targeting_type` (*type:* `String.t`) - Required. The type of targeting option to be listed.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
