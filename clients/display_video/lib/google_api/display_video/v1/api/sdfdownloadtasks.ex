...
defmodule GoogleApi.DisplayVideo.V1.Api.Sdfdownloadtasks do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V1.Model.CreateSdfDownloadTaskRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DisplayVideo.V1.Model.Operation{}}` on success
  *   `{:error, info}` on failure
  ...
  def displayvideo_sdfdownloadtasks_create(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/sdfdownloadtasks", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V1.Model.Operation{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec displayvideo_sdfdownloadtasks_operations_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
