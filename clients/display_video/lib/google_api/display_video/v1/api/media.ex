...
defmodule GoogleApi.DisplayVideo.V1.Api.Media do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DisplayVideo.V1.Model.GoogleBytestreamMedia{}}` on success
  *   `{:error, info}` on failure
  ...
  def displayvideo_media_download(connection, resource_name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DisplayVideo.V1.Model.GoogleBytestreamMedia{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DisplayVideo.V1.Model.GoogleBytestreamMedia.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `metadata` (*type:* `GoogleApi.DisplayVideo.V1.Model.GoogleBytestreamMedia.t`) - object metadata
  ...
  *   `{:error, info}` on failure
  ...
  @spec displayvideo_media_upload_iodata(
          ...
          String.t(),
          String.t(),
          GoogleApi.DisplayVideo.V1.Model.GoogleBytestreamMedia.t(),
          iodata,
          keyword(),
          keyword()
        ) ::
