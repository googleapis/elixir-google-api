...
defmodule GoogleApi.DisplayVideo.V1.Api.CustomBiddingAlgorithms do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:advertiserId` (*type:* `String.t`) - The ID of the DV3 partner that has access to the custom bidding algorithm.
      *   `:partnerId` (*type:* `String.t`) - The ID of the DV3 partner that has access to the custom bidding algorithm.
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:advertiserId` (*type:* `String.t`) - The ID of the DV3 advertiser that has access to the custom bidding algorithm.
