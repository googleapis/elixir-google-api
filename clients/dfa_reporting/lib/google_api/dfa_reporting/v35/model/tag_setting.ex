...
defmodule GoogleApi.DFAReporting.V35.Model.TagSetting do
  @moduledoc """
  Tag Settings
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.TagSetting do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.TagSetting.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.TagSetting do
