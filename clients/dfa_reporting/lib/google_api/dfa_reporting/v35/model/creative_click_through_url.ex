...
defmodule GoogleApi.DFAReporting.V35.Model.CreativeClickThroughUrl do
  @moduledoc """
  Click-through URL
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.CreativeClickThroughUrl do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.CreativeClickThroughUrl.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.CreativeClickThroughUrl do
