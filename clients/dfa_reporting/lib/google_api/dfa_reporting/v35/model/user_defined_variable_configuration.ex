...
defmodule GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration do
