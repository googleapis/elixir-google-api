...
defmodule GoogleApi.DFAReporting.V35.Model.InventoryItem do
  @moduledoc """
  ...
  *   `lastModifiedInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the most recent modification of this inventory item.
  ...
  *   `pricing` (*type:* `GoogleApi.DFAReporting.V35.Model.Pricing.t`, *default:* `nil`) - Pricing of this inventory item.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of inventory item.
  ...
  @type t :: %__MODULE__{
          ...
          :adSlots => list(GoogleApi.DFAReporting.V35.Model.AdSlot.t()) | nil,
          ...
          :pricing => GoogleApi.DFAReporting.V35.Model.Pricing.t() | nil,
  ...
  field(:accountId)
  field(:adSlots, as: GoogleApi.DFAReporting.V35.Model.AdSlot, type: :list)
  field(:advertiserId)
  ...
  field(:pricing, as: GoogleApi.DFAReporting.V35.Model.Pricing)
  field(:projectId)
  field(:rfpId)
  field(:siteId)
  field(:subaccountId)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.InventoryItem do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.InventoryItem.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.InventoryItem do
