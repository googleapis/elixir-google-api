...
defmodule GoogleApi.DFAReporting.V35.Model.MeasurementPartnerWrappingData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.MeasurementPartnerWrappingData do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.MeasurementPartnerWrappingData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.MeasurementPartnerWrappingData do
