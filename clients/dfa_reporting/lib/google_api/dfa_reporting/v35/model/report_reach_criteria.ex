...
defmodule GoogleApi.DFAReporting.V35.Model.ReportReachCriteria do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ReportReachCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ReportReachCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ReportReachCriteria do
