...
defmodule GoogleApi.DFAReporting.V35.Model.RemarketingList do
  @moduledoc """
  ...
  *   `listPopulationRule` (*type:* `GoogleApi.DFAReporting.V35.Model.ListPopulationRule.t`, *default:* `nil`) - Rule used to populate the remarketing list with users.
  ...
  *   `subaccountId` (*type:* `String.t`, *default:* `nil`) - Subaccount ID of this remarketing list. This is a read-only, auto-generated field that is only returned in GET requests.
  ...
  @type t :: %__MODULE__{
          ...
          :listPopulationRule => GoogleApi.DFAReporting.V35.Model.ListPopulationRule.t() | nil,
  ...
  field(:kind)
  field(:lifeSpan)
  field(:listPopulationRule, as: GoogleApi.DFAReporting.V35.Model.ListPopulationRule)
  field(:listSize)
  field(:listSource)
  field(:name)
  field(:subaccountId)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.RemarketingList do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.RemarketingList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.RemarketingList do
