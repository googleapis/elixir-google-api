...
defmodule GoogleApi.DFAReporting.V35.Model.ReportPathToConversionCriteriaReportProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V35.Model.ReportPathToConversionCriteriaReportProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ReportPathToConversionCriteriaReportProperties.decode(
      value,
      options
    )
  end
