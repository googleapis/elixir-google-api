...
defmodule GoogleApi.DFAReporting.V35.Model.PlacementGroup do
  @moduledoc """
  ...
  *   `createInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the creation of this placement group. This is a read-only field.
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this placement group. This is a read-only, auto-generated field.
  ...
  *   `lastModifiedInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the most recent modification of this placement group. This is a read-only field.
  ...
  *   `pricingSchedule` (*type:* `GoogleApi.DFAReporting.V35.Model.PricingSchedule.t`, *default:* `nil`) - Pricing schedule of this placement group. This field is required on insertion.
  ...
  *   `primaryPlacementIdDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of the primary placement. This is a read-only, auto-generated field.
  ...
  *   `subaccountId` (*type:* `String.t`, *default:* `nil`) - Subaccount ID of this placement group. This is a read-only field that can be left blank.
  ...
  field(:primaryPlacementIdDimensionValue, as: GoogleApi.DFAReporting.V35.Model.DimensionValue)
  field(:siteId)
  field(:siteIdDimensionValue, as: GoogleApi.DFAReporting.V35.Model.DimensionValue)
  field(:subaccountId)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.PlacementGroup do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.PlacementGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.PlacementGroup do
