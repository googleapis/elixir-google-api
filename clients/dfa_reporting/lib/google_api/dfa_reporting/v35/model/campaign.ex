...
defmodule GoogleApi.DFAReporting.V35.Model.Campaign do
  @moduledoc """
  ...
  *   `adBlockingConfiguration` (*type:* `GoogleApi.DFAReporting.V35.Model.AdBlockingConfiguration.t`, *default:* `nil`) - Ad blocking settings for this campaign.
  *   `additionalCreativeOptimizationConfigurations` (*type:* `list(GoogleApi.DFAReporting.V35.Model.CreativeOptimizationConfiguration.t)`, *default:* `nil`) - Additional creative optimization configurations for the campaign.
  ...
  *   `advertiserIdDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the advertiser ID of this campaign. This is a read-only, auto-generated field.
  *   `archived` (*type:* `boolean()`, *default:* `nil`) - Whether this campaign has been archived.
  *   `audienceSegmentGroups` (*type:* `list(GoogleApi.DFAReporting.V35.Model.AudienceSegmentGroup.t)`, *default:* `nil`) - Audience segment groups assigned to this campaign. Cannot have more than 300 segment groups.
  ...
  *   `clickThroughUrlSuffixProperties` (*type:* `GoogleApi.DFAReporting.V35.Model.ClickThroughUrlSuffixProperties.t`, *default:* `nil`) - Click-through URL suffix override properties for this campaign.
  *   `comment` (*type:* `String.t`, *default:* `nil`) - Arbitrary comments about this campaign. Must be less than 256 characters long.
  *   `createInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the creation of this campaign. This is a read-only field.
  *   `creativeGroupIds` (*type:* `list(String.t)`, *default:* `nil`) - List of creative group IDs that are assigned to the campaign.
  *   `creativeOptimizationConfiguration` (*type:* `GoogleApi.DFAReporting.V35.Model.CreativeOptimizationConfiguration.t`, *default:* `nil`) - Creative optimization configuration for the campaign.
  *   `defaultClickThroughEventTagProperties` (*type:* `GoogleApi.DFAReporting.V35.Model.DefaultClickThroughEventTagProperties.t`, *default:* `nil`) - Click-through event tag ID override properties for this campaign.
  ...
  *   `eventTagOverrides` (*type:* `list(GoogleApi.DFAReporting.V35.Model.EventTagOverride.t)`, *default:* `nil`) - Overrides that can be used to activate or deactivate advertiser event tags.
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this campaign. This is a read-only, auto-generated field.
  ...
  *   `traffickerEmails` (*type:* `list(String.t)`, *default:* `nil`) - Campaign trafficker contact emails.
  ...
  @type t :: %__MODULE__{
          ...
          :adBlockingConfiguration =>
            GoogleApi.DFAReporting.V35.Model.AdBlockingConfiguration.t() | nil,
          :additionalCreativeOptimizationConfigurations =>
            list(GoogleApi.DFAReporting.V35.Model.CreativeOptimizationConfiguration.t()) | nil,
          ...
          :audienceSegmentGroups =>
            list(GoogleApi.DFAReporting.V35.Model.AudienceSegmentGroup.t()) | nil,
          ...
          :creativeOptimizationConfiguration =>
            GoogleApi.DFAReporting.V35.Model.CreativeOptimizationConfiguration.t() | nil,
          ...
          :measurementPartnerLink =>
            GoogleApi.DFAReporting.V35.Model.MeasurementPartnerCampaignLink.t() | nil,
          :name => String.t() | nil,
  ...
  field(:accountId)
  field(:adBlockingConfiguration, as: GoogleApi.DFAReporting.V35.Model.AdBlockingConfiguration)

  field(:additionalCreativeOptimizationConfigurations,
    as: GoogleApi.DFAReporting.V35.Model.CreativeOptimizationConfiguration,
    type: :list
  )
  ...
  field(:audienceSegmentGroups,
    as: GoogleApi.DFAReporting.V35.Model.AudienceSegmentGroup,
    type: :list
  )
  ...
  field(:measurementPartnerLink,
    as: GoogleApi.DFAReporting.V35.Model.MeasurementPartnerCampaignLink
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Campaign do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Campaign.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Campaign do
