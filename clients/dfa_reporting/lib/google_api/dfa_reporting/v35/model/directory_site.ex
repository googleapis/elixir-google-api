...
defmodule GoogleApi.DFAReporting.V35.Model.DirectorySite do
  @moduledoc """
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this directory site. This is a read-only, auto-generated field.
  ...
  *   `settings` (*type:* `GoogleApi.DFAReporting.V35.Model.DirectorySiteSettings.t`, *default:* `nil`) - Directory site settings.
  *   `url` (*type:* `String.t`, *default:* `nil`) - URL of this directory site.
  ...
  @type t :: %__MODULE__{
          ...
          :kind => String.t() | nil,
          :name => String.t() | nil,
          :settings => GoogleApi.DFAReporting.V35.Model.DirectorySiteSettings.t() | nil,
          :url => String.t() | nil
        }
  ...
  field(:kind)
  field(:name)
  field(:settings, as: GoogleApi.DFAReporting.V35.Model.DirectorySiteSettings)
  field(:url)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.DirectorySite do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.DirectorySite.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.DirectorySite do
