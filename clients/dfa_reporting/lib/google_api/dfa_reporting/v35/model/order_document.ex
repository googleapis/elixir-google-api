...
defmodule GoogleApi.DFAReporting.V35.Model.OrderDocument do
  @moduledoc """
  ...
  *   `createdInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the creation of this order document.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of this order document
  ...
  @type t :: %__MODULE__{
          ...
          :createdInfo => GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t() | nil,
  ...
  field(:cancelled)
  field(:createdInfo, as: GoogleApi.DFAReporting.V35.Model.LastModifiedInfo)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.OrderDocument do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.OrderDocument.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.OrderDocument do
