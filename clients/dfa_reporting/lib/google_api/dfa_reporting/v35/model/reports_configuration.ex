...
defmodule GoogleApi.DFAReporting.V35.Model.ReportsConfiguration do
  @moduledoc """
  ...
  *   `lookbackConfiguration` (*type:* `GoogleApi.DFAReporting.V35.Model.LookbackConfiguration.t`, *default:* `nil`) - Default lookback windows for new advertisers in this account.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ReportsConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ReportsConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ReportsConfiguration do
