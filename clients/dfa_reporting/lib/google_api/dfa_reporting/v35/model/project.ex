...
defmodule GoogleApi.DFAReporting.V35.Model.Project do
  @moduledoc """
  ...
  *   `lastModifiedInfo` (*type:* `GoogleApi.DFAReporting.V35.Model.LastModifiedInfo.t`, *default:* `nil`) - Information about the most recent modification of this project.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Project do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Project.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Project do
