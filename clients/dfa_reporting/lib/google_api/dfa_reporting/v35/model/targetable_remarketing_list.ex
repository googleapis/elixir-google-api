...
defmodule GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList do
  @moduledoc """
  ...
  *   `advertiserIdDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of the advertiser.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList do
