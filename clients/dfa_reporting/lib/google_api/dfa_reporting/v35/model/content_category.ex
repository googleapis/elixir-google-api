...
defmodule GoogleApi.DFAReporting.V35.Model.ContentCategory do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ContentCategory do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ContentCategory.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ContentCategory do
