...
defmodule GoogleApi.DFAReporting.V35.Model.LandingPage do
  @moduledoc """
  ...
  *   `deepLinks` (*type:* `list(GoogleApi.DFAReporting.V35.Model.DeepLink.t)`, *default:* `nil`) - Links that will direct the user to a mobile app, if installed.
  ...
  *   `url` (*type:* `String.t`, *default:* `nil`) - URL of this landing page. This is a required field.
  ...
  @type t :: %__MODULE__{
          ...
          :deepLinks => list(GoogleApi.DFAReporting.V35.Model.DeepLink.t()) | nil,
          :id => String.t() | nil,
          :kind => String.t() | nil,
          :name => String.t() | nil,
          :url => String.t() | nil
  ...
  field(:advertiserId)
  field(:archived)
  field(:deepLinks, as: GoogleApi.DFAReporting.V35.Model.DeepLink, type: :list)
  field(:id)
  field(:kind)
  field(:name)
  field(:url)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.LandingPage do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.LandingPage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.LandingPage do
