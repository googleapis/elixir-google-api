...
defmodule GoogleApi.DFAReporting.V35.Model.UniversalAdId do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.UniversalAdId do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.UniversalAdId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.UniversalAdId do
