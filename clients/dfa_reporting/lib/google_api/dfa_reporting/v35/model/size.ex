...
defmodule GoogleApi.DFAReporting.V35.Model.Size do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Size do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Size.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Size do
