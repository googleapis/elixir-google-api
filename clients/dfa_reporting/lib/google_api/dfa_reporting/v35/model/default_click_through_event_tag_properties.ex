...
defmodule GoogleApi.DFAReporting.V35.Model.DefaultClickThroughEventTagProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V35.Model.DefaultClickThroughEventTagProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.DefaultClickThroughEventTagProperties.decode(value, options)
  end
end
