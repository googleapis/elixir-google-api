...
defmodule GoogleApi.DFAReporting.V35.Model.DimensionValue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.DimensionValue do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.DimensionValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.DimensionValue do
