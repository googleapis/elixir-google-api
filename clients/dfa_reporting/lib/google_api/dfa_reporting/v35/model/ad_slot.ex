...
defmodule GoogleApi.DFAReporting.V35.Model.AdSlot do
  @moduledoc """
  Ad Slot
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.AdSlot do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.AdSlot.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.AdSlot do
