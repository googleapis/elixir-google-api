...
defmodule GoogleApi.DFAReporting.V35.Model.OmnitureSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.OmnitureSettings do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.OmnitureSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.OmnitureSettings do
