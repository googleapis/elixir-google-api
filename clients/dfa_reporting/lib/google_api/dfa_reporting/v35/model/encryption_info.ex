...
defmodule GoogleApi.DFAReporting.V35.Model.EncryptionInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.EncryptionInfo do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.EncryptionInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.EncryptionInfo do
