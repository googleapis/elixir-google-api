...
defmodule GoogleApi.DFAReporting.V35.Model.FloodlightActivitiesGenerateTagResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V35.Model.FloodlightActivitiesGenerateTagResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.FloodlightActivitiesGenerateTagResponse.decode(
      value,
      options
    )
  end
