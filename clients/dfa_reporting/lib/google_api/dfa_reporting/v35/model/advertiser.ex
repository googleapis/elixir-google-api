...
defmodule GoogleApi.DFAReporting.V35.Model.Advertiser do
  @moduledoc """
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this advertiser. This is a read-only, auto-generated field.
  *   `kind` (*type:* `String.t`, *default:* `nil`) - Identifies what kind of resource this is. Value: the fixed string "dfareporting#advertiser".
  *   `measurementPartnerLink` (*type:* `GoogleApi.DFAReporting.V35.Model.MeasurementPartnerAdvertiserLink.t`, *default:* `nil`) - Measurement partner advertiser link for tag wrapping.
  ...
  *   `suspended` (*type:* `boolean()`, *default:* `nil`) - Suspension status of this advertiser.
  ...
  @type t :: %__MODULE__{
          ...
          :measurementPartnerLink =>
            GoogleApi.DFAReporting.V35.Model.MeasurementPartnerAdvertiserLink.t() | nil,
          :name => String.t() | nil,
  ...
  field(:measurementPartnerLink,
    as: GoogleApi.DFAReporting.V35.Model.MeasurementPartnerAdvertiserLink
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Advertiser do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Advertiser.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Advertiser do
