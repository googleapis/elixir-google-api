...
defmodule GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteria do
  @moduledoc """
  ...
  *   `reportProperties` (*type:* `GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteriaReportProperties.t`, *default:* `nil`) - The properties of the report.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :reportProperties =>
            GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteriaReportProperties.t() | nil
        }
  ...
  field(:reportProperties,
    as: GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteriaReportProperties
  )
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ReportFloodlightCriteria do
