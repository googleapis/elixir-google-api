...
defmodule GoogleApi.DFAReporting.V35.Model.Language do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Language do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Language.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Language do
