...
defmodule GoogleApi.DFAReporting.V35.Model.ObaIcon do
  @moduledoc """
  ...
  *   `size` (*type:* `GoogleApi.DFAReporting.V35.Model.Size.t`, *default:* `nil`) - OBA icon size.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ObaIcon do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ObaIcon.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ObaIcon do
