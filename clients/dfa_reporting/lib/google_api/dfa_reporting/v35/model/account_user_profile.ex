...
defmodule GoogleApi.DFAReporting.V35.Model.AccountUserProfile do
  @moduledoc """
  ...
  *   `advertiserFilter` (*type:* `GoogleApi.DFAReporting.V35.Model.ObjectFilter.t`, *default:* `nil`) - Filter that describes which advertisers are visible to the user profile.
  *   `campaignFilter` (*type:* `GoogleApi.DFAReporting.V35.Model.ObjectFilter.t`, *default:* `nil`) - Filter that describes which campaigns are visible to the user profile.
  ...
  *   `siteFilter` (*type:* `GoogleApi.DFAReporting.V35.Model.ObjectFilter.t`, *default:* `nil`) - Filter that describes which sites are visible to the user profile.
  ...
  *   `userRoleFilter` (*type:* `GoogleApi.DFAReporting.V35.Model.ObjectFilter.t`, *default:* `nil`) - Filter that describes which user roles are visible to the user profile.
  *   `userRoleId` (*type:* `String.t`, *default:* `nil`) - User role ID of the user profile. This is a required field.
  ...
  @type t :: %__MODULE__{
          ...
          :active => boolean() | nil,
          :advertiserFilter => GoogleApi.DFAReporting.V35.Model.ObjectFilter.t() | nil,
          :campaignFilter => GoogleApi.DFAReporting.V35.Model.ObjectFilter.t() | nil,
          ...
          :locale => String.t() | nil,
          :name => String.t() | nil,
          :siteFilter => GoogleApi.DFAReporting.V35.Model.ObjectFilter.t() | nil,
          :subaccountId => String.t() | nil,
          :traffickerType => String.t() | nil,
          :userAccessType => String.t() | nil,
          :userRoleFilter => GoogleApi.DFAReporting.V35.Model.ObjectFilter.t() | nil,
          :userRoleId => String.t() | nil
        }

  field(:accountId)
  field(:active)
  field(:advertiserFilter, as: GoogleApi.DFAReporting.V35.Model.ObjectFilter)
  field(:campaignFilter, as: GoogleApi.DFAReporting.V35.Model.ObjectFilter)
  field(:comments)
  field(:email)
  field(:id)
  field(:kind)
  field(:locale)
  field(:name)
  field(:siteFilter, as: GoogleApi.DFAReporting.V35.Model.ObjectFilter)
  field(:subaccountId)
  field(:traffickerType)
  field(:userAccessType)
  field(:userRoleFilter, as: GoogleApi.DFAReporting.V35.Model.ObjectFilter)
  field(:userRoleId)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.AccountUserProfile do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.AccountUserProfile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.AccountUserProfile do
