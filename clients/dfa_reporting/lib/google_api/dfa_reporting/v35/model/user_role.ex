...
defmodule GoogleApi.DFAReporting.V35.Model.UserRole do
  @moduledoc """
  ...
  *   `permissions` (*type:* `list(GoogleApi.DFAReporting.V35.Model.UserRolePermission.t)`, *default:* `nil`) - List of permissions associated with this user role.
  *   `subaccountId` (*type:* `String.t`, *default:* `nil`) - Subaccount ID of this user role. This is a read-only field that can be left blank.
  ...
  @type t :: %__MODULE__{
          ...
          :permissions => list(GoogleApi.DFAReporting.V35.Model.UserRolePermission.t()) | nil,
  ...
  field(:permissions, as: GoogleApi.DFAReporting.V35.Model.UserRolePermission, type: :list)
  field(:subaccountId)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.UserRole do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.UserRole.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.UserRole do
