...
defmodule GoogleApi.DFAReporting.V35.Model.AccountPermission do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.AccountPermission do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.AccountPermission.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.AccountPermission do
