...
defmodule GoogleApi.DFAReporting.V35.Model.MobileCarrier do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.MobileCarrier do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.MobileCarrier.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.MobileCarrier do
