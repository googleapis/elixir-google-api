...
defmodule GoogleApi.DFAReporting.V35.Model.FloodlightConfiguration do
  @moduledoc """
  ...
  *   `customViewabilityMetric` (*type:* `GoogleApi.DFAReporting.V35.Model.CustomViewabilityMetric.t`, *default:* `nil`) - Custom Viewability metric for the floodlight configuration.
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V35.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this floodlight configuration. This is a read-only, auto-generated field.
  ...
  *   `lookbackConfiguration` (*type:* `GoogleApi.DFAReporting.V35.Model.LookbackConfiguration.t`, *default:* `nil`) - Lookback window settings for this floodlight configuration.
  ...
  *   `omnitureSettings` (*type:* `GoogleApi.DFAReporting.V35.Model.OmnitureSettings.t`, *default:* `nil`) - Settings for Campaign Manager Omniture integration.
  ...
  *   `tagSettings` (*type:* `GoogleApi.DFAReporting.V35.Model.TagSettings.t`, *default:* `nil`) - Configuration settings for dynamic and image floodlight tags.
  *   `thirdPartyAuthenticationTokens` (*type:* `list(GoogleApi.DFAReporting.V35.Model.ThirdPartyAuthenticationToken.t)`, *default:* `nil`) - List of third-party authentication tokens enabled for this configuration.
  *   `userDefinedVariableConfigurations` (*type:* `list(GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration.t)`, *default:* `nil`) - List of user defined variables enabled for this configuration.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :customViewabilityMetric =>
            GoogleApi.DFAReporting.V35.Model.CustomViewabilityMetric.t() | nil,
          ...
          :omnitureSettings => GoogleApi.DFAReporting.V35.Model.OmnitureSettings.t() | nil,
          :subaccountId => String.t() | nil,
          :tagSettings => GoogleApi.DFAReporting.V35.Model.TagSettings.t() | nil,
          :thirdPartyAuthenticationTokens =>
            list(GoogleApi.DFAReporting.V35.Model.ThirdPartyAuthenticationToken.t()) | nil,
          :userDefinedVariableConfigurations =>
            list(GoogleApi.DFAReporting.V35.Model.UserDefinedVariableConfiguration.t()) | nil
        }
  ...
  field(:customViewabilityMetric, as: GoogleApi.DFAReporting.V35.Model.CustomViewabilityMetric)
  ...
  field(:omnitureSettings, as: GoogleApi.DFAReporting.V35.Model.OmnitureSettings)
  field(:subaccountId)
  field(:tagSettings, as: GoogleApi.DFAReporting.V35.Model.TagSettings)

  field(:thirdPartyAuthenticationTokens,
    as: GoogleApi.DFAReporting.V35.Model.ThirdPartyAuthenticationToken,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.FloodlightConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.FloodlightConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.FloodlightConfiguration do
