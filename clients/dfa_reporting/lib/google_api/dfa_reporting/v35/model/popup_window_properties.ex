...
defmodule GoogleApi.DFAReporting.V35.Model.PopupWindowProperties do
  @moduledoc """
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - Title of popup window.
  ...
  field(:dimension, as: GoogleApi.DFAReporting.V35.Model.Size)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.PopupWindowProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.PopupWindowProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.PopupWindowProperties do
