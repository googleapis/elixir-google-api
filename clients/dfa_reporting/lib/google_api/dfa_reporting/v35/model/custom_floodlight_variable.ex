...
defmodule GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable do
