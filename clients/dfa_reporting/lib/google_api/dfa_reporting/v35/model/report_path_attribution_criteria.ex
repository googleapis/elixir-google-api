...
defmodule GoogleApi.DFAReporting.V35.Model.ReportPathAttributionCriteria do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.ReportPathAttributionCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.ReportPathAttributionCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.ReportPathAttributionCriteria do
