...
defmodule GoogleApi.DFAReporting.V35.Model.Conversion do
  @moduledoc """
  ...
  *   `customVariables` (*type:* `list(GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable.t)`, *default:* `nil`) - Custom floodlight variables. This field may only be used when calling batchinsert; it is not supported by batchupdate.
  ...
  *   `value` (*type:* `float()`, *default:* `nil`) - The value of the conversion.
  ...
  @type t :: %__MODULE__{
          ...
          :customVariables =>
            list(GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable.t()) | nil,
          :dclid => String.t() | nil,
  ...
  field(:customVariables,
    as: GoogleApi.DFAReporting.V35.Model.CustomFloodlightVariable,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.Conversion do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.Conversion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.Conversion do
