...
defmodule GoogleApi.DFAReporting.V35.Model.UserProfile do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V35.Model.UserProfile do
  def decode(value, options) do
    GoogleApi.DFAReporting.V35.Model.UserProfile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V35.Model.UserProfile do
