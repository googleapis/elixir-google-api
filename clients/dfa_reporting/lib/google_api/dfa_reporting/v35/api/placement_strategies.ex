...
defmodule GoogleApi.DFAReporting.V35.Api.PlacementStrategies do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_placement_strategies_delete(
    ...
    request =
      ...
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/placementStrategies/{id}", %{
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.PlacementStrategy{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placement_strategies_get(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.PlacementStrategy.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_strategies_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.PlacementStrategy{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V35.Model.PlacementStrategy.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_placement_strategies_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/placementStrategies", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.PlacementStrategiesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placement_strategies_list(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.PlacementStrategiesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_strategies_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.PlacementStrategiesListResponse{}]
    )
  end
