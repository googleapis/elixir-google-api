...
defmodule GoogleApi.DFAReporting.V35.Api.RemarketingListShares do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.RemarketingListShare{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_remarketing_list_shares_get(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.RemarketingListShare.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_remarketing_list_shares_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.RemarketingListShare{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V35.Model.RemarketingListShare.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_list_shares_patch(
    ...
    request =
      ...
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/remarketingListShares", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
