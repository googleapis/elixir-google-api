...
defmodule GoogleApi.DFAReporting.V35.Api.UserProfiles do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.UserProfile{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_user_profiles_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V35.Model.UserProfile.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_user_profiles_get(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.UserProfile{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.UserProfileList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_user_profiles_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V35.Model.UserProfileList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_user_profiles_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.5/userprofiles", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.UserProfileList{}])
  end
end
