...
defmodule GoogleApi.DFAReporting.V35.Api.RemarketingLists do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.RemarketingList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.RemarketingList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_remarketing_lists_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/remarketingLists/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.RemarketingList{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V35.Model.RemarketingList.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_insert(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def dfareporting_remarketing_lists_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/remarketingLists", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:active` (*type:* `boolean()`) - Select only active or only inactive remarketing lists.
      *   `:floodlightActivityId` (*type:* `String.t`) - Select only remarketing lists that have this floodlight activity ID.
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.RemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.RemarketingListsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_remarketing_lists_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.RemarketingListsListResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_update(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
