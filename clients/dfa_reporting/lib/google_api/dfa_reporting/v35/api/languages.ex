...
defmodule GoogleApi.DFAReporting.V35.Api.Languages do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.LanguagesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_languages_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V35.Model.LanguagesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_languages_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/languages", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.LanguagesListResponse{}]
    )
  end
end
