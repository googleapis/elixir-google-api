...
defmodule GoogleApi.DFAReporting.V35.Api.TargetableRemarketingLists do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_targetable_remarketing_lists_get(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_targetable_remarketing_lists_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.TargetableRemarketingList{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.TargetableRemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_targetable_remarketing_lists_list(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.TargetableRemarketingListsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_targetable_remarketing_lists_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/targetableRemarketingLists", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.TargetableRemarketingListsListResponse{}]
    )
  end
end
