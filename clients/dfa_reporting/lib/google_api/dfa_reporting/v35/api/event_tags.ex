...
defmodule GoogleApi.DFAReporting.V35.Api.EventTags do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_event_tags_delete(
    ...
    request =
      ...
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/eventTags/{id}", %{
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.EventTag{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_event_tags_get(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.EventTag.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_event_tags_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.EventTag{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V35.Model.EventTag.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_event_tags_insert(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.5/userprofiles/{profileId}/eventTags", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.EventTagsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_event_tags_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V35.Model.EventTagsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_event_tags_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.EventTagsListResponse{}]
    )
  end
