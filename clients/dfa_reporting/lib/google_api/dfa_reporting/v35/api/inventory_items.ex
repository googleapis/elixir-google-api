...
defmodule GoogleApi.DFAReporting.V35.Api.InventoryItems do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.InventoryItem{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_inventory_items_get(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.InventoryItem.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_inventory_items_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.InventoryItem{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V35.Model.InventoryItemsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_inventory_items_list(
          ...
          {:ok, GoogleApi.DFAReporting.V35.Model.InventoryItemsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_inventory_items_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V35.Model.InventoryItemsListResponse{}]
    )
  end
end
