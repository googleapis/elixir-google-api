...
defmodule GoogleApi.DFAReporting.V34.Api.AccountActiveAdSummaries do
  @moduledoc """
  ...
  *   `summary_account_id` (*type:* `String.t`) - Account ID.
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_account_active_ad_summaries_get(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_account_active_ad_summaries_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary{}]
    )
  end
end
