...
defmodule GoogleApi.DFAReporting.V34.Api.CreativeFieldValues do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CreativeFieldValue{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_creative_field_values_get(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.CreativeFieldValue.t()} | {:error, Tesla.Env.t()}
  def dfareporting_creative_field_values_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.CreativeFieldValue{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.CreativeFieldValue.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CreativeFieldValuesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_creative_field_values_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.CreativeFieldValuesListResponse{}]
    )
  end
