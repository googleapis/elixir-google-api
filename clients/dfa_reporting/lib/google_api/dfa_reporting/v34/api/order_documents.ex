...
defmodule GoogleApi.DFAReporting.V34.Api.OrderDocuments do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_order_documents_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V34.Model.OrderDocument.t()} | {:error, Tesla.Env.t()}
  def dfareporting_order_documents_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.OrderDocument{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_order_documents_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.OrderDocumentsListResponse{}]
    )
  end
end
