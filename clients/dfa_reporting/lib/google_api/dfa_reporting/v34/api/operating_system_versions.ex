...
defmodule GoogleApi.DFAReporting.V34.Api.OperatingSystemVersions do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.OperatingSystemVersion{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_operating_system_versions_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.OperatingSystemVersion{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.OperatingSystemVersionsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_operating_system_versions_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/operatingSystemVersions", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.OperatingSystemVersionsListResponse{}]
    )
  end
end
