...
defmodule GoogleApi.DFAReporting.V34.Api.Sites do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_sites_get(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.Site.t()} | {:error, Tesla.Env.t()}
  def dfareporting_sites_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/sites/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.Site{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.SitesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_sites_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.SitesListResponse.t()} | {:error, Tesla.Env.t()}
  def dfareporting_sites_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.SitesListResponse{}])
  end
