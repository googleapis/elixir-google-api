...
defmodule GoogleApi.DFAReporting.V34.Api.Browsers do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.BrowsersListResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_browsers_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/browsers", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.BrowsersListResponse{}])
  end
end
