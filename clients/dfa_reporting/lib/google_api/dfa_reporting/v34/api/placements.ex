...
defmodule GoogleApi.DFAReporting.V34.Api.Placements do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.PlacementsGenerateTagsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placements_generatetags(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.PlacementsGenerateTagsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_placements_generatetags(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/placements/generatetags", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.PlacementsGenerateTagsResponse{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.Placement{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placements_get(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.Placement.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_placements_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.Placement{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.Placement.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_placements_insert(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/placements", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.PlacementsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placements_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.PlacementsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_placements_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.PlacementsListResponse{}]
    )
  end
