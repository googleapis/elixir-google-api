...
defmodule GoogleApi.DFAReporting.V34.Api.PlacementGroups do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_placement_groups_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V34.Model.PlacementGroup.t()} | {:error, Tesla.Env.t()}
  def dfareporting_placement_groups_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/placementGroups/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.PlacementGroup{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_placement_groups_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/placementGroups", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_placement_groups_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.PlacementGroupsListResponse{}]
    )
  end
