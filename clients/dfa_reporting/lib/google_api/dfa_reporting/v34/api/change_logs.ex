...
defmodule GoogleApi.DFAReporting.V34.Api.ChangeLogs do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.ChangeLog{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_change_logs_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/changeLogs/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.ChangeLog{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.ChangeLogsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_change_logs_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/changeLogs", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.ChangeLogsListResponse{}]
    )
  end
end
