...
defmodule GoogleApi.DFAReporting.V34.Api.DynamicTargetingKeys do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_dynamic_targeting_keys_insert(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_dynamic_targeting_keys_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/dynamicTargetingKeys", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.DynamicTargetingKeysListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_dynamic_targeting_keys_list(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.DynamicTargetingKeysListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_dynamic_targeting_keys_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.DynamicTargetingKeysListResponse{}]
    )
  end
end
