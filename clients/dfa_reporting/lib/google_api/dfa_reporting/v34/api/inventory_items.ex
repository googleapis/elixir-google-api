...
defmodule GoogleApi.DFAReporting.V34.Api.InventoryItems do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.InventoryItem{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_inventory_items_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.InventoryItem{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_inventory_items_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse{}]
    )
  end
end
