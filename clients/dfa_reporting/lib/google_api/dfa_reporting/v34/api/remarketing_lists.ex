...
defmodule GoogleApi.DFAReporting.V34.Api.RemarketingLists do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.RemarketingList{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_lists_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/remarketingLists/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.RemarketingList{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.RemarketingList.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_lists_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/remarketingLists", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.RemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_remarketing_lists_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.RemarketingListsListResponse{}]
    )
  end
