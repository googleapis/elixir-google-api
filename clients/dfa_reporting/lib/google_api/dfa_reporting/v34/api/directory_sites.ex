...
defmodule GoogleApi.DFAReporting.V34.Api.DirectorySites do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_directory_sites_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V34.Model.DirectorySite.t()} | {:error, Tesla.Env.t()}
  def dfareporting_directory_sites_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/directorySites/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.DirectorySite{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_directory_sites_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/directorySites", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_directory_sites_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.DirectorySitesListResponse{}]
    )
  end
end
