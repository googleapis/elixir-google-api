...
defmodule GoogleApi.DFAReporting.V34.Api.Accounts do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.Account{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_accounts_get(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.Account.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_accounts_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/accounts/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.Account{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.AccountsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_accounts_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.AccountsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_accounts_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/accounts", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.AccountsListResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:id` (*type:* `String.t`) - Account ID.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.Account.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec dfareporting_accounts_patch(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.Account.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_accounts_patch(connection, profile_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
