...
defmodule GoogleApi.DFAReporting.V34.Api.UserProfiles do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.UserProfile{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_user_profiles_get(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.UserProfile{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.UserProfileList{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_user_profiles_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.UserProfileList{}])
  end
end
