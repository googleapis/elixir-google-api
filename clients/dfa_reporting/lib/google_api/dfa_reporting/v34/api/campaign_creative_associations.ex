...
defmodule GoogleApi.DFAReporting.V34.Api.CampaignCreativeAssociations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociation.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociation{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_campaign_creative_associations_insert(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociation.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_campaign_creative_associations_insert(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociation{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociationsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_campaign_creative_associations_list(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociationsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_campaign_creative_associations_list(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.DFAReporting.V34.Model.CampaignCreativeAssociationsListResponse{}]
    )
  end
end
