...
defmodule GoogleApi.DFAReporting.V34.Api.Languages do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.LanguagesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_languages_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.LanguagesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_languages_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/languages", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.LanguagesListResponse{}]
    )
  end
end
