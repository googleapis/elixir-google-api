...
defmodule GoogleApi.DFAReporting.V34.Api.CreativeFields do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_creative_fields_delete(
    ...
    request =
      ...
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/creativeFields/{id}", %{
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CreativeField{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_creative_fields_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.CreativeField{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.CreativeField.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_creative_fields_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/creativeFields", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.CreativeFieldsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_creative_fields_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.CreativeFieldsListResponse{}]
    )
  end
