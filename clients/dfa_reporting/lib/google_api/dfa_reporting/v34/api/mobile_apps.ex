...
defmodule GoogleApi.DFAReporting.V34.Api.MobileApps do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.MobileApp{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_mobile_apps_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V34.Model.MobileApp.t()} | {:error, Tesla.Env.t()}
  def dfareporting_mobile_apps_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/mobileApps/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.MobileApp{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.MobileAppsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_mobile_apps_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V34.Model.MobileAppsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_mobile_apps_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/mobileApps", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.MobileAppsListResponse{}]
    )
  end
end
