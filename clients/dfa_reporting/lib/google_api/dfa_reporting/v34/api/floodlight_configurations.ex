...
defmodule GoogleApi.DFAReporting.V34.Api.FloodlightConfigurations do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.FloodlightConfiguration{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_floodlight_configurations_get(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.FloodlightConfiguration.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_floodlight_configurations_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.FloodlightConfiguration{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V34.Model.FloodlightConfigurationsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_floodlight_configurations_list(
          ...
          {:ok, GoogleApi.DFAReporting.V34.Model.FloodlightConfigurationsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_floodlight_configurations_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.4/userprofiles/{profileId}/floodlightConfigurations", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V34.Model.FloodlightConfigurationsListResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V34.Model.FloodlightConfiguration.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
