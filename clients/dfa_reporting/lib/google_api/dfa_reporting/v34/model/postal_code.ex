...
defmodule GoogleApi.DFAReporting.V34.Model.PostalCode do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PostalCode do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PostalCode.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PostalCode do
