...
defmodule GoogleApi.DFAReporting.V34.Model.FloodlightActivity do
  @moduledoc """
  ...
  *   `floodlightConfigurationIdDimensionValue` (*type:* `GoogleApi.DFAReporting.V34.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of the floodlight configuration. This is a read-only, auto-generated field.
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V34.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this floodlight activity. This is a read-only, auto-generated field.
  ...
  *   `publisherTags` (*type:* `list(GoogleApi.DFAReporting.V34.Model.FloodlightActivityPublisherDynamicTag.t)`, *default:* `nil`) - Publisher dynamic floodlight tags.
  ...
  *   `userDefinedVariableTypes` (*type:* `list(String.t)`, *default:* `nil`) - List of the user-defined variables used by this conversion tag. These map to the "u[1-100]=" in the tags. Each of these can have a user defined type.
  ...
  field(:defaultTags,
    as: GoogleApi.DFAReporting.V34.Model.FloodlightActivityDynamicTag,
    type: :list
  )
  ...
  field(:floodlightConfigurationIdDimensionValue,
    as: GoogleApi.DFAReporting.V34.Model.DimensionValue
  )
  ...
  field(:publisherTags,
    as: GoogleApi.DFAReporting.V34.Model.FloodlightActivityPublisherDynamicTag,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivity do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.FloodlightActivity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivity do
