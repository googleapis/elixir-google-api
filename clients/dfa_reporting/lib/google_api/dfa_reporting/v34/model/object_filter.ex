...
defmodule GoogleApi.DFAReporting.V34.Model.ObjectFilter do
  @moduledoc """
  Object Filter.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ObjectFilter do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ObjectFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ObjectFilter do
