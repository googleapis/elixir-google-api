...
defmodule GoogleApi.DFAReporting.V34.Model.EventTagsListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.EventTagsListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.EventTagsListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.EventTagsListResponse do
