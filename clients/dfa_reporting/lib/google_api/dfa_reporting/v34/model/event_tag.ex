...
defmodule GoogleApi.DFAReporting.V34.Model.EventTag do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.EventTag do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.EventTag.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.EventTag do
