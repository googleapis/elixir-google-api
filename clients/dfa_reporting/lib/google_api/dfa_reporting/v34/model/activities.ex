...
defmodule GoogleApi.DFAReporting.V34.Model.Activities do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Activities do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Activities.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Activities do
