...
defmodule GoogleApi.DFAReporting.V34.Model.ListPopulationRule do
  @moduledoc """
  ...
  *   `listPopulationClauses` (*type:* `list(GoogleApi.DFAReporting.V34.Model.ListPopulationClause.t)`, *default:* `nil`) - Clauses that make up this list population rule. Clauses are joined by ANDs, and the clauses themselves are made up of list population terms which are joined by ORs.
  ...
  @type t :: %__MODULE__{
          ...
          :listPopulationClauses =>
            list(GoogleApi.DFAReporting.V34.Model.ListPopulationClause.t()) | nil
        }
  ...
  field(:listPopulationClauses,
    as: GoogleApi.DFAReporting.V34.Model.ListPopulationClause,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ListPopulationRule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ListPopulationRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ListPopulationRule do
