...
defmodule GoogleApi.DFAReporting.V34.Model.InventoryItem do
  @moduledoc """
  ...
  *   `pricing` (*type:* `GoogleApi.DFAReporting.V34.Model.Pricing.t`, *default:* `nil`) - Pricing of this inventory item.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of inventory item.
  ...
  field(:accountId)
  field(:adSlots, as: GoogleApi.DFAReporting.V34.Model.AdSlot, type: :list)
  field(:advertiserId)
  ...
  field(:pricing, as: GoogleApi.DFAReporting.V34.Model.Pricing)
  field(:projectId)
  field(:rfpId)
  field(:siteId)
  field(:subaccountId)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.InventoryItem do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.InventoryItem.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.InventoryItem do
