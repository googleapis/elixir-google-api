...
defmodule GoogleApi.DFAReporting.V34.Model.OrderDocument do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of this order document
  ...
  @type t :: %__MODULE__{
          ...
          :cancelled => boolean(),
          :createdInfo => GoogleApi.DFAReporting.V34.Model.LastModifiedInfo.t(),
  ...
  field(:cancelled)
  field(:createdInfo, as: GoogleApi.DFAReporting.V34.Model.LastModifiedInfo)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.OrderDocument do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.OrderDocument.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.OrderDocument do
