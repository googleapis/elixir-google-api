...
defmodule GoogleApi.DFAReporting.V34.Model.ReportFloodlightCriteriaReportProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V34.Model.ReportFloodlightCriteriaReportProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportFloodlightCriteriaReportProperties.decode(
      value,
      options
    )
  end
