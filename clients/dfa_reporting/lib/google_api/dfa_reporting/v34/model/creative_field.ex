...
defmodule GoogleApi.DFAReporting.V34.Model.CreativeField do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CreativeField do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CreativeField.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CreativeField do
