...
defmodule GoogleApi.DFAReporting.V34.Model.DayPartTargeting do
  @moduledoc """
  Day Part Targeting.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.DayPartTargeting do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DayPartTargeting.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.DayPartTargeting do
