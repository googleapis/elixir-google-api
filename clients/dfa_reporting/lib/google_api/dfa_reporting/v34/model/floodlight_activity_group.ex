...
defmodule GoogleApi.DFAReporting.V34.Model.FloodlightActivityGroup do
  @moduledoc """
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V34.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this floodlight activity group. This is a read-only, auto-generated field.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivityGroup do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.FloodlightActivityGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivityGroup do
