...
defmodule GoogleApi.DFAReporting.V34.Model.CompanionSetting do
  @moduledoc """
  Companion Settings
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CompanionSetting do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CompanionSetting.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CompanionSetting do
