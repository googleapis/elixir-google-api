...
defmodule GoogleApi.DFAReporting.V34.Model.ChangeLog do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ChangeLog do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ChangeLog.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ChangeLog do
