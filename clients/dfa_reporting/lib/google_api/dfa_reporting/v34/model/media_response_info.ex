...
defmodule GoogleApi.DFAReporting.V34.Model.MediaResponseInfo do
  @moduledoc """
  ...
  *   `verifyHashFromHeader` (*type:* `boolean()`, *default:* `nil`) - Tells Scotty to verify hashes on the agent's behalf by parsing out the X-Goog-Hash header.
  ...
  @type t :: %__MODULE__{
          :customData => String.t(),
          :dataStorageTransform => String.t(),
          :dynamicDropTarget => String.t(),
          :dynamicDropzone => String.t(),
          :requestClass => String.t(),
          :trafficClassField => String.t(),
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.MediaResponseInfo do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.MediaResponseInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.MediaResponseInfo do
