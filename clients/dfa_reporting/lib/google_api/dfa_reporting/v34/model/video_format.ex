...
defmodule GoogleApi.DFAReporting.V34.Model.VideoFormat do
  @moduledoc """
  ...
  *   `targetBitRate` (*type:* `integer()`, *default:* `nil`) - The target bit rate of this video format.
  ...
  @type t :: %__MODULE__{
          ...
          :id => integer() | nil,
          :kind => String.t() | nil,
          :resolution => GoogleApi.DFAReporting.V34.Model.Size.t() | nil,
  ...
  field(:id)
  field(:kind)
  field(:resolution, as: GoogleApi.DFAReporting.V34.Model.Size)
  field(:targetBitRate)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.VideoFormat do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.VideoFormat.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.VideoFormat do
