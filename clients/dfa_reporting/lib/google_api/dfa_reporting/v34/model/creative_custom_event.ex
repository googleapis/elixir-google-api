...
defmodule GoogleApi.DFAReporting.V34.Model.CreativeCustomEvent do
  @moduledoc """
  ...
  *   `videoReportingId` (*type:* `String.t`, *default:* `nil`) - Video reporting ID, used to differentiate multiple videos in a single creative. This is a read-only field.
  ...
  field(:artworkLabel)
  field(:artworkType)
  field(:exitClickThroughUrl, as: GoogleApi.DFAReporting.V34.Model.CreativeClickThroughUrl)
  field(:id)
  field(:popupWindowProperties, as: GoogleApi.DFAReporting.V34.Model.PopupWindowProperties)
  field(:targetType)
  field(:videoReportingId)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CreativeCustomEvent do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CreativeCustomEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CreativeCustomEvent do
