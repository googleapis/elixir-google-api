...
defmodule GoogleApi.DFAReporting.V34.Model.OptimizationActivity do
  @moduledoc """
  ...
  *   `weight` (*type:* `integer()`, *default:* `nil`) - Weight associated with this optimization. The weight assigned will be understood in proportion to the weights assigned to the other optimization activities. Value must be greater than or equal to 1.
  ...
  field(:floodlightActivityIdDimensionValue, as: GoogleApi.DFAReporting.V34.Model.DimensionValue)
  field(:weight)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.OptimizationActivity do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.OptimizationActivity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.OptimizationActivity do
