...
defmodule GoogleApi.DFAReporting.V34.Model.PlacementStrategy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PlacementStrategy do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PlacementStrategy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PlacementStrategy do
