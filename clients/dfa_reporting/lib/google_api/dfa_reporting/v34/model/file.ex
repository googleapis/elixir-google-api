...
defmodule GoogleApi.DFAReporting.V34.Model.File do
  @moduledoc """
  Represents a File resource. A file contains the metadata for a report run. It shows the status of the run and holds the URLs to the generated report data if the run is finished and the status is "REPORT_AVAILABLE".

  ## Attributes

  *   `dateRange` (*type:* `GoogleApi.DFAReporting.V34.Model.DateRange.t`, *default:* `nil`) - The date range for which the file has report data. The date range will always be the absolute date range for which the report is run.
  ...
  *   `urls` (*type:* `GoogleApi.DFAReporting.V34.Model.FileUrls.t`, *default:* `nil`) - The URLs where the completed report file can be downloaded.
  ...
  @type t :: %__MODULE__{
          ...
          :status => String.t() | nil,
          :urls => GoogleApi.DFAReporting.V34.Model.FileUrls.t() | nil
        }
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.File do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.File.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.File do
