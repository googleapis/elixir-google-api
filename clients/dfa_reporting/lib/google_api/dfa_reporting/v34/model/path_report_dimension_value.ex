...
defmodule GoogleApi.DFAReporting.V34.Model.PathReportDimensionValue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PathReportDimensionValue do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PathReportDimensionValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PathReportDimensionValue do
