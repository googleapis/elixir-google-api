...
defmodule GoogleApi.DFAReporting.V34.Model.CustomViewabilityMetricConfiguration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CustomViewabilityMetricConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CustomViewabilityMetricConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CustomViewabilityMetricConfiguration do
