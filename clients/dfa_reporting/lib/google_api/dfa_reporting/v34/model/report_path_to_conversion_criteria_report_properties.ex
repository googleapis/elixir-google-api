...
defmodule GoogleApi.DFAReporting.V34.Model.ReportPathToConversionCriteriaReportProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V34.Model.ReportPathToConversionCriteriaReportProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportPathToConversionCriteriaReportProperties.decode(
      value,
      options
    )
  end
