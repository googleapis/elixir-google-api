...
defmodule GoogleApi.DFAReporting.V34.Model.MobileApp do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.MobileApp do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.MobileApp.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.MobileApp do
