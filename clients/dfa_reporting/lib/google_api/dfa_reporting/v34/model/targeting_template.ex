...
defmodule GoogleApi.DFAReporting.V34.Model.TargetingTemplate do
  @moduledoc """
  ...
  *   `technologyTargeting` (*type:* `GoogleApi.DFAReporting.V34.Model.TechnologyTargeting.t`, *default:* `nil`) - Technology platform targeting criteria.
  ...
  field(:listTargetingExpression, as: GoogleApi.DFAReporting.V34.Model.ListTargetingExpression)
  field(:name)
  field(:subaccountId)
  field(:technologyTargeting, as: GoogleApi.DFAReporting.V34.Model.TechnologyTargeting)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.TargetingTemplate do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.TargetingTemplate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.TargetingTemplate do
