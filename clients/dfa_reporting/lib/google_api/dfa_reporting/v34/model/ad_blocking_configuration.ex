...
defmodule GoogleApi.DFAReporting.V34.Model.AdBlockingConfiguration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.AdBlockingConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.AdBlockingConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.AdBlockingConfiguration do
