...
defmodule GoogleApi.DFAReporting.V34.Model.SiteSettings do
  @moduledoc """
  Site Settings
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.SiteSettings do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.SiteSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.SiteSettings do
