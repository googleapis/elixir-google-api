...
defmodule GoogleApi.DFAReporting.V34.Model.FloodlightActivityPublisherDynamicTag do
  @moduledoc """
  ...
  *   `viewThrough` (*type:* `boolean()`, *default:* `nil`) - Whether this tag is applicable only for view-throughs.
  ...
  @type t :: %__MODULE__{
          ...
          :dynamicTag => GoogleApi.DFAReporting.V34.Model.FloodlightActivityDynamicTag.t() | nil,
          :siteId => String.t() | nil,
  ...
  field(:dynamicTag, as: GoogleApi.DFAReporting.V34.Model.FloodlightActivityDynamicTag)
  field(:siteId)
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V34.Model.FloodlightActivityPublisherDynamicTag do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.FloodlightActivityPublisherDynamicTag.decode(value, options)
  end
end
