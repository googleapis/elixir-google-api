...
defmodule GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.DynamicTargetingKey do
