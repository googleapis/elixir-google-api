...
defmodule GoogleApi.DFAReporting.V34.Model.EventFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.EventFilter do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.EventFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.EventFilter do
