...
defmodule GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod do
  @moduledoc """
  Pricing Period
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod do
