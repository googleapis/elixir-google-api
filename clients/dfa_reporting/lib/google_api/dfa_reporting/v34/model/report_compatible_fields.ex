...
defmodule GoogleApi.DFAReporting.V34.Model.ReportCompatibleFields do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportCompatibleFields do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportCompatibleFields.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportCompatibleFields do
