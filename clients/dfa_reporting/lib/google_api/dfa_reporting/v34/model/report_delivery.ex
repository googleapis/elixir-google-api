...
defmodule GoogleApi.DFAReporting.V34.Model.ReportDelivery do
  @moduledoc """
  ...
  *   `recipients` (*type:* `list(GoogleApi.DFAReporting.V34.Model.Recipient.t)`, *default:* `nil`) - The list of recipients to which to email the report.
  ...
  field(:message)
  field(:recipients, as: GoogleApi.DFAReporting.V34.Model.Recipient, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportDelivery do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportDelivery.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportDelivery do
