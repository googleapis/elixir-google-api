...
defmodule GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.AccountActiveAdSummary do
