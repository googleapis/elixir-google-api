...
defmodule GoogleApi.DFAReporting.V34.Model.Recipient do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Recipient do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Recipient.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Recipient do
