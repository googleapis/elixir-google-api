...
defmodule GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.InventoryItemsListResponse do
