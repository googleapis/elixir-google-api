...
defmodule GoogleApi.DFAReporting.V34.Model.ReportReachCriteria do
  @moduledoc """
  ...
  *   `reachByFrequencyMetricNames` (*type:* `list(String.t)`, *default:* `nil`) - The list of names of Reach By Frequency metrics the report should include.
  ...
  field(:customRichMediaEvents, as: GoogleApi.DFAReporting.V34.Model.CustomRichMediaEvents)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportReachCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportReachCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportReachCriteria do
