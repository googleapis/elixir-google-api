...
defmodule GoogleApi.DFAReporting.V34.Model.ClickTag do
  @moduledoc """
  Creative Click Tag.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Parameter name for the specified click tag. For DISPLAY_IMAGE_GALLERY creative assets, this field must match the value of the creative asset's creativeAssetId.name field.
  ...
  @type t :: %__MODULE__{
          :clickThroughUrl => GoogleApi.DFAReporting.V34.Model.CreativeClickThroughUrl.t() | nil,
          :eventName => String.t() | nil,
          :name => String.t() | nil
        }

  field(:clickThroughUrl, as: GoogleApi.DFAReporting.V34.Model.CreativeClickThroughUrl)
  field(:eventName)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ClickTag do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ClickTag.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ClickTag do
