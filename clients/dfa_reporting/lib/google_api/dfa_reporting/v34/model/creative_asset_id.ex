...
defmodule GoogleApi.DFAReporting.V34.Model.CreativeAssetId do
  @moduledoc """
  Creative Asset ID.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CreativeAssetId do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CreativeAssetId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CreativeAssetId do
