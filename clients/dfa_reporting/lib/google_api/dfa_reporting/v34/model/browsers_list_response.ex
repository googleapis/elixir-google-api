...
defmodule GoogleApi.DFAReporting.V34.Model.BrowsersListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.BrowsersListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.BrowsersListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.BrowsersListResponse do
