...
defmodule GoogleApi.DFAReporting.V34.Model.ReportCrossDimensionReachCriteria do
  @moduledoc """
  The report criteria for a report of type "CROSS_DIMENSION_REACH".

  ## Attributes

  *   `breakdown` (*type:* `list(GoogleApi.DFAReporting.V34.Model.SortedDimension.t)`, *default:* `nil`) - The list of dimensions the report should include.
  ...
  *   `pivoted` (*type:* `boolean()`, *default:* `nil`) - Whether the report is pivoted or not. Defaults to true.
  ...
  @type t :: %__MODULE__{
          :breakdown => list(GoogleApi.DFAReporting.V34.Model.SortedDimension.t()) | nil,
  ...
  field(:breakdown, as: GoogleApi.DFAReporting.V34.Model.SortedDimension, type: :list)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportCrossDimensionReachCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportCrossDimensionReachCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportCrossDimensionReachCriteria do
