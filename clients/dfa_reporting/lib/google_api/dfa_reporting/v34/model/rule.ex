...
defmodule GoogleApi.DFAReporting.V34.Model.Rule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Rule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Rule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Rule do
