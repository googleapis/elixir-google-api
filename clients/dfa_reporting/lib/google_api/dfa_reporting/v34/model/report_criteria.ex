...
defmodule GoogleApi.DFAReporting.V34.Model.ReportCriteria do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportCriteria do
