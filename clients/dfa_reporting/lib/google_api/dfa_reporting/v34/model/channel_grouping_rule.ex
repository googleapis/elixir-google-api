...
defmodule GoogleApi.DFAReporting.V34.Model.ChannelGroupingRule do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Rule name.
  ...
  field(:disjunctiveMatchStatements,
    as: GoogleApi.DFAReporting.V34.Model.DisjunctiveMatchStatement,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ChannelGroupingRule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ChannelGroupingRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ChannelGroupingRule do
