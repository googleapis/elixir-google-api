...
defmodule GoogleApi.DFAReporting.V34.Model.Advertiser do
  @moduledoc """
  ...
  *   `idDimensionValue` (*type:* `GoogleApi.DFAReporting.V34.Model.DimensionValue.t`, *default:* `nil`) - Dimension value for the ID of this advertiser. This is a read-only, auto-generated field.
  *   `kind` (*type:* `String.t`, *default:* `dfareporting#advertiser`) - Identifies what kind of resource this is. Value: the fixed string "dfareporting#advertiser".
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Advertiser do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Advertiser.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Advertiser do
