...
defmodule GoogleApi.DFAReporting.V34.Model.ReportSchedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ReportSchedule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ReportSchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ReportSchedule do
