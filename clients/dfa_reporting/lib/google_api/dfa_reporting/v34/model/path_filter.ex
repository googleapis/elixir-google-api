...
defmodule GoogleApi.DFAReporting.V34.Model.PathFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PathFilter do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PathFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PathFilter do
