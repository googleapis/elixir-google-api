...
defmodule GoogleApi.DFAReporting.V34.Model.Account do
  @moduledoc """
  ...
  *   `teaserSizeLimit` (*type:* `String.t`, *default:* `nil`) - File size limit in kilobytes of Rich Media teaser creatives. Acceptable values are 1 to 10240, inclusive.
  ...
  @type t :: %__MODULE__{
          ...
          :reportsConfiguration => GoogleApi.DFAReporting.V34.Model.ReportsConfiguration.t(),
  ...
  field(:reportsConfiguration, as: GoogleApi.DFAReporting.V34.Model.ReportsConfiguration)
  field(:shareReportsWithTwitter)
  field(:teaserSizeLimit)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Account do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Account.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Account do
