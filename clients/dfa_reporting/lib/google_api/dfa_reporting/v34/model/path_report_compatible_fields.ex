...
defmodule GoogleApi.DFAReporting.V34.Model.PathReportCompatibleFields do
  @moduledoc """
  ...
  *   `pathFilters` (*type:* `list(GoogleApi.DFAReporting.V34.Model.Dimension.t)`, *default:* `nil`) - Dimensions which are compatible to be selected in the "pathFilters" section of the report.
  ...
  field(:pathFilters, as: GoogleApi.DFAReporting.V34.Model.Dimension, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PathReportCompatibleFields do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PathReportCompatibleFields.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PathReportCompatibleFields do
