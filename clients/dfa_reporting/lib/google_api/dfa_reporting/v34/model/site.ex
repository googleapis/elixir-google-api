...
defmodule GoogleApi.DFAReporting.V34.Model.Site do
  @moduledoc """
  ...
  *   `videoSettings` (*type:* `GoogleApi.DFAReporting.V34.Model.SiteVideoSettings.t`, *default:* `nil`) - Default video settings for new placements created under this site. This value will be used to populate the placements.videoSettings field, when no value is specified for the new placement.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :kind => String.t() | nil,
          :name => String.t() | nil,
          :siteContacts => list(GoogleApi.DFAReporting.V34.Model.SiteContact.t()) | nil,
          :siteSettings => GoogleApi.DFAReporting.V34.Model.SiteSettings.t() | nil,
          :subaccountId => String.t() | nil,
          :videoSettings => GoogleApi.DFAReporting.V34.Model.SiteVideoSettings.t() | nil
        }
  ...
  field(:kind)
  field(:name)
  field(:siteContacts, as: GoogleApi.DFAReporting.V34.Model.SiteContact, type: :list)
  field(:siteSettings, as: GoogleApi.DFAReporting.V34.Model.SiteSettings)
  field(:subaccountId)
  field(:videoSettings, as: GoogleApi.DFAReporting.V34.Model.SiteVideoSettings)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Site do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Site.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Site do
