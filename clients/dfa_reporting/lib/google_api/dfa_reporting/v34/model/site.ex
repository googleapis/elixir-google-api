...
defmodule GoogleApi.DFAReporting.V34.Model.Site do
  ...
  *   `videoSettings` (*type:* `GoogleApi.DFAReporting.V34.Model.SiteVideoSettings.t`, *default:* `nil`) - Default video settings for new placements created under this site. This value will be used to populate the placements.videoSettings field, when no value is specified for the new placement.
  ...
  @type t :: %__MODULE__{
          ...
          :kind => String.t(),
          :name => String.t(),
          :siteContacts => list(GoogleApi.DFAReporting.V34.Model.SiteContact.t()),
          :siteSettings => GoogleApi.DFAReporting.V34.Model.SiteSettings.t(),
          :subaccountId => String.t(),
          :videoSettings => GoogleApi.DFAReporting.V34.Model.SiteVideoSettings.t()
        }
