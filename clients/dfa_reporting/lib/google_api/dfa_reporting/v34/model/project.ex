...
defmodule GoogleApi.DFAReporting.V34.Model.Project do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Project do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Project.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Project do
