...
defmodule GoogleApi.DFAReporting.V34.Model.DefaultClickThroughEventTagProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V34.Model.DefaultClickThroughEventTagProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DefaultClickThroughEventTagProperties.decode(value, options)
  end
end
