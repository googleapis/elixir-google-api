...
defmodule GoogleApi.DFAReporting.V34.Model.PricingSchedule do
  @moduledoc """
  Pricing Schedule
  ...
  *   `pricingPeriods` (*type:* `list(GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod.t)`, *default:* `nil`) - Pricing periods for this placement.
  ...
  *   `testingStartDate` (*type:* `Date.t`, *default:* `nil`) - 
  ...
  field(:pricingPeriods,
    as: GoogleApi.DFAReporting.V34.Model.PricingSchedulePricingPeriod,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.PricingSchedule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.PricingSchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.PricingSchedule do
