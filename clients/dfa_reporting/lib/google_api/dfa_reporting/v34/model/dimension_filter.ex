...
defmodule GoogleApi.DFAReporting.V34.Model.DimensionFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.DimensionFilter do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DimensionFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.DimensionFilter do
