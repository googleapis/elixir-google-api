...
defmodule GoogleApi.DFAReporting.V34.Model.DimensionValueList do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Continuation token used to page through dimension values. To retrieve the next page of results, set the next request's "pageToken" to the value of this field. The page token is only valid for a limited amount of time and should not be persisted.
  ...
  @type t :: %__MODULE__{
          :etag => String.t() | nil,
          :items => list(GoogleApi.DFAReporting.V34.Model.DimensionValue.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil
        }

  field(:etag)
  field(:items, as: GoogleApi.DFAReporting.V34.Model.DimensionValue, type: :list)
  field(:kind)
  field(:nextPageToken)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.DimensionValueList do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DimensionValueList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.DimensionValueList do
