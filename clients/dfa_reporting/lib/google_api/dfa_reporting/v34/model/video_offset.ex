...
defmodule GoogleApi.DFAReporting.V34.Model.VideoOffset do
  @moduledoc """
  Video Offset
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.VideoOffset do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.VideoOffset.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.VideoOffset do
