...
defmodule GoogleApi.DFAReporting.V34.Model.ClickThroughUrlSuffixProperties do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ClickThroughUrlSuffixProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ClickThroughUrlSuffixProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ClickThroughUrlSuffixProperties do
