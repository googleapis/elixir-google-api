...
defmodule GoogleApi.DFAReporting.V34.Model.DeepLink do
  @moduledoc """
  ...
  *   `remarketingListIds` (*type:* `list(String.t)`, *default:* `nil`) - Ads served to users on these remarketing lists will use this deep link. Applicable when mobileApp.directory is APPLE_APP_STORE.
  ...
  field(:fallbackUrl)
  field(:kind)
  field(:mobileApp, as: GoogleApi.DFAReporting.V34.Model.MobileApp)
  field(:remarketingListIds, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.DeepLink do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.DeepLink.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.DeepLink do
