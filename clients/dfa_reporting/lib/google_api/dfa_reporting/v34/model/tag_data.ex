...
defmodule GoogleApi.DFAReporting.V34.Model.TagData do
  @moduledoc """
  Placement Tag Data
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.TagData do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.TagData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.TagData do
