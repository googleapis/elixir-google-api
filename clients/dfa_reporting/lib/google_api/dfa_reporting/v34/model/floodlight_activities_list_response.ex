...
defmodule GoogleApi.DFAReporting.V34.Model.FloodlightActivitiesListResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Pagination token to be used for the next list operation.
  ...
  field(:floodlightActivities,
    as: GoogleApi.DFAReporting.V34.Model.FloodlightActivity,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivitiesListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.FloodlightActivitiesListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.FloodlightActivitiesListResponse do
