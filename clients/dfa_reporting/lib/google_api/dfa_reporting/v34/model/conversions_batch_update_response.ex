...
defmodule GoogleApi.DFAReporting.V34.Model.ConversionsBatchUpdateResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.ConversionsBatchUpdateResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.ConversionsBatchUpdateResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.ConversionsBatchUpdateResponse do
