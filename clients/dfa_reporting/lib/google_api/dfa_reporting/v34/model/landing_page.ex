...
defmodule GoogleApi.DFAReporting.V34.Model.LandingPage do
  @moduledoc """
  ...
  *   `url` (*type:* `String.t`, *default:* `nil`) - URL of this landing page. This is a required field.
  ...
  field(:advertiserId)
  field(:archived)
  field(:deepLinks, as: GoogleApi.DFAReporting.V34.Model.DeepLink, type: :list)
  field(:id)
  field(:kind)
  field(:name)
  field(:url)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.LandingPage do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.LandingPage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.LandingPage do
