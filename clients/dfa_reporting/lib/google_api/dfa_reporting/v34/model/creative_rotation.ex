...
defmodule GoogleApi.DFAReporting.V34.Model.CreativeRotation do
  @moduledoc """
  Creative Rotation.

  ## Attributes

  *   `creativeAssignments` (*type:* `list(GoogleApi.DFAReporting.V34.Model.CreativeAssignment.t)`, *default:* `nil`) - Creative assignments in this creative rotation.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.CreativeRotation do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.CreativeRotation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.CreativeRotation do
