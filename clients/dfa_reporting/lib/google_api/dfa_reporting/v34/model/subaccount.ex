...
defmodule GoogleApi.DFAReporting.V34.Model.Subaccount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Subaccount do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Subaccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Subaccount do
