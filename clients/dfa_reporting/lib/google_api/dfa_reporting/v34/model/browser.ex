...
defmodule GoogleApi.DFAReporting.V34.Model.Browser do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V34.Model.Browser do
  def decode(value, options) do
    GoogleApi.DFAReporting.V34.Model.Browser.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V34.Model.Browser do
