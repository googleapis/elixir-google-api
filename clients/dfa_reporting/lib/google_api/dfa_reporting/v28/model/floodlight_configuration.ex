...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V28.Model.FloodlightConfiguration do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"omnitureSettings", :struct, GoogleApi.DFAReporting.V28.Model.OmnitureSettings, options)
    |> deserialize(:"tagSettings", :struct, GoogleApi.DFAReporting.V28.Model.TagSettings, options)
    |> deserialize(:"thirdPartyAuthenticationTokens", :list, GoogleApi.DFAReporting.V28.Model.ThirdPartyAuthenticationToken, options)
    |> deserialize(:"userDefinedVariableConfigurations", :list, GoogleApi.DFAReporting.V28.Model.UserDefinedVariableConfiguration, options)
  end
end
