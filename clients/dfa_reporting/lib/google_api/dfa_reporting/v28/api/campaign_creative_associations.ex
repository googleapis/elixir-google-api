...
defmodule GoogleApi.DFAReporting.V28.Api.CampaignCreativeAssociations do
  ...
  - campaign_id (String.t): Campaign ID in this association.
  ...
  @spec dfareporting_campaign_creative_associations_insert(
          ...
          {:ok, GoogleApi.DFAReporting.V28.Model.CampaignCreativeAssociation.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_campaign_creative_associations_insert(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.CampaignCreativeAssociation{}]
    )
  end
  ...
  @spec dfareporting_campaign_creative_associations_list(
          ...
          {:ok, GoogleApi.DFAReporting.V28.Model.CampaignCreativeAssociationsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_campaign_creative_associations_list(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.DFAReporting.V28.Model.CampaignCreativeAssociationsListResponse{}]
    )
  end
end
