...
defmodule GoogleApi.DFAReporting.V28.Api.Sites do
  ...
  """
  @spec dfareporting_sites_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.Site.t()} | {:error, Tesla.Env.t()}
  def dfareporting_sites_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/sites/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.Site{}])
  end
  ...
  {:error, info} on failure
  """
  @spec dfareporting_sites_insert(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.Site.t()} | {:error, Tesla.Env.t()}
  def dfareporting_sites_insert(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/sites", %{
        "profileId" => URI.encode_www_form(profile_id)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  - optional_params (KeywordList): [optional] Optional parameters
    ...
    - :campaignIds ([String.t]): Select only sites with these campaign IDs.
    - :directorySiteIds ([String.t]): Select only sites with these directory site IDs.
    - :ids ([String.t]): Select only sites with these IDs.
    - :maxResults (integer()): Maximum number of results to return.
    - :pageToken (String.t): Value of the nextPageToken from the previous result page.
    - :searchString (String.t): Allows searching for objects by name, ID or keyName. Wildcards (*) are allowed. For example, \&quot;site*2015\&quot; will return objects with names like \&quot;site June 2015\&quot;, \&quot;site April 2015\&quot;, or simply \&quot;site 2015\&quot;. Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \&quot;site\&quot; will match objects with name \&quot;my site\&quot;, \&quot;site 2015\&quot;, or simply \&quot;site\&quot;.
    - :sortField (String.t): Field by which to sort the list.
    - :sortOrder (String.t): Order of sorted results.
    - :subaccountId (String.t): Select only sites with this subaccount ID.
  ...
  {:error, info} on failure
  """
  @spec dfareporting_sites_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.SitesListResponse.t()} | {:error, Tesla.Env.t()}
  def dfareporting_sites_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.SitesListResponse{}])
  end
  ...
  {:error, info} on failure
  """
  @spec dfareporting_sites_patch(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.Site.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec dfareporting_sites_update(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.Site.t()} | {:error, Tesla.Env.t()}
