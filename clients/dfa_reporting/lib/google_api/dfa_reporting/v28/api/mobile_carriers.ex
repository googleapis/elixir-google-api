...
defmodule GoogleApi.DFAReporting.V28.Api.MobileCarriers do
  ...
  """
  @spec dfareporting_mobile_carriers_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.MobileCarrier.t()} | {:error, Tesla.Env.t()}
  def dfareporting_mobile_carriers_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/mobileCarriers/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.MobileCarrier{}])
  end
  ...
  {:error, info} on failure
  """
  @spec dfareporting_mobile_carriers_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.MobileCarriersListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_mobile_carriers_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/mobileCarriers", %{
        "profileId" => URI.encode_www_form(profile_id)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.MobileCarriersListResponse{}]
    )
  end
end
