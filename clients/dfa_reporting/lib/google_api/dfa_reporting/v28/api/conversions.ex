...
defmodule GoogleApi.DFAReporting.V28.Api.Conversions do
  ...
  """
  @spec dfareporting_conversions_batchinsert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.ConversionsBatchInsertResponse.t} | {:error, Tesla.Env.t}
  def dfareporting_conversions_batchinsert(connection, profile_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.DFAReporting.V28.Model.ConversionsBatchInsertResponse{})
  end
  ...
  {:error, info} on failure
  """
  @spec dfareporting_conversions_batchupdate(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.ConversionsBatchUpdateResponse.t} | {:error, Tesla.Env.t}
  def dfareporting_conversions_batchupdate(connection, profile_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DFAReporting.V28.Model.ConversionsBatchUpdateResponse{})
  end
end
