...
defmodule GoogleApi.DFAReporting.V28.Api.Orders do
  ...
  - project_id (String): Project ID for orders.
  - id (String): Order ID.
  ...
  """
  @spec dfareporting_orders_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.Order.t} | {:error, Tesla.Env.t}
  def dfareporting_orders_get(connection, profile_id, project_id, id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.DFAReporting.V28.Model.Order{})
  end
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quota_user (String): Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    - :user_ip (String): IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    - :ids (List[String]): Select only orders with these IDs.
    ...
    - :site_id (List[String]): Select only orders that are associated with these site IDs.
  ...
  {:error, info} on failure
  """
  @spec dfareporting_orders_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.OrdersListResponse.t} | {:error, Tesla.Env.t}
  def dfareporting_orders_list(connection, profile_id, project_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DFAReporting.V28.Model.OrdersListResponse{})
  end
end
