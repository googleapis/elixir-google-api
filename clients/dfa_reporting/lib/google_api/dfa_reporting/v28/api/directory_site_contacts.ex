...
defmodule GoogleApi.DFAReporting.V28.Api.DirectorySiteContacts do
  ...
  - id (String): Directory site contact ID.
  ...
  """
  @spec dfareporting_directory_site_contacts_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.DirectorySiteContact.t} | {:error, Tesla.Env.t}
  def dfareporting_directory_site_contacts_get(connection, profile_id, id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.DFAReporting.V28.Model.DirectorySiteContact{})
  end
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quota_user (String): Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    - :user_ip (String): IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    - :directory_site_ids (List[String]): Select only directory site contacts with these directory site IDs. This is a required field.
    - :ids (List[String]): Select only directory site contacts with these IDs.
  ...
  {:error, info} on failure
  """
  @spec dfareporting_directory_site_contacts_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.DirectorySiteContactsListResponse.t} | {:error, Tesla.Env.t}
  def dfareporting_directory_site_contacts_list(connection, profile_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DFAReporting.V28.Model.DirectorySiteContactsListResponse{})
  end
end
