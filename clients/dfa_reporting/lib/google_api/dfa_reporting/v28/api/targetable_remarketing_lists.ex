...
defmodule GoogleApi.DFAReporting.V28.Api.TargetableRemarketingLists do
  @moduledoc """
  ...
  {:ok, %GoogleApi.DFAReporting.V28.Model.TargetableRemarketingList{}} on success
  {:error, info} on failure
  """
  @spec dfareporting_targetable_remarketing_lists_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.TargetableRemarketingList.t} | {:error, Tesla.Env.t}
  def dfareporting_targetable_remarketing_lists_get(connection, profile_id, id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.DFAReporting.V28.Model.TargetableRemarketingList{})
  end
  ...
  - connection (GoogleApi.DFAReporting.V28.Connection): Connection to server
  - profile_id (String): User profile ID associated with this request.
  - advertiser_id (String): Select only targetable remarketing lists targetable by these advertisers.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:ok, %GoogleApi.DFAReporting.V28.Model.TargetableRemarketingListsListResponse{}} on success
  {:error, info} on failure
  """
  @spec dfareporting_targetable_remarketing_lists_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DFAReporting.V28.Model.TargetableRemarketingListsListResponse.t} | {:error, Tesla.Env.t}
  def dfareporting_targetable_remarketing_lists_list(connection, profile_id, advertiser_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DFAReporting.V28.Model.TargetableRemarketingListsListResponse{})
  end
end
