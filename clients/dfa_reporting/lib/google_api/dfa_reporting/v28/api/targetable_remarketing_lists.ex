...
defmodule GoogleApi.DFAReporting.V28.Api.TargetableRemarketingLists do
  ...
  @spec dfareporting_targetable_remarketing_lists_get(
          ...
          {:ok, GoogleApi.DFAReporting.V28.Model.TargetableRemarketingList.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_targetable_remarketing_lists_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.TargetableRemarketingList{}]
    )
  end
  ...
  - connection (GoogleApi.DFAReporting.V28.Connection): Connection to server
  - profile_id (String.t): User profile ID associated with this request.
  - advertiser_id (String.t): Select only targetable remarketing lists targetable by these advertisers.
  - optional_params (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  @spec dfareporting_targetable_remarketing_lists_list(
          ...
          {:ok, GoogleApi.DFAReporting.V28.Model.TargetableRemarketingListsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_targetable_remarketing_lists_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/targetableRemarketingLists", %{
        "profileId" => URI.encode_www_form(profile_id)
      })
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.TargetableRemarketingListsListResponse{}]
    )
  end
end
