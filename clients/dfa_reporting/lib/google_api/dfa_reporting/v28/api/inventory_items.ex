...
defmodule GoogleApi.DFAReporting.V28.Api.InventoryItems do
  ...
  @spec dfareporting_inventory_items_get(
          ...
          String.t(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V28.Model.InventoryItem.t()} | {:error, Tesla.Env.t()}
  def dfareporting_inventory_items_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.InventoryItem{}])
  end
  ...
  - optional_params (KeywordList): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :ids ([String.t]): Select only inventory items with these IDs.
    - :inPlan (boolean()): Select only inventory items that are in plan.
    - :maxResults (integer()): Maximum number of results to return.
    - :orderId ([String.t]): Select only inventory items that belong to specified orders.
    - :pageToken (String.t): Value of the nextPageToken from the previous result page.
    - :siteId ([String.t]): Select only inventory items that are associated with these sites.
    - :sortField (String.t): Field by which to sort the list.
    - :sortOrder (String.t): Order of sorted results.
    - :type (String.t): Select only inventory items with this type.
  ...
  {:error, info} on failure
  """
  @spec dfareporting_inventory_items_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.InventoryItemsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_inventory_items_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.InventoryItemsListResponse{}]
    )
  end
end
