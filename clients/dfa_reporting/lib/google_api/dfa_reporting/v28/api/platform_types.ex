...
defmodule GoogleApi.DFAReporting.V28.Api.PlatformTypes do
  ...
  """
  @spec dfareporting_platform_types_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.PlatformType.t()} | {:error, Tesla.Env.t()}
  def dfareporting_platform_types_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/platformTypes/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.PlatformType{}])
  end
  ...
  {:error, info} on failure
  """
  @spec dfareporting_platform_types_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V28.Model.PlatformTypesListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_platform_types_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v2.8/userprofiles/{profileId}/platformTypes", %{
        "profileId" => URI.encode_www_form(profile_id)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V28.Model.PlatformTypesListResponse{}]
    )
  end
end
