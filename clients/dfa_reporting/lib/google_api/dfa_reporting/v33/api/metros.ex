...
defmodule GoogleApi.DFAReporting.V33.Api.Metros do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.MetrosListResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_metros_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/metros", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.MetrosListResponse{}])
  end
end
