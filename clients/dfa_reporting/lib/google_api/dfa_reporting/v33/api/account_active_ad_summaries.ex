...
defmodule GoogleApi.DFAReporting.V33.Api.AccountActiveAdSummaries do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.AccountActiveAdSummary{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_account_active_ad_summaries_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.AccountActiveAdSummary{}]
    )
  end
end
