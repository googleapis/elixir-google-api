...
defmodule GoogleApi.DFAReporting.V33.Api.RemarketingListShares do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.RemarketingListShare{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_list_shares_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.RemarketingListShare{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.DFAReporting.V33.Connection.t`) - Connection to server
  *   `profile_id` (*type:* `String.t`) - User profile ID associated with this request.
  *   `remarketing_list_id` (*type:* `String.t`) - RemarketingList ID.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:id` (*type:* `String.t`) - RemarketingListShare ID.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V33.Model.RemarketingListShare.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_list_shares_patch(
    ...
    request =
      ...
      |> Request.url(
        "/dfareporting/v3.3/userprofiles/{profileId}/remarketingLists/{remarketingListId}/remarketingListShares",
        %{
          "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_remarketing_list_shares_update(
    ...
    request =
      Request.new()
      |> Request.method(:put)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/remarketingListShares", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
