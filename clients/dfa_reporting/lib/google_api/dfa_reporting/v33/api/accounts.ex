...
defmodule GoogleApi.DFAReporting.V33.Api.Accounts do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.Account{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_accounts_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/accounts/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.Account{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.AccountsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_accounts_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/accounts", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.AccountsListResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:id` (*type:* `String.t`) - Account ID.
      *   `:body` (*type:* `GoogleApi.DFAReporting.V33.Model.Account.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
