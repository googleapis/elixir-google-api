...
defmodule GoogleApi.DFAReporting.V33.Api.MobileCarriers do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_mobile_carriers_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/mobileCarriers/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.MobileCarrier{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_mobile_carriers_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/mobileCarriers", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.MobileCarriersListResponse{}]
    )
  end
end
