...
defmodule GoogleApi.DFAReporting.V33.Api.UserProfiles do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.UserProfile{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_user_profiles_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V33.Model.UserProfile.t()} | {:error, Tesla.Env.t()}
  def dfareporting_user_profiles_get(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.UserProfile{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.UserProfileList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_user_profiles_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V33.Model.UserProfileList.t()} | {:error, Tesla.Env.t()}
  def dfareporting_user_profiles_list(connection, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.UserProfileList{}])
  end
end
