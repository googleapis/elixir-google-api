...
defmodule GoogleApi.DFAReporting.V33.Api.Files do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_files_get(connection, report_id, file_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/reports/{reportId}/files/{fileId}", %{
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_files_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/files", %{
