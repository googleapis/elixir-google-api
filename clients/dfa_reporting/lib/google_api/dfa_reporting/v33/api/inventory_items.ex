...
defmodule GoogleApi.DFAReporting.V33.Api.InventoryItems do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_inventory_items_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V33.Model.InventoryItem.t()} | {:error, Tesla.Env.t()}
  def dfareporting_inventory_items_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.InventoryItem{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_inventory_items_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.InventoryItemsListResponse{}]
    )
  end
end
