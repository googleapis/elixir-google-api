...
defmodule GoogleApi.DFAReporting.V33.Api.Languages do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.LanguagesListResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_languages_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/languages", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.LanguagesListResponse{}]
    )
  end
end
