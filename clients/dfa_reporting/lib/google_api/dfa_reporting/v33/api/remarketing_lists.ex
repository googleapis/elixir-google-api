...
defmodule GoogleApi.DFAReporting.V33.Api.RemarketingLists do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_remarketing_lists_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DFAReporting.V33.Model.RemarketingList.t()} | {:error, Tesla.Env.t()}
  def dfareporting_remarketing_lists_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/remarketingLists/{id}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.RemarketingList{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.RemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_list(
          ...
          {:ok, GoogleApi.DFAReporting.V33.Model.RemarketingListsListResponse.t()}
          | {:error, Tesla.Env.t()}
  def dfareporting_remarketing_lists_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.RemarketingListsListResponse{}]
    )
  end
