...
defmodule GoogleApi.DFAReporting.V33.Api.Regions do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.RegionsListResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_regions_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v3.3/userprofiles/{profileId}/regions", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.RegionsListResponse{}])
  end
end
