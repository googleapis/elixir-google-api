...
defmodule GoogleApi.DFAReporting.V33.Api.EventTags do
  ...
  *   `{:error, info}` on failure
  """
  @spec dfareporting_event_tags_patch(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V33.Model.EventTag.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def dfareporting_event_tags_patch(connection, profile_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
