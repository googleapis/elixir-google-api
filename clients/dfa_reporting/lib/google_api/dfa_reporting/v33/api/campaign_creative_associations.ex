...
defmodule GoogleApi.DFAReporting.V33.Api.CampaignCreativeAssociations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.DFAReporting.V33.Model.CampaignCreativeAssociation.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.CampaignCreativeAssociation{}}` on success
  *   `{:error, info}` on failure
  ...
  def dfareporting_campaign_creative_associations_insert(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V33.Model.CampaignCreativeAssociation{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V33.Model.CampaignCreativeAssociationsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def dfareporting_campaign_creative_associations_list(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.DFAReporting.V33.Model.CampaignCreativeAssociationsListResponse{}]
    )
  end
end
