...
defmodule GoogleApi.DFAReporting.V33.Model.ClickThroughUrl do
  @moduledoc """
  Click-through URL
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.ClickThroughUrl do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.ClickThroughUrl.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.ClickThroughUrl do
