...
defmodule GoogleApi.DFAReporting.V33.Model.Flight do
  @moduledoc """
  Flight
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.Flight do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.Flight.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.Flight do
