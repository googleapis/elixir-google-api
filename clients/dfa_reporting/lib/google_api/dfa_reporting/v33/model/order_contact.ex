...
defmodule GoogleApi.DFAReporting.V33.Model.OrderContact do
  @moduledoc """
  Contact of an order.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.OrderContact do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.OrderContact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.OrderContact do
