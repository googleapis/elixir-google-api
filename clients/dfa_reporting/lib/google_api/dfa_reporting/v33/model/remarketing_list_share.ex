...
defmodule GoogleApi.DFAReporting.V33.Model.RemarketingListShare do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.RemarketingListShare do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.RemarketingListShare.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.RemarketingListShare do
