...
defmodule GoogleApi.DFAReporting.V33.Model.FloodlightConfiguration do
  @moduledoc """
  ...
  *   `userDefinedVariableConfigurations` (*type:* `list(GoogleApi.DFAReporting.V33.Model.UserDefinedVariableConfiguration.t)`, *default:* `nil`) - List of user defined variables enabled for this configuration.
  ...
  @type t :: %__MODULE__{
          ...
          :customViewabilityMetric =>
            GoogleApi.DFAReporting.V33.Model.CustomViewabilityMetric.t() | nil,
          ...
          :lookbackConfiguration =>
            GoogleApi.DFAReporting.V33.Model.LookbackConfiguration.t() | nil,
          :naturalSearchConversionAttributionOption => String.t() | nil,
          :omnitureSettings => GoogleApi.DFAReporting.V33.Model.OmnitureSettings.t() | nil,
          :subaccountId => String.t() | nil,
          :tagSettings => GoogleApi.DFAReporting.V33.Model.TagSettings.t() | nil,
          :thirdPartyAuthenticationTokens =>
            list(GoogleApi.DFAReporting.V33.Model.ThirdPartyAuthenticationToken.t()) | nil,
          :userDefinedVariableConfigurations =>
            list(GoogleApi.DFAReporting.V33.Model.UserDefinedVariableConfiguration.t()) | nil
        }
  ...
  field(:customViewabilityMetric, as: GoogleApi.DFAReporting.V33.Model.CustomViewabilityMetric)
  ...
  field(:omnitureSettings, as: GoogleApi.DFAReporting.V33.Model.OmnitureSettings)
  field(:subaccountId)
  field(:tagSettings, as: GoogleApi.DFAReporting.V33.Model.TagSettings)

  field(:thirdPartyAuthenticationTokens,
    as: GoogleApi.DFAReporting.V33.Model.ThirdPartyAuthenticationToken,
    type: :list
  )

  field(:userDefinedVariableConfigurations,
    as: GoogleApi.DFAReporting.V33.Model.UserDefinedVariableConfiguration,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.FloodlightConfiguration do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.FloodlightConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.FloodlightConfiguration do
