...
defmodule GoogleApi.DFAReporting.V33.Model.TargetableRemarketingList do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.TargetableRemarketingList do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.TargetableRemarketingList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.TargetableRemarketingList do
