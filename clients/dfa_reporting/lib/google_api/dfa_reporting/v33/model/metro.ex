...
defmodule GoogleApi.DFAReporting.V33.Model.Metro do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.Metro do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.Metro.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.Metro do
