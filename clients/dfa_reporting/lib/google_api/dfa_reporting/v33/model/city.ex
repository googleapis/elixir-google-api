...
defmodule GoogleApi.DFAReporting.V33.Model.City do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.City do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.City.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.City do
