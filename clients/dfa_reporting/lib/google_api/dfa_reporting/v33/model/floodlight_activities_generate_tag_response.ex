...
defmodule GoogleApi.DFAReporting.V33.Model.FloodlightActivitiesGenerateTagResponse do
  @moduledoc """
  ...
  *   `kind` (*type:* `String.t`, *default:* `dfareporting#floodlightActivitiesGenerateTagResponse`) - Identifies what kind of resource this is. Value: the fixed string "dfareporting#floodlightActivitiesGenerateTagResponse".
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V33.Model.FloodlightActivitiesGenerateTagResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.FloodlightActivitiesGenerateTagResponse.decode(
      value,
      options
    )
  end
