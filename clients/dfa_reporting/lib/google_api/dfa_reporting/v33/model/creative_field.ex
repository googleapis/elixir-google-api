...
defmodule GoogleApi.DFAReporting.V33.Model.CreativeField do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CreativeField do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CreativeField.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CreativeField do
