...
defmodule GoogleApi.DFAReporting.V33.Model.FsCommand do
  @moduledoc """
  FsCommand.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.FsCommand do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.FsCommand.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.FsCommand do
