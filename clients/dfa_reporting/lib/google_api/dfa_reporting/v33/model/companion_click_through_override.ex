...
defmodule GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride do
