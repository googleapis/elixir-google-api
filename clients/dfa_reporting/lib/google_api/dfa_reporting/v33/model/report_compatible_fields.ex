...
defmodule GoogleApi.DFAReporting.V33.Model.ReportCompatibleFields do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.ReportCompatibleFields do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.ReportCompatibleFields.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.ReportCompatibleFields do
