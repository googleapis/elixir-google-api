...
defmodule GoogleApi.DFAReporting.V33.Model.ReportPathToConversionCriteria do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.ReportPathToConversionCriteria do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.ReportPathToConversionCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.ReportPathToConversionCriteria do
