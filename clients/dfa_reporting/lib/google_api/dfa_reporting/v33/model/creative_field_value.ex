...
defmodule GoogleApi.DFAReporting.V33.Model.CreativeFieldValue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CreativeFieldValue do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CreativeFieldValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CreativeFieldValue do
