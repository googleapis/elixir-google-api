...
defmodule GoogleApi.DFAReporting.V33.Model.OperatingSystem do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.OperatingSystem do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.OperatingSystem.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.OperatingSystem do
