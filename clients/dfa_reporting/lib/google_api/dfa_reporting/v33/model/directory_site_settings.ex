...
defmodule GoogleApi.DFAReporting.V33.Model.DirectorySiteSettings do
  @moduledoc """
  ...
  *   `interstitialPlacementAccepted` (*type:* `boolean()`, *default:* `nil`) - Whether this site accepts interstitial ads.
  ...
  field(:dfpSettings, as: GoogleApi.DFAReporting.V33.Model.DfpSettings)
  field(:instreamVideoPlacementAccepted)
  field(:interstitialPlacementAccepted)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.DirectorySiteSettings do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.DirectorySiteSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.DirectorySiteSettings do
