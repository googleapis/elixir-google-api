...
defmodule GoogleApi.DFAReporting.V33.Model.FloodlightActivityGroup do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.FloodlightActivityGroup do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.FloodlightActivityGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.FloodlightActivityGroup do
