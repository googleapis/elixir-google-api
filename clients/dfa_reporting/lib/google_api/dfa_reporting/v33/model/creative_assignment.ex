...
defmodule GoogleApi.DFAReporting.V33.Model.CreativeAssignment do
  @moduledoc """
  Creative Assignment.
  ...
  *   `clickThroughUrl` (*type:* `GoogleApi.DFAReporting.V33.Model.ClickThroughUrl.t`, *default:* `nil`) - Click-through URL of the creative assignment.
  *   `companionCreativeOverrides` (*type:* `list(GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride.t)`, *default:* `nil`) - Companion creative overrides for this creative assignment. Applicable to video ads.
  ...
  *   `weight` (*type:* `integer()`, *default:* `nil`) - Weight of the creative assignment, applicable when the rotation type is CREATIVE_ROTATION_TYPE_RANDOM. Value must be greater than or equal to 1.
  ...
  field(
    :companionCreativeOverrides,
    as: GoogleApi.DFAReporting.V33.Model.CompanionClickThroughOverride,
    type: :list
  )
  ...
  field(:creativeId)
  field(:creativeIdDimensionValue, as: GoogleApi.DFAReporting.V33.Model.DimensionValue)
  field(:endTime, as: DateTime)

  field(
    :richMediaExitOverrides,
    as: GoogleApi.DFAReporting.V33.Model.RichMediaExitOverride,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CreativeAssignment do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CreativeAssignment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CreativeAssignment do
