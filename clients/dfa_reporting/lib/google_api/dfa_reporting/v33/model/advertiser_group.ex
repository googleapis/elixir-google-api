...
defmodule GoogleApi.DFAReporting.V33.Model.AdvertiserGroup do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.AdvertiserGroup do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.AdvertiserGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.AdvertiserGroup do
