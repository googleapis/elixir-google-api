...
defmodule GoogleApi.DFAReporting.V33.Model.SiteContact do
  @moduledoc """
  Site Contact
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.SiteContact do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.SiteContact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.SiteContact do
