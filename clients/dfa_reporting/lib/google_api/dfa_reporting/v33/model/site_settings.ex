...
defmodule GoogleApi.DFAReporting.V33.Model.SiteSettings do
  @moduledoc """
  Site Settings
  ...
  *   `tagSetting` (*type:* `GoogleApi.DFAReporting.V33.Model.TagSetting.t`, *default:* `nil`) - Configuration settings for dynamic and image floodlight tags.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.SiteSettings do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.SiteSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.SiteSettings do
