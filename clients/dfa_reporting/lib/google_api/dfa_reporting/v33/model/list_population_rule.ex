...
defmodule GoogleApi.DFAReporting.V33.Model.ListPopulationRule do
  @moduledoc """
  ...
  *   `listPopulationClauses` (*type:* `list(GoogleApi.DFAReporting.V33.Model.ListPopulationClause.t)`, *default:* `nil`) - Clauses that make up this list population rule. Clauses are joined by ANDs, and the clauses themselves are made up of list population terms which are joined by ORs.
  ...
  field(
    :listPopulationClauses,
    as: GoogleApi.DFAReporting.V33.Model.ListPopulationClause,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.ListPopulationRule do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.ListPopulationRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.ListPopulationRule do
