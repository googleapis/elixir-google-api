...
defmodule GoogleApi.DFAReporting.V33.Model.DeepLink do
  @moduledoc """
  ...
  *   `mobileApp` (*type:* `GoogleApi.DFAReporting.V33.Model.MobileApp.t`, *default:* `nil`) - The mobile app targeted by this deep link.
  *   `remarketingListIds` (*type:* `list(String.t)`, *default:* `nil`) - Ads served to users on these remarketing lists will use this deep link. Applicable when mobileApp.directory is APPLE_APP_STORE.
  ...
  @type t :: %__MODULE__{
          ...
          :kind => String.t() | nil,
          :mobileApp => GoogleApi.DFAReporting.V33.Model.MobileApp.t() | nil,
  ...
  field(:fallbackUrl)
  field(:kind)
  field(:mobileApp, as: GoogleApi.DFAReporting.V33.Model.MobileApp)
  field(:remarketingListIds, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.DeepLink do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.DeepLink.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.DeepLink do
