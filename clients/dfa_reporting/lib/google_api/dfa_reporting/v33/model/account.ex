...
defmodule GoogleApi.DFAReporting.V33.Model.Account do
  @moduledoc """
  ...
  *   `currencyId` (*type:* `String.t`, *default:* `nil`) - ID of currency associated with this account. This is a required field.
  ...
  *   `locale` (*type:* `String.t`, *default:* `nil`) - Locale of this account.
      Acceptable values are: 
      - "cs" (Czech) 
      - "de" (German) 
      - "en" (English) 
  ...
  *   `reportsConfiguration` (*type:* `GoogleApi.DFAReporting.V33.Model.ReportsConfiguration.t`, *default:* `nil`) - Reporting configuration of this account.
  ...
  *   `teaserSizeLimit` (*type:* `String.t`, *default:* `nil`) - File size limit in kilobytes of Rich Media teaser creatives. Acceptable values are 1 to 10240, inclusive.
  ...
  field(:reportsConfiguration, as: GoogleApi.DFAReporting.V33.Model.ReportsConfiguration)
  field(:shareReportsWithTwitter)
  field(:teaserSizeLimit)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.Account do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.Account.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.Account do
