...
defmodule GoogleApi.DFAReporting.V33.Model.CompanionSetting do
  ...
  *   `enabledSizes` (*type:* `list(GoogleApi.DFAReporting.V33.Model.Size.t)`, *default:* `nil`) - Allowlist of companion sizes to be served to this placement. Set this list to null or empty to serve all companion sizes.
