...
defmodule GoogleApi.DFAReporting.V33.Model.CreativesListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CreativesListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CreativesListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CreativesListResponse do
