...
defmodule GoogleApi.DFAReporting.V33.Model.Region do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.Region do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.Region.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.Region do
