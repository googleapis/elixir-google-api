...
defmodule GoogleApi.DFAReporting.V33.Model.CampaignsListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.CampaignsListResponse do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.CampaignsListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.CampaignsListResponse do
