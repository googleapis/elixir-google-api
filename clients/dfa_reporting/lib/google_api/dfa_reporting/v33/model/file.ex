...
defmodule GoogleApi.DFAReporting.V33.Model.File do
  ...
  *   `mediaRequestInfo` (*type:* `GoogleApi.DFAReporting.V33.Model.MediaRequestInfo.t`, *default:* `nil`) - 
  *   `mediaResponseInfo` (*type:* `GoogleApi.DFAReporting.V33.Model.MediaResponseInfo.t`, *default:* `nil`) - 
  ...
  *   `urls` (*type:* `GoogleApi.DFAReporting.V33.Model.FileUrls.t`, *default:* `nil`) - The URLs where the completed report file can be downloaded.
  ...
  @type t :: %__MODULE__{
          ...
          :mediaRequestInfo => GoogleApi.DFAReporting.V33.Model.MediaRequestInfo.t(),
          :mediaResponseInfo => GoogleApi.DFAReporting.V33.Model.MediaResponseInfo.t(),
          :reportId => String.t(),
          :status => String.t(),
  ...
  field(:mediaRequestInfo, as: GoogleApi.DFAReporting.V33.Model.MediaRequestInfo)
  field(:mediaResponseInfo, as: GoogleApi.DFAReporting.V33.Model.MediaResponseInfo)
  field(:reportId)
  field(:status)
