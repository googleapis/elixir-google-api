...
defmodule GoogleApi.DFAReporting.V33.Model.PlacementAssignment do
  @moduledoc """
  ...
  *   `sslRequired` (*type:* `boolean()`, *default:* `nil`) - Whether the placement to be assigned requires SSL. This is a read-only field that is auto-generated when the ad is inserted or updated.
  ...
  @type t :: %__MODULE__{
          ...
          :placementIdDimensionValue => GoogleApi.DFAReporting.V33.Model.DimensionValue.t() | nil,
          :sslRequired => boolean() | nil
        }

  field(:active)
  field(:placementId)
  field(:placementIdDimensionValue, as: GoogleApi.DFAReporting.V33.Model.DimensionValue)
  field(:sslRequired)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.PlacementAssignment do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.PlacementAssignment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.PlacementAssignment do
