  ...
  *   `traffickerEmails` (*type:* `list(String.t)`, *default:* `nil`) - Campaign trafficker contact emails.
  ...
  @type t :: %__MODULE__{
          ...
          :adBlockingConfiguration =>
            GoogleApi.DFAReporting.V33.Model.AdBlockingConfiguration.t() | nil,
          :additionalCreativeOptimizationConfigurations =>
            list(GoogleApi.DFAReporting.V33.Model.CreativeOptimizationConfiguration.t()) | nil,
          ...
          :audienceSegmentGroups =>
            list(GoogleApi.DFAReporting.V33.Model.AudienceSegmentGroup.t()) | nil,
          ...
          :creativeOptimizationConfiguration =>
            GoogleApi.DFAReporting.V33.Model.CreativeOptimizationConfiguration.t() | nil,
