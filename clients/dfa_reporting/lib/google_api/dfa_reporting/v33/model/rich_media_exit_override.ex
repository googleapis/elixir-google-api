...
defmodule GoogleApi.DFAReporting.V33.Model.RichMediaExitOverride do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.RichMediaExitOverride do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.RichMediaExitOverride.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.RichMediaExitOverride do
