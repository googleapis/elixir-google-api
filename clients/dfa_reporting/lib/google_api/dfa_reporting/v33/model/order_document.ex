...
defmodule GoogleApi.DFAReporting.V33.Model.OrderDocument do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of this order document
  ...
  field(:cancelled)
  field(:createdInfo, as: GoogleApi.DFAReporting.V33.Model.LastModifiedInfo)
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.OrderDocument do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.OrderDocument.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.OrderDocument do
