...
defmodule GoogleApi.DFAReporting.V33.Model.MediaResponseInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.MediaResponseInfo do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.MediaResponseInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.MediaResponseInfo do
