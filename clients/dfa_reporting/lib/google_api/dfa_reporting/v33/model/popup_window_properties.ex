...
defmodule GoogleApi.DFAReporting.V33.Model.PopupWindowProperties do
  @moduledoc """
  Popup Window Properties.

  ## Attributes

  *   `dimension` (*type:* `GoogleApi.DFAReporting.V33.Model.Size.t`, *default:* `nil`) - Popup dimension for a creative. This is a read-only field. Applicable to the following creative types: all RICH_MEDIA and all VPAID
  *   `offset` (*type:* `GoogleApi.DFAReporting.V33.Model.OffsetPosition.t`, *default:* `nil`) - Upper-left corner coordinates of the popup window. Applicable if positionType is COORDINATES.
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.PopupWindowProperties do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.PopupWindowProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.PopupWindowProperties do
