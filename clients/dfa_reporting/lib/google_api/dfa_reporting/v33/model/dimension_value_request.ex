...
defmodule GoogleApi.DFAReporting.V33.Model.DimensionValueRequest do
  @moduledoc """
  ...
  *   `startDate` (*type:* `Date.t`, *default:* `nil`) - The start date of the date range for which to retrieve dimension values. A string of the format "yyyy-MM-dd".
  ...
  field(:filters, as: GoogleApi.DFAReporting.V33.Model.DimensionFilter, type: :list)
  field(:kind)
  field(:startDate, as: Date)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.DimensionValueRequest do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.DimensionValueRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.DimensionValueRequest do
