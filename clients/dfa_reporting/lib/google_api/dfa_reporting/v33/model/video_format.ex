...
defmodule GoogleApi.DFAReporting.V33.Model.VideoFormat do
  @moduledoc """
  ...
  *   `targetBitRate` (*type:* `integer()`, *default:* `nil`) - The target bit rate of this video format.
  ...
  field(:id)
  field(:kind)
  field(:resolution, as: GoogleApi.DFAReporting.V33.Model.Size)
  field(:targetBitRate)
end

defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.VideoFormat do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.VideoFormat.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.VideoFormat do
