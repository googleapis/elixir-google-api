...
defmodule GoogleApi.DFAReporting.V33.Model.PathToConversionReportCompatibleFields do
  @moduledoc """
  ...
  *   `perInteractionDimensions` (*type:* `list(GoogleApi.DFAReporting.V33.Model.Dimension.t)`, *default:* `nil`) - Per-interaction dimensions which are compatible to be selected in the "perInteractionDimensions" section of the report.
  ...
  @type t :: %__MODULE__{
          :conversionDimensions => list(GoogleApi.DFAReporting.V33.Model.Dimension.t()),
          :customFloodlightVariables => list(GoogleApi.DFAReporting.V33.Model.Dimension.t()),
          :kind => String.t(),
          :metrics => list(GoogleApi.DFAReporting.V33.Model.Metric.t()),
          :perInteractionDimensions => list(GoogleApi.DFAReporting.V33.Model.Dimension.t())
        }

  field(:conversionDimensions, as: GoogleApi.DFAReporting.V33.Model.Dimension, type: :list)
  field(:customFloodlightVariables, as: GoogleApi.DFAReporting.V33.Model.Dimension, type: :list)
  field(:kind)
  field(:metrics, as: GoogleApi.DFAReporting.V33.Model.Metric, type: :list)
  field(:perInteractionDimensions, as: GoogleApi.DFAReporting.V33.Model.Dimension, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.DFAReporting.V33.Model.PathToConversionReportCompatibleFields do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.PathToConversionReportCompatibleFields.decode(value, options)
  end
end
