...
defmodule GoogleApi.DFAReporting.V33.Model.PathToConversionReportCompatibleFields do
  ...
  *   `perInteractionDimensions` (*type:* `list(GoogleApi.DFAReporting.V33.Model.Dimension.t)`, *default:* `nil`) - Per-interaction dimensions which are compatible to be selected in the "perInteractionDimensions" section of the report.
  ...
  @type t :: %__MODULE__{
          :conversionDimensions => list(GoogleApi.DFAReporting.V33.Model.Dimension.t()) | nil,
          :customFloodlightVariables =>
            list(GoogleApi.DFAReporting.V33.Model.Dimension.t()) | nil,
          :kind => String.t() | nil,
          :metrics => list(GoogleApi.DFAReporting.V33.Model.Metric.t()) | nil,
          :perInteractionDimensions => list(GoogleApi.DFAReporting.V33.Model.Dimension.t()) | nil
        }
