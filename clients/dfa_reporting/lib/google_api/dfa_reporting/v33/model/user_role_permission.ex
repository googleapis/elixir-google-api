...
defmodule GoogleApi.DFAReporting.V33.Model.UserRolePermission do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.UserRolePermission do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.UserRolePermission.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.UserRolePermission do
