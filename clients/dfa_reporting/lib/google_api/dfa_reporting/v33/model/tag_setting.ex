...
defmodule GoogleApi.DFAReporting.V33.Model.TagSetting do
  @moduledoc """
  Tag Settings
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V33.Model.TagSetting do
  def decode(value, options) do
    GoogleApi.DFAReporting.V33.Model.TagSetting.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V33.Model.TagSetting do
