...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V4.Model.ContentCategory do
  def decode(value, options) do
    GoogleApi.DFAReporting.V4.Model.ContentCategory.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V4.Model.ContentCategory do
