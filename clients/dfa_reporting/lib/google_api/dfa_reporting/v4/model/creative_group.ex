...
defmodule GoogleApi.DFAReporting.V4.Model.CreativeGroup do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V4.Model.CreativeGroup do
  def decode(value, options) do
    GoogleApi.DFAReporting.V4.Model.CreativeGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V4.Model.CreativeGroup do
