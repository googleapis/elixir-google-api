...
defmodule GoogleApi.DFAReporting.V4.Model.DfpSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DFAReporting.V4.Model.DfpSettings do
  def decode(value, options) do
    GoogleApi.DFAReporting.V4.Model.DfpSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DFAReporting.V4.Model.DfpSettings do
