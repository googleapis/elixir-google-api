...
defmodule GoogleApi.DFAReporting.V4.Api.AdvertiserLandingPages do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.LandingPage{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_advertiser_landing_pages_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.LandingPage.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_advertiser_landing_pages_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.LandingPage{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.LandingPage.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.AdvertiserLandingPagesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_advertiser_landing_pages_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.AdvertiserLandingPagesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_advertiser_landing_pages_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.AdvertiserLandingPagesListResponse{}]
    )
  end
