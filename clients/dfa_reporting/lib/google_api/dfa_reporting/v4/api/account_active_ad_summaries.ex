...
defmodule GoogleApi.DFAReporting.V4.Api.AccountActiveAdSummaries do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.AccountActiveAdSummary{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_account_active_ad_summaries_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.AccountActiveAdSummary.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_account_active_ad_summaries_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.AccountActiveAdSummary{}]
    )
  end
end
