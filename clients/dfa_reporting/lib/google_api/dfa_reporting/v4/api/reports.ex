...
defmodule GoogleApi.DFAReporting.V4.Api.Reports do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_reports_delete(
    ...
    request =
      ...
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/reports/{reportId}", %{
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.Report{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_reports_get(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.Report.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_reports_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.Report{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.Report.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_reports_insert(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/reports", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.ReportList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_reports_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.ReportList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_reports_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.ReportList{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.File{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_reports_run(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.File.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_reports_run(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/reports/{reportId}/run", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1),
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.File{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.CompatibleFields{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_reports_compatible_fields_query(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.CompatibleFields.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_reports_compatible_fields_query(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.CompatibleFields{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.FileList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_reports_files_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.FileList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_reports_files_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/reports/{reportId}/files", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1),
        "reportId" => URI.encode(report_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.FileList{}])
  end
end
