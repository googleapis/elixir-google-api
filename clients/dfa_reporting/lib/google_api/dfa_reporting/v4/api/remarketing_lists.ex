...
defmodule GoogleApi.DFAReporting.V4.Api.RemarketingLists do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.RemarketingList{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_remarketing_lists_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.RemarketingList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_remarketing_lists_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.RemarketingList{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.RemarketingList.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.RemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_remarketing_lists_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.RemarketingListsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_remarketing_lists_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.RemarketingListsListResponse{}]
    )
  end
