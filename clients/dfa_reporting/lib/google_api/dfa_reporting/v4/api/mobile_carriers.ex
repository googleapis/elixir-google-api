...
defmodule GoogleApi.DFAReporting.V4.Api.MobileCarriers do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.MobileCarrier{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_mobile_carriers_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.MobileCarrier.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_mobile_carriers_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.MobileCarrier{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.MobileCarriersListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_mobile_carriers_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.MobileCarriersListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_mobile_carriers_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.MobileCarriersListResponse{}]
    )
  end
end
