...
defmodule GoogleApi.DFAReporting.V4.Api.AccountUserProfiles do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.AccountUserProfile{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_account_user_profiles_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.AccountUserProfile.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_account_user_profiles_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.AccountUserProfile{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.AccountUserProfile.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.AccountUserProfilesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_account_user_profiles_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.AccountUserProfilesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_account_user_profiles_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.AccountUserProfilesListResponse{}]
    )
  end
