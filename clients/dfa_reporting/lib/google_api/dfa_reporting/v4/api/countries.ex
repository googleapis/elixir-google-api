...
defmodule GoogleApi.DFAReporting.V4.Api.Countries do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.Country{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_countries_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.Country.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_countries_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.Country{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.CountriesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_countries_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.CountriesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_countries_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.CountriesListResponse{}])
  end
end
