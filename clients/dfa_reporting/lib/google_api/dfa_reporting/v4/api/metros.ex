...
defmodule GoogleApi.DFAReporting.V4.Api.Metros do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.MetrosListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_metros_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.MetrosListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_metros_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.MetrosListResponse{}])
  end
end
