...
defmodule GoogleApi.DFAReporting.V4.Api.FloodlightConfigurations do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.FloodlightConfiguration{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_floodlight_configurations_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.FloodlightConfiguration.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_floodlight_configurations_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/floodlightConfigurations/{id}", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.FloodlightConfiguration{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.FloodlightConfigurationsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_floodlight_configurations_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.FloodlightConfigurationsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_floodlight_configurations_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/floodlightConfigurations", %{
        "profileId" => URI.encode(profile_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.FloodlightConfigurationsListResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.FloodlightConfiguration.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
