...
defmodule GoogleApi.DFAReporting.V4.Api.PlacementStrategies do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.PlacementStrategy{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placement_strategies_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.PlacementStrategy.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_strategies_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.PlacementStrategy{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.PlacementStrategy.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.PlacementStrategiesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placement_strategies_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.PlacementStrategiesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_strategies_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.PlacementStrategiesListResponse{}]
    )
  end
