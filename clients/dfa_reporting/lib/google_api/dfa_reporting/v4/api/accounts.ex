...
defmodule GoogleApi.DFAReporting.V4.Api.Accounts do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.Account{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_accounts_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.Account.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_accounts_get(connection, profile_id, id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.Account{}])
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.AccountsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_accounts_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.AccountsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_accounts_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.AccountsListResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.Account.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
