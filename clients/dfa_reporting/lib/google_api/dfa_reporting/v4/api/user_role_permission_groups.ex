...
defmodule GoogleApi.DFAReporting.V4.Api.UserRolePermissionGroups do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroup{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_user_role_permission_groups_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroup.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_user_role_permission_groups_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroup{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroupsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_user_role_permission_groups_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroupsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_user_role_permission_groups_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.UserRolePermissionGroupsListResponse{}]
    )
  end
end
