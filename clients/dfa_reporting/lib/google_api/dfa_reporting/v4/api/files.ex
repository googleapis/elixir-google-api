...
defmodule GoogleApi.DFAReporting.V4.Api.Files do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_files_get(connection, report_id, file_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v4/reports/{reportId}/files/{fileId}", %{
  ...
  *   `{:error, info}` on failure
  ...
  def dfareporting_files_list(connection, profile_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dfareporting/v4/userprofiles/{profileId}/files", %{
