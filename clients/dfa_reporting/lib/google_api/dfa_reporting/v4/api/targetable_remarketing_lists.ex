...
defmodule GoogleApi.DFAReporting.V4.Api.TargetableRemarketingLists do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.TargetableRemarketingList{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_targetable_remarketing_lists_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.TargetableRemarketingList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_targetable_remarketing_lists_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.TargetableRemarketingList{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.TargetableRemarketingListsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_targetable_remarketing_lists_list(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.TargetableRemarketingListsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_targetable_remarketing_lists_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.TargetableRemarketingListsListResponse{}]
    )
  end
end
