...
defmodule GoogleApi.DFAReporting.V4.Api.PlacementGroups do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.PlacementGroup{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec dfareporting_placement_groups_get(
          ...
          {:ok, GoogleApi.DFAReporting.V4.Model.PlacementGroup.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_groups_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.PlacementGroup{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.DFAReporting.V4.Model.PlacementGroup.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.DFAReporting.V4.Model.PlacementGroupsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dfareporting_placement_groups_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DFAReporting.V4.Model.PlacementGroupsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dfareporting_placement_groups_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DFAReporting.V4.Model.PlacementGroupsListResponse{}]
    )
  end
