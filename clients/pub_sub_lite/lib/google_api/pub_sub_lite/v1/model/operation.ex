...
defmodule GoogleApi.PubSubLite.V1.Model.Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.PubSubLite.V1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - The normal, successful response of the operation. If the original method returns no data on success, such as `Delete`, the response is `google.protobuf.Empty`. If the original method is standard `Get`/`Create`/`Update`, the response should be the resource. For other methods, the response should have the type `XxxResponse`, where `Xxx` is the original method name. For example, if the original method name is `TakeSnapshot()`, the inferred response type is `TakeSnapshotResponse`.
  ...
  @type t :: %__MODULE__{
          :done => boolean() | nil,
          :error => GoogleApi.PubSubLite.V1.Model.Status.t() | nil,
          :metadata => map() | nil,
          :name => String.t() | nil,
          :response => map() | nil
        }
  ...
  field(:done)
  field(:error, as: GoogleApi.PubSubLite.V1.Model.Status)
  field(:metadata, type: :map)
  field(:name)
  field(:response, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.PubSubLite.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.PubSubLite.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PubSubLite.V1.Model.Operation do
