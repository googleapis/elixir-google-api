...
defmodule GoogleApi.PubSubLite.V1.Model.Capacity do
  @moduledoc """
  ...
  *   `subscribeMibPerSec` (*type:* `integer()`, *default:* `nil`) - Subscribe throughput capacity per partition in MiB/s. Must be >= 4 and <= 32.
  ...
  field(:subscribeMibPerSec)
end

defimpl Poison.Decoder, for: GoogleApi.PubSubLite.V1.Model.Capacity do
  def decode(value, options) do
    GoogleApi.PubSubLite.V1.Model.Capacity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PubSubLite.V1.Model.Capacity do
