...
defmodule GoogleApi.ResourceViews.V1beta2.Model.OperationError do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ResourceViews.V1beta2.Model.OperationError do
  import GoogleApi.ResourceViews.V1beta2.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"errors", :list, GoogleApi.ResourceViews.V1beta2.Model.OperationErrorErrors, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ResourceViews.V1beta2.Model.OperationError do
