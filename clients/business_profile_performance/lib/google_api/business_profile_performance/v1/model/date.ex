...
defmodule GoogleApi.BusinessProfilePerformance.V1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BusinessProfilePerformance.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.BusinessProfilePerformance.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BusinessProfilePerformance.V1.Model.Date do
