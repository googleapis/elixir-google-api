...
defimpl Poison.Decoder, for: GoogleApi.UrlShortener.V1.Model.AnalyticsSummary do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"allTime", :struct, GoogleApi.UrlShortener.V1.Model.AnalyticsSnapshot, options)
    |> deserialize(:"day", :struct, GoogleApi.UrlShortener.V1.Model.AnalyticsSnapshot, options)
