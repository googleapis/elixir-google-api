...
defmodule GoogleApi.GamesManagement.V1management.Model.HiddenPlayerList do
  ...
  - items ([HiddenPlayer]): The players. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#hiddenPlayerList. Defaults to: `null`.
