...
defmodule GoogleApi.GamesManagement.V1management.Model.HiddenPlayerList do
  ...
  - items (list(GoogleApi.GamesManagement.V1management.Model.HiddenPlayer.t)): The players. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#hiddenPlayerList. Defaults to `gamesManagement#hiddenPlayerList`.
...
defimpl Poison.Decoder, for: GoogleApi.GamesManagement.V1management.Model.HiddenPlayerList do
  def decode(value, options) do
    GoogleApi.GamesManagement.V1management.Model.HiddenPlayerList.decode(value, options)
  end
end
