...
defmodule GoogleApi.GamesManagement.V1management.Model.ProfileSettings do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#profileSettings. Defaults to `gamesManagement#profileSettings`.
  - profileVisible (boolean()): The player's current profile visibility. This field is visible to both 1P and 3P APIs. Defaults to `nil`.
  """
