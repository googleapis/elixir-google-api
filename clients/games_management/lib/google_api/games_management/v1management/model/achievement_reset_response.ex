...
defmodule GoogleApi.GamesManagement.V1management.Model.AchievementResetResponse do
  ...
  *   `currentState` (*type:* `String.t`, *default:* `nil`) - The current state of the achievement. This is the same as the initial state of the achievement. Possible values are: - "`HIDDEN`"- Achievement is hidden. - "`REVEALED`" - Achievement is revealed. - "`UNLOCKED`" - Achievement is unlocked. 
  *   `definitionId` (*type:* `String.t`, *default:* `nil`) - The ID of an achievement for which player state has been updated.
  *   `kind` (*type:* `String.t`, *default:* `nil`) - Uniquely identifies the type of this resource. Value is always the fixed string `gamesManagement#achievementResetResponse`.
