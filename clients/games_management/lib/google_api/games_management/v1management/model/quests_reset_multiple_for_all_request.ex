...
defmodule GoogleApi.GamesManagement.V1management.Model.QuestsResetMultipleForAllRequest do
  ...
  *   `kind` (*type:* `String.t`, *default:* `gamesManagement#questsResetMultipleForAllRequest`) - Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#questsResetMultipleForAllRequest.
  *   `quest_ids` (*type:* `list(String.t)`, *default:* `nil`) - The IDs of quests to reset.
  """
