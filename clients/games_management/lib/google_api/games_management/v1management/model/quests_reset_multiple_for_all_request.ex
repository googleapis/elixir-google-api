...
defmodule GoogleApi.GamesManagement.V1management.Model.QuestsResetMultipleForAllRequest do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#questsResetMultipleForAllRequest. Defaults to: `null`.
  - quest_ids ([String.t]): The IDs of quests to reset. Defaults to: `null`.
  """
