...
defmodule GoogleApi.GamesManagement.V1management.Model.PlayerScoreResetResponse do
  ...
  - definitionId (String.t): The ID of an leaderboard for which player state has been updated. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#playerScoreResetResponse. Defaults to `gamesManagement#playerScoreResetResponse`.
  - resetScoreTimeSpans (list(String.t)): The time spans of the updated score.
  Possible values are:  
