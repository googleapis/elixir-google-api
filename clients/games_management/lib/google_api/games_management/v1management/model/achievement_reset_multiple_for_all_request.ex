...
defmodule GoogleApi.GamesManagement.V1management.Model.AchievementResetMultipleForAllRequest do
  ...
  - achievement_ids (list(String.t)): The IDs of achievements to reset. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesManagement#achievementResetMultipleForAllRequest. Defaults to `gamesManagement#achievementResetMultipleForAllRequest`.
  """
