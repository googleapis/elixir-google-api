...
defmodule GoogleApi.GamesManagement.V1management.Api.Applications do
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_applications_list_hidden(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def games_management_applications_list_hidden(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/games/v1management/applications/{applicationId}/players/hidden", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.GamesManagement.V1management.Model.HiddenPlayerList{}]
    )
  end
end
