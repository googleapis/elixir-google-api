...
defmodule GoogleApi.GamesManagement.V1management.Api.Quests do
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_quests_reset(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_quests_reset_all(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_quests_reset_all_for_all_players(
          Tesla.Env.client(),
          keyword(),
          keyword()
        ) :: {:ok, nil} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_quests_reset_for_all_players(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.GamesManagement.V1management.Model.QuestsResetMultipleForAllRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec games_management_quests_reset_multiple_for_all_players(
          Tesla.Env.client(),
          keyword(),
          keyword()
        ) :: {:ok, nil} | {:error, Tesla.Env.t()}
