...
defmodule GoogleApi.GamesManagement.V1management.Api.Events do
  ...
  - event_id (String.t): The ID of the event.
  ...
  """
  @spec games_management_events_reset(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec games_management_events_reset_all(Tesla.Env.client(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec games_management_events_reset_all_for_all_players(Tesla.Env.client(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec games_management_events_reset_for_all_players(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.GamesManagement.V1management.Model.EventsResetMultipleForAllRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec games_management_events_reset_multiple_for_all_players(Tesla.Env.client(), keyword()) ::
          {:ok, nil} | {:error, Tesla.Env.t()}
