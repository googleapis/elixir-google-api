  ...
  *   `{:error, info}` on failure
  ...
  def games_management_achievements_reset(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1management/achievements/{achievementId}/reset", %{
  ...
  *   `{:error, info}` on failure
  ...
  def games_management_achievements_reset_all(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1management/achievements/reset", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def games_management_achievements_reset_all_for_all_players(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1management/achievements/resetAllForAllPlayers", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def games_management_achievements_reset_for_all_players(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1management/achievements/{achievementId}/resetForAllPlayers", %{
        "achievementId" => URI.encode(achievement_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def games_management_achievements_reset_multiple_for_all_players(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1management/achievements/resetMultipleForAllPlayers", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
