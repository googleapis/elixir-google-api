...
defmodule GoogleApi.Redis.V1beta1.Model.Instance do
  ...
  - redisVersion (String.t): Optional. The version of Redis software. If not provided, latest supported version will be used. Updating the version will perform an upgrade/downgrade to the new version. Currently, the supported values are:   *   &#x60;REDIS_4_0&#x60; for Redis 4.0 compatibility  *   &#x60;REDIS_3_2&#x60; for Redis 3.2 compatibility Defaults to: `null`.
