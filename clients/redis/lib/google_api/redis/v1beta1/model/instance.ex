...
defmodule GoogleApi.Redis.V1beta1.Model.Instance do
  ...
  - redisConfigs (%{optional(String.t) &#x3D;&gt; String.t}): Optional. Redis configuration parameters, according to http://redis.io/topics/config. Currently, the only supported parameters are:   Redis 3.2 and above:   *   maxmemory-policy  *   notify-keyspace-events   Redis 4.0 and above:   *   activedefrag  *   lfu-log-factor  *   lfu-decay-time Defaults to: `null`.
  - redisVersion (String.t): Optional. The version of Redis software. If not provided, latest supported version will be used. Updating the version will perform an upgrade/downgrade to the new version. Currently, the supported values are:   *   &#x60;REDIS_4_0&#x60; for Redis 4.0 compatibility  *   &#x60;REDIS_3_2&#x60; for Redis 3.2 compatibility (default) Defaults to: `null`.
