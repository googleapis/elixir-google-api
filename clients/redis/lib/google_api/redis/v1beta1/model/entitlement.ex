...
defmodule GoogleApi.Redis.V1beta1.Model.Entitlement do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - An enum that represents the type of this entitlement.
  ...
  field(:entitlementState)
  field(:type)
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.Entitlement do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.Entitlement.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.Entitlement do
