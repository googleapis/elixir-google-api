...
defmodule GoogleApi.Redis.V1beta1.Model.DatabaseResourceHealthSignalData do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          ...
          :compliance => list(GoogleApi.Redis.V1beta1.Model.Compliance.t()) | nil,
  ...
  field(:compliance, as: GoogleApi.Redis.V1beta1.Model.Compliance, type: :list)
  field(:description)
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.DatabaseResourceHealthSignalData do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.DatabaseResourceHealthSignalData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.DatabaseResourceHealthSignalData do
