...
defmodule GoogleApi.Redis.V1beta1.Model.ClusterMaintenancePolicy do
  @moduledoc """
  ...
  *   `weeklyMaintenanceWindow` (*type:* `list(GoogleApi.Redis.V1beta1.Model.ClusterWeeklyMaintenanceWindow.t)`, *default:* `nil`) - Optional. Maintenance window that is applied to resources covered by this policy. Minimum 1. For the current version, the maximum number of weekly_maintenance_window is expected to be one.
  ...
  @type t :: %__MODULE__{
          ...
          :weeklyMaintenanceWindow =>
            list(GoogleApi.Redis.V1beta1.Model.ClusterWeeklyMaintenanceWindow.t()) | nil
        }
  ...
  field(:weeklyMaintenanceWindow,
    as: GoogleApi.Redis.V1beta1.Model.ClusterWeeklyMaintenanceWindow,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.ClusterMaintenancePolicy do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.ClusterMaintenancePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.ClusterMaintenancePolicy do
