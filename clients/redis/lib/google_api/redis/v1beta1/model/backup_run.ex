...
defmodule GoogleApi.Redis.V1beta1.Model.BackupRun do
  @moduledoc """
  A backup run.
  ...
  *   `status` (*type:* `String.t`, *default:* `nil`) - The status of this run. REQUIRED
  ...
  @type t :: %__MODULE__{
          ...
          :error => GoogleApi.Redis.V1beta1.Model.OperationError.t() | nil,
          :startTime => DateTime.t() | nil,
          :status => String.t() | nil
        }

  field(:endTime, as: DateTime)
  field(:error, as: GoogleApi.Redis.V1beta1.Model.OperationError)
  field(:startTime, as: DateTime)
  field(:status)
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.BackupRun do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.BackupRun.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.BackupRun do
