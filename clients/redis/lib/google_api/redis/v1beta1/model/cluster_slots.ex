...
defmodule GoogleApi.Redis.V1beta1.Model.ClusterSlots do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.ClusterSlots do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.ClusterSlots.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.ClusterSlots do
