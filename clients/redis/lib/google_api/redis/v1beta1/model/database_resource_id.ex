...
defmodule GoogleApi.Redis.V1beta1.Model.DatabaseResourceId do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.DatabaseResourceId do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.DatabaseResourceId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.DatabaseResourceId do
