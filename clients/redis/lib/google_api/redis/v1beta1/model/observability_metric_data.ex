...
defmodule GoogleApi.Redis.V1beta1.Model.ObservabilityMetricData do
  @moduledoc """
  ...
  *   `value` (*type:* `GoogleApi.Redis.V1beta1.Model.TypedValue.t`, *default:* `nil`) - Required. Value of the metric type.
  ...
  @type t :: %__MODULE__{
          ...
          :value => GoogleApi.Redis.V1beta1.Model.TypedValue.t() | nil
        }
  ...
  field(:resourceName)
  field(:value, as: GoogleApi.Redis.V1beta1.Model.TypedValue)
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.ObservabilityMetricData do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.ObservabilityMetricData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.ObservabilityMetricData do
