...
defmodule GoogleApi.Redis.V1beta1.Model.ClusterEndpoint do
  ...
  *   `connections` (*type:* `list(GoogleApi.Redis.V1beta1.Model.ConnectionDetail.t)`, *default:* `nil`) - A group of PSC connections. They are created in the same VPC network, one for each service attachment in the cluster.
  """
