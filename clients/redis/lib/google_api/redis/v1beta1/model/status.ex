...
defmodule GoogleApi.Redis.V1beta1.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.Redis.V1beta1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.Redis.V1beta1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.Status do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.Status do
