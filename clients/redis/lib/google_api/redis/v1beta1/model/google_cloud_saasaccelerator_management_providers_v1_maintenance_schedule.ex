...
defmodule GoogleApi.Redis.V1beta1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Redis.V1beta1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule.decode(
      value,
      options
    )
  end
