...
defmodule GoogleApi.Redis.V1beta1.Model.PrivateServiceConnect do
  @moduledoc """
  ...
  *   `pscServiceRoute` (*type:* `String.t`, *default:* `nil`) - Optional. The service route to connect using Private Service Connect. On Instance creation, this will automatically connect this route to this instance.
  ...
  field(:pscService)
  field(:pscServiceRoute)
end

defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.PrivateServiceConnect do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.PrivateServiceConnect.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.PrivateServiceConnect do
