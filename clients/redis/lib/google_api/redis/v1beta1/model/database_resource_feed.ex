...
defmodule GoogleApi.Redis.V1beta1.Model.DatabaseResourceFeed do
  ...
  *   `recommendationSignalData` (*type:* `GoogleApi.Redis.V1beta1.Model.DatabaseResourceRecommendationSignalData.t`, *default:* `nil`) - More feed data would be added in subsequent CLs
