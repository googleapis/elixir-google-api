...
defmodule GoogleApi.Redis.V1beta1.Model.PscServiceAttachment do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1beta1.Model.PscServiceAttachment do
  def decode(value, options) do
    GoogleApi.Redis.V1beta1.Model.PscServiceAttachment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1beta1.Model.PscServiceAttachment do
