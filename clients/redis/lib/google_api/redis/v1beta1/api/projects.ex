...
defmodule GoogleApi.Redis.V1beta1.Api.Projects do
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.BackupCollection{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_backup_collections_get(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.BackupCollection.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_backup_collections_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.BackupCollection{}])
  end
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.ListBackupCollectionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_backup_collections_list(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.ListBackupCollectionsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_backup_collections_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta1/{+parent}/backupCollections", %{
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.ListBackupCollectionsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Redis.V1beta1.Model.ExportBackupRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.Backup{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_backup_collections_backups_get(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.Backup.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_backup_collections_backups_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.Backup{}])
  end
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.ListBackupsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_backup_collections_backups_list(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.ListBackupsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_backup_collections_backups_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta1/{+parent}/backups", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.ListBackupsResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Redis.V1beta1.Model.BackupClusterRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def redis_projects_locations_clusters_backup(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1beta1/{+name}:backup", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.Cluster{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_clusters_get(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.Cluster.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_clusters_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.Cluster{}])
  end
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.CertificateAuthority{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_clusters_get_certificate_authority(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.CertificateAuthority.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_clusters_get_certificate_authority(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.CertificateAuthority{}])
  end
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.ListClustersResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec redis_projects_locations_clusters_list(
          ...
          {:ok, GoogleApi.Redis.V1beta1.Model.ListClustersResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def redis_projects_locations_clusters_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.ListClustersResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Redis.V1beta1.Model.RescheduleClusterMaintenanceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def redis_projects_locations_clusters_reschedule_cluster_maintenance(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1beta1/{+name}:rescheduleClusterMaintenance", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.Redis.V1beta1.Model.InstanceAuthString{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def redis_projects_locations_instances_get_auth_string(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Redis.V1beta1.Model.InstanceAuthString{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Redis.V1beta1.Model.RescheduleMaintenanceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Redis.V1beta1.Model.UpgradeInstanceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
