...
defmodule GoogleApi.Redis.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  @spec redis_projects_locations_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.Redis.V1.Model.Location.t()} | {:ok, Tesla.Env.t()} | {:error, any()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec redis_projects_locations_instances_create(
          ...
          {:ok, GoogleApi.Redis.V1.Model.Operation.t()} | {:ok, Tesla.Env.t()} | {:error, any()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec redis_projects_locations_instances_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.Redis.V1.Model.Instance.t()} | {:ok, Tesla.Env.t()} | {:error, any()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec redis_projects_locations_operations_cancel(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.Redis.V1.Model.Empty.t()} | {:ok, Tesla.Env.t()} | {:error, any()}
