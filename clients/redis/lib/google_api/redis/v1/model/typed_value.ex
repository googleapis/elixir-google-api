...
defmodule GoogleApi.Redis.V1.Model.TypedValue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.TypedValue do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.TypedValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.TypedValue do
