...
defmodule GoogleApi.Redis.V1.Model.TlsCertificate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.TlsCertificate do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.TlsCertificate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.TlsCertificate do
