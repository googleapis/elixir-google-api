...
defmodule GoogleApi.Redis.V1.Model.Membership do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.Membership do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.Membership.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.Membership do
