...
defmodule GoogleApi.Redis.V1.Model.RetentionSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.RetentionSettings do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.RetentionSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.RetentionSettings do
