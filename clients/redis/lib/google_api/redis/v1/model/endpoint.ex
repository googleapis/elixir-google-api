...
defmodule GoogleApi.Redis.V1.Model.Endpoint do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.Endpoint do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.Endpoint.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.Endpoint do
