...
defmodule GoogleApi.Redis.V1.Model.OutputConfig do
  @moduledoc """
  The output content
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.OutputConfig do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.OutputConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.OutputConfig do
