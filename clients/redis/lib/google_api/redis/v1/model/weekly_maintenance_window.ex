...
defmodule GoogleApi.Redis.V1.Model.WeeklyMaintenanceWindow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.WeeklyMaintenanceWindow do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.WeeklyMaintenanceWindow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.WeeklyMaintenanceWindow do
