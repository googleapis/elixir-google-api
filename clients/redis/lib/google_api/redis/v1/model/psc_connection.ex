...
defmodule GoogleApi.Redis.V1.Model.PscConnection do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.PscConnection do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.PscConnection.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.PscConnection do
