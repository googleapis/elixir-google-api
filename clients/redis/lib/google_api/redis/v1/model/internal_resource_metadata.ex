...
defmodule GoogleApi.Redis.V1.Model.InternalResourceMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.InternalResourceMetadata do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.InternalResourceMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.InternalResourceMetadata do
