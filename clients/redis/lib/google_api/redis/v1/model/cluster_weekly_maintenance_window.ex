...
defmodule GoogleApi.Redis.V1.Model.ClusterWeeklyMaintenanceWindow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.ClusterWeeklyMaintenanceWindow do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.ClusterWeeklyMaintenanceWindow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.ClusterWeeklyMaintenanceWindow do
