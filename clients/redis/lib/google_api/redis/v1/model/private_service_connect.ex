...
defmodule GoogleApi.Redis.V1.Model.PrivateServiceConnect do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.PrivateServiceConnect do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.PrivateServiceConnect.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.PrivateServiceConnect do
