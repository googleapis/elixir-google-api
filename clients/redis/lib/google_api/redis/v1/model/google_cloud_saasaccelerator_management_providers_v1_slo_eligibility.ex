...
defimpl Poison.Decoder,
  for: GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility.decode(
      value,
      options
    )
  end
