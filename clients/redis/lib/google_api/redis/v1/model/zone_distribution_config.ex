...
defmodule GoogleApi.Redis.V1.Model.ZoneDistributionConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.ZoneDistributionConfig do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.ZoneDistributionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.ZoneDistributionConfig do
