...
defmodule GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance do
  @moduledoc """
  ...
  *   `maintenanceSchedules` (*type:* `%{optional(String.t) => GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule.t}`, *default:* `nil`) - The MaintenanceSchedule contains the scheduling information of published maintenance schedule.
  *   `maintenanceSettings` (*type:* `GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings.t`, *default:* `nil`) - Optional. The MaintenanceSettings associated with instance.
  ...
  *   `provisionedResources` (*type:* `list(GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource.t)`, *default:* `nil`) - Output only. The list of data plane resources provisioned for this instance, e.g. compute VMs. See go/get-instance-metadata.
  ...
  *   `sloMetadata` (*type:* `GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata.t`, *default:* `nil`) - Output only. SLO metadata for instance classification in the Standardized dataplane SLO platform. See go/cloud-ssa-standard-slo for feature description.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Timestamp when the resource was last modified.
  ...
  @type t :: %__MODULE__{
          ...
          :maintenanceSchedules => %{
            optional(String.t()) =>
              GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule.t()
          },
          :maintenanceSettings =>
            GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings.t(),
          :name => String.t(),
          :producerMetadata => map(),
          :provisionedResources =>
            list(
              GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource.t()
            ),
          :slmInstanceTemplate => String.t(),
          :sloMetadata =>
            GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata.t(),
  ...
  field(:maintenanceSettings,
    as:
      GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSettings
  )
  ...
  field(:provisionedResources,
    as:
      GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1ProvisionedResource,
    type: :list
  )
  ...
  field(:sloMetadata,
    as: GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloMetadata
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1Instance.decode(
      value,
      options
    )
  end
