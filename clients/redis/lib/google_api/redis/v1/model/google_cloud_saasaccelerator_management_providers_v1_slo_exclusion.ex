...
defmodule GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1SloExclusion.decode(
      value,
      options
    )
  end
