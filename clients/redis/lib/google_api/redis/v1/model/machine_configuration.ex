...
defmodule GoogleApi.Redis.V1.Model.MachineConfiguration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.MachineConfiguration do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.MachineConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.MachineConfiguration do
