...
defmodule GoogleApi.Redis.V1.Model.RDBConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.RDBConfig do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.RDBConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.RDBConfig do
