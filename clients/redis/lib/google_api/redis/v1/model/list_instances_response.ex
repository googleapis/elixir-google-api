...
defmodule GoogleApi.Redis.V1.Model.ListInstancesResponse do
  ...
  *   `instances` (*type:* `list(GoogleApi.Redis.V1.Model.Instance.t)`, *default:* `nil`) - A list of Redis instances in the project in the specified location,
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - Locations that could not be reached.
  ...
  @type t :: %__MODULE__{
          :instances => list(GoogleApi.Redis.V1.Model.Instance.t()),
