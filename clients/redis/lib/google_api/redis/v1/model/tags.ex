...
defmodule GoogleApi.Redis.V1.Model.Tags do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Redis.V1.Model.Tags do
  def decode(value, options) do
    GoogleApi.Redis.V1.Model.Tags.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Redis.V1.Model.Tags do
