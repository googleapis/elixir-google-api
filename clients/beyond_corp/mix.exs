...
defmodule GoogleApi.BeyondCorp.Mixfile do
  ...
  def project() do
    [
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/beyond_corp"
    ]
  end
  ...
  defp package() do
    [
      ...
      licenses: ["Apache 2.0"],
      links: %{
        "GitHub" => "https://github.com/googleapis/elixir-google-api/tree/master/clients/beyond_corp",
