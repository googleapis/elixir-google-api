...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata.decode(
      value,
      options
    )
  end
