...
defmodule GoogleApi.BeyondCorp.V1.Model.ClientGatewayOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BeyondCorp.V1.Model.ClientGatewayOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.ClientGatewayOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BeyondCorp.V1.Model.ClientGatewayOperationMetadata do
