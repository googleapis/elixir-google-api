...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerServiceOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerServiceOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1alphaPartnerServiceOperationMetadata.decode(
      value,
      options
    )
  end
