...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGatewayOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGatewayOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGatewayOperationMetadata.decode(
      value,
      options
    )
  end
