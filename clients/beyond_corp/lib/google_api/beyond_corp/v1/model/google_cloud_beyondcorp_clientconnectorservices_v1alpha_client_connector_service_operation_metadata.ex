...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata.decode(
      value,
      options
    )
  end
