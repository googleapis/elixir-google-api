...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata.decode(
      value,
      options
    )
  end
