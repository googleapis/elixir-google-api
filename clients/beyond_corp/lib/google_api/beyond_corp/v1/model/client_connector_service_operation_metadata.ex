...
defmodule GoogleApi.BeyondCorp.V1.Model.ClientConnectorServiceOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BeyondCorp.V1.Model.ClientConnectorServiceOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.ClientConnectorServiceOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BeyondCorp.V1.Model.ClientConnectorServiceOperationMetadata do
