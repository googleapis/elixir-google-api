...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpAppconnectorsV1ListAppConnectorsResponse do
  @moduledoc """
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - A list of locations that could not be reached.
  ...
  field(:appConnectors,
    as: GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpAppconnectorsV1AppConnector,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpAppconnectorsV1ListAppConnectorsResponse do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpAppconnectorsV1ListAppConnectorsResponse.decode(
      value,
      options
    )
  end
