...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudLocationLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BeyondCorp.V1.Model.GoogleCloudLocationLocation do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudLocationLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BeyondCorp.V1.Model.GoogleCloudLocationLocation do
