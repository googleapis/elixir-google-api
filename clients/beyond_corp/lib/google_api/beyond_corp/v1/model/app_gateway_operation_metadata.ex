...
defmodule GoogleApi.BeyondCorp.V1.Model.AppGatewayOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BeyondCorp.V1.Model.AppGatewayOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.AppGatewayOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BeyondCorp.V1.Model.AppGatewayOperationMetadata do
