...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata.decode(
      value,
      options
    )
  end
