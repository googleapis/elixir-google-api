...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BeyondCorp.V1.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BeyondCorp.V1.Model.GoogleTypeExpr do
