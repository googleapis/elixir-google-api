...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpNetconnectionsV1alphaNetConnectionOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpNetconnectionsV1alphaNetConnectionOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpNetconnectionsV1alphaNetConnectionOperationMetadata.decode(
      value,
      options
    )
  end
