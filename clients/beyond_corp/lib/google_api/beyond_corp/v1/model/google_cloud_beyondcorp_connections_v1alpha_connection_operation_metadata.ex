...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata.decode(
      value,
      options
    )
  end
