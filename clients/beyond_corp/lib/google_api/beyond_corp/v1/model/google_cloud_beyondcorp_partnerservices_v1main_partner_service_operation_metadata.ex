...
defmodule GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1mainPartnerServiceOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1mainPartnerServiceOperationMetadata do
  def decode(value, options) do
    GoogleApi.BeyondCorp.V1.Model.GoogleCloudBeyondcorpPartnerservicesV1mainPartnerServiceOperationMetadata.decode(
      value,
      options
    )
  end
