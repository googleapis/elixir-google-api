...
defmodule GoogleApi.FirebaseHosting.V1beta1.Model.ListVersionsResponse do
  ...
  *   `versions` (*type:* `list(GoogleApi.FirebaseHosting.V1beta1.Model.Version.t)`, *default:* `nil`) - The list of versions, if any exist.
  ...
  @type t :: %__MODULE__{
          ...
          :versions => list(GoogleApi.FirebaseHosting.V1beta1.Model.Version.t()) | nil
        }

  field(:nextPageToken)
  field(:versions, as: GoogleApi.FirebaseHosting.V1beta1.Model.Version, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.FirebaseHosting.V1beta1.Model.ListVersionsResponse do
  def decode(value, options) do
    GoogleApi.FirebaseHosting.V1beta1.Model.ListVersionsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.FirebaseHosting.V1beta1.Model.ListVersionsResponse do
