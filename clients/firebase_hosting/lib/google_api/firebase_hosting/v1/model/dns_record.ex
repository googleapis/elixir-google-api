...
defmodule GoogleApi.FirebaseHosting.V1.Model.DnsRecord do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.FirebaseHosting.V1.Model.DnsRecord do
  def decode(value, options) do
    GoogleApi.FirebaseHosting.V1.Model.DnsRecord.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.FirebaseHosting.V1.Model.DnsRecord do
