...
defmodule GoogleApi.DomainsRDAP.V1.Api.Nameserver do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def domainsrdap_nameserver_get(connection, nameserver_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/nameserver/{nameserverId}", %{
        "nameserverId" => URI.encode(nameserver_id, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
