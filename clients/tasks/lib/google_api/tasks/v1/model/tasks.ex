...
defmodule GoogleApi.Tasks.V1.Model.Tasks do
  ...
  - items ([Task]): Collection of tasks. Defaults to: `null`.
  - kind (String.t): Type of the resource. This is always \&quot;tasks#tasks\&quot;. Defaults to: `null`.
  - nextPageToken (String.t): Token used to access the next page of this result. Defaults to: `null`.
  """
