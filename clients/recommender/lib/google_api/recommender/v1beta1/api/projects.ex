...
defmodule GoogleApi.Recommender.V1beta1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Recommender.V1beta1.Model.GoogleCloudLocationListLocationsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def recommender_projects_locations_list(connection, name, optional_params \\ [], opts \\ []) do
