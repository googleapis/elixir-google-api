...
defmodule GoogleApi.Recommender.V1beta1.Api.Organizations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_organizations_locations_insight_types_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_organizations_locations_insight_types_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeConfig{}
        ]
    )
  end
  ...
  *   `connection` (*type:* `GoogleApi.Recommender.V1beta1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. Name of the InsightTypeConfig to get. Acceptable formats: * `projects/[PROJECT_NUMBER]/locations/global/recommenders/[INSIGHT_TYPE_ID]/config` * `projects/[PROJECT_ID]/locations/global/recommenders/[INSIGHT_TYPE_ID]/config`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_organizations_locations_recommenders_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_organizations_locations_recommenders_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1RecommenderConfig{}
        ]
    )
  end
  ...
  *   `connection` (*type:* `GoogleApi.Recommender.V1beta1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. Name of the Recommendation Config to get. Acceptable formats: * `projects/[PROJECT_NUMBER]/locations/global/recommenders/[RECOMMENDER_ID]/config` * `projects/[PROJECT_ID]/locations/global/recommenders/[RECOMMENDER_ID]/config`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
