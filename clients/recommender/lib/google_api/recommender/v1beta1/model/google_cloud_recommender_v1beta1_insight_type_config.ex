...
defmodule GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeConfig do
  @moduledoc """
  ...
  *   `insightTypeGenerationConfig` (*type:* `GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig.t`, *default:* `nil`) - InsightTypeGenerationConfig which configures the generation of insights for this insight type.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Last time when the config was updated.
  ...
  @type t :: %__MODULE__{
          ...
          :insightTypeGenerationConfig =>
            GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeGenerationConfig.t()
            | nil,
          :name => String.t() | nil,
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeConfig do
  def decode(value, options) do
    GoogleApi.Recommender.V1beta1.Model.GoogleCloudRecommenderV1beta1InsightTypeConfig.decode(
      value,
      options
    )
  end
