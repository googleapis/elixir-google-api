...
defmodule GoogleApi.Recommender.V1beta1.Model.GoogleCloudLocationLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Recommender.V1beta1.Model.GoogleCloudLocationLocation do
  def decode(value, options) do
    GoogleApi.Recommender.V1beta1.Model.GoogleCloudLocationLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Recommender.V1beta1.Model.GoogleCloudLocationLocation do
