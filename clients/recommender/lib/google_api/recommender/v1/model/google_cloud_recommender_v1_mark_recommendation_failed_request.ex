...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationFailedRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationFailedRequest do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationFailedRequest.decode(
      value,
      options
    )
  end
