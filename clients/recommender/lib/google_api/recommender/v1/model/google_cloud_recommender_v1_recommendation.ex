...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1Recommendation do
  @moduledoc """
  ...
  *   `xorGroupId` (*type:* `String.t`, *default:* `nil`) - Corresponds to a mutually exclusive group ID within a recommender. A non-empty ID indicates that the recommendation belongs to a mutually exclusive group. This means that only one recommendation within the group is suggested to be applied.
  ...
  field(:associatedInsights,
    as: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommendationInsightReference,
    type: :list
  )

  field(:content, as: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommendationContent)

  field(:description)
  field(:etag)
  field(:lastRefreshTime, as: DateTime)
  field(:name)
  field(:primaryImpact, as: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1Impact)
  field(:priority)
...
defimpl Poison.Decoder, for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1Recommendation do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1Recommendation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1Recommendation do
