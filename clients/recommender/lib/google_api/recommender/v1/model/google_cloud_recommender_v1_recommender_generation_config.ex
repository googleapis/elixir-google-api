...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommenderGenerationConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommenderGenerationConfig do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommenderGenerationConfig.decode(
      value,
      options
    )
  end
