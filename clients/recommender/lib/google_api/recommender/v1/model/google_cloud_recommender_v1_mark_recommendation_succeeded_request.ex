...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest.decode(
      value,
      options
    )
  end
