...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1InsightTypeGenerationConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1InsightTypeGenerationConfig do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1InsightTypeGenerationConfig.decode(
      value,
      options
    )
  end
