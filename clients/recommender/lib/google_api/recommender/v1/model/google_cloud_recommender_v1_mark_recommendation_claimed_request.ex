...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest.decode(
      value,
      options
    )
  end
