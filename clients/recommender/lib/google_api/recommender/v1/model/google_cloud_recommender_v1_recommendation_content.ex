...
defmodule GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommendationContent do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommendationContent do
  def decode(value, options) do
    GoogleApi.Recommender.V1.Model.GoogleCloudRecommenderV1RecommendationContent.decode(
      value,
      options
    )
  end
