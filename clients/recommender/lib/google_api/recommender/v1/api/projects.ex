...
defmodule GoogleApi.Recommender.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_insight_types_get_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_projects_locations_insight_types_get_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_insight_types_update_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_projects_locations_insight_types_update_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_recommenders_get_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_projects_locations_recommenders_get_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_recommenders_update_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec recommender_projects_locations_recommenders_recommendations_mark_dismissed(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
