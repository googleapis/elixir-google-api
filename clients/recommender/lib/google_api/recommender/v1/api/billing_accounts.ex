...
defmodule GoogleApi.Recommender.V1.Api.BillingAccounts do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec recommender_billing_accounts_locations_insight_types_get_config(
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_billing_accounts_locations_insight_types_get_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  ...
  @spec recommender_billing_accounts_locations_insight_types_update_config(
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_billing_accounts_locations_insight_types_update_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  ...
  @spec recommender_billing_accounts_locations_recommenders_get_config(
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_billing_accounts_locations_recommenders_get_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  ...
  @spec recommender_billing_accounts_locations_recommenders_update_config(
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_billing_accounts_locations_recommenders_update_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  ...
  @spec recommender_billing_accounts_locations_recommenders_recommendations_mark_dismissed(
          ...
          | {:ok, list()}
          | {:error, any()}
  def recommender_billing_accounts_locations_recommenders_recommendations_mark_dismissed(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
