...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Api.Projects do
  ...
  *   `connection` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Connection.t`) - Connection to server
  *   `projects_id` (*type:* `String.t`) - Part of `name`. Required. The name of the scan configuration in the form of `projects/[PROJECT_ID]/scanConfigs/[SCAN_CONFIG_ID]`.
  ...
  *   `{:ok, %GoogleApi.ContainerAnalysis.V1beta1.Model.ScanConfig{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def containeranalysis_projects_scan_configs_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta1/projects/{projectsId}/scanConfigs/{scanConfigsId}", %{
        "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.ContainerAnalysis.V1beta1.Model.ScanConfig{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Connection.t`) - Connection to server
  *   `projects_id` (*type:* `String.t`) - Part of `parent`. Required. The name of the project to list scan configurations for in the form of `projects/[PROJECT_ID]`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:filter` (*type:* `String.t`) - Required. The filter expression.
      *   `:pageSize` (*type:* `integer()`) - The number of scan configs to return in the list.
      *   `:pageToken` (*type:* `String.t`) - Token to provide to skip to a particular spot in the list.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.ContainerAnalysis.V1beta1.Model.ListScanConfigsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def containeranalysis_projects_scan_configs_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta1/projects/{projectsId}/scanConfigs", %{
        "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.ContainerAnalysis.V1beta1.Model.ListScanConfigsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.ScanConfig.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec containeranalysis_projects_scan_configs_update(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
