...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.SbomReferenceIntotoPredicate do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContainerAnalysis.V1beta1.Model.SbomReferenceIntotoPredicate do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.SbomReferenceIntotoPredicate.decode(value, options)
  end
end
