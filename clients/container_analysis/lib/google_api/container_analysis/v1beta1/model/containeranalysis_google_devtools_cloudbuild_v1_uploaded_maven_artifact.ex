...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact do
  @moduledoc """
  A Maven artifact uploaded using the MavenArtifact directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes.t`, *default:* `nil`) - Hash types and values of the Maven Artifact.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedMavenArtifact.decode(
      value,
      options
    )
  end
