...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.Source do
  @moduledoc """
  ...
  *   `fileHashes` (*type:* `%{optional(String.t) => GoogleApi.ContainerAnalysis.V1beta1.Model.FileHashes.t}`, *default:* `nil`) - Hash(es) of the build source, which can be used to verify that the original source integrity was maintained in the build. The keys to this map are file paths used as build source and the values contain the hash values for those files. If the build source came in a single package such as a gzipped tarfile (.tar.gz), the FileHash will be for the single path to that file.
  ...
  field(:additionalContexts,
    as: GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext,
    type: :list
  )

  field(:artifactStorageSourceUri)
  field(:context, as: GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext)
  field(:fileHashes, as: GoogleApi.ContainerAnalysis.V1beta1.Model.FileHashes, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Source do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.Source.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Source do
