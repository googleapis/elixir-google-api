...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Source do
  ...
  *   `developerConnectConfig` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig.t`, *default:* `nil`) - If provided, get the source from this Developer Connect config.
  ...
  *   `storageSourceManifest` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1StorageSourceManifest.t`, *default:* `nil`) - If provided, get the source from this manifest in Cloud Storage. This feature is in Preview; see description [here](https://github.com/GoogleCloudPlatform/cloud-builders/tree/master/gcs-fetcher).
  ...
  @type t :: %__MODULE__{
          ...
          :developerConnectConfig =>
            GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig.t()
            | nil,
          :gitSource =>
  ...
  field(:developerConnectConfig,
    as:
      GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DeveloperConnectConfig
  )
