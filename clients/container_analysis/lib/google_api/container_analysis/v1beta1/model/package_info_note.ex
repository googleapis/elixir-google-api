...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoNote do
  @moduledoc """
  ...
  *   `licenseDeclared` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.License.t`, *default:* `nil`) - List the licenses that have been declared by the authors of the package
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Identify the version of the package
  ...
  @type t :: %__MODULE__{
          ...
          :licenseDeclared => GoogleApi.ContainerAnalysis.V1beta1.Model.License.t() | nil,
  ...
  field(:homePage)
  field(:licenseDeclared, as: GoogleApi.ContainerAnalysis.V1beta1.Model.License)
  field(:originator)
  field(:packageType)
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoNote do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoNote.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoNote do
