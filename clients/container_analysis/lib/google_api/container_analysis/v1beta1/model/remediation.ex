...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.Remediation do
  @moduledoc """
  ...
  *   `remediationUri` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.RelatedUrl.t`, *default:* `nil`) - Contains the URL where to obtain the remediation.
  ...
  field(:remediationUri, as: GoogleApi.ContainerAnalysis.V1beta1.Model.RelatedUrl)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Remediation do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.Remediation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Remediation do
