...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.PackageIssue do
  @moduledoc """
  ...
  *   `severityName` (*type:* `String.t`, *default:* `nil`) - Deprecated, use Details.effective_severity instead The severity (e.g., distro assigned severity) for this vulnerability.
  ...
  @type t :: %__MODULE__{
          :affectedLocation =>
            GoogleApi.ContainerAnalysis.V1beta1.Model.VulnerabilityLocation.t(),
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageIssue do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.PackageIssue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageIssue do
