...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.CloudRepoSourceContext do
  @moduledoc """
  ...
  *   `revisionId` (*type:* `String.t`, *default:* `nil`) - A revision ID.
  ...
  field(:repoId, as: GoogleApi.ContainerAnalysis.V1beta1.Model.RepoId)
  field(:revisionId)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.CloudRepoSourceContext do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.CloudRepoSourceContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.CloudRepoSourceContext do
