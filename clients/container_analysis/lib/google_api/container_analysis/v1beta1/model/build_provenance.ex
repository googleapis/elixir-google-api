...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.BuildProvenance do
  @moduledoc """
  ...
  *   `builtArtifacts` (*type:* `list(GoogleApi.ContainerAnalysis.V1beta1.Model.Artifact.t)`, *default:* `nil`) - Output of the build.
  *   `commands` (*type:* `list(GoogleApi.ContainerAnalysis.V1beta1.Model.Command.t)`, *default:* `nil`) - Commands requested by the build.
  ...
  *   `sourceProvenance` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.Source.t`, *default:* `nil`) - Details of the Source input to the build.
  ...
  *   `triggerId` (*type:* `String.t`, *default:* `nil`) - Trigger identifier if the build was triggered automatically; empty if not.
  ...
  @type t :: %__MODULE__{
          ...
          :builtArtifacts => list(GoogleApi.ContainerAnalysis.V1beta1.Model.Artifact.t()) | nil,
          :commands => list(GoogleApi.ContainerAnalysis.V1beta1.Model.Command.t()) | nil,
          ...
          :sourceProvenance => GoogleApi.ContainerAnalysis.V1beta1.Model.Source.t() | nil,
  ...
  field(:builtArtifacts, as: GoogleApi.ContainerAnalysis.V1beta1.Model.Artifact, type: :list)
  field(:commands, as: GoogleApi.ContainerAnalysis.V1beta1.Model.Command, type: :list)
  ...
  field(:logsUri)
  field(:projectId)
  field(:sourceProvenance, as: GoogleApi.ContainerAnalysis.V1beta1.Model.Source)
  field(:startTime, as: DateTime)
  field(:triggerId)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.BuildProvenance do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.BuildProvenance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.BuildProvenance do
