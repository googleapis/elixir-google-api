...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.BuildProvenance do
  ...
  *   `triggerId` (*type:* `String.t`, *default:* `nil`) - Trigger identifier if the build was triggered automatically; empty if not.
  ...
  @type t :: %__MODULE__{
          ...
          :builtArtifacts => list(GoogleApi.ContainerAnalysis.V1beta1.Model.Artifact.t()),
          :commands => list(GoogleApi.ContainerAnalysis.V1beta1.Model.Command.t()),
          ...
          :logsUri => String.t(),
          :projectId => String.t(),
          :sourceProvenance => GoogleApi.ContainerAnalysis.V1beta1.Model.Source.t(),
