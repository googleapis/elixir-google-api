...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.Installation do
  ...
  *   `location` (*type:* `list(GoogleApi.ContainerAnalysis.V1beta1.Model.Location.t)`, *default:* `nil`) - Required. All of the places within the filesystem versions of this package have been found.
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The name of the installed package.
  ...
  @type t :: %__MODULE__{
          :location => list(GoogleApi.ContainerAnalysis.V1beta1.Model.Location.t()),
          :name => String.t()
        }
