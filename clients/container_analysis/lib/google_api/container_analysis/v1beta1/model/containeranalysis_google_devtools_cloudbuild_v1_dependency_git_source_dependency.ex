...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency do
  @moduledoc """
  ...
  *   `revision` (*type:* `String.t`, *default:* `nil`) - Required. The revision that we will fetch the repo at.
  ...
  field(:repository,
    as:
      GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceRepository
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1DependencyGitSourceDependency.decode(
      value,
      options
    )
  end
