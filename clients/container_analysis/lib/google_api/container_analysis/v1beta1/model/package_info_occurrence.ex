...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoOccurrence do
  @moduledoc """
  ...
  *   `licenseConcluded` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.License.t`, *default:* `nil`) - package or alternative values, if the governing license cannot be determined
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoOccurrence do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.PackageInfoOccurrence do
