...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext do
  @moduledoc """
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Labels with user defined metadata.
  ...
  field(:gerrit, as: GoogleApi.ContainerAnalysis.V1beta1.Model.GerritSourceContext)
  field(:git, as: GoogleApi.ContainerAnalysis.V1beta1.Model.GitSourceContext)
  field(:labels, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.SourceContext do
