...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.Distribution do
  @moduledoc """
  ...
  *   `url` (*type:* `String.t`, *default:* `nil`) - The distribution channel-specific homepage for this package.
  ...
  @type t :: %__MODULE__{
          ...
          :latestVersion => GoogleApi.ContainerAnalysis.V1beta1.Model.Version.t(),
          :maintainer => String.t(),
          :url => String.t()
        }
  ...
  field(:cpeUri)
  field(:description)
  field(:latestVersion, as: GoogleApi.ContainerAnalysis.V1beta1.Model.Version)
  field(:maintainer)
  field(:url)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Distribution do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.Distribution.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1beta1.Model.Distribution do
