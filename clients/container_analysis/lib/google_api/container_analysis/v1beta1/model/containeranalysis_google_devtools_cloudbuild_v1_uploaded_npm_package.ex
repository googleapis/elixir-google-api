...
defmodule GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage do
  @moduledoc """
  An npm package uploaded to Artifact Registry using the NpmPackage directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes.t`, *default:* `nil`) - Hash types and values of the npm package.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1beta1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage.decode(
      value,
      options
    )
  end
