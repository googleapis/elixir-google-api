...
defmodule GoogleApi.ContainerAnalysis.V1.Model.Artifact do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.Artifact do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.Artifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.Artifact do
