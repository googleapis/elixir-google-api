...
defmodule GoogleApi.ContainerAnalysis.V1.Model.WindowsUpdate do
  @moduledoc """
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - The localized title of the update.
  ...
  @type t :: %__MODULE__{
          :categories => list(GoogleApi.ContainerAnalysis.V1.Model.Category.t()) | nil,
  ...
  field(:categories, as: GoogleApi.ContainerAnalysis.V1.Model.Category, type: :list)
  field(:description)
  field(:identity, as: GoogleApi.ContainerAnalysis.V1.Model.Identity)
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.WindowsUpdate do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.WindowsUpdate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.WindowsUpdate do
