...
defmodule GoogleApi.ContainerAnalysis.V1.Model.Volume do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.Volume do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.Volume.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.Volume do
