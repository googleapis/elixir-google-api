...
defmodule GoogleApi.ContainerAnalysis.V1.Model.ComplianceNote do
  @moduledoc """
  ...
  *   `impact` (*type:* `String.t`, *default:* `nil`) - 
  ...
  *   `version` (*type:* `list(GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion.t)`, *default:* `nil`) - The OS and config versions the benchmark applies to.
  ...
  @type t :: %__MODULE__{
          :cisBenchmark => GoogleApi.ContainerAnalysis.V1.Model.CisBenchmark.t() | nil,
          ...
          :title => String.t() | nil,
          :version => list(GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion.t()) | nil
        }

  field(:cisBenchmark, as: GoogleApi.ContainerAnalysis.V1.Model.CisBenchmark)
  field(:description)
  field(:impact)
  field(:rationale)
  field(:remediation)
  ...
  field(:title)
  field(:version, as: GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.ComplianceNote do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.ComplianceNote.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.ComplianceNote do
