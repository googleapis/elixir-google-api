...
defmodule GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.ComplianceVersion do
