...
defmodule GoogleApi.ContainerAnalysis.V1.Model.ImageNote do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.ImageNote do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.ImageNote.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.ImageNote do
