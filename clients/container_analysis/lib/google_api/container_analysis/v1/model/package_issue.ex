...
defmodule GoogleApi.ContainerAnalysis.V1.Model.PackageIssue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.PackageIssue do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.PackageIssue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.PackageIssue do
