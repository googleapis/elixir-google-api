...
defmodule GoogleApi.ContainerAnalysis.V1.Model.DeploymentOccurrence do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.DeploymentOccurrence do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.DeploymentOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.DeploymentOccurrence do
