...
defmodule GoogleApi.ContainerAnalysis.V1.Model.SourceContext do
  @moduledoc """
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Labels with user defined metadata.
  ...
  @type t :: %__MODULE__{
          :cloudRepo => GoogleApi.ContainerAnalysis.V1.Model.CloudRepoSourceContext.t() | nil,
  ...
  field(:cloudRepo, as: GoogleApi.ContainerAnalysis.V1.Model.CloudRepoSourceContext)
  field(:gerrit, as: GoogleApi.ContainerAnalysis.V1.Model.GerritSourceContext)
  field(:git, as: GoogleApi.ContainerAnalysis.V1.Model.GitSourceContext)
  field(:labels, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.SourceContext do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.SourceContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.SourceContext do
