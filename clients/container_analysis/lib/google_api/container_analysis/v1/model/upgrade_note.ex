...
defmodule GoogleApi.ContainerAnalysis.V1.Model.UpgradeNote do
  @moduledoc """
  ...
  *   `windowsUpdate` (*type:* `GoogleApi.ContainerAnalysis.V1.Model.WindowsUpdate.t`, *default:* `nil`) - Required for Windows OS. Represents the metadata about the Windows update.
  ...
  @type t :: %__MODULE__{
          :distributions =>
            list(GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution.t()) | nil,
  ...
  field(:distributions, as: GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution, type: :list)
  field(:package)
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.UpgradeNote do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.UpgradeNote.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.UpgradeNote do
