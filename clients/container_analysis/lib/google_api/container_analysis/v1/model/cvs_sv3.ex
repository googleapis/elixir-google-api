...
defmodule GoogleApi.ContainerAnalysis.V1.Model.CVSSv3 do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.CVSSv3 do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.CVSSv3.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.CVSSv3 do
