...
defmodule GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.UpgradeDistribution do
