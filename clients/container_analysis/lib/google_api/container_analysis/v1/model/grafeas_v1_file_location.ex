...
defmodule GoogleApi.ContainerAnalysis.V1.Model.GrafeasV1FileLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.GrafeasV1FileLocation do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.GrafeasV1FileLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.GrafeasV1FileLocation do
