...
defmodule GoogleApi.ContainerAnalysis.V1.Model.DiscoveryOccurrence do
  ...
  *   `analysisCompleted` (*type:* `GoogleApi.ContainerAnalysis.V1.Model.AnalysisCompleted.t`, *default:* `nil`) - 
  *   `analysisError` (*type:* `list(GoogleApi.ContainerAnalysis.V1.Model.Status.t)`, *default:* `nil`) - Indicates any errors encountered during analysis of a resource. There could be 0 or more of these errors.
  ...
  *   `sbomStatus` (*type:* `GoogleApi.ContainerAnalysis.V1.Model.SBOMStatus.t`, *default:* `nil`) - The status of an SBOM generation.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :analysisCompleted => GoogleApi.ContainerAnalysis.V1.Model.AnalysisCompleted.t() | nil,
          :analysisError => list(GoogleApi.ContainerAnalysis.V1.Model.Status.t()) | nil,
          ...
          :sbomStatus => GoogleApi.ContainerAnalysis.V1.Model.SBOMStatus.t() | nil
        }

  field(:analysisCompleted, as: GoogleApi.ContainerAnalysis.V1.Model.AnalysisCompleted)
  field(:analysisError, as: GoogleApi.ContainerAnalysis.V1.Model.Status, type: :list)
  ...
  field(:sbomStatus, as: GoogleApi.ContainerAnalysis.V1.Model.SBOMStatus)
end
