...
defmodule GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets do
  @moduledoc """
  ...
  *   `secretManager` (*type:* `list(GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1SecretManagerSecret.t)`, *default:* `nil`) - Secrets in Secret Manager and associated secret environment variable.
  ...
  field(:inline,
    as:
      GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1InlineSecret,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Secrets.decode(
      value,
      options
    )
  end
