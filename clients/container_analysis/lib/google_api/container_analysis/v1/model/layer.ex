...
defmodule GoogleApi.ContainerAnalysis.V1.Model.Layer do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.Layer do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.Layer.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.Layer do
