...
defmodule GoogleApi.ContainerAnalysis.V1.Model.SlsaMetadata do
  @moduledoc """
  ...
  *   `completeness` (*type:* `GoogleApi.ContainerAnalysis.V1.Model.SlsaCompleteness.t`, *default:* `nil`) - Indicates that the builder claims certain fields in this message to be complete.
  *   `reproducible` (*type:* `boolean()`, *default:* `nil`) - If true, the builder claims that running the recipe on materials will produce bit-for-bit identical output.
  ...
  @type t :: %__MODULE__{
          ...
          :completeness => GoogleApi.ContainerAnalysis.V1.Model.SlsaCompleteness.t() | nil,
  ...
  field(:completeness, as: GoogleApi.ContainerAnalysis.V1.Model.SlsaCompleteness)
  field(:reproducible)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.SlsaMetadata do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.SlsaMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.SlsaMetadata do
