...
defmodule GoogleApi.ContainerAnalysis.V1.Model.VexAssessment do
  @moduledoc """
  ...
  *   `relatedUris` (*type:* `list(GoogleApi.ContainerAnalysis.V1.Model.RelatedUrl.t)`, *default:* `nil`) - Holds a list of references associated with this vulnerability item and assessment.
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.VexAssessment do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.VexAssessment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.VexAssessment do
