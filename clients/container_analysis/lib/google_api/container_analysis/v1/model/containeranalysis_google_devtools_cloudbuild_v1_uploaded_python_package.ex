...
defmodule GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage do
  @moduledoc """
  Artifact uploaded using the PythonPackage directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1FileHashes.t`, *default:* `nil`) - Hash types and values of the Python Artifact.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage.decode(
      value,
      options
    )
  end
