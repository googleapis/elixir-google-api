...
defmodule GoogleApi.ContainerAnalysis.V1.Model.Recipe do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1.Model.Recipe do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1.Model.Recipe.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1.Model.Recipe do
