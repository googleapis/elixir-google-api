...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.Product do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Name of the product.
  ...
  field(:id)
  field(:identifierHelper, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.IdentifierHelper)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.Product do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.Product.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.Product do
