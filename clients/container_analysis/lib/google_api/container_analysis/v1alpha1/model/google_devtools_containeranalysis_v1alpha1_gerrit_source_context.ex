...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext do
  @moduledoc """
  ...
  *   `revisionId` (*type:* `String.t`, *default:* `nil`) - A revision (commit) ID.
  ...
  field(:aliasContext,
    as:
      GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1AliasContext
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext.decode(
      value,
      options
    )
  end
