...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata do
  @moduledoc """
  ...
  *   `reproducible` (*type:* `boolean()`, *default:* `nil`) - If true, the builder claims that running the recipe on materials will produce bit-for-bit identical output.
  ...
  @type t :: %__MODULE__{
          ...
          :completeness => GoogleApi.ContainerAnalysis.V1alpha1.Model.Completeness.t() | nil,
  ...
  field(:completeness, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.Completeness)
  field(:reproducible)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata do
