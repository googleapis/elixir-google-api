...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts do
  @moduledoc """
  ...
  *   `pythonPackages` (*type:* `list(GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage.t)`, *default:* `nil`) - A list of Python packages to be uploaded to Artifact Registry upon successful completion of all build steps. The build service account credentials will be used to perform the upload. If any objects fail to be pushed, the build is marked FAILURE.
  ...
  @type t :: %__MODULE__{
          ...
          :mavenArtifacts =>
            list(
              GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact.t()
            )
            | nil,
          :npmPackages =>
            list(
              GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage.t()
            )
            | nil,
          :objects =>
            GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects.t()
            | nil,
          :pythonPackages =>
            list(
              GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage.t()
            )
            | nil
        }
  ...
  field(:mavenArtifacts,
    as:
      GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsMavenArtifact,
    type: :list
  )

  field(:npmPackages,
    as:
      GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsNpmPackage,
    type: :list
  )

  field(:objects,
    as:
      GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsArtifactObjects
  )

  field(:pythonPackages,
    as:
      GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1ArtifactsPythonPackage,
    type: :list
  )
end
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.ContaineranalysisGoogleDevtoolsCloudbuildV1Artifacts.decode(
      value,
      options
    )
  end
