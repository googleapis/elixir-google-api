...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.SetIamPolicyRequest do
  ...
  *   `policy` (*type:* `GoogleApi.ContainerAnalysis.V1alpha1.Model.Policy.t`, *default:* `nil`) - REQUIRED: The complete policy to be applied to the `resource`. The size of the policy is limited to a few 10s of KB. An empty policy is a valid policy but certain Cloud Platform services (such as Projects) might reject them.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :policy => GoogleApi.ContainerAnalysis.V1alpha1.Model.Policy.t()
        }
