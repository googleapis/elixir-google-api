...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.InTotoProvenance do
  @moduledoc """
  ...
  *   `recipe` (*type:* `GoogleApi.ContainerAnalysis.V1alpha1.Model.Recipe.t`, *default:* `nil`) - Identifies the configuration used for the build. When combined with materials, this SHOULD fully describe the build, such that re-running this recipe results in bit-for-bit identical output (if the build is reproducible). required
  ...
  @type t :: %__MODULE__{
          :builderConfig => GoogleApi.ContainerAnalysis.V1alpha1.Model.BuilderConfig.t() | nil,
          :materials => list(String.t()) | nil,
          :metadata => GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata.t() | nil,
          :recipe => GoogleApi.ContainerAnalysis.V1alpha1.Model.Recipe.t() | nil
        }

  field(:builderConfig, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.BuilderConfig)
  field(:materials, type: :list)
  field(:metadata, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.Metadata)
  field(:recipe, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.Recipe)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.InTotoProvenance do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.InTotoProvenance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.InTotoProvenance do
