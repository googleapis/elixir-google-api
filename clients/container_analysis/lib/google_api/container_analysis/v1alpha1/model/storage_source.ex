...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.StorageSource do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.StorageSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.StorageSource do
