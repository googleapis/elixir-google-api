...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.Recipe do
  ...
  *   `environment` (*type:* `map()`, *default:* `nil`) - Any other builder-controlled inputs necessary for correctly evaluating the recipe. Usually only needed for reproducing the build but not evaluated as part of policy.
