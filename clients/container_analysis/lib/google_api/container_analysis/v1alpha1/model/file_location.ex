...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.FileLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.FileLocation do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.FileLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.FileLocation do
