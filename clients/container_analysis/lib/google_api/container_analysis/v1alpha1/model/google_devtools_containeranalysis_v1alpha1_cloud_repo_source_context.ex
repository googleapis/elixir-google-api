...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContext do
  ...
  *   `revisionId` (*type:* `String.t`, *default:* `nil`) - A revision ID.
  ...
  field(:repoId,
    as: GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1RepoId
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContext do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.GoogleDevtoolsContaineranalysisV1alpha1CloudRepoSourceContext.decode(
      value,
      options
    )
  end
