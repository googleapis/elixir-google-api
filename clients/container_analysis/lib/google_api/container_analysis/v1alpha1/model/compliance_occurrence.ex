...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.ComplianceOccurrence do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.ComplianceOccurrence do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.ComplianceOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.ComplianceOccurrence do
