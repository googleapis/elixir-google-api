...
defmodule GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaProvenance do
  @moduledoc """
  ...
  *   `recipe` (*type:* `GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaRecipe.t`, *default:* `nil`) - Identifies the configuration used for the build. When combined with materials, this SHOULD fully describe the build, such that re-running this recipe results in bit-for-bit identical output (if the build is reproducible).
  ...
  @type t :: %__MODULE__{
          :builder => GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaBuilder.t() | nil,
          :materials => list(GoogleApi.ContainerAnalysis.V1alpha1.Model.Material.t()) | nil,
          :metadata => GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaMetadata.t() | nil,
          :recipe => GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaRecipe.t() | nil
        }

  field(:builder, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaBuilder)
  field(:materials, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.Material, type: :list)
  field(:metadata, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaMetadata)
  field(:recipe, as: GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaRecipe)
end

defimpl Poison.Decoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaProvenance do
  def decode(value, options) do
    GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaProvenance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContainerAnalysis.V1alpha1.Model.SlsaProvenance do
