...
defmodule GoogleApi.YouTube.V3.Api.Sponsors do
  ...
  """
  @spec youtube_sponsors_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.SponsorListResponse.t} | {:error, Tesla.Env.t}
  def youtube_sponsors_list(connection, part, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/youtube/v3/sponsors")
    |> add_param(:query, :"part", part)
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.YouTube.V3.Model.SponsorListResponse{})
  end
end
