...
defmodule GoogleApi.YouTube.V3.Api.VideoAbuseReportReasons do
  ...
  *   `part` (*type:* `String.t`) - The part parameter specifies the videoCategory resource parts that the API response will include. Supported values are id and snippet.
  ...
  *   `{:error, info}` on failure
  """
  @spec youtube_video_abuse_report_reasons_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
