...
defmodule GoogleApi.YouTube.V3.Api.ChannelBanners do
  ...
  {:error, info} on failure
  """
  @spec youtube_channel_banners_insert_resumable(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_channel_banners_insert_simple(Tesla.Env.client, String.t, GoogleApi.YouTube.V3.Model.ChannelBannerResource.t, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.ChannelBannerResource.t} | {:error, Tesla.Env.t}
