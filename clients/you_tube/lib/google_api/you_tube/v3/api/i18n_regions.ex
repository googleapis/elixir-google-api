...
defmodule GoogleApi.YouTube.V3.Api.I18nRegions do
  ...
  *   `part` (*type:* `String.t`) - The part parameter specifies the i18nRegion resource properties that the API response will include. Set the parameter value to snippet.
  ...
  *   `{:error, info}` on failure
  """
  @spec youtube_i18n_regions_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  def youtube_i18n_regions_list(connection, part, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.YouTube.V3.Model.I18nRegionListResponse{}])
  end
end
