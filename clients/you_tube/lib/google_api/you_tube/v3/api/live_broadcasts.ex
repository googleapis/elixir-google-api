...
defmodule GoogleApi.YouTube.V3.Api.LiveBroadcasts do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :stream_id (String.t): The streamId parameter specifies the unique ID of the video stream that is being bound to a broadcast. If this parameter is omitted, the API will remove any existing binding between the broadcast and a video stream.
  ...
  """
  @spec youtube_live_broadcasts_bind(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcast.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_control(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcast.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_delete(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcast.t} | {:error, Tesla.Env.t}
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quota_user (String.t): Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    - :user_ip (String.t): IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    - :broadcast_status (String.t): The broadcastStatus parameter filters the API response to only include broadcasts with the specified status.
    - :broadcast_type (String.t): The broadcastType parameter filters the API response to only include broadcasts with the specified type. This is only compatible with the mine filter for now.
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_transition(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcast.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_live_broadcasts_update(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.LiveBroadcast.t} | {:error, Tesla.Env.t}
