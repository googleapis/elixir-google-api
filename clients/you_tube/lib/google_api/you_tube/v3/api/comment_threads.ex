...
defmodule GoogleApi.YouTube.V3.Api.CommentThreads do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.YouTube.V3.Model.CommentThread.t): 
  ...
  Note: This parameter is not supported for use in conjunction with the id parameter.
    - :moderationStatus (String.t): Set this parameter to limit the returned comment threads to a particular moderation state.

  Note: This parameter is not supported for use in conjunction with the id parameter.
    - :order (String.t): The order parameter specifies the order in which the API response should list comment threads. Valid values are: 
  ...
  Note: This parameter is not supported for use in conjunction with the id parameter.
    - :searchTerms (String.t): The searchTerms parameter instructs the API to limit the API response to only contain comments that contain the specified search terms.
