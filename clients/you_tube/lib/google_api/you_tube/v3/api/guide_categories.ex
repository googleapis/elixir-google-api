...
defmodule GoogleApi.YouTube.V3.Api.GuideCategories do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :regionCode (String.t): The regionCode parameter instructs the API to return the list of guide categories available in the specified country. The parameter value is an ISO 3166-1 alpha-2 country code.
  ...
  """
  @spec youtube_guide_categories_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.YouTube.V3.Model.GuideCategoryListResponse.t()}
          | {:error, Tesla.Env.t()}
  def youtube_guide_categories_list(connection, part, opts \\ []) do
    optional_params = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
    ...
    |> Response.decode(struct: %GoogleApi.YouTube.V3.Model.GuideCategoryListResponse{})
  end
end
