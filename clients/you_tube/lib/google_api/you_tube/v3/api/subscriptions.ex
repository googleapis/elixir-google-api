...
defmodule GoogleApi.YouTube.V3.Api.Subscriptions do
  ...
  *   `connection` (*type:* `GoogleApi.YouTube.V3.Connection.t`) - Connection to server
  *   `part` (*type:* `list(String.t)`) - The *part* parameter specifies a comma-separated list of one or more subscription resource properties that the API response will include. If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a subscription resource, the snippet property contains other properties, such as a display title for the subscription. If you set *part=snippet*, the API response will also contain all of those nested properties.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:channelId` (*type:* `String.t`) - Return the subscriptions of the given channel owner.
      *   `:forChannelId` (*type:* `String.t`) - Return the subscriptions to the subset of these channels that the authenticated user is subscribed to.
      *   `:id` (*type:* `list(String.t)`) - Return the subscriptions with the given IDs for Stubby or Apiary.
      ...
      *   `:mine` (*type:* `boolean()`) - Flag for returning the subscriptions of the authenticated user.
      *   `:myRecentSubscribers` (*type:* `boolean()`) - 
      *   `:mySubscribers` (*type:* `boolean()`) - Return the subscribers of the given channel owner.
      ...
      *   `:order` (*type:* `String.t`) - The order of the returned subscriptions
