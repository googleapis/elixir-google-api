...
defmodule GoogleApi.YouTube.V3.Api.MembershipsLevels do
  @moduledoc """
  ...
  *   `part` (*type:* `list(String.t)`) - The *part* parameter specifies the membershipsLevel resource parts that the API response will include. Supported values are id and snippet.
  ...
  *   `{:error, info}` on failure
  ...
  def youtube_memberships_levels_list(connection, part, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/youtube/v3/membershipsLevels", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.YouTube.V3.Model.MembershipsLevelListResponse{}]
    )
  end
end
