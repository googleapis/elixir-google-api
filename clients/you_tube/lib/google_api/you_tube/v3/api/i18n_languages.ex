...
defmodule GoogleApi.YouTube.V3.Api.I18nLanguages do
  ...
  *   `part` (*type:* `String.t`) - The part parameter specifies the i18nLanguage resource properties that the API response will include. Set the parameter value to snippet.
  ...
  *   `{:error, info}` on failure
  ...
  def youtube_i18n_languages_list(connection, part, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.YouTube.V3.Model.I18nLanguageListResponse{}])
  end
end
