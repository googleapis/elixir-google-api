...
defmodule GoogleApi.YouTube.V3.Api.I18nLanguages do
  @moduledoc """
  ...
  {:ok, %GoogleApi.YouTube.V3.Model.I18nLanguageListResponse{}} on success
  {:error, info} on failure
  """
  @spec youtube_i18n_languages_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTube.V3.Model.I18nLanguageListResponse.t} | {:error, Tesla.Env.t}
  def youtube_i18n_languages_list(connection, part, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/youtube/v3/i18nLanguages")
    |> add_param(:query, :"part", part)
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.YouTube.V3.Model.I18nLanguageListResponse{})
  end
end
