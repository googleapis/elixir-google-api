...
defmodule GoogleApi.YouTube.V3.Model.VideoProcessingDetailsProcessingProgress do
  ...
  *   `partsProcessed` (*type:* `String.t`, *default:* `nil`) - The number of parts of the video that YouTube has already processed.
  ...
  *   `partsTotal` (*type:* `String.t`, *default:* `nil`) - An estimate of the total number of parts that need to be processed
      for the video. The number may be updated with more precise estimates
      while YouTube processes the video.
  *   `timeLeftMs` (*type:* `String.t`, *default:* `nil`) - An estimate of the amount of time, in millseconds, that YouTube needs
