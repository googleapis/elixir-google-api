...
defmodule GoogleApi.YouTube.V3.Model.Comment do
  ...
  - id (String.t): The ID that YouTube uses to uniquely identify the comment. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#comment". Defaults to `youtube#comment`.
  - snippet (GoogleApi.YouTube.V3.Model.CommentSnippet.t): The snippet object contains basic details about the comment. Defaults to `nil`.
  """
