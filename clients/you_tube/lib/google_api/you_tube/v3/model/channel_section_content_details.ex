...
defmodule GoogleApi.YouTube.V3.Model.ChannelSectionContentDetails do
  ...
  - channels (list(String.t)): The channel ids for type multiple_channels. Defaults to `nil`.
  - playlists (list(String.t)): The playlist ids for type single_playlist and multiple_playlists. For singlePlaylist, only one playlistId is allowed. Defaults to `nil`.
  """
