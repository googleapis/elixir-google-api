...
defmodule GoogleApi.YouTube.V3.Model.SearchResult do
  ...
  *   `id` (*type:* `GoogleApi.YouTube.V3.Model.ResourceId.t`, *default:* `nil`) - The <code>id</code> object contains information that can be used to
      uniquely identify the resource that matches the search request.
  *   `kind` (*type:* `String.t`, *default:* `youtube#searchResult`) - Identifies what kind of resource this is. Value: the fixed string
      <code>"youtube#searchResult"</code>.
  *   `snippet` (*type:* `GoogleApi.YouTube.V3.Model.SearchResultSnippet.t`, *default:* `nil`) - The <code>snippet</code> object contains basic details about a search
