...
defmodule GoogleApi.YouTube.V3.Model.LiveChatModeratorSnippet do
  ...
  - liveChatId (String.t): The ID of the live chat this moderator can act on. Defaults to `nil`.
  - moderatorDetails (GoogleApi.YouTube.V3.Model.ChannelProfileDetails.t): Details about the moderator. Defaults to `nil`.
  """
