...
defmodule GoogleApi.YouTube.V3.Model.LiveChatUserBannedMessageDetails do
  ...
  - banDurationSeconds (String.t): The duration of the ban. This property is only present if the banType is temporary. Defaults to `nil`.
  - banType (String.t): The type of ban. Defaults to `nil`.
  - bannedUserDetails (GoogleApi.YouTube.V3.Model.ChannelProfileDetails.t): The details of the user that was banned. Defaults to `nil`.
  """
