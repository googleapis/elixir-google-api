...
defmodule GoogleApi.YouTube.V3.Model.ChannelSnippet do
  ...
  *   `publishedAt` (*type:* `String.t`, *default:* `nil`) - The date and time that the channel was created. The value is specified in < a href="//www.w3.org/TR/NOTE-datetime">ISO 8601 format.
