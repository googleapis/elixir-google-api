...
defmodule GoogleApi.YouTube.V3.Model.FanFundingEventListResponse do
  @moduledoc """
  ...
  - items ([FanFundingEvent]): A list of fan funding events that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#fanFundingEventListResponse\&quot;. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.FanFundingEventListResponse do
  import GoogleApi.YouTube.V3.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:items, :list, GoogleApi.YouTube.V3.Model.FanFundingEvent, options)
...
defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.FanFundingEventListResponse do
