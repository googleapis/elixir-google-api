...
defmodule GoogleApi.YouTube.V3.Model.GuideCategorySnippet do
  ...
  - channelId (String.t):  Defaults to `UCBR8-60-B28hp2BmDPdntcQ`.
  - title (String.t): Description of the guide category. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.GuideCategorySnippet do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.GuideCategorySnippet.decode(value, options)
  end
end
