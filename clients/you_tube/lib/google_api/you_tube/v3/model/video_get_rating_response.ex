...
defmodule GoogleApi.YouTube.V3.Model.VideoGetRatingResponse do
  ...
  - items ([VideoRating]): A list of ratings that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#videoGetRatingResponse\&quot;. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.VideoGetRatingResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.YouTube.V3.Model.VideoRating, options)
  end
end
