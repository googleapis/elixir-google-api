...
defmodule GoogleApi.YouTube.V3.Model.VideoGetRatingResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.VideoRating.t)): A list of ratings that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#videoGetRatingResponse". Defaults to `youtube#videoGetRatingResponse`.
