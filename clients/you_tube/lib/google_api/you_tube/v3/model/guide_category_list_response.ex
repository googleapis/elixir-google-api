...
defmodule GoogleApi.YouTube.V3.Model.GuideCategoryListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.GuideCategory.t)): A list of categories that can be associated with YouTube channels. In this map, the category ID is the map key, and its value is the corresponding guideCategory resource. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#guideCategoryListResponse". Defaults to `youtube#guideCategoryListResponse`.
