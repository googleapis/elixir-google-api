...
defmodule GoogleApi.YouTube.V3.Model.ChannelAuditDetails do
  ...
  - communityGuidelinesGoodStanding (boolean()): Whether or not the channel respects the community guidelines. Defaults to `nil`.
  - contentIdClaimsGoodStanding (boolean()): Whether or not the channel has any unresolved claims. Defaults to `nil`.
  - copyrightStrikesGoodStanding (boolean()): Whether or not the channel has any copyright strikes. Defaults to `nil`.
  """
