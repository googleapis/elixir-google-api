...
defmodule GoogleApi.YouTube.V3.Model.I18nRegion do
  ...
  - id (String.t): The ID that YouTube uses to uniquely identify the i18n region. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#i18nRegion". Defaults to `youtube#i18nRegion`.
  - snippet (GoogleApi.YouTube.V3.Model.I18nRegionSnippet.t): The snippet object contains basic details about the i18n region, such as region code and human-readable name. Defaults to `nil`.
  """
