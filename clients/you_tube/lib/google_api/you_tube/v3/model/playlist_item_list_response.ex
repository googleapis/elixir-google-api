...
defmodule GoogleApi.YouTube.V3.Model.PlaylistItemListResponse do
  ...
  - items ([PlaylistItem]): A list of playlist items that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#playlistItemListResponse\&quot;. Defaults to: `null`.
