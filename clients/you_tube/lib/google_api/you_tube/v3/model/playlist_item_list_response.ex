...
defmodule GoogleApi.YouTube.V3.Model.PlaylistItemListResponse do
  @moduledoc """
  ...
  - items (list(GoogleApi.YouTube.V3.Model.PlaylistItem.t)): A list of playlist items that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#playlistItemListResponse". Defaults to `youtube#playlistItemListResponse`.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.PlaylistItem.t()),
          :kind => String.t(),
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.PlaylistItem, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.PlaylistItemListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.PlaylistItemListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.PlaylistItemListResponse do
