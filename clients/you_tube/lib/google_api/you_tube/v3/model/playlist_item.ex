...
defmodule GoogleApi.YouTube.V3.Model.PlaylistItem do
  ...
  - contentDetails (GoogleApi.YouTube.V3.Model.PlaylistItemContentDetails.t): The contentDetails object is included in the resource if the included item is a YouTube video. The object contains additional information about the video. Defaults to `nil`.
  - etag (String.t): Etag of this resource. Defaults to `nil`.
  - id (String.t): The ID that YouTube uses to uniquely identify the playlist item. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#playlistItem". Defaults to `youtube#playlistItem`.
  - snippet (GoogleApi.YouTube.V3.Model.PlaylistItemSnippet.t): The snippet object contains basic details about the playlist item, such as its title and position in the playlist. Defaults to `nil`.
  - status (GoogleApi.YouTube.V3.Model.PlaylistItemStatus.t): The status object contains information about the playlist item's privacy status. Defaults to `nil`.
  """
