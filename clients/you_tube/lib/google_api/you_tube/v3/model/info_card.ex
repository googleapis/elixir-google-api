...
defmodule GoogleApi.YouTube.V3.Model.InfoCard do
  @moduledoc """
  ...
  *   `snippet` (*type:* `GoogleApi.YouTube.V3.Model.InfoCardSnippet.t`, *default:* `nil`) - The snippet object contains basic details about the infocard.
  ...
  field(:id)
  field(:kind)
  field(:snippet, as: GoogleApi.YouTube.V3.Model.InfoCardSnippet)
end

defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.InfoCard do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.InfoCard.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.InfoCard do
