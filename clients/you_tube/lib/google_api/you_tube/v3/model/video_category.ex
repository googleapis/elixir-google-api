...
defmodule GoogleApi.YouTube.V3.Model.VideoCategory do
  ...
  - id (String.t): The ID that YouTube uses to uniquely identify the video category. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#videoCategory". Defaults to `youtube#videoCategory`.
  - snippet (GoogleApi.YouTube.V3.Model.VideoCategorySnippet.t): The snippet object contains basic details about the video category, including its title. Defaults to `nil`.
  """
