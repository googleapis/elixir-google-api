...
defmodule GoogleApi.YouTube.V3.Model.InvideoPosition do
  ...
  *   `cornerPosition` (*type:* `String.t`, *default:* `nil`) - Describes in which corner of the video the visual widget will appear.
  *   `type` (*type:* `String.t`, *default:* `nil`) - Defines the position type.
  """
