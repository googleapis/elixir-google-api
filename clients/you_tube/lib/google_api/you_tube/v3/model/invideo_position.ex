...
defmodule GoogleApi.YouTube.V3.Model.InvideoPosition do
  ...
  - cornerPosition (String.t): Describes in which corner of the video the visual widget will appear. Defaults to `nil`.
  - type (String.t): Defines the position type. Defaults to `nil`.
  """
