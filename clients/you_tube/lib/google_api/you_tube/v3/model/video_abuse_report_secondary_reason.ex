...
defmodule GoogleApi.YouTube.V3.Model.VideoAbuseReportSecondaryReason do
  @moduledoc """


  ## Attributes

  *   `id` (*type:* `String.t`, *default:* `nil`) - The ID of this abuse report secondary reason.
  *   `label` (*type:* `String.t`, *default:* `nil`) - The localized label for this abuse report secondary reason.
  """
