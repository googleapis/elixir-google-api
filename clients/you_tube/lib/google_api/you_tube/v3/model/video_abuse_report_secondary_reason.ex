...
defmodule GoogleApi.YouTube.V3.Model.VideoAbuseReportSecondaryReason do
  ...
  - id (String.t): The ID of this abuse report secondary reason. Defaults to `nil`.
  - label (String.t): The localized label for this abuse report secondary reason. Defaults to `nil`.
  """
