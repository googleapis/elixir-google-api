...
defmodule GoogleApi.YouTube.V3.Model.CommentThreadListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.CommentThread.t)): A list of comment threads that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#commentThreadListResponse". Defaults to `youtube#commentThreadListResponse`.
