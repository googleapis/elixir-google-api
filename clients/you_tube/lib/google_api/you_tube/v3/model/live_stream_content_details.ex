...
defmodule GoogleApi.YouTube.V3.Model.LiveStreamContentDetails do
  ...
  - closedCaptionsIngestionUrl (String.t): The ingestion URL where the closed captions of this stream are sent. Defaults to `nil`.
  ...
  - The  liveStreams.list method does not list non-reusable streams if you call the method and set the mine parameter to true. The only way to use that method to retrieve the resource for a non-reusable stream is to use the id parameter to identify the stream. Defaults to `nil`.
  """
