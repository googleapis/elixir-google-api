...
defmodule GoogleApi.YouTube.V3.Model.SuperChatEventListResponse do
  ...
  - items ([SuperChatEvent]): A list of Super Chat purchases that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#superChatEventListResponse\&quot;. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.SuperChatEventListResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.YouTube.V3.Model.SuperChatEvent, options)
