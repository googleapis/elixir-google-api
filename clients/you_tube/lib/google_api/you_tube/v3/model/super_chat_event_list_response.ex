...
defmodule GoogleApi.YouTube.V3.Model.SuperChatEventListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.SuperChatEvent.t)): A list of Super Chat purchases that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#superChatEventListResponse". Defaults to `youtube#superChatEventListResponse`.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.SuperChatEvent.t()),
          :kind => String.t(),
