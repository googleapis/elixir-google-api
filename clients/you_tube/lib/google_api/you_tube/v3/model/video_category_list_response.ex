...
defmodule GoogleApi.YouTube.V3.Model.VideoCategoryListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.VideoCategory.t)): A list of video categories that can be associated with YouTube videos. In this map, the video category ID is the map key, and its value is the corresponding videoCategory resource. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#videoCategoryListResponse". Defaults to `youtube#videoCategoryListResponse`.
