...
defmodule GoogleApi.YouTube.V3.Model.VideoCategoryListResponse do
  ...
  - items ([VideoCategory]): A list of video categories that can be associated with YouTube videos. In this map, the video category ID is the map key, and its value is the corresponding videoCategory resource. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#videoCategoryListResponse\&quot;. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.VideoCategoryListResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.YouTube.V3.Model.VideoCategory, options)
