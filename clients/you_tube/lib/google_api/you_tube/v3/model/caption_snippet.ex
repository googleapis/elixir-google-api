...
defmodule GoogleApi.YouTube.V3.Model.CaptionSnippet do
  ...
  *   `isDraft` (*type:* `boolean()`, *default:* `nil`) - Indicates whether the caption track is a draft. If the value is true, then the track is not publicly visible. The default value is false. @mutable youtube.captions.insert youtube.captions.update
