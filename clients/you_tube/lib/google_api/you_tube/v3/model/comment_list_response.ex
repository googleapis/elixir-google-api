...
defmodule GoogleApi.YouTube.V3.Model.CommentListResponse do
  ...
  - items ([Comment]): A list of comments that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#commentListResponse\&quot;. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.CommentListResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.YouTube.V3.Model.Comment, options)
