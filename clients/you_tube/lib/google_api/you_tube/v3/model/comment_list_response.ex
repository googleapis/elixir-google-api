...
defmodule GoogleApi.YouTube.V3.Model.CommentListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Comment.t)): A list of comments that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#commentListResponse". Defaults to `youtube#commentListResponse`.
