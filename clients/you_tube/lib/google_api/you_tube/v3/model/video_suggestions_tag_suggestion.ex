...
defmodule GoogleApi.YouTube.V3.Model.VideoSuggestionsTagSuggestion do
  ...
  - categoryRestricts (list(String.t)): A set of video categories for which the tag is relevant. You can use this information to display appropriate tag suggestions based on the video category that the video uploader associates with the video. By default, tag suggestions are relevant for all categories if there are no restricts defined for the keyword. Defaults to `nil`.
  - tag (String.t): The keyword tag suggested for the video. Defaults to `nil`.
  """
