...
defmodule GoogleApi.YouTube.V3.Model.GuideCategory do
  ...
  - id (String.t): The ID that YouTube uses to uniquely identify the guide category. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#guideCategory". Defaults to `youtube#guideCategory`.
  - snippet (GoogleApi.YouTube.V3.Model.GuideCategorySnippet.t): The snippet object contains basic details about the category, such as its title. Defaults to `nil`.
  """
