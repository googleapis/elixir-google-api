...
defmodule GoogleApi.YouTube.V3.Model.VideoProcessingDetails do
  ...
  - editorSuggestionsAvailability (String.t): This value indicates whether video editing suggestions, which might improve video quality or the playback experience, are available for the video. You can retrieve these suggestions by requesting the suggestions part in your videos.list() request. Defaults to `nil`.
  - fileDetailsAvailability (String.t): This value indicates whether file details are available for the uploaded video. You can retrieve a video's file details by requesting the fileDetails part in your videos.list() request. Defaults to `nil`.
  - processingFailureReason (String.t): The reason that YouTube failed to process the video. This property will only have a value if the processingStatus property's value is failed. Defaults to `nil`.
  ...
  - processingProgress (GoogleApi.YouTube.V3.Model.VideoProcessingDetailsProcessingProgress.t): The processingProgress object contains information about the progress YouTube has made in processing the video. The values are really only relevant if the video's processing status is processing. Defaults to `nil`.
  - processingStatus (String.t): The video's processing status. This value indicates whether YouTube was able to process the video or if the video is still being processed. Defaults to `nil`.
  ...
  - thumbnailsAvailability (String.t): This value indicates whether thumbnail images have been generated for the video. Defaults to `nil`.
  """
