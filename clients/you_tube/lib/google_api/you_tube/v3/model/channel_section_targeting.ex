...
defmodule GoogleApi.YouTube.V3.Model.ChannelSectionTargeting do
  ...
  - countries (list(String.t)): The country the channel section is targeting. Defaults to `nil`.
  - languages (list(String.t)): The language the channel section is targeting. Defaults to `nil`.
  - regions (list(String.t)): The region the channel section is targeting. Defaults to `nil`.
  """
