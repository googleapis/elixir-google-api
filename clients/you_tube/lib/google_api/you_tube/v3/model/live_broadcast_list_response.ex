...
defmodule GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.LiveBroadcast.t)): A list of broadcasts that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#liveBroadcastListResponse". Defaults to `youtube#liveBroadcastListResponse`.
