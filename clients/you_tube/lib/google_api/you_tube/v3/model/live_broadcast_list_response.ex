...
defmodule GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse do
  @moduledoc """
  ...
  *   `items` (*type:* `list(GoogleApi.YouTube.V3.Model.LiveBroadcast.t)`, *default:* `nil`) - A list of broadcasts that match the request criteria.
  *   `kind` (*type:* `String.t`, *default:* `youtube#liveBroadcastListResponse`) - Identifies what kind of resource this is. Value: the fixed string "youtube#liveBroadcastListResponse".
  ...
  *   `visitorId` (*type:* `String.t`, *default:* `nil`) - The visitorId identifies the visitor.
  ...
  @type t :: %__MODULE__{
          ...
          :items => list(GoogleApi.YouTube.V3.Model.LiveBroadcast.t()) | nil,
          :kind => String.t() | nil,
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.LiveBroadcast, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse do
