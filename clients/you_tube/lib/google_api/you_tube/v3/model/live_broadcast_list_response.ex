...
defmodule GoogleApi.YouTube.V3.Model.LiveBroadcastListResponse do
  ...
  - items ([LiveBroadcast]): A list of broadcasts that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#liveBroadcastListResponse\&quot;. Defaults to: `null`.
