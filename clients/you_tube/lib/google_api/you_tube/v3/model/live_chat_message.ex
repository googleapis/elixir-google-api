...
defmodule GoogleApi.YouTube.V3.Model.LiveChatMessage do
  ...
  - authorDetails (GoogleApi.YouTube.V3.Model.LiveChatMessageAuthorDetails.t): The authorDetails object contains basic details about the user that posted this message. Defaults to `nil`.
  - etag (String.t): Etag of this resource. Defaults to `nil`.
  - id (String.t): The ID that YouTube assigns to uniquely identify the message. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#liveChatMessage". Defaults to `youtube#liveChatMessage`.
  - snippet (GoogleApi.YouTube.V3.Model.LiveChatMessageSnippet.t): The snippet object contains basic details about the message. Defaults to `nil`.
  """
