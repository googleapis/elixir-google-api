...
defmodule GoogleApi.YouTube.V3.Model.VideoRatingListResponse do
  @moduledoc """
  ...
  *   `visitorId` (*type:* `String.t`, *default:* `nil`) - The visitorId identifies the visitor.
  ...
  @type t :: %__MODULE__{
          ...
          :items => list(GoogleApi.YouTube.V3.Model.VideoRating.t()) | nil,
          :kind => String.t() | nil,
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.VideoRatingListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.VideoRatingListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.VideoRatingListResponse do
