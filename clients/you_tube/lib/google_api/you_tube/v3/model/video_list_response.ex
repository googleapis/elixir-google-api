...
defmodule GoogleApi.YouTube.V3.Model.VideoListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Video.t)): A list of videos that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#videoListResponse". Defaults to `youtube#videoListResponse`.
