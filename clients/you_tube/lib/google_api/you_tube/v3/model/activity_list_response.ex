...
defmodule GoogleApi.YouTube.V3.Model.ActivityListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Activity.t)): A list of activities, or events, that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#activityListResponse". Defaults to `youtube#activityListResponse`.
