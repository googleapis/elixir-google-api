...
defmodule GoogleApi.YouTube.V3.Model.ActivityListResponse do
  @moduledoc """
  ...
  *   `items` (*type:* `list(GoogleApi.YouTube.V3.Model.Activity.t)`, *default:* `nil`) - A list of activities, or events, that match the request criteria.
  *   `kind` (*type:* `String.t`, *default:* `youtube#activityListResponse`) - Identifies what kind of resource this is. Value: the fixed string "youtube#activityListResponse".
  ...
  *   `visitorId` (*type:* `String.t`, *default:* `nil`) - The visitorId identifies the visitor.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.Activity.t()),
          :kind => String.t(),
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.Activity, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.ActivityListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.ActivityListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.ActivityListResponse do
