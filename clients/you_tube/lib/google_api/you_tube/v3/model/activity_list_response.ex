...
defmodule GoogleApi.YouTube.V3.Model.ActivityListResponse do
  ...
  - items ([Activity]): A list of activities, or events, that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#activityListResponse\&quot;. Defaults to: `null`.
