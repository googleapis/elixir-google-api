...
defmodule GoogleApi.YouTube.V3.Model.VideoCategorySnippet do
  ...
  - assignable (boolean()):  Defaults to `nil`.
  - channelId (String.t): The YouTube channel that created the video category. Defaults to `UCBR8-60-B28hp2BmDPdntcQ`.
  - title (String.t): The video category's title. Defaults to `nil`.
  """
