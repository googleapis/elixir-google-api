...
defmodule GoogleApi.YouTube.V3.Model.ChannelBannerResource do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#channelBannerResource". Defaults to `youtube#channelBannerResource`.
  - url (String.t): The URL of this banner image. Defaults to `nil`.
  """
