...
defmodule GoogleApi.YouTube.V3.Model.LiveChatBan do
  ...
  - id (String.t): The ID that YouTube assigns to uniquely identify the ban. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#liveChatBan". Defaults to `youtube#liveChatBan`.
  - snippet (GoogleApi.YouTube.V3.Model.LiveChatBanSnippet.t): The snippet object contains basic details about the ban. Defaults to `nil`.
  """
