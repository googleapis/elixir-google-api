...
defmodule GoogleApi.YouTube.V3.Model.ChannelLocalization do
  ...
  *   `description` (*type:* `String.t`, *default:* `nil`) - The localized strings for channel's description.
  *   `title` (*type:* `String.t`, *default:* `nil`) - The localized strings for channel's title.
  """
