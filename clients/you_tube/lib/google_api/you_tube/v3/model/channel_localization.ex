...
defmodule GoogleApi.YouTube.V3.Model.ChannelLocalization do
  ...
  - description (String.t): The localized strings for channel's description. Defaults to `nil`.
  - title (String.t): The localized strings for channel's title. Defaults to `nil`.
  """
