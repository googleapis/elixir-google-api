...
defmodule GoogleApi.YouTube.V3.Model.LiveStreamListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.LiveStream.t)): A list of live streams that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#liveStreamListResponse". Defaults to `youtube#liveStreamListResponse`.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.LiveStream.t()),
          :kind => String.t(),
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.LiveStream, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.LiveStreamListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.LiveStreamListResponse.decode(value, options)
  end
end
