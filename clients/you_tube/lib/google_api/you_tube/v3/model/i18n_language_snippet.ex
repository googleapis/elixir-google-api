...
defmodule GoogleApi.YouTube.V3.Model.I18nLanguageSnippet do
  ...
  *   `hl` (*type:* `String.t`, *default:* `nil`) - A short BCP-47 code that uniquely identifies a language.
  *   `name` (*type:* `String.t`, *default:* `nil`) - The human-readable name of the language in the language itself.
  """
