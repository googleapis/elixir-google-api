...
defmodule GoogleApi.YouTube.V3.Model.Caption do
  ...
  - id (String.t): The ID that YouTube uses to uniquely identify the caption track. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#caption". Defaults to `youtube#caption`.
  - snippet (GoogleApi.YouTube.V3.Model.CaptionSnippet.t): The snippet object contains basic details about the caption. Defaults to `nil`.
  """
