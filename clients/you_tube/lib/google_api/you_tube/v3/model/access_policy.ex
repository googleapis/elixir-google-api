...
defmodule GoogleApi.YouTube.V3.Model.AccessPolicy do
  ...
  - allowed (boolean()): The value of allowed indicates whether the access to the policy is allowed or denied by default. Defaults to `nil`.
  - exception (list(String.t)): A list of region codes that identify countries where the default policy do not apply. Defaults to `nil`.
  """
