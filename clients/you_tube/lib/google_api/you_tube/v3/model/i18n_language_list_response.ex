...
defmodule GoogleApi.YouTube.V3.Model.I18nLanguageListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.I18nLanguage.t)): A list of supported i18n languages. In this map, the i18n language ID is the map key, and its value is the corresponding i18nLanguage resource. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#i18nLanguageListResponse". Defaults to `youtube#i18nLanguageListResponse`.
