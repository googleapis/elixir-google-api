...
defmodule GoogleApi.YouTube.V3.Model.CaptionListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Caption.t)): A list of captions that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#captionListResponse". Defaults to `youtube#captionListResponse`.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.Caption.t()),
          :kind => String.t(),
          :visitorId => String.t()
        }
