...
defmodule GoogleApi.YouTube.V3.Model.ActivityContentDetailsPlaylistItem do
  ...
  - playlistId (String.t): The value that YouTube uses to uniquely identify the playlist. Defaults to `nil`.
  - playlistItemId (String.t): ID of the item within the playlist. Defaults to `nil`.
  - resourceId (GoogleApi.YouTube.V3.Model.ResourceId.t): The resourceId object contains information about the resource that was added to the playlist. Defaults to `nil`.
  """
