...
defmodule GoogleApi.YouTube.V3.Model.LiveStreamHealthStatus do
  ...
  - configurationIssues (list(GoogleApi.YouTube.V3.Model.LiveStreamConfigurationIssue.t)): The configurations issues on this stream Defaults to `nil`.
  - lastUpdateTimeSeconds (String.t): The last time this status was updated (in seconds) Defaults to `nil`.
  - status (String.t): The status code of this stream Defaults to `nil`.
  """
