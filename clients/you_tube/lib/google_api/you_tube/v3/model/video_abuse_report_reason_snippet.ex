...
defmodule GoogleApi.YouTube.V3.Model.VideoAbuseReportReasonSnippet do
  ...
  - label (String.t): The localized label belonging to this abuse report reason. Defaults to `nil`.
  - secondaryReasons (list(GoogleApi.YouTube.V3.Model.VideoAbuseReportSecondaryReason.t)): The secondary reasons associated with this reason, if any are available. (There might be 0 or more.) Defaults to `nil`.
  """
