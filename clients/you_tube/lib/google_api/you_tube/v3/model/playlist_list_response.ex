...
defmodule GoogleApi.YouTube.V3.Model.PlaylistListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Playlist.t)): A list of playlists that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#playlistListResponse". Defaults to `youtube#playlistListResponse`.
