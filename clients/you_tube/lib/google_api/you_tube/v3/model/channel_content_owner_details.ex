...
defmodule GoogleApi.YouTube.V3.Model.ChannelContentOwnerDetails do
  ...
  - contentOwner (String.t): The ID of the content owner linked to the channel. Defaults to `nil`.
  - timeLinked (DateTime.t): The date and time of when the channel was linked to the content owner. The value is specified in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format. Defaults to `nil`.
  """
