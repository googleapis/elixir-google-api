...
defmodule GoogleApi.YouTube.V3.Model.VideoSuggestions do
  ...
  *   `editorSuggestions` (*type:* `list(String.t)`, *default:* `nil`) - A list of video editing operations that might improve the video quality
      or playback experience of the uploaded video.
  *   `processingErrors` (*type:* `list(String.t)`, *default:* `nil`) - A list of errors that will prevent YouTube from successfully processing
      ...
      <code>failed</code>.
  *   `processingHints` (*type:* `list(String.t)`, *default:* `nil`) - A list of suggestions that may improve YouTube's ability to process the
      video.
  *   `processingWarnings` (*type:* `list(String.t)`, *default:* `nil`) - A list of reasons why YouTube may have difficulty transcoding the
  ...
  *   `tagSuggestions` (*type:* `list(GoogleApi.YouTube.V3.Model.VideoSuggestionsTagSuggestion.t)`, *default:* `nil`) - A list of keyword tags that could be added to the video's metadata to
