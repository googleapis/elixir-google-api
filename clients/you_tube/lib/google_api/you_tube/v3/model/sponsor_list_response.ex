...
defmodule GoogleApi.YouTube.V3.Model.SponsorListResponse do
  @moduledoc """
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Sponsor.t)): A list of sponsors that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#sponsorListResponse". Defaults to `youtube#sponsorListResponse`.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.Sponsor.t()),
          :kind => String.t(),
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.Sponsor, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.SponsorListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.SponsorListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.SponsorListResponse do
