...
defmodule GoogleApi.YouTube.V3.Model.InvideoBranding do
  ...
  - imageBytes (String.t):  Defaults to `nil`.
  - imageUrl (String.t):  Defaults to `nil`.
  - position (GoogleApi.YouTube.V3.Model.InvideoPosition.t):  Defaults to `nil`.
  - targetChannelId (String.t):  Defaults to `nil`.
  - timing (GoogleApi.YouTube.V3.Model.InvideoTiming.t):  Defaults to `nil`.
  """
