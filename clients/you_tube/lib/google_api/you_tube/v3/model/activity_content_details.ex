...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.ActivityContentDetails do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"bulletin", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsBulletin, options)
    |> deserialize(:"channelItem", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsChannelItem, options)
    |> deserialize(:"comment", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsComment, options)
    |> deserialize(:"favorite", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsFavorite, options)
    |> deserialize(:"like", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsLike, options)
    |> deserialize(:"playlistItem", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsPlaylistItem, options)
    |> deserialize(:"promotedItem", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsPromotedItem, options)
    |> deserialize(:"recommendation", :struct, GoogleApi.YouTube.V3.Model.ActivityContentDetailsRecommendation, options)
