...
defmodule GoogleApi.YouTube.V3.Model.ChannelTopicDetails do
  ...
  - topicCategories (list(String.t)): A list of Wikipedia URLs that describe the channel's content. Defaults to `nil`.
  - topicIds (list(String.t)): A list of Freebase topic IDs associated with the channel. You can retrieve information about each topic using the Freebase Topic API. Defaults to `nil`.
  """
