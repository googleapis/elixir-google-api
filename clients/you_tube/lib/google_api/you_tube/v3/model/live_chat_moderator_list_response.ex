...
defmodule GoogleApi.YouTube.V3.Model.LiveChatModeratorListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.LiveChatModerator.t)): A list of moderators that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#liveChatModeratorListResponse". Defaults to `youtube#liveChatModeratorListResponse`.
