...
defmodule GoogleApi.YouTube.V3.Model.ActivityContentDetailsSubscription do
  ...
  - resourceId (GoogleApi.YouTube.V3.Model.ResourceId.t): The resourceId object contains information that identifies the resource that the user subscribed to. Defaults to `nil`.
  """
