...
defmodule GoogleApi.YouTube.V3.Model.ChannelConversionPings do
  ...
  - pings (list(GoogleApi.YouTube.V3.Model.ChannelConversionPing.t)): Pings that the app shall fire (authenticated by biscotti cookie). Each ping has a context, in which the app must fire the ping, and a url identifying the ping. Defaults to `nil`.
  """
