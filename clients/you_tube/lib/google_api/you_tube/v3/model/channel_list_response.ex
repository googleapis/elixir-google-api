...
defmodule GoogleApi.YouTube.V3.Model.ChannelListResponse do
  ...
  - items (list(GoogleApi.YouTube.V3.Model.Channel.t)): A list of channels that match the request criteria. Defaults to `nil`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#channelListResponse". Defaults to `youtube#channelListResponse`.
