...
defmodule GoogleApi.YouTube.V3.Model.ChannelListResponse do
  @moduledoc """
  ...
  *   `items` (*type:* `list(GoogleApi.YouTube.V3.Model.Channel.t)`, *default:* `nil`) - A list of channels that match the request criteria.
  *   `kind` (*type:* `String.t`, *default:* `youtube#channelListResponse`) - Identifies what kind of resource this is. Value: the fixed string "youtube#channelListResponse".
  ...
  *   `visitorId` (*type:* `String.t`, *default:* `nil`) - The visitorId identifies the visitor.
  ...
  @type t :: %__MODULE__{
          :etag => String.t(),
          :eventId => String.t(),
          :items => list(GoogleApi.YouTube.V3.Model.Channel.t()),
          :kind => String.t(),
  ...
  field(:etag)
  field(:eventId)
  field(:items, as: GoogleApi.YouTube.V3.Model.Channel, type: :list)
  field(:kind)
  field(:nextPageToken)
...
defimpl Poison.Decoder, for: GoogleApi.YouTube.V3.Model.ChannelListResponse do
  def decode(value, options) do
    GoogleApi.YouTube.V3.Model.ChannelListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.YouTube.V3.Model.ChannelListResponse do
