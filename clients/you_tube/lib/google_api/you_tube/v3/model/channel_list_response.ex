...
defmodule GoogleApi.YouTube.V3.Model.ChannelListResponse do
  ...
  - items ([Channel]): A list of channels that match the request criteria. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#channelListResponse\&quot;. Defaults to: `null`.
