...
defmodule GoogleApi.YouTube.V3.Model.Sponsor do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "youtube#sponsor". Defaults to `youtube#sponsor`.
  - snippet (GoogleApi.YouTube.V3.Model.SponsorSnippet.t): The snippet object contains basic details about the sponsor. Defaults to `nil`.
  """
