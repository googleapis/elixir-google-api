...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.Operation do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"error", :struct, GoogleApi.ServiceManagement.V1.Model.Status, options)
    |> deserialize(:"metadata", :struct, GoogleApi.ServiceManagement.V1.Model.Object, options)
    |> deserialize(:"response", :struct, GoogleApi.ServiceManagement.V1.Model.Object, options)
  end
end
