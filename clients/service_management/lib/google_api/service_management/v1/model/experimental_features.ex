...
defmodule GoogleApi.ServiceManagement.V1.Model.ExperimentalFeatures do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.ExperimentalFeatures do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.ExperimentalFeatures.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.ExperimentalFeatures do
