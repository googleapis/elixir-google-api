...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.Policy do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"auditConfigs", :list, GoogleApi.ServiceManagement.V1.Model.AuditConfig, options)
    |> deserialize(:"bindings", :list, GoogleApi.ServiceManagement.V1.Model.Binding, options)
    |> deserialize(:"rules", :list, GoogleApi.ServiceManagement.V1.Model.Rule, options)
  end
end
