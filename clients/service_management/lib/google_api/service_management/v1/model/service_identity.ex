...
defmodule GoogleApi.ServiceManagement.V1.Model.ServiceIdentity do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.ServiceIdentity do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.ServiceIdentity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.ServiceIdentity do
