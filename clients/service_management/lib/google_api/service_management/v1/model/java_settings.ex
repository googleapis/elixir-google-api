...
defmodule GoogleApi.ServiceManagement.V1.Model.JavaSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.JavaSettings do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.JavaSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.JavaSettings do
