...
defmodule GoogleApi.ServiceManagement.V1.Model.Diagnostic do
  ...
  - kind (String.t): The kind of diagnostic information provided. Defaults to `nil`.
  - location (String.t): File name and line number of the error or warning. Defaults to `nil`.
  - message (String.t): Message describing the error or warning. Defaults to `nil`.
  """
