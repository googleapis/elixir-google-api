...
defmodule GoogleApi.ServiceManagement.V1.Model.Page do
  ...
  - content (String): The Markdown content of the page. You can use &lt;code&gt;&amp;#40;&#x3D;&#x3D; include {path} &#x3D;&#x3D;&amp;#41;&lt;/code&gt; to include content from a Markdown file. Defaults to: `null`.
  ...
  - subpages (List[Page]): Subpages of this page. The order of subpages specified here will be honored in the generated docset. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.Page do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"subpages", :list, GoogleApi.ServiceManagement.V1.Model.Page, options)
  end
end
