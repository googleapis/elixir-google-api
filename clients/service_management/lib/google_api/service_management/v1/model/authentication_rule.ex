...
defmodule GoogleApi.ServiceManagement.V1.Model.AuthenticationRule do
  ...
  - oauth (GoogleApi.ServiceManagement.V1.Model.OAuthRequirements.t): The requirements for OAuth credentials. Defaults to `nil`.
  - requirements (list(GoogleApi.ServiceManagement.V1.Model.AuthRequirement.t)): Requirements for additional authentication providers. Defaults to `nil`.
