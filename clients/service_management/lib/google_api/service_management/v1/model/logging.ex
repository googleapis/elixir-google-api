...
defmodule GoogleApi.ServiceManagement.V1.Model.Logging do
  ...
  - consumerDestinations (list(GoogleApi.ServiceManagement.V1.Model.LoggingDestination.t)): Logging configurations for sending logs to the consumer project.
  There can be multiple consumer destinations, each one must have a
  different monitored resource type. A log can be used in at most
  one consumer destination. Defaults to `nil`.
  - producerDestinations (list(GoogleApi.ServiceManagement.V1.Model.LoggingDestination.t)): Logging configurations for sending logs to the producer project.
