...
defmodule GoogleApi.ServiceManagement.V1.Model.CustomError do
  ...
  *   `rules` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.CustomErrorRule.t)`, *default:* `nil`) - The list of custom error rules that apply to individual API messages. **NOTE:** All service configuration rules follow "last one wins" order.
  *   `types` (*type:* `list(String.t)`, *default:* `nil`) - The list of custom error detail types, e.g. 'google.foo.v1.CustomError'.
  ...
  @type t :: %__MODULE__{
          :rules => list(GoogleApi.ServiceManagement.V1.Model.CustomErrorRule.t()) | nil,
