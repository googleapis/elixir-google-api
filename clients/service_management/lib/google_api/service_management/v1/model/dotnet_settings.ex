...
defmodule GoogleApi.ServiceManagement.V1.Model.DotnetSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.DotnetSettings do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.DotnetSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.DotnetSettings do
