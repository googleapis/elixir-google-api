...
defmodule GoogleApi.ServiceManagement.V1.Model.Backend do
  ...
  *   `rules` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.BackendRule.t)`, *default:* `nil`) - A list of API backend rules that apply to individual API methods. **NOTE:** All service configuration rules follow "last one wins" order.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :rules => list(GoogleApi.ServiceManagement.V1.Model.BackendRule.t()) | nil
        }
