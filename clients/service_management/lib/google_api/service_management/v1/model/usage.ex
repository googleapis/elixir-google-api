...
defmodule GoogleApi.ServiceManagement.V1.Model.Usage do
  ...
  *   `rules` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.UsageRule.t)`, *default:* `nil`) - A list of usage rules that apply to individual API methods.

      **NOTE:** All service configuration rules follow "last one wins" order.
  *   `serviceIdentity` (*type:* `GoogleApi.ServiceManagement.V1.Model.ServiceIdentity.t`, *default:* `nil`) - The configuration of a per-product per-project service identity.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :serviceIdentity => GoogleApi.ServiceManagement.V1.Model.ServiceIdentity.t()
        }
  ...
  field(:serviceIdentity, as: GoogleApi.ServiceManagement.V1.Model.ServiceIdentity)
end
