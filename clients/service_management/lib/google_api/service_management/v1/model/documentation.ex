...
defmodule GoogleApi.ServiceManagement.V1.Model.Documentation do
  ...
  *   `summary` (*type:* `String.t`, *default:* `nil`) - A short description of what the service does. The summary must be plain text. It becomes the overview of the service displayed in Google Cloud Console. NOTE: This field is equivalent to the standard field `description`.
  ...
  @type t :: %__MODULE__{
          ...
          :rules => list(GoogleApi.ServiceManagement.V1.Model.DocumentationRule.t()) | nil,
          :sectionOverrides => list(GoogleApi.ServiceManagement.V1.Model.Page.t()) | nil,
  ...
  field(:sectionOverrides, as: GoogleApi.ServiceManagement.V1.Model.Page, type: :list)
