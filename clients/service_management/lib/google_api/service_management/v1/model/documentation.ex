...
defmodule GoogleApi.ServiceManagement.V1.Model.Documentation do
  ...
  @type t :: %__MODULE__{
          ...
          :overview => any(),
          :pages => list(GoogleApi.ServiceManagement.V1.Model.Page.t()),
          :rules => list(GoogleApi.ServiceManagement.V1.Model.DocumentationRule.t()),
          :summary => any()
        }
  ...
  field(:rules, as: GoogleApi.ServiceManagement.V1.Model.DocumentationRule, type: :list)
  field(:summary)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.Documentation do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.Documentation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.Documentation do
