...
defmodule GoogleApi.ServiceManagement.V1.Model.GenerateConfigReportResponse do
  ...
  - changeReports ([ChangeReport]): list of ChangeReport, each corresponding to comparison between two service configurations. Defaults to: `null`.
  - diagnostics ([Diagnostic]): Errors / Linter warnings associated with the service definition this report belongs to. Defaults to: `null`.
  - id (String.t): ID of the service configuration this report belongs to. Defaults to: `null`.
  - serviceName (String.t): Name of the service this report belongs to. Defaults to: `null`.
  """
