...
defmodule GoogleApi.ServiceManagement.V1.Model.GenerateConfigReportResponse do
  ...
  - changeReports (list(GoogleApi.ServiceManagement.V1.Model.ChangeReport.t)): list of ChangeReport, each corresponding to comparison between two
  service configurations. Defaults to `nil`.
  - diagnostics (list(GoogleApi.ServiceManagement.V1.Model.Diagnostic.t)): Errors / Linter warnings associated with the service definition this
  report
  belongs to. Defaults to `nil`.
  - id (String.t): ID of the service configuration this report belongs to. Defaults to `nil`.
  - serviceName (String.t): Name of the service this report belongs to. Defaults to `nil`.
  """
