...
defmodule GoogleApi.ServiceManagement.V1.Model.ListServicesResponse do
  ...
  *   `services` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.ManagedService.t)`, *default:* `nil`) - The returned services will only have the name field set.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :services => list(GoogleApi.ServiceManagement.V1.Model.ManagedService.t()) | nil
        }
