...
defmodule GoogleApi.ServiceManagement.V1.Model.ManagedService do
  ...
  *   `serviceName` (*type:* `String.t`, *default:* `nil`) - The name of the service. See the [overview](https://cloud.google.com/service-infrastructure/docs/overview) for naming requirements.
  """
