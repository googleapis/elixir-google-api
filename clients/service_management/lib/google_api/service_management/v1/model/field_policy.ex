...
defmodule GoogleApi.ServiceManagement.V1.Model.FieldPolicy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.FieldPolicy do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.FieldPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.FieldPolicy do
