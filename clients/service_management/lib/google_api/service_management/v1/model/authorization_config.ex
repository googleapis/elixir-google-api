...
defmodule GoogleApi.ServiceManagement.V1.Model.AuthorizationConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.AuthorizationConfig do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.AuthorizationConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.AuthorizationConfig do
