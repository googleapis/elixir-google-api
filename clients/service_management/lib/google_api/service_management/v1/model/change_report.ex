...
defmodule GoogleApi.ServiceManagement.V1.Model.ChangeReport do
  ...
  - configChanges (list(GoogleApi.ServiceManagement.V1.Model.ConfigChange.t)): List of changes between two service configurations.
  The changes will be alphabetically sorted based on the identifier
  of each change.
  A ConfigChange identifier is a dot separated path to the configuration.
  Example: visibility.rules[selector='LibraryService.CreateBook'].restriction Defaults to `nil`.
  """
