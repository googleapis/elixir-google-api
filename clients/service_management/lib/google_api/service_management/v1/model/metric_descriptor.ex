...
defmodule GoogleApi.ServiceManagement.V1.Model.MetricDescriptor do
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - The set of labels that can be used to describe a specific
  ...
  *   `metadata` (*type:* `GoogleApi.ServiceManagement.V1.Model.MetricDescriptorMetadata.t`, *default:* `nil`) - Optional. Metadata which can be used to guide usage of the metric.
