...
defmodule GoogleApi.ServiceManagement.V1.Model.HttpRule do
  ...
  @type t :: %__MODULE__{
          ...
          :delete => any(),
          :get => any(),
          :mediaDownload => GoogleApi.ServiceManagement.V1.Model.MediaDownload.t(),
          :mediaUpload => GoogleApi.ServiceManagement.V1.Model.MediaUpload.t(),
          :patch => any(),
          :post => any(),
          :put => any(),
          :selector => any()
  ...
  field(:delete)
  field(:get)
  field(:mediaDownload, as: GoogleApi.ServiceManagement.V1.Model.MediaDownload)
  field(:mediaUpload, as: GoogleApi.ServiceManagement.V1.Model.MediaUpload)
  field(:patch)
  field(:post)
  field(:put)
  field(:selector)
