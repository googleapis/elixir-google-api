...
defmodule GoogleApi.ServiceManagement.V1.Model.HttpRule do
  ...
  *   `additionalBindings` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.HttpRule.t)`, *default:* `nil`) - Additional HTTP bindings for the selector. Nested bindings must
  ...
  *   `body` (*type:* `String.t`, *default:* `nil`) - The name of the request field whose value is mapped to the HTTP request
      ...
      message type.
  *   `custom` (*type:* `GoogleApi.ServiceManagement.V1.Model.CustomHttpPattern.t`, *default:* `nil`) - The custom pattern is used for specifying an HTTP method that is not
  ...
  *   `selector` (*type:* `String.t`, *default:* `nil`) - Selects a method to which this rule applies.
  ...
  @type t :: %__MODULE__{
          :additionalBindings => list(GoogleApi.ServiceManagement.V1.Model.HttpRule.t()),
          :body => String.t(),
          :custom => GoogleApi.ServiceManagement.V1.Model.CustomHttpPattern.t(),
          :delete => String.t(),
          :get => String.t(),
          :patch => String.t(),
          :post => String.t(),
  ...
  field(:additionalBindings, as: GoogleApi.ServiceManagement.V1.Model.HttpRule, type: :list)
  field(:body)
  field(:custom, as: GoogleApi.ServiceManagement.V1.Model.CustomHttpPattern)
  field(:delete)
  field(:get)
  field(:patch)
  field(:post)
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.HttpRule do
  def decode(value, options) do
    GoogleApi.ServiceManagement.V1.Model.HttpRule.decode(value, options)
  end
end
