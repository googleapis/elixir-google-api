...
defmodule GoogleApi.ServiceManagement.V1.Model.HttpRule do
  ...
  - additionalBindings (list(GoogleApi.ServiceManagement.V1.Model.HttpRule.t)): Additional HTTP bindings for the selector. Nested bindings must
  ...
  - custom (GoogleApi.ServiceManagement.V1.Model.CustomHttpPattern.t): The custom pattern is used for specifying an HTTP method that is not
