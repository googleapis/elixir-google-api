...
defmodule GoogleApi.ServiceManagement.V1.Model.Rule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceManagement.V1.Model.Rule do
  import GoogleApi.ServiceManagement.V1.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"conditions", :list, GoogleApi.ServiceManagement.V1.Model.Condition, options)
    |> deserialize(:"logConfig", :list, GoogleApi.ServiceManagement.V1.Model.LogConfig, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceManagement.V1.Model.Rule do
