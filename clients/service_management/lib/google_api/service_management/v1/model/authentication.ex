...
defmodule GoogleApi.ServiceManagement.V1.Model.Authentication do
  ...
  - providers (list(GoogleApi.ServiceManagement.V1.Model.AuthProvider.t)): Defines a set of authentication providers that a service supports. Defaults to `nil`.
  - rules (list(GoogleApi.ServiceManagement.V1.Model.AuthenticationRule.t)): A list of authentication rules that apply to individual API methods.
