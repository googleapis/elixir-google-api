...
defmodule GoogleApi.ServiceManagement.V1.Model.LogDescriptor do
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - The set of labels that are available to describe a specific log entry. Runtime requests that contain labels not specified here are considered invalid.
