...
defmodule GoogleApi.ServiceManagement.V1.Model.ConfigSource do
  ...
  - files (list(GoogleApi.ServiceManagement.V1.Model.ConfigFile.t)): Set of source configuration files that are used to generate a service
  configuration (`google.api.Service`). Defaults to `nil`.
  - id (String.t): A unique ID for a specific instance of this message, typically assigned
  by the client for tracking purpose. If empty, the server may choose to
  generate one instead. Defaults to `nil`.
  """
