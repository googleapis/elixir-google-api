...
defmodule GoogleApi.ServiceManagement.V1.Model.Quota do
  ...
  - limits (list(GoogleApi.ServiceManagement.V1.Model.QuotaLimit.t)): List of `QuotaLimit` definitions for the service. Defaults to `nil`.
  - metricRules (list(GoogleApi.ServiceManagement.V1.Model.MetricRule.t)): List of `MetricRule` definitions, each one mapping a selected method to one
