...
defmodule GoogleApi.ServiceManagement.V1.Model.Quota do
  ...
  *   `metricRules` (*type:* `list(GoogleApi.ServiceManagement.V1.Model.MetricRule.t)`, *default:* `nil`) - List of `MetricRule` definitions, each one mapping a selected method to one
      or more metrics.
  """
