...
defmodule GoogleApi.Forms.V1.Model.Grid do
  @moduledoc """
  ...
  *   `shuffleQuestions` (*type:* `boolean()`, *default:* `nil`) - If `true`, the questions are randomly ordered. In other words, the rows appear in a different order for every respondent.
  ...
  field(:columns, as: GoogleApi.Forms.V1.Model.ChoiceQuestion)
  field(:shuffleQuestions)
end

defimpl Poison.Decoder, for: GoogleApi.Forms.V1.Model.Grid do
  def decode(value, options) do
    GoogleApi.Forms.V1.Model.Grid.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Forms.V1.Model.Grid do
