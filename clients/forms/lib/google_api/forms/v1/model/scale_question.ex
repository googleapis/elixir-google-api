...
defmodule GoogleApi.Forms.V1.Model.ScaleQuestion do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Forms.V1.Model.ScaleQuestion do
  def decode(value, options) do
    GoogleApi.Forms.V1.Model.ScaleQuestion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Forms.V1.Model.ScaleQuestion do
