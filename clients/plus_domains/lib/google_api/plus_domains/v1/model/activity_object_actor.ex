...
defmodule GoogleApi.PlusDomains.V1.Model.ActivityObjectActor do
  ...
  - clientSpecificActorInfo (GoogleApi.PlusDomains.V1.Model.ActivityObjectActorClientSpecificActorInfo.t): Actor info specific to particular clients. Defaults to `nil`.
  ...
  - image (GoogleApi.PlusDomains.V1.Model.ActivityObjectActorImage.t): The image representation of the original actor. Defaults to `nil`.
  - url (String.t): A link to the original actor's Google profile. Defaults to `nil`.
  - verification (GoogleApi.PlusDomains.V1.Model.ActivityObjectActorVerification.t): Verification status of actor. Defaults to `nil`.
  """
