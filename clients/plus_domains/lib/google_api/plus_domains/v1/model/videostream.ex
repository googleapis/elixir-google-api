...
defmodule GoogleApi.PlusDomains.V1.Model.Videostream do
  ...
  - height (integer()): The height, in pixels, of the video resource. Defaults to `nil`.
  - type (String.t): MIME type of the video stream. Defaults to `nil`.
  - url (String.t): URL of the video stream. Defaults to `nil`.
  - width (integer()): The width, in pixels, of the video resource. Defaults to `nil`.
  """
