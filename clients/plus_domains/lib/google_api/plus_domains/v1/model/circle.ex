...
defmodule GoogleApi.PlusDomains.V1.Model.Circle do
  ...
  - description (String.t): The description of this circle. Defaults to `nil`.
  - displayName (String.t): The circle name. Defaults to `nil`.
  - etag (String.t): ETag of this response for caching purposes. Defaults to `nil`.
  - id (String.t): The ID of the circle. Defaults to `nil`.
  - kind (String.t): Identifies this resource as a circle. Value: "plus#circle". Defaults to `plus#circle`.
  - people (GoogleApi.PlusDomains.V1.Model.CirclePeople.t): The people in this circle. Defaults to `nil`.
  - selfLink (String.t): Link to this circle resource Defaults to `nil`.
  """
