...
defmodule GoogleApi.PlusDomains.V1.Model.CommentActor do
  ...
  - clientSpecificActorInfo (GoogleApi.PlusDomains.V1.Model.CommentActorClientSpecificActorInfo.t): Actor info specific to particular clients. Defaults to `nil`.
  ...
  - image (GoogleApi.PlusDomains.V1.Model.CommentActorImage.t): The image representation of this actor. Defaults to `nil`.
  - url (String.t): A link to the Person resource for this actor. Defaults to `nil`.
  - verification (GoogleApi.PlusDomains.V1.Model.CommentActorVerification.t): Verification status of actor. Defaults to `nil`.
  """
