...
defmodule GoogleApi.PlusDomains.V1.Model.MediaAuthor do
  ...
  - displayName (String.t): The author's name. Defaults to `nil`.
  - id (String.t): ID of the author. Defaults to `nil`.
  - image (GoogleApi.PlusDomains.V1.Model.MediaAuthorImage.t): The author's Google profile image. Defaults to `nil`.
  - url (String.t): A link to the author's Google profile. Defaults to `nil`.
  """
