...
defmodule GoogleApi.PlusDomains.V1.Api.Media do
  ...
  """
  @spec plus_domains_media_insert(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.PlusDomains.V1.Model.Media.t} | {:error, Tesla.Env.t}
  def plus_domains_media_insert(connection, user_id, collection, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/plusDomains/v1/people/#{user_id}/media/#{collection}")
