...
defmodule GoogleApi.PlusDomains.V1.Api.Audiences do
  ...
  *   `user_id` (*type:* `String.t`) - The ID of the user to get audiences for. The special value "me" can be used to indicate the authenticated user.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:maxResults` (*type:* `integer()`) - The maximum number of circles to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults.
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_domains_audiences_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
