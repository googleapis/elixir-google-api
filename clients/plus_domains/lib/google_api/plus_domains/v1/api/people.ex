...
defmodule GoogleApi.PlusDomains.V1.Api.People do
  ...
  """
  @spec plus_domains_people_get(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec plus_domains_people_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  - connection (GoogleApi.PlusDomains.V1.Connection): Connection to server
  - circle_id (String.t): The ID of the circle to get the members of.
  - optional_params (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec plus_domains_people_list_by_circle(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.PlusDomains.V1.Model.PeopleFeed.t()} | {:error, Tesla.Env.t()}
  def plus_domains_people_list_by_circle(connection, circle_id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
