...
defmodule GoogleApi.PlusDomains.V1.Api.Circles do
  ...
  *   `user_id` (*type:* `String.t`) - The ID of the user to get circles for. The special value "me" can be used to indicate the authenticated user.
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_domains_circles_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
