...
defmodule GoogleApi.Fitness.V1.Model.ListDataSourcesResponse do
  ...
  - dataSource (list(GoogleApi.Fitness.V1.Model.DataSource.t)): A previously created data source. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Fitness.V1.Model.ListDataSourcesResponse do
  def decode(value, options) do
    GoogleApi.Fitness.V1.Model.ListDataSourcesResponse.decode(value, options)
  end
end
