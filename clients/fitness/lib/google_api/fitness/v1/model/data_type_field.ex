...
defmodule GoogleApi.Fitness.V1.Model.DataTypeField do
  ...
  - format (String.t): The different supported formats for each field in a data type. Defaults to `nil`.
  - name (String.t): Defines the name and format of data. Unlike data type names, field names are not namespaced, and only need to be unique within the data type. Defaults to `nil`.
