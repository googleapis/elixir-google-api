...
defmodule GoogleApi.Fitness.V1.Model.DataSource do
  ...
  - dataQualityStandard (List[String]):  Defaults to: `null`.
    - Enum - one of 
  ...
  - name (String): An end-user visible name for this data source. Defaults to: `null`.
  - type (String): A constant describing the type of this data source. Indicates whether this data source produces raw or derived data. Defaults to: `null`.
