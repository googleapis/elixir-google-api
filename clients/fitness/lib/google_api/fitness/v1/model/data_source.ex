...
defmodule GoogleApi.Fitness.V1.Model.DataSource do
  ...
  *   `dataQualityStandard` (*type:* `list(String.t)`, *default:* `nil`) - DO NOT POPULATE THIS FIELD. It is never populated in responses from the
      platform, and is ignored in queries. It will be removed in a future version
      entirely.
  *   `dataStreamId` (*type:* `String.t`, *default:* `nil`) - A unique identifier for the data stream produced by this data source. The
  ...
  *   `dataStreamName` (*type:* `String.t`, *default:* `nil`) - The stream name uniquely identifies this particular data source among
  ...
  *   `dataType` (*type:* `GoogleApi.Fitness.V1.Model.DataType.t`, *default:* `nil`) - The data type defines the schema for a stream of data being collected by,
      inserted into, or queried from the Fitness API.
  *   `device` (*type:* `GoogleApi.Fitness.V1.Model.Device.t`, *default:* `nil`) - Representation of an integrated device (such as a phone or a wearable) that
      can hold sensors.
  *   `name` (*type:* `String.t`, *default:* `nil`) - An end-user visible name for this data source.
  *   `type` (*type:* `String.t`, *default:* `nil`) - A constant describing the type of this data source. Indicates whether this
