...
defmodule GoogleApi.Fitness.V1.Model.Dataset do
  ...
  *   `dataSourceId` (*type:* `String.t`, *default:* `nil`) - The data stream ID of the data source that created the points in this
      dataset.
  *   `maxEndTimeNs` (*type:* `String.t`, *default:* `nil`) - The largest end time of all data points in this possibly partial
  ...
  *   `minStartTimeNs` (*type:* `String.t`, *default:* `nil`) - The smallest start time of all data points in this possibly partial
      representation of the dataset. Time is in nanoseconds from epoch. This
      should also match the first part of the dataset identifier.
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - This token will be set when a dataset is received in response to a GET
  ...
  *   `point` (*type:* `list(GoogleApi.Fitness.V1.Model.DataPoint.t)`, *default:* `nil`) - A partial list of data points contained in the dataset, ordered by largest
