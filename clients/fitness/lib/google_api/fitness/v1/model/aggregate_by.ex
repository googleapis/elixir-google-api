...
defmodule GoogleApi.Fitness.V1.Model.AggregateBy do
  ...
  - dataSourceId (String.t): A data source ID to aggregate. Mutually exclusive of dataTypeName. Only data from the specified data source ID will be included in the aggregation. The dataset in the response will have the same data source ID. Defaults to: `null`.
