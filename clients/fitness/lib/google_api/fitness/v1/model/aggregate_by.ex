...
defmodule GoogleApi.Fitness.V1.Model.AggregateBy do
  ...
  *   `dataSourceId` (*type:* `String.t`, *default:* `nil`) - A data source ID to aggregate. Only data from the specified data source ID
  ...
  *   `dataTypeName` (*type:* `String.t`, *default:* `nil`) - The data type to aggregate. All data sources providing this data type will
