...
defmodule GoogleApi.Fitness.V1.Model.DataPoint do
  ...
  *   `endTimeNanos` (*type:* `String.t`, *default:* `nil`) - The end time of the interval represented by this data point, in
      nanoseconds since epoch.
  *   `modifiedTimeMillis` (*type:* `String.t`, *default:* `nil`) - Indicates the last time this data point was modified. Useful only in
      contexts where we are listing the data changes, rather than representing
      the current state of the data.
  *   `originDataSourceId` (*type:* `String.t`, *default:* `nil`) - If the data point is contained in a dataset for a derived data source,
  ...
  *   `startTimeNanos` (*type:* `String.t`, *default:* `nil`) - The start time of the interval represented by this data point, in
      nanoseconds since epoch.
  *   `value` (*type:* `list(GoogleApi.Fitness.V1.Model.Value.t)`, *default:* `nil`) - Values of each data type field for the data point. It is expected that each
