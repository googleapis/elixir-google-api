...
defmodule GoogleApi.Fitness.V1.Model.Device do
  ...
  - manufacturer (String.t): Manufacturer of the product/hardware. Defaults to `nil`.
  - model (String.t): End-user visible model name for the device. Defaults to `nil`.
  - type (String.t): A constant representing the type of the device. Defaults to `nil`.
  - uid (String.t): The serial number or other unique ID for the hardware. This field is obfuscated when read by any REST or Android client that did not create the data source. Only the data source creator will see the uid field in clear and normal form. Defaults to `nil`.
  - version (String.t): Version string for the device hardware/software. Defaults to `nil`.
  """
