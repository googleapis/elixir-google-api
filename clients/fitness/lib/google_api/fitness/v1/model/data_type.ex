...
defmodule GoogleApi.Fitness.V1.Model.DataType do
  ...
  - field ([DataTypeField]): A field represents one dimension of a data type. Defaults to: `null`.
  - name (String.t): Each data type has a unique, namespaced, name. All data types in the com.google namespace are shared as part of the platform. Defaults to: `null`.
  """
