...
defmodule GoogleApi.Fitness.V1.Model.BucketBySession do
  ...
  - minDurationMillis (String.t): Specifies that only sessions of duration longer than minDurationMillis are considered and used as a container for aggregated data. Defaults to `nil`.
  """
