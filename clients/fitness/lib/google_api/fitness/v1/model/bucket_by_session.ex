...
defmodule GoogleApi.Fitness.V1.Model.BucketBySession do
  ...
  - minDurationMillis (String.t): Specifies that only sessions of duration longer than minDurationMillis are considered and used as a container for aggregated data. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Fitness.V1.Model.BucketBySession do
  def decode(value, options) do
    GoogleApi.Fitness.V1.Model.BucketBySession.decode(value, options)
  end
end
