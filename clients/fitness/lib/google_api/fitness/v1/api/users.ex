...
defmodule GoogleApi.Fitness.V1.Api.Users do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:endTime` (*type:* `String.t`) - An RFC3339 timestamp. Only sessions ending between the start and end times will be included in the response. If this time is omitted but startTime is specified, all sessions from startTime to the end of time will be returned.
      *   `:includeDeleted` (*type:* `boolean()`) - If true, and if both startTime and endTime are omitted, session deletions will be returned.
      ...
      *   `:startTime` (*type:* `String.t`) - An RFC3339 timestamp. Only sessions ending between the start and end times will be included in the response. If this time is omitted but endTime is specified, all sessions from the start of time up to endTime will be returned.
  *   `opts` (*type:* `keyword()`) - Call options
