...
defmodule GoogleApi.Checks.V1alpha.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Checks.V1alpha.Model.Status do
  def decode(value, options) do
    GoogleApi.Checks.V1alpha.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Checks.V1alpha.Model.Status do
