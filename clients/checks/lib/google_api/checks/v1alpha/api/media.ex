...
defmodule GoogleApi.Checks.V1alpha.Api.Media do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Checks.V1alpha.Model.GoogleChecksReportV1alphaAnalyzeUploadRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  """
  @spec checks_media_upload(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Checks.V1alpha.Model.Operation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def checks_media_upload(connection, parent, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1alpha/{+parent}/reports:analyzeUpload", %{
  ...
  *   `metadata` (*type:* `GoogleApi.Checks.V1alpha.Model.GoogleChecksReportV1alphaAnalyzeUploadRequest.t`) - object metadata
  ...
  *   `{:error, info}` on failure
  """
  @spec checks_media_upload_iodata(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          GoogleApi.Checks.V1alpha.Model.GoogleChecksReportV1alphaAnalyzeUploadRequest.t(),
          iodata,
          keyword(),
          keyword()
        ) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def checks_media_upload_iodata(
        connection,
        parent,
        upload_type,
        metadata,
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/upload/v1alpha/{+parent}/reports:analyzeUpload", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
  ...
  *   `{:error, info}` on failure
  """
  @spec checks_media_upload_simple(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          GoogleApi.Checks.V1alpha.Model.GoogleChecksReportV1alphaAnalyzeUploadRequest.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def checks_media_upload_simple(
        connection,
        parent,
        upload_type,
        metadata,
