...
defmodule GoogleApi.PageSpeedOnline.V5.Model.Categories do
  ...
  *   `best-practices` (*type:* `GoogleApi.PageSpeedOnline.V5.Model.LighthouseCategoryV5.t`, *default:* `nil`) - The best practices category, containing all best practices related
      audits.
  ...
  *   `pwa` (*type:* `GoogleApi.PageSpeedOnline.V5.Model.LighthouseCategoryV5.t`, *default:* `nil`) - The Progressive-Web-App (PWA) category, containing all pwa related
      audits.
  *   `seo` (*type:* `GoogleApi.PageSpeedOnline.V5.Model.LighthouseCategoryV5.t`, *default:* `nil`) - The Search-Engine-Optimization (SEO) category, containing all seo related
      audits.
  """
