...
defmodule GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5I18nRendererFormattedStrings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5I18nRendererFormattedStrings do
  def decode(value, options) do
    GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5I18nRendererFormattedStrings.decode(
      value,
      options
    )
  end
