...
defmodule GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5Categories do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5Categories do
  def decode(value, options) do
    GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5Categories.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PageSpeedOnline.V5.Model.LighthouseResultV5Categories do
