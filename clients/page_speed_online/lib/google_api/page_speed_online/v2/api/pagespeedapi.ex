...
defmodule GoogleApi.PageSpeedOnline.V2.Api.Pagespeedapi do
  ...
  import GoogleApi.PageSpeedOnline.V2.RequestBuilder
  ...
  """
  @spec pagespeedonline_pagespeedapi_runpagespeed(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.PageSpeedOnline.V2.Model.Result.t} | {:error, Tesla.Env.t}
  def pagespeedonline_pagespeedapi_runpagespeed(connection, url, opts \\ []) do
    ...
    |> decode(%GoogleApi.PageSpeedOnline.V2.Model.Result{})
  end
end
