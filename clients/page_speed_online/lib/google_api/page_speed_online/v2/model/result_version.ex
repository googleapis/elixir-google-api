...
defmodule GoogleApi.PageSpeedOnline.V2.Model.ResultVersion do
  ...
  - major (integer()): The major version number of PageSpeed used to generate these results. Defaults to `nil`.
  - minor (integer()): The minor version number of PageSpeed used to generate these results. Defaults to `nil`.
  """
