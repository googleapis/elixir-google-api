...
defmodule GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResults do
  ...
  - locale (String.t): The locale of the formattedResults, e.g. "en_US". Defaults to `nil`.
  - ruleResults (map()): Dictionary of formatted rule results, with one entry for each PageSpeed rule instantiated and run by the server. Defaults to `nil`.
  """
