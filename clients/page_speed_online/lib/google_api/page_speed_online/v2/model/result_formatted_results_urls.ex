...
defmodule GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsUrls do
  ...
  - details ([PagespeedApiFormatStringV2]): List of entries that provide additional details about a single URL. Optional. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :details => list(GoogleApi.PageSpeedOnline.V2.Model.PagespeedApiFormatStringV2.t()),
          :result => GoogleApi.PageSpeedOnline.V2.Model.PagespeedApiFormatStringV2.t()
        }

  field(:details, as: GoogleApi.PageSpeedOnline.V2.Model.PagespeedApiFormatStringV2, type: :list)
  field(:result, as: GoogleApi.PageSpeedOnline.V2.Model.PagespeedApiFormatStringV2)
end

defimpl Poison.Decoder, for: GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsUrls do
  def decode(value, options) do
    GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsUrls.decode(value, options)
  end
end
