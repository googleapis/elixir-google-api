...
defmodule GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsRuleResults do
  ...
  - groups ([String.t]): List of rule groups that this rule belongs to. Each entry in the list is one of \&quot;SPEED\&quot; or \&quot;USABILITY\&quot;. Defaults to: `null`.
  ...
  - urlBlocks ([ResultFormattedResultsUrlBlocks]): List of blocks of URLs. Each block may contain a heading and a list of URLs. Each URL may optionally include additional details. Defaults to: `null`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :ruleImpact => any(),
          :summary => GoogleApi.PageSpeedOnline.V2.Model.PagespeedApiFormatStringV2.t(),
          :urlBlocks =>
            list(GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsUrlBlocks.t())
        }
...
defimpl Poison.Decoder, for: GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsRuleResults do
  def decode(value, options) do
    GoogleApi.PageSpeedOnline.V2.Model.ResultFormattedResultsRuleResults.decode(value, options)
  end
end
