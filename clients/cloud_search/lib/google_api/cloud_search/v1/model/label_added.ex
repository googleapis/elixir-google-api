...
defmodule GoogleApi.CloudSearch.V1.Model.LabelAdded do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.LabelAdded do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.LabelAdded.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.LabelAdded do
