...
defmodule GoogleApi.CloudSearch.V1.Model.HashtagData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.HashtagData do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.HashtagData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.HashtagData do
