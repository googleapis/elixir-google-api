...
defmodule GoogleApi.CloudSearch.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.Status do
