...
defmodule GoogleApi.CloudSearch.V1.Model.AllAuthenticatedUsersProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AllAuthenticatedUsersProto do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AllAuthenticatedUsersProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AllAuthenticatedUsersProto do
