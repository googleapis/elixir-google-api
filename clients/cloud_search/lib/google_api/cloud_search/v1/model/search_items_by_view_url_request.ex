...
defmodule GoogleApi.CloudSearch.V1.Model.SearchItemsByViewUrlRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SearchItemsByViewUrlRequest do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SearchItemsByViewUrlRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SearchItemsByViewUrlRequest do
