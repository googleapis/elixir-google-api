...
defmodule GoogleApi.CloudSearch.V1.Model.PollItemsRequest do
  @moduledoc """
  ...
  *   `limit` (*type:* `integer()`, *default:* `nil`) - Maximum number of items to return.
      <br />The maximum value is 100 and the default value is 20.
  *   `queue` (*type:* `String.t`, *default:* `nil`) - Queue name to fetch items from.  If unspecified, PollItems will
  ...
  *   `statusCodes` (*type:* `list(String.t)`, *default:* `nil`) - Limit the items polled to the ones with these statuses.
  ...
  field(:limit)
  field(:queue)
  field(:statusCodes, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.PollItemsRequest do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.PollItemsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.PollItemsRequest do
