...
defmodule GoogleApi.CloudSearch.V1.Model.EnumPropertyOptions do
  ...
  *   `orderedRanking` (*type:* `String.t`, *default:* `nil`) - Used to specify the ordered ranking for the enumeration that determines how
      ...
      isRepeatable
      is false.
  *   `possibleValues` (*type:* `list(GoogleApi.CloudSearch.V1.Model.EnumValuePair.t)`, *default:* `nil`) - The list of possible values for the enumeration property. All
