...
defmodule GoogleApi.CloudSearch.V1.Model.VPCSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.VPCSettings do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.VPCSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.VPCSettings do
