...
defmodule GoogleApi.CloudSearch.V1.Model.ItemAcl do
  ...
  *   `aclInheritanceType` (*type:* `String.t`, *default:* `nil`) - Sets the type of access rules to apply when an item inherits its ACL from a
  ...
  *   `deniedReaders` (*type:* `list(GoogleApi.CloudSearch.V1.Model.Principal.t)`, *default:* `nil`) - List of principals who are explicitly denied access to the item in search
  ...
  *   `inheritAclFrom` (*type:* `String.t`, *default:* `nil`) - Name of the item to inherit the Access Permission List (ACL) from.
  ...
  *   `owners` (*type:* `list(GoogleApi.CloudSearch.V1.Model.Principal.t)`, *default:* `nil`) - Optional. List of owners for the item. This field has no bearing on
  ...
  *   `readers` (*type:* `list(GoogleApi.CloudSearch.V1.Model.Principal.t)`, *default:* `nil`) - List of principals who are allowed to see the item in search results.
