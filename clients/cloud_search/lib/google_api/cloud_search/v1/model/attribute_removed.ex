...
defmodule GoogleApi.CloudSearch.V1.Model.AttributeRemoved do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AttributeRemoved do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AttributeRemoved.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AttributeRemoved do
