...
defmodule GoogleApi.CloudSearch.V1.Model.PropertyDefinition do
  ...
  *   `isFacetable` (*type:* `boolean()`, *default:* `nil`) - Indicates that the property can be used for generating facets. Cannot be true for properties whose type is object. IsReturnable must be true to set this option. Only supported for boolean, enum, and text properties.
  ...
  *   `isWildcardSearchable` (*type:* `boolean()`, *default:* `nil`) - Indicates that users can perform wildcard search for this property. Only supported for Text properties. IsReturnable must be true to set this option. In a given datasource maximum of 5 properties can be marked as is_wildcard_searchable.
