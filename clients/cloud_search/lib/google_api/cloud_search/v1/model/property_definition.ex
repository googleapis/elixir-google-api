...
defmodule GoogleApi.CloudSearch.V1.Model.PropertyDefinition do
  ...
  *   `displayOptions` (*type:* `GoogleApi.CloudSearch.V1.Model.PropertyDisplayOptions.t`, *default:* `nil`) - Options that determine how the property is displayed in the Cloud Search results page if it is specified to be displayed in the object's display options .
