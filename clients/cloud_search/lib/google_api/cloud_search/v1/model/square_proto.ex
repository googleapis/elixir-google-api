...
defmodule GoogleApi.CloudSearch.V1.Model.SquareProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SquareProto do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SquareProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SquareProto do
