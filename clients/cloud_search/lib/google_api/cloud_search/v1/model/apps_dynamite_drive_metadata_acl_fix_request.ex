...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest do
