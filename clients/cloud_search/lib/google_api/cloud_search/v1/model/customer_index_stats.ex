...
defmodule GoogleApi.CloudSearch.V1.Model.CustomerIndexStats do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.CustomerIndexStats do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.CustomerIndexStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.CustomerIndexStats do
