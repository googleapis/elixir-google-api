...
defmodule GoogleApi.CloudSearch.V1.Model.Color do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.Color do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.Color.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.Color do
