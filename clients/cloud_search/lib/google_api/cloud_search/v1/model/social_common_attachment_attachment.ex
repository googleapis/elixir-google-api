...
defmodule GoogleApi.CloudSearch.V1.Model.SocialCommonAttachmentAttachment do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SocialCommonAttachmentAttachment do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SocialCommonAttachmentAttachment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SocialCommonAttachmentAttachment do
