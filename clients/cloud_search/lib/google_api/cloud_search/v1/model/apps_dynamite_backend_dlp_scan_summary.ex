...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteBackendDlpScanSummary do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteBackendDlpScanSummary do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteBackendDlpScanSummary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteBackendDlpScanSummary do
