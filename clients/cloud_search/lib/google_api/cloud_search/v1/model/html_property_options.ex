...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.HtmlPropertyOptions do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.HtmlPropertyOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.HtmlPropertyOptions do
