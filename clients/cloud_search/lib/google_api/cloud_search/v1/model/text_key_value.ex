...
defmodule GoogleApi.CloudSearch.V1.Model.TextKeyValue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.TextKeyValue do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.TextKeyValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.TextKeyValue do
