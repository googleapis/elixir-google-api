...
defmodule GoogleApi.CloudSearch.V1.Model.ObjectDefinition do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Name for the object, which then defines its type. Item indexing requests
      should set the
      objectType field
  ...
  *   `propertyDefinitions` (*type:* `list(GoogleApi.CloudSearch.V1.Model.PropertyDefinition.t)`, *default:* `nil`) - The property definitions for the object.
