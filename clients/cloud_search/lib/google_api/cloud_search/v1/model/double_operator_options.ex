...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.DoubleOperatorOptions do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.DoubleOperatorOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.DoubleOperatorOptions do
