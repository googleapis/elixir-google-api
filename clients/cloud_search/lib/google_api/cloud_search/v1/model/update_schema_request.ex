...
defmodule GoogleApi.CloudSearch.V1.Model.UpdateSchemaRequest do
  @moduledoc """
  ...
  *   `validateOnly` (*type:* `boolean()`, *default:* `nil`) - If true, the schema will be checked for validity,
  ...
  field(:schema, as: GoogleApi.CloudSearch.V1.Model.Schema)
  field(:validateOnly)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.UpdateSchemaRequest do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.UpdateSchemaRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.UpdateSchemaRequest do
