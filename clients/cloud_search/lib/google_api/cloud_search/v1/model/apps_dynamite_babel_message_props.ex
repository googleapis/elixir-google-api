...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteBabelMessageProps do
  @moduledoc """
  ...
  *   `messageContent` (*type:* `GoogleApi.CloudSearch.V1.Model.MessageContent.t`, *default:* `nil`) - Stores message segments (text content) and attachments (media URLs).
  *   `wasUpdatedByBackfill` (*type:* `boolean()`, *default:* `nil`) - Whether or not these message properties were backfilled by go/dinnertrain.
  ...
  @type t :: %__MODULE__{
          ...
          :messageContent => GoogleApi.CloudSearch.V1.Model.MessageContent.t() | nil,
  ...
  field(:eventId)
  field(:messageContent, as: GoogleApi.CloudSearch.V1.Model.MessageContent)
  field(:wasUpdatedByBackfill)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteBabelMessageProps do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteBabelMessageProps.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteBabelMessageProps do
