...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedOriginAppSuggestion do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedOriginAppSuggestion do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedOriginAppSuggestion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedOriginAppSuggestion do
