...
defmodule GoogleApi.CloudSearch.V1.Model.CardAction do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.CardAction do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.CardAction.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.CardAction do
