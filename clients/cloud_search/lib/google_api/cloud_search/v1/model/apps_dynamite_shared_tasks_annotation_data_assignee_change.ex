...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedTasksAnnotationDataAssigneeChange do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedTasksAnnotationDataAssigneeChange do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteSharedTasksAnnotationDataAssigneeChange.decode(
      value,
      options
    )
  end
