...
defmodule GoogleApi.CloudSearch.V1.Model.ResultDisplayMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.ResultDisplayMetadata do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.ResultDisplayMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.ResultDisplayMetadata do
