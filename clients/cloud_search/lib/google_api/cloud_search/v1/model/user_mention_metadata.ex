...
defmodule GoogleApi.CloudSearch.V1.Model.UserMentionMetadata do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          ...
          :inviteeInfo => GoogleApi.CloudSearch.V1.Model.InviteeInfo.t() | nil,
          :type => String.t() | nil
        }
  ...
  field(:inviteeInfo, as: GoogleApi.CloudSearch.V1.Model.InviteeInfo)
  field(:type)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.UserMentionMetadata do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.UserMentionMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.UserMentionMetadata do
