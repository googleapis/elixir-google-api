...
defmodule GoogleApi.CloudSearch.V1.Model.MapTile do
  @moduledoc """
  ...
  *   `tileY` (*type:* `float()`, *default:* `nil`) - Map tile y coordinate
  ...
  field(:imageUrl, as: GoogleApi.CloudSearch.V1.Model.SafeUrlProto)
  field(:tileX)
  field(:tileY)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.MapTile do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.MapTile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.MapTile do
