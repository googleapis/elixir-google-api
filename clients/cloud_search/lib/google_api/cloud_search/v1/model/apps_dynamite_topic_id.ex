...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteTopicId do
  @moduledoc """


  ## Attributes

  *   `groupId` (*type:* `GoogleApi.CloudSearch.V1.Model.AppsDynamiteGroupId.t`, *default:* `nil`) - The Space or DM that the topic belongs to.
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteTopicId do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteTopicId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteTopicId do
