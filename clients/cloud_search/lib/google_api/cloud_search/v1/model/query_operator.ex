...
defmodule GoogleApi.CloudSearch.V1.Model.QueryOperator do
  ...
  *   `enumValues` (*type:* `list(String.t)`, *default:* `nil`) - Potential list of values for the opeatror field. This field is only filled
      when we can safely enumerate all the possible values of this operator.
  *   `greaterThanOperatorName` (*type:* `String.t`, *default:* `nil`) - Indicates the operator name that can be used to  isolate the property using
  ...
  *   `isReturnable` (*type:* `boolean()`, *default:* `nil`) - Will the property associated with this facet be returned as part of search
      results.
