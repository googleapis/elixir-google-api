...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteUserId do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Clients do not need to send UserType to Backend, but Backend will always send this field to clients per the following rule: 1. For HUMAN Ids, the field is empty but by default .getType() will return HUMAN. 2. For BOT Ids, the field is ALWAYS set to BOT.
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t() | nil,
          :originAppId => GoogleApi.CloudSearch.V1.Model.AppsDynamiteAppId.t() | nil,
          :type => String.t() | nil
        }

  field(:actingUserId)
  field(:id)
  field(:originAppId, as: GoogleApi.CloudSearch.V1.Model.AppsDynamiteAppId)
  field(:type)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteUserId do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteUserId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteUserId do
