...
defmodule GoogleApi.CloudSearch.V1.Model.ResultCounts do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.ResultCounts do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.ResultCounts.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.ResultCounts do
