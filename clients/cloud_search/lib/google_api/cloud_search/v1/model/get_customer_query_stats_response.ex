...
defmodule GoogleApi.CloudSearch.V1.Model.GetCustomerQueryStatsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.GetCustomerQueryStatsResponse do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.GetCustomerQueryStatsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.GetCustomerQueryStatsResponse do
