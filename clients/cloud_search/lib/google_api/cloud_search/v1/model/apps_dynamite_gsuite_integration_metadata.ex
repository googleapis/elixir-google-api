...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteGsuiteIntegrationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteGsuiteIntegrationMetadata do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteGsuiteIntegrationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteGsuiteIntegrationMetadata do
