...
defmodule GoogleApi.CloudSearch.V1.Model.UnmappedIdentity do
  @moduledoc """
  ...
  *   `resolutionStatusCode` (*type:* `String.t`, *default:* `nil`) - The resolution status for the external identity.
  ...
  field(:resolutionStatusCode)
end

defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.UnmappedIdentity do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.UnmappedIdentity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.UnmappedIdentity do
