...
defmodule GoogleApi.CloudSearch.V1.Model.Person do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the person to provide information about.
  ...
  *   `photos` (*type:* `list(GoogleApi.CloudSearch.V1.Model.Photo.t)`, *default:* `nil`) - A person's read-only photo. A picture shown next to the person's name to
