...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.DeleteMetadata do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.DeleteMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.DeleteMetadata do
