...
defmodule GoogleApi.CloudSearch.V1.Model.SocialGraphNodeProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SocialGraphNodeProto do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SocialGraphNodeProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SocialGraphNodeProto do
