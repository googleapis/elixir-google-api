...
defmodule GoogleApi.CloudSearch.V1.Model.SourceResultCount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SourceResultCount do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SourceResultCount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SourceResultCount do
