...
defmodule GoogleApi.CloudSearch.V1.Model.CustomerSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.CustomerSettings do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.CustomerSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.CustomerSettings do
