...
defmodule GoogleApi.CloudSearch.V1.Model.CircleProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.CircleProto do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.CircleProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.CircleProto do
