...
defmodule GoogleApi.CloudSearch.V1.Model.SafeHtmlProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.SafeHtmlProto do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.SafeHtmlProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.SafeHtmlProto do
