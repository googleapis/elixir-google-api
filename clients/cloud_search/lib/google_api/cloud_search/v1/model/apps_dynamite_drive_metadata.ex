...
defmodule GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadata do
  @moduledoc """
  Annotation metadata for Drive artifacts.

  ## Attributes

  *   `aclFixRequest` (*type:* `GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest.t`, *default:* `nil`) - 
  *   `aclFixStatus` (*type:* `GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixStatus.t`, *default:* `nil`) - 
  ...
  *   `legacyUploadMetadata` (*type:* `GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataLegacyUploadMetadata.t`, *default:* `nil`) - Only present if this DriveMetadata is converted from an UploadMetadata.
  ...
  *   `wrappedResourceKey` (*type:* `GoogleApi.CloudSearch.V1.Model.WrappedResourceKey.t`, *default:* `nil`) - This is considered SPII and should not be logged.
  ...
  @type t :: %__MODULE__{
          :aclFixRequest =>
            GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest.t() | nil,
          :aclFixStatus =>
            GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixStatus.t() | nil,
          :canEdit => boolean() | nil,
          ...
          :legacyUploadMetadata =>
            GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataLegacyUploadMetadata.t() | nil,
  ...
  field(:aclFixRequest, as: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixRequest)
  field(:aclFixStatus, as: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataAclFixStatus)
  field(:canEdit)
  field(:canShare)
  field(:canView)
  field(:driveAction)
  ...
  field(:legacyUploadMetadata,
    as: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadataLegacyUploadMetadata
  )
...
defimpl Poison.Decoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadata do
  def decode(value, options) do
    GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSearch.V1.Model.AppsDynamiteDriveMetadata do
