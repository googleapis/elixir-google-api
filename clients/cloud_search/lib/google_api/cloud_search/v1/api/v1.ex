...
defmodule GoogleApi.CloudSearch.V1.Api.V1 do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.CloudSearch.V1.Model.InitializeCustomerRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudsearch_initialize_customer(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudSearch.V1.Model.Operation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudsearch_initialize_customer(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1:initializeCustomer", %{})
