...
defmodule GoogleApi.CloudSearch.V1.Api.Operations do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.CloudSearch.V1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def cloudsearch_operations_lro_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudSearch.V1.Model.ListOperationsResponse{}])
  end
end
