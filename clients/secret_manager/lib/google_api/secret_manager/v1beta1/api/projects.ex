...
defmodule GoogleApi.SecretManager.V1beta1.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.SecretManager.V1beta1.Connection
  ...
  *   `{:error, info}` on failure
  ...
  def secretmanager_projects_locations_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.Location{}])
  end
  ...
  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.ListLocationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_locations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.ListLocationsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.AddSecretVersionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.SecretVersion{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_add_version(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.SecretVersion{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def secretmanager_projects_secrets_create(connection, parent, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.Secret{}])
  end
  ...
  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_delete(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.Policy{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_get_iam_policy(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.Policy{}])
  end
  ...
  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.ListSecretsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_list(connection, parent, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.ListSecretsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.SetIamPolicyRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.TestIamPermissionsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.TestIamPermissionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_test_iam_permissions(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.TestIamPermissionsResponse{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.SecretManager.V1beta1.Model.AccessSecretVersionResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def secretmanager_projects_secrets_versions_access(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.AccessSecretVersionResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.DestroySecretVersionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.DisableSecretVersionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SecretManager.V1beta1.Model.EnableSecretVersionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def secretmanager_projects_secrets_versions_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SecretManager.V1beta1.Model.ListSecretVersionsResponse{}]
    )
  end
end
