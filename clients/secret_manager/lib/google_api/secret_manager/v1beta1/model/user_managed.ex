...
defimpl Poison.Decoder, for: GoogleApi.SecretManager.V1beta1.Model.UserManaged do
  def decode(value, options) do
    GoogleApi.SecretManager.V1beta1.Model.UserManaged.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecretManager.V1beta1.Model.UserManaged do
