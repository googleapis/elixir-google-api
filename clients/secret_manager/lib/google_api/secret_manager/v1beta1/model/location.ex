...
defmodule GoogleApi.SecretManager.V1beta1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecretManager.V1beta1.Model.Location do
  def decode(value, options) do
    GoogleApi.SecretManager.V1beta1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecretManager.V1beta1.Model.Location do
