...
defmodule GoogleApi.SecretManager.V1.Model.ReplicationStatus do
  @moduledoc """
  ...
  *   `userManaged` (*type:* `GoogleApi.SecretManager.V1.Model.UserManagedStatus.t`, *default:* `nil`) - Describes the replication status of a SecretVersion with user-managed replication. Only populated if the parent Secret has a user-managed replication policy.
  ...
  field(:userManaged, as: GoogleApi.SecretManager.V1.Model.UserManagedStatus)
end

defimpl Poison.Decoder, for: GoogleApi.SecretManager.V1.Model.ReplicationStatus do
  def decode(value, options) do
    GoogleApi.SecretManager.V1.Model.ReplicationStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecretManager.V1.Model.ReplicationStatus do
