...
defmodule GoogleApi.VMwareEngine.V1.Model.OperationMetadata do
  @moduledoc """
  ...
  *   `requestedCancellation` (*type:* `boolean()`, *default:* `nil`) - Output only. True if the user has requested cancellation of the operation; false otherwise. Operations that have successfully been cancelled have Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.
...
defimpl Poison.Decoder, for: GoogleApi.VMwareEngine.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.VMwareEngine.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMwareEngine.V1.Model.OperationMetadata do
