...
defmodule GoogleApi.VMwareEngine.V1.Model.Hcx do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMwareEngine.V1.Model.Hcx do
  def decode(value, options) do
    GoogleApi.VMwareEngine.V1.Model.Hcx.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMwareEngine.V1.Model.Hcx do
