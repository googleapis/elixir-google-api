...
defmodule GoogleApi.VMwareEngine.V1.Model.ResetVcenterCredentialsRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMwareEngine.V1.Model.ResetVcenterCredentialsRequest do
  def decode(value, options) do
    GoogleApi.VMwareEngine.V1.Model.ResetVcenterCredentialsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMwareEngine.V1.Model.ResetVcenterCredentialsRequest do
