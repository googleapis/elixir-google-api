...
defmodule GoogleApi.VMwareEngine.V1.Model.LocationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMwareEngine.V1.Model.LocationMetadata do
  def decode(value, options) do
    GoogleApi.VMwareEngine.V1.Model.LocationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMwareEngine.V1.Model.LocationMetadata do
