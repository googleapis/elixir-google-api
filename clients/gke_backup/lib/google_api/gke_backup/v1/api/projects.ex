...
defmodule GoogleApi.GKEBackup.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  @spec gkebackup_projects_locations_backup_plans_backups_get_backup_index_download_url(
          ...
          | {:ok, list()}
          | {:error, any()}
  def gkebackup_projects_locations_backup_plans_backups_get_backup_index_download_url(
        connection,
        backup,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+backup}:getBackupIndexDownloadUrl", %{
        "backup" => URI.encode(backup, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.GKEBackup.V1.Model.GetBackupIndexDownloadUrlResponse{}]
    )
  end
