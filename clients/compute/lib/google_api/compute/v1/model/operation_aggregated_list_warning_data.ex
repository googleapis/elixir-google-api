...
defmodule GoogleApi.Compute.V1.Model.OperationAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.OperationAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.OperationAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.OperationAggregatedListWarningData do
