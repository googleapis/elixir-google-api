...
defmodule GoogleApi.Compute.V1.Model.StatefulPolicyPreservedState do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.StatefulPolicyPreservedState do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.StatefulPolicyPreservedState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.StatefulPolicyPreservedState do
