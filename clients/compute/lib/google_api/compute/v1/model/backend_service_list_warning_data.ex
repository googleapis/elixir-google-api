...
defmodule GoogleApi.Compute.V1.Model.BackendServiceListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.BackendServiceListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.BackendServiceListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.BackendServiceListWarningData do
