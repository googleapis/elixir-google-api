...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointGroupList do
  ...
  - items ([NetworkEndpointGroup]): A list of NetworkEndpointGroup resources. Defaults to: `null`.
  - kind (String.t): [Output Only] The resource type, which is always compute#networkEndpointGroupList for network endpoint group lists. Defaults to: `null`.
