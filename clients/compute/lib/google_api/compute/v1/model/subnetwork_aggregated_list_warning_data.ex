...
defmodule GoogleApi.Compute.V1.Model.SubnetworkAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.SubnetworkAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.SubnetworkAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.SubnetworkAggregatedListWarningData do
