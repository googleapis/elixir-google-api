...
defmodule GoogleApi.Compute.V1.Model.TargetSslProxyList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.TargetSslProxy.t)): A list of TargetSslProxy resources. Defaults to `nil`.
  - kind (String.t): Type of resource. Defaults to `compute#targetSslProxyList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.TargetSslProxyListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
