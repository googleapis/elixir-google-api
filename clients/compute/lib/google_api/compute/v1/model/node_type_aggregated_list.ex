...
defmodule GoogleApi.Compute.V1.Model.NodeTypeAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; NodeTypesScopedList}): A list of NodeTypesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#nodeTypeAggregatedList for aggregated lists of node types. Defaults to: `null`.
