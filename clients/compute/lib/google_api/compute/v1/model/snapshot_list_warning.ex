...
defmodule GoogleApi.Compute.V1.Model.SnapshotListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.SnapshotListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example:
