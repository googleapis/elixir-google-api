...
defmodule GoogleApi.Compute.V1.Model.VpnGatewayStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.VpnGatewayStatus do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.VpnGatewayStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.VpnGatewayStatus do
