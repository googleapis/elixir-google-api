...
defmodule GoogleApi.Compute.V1.Model.RouterAdvertisedIpRange do
  ...
  - description (String.t): User-specified description for the IP range. Defaults to `nil`.
  - range (String.t): The IP range to advertise. The value must be a CIDR-formatted string. Defaults to `nil`.
  """
