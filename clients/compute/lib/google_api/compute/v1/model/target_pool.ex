...
defmodule GoogleApi.Compute.V1.Model.TargetPool do
  ...
  *   `healthChecks` (*type:* `list(String.t)`, *default:* `nil`) - The URL of the HttpHealthCheck resource. A member instance in this pool is considered healthy if and only if the health checks pass. An empty list means all member instances will be considered healthy at all times. Only HttpHealthChecks are supported. Only one health check may be specified.
