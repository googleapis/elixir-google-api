...
defmodule GoogleApi.Compute.V1.Model.AuditConfig do
  ...
  - auditLogConfigs (list(GoogleApi.Compute.V1.Model.AuditLogConfig.t)): The configuration for logging of each type of permission. Defaults to `nil`.
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.AuditConfig do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.AuditConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.AuditConfig do
