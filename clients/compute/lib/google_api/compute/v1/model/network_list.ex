...
defmodule GoogleApi.Compute.V1.Model.NetworkList do
  ...
  - items ([Network]): A list of Network resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#networkList for lists of networks. Defaults to: `null`.
