...
defmodule GoogleApi.Compute.V1.Model.XpnResourceId do
  ...
  *   `id` (*type:* `String.t`, *default:* `nil`) - The ID of the service resource. In the case of projects, this field supports project id (e.g., my-project-123) and project number (e.g. 12345678).
  *   `type` (*type:* `String.t`, *default:* `nil`) - The type of the service resource.
  """
