...
defmodule GoogleApi.Compute.V1.Model.SecuritySettings do
  ...
  *   `clientTlsPolicy` (*type:* `String.t`, *default:* `nil`) - Optional. A URL referring to a networksecurity.ClientTlsPolicy resource that describes how clients should authenticate with this service's backends.
