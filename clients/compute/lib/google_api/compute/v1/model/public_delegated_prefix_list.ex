...
defmodule GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.PublicDelegatedPrefixListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.PublicDelegatedPrefix.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.PublicDelegatedPrefixListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.PublicDelegatedPrefix, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList do
