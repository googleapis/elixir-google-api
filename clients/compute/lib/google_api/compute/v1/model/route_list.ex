...
defmodule GoogleApi.Compute.V1.Model.RouteList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Route.t)): A list of Route resources. Defaults to `nil`.
  - kind (String.t): Type of resource. Defaults to `compute#routeList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.RouteListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
