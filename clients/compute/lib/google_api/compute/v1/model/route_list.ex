...
defmodule GoogleApi.Compute.V1.Model.RouteList do
  ...
  *   `items` (*type:* `list(GoogleApi.Compute.V1.Model.Route.t)`, *default:* `nil`) - A list of Route resources.
  *   `kind` (*type:* `String.t`, *default:* `compute#routeList`) - Type of resource.
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.RouteListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  """
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.Route.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.RouteListWarning.t() | nil
        }
  ...
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.RouteListWarning)
end
