...
defmodule GoogleApi.Compute.V1.Model.RegionAutoscalerListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.RegionAutoscalerListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionAutoscalerListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.RegionAutoscalerListWarningData do
