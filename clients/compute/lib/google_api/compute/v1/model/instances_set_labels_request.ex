...
defmodule GoogleApi.Compute.V1.Model.InstancesSetLabelsRequest do
  ...
  - labelFingerprint (String.t): Fingerprint of the previous set of labels for this resource, used to prevent conflicts. Provide the latest fingerprint value when making a request to add or change labels. Defaults to `nil`.
  - labels (map()):  Defaults to `nil`.
  """
