...
defmodule GoogleApi.Compute.V1.Model.GlobalNetworkEndpointGroupsAttachEndpointsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.GlobalNetworkEndpointGroupsAttachEndpointsRequest do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.GlobalNetworkEndpointGroupsAttachEndpointsRequest.decode(
      value,
      options
    )
  end
