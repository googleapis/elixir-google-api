...
defmodule GoogleApi.Compute.V1.Model.NodeTypeListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NodeTypeListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NodeTypeListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.NodeTypeListWarningData do
