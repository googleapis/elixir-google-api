...
defmodule GoogleApi.Compute.V1.Model.InterconnectDiagnostics do
  ...
  - arpCaches (list(GoogleApi.Compute.V1.Model.InterconnectDiagnosticsARPEntry.t)): A list of InterconnectDiagnostics.ARPEntry objects, describing individual neighbors currently seen by the Google router in the ARP cache for the Interconnect. This will be empty when the Interconnect is not bundled. Defaults to `nil`.
  - links (list(GoogleApi.Compute.V1.Model.InterconnectDiagnosticsLinkStatus.t)): A list of InterconnectDiagnostics.LinkStatus objects, describing the status for each link on the Interconnect. Defaults to `nil`.
  - macAddress (String.t): The MAC address of the Interconnect's bundle interface. Defaults to `nil`.
  """
