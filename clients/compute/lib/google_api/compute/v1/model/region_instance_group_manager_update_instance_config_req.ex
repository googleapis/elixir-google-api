...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerUpdateInstanceConfigReq do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerUpdateInstanceConfigReq do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerUpdateInstanceConfigReq.decode(
      value,
      options
    )
  end
