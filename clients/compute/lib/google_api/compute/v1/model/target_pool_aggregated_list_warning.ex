...
defmodule GoogleApi.Compute.V1.Model.TargetPoolAggregatedListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.TargetPoolAggregatedListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example:
