...
defmodule GoogleApi.Compute.V1.Model.DiskListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.DiskListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.DiskListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.DiskListWarningData do
