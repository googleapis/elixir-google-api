...
defmodule GoogleApi.Compute.V1.Model.HttpsHealthCheckListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.HttpsHealthCheckListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.HttpsHealthCheckListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.HttpsHealthCheckListWarningData do
