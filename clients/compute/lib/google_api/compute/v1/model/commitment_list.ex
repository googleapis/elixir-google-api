...
defmodule GoogleApi.Compute.V1.Model.CommitmentList do
  ...
  - items ([Commitment]): A list of Commitment resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#commitmentList for lists of commitments. Defaults to: `null`.
