...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupAggregatedList do
  ...
  - items (%{optional(String.t) => GoogleApi.Compute.V1.Model.InstanceGroupsScopedList.t}): A list of InstanceGroupsScopedList resources. Defaults to `nil`.
  - kind (String.t): [Output Only] The resource type, which is always compute#instanceGroupAggregatedList for aggregated lists of instance groups. Defaults to `compute#instanceGroupAggregatedList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
  ...
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarning)
end
