...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicy do
  ...
  - retentionPolicy (GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicyRetentionPolicy.t): Retention policy applied to snapshots created by this resource policy. Defaults to `nil`.
  - schedule (GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicySchedule.t): A Vm Maintenance Policy specifies what kind of infrastructure maintenance we are allowed to perform on this VM and when. Schedule that is applied to disks covered by this policy. Defaults to `nil`.
  - snapshotProperties (GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicySnapshotProperties.t): Properties with which snapshots are created such as labels, encryption keys. Defaults to `nil`.
  """
