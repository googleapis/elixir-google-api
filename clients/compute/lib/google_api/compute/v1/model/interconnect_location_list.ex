...
defmodule GoogleApi.Compute.V1.Model.InterconnectLocationList do
  ...
  - items ([InterconnectLocation]): A list of InterconnectLocation resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectLocationList for lists of interconnect locations. Defaults to: `null`.
