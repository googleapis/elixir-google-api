...
defmodule GoogleApi.Compute.V1.Model.TargetInstancesScopedList do
  ...
  - targetInstances (list(GoogleApi.Compute.V1.Model.TargetInstance.t)): A list of target instances contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.TargetInstancesScopedListWarning.t): Informational warning which replaces the list of addresses when the list is empty. Defaults to `nil`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :targetInstances => list(GoogleApi.Compute.V1.Model.TargetInstance.t()),
          :warning => GoogleApi.Compute.V1.Model.TargetInstancesScopedListWarning.t()
        }
