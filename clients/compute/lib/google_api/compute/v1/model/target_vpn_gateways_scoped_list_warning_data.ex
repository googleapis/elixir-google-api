...
defmodule GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarningData do
