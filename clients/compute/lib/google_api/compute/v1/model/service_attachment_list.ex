...
defmodule GoogleApi.Compute.V1.Model.ServiceAttachmentList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.ServiceAttachmentListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.ServiceAttachment.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.ServiceAttachmentListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.ServiceAttachment, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.ServiceAttachmentListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.ServiceAttachmentList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.ServiceAttachmentList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.ServiceAttachmentList do
