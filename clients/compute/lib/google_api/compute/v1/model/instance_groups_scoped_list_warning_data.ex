...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupsScopedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceGroupsScopedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupsScopedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InstanceGroupsScopedListWarningData do
