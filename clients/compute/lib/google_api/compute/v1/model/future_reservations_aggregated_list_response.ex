...
defmodule GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponse do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponseWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t() | nil,
          :items =>
            %{optional(String.t()) => GoogleApi.Compute.V1.Model.FutureReservationsScopedList.t()}
            | nil,
          :kind => String.t() | nil,
          ...
          :warning =>
            GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponseWarning.t() | nil
        }

  field(:etag)
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.FutureReservationsScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:unreachables, type: :list)
  field(:warning, as: GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponseWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponse do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.FutureReservationsAggregatedListResponse do
