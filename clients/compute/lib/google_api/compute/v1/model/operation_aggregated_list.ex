...
defmodule GoogleApi.Compute.V1.Model.OperationAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; OperationsScopedList}): [Output Only] A map of scoped operation lists. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#operationAggregatedList for aggregated lists of operations. Defaults to: `null`.
