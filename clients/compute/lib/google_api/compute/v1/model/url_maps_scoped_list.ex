...
defmodule GoogleApi.Compute.V1.Model.UrlMapsScopedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.UrlMapsScopedListWarning.t`, *default:* `nil`) - Informational warning which replaces the list of backend services when the list is empty.
  ...
  field(:warning, as: GoogleApi.Compute.V1.Model.UrlMapsScopedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.UrlMapsScopedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.UrlMapsScopedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.UrlMapsScopedList do
