...
defmodule GoogleApi.Compute.V1.Model.SchedulingNodeAffinity do
  ...
  - key (String.t): Corresponds to the label key of Node resource. Defaults to `nil`.
  - operator (String.t): Defines the operation of node selection. Defaults to `nil`.
  - values (list(String.t)): Corresponds to the label values of Node resource. Defaults to `nil`.
  """
