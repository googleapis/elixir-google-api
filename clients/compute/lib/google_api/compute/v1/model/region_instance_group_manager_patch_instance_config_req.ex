...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerPatchInstanceConfigReq do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerPatchInstanceConfigReq do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerPatchInstanceConfigReq.decode(
      value,
      options
    )
  end
