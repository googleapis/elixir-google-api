...
defmodule GoogleApi.Compute.V1.Model.CustomerEncryptionKeyProtectedDisk do
  ...
  - diskEncryptionKey (CustomerEncryptionKey): Decrypts data associated with the disk with a customer-supplied encryption key. Defaults to: `null`.
  - source (String.t): Specifies a valid partial or full URL to an existing Persistent Disk resource. This field is only applicable for persistent disks. Defaults to: `null`.
  """
