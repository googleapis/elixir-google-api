...
defmodule GoogleApi.Compute.V1.Model.TargetGrpcProxyList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.TargetGrpcProxy.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.TargetGrpcProxy, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetGrpcProxyList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetGrpcProxyList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetGrpcProxyList do
