...
defmodule GoogleApi.Compute.V1.Model.OperationListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.OperationListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.OperationListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.OperationListWarningData do
