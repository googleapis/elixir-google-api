...
defmodule GoogleApi.Compute.V1.Model.InstanceAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; InstancesScopedList}): A list of InstancesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#instanceAggregatedList for aggregated lists of Instance resources. Defaults to: `null`.
