...
defmodule GoogleApi.Compute.V1.Model.AddressList do
  ...
  - items ([Address]): A list of Address resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#addressList for lists of addresses. Defaults to: `null`.
