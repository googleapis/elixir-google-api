...
defmodule GoogleApi.Compute.V1.Model.LogConfigDataAccessOptions do
  ...
  - logMode (String.t): Whether Gin logging should happen in a fail-closed manner at the caller. This is relevant only in the LocalIAM implementation, for now. Defaults to `nil`.
  """
