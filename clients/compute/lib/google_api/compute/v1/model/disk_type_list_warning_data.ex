...
defmodule GoogleApi.Compute.V1.Model.DiskTypeListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.DiskTypeListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.DiskTypeListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.DiskTypeListWarningData do
