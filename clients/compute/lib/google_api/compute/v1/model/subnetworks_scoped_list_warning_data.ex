...
defmodule GoogleApi.Compute.V1.Model.SubnetworksScopedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.SubnetworksScopedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.SubnetworksScopedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.SubnetworksScopedListWarningData do
