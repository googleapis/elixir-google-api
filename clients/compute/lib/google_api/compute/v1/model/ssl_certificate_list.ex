...
defmodule GoogleApi.Compute.V1.Model.SslCertificateList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.SslCertificate.t)): A list of SslCertificate resources. Defaults to `nil`.
  - kind (String.t): Type of resource. Defaults to `compute#sslCertificateList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.SslCertificateListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :selfLink => String.t(),
          :warning => GoogleApi.Compute.V1.Model.SslCertificateListWarning.t()
        }
