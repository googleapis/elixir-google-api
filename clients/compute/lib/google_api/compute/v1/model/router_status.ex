...
defmodule GoogleApi.Compute.V1.Model.RouterStatus do
  ...
  - bestRoutes (list(GoogleApi.Compute.V1.Model.Route.t)): Best routes for this router's network. Defaults to `nil`.
  - bestRoutesForRouter (list(GoogleApi.Compute.V1.Model.Route.t)): Best routes learned by this router. Defaults to `nil`.
  - bgpPeerStatus (list(GoogleApi.Compute.V1.Model.RouterStatusBgpPeerStatus.t)):  Defaults to `nil`.
  - natStatus (list(GoogleApi.Compute.V1.Model.RouterStatusNatStatus.t)):  Defaults to `nil`.
