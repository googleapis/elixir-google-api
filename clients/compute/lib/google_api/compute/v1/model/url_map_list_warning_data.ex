...
defmodule GoogleApi.Compute.V1.Model.UrlMapListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.UrlMapListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.UrlMapListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.UrlMapListWarningData do
