...
defmodule GoogleApi.Compute.V1.Model.FirewallListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.FirewallListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.FirewallListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.FirewallListWarningData do
