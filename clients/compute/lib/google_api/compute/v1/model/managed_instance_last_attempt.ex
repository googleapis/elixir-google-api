...
defmodule GoogleApi.Compute.V1.Model.ManagedInstanceLastAttempt do
  ...
  - errors (GoogleApi.Compute.V1.Model.ManagedInstanceLastAttemptErrors.t): [Output Only] Encountered errors during the last attempt to create or delete the instance. Defaults to `nil`.
  """
