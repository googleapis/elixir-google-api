...
defmodule GoogleApi.Compute.V1.Model.Operation do
  ...
  *   `instancesBulkInsertOperationMetadata` (*type:* `GoogleApi.Compute.V1.Model.InstancesBulkInsertOperationMetadata.t`, *default:* `nil`) - 
  ...
  *   `setCommonInstanceMetadataOperationMetadata` (*type:* `GoogleApi.Compute.V1.Model.SetCommonInstanceMetadataOperationMetadata.t`, *default:* `nil`) - [Output Only] If the operation is for projects.setCommonInstanceMetadata, this field will contain information on all underlying zonal actions and their state.
  ...
  *   `zone` (*type:* `String.t`, *default:* `nil`) - [Output Only] The URL of the zone where the operation resides. Only applicable when performing per-zone operations.
  ...
  @type t :: %__MODULE__{
          ...
          :instancesBulkInsertOperationMetadata =>
            GoogleApi.Compute.V1.Model.InstancesBulkInsertOperationMetadata.t() | nil,
          :kind => String.t() | nil,
          :name => String.t() | nil,
          ...
          :setCommonInstanceMetadataOperationMetadata =>
            GoogleApi.Compute.V1.Model.SetCommonInstanceMetadataOperationMetadata.t() | nil,
  ...
  field(:instancesBulkInsertOperationMetadata,
    as: GoogleApi.Compute.V1.Model.InstancesBulkInsertOperationMetadata
  )
  ...
  field(:setCommonInstanceMetadataOperationMetadata,
    as: GoogleApi.Compute.V1.Model.SetCommonInstanceMetadataOperationMetadata
  )
