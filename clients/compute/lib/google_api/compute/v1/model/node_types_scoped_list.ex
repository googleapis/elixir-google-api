...
defmodule GoogleApi.Compute.V1.Model.NodeTypesScopedList do
  ...
  - nodeTypes (list(GoogleApi.Compute.V1.Model.NodeType.t)): [Output Only] A list of node types contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.NodeTypesScopedListWarning.t): [Output Only] An informational warning that appears when the node types list is empty. Defaults to `nil`.
  """
