...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedListWarningData.decode(
      value,
      options
    )
  end
