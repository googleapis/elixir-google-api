...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.AutoscalersScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"autoscalers", :list, GoogleApi.Compute.V1.Model.Autoscaler, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.AutoscalersScopedList_warning, options)
  end
end
