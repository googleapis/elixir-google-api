...
defmodule GoogleApi.Compute.V1.Model.AutoscalersScopedList do
  ...
  - autoscalers (list(GoogleApi.Compute.V1.Model.Autoscaler.t)): [Output Only] A list of autoscalers contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.AutoscalersScopedListWarning.t): [Output Only] Informational warning which replaces the list of autoscalers when the list is empty. Defaults to `nil`.
  """
