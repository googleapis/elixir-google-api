...
defmodule GoogleApi.Compute.V1.Model.AutoscalersScopedList do
  ...
  - autoscalers ([Autoscaler]): [Output Only] A list of autoscalers contained in this scope. Defaults to: `null`.
  - warning (AutoscalersScopedListWarning):  Defaults to: `null`.
  """
