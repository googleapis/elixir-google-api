...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManager do
  ...
  *   `distributionPolicy` (*type:* `GoogleApi.Compute.V1.Model.DistributionPolicy.t`, *default:* `nil`) - Policy specifying intended distribution of instances in regional managed instance group.
  ...
  *   `zone` (*type:* `String.t`, *default:* `nil`) - [Output Only] The URL of the zone where the managed instance group is located (for zonal resources).
  """
