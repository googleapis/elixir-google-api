...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.Project do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"commonInstanceMetadata", :struct, GoogleApi.Compute.V1.Model.Metadata, options)
    |> deserialize(:"quotas", :list, GoogleApi.Compute.V1.Model.Quota, options)
    |> deserialize(:"usageExportLocation", :struct, GoogleApi.Compute.V1.Model.UsageExportLocation, options)
  end
end
