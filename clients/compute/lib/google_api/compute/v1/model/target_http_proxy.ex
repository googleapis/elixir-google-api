...
defmodule GoogleApi.Compute.V1.Model.TargetHttpProxy do
  ...
  - kind (String.t): [Output Only] Type of resource. Always compute#targetHttpProxy for target HTTP proxies. Defaults to: `null`.
  ...
  - urlMap (String.t): URL to the UrlMap resource that defines the mapping from URL to the BackendService. Defaults to: `null`.
  """
