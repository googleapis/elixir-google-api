...
defmodule GoogleApi.Compute.V1.Model.RouterAggregatedList do
  ...
  - items (%{optional(String.t) => GoogleApi.Compute.V1.Model.RoutersScopedList.t}): A list of Router resources. Defaults to `nil`.
  - kind (String.t): Type of resource. Defaults to `compute#routerAggregatedList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.RouterAggregatedListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
