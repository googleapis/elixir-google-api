...
defmodule GoogleApi.Compute.V1.Model.OperationWarningsData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.OperationWarningsData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.OperationWarningsData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.OperationWarningsData do
