...
defmodule GoogleApi.Compute.V1.Model.TargetTcpProxyListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetTcpProxyListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetTcpProxyListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetTcpProxyListWarningData do
