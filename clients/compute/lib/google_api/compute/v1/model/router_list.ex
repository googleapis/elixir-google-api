...
defmodule GoogleApi.Compute.V1.Model.RouterList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Router.t)): A list of Router resources. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#router for routers. Defaults to `compute#routerList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.RouterListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
