...
defmodule GoogleApi.Compute.V1.Model.InterconnectListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InterconnectListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InterconnectListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InterconnectListWarningData do
