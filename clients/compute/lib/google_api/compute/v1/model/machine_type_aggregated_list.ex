...
defmodule GoogleApi.Compute.V1.Model.MachineTypeAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; MachineTypesScopedList}): A list of MachineTypesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#machineTypeAggregatedList for aggregated lists of machine types. Defaults to: `null`.
