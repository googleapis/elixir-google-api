...
defmodule GoogleApi.Compute.V1.Model.BackendBucketListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.BackendBucketListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.BackendBucketListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.BackendBucketListWarningData do
