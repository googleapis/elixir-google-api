...
defmodule GoogleApi.Compute.V1.Model.BulkInsertDiskResource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.BulkInsertDiskResource do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.BulkInsertDiskResource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.BulkInsertDiskResource do
