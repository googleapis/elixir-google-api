...
defmodule GoogleApi.Compute.V1.Model.Instance do
  ...
  *   `reservationAffinity` (*type:* `GoogleApi.Compute.V1.Model.ReservationAffinity.t`, *default:* `nil`) - The configuration of desired reservations from which this Instance can consume capacity from.
