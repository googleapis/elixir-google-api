...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstancesScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"instances", :list, GoogleApi.Compute.V1.Model.Instance, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.InstancesScopedList_warning, options)
  end
end
