...
defmodule GoogleApi.Compute.V1.Model.InstancesScopedList do
  ...
  - instances (list(GoogleApi.Compute.V1.Model.Instance.t)): [Output Only] A list of instances contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.InstancesScopedListWarning.t): [Output Only] Informational warning which replaces the list of instances when the list is empty. Defaults to `nil`.
  """
