...
defmodule GoogleApi.Compute.V1.Model.NodeTemplateAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; NodeTemplatesScopedList}): A list of NodeTemplatesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#nodeTemplateAggregatedList for aggregated lists of node templates. Defaults to: `null`.
