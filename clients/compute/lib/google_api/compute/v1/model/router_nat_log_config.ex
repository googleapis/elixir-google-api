...
defmodule GoogleApi.Compute.V1.Model.RouterNatLogConfig do
  ...
  *   `filter` (*type:* `String.t`, *default:* `nil`) - Specifies the desired filtering of logs on this NAT. If unspecified, logs are exported for all connections handled by this NAT.
  """
