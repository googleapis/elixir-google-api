...
defmodule GoogleApi.Compute.V1.Model.BackendServiceList do
  ...
  - items ([BackendService]): A list of BackendService resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#backendServiceList for lists of backend services. Defaults to: `null`.
