...
defmodule GoogleApi.Compute.V1.Model.BackendServiceIAP do
  ...
  - oauth2ClientId (String.t):  Defaults to `nil`.
  - oauth2ClientSecret (String.t):  Defaults to `nil`.
  - oauth2ClientSecretSha256 (String.t): [Output Only] SHA256 hash value for the field oauth2_client_secret above. Defaults to `nil`.
  """
