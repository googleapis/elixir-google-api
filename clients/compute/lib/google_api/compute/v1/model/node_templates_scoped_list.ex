...
defmodule GoogleApi.Compute.V1.Model.NodeTemplatesScopedList do
  ...
  - nodeTemplates ([NodeTemplate]): [Output Only] A list of node templates contained in this scope. Defaults to: `null`.
  - warning (NodeTemplatesScopedListWarning):  Defaults to: `null`.
  """
