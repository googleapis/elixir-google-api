...
defmodule GoogleApi.Compute.V1.Model.TargetPoolList do
  ...
  - items ([TargetPool]): A list of TargetPool resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#targetPoolList for lists of target pools. Defaults to: `null`.
