...
defmodule GoogleApi.Compute.V1.Model.ManagedInstanceVersion do
  ...
  - instanceTemplate (String.t): [Output Only] The intended template of the instance. This field is empty when current_action is one of { DELETING, ABANDONING }. Defaults to `nil`.
  - name (String.t): [Output Only] Name of the version. Defaults to `nil`.
  """
