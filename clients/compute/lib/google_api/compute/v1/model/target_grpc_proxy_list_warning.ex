...
defmodule GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" } 
  *   `message` (*type:* `String.t`, *default:* `nil`) - [Output Only] A human-readable description of the warning code.
  ...
  @type t :: %__MODULE__{
          :code => String.t() | nil,
          :data => list(GoogleApi.Compute.V1.Model.TargetGrpcProxyListWarningData.t()) | nil,
