...
defmodule GoogleApi.Compute.V1.Model.TargetVpnGateway do
  ...
  - forwardingRules (list(String.t)): [Output Only] A list of URLs to the ForwardingRule resources. ForwardingRules are created using compute.forwardingRules.insert and associated with a VPN gateway. Defaults to `nil`.
  - id (String.t): [Output Only] The unique identifier for the resource. This identifier is defined by the server. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#targetVpnGateway for target VPN gateways. Defaults to `compute#targetVpnGateway`.
  ...
  - network (String.t): URL of the network to which this VPN gateway is attached. Provided by the client when the VPN gateway is created. Defaults to `nil`.
  - region (String.t): [Output Only] URL of the region where the target VPN gateway resides. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. Defaults to `nil`.
  - selfLink (String.t): [Output Only] Server-defined URL for the resource. Defaults to `nil`.
  - status (String.t): [Output Only] The status of the VPN gateway, which can be one of the following: CREATING, READY, FAILED, or DELETING. Defaults to `nil`.
  - tunnels (list(String.t)): [Output Only] A list of URLs to VpnTunnel resources. VpnTunnels are created using the compute.vpntunnels.insert method and associated with a VPN gateway. Defaults to `nil`.
  """
