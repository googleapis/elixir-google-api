...
defmodule GoogleApi.Compute.V1.Model.ShieldedInstanceIdentity do
  ...
  - encryptionKey (GoogleApi.Compute.V1.Model.ShieldedInstanceIdentityEntry.t): An Endorsement Key (EK) issued to the Shielded Instance's vTPM. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of the resource. Always compute#shieldedInstanceIdentity for shielded Instance identity entry. Defaults to `compute#shieldedInstanceIdentity`.
  - signingKey (GoogleApi.Compute.V1.Model.ShieldedInstanceIdentityEntry.t): An Attestation Key (AK) issued to the Shielded Instance's vTPM. Defaults to `nil`.
  """
