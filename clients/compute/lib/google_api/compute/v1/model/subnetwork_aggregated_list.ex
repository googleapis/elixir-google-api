...
defmodule GoogleApi.Compute.V1.Model.SubnetworkAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; SubnetworksScopedList}): A list of SubnetworksScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#subnetworkAggregatedList for aggregated lists of subnetworks. Defaults to: `null`.
