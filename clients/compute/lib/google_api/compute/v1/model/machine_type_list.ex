...
defmodule GoogleApi.Compute.V1.Model.MachineTypeList do
  ...
  - items ([MachineType]): A list of MachineType resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#machineTypeList for lists of machine types. Defaults to: `null`.
