...
defmodule GoogleApi.Compute.V1.Model.NodeTypeList do
  ...
  - items ([NodeType]): A list of NodeType resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#nodeTypeList for lists of node types. Defaults to: `null`.
