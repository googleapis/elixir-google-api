...
defmodule GoogleApi.Compute.V1.Model.DiskTypeAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; DiskTypesScopedList}): A list of DiskTypesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#diskTypeAggregatedList. Defaults to: `null`.
