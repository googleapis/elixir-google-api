...
defmodule GoogleApi.Compute.V1.Model.TargetHttpsProxiesSetSslCertificatesRequest do
  ...
  - sslCertificates (list(String.t)): New set of SslCertificate resources to associate with this TargetHttpsProxy resource. Currently exactly one SslCertificate resource must be specified. Defaults to `nil`.
  """
