...
defmodule GoogleApi.Compute.V1.Model.Scheduling do
  ...
  By default, this is set to true so an instance is automatically restarted if it is terminated by Compute Engine. Defaults to `nil`.
  - nodeAffinities (list(GoogleApi.Compute.V1.Model.SchedulingNodeAffinity.t)): A set of node affinity and anti-affinity. Defaults to `nil`.
  - onHostMaintenance (String.t): Defines the maintenance behavior for this instance. For standard instances, the default behavior is MIGRATE. For preemptible instances, the default and only possible behavior is TERMINATE. For more information, see Setting Instance Scheduling Options. Defaults to `nil`.
  - preemptible (boolean()): Defines whether the instance is preemptible. This can only be set during instance creation, it cannot be set or changed after the instance has been created. Defaults to `nil`.
  """
