...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupsListInstancesRequest do
  ...
  - instanceState (String.t): Instances in which state should be returned. Valid options are: 'ALL', 'RUNNING'. By default, it lists all instances. Defaults to `nil`.
  - portName (String.t): Name of port user is interested in. It is optional. If it is set, only information about this ports will be returned. If it is not set, all the named ports will be returned. Always lists all instances. Defaults to `nil`.
  """
