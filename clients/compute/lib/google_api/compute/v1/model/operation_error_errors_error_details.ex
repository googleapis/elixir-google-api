...
defmodule GoogleApi.Compute.V1.Model.OperationErrorErrorsErrorDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.OperationErrorErrorsErrorDetails do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.OperationErrorErrorsErrorDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.OperationErrorErrorsErrorDetails do
