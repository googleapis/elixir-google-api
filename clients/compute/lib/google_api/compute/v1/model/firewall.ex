...
defmodule GoogleApi.Compute.V1.Model.Firewall do
  ...
  *   `logConfig` (*type:* `GoogleApi.Compute.V1.Model.FirewallLogConfig.t`, *default:* `nil`) - This field denotes the logging options for a particular firewall rule. If logging is enabled, logs will be exported to Stackdriver.
