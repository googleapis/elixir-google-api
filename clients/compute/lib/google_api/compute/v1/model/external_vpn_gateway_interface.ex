...
defmodule GoogleApi.Compute.V1.Model.ExternalVpnGatewayInterface do
  ...
  *   `id` (*type:* `integer()`, *default:* `nil`) - The numeric ID of this interface. The allowed input values for this id for different redundancy types of external VPN gateway: 
