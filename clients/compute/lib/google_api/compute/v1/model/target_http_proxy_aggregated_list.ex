...
defmodule GoogleApi.Compute.V1.Model.TargetHttpProxyAggregatedList do
  @moduledoc """
  ...
  *   `selfLink` (*type:* `String.t`, *default:* `nil`) - [Output Only] Server-defined URL for this resource.
  ...
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.TargetHttpProxiesScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
end
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetHttpProxyAggregatedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetHttpProxyAggregatedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetHttpProxyAggregatedList do
