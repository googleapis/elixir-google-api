...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerList do
  ...
  - items ([InstanceGroupManager]): A list of InstanceGroupManager resources. Defaults to: `null`.
  - kind (String.t): [Output Only] The resource type, which is always compute#instanceGroupManagerList for a list of managed instance groups that exist in th regional scope. Defaults to: `null`.
