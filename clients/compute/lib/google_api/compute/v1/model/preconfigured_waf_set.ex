...
defmodule GoogleApi.Compute.V1.Model.PreconfiguredWafSet do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.PreconfiguredWafSet do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.PreconfiguredWafSet.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.PreconfiguredWafSet do
