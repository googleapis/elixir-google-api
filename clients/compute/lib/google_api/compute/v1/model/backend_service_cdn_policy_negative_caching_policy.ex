...
defmodule GoogleApi.Compute.V1.Model.BackendServiceCdnPolicyNegativeCachingPolicy do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.BackendServiceCdnPolicyNegativeCachingPolicy do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.BackendServiceCdnPolicyNegativeCachingPolicy.decode(value, options)
  end
end
