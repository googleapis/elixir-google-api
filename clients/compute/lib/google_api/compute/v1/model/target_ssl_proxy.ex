...
defmodule GoogleApi.Compute.V1.Model.TargetSslProxy do
  ...
  - kind (String.t): [Output Only] Type of the resource. Always compute#targetSslProxy for target SSL proxies. Defaults to `compute#targetSslProxy`.
  ...
  - sslCertificates (list(String.t)): URLs to SslCertificate resources that are used to authenticate connections to Backends. At least one SSL certificate must be specified. Currently, you may specify up to 15 SSL certificates. Defaults to `nil`.
  - sslPolicy (String.t): URL of SslPolicy resource that will be associated with the TargetSslProxy resource. If not set, the TargetSslProxy resource will not have any SSL policy configured. Defaults to `nil`.
  """
