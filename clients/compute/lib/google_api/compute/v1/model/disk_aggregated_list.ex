...
defmodule GoogleApi.Compute.V1.Model.DiskAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; DisksScopedList}): A list of DisksScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#diskAggregatedList for aggregated lists of persistent disks. Defaults to: `null`.
