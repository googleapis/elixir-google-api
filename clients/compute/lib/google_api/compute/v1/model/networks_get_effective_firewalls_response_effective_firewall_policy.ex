...
defmodule GoogleApi.Compute.V1.Model.NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy.decode(
      value,
      options
    )
  end
