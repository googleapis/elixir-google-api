...
defmodule GoogleApi.Compute.V1.Model.InstanceList do
  ...
  - items ([Instance]): A list of Instance resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#instanceList for lists of Instance resources. Defaults to: `null`.
