...
defmodule GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.SslPoliciesAggregatedListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t() | nil,
          :items =>
            %{optional(String.t()) => GoogleApi.Compute.V1.Model.SslPoliciesScopedList.t()} | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :unreachables => list(String.t()) | nil,
          :warning => GoogleApi.Compute.V1.Model.SslPoliciesAggregatedListWarning.t() | nil
        }

  field(:etag)
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.SslPoliciesScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:unreachables, type: :list)
  field(:warning, as: GoogleApi.Compute.V1.Model.SslPoliciesAggregatedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList do
