...
defmodule GoogleApi.Compute.V1.Model.NetworkRoutingConfig do
  ...
  - routingMode (String.t): The network-wide routing mode to use. If set to REGIONAL, this network&#39;s cloud routers will only advertise routes with subnetworks of this network in the same region as the router. If set to GLOBAL, this network&#39;s cloud routers will advertise routes with all subnetworks of this network, across regions. Defaults to: `null`.
