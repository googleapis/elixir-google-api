...
defmodule GoogleApi.Compute.V1.Model.NetworkRoutingConfig do
  ...
  - routingMode (String.t): The network-wide routing mode to use. If set to REGIONAL, this network's Cloud Routers will only advertise routes with subnets of this network in the same region as the router. If set to GLOBAL, this network's Cloud Routers will advertise routes with all subnets of this network, across regions. Defaults to `nil`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :routingMode => String.t()
        }
