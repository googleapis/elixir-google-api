...
defmodule GoogleApi.Compute.V1.Model.InstanceWithNamedPorts do
  ...
  - instance (String.t): [Output Only] The URL of the instance. Defaults to `nil`.
  - namedPorts (list(GoogleApi.Compute.V1.Model.NamedPort.t)): [Output Only] The named ports that belong to this instance group. Defaults to `nil`.
  - status (String.t): [Output Only] The status of the instance. Defaults to `nil`.
  """
