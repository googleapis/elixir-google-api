...
defmodule GoogleApi.Compute.V1.Model.RegionListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.RegionListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.RegionListWarningData do
