...
defmodule GoogleApi.Compute.V1.Model.SecurityPolicyRuleMatcherExprOptionsRecaptchaOptions do
  @moduledoc """
  ...
  *   `sessionTokenSiteKeys` (*type:* `list(String.t)`, *default:* `nil`) - A list of site keys to be used during the validation of reCAPTCHA session-tokens. The provided site keys need to be created from reCAPTCHA API under the same project where the security policy is created.
  ...
  @type t :: %__MODULE__{
          :actionTokenSiteKeys => list(String.t()) | nil,
          :sessionTokenSiteKeys => list(String.t()) | nil
        }

  field(:actionTokenSiteKeys, type: :list)
  field(:sessionTokenSiteKeys, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.SecurityPolicyRuleMatcherExprOptionsRecaptchaOptions do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.SecurityPolicyRuleMatcherExprOptionsRecaptchaOptions.decode(
      value,
      options
    )
  end
