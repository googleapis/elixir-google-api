...
defmodule GoogleApi.Compute.V1.Model.ResourcePoliciesScopedList do
  ...
  - resourcePolicies ([ResourcePolicy]): A list of resourcePolicies contained in this scope. Defaults to: `null`.
  - warning (ResourcePoliciesScopedListWarning):  Defaults to: `null`.
  """
