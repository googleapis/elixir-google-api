...
defmodule GoogleApi.Compute.V1.Model.ExternalVpnGatewayList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.ExternalVpnGatewayListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :etag => String.t() | nil,
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.ExternalVpnGateway.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.ExternalVpnGatewayListWarning.t() | nil
        }

  field(:etag)
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.ExternalVpnGateway, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.ExternalVpnGatewayListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.ExternalVpnGatewayList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.ExternalVpnGatewayList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.ExternalVpnGatewayList do
