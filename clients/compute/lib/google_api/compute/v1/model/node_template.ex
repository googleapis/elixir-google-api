...
defmodule GoogleApi.Compute.V1.Model.NodeTemplate do
  ...
  - kind (String.t): [Output Only] The type of the resource. Always compute#nodeTemplate for node templates. Defaults to `compute#nodeTemplate`.
  ...
  - nodeAffinityLabels (map()): Labels to use for node affinity, which will be used in instance scheduling. Defaults to `nil`.
  - nodeType (String.t): The node type to use for nodes group that are created from this template. Defaults to `nil`.
  - nodeTypeFlexibility (GoogleApi.Compute.V1.Model.NodeTemplateNodeTypeFlexibility.t): The flexible properties of the desired node type. Node groups that use this node template will create nodes of a type that matches these properties.

  This field is mutually exclusive with the node_type property; you can only define one or the other, but not both. Defaults to `nil`.
  - region (String.t): [Output Only] The name of the region where the node template resides, such as us-central1. Defaults to `nil`.
  ...
  - status (String.t): [Output Only] The status of the node template. One of the following values: CREATING, READY, and DELETING. Defaults to `nil`.
