...
defmodule GoogleApi.Compute.V1.Model.SslCertificate do
  ...
  - certificate (String.t): A local certificate file. The certificate must be in PEM format. The certificate chain must be no greater than 5 certs long. The chain must include at least one intermediate cert. Defaults to `nil`.
  ...
  - kind (String.t): [Output Only] Type of the resource. Always compute#sslCertificate for SSL certificates. Defaults to `compute#sslCertificate`.
  ...
  - privateKey (String.t): A write-only private key in PEM format. Only insert requests will include this field. Defaults to `nil`.
