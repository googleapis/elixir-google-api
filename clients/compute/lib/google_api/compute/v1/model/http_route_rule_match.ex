...
defmodule GoogleApi.Compute.V1.Model.HttpRouteRuleMatch do
  ...
  *   `fullPathMatch` (*type:* `String.t`, *default:* `nil`) - For satifying the matchRule condition, the path of the request must exactly match the value specified in fullPathMatch after removing any query parameters and anchor that may be part of the original URL.
  ...
  *   `prefixMatch` (*type:* `String.t`, *default:* `nil`) - For satifying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /.
