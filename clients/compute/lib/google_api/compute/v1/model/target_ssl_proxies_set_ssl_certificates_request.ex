...
defmodule GoogleApi.Compute.V1.Model.TargetSslProxiesSetSslCertificatesRequest do
  ...
  - sslCertificates ([String.t]): New set of URLs to SslCertificate resources to associate with this TargetSslProxy. Currently exactly one ssl certificate must be specified. Defaults to: `null`.
  """
