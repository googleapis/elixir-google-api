...
defmodule GoogleApi.Compute.V1.Model.FirewallList do
  ...
  - items ([Firewall]): A list of Firewall resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#firewallList for lists of firewalls. Defaults to: `null`.
