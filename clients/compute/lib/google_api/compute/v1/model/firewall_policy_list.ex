...
defmodule GoogleApi.Compute.V1.Model.FirewallPolicyList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.FirewallPolicyListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.FirewallPolicy, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:warning, as: GoogleApi.Compute.V1.Model.FirewallPolicyListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.FirewallPolicyList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.FirewallPolicyList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.FirewallPolicyList do
