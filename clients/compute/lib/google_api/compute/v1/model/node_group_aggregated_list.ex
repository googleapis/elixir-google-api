...
defmodule GoogleApi.Compute.V1.Model.NodeGroupAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; NodeGroupsScopedList}): A list of NodeGroupsScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#nodeGroupAggregatedList for aggregated lists of node groups. Defaults to: `null`.
