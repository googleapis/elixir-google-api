...
defmodule GoogleApi.Compute.V1.Model.SubnetworkList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Subnetwork.t)): A list of Subnetwork resources. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#subnetworkList for lists of subnetworks. Defaults to `compute#subnetworkList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.SubnetworkListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
