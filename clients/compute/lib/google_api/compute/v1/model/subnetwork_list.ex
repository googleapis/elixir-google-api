...
defmodule GoogleApi.Compute.V1.Model.SubnetworkList do
  ...
  - items ([Subnetwork]): A list of Subnetwork resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#subnetworkList for lists of subnetworks. Defaults to: `null`.
