...
defmodule GoogleApi.Compute.V1.Model.InstanceListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InstanceListWarningData do
