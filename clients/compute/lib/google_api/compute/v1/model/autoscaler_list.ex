...
defmodule GoogleApi.Compute.V1.Model.AutoscalerList do
  ...
  - kind (String.t): [Output Only] Type of resource. Always compute#autoscalerList for lists of autoscalers. Defaults to `compute#autoscalerList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.AutoscalerListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
