...
defmodule GoogleApi.Compute.V1.Model.HealthStatus do
  ...
  - healthState (String.t): Health state of the instance. Defaults to `nil`.
  - instance (String.t): URL of the instance resource. Defaults to `nil`.
  - ipAddress (String.t): The IP address represented by this resource. Defaults to `nil`.
  - port (integer()): The port on the instance. Defaults to `nil`.
  """
