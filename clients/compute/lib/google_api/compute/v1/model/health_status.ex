...
defmodule GoogleApi.Compute.V1.Model.HealthStatus do
  ...
  - healthState (String.t): Health state of the instance. Defaults to: `null`.
    - Enum - one of [HEALTHY, UNHEALTHY]
  - instance (String.t): URL of the instance resource. Defaults to: `null`.
  - ipAddress (String.t): The IP address represented by this resource. Defaults to: `null`.
  - port (integer()): The port on the instance. Defaults to: `null`.
  """
