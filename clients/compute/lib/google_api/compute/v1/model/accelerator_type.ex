...
defmodule GoogleApi.Compute.V1.Model.AcceleratorType do
  ...
  - deprecated (GoogleApi.Compute.V1.Model.DeprecationStatus.t): [Output Only] The deprecation status associated with this accelerator type. Defaults to `nil`.
  ...
  - kind (String.t): [Output Only] The type of the resource. Always compute#acceleratorType for accelerator types. Defaults to `compute#acceleratorType`.
  - maximumCardsPerInstance (integer()): [Output Only] Maximum accelerator cards allowed per instance. Defaults to `nil`.
  ...
  - zone (String.t): [Output Only] The name of the zone where the accelerator type resides, such as us-central1-a. You must specify this field as part of the HTTP request URL. It is not settable as a field in the request body. Defaults to `nil`.
  """
