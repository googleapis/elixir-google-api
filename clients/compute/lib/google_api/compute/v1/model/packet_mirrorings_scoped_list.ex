...
defmodule GoogleApi.Compute.V1.Model.PacketMirroringsScopedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.PacketMirroringsScopedListWarning.t`, *default:* `nil`) - Informational warning which replaces the list of packetMirrorings when the list is empty.
  ...
  field(:warning, as: GoogleApi.Compute.V1.Model.PacketMirroringsScopedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.PacketMirroringsScopedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.PacketMirroringsScopedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.PacketMirroringsScopedList do
