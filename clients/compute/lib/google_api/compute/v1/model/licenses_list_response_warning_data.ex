...
defmodule GoogleApi.Compute.V1.Model.LicensesListResponseWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.LicensesListResponseWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.LicensesListResponseWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.LicensesListResponseWarningData do
