...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceGroupManagersScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"instanceGroupManagers", :list, GoogleApi.Compute.V1.Model.InstanceGroupManager, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.InstanceGroupManagersScopedList_warning, options)
  end
end
