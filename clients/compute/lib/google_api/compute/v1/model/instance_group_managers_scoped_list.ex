...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagersScopedList do
  ...
  - instanceGroupManagers (list(GoogleApi.Compute.V1.Model.InstanceGroupManager.t)): [Output Only] The list of managed instance groups that are contained in the specified project and zone. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.InstanceGroupManagersScopedListWarning.t): [Output Only] The warning that replaces the list of managed instance groups when the list is empty. Defaults to `nil`.
  """
