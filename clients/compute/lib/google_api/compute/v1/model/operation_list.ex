...
defmodule GoogleApi.Compute.V1.Model.OperationList do
  ...
  - items ([Operation]): [Output Only] A list of Operation resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#operations for Operations resource. Defaults to: `null`.
