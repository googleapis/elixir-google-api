...
defmodule GoogleApi.Compute.V1.Model.Policy do
  ...
  *   `bindings` (*type:* `list(GoogleApi.Compute.V1.Model.Binding.t)`, *default:* `nil`) - Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
  ...
  *   `iamOwned` (*type:* `boolean()`, *default:* `nil`) - This is deprecated and has no effect. Do not use.
  *   `rules` (*type:* `list(GoogleApi.Compute.V1.Model.Rule.t)`, *default:* `nil`) - This is deprecated and has no effect. Do not use.
