...
defmodule GoogleApi.Compute.V1.Model.HealthStatusForNetworkEndpoint do
  ...
  - backendService (GoogleApi.Compute.V1.Model.BackendServiceReference.t): URL of the backend service associated with the health state of the network endpoint. Defaults to `nil`.
  - forwardingRule (GoogleApi.Compute.V1.Model.ForwardingRuleReference.t): URL of the forwarding rule associated with the health state of the network endpoint. Defaults to `nil`.
  - healthCheck (GoogleApi.Compute.V1.Model.HealthCheckReference.t): URL of the health check associated with the health state of the network endpoint. Defaults to `nil`.
  - healthState (String.t): Health state of the network endpoint determined based on the health checks configured. Defaults to `nil`.
  """
