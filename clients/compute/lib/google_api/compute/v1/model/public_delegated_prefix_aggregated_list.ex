...
defmodule GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          ...
          :items =>
            %{
              optional(String.t()) =>
                GoogleApi.Compute.V1.Model.PublicDelegatedPrefixesScopedList.t()
            }
            | nil,
          :kind => String.t() | nil,
          ...
          :warning =>
            GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixesScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:unreachables, type: :list)
  field(:warning, as: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList do
