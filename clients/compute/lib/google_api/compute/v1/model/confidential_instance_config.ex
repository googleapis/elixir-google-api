...
defmodule GoogleApi.Compute.V1.Model.ConfidentialInstanceConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.ConfidentialInstanceConfig do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.ConfidentialInstanceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.ConfidentialInstanceConfig do
