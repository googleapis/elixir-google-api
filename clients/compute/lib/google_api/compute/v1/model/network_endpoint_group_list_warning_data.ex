...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointGroupListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NetworkEndpointGroupListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NetworkEndpointGroupListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.NetworkEndpointGroupListWarningData do
