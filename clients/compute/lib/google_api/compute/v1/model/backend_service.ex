...
defmodule GoogleApi.Compute.V1.Model.BackendService do
  ...
  *   `subsetting` (*type:* `GoogleApi.Compute.V1.Model.Subsetting.t`, *default:* `nil`) - subsetting cannot be specified with haPolicy.
  ...
  *   `connectionDraining` (*type:* `GoogleApi.Compute.V1.Model.ConnectionDraining.t`, *default:* `nil`) - connectionDraining cannot be specified with haPolicy.
  ...
  *   `network` (*type:* `String.t`, *default:* `nil`) - The URL of the network to which this backend service belongs. This field must be set for Internal Passthrough Network Load Balancers when the haPolicy is enabled, and for External Passthrough Network Load Balancers when the haPolicy fastIpMove is enabled. This field can only be specified when the load balancing scheme is set to INTERNAL.
  ...
  *   `fingerprint` (*type:* `String.t`, *default:* `nil`) - Fingerprint of this resource. A hash of the contents stored in this object. This field is used in optimistic locking. This field will be ignored when inserting a BackendService. An up-to-date fingerprint must be provided in order to update the BackendService, otherwise the request will fail with error 412 conditionNotMet. To see the latest fingerprint, make a get() request to retrieve a BackendService.
  ...
  @type t :: %__MODULE__{
          ...
          :localityLbPolicies =>
            ...
            | nil,
          :haPolicy => GoogleApi.Compute.V1.Model.BackendServiceHAPolicy.t() | nil,
  ...
  field(:haPolicy, as: GoogleApi.Compute.V1.Model.BackendServiceHAPolicy)
