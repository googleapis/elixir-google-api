...
defmodule GoogleApi.Compute.V1.Model.GuestAttributesEntry do
  ...
  - key (String.t): Key for the guest attribute entry. Defaults to `nil`.
  - namespace (String.t): Namespace for the guest attribute entry. Defaults to `nil`.
  - value (String.t): Value for the guest attribute entry. Defaults to `nil`.
  """
