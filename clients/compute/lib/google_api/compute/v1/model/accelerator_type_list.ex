...
defmodule GoogleApi.Compute.V1.Model.AcceleratorTypeList do
  ...
  - items ([AcceleratorType]): A list of AcceleratorType resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#acceleratorTypeList for lists of accelerator types. Defaults to: `null`.
