...
defmodule GoogleApi.Compute.V1.Model.NodeGroupMaintenanceWindow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NodeGroupMaintenanceWindow do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NodeGroupMaintenanceWindow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.NodeGroupMaintenanceWindow do
