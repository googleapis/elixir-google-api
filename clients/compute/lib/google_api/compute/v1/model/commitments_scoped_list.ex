...
defmodule GoogleApi.Compute.V1.Model.CommitmentsScopedList do
  ...
  - commitments ([Commitment]): [Output Only] A list of commitments contained in this scope. Defaults to: `null`.
  - warning (CommitmentsScopedListWarning):  Defaults to: `null`.
  """
