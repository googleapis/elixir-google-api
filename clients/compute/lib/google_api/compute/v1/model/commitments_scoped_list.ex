...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.CommitmentsScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"commitments", :list, GoogleApi.Compute.V1.Model.Commitment, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.CommitmentsScopedList_warning, options)
  end
end
