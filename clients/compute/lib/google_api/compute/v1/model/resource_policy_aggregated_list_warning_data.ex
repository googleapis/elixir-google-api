...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicyAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.ResourcePolicyAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.ResourcePolicyAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.ResourcePolicyAggregatedListWarningData do
