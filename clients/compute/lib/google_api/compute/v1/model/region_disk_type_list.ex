...
defmodule GoogleApi.Compute.V1.Model.RegionDiskTypeList do
  ...
  - items ([DiskType]): A list of DiskType resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#regionDiskTypeList for region disk types. Defaults to: `null`.
