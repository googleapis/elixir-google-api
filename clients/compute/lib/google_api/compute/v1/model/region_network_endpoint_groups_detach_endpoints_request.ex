...
defmodule GoogleApi.Compute.V1.Model.RegionNetworkEndpointGroupsDetachEndpointsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.RegionNetworkEndpointGroupsDetachEndpointsRequest do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionNetworkEndpointGroupsDetachEndpointsRequest.decode(
      value,
      options
    )
  end
