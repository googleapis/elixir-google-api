...
defmodule GoogleApi.Compute.V1.Model.LogConfig do
  ...
  - cloudAudit (GoogleApi.Compute.V1.Model.LogConfigCloudAuditOptions.t): Cloud audit options. Defaults to `nil`.
  - counter (GoogleApi.Compute.V1.Model.LogConfigCounterOptions.t): Counter options. Defaults to `nil`.
  - dataAccess (GoogleApi.Compute.V1.Model.LogConfigDataAccessOptions.t): Data access options. Defaults to `nil`.
  """
