...
defmodule GoogleApi.Compute.V1.Model.AcceleratorTypeAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; AcceleratorTypesScopedList}): A list of AcceleratorTypesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#acceleratorTypeAggregatedList for aggregated lists of accelerator types. Defaults to: `null`.
