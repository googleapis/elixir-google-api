...
defmodule GoogleApi.Compute.V1.Model.RegionAddressesMoveRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.RegionAddressesMoveRequest do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionAddressesMoveRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.RegionAddressesMoveRequest do
