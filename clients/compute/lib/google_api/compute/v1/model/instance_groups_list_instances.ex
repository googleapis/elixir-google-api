...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupsListInstances do
  ...
  - kind (String.t): [Output Only] The resource type, which is always compute#instanceGroupsListInstances for the list of instances in the specified instance group. Defaults to: `null`.
