...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupsListInstances do
  ...
  - kind (String.t): [Output Only] The resource type, which is always compute#instanceGroupsListInstances for the list of instances in the specified instance group. Defaults to `compute#instanceGroupsListInstances`.
  ...
  - warning (GoogleApi.Compute.V1.Model.InstanceGroupsListInstancesWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
