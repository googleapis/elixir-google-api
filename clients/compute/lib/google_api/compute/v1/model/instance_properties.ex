...
defmodule GoogleApi.Compute.V1.Model.InstanceProperties do
  ...
  *   `resourcePolicies` (*type:* `list(String.t)`, *default:* `nil`) - Resource policies (names, not ULRs) applied to instances created from these properties. Note that for MachineImage, this is not supported yet.
