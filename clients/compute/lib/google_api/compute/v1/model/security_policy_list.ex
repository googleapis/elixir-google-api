...
defmodule GoogleApi.Compute.V1.Model.SecurityPolicyList do
  ...
  - items ([SecurityPolicy]): A list of SecurityPolicy resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#securityPolicyList for listsof securityPolicies Defaults to: `null`.
