...
defmodule GoogleApi.Compute.V1.Model.SslPoliciesList do
  ...
  - items ([SslPolicy]): A list of SslPolicy resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of the resource. Always compute#sslPoliciesList for lists of sslPolicies. Defaults to: `null`.
