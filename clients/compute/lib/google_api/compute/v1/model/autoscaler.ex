...
defmodule GoogleApi.Compute.V1.Model.Autoscaler do
  ...
  - kind (String.t): [Output Only] Type of the resource. Always compute#autoscaler for autoscalers. Defaults to: `null`.
  ...
  - region (String.t): [Output Only] URL of the region where the instance group resides (for autoscalers living in regional scope). Defaults to: `null`.
  - selfLink (String.t): [Output Only] Server-defined URL for the resource. Defaults to: `null`.
  - status (String.t): [Output Only] The status of the autoscaler configuration. Defaults to: `null`.
    - Enum - one of [ACTIVE, DELETING, ERROR, PENDING]
  - statusDetails ([AutoscalerStatusDetails]): [Output Only] Human-readable details about the current state of the autoscaler. Read the documentation for Commonly returned status messages for examples of status messages you might encounter. Defaults to: `null`.
  - target (String.t): URL of the managed instance group that this autoscaler will scale. Defaults to: `null`.
  - zone (String.t): [Output Only] URL of the zone where the instance group resides (for autoscalers living in zonal scope). Defaults to: `null`.
  """
