...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NetworkInterface do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"accessConfigs", :list, GoogleApi.Compute.V1.Model.AccessConfig, options)
    |> deserialize(:"aliasIpRanges", :list, GoogleApi.Compute.V1.Model.AliasIpRange, options)
  end
end
