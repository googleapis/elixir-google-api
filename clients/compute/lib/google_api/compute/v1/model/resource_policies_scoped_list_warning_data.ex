...
defmodule GoogleApi.Compute.V1.Model.ResourcePoliciesScopedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.ResourcePoliciesScopedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.ResourcePoliciesScopedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.ResourcePoliciesScopedListWarningData do
