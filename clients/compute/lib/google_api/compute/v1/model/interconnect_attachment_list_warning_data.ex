...
defmodule GoogleApi.Compute.V1.Model.InterconnectAttachmentListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InterconnectAttachmentListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InterconnectAttachmentListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InterconnectAttachmentListWarningData do
