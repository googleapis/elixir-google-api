...
defmodule GoogleApi.Compute.V1.Model.InstanceListReferrersWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceListReferrersWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceListReferrersWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InstanceListReferrersWarningData do
