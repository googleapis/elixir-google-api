...
defmodule GoogleApi.Compute.V1.Model.InterconnectAttachmentAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; InterconnectAttachmentsScopedList}): A list of InterconnectAttachmentsScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectAttachmentAggregatedList for aggregated lists of interconnect attachments. Defaults to: `null`.
