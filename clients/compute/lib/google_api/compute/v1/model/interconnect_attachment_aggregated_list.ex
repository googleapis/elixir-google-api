...
defmodule GoogleApi.Compute.V1.Model.InterconnectAttachmentAggregatedList do
  ...
  - items (%{optional(String.t) => GoogleApi.Compute.V1.Model.InterconnectAttachmentsScopedList.t}): A list of InterconnectAttachmentsScopedList resources. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectAttachmentAggregatedList for aggregated lists of interconnect attachments. Defaults to `compute#interconnectAttachmentAggregatedList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.InterconnectAttachmentAggregatedListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
