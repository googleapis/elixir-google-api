...
defmodule GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedListWarning.t`, *default:* `nil`) - Informational warning which replaces the list of backend services when the list is empty.
  ...
  field(:warning, as: GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetHttpsProxiesScopedList do
