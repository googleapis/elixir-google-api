...
defmodule GoogleApi.Compute.V1.Model.NodeGroupList do
  ...
  - items ([NodeGroup]): A list of NodeGroup resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#nodeGroupList for lists of node groups. Defaults to: `null`.
