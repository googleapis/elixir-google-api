...
defmodule GoogleApi.Compute.V1.Model.InstanceConsumptionInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceConsumptionInfo do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceConsumptionInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InstanceConsumptionInfo do
