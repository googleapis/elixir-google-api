...
defmodule GoogleApi.Compute.V1.Model.TargetHttpsProxyList do
  ...
  - items ([TargetHttpsProxy]): A list of TargetHttpsProxy resources. Defaults to: `null`.
  - kind (String.t): Type of resource. Always compute#targetHttpsProxyList for lists of target HTTPS proxies. Defaults to: `null`.
