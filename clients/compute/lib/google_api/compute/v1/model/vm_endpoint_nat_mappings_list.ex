...
defmodule GoogleApi.Compute.V1.Model.VmEndpointNatMappingsList do
  ...
  - kind (String.t): [Output Only] Type of resource. Always compute#vmEndpointNatMappingsList for lists of Nat mappings of VM endpoints. Defaults to `compute#vmEndpointNatMappingsList`.
  ...
  - result (list(GoogleApi.Compute.V1.Model.VmEndpointNatMappings.t)): [Output Only] A list of Nat mapping information of VM endpoints. Defaults to `nil`.
  - selfLink (String.t): [Output Only] Server-defined URL for this resource. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.VmEndpointNatMappingsListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
