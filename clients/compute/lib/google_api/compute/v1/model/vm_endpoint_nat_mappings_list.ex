...
defmodule GoogleApi.Compute.V1.Model.VmEndpointNatMappingsList do
  ...
  *   `kind` (*type:* `String.t`, *default:* `compute#vmEndpointNatMappingsList`) - [Output Only] Type of resource. Always compute#vmEndpointNatMappingsList for lists of Nat mappings of VM endpoints.
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
  *   `result` (*type:* `list(GoogleApi.Compute.V1.Model.VmEndpointNatMappings.t)`, *default:* `nil`) - [Output Only] A list of Nat mapping information of VM endpoints.
  *   `selfLink` (*type:* `String.t`, *default:* `nil`) - [Output Only] Server-defined URL for this resource.
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.VmEndpointNatMappingsListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  """
  ...
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.VmEndpointNatMappingsListWarning)
end
