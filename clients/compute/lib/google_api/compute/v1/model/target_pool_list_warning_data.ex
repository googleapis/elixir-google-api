...
defmodule GoogleApi.Compute.V1.Model.TargetPoolListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetPoolListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetPoolListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetPoolListWarningData do
