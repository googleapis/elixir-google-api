...
defmodule GoogleApi.Compute.V1.Model.AcceleratorTypesScopedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.AcceleratorTypesScopedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.AcceleratorTypesScopedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.AcceleratorTypesScopedListWarningData do
