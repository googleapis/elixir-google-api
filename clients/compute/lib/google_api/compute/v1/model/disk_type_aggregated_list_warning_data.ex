...
defmodule GoogleApi.Compute.V1.Model.DiskTypeAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.DiskTypeAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.DiskTypeAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.DiskTypeAggregatedListWarningData do
