...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagerAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.InstanceGroupManagerAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupManagerAggregatedListWarningData.decode(
      value,
      options
    )
  end
