...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicyList do
  ...
  - items ([ResourcePolicy]): [Output Only] A list of ResourcePolicy resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource.Always compute#resourcePoliciesList for listsof resourcePolicies Defaults to: `null`.
