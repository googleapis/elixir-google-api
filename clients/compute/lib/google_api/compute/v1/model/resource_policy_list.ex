...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicyList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.ResourcePolicy.t)): [Output Only] A list of ResourcePolicy resources. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource.Always compute#resourcePoliciesList for listsof resourcePolicies Defaults to `compute#resourcePolicyList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.ResourcePolicyListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
