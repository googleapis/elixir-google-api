...
defmodule GoogleApi.Compute.V1.Model.HealthCheckServicesList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.HealthCheckServicesListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items => list(GoogleApi.Compute.V1.Model.HealthCheckService.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :warning => GoogleApi.Compute.V1.Model.HealthCheckServicesListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.HealthCheckService, type: :list)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.HealthCheckServicesListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.HealthCheckServicesList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.HealthCheckServicesList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.HealthCheckServicesList do
