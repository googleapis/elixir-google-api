...
defmodule GoogleApi.Compute.V1.Model.DiskList do
  ...
  - items ([Disk]): A list of Disk resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#diskList for lists of disks. Defaults to: `null`.
