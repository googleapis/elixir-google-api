...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointGroupsListEndpointsRequest do
  ...
  - healthStatus (String.t): Optional query parameter for showing the health status of each network endpoint. Valid options are SKIP or SHOW. If you don&#39;t specifiy this parameter, the health status of network endpoints will not be provided. Defaults to: `null`.
    - Enum - one of [SHOW, SKIP]
  """
