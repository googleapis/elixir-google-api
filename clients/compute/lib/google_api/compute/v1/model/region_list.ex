...
defmodule GoogleApi.Compute.V1.Model.RegionList do
  ...
  - items ([Region]): A list of Region resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#regionList for lists of regions. Defaults to: `null`.
