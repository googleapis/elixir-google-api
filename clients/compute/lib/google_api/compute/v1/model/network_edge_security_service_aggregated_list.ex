...
defmodule GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          ...
          :items =>
            %{
              optional(String.t()) =>
                GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServicesScopedList.t()
            }
            | nil,
          :kind => String.t() | nil,
          ...
          :warning =>
            GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedListWarning.t() | nil
        }

  field(:etag)
  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServicesScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:unreachables, type: :list)
  field(:warning, as: GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList do
