...
defmodule GoogleApi.Compute.V1.Model.LogConfigCloudAuditOptions do
  ...
  - authorizationLoggingOptions (GoogleApi.Compute.V1.Model.AuthorizationLoggingOptions.t): Information used by the Cloud Audit Logging pipeline. Defaults to `nil`.
