...
defmodule GoogleApi.Compute.V1.Model.GlobalOrganizationSetPolicyRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.GlobalOrganizationSetPolicyRequest do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.GlobalOrganizationSetPolicyRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.GlobalOrganizationSetPolicyRequest do
