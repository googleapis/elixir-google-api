...
defmodule GoogleApi.Compute.V1.Model.PathMatcher do
  ...
  - defaultService (String.t): The full or partial URL to the BackendService resource. This will be used if none of the pathRules or routeRules defined by this PathMatcher are matched. For example, the following are all valid URLs to a BackendService resource:  
  ...
  - compute.backendServices.use Defaults to `nil`.
  ...
  - name (String.t): The name to which this PathMatcher is referred by the HostRule. Defaults to `nil`.
  - pathRules (list(GoogleApi.Compute.V1.Model.PathRule.t)): The list of path rules. Use this list instead of routeRules when routing based on simple path matching is all that's required. The order by which path rules are specified does not matter. Matches are always done on the longest-path-first basis.
  ...
  Only one of pathRules or routeRules must be set. Defaults to `nil`.
  """
