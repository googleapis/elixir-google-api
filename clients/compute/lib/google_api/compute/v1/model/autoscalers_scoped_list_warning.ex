...
defmodule GoogleApi.Compute.V1.Model.AutoscalersScopedListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.AutoscalersScopedListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example:
