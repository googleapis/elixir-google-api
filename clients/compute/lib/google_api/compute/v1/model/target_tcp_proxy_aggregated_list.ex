...
defmodule GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList do
  @moduledoc """
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  ...
  @type t :: %__MODULE__{
          :id => String.t() | nil,
          :items =>
            %{optional(String.t()) => GoogleApi.Compute.V1.Model.TargetTcpProxiesScopedList.t()}
            | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil,
          :selfLink => String.t() | nil,
          :unreachables => list(String.t()) | nil,
          :warning => GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedListWarning.t() | nil
        }

  field(:id)
  field(:items, as: GoogleApi.Compute.V1.Model.TargetTcpProxiesScopedList, type: :map)
  field(:kind)
  field(:nextPageToken)
  field(:selfLink)
  field(:unreachables, type: :list)
  field(:warning, as: GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedListWarning)
end

defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList do
