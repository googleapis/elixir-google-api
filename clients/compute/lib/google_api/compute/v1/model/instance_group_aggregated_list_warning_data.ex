...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.InstanceGroupAggregatedListWarningData do
