...
defmodule GoogleApi.Compute.V1.Model.RouterBgp do
  ...
  - asn (integer()): Local BGP Autonomous System Number (ASN). Must be an RFC6996 private ASN, either 16-bit or 32-bit. The value will be fixed for this router resource. All VPN tunnels that link to this router will have the same local ASN. Defaults to: `null`.
  """
