...
defmodule GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example:
