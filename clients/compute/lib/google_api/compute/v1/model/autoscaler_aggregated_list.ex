...
defmodule GoogleApi.Compute.V1.Model.AutoscalerAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; AutoscalersScopedList}): A list of AutoscalersScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#autoscalerAggregatedList for aggregated lists of autoscalers. Defaults to: `null`.
