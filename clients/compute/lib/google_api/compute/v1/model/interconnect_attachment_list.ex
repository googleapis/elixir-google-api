...
defmodule GoogleApi.Compute.V1.Model.InterconnectAttachmentList do
  ...
  - items ([InterconnectAttachment]): A list of InterconnectAttachment resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectAttachmentList for lists of interconnect attachments. Defaults to: `null`.
