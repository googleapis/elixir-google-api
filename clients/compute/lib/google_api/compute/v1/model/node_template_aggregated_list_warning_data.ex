...
defmodule GoogleApi.Compute.V1.Model.NodeTemplateAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.NodeTemplateAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.NodeTemplateAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.NodeTemplateAggregatedListWarningData do
