...
defmodule GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedList do
  ...
  - targetVpnGateways (list(GoogleApi.Compute.V1.Model.TargetVpnGateway.t)): [Output Only] A list of target VPN gateways contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarning.t): [Output Only] Informational warning which replaces the list of addresses when the list is empty. Defaults to `nil`.
  """
  ...
  field(:warning, as: GoogleApi.Compute.V1.Model.TargetVpnGatewaysScopedListWarning)
end
