...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails.decode(
      value,
      options
    )
  end
