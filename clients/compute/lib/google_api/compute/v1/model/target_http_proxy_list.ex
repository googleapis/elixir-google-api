...
defmodule GoogleApi.Compute.V1.Model.TargetHttpProxyList do
  ...
  - items ([TargetHttpProxy]): A list of TargetHttpProxy resources. Defaults to: `null`.
  - kind (String.t): Type of resource. Always compute#targetHttpProxyList for lists of target HTTP proxies. Defaults to: `null`.
