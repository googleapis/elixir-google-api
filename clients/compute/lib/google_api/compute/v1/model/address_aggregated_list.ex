...
defmodule GoogleApi.Compute.V1.Model.AddressAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; AddressesScopedList}): A list of AddressesScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#addressAggregatedList for aggregated lists of addresses. Defaults to: `null`.
