...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.DiskTypesScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"diskTypes", :list, GoogleApi.Compute.V1.Model.DiskType, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.DiskTypesScopedList_warning, options)
  end
end
