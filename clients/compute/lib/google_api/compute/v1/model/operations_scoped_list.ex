...
defmodule GoogleApi.Compute.V1.Model.OperationsScopedList do
  ...
  - operations (list(GoogleApi.Compute.V1.Model.Operation.t)): [Output Only] A list of operations contained in this scope. Defaults to `nil`.
  - warning (GoogleApi.Compute.V1.Model.OperationsScopedListWarning.t): [Output Only] Informational warning which replaces the list of operations when the list is empty. Defaults to `nil`.
  """
