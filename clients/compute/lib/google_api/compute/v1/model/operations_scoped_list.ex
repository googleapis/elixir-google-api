...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.OperationsScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"operations", :list, GoogleApi.Compute.V1.Model.Operation, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.OperationsScopedList_warning, options)
  end
end
