...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrors do
  @moduledoc """
  ...
  *   `message` (*type:* `String.t`, *default:* `nil`) - [Output Only] An optional, human-readable error message.
  ...
  @type t :: %__MODULE__{
          ...
          :errorDetails =>
            list(
              GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails.t()
            )
            | nil,
  ...
  field(:errorDetails,
    as:
      GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrors do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrors.decode(
      value,
      options
    )
  end
