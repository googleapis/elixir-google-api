...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.RegionInstanceGroupManagerListWarningData do
