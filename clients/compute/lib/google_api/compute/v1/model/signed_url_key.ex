...
defmodule GoogleApi.Compute.V1.Model.SignedUrlKey do
  ...
  - keyValue (String.t): 128-bit key value used for signing the URL. The key value must be a valid RFC 4648 Section 5 base64url encoded string. Defaults to `nil`.
  """
