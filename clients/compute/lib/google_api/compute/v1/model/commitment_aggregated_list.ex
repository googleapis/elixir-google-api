...
defmodule GoogleApi.Compute.V1.Model.CommitmentAggregatedList do
  ...
  - items (%{optional(String.t) &#x3D;&gt; CommitmentsScopedList}): A list of CommitmentsScopedList resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#commitmentAggregatedList for aggregated lists of commitments. Defaults to: `null`.
