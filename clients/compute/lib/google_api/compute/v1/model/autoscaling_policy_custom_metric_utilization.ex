...
defmodule GoogleApi.Compute.V1.Model.AutoscalingPolicyCustomMetricUtilization do
  ...
  - utilizationTargetType (String.t): Defines how target utilization value is expressed for a Stackdriver Monitoring metric. Either GAUGE, DELTA_PER_SECOND, or DELTA_PER_MINUTE. If not specified, the default is GAUGE. Defaults to: `null`.
