...
defmodule GoogleApi.Compute.V1.Model.InstanceListReferrers do
  ...
  - items ([Reference]): A list of Reference resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#instanceListReferrers for lists of Instance referrers. Defaults to: `null`.
