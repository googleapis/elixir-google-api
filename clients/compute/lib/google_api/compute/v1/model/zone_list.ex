...
defmodule GoogleApi.Compute.V1.Model.ZoneList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Zone.t)): A list of Zone resources. Defaults to `nil`.
  - kind (String.t): Type of resource. Defaults to `compute#zoneList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.ZoneListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          :id => String.t(),
          :items => list(GoogleApi.Compute.V1.Model.Zone.t()),
          :kind => String.t(),
          :nextPageToken => String.t(),
          :selfLink => String.t(),
          :warning => GoogleApi.Compute.V1.Model.ZoneListWarning.t()
        }
