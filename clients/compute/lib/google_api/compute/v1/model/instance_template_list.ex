...
defmodule GoogleApi.Compute.V1.Model.InstanceTemplateList do
  ...
  - items ([InstanceTemplate]): A list of InstanceTemplate resources. Defaults to: `null`.
  - kind (String.t): [Output Only] The resource type, which is always compute#instanceTemplatesListResponse for instance template lists. Defaults to: `null`.
