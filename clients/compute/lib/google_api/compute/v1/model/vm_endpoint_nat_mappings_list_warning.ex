...
defmodule GoogleApi.Compute.V1.Model.VmEndpointNatMappingsListWarning do
  ...
  *   `data` (*type:* `list(GoogleApi.Compute.V1.Model.VmEndpointNatMappingsListWarningData.t)`, *default:* `nil`) - [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" } 
