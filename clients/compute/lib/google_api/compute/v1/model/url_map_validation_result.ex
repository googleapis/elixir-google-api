...
defmodule GoogleApi.Compute.V1.Model.UrlMapValidationResult do
  ...
  - loadErrors (list(String.t)):  Defaults to `nil`.
  - loadSucceeded (boolean()): Whether the given UrlMap can be successfully loaded. If false, 'loadErrors' indicates the reasons. Defaults to `nil`.
  - testFailures (list(GoogleApi.Compute.V1.Model.TestFailure.t)):  Defaults to `nil`.
  - testPassed (boolean()): If successfully loaded, this field indicates whether the test passed. If false, 'testFailures's indicate the reason of failure. Defaults to `nil`.
  """
