...
defmodule GoogleApi.Compute.V1.Model.SslCertificateListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.SslCertificateListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.SslCertificateListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.SslCertificateListWarningData do
