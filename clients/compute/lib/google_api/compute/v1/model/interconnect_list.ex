...
defmodule GoogleApi.Compute.V1.Model.InterconnectList do
  ...
  - items ([Interconnect]): A list of Interconnect resources. Defaults to: `null`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectList for lists of interconnects. Defaults to: `null`.
