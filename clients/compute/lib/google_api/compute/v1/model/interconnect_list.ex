...
defmodule GoogleApi.Compute.V1.Model.InterconnectList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Interconnect.t)): A list of Interconnect resources. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#interconnectList for lists of interconnects. Defaults to `compute#interconnectList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.InterconnectListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
