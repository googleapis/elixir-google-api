...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagerStatusAllInstancesConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.InstanceGroupManagerStatusAllInstancesConfig do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupManagerStatusAllInstancesConfig.decode(value, options)
  end
end
