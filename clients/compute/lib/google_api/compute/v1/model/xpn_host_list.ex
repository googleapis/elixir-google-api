...
defmodule GoogleApi.Compute.V1.Model.XpnHostList do
  ...
  - items (list(GoogleApi.Compute.V1.Model.Project.t)): [Output Only] A list of shared VPC host project URLs. Defaults to `nil`.
  - kind (String.t): [Output Only] Type of resource. Always compute#xpnHostList for lists of shared VPC hosts. Defaults to `compute#xpnHostList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.XpnHostListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :selfLink => String.t(),
          :warning => GoogleApi.Compute.V1.Model.XpnHostListWarning.t()
        }
  ...
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.XpnHostListWarning)
end
