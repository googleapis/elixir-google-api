...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupList do
  ...
  *   `kind` (*type:* `String.t`, *default:* `compute#regionInstanceGroupList`) - The resource type.
  ...
  *   `warning` (*type:* `GoogleApi.Compute.V1.Model.RegionInstanceGroupListWarning.t`, *default:* `nil`) - [Output Only] Informational warning message.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :warning => GoogleApi.Compute.V1.Model.RegionInstanceGroupListWarning.t() | nil
        }
  ...
  field(:nextPageToken)
  field(:selfLink)
  field(:warning, as: GoogleApi.Compute.V1.Model.RegionInstanceGroupListWarning)
end
