...
defmodule GoogleApi.Compute.V1.Model.RegionInstanceGroupList do
  ...
  - kind (String.t): The resource type. Defaults to `compute#regionInstanceGroupList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.RegionInstanceGroupListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
