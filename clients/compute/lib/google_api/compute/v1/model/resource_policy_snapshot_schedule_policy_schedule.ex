...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicySchedule do
  ...
  *   `dailySchedule` (*type:* `GoogleApi.Compute.V1.Model.ResourcePolicyDailyCycle.t`, *default:* `nil`) - 
  *   `hourlySchedule` (*type:* `GoogleApi.Compute.V1.Model.ResourcePolicyHourlyCycle.t`, *default:* `nil`) - 
  *   `weeklySchedule` (*type:* `GoogleApi.Compute.V1.Model.ResourcePolicyWeeklyCycle.t`, *default:* `nil`) - 
  """
