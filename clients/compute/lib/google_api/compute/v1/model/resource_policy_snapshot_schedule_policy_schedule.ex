...
defmodule GoogleApi.Compute.V1.Model.ResourcePolicySnapshotSchedulePolicySchedule do
  ...
  - dailySchedule (ResourcePolicyDailyCycle):  Defaults to: `null`.
  - hourlySchedule (ResourcePolicyHourlyCycle):  Defaults to: `null`.
  - weeklySchedule (ResourcePolicyWeeklyCycle):  Defaults to: `null`.
  """
