...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointGroupsScopedList do
  ...
  - networkEndpointGroups ([NetworkEndpointGroup]): [Output Only] The list of network endpoint groups that are contained in this scope. Defaults to: `null`.
  - warning (NetworkEndpointGroupsScopedListWarning):  Defaults to: `null`.
  """
