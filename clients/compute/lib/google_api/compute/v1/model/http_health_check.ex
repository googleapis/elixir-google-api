...
defmodule GoogleApi.Compute.V1.Model.HttpHealthCheck do
  ...
  - host (String.t): The value of the host header in the HTTP health check request. If left empty (default value), the public IP on behalf of which this health check is performed will be used. Defaults to: `null`.
  ...
  - kind (String.t): [Output Only] Type of the resource. Always compute#httpHealthCheck for HTTP health checks. Defaults to: `null`.
  ...
  - port (integer()): The TCP port number for the HTTP health check request. The default value is 80. Defaults to: `null`.
  - requestPath (String.t): The request path of the HTTP health check request. The default value is /. Defaults to: `null`.
