...
defmodule GoogleApi.Compute.V1.Model.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse do
  @moduledoc """
  ...
  *   `firewalls` (*type:* `list(GoogleApi.Compute.V1.Model.Firewall.t)`, *default:* `nil`) - Effective firewalls on the network.
  ...
  field(:firewallPolicys,
    as:
      GoogleApi.Compute.V1.Model.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponseEffectiveFirewallPolicy,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse.decode(
      value,
      options
    )
  end
