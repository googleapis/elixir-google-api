...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.InstanceGroupsScopedList do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"instanceGroups", :list, GoogleApi.Compute.V1.Model.InstanceGroup, options)
    |> deserialize(:"warning", :struct, GoogleApi.Compute.V1.Model.InstanceGroupsScopedList_warning, options)
  end
end
