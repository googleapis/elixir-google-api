...
defmodule GoogleApi.Compute.V1.Model.NodeGroupsListNodes do
  ...
  - items ([NodeGroupNode]): A list of Node resources. Defaults to: `null`.
  - kind (String.t): [Output Only] The resource type, which is always compute.nodeGroupsListNodes for the list of nodes in the specified node group. Defaults to: `null`.
