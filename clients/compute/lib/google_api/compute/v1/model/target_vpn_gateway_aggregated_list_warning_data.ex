...
defmodule GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedListWarningData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedListWarningData do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedListWarningData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedListWarningData do
