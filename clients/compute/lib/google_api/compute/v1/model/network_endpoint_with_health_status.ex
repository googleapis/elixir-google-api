...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointWithHealthStatus do
  ...
  - healths (list(GoogleApi.Compute.V1.Model.HealthStatusForNetworkEndpoint.t)): [Output only] The health status of network endpoint; Defaults to `nil`.
  - networkEndpoint (GoogleApi.Compute.V1.Model.NetworkEndpoint.t): [Output only] The network endpoint; Defaults to `nil`.
  """
