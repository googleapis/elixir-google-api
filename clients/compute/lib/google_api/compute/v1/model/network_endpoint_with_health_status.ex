...
defmodule GoogleApi.Compute.V1.Model.NetworkEndpointWithHealthStatus do
  ...
  - healths ([HealthStatusForNetworkEndpoint]): [Output only] The health status of network endpoint; Defaults to: `null`.
  - networkEndpoint (NetworkEndpoint): [Output only] The network endpoint; Defaults to: `null`.
  """
