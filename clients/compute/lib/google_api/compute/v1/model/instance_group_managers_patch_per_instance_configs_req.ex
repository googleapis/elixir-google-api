...
defmodule GoogleApi.Compute.V1.Model.InstanceGroupManagersPatchPerInstanceConfigsReq do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Compute.V1.Model.InstanceGroupManagersPatchPerInstanceConfigsReq do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.InstanceGroupManagersPatchPerInstanceConfigsReq.decode(
      value,
      options
    )
  end
