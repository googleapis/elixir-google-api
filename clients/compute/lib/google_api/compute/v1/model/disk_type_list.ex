...
defmodule GoogleApi.Compute.V1.Model.DiskTypeList do
  ...
  - kind (String.t): [Output Only] Type of resource. Always compute#diskTypeList for disk types. Defaults to `compute#diskTypeList`.
  ...
  - warning (GoogleApi.Compute.V1.Model.DiskTypeListWarning.t): [Output Only] Informational warning message. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :selfLink => String.t(),
          :warning => GoogleApi.Compute.V1.Model.DiskTypeListWarning.t()
        }
