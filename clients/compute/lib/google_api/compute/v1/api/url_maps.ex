...
defmodule GoogleApi.Compute.V1.Api.UrlMaps do
  ...
  @doc """
  Retrieves the list of all UrlMap resources, regional and global, available to the specified project. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.UrlMapsAggregatedList{}}` on success
  *   `{:error, info}` on failure
  ...
  def compute_url_maps_aggregated_list(connection, project, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.UrlMapsAggregatedList{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  @doc """
  Initiates a cache invalidation operation, invalidating the specified path, scoped to the specified UrlMap. (== suppress_warning http-rest-shadowed ==)

  ## Parameters

  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `url_map` (*type:* `String.t`) - Name of the UrlMap scoping this request.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
      ...
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
          ...
          The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.CacheInvalidationRule.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_url_maps_invalidate_cache(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  @doc """
  Retrieves the list of UrlMap resources available to the specified project. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  ...
  @doc """
  Patches the specified UrlMap resource with the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.UrlMapsValidateRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_url_maps_validate(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
