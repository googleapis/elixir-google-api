...
defmodule GoogleApi.Compute.V1.Api.PublicAdvertisedPrefixes do
  @moduledoc """
  ...
  *   `public_advertised_prefix` (*type:* `String.t`) - The name of the public advertised prefix. It should comply with RFC1035.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_announce(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_public_advertised_prefixes_announce(
        connection,
        project,
      ...
      |> Request.url(
        ...
        %{
          ...
          "publicAdvertisedPrefix" =>
            URI.encode(public_advertised_prefix, &URI.char_unreserved?/1)
        }
      )
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `public_advertised_prefix` (*type:* `String.t`) - Name of the PublicAdvertisedPrefix resource to delete.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
    ...
    request =
      ...
      |> Request.url(
        ...
        %{
          "project" => URI.encode(project, &URI.char_unreserved?/1),
          "publicAdvertisedPrefix" =>
            URI.encode(public_advertised_prefix, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `public_advertised_prefix` (*type:* `String.t`) - Name of the PublicAdvertisedPrefix resource to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.PublicAdvertisedPrefix{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.PublicAdvertisedPrefix.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_public_advertised_prefixes_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.PublicAdvertisedPrefix{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.PublicAdvertisedPrefix.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_insert(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.PublicAdvertisedPrefixList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.PublicAdvertisedPrefixList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_public_advertised_prefixes_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.PublicAdvertisedPrefixList{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `public_advertised_prefix` (*type:* `String.t`) - Name of the PublicAdvertisedPrefix resource to patch.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_advertised_prefixes_withdraw(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_public_advertised_prefixes_withdraw(
        connection,
        project,
        public_advertised_prefix,
        optional_params \\ [],
