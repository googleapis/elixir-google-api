...
defmodule GoogleApi.Compute.V1.Api.ExternalVpnGateways do
  @moduledoc """
  ...
  *   `external_vpn_gateway` (*type:* `String.t`) - Name of the externalVpnGateways to delete.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_external_vpn_gateways_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `external_vpn_gateway` (*type:* `String.t`) - Name of the externalVpnGateway to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.ExternalVpnGateway{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_external_vpn_gateways_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.Compute.V1.Model.ExternalVpnGateway.t()} | {:error, Tesla.Env.t()}
  def compute_external_vpn_gateways_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.ExternalVpnGateway{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
          ...
          The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.ExternalVpnGateway.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.ExternalVpnGatewayList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_external_vpn_gateways_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.ExternalVpnGatewayList.t()} | {:error, Tesla.Env.t()}
  def compute_external_vpn_gateways_list(connection, project, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.ExternalVpnGatewayList{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_external_vpn_gateways_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_external_vpn_gateways_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
