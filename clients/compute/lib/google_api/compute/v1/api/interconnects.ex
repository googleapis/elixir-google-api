...
defmodule GoogleApi.Compute.V1.Api.Interconnects do
  ...
  *   `{:error, info}` on failure
  ...
  def compute_interconnects_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/global/interconnects/{interconnect}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "interconnect" => URI.encode(interconnect, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
  ...
  *   `{:error, info}` on failure
  ...
  def compute_interconnects_get_diagnostics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/interconnects/{interconnect}/getDiagnostics", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InterconnectsGetMacsecConfigResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_interconnects_get_macsec_config(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.InterconnectsGetMacsecConfigResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_interconnects_get_macsec_config(
        connection,
        project,
        interconnect,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/interconnects/{interconnect}/getMacsecConfig", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "interconnect" => URI.encode(interconnect, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.InterconnectsGetMacsecConfigResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def compute_interconnects_insert(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/interconnects", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_interconnects_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_interconnects_set_labels(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/interconnects/{resource}/setLabels", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
