...
defmodule GoogleApi.Compute.V1.Api.ImageFamilyViews do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.ImageFamilyView{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_image_family_views_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.ImageFamilyView.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_image_family_views_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/zones/{zone}/imageFamilyViews/{family}", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.ImageFamilyView{}])
  end
end
