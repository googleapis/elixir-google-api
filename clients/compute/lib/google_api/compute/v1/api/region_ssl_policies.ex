...
defmodule GoogleApi.Compute.V1.Api.RegionSslPolicies do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_region_ssl_policies_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/regions/{region}/sslPolicies/{sslPolicy}", %{
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_region_ssl_policies_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/sslPolicies", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_list_available_features(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_region_ssl_policies_list_available_features(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/regions/{region}/sslPolicies/listAvailableFeatures", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_ssl_policies_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
