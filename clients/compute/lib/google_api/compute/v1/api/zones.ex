...
defmodule GoogleApi.Compute.V1.Api.Zones do
  ...
  """
  @spec compute_zones_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Zone.t} | {:error, Tesla.Env.t}
  def compute_zones_get(connection, project, zone, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/zones/#{zone}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Zone{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_zones_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ZoneList.t} | {:error, Tesla.Env.t}
  def compute_zones_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.ZoneList{})
  end
end
