...
defmodule GoogleApi.Compute.V1.Api.RegionInstanceTemplates do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instance_templates_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instance_templates_delete(
        connection,
        project,
        region,
        instance_template,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instance_templates_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instance_templates_get(
        connection,
        project,
        region,
        instance_template,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instance_templates_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instance_templates_insert(
        connection,
        project,
        region,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/instanceTemplates", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - The name of the regions for this request.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instance_templates_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instance_templates_list(
        connection,
        project,
        region,
        optional_params \\ [],
