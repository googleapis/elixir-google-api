...
defmodule GoogleApi.Compute.V1.Api.TargetSslProxies do
  ...
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource to delete.
  ...
  """
  @spec compute_target_ssl_proxies_delete(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_target_ssl_proxies_delete(connection, project, target_ssl_proxy, opts \\ []) do
    ...
    request =
      ...
      |> Request.url("/{project}/global/targetSslProxies/{targetSslProxy}", %{
        ...
        "targetSslProxy" => URI.encode_www_form(target_ssl_proxy)
      })
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_target_ssl_proxies_get(connection, project, target_ssl_proxy, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.TargetSslProxy{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_insert(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def compute_target_ssl_proxies_list(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.TargetSslProxyList{})
  end
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource whose BackendService resource is to be set.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource whose ProxyHeader is to be set.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource whose SslCertificate resource is to be set.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - target_ssl_proxy (String.t): Name of the TargetSslProxy resource whose SSL policy is to be set. The name must be 1-63 characters long, and comply with RFC1035.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  def compute_target_ssl_proxies_set_ssl_policy(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
