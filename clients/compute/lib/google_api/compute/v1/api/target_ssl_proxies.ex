...
defmodule GoogleApi.Compute.V1.Api.TargetSslProxies do
  ...
  """
  @spec compute_target_ssl_proxies_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_delete(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/targetSslProxies/#{target_ssl_proxy}")
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetSslProxy.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_get(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetSslProxy{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_insert(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetSslProxies")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetSslProxyList.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetSslProxyList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_set_backend_service(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_set_backend_service(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetSslProxies/#{target_ssl_proxy}/setBackendService")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_set_proxy_header(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_set_proxy_header(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetSslProxies/#{target_ssl_proxy}/setProxyHeader")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_ssl_proxies_set_ssl_certificates(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_ssl_proxies_set_ssl_certificates(connection, project, target_ssl_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetSslProxies/#{target_ssl_proxy}/setSslCertificates")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
