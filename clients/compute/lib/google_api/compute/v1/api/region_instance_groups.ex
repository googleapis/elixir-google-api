...
defmodule GoogleApi.Compute.V1.Api.RegionInstanceGroups do
  ...
  *   `instance_group` (*type:* `String.t`) - Name of the instance group resource to return.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instance_groups_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request.
  *   `instance_group` (*type:* `String.t`) - Name of the regional instance group for which we want to list the instances.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request.
  *   `instance_group` (*type:* `String.t`) - The name of the regional instance group where the named ports are updated.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
      ...
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.RegionInstanceGroupsSetNamedPortsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
