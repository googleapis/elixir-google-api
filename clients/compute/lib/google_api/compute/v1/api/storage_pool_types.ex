...
defmodule GoogleApi.Compute.V1.Api.StoragePoolTypes do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.StoragePoolTypeAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_storage_pool_types_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.StoragePoolTypeAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_storage_pool_types_aggregated_list(
        connection,
        project,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/storagePoolTypes", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.StoragePoolTypeAggregatedList{}]
    )
  end
  ...
  *   `storage_pool_type` (*type:* `String.t`) - Name of the storage pool type to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.StoragePoolType{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_storage_pool_types_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.StoragePoolType.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_storage_pool_types_get(
        connection,
        project,
        zone,
        storage_pool_type,
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/zones/{zone}/storagePoolTypes/{storagePoolType}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "zone" => URI.encode(zone, &URI.char_unreserved?/1),
        "storagePoolType" =>
          URI.encode(storage_pool_type, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.StoragePoolType{}])
  end
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.StoragePoolTypeList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_storage_pool_types_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.StoragePoolTypeList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_storage_pool_types_list(
        connection,
        project,
        zone,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/zones/{zone}/storagePoolTypes", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "zone" => URI.encode(zone, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.StoragePoolTypeList{}])
  end
end
