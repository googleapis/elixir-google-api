...
defmodule GoogleApi.Compute.V1.Api.RegionAutoscalers do
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_autoscalers_update(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
