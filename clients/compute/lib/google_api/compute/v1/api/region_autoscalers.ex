...
defmodule GoogleApi.Compute.V1.Api.RegionAutoscalers do
  @moduledoc """
  ...
  """
  @spec compute_region_autoscalers_delete(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_region_autoscalers_delete(connection, project, region, autoscaler, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/regions/#{region}/autoscalers/#{autoscaler}")
  ...
  {:error, info} on failure
  """
  @spec compute_region_autoscalers_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Autoscaler.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_region_autoscalers_insert(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_region_autoscalers_insert(connection, project, region, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/regions/#{region}/autoscalers")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:ok, %GoogleApi.Compute.V1.Model.RegionAutoscalerList{}} on success
  {:error, info} on failure
  """
  @spec compute_region_autoscalers_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.RegionAutoscalerList.t} | {:error, Tesla.Env.t}
  def compute_region_autoscalers_list(connection, project, region, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.RegionAutoscalerList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_region_autoscalers_patch(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_region_autoscalers_update(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
