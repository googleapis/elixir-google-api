...
defmodule GoogleApi.Compute.V1.Api.PublicDelegatedPrefixes do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_public_delegated_prefixes_aggregated_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/publicDelegatedPrefixes", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.PublicDelegatedPrefixAggregatedList{}]
    )
  end
  ...
  *   `region` (*type:* `String.t`) - The name of the region where the public delegated prefix is located. It should comply with RFC1035.
  *   `public_delegated_prefix` (*type:* `String.t`) - The name of the public delegated prefix. It should comply with RFC1035.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_announce(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_public_delegated_prefixes_announce(
        connection,
        project,
        region,
    ...
    request =
      ...
      |> Request.url(
        ...
        %{
          ...
          "publicDelegatedPrefix" => URI.encode(public_delegated_prefix, &URI.char_unreserved?/1)
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region of this request.
  *   `public_delegated_prefix` (*type:* `String.t`) - Name of the PublicDelegatedPrefix resource to delete.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
      ...
      |> Request.url(
        ...
        %{
          ...
          "publicDelegatedPrefix" =>
            URI.encode(public_delegated_prefix, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region of this request.
  *   `public_delegated_prefix` (*type:* `String.t`) - Name of the PublicDelegatedPrefix resource to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.PublicDelegatedPrefix{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.PublicDelegatedPrefix.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_public_delegated_prefixes_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.PublicDelegatedPrefix{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.PublicDelegatedPrefix.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_public_delegated_prefixes_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/publicDelegatedPrefixes", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_public_delegated_prefixes_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.PublicDelegatedPrefixList{}])
  end
  ...
  *   `public_delegated_prefix` (*type:* `String.t`) - Name of the PublicDelegatedPrefix resource to patch.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_public_delegated_prefixes_withdraw(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_public_delegated_prefixes_withdraw(
        connection,
        project,
        region,
        public_delegated_prefix,
