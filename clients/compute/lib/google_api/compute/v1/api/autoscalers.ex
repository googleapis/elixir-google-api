...
defmodule GoogleApi.Compute.V1.Api.Autoscalers do
  ...
  """
  @spec compute_autoscalers_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.AutoscalerAggregatedList.t()} | {:error, Tesla.Env.t()}
  def compute_autoscalers_aggregated_list(connection, project, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.AutoscalerAggregatedList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_get(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_insert(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.AutoscalerList.t()} | {:error, Tesla.Env.t()}
  def compute_autoscalers_list(connection, project, zone, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.AutoscalerList{})
  end
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :autoscaler (String.t): Name of the autoscaler to patch.
    - :requestId (String.t): An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.  For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (Autoscaler): 
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_patch(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :autoscaler (String.t): Name of the autoscaler to update.
    - :requestId (String.t): An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.  For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (Autoscaler): 
  ...
  {:error, info} on failure
  """
  @spec compute_autoscalers_update(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
