...
defmodule GoogleApi.Compute.V1.Api.Regions do
  ...
  """
  @spec compute_regions_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Region.t} | {:error, Tesla.Env.t}
  def compute_regions_get(connection, project, region, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/regions/#{region}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Region{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_regions_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.RegionList.t} | {:error, Tesla.Env.t}
  def compute_regions_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.RegionList{})
  end
end
