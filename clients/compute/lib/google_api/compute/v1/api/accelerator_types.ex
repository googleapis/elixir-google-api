...
defmodule GoogleApi.Compute.V1.Api.AcceleratorTypes do
  @moduledoc """
  ...
  {:ok, %GoogleApi.Compute.V1.Model.AcceleratorTypeAggregatedList{}} on success
  {:error, info} on failure
  """
  @spec compute_accelerator_types_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AcceleratorTypeAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_accelerator_types_aggregated_list(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/acceleratorTypes")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.AcceleratorTypeAggregatedList{})
  end
  ...
  - accelerator_type (String): Name of the accelerator type to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:ok, %GoogleApi.Compute.V1.Model.AcceleratorType{}} on success
  {:error, info} on failure
  """
  @spec compute_accelerator_types_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AcceleratorType.t} | {:error, Tesla.Env.t}
  def compute_accelerator_types_get(connection, project, zone, accelerator_type, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/zones/#{zone}/acceleratorTypes/#{accelerator_type}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.AcceleratorType{})
  end
  ...
  {:ok, %GoogleApi.Compute.V1.Model.AcceleratorTypeList{}} on success
  {:error, info} on failure
  """
  @spec compute_accelerator_types_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AcceleratorTypeList.t} | {:error, Tesla.Env.t}
  def compute_accelerator_types_list(connection, project, zone, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/zones/#{zone}/acceleratorTypes")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.AcceleratorTypeList{})
  end
end
