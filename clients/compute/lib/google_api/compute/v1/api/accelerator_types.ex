...
defmodule GoogleApi.Compute.V1.Api.AcceleratorTypes do
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_accelerator_types_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `accelerator_type` (*type:* `String.t`) - Name of the accelerator type to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_accelerator_types_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_accelerator_types_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
