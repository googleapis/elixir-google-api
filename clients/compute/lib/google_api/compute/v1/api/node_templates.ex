...
defmodule GoogleApi.Compute.V1.Api.NodeTemplates do
  ...
  """
  @spec compute_node_templates_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - node_template (String.t): Name of the NodeTemplate resource to delete.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): The name of the region for this request.
  - node_template (String.t): Name of the node template to return.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NodeTemplate.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_node_templates_insert(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_node_templates_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
