...
defmodule GoogleApi.Compute.V1.Api.Addresses do
  ...
  """
  @spec compute_addresses_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AddressAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_addresses_aggregated_list(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/addresses")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.AddressAggregatedList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_addresses_delete(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_addresses_delete(connection, project, region, address, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/regions/#{region}/addresses/#{address}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:error, info} on failure
  """
  @spec compute_addresses_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Address.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_addresses_insert(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_addresses_insert(connection, project, region, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/regions/#{region}/addresses")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_addresses_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AddressList.t} | {:error, Tesla.Env.t}
