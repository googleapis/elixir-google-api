...
defmodule GoogleApi.Compute.V1.Api.Routers do
  ...
  def compute_routers_aggregated_list(connection, project, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.RouterAggregatedList{})
  end
  ...
  def compute_routers_get(connection, project, region, router, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.Router{})
  end
  ...
  def compute_routers_get_router_status(connection, project, region, router, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.RouterStatusResponse{})
  end
  ...
  def compute_routers_list(connection, project, region, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.RouterList{})
  end
  ...
  def compute_routers_preview(connection, project, region, router, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.RoutersPreviewResponse{})
  end
