...
defmodule GoogleApi.Compute.V1.Api.NetworkFirewallPolicies do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_add_association(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_add_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_add_rule(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}/addRule", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "firewallPolicy" => URI.encode(firewall_policy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_clone_rules(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_clone_rules(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}/cloneRules", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "firewallPolicy" => URI.encode(firewall_policy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_get_association(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_get_iam_policy(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/firewallPolicies/{resource}/getIamPolicy", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_get_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_get_rule(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}/getRule", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "firewallPolicy" => URI.encode(firewall_policy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_insert(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def compute_network_firewall_policies_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_patch_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_patch_rule(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}/patchRule", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "firewallPolicy" => URI.encode(firewall_policy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_remove_association(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_remove_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_remove_rule(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies/{firewallPolicy}/removeRule", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "firewallPolicy" => URI.encode(firewall_policy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_firewall_policies_set_iam_policy(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/firewallPolicies/{resource}/setIamPolicy", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "resource" => URI.encode(resource, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_firewall_policies_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
