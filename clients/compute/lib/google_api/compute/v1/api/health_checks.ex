...
defmodule GoogleApi.Compute.V1.Api.HealthChecks do
  @moduledoc """
  ...
  - health_check (String): Name of the HealthCheck resource to delete.
  ...
  """
  @spec compute_health_checks_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_health_checks_delete(connection, project, health_check, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/healthChecks/#{health_check}")
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - health_check (String): Name of the HealthCheck resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:ok, %GoogleApi.Compute.V1.Model.HealthCheck{}} on success
  {:error, info} on failure
  """
  @spec compute_health_checks_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.HealthCheck.t} | {:error, Tesla.Env.t}
  def compute_health_checks_get(connection, project, health_check, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.HealthCheck{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_health_checks_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_health_checks_insert(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/healthChecks")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:ok, %GoogleApi.Compute.V1.Model.HealthCheckList{}} on success
  {:error, info} on failure
  """
  @spec compute_health_checks_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.HealthCheckList.t} | {:error, Tesla.Env.t}
  def compute_health_checks_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.HealthCheckList{})
  end
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - health_check (String): Name of the HealthCheck resource to patch.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_health_checks_patch(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - health_check (String): Name of the HealthCheck resource to update.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_health_checks_update(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
