...
defmodule GoogleApi.Compute.V1.Api.MachineTypes do
  ...
  """
  @spec compute_machine_types_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.MachineTypeAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_machine_types_aggregated_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/machineTypes")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.MachineTypeAggregatedList{})
  end
  ...
  - machine_type (String): Name of the machine type to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_machine_types_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.MachineType.t} | {:error, Tesla.Env.t}
  def compute_machine_types_get(connection, project, zone, machine_type, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/zones/#{zone}/machineTypes/#{machine_type}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.MachineType{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_machine_types_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.MachineTypeList.t} | {:error, Tesla.Env.t}
  def compute_machine_types_list(connection, project, zone, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/zones/#{zone}/machineTypes")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.MachineTypeList{})
  end
end
