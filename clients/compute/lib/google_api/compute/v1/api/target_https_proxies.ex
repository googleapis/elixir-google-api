...
defmodule GoogleApi.Compute.V1.Api.TargetHttpsProxies do
  ...
  """
  @spec compute_target_https_proxies_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_delete(connection, project, target_https_proxy, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/targetHttpsProxies/#{target_https_proxy}")
  ...
  {:error, info} on failure
  """
  @spec compute_target_https_proxies_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetHttpsProxy.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_get(connection, project, target_https_proxy, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetHttpsProxy{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_https_proxies_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_insert(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetHttpsProxies")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_https_proxies_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetHttpsProxyList.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetHttpsProxyList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_https_proxies_set_ssl_certificates(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_set_ssl_certificates(connection, project, target_https_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/targetHttpsProxies/#{target_https_proxy}/setSslCertificates")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_https_proxies_set_url_map(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_https_proxies_set_url_map(connection, project, target_https_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/targetHttpsProxies/#{target_https_proxy}/setUrlMap")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
