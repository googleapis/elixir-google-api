...
defmodule GoogleApi.Compute.V1.Api.TargetHttpsProxies do
  ...
  *   `{:error, info}` on failure
  ...
  def compute_target_https_proxies_aggregated_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/targetHttpsProxies", %{
  ...
  *   `{:error, info}` on failure
  ...
  def compute_target_https_proxies_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/global/targetHttpsProxies/{targetHttpsProxy}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "targetHttpsProxy" =>
  ...
  *   `{:error, info}` on failure
  ...
  def compute_target_https_proxies_insert(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/targetHttpsProxies", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `target_https_proxy` (*type:* `String.t`) - Name of the TargetHttpsProxy resource to patch.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_target_https_proxies_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `target_https_proxy` (*type:* `String.t`) - Name of the TargetHttpsProxy resource whose CertificateMap is to be set. The name must be 1-63 characters long, and comply with RFC1035.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.TargetHttpsProxiesSetCertificateMapRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_target_https_proxies_set_certificate_map(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  ...
  def compute_target_https_proxies_set_url_map(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/targetHttpsProxies/{targetHttpsProxy}/setUrlMap", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "targetHttpsProxy" => URI.encode(target_https_proxy, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
