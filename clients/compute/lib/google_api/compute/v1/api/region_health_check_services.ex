...
defmodule GoogleApi.Compute.V1.Api.RegionHealthCheckServices do
  @moduledoc """
  ...
  *   `health_check_service` (*type:* `String.t`) - Name of the HealthCheckService to delete. The name must be 1-63 characters long, and comply with RFC1035.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_check_services_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_region_health_check_services_delete(
    ...
    request =
      ...
      |> Request.url("/{project}/regions/{region}/healthCheckServices/{healthCheckService}", %{
        ...
        "healthCheckService" => URI.encode(health_check_service, &URI.char_unreserved?/1)
      })
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request.
  *   `health_check_service` (*type:* `String.t`) - Name of the HealthCheckService to update. The name must be 1-63 characters long, and comply with RFC1035.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.HealthCheckService{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_check_services_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_region_health_check_services_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.HealthCheckService{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
          ...
          The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.HealthCheckService.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_check_services_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.HealthCheckServicesList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_check_services_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_region_health_check_services_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.HealthCheckServicesList{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_check_services_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
