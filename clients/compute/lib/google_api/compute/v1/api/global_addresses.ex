...
defmodule GoogleApi.Compute.V1.Api.GlobalAddresses do
  ...
  """
  @spec compute_global_addresses_delete(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_insert(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  def compute_global_addresses_insert(connection, project, opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/{project}/global/addresses", %{
        "project" => URI.encode_www_form(project)
      })
      |> Request.add_optional_params(optional_params, opts)
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_list(Tesla.Env.client(), String.t(), keyword()) ::
