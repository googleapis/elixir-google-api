...
defmodule GoogleApi.Compute.V1.Api.GlobalAddresses do
  ...
  """
  @spec compute_global_addresses_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_global_addresses_delete(connection, project, address, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/addresses/#{address}")
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Address.t} | {:error, Tesla.Env.t}
  def compute_global_addresses_get(connection, project, address, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Address{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_global_addresses_insert(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  {:error, info} on failure
  """
  @spec compute_global_addresses_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.AddressList.t} | {:error, Tesla.Env.t}
  def compute_global_addresses_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.AddressList{})
  end
end
