...
defmodule GoogleApi.Compute.V1.Api.RegionZones do
  @moduledoc """
  ...
  *   `region` (*type:* `String.t`) - Region for this request.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_zones_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_zones_list(connection, project, region, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/regions/{region}/zones", %{
