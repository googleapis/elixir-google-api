...
defmodule GoogleApi.Compute.V1.Api.RegionOperations do
  ...
  """
  @spec compute_region_operations_delete(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def compute_region_operations_delete(connection, project, region, operation, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/regions/#{region}/operations/#{operation}")
  ...
  {:error, info} on failure
  """
  @spec compute_region_operations_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_region_operations_get(connection, project, region, operation, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  {:error, info} on failure
  """
  @spec compute_region_operations_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.OperationList.t} | {:error, Tesla.Env.t}
  def compute_region_operations_list(connection, project, region, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/regions/#{region}/operations")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.OperationList{})
  end
end
