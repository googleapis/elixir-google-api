...
defmodule GoogleApi.Compute.V1.Api.Snapshots do
  ...
  - snapshot (String): Name of the Snapshot resource to delete.
  ...
  """
  @spec compute_snapshots_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_snapshots_delete(connection, project, snapshot, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/snapshots/#{snapshot}")
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - snapshot (String): Name of the Snapshot resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_snapshots_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Snapshot.t} | {:error, Tesla.Env.t}
  def compute_snapshots_get(connection, project, snapshot, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Snapshot{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_snapshots_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.SnapshotList.t} | {:error, Tesla.Env.t}
  def compute_snapshots_list(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/snapshots")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.SnapshotList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_snapshots_set_labels(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_snapshots_set_labels(connection, project, resource, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/snapshots/#{resource}/setLabels")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
