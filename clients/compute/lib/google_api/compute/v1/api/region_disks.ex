...
defmodule GoogleApi.Compute.V1.Api.RegionDisks do
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_disks_bulk_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_disks_bulk_insert(
        connection,
        project,
        region,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/disks/bulkInsert", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.RegionDisksStartAsyncReplicationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_disks_start_async_replication(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_disks_start_async_replication(
        connection,
        project,
        region,
        disk,
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/disks/{disk}/startAsyncReplication", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1),
        "disk" => URI.encode(disk, &URI.char_unreserved?/1)
      })
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_disks_stop_async_replication(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_disks_stop_async_replication(
        connection,
        project,
        region,
        disk,
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - The name of the region for this request. This must be the region of the primary or secondary disks in the consistency group.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_disks_stop_group_async_replication(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_disks_stop_group_async_replication(
        connection,
        project,
        region,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/disks/stopGroupAsyncReplication", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_disks_update(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
