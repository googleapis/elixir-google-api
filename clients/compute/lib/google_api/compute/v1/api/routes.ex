...
defmodule GoogleApi.Compute.V1.Api.Routes do
  @moduledoc """
  ...
  """
  @spec compute_routes_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_routes_delete(connection, project, route, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/routes/#{route}")
  ...
  {:ok, %GoogleApi.Compute.V1.Model.Route{}} on success
  {:error, info} on failure
  """
  @spec compute_routes_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Route.t} | {:error, Tesla.Env.t}
  def compute_routes_get(connection, project, route, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Route{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_routes_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %GoogleApi.Compute.V1.Model.RouteList{}} on success
  {:error, info} on failure
  """
  @spec compute_routes_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.RouteList.t} | {:error, Tesla.Env.t}
  def compute_routes_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.RouteList{})
  end
end
