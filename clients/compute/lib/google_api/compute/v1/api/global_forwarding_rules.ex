...
defmodule GoogleApi.Compute.V1.Api.GlobalForwardingRules do
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_global_forwarding_rules_get(connection, project, forwarding_rule, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.ForwardingRule{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_insert(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def compute_global_forwarding_rules_list(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.ForwardingRuleList{})
  end
