...
defmodule GoogleApi.Compute.V1.Api.GlobalForwardingRules do
  ...
  *   `{:error, info}` on failure
  ...
  def compute_global_forwarding_rules_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/global/forwardingRules/{forwardingRule}", %{
  ...
  *   `{:error, info}` on failure
  ...
  def compute_global_forwarding_rules_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/forwardingRules", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_global_forwarding_rules_set_labels(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/forwardingRules/{resource}/setLabels", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def compute_global_forwarding_rules_set_target(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/forwardingRules/{forwardingRule}/setTarget", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
