...
defmodule GoogleApi.Compute.V1.Api.GlobalForwardingRules do
  ...
  *   `forwarding_rule` (*type:* `String.t`) - Name of the ForwardingRule resource to delete.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  @doc """
  Returns the specified GlobalForwardingRule resource. Gets a list of available forwarding rules by making a list() request. (== suppress_warning http-rest-shadowed ==)

  ## Parameters

  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `forwarding_rule` (*type:* `String.t`) - Name of the ForwardingRule resource to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  @doc """
  Creates a GlobalForwardingRule resource in the specified project using the data included in the request. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_insert(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  @doc """
  Retrieves a list of GlobalForwardingRule resources available to the specified project. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  ...
  @doc """
  Changes target URL for the GlobalForwardingRule resource. The new target should be of the same type as the old target. (== suppress_warning http-rest-shadowed ==)

  ## Parameters

  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `forwarding_rule` (*type:* `String.t`) - Name of the ForwardingRule resource in which target is to be set.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_forwarding_rules_set_target(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
