...
defmodule GoogleApi.Compute.V1.Api.GlobalForwardingRules do
  @moduledoc """
  ...
  """
  @spec compute_global_forwarding_rules_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_global_forwarding_rules_delete(connection, project, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/forwardingRules/#{forwarding_rule}")
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ForwardingRule.t} | {:error, Tesla.Env.t}
  def compute_global_forwarding_rules_get(connection, project, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_global_forwarding_rules_insert(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/forwardingRules")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ForwardingRuleList.t} | {:error, Tesla.Env.t}
  def compute_global_forwarding_rules_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
  ...
  {:error, info} on failure
  """
  @spec compute_global_forwarding_rules_set_target(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_global_forwarding_rules_set_target(connection, project, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/forwardingRules/#{forwarding_rule}/setTarget")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
