...
defmodule GoogleApi.Compute.V1.Api.RegionInstantSnapshots do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_delete(
        connection,
        project,
        region,
        instant_snapshot,
    ...
    request =
      ...
      |> Request.url("/projects/{project}/regions/{region}/instantSnapshots/{instantSnapshot}", %{
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_get(
        connection,
        project,
        region,
        instant_snapshot,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_get_iam_policy(
        connection,
        project,
        region,
        resource,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_insert(
        connection,
        project,
        region,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/instantSnapshots", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_list(
        connection,
        project,
        region,
        optional_params \\ [],
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_set_iam_policy(
        connection,
        project,
        region,
        resource,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_set_labels(
        connection,
        project,
        region,
        resource,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_instant_snapshots_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_instant_snapshots_test_iam_permissions(
        connection,
        project,
        region,
        resource,
