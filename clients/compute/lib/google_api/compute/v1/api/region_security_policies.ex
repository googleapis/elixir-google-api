...
defmodule GoogleApi.Compute.V1.Api.RegionSecurityPolicies do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_add_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_security_policies_add_rule(
        connection,
        project,
        region,
        security_policy,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_region_security_policies_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/regions/{region}/securityPolicies/{securityPolicy}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_get_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_security_policies_get_rule(
        connection,
        project,
        region,
        security_policy,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_region_security_policies_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/securityPolicies", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_patch_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_security_policies_patch_rule(
        connection,
        project,
        region,
        security_policy,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_remove_rule(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_security_policies_remove_rule(
        connection,
        project,
        region,
        security_policy,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_security_policies_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_security_policies_set_labels(
        connection,
        project,
        region,
        resource,
