...
defmodule GoogleApi.Compute.V1.Api.Subnetworks do
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.SubnetworksExpandIpCidrRangeRequest.t): 
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.Subnetwork.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_subnetworks_list_usable(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.Compute.V1.Model.RegionSetPolicyRequest.t): 
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.SubnetworksSetPrivateIpGoogleAccessRequest.t): 
