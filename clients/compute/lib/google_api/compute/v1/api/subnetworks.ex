...
defmodule GoogleApi.Compute.V1.Api.Subnetworks do
  ...
  """
  @spec compute_subnetworks_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def compute_subnetworks_aggregated_list(connection, project, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.SubnetworkAggregatedList{})
  end
  ...
  - subnetwork (String.t): Name of the Subnetwork resource to delete.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): Name of the region scoping this request.
  - subnetwork (String.t): Name of the Subnetwork resource to update.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): Name of the region scoping this request.
  - subnetwork (String.t): Name of the Subnetwork resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_subnetworks_get(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
  ...
  def compute_subnetworks_get(connection, project, region, subnetwork, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.Subnetwork{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_subnetworks_insert(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_subnetworks_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_subnetworks_list(connection, project, region, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.SubnetworkList{})
  end
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): Name of the region scoping this request.
  - subnetwork (String.t): Name of the Subnetwork resource to patch.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  def compute_subnetworks_patch(connection, project, region, subnetwork, opts \\ []) do
    optional_params = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): Name of the region scoping this request.
  - subnetwork (String.t): Name of the Subnetwork resource.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
