...
defmodule GoogleApi.Compute.V1.Api.Images do
  ...
  """
  @spec compute_images_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_images_delete(connection, project, image, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/images/#{image}")
  ...
  {:error, info} on failure
  """
  @spec compute_images_deprecate(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_images_deprecate(connection, project, image, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/images/#{image}/deprecate")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_images_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Image.t} | {:error, Tesla.Env.t}
  def compute_images_get(connection, project, image, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Image{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_images_get_from_family(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Image.t} | {:error, Tesla.Env.t}
  def compute_images_get_from_family(connection, project, family, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/images/family/#{family}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Image{})
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quota_user (String): Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    - :user_ip (String): IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    - :force_create (Boolean): Force image creation if true.
    - :request_id (String): An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.  For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments.  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (Image): 
  ...
  {:error, info} on failure
  """
  @spec compute_images_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_images_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ImageList.t} | {:error, Tesla.Env.t}
  def compute_images_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.ImageList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_images_set_labels(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_images_set_labels(connection, project, resource, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/images/#{resource}/setLabels")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
