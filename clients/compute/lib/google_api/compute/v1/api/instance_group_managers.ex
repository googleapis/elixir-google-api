...
defmodule GoogleApi.Compute.V1.Api.InstanceGroupManagers do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.InstanceGroupManagersResumeInstancesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instance_group_managers_resume_instances(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instance_group_managers_resume_instances(
        connection,
        project,
        zone,
        instance_group_manager,
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.InstanceGroupManagersStartInstancesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instance_group_managers_start_instances(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instance_group_managers_start_instances(
        connection,
        project,
        zone,
        instance_group_manager,
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.InstanceGroupManagersStopInstancesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instance_group_managers_stop_instances(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instance_group_managers_stop_instances(
        connection,
        project,
        zone,
        instance_group_manager,
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.InstanceGroupManagersSuspendInstancesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instance_group_managers_suspend_instances(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instance_group_managers_suspend_instances(
        connection,
        project,
        zone,
        instance_group_manager,
