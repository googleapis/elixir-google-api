...
defmodule GoogleApi.Compute.V1.Api.SslCertificates do
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.SslCertificateAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_ssl_certificates_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def compute_ssl_certificates_aggregated_list(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.SslCertificateAggregatedList{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_ssl_certificates_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_ssl_certificates_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
