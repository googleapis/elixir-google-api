...
defmodule GoogleApi.Compute.V1.Api.Firewalls do
  @moduledoc """
  ...
  """
  @spec compute_firewalls_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_firewalls_delete(connection, project, firewall, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/firewalls/#{firewall}")
  ...
  {:ok, %GoogleApi.Compute.V1.Model.Firewall{}} on success
  {:error, info} on failure
  """
  @spec compute_firewalls_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Firewall.t} | {:error, Tesla.Env.t}
  def compute_firewalls_get(connection, project, firewall, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Firewall{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_firewalls_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:ok, %GoogleApi.Compute.V1.Model.FirewallList{}} on success
  {:error, info} on failure
  """
  @spec compute_firewalls_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.FirewallList.t} | {:error, Tesla.Env.t}
  def compute_firewalls_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.FirewallList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_firewalls_patch(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_firewalls_update(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
