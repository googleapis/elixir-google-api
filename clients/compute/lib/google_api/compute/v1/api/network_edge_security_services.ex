...
defmodule GoogleApi.Compute.V1.Api.NetworkEdgeSecurityServices do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_network_edge_security_services_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_network_edge_security_services_aggregated_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/networkEdgeSecurityServices", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.NetworkEdgeSecurityServiceAggregatedList{}]
    )
  end
  ...
  *   `network_edge_security_service` (*type:* `String.t`) - Name of the network edge security service to delete.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_edge_security_services_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
      ...
      |> Request.url(
        ...
        %{
          ...
          "networkEdgeSecurityService" =>
            URI.encode(network_edge_security_service, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request.
  *   `network_edge_security_service` (*type:* `String.t`) - Name of the network edge security service to get.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.NetworkEdgeSecurityService{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_network_edge_security_services_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.NetworkEdgeSecurityService.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_network_edge_security_services_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.NetworkEdgeSecurityService{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.NetworkEdgeSecurityService.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_edge_security_services_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_network_edge_security_services_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/networkEdgeSecurityServices", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request.
  *   `network_edge_security_service` (*type:* `String.t`) - Name of the network edge security service to update.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:updateMask` (*type:* `String.t`) - Indicates fields to be updated as part of this request.
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.NetworkEdgeSecurityService.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_network_edge_security_services_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
