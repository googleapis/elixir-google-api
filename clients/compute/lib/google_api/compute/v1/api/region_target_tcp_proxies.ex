...
defmodule GoogleApi.Compute.V1.Api.RegionTargetTcpProxies do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_target_tcp_proxies_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_region_target_tcp_proxies_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/regions/{region}/targetTcpProxies/{targetTcpProxy}", %{
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_target_tcp_proxies_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_target_tcp_proxies_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_region_target_tcp_proxies_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/targetTcpProxies", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_target_tcp_proxies_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
