...
defmodule GoogleApi.Compute.V1.Api.RegionBackendServices do
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_backend_services_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `connection` (*type:* `GoogleApi.Compute.V1.Connection.t`) - Connection to server
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `region` (*type:* `String.t`) - Name of the region scoping this request. It must be a string that meets the requirements in RFC1035.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_backend_services_list_usable(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_backend_services_list_usable(
        connection,
        project,
        region,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/regions/{region}/backendServices/listUsable", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_backend_services_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_backend_services_set_security_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_backend_services_set_security_policy(
        connection,
        project,
        region,
        backend_service,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_backend_services_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_region_backend_services_test_iam_permissions(
        connection,
        project,
        region,
        resource,
