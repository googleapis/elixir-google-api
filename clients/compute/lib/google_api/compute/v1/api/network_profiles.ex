...
defmodule GoogleApi.Compute.V1.Api.NetworkProfiles do
  @moduledoc """
  API calls for all endpoints tagged `NetworkProfiles`.
  """
  ...
  *   `network_profile` (*type:* `String.t`) - Name of the network profile to return.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.NetworkProfile{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_network_profiles_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.NetworkProfile.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_network_profiles_get(
        connection,
        project,
        network_profile,
        optional_params \\ [],
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/networkProfiles/{networkProfile}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "networkProfile" => URI.encode(network_profile, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.NetworkProfile{}])
  end
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.NetworkProfilesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_network_profiles_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.NetworkProfilesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_network_profiles_list(connection, project, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/networkProfiles", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.NetworkProfilesListResponse{}]
    )
  end
end
