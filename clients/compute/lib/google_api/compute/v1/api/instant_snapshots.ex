...
defmodule GoogleApi.Compute.V1.Api.InstantSnapshots do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InstantSnapshotAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.InstantSnapshotAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_aggregated_list(
        connection,
        project,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/instantSnapshots", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.InstantSnapshotAggregatedList{}]
    )
  end
  ...
  *   `instant_snapshot` (*type:* `String.t`) - Name of the InstantSnapshot resource to delete.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_delete(
        connection,
        project,
        zone,
        instant_snapshot,
    ...
    request =
      ...
      |> Request.url("/projects/{project}/zones/{zone}/instantSnapshots/{instantSnapshot}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "zone" => URI.encode(zone, &URI.char_unreserved?/1),
        "instantSnapshot" => URI.encode(instant_snapshot, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `project` (*type:* `String.t`) - Project ID for this request.
  *   `zone` (*type:* `String.t`) - The name of the zone for this request.
  *   `instant_snapshot` (*type:* `String.t`) - Name of the InstantSnapshot resource to return.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InstantSnapshot{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.InstantSnapshot.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_get(
        connection,
        project,
        zone,
        instant_snapshot,
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.InstantSnapshot{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_get_iam_policy(
        connection,
        project,
        zone,
        resource,
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:userIp` (*type:* `String.t`) - Legacy name for parameter that has been superseded by `quotaUser`.
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.InstantSnapshot.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_insert(
        connection,
        project,
        zone,
        optional_params \\ [],
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InstantSnapshotList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.InstantSnapshotList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_list(connection, project, zone, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.InstantSnapshotList{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_set_iam_policy(
        connection,
        project,
        zone,
        resource,
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_set_labels(
        connection,
        project,
        zone,
        resource,
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/zones/{zone}/instantSnapshots/{resource}/setLabels", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "zone" => URI.encode(zone, &URI.char_unreserved?/1),
        "resource" => URI.encode(resource, &URI.char_unreserved?/1)
      })
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_instant_snapshots_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def compute_instant_snapshots_test_iam_permissions(
        connection,
        project,
        zone,
        resource,
