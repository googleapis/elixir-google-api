...
defmodule GoogleApi.Compute.V1.Api.NodeGroups do
  ...
  - node_group (String.t): Name of the NodeGroup resource.
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NodeGroupsAddNodesRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_node_groups_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.NodeGroupAggregatedList.t()} | {:error, Tesla.Env.t()}
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NodeGroupsDeleteNodesRequest.t): 
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone for this request.
  - node_group (String.t): Name of the node group to return.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_node_groups_get(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.NodeGroup.t()} | {:error, Tesla.Env.t()}
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NodeGroup.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_node_groups_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.NodeGroupList.t()} | {:error, Tesla.Env.t()}
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone for this request.
  - node_group (String.t): Name of the NodeGroup resource whose nodes you want to list.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  @spec compute_node_groups_list_nodes(
          ...
          String.t(),
          keyword()
        ) :: {:ok, GoogleApi.Compute.V1.Model.NodeGroupsListNodes.t()} | {:error, Tesla.Env.t()}
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NodeGroupsSetNodeTemplateRequest.t): 
