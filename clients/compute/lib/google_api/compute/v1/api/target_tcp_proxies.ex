...
defmodule GoogleApi.Compute.V1.Api.TargetTcpProxies do
  ...
  - target_tcp_proxy (String): Name of the TargetTcpProxy resource to delete.
  ...
  """
  @spec compute_target_tcp_proxies_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_delete(connection, project, target_tcp_proxy, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/targetTcpProxies/#{target_tcp_proxy}")
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - target_tcp_proxy (String): Name of the TargetTcpProxy resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_tcp_proxies_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetTcpProxy.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_get(connection, project, target_tcp_proxy, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetTcpProxy{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_tcp_proxies_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_insert(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetTcpProxies")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_target_tcp_proxies_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.TargetTcpProxyList.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.TargetTcpProxyList{})
  end
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - target_tcp_proxy (String): Name of the TargetTcpProxy resource whose BackendService resource is to be set.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_tcp_proxies_set_backend_service(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_set_backend_service(connection, project, target_tcp_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetTcpProxies/#{target_tcp_proxy}/setBackendService")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String): Project ID for this request.
  - target_tcp_proxy (String): Name of the TargetTcpProxy resource whose ProxyHeader is to be set.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_tcp_proxies_set_proxy_header(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_target_tcp_proxies_set_proxy_header(connection, project, target_tcp_proxy, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/targetTcpProxies/#{target_tcp_proxy}/setProxyHeader")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
