...
defmodule GoogleApi.Compute.V1.Api.TargetTcpProxies do
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_target_tcp_proxies_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_target_tcp_proxies_aggregated_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/targetTcpProxies", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.TargetTcpProxyAggregatedList{}]
    )
  end
