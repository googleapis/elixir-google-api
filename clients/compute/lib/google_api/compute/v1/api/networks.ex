...
defmodule GoogleApi.Compute.V1.Api.Networks do
  ...
  """
  @spec compute_networks_add_peering(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_networks_add_peering(connection, project, network, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/networks/#{network}/addPeering")
  ...
  {:error, info} on failure
  """
  @spec compute_networks_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_networks_delete(connection, project, network, opts \\ []) do
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/global/networks/#{network}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_networks_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Network.t} | {:error, Tesla.Env.t}
  def compute_networks_get(connection, project, network, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Network{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_networks_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_networks_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.NetworkList.t} | {:error, Tesla.Env.t}
  def compute_networks_list(connection, project, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.NetworkList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_networks_remove_peering(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_networks_remove_peering(connection, project, network, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/networks/#{network}/removePeering")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_networks_switch_to_custom_mode(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_networks_switch_to_custom_mode(connection, project, network, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/global/networks/#{network}/switchToCustomMode")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
