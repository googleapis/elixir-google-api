...
defmodule GoogleApi.Compute.V1.Api.SslPolicies do
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_ssl_policies_aggregated_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_ssl_policies_aggregated_list(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/sslPolicies", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.SslPoliciesAggregatedList{}])
  end
