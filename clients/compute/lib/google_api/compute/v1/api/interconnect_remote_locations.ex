...
defmodule GoogleApi.Compute.V1.Api.InterconnectRemoteLocations do
  @moduledoc """
  ...
  *   `interconnect_remote_location` (*type:* `String.t`) - Name of the interconnect remote location to return.
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InterconnectRemoteLocation{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_interconnect_remote_locations_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.Compute.V1.Model.InterconnectRemoteLocation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_interconnect_remote_locations_get(
        connection,
        project,
      ...
      |> Request.url(
        ...
        %{
          ...
          "interconnectRemoteLocation" =>
            URI.encode(interconnect_remote_location, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.InterconnectRemoteLocation{}])
  end
  ...
  *   `{:ok, %GoogleApi.Compute.V1.Model.InterconnectRemoteLocationList{}}` on success
  *   `{:error, info}` on failure
  """
  @spec compute_interconnect_remote_locations_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.InterconnectRemoteLocationList.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def compute_interconnect_remote_locations_list(
        connection,
        project,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/interconnectRemoteLocations", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.InterconnectRemoteLocationList{}]
    )
  end
end
