...
defmodule GoogleApi.Compute.V1.Api.RegionCommitments do
  @moduledoc """
  ...
  {:ok, %GoogleApi.Compute.V1.Model.CommitmentAggregatedList{}} on success
  {:error, info} on failure
  """
  @spec compute_region_commitments_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.CommitmentAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_region_commitments_aggregated_list(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/commitments")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.CommitmentAggregatedList{})
  end
  ...
  {:ok, %GoogleApi.Compute.V1.Model.Commitment{}} on success
  {:error, info} on failure
  """
  @spec compute_region_commitments_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Commitment.t} | {:error, Tesla.Env.t}
  def compute_region_commitments_get(connection, project, region, commitment, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/regions/#{region}/commitments/#{commitment}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Commitment{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_region_commitments_insert(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_region_commitments_insert(connection, project, region, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/regions/#{region}/commitments")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:ok, %GoogleApi.Compute.V1.Model.CommitmentList{}} on success
  {:error, info} on failure
  """
  @spec compute_region_commitments_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.CommitmentList.t} | {:error, Tesla.Env.t}
  def compute_region_commitments_list(connection, project, region, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.CommitmentList{})
  end
end
