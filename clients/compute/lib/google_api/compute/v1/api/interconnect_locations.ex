...
defmodule GoogleApi.Compute.V1.Api.InterconnectLocations do
  ...
  *   `interconnect_location` (*type:* `String.t`) - Name of the interconnect location to return.
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_interconnect_locations_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_interconnect_locations_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/interconnectLocations/{interconnectLocation}", %{
  ...
  *   `{:error, info}` on failure
  ...
  def compute_interconnect_locations_list(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/global/interconnectLocations", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
