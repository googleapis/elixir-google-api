...
defmodule GoogleApi.Compute.V1.Api.RegionDiskTypes do
  ...
  def compute_region_disk_types_get(connection, project, region, disk_type, opts \\ []) do
    optional_params = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
    ...
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.DiskType{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_region_disk_types_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.RegionDiskTypeList.t()} | {:error, Tesla.Env.t()}
  def compute_region_disk_types_list(connection, project, region, opts \\ []) do
    optional_params = %{
      :alt => :query,
      :fields => :query,
      :key => :query,
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.RegionDiskTypeList{})
  end
end
