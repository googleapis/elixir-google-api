...
defmodule GoogleApi.Compute.V1.Api.TargetVpnGateways do
  ...
  """
  @spec compute_target_vpn_gateways_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def compute_target_vpn_gateways_aggregated_list(connection, project, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedList{})
  end
  ...
  - target_vpn_gateway (String.t): Name of the target VPN gateway to delete.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_vpn_gateways_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_target_vpn_gateways_delete(
    ...
    request =
      ...
      |> Request.url("/{project}/regions/{region}/targetVpnGateways/{targetVpnGateway}", %{
        ...
        "targetVpnGateway" => URI.encode_www_form(target_vpn_gateway)
      })
      |> Request.add_optional_params(optional_params, opts)
  ...
  - project (String.t): Project ID for this request.
  - region (String.t): Name of the region for this request.
  - target_vpn_gateway (String.t): Name of the target VPN gateway to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_target_vpn_gateways_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def compute_target_vpn_gateways_get(connection, project, region, target_vpn_gateway, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.TargetVpnGateway{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_target_vpn_gateways_insert(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_target_vpn_gateways_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_target_vpn_gateways_list(connection, project, region, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.TargetVpnGatewayList{})
  end
end
