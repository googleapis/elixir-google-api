...
defmodule GoogleApi.Compute.V1.Api.TargetVpnGateways do
  ...
  def compute_target_vpn_gateways_aggregated_list(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.TargetVpnGatewayAggregatedList{}]
    )
  end
  ...
  def compute_target_vpn_gateways_delete(
    ...
    request =
      ...
      |> Request.url("/{project}/regions/{region}/targetVpnGateways/{targetVpnGateway}", %{
        ...
        "targetVpnGateway" => URI.encode(target_vpn_gateway, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  def compute_target_vpn_gateways_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.TargetVpnGateway{}])
  end
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.TargetVpnGateway.t): 
  ...
  def compute_target_vpn_gateways_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.TargetVpnGatewayList{}])
  end
end
