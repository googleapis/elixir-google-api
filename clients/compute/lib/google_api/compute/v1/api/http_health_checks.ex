...
defmodule GoogleApi.Compute.V1.Api.HttpHealthChecks do
  ...
  - http_health_check (String.t): Name of the HttpHealthCheck resource to delete.
  ...
  """
  @spec compute_http_health_checks_delete(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_http_health_checks_delete(connection, project, http_health_check, opts \\ []) do
    ...
    request =
      ...
      |> Request.url("/{project}/global/httpHealthChecks/{httpHealthCheck}", %{
        ...
        "httpHealthCheck" => URI.encode_www_form(http_health_check)
      })
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - http_health_check (String.t): Name of the HttpHealthCheck resource to return.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_http_health_checks_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  def compute_http_health_checks_get(connection, project, http_health_check, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.HttpHealthCheck{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_http_health_checks_insert(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec compute_http_health_checks_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def compute_http_health_checks_list(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.HttpHealthCheckList{})
  end
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - http_health_check (String.t): Name of the HttpHealthCheck resource to patch.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_http_health_checks_patch(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - http_health_check (String.t): Name of the HttpHealthCheck resource to update.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_http_health_checks_update(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.Operation.t()} | {:error, Tesla.Env.t()}
