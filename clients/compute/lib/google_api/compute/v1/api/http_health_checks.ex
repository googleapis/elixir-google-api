...
defmodule GoogleApi.Compute.V1.Api.HttpHealthChecks do
  ...
  *   `{:error, info}` on failure
  ...
  def compute_http_health_checks_delete(
    ...
    request =
      ...
      |> Request.url("/{project}/global/httpHealthChecks/{httpHealthCheck}", %{
        ...
        "httpHealthCheck" => URI.encode(http_health_check, &URI.char_unreserved?/1)
      })
  ...
  @doc """
  Returns the specified HttpHealthCheck resource. Gets a list of available HTTP health checks by making a list() request. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  ...
  @spec compute_http_health_checks_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.Compute.V1.Model.HttpHealthCheck.t()} | {:error, Tesla.Env.t()}
  def compute_http_health_checks_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Compute.V1.Model.HttpHealthCheck{}])
  end

  @doc """
  Creates a HttpHealthCheck resource in the specified project using the data included in the request. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:requestId` (*type:* `String.t`) - An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed.
          ...
          The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
      *   `:body` (*type:* `GoogleApi.Compute.V1.Model.HttpHealthCheck.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  @doc """
  Retrieves the list of HttpHealthCheck resources available to the specified project. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  ...
  @spec compute_http_health_checks_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.HttpHealthCheckList.t()} | {:error, Tesla.Env.t()}
  ...
  @doc """
  Updates a HttpHealthCheck resource in the specified project using the data included in the request. This method supports PATCH semantics and uses the JSON merge patch format and processing rules. (== suppress_warning http-rest-shadowed ==)
  ...
  *   `{:error, info}` on failure
  ...
  @doc """
  Updates a HttpHealthCheck resource in the specified project using the data included in the request. (== suppress_warning http-rest-shadowed ==)
