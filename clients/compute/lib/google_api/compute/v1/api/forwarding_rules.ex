...
defmodule GoogleApi.Compute.V1.Api.ForwardingRules do
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_forwarding_rules_aggregated_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def compute_forwarding_rules_aggregated_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/projects/{project}/aggregated/forwardingRules", %{
  ...
  *   `{:error, info}` on failure
  ...
  def compute_forwarding_rules_delete(
    ...
    request =
      ...
      |> Request.url("/projects/{project}/regions/{region}/forwardingRules/{forwardingRule}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_forwarding_rules_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def compute_forwarding_rules_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/regions/{region}/forwardingRules", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "region" => URI.encode(region, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_forwarding_rules_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_forwarding_rules_set_labels(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
