...
defmodule GoogleApi.Compute.V1.Api.ForwardingRules do
  ...
  """
  @spec compute_forwarding_rules_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ForwardingRuleAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_aggregated_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/forwardingRules")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.ForwardingRuleAggregatedList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_forwarding_rules_delete(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_delete(connection, project, region, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:delete)
    |> url("/#{project}/regions/#{region}/forwardingRules/#{forwarding_rule}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:error, info} on failure
  """
  @spec compute_forwarding_rules_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ForwardingRule.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_get(connection, project, region, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.ForwardingRule{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_forwarding_rules_insert(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_insert(connection, project, region, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/regions/#{region}/forwardingRules")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
  ...
  {:error, info} on failure
  """
  @spec compute_forwarding_rules_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.ForwardingRuleList.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_list(connection, project, region, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.ForwardingRuleList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_forwarding_rules_set_target(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  def compute_forwarding_rules_set_target(connection, project, region, forwarding_rule, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/#{project}/regions/#{region}/forwardingRules/#{forwarding_rule}/setTarget")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.Operation{})
