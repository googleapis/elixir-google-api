...
defmodule GoogleApi.Compute.V1.Api.GlobalOperations do
  ...
  """
  @spec compute_global_operations_aggregated_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.OperationAggregatedList.t} | {:error, Tesla.Env.t}
  def compute_global_operations_aggregated_list(connection, project, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/aggregated/operations")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Compute.V1.Model.OperationAggregatedList{})
  end
  ...
  {:error, info} on failure
  """
  @spec compute_global_operations_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_global_operations_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec compute_global_operations_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Compute.V1.Model.OperationList.t} | {:error, Tesla.Env.t}
