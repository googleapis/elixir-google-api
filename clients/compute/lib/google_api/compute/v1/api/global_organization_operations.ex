...
defmodule GoogleApi.Compute.V1.Api.GlobalOrganizationOperations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_organization_operations_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def compute_global_organization_operations_delete(
    ...
    request =
      ...
      |> Request.url("/locations/global/operations/{operation}", %{
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_organization_operations_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  ...
  def compute_global_organization_operations_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/locations/global/operations", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
