...
defmodule GoogleApi.Compute.V1.Api.RegionHealthChecks do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_region_health_checks_update(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
