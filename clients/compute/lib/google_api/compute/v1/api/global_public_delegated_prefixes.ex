...
defmodule GoogleApi.Compute.V1.Api.GlobalPublicDelegatedPrefixes do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_public_delegated_prefixes_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_public_delegated_prefixes_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_public_delegated_prefixes_insert(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def compute_global_public_delegated_prefixes_insert(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/projects/{project}/global/publicDelegatedPrefixes", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_public_delegated_prefixes_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec compute_global_public_delegated_prefixes_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
