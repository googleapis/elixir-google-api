...
defmodule GoogleApi.Compute.V1.Api.NetworkEndpointGroups do
  @moduledoc """
  ...
  {:ok, %GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedList{}} on success
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_aggregated_list(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedList.t()}
          | {:error, Tesla.Env.t()}
  def compute_network_endpoint_groups_aggregated_list(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Compute.V1.Model.NetworkEndpointGroupAggregatedList{}]
    )
  end
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where the network endpoint group is located. It should comply with RFC1035.
  - network_endpoint_group (String.t): The name of the network endpoint group where you are attaching network endpoints to. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NetworkEndpointGroupsAttachEndpointsRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_attach_network_endpoints(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where the network endpoint group is located. It should comply with RFC1035.
  - network_endpoint_group (String.t): The name of the network endpoint group to delete. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where the network endpoint group is located. It should comply with RFC1035.
  - network_endpoint_group (String.t): The name of the network endpoint group where you are removing network endpoints. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NetworkEndpointGroupsDetachEndpointsRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_detach_network_endpoints(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where the network endpoint group is located. It should comply with RFC1035.
  - network_endpoint_group (String.t): The name of the network endpoint group. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          keyword()
        ) :: {:ok, GoogleApi.Compute.V1.Model.NetworkEndpointGroup.t()} | {:error, Tesla.Env.t()}
  ...
  - connection (GoogleApi.Compute.V1.Connection): Connection to server
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where you want to create the network endpoint group. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    - :body (GoogleApi.Compute.V1.Model.NetworkEndpointGroup.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_insert(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword()
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword()
        ) ::
          {:ok, GoogleApi.Compute.V1.Model.NetworkEndpointGroupList.t()} | {:error, Tesla.Env.t()}
  ...
  - project (String.t): Project ID for this request.
  - zone (String.t): The name of the zone where the network endpoint group is located. It should comply with RFC1035.
  - network_endpoint_group (String.t): The name of the network endpoint group from which you want to generate a list of included network endpoints. It should comply with RFC1035.
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :fields (String.t): Selector specifying which fields to include in a partial response.
    - :key (String.t): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  Currently, only sorting by name or creationTimestamp desc is supported.
    - :pageToken (String.t): Specifies a page token to use. Set pageToken to the nextPageToken returned by a previous list request to get the next page of results.
    - :body (GoogleApi.Compute.V1.Model.NetworkEndpointGroupsListEndpointsRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_list_network_endpoints(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  {:error, info} on failure
  """
  @spec compute_network_endpoint_groups_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
