...
defmodule GoogleApi.Compute.V1.Api.Projects do
  ...
  def compute_projects_get(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.Project{})
  end
  ...
  def compute_projects_get_xpn_resources(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.ProjectsGetXpnResources{})
  end
  ...
  def compute_projects_list_xpn_hosts(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Compute.V1.Model.XpnHostList{})
  end
