...
defmodule GoogleApi.BillingBudgets.V1beta1.Model.GoogleTypeDate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BillingBudgets.V1beta1.Model.GoogleTypeDate do
  def decode(value, options) do
    GoogleApi.BillingBudgets.V1beta1.Model.GoogleTypeDate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BillingBudgets.V1beta1.Model.GoogleTypeDate do
