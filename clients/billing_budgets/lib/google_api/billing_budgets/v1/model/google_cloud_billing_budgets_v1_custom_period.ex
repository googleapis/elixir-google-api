...
defmodule GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1CustomPeriod do
  @moduledoc """
  ...
  *   `startDate` (*type:* `GoogleApi.BillingBudgets.V1.Model.GoogleTypeDate.t`, *default:* `nil`) - Required. The start date must be after January 1, 2017.
  ...
  field(:startDate, as: GoogleApi.BillingBudgets.V1.Model.GoogleTypeDate)
end

defimpl Poison.Decoder,
  for: GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1CustomPeriod do
  def decode(value, options) do
    GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1CustomPeriod.decode(
      value,
      options
    )
  end
