...
defmodule GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1ListBudgetsResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - If not empty, indicates that there may be more budgets that match the request; this value should be passed in a new `ListBudgetsRequest`.
  ...
  field(:budgets,
    as: GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1Budget,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1ListBudgetsResponse do
  def decode(value, options) do
    GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1ListBudgetsResponse.decode(
      value,
      options
    )
  end
