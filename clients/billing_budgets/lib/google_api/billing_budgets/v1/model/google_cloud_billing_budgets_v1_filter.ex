...
defmodule GoogleApi.BillingBudgets.V1.Model.GoogleCloudBillingBudgetsV1Filter do
  ...
  *   `creditTypes` (*type:* `list(String.t)`, *default:* `nil`) - Optional. A list of credit types to be subtracted from gross cost to determine the spend for threshold calculations if and only if credit_types_treatment is INCLUDE_SPECIFIED_CREDITS. If credit_types_treatment is not INCLUDE_SPECIFIED_CREDITS, this field must be empty. See credits.type on https://cloud.google.com/billing/docs/how-to/export-data-bigquery-tables#data-schema for a list of acceptable credit type values in this field.
