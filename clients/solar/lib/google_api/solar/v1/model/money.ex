...
defmodule GoogleApi.Solar.V1.Model.Money do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Solar.V1.Model.Money do
  def decode(value, options) do
    GoogleApi.Solar.V1.Model.Money.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Solar.V1.Model.Money do
