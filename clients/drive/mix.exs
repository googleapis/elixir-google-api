...
defmodule GoogleApi.Drive.Mixfile do
  ...
  defp description() do
    """
    Client library for Drive API from Google. Manages files in Drive including uploading, downloading, searching, detecting changes, and updating sharing permissions.
    """
  end
