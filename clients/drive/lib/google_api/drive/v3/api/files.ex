...
defmodule GoogleApi.Drive.V3.Api.Files do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :ignore_default_visibility (Boolean): Whether to ignore the domain&#39;s default visibility settings for the created file. Domain administrators can choose to make all uploaded files visible to the domain by default; this parameter bypasses that behavior for the request. Permissions are still inherited from parent folders.
    - :keep_revision_forever (Boolean): Whether to set the &#39;keepForever&#39; field in the new head revision. This is only applicable to files with binary content in Drive.
  ...
  - connection (GoogleApi.Drive.V3.Connection): Connection to server
  - file_id (String): The ID of the file.
  - mime_type (String): The MIME type of the format requested for this export.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :include_team_drive_items (Boolean): Whether Team Drive items should be included in results.
    - :order_by (String): A comma-separated list of sort keys. Valid keys are &#39;createdTime&#39;, &#39;folder&#39;, &#39;modifiedByMeTime&#39;, &#39;modifiedTime&#39;, &#39;name&#39;, &#39;quotaBytesUsed&#39;, &#39;recency&#39;, &#39;sharedWithMeTime&#39;, &#39;starred&#39;, and &#39;viewedByMeTime&#39;. Each key sorts ascending by default, but may be reversed with the &#39;desc&#39; modifier. Example usage: ?orderBy&#x3D;folder,modifiedTime desc,name. Please note that there is a current limitation for users with approximately one million files in which the requested sort order is ignored.
    - :page_size (Integer): The maximum number of files to return per page. Partial or empty result pages are possible even before the end of the files list has been reached.
    ...
    - :supports_team_drives (Boolean): Whether the requesting application supports Team Drives.
    - :team_drive_id (String): ID of Team Drive to search.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :quota_user (String): Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters. Overrides userIp if both are provided.
    - :user_ip (String): IP address of the site where the request originates. Use this if you want to enforce per-user limits.
    - :add_parents (String): A comma-separated list of parent IDs to add.
    - :keep_revision_forever (Boolean): Whether to set the &#39;keepForever&#39; field in the new head revision. This is only applicable to files with binary content in Drive.
    - :ocr_language (String): A language hint for OCR processing during image import (ISO 639-1 code).
    - :remove_parents (String): A comma-separated list of parent IDs to remove.
    - :supports_team_drives (Boolean): Whether the requesting application supports Team Drives.
    - :use_content_as_indexable_text (Boolean): Whether to use the uploaded content as indexable text.
    - :body (File): 
