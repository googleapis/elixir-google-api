...
defmodule GoogleApi.Drive.V3.Api.Revisions do
  ...
  def drive_revisions_delete(connection, file_id, revision_id, opts \\ []) do
    ...
    request =
      ...
      |> Request.url("/drive/v3/files/{fileId}/revisions/{revisionId}", %{
         ...
         "revisionId" => URI.encode_www_form(revision_id)
       })
  ...
  def drive_revisions_get(connection, file_id, revision_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Drive.V3.Model.Revision{})
  end
  ...
  def drive_revisions_list(connection, file_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Drive.V3.Model.RevisionList{})
  end
