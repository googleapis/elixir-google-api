...
defmodule GoogleApi.Drive.V3.Model.AboutDriveThemes do
  ...
  - backgroundImageLink (String.t): A link to this theme's background image. Defaults to `nil`.
  - colorRgb (String.t): The color of this theme as an RGB hex string. Defaults to `nil`.
  - id (String.t): The ID of the theme. Defaults to `nil`.
  """
