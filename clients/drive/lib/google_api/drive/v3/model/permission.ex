...
defmodule GoogleApi.Drive.V3.Model.Permission do
  ...
  @type t :: %__MODULE__{
    ...
    :"photoLink" => any(),
    :"role" => any(),
    :"teamDrivePermissionDetails" => list(GoogleApi.Drive.V3.Model.PermissionTeamDrivePermissionDetails.t()),
    :"type" => any()
  }
  ...
  field(:"photoLink")
  field(:"role")
  field(:"teamDrivePermissionDetails", as: GoogleApi.Drive.V3.Model.PermissionTeamDrivePermissionDetails, type: :list)
  field(:"type")
end
