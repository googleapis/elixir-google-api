...
defmodule GoogleApi.Drive.V3.Model.PermissionPermissionDetails do
  ...
  - inheritedFrom (String.t): The ID of the item from which this permission is inherited. This is an output-only field and is only populated for members of the shared drive. Defaults to: `null`.
  - permissionType (String.t): The permission type for this user. While new values may be added in future, the following are currently possible:   - file  - member Defaults to: `null`.
