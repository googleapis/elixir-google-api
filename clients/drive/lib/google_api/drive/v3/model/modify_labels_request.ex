...
defmodule GoogleApi.Drive.V3.Model.ModifyLabelsRequest do
  ...
  *   `labelModifications` (*type:* `list(GoogleApi.Drive.V3.Model.LabelModification.t)`, *default:* `nil`) - The list of modifications to apply to the labels on the file.
  ...
  @type t :: %__MODULE__{
          :kind => String.t() | nil,
          :labelModifications => list(GoogleApi.Drive.V3.Model.LabelModification.t()) | nil
        }

  field(:kind)
  field(:labelModifications, as: GoogleApi.Drive.V3.Model.LabelModification, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Drive.V3.Model.ModifyLabelsRequest do
  def decode(value, options) do
    GoogleApi.Drive.V3.Model.ModifyLabelsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Drive.V3.Model.ModifyLabelsRequest do
