...
defmodule GoogleApi.Drive.V3.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Drive.V3.Model.Status do
  def decode(value, options) do
    GoogleApi.Drive.V3.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Drive.V3.Model.Status do
