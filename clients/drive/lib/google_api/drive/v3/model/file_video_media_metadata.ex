...
defmodule GoogleApi.Drive.V3.Model.FileVideoMediaMetadata do
  ...
  - durationMillis (String.t): The duration of the video in milliseconds. Defaults to `nil`.
  - height (integer()): The height of the video in pixels. Defaults to `nil`.
  - width (integer()): The width of the video in pixels. Defaults to `nil`.
  """
