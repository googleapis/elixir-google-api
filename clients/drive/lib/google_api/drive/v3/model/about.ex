...
defimpl Poison.Decoder, for: GoogleApi.Drive.V3.Model.About do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"storageQuota", :struct, GoogleApi.Drive.V3.Model.About_storageQuota, options)
    |> deserialize(:"teamDriveThemes", :list, GoogleApi.Drive.V3.Model.About_teamDriveThemes, options)
