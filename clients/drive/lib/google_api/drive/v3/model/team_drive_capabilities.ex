...
defmodule GoogleApi.Drive.V3.Model.TeamDriveCapabilities do
  ...
  - canChangeCopyRequiresWriterPermissionRestriction (boolean()): Whether the current user can change the copyRequiresWriterPermission restriction of this Team Drive. Defaults to: `null`.
  - canChangeDomainUsersOnlyRestriction (boolean()): Whether the current user can change the domainUsersOnly restriction of this Team Drive. Defaults to: `null`.
  ...
  - canChangeTeamMembersOnlyRestriction (boolean()): Whether the current user can change the teamMembersOnly restriction of this Team Drive. Defaults to: `null`.
  ...
  - canDeleteChildren (boolean()): Whether the current user can delete children from folders in this Team Drive. Defaults to: `null`.
  ...
  - canRemoveChildren (boolean()): Deprecated - use canDeleteChildren or canTrashChildren instead. Defaults to: `null`.
  ...
  - canTrashChildren (boolean()): Whether the current user can trash children from folders in this Team Drive. Defaults to: `null`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :canChangeTeamMembersOnlyRestriction => any(),
          :canComment => any(),
          :canCopy => any(),
