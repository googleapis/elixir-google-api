...
defmodule GoogleApi.Drive.V3.Model.FileContentHints do
  ...
  - indexableText (String.t): Text to be indexed for the file to improve fullText queries. This is limited to 128KB in length and may contain HTML elements. Defaults to `nil`.
  - thumbnail (GoogleApi.Drive.V3.Model.FileContentHintsThumbnail.t): A thumbnail for the file. This will only be used if Google Drive cannot generate a standard thumbnail. Defaults to `nil`.
  """
