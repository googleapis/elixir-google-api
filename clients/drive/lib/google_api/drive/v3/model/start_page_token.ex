...
defmodule GoogleApi.Drive.V3.Model.StartPageToken do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "drive#startPageToken". Defaults to `drive#startPageToken`.
  - startPageToken (String.t): The starting page token for listing changes. Defaults to `nil`.
  """
