...
defmodule GoogleApi.Drive.V3.RequestBuilder do
  @moduledoc """
  ...
  def decode(%Tesla.Env{body: body}, struct, dataWrapped: true) do
    Poison.decode(body, as: %GoogleApi.Drive.V3.RequestBuilder.DataWrapper{}, struct: struct)
    |> case do
...
defimpl Poison.Decoder, for: GoogleApi.Drive.V3.RequestBuilder.DataWrapper do
