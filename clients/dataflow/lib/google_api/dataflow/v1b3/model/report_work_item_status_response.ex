...
defmodule GoogleApi.Dataflow.V1b3.Model.ReportWorkItemStatusResponse do
  ...
  - unifiedWorkerResponse (map()): Untranslated bag-of-bytes WorkProgressUpdateResponse for UnifiedWorker. Defaults to `nil`.
  - workItemServiceStates (list(GoogleApi.Dataflow.V1b3.Model.WorkItemServiceState.t)): A set of messages indicating the service-side state for each
  WorkItem whose status was reported, in the same order as the
  WorkItemStatus messages in the ReportWorkItemStatusRequest which
  resulting in this response. Defaults to `nil`.
  """
