...
defmodule GoogleApi.Dataflow.V1b3.Model.ParDoInstruction do
  ...
  - input (GoogleApi.Dataflow.V1b3.Model.InstructionInput.t): The input. Defaults to `nil`.
  - multiOutputInfos (list(GoogleApi.Dataflow.V1b3.Model.MultiOutputInfo.t)): Information about each of the outputs, if user_fn is a  MultiDoFn. Defaults to `nil`.
  - numOutputs (integer()): The number of outputs. Defaults to `nil`.
