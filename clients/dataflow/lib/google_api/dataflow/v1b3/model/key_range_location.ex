...
defmodule GoogleApi.Dataflow.V1b3.Model.KeyRangeLocation do
  ...
  *   `deliveryEndpoint` (*type:* `String.t`, *default:* `nil`) - The physical location of this range assignment to be used for
      streaming computation cross-worker message delivery.
  *   `deprecatedPersistentDirectory` (*type:* `String.t`, *default:* `nil`) - DEPRECATED. The location of the persistent state for this range, as a
