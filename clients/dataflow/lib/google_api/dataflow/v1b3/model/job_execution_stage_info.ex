...
defmodule GoogleApi.Dataflow.V1b3.Model.JobExecutionStageInfo do
  ...
  - stepName ([String.t]): The steps associated with the execution stage. Note that stages may have several steps, and that a given step might be run by more than one stage. Defaults to: `null`.
  """
