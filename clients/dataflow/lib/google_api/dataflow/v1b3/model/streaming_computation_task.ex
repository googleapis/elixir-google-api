...
defmodule GoogleApi.Dataflow.V1b3.Model.StreamingComputationTask do
  ...
  - computationRanges (list(GoogleApi.Dataflow.V1b3.Model.StreamingComputationRanges.t)): Contains ranges of a streaming computation this task should apply to. Defaults to `nil`.
  - dataDisks (list(GoogleApi.Dataflow.V1b3.Model.MountedDataDisk.t)): Describes the set of data disks this task should apply to. Defaults to `nil`.
  - taskType (String.t): A type of streaming computation task. Defaults to `nil`.
  """
