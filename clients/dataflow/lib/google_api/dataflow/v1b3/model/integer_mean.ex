...
defmodule GoogleApi.Dataflow.V1b3.Model.IntegerMean do
  ...
  - count (GoogleApi.Dataflow.V1b3.Model.SplitInt64.t): The number of values being aggregated. Defaults to `nil`.
  - sum (GoogleApi.Dataflow.V1b3.Model.SplitInt64.t): The sum of all values being aggregated. Defaults to `nil`.
  """
