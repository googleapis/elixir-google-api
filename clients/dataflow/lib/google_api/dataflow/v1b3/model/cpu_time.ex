...
defmodule GoogleApi.Dataflow.V1b3.Model.CpuTime do
  ...
  - timestamp (DateTime.t): Timestamp of the measurement. Defaults to: `null`.
  - totalMs (String.t): Total active CPU time across all cores (ie., non-idle) in milliseconds since start-up. Defaults to: `null`.
  """
