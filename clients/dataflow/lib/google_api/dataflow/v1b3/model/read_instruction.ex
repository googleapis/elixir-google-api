...
defmodule GoogleApi.Dataflow.V1b3.Model.ReadInstruction do
  ...
  *   `source` (*type:* `GoogleApi.Dataflow.V1b3.Model.Source.t`, *default:* `nil`) - The source to read from.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.ReadInstruction do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.ReadInstruction.decode(value, options)
  end
end
