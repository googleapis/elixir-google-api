...
defmodule GoogleApi.Dataflow.V1b3.Model.SourceSplitRequest do
  ...
  - options (GoogleApi.Dataflow.V1b3.Model.SourceSplitOptions.t): Hints for tuning the splitting process. Defaults to `nil`.
  - source (GoogleApi.Dataflow.V1b3.Model.Source.t): Specification of the source to be split. Defaults to `nil`.
  """
