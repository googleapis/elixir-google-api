...
defmodule GoogleApi.Dataflow.V1b3.Model.IntegerList do
  ...
  *   `elements` (*type:* `list(GoogleApi.Dataflow.V1b3.Model.SplitInt64.t)`, *default:* `nil`) - Elements of the list.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.IntegerList do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.IntegerList.decode(value, options)
  end
end
