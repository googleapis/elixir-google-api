...
defmodule GoogleApi.Dataflow.V1b3.Model.Histogram do
  ...
  *   `bucketCounts` (*type:* `list(String.t)`, *default:* `nil`) - Counts of values in each bucket. For efficiency, prefix and trailing buckets with count = 0 are elided. Buckets can store the full range of values of an unsigned long, with ULLONG_MAX falling into the 59th bucket with range [1e19, 2e19).
  *   `firstBucketOffset` (*type:* `integer()`, *default:* `nil`) - Starting index of first stored bucket. The non-inclusive upper-bound of the ith bucket is given by: pow(10,(i-first_bucket_offset)/3) * (1,2,5)[(i-first_bucket_offset)%3]
  """
