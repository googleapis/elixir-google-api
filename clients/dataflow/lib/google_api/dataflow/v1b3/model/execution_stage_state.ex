...
defmodule GoogleApi.Dataflow.V1b3.Model.ExecutionStageState do
  ...
  - currentStateTime (DateTime.t): The time at which the stage transitioned to this state. Defaults to `nil`.
  - executionStageName (String.t): The name of the execution stage. Defaults to `nil`.
  - executionStageState (String.t): Executions stage states allow the same set of values as JobState. Defaults to `nil`.
  """
