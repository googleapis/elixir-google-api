...
defmodule GoogleApi.Dataflow.V1b3.Model.JobExecutionInfo do
  ...
  - stages (%{optional(String.t) => GoogleApi.Dataflow.V1b3.Model.JobExecutionStageInfo.t}): A mapping from each stage to the information about that stage. Defaults to `nil`.
  """
