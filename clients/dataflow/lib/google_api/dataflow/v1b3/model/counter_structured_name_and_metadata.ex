...
defmodule GoogleApi.Dataflow.V1b3.Model.CounterStructuredNameAndMetadata do
  ...
  - metadata (GoogleApi.Dataflow.V1b3.Model.CounterMetadata.t): Metadata associated with a counter Defaults to `nil`.
  - name (GoogleApi.Dataflow.V1b3.Model.CounterStructuredName.t): Structured name of the counter. Defaults to `nil`.
  """
