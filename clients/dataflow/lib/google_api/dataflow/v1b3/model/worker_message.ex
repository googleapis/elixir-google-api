...
defmodule GoogleApi.Dataflow.V1b3.Model.WorkerMessage do
  ...
  - labels (map()): Labels are used to group WorkerMessages.
  ...
  not be used here. Defaults to `nil`.
  - time (DateTime.t): The timestamp of the worker_message. Defaults to `nil`.
  - workerHealthReport (GoogleApi.Dataflow.V1b3.Model.WorkerHealthReport.t): The health of a worker. Defaults to `nil`.
  - workerLifecycleEvent (GoogleApi.Dataflow.V1b3.Model.WorkerLifecycleEvent.t): Record of worker lifecycle events. Defaults to `nil`.
  - workerMessageCode (GoogleApi.Dataflow.V1b3.Model.WorkerMessageCode.t): A worker message code. Defaults to `nil`.
  - workerMetrics (GoogleApi.Dataflow.V1b3.Model.ResourceUtilizationReport.t): Resource metrics reported by workers. Defaults to `nil`.
  - workerShutdownNotice (GoogleApi.Dataflow.V1b3.Model.WorkerShutdownNotice.t): Shutdown notice by workers. Defaults to `nil`.
  """
