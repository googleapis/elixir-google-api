...
defmodule GoogleApi.Dataflow.V1b3.Model.TransformSummary do
  ...
  - displayData (list(GoogleApi.Dataflow.V1b3.Model.DisplayData.t)): Transform-specific display data. Defaults to `nil`.
  - id (String.t): SDK generated id of this transform instance. Defaults to `nil`.
  - inputCollectionName (list(String.t)): User names for all collection inputs to this transform. Defaults to `nil`.
  - kind (String.t): Type of transform. Defaults to `nil`.
  - name (String.t): User provided name for this transform instance. Defaults to `nil`.
  - outputCollectionName (list(String.t)): User  names for all collection outputs to this transform. Defaults to `nil`.
  """
