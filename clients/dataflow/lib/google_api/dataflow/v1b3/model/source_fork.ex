...
defmodule GoogleApi.Dataflow.V1b3.Model.SourceFork do
  ...
  - primary (GoogleApi.Dataflow.V1b3.Model.SourceSplitShard.t): DEPRECATED Defaults to `nil`.
  - primarySource (GoogleApi.Dataflow.V1b3.Model.DerivedSource.t): DEPRECATED Defaults to `nil`.
  - residual (GoogleApi.Dataflow.V1b3.Model.SourceSplitShard.t): DEPRECATED Defaults to `nil`.
  - residualSource (GoogleApi.Dataflow.V1b3.Model.DerivedSource.t): DEPRECATED Defaults to `nil`.
  """
