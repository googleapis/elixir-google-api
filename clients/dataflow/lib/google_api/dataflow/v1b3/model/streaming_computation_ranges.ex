...
defmodule GoogleApi.Dataflow.V1b3.Model.StreamingComputationRanges do
  ...
  *   `rangeAssignments` (*type:* `list(GoogleApi.Dataflow.V1b3.Model.KeyRangeDataDiskAssignment.t)`, *default:* `nil`) - Data disk assignments for ranges from this computation.
  """
