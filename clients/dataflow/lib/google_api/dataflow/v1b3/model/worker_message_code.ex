...
defmodule GoogleApi.Dataflow.V1b3.Model.WorkerMessageCode do
  ...
  - code (String.t): The code is a string intended for consumption by a machine that identifies
  ...
  waiting for an API change. Defaults to `nil`.
  - parameters (map()): Parameters contains specific information about the code.
  ...
  as labels since they will be included on most messages. Defaults to `nil`.
  """
