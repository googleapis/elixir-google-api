...
defmodule GoogleApi.Dataflow.V1b3.Model.LeaseWorkItemResponse do
  ...
  - unifiedWorkerResponse (map()): Untranslated bag-of-bytes WorkResponse for UnifiedWorker. Defaults to `nil`.
  - workItems (list(GoogleApi.Dataflow.V1b3.Model.WorkItem.t)): A list of the leased WorkItems. Defaults to `nil`.
  """
