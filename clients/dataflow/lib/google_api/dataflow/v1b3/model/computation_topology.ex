...
defmodule GoogleApi.Dataflow.V1b3.Model.ComputationTopology do
  ...
  - computationId (String.t): The ID of the computation. Defaults to: `null`.
  - inputs ([StreamLocation]): The inputs to the computation. Defaults to: `null`.
  - keyRanges ([KeyRangeLocation]): The key ranges processed by the computation. Defaults to: `null`.
  - outputs ([StreamLocation]): The outputs from the computation. Defaults to: `null`.
  - stateFamilies ([StateFamilyConfig]): The state family values. Defaults to: `null`.
  - systemStageName (String.t): The system stage name. Defaults to: `null`.
  """
