...
defmodule GoogleApi.Dataflow.V1b3.Model.ComputationTopology do
  ...
  - computationId (String.t): The ID of the computation. Defaults to `nil`.
  - inputs (list(GoogleApi.Dataflow.V1b3.Model.StreamLocation.t)): The inputs to the computation. Defaults to `nil`.
  - keyRanges (list(GoogleApi.Dataflow.V1b3.Model.KeyRangeLocation.t)): The key ranges processed by the computation. Defaults to `nil`.
  - outputs (list(GoogleApi.Dataflow.V1b3.Model.StreamLocation.t)): The outputs from the computation. Defaults to `nil`.
  - stateFamilies (list(GoogleApi.Dataflow.V1b3.Model.StateFamilyConfig.t)): The state family values. Defaults to `nil`.
  - systemStageName (String.t): The system stage name. Defaults to `nil`.
  """
