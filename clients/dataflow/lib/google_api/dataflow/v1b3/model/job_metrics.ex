...
defmodule GoogleApi.Dataflow.V1b3.Model.JobMetrics do
  ...
  - metricTime (DateTime.t): Timestamp as of which metric values are current. Defaults to `nil`.
  - metrics (list(GoogleApi.Dataflow.V1b3.Model.MetricUpdate.t)): All metrics for this job. Defaults to `nil`.
  """
