...
defmodule GoogleApi.Dataflow.V1b3.Model.WorkerPool do
  ...
  - dataDisks ([Disk]): Data disks that are used by a VM in this workflow. Defaults to: `null`.
  - defaultPackageSet (String.t): The default package set to install.  This allows the service to select a default set of packages which are useful to worker harnesses written in a particular language. Defaults to: `null`.
  ...
  - diskSourceImage (String.t): Fully qualified source image for disks. Defaults to: `null`.
  - diskType (String.t): Type of root disk for VMs.  If empty or unspecified, the service will attempt to choose a reasonable default. Defaults to: `null`.
  - ipConfiguration (String.t): Configuration for VM IPs. Defaults to: `null`.
    - Enum - one of [WORKER_IP_UNSPECIFIED, WORKER_IP_PUBLIC, WORKER_IP_PRIVATE]
  - kind (String.t): The kind of the worker pool; currently only &#x60;harness&#x60; and &#x60;shuffle&#x60; are supported. Defaults to: `null`.
  - machineType (String.t): Machine type (e.g. \&quot;n1-standard-1\&quot;).  If empty or unspecified, the service will attempt to choose a reasonable default. Defaults to: `null`.
  - metadata (%{optional(String.t) &#x3D;&gt; String.t}): Metadata to set on the Google Compute Engine VMs. Defaults to: `null`.
  ...
  - onHostMaintenance (String.t): The action to take on host maintenance, as defined by the Google Compute Engine API. Defaults to: `null`.
  - packages ([Package]): Packages to be installed on workers. Defaults to: `null`.
  - poolArgs (%{optional(String.t) &#x3D;&gt; String.t}): Extra arguments for this worker pool. Defaults to: `null`.
  ...
  - workerHarnessContainerImage (String.t): Required. Docker container image that executes the Cloud Dataflow worker harness, residing in Google Container Registry. Defaults to: `null`.
  - zone (String.t): Zone to run the worker pools in.  If empty or unspecified, the service will attempt to choose a reasonable default. Defaults to: `null`.
  """
