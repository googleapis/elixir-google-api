...
defmodule GoogleApi.Dataflow.V1b3.Model.ResourceUtilizationReport do
  ...
  - cpuTime (list(GoogleApi.Dataflow.V1b3.Model.CPUTime.t)): CPU utilization samples. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.ResourceUtilizationReport do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.ResourceUtilizationReport.decode(value, options)
  end
end
