...
defmodule GoogleApi.Dataflow.V1b3.Model.TemplateMetadata do
  ...
  - description (String.t): Optional. A description of the template. Defaults to `nil`.
  - name (String.t): Required. The name of the template. Defaults to `nil`.
  - parameters (list(GoogleApi.Dataflow.V1b3.Model.ParameterMetadata.t)): The parameters for the template. Defaults to `nil`.
  """
