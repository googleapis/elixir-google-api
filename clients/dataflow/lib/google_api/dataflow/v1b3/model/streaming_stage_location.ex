...
defmodule GoogleApi.Dataflow.V1b3.Model.StreamingStageLocation do
  ...
  - streamId (String.t): Identifies the particular stream within the streaming Dataflow job. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.StreamingStageLocation do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.StreamingStageLocation.decode(value, options)
  end
end
