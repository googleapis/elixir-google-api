...
defmodule GoogleApi.Dataflow.V1b3.Model.PartialGroupByKeyInstruction do
  ...
  - input (GoogleApi.Dataflow.V1b3.Model.InstructionInput.t): Describes the input to the partial group-by-key instruction. Defaults to `nil`.
  - inputElementCodec (map()): The codec to use for interpreting an element in the input PTable. Defaults to `nil`.
  - originalCombineValuesInputStoreName (String.t): If this instruction includes a combining function this is the name of the
  intermediate store between the GBK and the CombineValues. Defaults to `nil`.
  - originalCombineValuesStepName (String.t): If this instruction includes a combining function, this is the name of the
  CombineValues instruction lifted into this instruction. Defaults to `nil`.
  - sideInputs (list(GoogleApi.Dataflow.V1b3.Model.SideInputInfo.t)): Zero or more side inputs. Defaults to `nil`.
  - valueCombiningFn (map()): The value combining function to invoke. Defaults to `nil`.
  """
