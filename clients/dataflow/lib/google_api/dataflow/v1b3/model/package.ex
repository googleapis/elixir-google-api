...
defmodule GoogleApi.Dataflow.V1b3.Model.Package do
  ...
  - location (String.t): The resource to read the package from. The supported resource type is:

  Google Cloud Storage:

  storage.googleapis.com/{bucket}
  bucket.storage.googleapis.com/ Defaults to `nil`.
  - name (String.t): The name of the package. Defaults to `nil`.
  """
