...
defmodule GoogleApi.Dataflow.V1b3.Model.Package do
  ...
  *   `location` (*type:* `String.t`, *default:* `nil`) - The resource to read the package from. The supported resource type is: Google Cloud Storage: storage.googleapis.com/{bucket} bucket.storage.googleapis.com/
