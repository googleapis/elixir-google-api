...
defmodule GoogleApi.Dataflow.V1b3.Model.SourceSplitShard do
  ...
  - derivationMode (String.t): DEPRECATED Defaults to `nil`.
  - source (GoogleApi.Dataflow.V1b3.Model.Source.t): DEPRECATED Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.SourceSplitShard do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.SourceSplitShard.decode(value, options)
  end
end
