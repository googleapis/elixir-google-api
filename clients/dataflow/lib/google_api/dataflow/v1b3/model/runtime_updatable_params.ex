...
defmodule GoogleApi.Dataflow.V1b3.Model.RuntimeUpdatableParams do
  @moduledoc """
  ...
  *   `workerUtilizationHint` (*type:* `float()`, *default:* `nil`) - Target worker utilization, compared against the aggregate utilization of the worker pool by autoscaler, to determine upscaling and downscaling when absent other constraints such as backlog. For more information, see [Update an existing pipeline](https://cloud.google.com/dataflow/docs/guides/updating-a-pipeline).
  ...
  field(:maxNumWorkers)
  field(:minNumWorkers)
  field(:workerUtilizationHint)
end

defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.RuntimeUpdatableParams do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.RuntimeUpdatableParams.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataflow.V1b3.Model.RuntimeUpdatableParams do
