...
defmodule GoogleApi.Dataflow.V1b3.Model.ListJobMessagesResponse do
  ...
  - autoscalingEvents ([AutoscalingEvent]): Autoscaling events in ascending timestamp order. Defaults to: `null`.
  - jobMessages ([JobMessage]): Messages in ascending timestamp order. Defaults to: `null`.
  - nextPageToken (String.t): The token to obtain the next page of results if there are more. Defaults to: `null`.
  """
