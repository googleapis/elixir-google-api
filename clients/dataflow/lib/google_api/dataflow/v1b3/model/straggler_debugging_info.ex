...
defmodule GoogleApi.Dataflow.V1b3.Model.StragglerDebuggingInfo do
  @moduledoc """
  ...
  *   `hotKey` (*type:* `GoogleApi.Dataflow.V1b3.Model.HotKeyDebuggingInfo.t`, *default:* `nil`) - Hot key debugging details.
  ...
  field(:hotKey, as: GoogleApi.Dataflow.V1b3.Model.HotKeyDebuggingInfo)
end

defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.StragglerDebuggingInfo do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.StragglerDebuggingInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataflow.V1b3.Model.StragglerDebuggingInfo do
