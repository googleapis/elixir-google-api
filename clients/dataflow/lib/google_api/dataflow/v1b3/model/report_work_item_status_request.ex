...
defmodule GoogleApi.Dataflow.V1b3.Model.ReportWorkItemStatusRequest do
  ...
  - unifiedWorkerRequest (map()): Untranslated bag-of-bytes WorkProgressUpdateRequest from UnifiedWorker. Defaults to `nil`.
  - workItemStatuses (list(GoogleApi.Dataflow.V1b3.Model.WorkItemStatus.t)): The order is unimportant, except that the order of the
  WorkItemServiceState messages in the ReportWorkItemStatusResponse
  corresponds to the order of WorkItemStatus messages here. Defaults to `nil`.
  - workerId (String.t): The ID of the worker reporting the WorkItem status.  If this
  does not match the ID of the worker which the Dataflow service
  believes currently has the lease on the WorkItem, the report
  will be dropped (with an error response). Defaults to `nil`.
  """
