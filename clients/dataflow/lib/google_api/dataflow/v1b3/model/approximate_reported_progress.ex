...
defmodule GoogleApi.Dataflow.V1b3.Model.ApproximateReportedProgress do
  ...
  - consumedParallelism (GoogleApi.Dataflow.V1b3.Model.ReportedParallelism.t): Total amount of parallelism in the portion of input of this task that has
  already been consumed and is no longer active. In the first two examples
  above (see remaining_parallelism), the value should be 29 or 2
  respectively.  The sum of remaining_parallelism and consumed_parallelism
  should equal the total amount of parallelism in this work item.  If
  specified, must be finite. Defaults to `nil`.
  - fractionConsumed (float()): Completion as fraction of the input consumed, from 0.0 (beginning, nothing
  consumed), to 1.0 (end of the input, entire input consumed). Defaults to `nil`.
  - position (GoogleApi.Dataflow.V1b3.Model.Position.t): A Position within the work to represent a progress. Defaults to `nil`.
  - remainingParallelism (GoogleApi.Dataflow.V1b3.Model.ReportedParallelism.t): Total amount of parallelism in the input of this task that remains,
  ...
  * If we are reading through the last block in a block-compressed file,
  ...
  additional remainder can be split off. Defaults to `nil`.
  """
