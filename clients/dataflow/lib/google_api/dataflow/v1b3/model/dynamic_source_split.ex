...
defmodule GoogleApi.Dataflow.V1b3.Model.DynamicSourceSplit do
  ...
  - primary (GoogleApi.Dataflow.V1b3.Model.DerivedSource.t): Primary part (continued to be processed by worker).
  Specified relative to the previously-current source.
  Becomes current. Defaults to `nil`.
  - residual (GoogleApi.Dataflow.V1b3.Model.DerivedSource.t): Residual part (returned to the pool of work).
  Specified relative to the previously-current source. Defaults to `nil`.
  """
