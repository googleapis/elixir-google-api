...
defmodule GoogleApi.Dataflow.V1b3.Model.StateFamilyConfig do
  ...
  *   `isRead` (*type:* `boolean()`, *default:* `nil`) - If true, this family corresponds to a read operation.
  *   `stateFamily` (*type:* `String.t`, *default:* `nil`) - The state family value.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.StateFamilyConfig do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.StateFamilyConfig.decode(value, options)
  end
end
