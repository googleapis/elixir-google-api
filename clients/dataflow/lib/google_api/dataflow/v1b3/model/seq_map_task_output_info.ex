...
defmodule GoogleApi.Dataflow.V1b3.Model.SeqMapTaskOutputInfo do
  ...
  - sink (GoogleApi.Dataflow.V1b3.Model.Sink.t): The sink to write the output value to. Defaults to `nil`.
  - tag (String.t): The id of the TupleTag the user code will tag the output value by. Defaults to `nil`.
  """
