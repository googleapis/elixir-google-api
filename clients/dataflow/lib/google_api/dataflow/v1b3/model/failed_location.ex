...
defmodule GoogleApi.Dataflow.V1b3.Model.FailedLocation do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of the [regional endpoint] (https://cloud.google.com/dataflow/docs/concepts/regional-endpoints) that failed to respond.
  """
