...
defmodule GoogleApi.Dataflow.V1b3.Model.SourceMetadata do
  ...
  - estimatedSizeBytes (String.t): An estimate of the total size (in bytes) of the data that would be
  read from this source.  This estimate is in terms of external storage
  size, before any decompression or other processing done by the reader. Defaults to `nil`.
  - infinite (boolean()): Specifies that the size of this source is known to be infinite
  (this is a streaming source). Defaults to `nil`.
  - producesSortedKeys (boolean()): Whether this source is known to produce key/value pairs with
  the (encoded) keys in lexicographically sorted order. Defaults to `nil`.
  """
