...
defmodule GoogleApi.Dataflow.V1b3.Model.ListJobsResponse do
  ...
  - failedLocation (list(GoogleApi.Dataflow.V1b3.Model.FailedLocation.t)): Zero or more messages describing the [regional endpoints]
  (https://cloud.google.com/dataflow/docs/concepts/regional-endpoints) that
  failed to respond. Defaults to `nil`.
  - jobs (list(GoogleApi.Dataflow.V1b3.Model.Job.t)): A subset of the requested job information. Defaults to `nil`.
  - nextPageToken (String.t): Set if there may be more results than fit in this response. Defaults to `nil`.
  """
