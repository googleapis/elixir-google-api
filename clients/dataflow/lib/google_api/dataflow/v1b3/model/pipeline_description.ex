...
defmodule GoogleApi.Dataflow.V1b3.Model.PipelineDescription do
  ...
  - displayData (list(GoogleApi.Dataflow.V1b3.Model.DisplayData.t)): Pipeline level display data. Defaults to `nil`.
  - executionPipelineStage (list(GoogleApi.Dataflow.V1b3.Model.ExecutionStageSummary.t)): Description of each stage of execution of the pipeline. Defaults to `nil`.
  - originalPipelineTransform (list(GoogleApi.Dataflow.V1b3.Model.TransformSummary.t)): Description of each transform in the pipeline and collections between them. Defaults to `nil`.
  """
