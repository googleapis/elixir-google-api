...
defmodule GoogleApi.Dataflow.V1b3.Model.Step do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name that identifies the step. This must be unique for each
      step with respect to all other steps in the Cloud Dataflow job.
  *   `properties` (*type:* `map()`, *default:* `nil`) - Named properties associated with the step. Each kind of
