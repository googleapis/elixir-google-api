...
defmodule GoogleApi.Dataflow.V1b3.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.Dataflow.V1b3.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.Dataflow.V1b3.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.Dataflow.V1b3.Model.Status do
  def decode(value, options) do
    GoogleApi.Dataflow.V1b3.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataflow.V1b3.Model.Status do
