...
defmodule GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampModerateSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampModerateSettings do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampModerateSettings.decode(
      value,
      options
    )
  end
