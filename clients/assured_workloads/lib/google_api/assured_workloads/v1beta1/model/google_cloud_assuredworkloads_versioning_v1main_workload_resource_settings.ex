...
defmodule GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings.decode(
      value,
      options
    )
  end
