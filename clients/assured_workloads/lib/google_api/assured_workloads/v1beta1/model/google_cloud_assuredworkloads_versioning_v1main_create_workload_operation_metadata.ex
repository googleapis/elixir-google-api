...
defmodule GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata.decode(
      value,
      options
    )
  end
