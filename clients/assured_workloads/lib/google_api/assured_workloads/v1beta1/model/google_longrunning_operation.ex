...
defmodule GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleLongrunningOperation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleRpcStatus.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - The normal response of the operation in case of success. If the original method returns no data on success, such as `Delete`, the response is `google.protobuf.Empty`. If the original method is standard `Get`/`Create`/`Update`, the response should be the resource. For other methods, the response should have the type `XxxResponse`, where `Xxx` is the original method name. For example, if the original method name is `TakeSnapshot()`, the inferred response type is `TakeSnapshotResponse`.
  ...
  @type t :: %__MODULE__{
          :done => boolean() | nil,
          :error => GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleRpcStatus.t() | nil,
          :metadata => map() | nil,
          :name => String.t() | nil,
          :response => map() | nil
        }
  ...
  field(:done)
  field(:error, as: GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleRpcStatus)
  field(:metadata, type: :map)
  field(:name)
  field(:response, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleLongrunningOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AssuredWorkloads.V1beta1.Model.GoogleLongrunningOperation do
