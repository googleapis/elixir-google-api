...
defmodule GoogleApi.AssuredWorkloads.V1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AssuredWorkloads.V1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AssuredWorkloads.V1.Model.GoogleRpcStatus do
