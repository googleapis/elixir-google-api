...
defmodule GoogleApi.AssuredWorkloads.V1.Model.GoogleLongrunningOperation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.AssuredWorkloads.V1.Model.GoogleRpcStatus.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.AssuredWorkloads.V1.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1.Model.GoogleLongrunningOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AssuredWorkloads.V1.Model.GoogleLongrunningOperation do
