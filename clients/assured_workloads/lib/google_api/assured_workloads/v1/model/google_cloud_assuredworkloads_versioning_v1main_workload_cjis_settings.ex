...
defmodule GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJISSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJISSettings do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJISSettings.decode(
      value,
      options
    )
  end
