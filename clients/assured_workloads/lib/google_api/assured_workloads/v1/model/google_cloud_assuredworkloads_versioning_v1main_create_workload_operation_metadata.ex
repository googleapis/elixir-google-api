...
defmodule GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata do
  @moduledoc """
  ...
  *   `resourceSettings` (*type:* `list(GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceSettings.t)`, *default:* `nil`) - Optional. Resource properties in the input that are used for creating/customizing workload resources.
  """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata do
  def decode(value, options) do
    GoogleApi.AssuredWorkloads.V1.Model.GoogleCloudAssuredworkloadsVersioningV1mainCreateWorkloadOperationMetadata.decode(
      value,
      options
    )
  end
