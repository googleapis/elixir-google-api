...
defmodule GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1PeripheralsReport do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1PeripheralsReport do
  def decode(value, options) do
    GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1PeripheralsReport.decode(
      value,
      options
    )
  end
