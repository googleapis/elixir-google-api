...
defmodule GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1DeviceActivityReport do
  @moduledoc """
  ...
  *   `reportTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Timestamp of when the report was collected.
  ...
  field(:deviceActivityState)
  field(:reportTime, as: DateTime)
end

defimpl Poison.Decoder,
  for: GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1DeviceActivityReport do
  def decode(value, options) do
    GoogleApi.ChromeManagement.V1.Model.GoogleChromeManagementV1DeviceActivityReport.decode(
      value,
      options
    )
  end
