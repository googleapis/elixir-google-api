...
defmodule GoogleApi.Poly.V1.Model.StartAssetImportResponse do
  ...
  - assetId (String.t): The id of newly created asset. If this is empty when the operation is
  complete it means the import failed. Please refer to the
  assetImportMessages field to understand what went wrong. Defaults to `nil`.
  - assetImportId (String.t): The id of the asset import. Defaults to `nil`.
  - assetImportMessages (list(GoogleApi.Poly.V1.Model.AssetImportMessage.t)): The message from the asset import. This will contain any warnings
  (or - in the case of failure - errors) that occurred during import. Defaults to `nil`.
  - publishUrl (String.t): The publish URL for the asset. Defaults to `nil`.
  """
