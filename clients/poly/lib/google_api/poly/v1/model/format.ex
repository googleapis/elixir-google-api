...
defmodule GoogleApi.Poly.V1.Model.Format do
  ...
  - formatComplexity (GoogleApi.Poly.V1.Model.FormatComplexity.t): Complexity stats about this representation of the asset. Defaults to `nil`.
  - formatType (String.t): A short string that identifies the format type of this representation.
  Possible values are: `FBX`, `GLTF`, `GLTF2`, `OBJ`, and `TILT`. Defaults to `nil`.
  - resources (list(GoogleApi.Poly.V1.Model.File.t)): A list of dependencies of the root element. May include, but is not
  limited to, materials, textures, and shader programs. Defaults to `nil`.
  - root (GoogleApi.Poly.V1.Model.File.t): The root of the file hierarchy. This will always be populated.
  ...
  These are contained in the resources field. Defaults to `nil`.
  """
