...
defmodule GoogleApi.OrgPolicy.V2.Api.Folders do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_constraints_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2ListConstraintsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_constraints_list(connection, parent, optional_params \\ [], opts \\ []) do
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_create(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_create(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_delete(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleProtobufEmpty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_delete(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_get(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_get_effective_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_get_effective_policy(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2ListPoliciesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_list(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec orgpolicy_folders_policies_patch(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def orgpolicy_folders_policies_patch(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
