...
defmodule GoogleApi.OrgPolicy.V2.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OrgPolicy.V2.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.OrgPolicy.V2.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OrgPolicy.V2.Model.GoogleTypeExpr do
