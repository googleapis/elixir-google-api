...
defmodule GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2ListPoliciesResponse do
  ...
  *   `policies` (*type:* `list(GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy.t)`, *default:* `nil`) - All policies that exist on the resource. It will be empty if no policies are set.
  ...
  @type t :: %__MODULE__{
          ...
          :policies => list(GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy.t()) | nil
        }

  field(:nextPageToken)
  field(:policies, as: GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2Policy, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2ListPoliciesResponse do
  def decode(value, options) do
    GoogleApi.OrgPolicy.V2.Model.GoogleCloudOrgpolicyV2ListPoliciesResponse.decode(value, options)
  end
end
