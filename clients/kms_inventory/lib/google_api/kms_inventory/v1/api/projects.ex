...
defmodule GoogleApi.KMSInventory.V1.Api.Projects do
  @moduledoc """
  ...
  def kmsinventory_projects_crypto_keys_list(
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsInventoryV1ListCryptoKeysResponse{}
        ]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  @spec kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary(
          ...
          | {:ok, list()}
          | {:error, any()}
  def kmsinventory_projects_locations_key_rings_crypto_keys_get_protected_resources_summary(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}/protectedResourcesSummary", %{
