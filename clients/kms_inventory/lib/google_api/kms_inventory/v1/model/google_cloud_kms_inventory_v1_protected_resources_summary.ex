...
defmodule GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsInventoryV1ProtectedResourcesSummary do
  @moduledoc """
  ...
  *   `resourceTypes` (*type:* `map()`, *default:* `nil`) - The number of resources protected by the key grouped by resource type.
  ...
  field(:cloudProducts, type: :map)
  field(:locations, type: :map)
  field(:name)
  field(:projectCount)
  field(:resourceCount)
  field(:resourceTypes, type: :map)
end

defimpl Poison.Decoder,
  for: GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsInventoryV1ProtectedResourcesSummary do
  def decode(value, options) do
    GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsInventoryV1ProtectedResourcesSummary.decode(
      value,
      options
    )
  end
