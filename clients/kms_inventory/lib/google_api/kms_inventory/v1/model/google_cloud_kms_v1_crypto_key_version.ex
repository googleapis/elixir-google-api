...
defmodule GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1CryptoKeyVersion do
  @moduledoc """
  ...
  *   `externalProtectionLevelOptions` (*type:* `GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1ExternalProtectionLevelOptions.t`, *default:* `nil`) - ExternalProtectionLevelOptions stores a group of additional fields for configuring a CryptoKeyVersion that are specific to the EXTERNAL protection level and EXTERNAL_VPC protection levels.
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - The current state of the CryptoKeyVersion.
  ...
  @type t :: %__MODULE__{
          ...
          :attestation =>
            GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1KeyOperationAttestation.t() | nil,
          :createTime => DateTime.t() | nil,
          :destroyEventTime => DateTime.t() | nil,
          :destroyTime => DateTime.t() | nil,
          :externalDestructionFailureReason => String.t() | nil,
          :externalProtectionLevelOptions =>
            GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1ExternalProtectionLevelOptions.t()
            | nil,
  ...
  field(:algorithm)
  field(:attestation, as: GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1KeyOperationAttestation)
  ...
  field(:externalProtectionLevelOptions,
    as: GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1ExternalProtectionLevelOptions
  )
...
defimpl Poison.Decoder, for: GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1CryptoKeyVersion do
  def decode(value, options) do
    GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1CryptoKeyVersion.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.KMSInventory.V1.Model.GoogleCloudKmsV1CryptoKeyVersion do
