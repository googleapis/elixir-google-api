...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3ListDocumentsResponse do
  @moduledoc """
  ...
  *   `totalSize` (*type:* `integer()`, *default:* `nil`) - Total count of documents queried.
  ...
  @type t :: %__MODULE__{
          :documentMetadata =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentMetadata.t()
            )
            | nil,
  ...
  field(:documentMetadata,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentMetadata,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3ListDocumentsResponse do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3ListDocumentsResponse.decode(
      value,
      options
    )
  end
