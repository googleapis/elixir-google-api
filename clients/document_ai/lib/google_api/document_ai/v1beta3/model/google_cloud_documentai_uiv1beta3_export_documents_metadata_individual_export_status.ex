...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadataIndividualExportStatus do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadataIndividualExportStatus do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ExportDocumentsMetadataIndividualExportStatus.decode(
      value,
      options
    )
  end
