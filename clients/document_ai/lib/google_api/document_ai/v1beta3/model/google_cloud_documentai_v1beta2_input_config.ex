...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2InputConfig do
  @moduledoc """
  ...
  *   `gcsSource` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2GcsSource.t`, *default:* `nil`) - The Google Cloud Storage location to read the input from. This must be a single file.
  *   `mimeType` (*type:* `String.t`, *default:* `nil`) - Required. Mimetype of the input. Current supported mimetypes are application/pdf, image/tiff, and image/gif. In addition, application/json type is supported for requests with ProcessDocumentRequest.automl_params field set. The JSON file needs to be in Document format.
  ...
  field(:contents)
  field(:gcsSource, as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2GcsSource)
  field(:mimeType)
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2InputConfig do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2InputConfig.decode(
      value,
      options
    )
  end
