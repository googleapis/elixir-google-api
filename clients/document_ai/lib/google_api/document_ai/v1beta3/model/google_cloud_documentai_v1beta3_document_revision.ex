...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevision do
  @moduledoc """
  ...
  *   `humanReview` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview.t`, *default:* `nil`) - Human Review information of this revision.
  ...
  *   `processor` (*type:* `String.t`, *default:* `nil`) - If the annotation was made by processor identify the processor by its resource name.
  ...
  @type t :: %__MODULE__{
          ...
          :humanReview =>
            GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview.t()
            | nil,
          :id => String.t() | nil,
  ...
  field(:humanReview,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevision do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentRevision.decode(
      value,
      options
    )
  end
