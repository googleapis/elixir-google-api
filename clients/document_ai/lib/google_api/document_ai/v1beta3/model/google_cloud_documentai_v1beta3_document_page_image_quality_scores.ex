...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores do
  ...
  *   `qualityScore` (*type:* `number()`, *default:* `nil`) - The overall quality score. Range `[0, 1]` where `1` is perfect quality.
  ...
  @type t :: %__MODULE__{
          :detectedDefects =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect.t()
            )
            | nil,
  ...
  field(:detectedDefects,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScoresDetectedDefect,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3DocumentPageImageQualityScores.decode(
      value,
      options
    )
  end
