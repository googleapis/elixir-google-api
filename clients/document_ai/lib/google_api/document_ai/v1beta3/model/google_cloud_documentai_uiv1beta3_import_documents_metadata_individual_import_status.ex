...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataIndividualImportStatus do
  ...
  *   `outputDocumentId` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DocumentId.t`, *default:* `nil`) - The document id of imported document if it was successful, otherwise empty.
