...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3PropertyMetadata do
  ...
  *   `fieldExtractionMetadata` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3FieldExtractionMetadata.t`, *default:* `nil`) - Field extraction metadata on the property.
  *   `inactive` (*type:* `boolean()`, *default:* `nil`) - Whether the property should be considered as "inactive".
  ...
  @type t :: %__MODULE__{
          :fieldExtractionMetadata =>
            GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3FieldExtractionMetadata.t()
            | nil,
          :inactive => boolean() | nil
        }

  field(:fieldExtractionMetadata,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3FieldExtractionMetadata
  )
