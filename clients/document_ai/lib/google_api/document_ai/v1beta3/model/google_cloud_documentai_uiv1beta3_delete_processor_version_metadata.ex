...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DeleteProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DeleteProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DeleteProcessorVersionMetadata.decode(
      value,
      options
    )
  end
