...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPage do
  ...
  *   `detectedBarcodes` (*type:* `list(GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageDetectedBarcode.t)`, *default:* `nil`) - A list of detected barcodes.
  ...
  *   `imageQualityScores` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageImageQualityScores.t`, *default:* `nil`) - Image Quality Scores.
  ...
  *   `provenance` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentProvenance.t`, *default:* `nil`) - The history of this page.
  *   `symbols` (*type:* `list(GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageSymbol.t)`, *default:* `nil`) - A list of visually detected symbols on the page.
  ...
  *   `visualElements` (*type:* `list(GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageVisualElement.t)`, *default:* `nil`) - A list of detected non-text visual elements e.g. checkbox, signature etc. on the page.
  ...
  @type t :: %__MODULE__{
          ...
          :detectedBarcodes =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageDetectedBarcode.t()
            )
            | nil,
          :detectedLanguages =>
            list(
          ...
          :image =>
            ...
            | nil,
          :imageQualityScores =>
            GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageImageQualityScores.t()
            | nil,
          :layout =>
          ...
          :symbols =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageSymbol.t()
            )
            | nil,
          :tables =>
            list(
  ...
  field(:detectedBarcodes,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageDetectedBarcode,
    type: :list
  )
  ...
  field(:imageQualityScores,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageImageQualityScores
  )
  ...
  field(:symbols,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageSymbol,
    type: :list
  )
