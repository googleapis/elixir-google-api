  ...
  *   `totalDocumentCount` (*type:* `integer()`, *default:* `nil`) - Total number of the documents that are qualified for importing.
  ...
  @type t :: %__MODULE__{
          ...
          :importConfigValidationResults =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult.t()
            )
            | nil,
  ...
  field(:importConfigValidationResults,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult,
    type: :list
  )
