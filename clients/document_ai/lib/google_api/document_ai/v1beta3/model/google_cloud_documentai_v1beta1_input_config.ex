...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1InputConfig do
  @moduledoc """
  The desired input location and metadata.

  ## Attributes

  *   `gcsSource` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1GcsSource.t`, *default:* `nil`) - The Google Cloud Storage location to read the input from. This must be a single file.
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1InputConfig do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1InputConfig.decode(
      value,
      options
    )
  end
