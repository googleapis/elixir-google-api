...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo do
  @moduledoc """
  Font and other text style attributes.

  ## Attributes

  *   `backgroundColor` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleTypeColor.t`, *default:* `nil`) - Color of the background.
  ...
  *   `textColor` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleTypeColor.t`, *default:* `nil`) - Color of the text.
  *   `underlined` (*type:* `boolean()`, *default:* `nil`) - Whether the text is underlined.
  ...
  @type t :: %__MODULE__{
          ...
          :textColor => GoogleApi.DocumentAI.V1beta3.Model.GoogleTypeColor.t() | nil,
  ...
  field(:subscript)
  field(:superscript)
  field(:textColor, as: GoogleApi.DocumentAI.V1beta3.Model.GoogleTypeColor)
  field(:underlined)
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta2DocumentPageTokenStyleInfo.decode(
      value,
      options
    )
  end
