...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadata do
  @moduledoc """
  ...
  *   `totalDocumentCount` (*type:* `integer()`, *default:* `nil`) - Total number of documents deleting from dataset.
  ...
  @type t :: %__MODULE__{
          ...
          :individualBatchDeleteStatuses =>
            list(
              GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadataIndividualBatchDeleteStatus.t()
            )
            | nil,
  ...
  field(:individualBatchDeleteStatuses,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadataIndividualBatchDeleteStatus,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta3BatchDeleteDocumentsMetadata.decode(
      value,
      options
    )
  end
