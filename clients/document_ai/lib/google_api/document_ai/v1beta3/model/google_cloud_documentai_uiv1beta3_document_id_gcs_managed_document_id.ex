...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DocumentIdGCSManagedDocumentId do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiUiv1beta3DocumentIdGCSManagedDocumentId.decode(
      value,
      options
    )
  end
