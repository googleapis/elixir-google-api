...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleRpcStatus.t`, *default:* `nil`) - The error encountered while attempting to process the document. Empty if there are no errors.
  ...
  @type t :: %__MODULE__{
          :humanReviewStatus =>
            GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1HumanReviewStatus.t() | nil,
  ...
  field(:humanReviewStatus,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1HumanReviewStatus
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus.decode(
      value,
      options
    )
  end
