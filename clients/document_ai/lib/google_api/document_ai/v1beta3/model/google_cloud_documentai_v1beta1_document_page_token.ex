...
defmodule GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageToken do
  @moduledoc """
  A detected token.
  ...
  *   `styleInfo` (*type:* `GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo.t`, *default:* `nil`) - Text style attributes.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :provenance =>
            ...
            | nil,
          :styleInfo =>
            GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo.t()
            | nil
        }

  field(:detectedBreak,
    as:
      GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageTokenDetectedBreak
  )
  ...
  field(:styleInfo,
    as: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageToken do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta3.Model.GoogleCloudDocumentaiV1beta1DocumentPageToken.decode(
      value,
      options
    )
  end
