...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata.decode(
      value,
      options
    )
  end
