...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentEntity do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. Entity type from a schema e.g. `Address`.
  ...
  @type t :: %__MODULE__{
          ...
          :normalizedValue =>
            ...
            | nil,
          :pageAnchor =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentPageAnchor.t() | nil,
          :properties =>
  ...
  field(:normalizedValue,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue
  )

  field(:pageAnchor,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentPageAnchor
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentEntity do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentEntity.decode(
      value,
      options
    )
  end
