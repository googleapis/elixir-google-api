...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1UndeployProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1UndeployProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1UndeployProcessorVersionMetadata.decode(
      value,
      options
    )
  end
