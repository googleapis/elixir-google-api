...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleTypeColor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypeColor do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleTypeColor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypeColor do
