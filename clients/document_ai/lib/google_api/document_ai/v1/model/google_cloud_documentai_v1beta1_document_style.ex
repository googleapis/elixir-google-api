...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyle do
  @moduledoc """
  ...
  *   `fontSize` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyleFontSize.t`, *default:* `nil`) - Font size.
  ...
  *   `textAnchor` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentTextAnchor.t`, *default:* `nil`) - Text anchor indexing into the Document.text.
  ...
  *   `textStyle` (*type:* `String.t`, *default:* `nil`) - Text style. Possible values are normal, italic, and oblique. https://www.w3schools.com/cssref/pr_font_font-style.asp
  ...
  @type t :: %__MODULE__{
          ...
          :fontSize =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyleFontSize.t()
            | nil,
          :fontWeight => String.t() | nil,
          :textAnchor =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentTextAnchor.t() | nil,
  ...
  field(:fontSize,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyleFontSize
  )

  field(:fontWeight)

  field(:textAnchor,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentTextAnchor
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyle do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentStyle.decode(value, options)
  end
end
