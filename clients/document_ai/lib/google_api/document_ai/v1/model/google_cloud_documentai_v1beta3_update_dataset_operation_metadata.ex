...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3UpdateDatasetOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3UpdateDatasetOperationMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3UpdateDatasetOperationMetadata.decode(
      value,
      options
    )
  end
