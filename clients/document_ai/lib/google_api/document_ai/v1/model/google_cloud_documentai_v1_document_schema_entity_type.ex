...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentSchemaEntityType do
  ...
  *   `entityTypeMetadata` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EntityTypeMetadata.t`, *default:* `nil`) - Metadata for the entity type.
  ...
  *   `properties` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentSchemaEntityTypeProperty.t)`, *default:* `nil`) - Describing the nested structure, or composition of an entity.
  ...
  @type t :: %__MODULE__{
          ...
          :entityTypeMetadata =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EntityTypeMetadata.t() | nil,
          :enumValues =>
  ...
  field(:entityTypeMetadata,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EntityTypeMetadata
  )
