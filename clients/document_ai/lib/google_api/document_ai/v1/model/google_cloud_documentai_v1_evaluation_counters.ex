...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluationCounters do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluationCounters do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1EvaluationCounters.decode(value, options)
  end
end
