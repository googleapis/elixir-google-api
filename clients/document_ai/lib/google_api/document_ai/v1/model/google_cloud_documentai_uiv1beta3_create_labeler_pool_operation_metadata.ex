...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3CreateLabelerPoolOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3CreateLabelerPoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3CreateLabelerPoolOperationMetadata.decode(
      value,
      options
    )
  end
