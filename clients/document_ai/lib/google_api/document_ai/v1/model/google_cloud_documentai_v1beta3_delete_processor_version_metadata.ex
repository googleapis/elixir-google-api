...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeleteProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeleteProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeleteProcessorVersionMetadata.decode(
      value,
      options
    )
  end
