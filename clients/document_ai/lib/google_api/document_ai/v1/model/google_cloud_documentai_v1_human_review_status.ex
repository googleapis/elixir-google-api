...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1HumanReviewStatus do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1HumanReviewStatus do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1HumanReviewStatus.decode(value, options)
  end
end
