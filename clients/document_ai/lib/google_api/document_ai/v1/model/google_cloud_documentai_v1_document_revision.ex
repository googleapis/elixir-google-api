...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevision do
  @moduledoc """
  ...
  *   `humanReview` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevisionHumanReview.t`, *default:* `nil`) - Human Review information of this revision.
  ...
  *   `processor` (*type:* `String.t`, *default:* `nil`) - If the annotation was made by processor identify the processor by its resource name.
  ...
  @type t :: %__MODULE__{
          ...
          :humanReview =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevisionHumanReview.t()
            | nil,
          :id => String.t() | nil,
  ...
  field(:humanReview,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevisionHumanReview
  )
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevision do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevision.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentRevision do
