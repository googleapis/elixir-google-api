...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1ProcessOptionsLayoutConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1ProcessOptionsLayoutConfig do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1ProcessOptionsLayoutConfig.decode(
      value,
      options
    )
  end
