...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageLayout do
  @moduledoc """
  Visual element describing a layout unit on a page.

  ## Attributes

  *   `boundingPoly` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1BoundingPoly.t`, *default:* `nil`) - The bounding polygon for the Layout.
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageLayout do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageLayout.decode(value, options)
  end
end
