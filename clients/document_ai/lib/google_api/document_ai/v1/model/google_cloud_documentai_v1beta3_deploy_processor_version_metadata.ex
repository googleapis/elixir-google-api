...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeployProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeployProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3DeployProcessorVersionMetadata.decode(
      value,
      options
    )
  end
