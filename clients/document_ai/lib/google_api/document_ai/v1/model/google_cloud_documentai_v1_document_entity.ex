...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntity do
  @moduledoc """
  ...
  *   `normalizedValue` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.t`, *default:* `nil`) - Optional. Normalized entity value. Absent if the extracted value could not be converted or the type (e.g. address) is not supported for certain parsers. This field is also only populated for certain supported document types.
  *   `pageAnchor` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageAnchor.t`, *default:* `nil`) - Optional. Represents the provenance of this entity wrt. the location on the page where it was found.
  *   `properties` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntity.t)`, *default:* `nil`) - Optional. Entities can be nested to form a hierarchical data structure representing the content in the document.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. Entity type from a schema e.g. `Address`.
  ...
  @type t :: %__MODULE__{
          ...
          :normalizedValue =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntityNormalizedValue.t()
            | nil,
          :pageAnchor =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageAnchor.t() | nil,
          :properties =>
  ...
  field(:normalizedValue,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntityNormalizedValue
  )

  field(:pageAnchor, as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageAnchor)
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntity do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentEntity do
