...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorMetadata.decode(
      value,
      options
    )
  end
