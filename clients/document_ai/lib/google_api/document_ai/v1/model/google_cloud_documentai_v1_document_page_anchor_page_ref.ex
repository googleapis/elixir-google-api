...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageAnchorPageRef do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1BoundingPoly.t`, *default:* `nil`) - Optional. Identifies the bounding polygon of a layout element on the page.
