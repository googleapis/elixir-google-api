...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeleteProcessorVersionMetadata.decode(
      value,
      options
    )
  end
