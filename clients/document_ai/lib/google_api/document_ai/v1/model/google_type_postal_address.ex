...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleTypePostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypePostalAddress do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleTypePostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypePostalAddress do
