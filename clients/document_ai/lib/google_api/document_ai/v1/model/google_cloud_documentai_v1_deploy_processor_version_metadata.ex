...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeployProcessorVersionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeployProcessorVersionMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DeployProcessorVersionMetadata.decode(
      value,
      options
    )
  end
