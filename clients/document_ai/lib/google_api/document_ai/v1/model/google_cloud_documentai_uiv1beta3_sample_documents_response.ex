...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponse do
  @moduledoc """
  ...
  *   `selectedDocuments` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponseSelectedDocument.t)`, *default:* `nil`) - The result of the sampling process.
  ...
  @type t :: %__MODULE__{
          ...
          :sampleTrainingStatus => GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus.t() | nil,
          :selectedDocuments =>
            list(
  ...
  field(:sampleTestStatus, as: GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus)
  field(:sampleTrainingStatus, as: GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus)

  field(:selectedDocuments,
    as:
      GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponseSelectedDocument,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponse do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsResponse.decode(
      value,
      options
    )
  end
