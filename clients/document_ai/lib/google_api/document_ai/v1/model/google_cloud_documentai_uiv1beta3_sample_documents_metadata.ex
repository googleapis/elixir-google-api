...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3SampleDocumentsMetadata.decode(
      value,
      options
    )
  end
