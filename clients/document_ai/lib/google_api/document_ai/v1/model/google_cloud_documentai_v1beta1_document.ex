...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1Document do
  ...
  *   `entityRelations` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentEntityRelation.t)`, *default:* `nil`) - Relationship among Document.entities.
  ...
  *   `revisions` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentRevision.t)`, *default:* `nil`) - Revision history of this document.
  ...
  *   `textChanges` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta1DocumentTextChange.t)`, *default:* `nil`) - A list of text corrections made to [Document.text]. This is usually used for annotating corrections to OCR mistakes. Text changes for a given revision may not overlap with each other.
