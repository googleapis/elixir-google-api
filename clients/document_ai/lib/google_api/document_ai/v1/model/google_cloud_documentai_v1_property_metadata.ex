...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1PropertyMetadata do
  @moduledoc """
  ...
  *   `humanReviewMetadata` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1HumanReviewValidationMetadata.t`, *default:* `nil`) - Human review validation config on the property.
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1PropertyMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1PropertyMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1PropertyMetadata do
