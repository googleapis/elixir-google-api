...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3TrainProcessorVersionMetadataDatasetValidation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3TrainProcessorVersionMetadataDatasetValidation do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1beta3TrainProcessorVersionMetadataDatasetValidation.decode(
      value,
      options
    )
  end
