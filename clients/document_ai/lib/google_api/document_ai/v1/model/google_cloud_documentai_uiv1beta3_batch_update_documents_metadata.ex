...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadata do
  @moduledoc """
  ...
  *   `individualBatchUpdateStatuses` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadataIndividualBatchUpdateStatus.t)`, *default:* `nil`) - The list of response details of each document.
  ...
  @type t :: %__MODULE__{
          ...
          :individualBatchUpdateStatuses =>
            list(
              GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadataIndividualBatchUpdateStatus.t()
            )
            | nil
        }
  ...
  field(:individualBatchUpdateStatuses,
    as:
      GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadataIndividualBatchUpdateStatus,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3BatchUpdateDocumentsMetadata.decode(
      value,
      options
    )
  end
