...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleTypeDateTime do
  @moduledoc """
  ...
  *   `timeZone` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleTypeTimeZone.t`, *default:* `nil`) - Time zone.
  ...
  *   `year` (*type:* `integer()`, *default:* `nil`) - Optional. Year of date. Must be from 1 to 9999, or 0 if specifying a datetime without a year.
  ...
  @type t :: %__MODULE__{
          ...
          :nanos => integer() | nil,
          :seconds => integer() | nil,
          :timeZone => GoogleApi.DocumentAI.V1.Model.GoogleTypeTimeZone.t() | nil,
  ...
  field(:nanos)
  field(:seconds)
  field(:timeZone, as: GoogleApi.DocumentAI.V1.Model.GoogleTypeTimeZone)
  field(:utcOffset)
  field(:year)
end

defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypeDateTime do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleTypeDateTime.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1.Model.GoogleTypeDateTime do
