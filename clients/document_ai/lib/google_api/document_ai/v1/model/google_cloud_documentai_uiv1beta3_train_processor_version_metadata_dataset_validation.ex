...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionMetadataDatasetValidation do
  @moduledoc """
  ...
  *   `documentErrors` (*type:* `list(GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus.t)`, *default:* `nil`) - Error information pertaining to specific documents. A maximum of 10 document errors will be returned. Any document with errors will not be used throughout training.
  ...
  @type t :: %__MODULE__{
          ...
          :datasetErrors => list(GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus.t()) | nil,
          :documentErrorCount => integer() | nil,
          :documentErrors => list(GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus.t()) | nil
        }

  field(:datasetErrorCount)
  field(:datasetErrors, as: GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus, type: :list)
  field(:documentErrorCount)
  field(:documentErrors, as: GoogleApi.DocumentAI.V1.Model.GoogleRpcStatus, type: :list)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionMetadataDatasetValidation do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiUiv1beta3TrainProcessorVersionMetadataDatasetValidation.decode(
      value,
      options
    )
  end
