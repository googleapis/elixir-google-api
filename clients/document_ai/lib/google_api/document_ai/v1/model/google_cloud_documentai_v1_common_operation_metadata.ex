...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1CommonOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1CommonOperationMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1CommonOperationMetadata.decode(
      value,
      options
    )
  end
