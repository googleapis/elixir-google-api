...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken do
  @moduledoc """
  A detected token.
  ...
  *   `styleInfo` (*type:* `GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo.t`, *default:* `nil`) - Text style attributes.
  ...
  @type t :: %__MODULE__{
          :detectedBreak =>
            GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak.t()
            | nil,
          :detectedLanguages =>
            list(
  ...
  field(:detectedBreak,
    as: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken.decode(value, options)
  end
end
