...
defmodule GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfig do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1.Model.GoogleCloudDocumentaiV1DocumentOutputConfigGcsOutputConfig.decode(
      value,
      options
    )
  end
