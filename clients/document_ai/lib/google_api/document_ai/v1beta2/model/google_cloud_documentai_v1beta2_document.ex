...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2Document do
  ...
  *   `textStyles` (*type:* `list(GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2DocumentStyle.t)`, *default:* `nil`) - Placeholder. Styles for the Document.text.
