...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1InputConfig do
  @moduledoc """
  ...
  *   `mimeType` (*type:* `String.t`, *default:* `nil`) - Required. Mimetype of the input. Current supported mimetypes are application/pdf, image/tiff, and image/gif. In addition, application/json type is supported for requests with ProcessDocumentRequest.automl_params field set. The JSON file needs to be in Document format.
  ...
  @type t :: %__MODULE__{
          :gcsSource =>
            GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1GcsSource.t() | nil,
          :mimeType => String.t() | nil
        }

  field(:gcsSource, as: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1GcsSource)
  field(:mimeType)
end

defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1InputConfig do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1InputConfig.decode(
      value,
      options
    )
  end
