...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadata do
  @moduledoc """
  ...
  *   `importConfigValidationResults` (*type:* `list(GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult.t)`, *default:* `nil`) - Validation statuses of the batch documents import config.
  ...
  *   `totalDocumentCount` (*type:* `integer()`, *default:* `nil`) - Total number of the documents that are qualified for importing.
  ...
  @type t :: %__MODULE__{
          ...
          :importConfigValidationResults =>
            list(
              GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult.t()
            )
            | nil,
  ...
  field(:importConfigValidationResults,
    as:
      GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadataImportConfigValidationResult,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ImportDocumentsMetadata.decode(
      value,
      options
    )
  end
