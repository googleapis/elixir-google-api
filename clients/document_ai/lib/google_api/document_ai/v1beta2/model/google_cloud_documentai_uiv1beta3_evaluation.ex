...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3Evaluation do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the evaluation. Format: projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}/evaluations/{evaluation}
  ...
  field(:allEntitiesMetrics,
    as:
      GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3EvaluationMultiConfidenceMetrics
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3Evaluation do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3Evaluation.decode(
      value,
      options
    )
  end
