...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2BatchProcessDocumentsResponse do
  ...
  *   `responses` (*type:* `list(GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2ProcessDocumentResponse.t)`, *default:* `nil`) - Responses for each individual document.
  ...
  field(:responses,
    as: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2ProcessDocumentResponse,
    type: :list
  )
end
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2BatchProcessDocumentsResponse do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta2BatchProcessDocumentsResponse.decode(
      value,
      options
    )
  end
