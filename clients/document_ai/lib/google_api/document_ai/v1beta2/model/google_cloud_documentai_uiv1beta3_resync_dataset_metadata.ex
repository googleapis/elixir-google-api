...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadata do
  ...
  *   `newlyAddedDocuments` (*type:* `list(GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadataUpdatedDocument.t)`, *default:* `nil`) - Returns the newly added document Cloud Storage prefix if the documents are founded in Cloud Storage while not in Document Service storage.
  ...
  @type t :: %__MODULE__{
          ...
          :newlyAddedDocuments =>
            list(
              GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadataUpdatedDocument.t()
            )
            | nil
        }
  ...
  field(:newlyAddedDocuments,
    as:
      GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadataUpdatedDocument,
    type: :list
  )
end
