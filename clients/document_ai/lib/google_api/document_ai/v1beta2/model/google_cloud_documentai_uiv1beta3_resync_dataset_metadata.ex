...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadata do
  @moduledoc """
  ...
  *   `datasetResyncStatuses` (*type:* `list(GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadataDatasetResyncStatus.t)`, *default:* `nil`) - The list of dataset resync statuses. Not checked when ResyncDatasetRequest.dataset_documents is specified.
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3ResyncDatasetMetadata.decode(
      value,
      options
    )
  end
