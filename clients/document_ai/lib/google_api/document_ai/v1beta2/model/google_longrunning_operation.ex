...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleLongrunningOperation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.DocumentAI.V1beta2.Model.GoogleRpcStatus.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleLongrunningOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleLongrunningOperation do
