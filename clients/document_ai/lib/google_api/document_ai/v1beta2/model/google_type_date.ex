...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDate do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDate do
