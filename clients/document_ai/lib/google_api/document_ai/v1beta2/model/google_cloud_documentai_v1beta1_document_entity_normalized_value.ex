...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue do
  @moduledoc """
  ...
  *   `text` (*type:* `String.t`, *default:* `nil`) - Optional. An optional field to store a normalized string. For some entity types, one of respective `structured_value` fields may also be populated. Also not all the types of `structured_value` will be normalized. For example, some processors may not generate `float` or `integer` normalized text by default. Below are sample formats mapped to structured values. - Money/Currency type (`money_value`) is in the ISO 4217 text format. - Date type (`date_value`) is in the ISO 8601 text format. - Datetime type (`datetime_value`) is in the ISO 8601 text format.
  ...
  @type t :: %__MODULE__{
          :addressValue => GoogleApi.DocumentAI.V1beta2.Model.GoogleTypePostalAddress.t() | nil,
          :booleanValue => boolean() | nil,
          :dateValue => GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDate.t() | nil,
          :datetimeValue => GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeDateTime.t() | nil,
          :floatValue => number() | nil,
          :integerValue => integer() | nil,
          :moneyValue => GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeMoney.t() | nil,
          :text => String.t() | nil
        }
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentEntityNormalizedValue.decode(
      value,
      options
    )
  end
