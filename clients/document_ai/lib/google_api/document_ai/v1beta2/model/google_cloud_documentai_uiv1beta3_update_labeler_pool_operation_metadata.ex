...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3UpdateLabelerPoolOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3UpdateLabelerPoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiUiv1beta3UpdateLabelerPoolOperationMetadata.decode(
      value,
      options
    )
  end
