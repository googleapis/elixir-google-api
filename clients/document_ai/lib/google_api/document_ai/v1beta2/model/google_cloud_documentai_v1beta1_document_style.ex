...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentStyle do
  @moduledoc """
  ...
  *   `textStyle` (*type:* `String.t`, *default:* `nil`) - [Text style](https://www.w3schools.com/cssref/pr_font_font-style.asp). Possible values are `normal`, `italic`, and `oblique`.
  ...
  field(:color, as: GoogleApi.DocumentAI.V1beta2.Model.GoogleTypeColor)
  field(:fontFamily)

  field(:fontSize,
    as: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentStyleFontSize
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentStyle do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1beta1DocumentStyle.decode(
      value,
      options
    )
  end
