...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1alpha1CommonOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1alpha1CommonOperationMetadata do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleCloudDocumentaiV1alpha1CommonOperationMetadata.decode(
      value,
      options
    )
  end
