...
defmodule GoogleApi.DocumentAI.V1beta2.Model.GoogleTypePostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleTypePostalAddress do
  def decode(value, options) do
    GoogleApi.DocumentAI.V1beta2.Model.GoogleTypePostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DocumentAI.V1beta2.Model.GoogleTypePostalAddress do
