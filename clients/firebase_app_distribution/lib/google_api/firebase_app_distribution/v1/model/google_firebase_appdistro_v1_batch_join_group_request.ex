...
defmodule GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1BatchJoinGroupRequest do
  @moduledoc """
  ...
  *   `emails` (*type:* `list(String.t)`, *default:* `nil`) - Required. The emails of the testers to be added to the group. A maximum of 999 and a minimum of 1 tester can be created in a batch.
  ...
  field(:createMissingTesters)
  field(:emails, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1BatchJoinGroupRequest do
  def decode(value, options) do
    GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1BatchJoinGroupRequest.decode(
      value,
      options
    )
  end
