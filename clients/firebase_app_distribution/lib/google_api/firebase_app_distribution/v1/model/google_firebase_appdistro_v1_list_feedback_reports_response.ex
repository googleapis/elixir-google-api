...
defmodule GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1ListFeedbackReportsResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A short-lived token, which can be sent as `pageToken` to retrieve the next page. If this field is omitted, there are no subsequent pages.
  ...
  field(:feedbackReports,
    as: GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1FeedbackReport,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1ListFeedbackReportsResponse do
  def decode(value, options) do
    GoogleApi.FirebaseAppDistribution.V1.Model.GoogleFirebaseAppdistroV1ListFeedbackReportsResponse.decode(
      value,
      options
    )
  end
