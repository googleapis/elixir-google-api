...
defmodule GoogleApi.FirebaseAppDistribution.V1.Model.GdataObjectId do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.FirebaseAppDistribution.V1.Model.GdataObjectId do
  def decode(value, options) do
    GoogleApi.FirebaseAppDistribution.V1.Model.GdataObjectId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.FirebaseAppDistribution.V1.Model.GdataObjectId do
