...
defmodule GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainObservabilityMetricData do
  @moduledoc """
  ...
  *   `value` (*type:* `GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterProtoCommonTypedValue.t`, *default:* `nil`) - Required. Value of the metric type.
  ...
  @type t :: %__MODULE__{
          ...
          :value =>
            GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterProtoCommonTypedValue.t() | nil
        }
  ...
  field(:resourceName)
  field(:value, as: GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterProtoCommonTypedValue)
end

defimpl Poison.Decoder,
  for: GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainObservabilityMetricData do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainObservabilityMetricData.decode(
      value,
      options
    )
  end
