...
defmodule GoogleApi.AlloyDB.V1.Model.FailoverInstanceRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AlloyDB.V1.Model.FailoverInstanceRequest do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.FailoverInstanceRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlloyDB.V1.Model.FailoverInstanceRequest do
