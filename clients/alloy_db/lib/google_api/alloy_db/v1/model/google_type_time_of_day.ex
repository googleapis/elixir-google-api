...
defmodule GoogleApi.AlloyDB.V1.Model.GoogleTypeTimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AlloyDB.V1.Model.GoogleTypeTimeOfDay do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.GoogleTypeTimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlloyDB.V1.Model.GoogleTypeTimeOfDay do
