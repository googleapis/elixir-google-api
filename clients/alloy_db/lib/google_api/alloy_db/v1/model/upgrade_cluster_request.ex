...
defmodule GoogleApi.AlloyDB.V1.Model.UpgradeClusterRequest do
  ...
  *   `validateOnly` (*type:* `boolean()`, *default:* `nil`) - Optional. If set, performs request validation (e.g. permission checks and any other type of validation), but does not actually execute the upgrade.
