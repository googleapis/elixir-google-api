...
defmodule GoogleApi.AlloyDB.V1.Model.StageInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AlloyDB.V1.Model.StageInfo do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.StageInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlloyDB.V1.Model.StageInfo do
