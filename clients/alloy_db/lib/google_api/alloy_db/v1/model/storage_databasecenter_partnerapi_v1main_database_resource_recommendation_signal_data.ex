...
defmodule GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainDatabaseResourceRecommendationSignalData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainDatabaseResourceRecommendationSignalData do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainDatabaseResourceRecommendationSignalData.decode(
      value,
      options
    )
  end
