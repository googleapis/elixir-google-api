...
defmodule GoogleApi.AlloyDB.V1.Model.SwitchoverClusterRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AlloyDB.V1.Model.SwitchoverClusterRequest do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.SwitchoverClusterRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlloyDB.V1.Model.SwitchoverClusterRequest do
