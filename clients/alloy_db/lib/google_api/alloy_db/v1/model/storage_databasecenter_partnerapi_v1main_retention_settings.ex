...
defmodule GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainRetentionSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainRetentionSettings do
  def decode(value, options) do
    GoogleApi.AlloyDB.V1.Model.StorageDatabasecenterPartnerapiV1mainRetentionSettings.decode(
      value,
      options
    )
  end
