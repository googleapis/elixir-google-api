...
defmodule GoogleApi.AndroidManagement.V1.Model.DpcMigrationInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.DpcMigrationInfo do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.DpcMigrationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.DpcMigrationInfo do
