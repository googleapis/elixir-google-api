...
defmodule GoogleApi.AndroidManagement.V1.Model.KeyImportEvent do
  @moduledoc """
  ...
  *   `applicationUid` (*type:* `integer()`, *default:* `nil`) - UID of the application which imported the key
...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.KeyImportEvent do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.KeyImportEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.KeyImportEvent do
