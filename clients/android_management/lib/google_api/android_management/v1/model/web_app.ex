...
defmodule GoogleApi.AndroidManagement.V1.Model.WebApp do
  ...
  *   `versionCode` (*type:* `String.t`, *default:* `nil`) - The current version of the app.<p>Note that the version can automatically increase during the lifetime of the web app, while Google does internal housekeeping to keep the web app up-to-date.
  """
