...
defmodule GoogleApi.AndroidManagement.V1.Model.WebApp do
  ...
  - displayMode (String.t): The display mode of the web app. Defaults to `nil`.
  - icons (list(GoogleApi.AndroidManagement.V1.Model.WebAppIcon.t)): A list of icons for the web app. Must have at least one element. Defaults to `nil`.
  - name (String.t): The name of the web app, which is generated by the server during creation in the form enterprises/{enterpriseId}/webApps/{packageName}. Defaults to `nil`.
  ...
  - versionCode (String.t): The current version of the app.<p>Note that the version can automatically increase during the lifetime of the web app, while Google does internal housekeeping to keep the web app up-to-date. Defaults to `nil`.
  """
