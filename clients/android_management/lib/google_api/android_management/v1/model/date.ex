...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.Date do
