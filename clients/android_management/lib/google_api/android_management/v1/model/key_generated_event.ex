...
defmodule GoogleApi.AndroidManagement.V1.Model.KeyGeneratedEvent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.KeyGeneratedEvent do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.KeyGeneratedEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.KeyGeneratedEvent do
