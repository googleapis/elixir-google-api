...
defmodule GoogleApi.AndroidManagement.V1.Model.CertAuthorityInstalledEvent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.CertAuthorityInstalledEvent do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.CertAuthorityInstalledEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.CertAuthorityInstalledEvent do
