...
defmodule GoogleApi.AndroidManagement.V1.Model.KeyIntegrityViolationEvent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidManagement.V1.Model.KeyIntegrityViolationEvent do
  def decode(value, options) do
    GoogleApi.AndroidManagement.V1.Model.KeyIntegrityViolationEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidManagement.V1.Model.KeyIntegrityViolationEvent do
