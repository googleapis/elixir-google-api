...
defmodule GoogleApi.CivicInfo.V2.Api.Divisions do
  ...
  """
  @spec civicinfo_divisions_search(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.CivicInfo.V2.Model.DivisionSearchResponse.t} | {:error, Tesla.Env.t}
  def civicinfo_divisions_search(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.CivicInfo.V2.Model.DivisionSearchResponse{})
  end
end
