...
defmodule GoogleApi.CivicInfo.V2.Model.CivicinfoApiprotosV2RepresentativeInfoData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CivicInfo.V2.Model.CivicinfoApiprotosV2RepresentativeInfoData do
  def decode(value, options) do
    GoogleApi.CivicInfo.V2.Model.CivicinfoApiprotosV2RepresentativeInfoData.decode(value, options)
  end
end
