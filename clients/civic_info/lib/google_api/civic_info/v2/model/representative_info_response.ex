...
defmodule GoogleApi.CivicInfo.V2.Model.RepresentativeInfoResponse do
  ...
  - divisions (%{optional(String.t) &#x3D;&gt; GeographicDivision}): Political geographic divisions that contain the requested address. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;civicinfo#representativeInfoResponse\&quot;. Defaults to: `null`.
  - normalizedInput (SimpleAddressType): The normalized version of the requested address Defaults to: `null`.
  - offices ([Office]): Elected offices referenced by the divisions listed above. Will only be present if includeOffices was true in the request. Defaults to: `null`.
  - officials ([Official]): Officials holding the offices listed above. Will only be present if includeOffices was true in the request. Defaults to: `null`.
  """
