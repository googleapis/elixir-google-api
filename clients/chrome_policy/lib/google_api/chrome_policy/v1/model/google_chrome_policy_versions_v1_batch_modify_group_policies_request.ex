...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest do
  @moduledoc """
  ...
  *   `requests` (*type:* `list(GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest.t)`, *default:* `nil`) - List of policies to modify as defined by the `requests`. All requests in the list must follow these restrictions: 1. All schemas in the list must have the same root namespace. 2. All `policyTargetKey.targetResource` values must point to a group resource. 3. All `policyTargetKey` values must have the same `app_id` key name in the `additionalTargetKeys`. 4. No two modification requests can reference the same `policySchema` + ` policyTargetKey` pair. 
  ...
  @type t :: %__MODULE__{
          :requests =>
            list(
              GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest.t()
            )
            | nil
        }

  field(:requests,
    as: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ModifyGroupPolicyRequest,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest.decode(
      value,
      options
    )
  end
