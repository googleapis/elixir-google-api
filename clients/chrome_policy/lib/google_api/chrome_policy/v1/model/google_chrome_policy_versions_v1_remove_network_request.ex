...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1RemoveNetworkRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1RemoveNetworkRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1RemoveNetworkRequest.decode(
      value,
      options
    )
  end
