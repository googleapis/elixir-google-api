...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1DefineCertificateResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1DefineCertificateResponse do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1DefineCertificateResponse.decode(
      value,
      options
    )
  end
