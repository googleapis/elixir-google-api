...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest.decode(
      value,
      options
    )
  end
