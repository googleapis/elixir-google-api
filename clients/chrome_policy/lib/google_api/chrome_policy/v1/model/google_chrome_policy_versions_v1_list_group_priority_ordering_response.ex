...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.decode(
      value,
      options
    )
  end
