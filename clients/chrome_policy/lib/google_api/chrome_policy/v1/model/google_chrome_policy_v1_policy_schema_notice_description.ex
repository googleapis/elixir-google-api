...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaNoticeDescription do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaNoticeDescription do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaNoticeDescription.decode(
      value,
      options
    )
  end
