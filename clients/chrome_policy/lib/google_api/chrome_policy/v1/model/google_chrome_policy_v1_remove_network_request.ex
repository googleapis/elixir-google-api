...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1RemoveNetworkRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1RemoveNetworkRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1RemoveNetworkRequest.decode(
      value,
      options
    )
  end
