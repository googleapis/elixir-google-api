...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ListGroupPriorityOrderingResponse do
  @moduledoc """
  ...
  *   `policyTargetKey` (*type:* `GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicyTargetKey.t`, *default:* `nil`) - Output only. The target resource for which the group priority ordering has been retrieved.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ListGroupPriorityOrderingResponse do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ListGroupPriorityOrderingResponse.decode(
      value,
      options
    )
  end
