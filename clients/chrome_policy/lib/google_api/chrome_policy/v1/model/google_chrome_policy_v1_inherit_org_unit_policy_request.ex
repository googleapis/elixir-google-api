...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1InheritOrgUnitPolicyRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1InheritOrgUnitPolicyRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1InheritOrgUnitPolicyRequest.decode(
      value,
      options
    )
  end
