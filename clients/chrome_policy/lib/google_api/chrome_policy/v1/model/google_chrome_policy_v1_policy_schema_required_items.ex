...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaRequiredItems do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaRequiredItems do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicySchemaRequiredItems.decode(
      value,
      options
    )
  end
