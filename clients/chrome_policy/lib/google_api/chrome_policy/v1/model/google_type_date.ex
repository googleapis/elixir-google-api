...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleTypeDate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ChromePolicy.V1.Model.GoogleTypeDate do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleTypeDate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ChromePolicy.V1.Model.GoogleTypeDate do
