...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyOrgUnitPolicyRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyOrgUnitPolicyRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyOrgUnitPolicyRequest.decode(
      value,
      options
    )
  end
