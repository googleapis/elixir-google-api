...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1UploadPolicyFileRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1UploadPolicyFileRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1UploadPolicyFileRequest.decode(
      value,
      options
    )
  end
