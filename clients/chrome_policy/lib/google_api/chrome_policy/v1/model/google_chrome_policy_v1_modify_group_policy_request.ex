...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyGroupPolicyRequest do
  @moduledoc """
  Request parameters for modifying a policy value for a specific group target.

  ## Attributes

  *   `policyTargetKey` (*type:* `GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicyTargetKey.t`, *default:* `nil`) - Required. The key of the target for which we want to modify a policy. The target resource must point to a Group.
  ...
  *   `updateMask` (*type:* `String.t`, *default:* `nil`) - Required. Policy fields to update. Only fields in this mask will be updated; other fields in `policy_value` will be ignored (even if they have values). If a field is in this list it must have a value in 'policy_value'.
  ...
  field(:policyValue, as: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1PolicyValue)
  field(:updateMask)
end

defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyGroupPolicyRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1ModifyGroupPolicyRequest.decode(
      value,
      options
    )
  end
