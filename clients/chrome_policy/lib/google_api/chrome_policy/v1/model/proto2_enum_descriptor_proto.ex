...
defmodule GoogleApi.ChromePolicy.V1.Model.Proto2EnumDescriptorProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ChromePolicy.V1.Model.Proto2EnumDescriptorProto do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.Proto2EnumDescriptorProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ChromePolicy.V1.Model.Proto2EnumDescriptorProto do
