...
defmodule GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1DefineCertificateRequest do
  @moduledoc """
  ...
  *   `settings` (*type:* `list(GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1NetworkSetting.t)`, *default:* `nil`) - Optional. Certificate settings within the chrome.networks.certificates namespace.
...
defimpl Poison.Decoder,
  for: GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1DefineCertificateRequest do
  def decode(value, options) do
    GoogleApi.ChromePolicy.V1.Model.GoogleChromePolicyV1DefineCertificateRequest.decode(
      value,
      options
    )
  end
