...
defmodule GoogleApi.Integrations.V1.Api.Callback do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def integrations_callback_generate_token(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/callback:generateToken", %{})
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaGenerateTokenResponse{}
        ]
    )
  end
end
