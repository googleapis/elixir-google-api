...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoFailurePolicy do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoFailurePolicy do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoFailurePolicy.decode(value, options)
  end
end
