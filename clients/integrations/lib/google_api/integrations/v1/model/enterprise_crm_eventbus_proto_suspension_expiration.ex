...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoSuspensionExpiration do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoSuspensionExpiration do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoSuspensionExpiration.decode(
      value,
      options
    )
  end
