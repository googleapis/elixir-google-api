...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCloudLoggingDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCloudLoggingDetails do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCloudLoggingDetails.decode(
      value,
      options
    )
  end
