...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNodeIdentifier do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNodeIdentifier do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNodeIdentifier.decode(
      value,
      options
    )
  end
