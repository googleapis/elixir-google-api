...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlowGoogleManaged do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlowGoogleManaged do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlowGoogleManaged.decode(
      value,
      options
    )
  end
