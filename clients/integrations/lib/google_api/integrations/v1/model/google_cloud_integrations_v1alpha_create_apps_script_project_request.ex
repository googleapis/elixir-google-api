...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest.decode(
      value,
      options
    )
  end
