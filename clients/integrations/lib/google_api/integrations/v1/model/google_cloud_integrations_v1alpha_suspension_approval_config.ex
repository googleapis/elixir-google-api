...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig do
  @moduledoc """
  ...
  *   `expiration` (*type:* `GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration.t`, *default:* `nil`) - Indicates the next steps when no external actions happen on the suspension.
  ...
  @type t :: %__MODULE__{
          ...
          :expiration =>
            GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration.t()
            | nil
        }
  ...
  field(:expiration,
    as: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig.decode(
      value,
      options
    )
  end
