...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoLoopMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoLoopMetadata do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoLoopMetadata.decode(value, options)
  end
end
