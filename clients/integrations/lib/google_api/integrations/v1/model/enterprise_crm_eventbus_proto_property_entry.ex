...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoPropertyEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoPropertyEntry do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoPropertyEntry.decode(value, options)
  end
end
