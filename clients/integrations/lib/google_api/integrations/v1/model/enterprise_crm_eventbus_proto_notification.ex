...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNotification do
  @moduledoc """
  ...
  *   `request` (*type:* `GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoCustomSuspensionRequest.t`, *default:* `nil`) - If the out-of-the-box email/pubsub notifications are not suitable and custom logic is required, fire a workflow containing all info needed to notify users to resume execution.
  ...
  field(:buganizerNotification,
    as: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoBuganizerNotification
  )

  field(:emailAddress, as: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoAddress)
  field(:escalatorQueue)
  field(:pubsubTopic)

  field(:request,
    as: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoCustomSuspensionRequest
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNotification do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoNotification.decode(value, options)
  end
end
