...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecution do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Last modified time of the execution.
  ...
  field(:eventExecutionDetails,
    as: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoEventExecutionDetails
  )

  field(:executionDetails,
    as: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecutionDetails
  )
  ...
  field(:replayInfo,
    as: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecutionReplayInfo
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecution do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecution.decode(value, options)
  end
end
