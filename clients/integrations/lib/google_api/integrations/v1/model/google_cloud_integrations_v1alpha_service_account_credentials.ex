...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaServiceAccountCredentials do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaServiceAccountCredentials do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaServiceAccountCredentials.decode(
      value,
      options
    )
  end
