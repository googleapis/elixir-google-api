...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials.decode(
      value,
      options
    )
  end
