...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmLoggingGwsFieldLimits do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Integrations.V1.Model.EnterpriseCrmLoggingGwsFieldLimits do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmLoggingGwsFieldLimits.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Integrations.V1.Model.EnterpriseCrmLoggingGwsFieldLimits do
