...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskMetadataAdmin do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskMetadataAdmin do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskMetadataAdmin.decode(
      value,
      options
    )
  end
