...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaAttemptStats do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaAttemptStats do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaAttemptStats.decode(
      value,
      options
    )
  end
