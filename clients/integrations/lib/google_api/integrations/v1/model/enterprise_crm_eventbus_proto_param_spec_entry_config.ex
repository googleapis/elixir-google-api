...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoParamSpecEntryConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoParamSpecEntryConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoParamSpecEntryConfig.decode(
      value,
      options
    )
  end
