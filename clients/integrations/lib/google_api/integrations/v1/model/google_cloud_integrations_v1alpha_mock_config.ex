...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaMockConfig do
  @moduledoc """
  ...
  *   `parameters` (*type:* `list(GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaEventParameter.t)`, *default:* `nil`) - Optional. List of key-value pairs for specific mock strategy
  ...
  @type t :: %__MODULE__{
          ...
          :parameters =>
            list(GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaEventParameter.t())
            | nil
        }
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaMockConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaMockConfig.decode(
      value,
      options
    )
  end
