...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails do
  @moduledoc """
  ...
  *   `integrationDescription` (*type:* `String.t`, *default:* `nil`) - Optional. Description of the sub integration which would be created via templates.
  ...
  field(:integration)
  field(:integrationDescription)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails.decode(
      value,
      options
    )
  end
