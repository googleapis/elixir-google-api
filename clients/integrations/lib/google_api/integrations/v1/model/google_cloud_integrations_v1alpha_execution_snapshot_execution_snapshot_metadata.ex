...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata.decode(
      value,
      options
    )
  end
