...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskAlertConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskAlertConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmEventbusProtoTaskAlertConfig.decode(
      value,
      options
    )
  end
