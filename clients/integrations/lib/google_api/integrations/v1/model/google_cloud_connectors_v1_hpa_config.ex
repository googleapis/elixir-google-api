...
defmodule GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1HPAConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1HPAConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1HPAConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Integrations.V1.Model.GoogleCloudConnectorsV1HPAConfig do
