...
defmodule GoogleApi.Integrations.V1.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot do
  @moduledoc """
  ...
  *   `diffParams` (*type:* `GoogleApi.Integrations.V1.Model.EnterpriseCrmFrontendsEventbusProtoEventParameters.t`, *default:* `nil`) - The parameters in Event object that differs from last snapshot.
  ...
  *   `eventParams` (*type:* `GoogleApi.Integrations.V1.Model.EnterpriseCrmFrontendsEventbusProtoEventParameters.t`, *default:* `nil`) - The parameters in Event object.
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot do
  def decode(value, options) do
    GoogleApi.Integrations.V1.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot.decode(
      value,
      options
    )
  end
