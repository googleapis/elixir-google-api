...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTaskExecutionDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTaskExecutionDetails do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTaskExecutionDetails.decode(
      value,
      options
    )
  end
