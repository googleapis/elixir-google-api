...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Connection do
  @moduledoc """
  ...
  *   `connectorVersionInfraConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectorVersionInfraConfig.t`, *default:* `nil`) - Output only. Infra configs supported by Connector Version.
  ...
  *   `destinationConfigs` (*type:* `list(GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1DestinationConfig.t)`, *default:* `nil`) - Optional. Configuration of the Connector's destination. Only accepted for Connectors that accepts user defined destination(s).
  ...
  *   `eventingConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingConfig.t`, *default:* `nil`) - Optional. Eventing config of a connection
  ...
  *   `eventingRuntimeData` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingRuntimeData.t`, *default:* `nil`) - Output only. Eventing Runtime Data.
  ...
  *   `lockConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LockConfig.t`, *default:* `nil`) - Optional. Configuration that indicates whether or not the Connection can be edited.
  *   `logConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LogConfig.t`, *default:* `nil`) - Optional. Log configuration for the connection.
  ...
  *   `nodeConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1NodeConfig.t`, *default:* `nil`) - Optional. Node configuration for the connection.
  ...
  *   `sslConfig` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1SslConfig.t`, *default:* `nil`) - Optional. Ssl config of a connection
  *   `status` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectionStatus.t`, *default:* `nil`) - Output only. Current status of the connection.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Updated time.
  ...
  @type t :: %__MODULE__{
          ...
          :connectorVersionInfraConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectorVersionInfraConfig.t()
            | nil,
          ...
          :eventingConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingConfig.t() | nil,
          :eventingEnablementType => String.t() | nil,
          :eventingRuntimeData =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingRuntimeData.t()
            | nil,
          :imageLocation => String.t() | nil,
          :isTrustedTester => boolean() | nil,
          :labels => map() | nil,
          :lockConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LockConfig.t() | nil,
          :logConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LogConfig.t() | nil,
          :name => String.t() | nil,
          :nodeConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1NodeConfig.t() | nil,
          :serviceAccount => String.t() | nil,
          :serviceDirectory => String.t() | nil,
          :sslConfig =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1SslConfig.t() | nil,
          :status =>
            GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectionStatus.t() | nil,
  ...
  field(:connectorVersionInfraConfig,
    as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectorVersionInfraConfig
  )
  ...
  field(:eventingConfig,
    as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingConfig
  )

  field(:eventingEnablementType)

  field(:eventingRuntimeData,
    as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1EventingRuntimeData
  )

  field(:imageLocation)
  field(:isTrustedTester)
  field(:labels, type: :map)
  field(:lockConfig, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LockConfig)
  field(:logConfig, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1LogConfig)
  field(:name)
  field(:nodeConfig, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1NodeConfig)
  field(:serviceAccount)
  field(:serviceDirectory)
  field(:sslConfig, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1SslConfig)
  field(:status, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1ConnectionStatus)
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Connection do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Connection.decode(value, options)
  end
end
