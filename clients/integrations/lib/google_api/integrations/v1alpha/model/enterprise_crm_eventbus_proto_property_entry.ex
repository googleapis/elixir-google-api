...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoPropertyEntry do
  @moduledoc """
  ...
  *   `value` (*type:* `GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoValueType.t`, *default:* `nil`) - Values for the defined keys. Each value can either be string, int, double or any proto message.
  """
...
defimpl Poison.Decoder,
  ...
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoPropertyEntry.decode(
      value,
      options
    )
  end
