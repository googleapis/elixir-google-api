...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTriggerCriteria do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTriggerCriteria do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTriggerCriteria.decode(
      value,
      options
    )
  end
