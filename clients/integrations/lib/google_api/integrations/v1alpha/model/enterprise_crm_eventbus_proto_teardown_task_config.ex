...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTeardownTaskConfig do
  @moduledoc """
  ...
  *   `teardownTaskImplementationClassName` (*type:* `String.t`, *default:* `nil`) - Required. Implementation class name.
  ...
  @type t :: %__MODULE__{
          ...
          :name => String.t() | nil,
          :nextTeardownTask =>
            GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoNextTeardownTask.t()
            | nil,
          :parameters =>
            GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventParameters.t()
            | nil,
          :properties =>
            GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventBusProperties.t()
            | nil,
  ...
  field(:nextTeardownTask,
    as: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoNextTeardownTask
  )
  ...
  field(:properties,
    as: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventBusProperties
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTeardownTaskConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoTeardownTaskConfig.decode(
      value,
      options
    )
  end
