...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusStatsDimensions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusStatsDimensions do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusStatsDimensions.decode(
      value,
      options
    )
  end
