...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoCloudSchedulerConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoCloudSchedulerConfig do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoCloudSchedulerConfig.decode(
      value,
      options
    )
  end
