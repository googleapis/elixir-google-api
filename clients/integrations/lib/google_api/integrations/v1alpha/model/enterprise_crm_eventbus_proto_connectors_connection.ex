...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConnectorsConnection do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConnectorsConnection do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConnectorsConnection.decode(
      value,
      options
    )
  end
