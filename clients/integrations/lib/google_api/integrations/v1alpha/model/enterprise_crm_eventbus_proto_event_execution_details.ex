...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventExecutionDetails do
  @moduledoc """
  ...
  *   `ryeLockUnheldCount` (*type:* `integer()`, *default:* `nil`) - Used internally and shouldn't be exposed to users. A counter for the cron job to record how many times this event is in in_process state but don't have a lock consecutively/
  ...
  field(:eventExecutionSnapshot,
    as: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventExecutionSnapshot,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventExecutionDetails do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoEventExecutionDetails.decode(
      value,
      options
    )
  end
