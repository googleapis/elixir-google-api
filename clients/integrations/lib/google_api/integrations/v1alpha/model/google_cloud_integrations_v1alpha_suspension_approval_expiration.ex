...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration.decode(
      value,
      options
    )
  end
