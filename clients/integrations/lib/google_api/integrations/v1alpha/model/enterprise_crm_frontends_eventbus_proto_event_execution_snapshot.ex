...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot.decode(
      value,
      options
    )
  end
