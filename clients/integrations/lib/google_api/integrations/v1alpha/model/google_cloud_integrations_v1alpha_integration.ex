...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaIntegration do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaIntegration do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaIntegration.decode(
      value,
      options
    )
  end
