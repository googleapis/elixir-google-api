...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigSshPublicKey do
  @moduledoc """
  ...
  *   `username` (*type:* `String.t`, *default:* `nil`) - The user account used to authenticate.
  ...
  field(:certType)
  field(:sshClientCert, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Secret)

  field(:sshClientCertPass, as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Secret)

  field(:username)
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigSshPublicKey do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigSshPublicKey.decode(
      value,
      options
    )
  end
