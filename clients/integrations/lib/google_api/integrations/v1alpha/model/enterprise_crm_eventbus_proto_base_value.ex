...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoBaseValue do
  @moduledoc """
  ...
  *   `referenceValue` (*type:* `String.t`, *default:* `nil`) - Start with a reference value to dereference.
  ...
  @type t :: %__MODULE__{
          :baseFunction =>
            GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoFunction.t() | nil,
          :literalValue =>
  ...
  field(:baseFunction, as: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoFunction)
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoBaseValue do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoBaseValue.decode(
      value,
      options
    )
  end
