...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshot do
  @moduledoc """
  ...
  *   `taskExecutionDetails` (*type:* `list(GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaTaskExecutionDetails.t)`, *default:* `nil`) - All of the task execution details at the given point of time.
  ...
  field(:taskExecutionDetails,
    as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaTaskExecutionDetails,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshot do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshot.decode(
      value,
      options
    )
  end
