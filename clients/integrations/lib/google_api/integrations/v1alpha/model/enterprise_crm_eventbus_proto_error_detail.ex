...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoErrorDetail do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoErrorDetail do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoErrorDetail.decode(
      value,
      options
    )
  end
