...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoFailurePolicy do
  @moduledoc """
  ...
  *   `retryStrategy` (*type:* `String.t`, *default:* `nil`) - Defines what happens to the task upon failure.
  ...
  field(:intervalInSeconds)
  field(:maxNumRetries)
  field(:retryStrategy)
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoFailurePolicy do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoFailurePolicy.decode(
      value,
      options
    )
  end
