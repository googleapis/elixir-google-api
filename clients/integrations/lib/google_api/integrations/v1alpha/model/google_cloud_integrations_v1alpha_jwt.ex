...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaJwt do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaJwt do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaJwt.decode(value, options)
  end
end
