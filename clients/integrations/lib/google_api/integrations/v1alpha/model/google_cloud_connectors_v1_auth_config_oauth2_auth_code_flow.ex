...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlow do
  @moduledoc """
  ...
  *   `clientSecret` (*type:* `GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1Secret.t`, *default:* `nil`) - Client secret for user-provided OAuth app.
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlow do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudConnectorsV1AuthConfigOauth2AuthCodeFlow.decode(
      value,
      options
    )
  end
