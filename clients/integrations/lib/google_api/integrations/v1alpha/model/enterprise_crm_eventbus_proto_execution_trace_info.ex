...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoExecutionTraceInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoExecutionTraceInfo do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoExecutionTraceInfo.decode(
      value,
      options
    )
  end
