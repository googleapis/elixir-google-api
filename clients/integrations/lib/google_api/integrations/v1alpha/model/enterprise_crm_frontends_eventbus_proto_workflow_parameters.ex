...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoWorkflowParameters do
  @moduledoc """
  ...
  *   `parameters` (*type:* `list(GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry.t)`, *default:* `nil`) - Parameters are a part of Event and can be used to communiticate between different tasks that are part of the same workflow execution.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoWorkflowParameters do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmFrontendsEventbusProtoWorkflowParameters.decode(
      value,
      options
    )
  end
