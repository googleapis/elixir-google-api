...
defmodule GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConditionResult do
  @moduledoc """
  ...
  *   `result` (*type:* `boolean()`, *default:* `nil`) - the result comes out after evaluate the combined condition. True if there's no combined condition specified.
  ...
  field(:currentTaskNumber)
  field(:nextTaskNumber)
  field(:result)
end

defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConditionResult do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.EnterpriseCrmEventbusProtoConditionResult.decode(
      value,
      options
    )
  end
