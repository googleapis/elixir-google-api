...
defmodule GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionDetails do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Status of the execution.
  ...
  field(:executionSnapshots,
    as: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionSnapshot,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionDetails do
  def decode(value, options) do
    GoogleApi.Integrations.V1alpha.Model.GoogleCloudIntegrationsV1alphaExecutionDetails.decode(
      value,
      options
    )
  end
