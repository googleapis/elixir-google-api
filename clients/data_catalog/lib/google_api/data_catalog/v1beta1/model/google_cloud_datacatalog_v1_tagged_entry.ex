...
defmodule GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1TaggedEntry do
  @moduledoc """
  ...
  *   `v1Entry` (*type:* `GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Entry.t`, *default:* `nil`) - Non-encrypted Data Catalog v1 Entry.
  ...
  @type t :: %__MODULE__{
          :absentTags =>
            list(GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Tag.t()) | nil,
          :presentTags =>
            list(GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Tag.t()) | nil,
          :v1Entry => GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Entry.t() | nil
        }

  field(:absentTags,
    as: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Tag,
    type: :list
  )
  ...
  field(:v1Entry, as: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1Entry)
end

defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1TaggedEntry do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1TaggedEntry.decode(value, options)
  end
end
