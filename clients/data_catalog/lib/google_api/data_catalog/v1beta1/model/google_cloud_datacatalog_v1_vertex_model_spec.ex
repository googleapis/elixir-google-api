...
defmodule GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSpec do
  @moduledoc """
  ...
  *   `vertexModelSourceInfo` (*type:* `GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSourceInfo.t`, *default:* `nil`) - Source of a Vertex model.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :vertexModelSourceInfo =>
            GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSourceInfo.t()
            | nil
        }
  ...
  field(:vertexModelSourceInfo,
    as: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSourceInfo
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSpec do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1VertexModelSpec.decode(
      value,
      options
    )
  end
