...
defmodule GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1CloudBigtableInstanceSpecCloudBigtableClusterSpec.decode(
      value,
      options
    )
  end
