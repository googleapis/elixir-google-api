...
defmodule GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1beta1SearchCatalogRequest do
  ...
  *   `pageSize` (*type:* `integer()`, *default:* `nil`) - Number of results in the search page. If <=0 then defaults to 10. Max limit
  ...
  *   `query` (*type:* `String.t`, *default:* `nil`) - Required. The query string in search query syntax. The query must be non-empty.
