...
defmodule GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchema do
  @moduledoc """
  ...
  *   `lookerColumnSpec` (*type:* `GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchemaLookerColumnSpec.t`, *default:* `nil`) - Looker specific column info of this column.
  ...
  *   `subcolumns` (*type:* `list(GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchema.t)`, *default:* `nil`) - Optional. Schema of sub-columns. A column can have zero or more sub-columns.
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. Type of the column. Must be a UTF-8 string with the maximum size of 128 bytes.
  ...
  @type t :: %__MODULE__{
          ...
          :lookerColumnSpec =>
            GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchemaLookerColumnSpec.t()
            | nil,
          :mode => String.t() | nil,
          :ordinalPosition => integer() | nil,
          :rangeElementType =>
            GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchemaFieldElementType.t()
            | nil,
          :subcolumns =>
  ...
  field(:lookerColumnSpec,
    as: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchemaLookerColumnSpec
  )
  ...
  field(:rangeElementType,
    as: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchemaFieldElementType
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchema do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1beta1.Model.GoogleCloudDatacatalogV1ColumnSchema.decode(
      value,
      options
    )
  end
