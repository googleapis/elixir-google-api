...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1Entry do
  @moduledoc """
  ...
  *   `userSpecifiedType` (*type:* `String.t`, *default:* `nil`) - Custom entry type that doesn't match any of the values allowed for input and listed in the `EntryType` enum. When creating an entry, first check the type values in the enum. If there are no appropriate types for the new entry, provide a custom value, for example, `my_special_type`. The `user_specified_type` string has the following limitations: * Is case insensitive. * Must begin with a letter or underscore. * Can only contain letters, numbers, and underscores. * Must be at least 1 character and at most 64 characters long.
  ...
  @type t :: %__MODULE__{
          :bigqueryDateShardedSpec =>
            GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1BigQueryDateShardedSpec.t()
            | nil,
          :bigqueryTableSpec =>
          ...
          :dataSourceConnectionSpec =>
            GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1DataSourceConnectionSpec.t()
            | nil,
          :databaseTableSpec =>
  ...
  field(:bigqueryDateShardedSpec,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1BigQueryDateShardedSpec
  )
  ...
  field(:dataSourceConnectionSpec,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1DataSourceConnectionSpec
  )
  ...
  field(:personalDetails,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1PersonalDetails
  )
  ...
  field(:type)
  field(:usageSignal, as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1UsageSignal)
  field(:userSpecifiedSystem)
  field(:userSpecifiedType)
end

defimpl Poison.Decoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1Entry do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1Entry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1Entry do
