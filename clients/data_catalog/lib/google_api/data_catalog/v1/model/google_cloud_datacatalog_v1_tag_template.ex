...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagTemplate do
  ...
  *   `isPubliclyReadable` (*type:* `boolean()`, *default:* `nil`) - Indicates whether tags created with this template are public. Public tags do not require tag template access to appear in ListTags API response. Additionally, you can search for a public tag by value with a simple search query instead of using a ``tag:`` predicate.
