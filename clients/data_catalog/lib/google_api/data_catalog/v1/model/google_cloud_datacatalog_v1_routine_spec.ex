...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpec do
  @moduledoc """
  ...
  *   `routineType` (*type:* `String.t`, *default:* `nil`) - The type of the routine.
  ...
  @type t :: %__MODULE__{
          :bigqueryRoutineSpec =>
            GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1BigQueryRoutineSpec.t() | nil,
          :definitionBody => String.t() | nil,
          :language => String.t() | nil,
          :returnType => String.t() | nil,
          :routineArguments =>
            list(GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpecArgument.t())
            | nil,
          :routineType => String.t() | nil
        }

  field(:bigqueryRoutineSpec,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1BigQueryRoutineSpec
  )
  ...
  field(:routineArguments,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpecArgument,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpec do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpec do
