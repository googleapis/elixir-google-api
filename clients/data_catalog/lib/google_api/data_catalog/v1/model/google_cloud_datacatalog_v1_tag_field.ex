...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagField do
  @moduledoc """
  ...
  *   `enumValue` (*type:* `GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagFieldEnumValue.t`, *default:* `nil`) - The value of a tag field with an enum type. This value must be one of the allowed values listed in this enum.
  ...
  *   `timestampValue` (*type:* `DateTime.t`, *default:* `nil`) - The value of a tag field with a timestamp type.
  ...
  @type t :: %__MODULE__{
          ...
          :enumValue =>
            GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagFieldEnumValue.t() | nil,
          :order => integer() | nil,
  ...
  field(:displayName)
  field(:doubleValue)
  field(:enumValue, as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagFieldEnumValue)
  field(:order)
  field(:richtextValue)
  field(:stringValue)
...
defimpl Poison.Decoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagField do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagField.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1TagField do
