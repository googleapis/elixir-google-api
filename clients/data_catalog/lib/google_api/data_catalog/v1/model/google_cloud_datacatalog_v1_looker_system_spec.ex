...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1LookerSystemSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  ...
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1LookerSystemSpec.decode(value, options)
  end
end
