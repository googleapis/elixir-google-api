...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpecArgument do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpecArgument do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1RoutineSpecArgument.decode(
      value,
      options
    )
  end
