...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1StorageProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1StorageProperties do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1StorageProperties.decode(
      value,
      options
    )
  end
