...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1OrganizationConfig do
  @moduledoc """
  ...
  *   `config` (*type:* `%{optional(String.t) => GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1MigrationConfig.t}`, *default:* `nil`) - Map of organizations and project resource names and their configuration. The format for the map keys is `organizations/{organizationId}` or `projects/{projectId}`.
  ...
  field(:config,
    as: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1MigrationConfig,
    type: :map
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1OrganizationConfig do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1OrganizationConfig.decode(
      value,
      options
    )
  end
