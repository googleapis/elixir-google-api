...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SystemTimestamps do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SystemTimestamps do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SystemTimestamps.decode(value, options)
  end
end
