...
defmodule GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SqlDatabaseSystemSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SqlDatabaseSystemSpec do
  def decode(value, options) do
    GoogleApi.DataCatalog.V1.Model.GoogleCloudDatacatalogV1SqlDatabaseSystemSpec.decode(
      value,
      options
    )
  end
