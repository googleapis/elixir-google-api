...
defmodule GoogleApi.Connectors.V2.Model.SloEligibility do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.SloEligibility do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.SloEligibility.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.SloEligibility do
