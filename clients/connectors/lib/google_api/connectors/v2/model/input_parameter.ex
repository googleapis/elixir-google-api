...
defmodule GoogleApi.Connectors.V2.Model.InputParameter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.InputParameter do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.InputParameter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.InputParameter do
