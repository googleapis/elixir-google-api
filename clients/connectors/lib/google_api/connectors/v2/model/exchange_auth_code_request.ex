...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.ExchangeAuthCodeRequest do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.ExchangeAuthCodeRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.ExchangeAuthCodeRequest do
