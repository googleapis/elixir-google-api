...
defmodule GoogleApi.Connectors.V2.Model.Instance do
  @moduledoc """
  ...
  *   `maintenanceSchedules` (*type:* `%{optional(String.t) => GoogleApi.Connectors.V2.Model.MaintenanceSchedule.t}`, *default:* `nil`) - The MaintenanceSchedule contains the scheduling information of published maintenance schedule with same key as software_versions.
  *   `maintenanceSettings` (*type:* `GoogleApi.Connectors.V2.Model.MaintenanceSettings.t`, *default:* `nil`) - Optional. The MaintenanceSettings associated with instance.
  ...
  *   `provisionedResources` (*type:* `list(GoogleApi.Connectors.V2.Model.ProvisionedResource.t)`, *default:* `nil`) - Output only. The list of data plane resources provisioned for this instance, e.g. compute VMs. See go/get-instance-metadata.
  ...
  *   `sloMetadata` (*type:* `GoogleApi.Connectors.V2.Model.SloMetadata.t`, *default:* `nil`) - Output only. SLO metadata for instance classification in the Standardized dataplane SLO platform. See go/cloud-ssa-standard-slo for feature description.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Timestamp when the resource was last modified.
  ...
  @type t :: %__MODULE__{
          ...
          :maintenanceSchedules =>
            %{optional(String.t()) => GoogleApi.Connectors.V2.Model.MaintenanceSchedule.t()} | nil,
          :maintenanceSettings => GoogleApi.Connectors.V2.Model.MaintenanceSettings.t() | nil,
          :name => String.t() | nil,
          :notificationParameters =>
            %{optional(String.t()) => GoogleApi.Connectors.V2.Model.NotificationParameter.t()}
            | nil,
          :producerMetadata => map() | nil,
          :provisionedResources =>
            list(GoogleApi.Connectors.V2.Model.ProvisionedResource.t()) | nil,
          :slmInstanceTemplate => String.t() | nil,
          :sloMetadata => GoogleApi.Connectors.V2.Model.SloMetadata.t() | nil,
  ...
  field(:maintenanceSchedules, as: GoogleApi.Connectors.V2.Model.MaintenanceSchedule, type: :map)
  field(:maintenanceSettings, as: GoogleApi.Connectors.V2.Model.MaintenanceSettings)
  field(:name)

  field(:notificationParameters,
    as: GoogleApi.Connectors.V2.Model.NotificationParameter,
    type: :map
  )

  field(:producerMetadata, type: :map)
  field(:provisionedResources, as: GoogleApi.Connectors.V2.Model.ProvisionedResource, type: :list)
  field(:slmInstanceTemplate)
  field(:sloMetadata, as: GoogleApi.Connectors.V2.Model.SloMetadata)
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.Instance do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.Instance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.Instance do
