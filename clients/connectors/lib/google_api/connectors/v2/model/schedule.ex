...
defmodule GoogleApi.Connectors.V2.Model.Schedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.Schedule do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.Schedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.Schedule do
