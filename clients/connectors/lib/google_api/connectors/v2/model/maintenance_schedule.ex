...
defmodule GoogleApi.Connectors.V2.Model.MaintenanceSchedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V2.Model.MaintenanceSchedule do
  def decode(value, options) do
    GoogleApi.Connectors.V2.Model.MaintenanceSchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V2.Model.MaintenanceSchedule do
