...
defmodule GoogleApi.Connectors.V1.Model.Provider do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.Provider do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.Provider.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.Provider do
