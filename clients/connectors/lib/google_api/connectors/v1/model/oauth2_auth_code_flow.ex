...
defmodule GoogleApi.Connectors.V1.Model.Oauth2AuthCodeFlow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.Oauth2AuthCodeFlow do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.Oauth2AuthCodeFlow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.Oauth2AuthCodeFlow do
