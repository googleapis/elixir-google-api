...
defmodule GoogleApi.Connectors.V1.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.TimeOfDay do
