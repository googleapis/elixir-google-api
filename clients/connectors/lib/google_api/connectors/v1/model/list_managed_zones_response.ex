...
defmodule GoogleApi.Connectors.V1.Model.ListManagedZonesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.ListManagedZonesResponse do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.ListManagedZonesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.ListManagedZonesResponse do
