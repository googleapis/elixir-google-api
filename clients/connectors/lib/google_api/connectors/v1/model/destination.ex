...
defmodule GoogleApi.Connectors.V1.Model.Destination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.Destination do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.Destination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.Destination do
