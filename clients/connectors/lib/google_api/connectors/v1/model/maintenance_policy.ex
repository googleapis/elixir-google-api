...
defmodule GoogleApi.Connectors.V1.Model.MaintenancePolicy do
  @moduledoc """
  ...
  *   `updatePolicy` (*type:* `GoogleApi.Connectors.V1.Model.UpdatePolicy.t`, *default:* `nil`) - Maintenance policy applicable to instance update.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time when the resource was updated.
  ...
  @type t :: %__MODULE__{
          ...
          :name => String.t() | nil,
          :state => String.t() | nil,
          :updatePolicy => GoogleApi.Connectors.V1.Model.UpdatePolicy.t() | nil,
  ...
  field(:name)
  field(:state)
  field(:updatePolicy, as: GoogleApi.Connectors.V1.Model.UpdatePolicy)
  field(:updateTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.Connectors.V1.Model.MaintenancePolicy do
  def decode(value, options) do
    GoogleApi.Connectors.V1.Model.MaintenancePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Connectors.V1.Model.MaintenancePolicy do
