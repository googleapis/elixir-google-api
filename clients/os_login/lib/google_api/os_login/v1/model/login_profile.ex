...
defmodule GoogleApi.OSLogin.V1.Model.LoginProfile do
  ...
  - posixAccounts (list(GoogleApi.OSLogin.V1.Model.PosixAccount.t)): The list of POSIX accounts associated with the user. Defaults to `nil`.
  - sshPublicKeys (%{optional(String.t) => GoogleApi.OSLogin.V1.Model.SshPublicKey.t}): A map from SSH public key fingerprint to the associated key object. Defaults to `nil`.
  """
