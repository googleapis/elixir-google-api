...
defmodule GoogleApi.OSLogin.V1alpha.Model.LoginProfile do
  ...
  - name (String.t): A unique user ID. Defaults to `nil`.
  - posixAccounts (list(GoogleApi.OSLogin.V1alpha.Model.PosixAccount.t)): The list of POSIX accounts associated with the user. Defaults to `nil`.
  - sshPublicKeys (%{optional(String.t) => GoogleApi.OSLogin.V1alpha.Model.SshPublicKey.t}): A map from SSH public key fingerprint to the associated key object. Defaults to `nil`.
  """
