...
defmodule GoogleApi.Eventarc.V1beta1.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.Eventarc.V1beta1.Connection
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.Location{}}` on success
  *   `{:error, info}` on failure
  ...
  def eventarc_projects_locations_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.Location{}])
  end
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.ListLocationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.ListLocationsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Eventarc.V1beta1.Model.CancelOperationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_operations_cancel(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.Operation{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_operations_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.Operation{}])
  end
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_operations_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.ListOperationsResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def eventarc_projects_locations_triggers_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1beta1/{+parent}/triggers", %{
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.Trigger{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_triggers_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.Trigger{}])
  end
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.Policy{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_triggers_get_iam_policy(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.Policy{}])
  end
  ...
  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.ListTriggersResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_triggers_list(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.ListTriggersResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Eventarc.V1beta1.Model.SetIamPolicyRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Eventarc.V1beta1.Model.TestIamPermissionsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Eventarc.V1beta1.Model.TestIamPermissionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def eventarc_projects_locations_triggers_test_iam_permissions(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Eventarc.V1beta1.Model.TestIamPermissionsResponse{}]
    )
  end
end
