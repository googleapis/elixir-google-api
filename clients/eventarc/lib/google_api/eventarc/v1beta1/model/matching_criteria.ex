...
defmodule GoogleApi.Eventarc.V1beta1.Model.MatchingCriteria do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Eventarc.V1beta1.Model.MatchingCriteria do
  def decode(value, options) do
    GoogleApi.Eventarc.V1beta1.Model.MatchingCriteria.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Eventarc.V1beta1.Model.MatchingCriteria do
