...
defmodule GoogleApi.Eventarc.V1.Model.FilteringAttribute do
  @moduledoc """
  ...
  *   `required` (*type:* `boolean()`, *default:* `nil`) - Output only. If true, the triggers for this provider should always specify a filter on these attributes. Trigger creation will fail otherwise.
  ...
  field(:attribute)
  field(:description)
  field(:pathPatternSupported)
  field(:required)
end

defimpl Poison.Decoder, for: GoogleApi.Eventarc.V1.Model.FilteringAttribute do
  def decode(value, options) do
    GoogleApi.Eventarc.V1.Model.FilteringAttribute.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Eventarc.V1.Model.FilteringAttribute do
