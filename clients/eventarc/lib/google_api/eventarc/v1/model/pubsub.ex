...
defmodule GoogleApi.Eventarc.V1.Model.Pubsub do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Eventarc.V1.Model.Pubsub do
  def decode(value, options) do
    GoogleApi.Eventarc.V1.Model.Pubsub.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Eventarc.V1.Model.Pubsub do
