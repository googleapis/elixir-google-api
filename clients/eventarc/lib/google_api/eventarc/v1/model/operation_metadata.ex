...
defmodule GoogleApi.Eventarc.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Eventarc.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Eventarc.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Eventarc.V1.Model.OperationMetadata do
