...
defimpl Poison.Decoder, for: GoogleApi.Eventarc.V1.Model.NetworkConfig do
  def decode(value, options) do
    GoogleApi.Eventarc.V1.Model.NetworkConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Eventarc.V1.Model.NetworkConfig do
