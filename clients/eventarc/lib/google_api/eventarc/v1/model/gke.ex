...
defmodule GoogleApi.Eventarc.V1.Model.GKE do
  ...
  *   `location` (*type:* `String.t`, *default:* `nil`) - Required. The name of the Google Compute Engine in which the cluster resides, which can either be compute zone (e.g. us-central1-a) for the zonal clusters or region (e.g. us-central1) for regional clusters.
  *   `namespace` (*type:* `String.t`, *default:* `nil`) - Required. The namespace the GKE service is running in.
  *   `path` (*type:* `String.t`, *default:* `nil`) - Optional. The relative path on the GKE service the events should be sent to. The value must conform to the definition of URI path segment (section 3.3 of RFC2396). Examples: "/route", "route", "route/subroute".
