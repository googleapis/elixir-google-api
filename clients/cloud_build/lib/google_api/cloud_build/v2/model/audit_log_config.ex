...
defmodule GoogleApi.CloudBuild.V2.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.AuditLogConfig do
