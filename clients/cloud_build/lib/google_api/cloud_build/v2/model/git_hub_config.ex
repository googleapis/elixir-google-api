...
defmodule GoogleApi.CloudBuild.V2.Model.GitHubConfig do
  @moduledoc """
  ...
  *   `authorizerCredential` (*type:* `GoogleApi.CloudBuild.V2.Model.OAuthCredential.t`, *default:* `nil`) - OAuth credential of the account that authorized the Cloud Build GitHub App. It is recommended to use a robot account instead of a human user account. The OAuth token must be tied to the Cloud Build GitHub App.
  ...
  field(:authorizerCredential, as: GoogleApi.CloudBuild.V2.Model.OAuthCredential)
end

defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.GitHubConfig do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.GitHubConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.GitHubConfig do
