...
defmodule GoogleApi.CloudBuild.V2.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.OperationMetadata do
