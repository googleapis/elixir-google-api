...
defmodule GoogleApi.CloudBuild.V2.Model.ListRepositoriesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.ListRepositoriesResponse do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.ListRepositoriesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.ListRepositoriesResponse do
