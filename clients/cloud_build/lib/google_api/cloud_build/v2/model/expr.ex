...
defmodule GoogleApi.CloudBuild.V2.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.Expr do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.Expr do
