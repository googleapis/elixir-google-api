...
defmodule GoogleApi.CloudBuild.V2.Model.GoogleDevtoolsCloudbuildV2OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudBuild.V2.Model.GoogleDevtoolsCloudbuildV2OperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.GoogleDevtoolsCloudbuildV2OperationMetadata.decode(
      value,
      options
    )
  end
