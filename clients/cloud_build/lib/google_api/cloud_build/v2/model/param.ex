...
defmodule GoogleApi.CloudBuild.V2.Model.Param do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.Param do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.Param.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.Param do
