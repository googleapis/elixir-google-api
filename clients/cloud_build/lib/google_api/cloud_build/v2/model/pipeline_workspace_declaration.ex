...
defmodule GoogleApi.CloudBuild.V2.Model.PipelineWorkspaceDeclaration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.PipelineWorkspaceDeclaration do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.PipelineWorkspaceDeclaration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.PipelineWorkspaceDeclaration do
