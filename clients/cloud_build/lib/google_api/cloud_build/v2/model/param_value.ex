...
defmodule GoogleApi.CloudBuild.V2.Model.ParamValue do
  @moduledoc """
  Parameter value.
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.ParamValue do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.ParamValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.ParamValue do
