...
defmodule GoogleApi.CloudBuild.V2.Model.ListConnectionsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.ListConnectionsResponse do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.ListConnectionsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.ListConnectionsResponse do
