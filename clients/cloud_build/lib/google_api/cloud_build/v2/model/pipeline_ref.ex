...
defmodule GoogleApi.CloudBuild.V2.Model.PipelineRef do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V2.Model.PipelineRef do
  def decode(value, options) do
    GoogleApi.CloudBuild.V2.Model.PipelineRef.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V2.Model.PipelineRef do
