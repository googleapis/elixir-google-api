...
defmodule GoogleApi.CloudBuild.V1.Model.PrivatePoolV1Config do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.PrivatePoolV1Config do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.PrivatePoolV1Config.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.PrivatePoolV1Config do
