...
defmodule GoogleApi.CloudBuild.V1.Model.SecretManagerSecret do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.SecretManagerSecret do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.SecretManagerSecret.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.SecretManagerSecret do
