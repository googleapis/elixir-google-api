...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.NotifierMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.NotifierMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.NotifierMetadata do
