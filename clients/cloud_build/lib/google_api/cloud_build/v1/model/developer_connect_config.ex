...
defmodule GoogleApi.CloudBuild.V1.Model.DeveloperConnectConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.DeveloperConnectConfig do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.DeveloperConnectConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.DeveloperConnectConfig do
