...
defmodule GoogleApi.CloudBuild.V1.Model.CreateGitLabConfigOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.CreateGitLabConfigOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.CreateGitLabConfigOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.CreateGitLabConfigOperationMetadata do
