...
defmodule GoogleApi.CloudBuild.V1.Model.Secrets do
  @moduledoc """
  ...
  *   `secretManager` (*type:* `list(GoogleApi.CloudBuild.V1.Model.SecretManagerSecret.t)`, *default:* `nil`) - Secrets in Secret Manager and associated secret environment variable.
  ...
  field(:secretManager, as: GoogleApi.CloudBuild.V1.Model.SecretManagerSecret, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.Secrets do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.Secrets.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.Secrets do
