...
defmodule GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV2OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV2OperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV2OperationMetadata.decode(
      value,
      options
    )
  end
