...
defmodule GoogleApi.CloudBuild.V1.Model.BitbucketServerConnectedRepository do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.CloudBuild.V1.Model.Status.t`, *default:* `nil`) - Output only. The status of the repo connection request.
  ...
  field(:parent)
  field(:repo, as: GoogleApi.CloudBuild.V1.Model.BitbucketServerRepositoryId)
  field(:status, as: GoogleApi.CloudBuild.V1.Model.Status)
end

defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.BitbucketServerConnectedRepository do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.BitbucketServerConnectedRepository.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.BitbucketServerConnectedRepository do
