...
defmodule GoogleApi.CloudBuild.V1.Model.UploadedNpmPackage do
  @moduledoc """
  An npm package uploaded to Artifact Registry using the NpmPackage directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.CloudBuild.V1.Model.FileHashes.t`, *default:* `nil`) - Hash types and values of the npm package.
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.UploadedNpmPackage do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.UploadedNpmPackage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.UploadedNpmPackage do
