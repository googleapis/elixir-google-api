...
defmodule GoogleApi.CloudBuild.V1.Model.DeleteGitLabConfigOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.DeleteGitLabConfigOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.DeleteGitLabConfigOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.DeleteGitLabConfigOperationMetadata do
