...
defmodule GoogleApi.CloudBuild.V1.Model.ApprovalResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.ApprovalResult do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.ApprovalResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.ApprovalResult do
