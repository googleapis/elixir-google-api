...
defmodule GoogleApi.CloudBuild.V1.Model.HttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.HttpBody do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.HttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.HttpBody do
