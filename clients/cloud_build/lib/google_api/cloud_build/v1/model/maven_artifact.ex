...
defmodule GoogleApi.CloudBuild.V1.Model.MavenArtifact do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.MavenArtifact do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.MavenArtifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.MavenArtifact do
