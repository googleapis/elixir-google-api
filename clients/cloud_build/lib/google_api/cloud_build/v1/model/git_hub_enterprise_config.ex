...
defmodule GoogleApi.CloudBuild.V1.Model.GitHubEnterpriseConfig do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Optional. The full resource name for the GitHubEnterpriseConfig For example: "projects/{$project_id}/githubEnterpriseConfigs/{$config_id}"
