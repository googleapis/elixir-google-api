...
defmodule GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptionsPoolOptionWorkerConfig.decode(
      value,
      options
    )
  end
