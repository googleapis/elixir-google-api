...
defmodule GoogleApi.CloudBuild.V1.Model.PythonPackage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.PythonPackage do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.PythonPackage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.PythonPackage do
