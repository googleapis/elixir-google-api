...
defmodule GoogleApi.CloudBuild.V1.Model.DeleteBitbucketServerConfigOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudBuild.V1.Model.DeleteBitbucketServerConfigOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.DeleteBitbucketServerConfigOperationMetadata.decode(
      value,
      options
    )
  end
