...
defmodule GoogleApi.CloudBuild.V1.Model.UploadedMavenArtifact do
  @moduledoc """
  A Maven artifact uploaded using the MavenArtifact directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.CloudBuild.V1.Model.FileHashes.t`, *default:* `nil`) - Hash types and values of the Maven Artifact.
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.UploadedMavenArtifact do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.UploadedMavenArtifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.UploadedMavenArtifact do
