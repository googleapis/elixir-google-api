...
defmodule GoogleApi.CloudBuild.V1.Model.NpmPackage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.NpmPackage do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.NpmPackage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.NpmPackage do
