...
defmodule GoogleApi.CloudBuild.V1.Model.GitLabRepositoryId do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.GitLabRepositoryId do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.GitLabRepositoryId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudBuild.V1.Model.GitLabRepositoryId do
