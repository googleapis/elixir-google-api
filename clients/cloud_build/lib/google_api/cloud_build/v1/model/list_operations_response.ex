...
defmodule GoogleApi.CloudBuild.V1.Model.ListOperationsResponse do
  @moduledoc """
  ...
  *   `operations` (*type:* `list(GoogleApi.CloudBuild.V1.Model.Operation.t)`, *default:* `nil`) - A list of operations that matches the specified filter in the request.
  """
