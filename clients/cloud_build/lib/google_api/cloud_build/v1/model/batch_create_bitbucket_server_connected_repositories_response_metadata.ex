...
defmodule GoogleApi.CloudBuild.V1.Model.BatchCreateBitbucketServerConnectedRepositoriesResponseMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.CloudBuild.V1.Model.BatchCreateBitbucketServerConnectedRepositoriesResponseMetadata do
  def decode(value, options) do
    GoogleApi.CloudBuild.V1.Model.BatchCreateBitbucketServerConnectedRepositoriesResponseMetadata.decode(
      value,
      options
    )
  end
