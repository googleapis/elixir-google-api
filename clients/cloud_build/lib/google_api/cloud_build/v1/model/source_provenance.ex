...
defimpl Poison.Decoder, for: GoogleApi.CloudBuild.V1.Model.SourceProvenance do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"resolvedRepoSource", :struct, GoogleApi.CloudBuild.V1.Model.RepoSource, options)
    |> deserialize(:"resolvedStorageSource", :struct, GoogleApi.CloudBuild.V1.Model.StorageSource, options)
  end
end
