...
defmodule GoogleApi.CloudBuild.V1.Api.Vbeta1 do
  @moduledoc """
  API calls for all endpoints tagged `Vbeta1`.
  """
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudbuild_vbeta1_projects_locations_operations_cancel(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def cloudbuild_vbeta1_projects_locations_operations_cancel(
        connection,
        projects_id,
        locations_id,
        operations_id,
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/vbeta1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:cancel",
        %{
