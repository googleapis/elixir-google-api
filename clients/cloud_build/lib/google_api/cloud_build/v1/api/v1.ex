...
defmodule GoogleApi.CloudBuild.V1.Api.V1 do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudbuild_webhook(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudBuild.V1.Model.Empty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudbuild_webhook(connection, optional_params \\ [], opts \\ []) do
