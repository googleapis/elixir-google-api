...
defmodule GoogleApi.CloudBuild.V1.Api.Operations do
  ...
  """
  @spec cloudbuild_operations_cancel(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudBuild.V1.Model.Empty.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec cloudbuild_operations_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudBuild.V1.Model.Operation.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec cloudbuild_operations_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.CloudBuild.V1.Model.ListOperationsResponse.t} | {:error, Tesla.Env.t}
