...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2UserEventImportSummary do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2UserEventImportSummary do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2UserEventImportSummary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2UserEventImportSummary do
