...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportProductsResponse do
  @moduledoc """
  ...
  *   `errorsConfig` (*type:* `GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportErrorsConfig.t`, *default:* `nil`) - Echoes the destination for the complete errors in the request if set.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportProductsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportProductsResponse.decode(
      value,
      options
    )
  end
