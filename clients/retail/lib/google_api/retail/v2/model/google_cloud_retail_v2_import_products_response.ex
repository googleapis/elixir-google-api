...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportProductsResponse do
  @moduledoc """
  ...
  *   `errorsConfig` (*type:* `GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportErrorsConfig.t`, *default:* `nil`) - Echoes the destination for the complete errors in the request if set.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportProductsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportProductsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportProductsResponse do
