...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportCompletionDataResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportCompletionDataResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaImportCompletionDataResponse.decode(
      value,
      options
    )
  end
