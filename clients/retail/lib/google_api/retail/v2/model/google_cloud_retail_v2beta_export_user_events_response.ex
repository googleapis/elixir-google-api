...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportUserEventsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportUserEventsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportUserEventsResponse.decode(
      value,
      options
    )
  end
