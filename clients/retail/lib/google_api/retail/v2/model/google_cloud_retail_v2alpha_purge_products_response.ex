...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsResponse.decode(value, options)
  end
end
