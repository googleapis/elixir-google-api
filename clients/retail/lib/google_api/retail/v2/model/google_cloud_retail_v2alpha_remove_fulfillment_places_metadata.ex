...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaRemoveFulfillmentPlacesMetadata do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaRemoveFulfillmentPlacesMetadata.decode(
      value,
      options
    )
  end
