...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2CatalogAttribute do
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Output only. The type of this attribute. This is derived from the attribute in Product.attributes.
  ...
  @type t :: %__MODULE__{
          ...
          :facetConfig =>
            GoogleApi.Retail.V2.Model.GoogleCloudRetailV2CatalogAttributeFacetConfig.t() | nil,
          :inUse => boolean() | nil,
  ...
  field(:facetConfig, as: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2CatalogAttributeFacetConfig)
