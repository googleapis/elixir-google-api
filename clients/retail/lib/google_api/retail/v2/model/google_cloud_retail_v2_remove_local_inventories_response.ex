...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2RemoveLocalInventoriesResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2RemoveLocalInventoriesResponse.decode(
      value,
      options
    )
  end
