...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaExportUserEventsResponse do
  ...
  *   `errorsConfig` (*type:* `GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaExportErrorsConfig.t`, *default:* `nil`) - Echoes the destination for the complete errors if this field was set in the request.
  """
