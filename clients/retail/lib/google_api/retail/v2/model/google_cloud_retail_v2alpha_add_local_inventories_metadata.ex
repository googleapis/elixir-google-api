...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaAddLocalInventoriesMetadata do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaAddLocalInventoriesMetadata.decode(
      value,
      options
    )
  end
