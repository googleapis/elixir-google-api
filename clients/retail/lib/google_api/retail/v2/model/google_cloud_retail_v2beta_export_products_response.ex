...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportProductsResponse do
  @moduledoc """
  ...
  *   `errorsConfig` (*type:* `GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportErrorsConfig.t`, *default:* `nil`) - Echoes the destination for the complete errors in the request if set.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportProductsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaExportProductsResponse.decode(value, options)
  end
end
