...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaPurgeProductsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaPurgeProductsResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaPurgeProductsResponse.decode(value, options)
  end
end
