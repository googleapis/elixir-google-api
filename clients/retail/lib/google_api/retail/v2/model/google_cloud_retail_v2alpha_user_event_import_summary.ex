...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaUserEventImportSummary do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaUserEventImportSummary do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaUserEventImportSummary.decode(
      value,
      options
    )
  end
