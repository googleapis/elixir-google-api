...
defmodule GoogleApi.Retail.V2.Model.GoogleTypeDate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleTypeDate do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleTypeDate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleTypeDate do
