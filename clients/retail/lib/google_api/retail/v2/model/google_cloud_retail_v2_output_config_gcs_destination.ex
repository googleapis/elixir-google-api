...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2OutputConfigGcsDestination do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2OutputConfigGcsDestination do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2OutputConfigGcsDestination.decode(value, options)
  end
end
