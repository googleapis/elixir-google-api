...
defmodule GoogleApi.Retail.V2.Model.GoogleApiHttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleApiHttpBody do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleApiHttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleApiHttpBody do
