...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2PurgeProductsMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2PurgeProductsMetadata do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2PurgeProductsMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2PurgeProductsMetadata do
