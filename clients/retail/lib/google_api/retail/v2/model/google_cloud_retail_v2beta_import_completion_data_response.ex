...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaImportCompletionDataResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaImportCompletionDataResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2betaImportCompletionDataResponse.decode(
      value,
      options
    )
  end
