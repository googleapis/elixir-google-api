...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsMetadata do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2alphaPurgeProductsMetadata.decode(value, options)
  end
end
