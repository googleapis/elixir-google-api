...
defmodule GoogleApi.Retail.V2.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleRpcStatus do
