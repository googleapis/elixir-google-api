...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportCompletionDataResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportCompletionDataResponse do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ImportCompletionDataResponse.decode(
      value,
      options
    )
  end
