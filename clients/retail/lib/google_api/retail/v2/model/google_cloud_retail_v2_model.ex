...
defmodule GoogleApi.Retail.V2.Model.GoogleCloudRetailV2Model do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Timestamp the Recommendation Model was last updated. E.g. if a Recommendation Model was paused - this would be the time the pause was initiated.
  ...
  @type t :: %__MODULE__{
          ...
          :modelFeaturesConfig =>
            GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ModelModelFeaturesConfig.t() | nil,
          :name => String.t() | nil,
          :optimizationObjective => String.t() | nil,
          :periodicTuningState => String.t() | nil,
          :servingConfigLists =>
            list(GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ModelServingConfigList.t()) | nil,
  ...
  field(:modelFeaturesConfig,
    as: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ModelModelFeaturesConfig
  )
  ...
  field(:servingConfigLists,
    as: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2ModelServingConfigList,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2Model do
  def decode(value, options) do
    GoogleApi.Retail.V2.Model.GoogleCloudRetailV2Model.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Retail.V2.Model.GoogleCloudRetailV2Model do
