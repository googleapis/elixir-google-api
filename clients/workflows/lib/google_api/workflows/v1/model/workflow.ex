...
defmodule GoogleApi.Workflows.V1.Model.Workflow do
  ...
  *   `allKmsKeys` (*type:* `list(String.t)`, *default:* `nil`) - Output only. A list of all KMS crypto keys used to encrypt or decrpt the data associated with the workflow.
  *   `allKmsKeysVersions` (*type:* `list(String.t)`, *default:* `nil`) - Output only. A list of all KMS crypto keys versions used to encrypt or decrpt the data associated with the workflow.
