...
defmodule GoogleApi.Workflows.V1beta.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Workflows.V1beta.Model.Location do
  def decode(value, options) do
    GoogleApi.Workflows.V1beta.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Workflows.V1beta.Model.Location do
