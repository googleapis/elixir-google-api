...
defmodule GoogleApi.WorkspaceEvents.V1.Api.Operations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec workspaceevents_operations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.WorkspaceEvents.V1.Model.Operation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def workspaceevents_operations_get(connection, name, optional_params \\ [], opts \\ []) do
