...
defmodule GoogleApi.PolicyTroubleshooter.V1beta.Model.GoogleCloudPolicytroubleshooterV1betaExplainedPolicy do
  ...
  *   `policy` (*type:* `GoogleApi.PolicyTroubleshooter.V1beta.Model.GoogleIamV1Policy.t`, *default:* `nil`) - The IAM policy attached to the resource. If the sender of the request does not have access to the policy, this field is empty.
