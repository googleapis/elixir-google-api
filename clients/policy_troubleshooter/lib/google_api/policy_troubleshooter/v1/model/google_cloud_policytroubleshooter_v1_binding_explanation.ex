...
defmodule GoogleApi.PolicyTroubleshooter.V1.Model.GoogleCloudPolicytroubleshooterV1BindingExplanation do
  ...
  *   `condition` (*type:* `GoogleApi.PolicyTroubleshooter.V1.Model.GoogleTypeExpr.t`, *default:* `nil`) - A condition expression that prevents this binding from granting access unless the expression evaluates to `true`. To learn about IAM Conditions, see https://cloud.google.com/iam/help/conditions/overview.
  ...
  *   `rolePermissionRelevance` (*type:* `String.t`, *default:* `nil`) - The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy.
  ...
  @type t :: %__MODULE__{
          :access => String.t() | nil,
          :condition => GoogleApi.PolicyTroubleshooter.V1.Model.GoogleTypeExpr.t() | nil,
          :memberships =>
            %{
              optional(String.t()) =>
