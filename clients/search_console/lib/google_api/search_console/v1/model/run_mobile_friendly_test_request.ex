...
defmodule GoogleApi.SearchConsole.V1.Model.RunMobileFriendlyTestRequest do
  ...
  - url (String.t): URL for inspection. Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :requestScreenshot => any(),
          :url => any()
        }
...
defimpl Poison.Decoder, for: GoogleApi.SearchConsole.V1.Model.RunMobileFriendlyTestRequest do
  def decode(value, options) do
    GoogleApi.SearchConsole.V1.Model.RunMobileFriendlyTestRequest.decode(value, options)
  end
end
