...
defmodule GoogleApi.SearchConsole.V1.Model.RichResultsIssue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SearchConsole.V1.Model.RichResultsIssue do
  def decode(value, options) do
    GoogleApi.SearchConsole.V1.Model.RichResultsIssue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SearchConsole.V1.Model.RichResultsIssue do
