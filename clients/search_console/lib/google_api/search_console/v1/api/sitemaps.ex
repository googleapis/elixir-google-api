...
defmodule GoogleApi.SearchConsole.V1.Api.Sitemaps do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def webmasters_sitemaps_delete(
    ...
    request =
      ...
      |> Request.url("/webmasters/v3/sites/{siteUrl}/sitemaps/{feedpath}", %{
  ...
  *   `{:ok, %GoogleApi.SearchConsole.V1.Model.WmxSitemap{}}` on success
  *   `{:error, info}` on failure
  """
  @spec webmasters_sitemaps_get(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SearchConsole.V1.Model.WmxSitemap.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def webmasters_sitemaps_get(connection, site_url, feedpath, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SearchConsole.V1.Model.WmxSitemap{}])
  end
  ...
  *   `{:ok, %GoogleApi.SearchConsole.V1.Model.SitemapsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec webmasters_sitemaps_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SearchConsole.V1.Model.SitemapsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def webmasters_sitemaps_list(connection, site_url, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/webmasters/v3/sites/{siteUrl}/sitemaps", %{
        "siteUrl" => URI.encode(site_url, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SearchConsole.V1.Model.SitemapsListResponse{}])
  end
