...
defmodule GoogleApi.SearchConsole.V1.Api.Searchanalytics do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.SearchConsole.V1.Model.SearchAnalyticsQueryRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SearchConsole.V1.Model.SearchAnalyticsQueryResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def webmasters_searchanalytics_query(connection, site_url, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/webmasters/v3/sites/{siteUrl}/searchAnalytics/query", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SearchConsole.V1.Model.SearchAnalyticsQueryResponse{}]
    )
  end
end
