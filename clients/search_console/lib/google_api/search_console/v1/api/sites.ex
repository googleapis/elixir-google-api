...
defmodule GoogleApi.SearchConsole.V1.Api.Sites do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def webmasters_sites_add(connection, site_url, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:put)
      |> Request.url("/webmasters/v3/sites/{siteUrl}", %{
  ...
  *   `connection` (*type:* `GoogleApi.SearchConsole.V1.Connection.t`) - Connection to server
  *   `site_url` (*type:* `String.t`) - The URI of the property as defined in Search Console. **Examples:** `http://www.example.com/` or `sc-domain:example.com`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  ...
  def webmasters_sites_get(connection, site_url, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SearchConsole.V1.Model.WmxSite{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def webmasters_sites_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/webmasters/v3/sites", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SearchConsole.V1.Model.SitesListResponse{}])
  end
end
