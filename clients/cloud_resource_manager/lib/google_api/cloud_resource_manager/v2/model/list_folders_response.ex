...
defmodule GoogleApi.CloudResourceManager.V2.Model.ListFoldersResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V2.Model.ListFoldersResponse do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V2.Model.ListFoldersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V2.Model.ListFoldersResponse do
