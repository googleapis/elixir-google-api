...
defmodule GoogleApi.CloudResourceManager.V2.Model.Folder do
  ...
  *   `displayName` (*type:* `String.t`, *default:* `nil`) - The folder’s display name.
  ...
  *   `lifecycleState` (*type:* `String.t`, *default:* `nil`) - Output only. The lifecycle state of the folder.
      Updates to the lifecycle_state must be performed via
      DeleteFolder and
      UndeleteFolder.
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name of the Folder.
      Its format is `folders/{folder_id}`, for example: "folders/1234".
  *   `parent` (*type:* `String.t`, *default:* `nil`) - Required. The Folder’s parent's resource name.
