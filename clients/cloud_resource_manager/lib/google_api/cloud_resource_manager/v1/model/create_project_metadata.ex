...
defmodule GoogleApi.CloudResourceManager.V1.Model.CreateProjectMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V1.Model.CreateProjectMetadata do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V1.Model.CreateProjectMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V1.Model.CreateProjectMetadata do
