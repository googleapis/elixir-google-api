...
defmodule GoogleApi.CloudResourceManager.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V1.Model.Expr do
