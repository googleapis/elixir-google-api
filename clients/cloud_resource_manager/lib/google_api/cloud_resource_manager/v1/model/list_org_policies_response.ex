...
defmodule GoogleApi.CloudResourceManager.V1.Model.ListOrgPoliciesResponse do
  ...
  - nextPageToken (String.t): Page token used to retrieve the next page. This is currently not used, but the server may at any point start supplying a valid token. Defaults to: `null`.
  - policies ([OrgPolicy]): The &#x60;Policies&#x60; that are set on the resource. It will be empty if no &#x60;Policies&#x60; are set. Defaults to: `null`.
  """
