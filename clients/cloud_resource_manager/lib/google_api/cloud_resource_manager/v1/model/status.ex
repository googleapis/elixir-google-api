...
defmodule GoogleApi.CloudResourceManager.V1.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.CloudResourceManager.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.CloudResourceManager.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V1.Model.Status do
