...
defmodule GoogleApi.CloudResourceManager.V1.Model.ListPolicy do
  ...
  - allValues (String.t): The policy all_values state. Defaults to `nil`.
  - allowedValues (list(String.t)): List of values allowed  at this resource. Can only be set if `all_values`
  is set to `ALL_VALUES_UNSPECIFIED`. Defaults to `nil`.
  - deniedValues (list(String.t)): List of values denied at this resource. Can only be set if `all_values`
  is set to `ALL_VALUES_UNSPECIFIED`. Defaults to `nil`.
  ...
  `folders/F1`, `projects/P1`. Defaults to `nil`.
  ...
  unless `inherit_from_parent` is `false`. Defaults to `nil`.
  """
