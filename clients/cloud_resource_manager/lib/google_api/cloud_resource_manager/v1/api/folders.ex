...
defmodule GoogleApi.CloudResourceManager.V1.Api.Folders do
  ...
  """
  @spec cloudresourcemanager_folders_clear_org_policy(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.Empty.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_clear_org_policy(connection, folders_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:clearOrgPolicy")
  ...
  {:error, info} on failure
  """
  @spec cloudresourcemanager_folders_get_effective_org_policy(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.OrgPolicy.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_get_effective_org_policy(connection, folders_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:getEffectiveOrgPolicy")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:error, info} on failure
  """
  @spec cloudresourcemanager_folders_get_org_policy(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.OrgPolicy.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_get_org_policy(connection, folders_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:getOrgPolicy")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.CloudResourceManager.V1.Model.OrgPolicy{})
  ...
  {:error, info} on failure
  """
  @spec cloudresourcemanager_folders_list_available_org_policy_constraints(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.ListAvailableOrgPolicyConstraintsResponse.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_list_available_org_policy_constraints(connection, folders_id, opts \\ []) do
    optional_params = %{
      :"upload_protocol" => :query,
      :"prettyPrint" => :query,
      :"fields" => :query,
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:listAvailableOrgPolicyConstraints")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:error, info} on failure
  """
  @spec cloudresourcemanager_folders_list_org_policies(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.ListOrgPoliciesResponse.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_list_org_policies(connection, folders_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:listOrgPolicies")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
  ...
  {:error, info} on failure
  """
  @spec cloudresourcemanager_folders_set_org_policy(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.CloudResourceManager.V1.Model.OrgPolicy.t} | {:error, Tesla.Env.t}
  def cloudresourcemanager_folders_set_org_policy(connection, folders_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/folders/#{folders_id}:setOrgPolicy")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.CloudResourceManager.V1.Model.OrgPolicy{})
