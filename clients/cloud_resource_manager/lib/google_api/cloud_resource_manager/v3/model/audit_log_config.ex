...
defmodule GoogleApi.CloudResourceManager.V3.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V3.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V3.Model.AuditLogConfig do
