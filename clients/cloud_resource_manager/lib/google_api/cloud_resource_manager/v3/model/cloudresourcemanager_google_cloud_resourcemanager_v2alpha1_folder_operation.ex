...
defmodule GoogleApi.CloudResourceManager.V3.Model.CloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.CloudResourceManager.V3.Model.CloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.CloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation.decode(
      value,
      options
    )
  end
