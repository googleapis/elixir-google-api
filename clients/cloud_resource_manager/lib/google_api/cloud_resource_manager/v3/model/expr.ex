...
defmodule GoogleApi.CloudResourceManager.V3.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V3.Model.Expr do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V3.Model.Expr do
