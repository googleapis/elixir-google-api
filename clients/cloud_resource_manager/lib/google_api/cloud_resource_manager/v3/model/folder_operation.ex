...
defmodule GoogleApi.CloudResourceManager.V3.Model.FolderOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V3.Model.FolderOperation do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.FolderOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V3.Model.FolderOperation do
