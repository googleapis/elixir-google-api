...
defmodule GoogleApi.CloudResourceManager.V3.Model.ProjectCreationStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V3.Model.ProjectCreationStatus do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.ProjectCreationStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V3.Model.ProjectCreationStatus do
