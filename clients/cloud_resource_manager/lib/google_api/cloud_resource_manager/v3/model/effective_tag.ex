...
defmodule GoogleApi.CloudResourceManager.V3.Model.EffectiveTag do
  ...
  *   `namespacedTagKey` (*type:* `String.t`, *default:* `nil`) - The namespaced_name of the TagKey, in the format of `{organization_id}/{tag_key_short_name}`
  *   `namespacedTagValue` (*type:* `String.t`, *default:* `nil`) - Namespaced name of the TagValue. Must be in the format `{organization_id}/{tag_key_short_name}/{tag_value_short_name}`.
