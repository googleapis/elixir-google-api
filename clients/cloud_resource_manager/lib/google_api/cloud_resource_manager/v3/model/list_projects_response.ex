...
defmodule GoogleApi.CloudResourceManager.V3.Model.ListProjectsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudResourceManager.V3.Model.ListProjectsResponse do
  def decode(value, options) do
    GoogleApi.CloudResourceManager.V3.Model.ListProjectsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudResourceManager.V3.Model.ListProjectsResponse do
