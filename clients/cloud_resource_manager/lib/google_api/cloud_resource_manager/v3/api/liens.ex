...
defmodule GoogleApi.CloudResourceManager.V3.Api.Liens do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.CloudResourceManager.V3.Model.Lien.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.CloudResourceManager.V3.Model.Lien{}}` on success
  *   `{:error, info}` on failure
  """
  @spec cloudresourcemanager_liens_create(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudResourceManager.V3.Model.Lien.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudresourcemanager_liens_create(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/liens", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudResourceManager.V3.Model.Lien{}])
  end
  ...
  *   `{:ok, %GoogleApi.CloudResourceManager.V3.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  """
  @spec cloudresourcemanager_liens_delete(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudResourceManager.V3.Model.Empty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudresourcemanager_liens_delete(connection, liens_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudResourceManager.V3.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.CloudResourceManager.V3.Model.ListLiensResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec cloudresourcemanager_liens_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudResourceManager.V3.Model.ListLiensResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudresourcemanager_liens_list(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.CloudResourceManager.V3.Model.ListLiensResponse{}]
    )
  end
end
