...
defmodule GoogleApi.MyBusinessVerifications.V1.Model.PostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MyBusinessVerifications.V1.Model.PostalAddress do
  def decode(value, options) do
    GoogleApi.MyBusinessVerifications.V1.Model.PostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MyBusinessVerifications.V1.Model.PostalAddress do
