...
defmodule GoogleApi.AdSenseHost.V41.Api.Urlchannels do
  ...
  *   `ad_client_id` (*type:* `String.t`) - Ad client from which to delete the URL channel.
  *   `url_channel_id` (*type:* `String.t`) - URL channel to delete.
  ...
  *   `{:error, info}` on failure
  """
  @spec adsensehost_urlchannels_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `connection` (*type:* `GoogleApi.AdSenseHost.V41.Connection.t`) - Connection to server
  *   `ad_client_id` (*type:* `String.t`) - Ad client to which the new URL channel will be added.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:fields` (*type:* `String.t`) - Selector specifying which fields to include in a partial response.
      *   `:key` (*type:* `String.t`) - API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.AdSenseHost.V41.Model.UrlChannel.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
