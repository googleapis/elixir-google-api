...
defmodule GoogleApi.AdSenseHost.V41.Model.AdUnitContentAdsSettings do
  ...
  - size (String.t): Size of this ad unit. Size values are in the form SIZE_{width}_{height}. Defaults to: `null`.
  - type (String.t): Type of this ad unit. Possible values are TEXT, TEXT_IMAGE, IMAGE and LINK. Defaults to: `null`.
  """
