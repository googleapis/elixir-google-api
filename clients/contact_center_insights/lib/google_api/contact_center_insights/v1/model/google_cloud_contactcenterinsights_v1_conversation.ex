...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Conversation do
  @moduledoc """
  ...
  *   `callMetadata` (*type:* `GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationCallMetadata.t`, *default:* `nil`) - Call-specific metadata.
  *   `createTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time at which the conversation was created.
  *   `dataSource` (*type:* `GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationDataSource.t`, *default:* `nil`) - The source of the audio and transcription for the conversation.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The most recent time at which the conversation was updated.
  ...
  @type t :: %__MODULE__{
          ...
          :callMetadata =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationCallMetadata.t()
            | nil,
          :createTime => DateTime.t() | nil,
          :dataSource =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationDataSource.t()
            | nil,
          :dialogflowIntents =>
            %{
              optional(String.t()) =>
                GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DialogflowIntent.t()
            }
            | nil,
          ...
          :transcript =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationTranscript.t()
            | nil,
          :ttl => String.t() | nil,
  ...
  field(:dialogflowIntents,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DialogflowIntent,
    type: :map
  )
  ...
  field(:runtimeAnnotations,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1RuntimeAnnotation,
    type: :list
  )
  ...
  field(:transcript,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1ConversationTranscript
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Conversation do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Conversation.decode(
      value,
      options
    )
  end
