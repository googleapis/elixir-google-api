...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContactCenterInsights.V1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContactCenterInsights.V1.Model.GoogleRpcStatus do
