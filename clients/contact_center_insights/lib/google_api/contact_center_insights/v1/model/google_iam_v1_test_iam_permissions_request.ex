...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContactCenterInsights.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleIamV1TestIamPermissionsRequest.decode(
      value,
      options
    )
  end
