...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecMetadata do
  @moduledoc """
  ...
  *   `request` (*type:* `GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecRequest.t`, *default:* `nil`) - Output only. The original request for initialization.
  ...
  @type t :: %__MODULE__{
          ...
          :request =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecRequest.t()
            | nil
        }
  ...
  field(:request,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecRequest
  )
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecMetadata do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1InitializeEncryptionSpecMetadata.decode(
      value,
      options
    )
  end
