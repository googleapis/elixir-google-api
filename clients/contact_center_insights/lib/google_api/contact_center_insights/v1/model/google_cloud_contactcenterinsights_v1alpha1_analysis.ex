...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1Analysis do
  @moduledoc """
  ...
  *   `requestTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time at which the analysis was requested.
  ...
  @type t :: %__MODULE__{
          :analysisResult =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1AnalysisResult.t()
            | nil,
          :annotatorSelector =>
...
defimpl Poison.Decoder,
  for: GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1Analysis do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1Analysis.decode(
      value,
      options
    )
  end
