...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Dimension do
  @moduledoc """
  ...
  *   `qaQuestionDimensionMetadata` (*type:* `GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionQaQuestionDimensionMetadata.t`, *default:* `nil`) - Output only. Metadata about the QA question dimension.
  ...
  @type t :: %__MODULE__{
          :agentDimensionMetadata =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionAgentDimensionMetadata.t()
            | nil,
          :dimensionKey => String.t() | nil,
          :issueDimensionMetadata =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionIssueDimensionMetadata.t()
            | nil,
          :qaQuestionAnswerDimensionMetadata =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionQaQuestionAnswerDimensionMetadata.t()
            | nil,
          :qaQuestionDimensionMetadata =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionQaQuestionDimensionMetadata.t()
            | nil
        }

  field(:agentDimensionMetadata,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionAgentDimensionMetadata
  )
  ...
  field(:issueDimensionMetadata,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionIssueDimensionMetadata
  )

  field(:qaQuestionAnswerDimensionMetadata,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionQaQuestionAnswerDimensionMetadata
  )

  field(:qaQuestionDimensionMetadata,
    as:
      GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1DimensionQaQuestionDimensionMetadata
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Dimension do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1Dimension.decode(
      value,
      options
    )
  end
