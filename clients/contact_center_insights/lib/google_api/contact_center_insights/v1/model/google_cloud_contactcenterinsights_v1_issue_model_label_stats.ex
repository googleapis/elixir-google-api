...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1IssueModelLabelStats do
  @moduledoc """
  ...
  *   `issueStats` (*type:* `%{optional(String.t) => GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1IssueModelLabelStatsIssueStats.t}`, *default:* `nil`) - Statistics on each issue. Key is the issue's resource name.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1IssueModelLabelStats do
  def decode(value, options) do
    GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1IssueModelLabelStats.decode(
      value,
      options
    )
  end
