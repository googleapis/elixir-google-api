...
defmodule GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotation do
  ...
  *   `userInput` (*type:* `GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotationUserInput.t`, *default:* `nil`) - Explicit input used for generating the answer
  """
  ...
  @type t :: %__MODULE__{
          ...
          :startBoundary =>
            ...
            | nil,
          :userInput =>
            GoogleApi.ContactCenterInsights.V1.Model.GoogleCloudContactcenterinsightsV1alpha1RuntimeAnnotationUserInput.t()
            | nil
        }
