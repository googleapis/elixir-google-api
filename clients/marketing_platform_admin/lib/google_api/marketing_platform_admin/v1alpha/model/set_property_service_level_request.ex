...
defmodule GoogleApi.MarketingPlatformAdmin.V1alpha.Model.SetPropertyServiceLevelRequest do
  @moduledoc """
  ...
  *   `serviceLevel` (*type:* `String.t`, *default:* `nil`) - Required. The service level to set for this property.
  ...
  field(:analyticsProperty)
  field(:serviceLevel)
end

defimpl Poison.Decoder,
  for: GoogleApi.MarketingPlatformAdmin.V1alpha.Model.SetPropertyServiceLevelRequest do
  def decode(value, options) do
    GoogleApi.MarketingPlatformAdmin.V1alpha.Model.SetPropertyServiceLevelRequest.decode(
      value,
      options
    )
  end
