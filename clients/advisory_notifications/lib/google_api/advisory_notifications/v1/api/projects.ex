...
defmodule GoogleApi.AdvisoryNotifications.V1.Api.Projects do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec advisorynotifications_projects_locations_get_settings(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def advisorynotifications_projects_locations_get_settings(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec advisorynotifications_projects_locations_update_settings(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def advisorynotifications_projects_locations_update_settings(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec advisorynotifications_projects_locations_notifications_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec advisorynotifications_projects_locations_notifications_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
