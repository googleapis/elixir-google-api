...
defmodule GoogleApi.AccessApproval.V1.Model.AccessApprovalSettings do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the settings. Format is one of: 1. "projects/{project_id}/accessApprovalSettings" 2. "folders/{folder_id}/accessApprovalSettings" 3. "organizations/{organization_id}/accessApprovalSettings" 
