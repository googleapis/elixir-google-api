...
defmodule GoogleApi.Translate.Mixfile do
  ...
  def project() do
    [
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/translate"
    ]
  end
  ...
  defp description() do
    """
    Client library for Google Cloud Translation API from Google. The Google Cloud Translation API lets websites and programs integrate with
