...
defmodule GoogleApi.Translate.V2.Model.DetectionsResource do
  ...
  - confidence (number()): The confidence of the detection result of this language. Defaults to `nil`.
  - isReliable (boolean()): A boolean to indicate is the language detection result reliable. Defaults to `nil`.
  - language (String.t): The language we detected. Defaults to `nil`.
  """
