...
defmodule GoogleApi.Translate.V2.Api.Detections do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Translate.V2.Model.DetectLanguageRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  ...
  def language_detections_detect(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Translate.V2.Model.DetectionsListResponse{}, data_wrapped: true]
    )
  end
  ...
  *   `connection` (*type:* `GoogleApi.Translate.V2.Connection.t`) - Connection to server
  *   `q` (*type:* `list(String.t)`) - The input text upon which to perform language detection. Repeat this
