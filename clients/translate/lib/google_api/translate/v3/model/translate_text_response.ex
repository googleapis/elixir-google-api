...
defmodule GoogleApi.Translate.V3.Model.TranslateTextResponse do
  @moduledoc """
  ...
  *   `translations` (*type:* `list(GoogleApi.Translate.V3.Model.Translation.t)`, *default:* `nil`) - Text translation responses with no glossary applied.
  ...
  field(:translations, as: GoogleApi.Translate.V3.Model.Translation, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Translate.V3.Model.TranslateTextResponse do
  def decode(value, options) do
    GoogleApi.Translate.V3.Model.TranslateTextResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3.Model.TranslateTextResponse do
