...
defmodule GoogleApi.Translate.V3.Model.GlossaryConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3.Model.GlossaryConfig do
  def decode(value, options) do
    GoogleApi.Translate.V3.Model.GlossaryConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3.Model.GlossaryConfig do
