...
defmodule GoogleApi.Translate.V3.Model.BatchDocumentOutputConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3.Model.BatchDocumentOutputConfig do
  def decode(value, options) do
    GoogleApi.Translate.V3.Model.BatchDocumentOutputConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3.Model.BatchDocumentOutputConfig do
