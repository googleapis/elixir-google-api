...
defmodule GoogleApi.Translate.V3.Model.BatchTranslateTextRequest do
  ...
  *   `inputConfigs` (*type:* `list(GoogleApi.Translate.V3.Model.InputConfig.t)`, *default:* `nil`) - Required. Input configurations. The total number of files matched should be <= 1000. The total content size should be <= 100M Unicode codepoints. The files must use UTF-8 encoding.
