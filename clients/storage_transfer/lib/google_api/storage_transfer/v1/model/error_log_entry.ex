...
defmodule GoogleApi.StorageTransfer.V1.Model.ErrorLogEntry do
  ...
  - errorDetails (list(String.t)): A list of messages that carry the error details. Defaults to `nil`.
  - url (String.t): Required. A URL that refers to the target (a data source, a data sink,
  or an object) with which the error is associated. Defaults to `nil`.
  """
