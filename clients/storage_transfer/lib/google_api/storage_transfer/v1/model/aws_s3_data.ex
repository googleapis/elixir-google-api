...
defmodule GoogleApi.StorageTransfer.V1.Model.AwsS3Data do
  ...
  - awsAccessKey (GoogleApi.StorageTransfer.V1.Model.AwsAccessKey.t): Required. AWS access key used to sign the API requests to the AWS S3
  bucket. Permissions on the bucket must be granted to the access ID of the
  AWS access key. Defaults to `nil`.
  - bucketName (String.t): Required. S3 Bucket name (see
  [Creating a
  bucket](http://docs.aws.amazon.com/AmazonS3/latest/dev/create-bucket-get-location-example.html)). Defaults to `nil`.
  """
