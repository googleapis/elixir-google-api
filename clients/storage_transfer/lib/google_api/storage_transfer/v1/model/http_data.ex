...
defmodule GoogleApi.StorageTransfer.V1.Model.HttpData do
  ...
  - listUrl (String.t): The URL that points to the file that stores the object list entries. This file must allow public access.  Currently, only URLs with HTTP and HTTPS schemes are supported. Required. Defaults to: `null`.
  """
