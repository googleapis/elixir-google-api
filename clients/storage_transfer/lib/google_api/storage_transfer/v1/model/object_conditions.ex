...
defmodule GoogleApi.StorageTransfer.V1.Model.ObjectConditions do
  ...
  - excludePrefixes (list(String.t)): `excludePrefixes` must follow the requirements described for
  `includePrefixes`.

  The max size of `excludePrefixes` is 1000. Defaults to `nil`.
  - includePrefixes (list(String.t)): If `includePrefixes` is specified, objects that satisfy the object
  ...
  * If `includePrefixes` is specified, then each exclude-prefix must start
  ...
  The max size of `includePrefixes` is 1000. Defaults to `nil`.
  - maxTimeElapsedSinceLastModification (String.t): If specified, only objects with a `lastModificationTime` on or after
  ...
  property of GCS objects and the `LastModified` field of S3 objects. Defaults to `nil`.
  - minTimeElapsedSinceLastModification (String.t): If specified, only objects with a `lastModificationTime` before
