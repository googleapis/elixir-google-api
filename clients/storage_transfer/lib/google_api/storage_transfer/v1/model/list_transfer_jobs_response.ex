...
defmodule GoogleApi.StorageTransfer.V1.Model.ListTransferJobsResponse do
  ...
  - nextPageToken (String.t): The list next page token. Defaults to `nil`.
  - transferJobs (list(GoogleApi.StorageTransfer.V1.Model.TransferJob.t)): A list of transfer jobs. Defaults to `nil`.
  """
