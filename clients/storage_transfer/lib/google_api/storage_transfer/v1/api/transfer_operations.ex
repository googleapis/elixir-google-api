...
defmodule GoogleApi.StorageTransfer.V1.Api.TransferOperations do
  ...
  - connection (GoogleApi.StorageTransfer.V1.Connection): Connection to server
  - name (String.t): Required. The value `transferOperations`.
  - optional_params (keyword()): [optional] Optional parameters
    - :$.xgafv (String.t): V1 error format.
    - :access_token (String.t): OAuth access token.
    - :alt (String.t): Data format for response.
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :filter (String.t): Required. A list of query parameters specified as JSON text in the form of: {"project_id":"my_project_id",
  ...
  - connection (GoogleApi.StorageTransfer.V1.Connection): Connection to server
  - name (String.t): Required. The name of the transfer operation.
  - optional_params (keyword()): [optional] Optional parameters
    - :$.xgafv (String.t): V1 error format.
    - :access_token (String.t): OAuth access token.
    - :alt (String.t): Data format for response.
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.StorageTransfer.V1.Model.PauseTransferOperationRequest.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.StorageTransfer.V1.Model.ResumeTransferOperationRequest.t): 
