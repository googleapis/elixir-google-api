...
defmodule GoogleApi.StorageTransfer.V1.Api.GoogleServiceAccounts do
  ...
  *   `project_id` (*type:* `String.t`) - Required. The ID of the Google Cloud project that the Google service account is associated with.
  ...
  *   `{:error, info}` on failure
  """
  @spec storagetransfer_google_service_accounts_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
