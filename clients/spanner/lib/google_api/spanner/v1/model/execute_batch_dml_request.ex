...
defmodule GoogleApi.Spanner.V1.Model.ExecuteBatchDmlRequest do
  ...
  *   `seqno` (*type:* `String.t`, *default:* `nil`) - Required. A per-transaction sequence number used to identify this request. This field
  ...
  *   `statements` (*type:* `list(GoogleApi.Spanner.V1.Model.Statement.t)`, *default:* `nil`) - Required. The list of statements to execute in this batch. Statements are executed
      serially, such that the effects of statement `i` are visible to statement
      `i+1`. Each statement must be a DML statement. Execution stops at the
      first failed statement; the remaining statements are not executed.

      Callers must provide at least one statement.
  *   `transaction` (*type:* `GoogleApi.Spanner.V1.Model.TransactionSelector.t`, *default:* `nil`) - Required. The transaction to use. Must be a read-write transaction.
