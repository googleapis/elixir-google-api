...
defmodule GoogleApi.Spanner.V1.Model.ShortRepresentation do
  ...
  - description (String.t): A string representation of the expression subtree rooted at this node. Defaults to `nil`.
  - subqueries (map()): A mapping of (subquery variable name) -> (subquery node id) for cases
