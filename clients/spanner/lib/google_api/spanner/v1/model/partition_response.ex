...
defmodule GoogleApi.Spanner.V1.Model.PartitionResponse do
  ...
  - partitions (list(GoogleApi.Spanner.V1.Model.Partition.t)): Partitions created by this request. Defaults to `nil`.
  - transaction (GoogleApi.Spanner.V1.Model.Transaction.t): Transaction created by this request. Defaults to `nil`.
  """
