...
defimpl Poison.Decoder, for: GoogleApi.Spanner.V1.Model.ListDatabaseOperationsResponse do
  def decode(value, options) do
    GoogleApi.Spanner.V1.Model.ListDatabaseOperationsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Spanner.V1.Model.ListDatabaseOperationsResponse do
