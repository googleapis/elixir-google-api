...
defmodule GoogleApi.Spanner.V1.Model.ReplicaInfo do
  ...
  - defaultLeaderLocation (boolean()): If true, this location is designated as the default leader location where
  leader replicas are placed. See the [region types
  documentation](https://cloud.google.com/spanner/docs/instances#region_types)
  for more details. Defaults to `nil`.
  - location (String.t): The location of the serving resources, e.g. "us-central1". Defaults to `nil`.
  - type (String.t): The type of replica. Defaults to `nil`.
  """
