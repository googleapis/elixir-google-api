...
defmodule GoogleApi.Spanner.V1.Model.QueryPlan do
  ...
  - planNodes (list(GoogleApi.Spanner.V1.Model.PlanNode.t)): The nodes in the query plan. Plan nodes are returned in pre-order starting
  with the plan root. Each PlanNode's `id` corresponds to its index in
  `plan_nodes`. Defaults to `nil`.
  """
