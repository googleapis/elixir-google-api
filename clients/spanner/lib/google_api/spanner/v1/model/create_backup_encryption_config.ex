...
defmodule GoogleApi.Spanner.V1.Model.CreateBackupEncryptionConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Spanner.V1.Model.CreateBackupEncryptionConfig do
  def decode(value, options) do
    GoogleApi.Spanner.V1.Model.CreateBackupEncryptionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Spanner.V1.Model.CreateBackupEncryptionConfig do
