...
defmodule GoogleApi.Spanner.V1.Model.ExecuteBatchDmlResponse do
  ...
  - resultSets (list(GoogleApi.Spanner.V1.Model.ResultSet.t)): ResultSets, one for each statement in the request that ran successfully, in
  ...
  ResultSetMetadata. Defaults to `nil`.
  - status (GoogleApi.Spanner.V1.Model.Status.t): If all DML statements are executed successfully, status will be OK.
  Otherwise, the error status of the first failed statement. Defaults to `nil`.
  """
