...
defmodule GoogleApi.Spanner.V1.Model.Database do
  ...
  - name (String.t): Required. The name of the database. Values are of the form
  `projects/<project>/instances/<instance>/databases/<database>`,
  where `<database>` is as specified in the `CREATE DATABASE`
  statement. This name can be passed to other API methods to
  identify the database. Defaults to `nil`.
  - state (String.t): Output only. The current database state. Defaults to `nil`.
  """
