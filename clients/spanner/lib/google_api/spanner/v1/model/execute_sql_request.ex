...
defimpl Poison.Decoder, for: GoogleApi.Spanner.V1.Model.ExecuteSqlRequest do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"paramTypes", :map, GoogleApi.Spanner.V1.Model.Type, options)
    |> deserialize(:"params", :struct, GoogleApi.Spanner.V1.Model.Object, options)
