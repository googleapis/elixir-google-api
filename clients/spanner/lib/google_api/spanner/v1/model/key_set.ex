...
defmodule GoogleApi.Spanner.V1.Model.KeySet do
  ...
  - keys ([[ErrorUnknown]]): A list of specific keys. Entries in &#x60;keys&#x60; should have exactly as many elements as there are columns in the primary or index key with which this &#x60;KeySet&#x60; is used.  Individual key values are encoded as described here. Defaults to: `null`.
  - ranges ([KeyRange]): A list of key ranges. See KeyRange for more information about key range specifications. Defaults to: `null`.
  """
