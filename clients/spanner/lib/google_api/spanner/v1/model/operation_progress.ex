...
defmodule GoogleApi.Spanner.V1.Model.OperationProgress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Spanner.V1.Model.OperationProgress do
  def decode(value, options) do
    GoogleApi.Spanner.V1.Model.OperationProgress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Spanner.V1.Model.OperationProgress do
