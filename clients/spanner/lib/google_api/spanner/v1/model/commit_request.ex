...
defmodule GoogleApi.Spanner.V1.Model.CommitRequest do
  ...
  - mutations (list(GoogleApi.Spanner.V1.Model.Mutation.t)): The mutations to be executed when this transaction commits. All
  mutations are applied atomically, in the order they appear in
  this list. Defaults to `nil`.
  - singleUseTransaction (GoogleApi.Spanner.V1.Model.TransactionOptions.t): Execute mutations in a temporary transaction. Note that unlike
  ...
  Commit instead. Defaults to `nil`.
  - transactionId (String.t): Commit a previously-started transaction. Defaults to `nil`.
  """
