...
defmodule GoogleApi.Spanner.V1.Model.TransactionOptions do
  ...
  *   `partitionedDml` (*type:* `GoogleApi.Spanner.V1.Model.PartitionedDml.t`, *default:* `nil`) - Partitioned DML transaction.

      Authorization to begin a Partitioned DML transaction requires
      `spanner.databases.beginPartitionedDmlTransaction` permission
      on the `session` resource.
  *   `readOnly` (*type:* `GoogleApi.Spanner.V1.Model.ReadOnly.t`, *default:* `nil`) - Transaction will not write.

      Authorization to begin a read-only transaction requires
      `spanner.databases.beginReadOnlyTransaction` permission
      on the `session` resource.
  *   `readWrite` (*type:* `GoogleApi.Spanner.V1.Model.ReadWrite.t`, *default:* `nil`) - Transaction may write.
