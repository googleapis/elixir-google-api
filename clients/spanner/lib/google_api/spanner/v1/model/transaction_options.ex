...
defmodule GoogleApi.Spanner.V1.Model.TransactionOptions do
  ...
  - partitionedDml (GoogleApi.Spanner.V1.Model.PartitionedDml.t): Partitioned DML transaction.

  Authorization to begin a Partitioned DML transaction requires
  `spanner.databases.beginPartitionedDmlTransaction` permission
  on the `session` resource. Defaults to `nil`.
  - readOnly (GoogleApi.Spanner.V1.Model.ReadOnly.t): Transaction will not write.

  Authorization to begin a read-only transaction requires
  `spanner.databases.beginReadOnlyTransaction` permission
  on the `session` resource. Defaults to `nil`.
  - readWrite (GoogleApi.Spanner.V1.Model.ReadWrite.t): Transaction may write.
