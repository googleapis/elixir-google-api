...
defmodule GoogleApi.Spanner.V1.Model.SetIamPolicyRequest do
  ...
  *   `policy` (*type:* `GoogleApi.Spanner.V1.Model.Policy.t`, *default:* `nil`) - REQUIRED: The complete policy to be applied to the `resource`. The size of
  ...
  @type t :: %__MODULE__{
          :policy => GoogleApi.Spanner.V1.Model.Policy.t()
        }
