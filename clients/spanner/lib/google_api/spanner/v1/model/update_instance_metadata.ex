...
defmodule GoogleApi.Spanner.V1.Model.UpdateInstanceMetadata do
  ...
  - cancelTime (DateTime.t): The time at which this operation was cancelled. If set, this operation is
  in the process of undoing itself (which is guaranteed to succeed) and
  cannot be cancelled again. Defaults to `nil`.
  - endTime (DateTime.t): The time at which this operation failed or was completed successfully. Defaults to `nil`.
  - instance (GoogleApi.Spanner.V1.Model.Instance.t): The desired end state of the update. Defaults to `nil`.
  - startTime (DateTime.t): The time at which UpdateInstance
  request was received. Defaults to `nil`.
  """
