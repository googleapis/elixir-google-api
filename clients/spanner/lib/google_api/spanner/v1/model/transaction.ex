...
defmodule GoogleApi.Spanner.V1.Model.Transaction do
  ...
  - id (String.t): `id` may be used to identify the transaction in subsequent
  Read,
  ExecuteSql,
  Commit, or
  Rollback calls.
  ...
  single-use transactions do not support multiple requests. Defaults to `nil`.
  - readTimestamp (DateTime.t): For snapshot read-only transactions, the read timestamp chosen
