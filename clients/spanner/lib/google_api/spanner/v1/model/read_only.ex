...
defmodule GoogleApi.Spanner.V1.Model.ReadOnly do
  ...
  - exactStaleness (String.t): Executes all reads at a timestamp that is `exact_staleness`
  ...
  timestamp negotiation overhead of `max_staleness`. Defaults to `nil`.
  - maxStaleness (String.t): Read data at a timestamp >= `NOW - max_staleness`
  ...
  transactions. Defaults to `nil`.
  - minReadTimestamp (DateTime.t): Executes all reads at a timestamp >= `min_read_timestamp`.
  ...
  Example: `"2014-10-02T15:01:23.045123456Z"`. Defaults to `nil`.
  - readTimestamp (DateTime.t): Executes all reads at the given timestamp. Unlike other modes,
  ...
  the Transaction message that describes the transaction. Defaults to `nil`.
  - strong (boolean()): Read at a timestamp where all previously committed transactions
  are visible. Defaults to `nil`.
  """
