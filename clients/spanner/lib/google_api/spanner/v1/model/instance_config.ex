...
defmodule GoogleApi.Spanner.V1.Model.InstanceConfig do
  ...
  *   `configType` (*type:* `String.t`, *default:* `nil`) - Output only. Whether this instance configuration is a Google- or user-managed configuration.
  ...
  *   `reconciling` (*type:* `boolean()`, *default:* `nil`) - Output only. If true, the instance configuration is being created or updated. If false, there are no ongoing operations for the instance config.
