...
defmodule GoogleApi.Spanner.V1.Model.ResultSetMetadata do
  ...
  - rowType (GoogleApi.Spanner.V1.Model.StructType.t): Indicates the field names and types for the rows in the result
  ...
  - transaction (GoogleApi.Spanner.V1.Model.Transaction.t): If the read or SQL query began a transaction as a side-effect, the
  information about the new transaction is yielded here. Defaults to `nil`.
  """
