...
defmodule GoogleApi.Spanner.V1.Model.BeginTransactionRequest do
  ...
  - options (GoogleApi.Spanner.V1.Model.TransactionOptions.t): Required. Options for the new transaction. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Spanner.V1.Model.BeginTransactionRequest do
  def decode(value, options) do
    GoogleApi.Spanner.V1.Model.BeginTransactionRequest.decode(value, options)
  end
end
