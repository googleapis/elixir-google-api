...
defmodule GoogleApi.Spanner.V1.Model.PartitionQueryRequest do
  ...
  - params (map()): The SQL query string can contain parameter placeholders. A parameter
  ...
  - sql (String.t): The query request to generate partitions for. The request will fail if
  ...
  PartitionedDml transaction for large, partition-friendly DML operations. Defaults to `nil`.
