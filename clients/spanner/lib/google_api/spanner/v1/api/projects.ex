...
defmodule GoogleApi.Spanner.V1.Api.Projects do
  ...
  *   `parent` (*type:* `String.t`) - Required. The project of the instance configuration operations. Values are of the form `projects/`.
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The name of the project in which to create the instance configuration. Values are of the form `projects/`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:etag` (*type:* `String.t`) - Used for optimistic concurrency control as a way to help prevent simultaneous deletes of an instance configuration from overwriting each other. If not empty, the API only deletes the instance configuration when the etag provided matches the current status of the requested instance configuration. Otherwise, deletes the instance configuration without checking the current status of the requested instance configuration.
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - A unique identifier for the instance configuration. Values are of the form `projects//instanceConfigs/a-z*`. User instance configuration must start with `custom-`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instance_configs_ssd_caches_operations_cancel(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instance_configs_ssd_caches_operations_cancel(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instance_configs_ssd_caches_operations_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instance_configs_ssd_caches_operations_delete(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instance_configs_ssd_caches_operations_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instance_configs_ssd_caches_operations_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instance_configs_ssd_caches_operations_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instance_configs_ssd_caches_operations_list(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  ...
  def spanner_projects_instances_backups_create(
    ...
    optional_params_config = %{
      ...
      :"encryptionConfig.kmsKeyNames" => :query,
      :body => :body
    }
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.ChangeQuorumRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_changequorum(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_changequorum(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+name}:changequorum", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the database. Values are of the form `projects//instances//databases/`, where `` is as specified in the `CREATE DATABASE` statement. This name can be passed to other API methods to identify the database.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:updateMask` (*type:* `String.t`) - Required. The list of fields to update. Currently, only `enable_drop_protection` field can be updated.
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.Database.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The name of the database that this backup schedule applies to.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:backupScheduleId` (*type:* `String.t`) - Required. The Id to use for the backup schedule. The `backup_schedule_id` appended to `parent` forms the full backup schedule name of the form `projects//instances//databases//backupSchedules/`.
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.BackupSchedule.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.BackupSchedule{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_create(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.BackupSchedule.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_create(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Spanner.V1.Model.BackupSchedule{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the schedule to delete. Values are of the form `projects//instances//databases//backupSchedules/`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_delete(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the schedule to retrieve. Values are of the form `projects//instances//databases//backupSchedules/`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_get_iam_policy(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. Database is the parent resource whose backup schedules should be listed. Values are of the form projects//instances//databases/
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:pageSize` (*type:* `integer()`) - Optional. Number of backup schedules to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
      *   `:pageToken` (*type:* `String.t`) - Optional. If non-empty, `page_token` should contain a next_page_token from a previous ListBackupSchedulesResponse to the same `parent`.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.ListBackupSchedulesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.ListBackupSchedulesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_list(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Spanner.V1.Model.ListBackupSchedulesResponse{}]
    )
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Identifier. Output only for the CreateBackupSchedule operation. Required for the UpdateBackupSchedule operation. A globally unique identifier for the backup schedule which cannot be changed. Values are of the form `projects//instances//databases//backupSchedules/a-z*[a-z0-9]` The final segment of the name must be between 2 and 60 characters in length.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:updateMask` (*type:* `String.t`) - Required. A mask specifying which fields in the BackupSchedule resource should be updated. This mask is relative to the BackupSchedule resource, not to the request message. The field mask must always be specified; this prevents any future fields from being erased accidentally.
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.BackupSchedule.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_set_iam_policy(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_backup_schedules_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_backup_schedules_test_iam_permissions(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The database session in which the adapter request is processed.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.AdaptMessageRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.AdaptMessageResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_sessions_adapt_message(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.AdaptMessageResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_sessions_adapt_message(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+name}:adaptMessage", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Spanner.V1.Model.AdaptMessageResponse{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The database in which the new session is created.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.AdapterSession.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.AdapterSession{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_sessions_adapter(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.AdapterSession.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_sessions_adapter(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/sessions:adapter", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Spanner.V1.Model.AdapterSession{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `session` (*type:* `String.t`) - Required. The session in which the batch request is to be run.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.BatchWriteRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.BatchWriteResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_databases_sessions_batch_write(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.BatchWriteResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_databases_sessions_batch_write(
        connection,
        session,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+session}:batchWrite", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Spanner.V1.Model.BatchWriteResponse{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The parent instance of the instance partition operations. Values are of the form `projects//instances/`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:filter` (*type:* `String.t`) - Optional. An expression that filters the list of returned operations. A filter expression consists of a field name, a comparison operator, and a value for filtering. The value must be a string, a number, or a boolean. The comparison operator must be one of: `<`, `>`, `<=`, `>=`, `!=`, `=`, or `:`. Colon `:` is the contains operator. Filter rules are not case sensitive. The following fields in the Operation are eligible for filtering: * `name` - The name of the long-running operation * `done` - False if the operation is in progress, else true. * `metadata.@type` - the type of metadata. For example, the type string for CreateInstancePartitionMetadata is `type.googleapis.com/google.spanner.admin.instance.v1.CreateInstancePartitionMetadata`. * `metadata.` - any field in metadata.value. `metadata.@type` must be specified first, if filtering on metadata fields. * `error` - Error associated with the long-running operation. * `response.@type` - the type of response. * `response.` - any field in response.value. You can combine multiple expressions by enclosing each expression in parentheses. By default, expressions are combined with AND logic. However, you can specify AND, OR, and NOT logic explicitly. Here are a few examples: * `done:true` - The operation is complete. * `(metadata.@type=` \\ `type.googleapis.com/google.spanner.admin.instance.v1.CreateInstancePartitionMetadata) AND` \\ `(metadata.instance_partition.name:custom-instance-partition) AND` \\ `(metadata.start_time < \\"2021-03-28T14:50:00Z\\") AND` \\ `(error:*)` - Return operations where: * The operation's metadata type is CreateInstancePartitionMetadata. * The instance partition name contains "custom-instance-partition". * The operation started before 2021-03-28T14:50:00Z. * The operation resulted in an error.
      *   `:instancePartitionDeadline` (*type:* `DateTime.t`) - Optional. Deadline used while retrieving metadata for instance partition operations. Instance partitions whose operation metadata cannot be retrieved within this deadline will be added to unreachable_instance_partitions in ListInstancePartitionOperationsResponse.
      *   `:pageSize` (*type:* `integer()`) - Optional. Number of operations to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
      *   `:pageToken` (*type:* `String.t`) - Optional. If non-empty, `page_token` should contain a next_page_token from a previous ListInstancePartitionOperationsResponse to the same `parent` and with the same `filter`.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.ListInstancePartitionOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partition_operations_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.ListInstancePartitionOperationsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partition_operations_list(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    optional_params_config = %{
      ...
      :upload_protocol => :query,
      :filter => :query,
      :instancePartitionDeadline => :query,
      :pageSize => :query,
      :pageToken => :query
    }
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}/instancePartitionOperations", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Spanner.V1.Model.ListInstancePartitionOperationsResponse{}]
    )
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The name of the instance in which to create the instance partition. Values are of the form `projects//instances/`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.CreateInstancePartitionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_create(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_create(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/instancePartitions", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the instance partition to be deleted. Values are of the form `projects/{project}/instances/{instance}/instancePartitions/{instance_partition}`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:etag` (*type:* `String.t`) - Optional. If not empty, the API only deletes the instance partition when the etag provided matches the current status of the requested instance partition. Otherwise, deletes the instance partition without checking the current status of the requested instance partition.
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_delete(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the requested instance partition. Values are of the form `projects/{project}/instances/{instance}/instancePartitions/{instance_partition}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Spanner.V1.Model.InstancePartition{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.InstancePartition.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Spanner.V1.Model.InstancePartition{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Spanner.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The instance whose instance partitions should be listed. Values are of the form `projects//instances/`. Use `{instance} = '-'` to list instance partitions for all Instances in a project, e.g., `projects/myproject/instances/-`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:instancePartitionDeadline` (*type:* `DateTime.t`) - Optional. Deadline used while retrieving metadata for instance partitions. Instance partitions whose metadata cannot be retrieved within this deadline will be added to unreachable in ListInstancePartitionsResponse.
      *   `:pageSize` (*type:* `integer()`) - Number of instance partitions to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
      *   `:pageToken` (*type:* `String.t`) - If non-empty, `page_token` should contain a next_page_token from a previous ListInstancePartitionsResponse.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Spanner.V1.Model.ListInstancePartitionsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Spanner.V1.Model.ListInstancePartitionsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_list(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Spanner.V1.Model.ListInstancePartitionsResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Spanner.V1.Model.UpdateInstancePartitionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_operations_cancel(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_operations_cancel(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_operations_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_operations_delete(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_operations_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_operations_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec spanner_projects_instances_instance_partitions_operations_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def spanner_projects_instances_instance_partitions_operations_list(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
