...
defimpl Poison.Decoder, for: GoogleApi.MigrationCenter.V1.Model.MachineSeries do
  def decode(value, options) do
    GoogleApi.MigrationCenter.V1.Model.MachineSeries.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MigrationCenter.V1.Model.MachineSeries do
