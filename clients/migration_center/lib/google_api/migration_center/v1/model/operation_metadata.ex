...
defmodule GoogleApi.MigrationCenter.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MigrationCenter.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.MigrationCenter.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MigrationCenter.V1.Model.OperationMetadata do
