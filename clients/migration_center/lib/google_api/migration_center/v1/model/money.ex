...
defmodule GoogleApi.MigrationCenter.V1.Model.Money do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MigrationCenter.V1.Model.Money do
  def decode(value, options) do
    GoogleApi.MigrationCenter.V1.Model.Money.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MigrationCenter.V1.Model.Money do
