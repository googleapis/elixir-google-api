...
defmodule GoogleApi.MigrationCenter.V1.Model.DailyResourceUsageAggregationDisk do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MigrationCenter.V1.Model.DailyResourceUsageAggregationDisk do
  def decode(value, options) do
    GoogleApi.MigrationCenter.V1.Model.DailyResourceUsageAggregationDisk.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MigrationCenter.V1.Model.DailyResourceUsageAggregationDisk do
