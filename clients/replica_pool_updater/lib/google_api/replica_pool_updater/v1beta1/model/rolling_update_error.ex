...
defmodule GoogleApi.ReplicaPoolUpdater.V1beta1.Model.RollingUpdate_error do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ReplicaPoolUpdater.V1beta1.Model.RollingUpdate_error do
