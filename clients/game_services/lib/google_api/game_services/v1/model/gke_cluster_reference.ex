...
defmodule GoogleApi.GameServices.V1.Model.GkeClusterReference do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1.Model.GkeClusterReference do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.GkeClusterReference.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1.Model.GkeClusterReference do
