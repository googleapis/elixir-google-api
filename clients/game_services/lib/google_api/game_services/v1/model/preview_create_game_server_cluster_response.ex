...
defmodule GoogleApi.GameServices.V1.Model.PreviewCreateGameServerClusterResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.GameServices.V1.Model.PreviewCreateGameServerClusterResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.PreviewCreateGameServerClusterResponse.decode(value, options)
  end
end
