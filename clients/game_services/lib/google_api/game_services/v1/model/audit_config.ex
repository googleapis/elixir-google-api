...
defmodule GoogleApi.GameServices.V1.Model.AuditConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1.Model.AuditConfig do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.AuditConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1.Model.AuditConfig do
