...
defmodule GoogleApi.GameServices.V1.Model.PreviewDeleteGameServerClusterResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.GameServices.V1.Model.PreviewDeleteGameServerClusterResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.PreviewDeleteGameServerClusterResponse.decode(value, options)
  end
end
