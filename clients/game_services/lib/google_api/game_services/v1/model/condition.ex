...
defmodule GoogleApi.GameServices.V1.Model.Condition do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1.Model.Condition do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.Condition.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1.Model.Condition do
