...
defmodule GoogleApi.GameServices.V1.Model.TargetFleetDetails do
  @moduledoc """
  ...
  *   `fleet` (*type:* `GoogleApi.GameServices.V1.Model.TargetFleet.t`, *default:* `nil`) - Reference to target Agones fleet.
  ...
  field(:fleet, as: GoogleApi.GameServices.V1.Model.TargetFleet)
end

defimpl Poison.Decoder, for: GoogleApi.GameServices.V1.Model.TargetFleetDetails do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.TargetFleetDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1.Model.TargetFleetDetails do
