...
defmodule GoogleApi.GameServices.V1.Model.PreviewGameServerDeploymentRolloutResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.GameServices.V1.Model.PreviewGameServerDeploymentRolloutResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.PreviewGameServerDeploymentRolloutResponse.decode(
      value,
      options
    )
  end
