...
defmodule GoogleApi.GameServices.V1.Model.OperationMetadata do
  @moduledoc """
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :operationStatus =>
            %{optional(String.t()) => GoogleApi.GameServices.V1.Model.OperationStatus.t()} | nil,
  ...
  field(:operationStatus, as: GoogleApi.GameServices.V1.Model.OperationStatus, type: :map)
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.GameServices.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1.Model.OperationMetadata do
