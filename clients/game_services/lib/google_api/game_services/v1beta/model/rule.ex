...
defmodule GoogleApi.GameServices.V1beta.Model.Rule do
  ...
  *   `logConfig` (*type:* `list(GoogleApi.GameServices.V1beta.Model.LogConfig.t)`, *default:* `nil`) - The config returned to callers of CheckPolicy for any entries that match the LOG action.
  ...
  *   `permissions` (*type:* `list(String.t)`, *default:* `nil`) - A permission is a string of form '..' (e.g., 'storage.buckets.list'). A value of '*' matches all permissions, and a verb part of '*' (e.g., 'storage.buckets.*') matches all verbs.
  ...
  @type t :: %__MODULE__{
          :action => String.t() | nil,
          :conditions => list(GoogleApi.GameServices.V1beta.Model.Condition.t()) | nil,
          :description => String.t() | nil,
          :in => list(String.t()) | nil,
          :logConfig => list(GoogleApi.GameServices.V1beta.Model.LogConfig.t()) | nil,
