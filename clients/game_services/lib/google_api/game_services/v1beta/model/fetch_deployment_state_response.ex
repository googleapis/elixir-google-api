...
defmodule GoogleApi.GameServices.V1beta.Model.FetchDeploymentStateResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.FetchDeploymentStateResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.FetchDeploymentStateResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.FetchDeploymentStateResponse do
