...
defimpl Poison.Decoder,
  for: GoogleApi.GameServices.V1beta.Model.PreviewDeleteGameServerClusterResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.PreviewDeleteGameServerClusterResponse.decode(
      value,
      options
    )
  end
