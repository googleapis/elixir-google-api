...
defmodule GoogleApi.GameServices.V1beta.Model.GameServerConfigOverride do
  ...
  *   `realmsSelector` (*type:* `GoogleApi.GameServices.V1beta.Model.RealmSelector.t`, *default:* `nil`) - Selector for choosing applicable realms.
  ...
  field(:configVersion)
  field(:realmsSelector, as: GoogleApi.GameServices.V1beta.Model.RealmSelector)
end

defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.GameServerConfigOverride do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.GameServerConfigOverride.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.GameServerConfigOverride do
