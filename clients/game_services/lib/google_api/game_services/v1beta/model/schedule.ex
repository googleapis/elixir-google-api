...
defmodule GoogleApi.GameServices.V1beta.Model.Schedule do
  ...
  *   `cronSpec` (*type:* `String.t`, *default:* `nil`) - The cron definition of the scheduled event. See https://en.wikipedia.org/wiki/Cron. The cron spec specifies the local time as defined by the realm.
