...
defmodule GoogleApi.GameServices.V1beta.Model.DeployedClusterState do
  ...
  *   `fleetDetails` (*type:* `list(GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails.t)`, *default:* `nil`) - The details about the Agones fleets and autoscalers created in the
  ...
  field(:cluster)
  field(:fleetDetails, as: GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.DeployedClusterState do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.DeployedClusterState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.DeployedClusterState do
