...
defmodule GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails do
  @moduledoc """
  ...
  *   `deployedFleet` (*type:* `GoogleApi.GameServices.V1beta.Model.DeployedFleet.t`, *default:* `nil`) - Information about the Agones fleet.
  ...
  field(:deployedFleet, as: GoogleApi.GameServices.V1beta.Model.DeployedFleet)
end

defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleetDetails do
