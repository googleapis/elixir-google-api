...
defmodule GoogleApi.GameServices.V1beta.Model.PreviewUpdateGameServerClusterResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.GameServices.V1beta.Model.PreviewUpdateGameServerClusterResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.PreviewUpdateGameServerClusterResponse.decode(
      value,
      options
    )
  end
