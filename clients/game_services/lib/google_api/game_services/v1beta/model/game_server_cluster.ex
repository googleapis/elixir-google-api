...
defmodule GoogleApi.GameServices.V1beta.Model.GameServerCluster do
  ...
  *   `connectionInfo` (*type:* `GoogleApi.GameServices.V1beta.Model.GameServerClusterConnectionInfo.t`, *default:* `nil`) - Game Server Cluster connection information. This information is used to
