...
defmodule GoogleApi.GameServices.V1beta.Model.DeployedFleet do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.GameServices.V1beta.Model.DeployedFleetStatus.t`, *default:* `nil`) - The current status of the Agones fleet. Includes count of game servers in various states.
  ...
  @type t :: %__MODULE__{
          ...
          :status => GoogleApi.GameServices.V1beta.Model.DeployedFleetStatus.t() | nil
        }

  field(:fleet)
  field(:fleetSpec)
  field(:specSource, as: GoogleApi.GameServices.V1beta.Model.SpecSource)
  field(:status, as: GoogleApi.GameServices.V1beta.Model.DeployedFleetStatus)
end

defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleet do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.DeployedFleet.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleet do
