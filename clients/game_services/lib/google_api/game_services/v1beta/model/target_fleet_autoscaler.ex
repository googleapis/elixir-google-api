...
defmodule GoogleApi.GameServices.V1beta.Model.TargetFleetAutoscaler do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.TargetFleetAutoscaler do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.TargetFleetAutoscaler.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.TargetFleetAutoscaler do
