...
defmodule GoogleApi.GameServices.V1beta.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.AuditLogConfig do
