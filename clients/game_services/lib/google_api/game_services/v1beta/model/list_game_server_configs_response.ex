...
defmodule GoogleApi.GameServices.V1beta.Model.ListGameServerConfigsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.ListGameServerConfigsResponse do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.ListGameServerConfigsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.ListGameServerConfigsResponse do
