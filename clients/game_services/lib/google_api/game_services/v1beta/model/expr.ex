...
defmodule GoogleApi.GameServices.V1beta.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.Expr do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.Expr do
