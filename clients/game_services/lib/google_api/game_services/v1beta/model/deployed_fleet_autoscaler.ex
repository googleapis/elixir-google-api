...
defmodule GoogleApi.GameServices.V1beta.Model.DeployedFleetAutoscaler do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleetAutoscaler do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.DeployedFleetAutoscaler.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.DeployedFleetAutoscaler do
