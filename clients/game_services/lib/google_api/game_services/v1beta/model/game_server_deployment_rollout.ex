...
defmodule GoogleApi.GameServices.V1beta.Model.GameServerDeploymentRollout do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the game server deployment rollout, in the following form: `projects/{project}/locations/{locationId}/gameServerDeployments/{deploymentId}/rollout`. For example, `projects/my-project/locations/global/gameServerDeployments/my-deployment/rollout`.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The last-modified time.
  ...
  @type t :: %__MODULE__{
          ...
          :gameServerConfigOverrides =>
            list(GoogleApi.GameServices.V1beta.Model.GameServerConfigOverride.t()) | nil,
          :name => String.t() | nil,
