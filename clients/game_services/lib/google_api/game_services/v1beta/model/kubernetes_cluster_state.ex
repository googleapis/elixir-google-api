...
defmodule GoogleApi.GameServices.V1beta.Model.KubernetesClusterState do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GameServices.V1beta.Model.KubernetesClusterState do
  def decode(value, options) do
    GoogleApi.GameServices.V1beta.Model.KubernetesClusterState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GameServices.V1beta.Model.KubernetesClusterState do
