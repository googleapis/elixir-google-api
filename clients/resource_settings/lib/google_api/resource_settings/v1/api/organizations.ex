...
defmodule GoogleApi.ResourceSettings.V1.Api.Organizations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec resourcesettings_organizations_settings_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def resourcesettings_organizations_settings_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec resourcesettings_organizations_settings_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def resourcesettings_organizations_settings_list(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec resourcesettings_organizations_settings_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def resourcesettings_organizations_settings_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
