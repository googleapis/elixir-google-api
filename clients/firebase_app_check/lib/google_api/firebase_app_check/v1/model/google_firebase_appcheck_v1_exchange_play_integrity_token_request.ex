...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangePlayIntegrityTokenRequest.decode(
      value,
      options
    )
  end
