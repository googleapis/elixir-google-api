...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1UpdateResourcePolicyRequest do
  @moduledoc """
  ...
  *   `updateMask` (*type:* `String.t`, *default:* `nil`) - Required. A comma-separated list of names of fields in the ResourcePolicy to update. Example: `enforcement_mode`.
  ...
  @type t :: %__MODULE__{
          :resourcePolicy =>
            GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ResourcePolicy.t() | nil,
...
defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1UpdateResourcePolicyRequest do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1UpdateResourcePolicyRequest.decode(
      value,
      options
    )
  end
