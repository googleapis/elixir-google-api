...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DebugToken do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DebugToken do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DebugToken.decode(value, options)
  end
end
