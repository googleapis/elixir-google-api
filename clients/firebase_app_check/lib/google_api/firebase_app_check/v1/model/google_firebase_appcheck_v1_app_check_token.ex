...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1AppCheckToken do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1AppCheckToken do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1AppCheckToken.decode(
      value,
      options
    )
  end
