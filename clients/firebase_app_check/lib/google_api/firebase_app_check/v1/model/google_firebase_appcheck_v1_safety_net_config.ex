...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1SafetyNetConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1SafetyNetConfig do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1SafetyNetConfig.decode(
      value,
      options
    )
  end
