...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DeviceCheckConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DeviceCheckConfig do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1DeviceCheckConfig.decode(
      value,
      options
    )
  end
