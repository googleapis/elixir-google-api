...
defmodule GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest do
  def decode(value, options) do
    GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest.decode(
      value,
      options
    )
  end
