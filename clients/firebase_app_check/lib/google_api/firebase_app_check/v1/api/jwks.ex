...
defmodule GoogleApi.FirebaseAppCheck.V1.Api.Jwks do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec firebaseappcheck_jwks_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1PublicJwkSet.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def firebaseappcheck_jwks_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.FirebaseAppCheck.V1.Model.GoogleFirebaseAppcheckV1PublicJwkSet{}]
    )
  end
end
