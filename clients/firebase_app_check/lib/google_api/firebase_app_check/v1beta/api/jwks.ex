...
defmodule GoogleApi.FirebaseAppCheck.V1beta.Api.Jwks do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.FirebaseAppCheck.V1beta.Model.GoogleFirebaseAppcheckV1betaPublicJwkSet{}}` on success
  *   `{:error, info}` on failure
  """
  @spec firebaseappcheck_jwks_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok,
           GoogleApi.FirebaseAppCheck.V1beta.Model.GoogleFirebaseAppcheckV1betaPublicJwkSet.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def firebaseappcheck_jwks_get(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.FirebaseAppCheck.V1beta.Model.GoogleFirebaseAppcheckV1betaPublicJwkSet{}
        ]
    )
  end
end
