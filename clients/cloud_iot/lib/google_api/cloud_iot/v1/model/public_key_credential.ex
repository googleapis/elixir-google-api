...
defmodule GoogleApi.CloudIot.V1.Model.PublicKeyCredential do
  ...
  - format (String.t): The format of the key. Defaults to: `null`.
    - Enum - one of [UNSPECIFIED_PUBLIC_KEY_FORMAT, RSA_PEM, RSA_X509_PEM, ES256_PEM, ES256_X509_PEM]
  - key (String.t): The key data. Defaults to: `null`.
  """
