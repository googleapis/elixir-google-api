...
defmodule GoogleApi.CloudIot.V1.Model.DeviceCredential do
  ...
  - expirationTime (DateTime.t): [Optional] The time at which this credential becomes invalid. This
  credential will be ignored for new client authentication requests after
  this timestamp; however, it will not be automatically deleted. Defaults to `nil`.
  - publicKey (GoogleApi.CloudIot.V1.Model.PublicKeyCredential.t): A public key used to verify the signature of JSON Web Tokens (JWTs).
  ...
  registry-level certificate. Defaults to `nil`.
  """
