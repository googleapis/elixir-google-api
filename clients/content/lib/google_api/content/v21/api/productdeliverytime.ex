...
defmodule GoogleApi.Content.V21.Api.Productdeliverytime do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec content_productdeliverytime_create(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.ProductDeliveryTime.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_productdeliverytime_create(
        connection,
        merchant_id,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/{merchantId}/productdeliverytime", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.ProductDeliveryTime{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec content_productdeliverytime_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def content_productdeliverytime_delete(
        connection,
        merchant_id,
        product_id,
        optional_params \\ [],
    ...
    request =
      ...
      |> Request.url("/{merchantId}/productdeliverytime/{productId}", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  """
  @spec content_productdeliverytime_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def content_productdeliverytime_get(
        connection,
        merchant_id,
        product_id,
        optional_params \\ [],
