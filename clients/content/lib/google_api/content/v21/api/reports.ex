...
defmodule GoogleApi.Content.V21.Api.Reports do
  @moduledoc """
  ...
  *   `merchant_id` (*type:* `String.t`) - Required. Id of the merchant making the call. Must be a standalone account or an MCA subaccount.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.SearchRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Content.V21.Model.SearchResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def content_reports_search(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.SearchResponse{}])
  end
end
