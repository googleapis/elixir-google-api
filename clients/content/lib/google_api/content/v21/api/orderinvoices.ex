...
defmodule GoogleApi.Content.V21.Api.Orderinvoices do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.OrderinvoicesCreateChargeInvoiceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Content.V21.Model.OrderinvoicesCreateChargeInvoiceResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def content_orderinvoices_createchargeinvoice(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.OrderinvoicesCreateChargeInvoiceResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:quotaUser` (*type:* `String.t`) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
      *   `:userIp` (*type:* `String.t`) - Deprecated. Please use quotaUser instead.
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def content_orderinvoices_createrefundinvoice(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceResponse{}]
    )
  end
end
