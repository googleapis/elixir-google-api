...
defmodule GoogleApi.Content.V21.Api.Orderreports do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def content_orderreports_listdisbursements(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/orderreports/disbursements", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.OrderreportsListDisbursementsResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def content_orderreports_listtransactions(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.OrderreportsListTransactionsResponse{}]
    )
  end
end
