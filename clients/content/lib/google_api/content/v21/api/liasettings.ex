  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_custombatch(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2.1/liasettings/batch", %{})
  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/liasettings/{accountId}", %{
  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_list(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/liasettings", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_listposdataproviders(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/liasettings/posdataproviders", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_requestgmbaccess(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2.1/{merchantId}/liasettings/{accountId}/requestgmbaccess", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
        "accountId" => URI.encode(account_id, &URI.char_unreserved?/1)
      })
  ...
  *   `{:error, info}` on failure
  ...
  def content_liasettings_setposdataprovider(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2.1/{merchantId}/liasettings/{accountId}/setposdataprovider", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
        "accountId" => URI.encode(account_id, &URI.char_unreserved?/1)
      })
      |> Request.add_param(:query, :country, country)
