...
defmodule GoogleApi.Content.V21.Api.Promotions do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec content_promotions_create(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.Promotion.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_promotions_create(connection, merchant_id, optional_params \\ [], opts \\ []) do
  ...
  *   `{:error, info}` on failure
  """
  @spec content_promotions_get(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.Promotion.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_promotions_get(connection, merchant_id, id, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/{merchantId}/promotions/{id}", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
