...
defmodule GoogleApi.Content.V21.Api.Accountstatuses do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.AccountstatusesCustomBatchRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Content.V21.Model.AccountstatusesCustomBatchResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accountstatuses_custombatch(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.AccountstatusesCustomBatchResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accountstatuses_custombatch(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2.1/accountstatuses/batch", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.AccountstatusesCustomBatchResponse{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.AccountStatus{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accountstatuses_get(
          ...
          {:ok, GoogleApi.Content.V21.Model.AccountStatus.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accountstatuses_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/accountstatuses/{accountId}", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.AccountStatus{}])
  end
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.AccountstatusesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accountstatuses_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.AccountstatusesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accountstatuses_list(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/accountstatuses", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.AccountstatusesListResponse{}]
    )
  end
end
