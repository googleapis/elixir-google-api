...
defmodule GoogleApi.Content.V21.Api.Collectionstatuses do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.CollectionStatus{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_collectionstatuses_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  def content_collectionstatuses_get(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.CollectionStatus{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:pageSize` (*type:* `integer()`) - The maximum number of collection statuses to return in the response, used for paging. Defaults to 50; values above 1000 will be coerced to 1000.
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.ListCollectionStatusesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def content_collectionstatuses_list(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.ListCollectionStatusesResponse{}]
    )
  end
end
