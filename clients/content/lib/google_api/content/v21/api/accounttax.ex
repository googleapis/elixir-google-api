...
defmodule GoogleApi.Content.V21.Api.Accounttax do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.AccounttaxCustomBatchRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Content.V21.Model.AccounttaxCustomBatchResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accounttax_custombatch(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.AccounttaxCustomBatchResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accounttax_custombatch(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2.1/accounttax/batch", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Content.V21.Model.AccounttaxCustomBatchResponse{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.AccountTax{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accounttax_get(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.AccountTax.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accounttax_get(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/accounttax/{accountId}", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.AccountTax{}])
  end
  ...
  *   `{:ok, %GoogleApi.Content.V21.Model.AccounttaxListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec content_accounttax_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Content.V21.Model.AccounttaxListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def content_accounttax_list(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2.1/{merchantId}/accounttax", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Content.V21.Model.AccounttaxListResponse{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Content.V21.Model.AccountTax.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
