...
defmodule GoogleApi.Content.V21.Model.OrderReportDisbursement do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderReportDisbursement do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderReportDisbursement.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderReportDisbursement do
