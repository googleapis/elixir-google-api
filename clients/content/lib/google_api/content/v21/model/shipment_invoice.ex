...
defmodule GoogleApi.Content.V21.Model.ShipmentInvoice do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ShipmentInvoice do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ShipmentInvoice.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ShipmentInvoice do
