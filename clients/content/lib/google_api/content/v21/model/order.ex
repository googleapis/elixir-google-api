...
defmodule GoogleApi.Content.V21.Model.Order do
  ...
  *   `taxCollector` (*type:* `String.t`, *default:* `nil`) - The party responsible for collecting and remitting taxes.
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t(),
          :kind => String.t(),
          :lineItems => list(GoogleApi.Content.V21.Model.OrderLineItem.t()),
          :merchantId => String.t(),
          ...
          :refunds => list(GoogleApi.Content.V21.Model.OrderRefund.t()),
          :shipments => list(GoogleApi.Content.V21.Model.OrderShipment.t()),
