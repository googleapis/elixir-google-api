...
defmodule GoogleApi.Content.V21.Model.Table do
  @moduledoc """
  ...
  *   `rows` (*type:* `list(GoogleApi.Content.V21.Model.Row.t)`, *default:* `nil`) - The list of rows that constitute the table. Must have the same length as `rowHeaders`. Required.
  ...
  field(:name)
  field(:rowHeaders, as: GoogleApi.Content.V21.Model.Headers)
  field(:rows, as: GoogleApi.Content.V21.Model.Row, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.Table do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.Table.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.Table do
