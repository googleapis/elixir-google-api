...
defmodule GoogleApi.Content.V21.Model.OrderDeliveryDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderDeliveryDetails do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderDeliveryDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderDeliveryDetails do
