...
defmodule GoogleApi.Content.V21.Model.PosInventory do
  @moduledoc """
  ...
  *   `kind` (*type:* `String.t`, *default:* `content#posInventory`) - Identifies what kind of resource this is. Value: the fixed string "content#posInventory".
  *   `price` (*type:* `GoogleApi.Content.V21.Model.Price.t`, *default:* `nil`) - The current price of the item.
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.PosInventory do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.PosInventory.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.PosInventory do
