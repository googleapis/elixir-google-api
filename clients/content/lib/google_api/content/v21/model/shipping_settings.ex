...
defmodule GoogleApi.Content.V21.Model.ShippingSettings do
  @moduledoc """
  ...
  *   `services` (*type:* `list(GoogleApi.Content.V21.Model.Service.t)`, *default:* `nil`) - The target account's list of services. Optional.
  ...
  @type t :: %__MODULE__{
          :accountId => String.t(),
          :postalCodeGroups => list(GoogleApi.Content.V21.Model.PostalCodeGroup.t()),
          :services => list(GoogleApi.Content.V21.Model.Service.t())
        }
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ShippingSettings do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ShippingSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ShippingSettings do
