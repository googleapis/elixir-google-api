...
defmodule GoogleApi.Content.V21.Model.OrderReportTransaction do
  @moduledoc """
  ...
  *   `transactionDate` (*type:* `String.t`, *default:* `nil`) - The date of the transaction, in ISO 8601 format.
  ...
  field(:orderId)
  field(:productAmount, as: GoogleApi.Content.V21.Model.ProductAmount)
  field(:transactionDate)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderReportTransaction do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderReportTransaction.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderReportTransaction do
