...
defmodule GoogleApi.Content.V21.Model.LoyaltyPoints do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.LoyaltyPoints do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.LoyaltyPoints.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.LoyaltyPoints do
