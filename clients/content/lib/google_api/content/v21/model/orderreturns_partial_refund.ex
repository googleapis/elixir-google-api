...
defmodule GoogleApi.Content.V21.Model.OrderreturnsPartialRefund do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderreturnsPartialRefund do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderreturnsPartialRefund.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderreturnsPartialRefund do
