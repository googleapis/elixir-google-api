...
defmodule GoogleApi.Content.V21.Model.ProductStatusDestinationStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ProductStatusDestinationStatus do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ProductStatusDestinationStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ProductStatusDestinationStatus do
