...
defmodule GoogleApi.Content.V21.Model.ProductAmount do
  @moduledoc """
  ...
  *   `taxAmount` (*type:* `GoogleApi.Content.V21.Model.Price.t`, *default:* `nil`) - Tax value.
  ...
  @type t :: %__MODULE__{
          ...
          :remittedTaxAmount => GoogleApi.Content.V21.Model.Price.t() | nil,
          :taxAmount => GoogleApi.Content.V21.Model.Price.t() | nil
        }

  field(:priceAmount, as: GoogleApi.Content.V21.Model.Price)
  field(:remittedTaxAmount, as: GoogleApi.Content.V21.Model.Price)
  field(:taxAmount, as: GoogleApi.Content.V21.Model.Price)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ProductAmount do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ProductAmount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ProductAmount do
