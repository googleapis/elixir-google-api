...
defmodule GoogleApi.Content.V21.Model.OrdersUpdateLineItemShippingDetailsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Content.V21.Model.OrdersUpdateLineItemShippingDetailsRequest do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrdersUpdateLineItemShippingDetailsRequest.decode(value, options)
  end
end
