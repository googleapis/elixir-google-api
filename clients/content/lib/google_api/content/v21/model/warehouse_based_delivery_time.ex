...
defmodule GoogleApi.Content.V21.Model.WarehouseBasedDeliveryTime do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.WarehouseBasedDeliveryTime do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.WarehouseBasedDeliveryTime.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.WarehouseBasedDeliveryTime do
