...
defmodule GoogleApi.Content.V21.Model.PosSale do
  @moduledoc """
  ...
  *   `kind` (*type:* `String.t`, *default:* `nil`) - Identifies what kind of resource this is. Value: the fixed string "`content#posSale`"
  ...
  *   `storeCode` (*type:* `String.t`, *default:* `nil`) - Required. The identifier of the merchant's store. Either a `storeCode` inserted via the API or the code of the store in a Business Profile.
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.PosSale do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.PosSale.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.PosSale do
