...
defmodule GoogleApi.Content.V21.Model.VerifyPhoneNumberRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.VerifyPhoneNumberRequest do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.VerifyPhoneNumberRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.VerifyPhoneNumberRequest do
