...
defmodule GoogleApi.Content.V21.Model.MerchantOrderReturn do
  ...
  *   `returnPricingInfo` (*type:* `GoogleApi.Content.V21.Model.ReturnPricingInfo.t`, *default:* `nil`) - Information about shipping costs.
  *   `returnShipments` (*type:* `list(GoogleApi.Content.V21.Model.ReturnShipment.t)`, *default:* `nil`) - Shipments of the return.
  ...
  field(:returnPricingInfo, as: GoogleApi.Content.V21.Model.ReturnPricingInfo)
