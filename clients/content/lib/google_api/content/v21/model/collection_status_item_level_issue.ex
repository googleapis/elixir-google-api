...
defmodule GoogleApi.Content.V21.Model.CollectionStatusItemLevelIssue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.CollectionStatusItemLevelIssue do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.CollectionStatusItemLevelIssue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.CollectionStatusItemLevelIssue do
