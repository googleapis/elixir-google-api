...
defmodule GoogleApi.Content.V21.Model.OrdersCancelLineItemRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrdersCancelLineItemRequest do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrdersCancelLineItemRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrdersCancelLineItemRequest do
