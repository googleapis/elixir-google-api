...
defmodule GoogleApi.Content.V21.Model.TransitTable do
  @moduledoc """
  ...
  *   `transitTimeLabels` (*type:* `list(String.t)`, *default:* `nil`) - A list of transit time labels. The last value can be `"all other labels"`. Example: `["food", "electronics", "all other labels"]`.
  ...
  @type t :: %__MODULE__{
          ...
          :rows => list(GoogleApi.Content.V21.Model.TransitTableTransitTimeRow.t()) | nil,
          :transitTimeLabels => list(String.t()) | nil
        }

  field(:postalCodeGroupNames, type: :list)
  field(:rows, as: GoogleApi.Content.V21.Model.TransitTableTransitTimeRow, type: :list)
  field(:transitTimeLabels, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.TransitTable do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.TransitTable.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.TransitTable do
