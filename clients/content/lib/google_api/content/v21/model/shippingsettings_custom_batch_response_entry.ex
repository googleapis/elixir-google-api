...
defmodule GoogleApi.Content.V21.Model.ShippingsettingsCustomBatchResponseEntry do
  @moduledoc """
  ...
  *   `shippingSettings` (*type:* `GoogleApi.Content.V21.Model.ShippingSettings.t`, *default:* `nil`) - The retrieved or updated account shipping settings.
  ...
  @type t :: %__MODULE__{
          ...
          :kind => String.t(),
          :shippingSettings => GoogleApi.Content.V21.Model.ShippingSettings.t()
        }

  field(:batchId)
  field(:errors, as: GoogleApi.Content.V21.Model.Errors)
  field(:kind)
  field(:shippingSettings, as: GoogleApi.Content.V21.Model.ShippingSettings)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ShippingsettingsCustomBatchResponseEntry do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ShippingsettingsCustomBatchResponseEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ShippingsettingsCustomBatchResponseEntry do
