...
defmodule GoogleApi.Content.V21.Model.ShippingsettingsGetSupportedCarriersResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Content.V21.Model.ShippingsettingsGetSupportedCarriersResponse do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ShippingsettingsGetSupportedCarriersResponse.decode(
      value,
      options
    )
  end
