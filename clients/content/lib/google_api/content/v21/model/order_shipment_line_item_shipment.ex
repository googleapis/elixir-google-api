...
defmodule GoogleApi.Content.V21.Model.OrderShipmentLineItemShipment do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderShipmentLineItemShipment do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderShipmentLineItemShipment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderShipmentLineItemShipment do
