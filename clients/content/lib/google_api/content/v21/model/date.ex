...
defmodule GoogleApi.Content.V21.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.Date do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.Date do
