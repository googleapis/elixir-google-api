...
defmodule GoogleApi.Content.V21.Model.SettlementTransactionAmountCommission do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.SettlementTransactionAmountCommission do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.SettlementTransactionAmountCommission.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.SettlementTransactionAmountCommission do
