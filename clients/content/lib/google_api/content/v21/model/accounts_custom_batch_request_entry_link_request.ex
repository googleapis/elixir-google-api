...
defmodule GoogleApi.Content.V21.Model.AccountsCustomBatchRequestEntryLinkRequest do
  ...
  *   `services` (*type:* `list(String.t)`, *default:* `nil`) - Provided services. Acceptable values are: - "`shoppingAdsProductManagement`" - "`shoppingActionsProductManagement`" - "`shoppingActionsOrderManagement`" 
  """
