...
defmodule GoogleApi.Content.V21.Model.AccountStatusProducts do
  @moduledoc """
  ...
  *   `statistics` (*type:* `GoogleApi.Content.V21.Model.AccountStatusStatistics.t`, *default:* `nil`) - Aggregated product statistics.
  ...
  field(:itemLevelIssues, as: GoogleApi.Content.V21.Model.AccountStatusItemLevelIssue, type: :list)

  field(:statistics, as: GoogleApi.Content.V21.Model.AccountStatusStatistics)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.AccountStatusProducts do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.AccountStatusProducts.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.AccountStatusProducts do
