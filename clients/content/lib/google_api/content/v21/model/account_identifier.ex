...
defmodule GoogleApi.Content.V21.Model.AccountIdentifier do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.AccountIdentifier do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.AccountIdentifier.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.AccountIdentifier do
