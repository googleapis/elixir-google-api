...
defmodule GoogleApi.Content.V21.Model.RefundReason do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.RefundReason do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.RefundReason.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.RefundReason do
