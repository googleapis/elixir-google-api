...
defmodule GoogleApi.Content.V21.Model.ReturnPolicy do
  ...
  *   `country` (*type:* `String.t`, *default:* `nil`) - The country of sale where the return policy is applicable.
  ...
  *   `label` (*type:* `String.t`, *default:* `nil`) - The user-defined label of the return policy. For the default policy, use the label "default".
  ...
  *   `policy` (*type:* `GoogleApi.Content.V21.Model.ReturnPolicyPolicy.t`, *default:* `nil`) - The policy.
