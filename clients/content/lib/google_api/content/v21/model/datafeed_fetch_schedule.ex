...
defmodule GoogleApi.Content.V21.Model.DatafeedFetchSchedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.DatafeedFetchSchedule do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.DatafeedFetchSchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.DatafeedFetchSchedule do
