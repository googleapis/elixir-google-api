...
defmodule GoogleApi.Content.V21.Model.TestOrderAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.TestOrderAddress do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.TestOrderAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.TestOrderAddress do
