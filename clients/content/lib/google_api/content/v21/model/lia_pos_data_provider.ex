...
defmodule GoogleApi.Content.V21.Model.LiaPosDataProvider do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.LiaPosDataProvider do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.LiaPosDataProvider.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.LiaPosDataProvider do
