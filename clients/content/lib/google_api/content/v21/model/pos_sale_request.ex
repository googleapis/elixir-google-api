...
defmodule GoogleApi.Content.V21.Model.PosSaleRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.PosSaleRequest do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.PosSaleRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.PosSaleRequest do
