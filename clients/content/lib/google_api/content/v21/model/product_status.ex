...
defmodule GoogleApi.Content.V21.Model.ProductStatus do
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - The title of the product.
  ...
  field(:destinationStatuses,
    as: GoogleApi.Content.V21.Model.ProductStatusDestinationStatus,
    type: :list
  )

  field(:googleExpirationDate)

  field(:itemLevelIssues, as: GoogleApi.Content.V21.Model.ProductStatusItemLevelIssue, type: :list)
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ProductStatus do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ProductStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ProductStatus do
