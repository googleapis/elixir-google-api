...
defmodule GoogleApi.Content.V21.Model.RecommendationCreative do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.RecommendationCreative do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.RecommendationCreative.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.RecommendationCreative do
