...
defmodule GoogleApi.Content.V21.Model.Warehouse do
  @moduledoc """
  ...
  *   `shippingAddress` (*type:* `GoogleApi.Content.V21.Model.Address.t`, *default:* `nil`) - Required. Shipping address of the warehouse.
  ...
  field(:businessDayConfig, as: GoogleApi.Content.V21.Model.BusinessDayConfig)
  field(:cutoffTime, as: GoogleApi.Content.V21.Model.WarehouseCutoffTime)
  field(:handlingDays)
  field(:name)
  field(:shippingAddress, as: GoogleApi.Content.V21.Model.Address)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.Warehouse do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.Warehouse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.Warehouse do
