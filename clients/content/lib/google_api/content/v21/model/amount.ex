...
defmodule GoogleApi.Content.V21.Model.Amount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.Amount do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.Amount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.Amount do
