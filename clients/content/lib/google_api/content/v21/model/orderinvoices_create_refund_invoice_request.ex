...
defmodule GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceRequest do
  @moduledoc """
  ...
  *   `shipmentInvoices` (*type:* `list(GoogleApi.Content.V21.Model.ShipmentInvoice.t)`, *default:* `nil`) - Invoice details for different shipment groups.
  ...
  field(:returnOption,
    as:
      GoogleApi.Content.V21.Model.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceReturnOption
  )

  field(:shipmentInvoices, as: GoogleApi.Content.V21.Model.ShipmentInvoice, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceRequest do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderinvoicesCreateRefundInvoiceRequest do
