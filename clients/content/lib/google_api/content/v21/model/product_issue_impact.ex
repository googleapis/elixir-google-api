...
defmodule GoogleApi.Content.V21.Model.ProductIssueImpact do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ProductIssueImpact do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ProductIssueImpact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ProductIssueImpact do
