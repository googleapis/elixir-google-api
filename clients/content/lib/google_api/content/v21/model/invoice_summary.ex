...
defmodule GoogleApi.Content.V21.Model.InvoiceSummary do
  @moduledoc """
  ...
  *   `productTotal` (*type:* `GoogleApi.Content.V21.Model.Amount.t`, *default:* `nil`) - [required] Total price for the product.
  ...
  field(:additionalChargeSummaries,
    as: GoogleApi.Content.V21.Model.InvoiceSummaryAdditionalChargeSummary,
    type: :list
  )

  field(:productTotal, as: GoogleApi.Content.V21.Model.Amount)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.InvoiceSummary do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.InvoiceSummary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.InvoiceSummary do
