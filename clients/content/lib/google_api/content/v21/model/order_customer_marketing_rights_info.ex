...
defmodule GoogleApi.Content.V21.Model.OrderCustomerMarketingRightsInfo do
  @moduledoc """
  ...
  *   `marketingEmailAddress` (*type:* `String.t`, *default:* `nil`) - Email address that can be used for marketing purposes. The field may be empty even if `explicitMarketingPreference` is 'granted'. This happens when retrieving an old order from the customer who deleted their account.
  ...
  @type t :: %__MODULE__{
          ...
          :marketingEmailAddress => String.t() | nil
        }
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderCustomerMarketingRightsInfo do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderCustomerMarketingRightsInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderCustomerMarketingRightsInfo do
