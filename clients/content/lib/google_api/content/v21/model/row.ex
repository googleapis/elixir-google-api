...
defmodule GoogleApi.Content.V21.Model.Row do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.Row do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.Row.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.Row do
