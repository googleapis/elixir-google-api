...
defmodule GoogleApi.Content.V21.Model.HolidayCutoff do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.HolidayCutoff do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.HolidayCutoff.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.HolidayCutoff do
