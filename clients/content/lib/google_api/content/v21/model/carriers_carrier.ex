...
defmodule GoogleApi.Content.V21.Model.CarriersCarrier do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.CarriersCarrier do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.CarriersCarrier.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.CarriersCarrier do
