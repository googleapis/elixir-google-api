...
defmodule GoogleApi.Content.V21.Model.ReturnaddressCustomBatchResponseEntry do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ReturnaddressCustomBatchResponseEntry do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ReturnaddressCustomBatchResponseEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ReturnaddressCustomBatchResponseEntry do
