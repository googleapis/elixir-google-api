...
defmodule GoogleApi.Content.V21.Model.OrderLineItemShippingDetailsMethod do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.OrderLineItemShippingDetailsMethod do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.OrderLineItemShippingDetailsMethod.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.OrderLineItemShippingDetailsMethod do
