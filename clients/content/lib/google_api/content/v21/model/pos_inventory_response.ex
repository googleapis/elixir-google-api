...
defmodule GoogleApi.Content.V21.Model.PosInventoryResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.PosInventoryResponse do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.PosInventoryResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.PosInventoryResponse do
