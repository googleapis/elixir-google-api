...
defmodule GoogleApi.Content.V21.Model.ListAccountReturnCarrierResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ListAccountReturnCarrierResponse do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ListAccountReturnCarrierResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ListAccountReturnCarrierResponse do
