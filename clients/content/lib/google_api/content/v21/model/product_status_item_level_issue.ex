...
defmodule GoogleApi.Content.V21.Model.ProductStatusItemLevelIssue do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.ProductStatusItemLevelIssue do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.ProductStatusItemLevelIssue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.ProductStatusItemLevelIssue do
