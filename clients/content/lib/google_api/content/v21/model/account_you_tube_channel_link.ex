...
defmodule GoogleApi.Content.V21.Model.AccountYouTubeChannelLink do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V21.Model.AccountYouTubeChannelLink do
  def decode(value, options) do
    GoogleApi.Content.V21.Model.AccountYouTubeChannelLink.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V21.Model.AccountYouTubeChannelLink do
