...
defmodule GoogleApi.Content.V2.Model.DatafeedsCustomBatchResponse do
  ...
  @type t :: %__MODULE__{
          :entries => list(GoogleApi.Content.V2.Model.DatafeedsCustomBatchResponseEntry.t()),
          :kind => any()
        }

  field(:entries, as: GoogleApi.Content.V2.Model.DatafeedsCustomBatchResponseEntry, type: :list)
  field(:kind)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.DatafeedsCustomBatchResponse do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.DatafeedsCustomBatchResponse.decode(value, options)
  end
end
