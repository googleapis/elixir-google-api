...
defmodule GoogleApi.Content.V2.Model.OrdersAcknowledgeResponse do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "content#ordersAcknowledgeResponse". Defaults to `content#ordersAcknowledgeResponse`.
  """
