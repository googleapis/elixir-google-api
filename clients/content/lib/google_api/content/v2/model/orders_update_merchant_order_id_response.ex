...
defmodule GoogleApi.Content.V2.Model.OrdersUpdateMerchantOrderIdResponse do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "content#ordersUpdateMerchantOrderIdResponse". Defaults to `content#ordersUpdateMerchantOrderIdResponse`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.OrdersUpdateMerchantOrderIdResponse do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.OrdersUpdateMerchantOrderIdResponse.decode(value, options)
  end
end
