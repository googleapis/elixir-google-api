...
defmodule GoogleApi.Content.V2.Model.OrderPromotion do
  ...
  @type t :: %__MODULE__{
          :benefits => list(GoogleApi.Content.V2.Model.OrderPromotionBenefit.t()),
          :effectiveDates => any(),
          :genericRedemptionCode => any(),
          :id => any(),
          :longTitle => any(),
          :productApplicability => any(),
          :redemptionChannel => any()
        }

  field(:benefits, as: GoogleApi.Content.V2.Model.OrderPromotionBenefit, type: :list)
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.OrderPromotion do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.OrderPromotion.decode(value, options)
  end
end
