...
defmodule GoogleApi.Content.V2.Model.PosInventory do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.PosInventory do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.PosInventory.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V2.Model.PosInventory do
