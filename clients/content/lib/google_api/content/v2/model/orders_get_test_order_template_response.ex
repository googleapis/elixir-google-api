...
defmodule GoogleApi.Content.V2.Model.OrdersGetTestOrderTemplateResponse do
  ...
  *   `template` (*type:* `GoogleApi.Content.V2.Model.TestOrder.t`, *default:* `nil`) - The requested test order template.
  ...
  @type t :: %__MODULE__{
          :kind => String.t() | nil,
          :template => GoogleApi.Content.V2.Model.TestOrder.t() | nil
        }

  field(:kind)
  field(:template, as: GoogleApi.Content.V2.Model.TestOrder)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.OrdersGetTestOrderTemplateResponse do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.OrdersGetTestOrderTemplateResponse.decode(value, options)
  end
end
