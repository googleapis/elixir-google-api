...
defmodule GoogleApi.Content.V2.Model.WarehouseCutoffTime do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.WarehouseCutoffTime do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.WarehouseCutoffTime.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V2.Model.WarehouseCutoffTime do
