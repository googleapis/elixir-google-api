...
defmodule GoogleApi.Content.V2.Model.ShippingsettingsCustomBatchRequest do
  ...
  - entries (list(GoogleApi.Content.V2.Model.ShippingsettingsCustomBatchRequestEntry.t)): The request entries to be processed in the batch. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.ShippingsettingsCustomBatchRequest do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.ShippingsettingsCustomBatchRequest.decode(value, options)
  end
end
