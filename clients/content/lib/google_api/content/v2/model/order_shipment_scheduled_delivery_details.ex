...
defmodule GoogleApi.Content.V2.Model.OrderShipmentScheduledDeliveryDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.OrderShipmentScheduledDeliveryDetails do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.OrderShipmentScheduledDeliveryDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V2.Model.OrderShipmentScheduledDeliveryDetails do
