...
defmodule GoogleApi.Content.V2.Model.AccountsLinkResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.AccountsLinkResponse do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.AccountsLinkResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V2.Model.AccountsLinkResponse do
