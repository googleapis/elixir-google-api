...
defmodule GoogleApi.Content.V2.Model.PosInventoryRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.PosInventoryRequest do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.PosInventoryRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Content.V2.Model.PosInventoryRequest do
