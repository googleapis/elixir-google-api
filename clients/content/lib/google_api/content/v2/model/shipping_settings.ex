...
defmodule GoogleApi.Content.V2.Model.ShippingSettings do
  ...
  *   `warehouses` (*type:* `list(GoogleApi.Content.V2.Model.Warehouse.t)`, *default:* `nil`) - Optional. A list of warehouses which can be referred to in `services`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :warehouses => list(GoogleApi.Content.V2.Model.Warehouse.t()) | nil
        }
  ...
  field(:warehouses, as: GoogleApi.Content.V2.Model.Warehouse, type: :list)
end
