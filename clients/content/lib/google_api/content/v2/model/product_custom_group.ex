...
defmodule GoogleApi.Content.V2.Model.ProductCustomGroup do
  ...
  @type t :: %__MODULE__{
          :attributes => list(GoogleApi.Content.V2.Model.ProductCustomAttribute.t()),
          :name => any()
        }

  field(:attributes, as: GoogleApi.Content.V2.Model.ProductCustomAttribute, type: :list)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.ProductCustomGroup do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.ProductCustomGroup.decode(value, options)
  end
end
