...
defmodule GoogleApi.Content.V2.Model.LiasettingsListResponse do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "content#liasettingsListResponse". Defaults to `content#liasettingsListResponse`.
  - nextPageToken (String.t): The token for the retrieval of the next page of LIA settings. Defaults to `nil`.
  - resources (list(GoogleApi.Content.V2.Model.LiaSettings.t)):  Defaults to `nil`.
  """
