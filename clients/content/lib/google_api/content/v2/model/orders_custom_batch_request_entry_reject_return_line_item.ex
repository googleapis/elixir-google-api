...
defmodule GoogleApi.Content.V2.Model.OrdersCustomBatchRequestEntryRejectReturnLineItem do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Content.V2.Model.OrdersCustomBatchRequestEntryRejectReturnLineItem do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.OrdersCustomBatchRequestEntryRejectReturnLineItem.decode(
      value,
      options
    )
  end
