...
defmodule GoogleApi.Content.V2.Model.ShippingsettingsGetSupportedHolidaysResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Content.V2.Model.ShippingsettingsGetSupportedHolidaysResponse do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.ShippingsettingsGetSupportedHolidaysResponse.decode(value, options)
  end
end
