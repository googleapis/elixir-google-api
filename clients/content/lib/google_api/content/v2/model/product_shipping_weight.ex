...
defmodule GoogleApi.Content.V2.Model.ProductShippingWeight do
  ...
  - value (float()): The weight of the product used to calculate the shipping cost of the item. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.ProductShippingWeight do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.ProductShippingWeight.decode(value, options)
  end
end
