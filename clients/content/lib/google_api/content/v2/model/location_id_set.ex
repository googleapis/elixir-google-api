...
defmodule GoogleApi.Content.V2.Model.LocationIdSet do
  ...
  - locationIds (list(String.t)): A non-empty list of location IDs. They must all be of the same location type (e.g., state). Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Content.V2.Model.LocationIdSet do
  def decode(value, options) do
    GoogleApi.Content.V2.Model.LocationIdSet.decode(value, options)
  end
end
