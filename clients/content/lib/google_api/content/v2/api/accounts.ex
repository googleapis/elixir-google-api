  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_authinfo(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/content/v2/accounts/authinfo", %{})
  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_claimwebsite(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2/{merchantId}/accounts/{accountId}/claimwebsite", %{
  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_custombatch(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2/accounts/batch", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_delete(
    ...
    request =
      ...
      |> Request.url("/content/v2/{merchantId}/accounts/{accountId}", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_insert(connection, merchant_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2/{merchantId}/accounts", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def content_accounts_link(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/content/v2/{merchantId}/accounts/{accountId}/link", %{
        "merchantId" => URI.encode(merchant_id, &URI.char_unreserved?/1),
        "accountId" => URI.encode(account_id, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
