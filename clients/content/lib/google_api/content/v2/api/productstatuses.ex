...
defmodule GoogleApi.Content.V2.Api.Productstatuses do
  ...
  def content_productstatuses_custombatch(connection, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.ProductstatusesCustomBatchResponse{})
  end
  ...
  def content_productstatuses_get(connection, merchant_id, product_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.ProductStatus{})
  end
  ...
  def content_productstatuses_list(connection, merchant_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.ProductstatusesListResponse{})
  end
end
