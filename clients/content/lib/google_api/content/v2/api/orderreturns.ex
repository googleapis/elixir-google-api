...
defmodule GoogleApi.Content.V2.Api.Orderreturns do
  ...
  - return_id (String.t): Merchant order return ID generated by Google.
  ...
  """
  @spec content_orderreturns_get(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  - optional_params (KeywordList): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :createdEndDate (String.t): Obtains order returns created before this date (inclusively), in ISO 8601 format.
    - :createdStartDate (String.t): Obtains order returns created after this date (inclusively), in ISO 8601 format.
    ...
    - :orderBy (String.t): Return the results in the specified order.
  ...
  {:error, info} on failure
  """
  @spec content_orderreturns_list(Tesla.Env.client(), String.t(), keyword()) ::
