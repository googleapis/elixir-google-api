...
defmodule GoogleApi.Content.V2.Api.Products do
  ...
  def content_products_custombatch(connection, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.ProductsCustomBatchResponse{})
  end
  ...
  def content_products_get(connection, merchant_id, product_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.Product{})
  end
  ...
  def content_products_list(connection, merchant_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.ProductsListResponse{})
  end
end
