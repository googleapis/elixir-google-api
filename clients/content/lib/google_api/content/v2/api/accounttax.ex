...
defmodule GoogleApi.Content.V2.Api.Accounttax do
  ...
  def content_accounttax_custombatch(connection, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.AccounttaxCustomBatchResponse{})
  end
  ...
  def content_accounttax_get(connection, merchant_id, account_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.AccountTax{})
  end
  ...
  def content_accounttax_list(connection, merchant_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Content.V2.Model.AccounttaxListResponse{})
  end
