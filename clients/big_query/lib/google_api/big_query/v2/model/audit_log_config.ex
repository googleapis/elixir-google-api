...
defmodule GoogleApi.BigQuery.V2.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.AuditLogConfig do
