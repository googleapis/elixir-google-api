...
defmodule GoogleApi.BigQuery.V2.Model.RemoteFunctionOptions do
  ...
  *   `connection` (*type:* `String.t`, *default:* `nil`) - Fully qualified name of the user-provided connection object which holds the authentication information to send requests to the remote service. projects/{project_id}/locations/{location_id}/connections/{connection_id}
  *   `endpoint` (*type:* `String.t`, *default:* `nil`) - Endpoint of the user-provided remote service (e.g. a function url in Google Cloud Functions).
  *   `maxBatchingRows` (*type:* `String.t`, *default:* `nil`) - Max number of rows in each batch sent to the remote service. If absent or if 0, it means no limit.
