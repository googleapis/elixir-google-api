...
defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.DataSplitResult do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.DataSplitResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.DataSplitResult do
