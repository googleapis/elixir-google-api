...
defmodule GoogleApi.BigQuery.V2.Model.GoogleSheetsOptions do
  ...
  - range (String.t): [Beta] [Optional] Range of a sheet to query from. Only used when non-empty. Typical format: sheet_name!top_left_cell_id:bottom_right_cell_id For example: sheet1!A1:B20 Defaults to: `null`.
