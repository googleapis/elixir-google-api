...
defmodule GoogleApi.BigQuery.V2.Model.VectorSearchStatistics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.VectorSearchStatistics do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.VectorSearchStatistics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.VectorSearchStatistics do
