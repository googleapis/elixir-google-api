...
defmodule GoogleApi.BigQuery.V2.Model.JobConfigurationLoad do
  ...
  - schemaUpdateOptions ([String.t]): [Experimental] Allows the schema of the desitination table to be updated as a side effect of the load job if a schema is autodetected or supplied in the job configuration. Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND; when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table, specified by partition decorators. For normal tables, WRITE_TRUNCATE will always overwrite the schema. One or more of the following values are specified: ALLOW_FIELD_ADDITION: allow adding a nullable field to the schema. ALLOW_FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable. Defaults to: `null`.
  ...
  - sourceFormat (String.t): [Optional] The format of the data files. For CSV files, specify \&quot;CSV\&quot;. For datastore backups, specify \&quot;DATASTORE_BACKUP\&quot;. For newline-delimited JSON, specify \&quot;NEWLINE_DELIMITED_JSON\&quot;. For Avro, specify \&quot;AVRO\&quot;. The default value is CSV. Defaults to: `null`.
