...
defmodule GoogleApi.BigQuery.V2.Model.RangePartitioningRange do
  ...
  - end (String.t): [Experimental] [Required] The end of range partitioning, exclusive. Defaults to: `null`.
  - interval (String.t): [Experimental] [Required] The width of each interval. Defaults to: `null`.
  - start (String.t): [Experimental] [Required] The start of range partitioning, inclusive. Defaults to: `null`.
  """
