...
defmodule GoogleApi.BigQuery.V2.Model.DmlStatistics do
  ...
  *   `updatedRowCount` (*type:* `String.t`, *default:* `nil`) - Output only. Number of updated Rows. Populated by DML UPDATE and MERGE statements.
  ...
  field(:deletedRowCount)
  field(:insertedRowCount)
  field(:updatedRowCount)
end

defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.DmlStatistics do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.DmlStatistics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.DmlStatistics do
