...
defmodule GoogleApi.BigQuery.V2.Model.ExternalDataConfiguration do
  ...
  - autodetect (boolean()): Try to detect schema and format options automatically. Any option specified explicitly will be honored. Defaults to `nil`.
  - bigtableOptions (GoogleApi.BigQuery.V2.Model.BigtableOptions.t): [Optional] Additional options if sourceFormat is set to BIGTABLE. Defaults to `nil`.
  ...
  - sourceFormat (String.t): [Required] The data format. For CSV files, specify "CSV". For Google sheets, specify "GOOGLE_SHEETS". For newline-delimited JSON, specify "NEWLINE_DELIMITED_JSON". For Avro files, specify "AVRO". For Google Cloud Datastore backups, specify "DATASTORE_BACKUP". [Beta] For Google Cloud Bigtable, specify "BIGTABLE". Defaults to `nil`.
