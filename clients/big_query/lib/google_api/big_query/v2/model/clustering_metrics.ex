...
defmodule GoogleApi.BigQuery.V2.Model.ClusteringMetrics do
  ...
  - daviesBouldinIndex (float()): Davies-Bouldin index. Defaults to: `null`.
  - meanSquaredDistance (float()): Mean of squared distances between each sample to its cluster centroid. Defaults to: `null`.
  """
