...
defmodule GoogleApi.BigQuery.V2.Model.CloneDefinition do
  ...
  *   `cloneTime` (*type:* `DateTime.t`, *default:* `nil`) - Required. The time at which the base table was cloned. This value is reported in the JSON response using RFC3339 format.
  ...
  @type t :: %__MODULE__{
          ...
          :cloneTime => DateTime.t() | nil
        }

  field(:baseTableReference, as: GoogleApi.BigQuery.V2.Model.TableReference)
  field(:cloneTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.CloneDefinition do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.CloneDefinition.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.CloneDefinition do
