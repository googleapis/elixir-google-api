...
defmodule GoogleApi.BigQuery.V2.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigQuery.V2.Model.Expr do
  def decode(value, options) do
    GoogleApi.BigQuery.V2.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQuery.V2.Model.Expr do
