...
defmodule GoogleApi.BigQuery.V2.Model.QueryRequest do
  ...
  *   `jobCreationMode` (*type:* `String.t`, *default:* `nil`) - Optional. If not set, jobs are always required. If set, the query request will follow the behavior described JobCreationMode. [Preview](/products/#product-launch-stages)
