...
defmodule GoogleApi.BigQuery.V2.Api.Models do
  ...
  """
  @spec bigquery_models_delete(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec bigquery_models_get(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec bigquery_models_list(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec bigquery_models_patch(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, GoogleApi.BigQuery.V2.Model.Model.t()} | {:error, Tesla.Env.t()}
