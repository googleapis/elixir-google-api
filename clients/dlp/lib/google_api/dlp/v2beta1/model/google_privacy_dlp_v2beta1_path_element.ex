...
defmodule GoogleApi.DLP.V2beta1.Model.GooglePrivacyDlpV2beta1PathElement do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DLP.V2beta1.Model.GooglePrivacyDlpV2beta1PathElement do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2beta1.Model.GooglePrivacyDlpV2beta1PathElement do
