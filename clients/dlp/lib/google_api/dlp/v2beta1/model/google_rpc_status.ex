...
defmodule GoogleApi.DLP.V2beta1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DLP.V2beta1.Model.GoogleRpcStatus do
  import GoogleApi.DLP.V2beta1.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"details", :list, GoogleApi.DLP.V2beta1.Model.Object, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2beta1.Model.GoogleRpcStatus do
