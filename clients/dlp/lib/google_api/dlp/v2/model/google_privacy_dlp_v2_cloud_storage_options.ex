...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CloudStorageOptions do
  ...
  *   `bytesLimitPerFile` (*type:* `String.t`, *default:* `nil`) - Max number of bytes to scan from a file. If a scanned file's size is bigger
      than this value then the rest of the bytes are omitted. Only one
      of bytes_limit_per_file and bytes_limit_per_file_percent can be specified.
  *   `bytesLimitPerFilePercent` (*type:* `integer()`, *default:* `nil`) - Max percentage of bytes to scan from a file. The rest are omitted. The
  ...
  *   `fileTypes` (*type:* `list(String.t)`, *default:* `nil`) - List of file type groups to include in the scan.
      If empty, all files are scanned and available data format processors
      are applied. In addition, the binary content of the selected files
      is always scanned as well.
  *   `filesLimitPercent` (*type:* `integer()`, *default:* `nil`) - Limits the number of files to scan to this percentage of the input FileSet.
