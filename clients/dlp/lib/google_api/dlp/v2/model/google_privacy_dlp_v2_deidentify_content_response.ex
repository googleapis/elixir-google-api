...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DeidentifyContentResponse do
  ...
  - item (GooglePrivacyDlpV2ContentItem): The de-identified item. Defaults to: `null`.
  - overview (GooglePrivacyDlpV2TransformationOverview): An overview of the changes that were made on the &#x60;item&#x60;. Defaults to: `null`.
  """
