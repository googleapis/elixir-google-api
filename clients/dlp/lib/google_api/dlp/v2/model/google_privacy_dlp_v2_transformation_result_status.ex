...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransformationResultStatus do
  ...
  *   `resultStatusType` (*type:* `String.t`, *default:* `nil`) - Transformation result status type, this will be either SUCCESS, or it will be the reason for why the transformation was not completely successful.
  ...
  field(:resultStatusType)
end

defimpl Poison.Decoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransformationResultStatus do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransformationResultStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2TransformationResultStatus do
