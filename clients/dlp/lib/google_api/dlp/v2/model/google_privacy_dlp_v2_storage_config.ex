...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StorageConfig do
  ...
  - bigQueryOptions (GooglePrivacyDlpV2BigQueryOptions): BigQuery options specification. Defaults to: `null`.
  - cloudStorageOptions (GooglePrivacyDlpV2CloudStorageOptions): Google Cloud Storage options specification. Defaults to: `null`.
  - datastoreOptions (GooglePrivacyDlpV2DatastoreOptions): Google Cloud Datastore options specification. Defaults to: `null`.
  - timespanConfig (GooglePrivacyDlpV2TimespanConfig):  Defaults to: `null`.
  """
