...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2CharacterMaskConfig do
  ...
  *   `numberToMask` (*type:* `integer()`, *default:* `nil`) - Number of characters to mask. If not set, all matching chars will be masked. Skipped characters do not count towards this tally.
