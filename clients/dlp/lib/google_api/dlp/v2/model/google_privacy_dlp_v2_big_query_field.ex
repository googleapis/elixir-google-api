...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2BigQueryField do
  ...
  - field (GooglePrivacyDlpV2FieldId): Designated field in the BigQuery table. Defaults to: `null`.
  - table (GooglePrivacyDlpV2BigQueryTable): Source table of the field. Defaults to: `null`.
  """
