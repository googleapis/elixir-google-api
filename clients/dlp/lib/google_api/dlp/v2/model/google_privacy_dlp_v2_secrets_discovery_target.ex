...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2SecretsDiscoveryTarget do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2SecretsDiscoveryTarget do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2SecretsDiscoveryTarget.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2SecretsDiscoveryTarget do
