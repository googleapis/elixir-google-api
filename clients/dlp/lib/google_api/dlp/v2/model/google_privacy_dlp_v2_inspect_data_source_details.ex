...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2InspectDataSourceDetails do
  ...
  - requestedOptions (GooglePrivacyDlpV2RequestedOptions): The configuration used for this job. Defaults to: `null`.
  - result (GooglePrivacyDlpV2Result): A summary of the outcome of this inspect job. Defaults to: `null`.
  """
