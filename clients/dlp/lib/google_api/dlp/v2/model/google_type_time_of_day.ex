...
defmodule GoogleApi.DLP.V2.Model.GoogleTypeTimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DLP.V2.Model.GoogleTypeTimeOfDay do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GoogleTypeTimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2.Model.GoogleTypeTimeOfDay do
