...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryOtherCloudGenerationCadence do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryOtherCloudGenerationCadence do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryOtherCloudGenerationCadence.decode(
      value,
      options
    )
  end
