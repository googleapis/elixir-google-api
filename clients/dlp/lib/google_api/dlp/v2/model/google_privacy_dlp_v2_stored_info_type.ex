...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2StoredInfoType do
  ...
  - currentVersion (GooglePrivacyDlpV2StoredInfoTypeVersion): Current version of the stored info type. Defaults to: `null`.
  - name (String.t): Resource name. Defaults to: `null`.
  - pendingVersions ([GooglePrivacyDlpV2StoredInfoTypeVersion]): Pending versions of the stored info type. Empty if no versions are pending. Defaults to: `null`.
  """
