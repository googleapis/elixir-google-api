...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Expressions do
  ...
  - conditions (GooglePrivacyDlpV2Conditions):  Defaults to: `null`.
  - logicalOperator (String.t): The operator to apply to the result of conditions. Default and currently only supported value is &#x60;AND&#x60;. Defaults to: `null`.
    - Enum - one of [LOGICAL_OPERATOR_UNSPECIFIED, AND]
  """
