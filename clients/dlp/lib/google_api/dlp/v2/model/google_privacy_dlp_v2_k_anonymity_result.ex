...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KAnonymityResult do
  ...
  *   `equivalenceClassHistogramBuckets` (*type:* `list(GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2KAnonymityHistogramBucket.t)`, *default:* `nil`) - Histogram of k-anonymity equivalence classes.
  """
