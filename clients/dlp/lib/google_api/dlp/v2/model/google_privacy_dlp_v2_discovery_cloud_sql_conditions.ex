...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryCloudSqlConditions do
  @moduledoc """
  ...
  *   `types` (*type:* `list(String.t)`, *default:* `nil`) - Data profiles will only be generated for the database resource types specified in this field. If not specified, defaults to [DATABASE_RESOURCE_TYPE_ALL_SUPPORTED_TYPES].
  ...
  @type t :: %__MODULE__{
          :databaseEngines => list(String.t()) | nil,
          :types => list(String.t()) | nil
        }

  field(:databaseEngines, type: :list)
  field(:types, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryCloudSqlConditions do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryCloudSqlConditions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2DiscoveryCloudSqlConditions do
