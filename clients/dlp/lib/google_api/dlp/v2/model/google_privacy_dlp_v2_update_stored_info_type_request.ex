...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2UpdateStoredInfoTypeRequest do
  ...
  - config (GooglePrivacyDlpV2StoredInfoTypeConfig): Updated configuration for the storedInfoType. If not provided, a new version of the storedInfoType will be created with the existing configuration. Defaults to: `null`.
