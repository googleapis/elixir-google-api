...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2LDiversityConfig do
  ...
  - quasiIds ([GooglePrivacyDlpV2FieldId]): Set of quasi-identifiers indicating how equivalence classes are defined for the l-diversity computation. When multiple fields are specified, they are considered a single composite key. Defaults to: `null`.
  - sensitiveAttribute (GooglePrivacyDlpV2FieldId): Sensitive field for computing the l-value. Defaults to: `null`.
  """
