...
defmodule GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2Range do
  ...
  *   `end` (*type:* `String.t`, *default:* `nil`) - Index of the last character of the range (exclusive).
  *   `start` (*type:* `String.t`, *default:* `nil`) - Index of the first character of the range (inclusive).
  """
