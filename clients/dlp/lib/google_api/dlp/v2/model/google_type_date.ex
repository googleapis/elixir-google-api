...
defmodule GoogleApi.DLP.V2.Model.GoogleTypeDate do
  ...
  - day (integer()): Day of month. Must be from 1 to 31 and valid for the year and month, or 0 if specifying a year by itself or a year and month where the day is not significant. Defaults to: `null`.
  - month (integer()): Month of year. Must be from 1 to 12, or 0 if specifying a year without a month and day. Defaults to: `null`.
