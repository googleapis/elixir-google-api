...
defmodule GoogleApi.DLP.V2.Model.GoogleRpcStatus do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.DLP.V2.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.DLP.V2.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.DLP.V2.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DLP.V2.Model.GoogleRpcStatus do
