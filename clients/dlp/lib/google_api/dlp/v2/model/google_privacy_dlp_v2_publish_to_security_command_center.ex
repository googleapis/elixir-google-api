...
defimpl Poison.Decoder,
  for: GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PublishToSecurityCommandCenter do
  def decode(value, options) do
    GoogleApi.DLP.V2.Model.GooglePrivacyDlpV2PublishToSecurityCommandCenter.decode(value, options)
  end
end
