...
defmodule GoogleApi.Manufacturers.V1.Model.Count do
  ...
  - unit (String.t): The unit in which these products are counted. Defaults to: `null`.
  - value (String.t): The numeric value of the number of products in a package. Defaults to: `null`.
  """
