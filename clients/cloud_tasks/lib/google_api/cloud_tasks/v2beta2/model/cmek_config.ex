...
defmodule GoogleApi.CloudTasks.V2beta2.Model.CmekConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2beta2.Model.CmekConfig do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2beta2.Model.CmekConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2beta2.Model.CmekConfig do
