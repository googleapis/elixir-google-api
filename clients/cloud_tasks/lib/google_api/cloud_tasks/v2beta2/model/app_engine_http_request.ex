...
defmodule GoogleApi.CloudTasks.V2beta2.Model.AppEngineHttpRequest do
  ...
  * `url =` host `+`
  ...
  - appEngineRouting (GoogleApi.CloudTasks.V2beta2.Model.AppEngineRouting.t): Task-level setting for App Engine routing.
  ...
  * `X-AppEngine-*`
  ...
  information, see the CreateTask documentation. Defaults to `nil`.
  - httpMethod (String.t): The HTTP method to use for the request. The default is POST.
  ...
  written in e.g.
  [Python Request
  Handler](https://cloud.google.com/appengine/docs/python/tools/webapp/requesthandlerclass). Defaults to `nil`.
  - payload (String.t): Payload.

  The payload will be sent as the HTTP message body. A message
  body, and thus a payload, is allowed only if the HTTP method is
  POST or PUT. It is an error to set a data payload on a task with
  an incompatible HttpMethod. Defaults to `nil`.
  - relativeUrl (String.t): The relative URL.

  The relative URL must begin with "/" and must be a valid HTTP relative URL.
  It can contain a path and query string arguments.
  If the relative URL is empty, then the root path "/" will be used.
  No spaces are allowed, and the maximum length allowed is 2083 characters. Defaults to `nil`.
  """
