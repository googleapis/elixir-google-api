...
defmodule GoogleApi.CloudTasks.V2beta2.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.CloudTasks.V2beta2.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.CloudTasks.V2beta2.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2beta2.Model.Status do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2beta2.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2beta2.Model.Status do
