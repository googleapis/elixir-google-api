...
defmodule GoogleApi.CloudTasks.V2beta2.Model.LeaseTasksRequest do
  ...
  - filter (String.t): `filter` can be used to specify a subset of tasks to lease.
  ...
  * `function = "oldest_tag()"`
  ...
  tag will be displayed as empty in Cloud Tasks. Defaults to `nil`.
  ...
  - maxTasks (integer()): The maximum number of tasks to lease.
  ...
  fewer tasks than requested are returned. Defaults to `nil`.
