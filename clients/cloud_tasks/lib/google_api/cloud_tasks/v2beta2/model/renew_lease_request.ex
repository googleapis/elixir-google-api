...
defmodule GoogleApi.CloudTasks.V2beta2.Model.RenewLeaseRequest do
  ...
  - leaseDuration (String.t): Required.  The desired new lease duration, starting from now.   The maximum lease duration is 1 week. &#x60;lease_duration&#x60; will be truncated to the nearest second. Defaults to: `null`.
