...
defmodule GoogleApi.CloudTasks.V2beta2.Model.RetryConfig do
  ...
  *   `maxAttempts` (*type:* `integer()`, *default:* `nil`) - The maximum number of attempts for a task. Cloud Tasks will attempt the task `max_attempts` times (that is, if the first attempt fails, then there will be `max_attempts - 1` retries). Must be > 0.
