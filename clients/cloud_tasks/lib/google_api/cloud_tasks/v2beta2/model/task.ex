...
defmodule GoogleApi.CloudTasks.V2beta2.Model.Task do
  ...
  *   `appEngineHttpRequest` (*type:* `GoogleApi.CloudTasks.V2beta2.Model.AppEngineHttpRequest.t`, *default:* `nil`) - App Engine HTTP request that is sent to the task's target. Can
      be set only if
  ...
  *   `pullMessage` (*type:* `GoogleApi.CloudTasks.V2beta2.Model.PullMessage.t`, *default:* `nil`) - LeaseTasks to process the task. Can be
      set only if pull_target is set on the queue.

      A pull task is a task that has PullMessage set.
  *   `scheduleTime` (*type:* `DateTime.t`, *default:* `nil`) - The time when the task is scheduled to be attempted.
