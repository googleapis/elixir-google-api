...
defmodule GoogleApi.CloudTasks.V2.Model.HeaderOverride do
  @moduledoc """
  ...
  *   `header` (*type:* `GoogleApi.CloudTasks.V2.Model.Header.t`, *default:* `nil`) - Header embodying a key and a value. Do not put business sensitive or personally identifying data in the HTTP Header Override Configuration or other similar fields in accordance with Section 12 (Resource Fields) of the [Service Specific Terms](https://cloud.google.com/terms/service-terms).
  ...
  field(:header, as: GoogleApi.CloudTasks.V2.Model.Header)
end

defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2.Model.HeaderOverride do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2.Model.HeaderOverride.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2.Model.HeaderOverride do
