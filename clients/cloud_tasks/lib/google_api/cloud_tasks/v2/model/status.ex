...
defmodule GoogleApi.CloudTasks.V2.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2.Model.Status do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2.Model.Status do
