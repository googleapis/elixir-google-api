...
defmodule GoogleApi.CloudTasks.V2.Model.HttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2.Model.HttpBody do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2.Model.HttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2.Model.HttpBody do
