...
defmodule GoogleApi.CloudTasks.V2.Model.Queue do
  ...
  *   `httpTarget` (*type:* `GoogleApi.CloudTasks.V2.Model.HttpTarget.t`, *default:* `nil`) - Modifies HTTP target for HTTP tasks.
  ...
  *   `stackdriverLoggingConfig` (*type:* `GoogleApi.CloudTasks.V2.Model.StackdriverLoggingConfig.t`, *default:* `nil`) - Configuration options for writing logs to [Stackdriver Logging](https://cloud.google.com/logging/docs/). If this field is unset, then no logs are written.
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The state of the queue. `state` can only be changed by calling PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change `state`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :httpTarget => GoogleApi.CloudTasks.V2.Model.HttpTarget.t() | nil,
          :name => String.t() | nil,
  ...
  field(:httpTarget, as: GoogleApi.CloudTasks.V2.Model.HttpTarget)
  field(:name)
