...
defmodule GoogleApi.CloudTasks.V2.Model.Queue do
  ...
  *   `appEngineRoutingOverride` (*type:* `GoogleApi.CloudTasks.V2.Model.AppEngineRouting.t`, *default:* `nil`) - Overrides for
  ...
  *   `rateLimits` (*type:* `GoogleApi.CloudTasks.V2.Model.RateLimits.t`, *default:* `nil`) - Rate limits for task dispatches.
  ...
  *   `retryConfig` (*type:* `GoogleApi.CloudTasks.V2.Model.RetryConfig.t`, *default:* `nil`) - Settings that determine the retry behavior.
