...
defmodule GoogleApi.CloudTasks.V2.Model.AppEngineHttpRequest do
  @moduledoc """
  ...
  *   `appEngineRouting` (*type:* `GoogleApi.CloudTasks.V2.Model.AppEngineRouting.t`, *default:* `nil`) - Task-level setting for App Engine routing. * If app_engine_routing_override is set on the queue, this value is used for all tasks in the queue, no matter what the setting is for the task-level app_engine_routing.
  *   `body` (*type:* `String.t`, *default:* `nil`) - HTTP request body. A request body is allowed only if the HTTP method is POST or PUT. It is an error to set a body on a task with an incompatible HttpMethod.
  ...
  *   `relativeUri` (*type:* `String.t`, *default:* `nil`) - The relative URI. The relative URI must begin with "/" and must be a valid HTTP relative URI. It can contain a path and query string arguments. If the relative URI is empty, then the root path "/" will be used. No spaces are allowed, and the maximum length allowed is 2083 characters.
  ...
  field(:appEngineRouting, as: GoogleApi.CloudTasks.V2.Model.AppEngineRouting)
  field(:body)
...
defimpl Poison.Decoder, for: GoogleApi.CloudTasks.V2.Model.AppEngineHttpRequest do
  def decode(value, options) do
    GoogleApi.CloudTasks.V2.Model.AppEngineHttpRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudTasks.V2.Model.AppEngineHttpRequest do
