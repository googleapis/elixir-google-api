...
defmodule GoogleApi.AndroidEnterprise.V1.Api.Grouplicenses do
  ...
  """
  @spec androidenterprise_grouplicenses_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.AndroidEnterprise.V1.Model.GroupLicense.t} | {:error, Tesla.Env.t}
  def androidenterprise_grouplicenses_get(connection, enterprise_id, group_license_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.AndroidEnterprise.V1.Model.GroupLicense{})
  end
  ...
  {:error, info} on failure
  """
  @spec androidenterprise_grouplicenses_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.AndroidEnterprise.V1.Model.GroupLicensesListResponse.t} | {:error, Tesla.Env.t}
  def androidenterprise_grouplicenses_list(connection, enterprise_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.AndroidEnterprise.V1.Model.GroupLicensesListResponse{})
  end
end
