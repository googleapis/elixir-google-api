...
defmodule GoogleApi.AndroidEnterprise.V1.Api.Grouplicenseusers do
  ...
  """
  @spec androidenterprise_grouplicenseusers_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.AndroidEnterprise.V1.Model.GroupLicenseUsersListResponse.t} | {:error, Tesla.Env.t}
  def androidenterprise_grouplicenseusers_list(connection, enterprise_id, group_license_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.AndroidEnterprise.V1.Model.GroupLicenseUsersListResponse{})
  end
end
