...
defmodule GoogleApi.AndroidEnterprise.V1.Api.Devices do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :updateMask (String.t): Mask that identifies which fields to update. If not set, all modifiable fields will be modified.

  When set in a query parameter, this field should be specified as updateMask=<field1>,<field2>,...
    - :body (GoogleApi.AndroidEnterprise.V1.Model.Device.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.AndroidEnterprise.V1.Model.DeviceState.t): 
