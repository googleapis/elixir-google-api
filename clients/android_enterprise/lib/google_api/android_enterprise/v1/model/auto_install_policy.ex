...
defmodule GoogleApi.AndroidEnterprise.V1.Model.AutoInstallPolicy do
  ...
  *   `autoInstallConstraint` (*type:* `list(GoogleApi.AndroidEnterprise.V1.Model.AutoInstallConstraint.t)`, *default:* `nil`) - The constraints for auto-installing the app. You can specify a maximum of
      one constraint.
  *   `autoInstallMode` (*type:* `String.t`, *default:* `nil`) - The auto-install mode. If unset defaults to "doNotAutoInstall".
  *   `autoInstallPriority` (*type:* `integer()`, *default:* `nil`) - The priority of the install, as an unsigned integer. A lower number means
      higher priority.
  *   `minimumVersionCode` (*type:* `integer()`, *default:* `nil`) - The minimum version of the app. If a lower version of the app is installed,
