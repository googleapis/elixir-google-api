...
defmodule GoogleApi.AndroidEnterprise.V1.Model.EntitlementsListResponse do
  ...
  - entitlement ([Entitlement]): An entitlement of a user to a product (e.g. an app). For example, a free app that they have installed, or a paid app that they have been allocated a license to. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#entitlementsListResponse\&quot;. Defaults to: `null`.
  """
