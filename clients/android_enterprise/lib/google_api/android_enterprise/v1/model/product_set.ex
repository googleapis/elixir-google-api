...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ProductSet do
  ...
  *   `productSetBehavior` (*type:* `String.t`, *default:* `nil`) - The interpretation of this product set. "unknown" should never be sent and
  ...
  *   `productVisibility` (*type:* `list(GoogleApi.AndroidEnterprise.V1.Model.ProductVisibility.t)`, *default:* `nil`) - Additional list of product IDs making up the product set.
