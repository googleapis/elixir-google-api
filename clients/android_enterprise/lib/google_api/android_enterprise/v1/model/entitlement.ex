...
defmodule GoogleApi.AndroidEnterprise.V1.Model.Entitlement do
  ...
  *   `productId` (*type:* `String.t`, *default:* `nil`) - The ID of the product that the entitlement is for. For example,
      <code>&quot;app:com.google.android.gm&quot;</code>.
  *   `reason` (*type:* `String.t`, *default:* `nil`) - The reason for the entitlement. For example, <code class="">"free"</code>
