...
defmodule GoogleApi.AndroidEnterprise.V1.Model.Entitlement do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#entitlement\&quot;. Defaults to: `null`.
  - productId (String.t): The ID of the product that the entitlement is for. For example, \&quot;app:com.google.android.gm\&quot;. Defaults to: `null`.
  - reason (String.t): The reason for the entitlement. For example, \&quot;free\&quot; for free apps. This property is temporary: it will be replaced by the acquisition kind field of group licenses. Defaults to: `null`.
  """
