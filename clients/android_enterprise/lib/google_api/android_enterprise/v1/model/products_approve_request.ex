...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ProductsApproveRequest do
  ...
  *   `approvalUrlInfo` (*type:* `GoogleApi.AndroidEnterprise.V1.Model.ApprovalUrlInfo.t`, *default:* `nil`) - The approval URL that was shown to the user. Only the permissions shown
      ...
      was generated.
  *   `approvedPermissions` (*type:* `String.t`, *default:* `nil`) - Sets how new permission requests for the product are handled.
