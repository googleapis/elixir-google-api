...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ManagedPropertyBundle do
  ...
  - managedProperty ([ManagedProperty]): The list of managed properties. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidEnterprise.V1.Model.ManagedPropertyBundle do
  def decode(value, options) do
    GoogleApi.AndroidEnterprise.V1.Model.ManagedPropertyBundle.decode(value, options)
  end
end
