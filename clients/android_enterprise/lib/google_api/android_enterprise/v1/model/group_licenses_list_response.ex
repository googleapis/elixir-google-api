...
defmodule GoogleApi.AndroidEnterprise.V1.Model.GroupLicensesListResponse do
  ...
  - groupLicense ([GroupLicense]): A group license for a product approved for use in the enterprise. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#groupLicensesListResponse\&quot;. Defaults to: `null`.
  """
