...
defmodule GoogleApi.AndroidEnterprise.V1.Model.EnterprisesListResponse do
  ...
  - enterprise ([Enterprise]): An enterprise. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#enterprisesListResponse\&quot;. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidEnterprise.V1.Model.EnterprisesListResponse do
  def decode(value, options) do
    GoogleApi.AndroidEnterprise.V1.Model.EnterprisesListResponse.decode(value, options)
  end
end
