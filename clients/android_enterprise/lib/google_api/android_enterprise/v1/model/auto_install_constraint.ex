...
defmodule GoogleApi.AndroidEnterprise.V1.Model.AutoInstallConstraint do
  ...
  - chargingStateConstraint (String.t): Charging state to constrain on. Defaults to: `null`.
  - deviceIdleStateConstraint (String.t): The idle state of the device to constrain on. Defaults to: `null`.
  - networkTypeConstraint (String.t): Network type to constrain on. Defaults to: `null`.
  """
