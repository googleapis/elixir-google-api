...
defmodule GoogleApi.AndroidEnterprise.V1.Model.StoreLayoutClustersListResponse do
  ...
  - cluster ([StoreCluster]): A store cluster of an enterprise. Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#storeLayoutClustersListResponse\&quot;. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidEnterprise.V1.Model.StoreLayoutClustersListResponse do
  def decode(value, options) do
    GoogleApi.AndroidEnterprise.V1.Model.StoreLayoutClustersListResponse.decode(value, options)
  end
end
