...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ServiceAccountKey do
  ...
  *   `kind` (*type:* `String.t`, *default:* `androidenterprise#serviceAccountKey`) - Identifies what kind of resource this is. Value: the fixed string "androidenterprise#serviceAccountKey".
