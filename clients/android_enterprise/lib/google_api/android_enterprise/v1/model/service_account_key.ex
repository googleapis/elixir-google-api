...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ServiceAccountKey do
  ...
  *   `data` (*type:* `String.t`, *default:* `nil`) - The body of the private key credentials file, in string format. This
      is only populated when the ServiceAccountKey is created, and is not stored
      by Google.
  *   `id` (*type:* `String.t`, *default:* `nil`) - An opaque, unique identifier for this ServiceAccountKey.
      Assigned by the server.
  *   `publicData` (*type:* `String.t`, *default:* `nil`) - Public key data for the credentials file. This is an X.509 cert. If you are
