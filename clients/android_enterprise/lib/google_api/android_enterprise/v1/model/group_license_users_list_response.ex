...
defmodule GoogleApi.AndroidEnterprise.V1.Model.GroupLicenseUsersListResponse do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string "androidenterprise#groupLicenseUsersListResponse". Defaults to `androidenterprise#groupLicenseUsersListResponse`.
