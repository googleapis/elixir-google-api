...
defmodule GoogleApi.AndroidEnterprise.V1.Model.AppState do
  ...
  - keyedAppState ([KeyedAppState]): List of keyed app states. This field will always be present. Defaults to: `null`.
  - packageName (String.t): The package name of the app. This field will always be present. Defaults to: `null`.
  """
