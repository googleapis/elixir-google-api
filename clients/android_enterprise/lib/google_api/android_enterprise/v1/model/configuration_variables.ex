...
defmodule GoogleApi.AndroidEnterprise.V1.Model.ConfigurationVariables do
  ...
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidenterprise#configurationVariables\&quot;. Defaults to: `null`.
  - mcmId (String.t): The ID of the managed configurations settings. Defaults to: `null`.
  - variableSet ([VariableSet]): The variable set that is attributed to the user. Defaults to: `null`.
  """
