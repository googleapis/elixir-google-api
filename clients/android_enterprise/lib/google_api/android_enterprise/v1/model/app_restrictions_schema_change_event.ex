...
defmodule GoogleApi.AndroidEnterprise.V1.Model.AppRestrictionsSchemaChangeEvent do
  ...
  - productId (String.t): The id of the product (e.g. "app:com.google.android.gm") for which the app restriction schema changed. This field will always be present. Defaults to `nil`.
  """
