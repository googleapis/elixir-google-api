...
defmodule GoogleApi.TPU.V1.Model.Symptom do
  @moduledoc """
  A Symptom instance.
...
defimpl Poison.Decoder, for: GoogleApi.TPU.V1.Model.Symptom do
  def decode(value, options) do
    GoogleApi.TPU.V1.Model.Symptom.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V1.Model.Symptom do
