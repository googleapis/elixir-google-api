...
defmodule GoogleApi.TPU.V2.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.TPU.V2.Model.Interval do
  def decode(value, options) do
    GoogleApi.TPU.V2.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V2.Model.Interval do
