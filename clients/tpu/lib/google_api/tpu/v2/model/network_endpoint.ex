...
defmodule GoogleApi.TPU.V2.Model.NetworkEndpoint do
  @moduledoc """
  ...
  *   `port` (*type:* `integer()`, *default:* `nil`) - The port of this network endpoint.
  ...
  field(:accessConfig, as: GoogleApi.TPU.V2.Model.AccessConfig)
  field(:ipAddress)
  field(:port)
end

defimpl Poison.Decoder, for: GoogleApi.TPU.V2.Model.NetworkEndpoint do
  def decode(value, options) do
    GoogleApi.TPU.V2.Model.NetworkEndpoint.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V2.Model.NetworkEndpoint do
