...
defmodule GoogleApi.TPU.V2.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.TPU.V2.Model.Location do
  def decode(value, options) do
    GoogleApi.TPU.V2.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V2.Model.Location do
