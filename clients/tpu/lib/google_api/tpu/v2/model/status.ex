...
defmodule GoogleApi.TPU.V2.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.TPU.V2.Model.Status do
  def decode(value, options) do
    GoogleApi.TPU.V2.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V2.Model.Status do
