...
defmodule GoogleApi.TPU.V2.Model.ServiceAccount do
  @moduledoc """
  A service account.
...
defimpl Poison.Decoder, for: GoogleApi.TPU.V2.Model.ServiceAccount do
  def decode(value, options) do
    GoogleApi.TPU.V2.Model.ServiceAccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TPU.V2.Model.ServiceAccount do
