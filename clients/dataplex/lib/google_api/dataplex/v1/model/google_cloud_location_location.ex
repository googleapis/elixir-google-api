...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudLocationLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudLocationLocation do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudLocationLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudLocationLocation do
