...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1ListAspectTypesResponse do
  ...
  *   `unreachableLocations` (*type:* `list(String.t)`, *default:* `nil`) - Locations that the service couldn't reach.
  ...
  @type t :: %__MODULE__{
          :aspectTypes =>
            list(GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AspectType.t()) | nil,
          :nextPageToken => String.t() | nil,
          :unreachableLocations => list(String.t()) | nil
        }

  field(:aspectTypes, as: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AspectType, type: :list)
...
defimpl Poison.Decoder,
  for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1ListAspectTypesResponse do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1ListAspectTypesResponse.decode(
      value,
      options
    )
  end
