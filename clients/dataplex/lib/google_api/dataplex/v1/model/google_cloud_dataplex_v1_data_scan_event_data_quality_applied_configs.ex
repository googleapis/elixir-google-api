...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1DataScanEventDataQualityAppliedConfigs do
  @moduledoc """
...
defimpl Poison.Decoder,
  ...
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1DataScanEventDataQualityAppliedConfigs.decode(
      value,
      options
    )
  end
