...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoveryStatusStats do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoveryStatusStats do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoveryStatusStats.decode(
      value,
      options
    )
  end
