...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1EntryTypeAuthorization do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1EntryTypeAuthorization do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1EntryTypeAuthorization.decode(value, options)
  end
end
