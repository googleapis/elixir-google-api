...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpec do
  @moduledoc """
  ...
  *   `schedule` (*type:* `String.t`, *default:* `nil`) - Optional. Cron schedule (https://en.wikipedia.org/wiki/Cron) for running discovery periodically. Successive discovery runs must be scheduled at least 60 minutes apart. The default value is to run discovery every 60 minutes. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, CRON_TZ=America/New_York 1 * * * *, or TZ=America/New_York 1 * * * *.
  ...
  field(:csvOptions,
    as: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpecCsvOptions
  )
  ...
  field(:jsonOptions,
    as: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpecJsonOptions
  )

  field(:schedule)
end

defimpl Poison.Decoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpec do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1AssetDiscoverySpec do
