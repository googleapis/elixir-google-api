...
defmodule GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1OperationMetadata do
  def decode(value, options) do
    GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataplex.V1.Model.GoogleCloudDataplexV1OperationMetadata do
