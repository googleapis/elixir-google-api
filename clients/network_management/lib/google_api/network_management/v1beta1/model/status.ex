...
defmodule GoogleApi.NetworkManagement.V1beta1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1beta1.Model.Status do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1beta1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1beta1.Model.Status do
