...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1beta1.Model.NetworkInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1beta1.Model.NetworkInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1beta1.Model.NetworkInfo do
