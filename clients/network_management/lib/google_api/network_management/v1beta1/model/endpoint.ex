...
defmodule GoogleApi.NetworkManagement.V1beta1.Model.Endpoint do
  ...
  *   `appEngineVersion` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.AppEngineVersionEndpoint.t`, *default:* `nil`) - An [App Engine](https://cloud.google.com/appengine) [service version](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1/apps.services.versions). Applicable only to source endpoint.
  *   `cloudFunction` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.CloudFunctionEndpoint.t`, *default:* `nil`) - A [Cloud Function](https://cloud.google.com/functions). Applicable only to source endpoint.
  *   `cloudRunRevision` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.CloudRunRevisionEndpoint.t`, *default:* `nil`) - A [Cloud Run](https://cloud.google.com/run) [revision](https://cloud.google.com/run/docs/reference/rest/v1/namespaces.revisions/get) Applicable only to source endpoint.
