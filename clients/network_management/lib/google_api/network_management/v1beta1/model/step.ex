...
defmodule GoogleApi.NetworkManagement.V1beta1.Model.Step do
  ...
  *   `endpoint` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.EndpointInfo.t`, *default:* `nil`) - Display info of the source and destination under analysis. The endpoint info in an intermediate state may differ with the initial input, as it might be modified by state like NAT, or Connection Proxy.
  ...
  *   `route` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.RouteInfo.t`, *default:* `nil`) - Display info of a Compute Engine route.
  *   `state` (*type:* `String.t`, *default:* `nil`) - Each step is in one of the pre-defined states.
  *   `vpnGateway` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.VpnGatewayInfo.t`, *default:* `nil`) - Display info of a Compute Engine VPN gateway.
  *   `vpnTunnel` (*type:* `GoogleApi.NetworkManagement.V1beta1.Model.VpnTunnelInfo.t`, *default:* `nil`) - Display info of a Compute Engine VPN tunnel.
  """
