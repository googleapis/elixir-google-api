...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1beta1.Model.CloudFunctionInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1beta1.Model.CloudFunctionInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1beta1.Model.CloudFunctionInfo do
