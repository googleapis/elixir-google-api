...
defmodule GoogleApi.NetworkManagement.V1.Api.Projects do
  ...
  *   `connection` (*type:* `GoogleApi.NetworkManagement.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Identifier. Unique name of the resource using the form: `projects/{project_id}/locations/global/connectivityTests/{test_id}`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.NetworkManagement.V1.Model.VpcFlowLogsConfig.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def networkmanagement_projects_locations_vpc_flow_logs_configs_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/vpcFlowLogsConfigs", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.NetworkManagement.V1.Model.VpcFlowLogsConfig{}}` on success
  *   `{:error, info}` on failure
  """
  @spec networkmanagement_projects_locations_vpc_flow_logs_configs_get(
          ...
          {:ok, GoogleApi.NetworkManagement.V1.Model.VpcFlowLogsConfig.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def networkmanagement_projects_locations_vpc_flow_logs_configs_get(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.NetworkManagement.V1.Model.VpcFlowLogsConfig{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.NetworkManagement.V1.Model.ListVpcFlowLogsConfigsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec networkmanagement_projects_locations_vpc_flow_logs_configs_list(
          ...
          {:ok, GoogleApi.NetworkManagement.V1.Model.ListVpcFlowLogsConfigsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def networkmanagement_projects_locations_vpc_flow_logs_configs_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.NetworkManagement.V1.Model.ListVpcFlowLogsConfigsResponse{}]
    )
  end
