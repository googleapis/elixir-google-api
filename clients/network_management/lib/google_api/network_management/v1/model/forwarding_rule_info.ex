...
defmodule GoogleApi.NetworkManagement.V1.Model.ForwardingRuleInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.ForwardingRuleInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.ForwardingRuleInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.ForwardingRuleInfo do
