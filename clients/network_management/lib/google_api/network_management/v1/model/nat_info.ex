...
defmodule GoogleApi.NetworkManagement.V1.Model.NatInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.NatInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.NatInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.NatInfo do
