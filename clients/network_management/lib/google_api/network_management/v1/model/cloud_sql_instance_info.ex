...
defmodule GoogleApi.NetworkManagement.V1.Model.CloudSQLInstanceInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.CloudSQLInstanceInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.CloudSQLInstanceInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.CloudSQLInstanceInfo do
