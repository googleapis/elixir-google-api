...
defmodule GoogleApi.NetworkManagement.V1.Model.DeliverInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.DeliverInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.DeliverInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.DeliverInfo do
