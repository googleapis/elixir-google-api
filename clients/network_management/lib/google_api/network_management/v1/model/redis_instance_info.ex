...
defmodule GoogleApi.NetworkManagement.V1.Model.RedisInstanceInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.RedisInstanceInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.RedisInstanceInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.RedisInstanceInfo do
