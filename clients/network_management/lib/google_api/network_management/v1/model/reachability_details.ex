...
defmodule GoogleApi.NetworkManagement.V1.Model.ReachabilityDetails do
  ...
  *   `traces` (*type:* `list(GoogleApi.NetworkManagement.V1.Model.Trace.t)`, *default:* `nil`) - Result may contain a list of traces if a test has multiple possible
  ...
  *   `verifyTime` (*type:* `DateTime.t`, *default:* `nil`) - The time the reachability state was verified.
  ...
  field(:result)
  field(:traces, as: GoogleApi.NetworkManagement.V1.Model.Trace, type: :list)
  field(:verifyTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.ReachabilityDetails do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.ReachabilityDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.ReachabilityDetails do
