...
defmodule GoogleApi.NetworkManagement.V1.Model.CloudFunctionInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.CloudFunctionInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.CloudFunctionInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.CloudFunctionInfo do
