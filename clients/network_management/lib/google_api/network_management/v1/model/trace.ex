...
defmodule GoogleApi.NetworkManagement.V1.Model.Trace do
  @moduledoc """
  ...
  *   `endpointInfo` (*type:* `GoogleApi.NetworkManagement.V1.Model.EndpointInfo.t`, *default:* `nil`) - Derived from the source and destination endpoints definition, and validated
      by the data plane model.
      If there are multiple traces starting from different source locations, then
      the endpoint_info may be different between traces.
  *   `steps` (*type:* `list(GoogleApi.NetworkManagement.V1.Model.Step.t)`, *default:* `nil`) - A trace of a test contains multiple steps from the initial state to the
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.Trace do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.Trace.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.Trace do
