...
defmodule GoogleApi.NetworkManagement.V1.Model.GKEMasterInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.GKEMasterInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.GKEMasterInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.GKEMasterInfo do
