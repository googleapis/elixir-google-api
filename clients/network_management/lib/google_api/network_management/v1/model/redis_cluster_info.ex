...
defmodule GoogleApi.NetworkManagement.V1.Model.RedisClusterInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkManagement.V1.Model.RedisClusterInfo do
  def decode(value, options) do
    GoogleApi.NetworkManagement.V1.Model.RedisClusterInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkManagement.V1.Model.RedisClusterInfo do
