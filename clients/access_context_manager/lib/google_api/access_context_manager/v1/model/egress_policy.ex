...
defmodule GoogleApi.AccessContextManager.V1.Model.EgressPolicy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.EgressPolicy do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.EgressPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.EgressPolicy do
