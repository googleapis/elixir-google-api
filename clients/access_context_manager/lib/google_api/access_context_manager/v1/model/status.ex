...
defmodule GoogleApi.AccessContextManager.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.Status do
