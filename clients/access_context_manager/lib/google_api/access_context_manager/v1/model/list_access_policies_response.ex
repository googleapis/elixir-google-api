...
defmodule GoogleApi.AccessContextManager.V1.Model.ListAccessPoliciesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.ListAccessPoliciesResponse do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.ListAccessPoliciesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.ListAccessPoliciesResponse do
