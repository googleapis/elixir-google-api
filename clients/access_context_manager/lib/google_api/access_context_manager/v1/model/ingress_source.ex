...
defmodule GoogleApi.AccessContextManager.V1.Model.IngressSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.IngressSource do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.IngressSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.IngressSource do
