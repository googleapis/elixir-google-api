...
defimpl Poison.Decoder,
  for: GoogleApi.AccessContextManager.V1.Model.GcpUserAccessBindingOperationMetadata do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.GcpUserAccessBindingOperationMetadata.decode(
      value,
      options
    )
  end
