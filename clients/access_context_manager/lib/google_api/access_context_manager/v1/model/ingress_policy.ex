...
defmodule GoogleApi.AccessContextManager.V1.Model.IngressPolicy do
  @moduledoc """
  ...
  *   `ingressTo` (*type:* `GoogleApi.AccessContextManager.V1.Model.IngressTo.t`, *default:* `nil`) - Defines the conditions on the ApiOperation and request destination that cause this IngressPolicy to apply.
  ...
  @type t :: %__MODULE__{
          :ingressFrom => GoogleApi.AccessContextManager.V1.Model.IngressFrom.t(),
          :ingressTo => GoogleApi.AccessContextManager.V1.Model.IngressTo.t()
        }
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.IngressPolicy do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.IngressPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.IngressPolicy do
