...
defmodule GoogleApi.AccessContextManager.V1.Model.IngressTo do
  ...
  *   `operations` (*type:* `list(GoogleApi.AccessContextManager.V1.Model.ApiOperation.t)`, *default:* `nil`) - A list of ApiOperations the sources specified in corresponding IngressFrom are allowed to perform in this ServicePerimeter.
