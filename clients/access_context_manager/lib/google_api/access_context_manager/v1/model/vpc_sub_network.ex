...
defmodule GoogleApi.AccessContextManager.V1.Model.VpcSubNetwork do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.VpcSubNetwork do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.VpcSubNetwork.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.VpcSubNetwork do
