...
defmodule GoogleApi.AccessContextManager.V1.Model.ApiOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.ApiOperation do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.ApiOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.ApiOperation do
