...
defmodule GoogleApi.AccessContextManager.V1.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.AuditLogConfig do
