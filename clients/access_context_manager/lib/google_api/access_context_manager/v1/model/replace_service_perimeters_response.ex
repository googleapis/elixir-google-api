...
defimpl Poison.Decoder,
  for: GoogleApi.AccessContextManager.V1.Model.ReplaceServicePerimetersResponse do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.ReplaceServicePerimetersResponse.decode(
      value,
      options
    )
  end
