...
defmodule GoogleApi.AccessContextManager.V1.Model.ListAccessLevelsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AccessContextManager.V1.Model.ListAccessLevelsResponse do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.ListAccessLevelsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AccessContextManager.V1.Model.ListAccessLevelsResponse do
