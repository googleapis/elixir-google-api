...
defmodule GoogleApi.AccessContextManager.V1.Model.EgressSource do
  ...
  *   `resource` (*type:* `String.t`, *default:* `nil`) - A Google Cloud resource from the service perimeter that you want to allow to access data outside the perimeter. This field supports only projects. The project format is `projects/{project_number}`. You can't use `*` in this field to allow all Google Cloud resources.
  """
