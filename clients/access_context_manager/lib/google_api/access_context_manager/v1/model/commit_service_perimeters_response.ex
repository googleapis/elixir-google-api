...
defimpl Poison.Decoder,
  for: GoogleApi.AccessContextManager.V1.Model.CommitServicePerimetersResponse do
  def decode(value, options) do
    GoogleApi.AccessContextManager.V1.Model.CommitServicePerimetersResponse.decode(value, options)
  end
end
