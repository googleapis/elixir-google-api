...
defmodule GoogleApi.AccessContextManager.V1.Api.Operations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.AccessContextManager.V1.Model.CancelOperationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.AccessContextManager.V1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  """
  @spec accesscontextmanager_operations_cancel(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.AccessContextManager.V1.Model.Empty.t()} | {:error, Tesla.Env.t()}
  def accesscontextmanager_operations_cancel(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.AccessContextManager.V1.Model.Empty{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec accesscontextmanager_operations_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:ok, %GoogleApi.AccessContextManager.V1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def accesscontextmanager_operations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.AccessContextManager.V1.Model.ListOperationsResponse{}]
    )
  end
end
