...
defmodule GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantServiceAccountIdentity do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantServiceAccountIdentity do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantServiceAccountIdentity.decode(
      value,
      options
    )
  end
