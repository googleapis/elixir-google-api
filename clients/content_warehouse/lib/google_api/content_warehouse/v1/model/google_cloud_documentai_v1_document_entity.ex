...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentEntity do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. Entity type from a schema e.g. `Address`.
  ...
  field(:normalizedValue,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentEntityNormalizedValue
  )

  field(:pageAnchor,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageAnchor
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentEntity do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentEntity.decode(
      value,
      options
    )
  end
