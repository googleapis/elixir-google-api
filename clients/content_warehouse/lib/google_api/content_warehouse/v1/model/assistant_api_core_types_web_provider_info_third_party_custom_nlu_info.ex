...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesWebProviderInfoThirdPartyCustomNluInfo do
  @moduledoc """
  ...
  *   `nluAgentVersion` (*type:* `String.t`, *default:* `nil`) - Identifies the 3P Custom NLU agent version.
  ...
  field(:locale)
  field(:nluAgentId)
  field(:nluAgentVersion)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesWebProviderInfoThirdPartyCustomNluInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesWebProviderInfoThirdPartyCustomNluInfo.decode(
      value,
      options
    )
  end
