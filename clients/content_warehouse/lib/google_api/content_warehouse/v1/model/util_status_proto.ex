...
defmodule GoogleApi.ContentWarehouse.V1.Model.UtilStatusProto do
  @moduledoc """
  ...
  *   `space` (*type:* `String.t`, *default:* `nil`) - The following are usually only present when code != 0 Space to which this status belongs
  ...
  field(:code)
  field(:message)
  field(:messageSet, as: GoogleApi.ContentWarehouse.V1.Model.Proto2BridgeMessageSet)
  field(:space)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.UtilStatusProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.UtilStatusProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.UtilStatusProto do
