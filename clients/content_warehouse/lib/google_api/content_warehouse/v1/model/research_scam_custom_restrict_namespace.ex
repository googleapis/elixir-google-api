...
defmodule GoogleApi.ContentWarehouse.V1.Model.ResearchScamCustomRestrictNamespace do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ResearchScamCustomRestrictNamespace do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ResearchScamCustomRestrictNamespace.decode(value, options)
  end
end
