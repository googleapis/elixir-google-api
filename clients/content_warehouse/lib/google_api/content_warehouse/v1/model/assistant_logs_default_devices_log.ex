...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDevicesLog do
  @moduledoc """
  ...
  *   `nearbyDefaultDevices` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDeviceLog.t)`, *default:* `nil`) - Default settings of nearby devices.
  ...
  field(:localDefaultDevices,
    as: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDeviceLog
  )

  field(:nearbyDefaultDevices,
    as: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDeviceLog,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDevicesLog do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDevicesLog.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsDefaultDevicesLog do
