...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchSportsKeyMomentsAnchorSetFeatures do
  @moduledoc """
  ...
  *   `tensorflowModelVersion` (*type:* `String.t`, *default:* `nil`) - Version of the underlying TensorFlow model.
  ...
  field(:prefilterClassificationLabel)
  field(:tensorflowModelVersion)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchSportsKeyMomentsAnchorSetFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchSportsKeyMomentsAnchorSetFeatures.decode(
      value,
      options
    )
  end
