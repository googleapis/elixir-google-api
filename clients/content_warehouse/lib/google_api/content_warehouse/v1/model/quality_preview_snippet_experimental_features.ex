...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetExperimentalFeatures do
  @moduledoc """
  ...
  *   `radish` (*type:* `GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetRadishFeatures.t`, *default:* `nil`) - 
  ...
  field(:isLikelyHomepage)
  field(:numQueryItems)
  field(:numTidbits)
  field(:numVisibleTokens)
  field(:radish, as: GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetRadishFeatures)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetExperimentalFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetExperimentalFeatures.decode(
      value,
      options
    )
  end
