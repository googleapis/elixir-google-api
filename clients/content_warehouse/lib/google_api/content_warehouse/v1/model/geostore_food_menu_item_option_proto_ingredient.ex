...
defmodule GoogleApi.ContentWarehouse.V1.Model.GeostoreFoodMenuItemOptionProtoIngredient do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GeostoreFoodMenuItemOptionProtoIngredient do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GeostoreFoodMenuItemOptionProtoIngredient.decode(
      value,
      options
    )
  end
