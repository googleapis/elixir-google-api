...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiSystemNotificationRestrictions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSystemNotificationRestrictions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiSystemNotificationRestrictions.decode(
      value,
      options
    )
  end
