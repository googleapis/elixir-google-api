...
defmodule GoogleApi.ContentWarehouse.V1.Model.CountryProvinceGeotoken do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.CountryProvinceGeotoken do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.CountryProvinceGeotoken.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.CountryProvinceGeotoken do
