...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCommentAnchorSetFeatures do
  @moduledoc """
  ...
  *   `rootComment` (*type:* `GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCommentAnchorSetFeaturesComment.t`, *default:* `nil`) - 
  ...
  field(:replies,
    as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCommentAnchorSetFeaturesComment,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCommentAnchorSetFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCommentAnchorSetFeatures.decode(
      value,
      options
    )
  end
