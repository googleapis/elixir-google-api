...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoAssetsVenomSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.VideoAssetsVenomSettings do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoAssetsVenomSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.VideoAssetsVenomSettings do
