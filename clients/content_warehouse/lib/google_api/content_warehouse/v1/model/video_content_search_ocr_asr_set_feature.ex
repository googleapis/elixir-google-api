...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrAsrSetFeature do
  @moduledoc """
  ...
  *   `wordOverlapScore` (*type:* `number()`, *default:* `nil`) - A score based on the number of overlapped words between the OCR and ASR for anchors in the cluster.
  ...
  field(:normalizedWordOverlapScore)
  field(:wordOverlapScore)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrAsrSetFeature do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrAsrSetFeature.decode(value, options)
  end
end
