...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeExpr do
