...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetQueryTermCoverageFeatures do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetQueryTermCoverageFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityPreviewSnippetQueryTermCoverageFeatures.decode(
      value,
      options
    )
  end
