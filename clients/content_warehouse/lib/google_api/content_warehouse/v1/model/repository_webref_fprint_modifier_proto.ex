...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefFprintModifierProto do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefFprintModifierProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefFprintModifierProto.decode(value, options)
  end
end
