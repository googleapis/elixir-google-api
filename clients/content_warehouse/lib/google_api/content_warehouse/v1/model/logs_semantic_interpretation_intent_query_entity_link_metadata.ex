...
defmodule GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryEntityLinkMetadata do
  @moduledoc """
  ...
  *   `kindInfo` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryLinkKindInfo.t)`, *default:* `nil`) - 
  ...
  field(:aggregateFlags,
    as: GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryLinkKindFlags
  )

  field(:kindInfo,
    as: GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryLinkKindInfo,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryEntityLinkMetadata do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.LogsSemanticInterpretationIntentQueryEntityLinkMetadata.decode(
      value,
      options
    )
  end
