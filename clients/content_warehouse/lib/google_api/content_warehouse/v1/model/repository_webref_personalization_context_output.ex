...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutput do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutput do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutput.decode(
      value,
      options
    )
  end
