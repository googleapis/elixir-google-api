...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialGraphWireProtoPeopleapiExtensionPeopleStackPersonExtendedData do
  @moduledoc """
  NEXT_ID: 6
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphWireProtoPeopleapiExtensionPeopleStackPersonExtendedData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphWireProtoPeopleapiExtensionPeopleStackPersonExtendedData.decode(
      value,
      options
    )
  end
