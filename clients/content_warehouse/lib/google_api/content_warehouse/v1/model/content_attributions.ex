...
defmodule GoogleApi.ContentWarehouse.V1.Model.ContentAttributions do
  @moduledoc """
  ...
  *   `onlineOutgoing` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution.t)`, *default:* `nil`) - Selected outgoing attributions extracted online on Alexandria.
  ...
  @type t :: %__MODULE__{
          :freshdocsOutgoing =>
            list(GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution.t())
            | nil,
          :offlineOutgoing =>
            list(GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution.t())
            | nil,
  ...
  field(:freshdocsOutgoing,
    as: GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution,
    type: :list
  )

  field(:offlineOutgoing,
    as: GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution,
    type: :list
  )

  field(:onlineOutgoing,
    as: GoogleApi.ContentWarehouse.V1.Model.ContentAttributionsOutgoingAttribution,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.ContentAttributions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ContentAttributions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.ContentAttributions do
