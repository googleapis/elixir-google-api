...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryLanguageIdentificationResult do
  @moduledoc """
  ...
  *   `ytCapsAudioLanguage` (*type:* `String.t`, *default:* `nil`) - From cs/symbol:video_platform.operation.AudioLanguage owned gy go/ytcaps.
  ...
  field(:localeStripped)
  field(:s3TopLocale)
  field(:ytCapsAudioLanguage)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryLanguageIdentificationResult do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryLanguageIdentificationResult.decode(
      value,
      options
    )
  end
