...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaWorkingElsewhereContext do
  @moduledoc """
  ...
  *   `location` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaUserLocation.t`, *default:* `nil`) - The new location of the user. Might represent home, office, or a custom address on the map.
  ...
  field(:location,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaUserLocation
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaWorkingElsewhereContext do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaWorkingElsewhereContext.decode(
      value,
      options
    )
  end
