...
defmodule GoogleApi.ContentWarehouse.V1.Model.BiasingPerDocData2BiasingField do
  @moduledoc """
  ...
  *   `valueInt` (*type:* `integer()`, *default:* `nil`) - value as an int32. When the value is encode-able as an integer.
  ...
  field(:compressedName)
  field(:value)
  field(:valueFloat)
  field(:valueInt)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.BiasingPerDocData2BiasingField do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.BiasingPerDocData2BiasingField.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.BiasingPerDocData2BiasingField do
