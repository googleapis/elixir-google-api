...
defmodule GoogleApi.ContentWarehouse.V1.Model.SnippetExtraInfoSnippetsBrainModelInfo do
  @moduledoc """
  ...
  *   `snippetsbrainTokenizerType` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:ng3ModelName)
  field(:snippetsbrainModelName)
  field(:snippetsbrainModelPartition)
  field(:snippetsbrainTokenizerType)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SnippetExtraInfoSnippetsBrainModelInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SnippetExtraInfoSnippetsBrainModelInfo.decode(
      value,
      options
    )
  end
