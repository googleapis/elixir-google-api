...
defmodule GoogleApi.ContentWarehouse.V1.Model.SdrPageAnchorsSitelinkWrapper do
  @moduledoc """
  ...
  *   `passageText` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:abbreviatedHeadingText)
  field(:abbrvEmbedding, as: GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding)
  field(:headingEmbedding, as: GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding)
  field(:normalizedHeadingText)
  field(:passageEmbedding, as: GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding)
  field(:passageText)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrPageAnchorsSitelinkWrapper do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SdrPageAnchorsSitelinkWrapper.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrPageAnchorsSitelinkWrapper do
