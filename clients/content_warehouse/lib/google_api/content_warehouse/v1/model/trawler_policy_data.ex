...
defmodule GoogleApi.ContentWarehouse.V1.Model.TrawlerPolicyData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.TrawlerPolicyData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.TrawlerPolicyData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.TrawlerPolicyData do
