...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalJoiner do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:numBytes)
  field(:numBytesForConversion)
  field(:startByte)
  field(:startByteForConversion)
  field(:text)
  field(:type)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalJoiner do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalJoiner.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalJoiner do
