...
defmodule GoogleApi.ContentWarehouse.V1.Model.OceanLocaleViewabilitySourceDetails do
  @moduledoc """
  ...
  *   `imprint` (*type:* `GoogleApi.ContentWarehouse.V1.Model.OceanVolumeImprint.t`, *default:* `nil`) - 
  ...
  field(:imprint, as: GoogleApi.ContentWarehouse.V1.Model.OceanVolumeImprint)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.OceanLocaleViewabilitySourceDetails do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.OceanLocaleViewabilitySourceDetails.decode(value, options)
  end
end
