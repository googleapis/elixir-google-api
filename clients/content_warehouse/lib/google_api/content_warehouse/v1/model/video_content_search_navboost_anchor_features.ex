...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchNavboostAnchorFeatures do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchNavboostAnchorFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchNavboostAnchorFeatures.decode(
      value,
      options
    )
  end
