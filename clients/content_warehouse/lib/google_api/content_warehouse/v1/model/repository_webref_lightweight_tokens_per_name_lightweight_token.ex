...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLightweightTokensPerNameLightweightToken do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLightweightTokensPerNameLightweightToken do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLightweightTokensPerNameLightweightToken.decode(
      value,
      options
    )
  end
