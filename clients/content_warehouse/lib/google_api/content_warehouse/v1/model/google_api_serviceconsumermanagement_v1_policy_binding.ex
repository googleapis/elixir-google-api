...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleApiServiceconsumermanagementV1PolicyBinding do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleApiServiceconsumermanagementV1PolicyBinding do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleApiServiceconsumermanagementV1PolicyBinding.decode(
      value,
      options
    )
  end
