...
defmodule GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoFrameResizeEvent do
  @moduledoc """
  ...
  *   `visibleRectBeforeResize` (*type:* `GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoBox.t`, *default:* `nil`) - 
  ...
  field(:visibleRectAfterResize,
    as: GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoBox
  )

  field(:visibleRectBeforeResize,
    as: GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoBox
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoFrameResizeEvent do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoFrameResizeEvent.decode(
      value,
      options
    )
  end
