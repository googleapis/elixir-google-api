...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteQRewriteAccountAwareCalendarAliasWrapper do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteQRewriteAccountAwareCalendarAliasWrapper do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteQRewriteAccountAwareCalendarAliasWrapper.decode(
      value,
      options
    )
  end
