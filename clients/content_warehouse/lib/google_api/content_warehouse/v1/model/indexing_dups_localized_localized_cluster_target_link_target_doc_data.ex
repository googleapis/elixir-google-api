...
defmodule GoogleApi.ContentWarehouse.V1.Model.IndexingDupsLocalizedLocalizedClusterTargetLinkTargetDocData do
  @moduledoc """
  ...
  *   `outgoingLinkData` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.IndexingDupsLocalizedLocalizedClusterTargetLinkLink.t)`, *default:* `nil`) - Repeated field for data about the outgoing hreflang links that appear in the document that the currently processed URL refers to.
  ...
  field(:crawlStatus)
  field(:crawlTimestampSeconds)
  field(:isCanonical)

  field(:outgoingLinkData,
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.IndexingDupsLocalizedLocalizedClusterTargetLinkTargetDocData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.IndexingDupsLocalizedLocalizedClusterTargetLinkTargetDocData.decode(
      value,
      options
    )
  end
