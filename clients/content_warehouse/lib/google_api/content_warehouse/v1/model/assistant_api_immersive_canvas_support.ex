...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiImmersiveCanvasSupport do
  @moduledoc """
  ...
  *   `pauseSignalSupported` (*type:* `boolean()`, *default:* `nil`) - Whether the client support canvas pause signal. If true, the Assistant Server will send a signal when canvas transitioning to pause mode.
  ...
  field(:confirmationMessageSupported)
  field(:pauseSignalSupported)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiImmersiveCanvasSupport do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiImmersiveCanvasSupport.decode(value, options)
  end
end
