...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersPlexityRequirement do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersPlexityRequirement do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersPlexityRequirement.decode(value, options)
  end
end
