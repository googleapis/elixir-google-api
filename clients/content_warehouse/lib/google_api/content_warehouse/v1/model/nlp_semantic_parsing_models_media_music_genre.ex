...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaMusicGenre do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaMusicGenre do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaMusicGenre.decode(
      value,
      options
    )
  end
