...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsCommonFeatureSet do
  @moduledoc """
  ...
  *   `mumUsefulnessStats` (*type:* `GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats.t`, *default:* `nil`) - A summary of the MUM usefulness scores of the anchors in the set.
  ...
  field(:dolphinDescriptivenessStats,
    as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats
  )

  field(:dolphinUsefulnessStats,
    as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats
  )

  field(:mumDescriptivenessStats,
    as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats
  )

  field(:mumUsefulnessStats, as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsCommonFeatureSet do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsCommonFeatureSet.decode(
      value,
      options
    )
  end
