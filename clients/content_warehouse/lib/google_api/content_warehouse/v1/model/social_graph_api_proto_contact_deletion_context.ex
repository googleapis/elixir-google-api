...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoContactDeletionContext do
  @moduledoc """
  ...
  *   `mutationContext` (*type:* `GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoContactMutationContext.t`, *default:* `nil`) - The general mutation context data
  ...
  field(:mutationContext,
    as: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoContactMutationContext
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoContactDeletionContext do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoContactDeletionContext.decode(
      value,
      options
    )
  end
