...
defmodule GoogleApi.ContentWarehouse.V1.Model.IndexingDocjoinerAnchorPhraseSpamInfo do
  @moduledoc """
  ...
  *   `phraseAnchorSpamStart` (*type:* `integer()`, *default:* `nil`) - Time when anchor spam spike started with padding.
  ...
  field(:phraseAnchorSpamCount)
  field(:phraseAnchorSpamDays)
  field(:phraseAnchorSpamDemoted)
  field(:phraseAnchorSpamEnd)
  field(:phraseAnchorSpamFraq)
  field(:phraseAnchorSpamPenalty)
  field(:phraseAnchorSpamProcessed)
  field(:phraseAnchorSpamRate)
  field(:phraseAnchorSpamStart)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.IndexingDocjoinerAnchorPhraseSpamInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.IndexingDocjoinerAnchorPhraseSpamInfo.decode(
      value,
      options
    )
  end
