...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAmarnaSignalsBlobInfo do
  @moduledoc """
  ...
  *   `signalsBlobUpdateTimestamp` (*type:* `DateTime.t`, *default:* `nil`) - Additional timestamp field for when the blob is written/updated, serving as the dirty field to help checksum-based update push (see `Dirty field` section in go/revisit-frame-level-signals-amarna).
  ...
  field(:signalsBlobId)
  field(:signalsBlobUpdateTimestamp, as: DateTime)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAmarnaSignalsBlobInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAmarnaSignalsBlobInfo.decode(
      value,
      options
    )
  end
