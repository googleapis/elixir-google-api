...
defmodule GoogleApi.ContentWarehouse.V1.Model.AppsPeopleOzExternalMergedpeopleapiNamePronunciationAudioMetadataInfo do
  @moduledoc """
  ...
  *   `namePronunciationAudioMetadata` (*type:* `GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoNamePronunciationAudioMetadata.t`, *default:* `nil`) - Actual metadata proto, shared with FBS backends.
  ...
  field(:namePronunciationAudioMetadata,
    as: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoNamePronunciationAudioMetadata
  )
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AppsPeopleOzExternalMergedpeopleapiNamePronunciationAudioMetadataInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AppsPeopleOzExternalMergedpeopleapiNamePronunciationAudioMetadataInfo.decode(
      value,
      options
    )
  end
