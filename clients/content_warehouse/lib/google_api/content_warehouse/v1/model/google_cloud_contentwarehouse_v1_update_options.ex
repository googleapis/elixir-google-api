...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1UpdateOptions do
  @moduledoc """
  ...
  *   `updateType` (*type:* `String.t`, *default:* `nil`) - Type for update.
  ...
  field(:mergeFieldsOptions,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1MergeFieldsOptions
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1UpdateOptions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1UpdateOptions.decode(
      value,
      options
    )
  end
