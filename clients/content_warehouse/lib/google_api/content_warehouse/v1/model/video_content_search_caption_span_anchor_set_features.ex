...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCaptionSpanAnchorSetFeatures do
  @moduledoc """
  ...
  *   `anchorSetDolphinScoreStats` (*type:* `GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats.t`, *default:* `nil`) - A summary of the dolphin scores over the anchor set.
  ...
  field(:anchorSetDolphinScoreStats,
    as: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchMetricStats
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCaptionSpanAnchorSetFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchCaptionSpanAnchorSetFeatures.decode(
      value,
      options
    )
  end
