...
defmodule GoogleApi.ContentWarehouse.V1.Model.ClassifierPornQueryStats do
  @moduledoc """
  ...
  *   `totalClicks` (*type:* `number()`, *default:* `nil`) - 
  ...
  field(:queryTextPornScore)
  field(:totalClicks)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.ClassifierPornQueryStats do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ClassifierPornQueryStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.ClassifierPornQueryStats do
