...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1CreateDocumentLinkRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1CreateDocumentLinkRequest do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1CreateDocumentLinkRequest.decode(
      value,
      options
    )
  end
