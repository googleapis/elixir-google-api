...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilitiesAndroidIntentCapability do
  @moduledoc """
  ...
  *   `packageNames` (*type:* `list(String.t)`, *default:* `nil`) - The Android provider packages that support the intent, e.g. "com.google.android.deskclock".
  ...
  field(:intentActionName)
  field(:packageNames, type: :list)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilitiesAndroidIntentCapability do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilitiesAndroidIntentCapability.decode(
      value,
      options
    )
  end
