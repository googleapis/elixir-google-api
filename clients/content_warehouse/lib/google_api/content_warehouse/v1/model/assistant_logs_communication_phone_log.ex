...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantLogsCommunicationPhoneLog do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsCommunicationPhoneLog do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantLogsCommunicationPhoneLog.decode(value, options)
  end
end
