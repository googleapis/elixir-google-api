...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataGenMlAlarmMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataGenMlAlarmMetadata do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataGenMlAlarmMetadata.decode(
      value,
      options
    )
  end
