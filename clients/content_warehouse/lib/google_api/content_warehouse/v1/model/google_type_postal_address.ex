...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleTypePostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypePostalAddress do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleTypePostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypePostalAddress do
