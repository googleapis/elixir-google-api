...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaPodcast do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaPodcast do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaPodcast.decode(
      value,
      options
    )
  end
