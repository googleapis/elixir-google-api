...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersSensitivityMyActivityPolicy do
  @moduledoc """
  ...
  *   `myActivityRedactionKey` (*type:* `String.t`, *default:* `nil`) - This field will be translated by footprints and is used to describe the content that was redacted that will be displayed to the user in MyActivity.
  ...
  field(:myActivityRedactedAction)
  field(:myActivityRedactionKey)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersSensitivityMyActivityPolicy do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersSensitivityMyActivityPolicy.decode(
      value,
      options
    )
  end
