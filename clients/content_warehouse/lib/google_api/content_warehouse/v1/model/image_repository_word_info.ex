...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryWordInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryWordInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryWordInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryWordInfo do
