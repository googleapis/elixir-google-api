...
defmodule GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedDenseFeatureData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedDenseFeatureData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedDenseFeatureData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedDenseFeatureData do
