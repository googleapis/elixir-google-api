...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCrossDeviceExecutionCapability do
  @moduledoc """
  ...
  *   `remoteCastMediaEnabled` (*type:* `boolean()`, *default:* `nil`) - Whether the device supports cast media originated from a remote device to be executed through local execution and can upload results asynchronously. Needs to be checked before sending remote media initiation through local channel since it needs an async result upload path.
  ...
  field(:localConnectivityEnabled)
  field(:remoteCastMediaEnabled)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCrossDeviceExecutionCapability do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCrossDeviceExecutionCapability.decode(
      value,
      options
    )
  end
