...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifier do
  @moduledoc """
  ...
  *   `timestampMs` (*type:* `integer()`, *default:* `nil`) - Offset of the frame from the beginning of the video (in milliseconds).
  ...
  field(:multiThumbnailVariant,
    as: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifierMultiThumbnailVariant
  )

  field(:previewFrameZeroVariant,
    as: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifierPreviewFrameZeroVariant
  )

  field(:thumbnailVariant,
    as: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifierThumbnailVariant
  )

  field(:timestampMs)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifier do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifier.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryFrameIdentifier do
