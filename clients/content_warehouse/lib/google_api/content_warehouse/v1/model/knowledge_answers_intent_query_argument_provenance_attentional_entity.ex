...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQueryArgumentProvenanceAttentionalEntity do
  @moduledoc """
  ...
  *   `mentionProperties` (*type:* `GoogleApi.ContentWarehouse.V1.Model.AttentionalEntitiesMentionProperties.t`, *default:* `nil`) - Source information from the AttentionalEntityReader.
  ...
  @type t :: %__MODULE__{
          ...
          :mentionProperties =>
            GoogleApi.ContentWarehouse.V1.Model.AttentionalEntitiesMentionProperties.t() | nil
        }

  field(:attentionalEntityKey)

  field(:mentionProperties,
    as: GoogleApi.ContentWarehouse.V1.Model.AttentionalEntitiesMentionProperties
  )
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQueryArgumentProvenanceAttentionalEntity do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQueryArgumentProvenanceAttentionalEntity.decode(
      value,
      options
    )
  end
