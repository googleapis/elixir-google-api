...
defmodule GoogleApi.ContentWarehouse.V1.Model.TravelFlightsAirlineConfigLocalizedContactInfo do
  @moduledoc """
  ...
  *   `language` (*type:* `String.t`, *default:* `nil`) - IETF BCP-47, e.g. "en" or "zh-HK-Hant"
  ...
  field(:contactInfo,
    as: GoogleApi.ContentWarehouse.V1.Model.TravelFlightsAirlineConfigContactInfo,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.TravelFlightsAirlineConfigLocalizedContactInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.TravelFlightsAirlineConfigLocalizedContactInfo.decode(
      value,
      options
    )
  end
