...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesLocationCoordinates do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesLocationCoordinates do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesLocationCoordinates.decode(
      value,
      options
    )
  end
