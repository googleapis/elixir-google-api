...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaYouTubePlaylistInfo do
  @moduledoc """
  ...
  *   `videoCount` (*type:* `integer()`, *default:* `nil`) - Total number of videos present in the retrieved playlist.
  ...
  field(:numVidsPlayableInWoodstock)
  field(:videoCount)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaYouTubePlaylistInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaYouTubePlaylistInfo.decode(
      value,
      options
    )
  end
