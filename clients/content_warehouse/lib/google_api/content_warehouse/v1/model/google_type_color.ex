...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleTypeColor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeColor do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleTypeColor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeColor do
