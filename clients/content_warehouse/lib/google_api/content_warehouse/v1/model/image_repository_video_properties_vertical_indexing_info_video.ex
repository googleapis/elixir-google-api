...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryVideoPropertiesVerticalIndexingInfoVideo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryVideoPropertiesVerticalIndexingInfoVideo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryVideoPropertiesVerticalIndexingInfoVideo.decode(
      value,
      options
    )
  end
