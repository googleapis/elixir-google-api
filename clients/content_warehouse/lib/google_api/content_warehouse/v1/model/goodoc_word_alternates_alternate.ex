...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoodocWordAlternatesAlternate do
  @moduledoc """
  ...
  *   `Word` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GoodocWord.t`, *default:* `nil`) - In order to compile, this recursive message needs to be optional, even though it's within an optional group.
  ...
  field(:Word, as: GoogleApi.ContentWarehouse.V1.Model.GoodocWord)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoodocWordAlternatesAlternate do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoodocWordAlternatesAlternate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoodocWordAlternatesAlternate do
