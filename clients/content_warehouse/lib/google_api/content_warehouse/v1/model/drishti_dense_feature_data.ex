...
defmodule GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseFeatureData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseFeatureData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseFeatureData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseFeatureData do
