...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilities do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilities do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiAndroidIntentCapabilities.decode(
      value,
      options
    )
  end
