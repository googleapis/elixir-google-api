...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoPartialNameOptionsTwoPartNameSpec do
  @moduledoc """
  ...
  *   `givenNameSpec` (*type:* `GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoPartialNameOptionsNamePartSpec.t`, *default:* `nil`) - 
  ...
  field(:familyNameSpec,
    as: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoPartialNameOptionsNamePartSpec
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoPartialNameOptionsTwoPartNameSpec do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoPartialNameOptionsTwoPartNameSpec.decode(
      value,
      options
    )
  end
