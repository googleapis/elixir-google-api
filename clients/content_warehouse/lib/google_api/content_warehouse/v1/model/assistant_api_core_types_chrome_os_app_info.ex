...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesChromeOsAppInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesChromeOsAppInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesChromeOsAppInfo.decode(
      value,
      options
    )
  end
