...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataMediaProviderSourceData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataMediaProviderSourceData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataMediaProviderSourceData.decode(
      value,
      options
    )
  end
