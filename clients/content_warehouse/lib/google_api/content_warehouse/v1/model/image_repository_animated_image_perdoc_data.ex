...
defmodule GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAnimatedImagePerdocData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAnimatedImagePerdocData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ImageRepositoryAnimatedImagePerdocData.decode(
      value,
      options
    )
  end
