...
defmodule GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceInfraSpannerConfigCreateDatabaseOptions do
  @moduledoc """
  ...
  *   `cmekServiceName` (*type:* `String.t`, *default:* `nil`) - The service name for the CMEK encryption. For example, contentwarehouse.googleapis.com
  ...
  field(:cmekCloudResourceName)
  field(:cmekCloudResourceType)
  field(:cmekServiceName)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceInfraSpannerConfigCreateDatabaseOptions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceInfraSpannerConfigCreateDatabaseOptions.decode(
      value,
      options
    )
  end
