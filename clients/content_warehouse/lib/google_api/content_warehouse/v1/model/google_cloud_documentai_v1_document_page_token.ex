...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken do
  @moduledoc """
  A detected token.
  ...
  *   `styleInfo` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo.t`, *default:* `nil`) - Text style attributes.
  ...
  field(:detectedBreak,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak
  )
  ...
  field(:styleInfo,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageTokenStyleInfo
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentPageToken.decode(
      value,
      options
    )
  end
