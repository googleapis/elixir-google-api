...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedPageType do
  @moduledoc """
  ...
  *   `isQnaPage` (*type:* `boolean()`, *default:* `nil`) - Set to true if this page is classified as a question answers page.
  ...
  field(:isForumPage)
  field(:isPageWithFreshRepeatedDates)
  field(:isQnaPage)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedPageType do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedPageType.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedPageType do
