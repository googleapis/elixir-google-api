...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentChunkedDocumentChunk do
  @moduledoc """
  Represents a chunk.
  ...
  *   `sourceBlockIds` (*type:* `list(String.t)`, *default:* `nil`) - Unused.
  ...
  field(:pageHeaders,
    as:
      GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageHeader,
    type: :list
  )

  field(:pageSpan,
    as:
      GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageSpan
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentChunkedDocumentChunk do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentChunkedDocumentChunk.decode(
      value,
      options
    )
  end
