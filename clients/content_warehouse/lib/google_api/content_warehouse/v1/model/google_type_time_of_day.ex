...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleTypeTimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeTimeOfDay do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleTypeTimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeTimeOfDay do
