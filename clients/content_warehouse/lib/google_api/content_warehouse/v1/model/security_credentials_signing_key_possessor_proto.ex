...
defmodule GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSigningKeyPossessorProto do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSigningKeyPossessorProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSigningKeyPossessorProto.decode(
      value,
      options
    )
  end
