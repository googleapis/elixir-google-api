...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoVideoStreamInfoMetadataLutAttachmentsLut3D do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoVideoStreamInfoMetadataLutAttachmentsLut3D do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoVideoStreamInfoMetadataLutAttachmentsLut3D.decode(
      value,
      options
    )
  end
