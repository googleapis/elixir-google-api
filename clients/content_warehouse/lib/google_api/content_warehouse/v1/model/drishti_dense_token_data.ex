...
defmodule GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseTokenData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseTokenData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseTokenData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiDenseTokenData do
