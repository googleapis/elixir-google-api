...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiProtobuf do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiProtobuf do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiProtobuf.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiProtobuf do
