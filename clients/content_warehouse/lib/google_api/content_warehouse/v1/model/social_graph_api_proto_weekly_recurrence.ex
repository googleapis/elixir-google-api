...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoWeeklyRecurrence do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoWeeklyRecurrence do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoWeeklyRecurrence.decode(value, options)
  end
end
