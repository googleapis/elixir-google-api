...
defmodule GoogleApi.ContentWarehouse.V1.Model.KeGovernanceTypedRegions do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.KeGovernanceTypedRegions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KeGovernanceTypedRegions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.KeGovernanceTypedRegions do
