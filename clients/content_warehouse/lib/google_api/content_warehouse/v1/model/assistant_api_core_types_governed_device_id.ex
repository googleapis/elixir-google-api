...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceId do
  @moduledoc """
  ...
  *   `quartzDeviceId` (*type:* `String.t`, *default:* `nil`) - The unique ID of a Quartz device. See go/quartz-design-doc for more details. Quartz ID is a hash of (android_id + gaia).
  ...
  @type t :: %__MODULE__{
          ...
          :deviceConfig =>
            GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceConfig.t()
            | nil,
  ...
  field(:deviceConfig,
    as: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceConfig
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceId do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceId.decode(
      value,
      options
    )
  end
