...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsReauthTrustedDeviceSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsReauthTrustedDeviceSettings do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsReauthTrustedDeviceSettings.decode(
      value,
      options
    )
  end
