...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaQuantification do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaQuantification do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaQuantification.decode(
      value,
      options
    )
  end
