...
defmodule GoogleApi.ContentWarehouse.V1.Model.BlogPerDocDataOutlinks do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.BlogPerDocDataOutlinks do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.BlogPerDocDataOutlinks.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.BlogPerDocDataOutlinks do
