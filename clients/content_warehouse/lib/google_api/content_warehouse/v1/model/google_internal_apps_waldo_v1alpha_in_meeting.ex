...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaInMeeting do
  @moduledoc """
  ...
  *   `occupiedUntil` (*type:* `DateTime.t`, *default:* `nil`) - The time when the user will stop being occupied, i.e., when their status will be neither InMeeting, Busy nor DoNotDisturb.
  ...
  field(:eventSummary)
  field(:inMeetingsUntil, as: DateTime)
  field(:nextAvailable, as: DateTime)
  field(:occupiedUntil, as: DateTime)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaInMeeting do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleInternalAppsWaldoV1alphaInMeeting.decode(
      value,
      options
    )
  end
