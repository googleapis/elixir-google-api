...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceConfig do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedDeviceConfig.decode(
      value,
      options
    )
  end
