...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCastAssistantSettingLinkingResult do
  @moduledoc """
  ...
  *   `truncatedErrorMsg` (*type:* `String.t`, *default:* `nil`) - The error msg returned from COS, truncated in case it's too large.
  ...
  field(:castLinkingStatus)
  field(:truncatedErrorMsg)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCastAssistantSettingLinkingResult do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCastAssistantSettingLinkingResult.decode(
      value,
      options
    )
  end
