...
defmodule GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStyleAestheticsScoreSignals do
  @moduledoc """
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:discretizedAestheticsScore)
  field(:version)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStyleAestheticsScoreSignals do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStyleAestheticsScoreSignals.decode(
      value,
      options
    )
  end
