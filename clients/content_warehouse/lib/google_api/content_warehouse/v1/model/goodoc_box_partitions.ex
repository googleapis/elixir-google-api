...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoodocBoxPartitions do
  @moduledoc """
  ...
  *   `span` (*type:* `list(integer())`, *default:* `nil`) - "span" is width or height, determined by "direction". If there are k partitions, then there are k - 1 "span" values, one for each except the last symbol (which is redundant).
  ...
  @type t :: %__MODULE__{
          ...
          :span => list(integer()) | nil
        }

  field(:direction)
  field(:span, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoodocBoxPartitions do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoodocBoxPartitions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoodocBoxPartitions do
