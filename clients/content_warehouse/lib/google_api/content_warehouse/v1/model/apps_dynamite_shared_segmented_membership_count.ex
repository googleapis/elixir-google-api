...
defmodule GoogleApi.ContentWarehouse.V1.Model.AppsDynamiteSharedSegmentedMembershipCount do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AppsDynamiteSharedSegmentedMembershipCount do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AppsDynamiteSharedSegmentedMembershipCount.decode(
      value,
      options
    )
  end
