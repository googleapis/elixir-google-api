...
defmodule GoogleApi.ContentWarehouse.V1.Model.FatcatCompactTaxonomicClassification do
  @moduledoc """
  ...
  *   `taxonomyName` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:category,
    as: GoogleApi.ContentWarehouse.V1.Model.FatcatCompactTaxonomicClassificationCategory,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.FatcatCompactTaxonomicClassification do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.FatcatCompactTaxonomicClassification.decode(
      value,
      options
    )
  end
