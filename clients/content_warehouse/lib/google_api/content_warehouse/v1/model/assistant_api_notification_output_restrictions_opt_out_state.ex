...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiNotificationOutputRestrictionsOptOutState do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiNotificationOutputRestrictionsOptOutState do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiNotificationOutputRestrictionsOptOutState.decode(
      value,
      options
    )
  end
