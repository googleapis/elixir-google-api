...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp do
