...
defmodule GoogleApi.ContentWarehouse.V1.Model.EmbedsPackagingServiceClient do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.EmbedsPackagingServiceClient do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.EmbedsPackagingServiceClient.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.EmbedsPackagingServiceClient do
