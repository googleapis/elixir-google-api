...
defmodule GoogleApi.ContentWarehouse.V1.Model.OceanDocTagContributor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.OceanDocTagContributor do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.OceanDocTagContributor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.OceanDocTagContributor do
