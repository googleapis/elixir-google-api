...
defmodule GoogleApi.ContentWarehouse.V1.Model.TrawlerOriginalClientParams do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.TrawlerOriginalClientParams do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.TrawlerOriginalClientParams.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.TrawlerOriginalClientParams do
