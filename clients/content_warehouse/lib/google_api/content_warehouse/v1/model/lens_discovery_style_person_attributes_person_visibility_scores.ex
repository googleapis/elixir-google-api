...
defmodule GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStylePersonAttributesPersonVisibilityScores do
  @moduledoc """
  ...
  *   `personVisibilityPredictions` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStylePersonAttributesPersonVisibilityScoresPersonVisibilityPrediction.t)`, *default:* `nil`) - Repeated for # of PersonVisibility types.
  ...
  field(:discretizedPersonVisibilityScore)

  field(:personVisibilityPredictions,
    as:
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStylePersonAttributesPersonVisibilityScores do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.LensDiscoveryStylePersonAttributesPersonVisibilityScores.decode(
      value,
      options
    )
  end
