...
defmodule GoogleApi.ContentWarehouse.V1.Model.SdrScrollToOnPageMatches do
  @moduledoc """
  ...
  *   `textWithSuffix` (*type:* `integer()`, *default:* `nil`) - 
  ...
  field(:text)
  field(:textWithPrefix)
  field(:textWithPrefixSuffix)
  field(:textWithSuffix)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrScrollToOnPageMatches do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SdrScrollToOnPageMatches.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrScrollToOnPageMatches do
