...
defmodule GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsOAuthConsumerProto do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsOAuthConsumerProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsOAuthConsumerProto.decode(
      value,
      options
    )
  end
