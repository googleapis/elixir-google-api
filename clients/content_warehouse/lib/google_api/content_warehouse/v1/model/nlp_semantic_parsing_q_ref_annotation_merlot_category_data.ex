...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingQRefAnnotationMerlotCategoryData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingQRefAnnotationMerlotCategoryData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingQRefAnnotationMerlotCategoryData.decode(
      value,
      options
    )
  end
