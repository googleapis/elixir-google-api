...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersTrackingNumberType do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersTrackingNumberType do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersTrackingNumberType.decode(value, options)
  end
end
