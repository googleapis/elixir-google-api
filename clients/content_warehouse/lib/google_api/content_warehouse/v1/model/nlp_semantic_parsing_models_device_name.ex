...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsDeviceName do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsDeviceName do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsDeviceName.decode(value, options)
  end
end
