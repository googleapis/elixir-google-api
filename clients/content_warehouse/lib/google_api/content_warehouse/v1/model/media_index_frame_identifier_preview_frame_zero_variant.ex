...
defmodule GoogleApi.ContentWarehouse.V1.Model.MediaIndexFrameIdentifierPreviewFrameZeroVariant do
  @moduledoc """
  ...
  *   `xtagList` (*type:* `GoogleApi.ContentWarehouse.V1.Model.MediaIndexXtagList.t`, *default:* `nil`) - All xtags used in the generation of the preview. The same frame generated from the same preview with different xtags will likely have different bytes (such as, for example, resulting from a different aspect ratio).
  ...
  field(:previewLength)
  field(:xtagList, as: GoogleApi.ContentWarehouse.V1.Model.MediaIndexXtagList)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.MediaIndexFrameIdentifierPreviewFrameZeroVariant do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.MediaIndexFrameIdentifierPreviewFrameZeroVariant.decode(
      value,
      options
    )
  end
