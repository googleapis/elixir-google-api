...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteContactCalendarName do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteContactCalendarName do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteContactCalendarName.decode(value, options)
  end
end
