...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataAllowListSourceData do
  @moduledoc """
  ...
  *   `unknownAppDeviceCompatibility` (*type:* `boolean()`, *default:* `nil`) - Whether app compatibility is unknown. This field is needed for apps like apple tv that have different package names on different devices. Play Gateway Service (PGS) lookup is needed to validate that the app is available on the user's device. go/app-fulfillment-quality
  ...
  field(:preReleaseMode)
  field(:unknownAppDeviceCompatibility)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataAllowListSourceData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityActionsAppInfoSourceDataAllowListSourceData.decode(
      value,
      options
    )
  end
