...
defmodule GoogleApi.ContentWarehouse.V1.Model.SmartphonePerDocData do
  ...
  *   `adsDensityInterstitialViolationStrength` (*type:* `integer()`, *default:* `nil`) - Indicates if the page is violating mobile ads density interstitial policy and the violation strength. See go/interstitials-for-ads and http://ariane/268642 for details. To save indexing space, we convert the double values in [0.0, 1.0] to integers in range [0, 1000] by using floor(value * 1000).
