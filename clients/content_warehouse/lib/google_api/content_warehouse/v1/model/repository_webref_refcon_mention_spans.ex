...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefRefconMentionSpans do
  @moduledoc """
  ...
  *   `token` (*type:* `list(String.t)`, *default:* `nil`) - Fingerprinted tokens which form the mention span.
  ...
  @type t :: %__MODULE__{
          :segment => list(String.t()) | nil,
          :shortToken => list(integer()) | nil,
          :token => list(String.t()) | nil
        }

  field(:segment, type: :list)
  field(:shortToken, type: :list)
  field(:token, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefRefconMentionSpans do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefRefconMentionSpans.decode(value, options)
  end
end
