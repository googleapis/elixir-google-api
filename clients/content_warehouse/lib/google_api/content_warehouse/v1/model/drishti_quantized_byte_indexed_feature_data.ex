...
defmodule GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedByteIndexedFeatureData do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedByteIndexedFeatureData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.DrishtiQuantizedByteIndexedFeatureData.decode(
      value,
      options
    )
  end
