...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalMenuItem do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalMenuItem do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalMenuItem.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingLocalMenuItem do
