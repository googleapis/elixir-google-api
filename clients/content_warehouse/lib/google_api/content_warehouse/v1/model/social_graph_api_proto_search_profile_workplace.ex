...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoSearchProfileWorkplace do
  @moduledoc """
  ...
  *   `startTime` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GoogleTypeDate.t`, *default:* `nil`) - 
  ...
  field(:company, as: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoSearchProfileEntity)
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoSearchProfileWorkplace do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialGraphApiProtoSearchProfileWorkplace.decode(
      value,
      options
    )
  end
