...
defmodule GoogleApi.ContentWarehouse.V1.Model.IndexingMobileInterstitialsProtoInterstitialBasicInfo do
  @moduledoc """
  ...
  *   `layoutType` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:absoluteBox, as: GoogleApi.ContentWarehouse.V1.Model.HtmlrenderWebkitHeadlessProtoBox)
  field(:contentType)
  field(:detectionMode)
  field(:layoutType)
end
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.IndexingMobileInterstitialsProtoInterstitialBasicInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.IndexingMobileInterstitialsProtoInterstitialBasicInfo.decode(
      value,
      options
    )
  end
