...
defmodule GoogleApi.ContentWarehouse.V1.Model.WatchpageLanguageWatchPageLanguageResult do
  @moduledoc """
  Next ID: 3
  ...
  *   `watchpageLanguage` (*type:* `String.t`, *default:* `nil`) - The language predicted by the V1 WatchPage Language model. For new and experimental versions use versioned_language_result.
  ...
  field(:predictions,
    as: GoogleApi.ContentWarehouse.V1.Model.WatchpageLanguageWatchPageLanguageModelPredictions,
    type: :list
  )

  field(:watchpageLanguage)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.WatchpageLanguageWatchPageLanguageResult do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.WatchpageLanguageWatchPageLanguageResult.decode(
      value,
      options
    )
  end
