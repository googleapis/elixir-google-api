...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1QAResult do
  @moduledoc """
  ...
  *   `highlights` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1QAResultHighlight.t)`, *default:* `nil`) - Highlighted sections in the snippet.
  ...
  field(:highlights,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1QAResultHighlight,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1QAResult do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1QAResult.decode(
      value,
      options
    )
  end
