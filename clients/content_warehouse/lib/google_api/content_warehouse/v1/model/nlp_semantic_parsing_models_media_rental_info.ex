...
defmodule GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaRentalInfo do
  @moduledoc """
  ...
  *   `validUntilTimestampSec` (*type:* `String.t`, *default:* `nil`) - Time until which ownership is granted
  ...
  field(:activatePeriodSec)
  field(:grantPeriodSec)
  field(:purchaseTimestampSec)
  field(:validUntilTimestampSec)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaRentalInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.NlpSemanticParsingModelsMediaRentalInfo.decode(
      value,
      options
    )
  end
