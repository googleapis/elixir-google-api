...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval do
