...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySaftSignals do
  @moduledoc """
  ...
  *   `number` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:entityType)
  field(:isHeadOfIntent)
  field(:isVerb)
  field(:number)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySaftSignals do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySaftSignals.decode(
      value,
      options
    )
  end
