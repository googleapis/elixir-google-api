...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoFileContentLightLevel do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.VideoFileContentLightLevel do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoFileContentLightLevel.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.VideoFileContentLightLevel do
