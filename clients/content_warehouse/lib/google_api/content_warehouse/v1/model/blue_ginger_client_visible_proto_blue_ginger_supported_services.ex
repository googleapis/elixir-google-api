...
defmodule GoogleApi.ContentWarehouse.V1.Model.BlueGingerClientVisibleProtoBlueGingerSupportedServices do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.BlueGingerClientVisibleProtoBlueGingerSupportedServices do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.BlueGingerClientVisibleProtoBlueGingerSupportedServices.decode(
      value,
      options
    )
  end
