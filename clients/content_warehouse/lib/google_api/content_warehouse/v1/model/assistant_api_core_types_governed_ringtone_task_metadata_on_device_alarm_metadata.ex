...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataOnDeviceAlarmMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataOnDeviceAlarmMetadata do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataOnDeviceAlarmMetadata.decode(
      value,
      options
    )
  end
