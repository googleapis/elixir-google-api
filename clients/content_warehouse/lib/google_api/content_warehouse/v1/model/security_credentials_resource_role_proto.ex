...
defmodule GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsResourceRoleProto do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsResourceRoleProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsResourceRoleProto.decode(
      value,
      options
    )
  end
