...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantRemindersNlgTemplateKey do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantRemindersNlgTemplateKey do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantRemindersNlgTemplateKey.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantRemindersNlgTemplateKey do
