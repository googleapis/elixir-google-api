...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteRelationshipMemoryData do
  @moduledoc """
  ...
  *   `value` (*type:* `String.t`, *default:* `nil`) - The contact name copied from UserAttribute.value.
  ...
  field(:contactPointer, as: GoogleApi.ContentWarehouse.V1.Model.FocusBackendContactPointer)
  field(:value)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteRelationshipMemoryData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityQrewriteRelationshipMemoryData.decode(
      value,
      options
    )
  end
