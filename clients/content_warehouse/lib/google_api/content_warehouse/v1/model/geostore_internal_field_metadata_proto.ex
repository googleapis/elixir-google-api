...
defmodule GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalFieldMetadataProto do
  @moduledoc """
  ...
  *   `sourceSummary` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalSourceSummaryProto.t`, *default:* `nil`) - Information about the source providing the piece of data this metadata is attached to.
  ...
  @type t :: %__MODULE__{
          :isAuto => boolean() | nil,
          :sourceSummary =>
            GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalSourceSummaryProto.t() | nil
        }

  field(:isAuto)

  field(:sourceSummary, as: GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalSourceSummaryProto)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalFieldMetadataProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GeostoreInternalFieldMetadataProto.decode(value, options)
  end
end
