...
defmodule GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.SdrEmbedding do
