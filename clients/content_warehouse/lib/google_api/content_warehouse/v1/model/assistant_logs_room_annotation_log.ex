...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantLogsRoomAnnotationLog do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsRoomAnnotationLog do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantLogsRoomAnnotationLog.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantLogsRoomAnnotationLog do
