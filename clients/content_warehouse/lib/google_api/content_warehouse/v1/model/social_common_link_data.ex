...
defmodule GoogleApi.ContentWarehouse.V1.Model.SocialCommonLinkData do
  @moduledoc """
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - Title is an optional field that provides a short string that describes the link or its destination. User interfaces often use title as a tooltip or for accessibility purposes. However, they are of course free to present this data in any form. This field is plain text.
  ...
  @type t :: %__MODULE__{
          :attachment =>
            GoogleApi.ContentWarehouse.V1.Model.SocialCommonAttachmentAttachment.t() | nil,
  ...
  field(:attachment, as: GoogleApi.ContentWarehouse.V1.Model.SocialCommonAttachmentAttachment)
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.SocialCommonLinkData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SocialCommonLinkData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.SocialCommonLinkData do
