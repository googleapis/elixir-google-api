...
defmodule GoogleApi.ContentWarehouse.V1.Model.MobilePerDocData do
  @moduledoc """
  ...
  *   `transcodedPageScore` (*type:* `integer()`, *default:* `nil`) - DEPRECATED: The transcoded page quality repesented in 7-bits range from 0 to 127.
  ...
  field(:flags)
  field(:mobileurl)
  field(:transcodedPageScore)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.MobilePerDocData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.MobilePerDocData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.MobilePerDocData do
