...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataFuntimeMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataFuntimeMetadata do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesGovernedRingtoneTaskMetadataFuntimeMetadata.decode(
      value,
      options
    )
  end
