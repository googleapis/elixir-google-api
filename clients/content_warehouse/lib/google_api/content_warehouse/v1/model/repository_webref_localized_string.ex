...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLocalizedString do
  @moduledoc """
  ...
  *   `sourceType` (*type:* `String.t`, *default:* `nil`) - Which querybase pipeline the data comes from.
  ...
  @type t :: %__MODULE__{
          :domain => String.t() | nil,
          :fprintModifier =>
            GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefFprintModifierProto.t() | nil,
  ...
  field(:fprintModifier,
    as: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefFprintModifierProto
  )

  field(:language)
  field(:normalizedString)
  field(:originalString)
  field(:region)
  field(:sourceType)
end

defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLocalizedString do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLocalizedString.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefLocalizedString do
