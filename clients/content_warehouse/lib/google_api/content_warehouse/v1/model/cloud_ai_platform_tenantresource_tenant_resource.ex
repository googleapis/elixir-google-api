...
defmodule GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantResource do
  @moduledoc """
  ...
  *   `tenantProjectResources` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantProjectResource.t)`, *default:* `nil`) - A list of tenant projects and tenant resources to provision or deprovision.
  ...
  field(:p4ServiceAccounts,
    as: GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceServiceAccountIdentity,
    type: :list
  )

  field(:tenantProjectResources,
    as: GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantProjectResource,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantResource do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.CloudAiPlatformTenantresourceTenantResource.decode(
      value,
      options
    )
  end
