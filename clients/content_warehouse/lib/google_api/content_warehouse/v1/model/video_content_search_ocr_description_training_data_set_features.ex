...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrDescriptionTrainingDataSetFeatures do
  @moduledoc """
  ...
  *   `medianEditDistance` (*type:* `integer()`, *default:* `nil`) - The median edit distance of any description anchor to its closest OCR text.
  ...
  field(:maxEditDistance)
  field(:maxEditDistanceRatio)
  field(:medianEditDistance)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrDescriptionTrainingDataSetFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchOcrDescriptionTrainingDataSetFeatures.decode(
      value,
      options
    )
  end
