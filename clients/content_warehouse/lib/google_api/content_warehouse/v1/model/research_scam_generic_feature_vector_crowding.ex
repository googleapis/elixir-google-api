...
defmodule GoogleApi.ContentWarehouse.V1.Model.ResearchScamGenericFeatureVectorCrowding do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.ResearchScamGenericFeatureVectorCrowding do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.ResearchScamGenericFeatureVectorCrowding.decode(
      value,
      options
    )
  end
