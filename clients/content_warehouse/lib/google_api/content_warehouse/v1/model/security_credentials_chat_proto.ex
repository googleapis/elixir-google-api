...
defmodule GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsChatProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsChatProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsChatProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsChatProto do
