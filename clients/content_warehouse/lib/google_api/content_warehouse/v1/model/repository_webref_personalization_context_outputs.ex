...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutputs do
  @moduledoc """
  ...
  *   `outputs` (*type:* `list(GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutput.t)`, *default:* `nil`) - Detailed output scores per personalization type.
  ...
  field(:outputs,
    as: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutput,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutputs do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefPersonalizationContextOutputs.decode(
      value,
      options
    )
  end
