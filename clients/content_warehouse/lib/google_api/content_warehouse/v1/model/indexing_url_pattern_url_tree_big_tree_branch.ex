...
defmodule GoogleApi.ContentWarehouse.V1.Model.IndexingUrlPatternUrlTreeBigTreeBranch do
  @moduledoc """
  ...
  *   `payload` (*type:* `GoogleApi.ContentWarehouse.V1.Model.Proto2BridgeMessageSet.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          :features =>
            GoogleApi.ContentWarehouse.V1.Model.IndexingUrlPatternUrlTreeUrlFeatures.t() | nil,
          :patternId => String.t() | nil,
          :payload => GoogleApi.ContentWarehouse.V1.Model.Proto2BridgeMessageSet.t() | nil
        }

  field(:features, as: GoogleApi.ContentWarehouse.V1.Model.IndexingUrlPatternUrlTreeUrlFeatures)
  field(:patternId)
  field(:payload, as: GoogleApi.ContentWarehouse.V1.Model.Proto2BridgeMessageSet)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.IndexingUrlPatternUrlTreeBigTreeBranch do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.IndexingUrlPatternUrlTreeBigTreeBranch.decode(
      value,
      options
    )
  end
