...
defmodule GoogleApi.ContentWarehouse.V1.Model.GeostoreTimezoneProto do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.GeostoreTimezoneProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GeostoreTimezoneProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.GeostoreTimezoneProto do
