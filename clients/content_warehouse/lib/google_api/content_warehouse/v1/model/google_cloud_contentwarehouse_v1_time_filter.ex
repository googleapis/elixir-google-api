...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1TimeFilter do
  @moduledoc """
  ...
  *   `timeRange` (*type:* `GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval.t`, *default:* `nil`) - 
  ...
  field(:timeField)
  field(:timeRange, as: GoogleApi.ContentWarehouse.V1.Model.GoogleTypeInterval)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1TimeFilter do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudContentwarehouseV1TimeFilter.decode(
      value,
      options
    )
  end
