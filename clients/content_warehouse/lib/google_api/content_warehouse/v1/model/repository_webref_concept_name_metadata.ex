...
defmodule GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefConceptNameMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefConceptNameMetadata do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.RepositoryWebrefConceptNameMetadata.decode(value, options)
  end
end
