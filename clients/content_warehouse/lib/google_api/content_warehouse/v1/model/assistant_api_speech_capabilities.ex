...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiSpeechCapabilities do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSpeechCapabilities do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiSpeechCapabilities.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSpeechCapabilities do
