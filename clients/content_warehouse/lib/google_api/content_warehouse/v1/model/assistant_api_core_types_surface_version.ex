...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesSurfaceVersion do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesSurfaceVersion do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiCoreTypesSurfaceVersion.decode(value, options)
  end
end
