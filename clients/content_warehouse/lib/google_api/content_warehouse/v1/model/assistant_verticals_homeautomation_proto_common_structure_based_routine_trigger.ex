...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantVerticalsHomeautomationProtoCommonStructureBasedRoutineTrigger do
  @moduledoc """
  Next id: 3
...
defimpl Poison.Decoder,
  for:
    GoogleApi.ContentWarehouse.V1.Model.AssistantVerticalsHomeautomationProtoCommonStructureBasedRoutineTrigger do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantVerticalsHomeautomationProtoCommonStructureBasedRoutineTrigger.decode(
      value,
      options
    )
  end
