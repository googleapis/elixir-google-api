...
defmodule GoogleApi.ContentWarehouse.V1.Model.DrishtiIndexedFeatureData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiIndexedFeatureData do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.DrishtiIndexedFeatureData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContentWarehouse.V1.Model.DrishtiIndexedFeatureData do
