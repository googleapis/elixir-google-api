...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchQbstTermsOverlapFeatures do
  @moduledoc """
  ...
  *   `qbstNavboostOverlap` (*type:* `number()`, *default:* `nil`) - Fraction of salient terms of original query covered by top navboost query of the video.
  ...
  field(:qbstAnchorOverlap)
  field(:qbstNavboostOverlap)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchQbstTermsOverlapFeatures do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchQbstTermsOverlapFeatures.decode(
      value,
      options
    )
  end
