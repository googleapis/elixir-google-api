...
defmodule GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedLastSignificantUpdate do
  @moduledoc """
  ...
  *   `source` (*type:* `String.t`, *default:* `nil`) - The source the signal comes from.
  ...
  @type t :: %__MODULE__{
          ...
          :dateUnreliabilityInfo =>
            GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedDateUnreliability.t() | nil,
          :source => String.t() | nil
        }

  field(:adjustmentInfo,
    as: GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedLastSignificantUpdateAdjustments
  )

  field(:date)

  field(:dateUnreliabilityInfo,
    as: GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedDateUnreliability
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedLastSignificantUpdate do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.QualityTimebasedLastSignificantUpdate.decode(
      value,
      options
    )
  end
