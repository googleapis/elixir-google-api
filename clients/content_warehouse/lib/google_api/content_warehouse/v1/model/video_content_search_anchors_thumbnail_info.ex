...
defmodule GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsThumbnailInfo do
  @moduledoc """
  ...
  *   `thumbnailDiversity` (*type:* `number()`, *default:* `nil`) - A score representing how diverse a set of thumbnails is. This is currently defined as one minus the median pairwise cosine similarity between thumbnail Starburst embeddings.
  ...
  field(:hasMissingStarburst)
  field(:hasMissingThumbnails)
  field(:thumbnailDiversity)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsThumbnailInfo do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.VideoContentSearchAnchorsThumbnailInfo.decode(
      value,
      options
    )
  end
