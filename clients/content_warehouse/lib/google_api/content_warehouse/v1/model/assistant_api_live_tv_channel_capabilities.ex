...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiLiveTvChannelCapabilities do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiLiveTvChannelCapabilities do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiLiveTvChannelCapabilities.decode(
      value,
      options
    )
  end
