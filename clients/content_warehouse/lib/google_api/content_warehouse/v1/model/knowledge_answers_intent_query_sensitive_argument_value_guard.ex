...
defmodule GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySensitiveArgumentValueGuard do
  @moduledoc """
  ...
  *   `encryptedValue` (*type:* `String.t`, *default:* `nil`) - Encrypted protobuffer of type ArgumentValue.
  ...
  field(:doNotUseDebugOnlyDecryptedValue,
    as: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQueryArgumentValue
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySensitiveArgumentValueGuard do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.KnowledgeAnswersIntentQuerySensitiveArgumentValueGuard.decode(
      value,
      options
    )
  end
