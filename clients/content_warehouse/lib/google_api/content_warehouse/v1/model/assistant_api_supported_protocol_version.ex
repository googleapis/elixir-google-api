...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiSupportedProtocolVersion do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSupportedProtocolVersion do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiSupportedProtocolVersion.decode(
      value,
      options
    )
  end
