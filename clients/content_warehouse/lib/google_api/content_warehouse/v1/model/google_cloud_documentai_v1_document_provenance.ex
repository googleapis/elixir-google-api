...
defmodule GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentProvenance do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - The type of provenance operation.
  ...
  field(:parents,
    as: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentProvenanceParent,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentProvenance do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.GoogleCloudDocumentaiV1DocumentProvenance.decode(
      value,
      options
    )
  end
