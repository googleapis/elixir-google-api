...
defmodule GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSocialGraphNodeProto do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSocialGraphNodeProto do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.SecurityCredentialsSocialGraphNodeProto.decode(
      value,
      options
    )
  end
