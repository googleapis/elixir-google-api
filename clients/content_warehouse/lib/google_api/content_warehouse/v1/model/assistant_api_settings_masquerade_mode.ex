...
defmodule GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsMasqueradeMode do
  @moduledoc """
  ...
  *   `masqueradeModeEnabled` (*type:* `boolean()`, *default:* `nil`) - 
  ...
  field(:lastEnterGuestModeTimestamp,
    as: GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp
  )

  field(:lastExitGuestModeTimestamp, as: GoogleApi.ContentWarehouse.V1.Model.AssistantApiTimestamp)

  field(:masqueradeModeEnabled)
end

defimpl Poison.Decoder,
  for: GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsMasqueradeMode do
  def decode(value, options) do
    GoogleApi.ContentWarehouse.V1.Model.AssistantApiSettingsMasqueradeMode.decode(value, options)
  end
end
