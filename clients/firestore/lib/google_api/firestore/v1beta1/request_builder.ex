...
defmodule GoogleApi.Firestore.V1beta1.RequestBuilder do
  @moduledoc """
  ...
  def decode(%Tesla.Env{body: body}, struct, dataWrapped: true) do
    Poison.decode(body, as: %GoogleApi.Firestore.V1beta1.RequestBuilder.DataWrapper{}, struct: struct)
    |> case do
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.RequestBuilder.DataWrapper do
