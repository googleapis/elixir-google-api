...
defmodule GoogleApi.Firestore.V1beta1.Model.BeginTransactionRequest do
  @moduledoc """
  The request for Firestore.BeginTransaction.

  ## Attributes

  *   `options` (*type:* `GoogleApi.Firestore.V1beta1.Model.TransactionOptions.t`, *default:* `nil`) - The options for the transaction. Defaults to a read-write transaction.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :options => GoogleApi.Firestore.V1beta1.Model.TransactionOptions.t() | nil
        }
