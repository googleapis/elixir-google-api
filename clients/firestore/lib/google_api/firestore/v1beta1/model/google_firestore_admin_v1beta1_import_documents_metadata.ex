...
defmodule GoogleApi.Firestore.V1beta1.Model.GoogleFirestoreAdminV1beta1ImportDocumentsMetadata do
  ...
  - collectionIds (list(String.t)): Which collection ids are being imported. Defaults to `nil`.
  ...
  - inputUriPrefix (String.t): The location of the documents being imported. Defaults to `nil`.
  - operationState (String.t): The state of the import operation. Defaults to `nil`.
