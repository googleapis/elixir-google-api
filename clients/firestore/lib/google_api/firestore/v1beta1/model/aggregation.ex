...
defmodule GoogleApi.Firestore.V1beta1.Model.Aggregation do
  ...
  *   `alias` (*type:* `String.t`, *default:* `nil`) - Required. The name of the field to store the result of the aggregation into. Requires: * Must be present. * Must be unique across all aggregation aliases. * Conform to existing document field name limitations.
