...
defmodule GoogleApi.Firestore.V1beta1.Model.WriteResponse do
  ...
  - commitTime (DateTime.t): The time at which the commit occurred. Defaults to `nil`.
  - streamId (String.t): The ID of the stream.
  Only set on the first message, when a new stream was created. Defaults to `nil`.
  - streamToken (String.t): A token that represents the position of this response in the stream.
  This can be used by a client to resume the stream at this point.

  This field is always set. Defaults to `nil`.
  - writeResults (list(GoogleApi.Firestore.V1beta1.Model.WriteResult.t)): The result of applying the writes.
