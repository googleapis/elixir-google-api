...
defmodule GoogleApi.Firestore.V1beta1.Model.RunAggregationQueryRequest do
  @moduledoc """
  ...
  *   `transaction` (*type:* `String.t`, *default:* `nil`) - Run the aggregation within an already active transaction. The value here is the opaque transaction ID to execute the query in.
  ...
  @type t :: %__MODULE__{
          ...
          :structuredAggregationQuery =>
            GoogleApi.Firestore.V1beta1.Model.StructuredAggregationQuery.t() | nil,
  ...
  field(:structuredAggregationQuery,
    as: GoogleApi.Firestore.V1beta1.Model.StructuredAggregationQuery
  )

  field(:transaction)
end

defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.Model.RunAggregationQueryRequest do
  def decode(value, options) do
    GoogleApi.Firestore.V1beta1.Model.RunAggregationQueryRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1beta1.Model.RunAggregationQueryRequest do
