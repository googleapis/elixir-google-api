...
defmodule GoogleApi.Firestore.V1beta1.Model.StructuredQuery do
  ...
  *   `select` (*type:* `GoogleApi.Firestore.V1beta1.Model.Projection.t`, *default:* `nil`) - Optional sub-set of the fields to return. This acts as a DocumentMask over the documents returned from a query. When not set, assumes that the caller wants all fields returned.
