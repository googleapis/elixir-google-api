...
defmodule GoogleApi.Firestore.V1beta1.Model.FieldTransform do
  ...
  *   `appendMissingElements` (*type:* `GoogleApi.Firestore.V1beta1.Model.ArrayValue.t`, *default:* `nil`) - Append the given elements in order if they are not already present in
  ...
  *   `fieldPath` (*type:* `String.t`, *default:* `nil`) - The path of the field. See Document.fields for the field path syntax
      reference.
  *   `increment` (*type:* `GoogleApi.Firestore.V1beta1.Model.Value.t`, *default:* `nil`) - Adds the given value to the field's current value.
  ...
  *   `maximum` (*type:* `GoogleApi.Firestore.V1beta1.Model.Value.t`, *default:* `nil`) - Sets the field to the maximum of its current value and the given value.
  ...
  *   `minimum` (*type:* `GoogleApi.Firestore.V1beta1.Model.Value.t`, *default:* `nil`) - Sets the field to the minimum of its current value and the given value.
  ...
  *   `removeAllFromArray` (*type:* `GoogleApi.Firestore.V1beta1.Model.ArrayValue.t`, *default:* `nil`) - Remove all of the given elements from the array in the field.
      If the field is not an array, or if the field does not yet exist, it is
