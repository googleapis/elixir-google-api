...
defmodule GoogleApi.Firestore.V1beta1.Model.ListCollectionIdsRequest do
  ...
  - pageSize (integer()): The maximum number of results to return. Defaults to: `null`.
  - pageToken (String.t): A page token. Must be a value from ListCollectionIdsResponse. Defaults to: `null`.
  """
