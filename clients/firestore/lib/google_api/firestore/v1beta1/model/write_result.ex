...
defmodule GoogleApi.Firestore.V1beta1.Model.WriteResult do
  ...
  - transformResults (list(GoogleApi.Firestore.V1beta1.Model.Value.t)): The results of applying each DocumentTransform.FieldTransform, in the
  same order. Defaults to `nil`.
  - updateTime (DateTime.t): The last update time of the document after applying the write. Not set
  after a `delete`.

  If the write did not actually change the document, this will be the
  previous update_time. Defaults to `nil`.
  """
