...
defmodule GoogleApi.Firestore.V1beta1.Model.FieldFilter do
  ...
  - field (GoogleApi.Firestore.V1beta1.Model.FieldReference.t): The field to filter by. Defaults to `nil`.
  - op (String.t): The operator to filter by. Defaults to `nil`.
  - value (GoogleApi.Firestore.V1beta1.Model.Value.t): The value to compare to. Defaults to `nil`.
  """
