...
defmodule GoogleApi.Firestore.V1beta1.Model.FieldFilter do
  ...
  *   `field` (*type:* `GoogleApi.Firestore.V1beta1.Model.FieldReference.t`, *default:* `nil`) - The field to filter by.
  *   `op` (*type:* `String.t`, *default:* `nil`) - The operator to filter by.
  *   `value` (*type:* `GoogleApi.Firestore.V1beta1.Model.Value.t`, *default:* `nil`) - The value to compare to.
  """
