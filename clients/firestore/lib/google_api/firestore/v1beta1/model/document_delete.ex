...
defmodule GoogleApi.Firestore.V1beta1.Model.DocumentDelete do
  ...
  - document (String.t): The resource name of the Document that was deleted. Defaults to: `null`.
  - readTime (DateTime.t): The read timestamp at which the delete was observed.  Greater or equal to the &#x60;commit_time&#x60; of the delete. Defaults to: `null`.
  - removedTargetIds ([integer()]): A set of target IDs for targets that previously matched this entity. Defaults to: `null`.
  """
