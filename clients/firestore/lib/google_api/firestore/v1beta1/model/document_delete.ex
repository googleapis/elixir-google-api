...
defmodule GoogleApi.Firestore.V1beta1.Model.DocumentDelete do
  ...
  - document (String.t): The resource name of the Document that was deleted. Defaults to `nil`.
  - readTime (DateTime.t): The read timestamp at which the delete was observed.

  Greater or equal to the `commit_time` of the delete. Defaults to `nil`.
  - removedTargetIds (list(integer())): A set of target IDs for targets that previously matched this entity. Defaults to `nil`.
  """
