...
defmodule GoogleApi.Firestore.V1beta1.Model.Operation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.Model.Operation do
  import GoogleApi.Firestore.V1beta1.Deserializer
  def decode(value, options) do
    value
    
    |> deserialize(:"error", :struct, GoogleApi.Firestore.V1beta1.Model.Status, options)
    
    |> deserialize(:"metadata", :struct, GoogleApi.Firestore.V1beta1.Model.Object, options)
    
    
    |> deserialize(:"response", :struct, GoogleApi.Firestore.V1beta1.Model.Object, options)
    
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1beta1.Model.Operation do
