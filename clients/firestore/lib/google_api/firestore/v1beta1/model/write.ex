...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.Model.Write do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"currentDocument", :struct, GoogleApi.Firestore.V1beta1.Model.Precondition, options)
    
    
    |> deserialize(:"transform", :struct, GoogleApi.Firestore.V1beta1.Model.DocumentTransform, options)
