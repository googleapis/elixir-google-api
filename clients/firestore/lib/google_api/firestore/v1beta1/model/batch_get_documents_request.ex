...
defmodule GoogleApi.Firestore.V1beta1.Model.BatchGetDocumentsRequest do
  ...
  given `database`. Duplicate names will be elided. Defaults to `nil`.
  - mask (GoogleApi.Firestore.V1beta1.Model.DocumentMask.t): The fields to return. If not set, returns all fields.

  If a document has a field that is not present in this mask, that field will
  not be returned in the response. Defaults to `nil`.
  - newTransaction (GoogleApi.Firestore.V1beta1.Model.TransactionOptions.t): Starts a new transaction and reads the documents.
  Defaults to a read-only transaction.
  The new transaction ID will be returned as the first response in the
  stream. Defaults to `nil`.
  - readTime (DateTime.t): Reads documents as they were at the given time.
  This may not be older than 60 seconds. Defaults to `nil`.
  - transaction (String.t): Reads documents in a transaction. Defaults to `nil`.
  """
