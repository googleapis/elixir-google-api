...
defmodule GoogleApi.Firestore.V1beta1.Model.ExistenceFilter do
  ...
  client must manually determine which documents no longer match the target. Defaults to `nil`.
  - targetId (integer()): The target ID to which this filter applies. Defaults to `nil`.
  """
