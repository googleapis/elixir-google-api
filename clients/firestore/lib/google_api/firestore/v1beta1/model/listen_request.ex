...
defmodule GoogleApi.Firestore.V1beta1.Model.ListenRequest do
  ...
  - addTarget (GoogleApi.Firestore.V1beta1.Model.Target.t): A target to add to this stream. Defaults to `nil`.
  - labels (map()): Labels associated with this target change. Defaults to `nil`.
  - removeTarget (integer()): The ID of a target to remove from this stream. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.Model.ListenRequest do
  def decode(value, options) do
    GoogleApi.Firestore.V1beta1.Model.ListenRequest.decode(value, options)
  end
end
