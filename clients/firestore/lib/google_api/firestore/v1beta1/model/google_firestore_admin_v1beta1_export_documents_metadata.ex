...
defmodule GoogleApi.Firestore.V1beta1.Model.GoogleFirestoreAdminV1beta1ExportDocumentsMetadata do
  ...
  - collectionIds ([String.t]): Which collection ids are being exported. Defaults to: `null`.
  ...
  - operationState (String.t): The state of the export operation. Defaults to: `null`.
    - Enum - one of [STATE_UNSPECIFIED, INITIALIZING, PROCESSING, CANCELLING, FINALIZING, SUCCESSFUL, FAILED, CANCELLED]
  - outputUriPrefix (String.t): Where the entities are being exported to. Defaults to: `null`.
