...
defmodule GoogleApi.Firestore.V1beta1.Model.GoogleFirestoreAdminV1beta1ImportDocumentsRequest do
  ...
  - collectionIds (list(String.t)): Which collection ids to import. Unspecified means all collections included
  in the import. Defaults to `nil`.
  - inputUriPrefix (String.t): Location of the exported files.
  This must match the output_uri_prefix of an ExportDocumentsResponse from
  an export that has completed successfully.
  See:
  google.firestore.admin.v1beta1.ExportDocumentsResponse.output_uri_prefix. Defaults to `nil`.
  """
