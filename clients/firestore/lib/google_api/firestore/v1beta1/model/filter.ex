...
defmodule GoogleApi.Firestore.V1beta1.Model.Filter do
  ...
  *   `unaryFilter` (*type:* `GoogleApi.Firestore.V1beta1.Model.UnaryFilter.t`, *default:* `nil`) - A filter that takes exactly one argument.
  ...
  @type t :: %__MODULE__{
          :compositeFilter => GoogleApi.Firestore.V1beta1.Model.CompositeFilter.t() | nil,
          :fieldFilter => GoogleApi.Firestore.V1beta1.Model.FieldFilter.t() | nil,
          :unaryFilter => GoogleApi.Firestore.V1beta1.Model.UnaryFilter.t() | nil
        }
