...
defmodule GoogleApi.Firestore.V1beta1.Model.Filter do
  ...
  - compositeFilter (GoogleApi.Firestore.V1beta1.Model.CompositeFilter.t): A composite filter. Defaults to `nil`.
  - fieldFilter (GoogleApi.Firestore.V1beta1.Model.FieldFilter.t): A filter on a document field. Defaults to `nil`.
  - unaryFilter (GoogleApi.Firestore.V1beta1.Model.UnaryFilter.t): A filter that takes exactly one argument. Defaults to `nil`.
  """
