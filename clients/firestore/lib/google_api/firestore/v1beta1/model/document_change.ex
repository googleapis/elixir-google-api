...
defmodule GoogleApi.Firestore.V1beta1.Model.DocumentChange do
  ...
  - document (GoogleApi.Firestore.V1beta1.Model.Document.t): The new state of the Document.

  If `mask` is set, contains only fields that were updated or added. Defaults to `nil`.
  - removedTargetIds (list(integer())): A set of target IDs for targets that no longer match this document. Defaults to `nil`.
  - targetIds (list(integer())): A set of target IDs of targets that match this document. Defaults to `nil`.
  """
