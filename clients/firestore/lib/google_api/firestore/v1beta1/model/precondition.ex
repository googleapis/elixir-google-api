...
defmodule GoogleApi.Firestore.V1beta1.Model.Precondition do
  @moduledoc """
  ...
  When set to `false`, the target document must not exist. Defaults to `nil`.
  - updateTime (DateTime.t): When set, the target document must exist and have been last updated at
  that time. Defaults to `nil`.
  """
