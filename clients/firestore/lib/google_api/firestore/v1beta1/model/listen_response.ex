...
defmodule GoogleApi.Firestore.V1beta1.Model.ListenResponse do
  ...
  - documentChange (GoogleApi.Firestore.V1beta1.Model.DocumentChange.t): A Document has changed. Defaults to `nil`.
  - documentDelete (GoogleApi.Firestore.V1beta1.Model.DocumentDelete.t): A Document has been deleted. Defaults to `nil`.
  - documentRemove (GoogleApi.Firestore.V1beta1.Model.DocumentRemove.t): A Document has been removed from a target (because it is no longer
  relevant to that target). Defaults to `nil`.
  - filter (GoogleApi.Firestore.V1beta1.Model.ExistenceFilter.t): A filter to apply to the set of documents previously returned for the
  given target.

  Returned when documents may have been removed from the given target, but
  the exact documents are unknown. Defaults to `nil`.
  - targetChange (GoogleApi.Firestore.V1beta1.Model.TargetChange.t): Targets have changed. Defaults to `nil`.
  """
