...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1beta1.Model.ListenResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"documentChange", :struct, GoogleApi.Firestore.V1beta1.Model.DocumentChange, options)
    
    |> deserialize(:"documentDelete", :struct, GoogleApi.Firestore.V1beta1.Model.DocumentDelete, options)
    
    |> deserialize(:"documentRemove", :struct, GoogleApi.Firestore.V1beta1.Model.DocumentRemove, options)
    
    |> deserialize(:"filter", :struct, GoogleApi.Firestore.V1beta1.Model.ExistenceFilter, options)
    
    |> deserialize(:"targetChange", :struct, GoogleApi.Firestore.V1beta1.Model.TargetChange, options)
