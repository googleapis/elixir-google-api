...
defmodule GoogleApi.Firestore.V1.Model.Value do
  @moduledoc """
  A message that can hold any of the supported value types.

  ## Attributes

  *   `arrayValue` (*type:* `GoogleApi.Firestore.V1.Model.ArrayValue.t`, *default:* `nil`) - An array value.
  ...
  *   `timestampValue` (*type:* `DateTime.t`, *default:* `nil`) - A timestamp value.
  ...
  @type t :: %__MODULE__{
          :arrayValue => GoogleApi.Firestore.V1.Model.ArrayValue.t(),
          :booleanValue => boolean(),
          :bytesValue => String.t(),
          :doubleValue => float(),
          :geoPointValue => GoogleApi.Firestore.V1.Model.LatLng.t(),
          :integerValue => String.t(),
          :mapValue => GoogleApi.Firestore.V1.Model.MapValue.t(),
          :nullValue => String.t(),
  ...
  field(:arrayValue, as: GoogleApi.Firestore.V1.Model.ArrayValue)
  field(:booleanValue)
  field(:bytesValue)
  field(:doubleValue)
  field(:geoPointValue, as: GoogleApi.Firestore.V1.Model.LatLng)
  field(:integerValue)
  field(:mapValue, as: GoogleApi.Firestore.V1.Model.MapValue)
  field(:nullValue)
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.Value do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.Value.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.Value do
