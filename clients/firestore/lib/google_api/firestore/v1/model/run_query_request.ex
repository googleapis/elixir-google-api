...
defmodule GoogleApi.Firestore.V1.Model.RunQueryRequest do
  @moduledoc """
  ...
  *   `transaction` (*type:* `String.t`, *default:* `nil`) - Run the query within an already active transaction. The value here is the opaque transaction ID to execute the query in.
  ...
  field(:explainOptions, as: GoogleApi.Firestore.V1.Model.ExplainOptions)
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.RunQueryRequest do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.RunQueryRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.RunQueryRequest do
