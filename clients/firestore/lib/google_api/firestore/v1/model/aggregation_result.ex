...
defmodule GoogleApi.Firestore.V1.Model.AggregationResult do
  @moduledoc """
  ...
  *   `aggregateFields` (*type:* `%{optional(String.t) => GoogleApi.Firestore.V1.Model.Value.t}`, *default:* `nil`) - The result of the aggregation functions, ex: `COUNT(*) AS total_docs`. The key is the alias assigned to the aggregation function on input and the size of this map equals the number of aggregation functions in the query.
  ...
  field(:aggregateFields, as: GoogleApi.Firestore.V1.Model.Value, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.AggregationResult do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.AggregationResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.AggregationResult do
