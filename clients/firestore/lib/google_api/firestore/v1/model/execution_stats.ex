...
defmodule GoogleApi.Firestore.V1.Model.ExecutionStats do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.ExecutionStats do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.ExecutionStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.ExecutionStats do
