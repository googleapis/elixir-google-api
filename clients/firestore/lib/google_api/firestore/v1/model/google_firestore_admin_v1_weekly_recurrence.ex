...
defmodule GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1WeeklyRecurrence do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1WeeklyRecurrence do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1WeeklyRecurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1WeeklyRecurrence do
