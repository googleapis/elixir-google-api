...
defmodule GoogleApi.Firestore.V1.Model.PartitionQueryRequest do
  ...
  *   `pageSize` (*type:* `integer()`, *default:* `nil`) - The maximum number of partitions to return in this call, subject to
      `partition_count`.
  ...
  *   `pageToken` (*type:* `String.t`, *default:* `nil`) - The `next_page_token` value returned from a previous call to
  ...
  *   `partitionCount` (*type:* `String.t`, *default:* `nil`) - The desired maximum number of partition points.
  ...
  *   `structuredQuery` (*type:* `GoogleApi.Firestore.V1.Model.StructuredQuery.t`, *default:* `nil`) - A structured query.
  ...
  @type t :: %__MODULE__{
          ...
          :structuredQuery => GoogleApi.Firestore.V1.Model.StructuredQuery.t()
        }
