...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.FieldReference do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.FieldReference.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.FieldReference do
