...
defmodule GoogleApi.Firestore.V1.Model.CommitResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.CommitResponse do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.CommitResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.CommitResponse do
