...
defmodule GoogleApi.Firestore.V1.Model.Cursor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firestore.V1.Model.Cursor do
  def decode(value, options) do
    GoogleApi.Firestore.V1.Model.Cursor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firestore.V1.Model.Cursor do
