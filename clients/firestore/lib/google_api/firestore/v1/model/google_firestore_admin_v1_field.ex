...
defmodule GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1Field do
  ...
  *   `indexConfig` (*type:* `GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1IndexConfig.t`, *default:* `nil`) - The index configuration for this field. If unset, field indexing will
      revert to the configuration defined by the `ancestor_field`. To
      explicitly remove all indexes for this field, specify an index config
      with an empty list of indexes.
  *   `name` (*type:* `String.t`, *default:* `nil`) - A field name of the form
  ...
  @type t :: %__MODULE__{
          :indexConfig => GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1IndexConfig.t(),
          :name => String.t()
        }
