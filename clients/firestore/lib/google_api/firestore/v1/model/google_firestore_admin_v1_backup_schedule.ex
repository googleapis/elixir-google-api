...
defmodule GoogleApi.Firestore.V1.Model.GoogleFirestoreAdminV1BackupSchedule do
  ...
  *   `retention` (*type:* `String.t`, *default:* `nil`) - At what relative time in the future, compared to its creation time, the backup should be deleted, e.g. keep backups for 7 days. The maximum supported retention is 14 weeks.
