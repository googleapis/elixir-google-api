...
defmodule GoogleApi.Datastream.V1.Model.PostgresqlColumn do
  @moduledoc """
  PostgreSQL Column.
  ...
  *   `dataType` (*type:* `String.t`, *default:* `nil`) - The PostgreSQL data type.
...
defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.PostgresqlColumn do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.PostgresqlColumn.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.PostgresqlColumn do
