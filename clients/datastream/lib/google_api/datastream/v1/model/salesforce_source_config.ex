...
defmodule GoogleApi.Datastream.V1.Model.SalesforceSourceConfig do
  @moduledoc """
  ...
  *   `pollingInterval` (*type:* `String.t`, *default:* `nil`) - Required. Salesforce objects polling interval. The interval at which new changes will be polled for each object. The duration must be between 5 minutes and 24 hours.
  ...
  field(:excludeObjects, as: GoogleApi.Datastream.V1.Model.SalesforceOrg)
  field(:includeObjects, as: GoogleApi.Datastream.V1.Model.SalesforceOrg)
  field(:pollingInterval)
end

defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.SalesforceSourceConfig do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.SalesforceSourceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.SalesforceSourceConfig do
