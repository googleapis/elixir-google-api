...
defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.Location do
