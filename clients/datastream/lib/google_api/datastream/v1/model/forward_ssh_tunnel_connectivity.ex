...
defmodule GoogleApi.Datastream.V1.Model.ForwardSshTunnelConnectivity do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.ForwardSshTunnelConnectivity do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.ForwardSshTunnelConnectivity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.ForwardSshTunnelConnectivity do
