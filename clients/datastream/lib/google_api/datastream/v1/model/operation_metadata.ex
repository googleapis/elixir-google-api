...
defmodule GoogleApi.Datastream.V1.Model.OperationMetadata do
  @moduledoc """
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :target => String.t() | nil,
          :validationResult => GoogleApi.Datastream.V1.Model.ValidationResult.t() | nil,
          :verb => String.t() | nil
        }
  ...
  field(:statusMessage)
  field(:target)
  field(:validationResult, as: GoogleApi.Datastream.V1.Model.ValidationResult)
  field(:verb)
end

defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.OperationMetadata do
