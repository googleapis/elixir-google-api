...
defmodule GoogleApi.Datastream.V1.Model.DestinationConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.DestinationConfig do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.DestinationConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.DestinationConfig do
