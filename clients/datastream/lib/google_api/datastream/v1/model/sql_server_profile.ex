...
defimpl Poison.Decoder, for: GoogleApi.Datastream.V1.Model.SqlServerProfile do
  def decode(value, options) do
    GoogleApi.Datastream.V1.Model.SqlServerProfile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastream.V1.Model.SqlServerProfile do
