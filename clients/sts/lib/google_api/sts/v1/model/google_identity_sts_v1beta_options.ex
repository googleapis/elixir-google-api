...
defmodule GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaOptions do
  @moduledoc """
  ...
  *   `userProject` (*type:* `String.t`, *default:* `nil`) - A Google project used for quota and billing purposes when the credential is used to access Google APIs. The provided project overrides the project bound to the credential. The value must be a project number or a project ID. Example: `my-sample-project-191923`. The maximum length is 32 characters.
  ...
  @type t :: %__MODULE__{
          :accessBoundary =>
            GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaAccessBoundary.t() | nil,
          :userProject => String.t() | nil
        }

  field(:accessBoundary, as: GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaAccessBoundary)
  field(:userProject)
end

defimpl Poison.Decoder, for: GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaOptions do
  def decode(value, options) do
    GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.STS.V1.Model.GoogleIdentityStsV1betaOptions do
