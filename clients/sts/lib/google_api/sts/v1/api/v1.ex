...
defmodule GoogleApi.STS.V1.Api.V1 do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.STS.V1.Model.GoogleIdentityStsV1ExchangeOauthTokenRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.STS.V1.Model.GoogleIdentityStsV1ExchangeOauthTokenResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sts_oauthtoken(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.STS.V1.Model.GoogleIdentityStsV1ExchangeOauthTokenResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sts_oauthtoken(connection, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.STS.V1.Model.GoogleIdentityStsV1ExchangeOauthTokenResponse{}]
    )
  end
