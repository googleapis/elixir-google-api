...
defmodule GoogleApi.DataPipelines.V1.Model.GoogleCloudDatapipelinesV1LaunchTemplateRequest do
  @moduledoc """
  ...
  *   `validateOnly` (*type:* `boolean()`, *default:* `nil`) - If true, the request is validated but not actually executed. Defaults to false.
  ...
  field(:launchParameters,
    as: GoogleApi.DataPipelines.V1.Model.GoogleCloudDatapipelinesV1LaunchTemplateParameters
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DataPipelines.V1.Model.GoogleCloudDatapipelinesV1LaunchTemplateRequest do
  def decode(value, options) do
    GoogleApi.DataPipelines.V1.Model.GoogleCloudDatapipelinesV1LaunchTemplateRequest.decode(
      value,
      options
    )
  end
