...
defmodule GoogleApi.DataPipelines.V1.Model.GoogleTypeDecimal do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataPipelines.V1.Model.GoogleTypeDecimal do
  def decode(value, options) do
    GoogleApi.DataPipelines.V1.Model.GoogleTypeDecimal.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataPipelines.V1.Model.GoogleTypeDecimal do
