...
defmodule GoogleApi.DataPipelines.V1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataPipelines.V1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.DataPipelines.V1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataPipelines.V1.Model.GoogleRpcStatus do
