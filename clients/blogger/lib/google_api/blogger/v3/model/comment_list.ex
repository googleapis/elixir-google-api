...
defmodule GoogleApi.Blogger.V3.Model.CommentList do
  ...
  - items ([Comment]): The List of Comments for a Post. Defaults to: `null`.
  - kind (String.t): The kind of this entry. Always blogger#commentList Defaults to: `null`.
  - nextPageToken (String.t): Pagination token to fetch the next page, if one exists. Defaults to: `null`.
  - prevPageToken (String.t): Pagination token to fetch the previous page, if one exists. Defaults to: `null`.
  """
