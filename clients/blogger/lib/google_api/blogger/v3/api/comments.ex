...
defmodule GoogleApi.Blogger.V3.Api.Comments do
  ...
  """
  @spec blogger_comments_approve(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.Comment.t} | {:error, Tesla.Env.t}
  def blogger_comments_approve(connection, blog_id, post_id, comment_id, opts \\ []) do
    ...
    |> decode(%GoogleApi.Blogger.V3.Model.Comment{})
  end
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_delete(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.Comment.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.CommentList.t} | {:error, Tesla.Env.t}
  def blogger_comments_list(connection, blog_id, post_id, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Blogger.V3.Model.CommentList{})
  end
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_list_by_blog(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.CommentList.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_mark_as_spam(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.Comment.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec blogger_comments_remove_content(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.Comment.t} | {:error, Tesla.Env.t}
