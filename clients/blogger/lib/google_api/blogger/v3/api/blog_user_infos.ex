...
defmodule GoogleApi.Blogger.V3.Api.BlogUserInfos do
  ...
  """
  @spec blogger_blog_user_infos_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.Blogger.V3.Model.BlogUserInfo.t} | {:error, Tesla.Env.t}
  def blogger_blog_user_infos_get(connection, user_id, blog_id, opts \\ []) do
    ...
    |> decode(%GoogleApi.Blogger.V3.Model.BlogUserInfo{})
  end
end
