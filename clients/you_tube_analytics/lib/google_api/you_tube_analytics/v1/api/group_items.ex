...
defmodule GoogleApi.YouTubeAnalytics.V1.Api.GroupItems do
  ...
  """
  @spec youtube_analytics_group_items_delete(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec youtube_analytics_group_items_insert(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.YouTubeAnalytics.V1.Model.GroupItem.t} | {:error, Tesla.Env.t}
  def youtube_analytics_group_items_insert(connection, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.YouTubeAnalytics.V1.Model.GroupItem{})
  end
  ...
  - connection (GoogleApi.YouTubeAnalytics.V1.Connection): Connection to server
  - group_id (String): The id parameter specifies the unique ID of the group for which you want to retrieve group items.
  - opts (KeywordList): [optional] Optional parameters
    - :alt (String): Data format for the response.
    - :fields (String): Selector specifying which fields to include in a partial response.
    - :key (String): API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  {:error, info} on failure
  """
  @spec youtube_analytics_group_items_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.YouTubeAnalytics.V1.Model.GroupItemListResponse.t} | {:error, Tesla.Env.t}
  def youtube_analytics_group_items_list(connection, group_id, opts \\ []) do
    ...
    |> method(:get)
    |> url("/groupItems")
    |> add_param(:query, :"groupId", group_id)
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.YouTubeAnalytics.V1.Model.GroupItemListResponse{})
  end
end
