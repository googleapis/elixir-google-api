...
defmodule GoogleApi.YouTubeAnalytics.V1.Api.Reports do
  ...
  - start_date (String): The start date for fetching YouTube Analytics data. The value should be in YYYY-MM-DD format.
  - end_date (String): The end date for fetching YouTube Analytics data. The value should be in YYYY-MM-DD format.
  ...
  """
  @spec youtube_analytics_reports_query(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.YouTubeAnalytics.V1.Model.ResultTable.t} | {:error, Tesla.Env.t}
  def youtube_analytics_reports_query(connection, ids, start_date, end_date, metrics, opts \\ []) do
    ...
    |> decode(%GoogleApi.YouTubeAnalytics.V1.Model.ResultTable{})
  end
end
