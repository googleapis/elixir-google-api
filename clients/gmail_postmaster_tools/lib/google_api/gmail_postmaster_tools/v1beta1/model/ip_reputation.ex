...
defmodule GoogleApi.GmailPostmasterTools.V1beta1.Model.IpReputation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GmailPostmasterTools.V1beta1.Model.IpReputation do
  def decode(value, options) do
    GoogleApi.GmailPostmasterTools.V1beta1.Model.IpReputation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GmailPostmasterTools.V1beta1.Model.IpReputation do
