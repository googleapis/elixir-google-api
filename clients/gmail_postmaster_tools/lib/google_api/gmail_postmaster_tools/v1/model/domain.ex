...
defmodule GoogleApi.GmailPostmasterTools.V1.Model.Domain do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GmailPostmasterTools.V1.Model.Domain do
  def decode(value, options) do
    GoogleApi.GmailPostmasterTools.V1.Model.Domain.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GmailPostmasterTools.V1.Model.Domain do
