...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Results do
  @moduledoc """
  ...
  *   `pythonPackages` (*type:* `list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage.t)`, *default:* `nil`) - Python artifacts uploaded to Artifact Registry at the end of the build.
  ...
  @type t :: %__MODULE__{
          ...
          :artifactTiming => GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan.t() | nil,
          :buildStepImages => list(String.t()) | nil,
          :buildStepOutputs => list(String.t()) | nil,
          :images => list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage.t()) | nil,
          :mavenArtifacts =>
            list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedMavenArtifact.t()) | nil,
          :npmPackages =>
            list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedNpmPackage.t()) | nil,
          :numArtifacts => String.t() | nil,
          :pythonPackages =>
            list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage.t()) | nil
        }

  field(:artifactManifest)
  field(:artifactTiming, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan)
  field(:buildStepImages, type: :list)
  field(:buildStepOutputs, type: :list)
  field(:images, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage, type: :list)

  field(:mavenArtifacts,
    as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedMavenArtifact,
    type: :list
  )

  field(:npmPackages,
    as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedNpmPackage,
    type: :list
  )
  ...
  field(:pythonPackages,
    as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Results do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Results.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Results do
