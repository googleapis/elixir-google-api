...
defmodule GoogleApi.Run.V1.Model.Probe do
  ...
  *   `exec` (*type:* `GoogleApi.Run.V1.Model.ExecAction.t`, *default:* `nil`) - (Optional) Not supported by Cloud Run One and only one of the following should be specified. Exec specifies the action to take. A field inlined from the Handler message.
  ...
  *   `grpc` (*type:* `GoogleApi.Run.V1.Model.GRPCAction.t`, *default:* `nil`) - (Optional) GRPCAction specifies an action involving a GRPC port. A field inlined from the Handler message.
