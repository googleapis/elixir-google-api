...
defmodule GoogleApi.Run.V1.Model.ObjectMeta do
  ...
  *   `creationTimestamp` (*type:* `DateTime.t`, *default:* `nil`) - UTC timestamp representing the server time when this object was created. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and routes. More info: https://kubernetes.io/docs/user-guide/labels
  *   `name` (*type:* `String.t`, *default:* `nil`) - The immutable name of the resource. In Cloud Run, name is required when creating top-level resources (Service, Job), and must be unique within a Cloud Run project/region. More info: https://kubernetes.io/docs/user-guide/identifiers#names If ObjectMeta is part of a CreateServiceRequest, name must contain fewer than 50 characters. Otherwise,
  *   `namespace` (*type:* `String.t`, *default:* `nil`) - Defines the space within each name must be unique within a Cloud Run region. In Cloud Run, it must be project ID or number.
  *   `ownerReferences` (*type:* `list(GoogleApi.Run.V1.Model.OwnerReference.t)`, *default:* `nil`) - Not supported by Cloud Run
  *   `resourceVersion` (*type:* `String.t`, *default:* `nil`) - Optional. Opaque, system-generated value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodified back to the server or omit the value to disable conflict-detection. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency
  *   `selfLink` (*type:* `String.t`, *default:* `nil`) - URL representing this object.
  *   `uid` (*type:* `String.t`, *default:* `nil`) - Unique, system-generated identifier for this resource. More info: https://kubernetes.io/docs/user-guide/identifiers#uids
  """
