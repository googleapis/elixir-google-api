...
defmodule GoogleApi.Run.V1.Model.ObjectMeta do
  ...
  *   `annotations` (*type:* `map()`, *default:* `nil`) - (Optional)

      Annotations is an unstructured key value map stored with a resource that
      may be set by external tools to store and retrieve arbitrary metadata. They
      are not queryable and should be preserved when modifying objects. More
      info: http://kubernetes.io/docs/user-guide/annotations
  *   `clusterName` (*type:* `String.t`, *default:* `nil`) - (Optional)
  ...
  *   `creationTimestamp` (*type:* `DateTime.t`, *default:* `nil`) - (Optional)
  ...
  *   `deletionGracePeriodSeconds` (*type:* `integer()`, *default:* `nil`) - (Optional)
  ...
  *   `deletionTimestamp` (*type:* `DateTime.t`, *default:* `nil`) - (Optional)
      ...
      More info:
      https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
  *   `finalizers` (*type:* `list(String.t)`, *default:* `nil`) - (Optional)
      ...
      +patchStrategy=merge
  *   `generateName` (*type:* `String.t`, *default:* `nil`) - (Optional)
  ...
  *   `generation` (*type:* `integer()`, *default:* `nil`) - (Optional)

      A sequence number representing a specific generation of the desired state.
      Populated by the system. Read-only.
  *   `labels` (*type:* `map()`, *default:* `nil`) - (Optional)
  ...
  *   `ownerReferences` (*type:* `list(GoogleApi.Run.V1.Model.OwnerReference.t)`, *default:* `nil`) - (Optional)
  ...
  *   `resourceVersion` (*type:* `String.t`, *default:* `nil`) - (Optional)
  ...
  *   `selfLink` (*type:* `String.t`, *default:* `nil`) - (Optional)

      SelfLink is a URL representing this object.
      Populated by the system.
      Read-only.
       string selfLink = 4;
  *   `uid` (*type:* `String.t`, *default:* `nil`) - (Optional)
