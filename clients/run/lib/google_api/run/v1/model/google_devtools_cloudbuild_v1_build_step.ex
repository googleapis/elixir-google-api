...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildStep do
  @moduledoc """
  ...
  *   `pullTiming` (*type:* `GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan.t`, *default:* `nil`) - Output only. Stores timing information for pulling this build step's builder image only.
  ...
  *   `timing` (*type:* `GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan.t`, *default:* `nil`) - Output only. Stores timing information for executing this build step.
  *   `volumes` (*type:* `list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Volume.t)`, *default:* `nil`) - List of volumes to mount into the build step. Each volume is created as an empty volume prior to execution of the build step. Upon completion of the build, volumes and their contents are discarded. Using a named volume in only one step is not valid as it is indicative of a build request with an incorrect configuration.
  *   `waitFor` (*type:* `list(String.t)`, *default:* `nil`) - The ID(s) of the step(s) that this build step depends on. This build step will not start until all the build steps in `wait_for` have completed successfully. If `wait_for` is empty, this build step will start when all previous build steps in the `Build.Steps` list have completed successfully.
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t() | nil,
          :name => String.t() | nil,
          :pullTiming => GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan.t() | nil,
          :script => String.t() | nil,
          :secretEnv => list(String.t()) | nil,
          :status => String.t() | nil,
          :timeout => String.t() | nil,
          :timing => GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan.t() | nil,
          :volumes => list(GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Volume.t()) | nil,
  ...
  field(:id)
  field(:name)
  field(:pullTiming, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan)
  field(:script)
  field(:secretEnv, type: :list)
  field(:status)
  field(:timeout)
  field(:timing, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1TimeSpan)
  field(:volumes, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1Volume, type: :list)
  field(:waitFor, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildStep do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildStep.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildStep do
