...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptions do
  @moduledoc """
  ...
  *   `pool` (*type:* `GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1PoolOption.t`, *default:* `nil`) - Optional. Specification for execution on a `WorkerPool`. See [running builds in a private pool](https://cloud.google.com/build/docs/private-pools/run-builds-in-private-pool) for more information.
  ...
  *   `workerPool` (*type:* `String.t`, *default:* `nil`) - This field deprecated; please use `pool.name` instead.
  ...
  @type t :: %__MODULE__{
          ...
          :pool => GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1PoolOption.t() | nil,
  ...
  field(:logging)
  field(:machineType)
  field(:pool, as: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1PoolOption)
...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptions do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuildOptions do
