...
defmodule GoogleApi.Run.V1.Model.SecretEnvSource do
  @moduledoc """
  ...
  *   `optional` (*type:* `boolean()`, *default:* `nil`) - (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos: supported Specify whether the Secret must be defined
  """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.SecretEnvSource do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.SecretEnvSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.SecretEnvSource do
