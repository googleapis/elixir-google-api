...
defmodule GoogleApi.Run.V1.Model.DomainMappingStatus do
  ...
  *   `conditions` (*type:* `list(GoogleApi.Run.V1.Model.GoogleCloudRunV1Condition.t)`, *default:* `nil`) - Array of observed DomainMappingConditions, indicating the current state
