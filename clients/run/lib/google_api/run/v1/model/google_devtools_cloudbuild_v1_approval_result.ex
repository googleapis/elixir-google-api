...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1ApprovalResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1ApprovalResult do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1ApprovalResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1ApprovalResult do
