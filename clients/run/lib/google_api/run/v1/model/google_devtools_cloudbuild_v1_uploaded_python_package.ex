...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage do
  @moduledoc """
  Artifact uploaded using the PythonPackage directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1FileHashes.t`, *default:* `nil`) - Hash types and values of the Python Artifact.
...
defimpl Poison.Decoder,
  for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedPythonPackage.decode(value, options)
  end
end
