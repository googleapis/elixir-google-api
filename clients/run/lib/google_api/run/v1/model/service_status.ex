...
defmodule GoogleApi.Run.V1.Model.ServiceStatus do
  ...
  *   `address` (*type:* `GoogleApi.Run.V1.Model.Addressable.t`, *default:* `nil`) - From RouteStatus.
  ...
  *   `observedGeneration` (*type:* `integer()`, *default:* `nil`) - ObservedGeneration is the 'Generation' of the Route that
      ...
      is True or False.
  *   `traffic` (*type:* `list(GoogleApi.Run.V1.Model.TrafficTarget.t)`, *default:* `nil`) - From RouteStatus.
