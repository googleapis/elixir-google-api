...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1GitSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1GitSource do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1GitSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1GitSource do
