...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1DeveloperConnectConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1DeveloperConnectConfig do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1DeveloperConnectConfig.decode(value, options)
  end
end
