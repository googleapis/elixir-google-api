...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1BuiltImage do
