...
defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.NamespaceStatus do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.NamespaceStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.NamespaceStatus do
