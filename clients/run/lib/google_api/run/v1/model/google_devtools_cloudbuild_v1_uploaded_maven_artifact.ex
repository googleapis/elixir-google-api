...
defmodule GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedMavenArtifact do
  @moduledoc """
  A Maven artifact uploaded using the MavenArtifact directive.

  ## Attributes

  *   `fileHashes` (*type:* `GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1FileHashes.t`, *default:* `nil`) - Hash types and values of the Maven Artifact.
...
defimpl Poison.Decoder,
  for: GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedMavenArtifact do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.GoogleDevtoolsCloudbuildV1UploadedMavenArtifact.decode(value, options)
  end
end
