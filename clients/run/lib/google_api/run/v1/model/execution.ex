...
defmodule GoogleApi.Run.V1.Model.Execution do
  ...
  *   `spec` (*type:* `GoogleApi.Run.V1.Model.ExecutionSpec.t`, *default:* `nil`) - Optional. Specification of the desired behavior of an execution.
  *   `status` (*type:* `GoogleApi.Run.V1.Model.ExecutionStatus.t`, *default:* `nil`) - Output only. Current status of an execution.
  """
