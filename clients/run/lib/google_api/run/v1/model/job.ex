...
defmodule GoogleApi.Run.V1.Model.Job do
  ...
  *   `status` (*type:* `GoogleApi.Run.V1.Model.JobStatus.t`, *default:* `nil`) - Output only. Current status of a job.
  ...
  field(:spec, as: GoogleApi.Run.V1.Model.JobSpec)
  field(:status, as: GoogleApi.Run.V1.Model.JobStatus)
end

defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.Job do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.Job.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.Job do
