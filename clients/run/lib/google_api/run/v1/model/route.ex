...
defmodule GoogleApi.Run.V1.Model.Route do
  ...
  *   `metadata` (*type:* `GoogleApi.Run.V1.Model.ObjectMeta.t`, *default:* `nil`) - Metadata associated with this Route, including name, namespace, labels,
      and annotations.
  ...
  *   `status` (*type:* `GoogleApi.Run.V1.Model.RouteStatus.t`, *default:* `nil`) - Status communicates the observed state of the Route (from the controller).
  ...
  @type t :: %__MODULE__{
          ...
          :spec => GoogleApi.Run.V1.Model.RouteSpec.t(),
          :status => GoogleApi.Run.V1.Model.RouteStatus.t()
        }
