...
defmodule GoogleApi.Run.V1.Model.Status do
  ...
  *   `code` (*type:* `integer()`, *default:* `nil`) - Suggested HTTP return code for this status, 0 if not set.
      +optional
  *   `details` (*type:* `GoogleApi.Run.V1.Model.StatusDetails.t`, *default:* `nil`) - Extended data associated with the reason.  Each reason may define its
  ...
  *   `metadata` (*type:* `GoogleApi.Run.V1.Model.ListMeta.t`, *default:* `nil`) - Standard list metadata.
      ...
      +optional
  *   `reason` (*type:* `String.t`, *default:* `nil`) - A machine-readable description of why this operation is in the
