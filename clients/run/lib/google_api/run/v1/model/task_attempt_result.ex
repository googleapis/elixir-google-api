...
defmodule GoogleApi.Run.V1.Model.TaskAttemptResult do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.Run.V1.Model.GoogleRpcStatus.t`, *default:* `nil`) - Optional. The status of this attempt. If the status code is OK, then the attempt succeeded.
  ...
  field(:exitCode)
  field(:status, as: GoogleApi.Run.V1.Model.GoogleRpcStatus)
end

defimpl Poison.Decoder, for: GoogleApi.Run.V1.Model.TaskAttemptResult do
  def decode(value, options) do
    GoogleApi.Run.V1.Model.TaskAttemptResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V1.Model.TaskAttemptResult do
