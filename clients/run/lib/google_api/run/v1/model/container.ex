...
defmodule GoogleApi.Run.V1.Model.Container do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - (Optional) Name of the container specified as a DNS_LABEL.
  ...
  *   `volumeMounts` (*type:* `list(GoogleApi.Run.V1.Model.VolumeMount.t)`, *default:* `nil`) - (Optional) Cloud Run fully managed: not supported Cloud Run for Anthos: supported Pod volumes to mount into the container's filesystem.
