...
defmodule GoogleApi.Run.V1.Model.Container do
  ...
  *   `imagePullPolicy` (*type:* `String.t`, *default:* `nil`) - Image pull policy. One of Always, Never, IfNotPresent. Defaults to Always if :latest tag is specified, or IfNotPresent otherwise.
