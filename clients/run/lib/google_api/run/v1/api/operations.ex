...
defmodule GoogleApi.Run.V1.Api.Operations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Run.V1.Model.GoogleLongrunningCancelOperationRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  """
  @spec run_operations_cancel(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Run.V1.Model.Empty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def run_operations_cancel(connection, operations_id, optional_params \\ [], opts \\ []) do
