...
defmodule GoogleApi.Run.V2.Api.Projects do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Run.V2.Model.GoogleCloudRunV2SubmitBuildRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Run.V2.Model.GoogleCloudRunV2SubmitBuildResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec run_projects_locations_builds_submit(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Run.V2.Model.GoogleCloudRunV2SubmitBuildResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def run_projects_locations_builds_submit(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v2/{+parent}/builds:submit", %{
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Run.V2.Model.GoogleCloudRunV2SubmitBuildResponse{}]
    )
  end
