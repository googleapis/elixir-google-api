...
defmodule GoogleApi.Run.V2.Model.GoogleIamV1Binding do
  @moduledoc """
  ...
  *   `role` (*type:* `String.t`, *default:* `nil`) - Role that is assigned to the list of `members`, or principals. For example, `roles/viewer`, `roles/editor`, or `roles/owner`.
  ...
  @type t :: %__MODULE__{
          :condition => GoogleApi.Run.V2.Model.GoogleTypeExpr.t() | nil,
          :members => list(String.t()) | nil,
          :role => String.t() | nil
        }

  field(:condition, as: GoogleApi.Run.V2.Model.GoogleTypeExpr)
  field(:members, type: :list)
  field(:role)
end

defimpl Poison.Decoder, for: GoogleApi.Run.V2.Model.GoogleIamV1Binding do
  def decode(value, options) do
    GoogleApi.Run.V2.Model.GoogleIamV1Binding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V2.Model.GoogleIamV1Binding do
