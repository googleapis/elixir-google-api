...
defmodule GoogleApi.Run.V2.Model.GoogleDevtoolsCloudbuildV1HttpConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V2.Model.GoogleDevtoolsCloudbuildV1HttpConfig do
  def decode(value, options) do
    GoogleApi.Run.V2.Model.GoogleDevtoolsCloudbuildV1HttpConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V2.Model.GoogleDevtoolsCloudbuildV1HttpConfig do
