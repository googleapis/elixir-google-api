...
defmodule GoogleApi.Run.V2.Model.GoogleIamV1AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Run.V2.Model.GoogleIamV1AuditLogConfig do
  def decode(value, options) do
    GoogleApi.Run.V2.Model.GoogleIamV1AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Run.V2.Model.GoogleIamV1AuditLogConfig do
