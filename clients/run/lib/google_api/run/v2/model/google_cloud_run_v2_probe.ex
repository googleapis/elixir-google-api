...
defmodule GoogleApi.Run.V2.Model.GoogleCloudRunV2Probe do
  ...
  *   `tcpSocket` (*type:* `GoogleApi.Run.V2.Model.GoogleCloudRunV2TCPSocketAction.t`, *default:* `nil`) - TCPSocket specifies an action involving a TCP port. Exactly one of HTTPGet, TCPSocket, or gRPC must be specified. TCP hooks not yet supported
  *   `timeoutSeconds` (*type:* `integer()`, *default:* `nil`) - Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Maximum value is 3600. Must be smaller than period_seconds. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
  ...
  @type t :: %__MODULE__{
          ...
          :grpc => GoogleApi.Run.V2.Model.GoogleCloudRunV2GRPCAction.t() | nil,
  ...
  field(:grpc, as: GoogleApi.Run.V2.Model.GoogleCloudRunV2GRPCAction)
