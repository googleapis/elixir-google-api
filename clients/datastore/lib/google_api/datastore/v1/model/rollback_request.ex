...
defmodule GoogleApi.Datastore.V1.Model.RollbackRequest do
  ...
  - transaction (binary()): The transaction identifier, returned by a call to Datastore.BeginTransaction. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.RollbackRequest do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.RollbackRequest.decode(value, options)
  end
end
