...
defmodule GoogleApi.Datastore.V1.Model.BeginTransactionResponse do
  ...
  - transaction (binary()): The transaction identifier (always present). Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.BeginTransactionResponse do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.BeginTransactionResponse.decode(value, options)
  end
end
