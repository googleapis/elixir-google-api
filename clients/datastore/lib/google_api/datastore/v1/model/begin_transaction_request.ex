...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.BeginTransactionRequest do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.BeginTransactionRequest.decode(value, options)
  end
end
