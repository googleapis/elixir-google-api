...
defmodule GoogleApi.Datastore.V1.Model.GoogleDatastoreAdminV1ExportEntitiesRequest do
  ...
  - entityFilter (GoogleApi.Datastore.V1.Model.GoogleDatastoreAdminV1EntityFilter.t): Description of what data from the project is included in the export. Defaults to `nil`.
