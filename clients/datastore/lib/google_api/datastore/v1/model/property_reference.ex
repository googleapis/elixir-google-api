...
defmodule GoogleApi.Datastore.V1.Model.PropertyReference do
  ...
  - name (String.t): The name of the property. If name includes \&quot;.\&quot;s, it may be interpreted as a property name path. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.PropertyReference do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.PropertyReference.decode(value, options)
  end
end
