...
defmodule GoogleApi.Datastore.V1.Model.ReadOptions do
  ...
  - readConsistency (String.t): The non-transactional read consistency to use. Cannot be set to &#x60;STRONG&#x60; for global queries. Defaults to: `null`.
    - Enum - one of [READ_CONSISTENCY_UNSPECIFIED, STRONG, EVENTUAL]
  - transaction (binary()): The identifier of the transaction in which to read. A transaction identifier is returned by a call to Datastore.BeginTransaction. Defaults to: `null`.
  """
