...
defmodule GoogleApi.Datastore.V1.Model.GoogleDatastoreAdminV1ImportEntitiesMetadata do
  ...
  *   `inputUrl` (*type:* `String.t`, *default:* `nil`) - The location of the import metadata file. This will be the same value as the google.datastore.admin.v1.ExportEntitiesResponse.output_url field.
