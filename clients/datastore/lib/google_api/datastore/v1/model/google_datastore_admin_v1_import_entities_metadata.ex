...
defmodule GoogleApi.Datastore.V1.Model.GoogleDatastoreAdminV1ImportEntitiesMetadata do
  ...
  - entityFilter (GoogleDatastoreAdminV1EntityFilter): Description of which entities are being imported. Defaults to: `null`.
  - inputUrl (String.t): The location of the import metadata file. This will be the same value as the google.datastore.admin.v1.ExportEntitiesResponse.output_url field. Defaults to: `null`.
