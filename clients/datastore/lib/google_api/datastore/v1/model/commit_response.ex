...
defmodule GoogleApi.Datastore.V1.Model.CommitResponse do
  ...
  - mutationResults ([MutationResult]): The result of performing the mutations. The i-th mutation result corresponds to the i-th mutation in the request. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.CommitResponse do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.CommitResponse.decode(value, options)
  end
end
