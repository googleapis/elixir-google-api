...
defmodule GoogleApi.Datastore.V1.Model.GoogleLongrunningOperation do
  ...
  - error (GoogleApi.Datastore.V1.Model.Status.t): The error result of the operation in case of failure or cancellation. Defaults to `nil`.
  ...
  @type t :: %__MODULE__{
          :done => boolean(),
          :error => GoogleApi.Datastore.V1.Model.Status.t(),
          :metadata => map(),
          :name => String.t(),
          :response => map()
        }
  ...
  field(:done)
  field(:error, as: GoogleApi.Datastore.V1.Model.Status)
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.GoogleLongrunningOperation.decode(value, options)
  end
end
