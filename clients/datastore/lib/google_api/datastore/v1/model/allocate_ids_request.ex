...
defmodule GoogleApi.Datastore.V1.Model.AllocateIdsRequest do
  ...
  *   `keys` (*type:* `list(GoogleApi.Datastore.V1.Model.Key.t)`, *default:* `nil`) - Required. A list of keys with incomplete key paths for which to allocate IDs.
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.AllocateIdsRequest do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.AllocateIdsRequest.decode(value, options)
  end
end
