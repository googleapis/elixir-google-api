...
defmodule GoogleApi.Datastore.V1.Model.Key do
  ...
  - partitionId (GoogleApi.Datastore.V1.Model.PartitionId.t): Entities are partitioned into subsets, currently identified by a project
  ID and namespace ID.
  Queries are scoped to a single partition. Defaults to `nil`.
  - path (list(GoogleApi.Datastore.V1.Model.PathElement.t)): The entity path.
  ...
  A path can never be empty, and a path can have at most 100 elements. Defaults to `nil`.
  """
