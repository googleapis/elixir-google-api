...
defmodule GoogleApi.Datastore.V1.Model.RunAggregationQueryRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.RunAggregationQueryRequest do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.RunAggregationQueryRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Datastore.V1.Model.RunAggregationQueryRequest do
