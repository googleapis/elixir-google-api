...
defmodule GoogleApi.Datastore.V1.Model.Status do
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.Datastore.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.Datastore.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.Status.decode(value, options)
  end
end
