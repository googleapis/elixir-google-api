...
defmodule GoogleApi.Datastore.V1.Model.LookupResponse do
  ...
  - deferred ([Key]): A list of keys that were not looked up due to resource constraints. The order of results in this field is undefined and has no relation to the order of the keys in the input. Defaults to: `null`.
  - found ([EntityResult]): Entities found as &#x60;ResultType.FULL&#x60; entities. The order of results in this field is undefined and has no relation to the order of the keys in the input. Defaults to: `null`.
  - missing ([EntityResult]): Entities not found as &#x60;ResultType.KEY_ONLY&#x60; entities. The order of results in this field is undefined and has no relation to the order of the keys in the input. Defaults to: `null`.
  """
