...
defmodule GoogleApi.Datastore.V1.Model.ReadWrite do
  ...
  - previousTransaction (binary()): The transaction identifier of the transaction being retried. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Datastore.V1.Model.ReadWrite do
  def decode(value, options) do
    GoogleApi.Datastore.V1.Model.ReadWrite.decode(value, options)
  end
end
