...
defmodule GoogleApi.Datastore.V1.Model.GoogleDatastoreAdminV1IndexedProperty do
  ...
  - direction (String.t): The indexed property&#39;s direction.  Must not be DIRECTION_UNSPECIFIED. Required. Defaults to: `null`.
    - Enum - one of [DIRECTION_UNSPECIFIED, ASCENDING, DESCENDING]
  - name (String.t): The property name to index. Required. Defaults to: `null`.
  """
