...
defmodule GoogleApi.VMMigration.V1.Model.SchedulingNodeAffinity do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.SchedulingNodeAffinity do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.SchedulingNodeAffinity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.SchedulingNodeAffinity do
