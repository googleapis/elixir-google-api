...
defmodule GoogleApi.VMMigration.V1.Model.AzureSourceVmDetails do
  @moduledoc """
  ...
  *   `disks` (*type:* `list(GoogleApi.VMMigration.V1.Model.AzureDiskDetails.t)`, *default:* `nil`) - The disks attached to the source VM.
...
defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.AzureSourceVmDetails do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.AzureSourceVmDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.AzureSourceVmDetails do
