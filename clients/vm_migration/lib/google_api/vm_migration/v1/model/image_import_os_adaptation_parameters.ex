...
defmodule GoogleApi.VMMigration.V1.Model.ImageImportOsAdaptationParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.ImageImportOsAdaptationParameters do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.ImageImportOsAdaptationParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.ImageImportOsAdaptationParameters do
