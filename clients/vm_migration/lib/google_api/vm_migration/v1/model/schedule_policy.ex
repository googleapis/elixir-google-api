...
defmodule GoogleApi.VMMigration.V1.Model.SchedulePolicy do
  @moduledoc """
  ...
  *   `skipOsAdaptation` (*type:* `boolean()`, *default:* `nil`) - A flag to indicate whether to skip OS adaptation during the replication sync. OS adaptation is a process where the VM's operating system undergoes changes and adaptations to fully function on Compute Engine.
  ...
  field(:idleDuration)
  field(:skipOsAdaptation)
end

defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.SchedulePolicy do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.SchedulePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.SchedulePolicy do
