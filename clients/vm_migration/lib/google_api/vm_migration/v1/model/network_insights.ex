...
defmodule GoogleApi.VMMigration.V1.Model.NetworkInsights do
  @moduledoc """
  ...
  *   `sourceNetworkTerraform` (*type:* `String.t`, *default:* `nil`) - Output only. The gathered network configuration of the source. Presented in terraform format.
  ...
  field(:sourceNetworkConfig)
  field(:sourceNetworkTerraform)
end

defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.NetworkInsights do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.NetworkInsights.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.NetworkInsights do
