...
defmodule GoogleApi.VMMigration.V1.Model.ServiceAccount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VMMigration.V1.Model.ServiceAccount do
  def decode(value, options) do
    GoogleApi.VMMigration.V1.Model.ServiceAccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VMMigration.V1.Model.ServiceAccount do
