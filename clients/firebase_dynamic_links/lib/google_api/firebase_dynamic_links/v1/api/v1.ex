...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Api.V1 do
  ...
  *   `dynamic_link` (*type:* `String.t`) - Dynamic Link URL. e.g. https://abcd.app.goo.gl/wxyz
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:durationDays` (*type:* `String.t`) - The span of time requested in days.
      *   `:sdkVersion` (*type:* `String.t`) - Google SDK version. Version takes the form "$major.$minor.$patch"
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.FirebaseDynamicLinks.V1.Model.GetIosPostInstallAttributionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.FirebaseDynamicLinks.V1.Model.GetIosReopenAttributionRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
