...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Api.ShortLinks do
  ...
  """
  @spec firebasedynamiclinks_short_links_create(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.FirebaseDynamicLinks.V1.Model.CreateShortDynamicLinkResponse.t} | {:error, Tesla.Env.t}
  def firebasedynamiclinks_short_links_create(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.FirebaseDynamicLinks.V1.Model.CreateShortDynamicLinkResponse{})
  end
end
