...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.CreateManagedShortLinkRequest do
  ...
  - dynamicLinkInfo (GoogleApi.FirebaseDynamicLinks.V1.Model.DynamicLinkInfo.t): Information about the Dynamic Link to be shortened.
  [Learn
  more](https://firebase.google.com/docs/reference/dynamic-links/link-shortener). Defaults to `nil`.
  - longDynamicLink (String.t): Full long Dynamic Link URL with desired query parameters specified.
  For example,
  "https://sample.app.goo.gl/?link=http://www.google.com&apn=com.sample",
  [Learn
  more](https://firebase.google.com/docs/reference/dynamic-links/link-shortener). Defaults to `nil`.
  - name (String.t): Link name to associate with the link. It's used for marketer to identify
  manually-created links in the Firebase console
  (https://console.firebase.google.com/).
  Links must be named to be tracked. Defaults to `nil`.
  - sdkVersion (String.t): Google SDK version. Version takes the form "$major.$minor.$patch" Defaults to `nil`.
  - suffix (GoogleApi.FirebaseDynamicLinks.V1.Model.Suffix.t): Short Dynamic Link suffix. Optional. Defaults to `nil`.
  """
