...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.AppPreview do
  @moduledoc """
  ...
  field(:savePositionText)
end

defimpl Poison.Decoder, for: GoogleApi.FirebaseDynamicLinks.V1.Model.AppPreview do
  def decode(value, options) do
    GoogleApi.FirebaseDynamicLinks.V1.Model.AppPreview.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.FirebaseDynamicLinks.V1.Model.AppPreview do
