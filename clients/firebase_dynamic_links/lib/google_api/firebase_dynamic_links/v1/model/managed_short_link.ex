...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.ManagedShortLink do
  ...
  - creationTime (DateTime.t): Creation timestamp of the short link. Defaults to `nil`.
  - flaggedAttribute (list(String.t)): Attributes that have been flagged about this short url. Defaults to `nil`.
  - info (GoogleApi.FirebaseDynamicLinks.V1.Model.DynamicLinkInfo.t): Full Dyamic Link info Defaults to `nil`.
  - link (String.t): Short durable link url, for example, "https://sample.app.goo.gl/xyz123".

  Required. Defaults to `nil`.
  - linkName (String.t): Link name defined by the creator.

  Required. Defaults to `nil`.
  - visibility (String.t): Visibility status of link. Defaults to `nil`.
  """
