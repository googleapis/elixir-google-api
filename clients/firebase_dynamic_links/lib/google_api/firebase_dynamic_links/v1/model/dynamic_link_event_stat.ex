...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.DynamicLinkEventStat do
  ...
  - count (String.t): The number of times this event occurred. Defaults to `nil`.
  - event (String.t): Link event. Defaults to `nil`.
  - platform (String.t): Requested platform. Defaults to `nil`.
  """
