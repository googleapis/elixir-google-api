...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.AnalyticsInfo do
  ...
  - googlePlayAnalytics (GoogleApi.FirebaseDynamicLinks.V1.Model.GooglePlayAnalytics.t): Google Play Campaign Measurements. Defaults to `nil`.
  - itunesConnectAnalytics (GoogleApi.FirebaseDynamicLinks.V1.Model.ITunesConnectAnalytics.t): iTunes Connect App Analytics. Defaults to `nil`.
  """
