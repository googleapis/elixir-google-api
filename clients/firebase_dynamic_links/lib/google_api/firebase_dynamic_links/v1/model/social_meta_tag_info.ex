...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.SocialMetaTagInfo do
  ...
  - socialDescription (String.t): A short description of the link. Optional. Defaults to `nil`.
  - socialImageLink (String.t): An image url string. Optional. Defaults to `nil`.
  - socialTitle (String.t): Title to be displayed. Optional. Defaults to `nil`.
  """
