...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Model.DynamicLinkWarning do
  ...
  - warningCode (String.t): The warning code. Defaults to `nil`.
  - warningDocumentLink (String.t): The document describing the warning, and helps resolve. Defaults to `nil`.
  - warningMessage (String.t): The warning message to help developers improve their requests. Defaults to `nil`.
  """
