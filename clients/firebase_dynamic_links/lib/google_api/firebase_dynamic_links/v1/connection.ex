...
defmodule GoogleApi.FirebaseDynamicLinks.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.FirebaseDynamicLinks.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://firebasedynamiclinks-ipv6.googleapis.com"
