...
defmodule GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1StructureParentRelation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1StructureParentRelation do
  def decode(value, options) do
    GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1StructureParentRelation.decode(
      value,
      options
    )
  end
