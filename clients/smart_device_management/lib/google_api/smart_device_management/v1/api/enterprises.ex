...
defmodule GoogleApi.SmartDeviceManagement.V1.Api.Enterprises do
  @moduledoc """
  API calls for all endpoints tagged `Enterprises`.
  """

  alias GoogleApi.SmartDeviceManagement.V1.Connection
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_devices_execute_command(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_devices_execute_command(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+name}:executeCommand", %{
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_devices_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_devices_get(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1Device{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_devices_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_structures_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_structures_get(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1Structure{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_structures_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_structures_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}/structures", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_structures_rooms_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_structures_rooms_get(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1Room{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec smartdevicemanagement_enterprises_structures_rooms_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def smartdevicemanagement_enterprises_structures_rooms_list(
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.SmartDeviceManagement.V1.Model.GoogleHomeEnterpriseSdmV1ListRoomsResponse{}
        ]
    )
  end
end
