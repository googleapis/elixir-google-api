...
defmodule GoogleApi.ServiceUsage.V1.Model.AuthProvider do
  @moduledoc """
  ...
  *   `jwtLocations` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.JwtLocation.t)`, *default:* `nil`) - Defines the locations to extract the JWT.
  ...
  field(:issuer)
  field(:jwksUri)
  field(:jwtLocations, as: GoogleApi.ServiceUsage.V1.Model.JwtLocation, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.AuthProvider do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.AuthProvider.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.AuthProvider do
