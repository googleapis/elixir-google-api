...
defmodule GoogleApi.ServiceUsage.V1.Model.HttpRule do
  ...
  *   `additionalBindings` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.HttpRule.t)`, *default:* `nil`) - Additional HTTP bindings for the selector. Nested bindings must
  ...
  *   `body` (*type:* `String.t`, *default:* `nil`) - The name of the request field whose value is mapped to the HTTP request
      ...
      message type.
  *   `custom` (*type:* `GoogleApi.ServiceUsage.V1.Model.CustomHttpPattern.t`, *default:* `nil`) - The custom pattern is used for specifying an HTTP method that is not
