...
defmodule GoogleApi.ServiceUsage.V1.Model.Method do
  @moduledoc """
  ...
  *   `options` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.Option.t)`, *default:* `nil`) - Any metadata attached to the method.
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.Method do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.Method.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.Method do
