...
defmodule GoogleApi.ServiceUsage.V1.Model.Page do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of the page. It will be used as an identity of the page to
      ...
      `Java`.
  *   `subpages` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.Page.t)`, *default:* `nil`) - Subpages of this page. The order of subpages specified here will be
  ...
  @type t :: %__MODULE__{
          :content => String.t(),
          :name => String.t(),
          :subpages => list(GoogleApi.ServiceUsage.V1.Model.Page.t())
        }
