...
defmodule GoogleApi.ServiceUsage.V1.Model.Enum do
  @moduledoc """
  ...
  *   `syntax` (*type:* `String.t`, *default:* `nil`) - The source syntax.
  ...
  @type t :: %__MODULE__{
          ...
          :enumvalue => list(GoogleApi.ServiceUsage.V1.Model.EnumValue.t()) | nil,
          :name => String.t() | nil,
  ...
  field(:edition)
  field(:enumvalue, as: GoogleApi.ServiceUsage.V1.Model.EnumValue, type: :list)
  field(:name)
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.Enum do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.Enum.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.Enum do
