...
defmodule GoogleApi.ServiceUsage.V1.Model.QuotaLimit do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.QuotaLimit do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.QuotaLimit.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.QuotaLimit do
