...
defmodule GoogleApi.ServiceUsage.V1.Model.MetricDescriptorMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.MetricDescriptorMetadata do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.MetricDescriptorMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.MetricDescriptorMetadata do
