...
defmodule GoogleApi.ServiceUsage.V1.Model.LogDescriptor do
  @moduledoc """
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - The set of labels that are available to describe a specific log entry.
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.LogDescriptor do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.LogDescriptor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.LogDescriptor do
