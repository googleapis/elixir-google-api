...
defmodule GoogleApi.ServiceUsage.V1.Model.Documentation do
  ...
  *   `rules` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.DocumentationRule.t)`, *default:* `nil`) - A list of documentation rules that apply to individual API elements.
  ...
  *   `summary` (*type:* `String.t`, *default:* `nil`) - A short summary of what the service does. Can only be provided by
  ...
  @type t :: %__MODULE__{
          ...
          :overview => String.t(),
          :pages => list(GoogleApi.ServiceUsage.V1.Model.Page.t()),
          :rules => list(GoogleApi.ServiceUsage.V1.Model.DocumentationRule.t()),
