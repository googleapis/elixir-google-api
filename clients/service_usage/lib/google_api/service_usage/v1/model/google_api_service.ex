...
defmodule GoogleApi.ServiceUsage.V1.Model.GoogleApiService do
  ...
  *   `usage` (*type:* `GoogleApi.ServiceUsage.V1.Model.Usage.t`, *default:* `nil`) - Configuration controlling usage of this service.
  ...
  @type t :: %__MODULE__{
          ...
          :enums => list(GoogleApi.ServiceUsage.V1.Model.Enum.t()) | nil,
          :http => GoogleApi.ServiceUsage.V1.Model.Http.t() | nil,
          :id => String.t() | nil,
          :logging => GoogleApi.ServiceUsage.V1.Model.Logging.t() | nil,
          :logs => list(GoogleApi.ServiceUsage.V1.Model.LogDescriptor.t()) | nil,
          :metrics => list(GoogleApi.ServiceUsage.V1.Model.MetricDescriptor.t()) | nil,
          :monitoredResources =>
          ...
          :systemTypes => list(GoogleApi.ServiceUsage.V1.Model.Type.t()) | nil,
          :title => String.t() | nil,
          :types => list(GoogleApi.ServiceUsage.V1.Model.Type.t()) | nil,
