...
defmodule GoogleApi.ServiceUsage.V1.Model.MonitoredResourceDescriptor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.MonitoredResourceDescriptor do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.MonitoredResourceDescriptor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.MonitoredResourceDescriptor do
