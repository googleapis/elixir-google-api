...
defmodule GoogleApi.ServiceUsage.V1.Model.ContextRule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.ContextRule do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.ContextRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.ContextRule do
