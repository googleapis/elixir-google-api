...
defmodule GoogleApi.ServiceUsage.V1.Model.OAuthRequirements do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.OAuthRequirements do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.OAuthRequirements.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.OAuthRequirements do
