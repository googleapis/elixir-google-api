...
defmodule GoogleApi.ServiceUsage.V1.Model.CustomError do
  ...
  *   `types` (*type:* `list(String.t)`, *default:* `nil`) - The list of custom error detail types, e.g. 'google.foo.v1.CustomError'.
  ...
  @type t :: %__MODULE__{
          :rules => list(GoogleApi.ServiceUsage.V1.Model.CustomErrorRule.t()) | nil,
          :types => list(String.t()) | nil
        }

  field(:rules, as: GoogleApi.ServiceUsage.V1.Model.CustomErrorRule, type: :list)
  field(:types, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.CustomError do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.CustomError.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.CustomError do
