...
defmodule GoogleApi.ServiceUsage.V1.Model.Publishing do
  @moduledoc """
  ...
  *   `librarySettings` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.ClientLibrarySettings.t)`, *default:* `nil`) - Client library settings. If the same version string appears multiple times in this list, then the last one wins. Settings from earlier settings with the same version string are discarded.
  *   `methodSettings` (*type:* `list(GoogleApi.ServiceUsage.V1.Model.MethodSettings.t)`, *default:* `nil`) - A list of API method settings, e.g. the behavior for methods that use the long-running operation pattern.
  ...
  *   `organization` (*type:* `String.t`, *default:* `nil`) - For whom the client library is being published.
  ...
  @type t :: %__MODULE__{
          ...
          :librarySettings =>
            list(GoogleApi.ServiceUsage.V1.Model.ClientLibrarySettings.t()) | nil,
          :methodSettings => list(GoogleApi.ServiceUsage.V1.Model.MethodSettings.t()) | nil,
  ...
  field(:githubLabel)
  field(:librarySettings, as: GoogleApi.ServiceUsage.V1.Model.ClientLibrarySettings, type: :list)
  field(:methodSettings, as: GoogleApi.ServiceUsage.V1.Model.MethodSettings, type: :list)
  field(:newIssueUri)
  field(:organization)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.Publishing do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.Publishing.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.Publishing do
