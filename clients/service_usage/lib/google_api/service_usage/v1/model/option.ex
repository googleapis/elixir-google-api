...
defmodule GoogleApi.ServiceUsage.V1.Model.Option do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.Option do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.Option.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.Option do
