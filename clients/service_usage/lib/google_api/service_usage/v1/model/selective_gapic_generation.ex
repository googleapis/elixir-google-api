...
defmodule GoogleApi.ServiceUsage.V1.Model.SelectiveGapicGeneration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.SelectiveGapicGeneration do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.SelectiveGapicGeneration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.SelectiveGapicGeneration do
