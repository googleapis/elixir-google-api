...
defmodule GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceIdentity do
  @moduledoc """
  ...
  *   `serviceAccountParent` (*type:* `String.t`, *default:* `nil`) - A service account project that hosts the service accounts.
  ...
  field(:description)
  field(:displayName)
  field(:serviceAccountParent)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceIdentity do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceIdentity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceIdentity do
