...
defmodule GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceusageV1beta1GetServiceIdentityResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceusageV1beta1GetServiceIdentityResponse do
  def decode(value, options) do
    GoogleApi.ServiceUsage.V1.Model.GoogleApiServiceusageV1beta1GetServiceIdentityResponse.decode(
      value,
      options
    )
  end
