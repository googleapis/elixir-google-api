...
defmodule GoogleApi.ServiceUsage.V1.Api.Operations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.ServiceUsage.V1.Model.CancelOperationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.ServiceUsage.V1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  ...
  def serviceusage_operations_cancel(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.ServiceUsage.V1.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.ServiceUsage.V1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def serviceusage_operations_list(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.ServiceUsage.V1.Model.ListOperationsResponse{}]
    )
  end
end
