...
defmodule GoogleApi.APIM.V1alpha.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIM.V1alpha.Model.Location do
  def decode(value, options) do
    GoogleApi.APIM.V1alpha.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIM.V1alpha.Model.Location do
