...
defmodule GoogleApi.APIM.V1alpha.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIM.V1alpha.Model.Status do
  def decode(value, options) do
    GoogleApi.APIM.V1alpha.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIM.V1alpha.Model.Status do
