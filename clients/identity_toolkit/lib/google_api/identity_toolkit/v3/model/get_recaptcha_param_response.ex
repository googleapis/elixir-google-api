...
defmodule GoogleApi.IdentityToolkit.V3.Model.GetRecaptchaParamResponse do
  ...
  - kind (String.t): The fixed string \&quot;identitytoolkit#GetRecaptchaParamResponse\&quot;. Defaults to: `null`.
  - recaptchaSiteKey (String.t): Site key registered at recaptcha. Defaults to: `null`.
  - recaptchaStoken (String.t): The stoken field for the recaptcha widget, used to request captcha challenge. Defaults to: `null`.
  """
