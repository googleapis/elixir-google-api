...
defmodule GoogleApi.IdentityToolkit.V3.Model.DeleteAccountResponse do
  ...
  - kind (String.t): The fixed string \&quot;identitytoolkit#DeleteAccountResponse\&quot;. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.IdentityToolkit.V3.Model.DeleteAccountResponse do
  def decode(value, options) do
    GoogleApi.IdentityToolkit.V3.Model.DeleteAccountResponse.decode(value, options)
  end
end
