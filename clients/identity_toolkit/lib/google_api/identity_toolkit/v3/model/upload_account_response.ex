...
defmodule GoogleApi.IdentityToolkit.V3.Model.UploadAccountResponse do
  ...
  - error ([UploadAccountResponseError]): The error encountered while processing the account info. Defaults to: `null`.
  - kind (String.t): The fixed string \&quot;identitytoolkit#UploadAccountResponse\&quot;. Defaults to: `null`.
  """
