...
defmodule GoogleApi.IdentityToolkit.V3.Model.ResetPasswordResponse do
  ...
  - email (String.t): The user&#39;s email. If the out-of-band code is for email recovery, the user&#39;s original email. Defaults to: `null`.
  - kind (String.t): The fixed string \&quot;identitytoolkit#ResetPasswordResponse\&quot;. Defaults to: `null`.
  - newEmail (String.t): If the out-of-band code is for email recovery, the user&#39;s new email. Defaults to: `null`.
