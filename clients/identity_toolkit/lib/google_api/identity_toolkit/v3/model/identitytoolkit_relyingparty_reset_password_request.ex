...
defmodule GoogleApi.IdentityToolkit.V3.Model.IdentitytoolkitRelyingpartyResetPasswordRequest do
  ...
  - newPassword (String.t): The new password inputted by the user. Defaults to: `null`.
  - oldPassword (String.t): The old password inputted by the user. Defaults to: `null`.
