...
defmodule GoogleApi.Workstations.V1.Model.GceShieldedInstanceConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Workstations.V1.Model.GceShieldedInstanceConfig do
  def decode(value, options) do
    GoogleApi.Workstations.V1.Model.GceShieldedInstanceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Workstations.V1.Model.GceShieldedInstanceConfig do
