...
defimpl Poison.Decoder, for: GoogleApi.NetworkConnectivity.V1.Model.VirtualMachine do
  def decode(value, options) do
    GoogleApi.NetworkConnectivity.V1.Model.VirtualMachine.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkConnectivity.V1.Model.VirtualMachine do
