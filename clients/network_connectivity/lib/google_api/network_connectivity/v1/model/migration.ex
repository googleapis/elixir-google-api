...
defmodule GoogleApi.NetworkConnectivity.V1.Model.Migration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkConnectivity.V1.Model.Migration do
  def decode(value, options) do
    GoogleApi.NetworkConnectivity.V1.Model.Migration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkConnectivity.V1.Model.Migration do
