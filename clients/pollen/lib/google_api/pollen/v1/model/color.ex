...
defmodule GoogleApi.Pollen.V1.Model.Color do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Pollen.V1.Model.Color do
  def decode(value, options) do
    GoogleApi.Pollen.V1.Model.Color.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Pollen.V1.Model.Color do
