...
defmodule GoogleApi.Pollen.V1.Model.HttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Pollen.V1.Model.HttpBody do
  def decode(value, options) do
    GoogleApi.Pollen.V1.Model.HttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Pollen.V1.Model.HttpBody do
