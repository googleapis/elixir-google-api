...
defmodule GoogleApi.CloudScheduler.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  @spec cloudscheduler_projects_locations_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.CloudScheduler.V1.Model.Location.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec cloudscheduler_projects_locations_jobs_create(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.CloudScheduler.V1.Model.Job.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec cloudscheduler_projects_locations_jobs_delete(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.CloudScheduler.V1.Model.Empty.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec cloudscheduler_projects_locations_jobs_list(
          ...
          {:ok, GoogleApi.CloudScheduler.V1.Model.ListJobsResponse.t()} | {:error, Tesla.Env.t()}
