...
defmodule GoogleApi.CloudScheduler.V1.Model.RetryConfig do
  ...
  *   `maxBackoffDuration` (*type:* `String.t`, *default:* `nil`) - The maximum amount of time to wait before retrying a job after
      it fails.

      The default value of this field is 1 hour.
  *   `maxDoublings` (*type:* `integer()`, *default:* `nil`) - The time between retries will double `max_doublings` times.
  ...
  *   `maxRetryDuration` (*type:* `String.t`, *default:* `nil`) - The time limit for retrying a failed job, measured from time when an
  ...
  *   `minBackoffDuration` (*type:* `String.t`, *default:* `nil`) - The minimum amount of time to wait before retrying a job after
      it fails.

      The default value of this field is 5 seconds.
  *   `retryCount` (*type:* `integer()`, *default:* `nil`) - The number of attempts that the system will make to run a job using the
