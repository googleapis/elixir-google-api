...
defmodule GoogleApi.SecurityCenter.V1.Api.Folders do
  ...
  *   `{:error, info}` on failure
  ...
  @spec securitycenter_folders_assets_group(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def securitycenter_folders_assets_group(connection, parent, optional_params \\ [], opts \\ []) do
  ...
  *   `{:error, info}` on failure
  ...
  @spec securitycenter_folders_assets_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def securitycenter_folders_assets_list(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  ...
  @spec securitycenter_folders_mute_configs_get(
          ...
          | {:ok, list()}
          | {:error, any()}
  def securitycenter_folders_mute_configs_get(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  ...
  @spec securitycenter_folders_sources_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def securitycenter_folders_sources_list(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
