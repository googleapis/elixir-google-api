...
defmodule GoogleApi.SecurityCenter.V1.Model.KernelRootkit do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.KernelRootkit do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.KernelRootkit.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.KernelRootkit do
