...
defmodule GoogleApi.SecurityCenter.V1.Model.OrganizationSettings do
  ...
  *   `enableAssetDiscovery` (*type:* `boolean()`, *default:* `nil`) - A flag that indicates if Asset Discovery should be enabled. If the flag is
      set to `true`, then discovery of assets will occur. If it is set to `false,
      all historical assets will remain, but discovery of future assets will not
      occur.
  *   `name` (*type:* `String.t`, *default:* `nil`) - The relative resource name of the settings. See:
