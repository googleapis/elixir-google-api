...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePathNode do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePathNode do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePathNode.decode(
      value,
      options
    )
  end
