...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Compliance do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Compliance do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Compliance.decode(value, options)
  end
end
