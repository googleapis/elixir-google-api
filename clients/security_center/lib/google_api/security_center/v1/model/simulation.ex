...
defmodule GoogleApi.SecurityCenter.V1.Model.Simulation do
  @moduledoc """
  ...
  *   `resourceValueConfigsMetadata` (*type:* `list(GoogleApi.SecurityCenter.V1.Model.ResourceValueConfigMetadata.t)`, *default:* `nil`) - Resource value configurations' metadata used in this simulation. Maximum of 100.
  ...
  field(:resourceValueConfigsMetadata,
    as: GoogleApi.SecurityCenter.V1.Model.ResourceValueConfigMetadata,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.Simulation do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.Simulation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.Simulation do
