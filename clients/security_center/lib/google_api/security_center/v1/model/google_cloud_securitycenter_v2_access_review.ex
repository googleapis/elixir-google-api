...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AccessReview do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AccessReview do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AccessReview.decode(
      value,
      options
    )
  end
