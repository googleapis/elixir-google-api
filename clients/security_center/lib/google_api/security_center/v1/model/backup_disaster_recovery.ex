...
defmodule GoogleApi.SecurityCenter.V1.Model.BackupDisasterRecovery do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.BackupDisasterRecovery do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.BackupDisasterRecovery.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.BackupDisasterRecovery do
