...
defmodule GoogleApi.SecurityCenter.V1.Model.PathNodeAssociatedFinding do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Full resource name of the finding.
  ...
  field(:canonicalFinding)
  field(:findingCategory)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.PathNodeAssociatedFinding do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.PathNodeAssociatedFinding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.PathNodeAssociatedFinding do
