...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1Asset do
  ...
  *   `iamPolicy` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1IamPolicy.t`, *default:* `nil`) - Cloud IAM Policy information associated with the Google Cloud resource described by the Security Command Center asset. This information is managed and defined by the Google Cloud resource and cannot be modified by the user.
  ...
  *   `securityCenterProperties` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties.t`, *default:* `nil`) - Security Command Center managed properties. These properties are managed by Security Command Center and cannot be modified by the user.
  *   `securityMarks` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1SecurityMarks.t`, *default:* `nil`) - User specified security marks. These marks are entirely managed by the user and come from the SecurityMarks resource that belongs to the asset.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - The time at which the asset was last updated, added, or deleted in Cloud SCC.
  """
