...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ExfilResource do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ExfilResource do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ExfilResource.decode(
      value,
      options
    )
  end
