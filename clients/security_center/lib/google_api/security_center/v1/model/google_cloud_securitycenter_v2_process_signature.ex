...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ProcessSignature do
  @moduledoc """
  ...
  *   `yaraRuleSignature` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2YaraRuleSignature.t`, *default:* `nil`) - Signature indicating that a YARA rule was matched.
  ...
  field(:memoryHashSignature,
    as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2MemoryHashSignature
  )

  field(:signatureType)

  field(:yaraRuleSignature,
    as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2YaraRuleSignature
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ProcessSignature do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ProcessSignature.decode(
      value,
      options
    )
  end
