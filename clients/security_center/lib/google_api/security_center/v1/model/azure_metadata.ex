...
defmodule GoogleApi.SecurityCenter.V1.Model.AzureMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.AzureMetadata do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.AzureMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.AzureMetadata do
