...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AwsOrganization do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AwsOrganization do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AwsOrganization.decode(
      value,
      options
    )
  end
