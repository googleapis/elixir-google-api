...
defimpl Poison.Decoder,
  for:
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties.decode(
      value,
      options
    )
  end
