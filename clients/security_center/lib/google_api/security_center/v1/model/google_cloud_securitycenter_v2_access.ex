...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Access do
  @moduledoc """
  ...
  *   `callerIpGeo` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Geolocation.t`, *default:* `nil`) - The caller IP's geolocation, which identifies where the call came from.
  ...
  *   `userName` (*type:* `String.t`, *default:* `nil`) - A string that represents a username. The username provided depends on the type of the finding and is likely not an IAM principal. For example, this can be a system username if the finding is related to a virtual machine, or it can be an application login username.
  ...
  @type t :: %__MODULE__{
          ...
          :callerIpGeo =>
            GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Geolocation.t() | nil,
          :methodName => String.t() | nil,
          :principalEmail => String.t() | nil,
          :principalSubject => String.t() | nil,
          :serviceAccountDelegationInfo =>
            list(
              GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo.t()
            )
            | nil,
  ...
  field(:callerIpGeo, as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Geolocation)
  ...
  field(:serviceAccountDelegationInfo,
    as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Access do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Access.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Access do
