...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Application do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Application do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2Application.decode(
      value,
      options
    )
  end
