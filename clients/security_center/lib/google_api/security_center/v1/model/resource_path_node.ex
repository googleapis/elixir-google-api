...
defmodule GoogleApi.SecurityCenter.V1.Model.ResourcePathNode do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.ResourcePathNode do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.ResourcePathNode.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.ResourcePathNode do
