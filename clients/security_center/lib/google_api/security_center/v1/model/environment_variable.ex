...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.EnvironmentVariable do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.EnvironmentVariable.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.EnvironmentVariable do
