...
defmodule GoogleApi.SecurityCenter.V1.Model.ToxicCombination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.ToxicCombination do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.ToxicCombination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.ToxicCombination do
