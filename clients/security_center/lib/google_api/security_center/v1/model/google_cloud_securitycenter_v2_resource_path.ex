...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePath do
  @moduledoc """
  ...
  *   `nodes` (*type:* `list(GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePathNode.t)`, *default:* `nil`) - The list of nodes that make the up resource path, ordered from lowest level to highest level.
  ...
  field(:nodes,
    as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePathNode,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePath do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2ResourcePath.decode(
      value,
      options
    )
  end
