...
defmodule GoogleApi.SecurityCenter.V1.Model.IamBinding do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.IamBinding do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.IamBinding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.IamBinding do
