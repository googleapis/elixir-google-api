...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AttackExposure do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. What state this AttackExposure is in. This captures whether or not an attack exposure has been calculated or not.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AttackExposure do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2AttackExposure.decode(
      value,
      options
    )
  end
