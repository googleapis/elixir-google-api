...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudDlpInspection do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudDlpInspection do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudDlpInspection.decode(
      value,
      options
    )
  end
