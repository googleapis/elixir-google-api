...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2SecurityMarks do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2SecurityMarks do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2SecurityMarks.decode(
      value,
      options
    )
  end
