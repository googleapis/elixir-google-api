...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.Pod do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.Pod.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.Pod do
