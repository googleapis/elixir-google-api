...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2IamBinding do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2IamBinding do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2IamBinding.decode(value, options)
  end
end
