...
defmodule GoogleApi.SecurityCenter.V1.Model.ListDescendantSecurityHealthAnalyticsCustomModulesResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.SecurityCenter.V1.Model.ListDescendantSecurityHealthAnalyticsCustomModulesResponse do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.ListDescendantSecurityHealthAnalyticsCustomModulesResponse.decode(
      value,
      options
    )
  end
