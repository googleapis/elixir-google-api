...
defmodule GoogleApi.SecurityCenter.V1.Model.Package do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.Package do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.Package.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.Package do
