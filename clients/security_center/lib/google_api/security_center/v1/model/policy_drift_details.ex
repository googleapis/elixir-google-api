...
defmodule GoogleApi.SecurityCenter.V1.Model.PolicyDriftDetails do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.PolicyDriftDetails do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.PolicyDriftDetails.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.PolicyDriftDetails do
