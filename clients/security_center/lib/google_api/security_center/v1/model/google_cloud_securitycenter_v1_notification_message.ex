...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1NotificationMessage do
  @moduledoc """
  ...
  *   `resource` (*type:* `GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1Resource.t`, *default:* `nil`) - The Cloud resource tied to this notification's Finding.
  ...
  field(:resource, as: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1Resource)
end

defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1NotificationMessage do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1NotificationMessage.decode(
      value,
      options
    )
  end
