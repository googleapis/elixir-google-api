...
defmodule GoogleApi.SecurityCenter.V1.Model.GroupFindingsRequest do
  ...
  *   `compareDuration` (*type:* `String.t`, *default:* `nil`) - When compare_duration is set, the GroupResult's "state_change" attribute is
      ...
      * "REMOVED":   indicates that the finding was present and matched the
      ...
      `group_by`.
  *   `filter` (*type:* `String.t`, *default:* `nil`) - Expression that defines the filter to apply across findings.
  ...
  *   `pageToken` (*type:* `String.t`, *default:* `nil`) - The value returned by the last `GroupFindingsResponse`; indicates
      that this is a continuation of a prior `GroupFindings` call, and
      that the system should return the next page of data.
  *   `readTime` (*type:* `DateTime.t`, *default:* `nil`) - Time used as a reference point when filtering findings. The filter is
