...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudLoggingEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudLoggingEntry do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2CloudLoggingEntry.decode(
      value,
      options
    )
  end
