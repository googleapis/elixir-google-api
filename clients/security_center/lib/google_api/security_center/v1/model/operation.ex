...
defmodule GoogleApi.SecurityCenter.V1.Model.Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.SecurityCenter.V1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - The normal response of the operation in case of success. If the original method returns no data on success, such as `Delete`, the response is `google.protobuf.Empty`. If the original method is standard `Get`/`Create`/`Update`, the response should be the resource. For other methods, the response should have the type `XxxResponse`, where `Xxx` is the original method name. For example, if the original method name is `TakeSnapshot()`, the inferred response type is `TakeSnapshotResponse`.
  ...
  @type t :: %__MODULE__{
          :done => boolean(),
          :error => GoogleApi.SecurityCenter.V1.Model.Status.t(),
          :metadata => map(),
          :name => String.t(),
          :response => map()
        }
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.Operation do
