...
defmodule GoogleApi.SecurityCenter.V1.Model.DataFlowEvent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.DataFlowEvent do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.DataFlowEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.DataFlowEvent do
