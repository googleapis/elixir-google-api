...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV1MuteConfig do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - This field will be ignored if provided on config creation. Format "organizations/{organization}/muteConfigs/{mute_config}" "folders/{folder}/muteConfigs/{mute_config}" "projects/{project}/muteConfigs/{mute_config}"
