...
defmodule GoogleApi.SecurityCenter.V1.Model.StaticMute do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.StaticMute do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.StaticMute.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.StaticMute do
