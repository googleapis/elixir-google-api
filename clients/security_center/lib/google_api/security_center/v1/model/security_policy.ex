...
defmodule GoogleApi.SecurityCenter.V1.Model.SecurityPolicy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.SecurityPolicy do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.SecurityPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.SecurityPolicy do
