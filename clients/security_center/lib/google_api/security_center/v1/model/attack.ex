...
defmodule GoogleApi.SecurityCenter.V1.Model.Attack do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.Attack do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.Attack.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.Attack do
