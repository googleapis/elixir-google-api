...
defmodule GoogleApi.SecurityCenter.V1.Model.PortRange do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.PortRange do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.PortRange.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.PortRange do
