...
defmodule GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2PolicyDriftDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2PolicyDriftDetails do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.GoogleCloudSecuritycenterV2PolicyDriftDetails.decode(
      value,
      options
    )
  end
