...
defmodule GoogleApi.SecurityCenter.V1.Model.MuteInfo do
  @moduledoc """
  ...
  *   `staticMute` (*type:* `GoogleApi.SecurityCenter.V1.Model.StaticMute.t`, *default:* `nil`) - If set, the static mute applied to this finding. Static mutes override dynamic mutes. If unset, there is no static mute.
  ...
  @type t :: %__MODULE__{
          :dynamicMuteRecords =>
            list(GoogleApi.SecurityCenter.V1.Model.DynamicMuteRecord.t()) | nil,
          :staticMute => GoogleApi.SecurityCenter.V1.Model.StaticMute.t() | nil
        }

  field(:dynamicMuteRecords, as: GoogleApi.SecurityCenter.V1.Model.DynamicMuteRecord, type: :list)
  field(:staticMute, as: GoogleApi.SecurityCenter.V1.Model.StaticMute)
end

defimpl Poison.Decoder, for: GoogleApi.SecurityCenter.V1.Model.MuteInfo do
  def decode(value, options) do
    GoogleApi.SecurityCenter.V1.Model.MuteInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SecurityCenter.V1.Model.MuteInfo do
