...
defmodule GoogleApi.Directory.Directory_v1.Api.Tokens do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec directory_tokens_delete(Tesla.Env.client(), String.t, String.t, keyword(), keyword()) :: {:ok, nil} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:ok, %GoogleApi.Directory.Directory_v1.Model.Token{}}` on success
  *   `{:error, info}` on failure
  """
  @spec directory_tokens_get(Tesla.Env.client(), String.t, String.t, keyword(), keyword()) :: {:ok, GoogleApi.Directory.Directory_v1.Model.Token.t} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  def directory_tokens_get(connection, user_key, client_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Directory.Directory_v1.Model.Token{}])
  end
  ...
  *   `{:ok, %GoogleApi.Directory.Directory_v1.Model.Tokens{}}` on success
  *   `{:error, info}` on failure
  """
  @spec directory_tokens_list(Tesla.Env.client(), String.t, keyword(), keyword()) :: {:ok, GoogleApi.Directory.Directory_v1.Model.Tokens.t} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  def directory_tokens_list(connection, user_key, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Directory.Directory_v1.Model.Tokens{}])
  end
