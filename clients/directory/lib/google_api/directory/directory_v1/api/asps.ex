...
defmodule GoogleApi.Directory.Directory_v1.Api.Asps do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec directory_asps_delete(Tesla.Env.client(), String.t, integer(), keyword(), keyword()) :: {:ok, nil} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:ok, %GoogleApi.Directory.Directory_v1.Model.Asp{}}` on success
  *   `{:error, info}` on failure
  """
  @spec directory_asps_get(Tesla.Env.client(), String.t, integer(), keyword(), keyword()) :: {:ok, GoogleApi.Directory.Directory_v1.Model.Asp.t} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  def directory_asps_get(connection, user_key, code_id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Directory.Directory_v1.Model.Asp{}])
  end
  ...
  *   `{:ok, %GoogleApi.Directory.Directory_v1.Model.Asps{}}` on success
  *   `{:error, info}` on failure
  """
  @spec directory_asps_list(Tesla.Env.client(), String.t, keyword(), keyword()) :: {:ok, GoogleApi.Directory.Directory_v1.Model.Asps.t} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  def directory_asps_list(connection, user_key, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Directory.Directory_v1.Model.Asps{}])
  end
