...
defmodule GoogleApi.Directory.Directory_v1.Api.Privileges do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Directory.Directory_v1.Model.Privileges{}}` on success
  *   `{:error, info}` on failure
  """
  @spec directory_privileges_list(Tesla.Env.client(), String.t, keyword(), keyword()) :: {:ok, GoogleApi.Directory.Directory_v1.Model.Privileges.t} | {:ok, Tesla.Env.t()} | {:error, Tesla.Env.t()}
  def directory_privileges_list(connection, customer, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Directory.Directory_v1.Model.Privileges{}])
  end
