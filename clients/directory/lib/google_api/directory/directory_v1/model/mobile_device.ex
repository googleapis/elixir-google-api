...
defmodule GoogleApi.Directory.Directory_v1.Model.MobileDevice do
  @moduledoc """
  ...
  *   `applications` (*type:* `list(GoogleApi.Directory.Directory_v1.Model.MobileDeviceApplications.t)`, *default:* `nil`) - List of applications installed on Mobile Device
  *   `otherAccountsInfo` (*type:* `list(String.t)`, *default:* `nil`) - List of accounts added on device (Read-only)
  ...
  @type t :: %__MODULE__{
      ...
      :"applications" => list(GoogleApi.Directory.Directory_v1.Model.MobileDeviceApplications.t),
  ...
  field(:"applications", as: GoogleApi.Directory.Directory_v1.Model.MobileDeviceApplications, type: :list)
  field(:"otherAccountsInfo", type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Directory.Directory_v1.Model.MobileDevice do
  def decode(value, options) do
    GoogleApi.Directory.Directory_v1.Model.MobileDevice.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Directory.Directory_v1.Model.MobileDevice do
