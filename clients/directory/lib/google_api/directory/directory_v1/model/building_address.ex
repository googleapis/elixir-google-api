...
defmodule GoogleApi.Directory.Directory_v1.Model.BuildingAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Directory.Directory_v1.Model.BuildingAddress do
  def decode(value, options) do
    GoogleApi.Directory.Directory_v1.Model.BuildingAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Directory.Directory_v1.Model.BuildingAddress do
