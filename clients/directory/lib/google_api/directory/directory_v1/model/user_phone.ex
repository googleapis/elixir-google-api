...
defmodule GoogleApi.Directory.Directory_v1.Model.UserPhone do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Directory.Directory_v1.Model.UserPhone do
  def decode(value, options) do
    GoogleApi.Directory.Directory_v1.Model.UserPhone.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Directory.Directory_v1.Model.UserPhone do
