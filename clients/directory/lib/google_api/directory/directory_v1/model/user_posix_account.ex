...
defmodule GoogleApi.Directory.Directory_v1.Model.UserPosixAccount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Directory.Directory_v1.Model.UserPosixAccount do
  def decode(value, options) do
    GoogleApi.Directory.Directory_v1.Model.UserPosixAccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Directory.Directory_v1.Model.UserPosixAccount do
