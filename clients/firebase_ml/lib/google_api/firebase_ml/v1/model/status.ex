...
defmodule GoogleApi.FirebaseML.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.FirebaseML.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.FirebaseML.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.FirebaseML.V1.Model.Status do
