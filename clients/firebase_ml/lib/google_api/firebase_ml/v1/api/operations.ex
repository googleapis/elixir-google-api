...
defmodule GoogleApi.FirebaseML.V1.Api.Operations do
  @moduledoc """
  API calls for all endpoints tagged `Operations`.
  """

  alias GoogleApi.FirebaseML.V1.Connection
  ...
  *   `connection` (*type:* `GoogleApi.FirebaseML.V1.Connection.t`) - Connection to server
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.FirebaseML.V1.Model.CancelOperationRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.FirebaseML.V1.Model.Empty{}}` on success
  *   `{:error, info}` on failure
  ...
  def firebaseml_operations_cancel(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.FirebaseML.V1.Model.Empty{}])
  end
  ...
  *   `{:ok, %GoogleApi.FirebaseML.V1.Model.ListOperationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def firebaseml_operations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.FirebaseML.V1.Model.ListOperationsResponse{}])
  end
end
