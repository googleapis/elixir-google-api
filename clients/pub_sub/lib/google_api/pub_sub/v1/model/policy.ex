...
defmodule GoogleApi.PubSub.V1.Model.Policy do
  @moduledoc """
  ...
  *   `bindings` (*type:* `list(GoogleApi.PubSub.V1.Model.Binding.t)`, *default:* `nil`) - Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
...
defimpl Poison.Decoder, for: GoogleApi.PubSub.V1.Model.Policy do
  def decode(value, options) do
    GoogleApi.PubSub.V1.Model.Policy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PubSub.V1.Model.Policy do
