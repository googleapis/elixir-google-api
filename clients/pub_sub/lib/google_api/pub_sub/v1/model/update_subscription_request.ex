...
defmodule GoogleApi.PubSub.V1.Model.UpdateSubscriptionRequest do
  ...
  - subscription (GoogleApi.PubSub.V1.Model.Subscription.t): The updated subscription object. Defaults to `nil`.
  - updateMask (String.t): Indicates which fields in the provided subscription to update.
  Must be specified and non-empty. Defaults to `nil`.
  """
