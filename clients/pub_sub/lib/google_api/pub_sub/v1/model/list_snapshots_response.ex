...
defmodule GoogleApi.PubSub.V1.Model.ListSnapshotsResponse do
  ...
  - nextPageToken (String.t): If not empty, indicates that there may be more snapshot that match the
  request; this value should be passed in a new `ListSnapshotsRequest`. Defaults to `nil`.
  - snapshots (list(GoogleApi.PubSub.V1.Model.Snapshot.t)): The resulting snapshots. Defaults to `nil`.
  """
