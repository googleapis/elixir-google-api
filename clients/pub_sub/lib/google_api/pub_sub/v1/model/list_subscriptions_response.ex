...
defmodule GoogleApi.PubSub.V1.Model.ListSubscriptionsResponse do
  ...
  `ListSubscriptionsRequest` to get more subscriptions. Defaults to `nil`.
  - subscriptions (list(GoogleApi.PubSub.V1.Model.Subscription.t)): The subscriptions that match the request. Defaults to `nil`.
  """
