...
defmodule GoogleApi.PubSub.V1.Model.UpdateTopicRequest do
  ...
  - topic (GoogleApi.PubSub.V1.Model.Topic.t): The updated topic object. Defaults to `nil`.
  - updateMask (String.t): Indicates which fields in the provided topic to update. Must be specified
  and non-empty. Note that if `update_mask` contains
  "message_storage_policy" then the new value will be determined based on the
  policy configured at the project or organization level. The
  `message_storage_policy` must not be set in the `topic` provided above. Defaults to `nil`.
  """
