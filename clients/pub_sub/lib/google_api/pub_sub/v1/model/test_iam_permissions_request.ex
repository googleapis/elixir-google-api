...
defmodule GoogleApi.PubSub.V1.Model.TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PubSub.V1.Model.TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.PubSub.V1.Model.TestIamPermissionsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PubSub.V1.Model.TestIamPermissionsRequest do
