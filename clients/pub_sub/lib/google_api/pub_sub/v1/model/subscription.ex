...
defmodule GoogleApi.PubSub.V1.Model.Subscription do
  ...
  *   `bigqueryConfig` (*type:* `GoogleApi.PubSub.V1.Model.BigQueryConfig.t`, *default:* `nil`) - If delivery to BigQuery is used with this subscription, this field is used to configure it.
  ...
  *   `pushConfig` (*type:* `GoogleApi.PubSub.V1.Model.PushConfig.t`, *default:* `nil`) - If push delivery is used with this subscription, this field is used to configure it.
