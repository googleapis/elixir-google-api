...
defmodule GoogleApi.PubSub.V1.Model.ListTopicsResponse do
  ...
  - nextPageToken (String.t): If not empty, indicates that there may be more topics that match the request; this value should be passed in a new &#x60;ListTopicsRequest&#x60;. Defaults to: `null`.
  - topics ([Topic]): The resulting topics. Defaults to: `null`.
  """
