...
defmodule GoogleApi.PubSub.V1.Model.ListTopicsResponse do
  ...
  - nextPageToken (String.t): If not empty, indicates that there may be more topics that match the
  request; this value should be passed in a new `ListTopicsRequest`. Defaults to `nil`.
  - topics (list(GoogleApi.PubSub.V1.Model.Topic.t)): The resulting topics. Defaults to `nil`.
  """
