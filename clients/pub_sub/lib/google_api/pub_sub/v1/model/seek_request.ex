...
defmodule GoogleApi.PubSub.V1.Model.SeekRequest do
  ...
  *   `snapshot` (*type:* `String.t`, *default:* `nil`) - The snapshot to seek to. The snapshot's topic must be the same as that of
      the provided subscription.
      Format is `projects/{project}/snapshots/{snap}`.
  *   `time` (*type:* `DateTime.t`, *default:* `nil`) - The time to seek to.
