...
defmodule GoogleApi.PubSub.V1.Model.SeekRequest do
  ...
  - snapshot (String.t): The snapshot to seek to. The snapshot's topic must be the same as that of
  the provided subscription.
  Format is `projects/{project}/snapshots/{snap}`. Defaults to `nil`.
  - time (DateTime.t): The time to seek to.
  ...
  and already-expunged messages will not be restored. Defaults to `nil`.
  """
