...
defmodule GoogleApi.PubSub.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PubSub.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.PubSub.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PubSub.V1.Model.Expr do
