...
defmodule GoogleApi.PubSub.V1.Model.PullResponse do
  ...
  - receivedMessages (list(GoogleApi.PubSub.V1.Model.ReceivedMessage.t)): Received Pub/Sub messages. The list will be empty if there are no more
  messages available in the backlog. For JSON, the response can be entirely
  empty. The Pub/Sub system may return fewer than the `maxMessages` requested
  even if there are more messages available in the backlog. Defaults to `nil`.
  """
