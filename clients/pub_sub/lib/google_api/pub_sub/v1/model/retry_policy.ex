...
defmodule GoogleApi.PubSub.V1.Model.RetryPolicy do
  ...
  *   `maximumBackoff` (*type:* `String.t`, *default:* `nil`) - The maximum delay between consecutive deliveries of a given message.
      Value should be between 0 and 600 seconds. Defaults to 600 seconds.
  *   `minimumBackoff` (*type:* `String.t`, *default:* `nil`) - The minimum delay between consecutive deliveries of a given message.
