...
defmodule GoogleApi.PubSub.V1.Model.ReceivedMessage do
  ...
  - ackId (String.t): This ID can be used to acknowledge the received message. Defaults to `nil`.
  - message (GoogleApi.PubSub.V1.Model.PubsubMessage.t): The message. Defaults to `nil`.
  """
