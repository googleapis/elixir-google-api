...
defmodule GoogleApi.PubSub.V1.Model.UpdateSnapshotRequest do
  ...
  - snapshot (GoogleApi.PubSub.V1.Model.Snapshot.t): The updated snapshot object. Defaults to `nil`.
  - updateMask (String.t): Indicates which fields in the provided snapshot to update.
