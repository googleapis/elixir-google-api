...
defmodule GoogleApi.AdMob.V1.Model.NetworkReportSpecDimensionFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdMob.V1.Model.NetworkReportSpecDimensionFilter do
  def decode(value, options) do
    GoogleApi.AdMob.V1.Model.NetworkReportSpecDimensionFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdMob.V1.Model.NetworkReportSpecDimensionFilter do
