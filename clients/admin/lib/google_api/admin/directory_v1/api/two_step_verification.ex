...
defmodule GoogleApi.Admin.Directory_v1.Api.TwoStepVerification do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec directory_two_step_verification_turn_off(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def directory_two_step_verification_turn_off(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/admin/directory/v1/users/{userKey}/twoStepVerification/turnOff", %{
