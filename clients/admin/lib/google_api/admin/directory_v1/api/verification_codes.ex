...
defmodule GoogleApi.Admin.Directory_v1.Api.VerificationCodes do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec directory_verification_codes_generate(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec directory_verification_codes_invalidate(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:ok, %GoogleApi.Admin.Directory_v1.Model.VerificationCodes{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def directory_verification_codes_list(connection, user_key, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Admin.Directory_v1.Model.VerificationCodes{}])
  end
end
