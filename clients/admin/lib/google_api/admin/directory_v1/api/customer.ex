...
defmodule GoogleApi.Admin.Directory_v1.Api.Customer do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.Admin.Directory_v1.Model.DirectoryChromeosdevicesIssueCommandRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Admin.Directory_v1.Model.DirectoryChromeosdevicesIssueCommandResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec admin_customer_devices_chromeos_issue_command(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `customer_id` (*type:* `String.t`) - Immutable. ID of the Google Workspace account.
  *   `device_id` (*type:* `String.t`) - Immutable. ID of Chrome OS Device.
  *   `command_id` (*type:* `String.t`) - Immutable. ID of Chrome OS Device Command.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.Admin.Directory_v1.Model.DirectoryChromeosdevicesCommand{}}` on success
  *   `{:error, info}` on failure
  """
  @spec admin_customer_devices_chromeos_commands_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def admin_customer_devices_chromeos_commands_get(
    ...
    request =
      ...
      |> Request.url(
        ...
        %{
          "customerId" => URI.encode(customer_id, &URI.char_unreserved?/1),
          "deviceId" => URI.encode(device_id, &URI.char_unreserved?/1),
          "commandId" => URI.encode(command_id, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Admin.Directory_v1.Model.DirectoryChromeosdevicesCommand{}]
    )
  end
end
