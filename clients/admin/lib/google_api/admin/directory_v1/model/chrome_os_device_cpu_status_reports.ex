...
defmodule GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReports do
  @moduledoc """
  ...
  *   `reportTime` (*type:* `DateTime.t`, *default:* `nil`) - Date and time the report was received.
  ...
  field(:cpuTemperatureInfo,
    as: GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReports do
  def decode(value, options) do
    GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReports.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReports do
