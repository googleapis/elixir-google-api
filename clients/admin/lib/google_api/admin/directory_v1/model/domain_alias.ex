...
defimpl Poison.Decoder, for: GoogleApi.Admin.Directory_v1.Model.DomainAlias do
  def decode(value, options) do
    GoogleApi.Admin.Directory_v1.Model.DomainAlias.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Admin.Directory_v1.Model.DomainAlias do
