...
defimpl Poison.Decoder, for: GoogleApi.Admin.Directory_v1.Model.UserName do
  def decode(value, options) do
    GoogleApi.Admin.Directory_v1.Model.UserName.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Admin.Directory_v1.Model.UserName do
