...
defmodule GoogleApi.Admin.Directory_v1.Model.Channel do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Admin.Directory_v1.Model.Channel do
  def decode(value, options) do
    GoogleApi.Admin.Directory_v1.Model.Channel.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Admin.Directory_v1.Model.Channel do
