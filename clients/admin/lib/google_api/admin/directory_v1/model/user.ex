...
defmodule GoogleApi.Admin.Directory_v1.Model.User do
  ...
  *   `posixAccounts` (*type:* `any()`, *default:* `nil`) - A list of [POSIX](http://www.opengroup.org/austin/papers/posix_faq.html) account information for the user.
  ...
  *   `ipWhitelisted` (*type:* `boolean()`, *default:* `nil`) - If `true`, the user's IP address is [white listed](http://support.google.com/a/bin/answer.py?answer=60752).
