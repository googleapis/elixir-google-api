...
defmodule GoogleApi.Admin.Directory_v1.Model.ChromeOsDevice do
  ...
  *   `lastKnownNetwork` (*type:* `list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceLastKnownNetwork.t)`, *default:* `nil`) - Contains last used network (Read-only)
  ...
  @type t :: %__MODULE__{
          ...
          :deviceFiles => list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceDeviceFiles.t()),
          :etag => String.t(),
          ...
          :meid => String.t(),
          :tpmVersionInfo => GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceTpmVersionInfo.t(),
          :activeTimeRanges =>
            list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceActiveTimeRanges.t()),
          :bootMode => String.t(),
          :ethernetMacAddress => String.t(),
          :lastEnrollmentTime => DateTime.t(),
          :diskVolumeReports =>
            list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceDiskVolumeReports.t()),
          :systemRamFreeReports =>
            list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceSystemRamFreeReports.t()),
          :annotatedAssetId => String.t(),
          :cpuStatusReports =>
            list(GoogleApi.Admin.Directory_v1.Model.ChromeOsDeviceCpuStatusReports.t()),
