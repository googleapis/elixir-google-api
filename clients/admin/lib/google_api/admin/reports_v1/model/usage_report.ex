...
defmodule GoogleApi.Admin.Reports_v1.Model.UsageReport do
  ...
  - parameters ([UsageReportParameters]): Parameter value pairs for various applications. Defaults to: `null`.
  - date (String.t): The date to which the record belongs. Defaults to: `null`.
