...
defmodule GoogleApi.Genomics.V2alpha1.Model.Mount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V2alpha1.Model.Mount do
  def decode(value, options) do
    GoogleApi.Genomics.V2alpha1.Model.Mount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V2alpha1.Model.Mount do
