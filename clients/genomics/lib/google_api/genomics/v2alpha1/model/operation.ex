...
defmodule GoogleApi.Genomics.V2alpha1.Model.Operation do
  @moduledoc """
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - An Empty object.
  ...
  field(:done)
  field(:error, as: GoogleApi.Genomics.V2alpha1.Model.Status)
  field(:metadata, type: :map)
  field(:name)
  field(:response, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V2alpha1.Model.Operation do
  def decode(value, options) do
    GoogleApi.Genomics.V2alpha1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V2alpha1.Model.Operation do
