...
defmodule GoogleApi.Genomics.V2alpha1.Model.VirtualMachine do
  @moduledoc """
  Carries information about a Compute Engine VM resource.

  ## Attributes

  *   `accelerators` (*type:* `list(GoogleApi.Genomics.V2alpha1.Model.Accelerator.t)`, *default:* `nil`) - The list of accelerators to attach to the VM.
  ...
  *   `disks` (*type:* `list(GoogleApi.Genomics.V2alpha1.Model.Disk.t)`, *default:* `nil`) - The list of disks to create and attach to the VM. Specify either the `volumes[]` field or the `disks[]` field, but not both.
  ...
  *   `network` (*type:* `GoogleApi.Genomics.V2alpha1.Model.Network.t`, *default:* `nil`) - The VM network configuration.
  ...
  *   `serviceAccount` (*type:* `GoogleApi.Genomics.V2alpha1.Model.ServiceAccount.t`, *default:* `nil`) - The service account to install on the VM. This account does not need any permissions other than those required by the pipeline.
  *   `volumes` (*type:* `list(GoogleApi.Genomics.V2alpha1.Model.Volume.t)`, *default:* `nil`) - The list of disks and other storage to create or attach to the VM. Specify either the `volumes[]` field or the `disks[]` field, but not both.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :accelerators => list(GoogleApi.Genomics.V2alpha1.Model.Accelerator.t()) | nil,
          :bootDiskSizeGb => integer() | nil,
          :bootImage => String.t() | nil,
          :cpuPlatform => String.t() | nil,
          :disks => list(GoogleApi.Genomics.V2alpha1.Model.Disk.t()) | nil,
          :dockerCacheImages => list(String.t()) | nil,
          :enableStackdriverMonitoring => boolean() | nil,
          :labels => map() | nil,
          :machineType => String.t() | nil,
          :network => GoogleApi.Genomics.V2alpha1.Model.Network.t() | nil,
          :nvidiaDriverVersion => String.t() | nil,
          :preemptible => boolean() | nil,
          :reservation => String.t() | nil,
          :serviceAccount => GoogleApi.Genomics.V2alpha1.Model.ServiceAccount.t() | nil,
          :volumes => list(GoogleApi.Genomics.V2alpha1.Model.Volume.t()) | nil
        }

  field(:accelerators, as: GoogleApi.Genomics.V2alpha1.Model.Accelerator, type: :list)
  field(:bootDiskSizeGb)
  field(:bootImage)
  field(:cpuPlatform)
  field(:disks, as: GoogleApi.Genomics.V2alpha1.Model.Disk, type: :list)
  field(:dockerCacheImages, type: :list)
  field(:enableStackdriverMonitoring)
  field(:labels, type: :map)
  field(:machineType)
  field(:network, as: GoogleApi.Genomics.V2alpha1.Model.Network)
  field(:nvidiaDriverVersion)
  field(:preemptible)
  field(:reservation)
  field(:serviceAccount, as: GoogleApi.Genomics.V2alpha1.Model.ServiceAccount)
  field(:volumes, as: GoogleApi.Genomics.V2alpha1.Model.Volume, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V2alpha1.Model.VirtualMachine do
  def decode(value, options) do
    GoogleApi.Genomics.V2alpha1.Model.VirtualMachine.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V2alpha1.Model.VirtualMachine do
