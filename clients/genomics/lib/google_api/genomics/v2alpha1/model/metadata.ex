...
defmodule GoogleApi.Genomics.V2alpha1.Model.Metadata do
  @moduledoc """
  ...
  *   `startTime` (*type:* `DateTime.t`, *default:* `nil`) - The first time at which resources were allocated to execute the pipeline.
  ...
  @type t :: %__MODULE__{
          ...
          :events => list(GoogleApi.Genomics.V2alpha1.Model.Event.t()) | nil,
          :labels => map() | nil,
  ...
  field(:events, as: GoogleApi.Genomics.V2alpha1.Model.Event, type: :list)
  field(:labels, type: :map)
  field(:pipeline, as: GoogleApi.Genomics.V2alpha1.Model.Pipeline)
  field(:startTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V2alpha1.Model.Metadata do
  def decode(value, options) do
    GoogleApi.Genomics.V2alpha1.Model.Metadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V2alpha1.Model.Metadata do
