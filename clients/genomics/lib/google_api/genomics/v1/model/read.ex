...
defmodule GoogleApi.Genomics.V1.Model.Read do
  ...
  - fragmentName (String.t): The fragment name. Equivalent to QNAME (query template name) in SAM. Defaults to: `null`.
  - id (String.t): The server-generated read ID, unique across all reads. This is different from the &#x60;fragmentName&#x60;. Defaults to: `null`.
  ...
  - readGroupId (String.t): The ID of the read group this read belongs to. A read belongs to exactly one read group. This is a server-generated ID which is distinct from SAM&#39;s RG tag (for that value, see ReadGroup.name). Defaults to: `null`.
  - readGroupSetId (String.t): The ID of the read group set this read belongs to. A read belongs to exactly one read group set. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :info => map(),
          :alignedQuality => list(any()),
          :alignedSequence => any(),
          :alignment => GoogleApi.Genomics.V1.Model.LinearAlignment.t(),
          :duplicateFragment => any(),
          :failedVendorQualityChecks => any(),
          :fragmentLength => any(),
          :fragmentName => any(),
          :id => any(),
          :nextMatePosition => GoogleApi.Genomics.V1.Model.Position.t(),
          :numberReads => any(),
          :properPlacement => any(),
          :readGroupId => any(),
          :readGroupSetId => any(),
          :readNumber => any(),
          :secondaryAlignment => any(),
          :supplementaryAlignment => any()
        }

  field(:info, type: :map)
  field(:alignedQuality, type: :list)
  field(:alignedSequence)
  field(:alignment, as: GoogleApi.Genomics.V1.Model.LinearAlignment)
  field(:duplicateFragment)
  field(:failedVendorQualityChecks)
  field(:fragmentLength)
  field(:fragmentName)
  field(:id)
  field(:nextMatePosition, as: GoogleApi.Genomics.V1.Model.Position)
  field(:numberReads)
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Read do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Read.decode(value, options)
  end
end
