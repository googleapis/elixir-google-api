...
defmodule GoogleApi.Genomics.V1.Model.ImportVariantsResponse do
  ...
  - callSetIds ([String.t]): IDs of the call sets created during the import. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.ImportVariantsResponse do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.ImportVariantsResponse.decode(value, options)
  end
end
