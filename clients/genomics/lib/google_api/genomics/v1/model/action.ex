...
defmodule GoogleApi.Genomics.V1.Model.Action do
  @moduledoc """
  ...
  *   `timeout` (*type:* `String.t`, *default:* `nil`) - The maximum amount of time to give the action to complete. If the action fails to complete before the timeout, it will be terminated and the exit status will be non-zero. The pipeline will continue or terminate based on the rules defined by the `ALWAYS_RUN` and `IGNORE_EXIT_STATUS` flags.
  ...
  @type t :: %__MODULE__{
          ...
          :credentials => GoogleApi.Genomics.V1.Model.Secret.t() | nil,
          ...
          :labels => map() | nil,
          :mounts => list(GoogleApi.Genomics.V1.Model.Mount.t()) | nil,
          :name => String.t() | nil,
  ...
  field(:credentials, as: GoogleApi.Genomics.V1.Model.Secret)
  ...
  field(:mounts, as: GoogleApi.Genomics.V1.Model.Mount, type: :list)
  field(:name)
  field(:pidNamespace)
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Action do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Action.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Action do
