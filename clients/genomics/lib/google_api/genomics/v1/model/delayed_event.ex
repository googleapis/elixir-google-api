...
defmodule GoogleApi.Genomics.V1.Model.DelayedEvent do
  ...
  - cause (String.t): A textual description of the cause of the delay.  The string may change without notice since it is often generated by another service (such as Compute Engine). Defaults to: `null`.
