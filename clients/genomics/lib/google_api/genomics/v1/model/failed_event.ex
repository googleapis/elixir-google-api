...
defmodule GoogleApi.Genomics.V1.Model.FailedEvent do
  ...
  - cause (String.t): The human-readable description of the cause of the failure. Defaults to `nil`.
  - code (String.t): The Google standard error code that best describes this failure. Defaults to `nil`.
  """
