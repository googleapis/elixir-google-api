...
defmodule GoogleApi.Genomics.V1.Model.Network do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Network do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Network.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Network do
