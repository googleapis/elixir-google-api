...
defmodule GoogleApi.Genomics.V1.Model.SearchCallSetsResponse do
  ...
  - callSets ([CallSet]): The list of matching call sets. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :callSets => list(GoogleApi.Genomics.V1.Model.CallSet.t()),
          :nextPageToken => any()
        }

  field(:callSets, as: GoogleApi.Genomics.V1.Model.CallSet, type: :list)
  field(:nextPageToken)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.SearchCallSetsResponse do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.SearchCallSetsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.SearchCallSetsResponse do
