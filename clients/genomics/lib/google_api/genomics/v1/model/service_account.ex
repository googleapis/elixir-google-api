...
defmodule GoogleApi.Genomics.V1.Model.ServiceAccount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.ServiceAccount do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.ServiceAccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.ServiceAccount do
