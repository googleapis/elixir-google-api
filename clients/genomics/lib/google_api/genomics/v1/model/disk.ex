...
defmodule GoogleApi.Genomics.V1.Model.Disk do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Disk do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Disk.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Disk do
