...
defmodule GoogleApi.Genomics.V1.Model.SearchCallSetsRequest do
  ...
  - name (String.t): Only return call sets for which a substring of the name matches this string. Defaults to: `null`.
  ...
  - variantSetIds ([String.t]): Restrict the query to call sets within the given variant sets. At least one ID must be provided. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.SearchCallSetsRequest do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.SearchCallSetsRequest.decode(value, options)
  end
end
