...
defmodule GoogleApi.Genomics.V1.Model.Policy do
  ...
  @type t :: %__MODULE__{
          :bindings => list(GoogleApi.Genomics.V1.Model.Binding.t()),
          :etag => any(),
          :version => any()
        }

  field(:bindings, as: GoogleApi.Genomics.V1.Model.Binding, type: :list)
  field(:etag)
  field(:version)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Policy do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Policy.decode(value, options)
  end
end
