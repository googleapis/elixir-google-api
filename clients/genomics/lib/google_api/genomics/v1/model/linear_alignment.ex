...
defmodule GoogleApi.Genomics.V1.Model.LinearAlignment do
  ...
  @type t :: %__MODULE__{
          :cigar => list(GoogleApi.Genomics.V1.Model.CigarUnit.t()),
          :mappingQuality => any(),
          :position => GoogleApi.Genomics.V1.Model.Position.t()
        }

  field(:cigar, as: GoogleApi.Genomics.V1.Model.CigarUnit, type: :list)
  field(:mappingQuality)
  field(:position, as: GoogleApi.Genomics.V1.Model.Position)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.LinearAlignment do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.LinearAlignment.decode(value, options)
  end
end
