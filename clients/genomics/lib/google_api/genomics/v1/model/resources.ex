...
defmodule GoogleApi.Genomics.V1.Model.Resources do
  @moduledoc """
  ...
  *   `zones` (*type:* `list(String.t)`, *default:* `nil`) - The list of zones allowed for VM allocation. If set, the `regions` field must not be set.
  ...
  field(:virtualMachine, as: GoogleApi.Genomics.V1.Model.VirtualMachine)
  field(:zones, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Resources do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Resources.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Resources do
