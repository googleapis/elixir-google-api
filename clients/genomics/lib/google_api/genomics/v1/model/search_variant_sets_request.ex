...
defmodule GoogleApi.Genomics.V1.Model.SearchVariantSetsRequest do
  ...
  - datasetIds ([String.t]): Exactly one dataset ID must be provided here. Only variant sets which belong to this dataset will be returned. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.SearchVariantSetsRequest do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.SearchVariantSetsRequest.decode(value, options)
  end
end
