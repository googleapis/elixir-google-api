...
defmodule GoogleApi.Genomics.V1.Model.SetIamPolicyRequest do
  ...
  @type t :: %__MODULE__{
          :policy => GoogleApi.Genomics.V1.Model.Policy.t()
        }

  field(:policy, as: GoogleApi.Genomics.V1.Model.Policy)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.SetIamPolicyRequest do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.SetIamPolicyRequest.decode(value, options)
  end
end
