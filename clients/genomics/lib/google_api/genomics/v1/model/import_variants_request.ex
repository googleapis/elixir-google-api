...
defmodule GoogleApi.Genomics.V1.Model.ImportVariantsRequest do
  ...
  - sourceUris (List[String]): A list of URIs referencing variant files in Google Cloud Storage. URIs can include wildcards [as described here](https://cloud.google.com/storage/docs/gsutil/addlhelp/WildcardNames). Note that recursive wildcards (&#39;**&#39;) are not supported. Defaults to: `null`.
