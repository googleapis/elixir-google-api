...
defmodule GoogleApi.Genomics.V1.Model.SearchReadGroupSetsRequest do
  ...
  - datasetIds ([String.t]): Restricts this query to read group sets within the given datasets. At least one ID must be provided. Defaults to: `null`.
  - name (String.t): Only return read group sets for which a substring of the name matches this string. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.SearchReadGroupSetsRequest do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.SearchReadGroupSetsRequest.decode(value, options)
  end
end
