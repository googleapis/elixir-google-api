...
defmodule GoogleApi.Genomics.V1.Model.Binding do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :condition => GoogleApi.Genomics.V1.Model.Expr.t(),
          :members => list(any()),
          :role => any()
        }

  field(:condition, as: GoogleApi.Genomics.V1.Model.Expr)
  field(:members, type: :list)
  field(:role)
end

defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Binding do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Binding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Binding do
