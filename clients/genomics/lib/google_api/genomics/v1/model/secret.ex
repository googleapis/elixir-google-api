...
defmodule GoogleApi.Genomics.V1.Model.Secret do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Genomics.V1.Model.Secret do
  def decode(value, options) do
    GoogleApi.Genomics.V1.Model.Secret.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Genomics.V1.Model.Secret do
