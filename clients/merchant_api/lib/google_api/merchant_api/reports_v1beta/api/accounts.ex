...
defmodule GoogleApi.MerchantAPI.Reports_v1beta.Api.Accounts do
  @moduledoc """
  API calls for all endpoints tagged `Accounts`.
  """

  alias GoogleApi.MerchantAPI.Reports_v1beta.Connection
  ...
  *   `{:error, info}` on failure
  """
  @spec merchantapi_accounts_reports_search(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.MerchantAPI.Reports_v1beta.Model.SearchResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def merchantapi_accounts_reports_search(connection, parent, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/reports/v1beta/{+parent}/reports:search", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.MerchantAPI.Reports_v1beta.Model.SearchResponse{}]
    )
  end
end
