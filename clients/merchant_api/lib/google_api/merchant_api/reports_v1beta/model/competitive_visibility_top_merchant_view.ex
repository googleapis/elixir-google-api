...
defmodule GoogleApi.MerchantAPI.Reports_v1beta.Model.CompetitiveVisibilityTopMerchantView do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.MerchantAPI.Reports_v1beta.Model.CompetitiveVisibilityTopMerchantView do
  def decode(value, options) do
    GoogleApi.MerchantAPI.Reports_v1beta.Model.CompetitiveVisibilityTopMerchantView.decode(
      value,
      options
    )
  end
