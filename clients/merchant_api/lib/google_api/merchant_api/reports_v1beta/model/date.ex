...
defmodule GoogleApi.MerchantAPI.Reports_v1beta.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MerchantAPI.Reports_v1beta.Model.Date do
  def decode(value, options) do
    GoogleApi.MerchantAPI.Reports_v1beta.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MerchantAPI.Reports_v1beta.Model.Date do
