...
defmodule GoogleApi.ProximityBeacon.V1BETA1.Api.Beacons do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :project_id (String): The project id of the beacon to activate. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the project the attachment will belong to. If the project id is not specified then the project making the request is used. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the attachment to delete. If not provided, the project that is making the request is used. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id to list beacon attachments under. This field can be used when \&quot;*\&quot; is specified to mean all attachment namespaces. Projects may have multiple attachments with multiple namespaces. If \&quot;*\&quot; is specified and the projectId string is empty, then the project making the request is used. Optional.
    - :namespaced_type (String): Specifies the namespace and type of attachment to include in response in &lt;var&gt;namespace/type&lt;/var&gt; format. Accepts &#x60;*/*&#x60; to specify \&quot;all types in all namespaces\&quot;.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the beacon to deactivate. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the beacon to decommission. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the beacon to delete. If not provided, the project that is making the request is used. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :page_token (String): Requests results that occur after the &#x60;page_token&#x60;, obtained from the response to a previous request. Optional.
    - :alert_filter (String): Requests only beacons that have the given alert. For example, to find beacons that have low batteries use &#x60;alert_filter&#x3D;LOW_BATTERY&#x60;.
    - :page_size (Integer): Specifies the maximum number of results to return. Defaults to 10. Maximum 1000. Optional.
    - :project_id (String): Requests only diagnostic records for the given project id. If not set, then the project making the request will be used for looking up diagnostic records. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the beacon to request. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :page_token (String): A pagination token obtained from a previous request to list beacons.
    - :page_size (Integer): The maximum number of records to return for this request, up to a server-defined upper limit.
    ...
    - :project_id (String): The project id to list beacons under. If not present then the project credential that made the request is used as the project. Optional.
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the project the beacon will be registered to. If the project id is not specified then the project making the request is used. Optional.
    - :body (Beacon): 
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :bearer_token (String): OAuth bearer token.
    - :oauth_token (String): OAuth 2.0 token for the current user.
    - :project_id (String): The project id of the beacon to update. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
    - :body (Beacon): 
