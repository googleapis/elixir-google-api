...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.ListBeaconsResponse do
  ...
  - beacons ([Beacon]): The beacons that matched the search criteria. Defaults to: `null`.
  - nextPageToken (String.t): An opaque pagination token that the client may provide in their next request to retrieve the next page of results. Defaults to: `null`.
  - totalCount (String.t): Estimate of the total number of beacons matched by the query. Higher values may be less accurate. Defaults to: `null`.
  """
