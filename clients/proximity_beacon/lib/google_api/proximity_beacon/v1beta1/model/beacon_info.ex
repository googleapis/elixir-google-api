...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.BeaconInfo do
  ...
  - advertisedId (GoogleApi.ProximityBeacon.V1beta1.Model.AdvertisedId.t): The ID advertised by the beacon. Defaults to `nil`.
  - attachments (list(GoogleApi.ProximityBeacon.V1beta1.Model.AttachmentInfo.t)): Attachments matching the type(s) requested.
  May be empty if no attachment types were requested. Defaults to `nil`.
  - beaconName (String.t): The name under which the beacon is registered. Defaults to `nil`.
  """
