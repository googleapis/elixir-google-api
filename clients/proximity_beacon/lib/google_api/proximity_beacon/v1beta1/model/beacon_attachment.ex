...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.BeaconAttachment do
  ...
  - attachmentName (String.t): Resource name of this attachment. Attachment names have the format:
  <code>beacons/<var>beacon_id</var>/attachments/<var>attachment_id</var></code>.
  Leave this empty on creation. Defaults to `nil`.
  - creationTimeMs (DateTime.t): The UTC time when this attachment was created, in milliseconds since the
  UNIX epoch. Defaults to `nil`.
  - data (String.t): An opaque data container for client-provided data. Must be
  [base64](http://tools.ietf.org/html/rfc4648#section-4) encoded in HTTP
  requests, and will be so encoded (with padding) in responses.
  Required. Defaults to `nil`.
  - maxDistanceMeters (float()): The distance away from the beacon at which this attachment should be
  ...
  Negative values are invalid and return an error. Defaults to `nil`.
  - namespacedType (String.t): Specifies what kind of attachment this is. Tells a client how to
