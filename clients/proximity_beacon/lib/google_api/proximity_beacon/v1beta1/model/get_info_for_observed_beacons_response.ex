...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.GetInfoForObservedBeaconsResponse do
  ...
  - beacons (list(GoogleApi.ProximityBeacon.V1beta1.Model.BeaconInfo.t)): Public information about beacons.
  May be empty if the request matched no beacons. Defaults to `nil`.
  """
