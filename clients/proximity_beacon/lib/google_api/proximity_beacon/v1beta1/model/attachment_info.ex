...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.AttachmentInfo do
  ...
  - data (String.t): An opaque data container for client-provided data. Defaults to `nil`.
  ...
  beacon's outer limit of detection. Defaults to `nil`.
  - namespacedType (String.t): Specifies what kind of attachment this is. Tells a client how to
  interpret the `data` field. Format is <var>namespace/type</var>, for
  example <code>scrupulous-wombat-12345/welcome-message</code> Defaults to `nil`.
  """
