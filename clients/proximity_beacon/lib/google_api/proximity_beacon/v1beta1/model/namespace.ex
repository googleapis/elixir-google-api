...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.Namespace do
  ...
  - namespaceName (String.t): Resource name of this namespace. Namespaces names have the format:
  <code>namespaces/<var>namespace</var></code>. Defaults to `nil`.
  - servingVisibility (String.t): Specifies what clients may receive attachments under this namespace
  via `beaconinfo.getforobserved`. Defaults to `nil`.
  """
