...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.EphemeralIdRegistration do
  ...
  - beaconEcdhPublicKey (String): The beacon&#39;s public key used for the Elliptic curve Diffie-Hellman key exchange. When this field is populated, &#x60;service_ecdh_public_key&#x60; must also be populated, and &#x60;beacon_identity_key&#x60; must not be. Defaults to: `null`.
  - beaconIdentityKey (String): The private key of the beacon. If this field is populated, &#x60;beacon_ecdh_public_key&#x60; and &#x60;service_ecdh_public_key&#x60; must not be populated. Defaults to: `null`.
  ...
  - serviceEcdhPublicKey (String): The service&#39;s public key used for the Elliptic curve Diffie-Hellman key exchange. When this field is populated, &#x60;beacon_ecdh_public_key&#x60; must also be populated, and &#x60;beacon_identity_key&#x60; must not be. Defaults to: `null`.
  """
