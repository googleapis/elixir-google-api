...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.EphemeralIdRegistration do
  ...
  - beaconEcdhPublicKey (String.t): The beacon's public key used for the Elliptic curve Diffie-Hellman
  key exchange. When this field is populated, `service_ecdh_public_key`
  must also be populated, and `beacon_identity_key` must not be. Defaults to `nil`.
  - beaconIdentityKey (String.t): The private key of the beacon. If this field is populated,
  ...
  value is not provided, the default is zero. Defaults to `nil`.
  - initialEid (String.t): An initial ephemeral ID calculated using the clock value submitted as
  `initial_clock_value`, and the secret key generated by the
  Diffie-Hellman key exchange using `service_ecdh_public_key` and
  `service_ecdh_public_key`. This initial EID value will be used by the
  service to confirm that the key exchange process was successful. Defaults to `nil`.
  ...
  broadcasting a new ephemeral ID on average every 2^K seconds. Defaults to `nil`.
  - serviceEcdhPublicKey (String.t): The service's public key used for the Elliptic curve Diffie-Hellman
