...
defmodule GoogleApi.ProximityBeacon.V1beta1.Model.EphemeralIdRegistrationParams do
  ...
  See EddystoneEidRegistration.rotation_period_exponent Defaults to `nil`.
  - minRotationPeriodExponent (integer()): Indicates the minimum rotation period supported by the service.
  See EddystoneEidRegistration.rotation_period_exponent Defaults to `nil`.
  - serviceEcdhPublicKey (String.t): The beacon service's public key for use by a beacon to derive its
  Identity Key using Elliptic Curve Diffie-Hellman key exchange. Defaults to `nil`.
  """
