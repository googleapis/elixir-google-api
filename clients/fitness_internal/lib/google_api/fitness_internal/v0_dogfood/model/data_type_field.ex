...
defmodule GoogleApi.FitnessInternal.V0DOGFOOD.Model.DataTypeField do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.FitnessInternal.V0DOGFOOD.Model.DataTypeField do
