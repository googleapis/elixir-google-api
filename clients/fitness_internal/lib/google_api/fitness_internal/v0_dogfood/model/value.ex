...
defmodule GoogleApi.FitnessInternal.V0DOGFOOD.Model.Value do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.FitnessInternal.V0DOGFOOD.Model.Value do
  import GoogleApi.FitnessInternal.V0DOGFOOD.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"mapVal", :list, GoogleApi.FitnessInternal.V0DOGFOOD.Model.ValueMapValEntry, options)
  end
end
