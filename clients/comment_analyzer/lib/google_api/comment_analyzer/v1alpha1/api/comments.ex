...
defmodule GoogleApi.CommentAnalyzer.V1alpha1.Api.Comments do
  @moduledoc """
  API calls for all endpoints tagged `Comments`.
  """

  alias GoogleApi.CommentAnalyzer.V1alpha1.Connection
  ...
  *   `{:error, info}` on failure
  ...
  def commentanalyzer_comments_analyze(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1alpha1/comments:analyze", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.CommentAnalyzer.V1alpha1.Model.AnalyzeCommentResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def commentanalyzer_comments_suggestscore(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1alpha1/comments:suggestscore", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.CommentAnalyzer.V1alpha1.Model.SuggestCommentScoreResponse{}]
    )
  end
end
