...
defmodule GoogleApi.PrivateCA.V1.Model.ListCaPoolsResponse do
  @moduledoc """
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - A list of locations (e.g. "us-west1") that could not be reached.
  ...
  @type t :: %__MODULE__{
          :caPools => list(GoogleApi.PrivateCA.V1.Model.CaPool.t()) | nil,
          :nextPageToken => String.t() | nil,
          :unreachable => list(String.t()) | nil
        }

  field(:caPools, as: GoogleApi.PrivateCA.V1.Model.CaPool, type: :list)
  field(:nextPageToken)
  field(:unreachable, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1.Model.ListCaPoolsResponse do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1.Model.ListCaPoolsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1.Model.ListCaPoolsResponse do
