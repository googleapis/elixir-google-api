...
defmodule GoogleApi.PrivateCA.V1.Model.ActivateCertificateAuthorityRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1.Model.ActivateCertificateAuthorityRequest do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1.Model.ActivateCertificateAuthorityRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1.Model.ActivateCertificateAuthorityRequest do
