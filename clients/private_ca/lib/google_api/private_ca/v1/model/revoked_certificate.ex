...
defmodule GoogleApi.PrivateCA.V1.Model.RevokedCertificate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1.Model.RevokedCertificate do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1.Model.RevokedCertificate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1.Model.RevokedCertificate do
