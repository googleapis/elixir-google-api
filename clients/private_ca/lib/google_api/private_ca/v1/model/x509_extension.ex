...
defmodule GoogleApi.PrivateCA.V1.Model.X509Extension do
  @moduledoc """
  ...
  *   `value` (*type:* `String.t`, *default:* `nil`) - Required. The value of this X.509 extension.
  ...
  field(:critical)
  field(:objectId, as: GoogleApi.PrivateCA.V1.Model.ObjectId)
  field(:value)
end

defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1.Model.X509Extension do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1.Model.X509Extension.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1.Model.X509Extension do
