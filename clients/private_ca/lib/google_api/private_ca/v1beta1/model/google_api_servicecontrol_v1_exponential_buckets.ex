...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ExponentialBuckets do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ExponentialBuckets do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ExponentialBuckets.decode(
      value,
      options
    )
  end
