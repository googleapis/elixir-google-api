...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ResourceInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ResourceInfo do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ResourceInfo.decode(value, options)
  end
end
