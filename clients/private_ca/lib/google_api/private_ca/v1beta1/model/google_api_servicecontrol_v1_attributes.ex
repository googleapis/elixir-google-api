...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Attributes do
  @moduledoc """
  ...
  *   `droppedAttributesCount` (*type:* `integer()`, *default:* `nil`) - The number of attributes that were discarded. Attributes can be discarded because their keys are too long or because there are too many attributes. If this value is 0 then all attributes are valid.
  ...
  field(:attributeMap,
    as: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1AttributeValue,
    type: :map
  )
...
defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Attributes do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Attributes.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Attributes do
