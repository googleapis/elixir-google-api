...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1AttributeValue do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1AttributeValue do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1AttributeValue.decode(
      value,
      options
    )
  end
