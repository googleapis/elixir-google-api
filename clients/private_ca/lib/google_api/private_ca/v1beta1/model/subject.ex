...
defmodule GoogleApi.PrivateCA.V1beta1.Model.Subject do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1beta1.Model.Subject do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.Subject.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1beta1.Model.Subject do
