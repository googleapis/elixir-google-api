...
defmodule GoogleApi.PrivateCA.V1beta1.Model.CertificateConfig do
  @moduledoc """
  ...
  *   `subjectConfig` (*type:* `GoogleApi.PrivateCA.V1beta1.Model.SubjectConfig.t`, *default:* `nil`) - Required. Specifies some of the values in a certificate that are related to the subject.
  ...
  field(:reusableConfig, as: GoogleApi.PrivateCA.V1beta1.Model.ReusableConfigWrapper)
  field(:subjectConfig, as: GoogleApi.PrivateCA.V1beta1.Model.SubjectConfig)
end

defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1beta1.Model.CertificateConfig do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.CertificateConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1beta1.Model.CertificateConfig do
