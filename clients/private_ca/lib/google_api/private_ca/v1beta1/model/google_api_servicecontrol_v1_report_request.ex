...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ReportRequest do
  ...
  *   `serviceName` (*type:* `String.t`, *default:* `nil`) - The service name as specified in its service configuration. For example, `"pubsub.googleapis.com"`. See [google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service) for the definition of a service name.
  """
  ...
  field(:operations,
    as: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Operation,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ReportRequest do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1ReportRequest.decode(
      value,
      options
    )
  end
