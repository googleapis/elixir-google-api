...
defmodule GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1MetricValue do
  @moduledoc """
  ...
  *   `distributionValue` (*type:* `GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Distribution.t`, *default:* `nil`) - A distribution value.
  ...
  *   `moneyValue` (*type:* `GoogleApi.PrivateCA.V1beta1.Model.Money.t`, *default:* `nil`) - A money value.
  ...
  *   `stringValue` (*type:* `String.t`, *default:* `nil`) - A text string value.
  ...
  field(:distributionValue,
    as: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1Distribution
  )
  ...
  field(:moneyValue, as: GoogleApi.PrivateCA.V1beta1.Model.Money)
  field(:startTime, as: DateTime)
  field(:stringValue)
end

defimpl Poison.Decoder,
  for: GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1MetricValue do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.GoogleApiServicecontrolV1MetricValue.decode(value, options)
  end
end
