...
defmodule GoogleApi.PrivateCA.V1beta1.Model.Money do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PrivateCA.V1beta1.Model.Money do
  def decode(value, options) do
    GoogleApi.PrivateCA.V1beta1.Model.Money.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PrivateCA.V1beta1.Model.Money do
