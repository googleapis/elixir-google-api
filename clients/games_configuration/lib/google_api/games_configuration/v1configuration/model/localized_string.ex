...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.LocalizedString do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesConfiguration#localizedString. Defaults to `gamesConfiguration#localizedString`.
  - locale (String.t): The locale string. Defaults to `nil`.
  - value (String.t): The string value. Defaults to `nil`.
  """
