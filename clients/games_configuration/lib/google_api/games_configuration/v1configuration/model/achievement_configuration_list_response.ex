...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.AchievementConfigurationListResponse do
  ...
  - items ([AchievementConfiguration]): The achievement configurations. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementConfigurationListResponse. Defaults to: `null`.
