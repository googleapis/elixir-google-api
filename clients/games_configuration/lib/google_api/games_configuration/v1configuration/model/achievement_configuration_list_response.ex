...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.AchievementConfigurationListResponse do
  ...
  - items (list(GoogleApi.GamesConfiguration.V1configuration.Model.AchievementConfiguration.t)): The achievement configurations. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementConfigurationListResponse. Defaults to `gamesConfiguration#achievementConfigurationListResponse`.
