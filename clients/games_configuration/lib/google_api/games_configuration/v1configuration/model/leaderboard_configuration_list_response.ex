...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.LeaderboardConfigurationListResponse do
  ...
  - items ([LeaderboardConfiguration]): The leaderboard configurations. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#leaderboardConfigurationListResponse. Defaults to: `null`.
