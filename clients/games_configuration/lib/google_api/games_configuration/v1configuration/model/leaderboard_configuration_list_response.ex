...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.LeaderboardConfigurationListResponse do
  ...
  - items (list(GoogleApi.GamesConfiguration.V1configuration.Model.LeaderboardConfiguration.t)): The leaderboard configurations. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#leaderboardConfigurationListResponse. Defaults to `gamesConfiguration#leaderboardConfigurationListResponse`.
