...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.LocalizedStringBundle do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesConfiguration#localizedStringBundle. Defaults to `gamesConfiguration#localizedStringBundle`.
  - translations (list(GoogleApi.GamesConfiguration.V1configuration.Model.LocalizedString.t)): The locale strings. Defaults to `nil`.
  """
