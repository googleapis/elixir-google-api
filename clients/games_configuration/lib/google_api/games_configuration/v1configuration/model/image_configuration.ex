...
defmodule GoogleApi.GamesConfiguration.V1configuration.Model.ImageConfiguration do
  ...
  - imageType (String.t): The image type for the image. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string gamesConfiguration#imageConfiguration. Defaults to `gamesConfiguration#imageConfiguration`.
  - resourceId (String.t): The resource ID of resource which the image belongs to. Defaults to `nil`.
  - url (String.t): The url for this image. Defaults to `nil`.
  """
