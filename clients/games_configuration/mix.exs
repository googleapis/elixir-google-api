...
defmodule GoogleApi.GamesConfiguration.Mixfile do
  ...
  def project() do
    [
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/games_configuration"
    ]
  end
  ...
  defp description() do
    """
    Client library for Google Play Game Services Publishing API from Google. The Publishing API for Google Play Game Services.
    """
  end
