...
defmodule GoogleApi.File.V1.Model.Distribution do
  @moduledoc """
  ...
  *   `sumOfSquaredDeviation` (*type:* `float()`, *default:* `nil`) - The sum of squared deviations from the mean:
  ...
  @type t :: %__MODULE__{
          ...
          :count => String.t(),
          :exemplars => list(GoogleApi.File.V1.Model.Exemplar.t()),
  ...
  field(:count)
  field(:exemplars, as: GoogleApi.File.V1.Model.Exemplar, type: :list)
  field(:explicitBuckets, as: GoogleApi.File.V1.Model.ExplicitBuckets)
  field(:exponentialBuckets, as: GoogleApi.File.V1.Model.ExponentialBuckets)
  field(:linearBuckets, as: GoogleApi.File.V1.Model.LinearBuckets)
  field(:maximum)
  field(:mean)
  field(:minimum)
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.Distribution do
  def decode(value, options) do
    GoogleApi.File.V1.Model.Distribution.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.Distribution do
