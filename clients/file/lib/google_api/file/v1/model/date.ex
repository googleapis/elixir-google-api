...
defmodule GoogleApi.File.V1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.File.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.Date do
