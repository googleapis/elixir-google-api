...
defmodule GoogleApi.File.V1.Model.ExponentialBuckets do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.ExponentialBuckets do
  def decode(value, options) do
    GoogleApi.File.V1.Model.ExponentialBuckets.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.ExponentialBuckets do
