...
defmodule GoogleApi.File.V1.Model.LogEntryOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.LogEntryOperation do
  def decode(value, options) do
    GoogleApi.File.V1.Model.LogEntryOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.LogEntryOperation do
