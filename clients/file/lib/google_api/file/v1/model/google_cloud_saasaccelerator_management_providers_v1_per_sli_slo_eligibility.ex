...
defmodule GoogleApi.File.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.File.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility do
  def decode(value, options) do
    GoogleApi.File.V1.Model.GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility.decode(
      value,
      options
    )
  end
