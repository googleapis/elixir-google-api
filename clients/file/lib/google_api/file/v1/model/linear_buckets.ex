...
defmodule GoogleApi.File.V1.Model.LinearBuckets do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.LinearBuckets do
  def decode(value, options) do
    GoogleApi.File.V1.Model.LinearBuckets.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.LinearBuckets do
