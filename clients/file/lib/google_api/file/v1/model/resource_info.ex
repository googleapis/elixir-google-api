...
defmodule GoogleApi.File.V1.Model.ResourceInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.ResourceInfo do
  def decode(value, options) do
    GoogleApi.File.V1.Model.ResourceInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.ResourceInfo do
