...
defmodule GoogleApi.File.V1.Model.TraceSpan do
  @moduledoc """
  ...
  *   `attributes` (*type:* `GoogleApi.File.V1.Model.Attributes.t`, *default:* `nil`) - A set of attributes on the span. You can have up to 32 attributes per
      span.
  ...
  *   `displayName` (*type:* `GoogleApi.File.V1.Model.TruncatableString.t`, *default:* `nil`) - A description of the span's operation (up to 128 bytes).
  ...
  *   `status` (*type:* `GoogleApi.File.V1.Model.Status.t`, *default:* `nil`) - An optional final status for this span.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :attributes => GoogleApi.File.V1.Model.Attributes.t(),
          :childSpanCount => integer(),
          :displayName => GoogleApi.File.V1.Model.TruncatableString.t(),
          :endTime => DateTime.t(),
          :name => String.t(),
          ...
          :status => GoogleApi.File.V1.Model.Status.t()
        }

  field(:attributes, as: GoogleApi.File.V1.Model.Attributes)
  field(:childSpanCount)
  field(:displayName, as: GoogleApi.File.V1.Model.TruncatableString)
  ...
  field(:status, as: GoogleApi.File.V1.Model.Status)
end

defimpl Poison.Decoder, for: GoogleApi.File.V1.Model.TraceSpan do
  def decode(value, options) do
    GoogleApi.File.V1.Model.TraceSpan.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.File.V1.Model.TraceSpan do
