...
defmodule GoogleApi.ServiceUser.V1.Model.SearchServicesResponse do
  ...
  - nextPageToken (String.t): Token that can be passed to `ListAvailableServices` to resume a paginated
  query. Defaults to `nil`.
  - services (list(GoogleApi.ServiceUser.V1.Model.PublishedService.t)): Services available publicly or available to the authenticated caller. Defaults to `nil`.
  """
