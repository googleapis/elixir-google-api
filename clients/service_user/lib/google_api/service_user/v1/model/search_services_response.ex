...
defmodule GoogleApi.ServiceUser.V1.Model.SearchServicesResponse do
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Token that can be passed to `ListAvailableServices` to resume a paginated
      query.
  *   `services` (*type:* `list(GoogleApi.ServiceUser.V1.Model.PublishedService.t)`, *default:* `nil`) - Services available publicly or available to the authenticated caller.
  """
