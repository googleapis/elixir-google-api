...
defmodule GoogleApi.ServiceUser.V1.Model.Documentation do
  ...
  - pages (list(GoogleApi.ServiceUser.V1.Model.Page.t)): The top level pages for the documentation set. Defaults to `nil`.
  - rules (list(GoogleApi.ServiceUser.V1.Model.DocumentationRule.t)): A list of documentation rules that apply to individual API elements.
