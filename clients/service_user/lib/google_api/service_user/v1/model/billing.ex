...
defmodule GoogleApi.ServiceUser.V1.Model.Billing do
  ...
  *   `consumerDestinations` (*type:* `list(GoogleApi.ServiceUser.V1.Model.BillingDestination.t)`, *default:* `nil`) - Billing configurations for sending metrics to the consumer project.
