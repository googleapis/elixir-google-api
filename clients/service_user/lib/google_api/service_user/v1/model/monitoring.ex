...
defmodule GoogleApi.ServiceUser.V1.Model.Monitoring do
  ...
  - consumerDestinations (list(GoogleApi.ServiceUser.V1.Model.MonitoringDestination.t)): Monitoring configurations for sending metrics to the consumer project.
  There can be multiple consumer destinations. A monitored resouce type may
  appear in multiple monitoring destinations if different aggregations are
  needed for different sets of metrics associated with that monitored
  resource type. A monitored resource and metric pair may only be used once
  in the Monitoring configuration. Defaults to `nil`.
  - producerDestinations (list(GoogleApi.ServiceUser.V1.Model.MonitoringDestination.t)): Monitoring configurations for sending metrics to the producer project.
