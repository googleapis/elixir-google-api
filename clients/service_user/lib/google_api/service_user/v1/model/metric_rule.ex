...
defmodule GoogleApi.ServiceUser.V1.Model.MetricRule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceUser.V1.Model.MetricRule do
  def decode(value, options) do
    GoogleApi.ServiceUser.V1.Model.MetricRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceUser.V1.Model.MetricRule do
