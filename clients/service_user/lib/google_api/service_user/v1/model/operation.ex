...
defimpl Poison.Decoder, for: GoogleApi.ServiceUser.V1.Model.Operation do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"error", :struct, GoogleApi.ServiceUser.V1.Model.Status, options)
    |> deserialize(:"metadata", :struct, GoogleApi.ServiceUser.V1.Model.Object, options)
    |> deserialize(:"response", :struct, GoogleApi.ServiceUser.V1.Model.Object, options)
  end
end
