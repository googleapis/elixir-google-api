...
defmodule GoogleApi.ServiceUser.V1.Model.Authentication do
  ...
  *   `providers` (*type:* `list(GoogleApi.ServiceUser.V1.Model.AuthProvider.t)`, *default:* `nil`) - Defines a set of authentication providers that a service supports.
  *   `rules` (*type:* `list(GoogleApi.ServiceUser.V1.Model.AuthenticationRule.t)`, *default:* `nil`) - A list of authentication rules that apply to individual API methods.
