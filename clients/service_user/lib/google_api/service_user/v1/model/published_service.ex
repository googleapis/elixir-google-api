...
defmodule GoogleApi.ServiceUser.V1.Model.PublishedService do
  ...
  - name (String.t): The resource name of the service.

  A valid name would be:
  - services/serviceuser.googleapis.com Defaults to `nil`.
  - service (GoogleApi.ServiceUser.V1.Model.Service.t): The service's published configuration. Defaults to `nil`.
  """
