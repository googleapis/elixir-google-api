...
defmodule GoogleApi.ServiceUser.V1.Api.Projects do
  ...
  - name (String.t): Name of the consumer and the service to disable for that consumer.
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.ServiceUser.V1.Model.DisableServiceRequest.t): 
  ...
  - connection (GoogleApi.ServiceUser.V1.Connection): Connection to server
  - name (String.t): Name of the consumer and the service to enable for that consumer.
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.ServiceUser.V1.Model.EnableServiceRequest.t): 
  ...
  - connection (GoogleApi.ServiceUser.V1.Connection): Connection to server
  - parent (String.t): List enabled services for the specified parent.
