...
defmodule GoogleApi.ServiceUser.V1.Api.Services do
  ...
  """
  @spec serviceuser_services_search(Tesla.Env.client(), keyword()) ::
          {:ok, GoogleApi.ServiceUser.V1.Model.SearchServicesResponse.t()}
          | {:error, Tesla.Env.t()}
  def serviceuser_services_search(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.ServiceUser.V1.Model.SearchServicesResponse{}])
  end
end
