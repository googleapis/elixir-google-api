...
defmodule GoogleApi.ServiceUser.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.ServiceUser.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://serviceuser.googleapis.com"
