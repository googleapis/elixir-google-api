...
defmodule GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1alpha1OpMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1alpha1OpMetadata do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1alpha1OpMetadata.decode(
      value,
      options
    )
  end
