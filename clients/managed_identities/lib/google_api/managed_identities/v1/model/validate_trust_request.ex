...
defimpl Poison.Decoder, for: GoogleApi.ManagedIdentities.V1.Model.ValidateTrustRequest do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.ValidateTrustRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ManagedIdentities.V1.Model.ValidateTrustRequest do
