...
defmodule GoogleApi.ManagedIdentities.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ManagedIdentities.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ManagedIdentities.V1.Model.OperationMetadata do
