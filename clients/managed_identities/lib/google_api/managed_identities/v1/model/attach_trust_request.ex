...
defimpl Poison.Decoder, for: GoogleApi.ManagedIdentities.V1.Model.AttachTrustRequest do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.AttachTrustRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ManagedIdentities.V1.Model.AttachTrustRequest do
