...
defmodule GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1OpMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1OpMetadata do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.GoogleCloudManagedidentitiesV1OpMetadata.decode(
      value,
      options
    )
  end
