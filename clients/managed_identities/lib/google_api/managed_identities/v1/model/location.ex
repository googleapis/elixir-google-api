...
defmodule GoogleApi.ManagedIdentities.V1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ManagedIdentities.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ManagedIdentities.V1.Model.Location do
