...
defmodule GoogleApi.ManagedIdentities.V1.Model.MaintenancePolicy do
  @moduledoc """
  ...
  *   `updatePolicy` (*type:* `GoogleApi.ManagedIdentities.V1.Model.UpdatePolicy.t`, *default:* `nil`) - Maintenance policy applicable to instance update.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time when the resource was updated.
  ...
  @type t :: %__MODULE__{
          ...
          :name => String.t() | nil,
          :state => String.t() | nil,
          :updatePolicy => GoogleApi.ManagedIdentities.V1.Model.UpdatePolicy.t() | nil,
  ...
  field(:name)
  field(:state)
  field(:updatePolicy, as: GoogleApi.ManagedIdentities.V1.Model.UpdatePolicy)
  field(:updateTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.ManagedIdentities.V1.Model.MaintenancePolicy do
  def decode(value, options) do
    GoogleApi.ManagedIdentities.V1.Model.MaintenancePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ManagedIdentities.V1.Model.MaintenancePolicy do
