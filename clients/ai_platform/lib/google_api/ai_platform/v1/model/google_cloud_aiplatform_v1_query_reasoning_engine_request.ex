...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1QueryReasoningEngineRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1QueryReasoningEngineRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1QueryReasoningEngineRequest.decode(
      value,
      options
    )
  end
