...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetOperationMetadata.decode(
      value,
      options
    )
  end
