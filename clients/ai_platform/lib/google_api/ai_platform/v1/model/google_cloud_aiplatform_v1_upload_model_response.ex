...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelResponse do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelResponse.decode(
      value,
      options
    )
  end
