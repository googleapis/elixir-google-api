...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StudySpecParameterSpecIntegerValueSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StudySpecParameterSpecIntegerValueSpec do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StudySpecParameterSpecIntegerValueSpec.decode(
      value,
      options
    )
  end
