...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1AssignNotebookRuntimeOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1AssignNotebookRuntimeOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1AssignNotebookRuntimeOperationMetadata.decode(
      value,
      options
    )
  end
