...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteOperationMetadata.decode(
      value,
      options
    )
  end
