...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportDataOperationMetadata do
  @moduledoc """
  Runtime operation information for DatasetService.ExportData.

  ## Attributes

  *   `gcsOutputDirectory` (*type:* `String.t`, *default:* `nil`) - A Google Cloud Storage directory which path ends with '/'. The exported data is stored in the directory.
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportDataOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportDataOperationMetadata.decode(
      value,
      options
    )
  end
