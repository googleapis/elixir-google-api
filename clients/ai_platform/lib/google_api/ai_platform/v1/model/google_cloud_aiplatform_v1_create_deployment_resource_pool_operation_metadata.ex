...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDeploymentResourcePoolOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDeploymentResourcePoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDeploymentResourcePoolOperationMetadata.decode(
      value,
      options
    )
  end
