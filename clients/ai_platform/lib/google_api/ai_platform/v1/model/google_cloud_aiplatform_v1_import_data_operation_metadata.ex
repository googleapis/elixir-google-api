...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ImportDataOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ImportDataOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ImportDataOperationMetadata.decode(
      value,
      options
    )
  end
