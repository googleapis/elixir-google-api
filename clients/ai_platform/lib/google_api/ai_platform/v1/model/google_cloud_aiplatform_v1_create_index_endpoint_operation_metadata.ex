...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateIndexEndpointOperationMetadata.decode(
      value,
      options
    )
  end
