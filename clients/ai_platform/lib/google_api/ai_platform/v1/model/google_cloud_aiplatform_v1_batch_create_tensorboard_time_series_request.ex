...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCreateTensorboardTimeSeriesRequest do
  @moduledoc """
  ...
  *   `requests` (*type:* `list(GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateTensorboardTimeSeriesRequest.t)`, *default:* `nil`) - Required. The request message specifying the TensorboardTimeSeries to create. A maximum of 1000 TensorboardTimeSeries can be created in a batch.
  ...
  field(:requests,
    as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateTensorboardTimeSeriesRequest,
    type: :list
  )
end
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCreateTensorboardTimeSeriesRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCreateTensorboardTimeSeriesRequest.decode(
      value,
      options
    )
  end
