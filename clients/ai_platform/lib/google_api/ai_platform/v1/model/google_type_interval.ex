...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleTypeInterval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.GoogleTypeInterval do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleTypeInterval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.GoogleTypeInterval do
