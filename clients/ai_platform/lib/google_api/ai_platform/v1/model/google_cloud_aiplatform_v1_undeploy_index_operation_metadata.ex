...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployIndexOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployIndexOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployIndexOperationMetadata.decode(
      value,
      options
    )
  end
