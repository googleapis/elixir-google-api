...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleApiHttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.GoogleApiHttpBody do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleApiHttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.GoogleApiHttpBody do
