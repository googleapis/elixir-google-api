...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StreamingReadFeatureValuesRequest do
  ...
  *   `featureSelector` (*type:* `GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FeatureSelector.t`, *default:* `nil`) - Required. Selector choosing Features of the target EntityType. Feature IDs will be deduplicated.
  ...
  @type t :: %__MODULE__{
          :entityIds => list(String.t()) | nil,
          :featureSelector =>
            GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FeatureSelector.t() | nil
        }

  field(:entityIds, type: :list)

  field(:featureSelector, as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FeatureSelector)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StreamingReadFeatureValuesRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StreamingReadFeatureValuesRequest.decode(
      value,
      options
    )
  end
