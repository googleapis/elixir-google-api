...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PairwiseMetricInstance do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PairwiseMetricInstance do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PairwiseMetricInstance.decode(
      value,
      options
    )
  end
