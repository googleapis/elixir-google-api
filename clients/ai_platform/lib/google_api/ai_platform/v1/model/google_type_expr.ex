...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.GoogleTypeExpr do
