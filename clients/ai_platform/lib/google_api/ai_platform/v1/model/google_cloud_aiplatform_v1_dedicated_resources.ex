  ...
  *   `spot` (*type:* `boolean()`, *default:* `nil`) - Optional. If true, schedule the deployment workload on [spot VMs](https://cloud.google.com/kubernetes-engine/docs/concepts/spot-vms).
  ...
  @type t :: %__MODULE__{
          :autoscalingMetricSpecs =>
            list(GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1AutoscalingMetricSpec.t())
            | nil,
          :machineSpec =>
          ...
          :requiredReplicaCount => integer() | nil,
          :spot => boolean() | nil
        }

  field(:autoscalingMetricSpecs,
    as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1AutoscalingMetricSpec,
    type: :list
  )
  ...
  field(:requiredReplicaCount)
  field(:spot)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DedicatedResources do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DedicatedResources.decode(value, options)
  end
end
