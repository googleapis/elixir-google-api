...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployIndexOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployIndexOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployIndexOperationMetadata.decode(
      value,
      options
    )
  end
