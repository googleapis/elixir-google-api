...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponse do
  @moduledoc """
  ...
  *   `protoStruct` (*type:* `map()`, *default:* `nil`) - Feature values in proto Struct format.
  ...
  field(:protoStruct, type: :map)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponse do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponse.decode(
      value,
      options
    )
  end
