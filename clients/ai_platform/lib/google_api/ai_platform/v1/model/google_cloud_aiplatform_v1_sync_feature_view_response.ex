...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SyncFeatureViewResponse do
  ...
  *   `featureViewSync` (*type:* `String.t`, *default:* `nil`) - Format: `projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}/featureViewSyncs/{feature_view_sync}`
  ...
  field(:featureViewSync)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SyncFeatureViewResponse do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SyncFeatureViewResponse.decode(
      value,
      options
    )
  end
