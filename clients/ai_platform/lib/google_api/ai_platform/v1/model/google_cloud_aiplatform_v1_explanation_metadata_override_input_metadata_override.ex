...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExplanationMetadataOverrideInputMetadataOverride.decode(
      value,
      options
    )
  end
