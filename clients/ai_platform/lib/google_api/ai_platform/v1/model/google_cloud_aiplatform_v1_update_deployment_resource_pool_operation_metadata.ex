...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateDeploymentResourcePoolOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateDeploymentResourcePoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateDeploymentResourcePoolOperationMetadata.decode(
      value,
      options
    )
  end
