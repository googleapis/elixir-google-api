...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadRagFileConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadRagFileConfig do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadRagFileConfig.decode(
      value,
      options
    )
  end
