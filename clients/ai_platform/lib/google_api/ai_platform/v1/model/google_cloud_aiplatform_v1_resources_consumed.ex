...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ResourcesConsumed do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ResourcesConsumed do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ResourcesConsumed.decode(value, options)
  end
end
