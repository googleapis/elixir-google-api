...
defmodule GoogleApi.AIPlatform.V1.Model.LearningGenaiRecitationDocAttribution do
  @moduledoc """
  ...
  *   `isPrompt` (*type:* `boolean()`, *default:* `nil`) - When true, this attribution came from the user's prompt.
  ...
  *   `youtubeVideoId` (*type:* `String.t`, *default:* `nil`) - 
  """
...
defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.LearningGenaiRecitationDocAttribution do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.LearningGenaiRecitationDocAttribution.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.LearningGenaiRecitationDocAttribution do
