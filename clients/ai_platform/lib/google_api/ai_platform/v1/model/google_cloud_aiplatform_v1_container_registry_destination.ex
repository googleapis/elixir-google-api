...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ContainerRegistryDestination do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ContainerRegistryDestination do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ContainerRegistryDestination.decode(
      value,
      options
    )
  end
