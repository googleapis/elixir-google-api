...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictPredictionTextExtractionPredictionResult do
  @moduledoc """
  ...
  *   `textSegmentStartOffsets` (*type:* `list(String.t)`, *default:* `nil`) - The start offsets, inclusive, of the text segment in which the AnnotationSpec has been identified. Expressed as a zero-based number of characters as measured from the start of the text snippet.
  ...
  @type t :: %__MODULE__{
          ...
          :textSegmentEndOffsets => list(String.t()) | nil,
          :textSegmentStartOffsets => list(String.t()) | nil
        }

  field(:confidences, type: :list)
  field(:displayNames, type: :list)
  field(:ids, type: :list)
  field(:textSegmentEndOffsets, type: :list)
  field(:textSegmentStartOffsets, type: :list)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictPredictionTextExtractionPredictionResult do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictPredictionTextExtractionPredictionResult.decode(
      value,
      options
    )
  end
