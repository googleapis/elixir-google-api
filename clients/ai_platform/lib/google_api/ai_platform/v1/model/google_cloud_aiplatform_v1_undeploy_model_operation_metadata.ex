...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UndeployModelOperationMetadata.decode(
      value,
      options
    )
  end
