...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1RestoreDatasetVersionOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1RestoreDatasetVersionOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1RestoreDatasetVersionOperationMetadata.decode(
      value,
      options
    )
  end
