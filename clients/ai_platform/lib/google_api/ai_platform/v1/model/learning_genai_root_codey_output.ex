...
defmodule GoogleApi.AIPlatform.V1.Model.LearningGenaiRootCodeyOutput do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.LearningGenaiRootCodeyOutput do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.LearningGenaiRootCodeyOutput.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.LearningGenaiRootCodeyOutput do
