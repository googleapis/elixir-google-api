...
defmodule GoogleApi.AIPlatform.V1.Model.LanguageLabsAidaTrustRecitationProtoRecitationResult do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.LanguageLabsAidaTrustRecitationProtoRecitationResult do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.LanguageLabsAidaTrustRecitationProtoRecitationResult.decode(
      value,
      options
    )
  end
