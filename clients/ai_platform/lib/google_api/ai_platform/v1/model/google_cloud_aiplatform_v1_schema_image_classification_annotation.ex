...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaImageClassificationAnnotation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaImageClassificationAnnotation do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaImageClassificationAnnotation.decode(
      value,
      options
    )
  end
