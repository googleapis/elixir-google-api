...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1TrajectoryInOrderMatchSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  ...
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1TrajectoryInOrderMatchSpec.decode(
      value,
      options
    )
  end
