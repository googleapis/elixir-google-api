...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetVersionOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetVersionOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateDatasetVersionOperationMetadata.decode(
      value,
      options
    )
  end
