...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ExportModelOperationMetadata.decode(
      value,
      options
    )
  end
