...
defmodule GoogleApi.AIPlatform.V1.Model.CloudAiNlLlmProtoServiceSafetyRatingInfluentialTerm do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.CloudAiNlLlmProtoServiceSafetyRatingInfluentialTerm do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.CloudAiNlLlmProtoServiceSafetyRatingInfluentialTerm.decode(
      value,
      options
    )
  end
