...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateSpecialistPoolOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateSpecialistPoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateSpecialistPoolOperationMetadata.decode(
      value,
      options
    )
  end
