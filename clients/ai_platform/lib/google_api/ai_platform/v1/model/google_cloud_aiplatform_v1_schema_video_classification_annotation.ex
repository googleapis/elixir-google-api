...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaVideoClassificationAnnotation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaVideoClassificationAnnotation do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaVideoClassificationAnnotation.decode(
      value,
      options
    )
  end
