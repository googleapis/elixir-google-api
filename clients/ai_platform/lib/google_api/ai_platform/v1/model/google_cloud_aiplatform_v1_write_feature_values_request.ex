...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1WriteFeatureValuesRequest do
  @moduledoc """
  ...
  *   `payloads` (*type:* `list(GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1WriteFeatureValuesPayload.t)`, *default:* `nil`) - Required. The entities to be written. Up to 100,000 feature values can be written across all `payloads`.
  ...
  field(:payloads,
    as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1WriteFeatureValuesPayload,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1WriteFeatureValuesRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1WriteFeatureValuesRequest.decode(
      value,
      options
    )
  end
