...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCancelPipelineJobsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCancelPipelineJobsRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1BatchCancelPipelineJobsRequest.decode(
      value,
      options
    )
  end
