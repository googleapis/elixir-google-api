...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeArtifactsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeArtifactsResponse do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeArtifactsResponse.decode(
      value,
      options
    )
  end
