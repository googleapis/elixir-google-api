...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairList do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairList do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesResponseFeatureNameValuePairList.decode(
      value,
      options
    )
  end
