...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictInstanceVideoActionRecognitionPredictionInstance do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictInstanceVideoActionRecognitionPredictionInstance do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaPredictInstanceVideoActionRecognitionPredictionInstance.decode(
      value,
      options
    )
  end
