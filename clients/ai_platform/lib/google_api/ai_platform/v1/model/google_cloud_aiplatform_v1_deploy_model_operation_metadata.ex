...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeployModelOperationMetadata.decode(
      value,
      options
    )
  end
