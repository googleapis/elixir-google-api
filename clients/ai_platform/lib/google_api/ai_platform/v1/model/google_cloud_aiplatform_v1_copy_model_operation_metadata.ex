...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CopyModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CopyModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CopyModelOperationMetadata.decode(
      value,
      options
    )
  end
