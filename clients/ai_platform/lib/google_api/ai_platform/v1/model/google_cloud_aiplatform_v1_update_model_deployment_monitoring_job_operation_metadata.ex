...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateModelDeploymentMonitoringJobOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateModelDeploymentMonitoringJobOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateModelDeploymentMonitoringJobOperationMetadata.decode(
      value,
      options
    )
  end
