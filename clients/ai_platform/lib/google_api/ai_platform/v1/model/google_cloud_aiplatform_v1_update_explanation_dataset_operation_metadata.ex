...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetOperationMetadata.decode(
      value,
      options
    )
  end
