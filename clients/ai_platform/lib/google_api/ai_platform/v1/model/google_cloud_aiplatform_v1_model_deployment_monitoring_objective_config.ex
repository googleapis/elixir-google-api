...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig do
  @moduledoc """
  ...
  *   `objectiveConfig` (*type:* `GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig.t`, *default:* `nil`) - The objective config of for the modelmonitoring job of this deployed model.
  ...
  field(:objectiveConfig,
    as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ModelMonitoringObjectiveConfig
  )
end

defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.decode(
      value,
      options
    )
  end
