...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1MutateDeployedModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1MutateDeployedModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1MutateDeployedModelOperationMetadata.decode(
      value,
      options
    )
  end
