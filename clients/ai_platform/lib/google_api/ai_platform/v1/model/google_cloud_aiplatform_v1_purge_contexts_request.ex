...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeContextsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeContextsRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PurgeContextsRequest.decode(
      value,
      options
    )
  end
