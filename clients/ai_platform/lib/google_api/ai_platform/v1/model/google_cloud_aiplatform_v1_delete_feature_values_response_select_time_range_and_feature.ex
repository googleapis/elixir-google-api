...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteFeatureValuesResponseSelectTimeRangeAndFeature do
  @moduledoc """
  ...
  *   `onlineStorageModifiedEntityCount` (*type:* `String.t`, *default:* `nil`) - The count of modified entities in the online storage. Each entity ID corresponds to one entity. Within each entity, only the features specified in the request are deleted.
  ...
  field(:impactedFeatureCount)
  field(:offlineStorageModifiedEntityRowCount)
  field(:onlineStorageModifiedEntityCount)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteFeatureValuesResponseSelectTimeRangeAndFeature do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1DeleteFeatureValuesResponseSelectTimeRangeAndFeature.decode(
      value,
      options
    )
  end
