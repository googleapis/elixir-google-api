...
defmodule GoogleApi.AIPlatform.V1.Model.UtilStatusProto do
  @moduledoc """
  ...
  *   `messageSet` (*type:* `GoogleApi.AIPlatform.V1.Model.Proto2BridgeMessageSet.t`, *default:* `nil`) - message_set associates an arbitrary proto message with the status.
  *   `space` (*type:* `String.t`, *default:* `nil`) - The following are usually only present when code != 0 Space to which this status belongs
  ...
  @type t :: %__MODULE__{
          ...
          :messageSet => GoogleApi.AIPlatform.V1.Model.Proto2BridgeMessageSet.t() | nil,
          :space => String.t() | nil
        }
  ...
  field(:code)
  field(:message)
  field(:messageSet, as: GoogleApi.AIPlatform.V1.Model.Proto2BridgeMessageSet)
  field(:space)
end

defimpl Poison.Decoder, for: GoogleApi.AIPlatform.V1.Model.UtilStatusProto do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.UtilStatusProto.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AIPlatform.V1.Model.UtilStatusProto do
