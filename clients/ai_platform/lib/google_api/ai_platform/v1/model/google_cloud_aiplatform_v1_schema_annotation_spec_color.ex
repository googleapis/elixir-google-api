...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaAnnotationSpecColor do
  @moduledoc """
  ...
  *   `id` (*type:* `String.t`, *default:* `nil`) - The ID of the AnnotationSpec represented by the color in the segmentation mask.
  ...
  field(:color, as: GoogleApi.AIPlatform.V1.Model.GoogleTypeColor)
  field(:displayName)
  field(:id)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaAnnotationSpecColor do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1SchemaAnnotationSpecColor.decode(
      value,
      options
    )
  end
