...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StartNotebookRuntimeOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StartNotebookRuntimeOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1StartNotebookRuntimeOperationMetadata.decode(
      value,
      options
    )
  end
