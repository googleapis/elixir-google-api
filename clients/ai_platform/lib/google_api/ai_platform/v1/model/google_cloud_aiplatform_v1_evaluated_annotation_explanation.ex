...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1EvaluatedAnnotationExplanation do
  @moduledoc """
  ...
  *   `explanationType` (*type:* `String.t`, *default:* `nil`) - Explanation type. For AutoML Image Classification models, possible values are: * `image-integrated-gradients` * `image-xrai`
  ...
  field(:explanation, as: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1Explanation)
  field(:explanationType)
end

defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1EvaluatedAnnotationExplanation do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1EvaluatedAnnotationExplanation.decode(
      value,
      options
    )
  end
