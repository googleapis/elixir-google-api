...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PublisherModelResourceReference do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PublisherModelResourceReference do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1PublisherModelResourceReference.decode(
      value,
      options
    )
  end
