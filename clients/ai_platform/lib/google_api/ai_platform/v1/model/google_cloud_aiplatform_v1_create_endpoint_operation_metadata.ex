...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateEndpointOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateEndpointOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1CreateEndpointOperationMetadata.decode(
      value,
      options
    )
  end
