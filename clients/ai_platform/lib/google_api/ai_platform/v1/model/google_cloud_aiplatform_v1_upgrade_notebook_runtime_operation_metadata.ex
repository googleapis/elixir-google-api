...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpgradeNotebookRuntimeOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpgradeNotebookRuntimeOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpgradeNotebookRuntimeOperationMetadata.decode(
      value,
      options
    )
  end
