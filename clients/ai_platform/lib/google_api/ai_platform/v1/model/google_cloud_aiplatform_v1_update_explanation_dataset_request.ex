...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetRequest do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateExplanationDatasetRequest.decode(
      value,
      options
    )
  end
