...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateIndexOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateIndexOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UpdateIndexOperationMetadata.decode(
      value,
      options
    )
  end
