...
defmodule GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.AIPlatform.V1.Model.GoogleCloudAiplatformV1UploadModelOperationMetadata.decode(
      value,
      options
    )
  end
