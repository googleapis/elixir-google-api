...
defmodule GoogleApi.YouTubeReporting.V1.Api.Jobs do
  ...
  returned in response to the previous call to the `ListReports` method.
    - :startTimeAtOrAfter (DateTime.t): If set, only reports whose start time is greater than or equal the
  specified date/time are returned.
    - :startTimeBefore (DateTime.t): If set, only reports whose start time is smaller than the specified
