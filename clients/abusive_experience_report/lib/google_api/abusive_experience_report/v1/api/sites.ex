...
defmodule GoogleApi.AbusiveExperienceReport.V1.Api.Sites do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.AbusiveExperienceReport.V1.Model.SiteSummaryResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def abusiveexperiencereport_sites_get(connection, sites_id, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.AbusiveExperienceReport.V1.Model.SiteSummaryResponse{}]
    )
  end
end
