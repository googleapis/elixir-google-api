...
defmodule GoogleApi.SourceRepo.V1.Model.Condition do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SourceRepo.V1.Model.Condition do
  def decode(value, _options) do
    value
  end
end

defimpl Poison.Encoder, for: GoogleApi.SourceRepo.V1.Model.Condition do
