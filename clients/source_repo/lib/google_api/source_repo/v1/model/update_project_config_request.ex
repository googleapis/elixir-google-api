...
defmodule GoogleApi.SourceRepo.V1.Model.UpdateProjectConfigRequest do
  ...
  - projectConfig (GoogleApi.SourceRepo.V1.Model.ProjectConfig.t): The new configuration for the project. Defaults to `nil`.
  - updateMask (String.t): A FieldMask specifying which fields of the project_config to modify. Only
  the fields in the mask will be modified. If no mask is provided, this
  request is no-op. Defaults to `nil`.
  """
