...
defmodule GoogleApi.SourceRepo.V1.Model.Rule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SourceRepo.V1.Model.Rule do
  import GoogleApi.SourceRepo.V1.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"conditions", :list, GoogleApi.SourceRepo.V1.Model.Condition, options)
    |> deserialize(:"logConfig", :list, GoogleApi.SourceRepo.V1.Model.LogConfig, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SourceRepo.V1.Model.Rule do
