...
defmodule GoogleApi.SourceRepo.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.SourceRepo.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://sourcerepo.googleapis.com"
