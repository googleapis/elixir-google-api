...
defimpl Poison.Decoder, for: GoogleApi.RuntimeConfig.V1.Model.Operation do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"error", :struct, GoogleApi.RuntimeConfig.V1.Model.Status, options)
    |> deserialize(:"metadata", :struct, GoogleApi.RuntimeConfig.V1.Model.Object, options)
    |> deserialize(:"response", :struct, GoogleApi.RuntimeConfig.V1.Model.Object, options)
  end
end
