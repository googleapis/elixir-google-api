...
defmodule GoogleApi.RuntimeConfig.V1.Model.Status do
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.RuntimeConfig.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.RuntimeConfig.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.RuntimeConfig.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.RuntimeConfig.V1.Model.Status.decode(value, options)
  end
end
