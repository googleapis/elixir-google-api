...
defmodule GoogleApi.RuntimeConfig.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.RuntimeConfig.V1.Model.Status do
  import GoogleApi.RuntimeConfig.V1.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"details", :list, GoogleApi.RuntimeConfig.V1.Model.Object, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.RuntimeConfig.V1.Model.Status do
