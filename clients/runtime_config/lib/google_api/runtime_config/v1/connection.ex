...
defmodule GoogleApi.RuntimeConfig.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.RuntimeConfig.V1.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://runtimeconfig.googleapis.com"
