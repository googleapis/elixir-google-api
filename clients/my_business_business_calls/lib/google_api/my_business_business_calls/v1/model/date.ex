...
defmodule GoogleApi.MyBusinessBusinessCalls.V1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MyBusinessBusinessCalls.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.MyBusinessBusinessCalls.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MyBusinessBusinessCalls.V1.Model.Date do
