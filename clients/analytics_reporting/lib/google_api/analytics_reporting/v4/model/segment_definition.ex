...
defmodule GoogleApi.AnalyticsReporting.V4.Model.SegmentDefinition do
  ...
  - segmentFilters ([SegmentFilter]): A segment is defined by a set of segment filters which are combined together with a logical &#x60;AND&#x60; operation. Defaults to: `null`.
  """
