...
defmodule GoogleApi.AnalyticsReporting.V4.Model.DateRangeValues do
  ...
  - pivotValueRegions ([PivotValueRegion]): The values of each pivot region. Defaults to: `null`.
  - values ([String.t]): Each value corresponds to each Metric in the request. Defaults to: `null`.
  """
