...
defmodule GoogleApi.AnalyticsReporting.V4.Model.PivotValueRegion do
  ...
  - values ([String.t]): The values of the metrics in each of the pivot regions. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsReporting.V4.Model.PivotValueRegion do
  def decode(value, options) do
    GoogleApi.AnalyticsReporting.V4.Model.PivotValueRegion.decode(value, options)
  end
end
