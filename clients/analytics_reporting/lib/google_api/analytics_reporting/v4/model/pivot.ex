...
defmodule GoogleApi.AnalyticsReporting.V4.Model.Pivot do
  ...
  - dimensionFilterClauses ([DimensionFilterClause]): DimensionFilterClauses are logically combined with an &#x60;AND&#x60; operator: only data that is included by all these DimensionFilterClauses contributes to the values in this pivot region. Dimension filters can be used to restrict the columns shown in the pivot region. For example if you have &#x60;ga:browser&#x60; as the requested dimension in the pivot region, and you specify key filters to restrict &#x60;ga:browser&#x60; to only \&quot;IE\&quot; or \&quot;Firefox\&quot;, then only those two browsers would show up as columns. Defaults to: `null`.
  - dimensions ([Dimension]): A list of dimensions to show as pivot columns. A Pivot can have a maximum of 4 dimensions. Pivot dimensions are part of the restriction on the total number of dimensions allowed in the request. Defaults to: `null`.
  ...
  - metrics ([Metric]): The pivot metrics. Pivot metrics are part of the restriction on total number of metrics allowed in the request. Defaults to: `null`.
