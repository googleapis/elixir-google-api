...
defmodule GoogleApi.AnalyticsReporting.V4.Model.CustomDimension do
  ...
  - index (integer()): Slot number of custom dimension. Defaults to: `null`.
  - value (String.t): Value of the custom dimension. Default value (i.e. empty string) indicates clearing sesion/visitor scope custom dimension value. Defaults to: `null`.
  """
