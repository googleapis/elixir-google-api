...
defmodule GoogleApi.AnalyticsReporting.V4.Model.MetricFilterClause do
  ...
  - filters ([MetricFilter]): The repeated set of filters. They are logically combined based on the operator specified. Defaults to: `null`.
  - operator (String.t): The operator for combining multiple metric filters. If unspecified, it is treated as an &#x60;OR&#x60;. Defaults to: `null`.
