...
defmodule GoogleApi.AnalyticsReporting.V4.Model.Dimension do
  ...
  - histogramBuckets (list(String.t)): If non-empty, we place dimension values into buckets after string to
  ...
  for a histogram-mutated dimension. Defaults to `nil`.
  - name (String.t): Name of the dimension to fetch, for example `ga:browser`. Defaults to `nil`.
  """
