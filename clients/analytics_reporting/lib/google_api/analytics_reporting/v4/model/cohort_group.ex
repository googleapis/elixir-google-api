...
defmodule GoogleApi.AnalyticsReporting.V4.Model.CohortGroup do
  ...
  - cohorts (list(GoogleApi.AnalyticsReporting.V4.Model.Cohort.t)): The definition for the cohort. Defaults to `nil`.
  ...
  [app view ID](https://support.google.com/analytics/answer/2649553#WebVersusAppViews) Defaults to `nil`.
  """
