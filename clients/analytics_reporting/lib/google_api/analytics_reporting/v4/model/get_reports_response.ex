...
defmodule GoogleApi.AnalyticsReporting.V4.Model.GetReportsResponse do
  ...
  - queryCost (integer()): The amount of resource quota tokens deducted to execute the query. Includes all responses. Defaults to: `null`.
  - reports ([Report]): Responses corresponding to each of the request. Defaults to: `null`.
  - resourceQuotasRemaining (ResourceQuotasRemaining): The amount of resource quota remaining for the property. Defaults to: `null`.
  """
