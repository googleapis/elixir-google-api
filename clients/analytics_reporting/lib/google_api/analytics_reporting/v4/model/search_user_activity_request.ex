...
defmodule GoogleApi.AnalyticsReporting.V4.Model.SearchUserActivityRequest do
  ...
  *   `pageToken` (*type:* `String.t`, *default:* `nil`) - A continuation token to get the next page of the results. Adding this to the request will return the rows after the pageToken. The pageToken should be the value returned in the nextPageToken parameter in the response to the [SearchUserActivityRequest](#SearchUserActivityRequest) request.
  *   `user` (*type:* `GoogleApi.AnalyticsReporting.V4.Model.User.t`, *default:* `nil`) - Required. Unique user Id to query for. Every [SearchUserActivityRequest](#SearchUserActivityRequest) must contain this field.
  *   `viewId` (*type:* `String.t`, *default:* `nil`) - Required. The Analytics [view ID](https://support.google.com/analytics/answer/1009618) from which to retrieve data. Every [SearchUserActivityRequest](#SearchUserActivityRequest) must contain the `viewId`.
  """
