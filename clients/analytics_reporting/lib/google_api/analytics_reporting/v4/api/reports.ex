...
defmodule GoogleApi.AnalyticsReporting.V4.Api.Reports do
  ...
  import GoogleApi.AnalyticsReporting.V4.RequestBuilder
  ...
  """
  @spec analyticsreporting_reports_batch_get(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.AnalyticsReporting.V4.Model.GetReportsResponse.t} | {:error, Tesla.Env.t}
  def analyticsreporting_reports_batch_get(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.AnalyticsReporting.V4.Model.GetReportsResponse{})
  end
end
