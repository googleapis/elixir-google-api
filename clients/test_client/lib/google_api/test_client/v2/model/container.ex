...
defmodule GoogleApi.TestClient.V2.Model.Container do
  ...
  - arrayRefVal (list(GoogleApi.TestClient.V2.Model.Container.t)): An array of reference objects Defaults to `nil`.
  ...
  - objectRefVal (GoogleApi.TestClient.V2.Model.Container.t): A reference to an object definition. Defaults to `nil`.
  - objectVal (GoogleApi.TestClient.V2.Model.ContainerObjectVal.t): An inline object definition Defaults to `nil`.
