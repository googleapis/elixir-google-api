...
defmodule GoogleApi.TestClient.V2.Api.Objects do
  ...
  - name (String.t): Required. The name of the bucket where the objects belong. The format is
  `b/[BUCKET]`
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :body (GoogleApi.TestClient.V2.Model.Container.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    - :alt (String.t): Data format for the response.
    - :category (list(String.t)): The category of the items. Must match all.
  ...
  - metadata (GoogleApi.TestClient.V2.Model.Container.t): object metadata
