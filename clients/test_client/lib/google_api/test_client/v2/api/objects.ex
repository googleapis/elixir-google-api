...
defmodule GoogleApi.TestClient.V2.Api.Objects do
  ...
  *   `connection` (*type:* `GoogleApi.TestClient.V2.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the bucket where the objects belong. The format is
      `b/[BUCKET]`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:alt` (*type:* `String.t`) - Data format for the response.
      *   `:body` (*type:* `GoogleApi.TestClient.V2.Model.Container.t`) - 
  ...
  *   `metadata` (*type:* `GoogleApi.TestClient.V2.Model.Container.t`) - object metadata
