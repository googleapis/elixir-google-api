...
defmodule GoogleApi.IAP.V1.Model.ApplicationSettings do
  ...
  *   `accessDeniedPageSettings` (*type:* `GoogleApi.IAP.V1.Model.AccessDeniedPageSettings.t`, *default:* `nil`) - Optional. Customization for Access Denied page.
  *   `attributePropagationSettings` (*type:* `GoogleApi.IAP.V1.Model.AttributePropagationSettings.t`, *default:* `nil`) - Optional. Settings to configure attribute propagation.
  ...
  *   `csmSettings` (*type:* `GoogleApi.IAP.V1.Model.CsmSettings.t`, *default:* `nil`) - Optional. Settings to configure IAP's behavior for a service mesh.
  """
