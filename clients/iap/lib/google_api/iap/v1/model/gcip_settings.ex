...
defmodule GoogleApi.IAP.V1.Model.GcipSettings do
  ...
  *   `loginPageUri` (*type:* `String.t`, *default:* `nil`) - Login page URI associated with the GCIP tenants.
      Typically, all resources within the same project share the same login page,
      though it could be overridden at the sub resource level.
  *   `tenantIds` (*type:* `list(String.t)`, *default:* `nil`) - GCIP tenant ids that are linked to the IAP resource.
