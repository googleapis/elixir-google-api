...
defimpl Poison.Decoder, for: GoogleApi.IAP.V1.Model.CorsSettings do
  def decode(value, options) do
    GoogleApi.IAP.V1.Model.CorsSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAP.V1.Model.CorsSettings do
