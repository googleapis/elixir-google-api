...
defmodule GoogleApi.IAP.V1.Model.TunnelDestGroup do
  @moduledoc """
  A TunnelDestGroup.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Required. Immutable. Identifier for the TunnelDestGroup. Must be unique within the project.
  ...
  @type t :: %__MODULE__{
          :cidrs => list(String.t()) | nil,
          :fqdns => list(String.t()) | nil,
          :name => String.t() | nil
        }

  field(:cidrs, type: :list)
  field(:fqdns, type: :list)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.IAP.V1.Model.TunnelDestGroup do
  def decode(value, options) do
    GoogleApi.IAP.V1.Model.TunnelDestGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAP.V1.Model.TunnelDestGroup do
