...
defmodule GoogleApi.IAP.V1.Model.Resource do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Name of the resource on which conditions will be evaluated.
      Relative Resource Name of the resource should be set, which is the URI
      path of the resource without leading "/". For instance, resource.name
      set for a bucket is "projects/project123/buckets/bucket456".
      This field is required for evaluating conditions with rules on resource
      names. SYSContext.resource_name is not used by condition evaluation.
