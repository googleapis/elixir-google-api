...
defmodule GoogleApi.IAP.V1.Model.Policy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAP.V1.Model.Policy do
  def decode(value, options) do
    GoogleApi.IAP.V1.Model.Policy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAP.V1.Model.Policy do
