...
defmodule GoogleApi.BareMetalSolution.V1.Model.ServerNetworkTemplate do
  @moduledoc """
  Network template.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. Template's unique name. The full resource name follows the pattern: `projects/{project}/locations/{location}/serverNetworkTemplate/{server_network_template}` Generally, the {server_network_template} follows the syntax of "bond" or "nic".
  ...
  @type t :: %__MODULE__{
          ...
          :logicalInterfaces =>
            list(GoogleApi.BareMetalSolution.V1.Model.LogicalInterface.t()) | nil,
          :name => String.t() | nil
        }

  field(:applicableInstanceTypes, type: :list)

  field(:logicalInterfaces, as: GoogleApi.BareMetalSolution.V1.Model.LogicalInterface, type: :list)

  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.BareMetalSolution.V1.Model.ServerNetworkTemplate do
  def decode(value, options) do
    GoogleApi.BareMetalSolution.V1.Model.ServerNetworkTemplate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BareMetalSolution.V1.Model.ServerNetworkTemplate do
