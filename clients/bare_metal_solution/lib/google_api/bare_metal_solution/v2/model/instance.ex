...
defmodule GoogleApi.BareMetalSolution.V2.Model.Instance do
  ...
  *   `id` (*type:* `String.t`, *default:* `nil`) - An identifier for the `Instance`, generated by the backend.
  *   `interactiveSerialConsoleEnabled` (*type:* `boolean()`, *default:* `nil`) - True if the interactive serial console feature is enabled for the instance, false otherwise. The default value is false.
  ...
  *   `luns` (*type:* `list(GoogleApi.BareMetalSolution.V2.Model.Lun.t)`, *default:* `nil`) - List of LUNs associated with this server.
  *   `machineType` (*type:* `String.t`, *default:* `nil`) - The server type. [Available server types](https://cloud.google.com/bare-metal/docs/bms-planning#server_configurations)
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name of this `Instance`. Resource names are schemeless URIs that follow the conventions in https://cloud.google.com/apis/design/resource_names. Format: `projects/{project}/locations/{location}/instances/{instance}`
  ...
  *   `networks` (*type:* `list(GoogleApi.BareMetalSolution.V2.Model.Network.t)`, *default:* `nil`) - List of networks associated with this server.
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - The state of the server.
