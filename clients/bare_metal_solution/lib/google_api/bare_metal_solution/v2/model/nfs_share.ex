...
defmodule GoogleApi.BareMetalSolution.V2.Model.NfsShare do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The name of the NFS share.
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - The state of the NFS share.
  *   `volume` (*type:* `String.t`, *default:* `nil`) - The volume containing the share.
  """
