...
defmodule GoogleApi.BareMetalSolution.V2.Model.ListNetworksResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BareMetalSolution.V2.Model.ListNetworksResponse do
  def decode(value, options) do
    GoogleApi.BareMetalSolution.V2.Model.ListNetworksResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BareMetalSolution.V2.Model.ListNetworksResponse do
