...
defmodule GoogleApi.BareMetalSolution.V2.Model.UserAccount do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BareMetalSolution.V2.Model.UserAccount do
  def decode(value, options) do
    GoogleApi.BareMetalSolution.V2.Model.UserAccount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BareMetalSolution.V2.Model.UserAccount do
