...
defmodule GoogleApi.BareMetalSolution.V2.Model.ListVolumesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BareMetalSolution.V2.Model.ListVolumesResponse do
  def decode(value, options) do
    GoogleApi.BareMetalSolution.V2.Model.ListVolumesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BareMetalSolution.V2.Model.ListVolumesResponse do
