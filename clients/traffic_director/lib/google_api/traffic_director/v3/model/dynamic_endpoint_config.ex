...
defmodule GoogleApi.TrafficDirector.V3.Model.DynamicEndpointConfig do
  @moduledoc """
  [#next-free-field: 6]
  ...
  *   `versionInfo` (*type:* `String.t`, *default:* `nil`) - [#not-implemented-hide:] This is the per-resource version information. This version is currently taken from the :ref:`version_info ` field at the time that the endpoint configuration was loaded.
  """
  ...
  field(:clientStatus)
  field(:endpointConfig, type: :map)
  field(:errorState, as: GoogleApi.TrafficDirector.V3.Model.UpdateFailureState)
  field(:lastUpdated, as: DateTime)
  field(:versionInfo)
end

defimpl Poison.Decoder, for: GoogleApi.TrafficDirector.V3.Model.DynamicEndpointConfig do
  def decode(value, options) do
    GoogleApi.TrafficDirector.V3.Model.DynamicEndpointConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TrafficDirector.V3.Model.DynamicEndpointConfig do
