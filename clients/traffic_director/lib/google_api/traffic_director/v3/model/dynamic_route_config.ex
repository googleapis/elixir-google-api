...
defmodule GoogleApi.TrafficDirector.V3.Model.DynamicRouteConfig do
  @moduledoc """
  [#next-free-field: 6]
  ...
  *   `versionInfo` (*type:* `String.t`, *default:* `nil`) - This is the per-resource version information. This version is currently taken from the :ref:`version_info ` field at the time that the route configuration was loaded.
  """
  ...
  field(:routeConfig, type: :map)
  field(:versionInfo)
end

defimpl Poison.Decoder, for: GoogleApi.TrafficDirector.V3.Model.DynamicRouteConfig do
  def decode(value, options) do
    GoogleApi.TrafficDirector.V3.Model.DynamicRouteConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TrafficDirector.V3.Model.DynamicRouteConfig do
