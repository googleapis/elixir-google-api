...
defmodule GoogleApi.BigLake.V1.Model.RenameTableRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigLake.V1.Model.RenameTableRequest do
  def decode(value, options) do
    GoogleApi.BigLake.V1.Model.RenameTableRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigLake.V1.Model.RenameTableRequest do
