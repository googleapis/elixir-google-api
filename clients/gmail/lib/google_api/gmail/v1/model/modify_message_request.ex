...
defmodule GoogleApi.Gmail.V1.Model.ModifyMessageRequest do
  ...
  - addLabelIds (list(String.t)): A list of IDs of labels to add to this message. Defaults to `nil`.
  - removeLabelIds (list(String.t)): A list IDs of labels to remove from this message. Defaults to `nil`.
  """
