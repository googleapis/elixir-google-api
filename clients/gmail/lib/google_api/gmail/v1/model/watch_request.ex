...
defmodule GoogleApi.Gmail.V1.Model.WatchRequest do
  ...
  - labelFilterAction (String.t): Filtering behavior of labelIds list specified. Defaults to `nil`.
  - labelIds (list(String.t)): List of label_ids to restrict notifications about. By default, if unspecified, all changes are pushed out. If specified then dictates which labels are required for a push notification to be generated. Defaults to `nil`.
  ...
  Note that the "my-project-identifier" portion must exactly match your Google developer project id (the one executing this watch request). Defaults to `nil`.
  """
