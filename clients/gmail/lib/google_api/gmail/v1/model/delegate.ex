...
defmodule GoogleApi.Gmail.V1.Model.Delegate do
  ...
  - delegateEmail (String.t): The email address of the delegate. Defaults to `nil`.
  - verificationStatus (String.t): Indicates whether this address has been verified and can act as a delegate for the account. Read-only. Defaults to `nil`.
  """
