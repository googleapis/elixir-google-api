...
defmodule GoogleApi.RapidMigrationAssessment.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.RapidMigrationAssessment.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.RapidMigrationAssessment.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.RapidMigrationAssessment.V1.Model.OperationMetadata do
