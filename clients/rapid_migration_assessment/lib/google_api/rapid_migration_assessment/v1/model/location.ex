...
defmodule GoogleApi.RapidMigrationAssessment.V1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.RapidMigrationAssessment.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.RapidMigrationAssessment.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.RapidMigrationAssessment.V1.Model.Location do
