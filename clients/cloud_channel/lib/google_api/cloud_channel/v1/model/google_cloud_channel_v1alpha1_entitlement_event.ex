...
defmodule GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1EntitlementEvent do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1EntitlementEvent do
  def decode(value, options) do
    GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1EntitlementEvent.decode(
      value,
      options
    )
  end
