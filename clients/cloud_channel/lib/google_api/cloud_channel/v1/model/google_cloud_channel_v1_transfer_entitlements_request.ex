...
defmodule GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1TransferEntitlementsRequest do
  @moduledoc """
  ...
  *   `entitlements` (*type:* `list(GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Entitlement.t)`, *default:* `nil`) - Required. The new entitlements to create or transfer.
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1TransferEntitlementsRequest do
  def decode(value, options) do
    GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1TransferEntitlementsRequest.decode(
      value,
      options
    )
  end
