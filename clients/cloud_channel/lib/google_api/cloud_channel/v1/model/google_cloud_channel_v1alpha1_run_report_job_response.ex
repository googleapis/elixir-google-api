...
defmodule GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1RunReportJobResponse do
  @moduledoc """
  ...
  *   `reportMetadata` (*type:* `GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1ReportResultsMetadata.t`, *default:* `nil`) - The metadata for the report's results (display name, columns, row count, and date range). If you view this before the operation finishes, you may see incomplete data.
  ...
  @type t :: %__MODULE__{
          :reportJob =>
            GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1ReportJob.t() | nil,
          :reportMetadata =>
            GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1ReportResultsMetadata.t()
            | nil
        }

  field(:reportJob, as: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1ReportJob)

  field(:reportMetadata,
    as: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1ReportResultsMetadata
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1RunReportJobResponse do
  def decode(value, options) do
    GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1alpha1RunReportJobResponse.decode(
      value,
      options
    )
  end
