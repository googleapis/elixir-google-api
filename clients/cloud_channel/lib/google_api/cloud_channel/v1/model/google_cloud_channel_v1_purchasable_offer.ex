...
defmodule GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1PurchasableOffer do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1PurchasableOffer do
  def decode(value, options) do
    GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1PurchasableOffer.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1PurchasableOffer do
