...
defmodule GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Report do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Required. The report's resource name. Specifies the account and report used to generate report data. The report_id identifier is a UID (for example, `613bf59q`). Name uses the format: accounts/{account_id}/reports/{report_id}
  ...
  @type t :: %__MODULE__{
          :columns => list(GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Column.t()) | nil,
          :description => String.t() | nil,
          :displayName => String.t() | nil,
          :name => String.t() | nil
        }

  field(:columns, as: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Column, type: :list)
  field(:description)
  field(:displayName)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Report do
  def decode(value, options) do
    GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Report.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudChannel.V1.Model.GoogleCloudChannelV1Report do
