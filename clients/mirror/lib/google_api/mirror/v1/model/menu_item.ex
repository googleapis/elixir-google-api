...
defmodule GoogleApi.Mirror.V1.Model.MenuItem do
  ...
  *   `action` (*type:* `String.t`, *default:* `nil`) - Controls the behavior when the user picks the menu option. Allowed values are:  
  ...
  *   `removeWhenSelected` (*type:* `boolean()`, *default:* `nil`) - If set to true on a CUSTOM menu item, that item will be removed from the menu after it is selected.
  *   `values` (*type:* `list(GoogleApi.Mirror.V1.Model.MenuValue.t)`, *default:* `nil`) - For CUSTOM items, a list of values controlling the appearance of the menu item in each of its states. A value for the DEFAULT state must be provided. If the PENDING or CONFIRMED states are missing, they will not be shown.
  """
