...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAttachmentCsv do
  @moduledoc """
  ...
  *   `headers` (*type:* `list(String.t)`, *default:* `nil`) - The list of headers for data columns in a CSV file.
  ...
  field(:dataRows,
    as: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAttachmentCsvCsvRow,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAttachmentCsv do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAttachmentCsv.decode(
      value,
      options
    )
  end
