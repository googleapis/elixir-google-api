...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1SettingsNotificationCloudPubsubTopic do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1SettingsNotificationCloudPubsubTopic do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1SettingsNotificationCloudPubsubTopic.decode(
      value,
      options
    )
  end
