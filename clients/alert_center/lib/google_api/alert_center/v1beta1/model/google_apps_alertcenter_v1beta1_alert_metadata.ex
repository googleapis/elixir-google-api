...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata do
  @moduledoc """
  An alert metadata.
...
defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata.decode(
      value,
      options
    )
  end
