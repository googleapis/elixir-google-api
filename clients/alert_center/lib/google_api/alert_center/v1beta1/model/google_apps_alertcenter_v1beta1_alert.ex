...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1Alert do
  @moduledoc """
  ...
  *   `metadata` (*type:* `GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata.t`, *default:* `nil`) - Output only. The metadata associated with this alert.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time this alert was last updated.
  ...
  @type t :: %__MODULE__{
          ...
          :etag => String.t() | nil,
          :metadata =>
            GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata.t()
            | nil,
  ...
  field(:metadata,
    as: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertMetadata
  )
...
defimpl Poison.Decoder, for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1Alert do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1Alert.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1Alert do
