...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertFeedback do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertFeedback do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterV1beta1AlertFeedback.decode(
      value,
      options
    )
  end
