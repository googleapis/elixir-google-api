...
defmodule GoogleApi.AlertCenter.V1beta1.Model.AlertMetadata do
  ...
  *   `etag` (*type:* `String.t`, *default:* `nil`) - Optional. `etag` is used for optimistic concurrency control as a way to
  ...
  *   `severity` (*type:* `String.t`, *default:* `nil`) - The severity value of the alert. Alert Center will set this field at alert
      ...
      * MEDIUM
      * LOW
  *   `status` (*type:* `String.t`, *default:* `nil`) - The current status of the alert.
