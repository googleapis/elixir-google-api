...
defimpl Poison.Decoder, for: GoogleApi.AlertCenter.V1beta1.Model.PhishingSpike do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.PhishingSpike.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlertCenter.V1beta1.Model.PhishingSpike do
