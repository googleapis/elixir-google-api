...
defmodule GoogleApi.AlertCenter.V1beta1.Model.UserChanges do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AlertCenter.V1beta1.Model.UserChanges do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.UserChanges.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlertCenter.V1beta1.Model.UserChanges do
