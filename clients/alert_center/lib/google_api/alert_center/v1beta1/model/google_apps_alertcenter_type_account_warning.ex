...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarning do
  @moduledoc """
  ...
  *   `loginDetails` (*type:* `GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarningLoginDetails.t`, *default:* `nil`) - Optional. Details of the login action associated with the warning event. This is only available for: * Suspicious login * Suspicious login (less secure app) * Suspicious programmatic login * User suspended (suspicious activity)
  ...
  field(:loginDetails,
    as: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarningLoginDetails
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarning do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarning.decode(
      value,
      options
    )
  end
