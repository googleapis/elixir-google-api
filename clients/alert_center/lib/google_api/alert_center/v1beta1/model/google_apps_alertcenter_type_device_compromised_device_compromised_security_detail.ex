...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeDeviceCompromisedDeviceCompromisedSecurityDetail do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeDeviceCompromisedDeviceCompromisedSecurityDetail do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeDeviceCompromisedDeviceCompromisedSecurityDetail.decode(
      value,
      options
    )
  end
