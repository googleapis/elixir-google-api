...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypePhishingSpike do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypePhishingSpike do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypePhishingSpike.decode(
      value,
      options
    )
  end
