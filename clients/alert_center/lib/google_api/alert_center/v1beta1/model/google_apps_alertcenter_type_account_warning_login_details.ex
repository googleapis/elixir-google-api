...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarningLoginDetails do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarningLoginDetails do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAccountWarningLoginDetails.decode(
      value,
      options
    )
  end
