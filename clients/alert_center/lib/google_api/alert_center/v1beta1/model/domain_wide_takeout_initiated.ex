...
defimpl Poison.Decoder, for: GoogleApi.AlertCenter.V1beta1.Model.DomainWideTakeoutInitiated do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.DomainWideTakeoutInitiated.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AlertCenter.V1beta1.Model.DomainWideTakeoutInitiated do
