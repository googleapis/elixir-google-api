...
defmodule GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAppMakerSqlSetupNotificationRequestInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAppMakerSqlSetupNotificationRequestInfo do
  def decode(value, options) do
    GoogleApi.AlertCenter.V1beta1.Model.GoogleAppsAlertcenterTypeAppMakerSqlSetupNotificationRequestInfo.decode(
      value,
      options
    )
  end
