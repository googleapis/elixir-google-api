...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_CampaignEffectiveLabel do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_CampaignEffectiveLabel do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_CampaignEffectiveLabel.decode(
      value,
      options
    )
  end
