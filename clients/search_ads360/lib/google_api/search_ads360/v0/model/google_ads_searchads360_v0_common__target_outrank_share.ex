...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_TargetOutrankShare do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_TargetOutrankShare do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_TargetOutrankShare.decode(
      value,
      options
    )
  end
