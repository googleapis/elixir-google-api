...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_AssetGroupTopCombinationView do
  @moduledoc """
  ...
  *   `resourceName` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name of the asset group top combination view. AssetGroup Top Combination view resource names have the form: `"customers/{customer_id}/assetGroupTopCombinationViews/{asset_group_id}~{asset_combination_category}"
  ...
  field(:assetGroupTopCombinations,
    as:
      GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_AssetGroupAssetCombinationData,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_AssetGroupTopCombinationView do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Resources_AssetGroupTopCombinationView.decode(
      value,
      options
    )
  end
