...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_BusinessProfileLocation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_BusinessProfileLocation do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_BusinessProfileLocation.decode(
      value,
      options
    )
  end
