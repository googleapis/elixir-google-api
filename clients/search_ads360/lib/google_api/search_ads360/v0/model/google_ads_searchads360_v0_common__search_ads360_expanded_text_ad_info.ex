...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_SearchAds360ExpandedTextAdInfo do
  @moduledoc """
  ...
  *   `headline2` (*type:* `String.t`, *default:* `nil`) - The second headline of the ad.
  *   `headline3` (*type:* `String.t`, *default:* `nil`) - The third headline of the ad.
  ...
  *   `path2` (*type:* `String.t`, *default:* `nil`) - Text appended to path1 with a delimiter.
  ...
  @type t :: %__MODULE__{
          ...
          :headline2 => String.t() | nil,
          :headline3 => String.t() | nil,
          :path1 => String.t() | nil,
          :path2 => String.t() | nil
        }
...
defimpl Poison.Decoder,
  for:
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_SearchAds360ExpandedTextAdInfo do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_SearchAds360ExpandedTextAdInfo.decode(
      value,
      options
    )
  end
