...
defmodule GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_AssetInteractionTarget do
  @moduledoc """
  ...
  *   `interactionOnThisAsset` (*type:* `boolean()`, *default:* `nil`) - Only used with CustomerAsset, CampaignAsset and AdGroupAsset metrics. Indicates whether the interaction metrics occurred on the asset itself or a different asset or ad unit.
  ...
  field(:asset)
  field(:interactionOnThisAsset)
end

defimpl Poison.Decoder,
  for: GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_AssetInteractionTarget do
  def decode(value, options) do
    GoogleApi.SearchAds360.V0.Model.GoogleAdsSearchads360V0Common_AssetInteractionTarget.decode(
      value,
      options
    )
  end
