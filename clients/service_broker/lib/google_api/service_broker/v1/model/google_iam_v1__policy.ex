...
defmodule GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Policy do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :bindings => list(GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Binding.t()),
          :etag => any(),
          :version => any()
        }

  field(:bindings, as: GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Binding, type: :list)
  field(:etag)
  field(:version)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Policy do
  def decode(value, options) do
    GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Policy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceBroker.V1.Model.GoogleIamV1Policy do
