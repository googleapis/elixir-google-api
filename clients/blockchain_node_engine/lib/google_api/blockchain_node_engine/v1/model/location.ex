...
defmodule GoogleApi.BlockchainNodeEngine.V1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BlockchainNodeEngine.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.BlockchainNodeEngine.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BlockchainNodeEngine.V1.Model.Location do
