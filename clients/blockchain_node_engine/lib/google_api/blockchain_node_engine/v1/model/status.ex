...
defmodule GoogleApi.BlockchainNodeEngine.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BlockchainNodeEngine.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.BlockchainNodeEngine.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BlockchainNodeEngine.V1.Model.Status do
