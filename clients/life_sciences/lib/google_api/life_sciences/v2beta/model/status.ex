...
defmodule GoogleApi.LifeSciences.V2beta.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.LifeSciences.V2beta.Model.Status do
  def decode(value, options) do
    GoogleApi.LifeSciences.V2beta.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.LifeSciences.V2beta.Model.Status do
