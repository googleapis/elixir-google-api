...
defimpl Poison.Decoder, for: GoogleApi.LifeSciences.V2beta.Model.FailedEvent do
  def decode(value, options) do
    GoogleApi.LifeSciences.V2beta.Model.FailedEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.LifeSciences.V2beta.Model.FailedEvent do
