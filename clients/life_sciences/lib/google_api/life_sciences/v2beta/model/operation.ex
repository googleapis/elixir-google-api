...
defmodule GoogleApi.LifeSciences.V2beta.Model.Operation do
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - An Empty object.
  ...
  @type t :: %__MODULE__{
          :done => boolean() | nil,
          :error => GoogleApi.LifeSciences.V2beta.Model.Status.t() | nil,
          :metadata => map() | nil,
          :name => String.t() | nil,
          :response => map() | nil
        }
  ...
  field(:done)
  field(:error, as: GoogleApi.LifeSciences.V2beta.Model.Status)
  field(:metadata, type: :map)
  field(:name)
  field(:response, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.LifeSciences.V2beta.Model.Operation do
  def decode(value, options) do
    GoogleApi.LifeSciences.V2beta.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.LifeSciences.V2beta.Model.Operation do
