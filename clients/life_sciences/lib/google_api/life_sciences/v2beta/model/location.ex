...
defmodule GoogleApi.LifeSciences.V2beta.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.LifeSciences.V2beta.Model.Location do
  def decode(value, options) do
    GoogleApi.LifeSciences.V2beta.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.LifeSciences.V2beta.Model.Location do
