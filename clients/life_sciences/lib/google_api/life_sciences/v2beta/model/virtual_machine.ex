...
defmodule GoogleApi.LifeSciences.V2beta.Model.VirtualMachine do
  ...
  *   `disks` (*type:* `list(GoogleApi.LifeSciences.V2beta.Model.Disk.t)`, *default:* `nil`) - The list of disks to create and attach to the VM. Specify either the `volumes[]` field or the `disks[]` field, but not both.
  ...
  *   `volumes` (*type:* `list(GoogleApi.LifeSciences.V2beta.Model.Volume.t)`, *default:* `nil`) - The list of disks and other storage to create or attach to the VM. Specify either the `volumes[]` field or the `disks[]` field, but not both.
  """
