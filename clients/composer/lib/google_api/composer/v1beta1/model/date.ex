...
defmodule GoogleApi.Composer.V1beta1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1beta1.Model.Date do
  def decode(value, options) do
    GoogleApi.Composer.V1beta1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1beta1.Model.Date do
