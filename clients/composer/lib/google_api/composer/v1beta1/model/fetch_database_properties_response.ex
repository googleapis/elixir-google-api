...
defmodule GoogleApi.Composer.V1beta1.Model.FetchDatabasePropertiesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1beta1.Model.FetchDatabasePropertiesResponse do
  def decode(value, options) do
    GoogleApi.Composer.V1beta1.Model.FetchDatabasePropertiesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1beta1.Model.FetchDatabasePropertiesResponse do
