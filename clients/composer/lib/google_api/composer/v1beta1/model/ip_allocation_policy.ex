...
defmodule GoogleApi.Composer.V1beta1.Model.IPAllocationPolicy do
  ...
  - clusterIpv4CidrBlock (String.t): Optional. The IP address range used to allocate IP addresses to pods in
  the cluster.
  ...
  but not both. Defaults to `nil`.
  - clusterSecondaryRangeName (String.t): Optional. The name of the cluster's secondary range used to allocate
  IP addresses to pods. Specify either `cluster_secondary_range_name`
  or `cluster_ipv4_cidr_block` but not both.

  This field is applicable only when `use_ip_aliases` is true. Defaults to `nil`.
  - servicesIpv4CidrBlock (String.t): Optional. The IP address range of the services IP addresses in this
  cluster.
  ...
  but not both. Defaults to `nil`.
  - servicesSecondaryRangeName (String.t): Optional. The name of the services' secondary range used to allocate
  IP addresses to the cluster. Specify either `services_secondary_range_name`
  or `services_ipv4_cidr_block` but not both.

  This field is applicable only when `use_ip_aliases` is true. Defaults to `nil`.
  - useIpAliases (boolean()): Optional. Whether or not to enable Alias IPs in the GKE cluster.
  If `true`, a VPC-native cluster is created. Defaults to `nil`.
  """
