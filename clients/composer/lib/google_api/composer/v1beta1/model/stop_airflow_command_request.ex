...
defmodule GoogleApi.Composer.V1beta1.Model.StopAirflowCommandRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1beta1.Model.StopAirflowCommandRequest do
  def decode(value, options) do
    GoogleApi.Composer.V1beta1.Model.StopAirflowCommandRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1beta1.Model.StopAirflowCommandRequest do
