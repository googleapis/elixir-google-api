...
defmodule GoogleApi.Composer.V1beta1.Model.PrivateClusterConfig do
  ...
  - enablePrivateEndpoint (boolean()): Optional. If `true`, access to the public endpoint of the GKE cluster is
  denied. Defaults to `nil`.
  ...
  '172.16.0.0/28' is used. Defaults to `nil`.
  """
