...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1beta1.Model.DagProcessorResource do
  def decode(value, options) do
    GoogleApi.Composer.V1beta1.Model.DagProcessorResource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1beta1.Model.DagProcessorResource do
