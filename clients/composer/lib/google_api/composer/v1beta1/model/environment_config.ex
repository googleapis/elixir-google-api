...
defmodule GoogleApi.Composer.V1beta1.Model.EnvironmentConfig do
  ...
  *   `dataRetentionConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.DataRetentionConfig.t`, *default:* `nil`) - Optional. The configuration setting for Airflow database data retention mechanism.
  ...
  *   `encryptionConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.EncryptionConfig.t`, *default:* `nil`) - Optional. The encryption options for the Cloud Composer environment and its dependencies. Cannot be updated.
  ...
  *   `nodeConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.NodeConfig.t`, *default:* `nil`) - Optional. The configuration used for the Kubernetes Engine cluster.
  ...
  *   `privateEnvironmentConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.PrivateEnvironmentConfig.t`, *default:* `nil`) - Optional. The configuration used for the Private IP Cloud Composer environment.
  ...
  *   `softwareConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.SoftwareConfig.t`, *default:* `nil`) - Optional. The configuration settings for software inside the environment.
  ...
  *   `workloadsConfig` (*type:* `GoogleApi.Composer.V1beta1.Model.WorkloadsConfig.t`, *default:* `nil`) - Optional. The workloads configuration settings for the GKE cluster associated with the Cloud Composer environment. The GKE cluster runs Airflow scheduler, web server and workers workloads. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
  ...
  @type t :: %__MODULE__{
          ...
          :dataRetentionConfig => GoogleApi.Composer.V1beta1.Model.DataRetentionConfig.t() | nil,
          ...
          :masterAuthorizedNetworksConfig =>
            GoogleApi.Composer.V1beta1.Model.MasterAuthorizedNetworksConfig.t() | nil,
          ...
          :workloadsConfig => GoogleApi.Composer.V1beta1.Model.WorkloadsConfig.t() | nil
        }

  field(:airflowByoidUri)
  field(:airflowUri)
  field(:dagGcsPrefix)
  field(:dataRetentionConfig, as: GoogleApi.Composer.V1beta1.Model.DataRetentionConfig)
  ...
  field(:masterAuthorizedNetworksConfig,
    as: GoogleApi.Composer.V1beta1.Model.MasterAuthorizedNetworksConfig
  )
  ...
  field(:webServerNetworkAccessControl,
    as: GoogleApi.Composer.V1beta1.Model.WebServerNetworkAccessControl
  )

  field(:workloadsConfig, as: GoogleApi.Composer.V1beta1.Model.WorkloadsConfig)
end
