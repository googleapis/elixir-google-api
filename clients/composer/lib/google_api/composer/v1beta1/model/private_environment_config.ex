...
defmodule GoogleApi.Composer.V1beta1.Model.PrivateEnvironmentConfig do
  ...
  *   `enablePrivateEnvironment` (*type:* `boolean()`, *default:* `nil`) - Optional. If `true`, a Private IP Cloud Composer environment is created. If this field is true, `use_ip_aliases` must be true.
