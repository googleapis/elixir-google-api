...
defmodule GoogleApi.Composer.V1beta1.Model.PrivateEnvironmentConfig do
  ...
  - enablePrivateEnvironment (boolean()): Optional. If `true`, a Private IP Cloud Composer environment is created.
  If this field is true, `use_ip_aliases` must be true. Defaults to `nil`.
  - privateClusterConfig (GoogleApi.Composer.V1beta1.Model.PrivateClusterConfig.t): Optional. Configuration for the private GKE cluster for a Private IP
  Cloud Composer environment. Defaults to `nil`.
  """
