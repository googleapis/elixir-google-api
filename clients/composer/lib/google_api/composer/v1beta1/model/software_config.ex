...
defmodule GoogleApi.Composer.V1beta1.Model.SoftwareConfig do
  ...
  - airflowConfigOverrides (map()): Optional. Apache Airflow configuration properties to override.
  ...
  and cannot be overridden. Defaults to `nil`.
  - envVariables (map()): Optional. Additional environment variables to provide to the Apache Airflow
  ...
  * `SQL_PROJECT`
  * `SQL_REGION`
  * `SQL_USER` Defaults to `nil`.
  - imageVersion (String.t): The version of the software running in the environment.
  ...
  See also [Version
  List](/composer/docs/concepts/versioning/composer-versions). Defaults to `nil`.
  - pypiPackages (map()): Optional. Custom Python Package Index (PyPI) packages to be installed in
  the environment.
  ...
  - pythonVersion (String.t): Optional. The major version of Python used to run the Apache Airflow
  scheduler, worker, and webserver processes.
