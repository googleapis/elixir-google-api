...
defmodule GoogleApi.Composer.V1beta1.Model.LoadSnapshotRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1beta1.Model.LoadSnapshotRequest do
  def decode(value, options) do
    GoogleApi.Composer.V1beta1.Model.LoadSnapshotRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1beta1.Model.LoadSnapshotRequest do
