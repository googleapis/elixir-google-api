...
defmodule GoogleApi.Composer.V1beta1.Api.Projects do
  ...
  - projects_id (String.t): Part of `parent`. The parent must be of the form
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.Composer.V1beta1.Model.Environment.t): 
  ...
  - connection (GoogleApi.Composer.V1beta1.Connection): Connection to server
  - projects_id (String.t): Part of `name`. The environment to delete, in the form:
  ...
  - connection (GoogleApi.Composer.V1beta1.Connection): Connection to server
  - projects_id (String.t): Part of `name`. The resource name of the environment to get, in the form:
  "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
  - locations_id (String.t): Part of `name`. See documentation of `projectsId`.
  - environments_id (String.t): Part of `name`. See documentation of `projectsId`.
  - optional_params (keyword()): [optional] Optional parameters
  ...
  - connection (GoogleApi.Composer.V1beta1.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. List environments in the given project and location, in the form:
  "projects/{projectId}/locations/{locationId}"
  - locations_id (String.t): Part of `parent`. See documentation of `projectsId`.
  - optional_params (keyword()): [optional] Optional parameters
    - :$.xgafv (String.t): V1 error format.
  ...
  - connection (GoogleApi.Composer.V1beta1.Connection): Connection to server
  - projects_id (String.t): Part of `name`. The relative resource name of the environment to update, in the form:
  "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
  - locations_id (String.t): Part of `name`. See documentation of `projectsId`.
  - environments_id (String.t): Part of `name`. See documentation of `projectsId`.
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :updateMask (String.t): Required. A comma-separated list of paths, relative to `Environment`, of
  fields to update.
  ...
  - connection (GoogleApi.Composer.V1beta1.Connection): Connection to server
  - projects_id (String.t): Part of `parent`. List ImageVersions in the given project and location, in the form:
  "projects/{projectId}/locations/{locationId}"
  - locations_id (String.t): Part of `parent`. See documentation of `projectsId`.
  - optional_params (keyword()): [optional] Optional parameters
    - :$.xgafv (String.t): V1 error format.
