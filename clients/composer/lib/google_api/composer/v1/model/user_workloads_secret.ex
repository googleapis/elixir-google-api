...
defmodule GoogleApi.Composer.V1.Model.UserWorkloadsSecret do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1.Model.UserWorkloadsSecret do
  def decode(value, options) do
    GoogleApi.Composer.V1.Model.UserWorkloadsSecret.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1.Model.UserWorkloadsSecret do
