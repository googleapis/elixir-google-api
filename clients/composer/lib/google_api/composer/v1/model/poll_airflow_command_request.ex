...
defmodule GoogleApi.Composer.V1.Model.PollAirflowCommandRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1.Model.PollAirflowCommandRequest do
  def decode(value, options) do
    GoogleApi.Composer.V1.Model.PollAirflowCommandRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1.Model.PollAirflowCommandRequest do
