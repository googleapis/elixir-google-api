...
defmodule GoogleApi.Composer.V1.Model.SoftwareConfig do
  ...
  *   `cloudDataLineageIntegration` (*type:* `GoogleApi.Composer.V1.Model.CloudDataLineageIntegration.t`, *default:* `nil`) - Optional. The configuration for Cloud Data Lineage integration.
  ...
  *   `webServerPluginsMode` (*type:* `String.t`, *default:* `nil`) - Optional. Whether or not the web server uses custom plugins. If unspecified, the field defaults to `PLUGINS_ENABLED`. This field is supported for Cloud Composer environments in versions composer-3.*.*-airflow-*.*.* and newer.
  ...
  @type t :: %__MODULE__{
          ...
          :cloudDataLineageIntegration =>
            GoogleApi.Composer.V1.Model.CloudDataLineageIntegration.t() | nil,
  ...
  field(:cloudDataLineageIntegration, as: GoogleApi.Composer.V1.Model.CloudDataLineageIntegration)
