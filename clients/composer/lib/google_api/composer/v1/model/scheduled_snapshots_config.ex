...
defmodule GoogleApi.Composer.V1.Model.ScheduledSnapshotsConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1.Model.ScheduledSnapshotsConfig do
  def decode(value, options) do
    GoogleApi.Composer.V1.Model.ScheduledSnapshotsConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1.Model.ScheduledSnapshotsConfig do
