...
defmodule GoogleApi.Composer.V1.Model.UserWorkloadsConfigMap do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Composer.V1.Model.UserWorkloadsConfigMap do
  def decode(value, options) do
    GoogleApi.Composer.V1.Model.UserWorkloadsConfigMap.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Composer.V1.Model.UserWorkloadsConfigMap do
