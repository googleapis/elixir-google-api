...
defmodule GoogleApi.Composer.V1.Model.IPAllocationPolicy do
  ...
  *   `clusterSecondaryRangeName` (*type:* `String.t`, *default:* `nil`) - Optional. The name of the GKE cluster's secondary range used to allocate IP addresses to pods. This field is applicable only when `use_ip_aliases` is true.
  ...
  *   `servicesSecondaryRangeName` (*type:* `String.t`, *default:* `nil`) - Optional. The name of the services' secondary range used to allocate IP addresses to the GKE cluster. This field is applicable only when `use_ip_aliases` is true.
