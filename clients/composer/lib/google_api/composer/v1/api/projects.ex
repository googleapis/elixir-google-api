...
defmodule GoogleApi.Composer.V1.Api.Projects do
  ...
  *   `environment` (*type:* `String.t`) - Required. The resource name of the environment to check upgrade for, in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.Composer.V1.Model.CheckUpgradeRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_check_upgrade(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:checkUpgrade", %{
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_database_failover(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:databaseFailover", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_execute_airflow_command(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:executeAirflowCommand", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_fetch_database_properties(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+environment}:fetchDatabaseProperties", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_load_snapshot(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:loadSnapshot", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_poll_airflow_command(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:pollAirflowCommand", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_save_snapshot(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:saveSnapshot", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_stop_airflow_command(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+environment}:stopAirflowCommand", %{
        "environment" => URI.encode(environment, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_user_workloads_config_maps_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/userWorkloadsConfigMaps", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_user_workloads_secrets_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/userWorkloadsSecrets", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_image_versions_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}/imageVersions", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
