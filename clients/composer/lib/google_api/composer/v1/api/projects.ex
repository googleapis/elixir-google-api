...
defmodule GoogleApi.Composer.V1.Api.Projects do
  ...
  *   `projects_id` (*type:* `String.t`) - Part of `environment`. Required. The resource name of the environment to check upgrade for, in the form: "projects/{projectId}/locations/{locationId}/environments/{environmentId}"
  ...
  *   `{:error, info}` on failure
  ...
  def composer_projects_locations_environments_check_upgrade(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/v1/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}:checkUpgrade",
        %{
