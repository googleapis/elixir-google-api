...
defmodule GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1TransactionDataGatewayInfo do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Optional. Name of the gateway service (for example, stripe, square, paypal).
  ...
  field(:avsResponseCode)
  field(:cvvResponseCode)
...
defimpl Poison.Decoder,
  for:
    GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1TransactionDataGatewayInfo do
  def decode(value, options) do
    GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1TransactionDataGatewayInfo.decode(
      value,
      options
    )
  end
