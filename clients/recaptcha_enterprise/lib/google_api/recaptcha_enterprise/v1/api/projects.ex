...
defmodule GoogleApi.RecaptchaEnterprise.V1.Api.Projects do
  ...
  *   `connection` (*type:* `GoogleApi.RecaptchaEnterprise.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Required. The parent key for which the IP overrides are listed, in the format `projects/{project}/keys/{key}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:pageSize` (*type:* `integer()`) - Optional. The maximum number of overrides to return. Default is 10. Max limit is 100. If the number of overrides is less than the page_size, all overrides are returned. If the page size is more than 100, it is coerced to 100.
      *   `:pageToken` (*type:* `String.t`) - Optional. The next_page_token value returned from a previous ListIpOverridesRequest, if any.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec recaptchaenterprise_projects_keys_list_ip_overrides(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          {:ok,
           GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def recaptchaenterprise_projects_keys_list_ip_overrides(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}:listIpOverrides", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.RecaptchaEnterprise.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. The name of the key from which the IP override is removed, in the format `projects/{project}/keys/{key}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec recaptchaenterprise_projects_keys_remove_ip_override(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          {:ok,
           GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def recaptchaenterprise_projects_keys_remove_ip_override(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+name}:removeIpOverride", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Response.decode(
      opts ++
        [
          struct:
            %GoogleApi.RecaptchaEnterprise.V1.Model.GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse{}
        ]
    )
  end
