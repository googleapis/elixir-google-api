...
defmodule GoogleApi.BigQueryDataTransfer.V1.Model.Status do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.BigQueryDataTransfer.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.BigQueryDataTransfer.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.BigQueryDataTransfer.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.BigQueryDataTransfer.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQueryDataTransfer.V1.Model.Status do
