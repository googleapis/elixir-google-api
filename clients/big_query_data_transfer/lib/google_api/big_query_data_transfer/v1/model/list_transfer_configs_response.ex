...
defmodule GoogleApi.BigQueryDataTransfer.V1.Model.ListTransferConfigsResponse do
  ...
  - nextPageToken (String.t): Output only. The next-pagination token. For multiple-page list results, this token can be used as the &#x60;ListTransferConfigsRequest.page_token&#x60; to request the next page of list results. Defaults to: `null`.
  - transferConfigs ([TransferConfig]): Output only. The stored pipeline transfer configurations. Defaults to: `null`.
  """
