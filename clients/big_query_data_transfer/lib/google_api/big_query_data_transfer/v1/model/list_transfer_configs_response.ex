...
defmodule GoogleApi.BigQueryDataTransfer.V1.Model.ListTransferConfigsResponse do
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Output only. The next-pagination token. For multiple-page list results, this token can be used as the `ListTransferConfigsRequest.page_token` to request the next page of list results.
