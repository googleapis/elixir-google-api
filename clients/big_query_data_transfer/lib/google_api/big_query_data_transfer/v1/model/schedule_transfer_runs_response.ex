...
defmodule GoogleApi.BigQueryDataTransfer.V1.Model.ScheduleTransferRunsResponse do
  ...
  - runs ([TransferRun]): The transfer runs that were scheduled. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.BigQueryDataTransfer.V1.Model.ScheduleTransferRunsResponse do
  def decode(value, options) do
    GoogleApi.BigQueryDataTransfer.V1.Model.ScheduleTransferRunsResponse.decode(value, options)
  end
end
