...
defmodule GoogleApi.ApigeeRegistry.V1.Model.HttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ApigeeRegistry.V1.Model.HttpBody do
  def decode(value, options) do
    GoogleApi.ApigeeRegistry.V1.Model.HttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ApigeeRegistry.V1.Model.HttpBody do
