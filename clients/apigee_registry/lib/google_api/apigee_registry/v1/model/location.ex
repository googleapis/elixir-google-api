...
defimpl Poison.Decoder, for: GoogleApi.ApigeeRegistry.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.ApigeeRegistry.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ApigeeRegistry.V1.Model.Location do
