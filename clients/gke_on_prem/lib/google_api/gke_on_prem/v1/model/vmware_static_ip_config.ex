...
defmodule GoogleApi.GKEOnPrem.V1.Model.VmwareStaticIpConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareStaticIpConfig do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.VmwareStaticIpConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareStaticIpConfig do
