...
defmodule GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminMaintenanceConfig do
  @moduledoc """
  ...
  *   `maintenanceAddressCidrBlocks` (*type:* `list(String.t)`, *default:* `nil`) - Required. All IPv4 address from these ranges will be placed into maintenance mode. Nodes in maintenance mode will be cordoned and drained. When both of these are true, the "baremetal.cluster.gke.io/maintenance" annotation will be set on the node resource.
  ...
  @type t :: %__MODULE__{
          :maintenanceAddressCidrBlocks => list(String.t()) | nil
        }

  field(:maintenanceAddressCidrBlocks, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminMaintenanceConfig do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminMaintenanceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminMaintenanceConfig do
