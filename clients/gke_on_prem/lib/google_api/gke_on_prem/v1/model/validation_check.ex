...
defmodule GoogleApi.GKEOnPrem.V1.Model.ValidationCheck do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.GKEOnPrem.V1.Model.ValidationCheckStatus.t`, *default:* `nil`) - Output only. The detailed validation check status.
  ...
  field(:option)
  field(:scenario)
  field(:status, as: GoogleApi.GKEOnPrem.V1.Model.ValidationCheckStatus)
end

defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.ValidationCheck do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.ValidationCheck.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.ValidationCheck do
