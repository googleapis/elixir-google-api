...
defmodule GoogleApi.GKEOnPrem.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.Expr do
