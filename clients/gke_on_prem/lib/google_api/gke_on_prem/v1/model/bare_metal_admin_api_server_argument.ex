...
defmodule GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminApiServerArgument do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminApiServerArgument do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminApiServerArgument.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.BareMetalAdminApiServerArgument do
