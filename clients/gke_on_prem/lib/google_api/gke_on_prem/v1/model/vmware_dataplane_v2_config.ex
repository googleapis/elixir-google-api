...
defmodule GoogleApi.GKEOnPrem.V1.Model.VmwareDataplaneV2Config do
  @moduledoc """
  ...
  *   `windowsDataplaneV2Enabled` (*type:* `boolean()`, *default:* `nil`) - Enable Dataplane V2 for clusters with Windows nodes.
  ...
  field(:dataplaneV2Enabled)
  field(:forwardMode)
  field(:windowsDataplaneV2Enabled)
end

defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareDataplaneV2Config do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.VmwareDataplaneV2Config.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareDataplaneV2Config do
