...
defmodule GoogleApi.GKEOnPrem.V1.Model.VmwareManualLbConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareManualLbConfig do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.VmwareManualLbConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareManualLbConfig do
