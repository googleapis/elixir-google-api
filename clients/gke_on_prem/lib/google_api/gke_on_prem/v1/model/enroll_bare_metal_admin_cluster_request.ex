...
defmodule GoogleApi.GKEOnPrem.V1.Model.EnrollBareMetalAdminClusterRequest do
  @moduledoc """
  ...
  *   `membership` (*type:* `String.t`, *default:* `nil`) - Required. This is the full resource name of this admin cluster's fleet membership.
  ...
  field(:bareMetalAdminClusterId)
  field(:membership)
end

defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.EnrollBareMetalAdminClusterRequest do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.EnrollBareMetalAdminClusterRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.EnrollBareMetalAdminClusterRequest do
