...
defmodule GoogleApi.GKEOnPrem.V1.Model.VmwareAddressPool do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareAddressPool do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.VmwareAddressPool.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareAddressPool do
