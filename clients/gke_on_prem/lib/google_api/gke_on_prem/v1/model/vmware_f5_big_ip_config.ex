...
defmodule GoogleApi.GKEOnPrem.V1.Model.VmwareF5BigIpConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareF5BigIpConfig do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.VmwareF5BigIpConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.VmwareF5BigIpConfig do
