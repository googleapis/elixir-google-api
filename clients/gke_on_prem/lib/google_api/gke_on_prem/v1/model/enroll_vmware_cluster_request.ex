...
defmodule GoogleApi.GKEOnPrem.V1.Model.EnrollVmwareClusterRequest do
  @moduledoc """
  ...
  *   `validateOnly` (*type:* `boolean()`, *default:* `nil`) - Validate the request without actually doing any updates.
  *   `vmwareClusterId` (*type:* `String.t`, *default:* `nil`) - User provided OnePlatform identifier that is used as part of the resource name. This must be unique among all GKE on-prem clusters within a project and location and will return a 409 if the cluster already exists. (https://tools.ietf.org/html/rfc1123) format.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :vmwareClusterId => String.t() | nil
        }

  field(:adminClusterMembership)
  field(:localName)
  field(:validateOnly)
  field(:vmwareClusterId)
end

defimpl Poison.Decoder, for: GoogleApi.GKEOnPrem.V1.Model.EnrollVmwareClusterRequest do
  def decode(value, options) do
    GoogleApi.GKEOnPrem.V1.Model.EnrollVmwareClusterRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEOnPrem.V1.Model.EnrollVmwareClusterRequest do
