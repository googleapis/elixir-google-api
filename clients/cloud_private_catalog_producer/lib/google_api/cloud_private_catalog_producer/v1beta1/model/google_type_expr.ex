...
defmodule GoogleApi.CloudPrivateCatalogProducer.V1beta1.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudPrivateCatalogProducer.V1beta1.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.CloudPrivateCatalogProducer.V1beta1.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudPrivateCatalogProducer.V1beta1.Model.GoogleTypeExpr do
