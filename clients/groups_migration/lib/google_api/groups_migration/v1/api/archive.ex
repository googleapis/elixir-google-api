...
defmodule GoogleApi.GroupsMigration.V1.Api.Archive do
  ...
  import GoogleApi.GroupsMigration.V1.RequestBuilder
  ...
  """
  @spec groupsmigration_archive_insert(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.GroupsMigration.V1.Model.Groups.t} | {:error, Tesla.Env.t}
  def groupsmigration_archive_insert(connection, group_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
