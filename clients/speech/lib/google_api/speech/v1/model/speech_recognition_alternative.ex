...
defmodule GoogleApi.Speech.V1.Model.SpeechRecognitionAlternative do
  ...
  The default of 0.0 is a sentinel value indicating `confidence` was not set. Defaults to `nil`.
  - transcript (String.t): Output only. Transcript text representing the words that the user spoke. Defaults to `nil`.
  - words (list(GoogleApi.Speech.V1.Model.WordInfo.t)): Output only. A list of word-specific information for each recognized word.
  Note: When `enable_speaker_diarization` is true, you will see all the words
  from the beginning of the audio. Defaults to `nil`.
  """
