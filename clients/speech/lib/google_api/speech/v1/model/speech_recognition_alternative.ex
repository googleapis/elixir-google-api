...
defmodule GoogleApi.Speech.V1.Model.SpeechRecognitionAlternative do
  ...
  *   `transcript` (*type:* `String.t`, *default:* `nil`) - Output only. Transcript text representing the words that the user spoke.
  *   `words` (*type:* `list(GoogleApi.Speech.V1.Model.WordInfo.t)`, *default:* `nil`) - Output only. A list of word-specific information for each recognized word.
