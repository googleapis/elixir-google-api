...
defmodule GoogleApi.Speech.V1.Model.SpeechAdaptation do
  ...
  *   `phraseSets` (*type:* `list(GoogleApi.Speech.V1.Model.PhraseSet.t)`, *default:* `nil`) - A collection of phrase sets. To specify the hints inline, leave the phrase set's `name` blank and fill in the rest of its fields. Any phrase set can use any custom class.
  ...
  field(:abnfGrammar, as: GoogleApi.Speech.V1.Model.ABNFGrammar)
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1.Model.SpeechAdaptation do
  def decode(value, options) do
    GoogleApi.Speech.V1.Model.SpeechAdaptation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V1.Model.SpeechAdaptation do
