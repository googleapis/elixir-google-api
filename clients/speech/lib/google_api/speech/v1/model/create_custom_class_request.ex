...
defmodule GoogleApi.Speech.V1.Model.CreateCustomClassRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1.Model.CreateCustomClassRequest do
  def decode(value, options) do
    GoogleApi.Speech.V1.Model.CreateCustomClassRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V1.Model.CreateCustomClassRequest do
