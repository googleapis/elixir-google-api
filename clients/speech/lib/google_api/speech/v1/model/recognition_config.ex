...
defmodule GoogleApi.Speech.V1.Model.RecognitionConfig do
  ...
  - audioChannelCount (integer()): *Optional* The number of channels in the input audio data. ONLY set this for MULTI-CHANNEL recognition. Valid values for LINEAR16 and FLAC are &#x60;1&#x60;-&#x60;8&#x60;. Valid values for OGG_OPUS are &#39;1&#39;-&#39;254&#39;. Valid value for MULAW, AMR, AMR_WB and SPEEX_WITH_HEADER_BYTE is only &#x60;1&#x60;. If &#x60;0&#x60; or omitted, defaults to one channel (mono). Note: We only recognize the first channel by default. To perform independent recognition on each channel set &#x60;enable_separate_recognition_per_channel&#x60; to &#39;true&#39;. Defaults to: `null`.
  ...
  - metadata (RecognitionMetadata): *Optional* Metadata regarding this request. Defaults to: `null`.
  ...
  - sampleRateHertz (integer()): Sample rate in Hertz of the audio data sent in all &#x60;RecognitionAudio&#x60; messages. Valid values are: 8000-48000. 16000 is optimal. For best results, set the sampling rate of the audio source to 16000 Hz. If that&#39;s not possible, use the native sample rate of the audio source (instead of re-sampling). This field is optional for &#x60;FLAC&#x60;,  &#x60;WAV&#x60;. and &#39;MP3&#39; audio files, and is required for all other audio formats. For details, see AudioEncoding. Defaults to: `null`.
