...
defmodule GoogleApi.Speech.V1.Model.RecognitionConfig do
  ...
  *   `audioChannelCount` (*type:* `integer()`, *default:* `nil`) - *Optional* The number of channels in the input audio data.
  ...
  *   `enableWordTimeOffsets` (*type:* `boolean()`, *default:* `nil`) - *Optional* If `true`, the top result includes a list of words and
  ...
  *   `metadata` (*type:* `GoogleApi.Speech.V1.Model.RecognitionMetadata.t`, *default:* `nil`) - *Optional* Metadata regarding this request.
  *   `model` (*type:* `String.t`, *default:* `nil`) - *Optional* Which model to select for the given request. Select the model
  ...
  *   `profanityFilter` (*type:* `boolean()`, *default:* `nil`) - *Optional* If set to `true`, the server will attempt to filter out
