...
defmodule GoogleApi.Speech.V1.Model.LongRunningRecognizeMetadata do
  ...
  - lastUpdateTime (DateTime.t): Time of the most recent processing update. Defaults to `nil`.
  - progressPercent (integer()): Approximate percentage of audio processed thus far. Guaranteed to be 100
  when the audio is fully processed and the results are available. Defaults to `nil`.
  - startTime (DateTime.t): Time when the request was received. Defaults to `nil`.
  """
