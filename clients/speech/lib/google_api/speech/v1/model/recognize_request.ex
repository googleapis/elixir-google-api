...
defmodule GoogleApi.Speech.V1.Model.RecognizeRequest do
  ...
  - audio (GoogleApi.Speech.V1.Model.RecognitionAudio.t): *Required* The audio data to be recognized. Defaults to `nil`.
  - config (GoogleApi.Speech.V1.Model.RecognitionConfig.t): *Required* Provides information to the recognizer that specifies how to
  process the request. Defaults to `nil`.
  """
