...
defmodule GoogleApi.Speech.V1.Api.Projects do
  ...
  """
  @spec speech_projects_locations_operations_get(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  {:error, info} on failure
  """
  @spec speech_projects_locations_operations_list(Tesla.Env.client(), String.t(), keyword()) ::
