...
defmodule GoogleApi.Speech.V1.Api.Operations do
  ...
  *   `{:error, info}` on failure
  """
  @spec speech_operations_get(Tesla.Env.client(), String.t, keyword(), keyword()) :: {:ok, GoogleApi.Speech.V1.Model.Operation.t} | {:ok, Tesla.Env.t()} | {:ok, list()} | {:error, any()}
  ...
  *   `{:error, info}` on failure
  """
  @spec speech_operations_list(Tesla.Env.client(), keyword(), keyword()) :: {:ok, GoogleApi.Speech.V1.Model.ListOperationsResponse.t} | {:ok, Tesla.Env.t()} | {:ok, list()} | {:error, any()}
