...
defmodule GoogleApi.Speech.V2.Model.ListPhraseSetsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.ListPhraseSetsResponse do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.ListPhraseSetsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.ListPhraseSetsResponse do
