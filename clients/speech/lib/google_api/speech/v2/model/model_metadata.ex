...
defmodule GoogleApi.Speech.V2.Model.ModelMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.ModelMetadata do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.ModelMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.ModelMetadata do
