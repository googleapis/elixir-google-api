...
defmodule GoogleApi.Speech.V2.Model.UndeleteRecognizerRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.UndeleteRecognizerRequest do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.UndeleteRecognizerRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.UndeleteRecognizerRequest do
