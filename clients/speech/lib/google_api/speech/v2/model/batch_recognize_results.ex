...
defmodule GoogleApi.Speech.V2.Model.BatchRecognizeResults do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeResults do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.BatchRecognizeResults.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeResults do
