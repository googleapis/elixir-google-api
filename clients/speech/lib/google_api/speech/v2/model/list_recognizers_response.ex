...
defmodule GoogleApi.Speech.V2.Model.ListRecognizersResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.ListRecognizersResponse do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.ListRecognizersResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.ListRecognizersResponse do
