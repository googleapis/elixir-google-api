...
defmodule GoogleApi.Speech.V2.Model.ModelFeatures do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.ModelFeatures do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.ModelFeatures.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.ModelFeatures do
