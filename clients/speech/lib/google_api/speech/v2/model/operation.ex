...
defmodule GoogleApi.Speech.V2.Model.Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.Speech.V2.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.Operation do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.Operation do
