...
defmodule GoogleApi.Speech.V2.Model.UpdateConfigRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.UpdateConfigRequest do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.UpdateConfigRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.UpdateConfigRequest do
