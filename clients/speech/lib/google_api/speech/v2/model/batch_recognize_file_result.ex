...
defmodule GoogleApi.Speech.V2.Model.BatchRecognizeFileResult do
  @moduledoc """
  ...
  *   `uri` (*type:* `String.t`, *default:* `nil`) - The Cloud Storage URI to which recognition results were written.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeFileResult do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.BatchRecognizeFileResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeFileResult do
