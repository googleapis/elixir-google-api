...
defmodule GoogleApi.Speech.V2.Model.RecognitionOutputConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.RecognitionOutputConfig do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.RecognitionOutputConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.RecognitionOutputConfig do
