...
defmodule GoogleApi.Speech.V2.Model.DeleteRecognizerRequest do
  @moduledoc """
  ...
  *   `validateOnly` (*type:* `boolean()`, *default:* `nil`) - If set, validate the request and preview the deleted Recognizer, but do not actually delete it.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.DeleteRecognizerRequest do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.DeleteRecognizerRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.DeleteRecognizerRequest do
