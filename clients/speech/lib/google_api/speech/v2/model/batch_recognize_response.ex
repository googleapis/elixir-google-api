...
defmodule GoogleApi.Speech.V2.Model.BatchRecognizeResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeResponse do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.BatchRecognizeResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.BatchRecognizeResponse do
