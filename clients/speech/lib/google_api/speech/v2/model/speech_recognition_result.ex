...
defmodule GoogleApi.Speech.V2.Model.SpeechRecognitionResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.SpeechRecognitionResult do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.SpeechRecognitionResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.SpeechRecognitionResult do
