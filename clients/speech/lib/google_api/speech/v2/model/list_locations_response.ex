...
defmodule GoogleApi.Speech.V2.Model.ListLocationsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V2.Model.ListLocationsResponse do
  def decode(value, options) do
    GoogleApi.Speech.V2.Model.ListLocationsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V2.Model.ListLocationsResponse do
