...
defmodule GoogleApi.Speech.V1p1beta1.Model.RecognitionAudio do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1p1beta1.Model.RecognitionAudio do
  def decode(value, options) do
    GoogleApi.Speech.V1p1beta1.Model.RecognitionAudio.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V1p1beta1.Model.RecognitionAudio do
