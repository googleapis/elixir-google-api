...
defmodule GoogleApi.Speech.V1p1beta1.Model.RecognitionMetadata do
  @moduledoc """
  ...
  *   `obfuscatedId` (*type:* `String.t`, *default:* `nil`) - Obfuscated (privacy-protected) ID of the user, to identify number of unique users using the service.
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1p1beta1.Model.RecognitionMetadata do
  def decode(value, options) do
    GoogleApi.Speech.V1p1beta1.Model.RecognitionMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V1p1beta1.Model.RecognitionMetadata do
