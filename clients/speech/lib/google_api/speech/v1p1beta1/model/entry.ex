...
defmodule GoogleApi.Speech.V1p1beta1.Model.Entry do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Speech.V1p1beta1.Model.Entry do
  def decode(value, options) do
    GoogleApi.Speech.V1p1beta1.Model.Entry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Speech.V1p1beta1.Model.Entry do
