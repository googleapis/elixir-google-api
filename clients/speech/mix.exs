...
defmodule GoogleApi.Speech.Mixfile do
  ...
  defp description() do
    """
    Client library for Cloud Speech-to-Text API from Google. Converts audio to text by applying powerful neural network models.
    """
  end
  ...
  defp package() do
    [
      ...
      licenses: ["Apache 2.0"],
      links: %{
        "GitHub" => "https://github.com/googleapis/elixir-google-api/tree/master/clients/speech",
