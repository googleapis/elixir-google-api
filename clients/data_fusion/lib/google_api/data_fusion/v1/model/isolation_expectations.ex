...
defmodule GoogleApi.DataFusion.V1.Model.IsolationExpectations do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1.Model.IsolationExpectations do
  def decode(value, options) do
    GoogleApi.DataFusion.V1.Model.IsolationExpectations.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1.Model.IsolationExpectations do
