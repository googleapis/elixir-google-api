...
defmodule GoogleApi.DataFusion.V1.Model.PersistentDiskData do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1.Model.PersistentDiskData do
  def decode(value, options) do
    GoogleApi.DataFusion.V1.Model.PersistentDiskData.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1.Model.PersistentDiskData do
