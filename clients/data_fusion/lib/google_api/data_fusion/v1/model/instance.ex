...
defmodule GoogleApi.DataFusion.V1.Model.Instance do
  ...
  *   `enableZoneSeparation` (*type:* `boolean()`, *default:* `nil`) - Output only. Option to enable granular zone separation.
  ...
  *   `cryptoKeyConfig` (*type:* `GoogleApi.DataFusion.V1.Model.CryptoKeyConfig.t`, *default:* `nil`) - Optional. The crypto key configuration. This field is used by the Customer-Managed Encryption Keys (CMEK) feature.
  ...
  *   `enableStackdriverMonitoring` (*type:* `boolean()`, *default:* `nil`) - Optional. Option to enable Stackdriver Monitoring.
  *   `version` (*type:* `String.t`, *default:* `nil`) - Optional. Current version of the Data Fusion. Only specifiable in Update.
  *   `patchRevision` (*type:* `String.t`, *default:* `nil`) - Optional. Current patch revision of the Data Fusion.
  *   `eventPublishConfig` (*type:* `GoogleApi.DataFusion.V1.Model.EventPublishConfig.t`, *default:* `nil`) - Optional. Option to enable and pass metadata for event publishing.
  *   `zone` (*type:* `String.t`, *default:* `nil`) - Optional. Name of the zone in which the Data Fusion instance will be created. Only DEVELOPER instances use this field.
  *   `dataprocServiceAccount` (*type:* `String.t`, *default:* `nil`) - Optional. User-managed service account to set on Dataproc when Cloud Data Fusion creates Dataproc to run data processing pipelines. This allows users to have fine-grained access control on Dataproc's accesses to cloud resources.
  ...
  *   `privateInstance` (*type:* `boolean()`, *default:* `nil`) - Optional. Specifies whether the Data Fusion instance should be private. If set to true, all Data Fusion nodes will have private IP addresses and will not be able to access the public internet.
