...
defmodule GoogleApi.DataFusion.V1.Model.Accelerator do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1.Model.Accelerator do
  def decode(value, options) do
    GoogleApi.DataFusion.V1.Model.Accelerator.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1.Model.Accelerator do
