...
defmodule GoogleApi.DataFusion.V1beta1.Model.Condition do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.Condition do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.Condition.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.Condition do
