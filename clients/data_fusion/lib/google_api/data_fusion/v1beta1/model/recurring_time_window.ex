...
defmodule GoogleApi.DataFusion.V1beta1.Model.RecurringTimeWindow do
  @moduledoc """
  ...
  *   `window` (*type:* `GoogleApi.DataFusion.V1beta1.Model.TimeWindow.t`, *default:* `nil`) - Required. The window representing the start and end time of recurrences. This field ignores the date components of the provided timestamps. Only the time of day and duration between start and end time are relevant.
  ...
  field(:recurrence)
  field(:window, as: GoogleApi.DataFusion.V1beta1.Model.TimeWindow)
end

defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.RecurringTimeWindow do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.RecurringTimeWindow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.RecurringTimeWindow do
