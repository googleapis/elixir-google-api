...
defmodule GoogleApi.DataFusion.V1beta1.Model.AuditConfig do
  @moduledoc """
  ...
  *   `service` (*type:* `String.t`, *default:* `nil`) - Specifies a service that will be enabled for audit logging. For example, `storage.googleapis.com`, `cloudsql.googleapis.com`. `allServices` is a special value that covers all services.
  ...
  @type t :: %__MODULE__{
          :auditLogConfigs => list(GoogleApi.DataFusion.V1beta1.Model.AuditLogConfig.t()) | nil,
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.AuditConfig do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.AuditConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.AuditConfig do
