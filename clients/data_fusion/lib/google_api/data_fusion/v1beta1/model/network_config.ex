...
defmodule GoogleApi.DataFusion.V1beta1.Model.NetworkConfig do
  @moduledoc """
  ...
  *   `privateServiceConnectConfig` (*type:* `GoogleApi.DataFusion.V1beta1.Model.PrivateServiceConnectConfig.t`, *default:* `nil`) - Optional. Configuration for Private Service Connect. This is required only when using connection type PRIVATE_SERVICE_CONNECT_INTERFACES.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :privateServiceConnectConfig =>
            GoogleApi.DataFusion.V1beta1.Model.PrivateServiceConnectConfig.t() | nil
        }
  ...
  field(:privateServiceConnectConfig,
    as: GoogleApi.DataFusion.V1beta1.Model.PrivateServiceConnectConfig
  )
end

defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.NetworkConfig do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.NetworkConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.NetworkConfig do
