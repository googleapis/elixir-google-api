...
defmodule GoogleApi.DataFusion.V1beta1.Model.DataResidencyAugmentedView do
  @moduledoc """
  Next tag: 7
  ...
  *   `serviceData` (*type:* `GoogleApi.DataFusion.V1beta1.Model.ServiceData.t`, *default:* `nil`) - Service-specific data. Only required for pre-determined services. Generally used to bind a Cloud Resource to some a TI container that uniquely specifies a customer. See milestone 2 of DRZ KR8 SIG for more information.
  *   `tpIds` (*type:* `list(String.t)`, *default:* `nil`) - The list of project_id's of the tenant projects in the 'google.com' org which serve the Cloud Resource. See go/drz-mst-sig for more details.
  ...
  @type t :: %__MODULE__{
          ...
          :serviceData => GoogleApi.DataFusion.V1beta1.Model.ServiceData.t() | nil,
          :tpIds => list(String.t()) | nil
        }

  field(:crGopoGuris, type: :list)
  field(:crGopoPrefixes, type: :list)
  field(:serviceData, as: GoogleApi.DataFusion.V1beta1.Model.ServiceData)
  field(:tpIds, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.DataResidencyAugmentedView do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.DataResidencyAugmentedView.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.DataResidencyAugmentedView do
