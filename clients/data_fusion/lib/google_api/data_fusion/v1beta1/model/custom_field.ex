...
defmodule GoogleApi.DataFusion.V1beta1.Model.CustomField do
  @moduledoc """
  Custom fields.
...
defimpl Poison.Decoder, for: GoogleApi.DataFusion.V1beta1.Model.CustomField do
  def decode(value, options) do
    GoogleApi.DataFusion.V1beta1.Model.CustomField.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataFusion.V1beta1.Model.CustomField do
