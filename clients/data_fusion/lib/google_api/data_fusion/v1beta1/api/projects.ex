...
defmodule GoogleApi.DataFusion.V1beta1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  @spec datafusion_projects_locations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.DataFusion.V1beta1.Model.Location.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec datafusion_projects_locations_instances_create(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DataFusion.V1beta1.Model.Operation.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec datafusion_projects_locations_instances_get(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DataFusion.V1beta1.Model.Instance.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec datafusion_projects_locations_instances_get_iam_policy(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DataFusion.V1beta1.Model.Policy.t()} | {:error, Tesla.Env.t()}
  ...
  *   `connection` (*type:* `GoogleApi.DataFusion.V1beta1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Output only. The name of this instance is in the form of
      projects/{project}/locations/{location}/instances/{instance}.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:updateMask` (*type:* `String.t`) - Field mask is used to specify the fields that the update will overwrite
  ...
  *   `connection` (*type:* `GoogleApi.DataFusion.V1beta1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the Data Fusion instance which need to be restarted in the form of
      projects/{project}/locations/{location}/instances/{instance}
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
  ...
  *   `connection` (*type:* `GoogleApi.DataFusion.V1beta1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the Data Fusion instance which need to be upgraded in the form of
      projects/{project}/locations/{location}/instances/{instance}
  ...
  *   `{:error, info}` on failure
  ...
  @spec datafusion_projects_locations_operations_cancel(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.DataFusion.V1beta1.Model.Empty.t()} | {:error, Tesla.Env.t()}
