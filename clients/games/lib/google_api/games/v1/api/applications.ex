...
defmodule GoogleApi.Games.V1.Api.Applications do
  ...
  *   `{:error, info}` on failure
  ...
  def games_applications_get(connection, application_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/games/v1/applications/{applicationId}", %{
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:applicationId` (*type:* `String.t`) - The application ID from the Google Play developer console.
      *   `:endPointType` (*type:* `String.t`) - Type of endpoint being requested.
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.Games.V1.Model.EndPoint{}}` on success
  *   `{:error, info}` on failure
  """
  ...
  def games_applications_get_end_point(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1/applications/getEndPoint", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Games.V1.Model.EndPoint{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def games_applications_played(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1/applications/played", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def games_applications_verify(connection, application_id, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/games/v1/applications/{applicationId}/verify", %{
