...
defmodule GoogleApi.Games.V1.Api.Pushtokens do
  ...
  """
  @spec games_pushtokens_remove(Tesla.Env.client, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec games_pushtokens_update(Tesla.Env.client, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
