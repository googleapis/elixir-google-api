...
defmodule GoogleApi.Games.V1.Api.Snapshots do
  ...
  """
  @spec games_snapshots_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Games.V1.Model.Snapshot.t} | {:error, Tesla.Env.t}
  def games_snapshots_get(connection, snapshot_id, opts \\ []) do
    ...
    |> decode(%GoogleApi.Games.V1.Model.Snapshot{})
  end
  ...
  {:error, info} on failure
  """
  @spec games_snapshots_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Games.V1.Model.SnapshotListResponse.t} | {:error, Tesla.Env.t}
  def games_snapshots_list(connection, player_id, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/players/#{player_id}/snapshots")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Games.V1.Model.SnapshotListResponse{})
  end
end
