...
defmodule GoogleApi.Games.V1.Api.Stats do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.Games.V1.Model.StatsResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def games_stats_get(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/games/v1/stats", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Games.V1.Model.StatsResponse{}])
  end
end
