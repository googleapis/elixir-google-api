...
defmodule GoogleApi.Games.V1.Api.QuestMilestones do
  ...
  *   `milestone_id` (*type:* `String.t`) - The ID of the milestone.
  *   `request_id` (*type:* `String.t`) - A numeric ID to ensure that the request is handled correctly across retries. Your client application must generate this ID randomly.
