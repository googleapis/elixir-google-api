...
defmodule GoogleApi.Games.V1.Api.SnapshotsExtended do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec games_snapshots_extended_resolve_snapshot_head(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def games_snapshots_extended_resolve_snapshot_head(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/games/v1/snapshotsExtended/{snapshotName}:resolveHead", %{
        "snapshotName" => URI.encode(snapshot_name, &URI.char_unreserved?/1)
      })
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Games.V1.Model.ResolveSnapshotHeadResponse{}])
  end
end
