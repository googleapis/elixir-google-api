...
defmodule GoogleApi.Games.V1.Api.AchievementDefinitions do
  @moduledoc """
  ...
  """
  @spec games_achievement_definitions_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Games.V1.Model.AchievementDefinitionsListResponse.t} | {:error, Tesla.Env.t}
  def games_achievement_definitions_list(connection, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.Games.V1.Model.AchievementDefinitionsListResponse{})
  end
end
