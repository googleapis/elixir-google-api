...
defmodule GoogleApi.Games.V1.Api.AchievementDefinitions do
  ...
  """
  @spec games_achievement_definitions_list(Tesla.Env.client(), keyword()) ::
  ...
  def games_achievement_definitions_list(connection, opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/achievements")
      |> Request.add_optional_params(optional_params, opts)

    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.Games.V1.Model.AchievementDefinitionsListResponse{})
  end
end
