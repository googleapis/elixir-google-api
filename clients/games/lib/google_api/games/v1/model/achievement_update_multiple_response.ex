...
defmodule GoogleApi.Games.V1.Model.AchievementUpdateMultipleResponse do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementUpdateListResponse. Defaults to: `null`.
  - updatedAchievements ([AchievementUpdateResponse]): The updated state of the achievements. Defaults to: `null`.
  """
