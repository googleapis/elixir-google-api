...
defmodule GoogleApi.Games.V1.Model.PlayerLeaderboardScoreListResponse do
  ...
  - items ([PlayerLeaderboardScore]): The leaderboard scores. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#playerLeaderboardScoreListResponse. Defaults to: `null`.
