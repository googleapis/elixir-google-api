...
defmodule GoogleApi.Games.V1.Model.PeerSessionDiagnostics do
  ...
  - connectedTimestampMillis (String.t): Connected time in milliseconds. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#peerSessionDiagnostics. Defaults to `games#peerSessionDiagnostics`.
  - participantId (String.t): The participant ID of the peer. Defaults to `nil`.
  - reliableChannel (GoogleApi.Games.V1.Model.PeerChannelDiagnostics.t): Reliable channel diagnostics. Defaults to `nil`.
  - unreliableChannel (GoogleApi.Games.V1.Model.PeerChannelDiagnostics.t): Unreliable channel diagnostics. Defaults to `nil`.
  """
