...
defmodule GoogleApi.Games.V1.Model.PeerSessionDiagnostics do
  ...
  - connectedTimestampMillis (String.t): Connected time in milliseconds. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#peerSessionDiagnostics. Defaults to: `null`.
  - participantId (String.t): The participant ID of the peer. Defaults to: `null`.
