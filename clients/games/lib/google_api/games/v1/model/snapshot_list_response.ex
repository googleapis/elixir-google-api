...
defmodule GoogleApi.Games.V1.Model.SnapshotListResponse do
  ...
  - items ([Snapshot]): The snapshots. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#snapshotListResponse. Defaults to: `null`.
  - nextPageToken (String.t): Token corresponding to the next page of results. If there are no more results, the token is omitted. Defaults to: `null`.
  """
