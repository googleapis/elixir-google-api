...
defmodule GoogleApi.Games.V1.Model.EventDefinitionListResponse do
  ...
  - items (List[EventDefinition]): The event definitions. Defaults to: `null`.
  - kind (String): Uniquely identifies the type of this resource. Value is always the fixed string games#eventDefinitionListResponse. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Games.V1.Model.EventDefinitionListResponse do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"items", :list, GoogleApi.Games.V1.Model.EventDefinition, options)
  end
end
