...
defmodule GoogleApi.Games.V1.Model.EventDefinitionListResponse do
  ...
  - items ([EventDefinition]): The event definitions. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#eventDefinitionListResponse. Defaults to: `null`.
