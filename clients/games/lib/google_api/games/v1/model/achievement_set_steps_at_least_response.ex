...
defmodule GoogleApi.Games.V1.Model.AchievementSetStepsAtLeastResponse do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementSetStepsAtLeastResponse. Defaults to: `null`.
