...
defmodule GoogleApi.Games.V1.Model.InstanceWebDetails do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#instanceWebDetails. Defaults to: `null`.
  - launchUrl (String.t): Launch URL for the game. Defaults to: `null`.
