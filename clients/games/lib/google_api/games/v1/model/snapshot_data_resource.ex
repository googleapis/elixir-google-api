...
defmodule GoogleApi.Games.V1.Model.SnapshotDataResource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Games.V1.Model.SnapshotDataResource do
  def decode(value, options) do
    GoogleApi.Games.V1.Model.SnapshotDataResource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Games.V1.Model.SnapshotDataResource do
