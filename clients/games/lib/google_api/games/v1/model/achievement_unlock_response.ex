...
defmodule GoogleApi.Games.V1.Model.AchievementUnlockResponse do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementUnlockResponse. Defaults to `games#achievementUnlockResponse`.
...
defimpl Poison.Decoder, for: GoogleApi.Games.V1.Model.AchievementUnlockResponse do
  def decode(value, options) do
    GoogleApi.Games.V1.Model.AchievementUnlockResponse.decode(value, options)
  end
end
