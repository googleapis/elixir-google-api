...
defmodule GoogleApi.Games.V1.Model.TurnBasedMatchResults do
  ...
  *   `data` (*type:* `GoogleApi.Games.V1.Model.TurnBasedMatchDataRequest.t`, *default:* `nil`) - The final match data.
  *   `kind` (*type:* `String.t`, *default:* `games#turnBasedMatchResults`) - Uniquely identifies the type of this resource. Value is always the fixed string games#turnBasedMatchResults.
  *   `matchVersion` (*type:* `integer()`, *default:* `nil`) - The version of the match being updated.
