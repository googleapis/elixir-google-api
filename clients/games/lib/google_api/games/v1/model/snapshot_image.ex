...
defmodule GoogleApi.Games.V1.Model.SnapshotImage do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#snapshotImage. Defaults to: `null`.
  - mime_type (String.t): The MIME type of the image. Defaults to: `null`.
  - url (String.t): The URL of the image. This URL may be invalidated at any time and should not be cached. Defaults to: `null`.
