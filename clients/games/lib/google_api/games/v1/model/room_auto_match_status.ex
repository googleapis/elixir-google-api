...
defmodule GoogleApi.Games.V1.Model.RoomAutoMatchStatus do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#roomAutoMatchStatus. Defaults to: `null`.
