...
defmodule GoogleApi.Games.V1.Model.InstanceAndroidDetails do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#instanceAndroidDetails. Defaults to: `null`.
  - packageName (String.t): Android package name which maps to Google Play URL. Defaults to: `null`.
