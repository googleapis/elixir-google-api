...
defmodule GoogleApi.Games.V1.Model.PlayerAchievementListResponse do
  ...
  - items ([PlayerAchievement]): The achievements. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#playerAchievementListResponse. Defaults to: `null`.
