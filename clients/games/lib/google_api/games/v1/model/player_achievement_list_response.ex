...
defmodule GoogleApi.Games.V1.Model.PlayerAchievementListResponse do
  ...
  - items (list(GoogleApi.Games.V1.Model.PlayerAchievement.t)): The achievements. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#playerAchievementListResponse. Defaults to `games#playerAchievementListResponse`.
