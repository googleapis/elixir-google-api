...
defmodule GoogleApi.Games.V1.Model.LeaderboardScores do
  ...
  *   `kind` (*type:* `String.t`, *default:* `games#leaderboardScores`) - Uniquely identifies the type of this resource. Value is always the fixed string games#leaderboardScores.
