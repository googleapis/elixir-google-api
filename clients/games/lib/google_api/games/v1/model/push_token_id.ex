...
defmodule GoogleApi.Games.V1.Model.PushTokenId do
  ...
  - ios (GoogleApi.Games.V1.Model.PushTokenIdIos.t): A push token ID for iOS devices. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#pushTokenId. Defaults to `games#pushTokenId`.
  """
