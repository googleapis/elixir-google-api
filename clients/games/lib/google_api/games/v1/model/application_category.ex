...
defmodule GoogleApi.Games.V1.Model.ApplicationCategory do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#applicationCategory. Defaults to: `null`.
  - primary (String.t): The primary category. Defaults to: `null`.
  - secondary (String.t): The secondary category. Defaults to: `null`.
  """
