...
defmodule GoogleApi.Games.V1.Model.QuestCriterion do
  ...
  - eventId (String.t): The ID of the event the criterion corresponds to. Defaults to: `null`.
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#questCriterion. Defaults to: `null`.
  """
