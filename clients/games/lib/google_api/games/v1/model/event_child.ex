...
defmodule GoogleApi.Games.V1.Model.EventChild do
  ...
  - childId (String.t): The ID of the child event. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#eventChild. Defaults to: `null`.
  """
