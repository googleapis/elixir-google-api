...
defmodule GoogleApi.Games.V1.Model.TurnBasedMatchSync do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#turnBasedMatchSync. Defaults to `games#turnBasedMatchSync`.
  - moreAvailable (boolean()): True if there were more matches available to fetch at the time the response was generated (which were not returned due to page size limits.) Defaults to `nil`.
