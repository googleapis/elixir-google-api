...
defmodule GoogleApi.Games.V1.Model.GamesAchievementIncrement do
  ...
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#GamesAchievementIncrement. Defaults to `games#GamesAchievementIncrement`.
  - requestId (String.t): The requestId associated with an increment to an achievement. Defaults to `nil`.
  - steps (integer()): The number of steps to be incremented. Defaults to `nil`.
  """
