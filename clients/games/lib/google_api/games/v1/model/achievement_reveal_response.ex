...
defmodule GoogleApi.Games.V1.Model.AchievementRevealResponse do
  ...
  - currentState (String.t): The current state of the achievement for which a reveal was attempted. This might be UNLOCKED if the achievement was already unlocked.
  Possible values are:  
  - "REVEALED" - Achievement is revealed. 
  - "UNLOCKED" - Achievement is unlocked. Defaults to `nil`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string games#achievementRevealResponse. Defaults to `games#achievementRevealResponse`.
  """
