...
defmodule GoogleApi.CloudPrivateCatalog.V1beta1.Model.GoogleCloudPrivatecatalogV1beta1Catalog do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. The resource name of the target catalog, in the format of
      `catalogs/{catalog_id}'.
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudPrivateCatalog.V1beta1.Model.GoogleCloudPrivatecatalogV1beta1Catalog do
  def decode(value, options) do
    GoogleApi.CloudPrivateCatalog.V1beta1.Model.GoogleCloudPrivatecatalogV1beta1Catalog.decode(
      value,
      options
    )
  end
