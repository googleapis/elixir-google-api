...
defmodule GoogleApi.CloudPrivateCatalog.V1beta1.Api.Organizations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_organizations_catalogs_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_organizations_products_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_organizations_versions_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
