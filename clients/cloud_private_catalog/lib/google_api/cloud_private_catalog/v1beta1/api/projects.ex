...
defmodule GoogleApi.CloudPrivateCatalog.V1beta1.Api.Projects do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_projects_catalogs_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def cloudprivatecatalog_projects_catalogs_search(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_projects_products_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def cloudprivatecatalog_projects_products_search(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudprivatecatalog_projects_versions_search(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, Tesla.Env.t()}
          | {:error, Tesla.Env.t()}
  def cloudprivatecatalog_projects_versions_search(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
