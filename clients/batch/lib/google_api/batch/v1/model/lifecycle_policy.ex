...
defmodule GoogleApi.Batch.V1.Model.LifecyclePolicy do
  @moduledoc """
  ...
  *   `actionCondition` (*type:* `GoogleApi.Batch.V1.Model.ActionCondition.t`, *default:* `nil`) - Conditions that decide why a task failure is dealt with a specific action.
  ...
  field(:action)
  field(:actionCondition, as: GoogleApi.Batch.V1.Model.ActionCondition)
end

defimpl Poison.Decoder, for: GoogleApi.Batch.V1.Model.LifecyclePolicy do
  def decode(value, options) do
    GoogleApi.Batch.V1.Model.LifecyclePolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Batch.V1.Model.LifecyclePolicy do
