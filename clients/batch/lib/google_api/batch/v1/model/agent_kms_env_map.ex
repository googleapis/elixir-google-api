...
defmodule GoogleApi.Batch.V1.Model.AgentKMSEnvMap do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Batch.V1.Model.AgentKMSEnvMap do
  def decode(value, options) do
    GoogleApi.Batch.V1.Model.AgentKMSEnvMap.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Batch.V1.Model.AgentKMSEnvMap do
