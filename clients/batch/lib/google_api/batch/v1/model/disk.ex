...
defmodule GoogleApi.Batch.V1.Model.Disk do
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Disk type as shown in `gcloud compute disk-types list`. For example, local SSD uses type "local-ssd". Persistent disks and boot disks use "pd-balanced", "pd-extreme", "pd-ssd" or "pd-standard".
  """
