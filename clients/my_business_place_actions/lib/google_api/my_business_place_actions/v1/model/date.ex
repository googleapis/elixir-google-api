...
defmodule GoogleApi.MyBusinessPlaceActions.V1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MyBusinessPlaceActions.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.MyBusinessPlaceActions.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MyBusinessPlaceActions.V1.Model.Date do
