...
defmodule GoogleApi.WebSecurityScanner.V1alpha.Model.ScanRun do
  ...
  *   `endTime` (*type:* `DateTime.t`, *default:* `nil`) - The time at which the ScanRun reached termination state - that the ScanRun
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the ScanRun. The name follows the format of
      'projects/{projectId}/scanConfigs/{scanConfigId}/scanRuns/{scanRunId}'.
      The ScanRun IDs are generated by the system.
  *   `progressPercent` (*type:* `integer()`, *default:* `nil`) - The percentage of total completion ranging from 0 to 100.
      If the scan is in queue, the value is 0.
      If the scan is running, the value ranges from 0 to 100.
      If the scan is finished, the value is 100.
  *   `resultState` (*type:* `String.t`, *default:* `nil`) - The result state of the ScanRun. This field is only available after the
      execution state reaches "FINISHED".
  *   `startTime` (*type:* `DateTime.t`, *default:* `nil`) - The time at which the ScanRun started.
  *   `urlsCrawledCount` (*type:* `String.t`, *default:* `nil`) - The number of URLs crawled during this ScanRun. If the scan is in progress,
      the value represents the number of URLs crawled up to now.
  *   `urlsTestedCount` (*type:* `String.t`, *default:* `nil`) - The number of URLs tested during this ScanRun. If the scan is in progress,
