...
defmodule GoogleApi.WebSecurityScanner.V1alpha.Model.FindingTypeStats do
  ...
  - findingCount (integer()): Output only.
  The count of findings belonging to this finding type. Defaults to `nil`.
  - findingType (String.t): Output only.
  The finding type associated with the stats. Defaults to `nil`.
  """
