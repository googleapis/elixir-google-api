...
defmodule GoogleApi.WebSecurityScanner.V1alpha.Model.Schedule do
  ...
  - intervalDurationDays (integer()): Required.
  The duration of time between executions in days. Defaults to `nil`.
  - scheduleTime (DateTime.t): A timestamp indicates when the next run will be scheduled. The value is
  refreshed by the server after each run. If unspecified, it will default
  to current server time, which means the scan will be scheduled to start
  immediately. Defaults to `nil`.
  """
