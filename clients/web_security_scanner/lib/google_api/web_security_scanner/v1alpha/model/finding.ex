...
defmodule GoogleApi.WebSecurityScanner.V1alpha.Model.Finding do
  ...
  *   `description` (*type:* `String.t`, *default:* `nil`) - Output only.
      The description of the vulnerability.
  *   `finalUrl` (*type:* `String.t`, *default:* `nil`) - Output only.
      The URL where the browser lands when the vulnerability is detected.
  *   `findingType` (*type:* `String.t`, *default:* `nil`) - Output only.
      The type of the Finding.
  *   `frameUrl` (*type:* `String.t`, *default:* `nil`) - Output only.
      If the vulnerability was originated from nested IFrame, the immediate
      parent IFrame is reported.
  *   `fuzzedUrl` (*type:* `String.t`, *default:* `nil`) - Output only.
  ...
  *   `outdatedLibrary` (*type:* `GoogleApi.WebSecurityScanner.V1alpha.Model.OutdatedLibrary.t`, *default:* `nil`) - Output only.
      An addon containing information about outdated libraries.
  *   `reproductionUrl` (*type:* `String.t`, *default:* `nil`) - Output only.
      The URL containing human-readable payload that user can leverage to
      reproduce the vulnerability.
  *   `trackingId` (*type:* `String.t`, *default:* `nil`) - Output only.
      The tracking ID uniquely identifies a vulnerability instance across
      multiple ScanRuns.
  *   `violatingResource` (*type:* `GoogleApi.WebSecurityScanner.V1alpha.Model.ViolatingResource.t`, *default:* `nil`) - Output only.
      An addon containing detailed information regarding any resource causing the
      vulnerability such as JavaScript sources, image, audio files, etc.
  *   `vulnerableHeaders` (*type:* `GoogleApi.WebSecurityScanner.V1alpha.Model.VulnerableHeaders.t`, *default:* `nil`) - Output only.
      An addon containing information about vulnerable or missing HTTP headers.
  *   `vulnerableParameters` (*type:* `GoogleApi.WebSecurityScanner.V1alpha.Model.VulnerableParameters.t`, *default:* `nil`) - Output only.
      An addon containing information about request parameters which were found
      to be vulnerable.
  *   `xss` (*type:* `GoogleApi.WebSecurityScanner.V1alpha.Model.Xss.t`, *default:* `nil`) - Output only.
