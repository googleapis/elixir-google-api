...
defmodule GoogleApi.WebSecurityScanner.V1.Model.Schedule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WebSecurityScanner.V1.Model.Schedule do
  def decode(value, options) do
    GoogleApi.WebSecurityScanner.V1.Model.Schedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WebSecurityScanner.V1.Model.Schedule do
