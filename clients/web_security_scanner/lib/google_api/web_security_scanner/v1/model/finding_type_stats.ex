...
defimpl Poison.Decoder, for: GoogleApi.WebSecurityScanner.V1.Model.FindingTypeStats do
  def decode(value, options) do
    GoogleApi.WebSecurityScanner.V1.Model.FindingTypeStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WebSecurityScanner.V1.Model.FindingTypeStats do
