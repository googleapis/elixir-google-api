...
defmodule GoogleApi.WebSecurityScanner.V1.Model.Finding do
  ...
  *   `vulnerableParameters` (*type:* `GoogleApi.WebSecurityScanner.V1.Model.VulnerableParameters.t`, *default:* `nil`) - Output only. An addon containing information about request parameters which were found
      to be vulnerable.
