...
defmodule GoogleApi.WebSecurityScanner.V1.Model.VulnerableHeaders do
  @moduledoc """
  ...
  *   `missingHeaders` (*type:* `list(GoogleApi.WebSecurityScanner.V1.Model.Header.t)`, *default:* `nil`) - List of missing headers.
  ...
  field(:missingHeaders, as: GoogleApi.WebSecurityScanner.V1.Model.Header, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.WebSecurityScanner.V1.Model.VulnerableHeaders do
  def decode(value, options) do
    GoogleApi.WebSecurityScanner.V1.Model.VulnerableHeaders.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WebSecurityScanner.V1.Model.VulnerableHeaders do
