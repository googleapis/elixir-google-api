...
defmodule GoogleApi.WebSecurityScanner.V1.Model.OutdatedLibrary do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.WebSecurityScanner.V1.Model.OutdatedLibrary do
  def decode(value, options) do
    GoogleApi.WebSecurityScanner.V1.Model.OutdatedLibrary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WebSecurityScanner.V1.Model.OutdatedLibrary do
