...
defimpl Poison.Decoder, for: GoogleApi.WebSecurityScanner.V1.Model.IapTestServiceAccountInfo do
  def decode(value, options) do
    GoogleApi.WebSecurityScanner.V1.Model.IapTestServiceAccountInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WebSecurityScanner.V1.Model.IapTestServiceAccountInfo do
