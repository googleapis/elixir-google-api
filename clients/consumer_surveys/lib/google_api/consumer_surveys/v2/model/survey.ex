...
defimpl Poison.Decoder, for: GoogleApi.ConsumerSurveys.V2.Model.Survey do
  import GoogleApi.ConsumerSurveys.V2.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:audience, :struct, GoogleApi.ConsumerSurveys.V2.Model.SurveyAudience, options)
    ...
    |> deserialize(
      :rejectionReason,
      :struct,
      GoogleApi.ConsumerSurveys.V2.Model.SurveyRejection,
      options
    )
  end
end
