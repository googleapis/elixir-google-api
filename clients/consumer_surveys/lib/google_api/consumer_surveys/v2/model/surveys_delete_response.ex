...
defmodule GoogleApi.ConsumerSurveys.V2.Model.SurveysDeleteResponse do
  @moduledoc """
...
defimpl Poison.Encoder, for: GoogleApi.ConsumerSurveys.V2.Model.SurveysDeleteResponse do
