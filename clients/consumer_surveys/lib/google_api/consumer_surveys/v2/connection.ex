...
defmodule GoogleApi.ConsumerSurveys.V2.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.ConsumerSurveys.V2.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug(Tesla.Middleware.BaseUrl, "https://www.googleapis.com/consumersurveys/v2")
