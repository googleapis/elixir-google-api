...
defmodule GoogleApi.Spectrum.V1explorer.Model.PawsGetSpectrumResponse do
  ...
  - kind (String): Identifies what kind of resource this is. Value: the fixed string \&quot;spectrum#pawsGetSpectrumResponse\&quot;. Defaults to: `null`.
  ...
  - spectrumSchedules (List[SpectrumSchedule]): The available spectrum response must contain a spectrum schedule list. The list may be empty if spectrum is not available. The database may return more than one spectrum schedule to represent future changes to the available spectrum. How far in advance a schedule may be provided depends on the applicable regulatory domain. Defaults to: `null`.
  - timestamp (String): The database includes a timestamp of the form YYYY-MM-DDThh:mm:ssZ (Internet timestamp format per RFC3339) in its available spectrum response. The timestamp should be used by the device as a reference for the start and stop times specified in the response spectrum schedules. Defaults to: `null`.
