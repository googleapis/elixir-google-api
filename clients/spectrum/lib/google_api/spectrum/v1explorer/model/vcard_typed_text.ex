...
defmodule GoogleApi.Spectrum.V1explorer.Model.VcardTypedText do
  ...
  - text (String.t): The text string associated with this item. For example, for an org field: ACME, inc. For an email field: smith@example.com. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Spectrum.V1explorer.Model.VcardTypedText do
  def decode(value, options) do
    GoogleApi.Spectrum.V1explorer.Model.VcardTypedText.decode(value, options)
  end
end
