...
defmodule GoogleApi.Spectrum.V1explorer.Model.VcardTelephone do
  ...
  - uri (String.t): A nested telephone URI of the form: tel:+1-123-456-7890. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Spectrum.V1explorer.Model.VcardTelephone do
  def decode(value, options) do
    GoogleApi.Spectrum.V1explorer.Model.VcardTelephone.decode(value, options)
  end
end
