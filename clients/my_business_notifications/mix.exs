...
defmodule GoogleApi.MyBusinessNotifications.Mixfile do
  ...
  def project() do
    [
      app: :google_api_my_business_notifications,
      version: @version,
      elixir: "~> 1.6",
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/my_business_notifications"
    ]
  end
  ...
  defp package() do
    [
      ...
      licenses: ["Apache 2.0"],
      links: %{
        "GitHub" => "https://github.com/googleapis/elixir-google-api/tree/master/clients/my_business_notifications",
