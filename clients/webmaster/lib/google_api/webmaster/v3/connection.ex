...
defmodule GoogleApi.Webmaster.V3.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.Webmaster.V3.
  """

  use Tesla

  # Add any middleware here (authentication)
  plug Tesla.Middleware.BaseUrl, "https://www.googleapis.com/webmasters/v3"
