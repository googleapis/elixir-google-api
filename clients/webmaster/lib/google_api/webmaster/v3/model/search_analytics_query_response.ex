...
defmodule GoogleApi.Webmaster.V3.Model.SearchAnalyticsQueryResponse do
  ...
  - responseAggregationType (String.t): How the results were aggregated. Defaults to `nil`.
  - rows (list(GoogleApi.Webmaster.V3.Model.ApiDataRow.t)): A list of rows grouped by the key values in the order given in the query. Defaults to `nil`.
  """
