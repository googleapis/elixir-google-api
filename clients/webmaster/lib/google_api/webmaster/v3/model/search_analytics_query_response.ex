...
defmodule GoogleApi.Webmaster.V3.Model.SearchAnalyticsQueryResponse do
  ...
  - responseAggregationType (String.t): How the results were aggregated. Defaults to: `null`.
  - rows ([ApiDataRow]): A list of rows grouped by the key values in the order given in the query. Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :responseAggregationType => any(),
