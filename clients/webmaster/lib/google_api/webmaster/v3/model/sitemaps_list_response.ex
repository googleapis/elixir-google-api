...
defmodule GoogleApi.Webmaster.V3.Model.SitemapsListResponse do
  ...
  - sitemap (list(GoogleApi.Webmaster.V3.Model.WmxSitemap.t)): Contains detailed information about a specific URL submitted as a sitemap. Defaults to `nil`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :sitemap => list(GoogleApi.Webmaster.V3.Model.WmxSitemap.t())
        }
