...
defmodule GoogleApi.Webmaster.V3.Model.ApiDataRow do
  ...
  - clicks (float()):  Defaults to `nil`.
  - ctr (float()):  Defaults to `nil`.
  - impressions (float()):  Defaults to `nil`.
  - keys (list(String.t)):  Defaults to `nil`.
  - position (float()):  Defaults to `nil`.
  """
