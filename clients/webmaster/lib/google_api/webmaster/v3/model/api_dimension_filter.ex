...
defmodule GoogleApi.Webmaster.V3.Model.ApiDimensionFilter do
  ...
  - dimension (String.t):  Defaults to: `null`.
  - expression (String.t):  Defaults to: `null`.
  - operator (String.t):  Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Webmaster.V3.Model.ApiDimensionFilter do
  def decode(value, options) do
    GoogleApi.Webmaster.V3.Model.ApiDimensionFilter.decode(value, options)
  end
end
