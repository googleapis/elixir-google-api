...
defmodule GoogleApi.Webmaster.V3.Api.Urlcrawlerrorssamples do
  ...
  """
  @spec webmasters_urlcrawlerrorssamples_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Webmaster.V3.Model.UrlCrawlErrorsSample.t()} | {:error, Tesla.Env.t()}
  def webmasters_urlcrawlerrorssamples_get(
        connection,
        site_url,
        url,
        category,
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.Webmaster.V3.Model.UrlCrawlErrorsSample{}])
  end
  ...
  {:error, info} on failure
  """
  @spec webmasters_urlcrawlerrorssamples_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.Webmaster.V3.Model.UrlCrawlErrorsSamplesListResponse.t()}
          | {:error, Tesla.Env.t()}
  def webmasters_urlcrawlerrorssamples_list(
        connection,
        site_url,
        category,
        platform,
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Webmaster.V3.Model.UrlCrawlErrorsSamplesListResponse{}]
    )
  end
  ...
  {:error, info} on failure
  """
  @spec webmasters_urlcrawlerrorssamples_mark_as_fixed(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  def webmasters_urlcrawlerrorssamples_mark_as_fixed(
        connection,
        site_url,
        url,
        category,
