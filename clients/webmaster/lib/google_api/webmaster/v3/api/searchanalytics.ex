...
defmodule GoogleApi.Webmaster.V3.Api.Searchanalytics do
  ...
  """
  @spec webmasters_searchanalytics_query(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def webmasters_searchanalytics_query(connection, site_url, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.Webmaster.V3.Model.SearchAnalyticsQueryResponse{})
  end
end
