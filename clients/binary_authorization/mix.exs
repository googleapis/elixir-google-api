...
defmodule GoogleApi.BinaryAuthorization.Mixfile do
  ...
  def project() do
    [
      app: :google_api_binary_authorization,
      version: @version,
      elixir: "~> 1.6",
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/binary_authorization"
    ]
  end
  ...
  defp package() do
    [
      ...
      licenses: ["Apache 2.0"],
      links: %{
        "GitHub" => "https://github.com/googleapis/elixir-google-api/tree/master/clients/binary_authorization",
