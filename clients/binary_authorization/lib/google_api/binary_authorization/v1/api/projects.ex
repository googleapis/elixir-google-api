...
defmodule GoogleApi.BinaryAuthorization.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  @spec binaryauthorization_projects_get_policy(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.BinaryAuthorization.V1.Model.Policy.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec binaryauthorization_projects_attestors_create(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.BinaryAuthorization.V1.Model.Attestor.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec binaryauthorization_projects_attestors_delete(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.BinaryAuthorization.V1.Model.Empty.t()} | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  ...
  @spec binaryauthorization_projects_attestors_get_iam_policy(
          ...
          keyword(),
          keyword()
        ) :: {:ok, GoogleApi.BinaryAuthorization.V1.Model.IamPolicy.t()} | {:error, Tesla.Env.t()}
