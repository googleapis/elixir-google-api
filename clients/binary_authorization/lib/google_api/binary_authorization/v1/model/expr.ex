...
defmodule GoogleApi.BinaryAuthorization.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BinaryAuthorization.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.BinaryAuthorization.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BinaryAuthorization.V1.Model.Expr do
