...
defimpl Poison.Decoder, for: GoogleApi.BinaryAuthorization.V1.Model.ListAttestorsResponse do
  def decode(value, options) do
    GoogleApi.BinaryAuthorization.V1.Model.ListAttestorsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BinaryAuthorization.V1.Model.ListAttestorsResponse do
