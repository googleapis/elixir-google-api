...
defmodule GoogleApi.BinaryAuthorization.V1.Model.Scope do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BinaryAuthorization.V1.Model.Scope do
  def decode(value, options) do
    GoogleApi.BinaryAuthorization.V1.Model.Scope.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BinaryAuthorization.V1.Model.Scope do
