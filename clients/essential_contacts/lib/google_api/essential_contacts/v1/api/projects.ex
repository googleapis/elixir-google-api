...
defmodule GoogleApi.EssentialContacts.V1.Api.Projects do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_compute(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_create(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_projects_contacts_get(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_projects_contacts_send_test_message(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
