...
defmodule GoogleApi.EssentialContacts.V1.Api.Folders do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_compute(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_compute(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_create(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_create(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_delete(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_delete(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_get(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_list(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_list(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec essentialcontacts_folders_contacts_send_test_message(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def essentialcontacts_folders_contacts_send_test_message(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
