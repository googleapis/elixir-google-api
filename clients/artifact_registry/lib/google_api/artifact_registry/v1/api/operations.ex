...
defmodule GoogleApi.ArtifactRegistry.V1.Api.Operations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec artifactregistry_operations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.ArtifactRegistry.V1.Model.Operation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def artifactregistry_operations_get(
        connection,
        operations_id,
        optional_params \\ [],
        opts \\ []
