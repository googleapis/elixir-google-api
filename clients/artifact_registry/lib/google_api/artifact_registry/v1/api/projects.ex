...
defmodule GoogleApi.ArtifactRegistry.V1.Api.Projects do
  ...
  *   `connection` (*type:* `GoogleApi.ArtifactRegistry.V1.Connection.t`) - Connection to server
  *   `projects_id` (*type:* `String.t`) - Part of `parent`. The resource name of the repository where the generic artifact will be uploaded.
  *   `locations_id` (*type:* `String.t`) - Part of `parent`. See documentation of `projectsId`.
  *   `repositories_id` (*type:* `String.t`) - Part of `parent`. See documentation of `projectsId`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
  ...
  *   `{:error, info}` on failure
  ...
  def artifactregistry_projects_locations_repositories_generic_artifacts_upload_iodata(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/upload/v1/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/genericArtifacts:create",
        %{
          "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
          "repositoriesId" => URI.encode(repositories_id, &URI.char_unreserved?/1)
  ...
  *   `{:error, info}` on failure
  ...
  def artifactregistry_projects_locations_repositories_generic_artifacts_upload_resumable(
    ...
    request =
      ...
      |> Request.method(:post)
      |> Request.url(
        "/resumable/upload/v1/projects/{projectsId}/locations/{locationsId}/repositories/{repositoriesId}/genericArtifacts:create",
        %{
          "projectsId" => URI.encode(projects_id, &URI.char_unreserved?/1),
          "locationsId" => URI.encode(locations_id, &URI.char_unreserved?/1),
          "repositoriesId" => URI.encode(repositories_id, &URI.char_unreserved?/1)
