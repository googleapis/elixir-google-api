...
defmodule GoogleApi.ArtifactRegistry.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  """
  @spec artifactregistry_projects_locations_repositories_goo_get_artifacts_import(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def artifactregistry_projects_locations_repositories_goo_get_artifacts_import(
        connection,
        projects_id,
        locations_id,
        repositories_id,
