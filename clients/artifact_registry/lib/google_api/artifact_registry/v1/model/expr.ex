...
defmodule GoogleApi.ArtifactRegistry.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1.Model.Expr do
