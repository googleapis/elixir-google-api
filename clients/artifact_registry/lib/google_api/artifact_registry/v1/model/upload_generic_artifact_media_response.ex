...
defmodule GoogleApi.ArtifactRegistry.V1.Model.UploadGenericArtifactMediaResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ArtifactRegistry.V1.Model.UploadGenericArtifactMediaResponse do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1.Model.UploadGenericArtifactMediaResponse.decode(value, options)
  end
end
