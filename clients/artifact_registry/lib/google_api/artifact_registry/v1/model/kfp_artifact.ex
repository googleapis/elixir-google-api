...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1.Model.KfpArtifact do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1.Model.KfpArtifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1.Model.KfpArtifact do
