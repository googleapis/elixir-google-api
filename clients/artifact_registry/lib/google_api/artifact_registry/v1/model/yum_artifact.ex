...
defmodule GoogleApi.ArtifactRegistry.V1.Model.YumArtifact do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1.Model.YumArtifact do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1.Model.YumArtifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1.Model.YumArtifact do
