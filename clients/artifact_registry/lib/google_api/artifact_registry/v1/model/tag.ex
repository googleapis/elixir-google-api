...
defmodule GoogleApi.ArtifactRegistry.V1.Model.Tag do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1.Model.Tag do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1.Model.Tag.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1.Model.Tag do
