...
defmodule GoogleApi.ArtifactRegistry.V1beta1.Model.Package do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Package do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1beta1.Model.Package.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Package do
