...
defmodule GoogleApi.ArtifactRegistry.V1beta1.Model.Policy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Policy do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1beta1.Model.Policy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Policy do
