...
defmodule GoogleApi.ArtifactRegistry.V1beta1.Model.Version do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - The time when the version was last updated.
  ...
  field(:description)
  field(:name)
  field(:relatedTags, as: GoogleApi.ArtifactRegistry.V1beta1.Model.Tag, type: :list)
  field(:updateTime, as: DateTime)
end

defimpl Poison.Decoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Version do
  def decode(value, options) do
    GoogleApi.ArtifactRegistry.V1beta1.Model.Version.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ArtifactRegistry.V1beta1.Model.Version do
