...
defmodule GoogleApi.Classroom.V1.Model.Course do
  ...
  - calendarId (String.t): The Calendar ID for a calendar that all course members can see, to which
  Classroom adds events for course work and announcements in the course.

  Read-only. Defaults to `nil`.
  - courseGroupEmail (String.t): The email address of a Google group containing all members of the course.
  ...
  Read-only. Defaults to `nil`.
  - courseState (String.t): State of the course.
  If unspecified, the default state is `PROVISIONED`. Defaults to `nil`.
  - creationTime (DateTime.t): Creation time of the course.
  Specifying this field in a course update mask results in an error.

  Read-only. Defaults to `nil`.
  - description (String.t): Optional description.
  For example, "We'll be learning about the structure of living
  creatures from a combination of textbooks, guest lectures, and lab work.
  Expect to be excited!"
  If set, this field must be a valid UTF-8 string and no longer than 30,000
  characters. Defaults to `nil`.
  - descriptionHeading (String.t): Optional heading for the description.
  For example, "Welcome to 10th Grade Biology."
  If set, this field must be a valid UTF-8 string and no longer than 3600
  characters. Defaults to `nil`.
  - enrollmentCode (String.t): Enrollment code to use when joining this course.
  Specifying this field in a course update mask results in an error.
  ...
  - name (String.t): Name of the course.
  For example, "10th Grade Biology".
  The name is required. It must be between 1 and 750 characters and a valid
  UTF-8 string. Defaults to `nil`.
  ...
  * the string literal `"me"`, indicating the requesting user
  ...
  transfer ownership. In other contexts, it is read-only. Defaults to `nil`.
  - room (String.t): Optional room location.
  For example, "301".
  If set, this field must be a valid UTF-8 string and no longer than 650
  characters. Defaults to `nil`.
  - section (String.t): Section of the course.
  For example, "Period 2".
  If set, this field must be a valid UTF-8 string and no longer than 2800
  characters. Defaults to `nil`.
  - teacherFolder (GoogleApi.Classroom.V1.Model.DriveFolder.t): Information about a Drive Folder that is shared with all teachers of the
  course.
  ...
  Read-only. Defaults to `nil`.
  - teacherGroupEmail (String.t): The email address of a Google group containing all teachers of the course.
  This group does not accept email and can only be used for permissions.

  Read-only. Defaults to `nil`.
  - updateTime (DateTime.t): Time of the most recent update to this course.
  Specifying this field in a course update mask results in an error.
