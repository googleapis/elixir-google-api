...
defmodule GoogleApi.Classroom.V1.Model.DriveFolder do
  ...
  - alternateLink (String.t): URL that can be used to access the Drive folder.  Read-only. Defaults to: `null`.
  - id (String.t): Drive API resource ID. Defaults to: `null`.
  - title (String.t): Title of the Drive folder.  Read-only. Defaults to: `null`.
  """
