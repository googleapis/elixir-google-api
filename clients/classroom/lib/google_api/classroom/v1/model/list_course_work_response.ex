...
defmodule GoogleApi.Classroom.V1.Model.ListCourseWorkResponse do
  ...
  - courseWork ([CourseWork]): Course work items that match the request. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Classroom.V1.Model.ListCourseWorkResponse do
  def decode(value, options) do
    GoogleApi.Classroom.V1.Model.ListCourseWorkResponse.decode(value, options)
  end
end
