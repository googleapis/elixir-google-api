...
defmodule GoogleApi.Classroom.V1.Model.ListCourseAliasesResponse do
  ...
  - aliases ([CourseAlias]): The course aliases. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Classroom.V1.Model.ListCourseAliasesResponse do
  def decode(value, options) do
    GoogleApi.Classroom.V1.Model.ListCourseAliasesResponse.decode(value, options)
  end
end
