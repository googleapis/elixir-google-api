...
defmodule GoogleApi.NetworkServices.V1.Model.ListServiceBindingsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.ListServiceBindingsResponse do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.ListServiceBindingsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.ListServiceBindingsResponse do
