...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.LoggingConfig do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.LoggingConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.LoggingConfig do
