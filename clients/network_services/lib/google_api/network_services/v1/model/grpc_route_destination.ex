...
defmodule GoogleApi.NetworkServices.V1.Model.GrpcRouteDestination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.GrpcRouteDestination do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.GrpcRouteDestination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.GrpcRouteDestination do
