...
defmodule GoogleApi.NetworkServices.V1.Model.ListGatewayRouteViewsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.ListGatewayRouteViewsResponse do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.ListGatewayRouteViewsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.ListGatewayRouteViewsResponse do
