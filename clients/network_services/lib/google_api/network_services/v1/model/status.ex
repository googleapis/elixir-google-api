...
defmodule GoogleApi.NetworkServices.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.Status do
