...
defmodule GoogleApi.NetworkServices.V1.Model.LbTrafficExtension do
  @moduledoc """
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Optional. Set of labels associated with the `LbTrafficExtension` resource. The format must comply with [the requirements for labels](/compute/docs/labeling-resources#requirements) for Google Cloud resources.
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.LbTrafficExtension do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.LbTrafficExtension.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.LbTrafficExtension do
