...
defmodule GoogleApi.NetworkServices.V1.Model.ListMeshRouteViewsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.ListMeshRouteViewsResponse do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.ListMeshRouteViewsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.ListMeshRouteViewsResponse do
