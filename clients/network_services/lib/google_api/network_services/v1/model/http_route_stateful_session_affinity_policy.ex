...
defmodule GoogleApi.NetworkServices.V1.Model.HttpRouteStatefulSessionAffinityPolicy do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.NetworkServices.V1.Model.HttpRouteStatefulSessionAffinityPolicy do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.HttpRouteStatefulSessionAffinityPolicy.decode(
      value,
      options
    )
  end
