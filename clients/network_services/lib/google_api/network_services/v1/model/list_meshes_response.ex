...
defmodule GoogleApi.NetworkServices.V1.Model.ListMeshesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkServices.V1.Model.ListMeshesResponse do
  def decode(value, options) do
    GoogleApi.NetworkServices.V1.Model.ListMeshesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkServices.V1.Model.ListMeshesResponse do
