...
defmodule GoogleApi.Calendar.V3.Model.CalendarNotification do
  ...
  - method (String.t): The method used to deliver the notification. Possible values are:   - \&quot;email\&quot; - Notifications are sent via email.  - \&quot;sms\&quot; - Deprecated. Once this feature is shutdown, the API will no longer return notifications using this method. Any newly added SMS notifications will be ignored. See  Google Calendar SMS notifications to be removed for more information. Notifications are sent via SMS. This value is read-only and is ignored on inserts and updates. SMS notifications are only available for G Suite customers.   Required when adding a notification. Defaults to: `null`.
