...
defmodule GoogleApi.Calendar.V3.Model.Events do
  ...
  - "owner" - The user has ownership of the calendar. This role has all of the permissions of the writer role with the additional ability to see and manipulate ACLs. Defaults to `nil`.
  - defaultReminders (list(GoogleApi.Calendar.V3.Model.EventReminder.t)): The default reminders on the calendar for the authenticated user. These reminders apply to all events on this calendar that do not explicitly override them (i.e. do not have reminders.useDefault set to True). Defaults to `nil`.
  - description (String.t): Description of the calendar. Read-only. Defaults to `nil`.
  - etag (String.t): ETag of the collection. Defaults to `nil`.
  - items (list(GoogleApi.Calendar.V3.Model.Event.t)): List of events on the calendar. Defaults to `nil`.
  - kind (String.t): Type of the collection ("calendar#events"). Defaults to `calendar#events`.
  ...
  - timeZone (String.t): The time zone of the calendar. Read-only. Defaults to `nil`.
  - updated (DateTime.t): Last modification time of the calendar (as a RFC3339 timestamp). Read-only. Defaults to `nil`.
  """
