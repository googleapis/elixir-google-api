...
defmodule GoogleApi.MyBusinessBusinessInformation.V1.Model.PostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MyBusinessBusinessInformation.V1.Model.PostalAddress do
  def decode(value, options) do
    GoogleApi.MyBusinessBusinessInformation.V1.Model.PostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MyBusinessBusinessInformation.V1.Model.PostalAddress do
