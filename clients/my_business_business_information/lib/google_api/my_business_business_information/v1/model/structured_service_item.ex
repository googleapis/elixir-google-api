...
defmodule GoogleApi.MyBusinessBusinessInformation.V1.Model.StructuredServiceItem do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.MyBusinessBusinessInformation.V1.Model.StructuredServiceItem do
  def decode(value, options) do
    GoogleApi.MyBusinessBusinessInformation.V1.Model.StructuredServiceItem.decode(value, options)
  end
end
