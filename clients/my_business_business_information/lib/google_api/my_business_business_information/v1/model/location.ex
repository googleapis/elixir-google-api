...
defmodule GoogleApi.MyBusinessBusinessInformation.V1.Model.Location do
  ...
  *   `profile` (*type:* `GoogleApi.MyBusinessBusinessInformation.V1.Model.Profile.t`, *default:* `nil`) - Required. Describes your business in your own voice and shares with users the unique story of your business and offerings.
  ...
  *   `relationshipData` (*type:* `GoogleApi.MyBusinessBusinessInformation.V1.Model.RelationshipData.t`, *default:* `nil`) - Output only. All locations and chain related to this one.
