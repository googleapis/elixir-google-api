...
defmodule GoogleApi.VideoIntelligence.V1.Api.Operations do
  ...
  *   `{:error, info}` on failure
  """
  @spec videointelligence_operations_cancel(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec videointelligence_operations_delete(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.VideoIntelligence.V1.Model.GoogleProtobuf_Empty.t()}
          | {:error, Tesla.Env.t()}
  ...
  *   `{:error, info}` on failure
  """
  @spec videointelligence_operations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
