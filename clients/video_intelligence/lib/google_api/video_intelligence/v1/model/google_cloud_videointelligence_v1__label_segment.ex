...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_LabelSegment do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_LabelSegment do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_LabelSegment.decode(
      value,
      options
    )
  end
