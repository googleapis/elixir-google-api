...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_SpeechTranscriptionConfig do
  ...
  *   `diarizationSpeakerCount` (*type:* `integer()`, *default:* `nil`) - Optional. If set, specifies the estimated number of speakers in the conversation.
  ...
  *   `languageCode` (*type:* `String.t`, *default:* `nil`) - Required. *Required* The language of the supplied audio as a
