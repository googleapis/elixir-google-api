...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_VideoAnnotationResults do
  ...
  *   `faceAnnotations` (*type:* `list(GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceAnnotation.t)`, *default:* `nil`) - Deprecated. Please use `face_detection_annotations` instead.
  *   `faceDetectionAnnotations` (*type:* `list(GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceDetectionAnnotation.t)`, *default:* `nil`) - Face detection annotations.
  ...
  *   `personDetectionAnnotations` (*type:* `list(GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_PersonDetectionAnnotation.t)`, *default:* `nil`) - Person detection annotations.
  ...
  *   `textAnnotations` (*type:* `list(GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_TextAnnotation.t)`, *default:* `nil`) - OCR text detection and tracking. Annotations for list of detected text snippets. Each will have list of frame information associated with it.
  ...
  @type t :: %__MODULE__{
          ...
          :faceAnnotations =>
            list(
              GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceAnnotation.t()
            ),
          :faceDetectionAnnotations =>
            list(
              GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceDetectionAnnotation.t()
            ),
          ...
          :personDetectionAnnotations =>
            list(
              GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_PersonDetectionAnnotation.t()
            ),
          :segment =>
  ...
  field(:faceAnnotations,
    as: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceAnnotation,
    type: :list
  )

  field(:faceDetectionAnnotations,
    as:
      GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_FaceDetectionAnnotation,
    type: :list
  )
  ...
  field(:personDetectionAnnotations,
    as:
      GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_PersonDetectionAnnotation,
    type: :list
  )
