...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleLongrunning_Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.VideoIntelligence.V1.Model.GoogleRpc_Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.VideoIntelligence.V1.Model.GoogleLongrunning_Operation do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleLongrunning_Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VideoIntelligence.V1.Model.GoogleLongrunning_Operation do
