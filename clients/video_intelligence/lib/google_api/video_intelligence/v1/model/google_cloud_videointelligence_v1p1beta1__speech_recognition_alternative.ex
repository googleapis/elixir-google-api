...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p1beta1_SpeechRecognitionAlternative do
  ...
  *   `words` (*type:* `list(GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p1beta1_WordInfo.t)`, *default:* `nil`) - Output only. A list of word-specific information for each recognized word.
