...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress do
  @moduledoc """
  ...
  - feature (String.t): Specifies which feature is being tracked if the request contains more than one features. Defaults to: `null`.
    - Enum - one of [FEATURE_UNSPECIFIED, LABEL_DETECTION, SHOT_CHANGE_DETECTION, EXPLICIT_CONTENT_DETECTION, SPEECH_TRANSCRIPTION, TEXT_DETECTION, OBJECT_TRACKING, LOGO_RECOGNITION]
  ...
  - segment (GoogleCloudVideointelligenceV1p3beta1VideoSegment): Specifies which segment is being tracked if the request contains more than one segments. Defaults to: `null`.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress.decode(
      value,
      options
    )
  end
