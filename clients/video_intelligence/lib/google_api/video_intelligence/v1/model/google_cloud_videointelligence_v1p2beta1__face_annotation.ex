...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1_FaceAnnotation do
  @moduledoc """
  ...
  *   `thumbnail` (*type:* `String.t`, *default:* `nil`) - Thumbnail of a representative face view (in JPEG format).
  ...
  field(:frames,
    as: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1_FaceFrame,
    type: :list
  )

  field(:segments,
    as: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1_FaceSegment,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1_FaceAnnotation do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1_FaceAnnotation.decode(
      value,
      options
    )
  end
