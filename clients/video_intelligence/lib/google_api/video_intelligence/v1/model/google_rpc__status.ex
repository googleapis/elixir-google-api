...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleRpc_Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VideoIntelligence.V1.Model.GoogleRpc_Status do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleRpc_Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VideoIntelligence.V1.Model.GoogleRpc_Status do
