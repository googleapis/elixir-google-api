...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationProgress do
  @moduledoc """
  ...
  - segment (GoogleCloudVideointelligenceV1p2beta1VideoSegment): Specifies which segment is being tracked if the request contains more than one segments. Defaults to: `null`.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationProgress do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationProgress.decode(
      value,
      options
    )
  end
