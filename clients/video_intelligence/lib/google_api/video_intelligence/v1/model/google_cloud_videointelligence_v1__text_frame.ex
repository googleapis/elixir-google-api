...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_TextFrame do
  ...
  *   `timeOffset` (*type:* `String.t`, *default:* `nil`) - Timestamp of this frame.
  ...
  field(
    :rotatedBoundingBox,
    as: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_NormalizedBoundingPoly
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_TextFrame do
  def decode(value, options) do
    GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1_TextFrame.decode(
      value,
      options
    )
  end
