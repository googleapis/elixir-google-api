...
defmodule GoogleApi.VideoIntelligence.V1.Model.GoogleCloudVideointelligenceV1VideoAnnotationProgress do
  ...
  - segment (GoogleCloudVideointelligenceV1VideoSegment): Specifies which segment is being tracked if the request contains more than one segments. Defaults to: `null`.
