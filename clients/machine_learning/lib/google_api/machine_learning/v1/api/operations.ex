...
defmodule GoogleApi.MachineLearning.V1.Api.Operations do
  @moduledoc """
  ...
  """
  @spec ml_operations_delete(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.MachineLearning.V1.Model.GoogleProtobufEmpty.t()}
          | {:error, Tesla.Env.t()}
  def ml_operations_delete(connection, operations_id, optional_params \\ [], opts \\ []) do
