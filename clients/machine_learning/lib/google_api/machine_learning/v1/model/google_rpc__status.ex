...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleRpcStatus do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :code => any(),
          :details => list(GoogleApi.MachineLearning.V1.Model.Object.t()),
          :message => any()
        }

  field(:code)
  field(:details, as: GoogleApi.MachineLearning.V1.Model.Object, type: :list)
  field(:message)
end

defimpl Poison.Decoder, for: GoogleApi.MachineLearning.V1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MachineLearning.V1.Model.GoogleRpcStatus do
