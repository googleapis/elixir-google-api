...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleIamV1_TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.MachineLearning.V1.Model.GoogleIamV1_TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleIamV1_TestIamPermissionsRequest.decode(
      value,
      options
    )
  end
