...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.MachineLearning.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleIamV1TestIamPermissionsRequest.decode(value, options)
  end
end
