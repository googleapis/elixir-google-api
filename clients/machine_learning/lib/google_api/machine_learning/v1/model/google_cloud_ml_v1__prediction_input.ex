...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1PredictionInput do
  ...
  - region (String.t): Required. The Google Compute Engine region to run the prediction job in. See the &lt;a href&#x3D;\&quot;/ml-engine/docs/tensorflow/regions\&quot;&gt;available regions&lt;/a&gt; for AI Platform services. Defaults to: `null`.
  - runtimeVersion (String.t): Optional. The AI Platform runtime version to use for this batch prediction. If not set, AI Platform will pick the runtime version used during the CreateVersion request for this model version, or choose the latest stable version when model version information is not available such as when the model is specified by uri. Defaults to: `null`.
