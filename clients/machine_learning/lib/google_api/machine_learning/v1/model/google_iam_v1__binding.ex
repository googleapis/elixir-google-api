...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Binding do
  ...
  *   `role` (*type:* `String.t`, *default:* `nil`) - Role that is assigned to the list of `members`, or principals. For example, `roles/viewer`, `roles/editor`, or `roles/owner`. For an overview of the IAM roles and permissions, see the [IAM documentation](https://cloud.google.com/iam/docs/roles-overview). For a list of the available pre-defined roles, see [here](https://cloud.google.com/iam/docs/understanding-roles).
  ...
  @type t :: %__MODULE__{
          :condition => GoogleApi.MachineLearning.V1.Model.GoogleType_Expr.t() | nil,
...
defimpl Poison.Decoder, for: GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Binding do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Binding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Binding do
