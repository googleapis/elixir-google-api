...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_Version do
  ...
  *   `endpoints` (*type:* `GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_EndpointMap.t`, *default:* `nil`) - Optional. Output only. If set by server, the http(s) endpoints returned to user after the public/private deployment is successful. https://cloud.google.com/apis/design/design_patterns#output_fields.
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The state of a version.
  ...
  @type t :: %__MODULE__{
          ...
          :endpoints => GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_EndpointMap.t(),
  ...
  field(:deploymentUri)
  field(:description)
  field(:endpoints, as: GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_EndpointMap)
  field(:errorMessage)
  field(:etag)
