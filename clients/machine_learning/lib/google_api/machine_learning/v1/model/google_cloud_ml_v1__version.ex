...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_Version do
  ...
  *   `container` (*type:* `GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_ContainerSpec.t`, *default:* `nil`) - 
  ...
  *   `routes` (*type:* `GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_RouteMap.t`, *default:* `nil`) - 
