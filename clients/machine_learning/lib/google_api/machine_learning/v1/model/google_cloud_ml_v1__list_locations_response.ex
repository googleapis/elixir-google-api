...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_ListLocationsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_ListLocationsResponse do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1_ListLocationsResponse.decode(
      value,
      options
    )
  end
