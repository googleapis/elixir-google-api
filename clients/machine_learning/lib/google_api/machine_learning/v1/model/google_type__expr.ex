...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleType_Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MachineLearning.V1.Model.GoogleType_Expr do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleType_Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MachineLearning.V1.Model.GoogleType_Expr do
