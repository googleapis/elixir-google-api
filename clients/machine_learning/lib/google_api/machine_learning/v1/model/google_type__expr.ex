...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MachineLearning.V1.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.MachineLearning.V1.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MachineLearning.V1.Model.GoogleTypeExpr do
