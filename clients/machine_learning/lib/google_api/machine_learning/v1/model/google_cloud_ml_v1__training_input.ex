...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleCloudMlV1TrainingInput do
  ...
  - parameterServerConfig (GoogleCloudMlV1ReplicaConfig): Optional. The configuration for parameter servers.  You should only set &#x60;parameterServerConfig.acceleratorConfig&#x60; if &#x60;parameterServerConfigType&#x60; is set to a Compute Engine machine type. [Learn about restrictions on accelerator configurations for training.](/ml-engine/docs/tensorflow/using-gpus#compute-engine-machine-types-with-gpu)  Set &#x60;parameterServerConfig.imageUri&#x60; only if you build a custom image for your parameter server. If &#x60;parameterServerConfig.imageUri&#x60; has not been set, Cloud ML Engine uses the value of &#x60;masterConfig.imageUri&#x60;. Learn more about [configuring custom containers](/ml-engine/docs/distributed-training-containers). Defaults to: `null`.
  ...
  - workerConfig (GoogleCloudMlV1ReplicaConfig): Optional. The configuration for workers.  You should only set &#x60;workerConfig.acceleratorConfig&#x60; if &#x60;workerType&#x60; is set to a Compute Engine machine type. [Learn about restrictions on accelerator configurations for training.](/ml-engine/docs/tensorflow/using-gpus#compute-engine-machine-types-with-gpu)  Set &#x60;workerConfig.imageUri&#x60; only if you build a custom image for your worker. If &#x60;workerConfig.imageUri&#x60; has not been set, Cloud ML Engine uses the value of &#x60;masterConfig.imageUri&#x60;. Learn more about [configuring custom containers](/ml-engine/docs/distributed-training-containers). Defaults to: `null`.
