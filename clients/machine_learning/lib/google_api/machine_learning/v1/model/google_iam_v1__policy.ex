...
defmodule GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Policy do
  ...
  *   `bindings` (*type:* `list(GoogleApi.MachineLearning.V1.Model.GoogleIamV1_Binding.t)`, *default:* `nil`) - Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
