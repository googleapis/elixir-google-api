...
defimpl Poison.Decoder, for: GoogleApi.CertificateManager.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.CertificateManager.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CertificateManager.V1.Model.Location do
