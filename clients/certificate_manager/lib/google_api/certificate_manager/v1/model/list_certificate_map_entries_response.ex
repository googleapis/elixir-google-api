...
defmodule GoogleApi.CertificateManager.V1.Model.ListCertificateMapEntriesResponse do
  @moduledoc """
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - Locations that could not be reached.
  ...
  @type t :: %__MODULE__{
          :certificateMapEntries =>
            list(GoogleApi.CertificateManager.V1.Model.CertificateMapEntry.t()) | nil,
          :nextPageToken => String.t() | nil,
          :unreachable => list(String.t()) | nil
        }

  field(:certificateMapEntries,
    as: GoogleApi.CertificateManager.V1.Model.CertificateMapEntry,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.CertificateManager.V1.Model.ListCertificateMapEntriesResponse do
  def decode(value, options) do
    GoogleApi.CertificateManager.V1.Model.ListCertificateMapEntriesResponse.decode(value, options)
  end
end
