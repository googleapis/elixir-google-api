...
defmodule GoogleApi.CertificateManager.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CertificateManager.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.CertificateManager.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CertificateManager.V1.Model.OperationMetadata do
