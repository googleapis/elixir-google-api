...
defmodule GoogleApi.AnalyticsHub.V1beta1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1beta1.Model.Location do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1beta1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1beta1.Model.Location do
