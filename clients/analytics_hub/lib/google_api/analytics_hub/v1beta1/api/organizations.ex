...
defmodule GoogleApi.AnalyticsHub.V1beta1.Api.Organizations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def analyticshub_organizations_locations_data_exchanges_list(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta1/{+organization}/dataExchanges", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.AnalyticsHub.V1beta1.Model.ListOrgDataExchangesResponse{}]
    )
  end
end
