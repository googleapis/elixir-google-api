...
defmodule GoogleApi.AnalyticsHub.V1.Model.LinkedResource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1.Model.LinkedResource do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1.Model.LinkedResource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1.Model.LinkedResource do
