...
defmodule GoogleApi.AnalyticsHub.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1.Model.OperationMetadata do
