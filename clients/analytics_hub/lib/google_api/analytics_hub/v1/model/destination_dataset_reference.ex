...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1.Model.DestinationDatasetReference do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1.Model.DestinationDatasetReference.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1.Model.DestinationDatasetReference do
