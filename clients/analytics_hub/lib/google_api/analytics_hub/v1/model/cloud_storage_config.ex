...
defmodule GoogleApi.AnalyticsHub.V1.Model.CloudStorageConfig do
  @moduledoc """
  Configuration for a Cloud Storage subscription.

  ## Attributes

  *   `avroConfig` (*type:* `GoogleApi.AnalyticsHub.V1.Model.AvroConfig.t`, *default:* `nil`) - Optional. If set, message data will be written to Cloud Storage in Avro format.
  ...
  *   `textConfig` (*type:* `GoogleApi.AnalyticsHub.V1.Model.TextConfig.t`, *default:* `nil`) - Optional. If set, message data will be written to Cloud Storage in text format.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :avroConfig => GoogleApi.AnalyticsHub.V1.Model.AvroConfig.t() | nil,
          :bucket => String.t() | nil,
          ...
          :state => String.t() | nil,
          :textConfig => GoogleApi.AnalyticsHub.V1.Model.TextConfig.t() | nil
        }

  field(:avroConfig, as: GoogleApi.AnalyticsHub.V1.Model.AvroConfig)
  field(:bucket)
  ...
  field(:state)
  field(:textConfig, as: GoogleApi.AnalyticsHub.V1.Model.TextConfig)
end

defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1.Model.CloudStorageConfig do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1.Model.CloudStorageConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1.Model.CloudStorageConfig do
