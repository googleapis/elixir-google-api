...
defmodule GoogleApi.AnalyticsHub.V1.Model.BigQueryConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsHub.V1.Model.BigQueryConfig do
  def decode(value, options) do
    GoogleApi.AnalyticsHub.V1.Model.BigQueryConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsHub.V1.Model.BigQueryConfig do
