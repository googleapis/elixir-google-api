...
defmodule GoogleApi.RealTimeBidding.V1.Model.VideoContent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.RealTimeBidding.V1.Model.VideoContent do
  def decode(value, options) do
    GoogleApi.RealTimeBidding.V1.Model.VideoContent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.RealTimeBidding.V1.Model.VideoContent do
