...
defmodule GoogleApi.RealTimeBidding.V1.Model.AdTechnologyProviders do
  ...
  *   `detectedGvlIds` (*type:* `list(String.t)`, *default:* `nil`) - The detected IAB Global Vendor List (GVL) IDs for this creative. See the IAB Global Vendor List at https://vendorlist.consensu.org/v2/vendor-list.json for details about the vendors.
