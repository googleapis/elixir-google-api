...
defmodule GoogleApi.Analytics.V3.Api.Metadata do
  ...
  - report_type (String): Report type. Allowed Values: &#39;ga&#39;. Where &#39;ga&#39; corresponds to the Core Reporting API
  ...
  """
  @spec analytics_metadata_columns_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Analytics.V3.Model.Columns.t} | {:error, Tesla.Env.t}
  def analytics_metadata_columns_list(connection, report_type, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.Analytics.V3.Model.Columns{})
  end
end
