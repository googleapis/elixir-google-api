...
defmodule GoogleApi.Analytics.V3.Model.WebpropertyChildLink do
  ...
  - href (String.t): Link to the list of views (profiles) for this web property. Defaults to: `null`.
  - type (String.t): Type of the parent link. Its value is \&quot;analytics#profiles\&quot;. Defaults to: `null`.
  """
