...
defmodule GoogleApi.Analytics.V3.Model.EntityUserLinks do
  ...
  - items ([EntityUserLink]): A list of entity user links. Defaults to: `null`.
  ...
  - nextLink (String.t): Next link for this account collection. Defaults to: `null`.
  - previousLink (String.t): Previous link for this account collection. Defaults to: `null`.
