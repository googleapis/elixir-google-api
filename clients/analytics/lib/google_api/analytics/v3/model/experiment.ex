...
defmodule GoogleApi.Analytics.V3.Model.Experiment do
  ...
  *   `winnerFound` (*type:* `boolean()`, *default:* `nil`) - Boolean specifying whether a winner has been found for this experiment. This field is read-only.
  ...
  @type t :: %__MODULE__{
          ...
          :editableInGaUi => boolean() | nil,
          :endTime => DateTime.t() | nil,
          :equalWeighting => boolean() | nil,
          :id => String.t() | nil,
          :internalWebPropertyId => String.t() | nil,
          :kind => String.t() | nil,
          :minimumExperimentLengthInDays => integer() | nil,
          :name => String.t() | nil,
          :objectiveMetric => String.t() | nil,
          :optimizationType => String.t() | nil,
          :parentLink => GoogleApi.Analytics.V3.Model.ExperimentParentLink.t() | nil,
          :profileId => String.t() | nil,
          :reasonExperimentEnded => String.t() | nil,
          :rewriteVariationUrlsAsOriginal => boolean() | nil,
          :selfLink => String.t() | nil,
          :servingFramework => String.t() | nil,
          :snippet => String.t() | nil,
          :startTime => DateTime.t() | nil,
          :status => String.t() | nil,
          :trafficCoverage => float() | nil,
          :updated => DateTime.t() | nil,
          :variations => list(GoogleApi.Analytics.V3.Model.ExperimentVariations.t()) | nil,
          :webPropertyId => String.t() | nil,
          :winnerConfidenceLevel => float() | nil,
          :winnerFound => boolean() | nil
        }
