...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.Experiment do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"parentLink", :struct, GoogleApi.Analytics.V3.Model.Experiment_parentLink, options)
    |> deserialize(:"variations", :list, GoogleApi.Analytics.V3.Model.Experiment_variations, options)
  end
end
