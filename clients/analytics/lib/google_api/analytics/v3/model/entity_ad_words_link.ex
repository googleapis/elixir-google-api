...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.EntityAdWordsLink do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"adWordsAccounts", :list, GoogleApi.Analytics.V3.Model.AdWordsAccount, options)
    |> deserialize(:"entity", :struct, GoogleApi.Analytics.V3.Model.EntityAdWordsLink_entity, options)
  end
end
