...
defmodule GoogleApi.Analytics.V3.Model.CustomDataSourceChildLink do
  ...
  - href (String.t): Link to the list of daily uploads for this custom data source. Link to the list of uploads for this custom data source. Defaults to: `null`.
  - type (String.t): Value is \&quot;analytics#dailyUploads\&quot;. Value is \&quot;analytics#uploads\&quot;. Defaults to: `null`.
  """
