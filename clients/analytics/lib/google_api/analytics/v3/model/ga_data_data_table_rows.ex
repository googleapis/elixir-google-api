...
defmodule GoogleApi.Analytics.V3.Model.GaDataDataTableRows do
  ...
  - c ([GaDataDataTableC]):  Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :c => list(GoogleApi.Analytics.V3.Model.GaDataDataTableC.t())
        }

  field(:c, as: GoogleApi.Analytics.V3.Model.GaDataDataTableC, type: :list)
end
