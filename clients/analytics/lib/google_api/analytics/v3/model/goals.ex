...
defmodule GoogleApi.Analytics.V3.Model.Goals do
  ...
  - items ([Goal]): A list of goals. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this goal collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this goal collection. Defaults to: `null`.
