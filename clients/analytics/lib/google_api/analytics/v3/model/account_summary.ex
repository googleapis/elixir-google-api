...
defmodule GoogleApi.Analytics.V3.Model.AccountSummary do
  ...
  - kind (String.t): Resource type for Analytics AccountSummary. Defaults to: `null`.
  ...
  - webProperties ([WebPropertySummary]): List of web properties under this account. Defaults to: `null`.
  """
