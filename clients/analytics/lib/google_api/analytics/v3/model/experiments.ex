...
defmodule GoogleApi.Analytics.V3.Model.Experiments do
  ...
  - items ([Experiment]): A list of experiments. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this experiment collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this experiment collection. Defaults to: `null`.
