...
defmodule GoogleApi.Analytics.V3.Model.AccountSummaries do
  ...
  - items ([AccountSummary]): A list of AccountSummaries. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this AccountSummary collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this AccountSummary collection. Defaults to: `null`.
