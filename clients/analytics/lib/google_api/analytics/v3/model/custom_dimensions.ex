...
defmodule GoogleApi.Analytics.V3.Model.CustomDimensions do
  ...
  - items ([CustomDimension]): Collection of custom dimensions. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this custom dimension collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this custom dimension collection. Defaults to: `null`.
