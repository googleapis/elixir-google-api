...
defmodule GoogleApi.Analytics.V3.Model.CustomDimensions do
  ...
  - items (list(GoogleApi.Analytics.V3.Model.CustomDimension.t)): Collection of custom dimensions. Defaults to `nil`.
  ...
  - kind (String.t): Collection type. Defaults to `analytics#customDimensions`.
  - nextLink (String.t): Link to next page for this custom dimension collection. Defaults to `nil`.
  - previousLink (String.t): Link to previous page for this custom dimension collection. Defaults to `nil`.
