...
defmodule GoogleApi.Analytics.V3.Model.GaData do
  ...
  - columnHeaders (list(GoogleApi.Analytics.V3.Model.GaDataColumnHeaders.t)): Column headers that list dimension names followed by the metric names. The order of dimensions and metrics is same as specified in the request. Defaults to `nil`.
  - containsSampledData (boolean()): Determines if Analytics data contains samples. Defaults to `nil`.
  - dataLastRefreshed (String.t): The last refreshed time in seconds for Analytics data. Defaults to `nil`.
  - dataTable (GoogleApi.Analytics.V3.Model.GaDataDataTable.t):  Defaults to `nil`.
  ...
  - kind (String.t): Resource type. Defaults to `analytics#gaData`.
  ...
  - profileInfo (GoogleApi.Analytics.V3.Model.GaDataProfileInfo.t): Information for the view (profile), for which the Analytics data was requested. Defaults to `nil`.
  - query (GoogleApi.Analytics.V3.Model.GaDataQuery.t): Analytics data request query parameters. Defaults to `nil`.
  - rows (list(list(String.t))): Analytics data rows, where each row contains a list of dimension values followed by the metric values. The order of dimensions and metrics is same as specified in the request. Defaults to `nil`.
