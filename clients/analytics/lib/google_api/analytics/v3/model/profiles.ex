...
defmodule GoogleApi.Analytics.V3.Model.Profiles do
  @moduledoc """
  ...
  - items (list(GoogleApi.Analytics.V3.Model.Profile.t)): A list of views (profiles). Defaults to `nil`.
  ...
  - kind (String.t): Collection type. Defaults to `analytics#profiles`.
  - nextLink (String.t): Link to next page for this view (profile) collection. Defaults to `nil`.
  ...
  @type t :: %__MODULE__{
          :items => list(GoogleApi.Analytics.V3.Model.Profile.t()),
  ...
  field(:items, as: GoogleApi.Analytics.V3.Model.Profile, type: :list)
  field(:itemsPerPage)
  field(:kind)
  field(:nextLink)
  field(:previousLink)
...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.Profiles do
  def decode(value, options) do
    GoogleApi.Analytics.V3.Model.Profiles.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Analytics.V3.Model.Profiles do
