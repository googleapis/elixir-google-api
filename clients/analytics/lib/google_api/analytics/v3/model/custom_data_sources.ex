...
defmodule GoogleApi.Analytics.V3.Model.CustomDataSources do
  @moduledoc """
  ...
  - items ([CustomDataSource]): Collection of custom data sources. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this custom data source collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this custom data source collection. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :items => list(GoogleApi.Analytics.V3.Model.CustomDataSource.t()),
          :itemsPerPage => any(),
          :kind => any(),
          :nextLink => any(),
          :previousLink => any(),
  ...
  field(:items, as: GoogleApi.Analytics.V3.Model.CustomDataSource, type: :list)
  field(:itemsPerPage)
  field(:kind)
  field(:nextLink)
  field(:previousLink)
...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.CustomDataSources do
  def decode(value, options) do
    GoogleApi.Analytics.V3.Model.CustomDataSources.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Analytics.V3.Model.CustomDataSources do
