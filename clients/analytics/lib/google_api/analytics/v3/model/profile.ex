...
defmodule GoogleApi.Analytics.V3.Model.Profile do
  ...
  *   `websiteUrl` (*type:* `String.t`, *default:* `nil`) - Website URL for this view (profile).
  ...
  @type t :: %__MODULE__{
          ...
          :botFilteringEnabled => boolean() | nil,
          :childLink => GoogleApi.Analytics.V3.Model.ProfileChildLink.t() | nil,
          :created => DateTime.t() | nil,
          :currency => String.t() | nil,
          :defaultPage => String.t() | nil,
          :eCommerceTracking => boolean() | nil,
          :enhancedECommerceTracking => boolean() | nil,
          :excludeQueryParameters => String.t() | nil,
          :id => String.t() | nil,
          :internalWebPropertyId => String.t() | nil,
          :kind => String.t() | nil,
          :name => String.t() | nil,
          :parentLink => GoogleApi.Analytics.V3.Model.ProfileParentLink.t() | nil,
          :permissions => GoogleApi.Analytics.V3.Model.ProfilePermissions.t() | nil,
          :selfLink => String.t() | nil,
          :siteSearchCategoryParameters => String.t() | nil,
          :siteSearchQueryParameters => String.t() | nil,
          :starred => boolean() | nil,
          :stripSiteSearchCategoryParameters => boolean() | nil,
          :stripSiteSearchQueryParameters => boolean() | nil,
