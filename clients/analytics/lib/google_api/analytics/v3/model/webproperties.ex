...
defmodule GoogleApi.Analytics.V3.Model.Webproperties do
  ...
  - items (list(GoogleApi.Analytics.V3.Model.Webproperty.t)): A list of web properties. Defaults to `nil`.
  ...
  - kind (String.t): Collection type. Defaults to `analytics#webproperties`.
  - nextLink (String.t): Link to next page for this web property collection. Defaults to `nil`.
  - previousLink (String.t): Link to previous page for this web property collection. Defaults to `nil`.
