...
defmodule GoogleApi.Analytics.V3.Model.Webproperties do
  @moduledoc """
  ...
  *   `items` (*type:* `list(GoogleApi.Analytics.V3.Model.Webproperty.t)`, *default:* `nil`) - A list of web properties.
  ...
  *   `kind` (*type:* `String.t`, *default:* `analytics#webproperties`) - Collection type.
  *   `nextLink` (*type:* `String.t`, *default:* `nil`) - Link to next page for this web property collection.
  *   `previousLink` (*type:* `String.t`, *default:* `nil`) - Link to previous page for this web property collection.
  ...
  *   `username` (*type:* `String.t`, *default:* `nil`) - Email ID of the authenticated user
  ...
  @type t :: %__MODULE__{
          :items => list(GoogleApi.Analytics.V3.Model.Webproperty.t()) | nil,
  ...
  field(:items, as: GoogleApi.Analytics.V3.Model.Webproperty, type: :list)
  field(:itemsPerPage)
  field(:kind)
  field(:nextLink)
  field(:previousLink)
...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.Webproperties do
  def decode(value, options) do
    GoogleApi.Analytics.V3.Model.Webproperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Analytics.V3.Model.Webproperties do
