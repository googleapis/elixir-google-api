...
defmodule GoogleApi.Analytics.V3.Model.Webproperties do
  ...
  - items ([Webproperty]): A list of web properties. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this web property collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this web property collection. Defaults to: `null`.
