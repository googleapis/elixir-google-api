...
defmodule GoogleApi.Analytics.V3.Model.CustomMetrics do
  @moduledoc """
  ...
  - items (list(GoogleApi.Analytics.V3.Model.CustomMetric.t)): Collection of custom metrics. Defaults to `nil`.
  ...
  - kind (String.t): Collection type. Defaults to `analytics#customMetrics`.
  - nextLink (String.t): Link to next page for this custom metric collection. Defaults to `nil`.
  - previousLink (String.t): Link to previous page for this custom metric collection. Defaults to `nil`.
  ...
  @type t :: %__MODULE__{
          :items => list(GoogleApi.Analytics.V3.Model.CustomMetric.t()),
  ...
  field(:items, as: GoogleApi.Analytics.V3.Model.CustomMetric, type: :list)
  field(:itemsPerPage)
  field(:kind)
  field(:nextLink)
  field(:previousLink)
...
defimpl Poison.Decoder, for: GoogleApi.Analytics.V3.Model.CustomMetrics do
  def decode(value, options) do
    GoogleApi.Analytics.V3.Model.CustomMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Analytics.V3.Model.CustomMetrics do
