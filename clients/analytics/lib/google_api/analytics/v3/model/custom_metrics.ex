...
defmodule GoogleApi.Analytics.V3.Model.CustomMetrics do
  ...
  - items ([CustomMetric]): Collection of custom metrics. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this custom metric collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this custom metric collection. Defaults to: `null`.
