...
defmodule GoogleApi.Analytics.V3.Model.Columns do
  ...
  - attributeNames ([String.t]): List of attributes names returned by columns. Defaults to: `null`.
  - etag (String.t): Etag of collection. This etag can be compared with the last response etag to check if response has changed. Defaults to: `null`.
  - items ([Column]): List of columns for a report type. Defaults to: `null`.
  - kind (String.t): Collection type. Defaults to: `null`.
  - totalResults (integer()): Total number of columns returned in the response. Defaults to: `null`.
  """
