...
defmodule GoogleApi.Analytics.V3.Model.UnsampledReports do
  ...
  *   `items` (*type:* `list(GoogleApi.Analytics.V3.Model.UnsampledReport.t)`, *default:* `nil`) - A list of unsampled reports.
  ...
  *   `kind` (*type:* `String.t`, *default:* `analytics#unsampledReports`) - Collection type.
  *   `nextLink` (*type:* `String.t`, *default:* `nil`) - Link to next page for this unsampled report collection.
  *   `previousLink` (*type:* `String.t`, *default:* `nil`) - Link to previous page for this unsampled report collection.
  ...
  *   `username` (*type:* `String.t`, *default:* `nil`) - Email ID of the authenticated user
  ...
  @type t :: %__MODULE__{
          :items => list(GoogleApi.Analytics.V3.Model.UnsampledReport.t()) | nil,
