...
defmodule GoogleApi.Analytics.V3.Model.Uploads do
  ...
  - items (list(GoogleApi.Analytics.V3.Model.Upload.t)): A list of uploads. Defaults to `nil`.
  ...
  - kind (String.t): Collection type. Defaults to `analytics#uploads`.
  - nextLink (String.t): Link to next page for this upload collection. Defaults to `nil`.
  - previousLink (String.t): Link to previous page for this upload collection. Defaults to `nil`.
