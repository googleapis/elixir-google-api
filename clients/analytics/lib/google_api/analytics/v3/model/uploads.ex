...
defmodule GoogleApi.Analytics.V3.Model.Uploads do
  ...
  - items ([Upload]): A list of uploads. Defaults to: `null`.
  ...
  - nextLink (String.t): Link to next page for this upload collection. Defaults to: `null`.
  - previousLink (String.t): Link to previous page for this upload collection. Defaults to: `null`.
