...
defmodule GoogleApi.CloudUserAccounts.Vm_alpha.Model.GroupsRemoveMemberRequest do
  ...
  - users (List[String]): Fully-qualified URLs of the User resources to remove. Defaults to: `null`.
  """
...
defimpl Poison.Encoder, for: GoogleApi.CloudUserAccounts.Vm_alpha.Model.GroupsRemoveMemberRequest do
