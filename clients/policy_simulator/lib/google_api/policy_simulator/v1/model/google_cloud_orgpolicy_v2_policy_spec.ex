...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpec do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The time stamp this was previously updated. This represents the last time a call to `CreatePolicy` or `UpdatePolicy` was made for that policy.
  ...
  @type t :: %__MODULE__{
          ...
          :rules =>
            list(
              GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpecPolicyRule.t()
            )
            | nil,
  ...
  field(:rules,
    as: GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpecPolicyRule,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpec do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpec do
