...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1Replay do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The current state of the `Replay`.
  ...
  field(:config,
    as: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1ReplayConfig
  )

  field(:name)

  field(:resultsSummary,
    as: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1Replay do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1Replay.decode(
      value,
      options
    )
  end
