...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary.decode(
      value,
      options
    )
  end
