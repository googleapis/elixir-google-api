...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlay do
  @moduledoc """
  ...
  *   `policies` (*type:* `list(GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay.t)`, *default:* `nil`) - Optional. The OrgPolicy changes to preview violations for. Any existing OrgPolicies with the same name will be overridden in the simulation. That is, violations will be determined as if all policies in the overlay were created or updated.
  ...
  @type t :: %__MODULE__{
          :customConstraints =>
            list(
              GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayCustomConstraintOverlay.t()
            )
            | nil,
          :policies =>
            list(
              GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayPolicyOverlay.t()
            )
            | nil
        }
  ...
  field(:customConstraints,
    as:
      GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayCustomConstraintOverlay,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlay do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlay.decode(
      value,
      options
    )
  end
