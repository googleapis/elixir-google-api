...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayCustomConstraintOverlay do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayCustomConstraintOverlay do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1alphaOrgPolicyOverlayCustomConstraintOverlay.decode(
      value,
      options
    )
  end
