...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts.decode(
      value,
      options
    )
  end
