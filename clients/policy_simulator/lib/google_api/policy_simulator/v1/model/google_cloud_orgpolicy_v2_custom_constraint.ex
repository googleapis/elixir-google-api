...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2CustomConstraint do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2CustomConstraint do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2CustomConstraint.decode(
      value,
      options
    )
  end
