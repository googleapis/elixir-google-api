...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues.decode(
      value,
      options
    )
  end
