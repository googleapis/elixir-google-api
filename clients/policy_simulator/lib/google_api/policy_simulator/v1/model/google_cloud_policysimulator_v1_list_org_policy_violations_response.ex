...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse do
  @moduledoc """
  ...
  *   `orgPolicyViolations` (*type:* `list(GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1OrgPolicyViolation.t)`, *default:* `nil`) - The list of OrgPolicyViolations
  ...
  field(:orgPolicyViolations,
    as: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1OrgPolicyViolation,
    type: :list
  )
end
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse.decode(
      value,
      options
    )
  end
