...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview do
  @moduledoc """
  ...
  *   `overlay` (*type:* `GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay.t`, *default:* `nil`) - Required. The proposed changes we are previewing violations for.
  *   `resourceCounts` (*type:* `GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts.t`, *default:* `nil`) - Output only. A summary of the state of all resources scanned for compliance with the changed OrgPolicy.
  ...
  *   `violationsCount` (*type:* `integer()`, *default:* `nil`) - Output only. The number of OrgPolicyViolations in this `OrgPolicyViolationsPreview`. This count may differ from `resource_summary.noncompliant_count` because each OrgPolicyViolation is specific to a resource **and** constraint. If there are multiple constraints being evaluated (i.e. multiple policies in the overlay), a single resource may violate multiple constraints.
  ...
  @type t :: %__MODULE__{
          ...
          :name => String.t() | nil,
          :overlay =>
            GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay.t()
            | nil,
          :resourceCounts =>
            GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts.t()
            | nil,
          :state => String.t() | nil,
  ...
  field(:overlay,
    as: GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview.decode(
      value,
      options
    )
  end
