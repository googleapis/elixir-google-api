...
defmodule GoogleApi.PolicySimulator.V1.Model.GoogleIamV1Binding do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.PolicySimulator.V1.Model.GoogleIamV1Binding do
  def decode(value, options) do
    GoogleApi.PolicySimulator.V1.Model.GoogleIamV1Binding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PolicySimulator.V1.Model.GoogleIamV1Binding do
