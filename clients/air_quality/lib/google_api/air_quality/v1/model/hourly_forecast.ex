...
defmodule GoogleApi.AirQuality.V1.Model.HourlyForecast do
  @moduledoc """
  ...
  *   `dateTime` (*type:* `DateTime.t`, *default:* `nil`) - A rounded down timestamp indicating the time (hour) the data refers to in RFC3339 UTC "Zulu" format. For example: "2014-10-02T15:00:00Z".
...
defimpl Poison.Decoder, for: GoogleApi.AirQuality.V1.Model.HourlyForecast do
  def decode(value, options) do
    GoogleApi.AirQuality.V1.Model.HourlyForecast.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AirQuality.V1.Model.HourlyForecast do
