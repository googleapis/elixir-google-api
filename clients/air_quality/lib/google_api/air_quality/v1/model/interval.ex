...
defmodule GoogleApi.AirQuality.V1.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AirQuality.V1.Model.Interval do
  def decode(value, options) do
    GoogleApi.AirQuality.V1.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AirQuality.V1.Model.Interval do
