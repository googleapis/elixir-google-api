...
defmodule GoogleApi.Chat.V1.Model.GoogleAppsCardV1SelectionInput do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name that identifies the selection input in a form input event. For details about working with form inputs, see [Receive form data](https://developers.google.com/workspace/chat/read-form-data).
