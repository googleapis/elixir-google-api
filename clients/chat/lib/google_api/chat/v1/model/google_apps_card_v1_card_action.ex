...
defmodule GoogleApi.Chat.V1.Model.GoogleAppsCardV1CardAction do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Chat.V1.Model.GoogleAppsCardV1CardAction do
  def decode(value, options) do
    GoogleApi.Chat.V1.Model.GoogleAppsCardV1CardAction.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Chat.V1.Model.GoogleAppsCardV1CardAction do
