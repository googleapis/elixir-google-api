...
defmodule GoogleApi.Chat.V1.Model.GoogleAppsCardV1ImageComponent do
  ...
  *   `imageUri` (*type:* `String.t`, *default:* `nil`) - The image URL.
  ...
  field(:cropStyle, as: GoogleApi.Chat.V1.Model.GoogleAppsCardV1ImageCropStyle)
  field(:imageUri)
end

defimpl Poison.Decoder, for: GoogleApi.Chat.V1.Model.GoogleAppsCardV1ImageComponent do
  def decode(value, options) do
    GoogleApi.Chat.V1.Model.GoogleAppsCardV1ImageComponent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Chat.V1.Model.GoogleAppsCardV1ImageComponent do
