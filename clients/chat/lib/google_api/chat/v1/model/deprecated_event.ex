...
defmodule GoogleApi.Chat.V1.Model.DeprecatedEvent do
  ...
  - eventTime (DateTime.t): The timestamp indicating when the event was dispatched. Defaults to `nil`.
  - message (GoogleApi.Chat.V1.Model.Message.t): The message that triggered the event, if applicable. Defaults to `nil`.
  - space (GoogleApi.Chat.V1.Model.Space.t): The room or DM in which the event occurred. Defaults to `nil`.
  - threadKey (String.t): The bot-defined key for the thread related to the event. See the
  thread_key field of the
  `spaces.message.create` request for more information. Defaults to `nil`.
  ...
  Developers can revoke/regenerate it if needed from the same page. Defaults to `nil`.
  - type (String.t): The type of the event. Defaults to `nil`.
  - user (GoogleApi.Chat.V1.Model.User.t): The user that triggered the event. Defaults to `nil`.
  """
