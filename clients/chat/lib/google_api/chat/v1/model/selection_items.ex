...
defmodule GoogleApi.Chat.V1.Model.SelectionItems do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Chat.V1.Model.SelectionItems do
  def decode(value, options) do
    GoogleApi.Chat.V1.Model.SelectionItems.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Chat.V1.Model.SelectionItems do
