...
defmodule GoogleApi.Chat.V1.Model.ListSpacesResponse do
  ...
  - nextPageToken (String.t): Continuation token to retrieve the next page of results. It will be empty for the last page of results. Tokens expire in an hour. An error is thrown if an expired token is passed. Defaults to: `null`.
  - spaces ([Space]): List of spaces in the requested (or first) page. Defaults to: `null`.
  """
