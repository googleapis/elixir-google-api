...
defmodule GoogleApi.Chat.V1.Api.Users do
  ...
  *   `{:ok, %GoogleApi.Chat.V1.Model.SpaceNotificationSetting{}}` on success
  *   `{:error, info}` on failure
  """
  @spec chat_users_spaces_space_notification_setting_get(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Chat.V1.Model.SpaceNotificationSetting.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def chat_users_spaces_space_notification_setting_get(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.Chat.V1.Model.SpaceNotificationSetting{}])
  end
  ...
  *   `connection` (*type:* `GoogleApi.Chat.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Identifier. The resource name of the space notification setting. Format: `users/{user}/spaces/{space}/spaceNotificationSetting`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:updateMask` (*type:* `String.t`) - Required. Supported field paths: - `notification_setting` - `mute_setting`
      *   `:body` (*type:* `GoogleApi.Chat.V1.Model.SpaceNotificationSetting.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  """
  @spec chat_users_spaces_space_notification_setting_patch(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def chat_users_spaces_space_notification_setting_patch(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
