...
defmodule GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponse do
  @moduledoc """
  ...
  *   `totalCount` (*type:* `integer()`, *default:* `nil`) - Output only. Total number of examples requested to export
  ...
  field(:labelStats,
    as: GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1p1alpha1LabelStats
  )

  field(:outputConfig,
    as: GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1p1alpha1OutputConfig
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponse do
  def decode(value, options) do
    GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1p1alpha1ExportDataOperationResponse.decode(
      value,
      options
    )
  end
