...
defmodule GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1beta1VideoObjectTrackingAnnotation do
  @moduledoc """
  ...
  *   `timeSegment` (*type:* `GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1beta1TimeSegment.t`, *default:* `nil`) - The time segment of the video to which object tracking applies.
  ...
  field(:objectTrackingFrames,
    as: GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1beta1ObjectTrackingFrame,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1beta1VideoObjectTrackingAnnotation do
  def decode(value, options) do
    GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1beta1VideoObjectTrackingAnnotation.decode(
      value,
      options
    )
  end
