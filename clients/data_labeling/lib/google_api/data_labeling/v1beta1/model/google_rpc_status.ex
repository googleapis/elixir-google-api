...
defmodule GoogleApi.DataLabeling.V1beta1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataLabeling.V1beta1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.DataLabeling.V1beta1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataLabeling.V1beta1.Model.GoogleRpcStatus do
