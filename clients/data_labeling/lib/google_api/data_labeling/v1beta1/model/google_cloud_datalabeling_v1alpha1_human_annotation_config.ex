...
defmodule GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1alpha1HumanAnnotationConfig do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1alpha1HumanAnnotationConfig do
  def decode(value, options) do
    GoogleApi.DataLabeling.V1beta1.Model.GoogleCloudDatalabelingV1alpha1HumanAnnotationConfig.decode(
      value,
      options
    )
  end
