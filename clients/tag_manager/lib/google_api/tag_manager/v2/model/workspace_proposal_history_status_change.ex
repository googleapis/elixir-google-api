...
defmodule GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryStatusChange do
  ...
  - newStatus (String.t): The new proposal status after that status change. Defaults to: `null`.
    - Enum - one of [approved, cancelled, completed, requested, reviewed, statusUnspecified]
  - oldStatus (String.t): The old proposal status before the status change. Defaults to: `null`.
    - Enum - one of [approved, cancelled, completed, requested, reviewed, statusUnspecified]
  """
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryStatusChange do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryStatusChange.decode(value, options)
  end
end
