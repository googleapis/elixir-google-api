...
defmodule GoogleApi.TagManager.V2.Model.ListAccountsResponse do
  ...
  *   `account` (*type:* `list(GoogleApi.TagManager.V2.Model.Account.t)`, *default:* `nil`) - List of GTM Accounts that a user has access to.
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.ListAccountsResponse do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.ListAccountsResponse.decode(value, options)
  end
end
