...
defmodule GoogleApi.TagManager.V2.Model.RevertTransformationResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.RevertTransformationResponse do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.RevertTransformationResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TagManager.V2.Model.RevertTransformationResponse do
