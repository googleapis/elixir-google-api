...
defmodule GoogleApi.TagManager.V2.Model.FolderEntities do
  ...
  - tag (list(GoogleApi.TagManager.V2.Model.Tag.t)): The list of tags inside the folder. Defaults to `nil`.
  - trigger (list(GoogleApi.TagManager.V2.Model.Trigger.t)): The list of triggers inside the folder. Defaults to `nil`.
  - variable (list(GoogleApi.TagManager.V2.Model.Variable.t)): The list of variables inside the folder. Defaults to `nil`.
  """
