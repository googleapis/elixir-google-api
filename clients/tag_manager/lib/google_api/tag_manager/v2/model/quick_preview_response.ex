...
defmodule GoogleApi.TagManager.V2.Model.QuickPreviewResponse do
  ...
  - compilerError (boolean()): Were there compiler errors or not. Defaults to `nil`.
  - containerVersion (GoogleApi.TagManager.V2.Model.ContainerVersion.t): The quick previewed container version. Defaults to `nil`.
  - syncStatus (GoogleApi.TagManager.V2.Model.SyncStatus.t): Whether quick previewing failed when syncing the workspace to the latest container version. Defaults to `nil`.
  """
