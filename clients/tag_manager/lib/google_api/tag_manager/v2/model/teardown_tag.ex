...
defmodule GoogleApi.TagManager.V2.Model.TeardownTag do
  ...
  - stopTeardownOnFailure (boolean()): If true, fire the teardown tag if and only if the main tag fires successfully. If false, fire the teardown tag regardless of main tag firing status. Defaults to `nil`.
  - tagName (String.t): The name of the teardown tag. Defaults to `nil`.
  """
