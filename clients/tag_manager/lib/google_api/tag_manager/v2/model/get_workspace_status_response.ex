...
defmodule GoogleApi.TagManager.V2.Model.GetWorkspaceStatusResponse do
  ...
  - mergeConflict ([MergeConflict]): The merge conflict after sync. Defaults to: `null`.
  - workspaceChange ([Entity]): Entities that have been changed in the workspace. Defaults to: `null`.
  """
