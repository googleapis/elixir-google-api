...
defmodule GoogleApi.TagManager.V2.Model.Folder do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Folder display name. @mutable tagmanager.accounts.containers.workspaces.folders.create @mutable tagmanager.accounts.containers.workspaces.folders.update
  *   `notes` (*type:* `String.t`, *default:* `nil`) - User notes on how to apply this folder in the container. @mutable tagmanager.accounts.containers.workspaces.folders.create @mutable tagmanager.accounts.containers.workspaces.folders.update
