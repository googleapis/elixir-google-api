...
defmodule GoogleApi.TagManager.V2.Model.ZoneTypeRestriction do
  ...
  - enable (boolean()): True if type restrictions have been enabled for this Zone. Defaults to `nil`.
  - whitelistedTypeId (list(String.t)): List of type public ids that have been whitelisted for use in this Zone. Defaults to `nil`.
  """
