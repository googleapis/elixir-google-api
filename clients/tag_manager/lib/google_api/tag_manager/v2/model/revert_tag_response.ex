...
defmodule GoogleApi.TagManager.V2.Model.RevertTagResponse do
  ...
  - tag (GoogleApi.TagManager.V2.Model.Tag.t): Tag as it appears in the latest container version since the last workspace synchronization operation. If no tag is present, that means the tag was deleted in the latest container version. Defaults to `nil`.
  """
