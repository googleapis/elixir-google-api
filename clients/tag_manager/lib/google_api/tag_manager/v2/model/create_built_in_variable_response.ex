...
defmodule GoogleApi.TagManager.V2.Model.CreateBuiltInVariableResponse do
  ...
  - builtInVariable (list(GoogleApi.TagManager.V2.Model.BuiltInVariable.t)): List of created built-in variables. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.CreateBuiltInVariableResponse do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.CreateBuiltInVariableResponse.decode(value, options)
  end
end
