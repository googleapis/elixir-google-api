...
defmodule GoogleApi.TagManager.V2.Model.ListContainersResponse do
  ...
  *   `container` (*type:* `list(GoogleApi.TagManager.V2.Model.Container.t)`, *default:* `nil`) - All Containers of a GTM Account.
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.ListContainersResponse do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.ListContainersResponse.decode(value, options)
  end
end
