...
defmodule GoogleApi.TagManager.V2.Model.Condition do
  ...
  - parameter (list(GoogleApi.TagManager.V2.Model.Parameter.t)): A list of named parameters (key/value), depending on the condition's type. Notes: 
  ...
  - To negate an operator, include a boolean parameter named negate boolean parameter that is set to true. Defaults to `nil`.
  - type (String.t): The type of operator for this condition. Defaults to `nil`.
  """
