...
defmodule GoogleApi.TagManager.V2.Model.Account do
  ...
  *   `fingerprint` (*type:* `String.t`, *default:* `nil`) - The fingerprint of the GTM Account as computed at storage time.
  ...
  *   `shareData` (*type:* `boolean()`, *default:* `nil`) - Whether the account shares data anonymously with Google and others.
