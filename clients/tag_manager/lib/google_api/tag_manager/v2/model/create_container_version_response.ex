...
defmodule GoogleApi.TagManager.V2.Model.CreateContainerVersionResponse do
  ...
  - compilerError (boolean()): Compiler errors or not. Defaults to `nil`.
  - containerVersion (GoogleApi.TagManager.V2.Model.ContainerVersion.t): The container version created. Defaults to `nil`.
  - newWorkspacePath (String.t): Auto generated workspace path created as a result of version creation. This field should only be populated if the created version was not a quick preview. Defaults to `nil`.
  - syncStatus (GoogleApi.TagManager.V2.Model.SyncStatus.t): Whether version creation failed when syncing the workspace to the latest container version. Defaults to `nil`.
  """
