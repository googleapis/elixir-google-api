...
defmodule GoogleApi.TagManager.V2.Model.ZoneBoundary do
  ...
  - condition (list(GoogleApi.TagManager.V2.Model.Condition.t)): The conditions that, when conjoined, make up the boundary. Defaults to `nil`.
  - customEvaluationTriggerId (list(String.t)): Custom evaluation trigger IDs. A zone will evaluate its boundary conditions when any of the listed triggers are true. Defaults to `nil`.
  """
