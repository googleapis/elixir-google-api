...
defmodule GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryComment do
  ...
  - content (String.t): The contents of the reviewer or author comment. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryComment do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.WorkspaceProposalHistoryComment.decode(value, options)
  end
end
