...
defmodule GoogleApi.TagManager.V2.Model.ListFoldersResponse do
  ...
  *   `folder` (*type:* `list(GoogleApi.TagManager.V2.Model.Folder.t)`, *default:* `nil`) - All GTM Folders of a GTM Container.
...
defimpl Poison.Decoder, for: GoogleApi.TagManager.V2.Model.ListFoldersResponse do
  def decode(value, options) do
    GoogleApi.TagManager.V2.Model.ListFoldersResponse.decode(value, options)
  end
end
