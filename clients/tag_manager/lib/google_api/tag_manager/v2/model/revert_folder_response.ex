...
defmodule GoogleApi.TagManager.V2.Model.RevertFolderResponse do
  ...
  - folder (GoogleApi.TagManager.V2.Model.Folder.t): Folder as it appears in the latest container version since the last workspace synchronization operation. If no folder is present, that means the folder was deleted in the latest container version. Defaults to `nil`.
  """
