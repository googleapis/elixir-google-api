...
defmodule GoogleApi.TagManager.V2.Model.SyncWorkspaceResponse do
  ...
  - mergeConflict (list(GoogleApi.TagManager.V2.Model.MergeConflict.t)): The merge conflict after sync. If this field is not empty, the sync is still treated as successful. But a version cannot be created until all conflicts are resolved. Defaults to `nil`.
  - syncStatus (GoogleApi.TagManager.V2.Model.SyncStatus.t): Indicates whether synchronization caused a merge conflict or sync error. Defaults to `nil`.
  """
