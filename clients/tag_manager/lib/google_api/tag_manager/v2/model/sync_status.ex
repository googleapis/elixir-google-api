...
defmodule GoogleApi.TagManager.V2.Model.SyncStatus do
  ...
  - mergeConflict (boolean()): Synchornization operation detected a merge conflict. Defaults to `nil`.
  - syncError (boolean()): An error occurred during the synchronization operation. Defaults to `nil`.
  """
