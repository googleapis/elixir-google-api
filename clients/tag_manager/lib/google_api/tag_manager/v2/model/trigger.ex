...
defmodule GoogleApi.TagManager.V2.Model.Trigger do
  ...
  *   `checkValidation` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Whether or not we should only fire tags if the form submit or link click
      event is not cancelled by some other event handler (e.g. because of
      validation). Only valid for Form Submission and Link Click triggers.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `containerId` (*type:* `String.t`, *default:* `nil`) - GTM Container ID.
  *   `continuousTimeMinMilliseconds` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A visibility trigger minimum continuous visible time (in milliseconds).
      Only valid for AMP Visibility trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `customEventFilter` (*type:* `list(GoogleApi.TagManager.V2.Model.Condition.t)`, *default:* `nil`) - Used in the case of custom event, which is fired iff all Conditions are
      true.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  ...
  *   `filter` (*type:* `list(GoogleApi.TagManager.V2.Model.Condition.t)`, *default:* `nil`) - The trigger will only fire iff all Conditions are true.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `fingerprint` (*type:* `String.t`, *default:* `nil`) - The fingerprint of the GTM Trigger as computed at storage time.
      This value is recomputed whenever the trigger is modified.
  *   `horizontalScrollPercentageList` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - List of integer percentage values for scroll triggers. The trigger will
      fire when each percentage is reached when the view is scrolled
      horizontally. Only valid for AMP scroll triggers.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `interval` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Time between triggering recurring Timer Events (in milliseconds). Only
      valid for Timer triggers.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `intervalSeconds` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Time between Timer Events to fire (in seconds). Only valid for AMP Timer
      trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `limit` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Limit of the number of GTM events this Timer Trigger will fire. If no limit
      is set, we will continue to fire GTM events until the user leaves the page.
      Only valid for Timer triggers.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `maxTimerLengthSeconds` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Max time to fire Timer Events (in seconds). Only valid for AMP Timer
      trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  ...
  *   `selector` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A click trigger CSS selector (i.e. "a", "button" etc.). Only valid for AMP
      Click trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `tagManagerUrl` (*type:* `String.t`, *default:* `nil`) - Auto generated link to the tag manager UI
  *   `totalTimeMinMilliseconds` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A visibility trigger minimum total visible time (in milliseconds).
      Only valid for AMP Visibility trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Defines the data layer event that causes this trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `uniqueTriggerId` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Globally unique id of the trigger that auto-generates this (a Form Submit,
      ...
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `verticalScrollPercentageList` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - List of integer percentage values for scroll triggers. The trigger will
      fire when each percentage is reached when the view is scrolled vertically.
      Only valid for AMP scroll triggers.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `visibilitySelector` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A visibility trigger CSS selector (i.e. "#id"). Only valid for AMP
      Visibility trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `visiblePercentageMax` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A visibility trigger maximum percent visibility. Only valid for AMP
      Visibility trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `visiblePercentageMin` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - A visibility trigger minimum percent visibility. Only valid for AMP
      Visibility trigger.
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `waitForTags` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - Whether or not we should delay the form submissions or link opening
      ...
      @mutable tagmanager.accounts.containers.workspaces.triggers.create
      @mutable tagmanager.accounts.containers.workspaces.triggers.update
  *   `waitForTagsTimeout` (*type:* `GoogleApi.TagManager.V2.Model.Parameter.t`, *default:* `nil`) - How long to wait (in milliseconds) for tags to fire when 'waits_for_tags'
