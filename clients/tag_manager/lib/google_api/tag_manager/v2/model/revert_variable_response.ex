...
defmodule GoogleApi.TagManager.V2.Model.RevertVariableResponse do
  ...
  - variable (GoogleApi.TagManager.V2.Model.Variable.t): Variable as it appears in the latest container version since the last workspace synchronization operation. If no variable is present, that means the variable was deleted in the latest container version. Defaults to `nil`.
  """
