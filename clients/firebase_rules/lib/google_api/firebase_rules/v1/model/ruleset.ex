...
defmodule GoogleApi.FirebaseRules.V1.Model.Ruleset do
  ...
  *   `createTime` (*type:* `DateTime.t`, *default:* `nil`) - Time the `Ruleset` was created. Output only.
  *   `metadata` (*type:* `GoogleApi.FirebaseRules.V1.Model.Metadata.t`, *default:* `nil`) - The metadata for this ruleset. Output only.
  *   `name` (*type:* `String.t`, *default:* `nil`) - Name of the `Ruleset`. The ruleset_id is auto generated by the service. Format: `projects/{project_id}/rulesets/{ruleset_id}` Output only.
