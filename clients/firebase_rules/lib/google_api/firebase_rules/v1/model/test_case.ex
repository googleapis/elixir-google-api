...
defmodule GoogleApi.FirebaseRules.V1.Model.TestCase do
  ...
  - expectation (String.t): Test expectation. Defaults to `nil`.
  - functionMocks (list(GoogleApi.FirebaseRules.V1.Model.FunctionMock.t)): Optional function mocks for service-defined functions. If not set, any
  service defined function is expected to return an error, which may or may
  not influence the test outcome. Defaults to `nil`.
  - request (any()): Request context.
  ...
  be rejected as an invalid argument. Defaults to `nil`.
  - resource (any()): Optional resource value as it appears in persistent storage before the
  request is fulfilled.

  The resource type depends on the `request.path` value. Defaults to `nil`.
  """
