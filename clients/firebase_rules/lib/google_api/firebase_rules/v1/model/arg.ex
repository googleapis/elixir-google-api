...
defmodule GoogleApi.FirebaseRules.V1.Model.Arg do
  ...
  - anyValue (GoogleApi.FirebaseRules.V1.Model.Empty.t): Argument matches any value provided. Defaults to `nil`.
  - exactValue (any()): Argument exactly matches value provided. Defaults to `nil`.
  """
