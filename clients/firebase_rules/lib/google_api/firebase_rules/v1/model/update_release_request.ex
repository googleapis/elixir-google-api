...
defmodule GoogleApi.FirebaseRules.V1.Model.UpdateReleaseRequest do
  ...
  - release (GoogleApi.FirebaseRules.V1.Model.Release.t): `Release` to update. Defaults to `nil`.
  - updateMask (String.t): Specifies which fields to update. Defaults to `nil`.
  """
