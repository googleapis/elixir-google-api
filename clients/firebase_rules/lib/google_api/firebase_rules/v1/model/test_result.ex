...
defmodule GoogleApi.FirebaseRules.V1.Model.TestResult do
  ...
  - debugMessages (list(String.t)): Debug messages related to test execution issues encountered during
  evaluation.

  Debug messages may be related to too many or too few invocations of
  function mocks or to runtime errors that occur during evaluation.

  For example: ```Unable to read variable [name: "resource"]``` Defaults to `nil`.
  - errorPosition (GoogleApi.FirebaseRules.V1.Model.SourcePosition.t): Position in the `Source` or `Ruleset` where the principle runtime error
  occurs.
  ...
  E.g. `error_position { line: 19 column: 37 }` Defaults to `nil`.
  - functionCalls (list(GoogleApi.FirebaseRules.V1.Model.FunctionCall.t)): The set of function calls made to service-defined methods.

  Function calls are included in the order in which they are encountered
  during evaluation, are provided for both mocked and unmocked functions,
  and included on the response regardless of the test `state`. Defaults to `nil`.
  - state (String.t): State of the test. Defaults to `nil`.
  - visitedExpressions (list(GoogleApi.FirebaseRules.V1.Model.VisitedExpression.t)): The set of visited permission expressions for a given test. This returns
  ...
  `expression_reports` field Defaults to `nil`.
  """
