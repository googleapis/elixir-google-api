...
defmodule GoogleApi.FirebaseRules.V1.Model.SourcePosition do
  ...
  - column (integer()): First column on the source line associated with the source fragment. Defaults to `nil`.
  - fileName (String.t): Name of the `File`. Defaults to `nil`.
  - line (integer()): Line number of the source fragment. 1-based. Defaults to `nil`.
  """
