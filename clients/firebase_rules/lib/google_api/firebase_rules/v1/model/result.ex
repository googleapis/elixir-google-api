...
defmodule GoogleApi.FirebaseRules.V1.Model.Result do
  ...
  - undefined (GoogleApi.FirebaseRules.V1.Model.Empty.t): The result is undefined, meaning the result could not be computed. Defaults to `nil`.
  - value (any()): The result is an actual value. The type of the value must match that
  of the type declared by the service. Defaults to `nil`.
  """
