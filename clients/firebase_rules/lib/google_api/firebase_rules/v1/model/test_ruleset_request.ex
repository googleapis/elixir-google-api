...
defmodule GoogleApi.FirebaseRules.V1.Model.TestRulesetRequest do
  ...
  - source (GoogleApi.FirebaseRules.V1.Model.Source.t): Optional `Source` to be checked for correctness.

  This field must not be set when the resource name refers to a `Ruleset`. Defaults to `nil`.
  - testSuite (GoogleApi.FirebaseRules.V1.Model.TestSuite.t): Inline `TestSuite` to run. Defaults to `nil`.
  """
