...
defmodule GoogleApi.FirebaseRules.V1.Model.FunctionMock do
  ...
  *   `args` (*type:* `list(GoogleApi.FirebaseRules.V1.Model.Arg.t)`, *default:* `nil`) - The list of `Arg` values to match. The order in which the arguments are
      provided is the order in which they must appear in the function
      invocation.
  *   `function` (*type:* `String.t`, *default:* `nil`) - The name of the function.
