...
defmodule GoogleApi.Vision.V1.Api.Files do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.Vision.V1.Model.BatchAnnotateFilesRequest.t): 
  ...
  """
  @spec vision_files_annotate(Tesla.Env.client(), keyword()) ::
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.Vision.V1.Model.AsyncBatchAnnotateFilesRequest.t): 
  ...
  {:error, info} on failure
  """
  @spec vision_files_async_batch_annotate(Tesla.Env.client(), keyword()) ::
