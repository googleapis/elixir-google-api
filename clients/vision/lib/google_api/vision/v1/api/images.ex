...
defmodule GoogleApi.Vision.V1.Api.Images do
  ...
  import GoogleApi.Vision.V1.RequestBuilder
  ...
  """
  @spec vision_images_annotate(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Vision.V1.Model.BatchAnnotateImagesResponse.t} | {:error, Tesla.Env.t}
  def vision_images_annotate(connection, opts \\ []) do
    optional_params = %{
      :"bearer_token" => :query,
      :"oauth_token" => :query,
    ...
    |> decode(%GoogleApi.Vision.V1.Model.BatchAnnotateImagesResponse{})
  end
end
