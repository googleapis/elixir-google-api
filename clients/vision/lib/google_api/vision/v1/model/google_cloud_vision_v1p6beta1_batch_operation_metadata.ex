...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BatchOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BatchOperationMetadata do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BatchOperationMetadata.decode(
      value,
      options
    )
  end
