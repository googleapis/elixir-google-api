...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1AnnotateImageResponse do
  ...
  - context (GoogleCloudVisionV1p2beta1ImageAnnotationContext): If present, contextual information is needed to understand where this image comes from. Defaults to: `null`.
  - cropHintsAnnotation (GoogleCloudVisionV1p2beta1CropHintsAnnotation): If present, crop hints have completed successfully. Defaults to: `null`.
  ...
  - faceAnnotations ([GoogleCloudVisionV1p2beta1FaceAnnotation]): If present, face detection has completed successfully. Defaults to: `null`.
  - fullTextAnnotation (GoogleCloudVisionV1p2beta1TextAnnotation): If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text. Defaults to: `null`.
