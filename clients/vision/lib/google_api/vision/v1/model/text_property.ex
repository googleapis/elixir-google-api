...
defmodule GoogleApi.Vision.V1.Model.TextProperty do
  ...
  - detectedBreak (DetectedBreak): Detected start or end of a text segment. Defaults to: `null`.
  - detectedLanguages ([DetectedLanguage]): A list of detected languages together with confidence. Defaults to: `null`.
  """
