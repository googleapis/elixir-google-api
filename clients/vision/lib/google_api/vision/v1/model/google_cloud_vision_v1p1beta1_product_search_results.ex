...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ProductSearchResults do
  ...
  - productGroupedResults (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult.t)): List of results grouped by products detected in the query image. Each entry
  corresponds to one bounding polygon in the query image, and contains the
  matching products specific to that region. There may be duplicate product
  matches in the union of all the per-product results. Defaults to `nil`.
  - results (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ProductSearchResultsResult.t)): List of results, one for each product match. Defaults to `nil`.
  """
