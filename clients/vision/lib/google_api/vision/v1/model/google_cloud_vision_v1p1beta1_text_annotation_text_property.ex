...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty do
  ...
  - detectedBreak (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak.t): Detected start or end of a text segment. Defaults to `nil`.
  - detectedLanguages (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage.t)): A list of detected languages together with confidence. Defaults to `nil`.
  """
