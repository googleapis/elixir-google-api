...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty do
  ...
  *   `detectedBreak` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak.t`, *default:* `nil`) - Detected start or end of a text segment.
  *   `detectedLanguages` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationDetectedLanguage.t)`, *default:* `nil`) - A list of detected languages together with confidence.
  """
