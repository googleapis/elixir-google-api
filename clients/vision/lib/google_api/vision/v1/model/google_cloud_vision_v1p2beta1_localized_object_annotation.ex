...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1LocalizedObjectAnnotation do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1BoundingPoly.t`, *default:* `nil`) - Image region to which this object belongs. This must be populated.
