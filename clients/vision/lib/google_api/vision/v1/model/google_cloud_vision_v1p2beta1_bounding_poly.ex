...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1BoundingPoly do
  ...
  - normalizedVertices ([GoogleCloudVisionV1p2beta1NormalizedVertex]): The bounding polygon normalized vertices. Defaults to: `null`.
  - vertices ([GoogleCloudVisionV1p2beta1Vertex]): The bounding polygon vertices. Defaults to: `null`.
  """
