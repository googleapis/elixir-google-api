...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1BoundingPoly do
  ...
  - normalizedVertices (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1NormalizedVertex.t)): The bounding polygon normalized vertices. Defaults to `nil`.
  - vertices (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1Vertex.t)): The bounding polygon vertices. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          :normalizedVertices =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1NormalizedVertex.t()),
          :vertices => list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1Vertex.t())
        }
