...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1FaceAnnotation do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t`, *default:* `nil`) - The bounding polygon around the face. The coordinates of the bounding box
  ...
  *   `fdBoundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t`, *default:* `nil`) - The `fd_bounding_poly` bounding polygon is tighter than the
  ...
  *   `landmarks` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1FaceAnnotationLandmark.t)`, *default:* `nil`) - Detected face landmarks.
