...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1FaceAnnotation do
  ...
  - boundingPoly (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t): The bounding polygon around the face. The coordinates of the bounding box
  ...
  - fdBoundingPoly (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t): The `fd_bounding_poly` bounding polygon is tighter than the
  ...
  - landmarks (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1FaceAnnotationLandmark.t)): Detected face landmarks. Defaults to `nil`.
