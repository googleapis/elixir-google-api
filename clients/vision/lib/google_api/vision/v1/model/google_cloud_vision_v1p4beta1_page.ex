...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1Page do
  ...
  - blocks ([GoogleCloudVisionV1p4beta1Block]): List of blocks of text, images etc on this page. Defaults to: `null`.
  ...
  - property (GoogleCloudVisionV1p4beta1TextAnnotationTextProperty): Additional information detected on the page. Defaults to: `null`.
