...
defmodule GoogleApi.Vision.V1.Model.ProductSearchResults do
  ...
  - productGroupedResults (list(GoogleApi.Vision.V1.Model.GroupedResult.t)): List of results grouped by products detected in the query image. Each entry
  corresponds to one bounding polygon in the query image, and contains the
  matching products specific to that region. There may be duplicate product
  matches in the union of all the per-product results. Defaults to `nil`.
  - results (list(GoogleApi.Vision.V1.Model.Result.t)): List of results, one for each product match. Defaults to `nil`.
  """
