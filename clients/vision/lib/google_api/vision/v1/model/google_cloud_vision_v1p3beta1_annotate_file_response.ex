...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1AnnotateFileResponse do
  ...
  *   `responses` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1AnnotateImageResponse.t)`, *default:* `nil`) - Individual responses to images found within the file. This field will be empty if the `error` field is set.
