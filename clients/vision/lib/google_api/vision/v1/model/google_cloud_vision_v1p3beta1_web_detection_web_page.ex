...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1WebDetectionWebPage do
  ...
  *   `fullMatchingImages` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1WebDetectionWebImage.t)`, *default:* `nil`) - Fully matching images on the page. Can include resized copies of the query image.
  *   `pageTitle` (*type:* `String.t`, *default:* `nil`) - Title for the web page, may contain HTML markups.
  *   `partialMatchingImages` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1WebDetectionWebImage.t)`, *default:* `nil`) - Partial matching images on the page. Those images are similar enough to share some key-point features. For example an original image will likely have partial matching for its crops.
