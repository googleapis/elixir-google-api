...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1OutputConfig do
  ...
  - gcsDestination (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1GcsDestination.t): The Google Cloud Storage location to write the output(s) to. Defaults to `nil`.
  """
