...
defmodule GoogleApi.Vision.V1.Model.AnnotateImageRequest do
  ...
  - features (list(GoogleApi.Vision.V1.Model.Feature.t)): Requested features. Defaults to `nil`.
  - image (GoogleApi.Vision.V1.Model.Image.t): The image to be processed. Defaults to `nil`.
  - imageContext (GoogleApi.Vision.V1.Model.ImageContext.t): Additional context that may accompany the image. Defaults to `nil`.
  """
