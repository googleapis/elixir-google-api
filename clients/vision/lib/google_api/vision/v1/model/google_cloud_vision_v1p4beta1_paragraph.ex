...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1Paragraph do
  ...
  - property (GoogleCloudVisionV1p4beta1TextAnnotationTextProperty): Additional information detected for the paragraph. Defaults to: `null`.
  - words ([GoogleCloudVisionV1p4beta1Word]): List of words in this paragraph. Defaults to: `null`.
  """
