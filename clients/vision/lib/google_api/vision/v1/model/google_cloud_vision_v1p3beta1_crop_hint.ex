...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1CropHint do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1BoundingPoly.t`, *default:* `nil`) - The bounding polygon for the crop region. The coordinates of the bounding box are in the original image's scale.
