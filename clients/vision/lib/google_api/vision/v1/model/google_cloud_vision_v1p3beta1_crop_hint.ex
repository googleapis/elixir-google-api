...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1CropHint do
  ...
  - boundingPoly (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1BoundingPoly.t): The bounding polygon for the crop region. The coordinates of the bounding
