...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1CropHint do
  ...
  - boundingPoly (GoogleCloudVisionV1p3beta1BoundingPoly): The bounding polygon for the crop region. The coordinates of the bounding box are in the original image&#39;s scale, as returned in &#x60;ImageParams&#x60;. Defaults to: `null`.
