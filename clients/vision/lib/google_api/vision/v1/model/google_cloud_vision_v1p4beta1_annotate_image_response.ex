...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1AnnotateImageResponse do
  ...
  *   `context` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1ImageAnnotationContext.t`, *default:* `nil`) - If present, contextual information is needed to understand where this image comes from.
  *   `cropHintsAnnotation` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1CropHintsAnnotation.t`, *default:* `nil`) - If present, crop hints have completed successfully.
  ...
  *   `faceAnnotations` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1FaceAnnotation.t)`, *default:* `nil`) - If present, face detection has completed successfully.
  *   `fullTextAnnotation` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1TextAnnotation.t`, *default:* `nil`) - If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
  ...
  *   `localizedObjectAnnotations` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1LocalizedObjectAnnotation.t)`, *default:* `nil`) - If present, localized object detection has completed successfully. This will be sorted descending by confidence score.
