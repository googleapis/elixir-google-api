...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1AnnotateImageResponse do
  ...
  *   `context` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1ImageAnnotationContext.t`, *default:* `nil`) - If present, contextual information is needed to understand where this image
      comes from.
  ...
  *   `fullTextAnnotation` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1TextAnnotation.t`, *default:* `nil`) - If present, text (OCR) detection or document (OCR) text detection has
