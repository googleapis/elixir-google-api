...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1Word do
  ...
  *   `symbols` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1Symbol.t)`, *default:* `nil`) - List of symbols in the word. The order of the symbols follows the natural reading order.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :property =>
            ...
            | nil,
          :symbols => list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1Symbol.t()) | nil
        }
