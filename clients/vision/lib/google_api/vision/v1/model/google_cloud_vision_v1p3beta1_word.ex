...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1Word do
  ...
  - property (GoogleCloudVisionV1p3beta1TextAnnotationTextProperty): Additional information detected for the word. Defaults to: `null`.
  - symbols ([GoogleCloudVisionV1p3beta1Symbol]): List of symbols in the word. The order of the symbols follows the natural reading order. Defaults to: `null`.
  """
