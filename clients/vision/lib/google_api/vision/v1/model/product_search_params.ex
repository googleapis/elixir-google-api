...
defmodule GoogleApi.Vision.V1.Model.ProductSearchParams do
  ...
  *   `productSet` (*type:* `String.t`, *default:* `nil`) - The resource name of a ProductSet to be searched for similar images. Format is: `projects/PROJECT_ID/locations/LOC_ID/productSets/PRODUCT_SET_ID`.
  """
