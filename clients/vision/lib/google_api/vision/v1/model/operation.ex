...
defmodule GoogleApi.Vision.V1.Model.Operation do
  @moduledoc """
  ...
  - error (GoogleApi.Vision.V1.Model.Status.t): The error result of the operation in case of failure or cancellation. Defaults to `nil`.
...
defimpl Poison.Decoder, for: GoogleApi.Vision.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vision.V1.Model.Operation do
