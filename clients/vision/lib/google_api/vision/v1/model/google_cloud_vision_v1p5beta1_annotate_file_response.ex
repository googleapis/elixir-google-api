...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1AnnotateFileResponse do
  ...
  - inputConfig (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1InputConfig.t): Information about the file for which this response is generated. Defaults to `nil`.
  - responses (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1AnnotateImageResponse.t)): Individual responses to images found within the file. Defaults to `nil`.
