...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1AnnotateFileResponse do
  ...
  *   `responses` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1AnnotateImageResponse.t)`, *default:* `nil`) - Individual responses to images found within the file. This field will be
