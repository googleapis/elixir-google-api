...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1FaceAnnotationLandmark do
  ...
  - position (GoogleCloudVisionV1p2beta1Position): Face landmark position. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :position => GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1Position.t(),
          :type => any()
        }

  field(:position, as: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1Position)
  field(:type)
end

defimpl Poison.Decoder,
  for: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1FaceAnnotationLandmark do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1FaceAnnotationLandmark.decode(
      value,
      options
    )
  end
