...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotation do
  @moduledoc """
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BoundingPoly.t`, *default:* `nil`) - The bounding polygon around the face. The coordinates of the bounding box
  ...
  *   `fdBoundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BoundingPoly.t`, *default:* `nil`) - The `fd_bounding_poly` bounding polygon is tighter than the
  ...
  *   `landmarks` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotationLandmark.t)`, *default:* `nil`) - Detected face landmarks.
  ...
  *   `underExposedLikelihood` (*type:* `String.t`, *default:* `nil`) - Under-exposed likelihood.
  ...
  @type t :: %__MODULE__{
          ...
          :fdBoundingPoly => GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BoundingPoly.t(),
          :headwearLikelihood => String.t(),
          :joyLikelihood => String.t(),
          :landmarkingConfidence => number(),
          :landmarks =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotationLandmark.t()),
          :panAngle => number(),
          :rollAngle => number(),
  ...
  field(:fdBoundingPoly, as: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1BoundingPoly)
  ...
  field(
    :landmarks,
    as: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotationLandmark,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotation do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p6beta1FaceAnnotation do
