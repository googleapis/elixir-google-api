...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation.decode(
      value,
      options
    )
  end
