...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult do
  ...
  - boundingPoly (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1BoundingPoly.t): The bounding polygon around the product detected in the query image. Defaults to `nil`.
