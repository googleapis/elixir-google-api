...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Paragraph do
  ...
  *   `boundingBox` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t`, *default:* `nil`) - The bounding box for the paragraph.
  ...
  *   `property` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty.t`, *default:* `nil`) - Additional information detected for the paragraph.
  *   `words` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Word.t)`, *default:* `nil`) - List of all words in this paragraph.
  """
