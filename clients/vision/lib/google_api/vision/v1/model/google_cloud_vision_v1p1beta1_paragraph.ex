...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Paragraph do
  ...
  - boundingBox (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t): The bounding box for the paragraph.
  ...
  * when it's rotated 180 degrees around the top-left corner it becomes:
  ...
  - property (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty.t): Additional information detected for the paragraph. Defaults to `nil`.
  - words (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Word.t)): List of words in this paragraph. Defaults to `nil`.
  """
