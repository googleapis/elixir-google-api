...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1AnnotateImageResponse do
  ...
  *   `context` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ImageAnnotationContext.t`, *default:* `nil`) - If present, contextual information is needed to understand where this image comes from.
  ...
  *   `fullTextAnnotation` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotation.t`, *default:* `nil`) - If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text.
  ...
  *   `localizedObjectAnnotations` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1LocalizedObjectAnnotation.t)`, *default:* `nil`) - If present, localized object detection has completed successfully. This will be sorted descending by confidence score.
  ...
  *   `webDetection` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1WebDetection.t`, *default:* `nil`) - If present, web detection has completed successfully.
  ...
  @type t :: %__MODULE__{
          :context =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ImageAnnotationContext.t() | nil,
          :cropHintsAnnotation =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1CropHintsAnnotation.t() | nil,
          :error => GoogleApi.Vision.V1.Model.Status.t() | nil,
          :faceAnnotations =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1FaceAnnotation.t()) | nil,
          :fullTextAnnotation =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotation.t() | nil,
          :imagePropertiesAnnotation =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ImageProperties.t() | nil,
          :labelAnnotations =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1EntityAnnotation.t()) | nil,
          :landmarkAnnotations =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1EntityAnnotation.t()) | nil,
          ...
          :productSearchResults =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ProductSearchResults.t() | nil,
          :safeSearchAnnotation =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1SafeSearchAnnotation.t() | nil,
          :textAnnotations =>
            list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1EntityAnnotation.t()) | nil,
          :webDetection =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1WebDetection.t() | nil
        }
