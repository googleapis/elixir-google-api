...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1ImageProperties do
  ...
  *   `dominantColors` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1DominantColorsAnnotation.t`, *default:* `nil`) - If present, dominant colors completed successfully.
  """
  ...
  @type t :: %__MODULE__{
          :dominantColors =>
            GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1DominantColorsAnnotation.t() | nil
        }
