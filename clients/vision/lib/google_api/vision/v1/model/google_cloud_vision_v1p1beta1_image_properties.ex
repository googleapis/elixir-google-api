...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1ImageProperties do
  ...
  - dominantColors (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1DominantColorsAnnotation.t): If present, dominant colors completed successfully. Defaults to `nil`.
  """
