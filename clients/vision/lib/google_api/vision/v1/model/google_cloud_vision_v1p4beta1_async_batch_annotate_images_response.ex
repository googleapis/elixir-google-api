...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1AsyncBatchAnnotateImagesResponse do
  ...
  *   `outputConfig` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1OutputConfig.t`, *default:* `nil`) - The output location and metadata from AsyncBatchAnnotateImagesRequest.
  """
