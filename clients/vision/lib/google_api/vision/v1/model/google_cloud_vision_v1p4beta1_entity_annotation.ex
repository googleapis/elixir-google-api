...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1EntityAnnotation do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1BoundingPoly.t`, *default:* `nil`) - Image region to which this entity belongs. Not produced for `LABEL_DETECTION` features.
  ...
  *   `properties` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1Property.t)`, *default:* `nil`) - Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity.
  ...
  *   `topicality` (*type:* `number()`, *default:* `nil`) - The relevancy of the ICA (Image Content Annotation) label to the image. For example, the relevancy of "tower" is likely higher to an image containing the detected "Eiffel Tower" than to an image containing a detected distant towering building, even though the confidence that there is a tower in each image may be the same. Range [0, 1].
  ...
  field(:properties, as: GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1Property, type: :list)
