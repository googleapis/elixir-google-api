...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Word do
  ...
  - boundingBox (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t): The bounding box for the word.
  ...
  * when it's rotated 180 degrees around the top-left corner it becomes:
  ...
  - property (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty.t): Additional information detected for the word. Defaults to `nil`.
  - symbols (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Symbol.t)): List of symbols in the word.
