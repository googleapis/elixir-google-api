...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Word do
  ...
  *   `boundingBox` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t`, *default:* `nil`) - The bounding box for the word.
  ...
  *   `symbols` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Symbol.t)`, *default:* `nil`) - List of symbols in the word.
