...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1EntityAnnotation do
  ...
  - boundingPoly (GoogleCloudVisionV1p3beta1BoundingPoly): Image region to which this entity belongs. Not produced for &#x60;LABEL_DETECTION&#x60; features. Defaults to: `null`.
  ...
  - locations ([GoogleCloudVisionV1p3beta1LocationInfo]): The location information for the detected entity. Multiple &#x60;LocationInfo&#x60; elements can be present because one location may indicate the location of the scene in the image, and another location may indicate the location of the place where the image was taken. Location information is usually present for landmarks. Defaults to: `null`.
  ...
  - properties ([GoogleCloudVisionV1p3beta1Property]): Some entities may have optional user-supplied &#x60;Property&#x60; (name/value) fields, such a score or string that qualifies the entity. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          ...
          :description => any(),
          :locale => any(),
          :locations => list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1LocationInfo.t()),
          :mid => any(),
