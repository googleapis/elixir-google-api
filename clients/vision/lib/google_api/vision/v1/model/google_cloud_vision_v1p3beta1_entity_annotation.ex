...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1EntityAnnotation do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1BoundingPoly.t`, *default:* `nil`) - Image region to which this entity belongs. Not produced for `LABEL_DETECTION` features.
  ...
  *   `properties` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1Property.t)`, *default:* `nil`) - Some entities may have optional user-supplied `Property` (name/value) fields, such a score or string that qualifies the entity.
