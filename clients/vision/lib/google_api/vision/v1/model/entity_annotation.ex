...
defmodule GoogleApi.Vision.V1.Model.EntityAnnotation do
  ...
  - boundingPoly (BoundingPoly): Image region to which this entity belongs. Not produced for &#x60;LABEL_DETECTION&#x60; features. Defaults to: `null`.
  ...
  - properties ([Property]): Some entities may have optional user-supplied &#x60;Property&#x60; (name/value) fields, such a score or string that qualifies the entity. Defaults to: `null`.
