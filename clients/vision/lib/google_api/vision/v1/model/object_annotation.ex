...
defmodule GoogleApi.Vision.V1.Model.ObjectAnnotation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Vision.V1.Model.ObjectAnnotation do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.ObjectAnnotation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vision.V1.Model.ObjectAnnotation do
