...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1TextAnnotationTextProperty do
  ...
  - detectedBreak (GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak): Detected start or end of a text segment. Defaults to: `null`.
  - detectedLanguages ([GoogleCloudVisionV1p2beta1TextAnnotationDetectedLanguage]): A list of detected languages together with confidence. Defaults to: `null`.
  """
