...
defmodule GoogleApi.Vision.V1.Model.AnnotateImageResponse do
  ...
  - context (ImageAnnotationContext): If present, contextual information is needed to understand where this image comes from. Defaults to: `null`.
  - cropHintsAnnotation (CropHintsAnnotation): If present, crop hints have completed successfully. Defaults to: `null`.
  ...
  - faceAnnotations ([FaceAnnotation]): If present, face detection has completed successfully. Defaults to: `null`.
  - fullTextAnnotation (TextAnnotation): If present, text (OCR) detection or document (OCR) text detection has completed successfully. This annotation provides the structural hierarchy for the OCR detected text. Defaults to: `null`.
