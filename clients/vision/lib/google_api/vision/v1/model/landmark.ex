...
defmodule GoogleApi.Vision.V1.Model.Landmark do
  ...
  - position (Position): Face landmark position. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Vision.V1.Model.Landmark do
  def decode(value, options) do
    GoogleApi.Vision.V1.Model.Landmark.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vision.V1.Model.Landmark do
