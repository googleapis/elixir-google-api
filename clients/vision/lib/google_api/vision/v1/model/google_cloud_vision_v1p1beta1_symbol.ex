...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Symbol do
  ...
  - boundingBox (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t): The bounding box for the symbol.
  ...
  * when it's rotated 180 degrees around the top-left corner it becomes:
  ...
  - property (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1TextAnnotationTextProperty.t): Additional information detected for the symbol. Defaults to `nil`.
