...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse do
  ...
  - responses (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1AnnotateFileResponse.t)): The list of file annotation responses, each response corresponding to each
