...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p4beta1BatchAnnotateFilesResponse do
  ...
  - responses ([GoogleCloudVisionV1p4beta1AnnotateFileResponse]): The list of file annotation responses, each response corresponding to each AnnotateFileRequest in BatchAnnotateFilesRequest. Defaults to: `null`.
  """
