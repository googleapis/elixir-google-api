...
defmodule GoogleApi.Vision.V1.Model.Page do
  ...
  - blocks ([Block]): List of blocks of text, images etc on this page. Defaults to: `null`.
  ...
  - property (TextProperty): Additional information detected on the page. Defaults to: `null`.
