...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1KeyValuePair do
  ...
  - key (String.t): The key string value. Defaults to `nil`.
  - keyBlock (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1Block.t): Key block of the pair containing the normalized bounding box and key text. Defaults to `nil`.
  - normalizedKey (String.t): Optional. The translation of key text if the text is not in English. Defaults to `nil`.
  - valueBlock (GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1Block.t): Value block of the pair containing the normalized bounding box and value
  text, including potentially deeper structures within the value text. Defaults to `nil`.
  - valueType (String.t): Type of the value. Valid strings are the following:
  ...
  "phone" - for phone numbers. Defaults to `nil`.
  """
