...
defmodule GoogleApi.Vision.V1.Model.Feature do
  ...
  `TEXT_DETECTION`, `DOCUMENT_TEXT_DETECTION`, or `CROP_HINTS`. Defaults to `nil`.
  - model (String.t): Model to use for the feature.
  Supported values: "builtin/stable" (the default if unset) and
  "builtin/latest". Defaults to `nil`.
  - type (String.t): The feature type. Defaults to `nil`.
  """
