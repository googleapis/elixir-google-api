...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1EntityAnnotation do
  ...
  *   `boundingPoly` (*type:* `GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1BoundingPoly.t`, *default:* `nil`) - Image region to which this entity belongs. Not produced
  ...
  *   `locations` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1LocationInfo.t)`, *default:* `nil`) - The location information for the detected entity. Multiple
  ...
  *   `properties` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p1beta1Property.t)`, *default:* `nil`) - Some entities may have optional user-supplied `Property` (name/value)
