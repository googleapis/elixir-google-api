...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResults do
  ...
  *   `productGroupedResults` (*type:* `list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult.t)`, *default:* `nil`) - List of results grouped by products detected in the query image. Each entry
