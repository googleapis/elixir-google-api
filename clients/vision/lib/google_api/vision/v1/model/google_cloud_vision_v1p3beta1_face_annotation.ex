...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p3beta1FaceAnnotation do
  ...
  - landmarks ([GoogleCloudVisionV1p3beta1FaceAnnotationLandmark]): Detected face landmarks. Defaults to: `null`.
