...
defmodule GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1ProductSearchResults do
  ...
  - productGroupedResults (list(GoogleApi.Vision.V1.Model.GoogleCloudVisionV1p5beta1ProductSearchResultsGroupedResult.t)): List of results grouped by products detected in the query image. Each entry
