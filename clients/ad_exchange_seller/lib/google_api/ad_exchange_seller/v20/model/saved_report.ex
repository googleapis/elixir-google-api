...
defmodule GoogleApi.AdExchangeSeller.V20.Model.SavedReport do
  ...
  - kind (String.t): Kind of resource this is, in this case adexchangeseller#savedReport. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeSeller.V20.Model.SavedReport do
  def decode(value, options) do
    GoogleApi.AdExchangeSeller.V20.Model.SavedReport.decode(value, options)
  end
end
