...
defmodule GoogleApi.AdExchangeSeller.V20.Model.AdClients do
  ...
  - kind (String.t): Kind of list this is, in this case adexchangeseller#adClients. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :etag => any(),
          :items => list(GoogleApi.AdExchangeSeller.V20.Model.AdClient.t()),
          :kind => any(),
          :nextPageToken => any()
        }

  field(:etag)
  field(:items, as: GoogleApi.AdExchangeSeller.V20.Model.AdClient, type: :list)
  field(:kind)
  field(:nextPageToken)
end
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeSeller.V20.Model.AdClients do
  def decode(value, options) do
    GoogleApi.AdExchangeSeller.V20.Model.AdClients.decode(value, options)
  end
end
