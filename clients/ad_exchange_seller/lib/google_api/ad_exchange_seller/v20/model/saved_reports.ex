...
defmodule GoogleApi.AdExchangeSeller.V20.Model.SavedReports do
  ...
  - kind (String.t): Kind of list this is, in this case adexchangeseller#savedReports. Defaults to: `null`.
  ...
  @type t :: %__MODULE__{
          :etag => any(),
          :items => list(GoogleApi.AdExchangeSeller.V20.Model.SavedReport.t()),
          :kind => any(),
          :nextPageToken => any()
        }

  field(:etag)
  field(:items, as: GoogleApi.AdExchangeSeller.V20.Model.SavedReport, type: :list)
  field(:kind)
  field(:nextPageToken)
end
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeSeller.V20.Model.SavedReports do
  def decode(value, options) do
    GoogleApi.AdExchangeSeller.V20.Model.SavedReports.decode(value, options)
  end
end
