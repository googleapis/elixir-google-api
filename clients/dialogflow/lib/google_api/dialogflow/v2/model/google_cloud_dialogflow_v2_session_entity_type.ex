...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SessionEntityType do
  ...
  - entities (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EntityTypeEntity.t)): Required. The collection of entities associated with this session entity
  type. Defaults to `nil`.
  - entityOverrideMode (String.t): Required. Indicates whether the additional data should override or
  supplement the developer entity type definition. Defaults to `nil`.
  - name (String.t): Required. The unique identifier of this session entity type. Format:
  `projects/<Project ID>/agent/sessions/<Session ID>/entityTypes/<Entity Type
  Display Name>`.

  `<Entity Type Display Name>` must be the display name of an existing entity
  type in the same agent that will be overridden or supplemented. Defaults to `nil`.
  """
