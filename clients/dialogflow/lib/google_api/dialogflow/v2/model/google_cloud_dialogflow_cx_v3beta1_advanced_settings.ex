...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings do
  @moduledoc """
  ...
  *   `speechSettings` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings.t`, *default:* `nil`) - Settings for speech to text detection. Exposed at the following levels: - Agent level - Flow level - Page level - Parameter level
  ...
  @type t :: %__MODULE__{
          :audioExportGcsDestination =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1GcsDestination.t() | nil,
          :dtmfSettings =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettings.t()
            | nil,
          :loggingSettings =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettings.t()
            | nil,
          :speechSettings =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings.t()
            | nil
        }

  field(:audioExportGcsDestination,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1GcsDestination
  )

  field(:dtmfSettings,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsDtmfSettings
  )

  field(:loggingSettings,
    as:
      GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsLoggingSettings
  )

  field(:speechSettings,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings.decode(
      value,
      options
    )
  end
