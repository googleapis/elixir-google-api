...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2WebhookRequest do
  ...
  *   `originalDetectIntentRequest` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2OriginalDetectIntentRequest.t`, *default:* `nil`) - Optional. The contents of the original request that was passed to
      `[Streaming]DetectIntent` call.
  *   `queryResult` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2QueryResult.t`, *default:* `nil`) - The result of the conversational query or event processing. Contains the
