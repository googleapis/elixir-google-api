...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsOperationMetadata.decode(
      value,
      options
    )
  end
