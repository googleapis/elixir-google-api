...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3WebhookResponse do
  @moduledoc """
  ...
  *   `targetPage` (*type:* `String.t`, *default:* `nil`) - The target page to transition to. Format: `projects//locations//agents//flows//pages/`.
  ...
  field(:fulfillmentResponse,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3WebhookResponseFulfillmentResponse
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3WebhookResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3WebhookResponse.decode(value, options)
  end
end
