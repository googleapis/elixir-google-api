...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestSmartRepliesResponse do
  @moduledoc """
  ...
  *   `smartReplyAnswers` (*type:* `list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer.t)`, *default:* `nil`) - Output only. Multiple reply options provided by smart reply service. The order is based on the rank of the model prediction. The maximum number of the returned replies is set in SmartReplyConfig.
  ...
  @type t :: %__MODULE__{
          ...
          :smartReplyAnswers =>
            list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer.t())
            | nil
        }
  ...
  field(:smartReplyAnswers,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestSmartRepliesResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestSmartRepliesResponse.decode(
      value,
      options
    )
  end
