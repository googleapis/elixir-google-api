...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1QueryInput do
  ...
  *   `toolCallResult` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1ToolCallResult.t`, *default:* `nil`) - The results of a tool executed by the client.
  ...
  @type t :: %__MODULE__{
          :audio =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1AudioInput.t() | nil,
          :dtmf =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1DtmfInput.t() | nil,
          :event =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1EventInput.t() | nil,
          :intent =>
