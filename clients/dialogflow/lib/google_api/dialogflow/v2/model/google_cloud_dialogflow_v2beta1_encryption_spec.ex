...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EncryptionSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EncryptionSpec do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EncryptionSpec.decode(
      value,
      options
    )
  end
