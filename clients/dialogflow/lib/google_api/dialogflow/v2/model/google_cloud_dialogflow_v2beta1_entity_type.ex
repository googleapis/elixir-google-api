...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EntityType do
  ...
  - autoExpansionMode (String.t): Optional. Indicates whether the entity type can be automatically
  expanded. Defaults to `nil`.
  - displayName (String.t): Required. The name of the entity type. Defaults to `nil`.
  - entities (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EntityTypeEntity.t)): Optional. The collection of entity entries associated with the entity type. Defaults to `nil`.
  - kind (String.t): Required. Indicates the kind of entity type. Defaults to `nil`.
  - name (String.t): The unique identifier of the entity type.
  Required for EntityTypes.UpdateEntityType and
  EntityTypes.BatchUpdateEntityTypes methods.
  Format: `projects/<Project ID>/agent/entityTypes/<Entity Type ID>`. Defaults to `nil`.
  """
