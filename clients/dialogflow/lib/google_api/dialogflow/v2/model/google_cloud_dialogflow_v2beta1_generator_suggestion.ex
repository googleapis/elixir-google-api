...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1GeneratorSuggestion do
  ...
  *   `toolCallInfo` (*type:* `list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1GeneratorSuggestionToolCallInfo.t)`, *default:* `nil`) - Optional. List of request and response for tool calls executed.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :toolCallInfo =>
            list(
              GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1GeneratorSuggestionToolCallInfo.t()
            )
            | nil
        }
  ...
  field(:toolCallInfo,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1GeneratorSuggestionToolCallInfo,
    type: :list
  )
end
