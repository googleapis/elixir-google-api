...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SynthesizeSpeechConfig do
  ...
  *   `effectsProfileId` (*type:* `list(String.t)`, *default:* `nil`) - Optional. An identifier which selects 'audio effects' profiles that are
      applied on (post synthesized) text to speech. Effects are applied on top of
      each other in the order they are given.
  *   `pitch` (*type:* `float()`, *default:* `nil`) - Optional. Speaking pitch, in the range [-20.0, 20.0]. 20 means increase 20
      semitones from the original pitch. -20 means decrease 20 semitones from the
      original pitch.
  *   `speakingRate` (*type:* `float()`, *default:* `nil`) - Optional. Speaking rate/speed, in the range [0.25, 4.0]. 1.0 is the normal
  ...
  *   `volumeGainDb` (*type:* `float()`, *default:* `nil`) - Optional. Volume gain (in dB) of the normal native volume supported by the
