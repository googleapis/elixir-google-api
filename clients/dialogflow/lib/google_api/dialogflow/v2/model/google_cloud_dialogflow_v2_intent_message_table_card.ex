...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageTableCard do
  @moduledoc """
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - Required. Title of the card.
  ...
  @type t :: %__MODULE__{
          ...
          :columnProperties =>
            list(
              GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageColumnProperties.t()
            ),
          :image => GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageImage.t(),
          :rows =>
            list(
              GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageTableCardRow.t()
            ),
          :subtitle => String.t(),
          :title => String.t()
        }
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageTableCard do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageTableCard.decode(
      value,
      options
    )
  end
