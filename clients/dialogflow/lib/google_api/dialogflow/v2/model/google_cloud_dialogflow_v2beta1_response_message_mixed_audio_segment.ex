...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment.decode(
      value,
      options
    )
  end
