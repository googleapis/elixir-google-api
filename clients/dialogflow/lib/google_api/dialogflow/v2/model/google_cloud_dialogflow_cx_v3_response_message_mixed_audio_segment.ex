...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment.decode(
      value,
      options
    )
  end
