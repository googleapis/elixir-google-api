...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2DetectIntentRequest do
  ...
  - inputAudio (String.t): Optional. The natural language speech audio to be processed. This field
  should be populated iff `query_input` is set to an input audio config.
  A single request can contain up to 1 minute of speech audio data. Defaults to `nil`.
  - outputAudioConfig (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2OutputAudioConfig.t): Optional. Instructs the speech synthesizer how to generate the output
  audio. If this field is not set and agent-level speech synthesizer is not
  configured, no output audio is generated. Defaults to `nil`.
  - queryInput (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2QueryInput.t): Required. The input specification. It can be set to:
  ...
  3.  an event that specifies which intent to trigger. Defaults to `nil`.
  - queryParams (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2QueryParameters.t): Optional. The parameters of this query. Defaults to `nil`.
  """
