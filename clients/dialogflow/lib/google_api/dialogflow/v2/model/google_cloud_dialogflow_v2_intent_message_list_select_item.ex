...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageListSelectItem do
  ...
  - image (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageImage.t): Optional. The image to display. Defaults to `nil`.
  - info (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageSelectItemInfo.t): Required. Additional information about this option. Defaults to `nil`.
