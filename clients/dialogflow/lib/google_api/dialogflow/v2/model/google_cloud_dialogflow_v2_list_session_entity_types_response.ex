...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ListSessionEntityTypesResponse do
  ...
  - sessionEntityTypes (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SessionEntityType.t)): The list of session entity types. There will be a maximum number of items
