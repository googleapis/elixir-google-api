...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo.decode(
      value,
      options
    )
  end
