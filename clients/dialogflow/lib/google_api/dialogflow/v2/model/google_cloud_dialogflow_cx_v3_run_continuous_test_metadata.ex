...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3RunContinuousTestMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3RunContinuousTestMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3RunContinuousTestMetadata.decode(
      value,
      options
    )
  end
