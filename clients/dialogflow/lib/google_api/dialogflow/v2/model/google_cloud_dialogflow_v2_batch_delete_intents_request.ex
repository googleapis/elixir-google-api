...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2BatchDeleteIntentsRequest do
  ...
  - intents (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2Intent.t)): Required. The collection of intents to delete. Only intent `name` must be
  filled in. Defaults to `nil`.
  """
