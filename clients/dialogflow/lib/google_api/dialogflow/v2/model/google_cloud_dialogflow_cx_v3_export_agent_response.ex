...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ExportAgentResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ExportAgentResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ExportAgentResponse.decode(
      value,
      options
    )
  end
