...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2OutputAudioConfig do
  ...
  - audioEncoding (String.t): Required. Audio encoding of the synthesized audio content. Defaults to `nil`.
  - sampleRateHertz (integer()): Optional. The synthesis sample rate (in hertz) for this audio. If not
  provided, then the synthesizer will use the default sample rate based on
  the audio encoding. If this is different from the voice's natural sample
  rate, then the synthesizer will honor this request by converting to the
  desired sample rate (which might result in worse audio quality). Defaults to `nil`.
  - synthesizeSpeechConfig (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SynthesizeSpeechConfig.t): Optional. Configuration of how speech should be synthesized. Defaults to `nil`.
  """
