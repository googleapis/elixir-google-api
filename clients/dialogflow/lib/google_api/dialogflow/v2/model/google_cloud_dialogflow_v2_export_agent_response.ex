...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ExportAgentResponse do
  ...
  - agentContent (String.t): The exported agent.
  ...
  | base64 --decode > &lt;agent zip file&gt;</pre> Defaults to `nil`.
  - agentUri (String.t): The URI to a file containing the exported agent. This field is populated
  only if `agent_uri` is specified in `ExportAgentRequest`. Defaults to `nil`.
  """
