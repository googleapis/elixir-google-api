...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection.decode(
      value,
      options
    )
  end
