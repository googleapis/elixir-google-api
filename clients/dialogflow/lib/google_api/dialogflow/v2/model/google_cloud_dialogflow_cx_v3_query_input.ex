...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3QueryInput do
  @moduledoc """
  ...
  *   `text` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TextInput.t`, *default:* `nil`) - The natural language text to be processed.
  ...
  field(:dtmf, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DtmfInput)
  field(:event, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3EventInput)
  field(:intent, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3IntentInput)
  field(:languageCode)
  field(:text, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TextInput)
end

defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3QueryInput do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3QueryInput.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3QueryInput do
