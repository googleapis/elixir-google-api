...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentMessageBasicCard do
  ...
  - buttons ([GoogleCloudDialogflowV2IntentMessageBasicCardButton]): Optional. The collection of card buttons. Defaults to: `null`.
  - formattedText (String.t): Required, unless image is present. The body text of the card. Defaults to: `null`.
  - image (GoogleCloudDialogflowV2IntentMessageImage): Optional. The image for the card. Defaults to: `null`.
