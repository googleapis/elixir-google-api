...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1DataStoreConnection do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1DataStoreConnection do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1DataStoreConnection.decode(
      value,
      options
    )
  end
