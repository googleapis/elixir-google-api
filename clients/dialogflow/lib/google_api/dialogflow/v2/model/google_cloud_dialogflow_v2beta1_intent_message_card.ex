...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1IntentMessageCard do
  ...
  - buttons (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1IntentMessageCardButton.t)): Optional. The collection of card buttons. Defaults to `nil`.
