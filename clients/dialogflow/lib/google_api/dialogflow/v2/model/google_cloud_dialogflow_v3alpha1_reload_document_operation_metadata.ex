...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ReloadDocumentOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ReloadDocumentOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1ReloadDocumentOperationMetadata.decode(
      value,
      options
    )
  end
