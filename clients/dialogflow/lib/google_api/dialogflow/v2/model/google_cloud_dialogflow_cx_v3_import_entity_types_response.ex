...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ImportEntityTypesResponse do
  @moduledoc """
  ...
  *   `entityTypes` (*type:* `list(String.t)`, *default:* `nil`) - The unique identifier of the imported entity types. Format: `projects//locations//agents//entity_types/`.
  ...
  field(:conflictingResources,
    as:
      GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ImportEntityTypesResponseConflictingResources
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ImportEntityTypesResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ImportEntityTypesResponse.decode(
      value,
      options
    )
  end
