...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1CreateDocumentOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1CreateDocumentOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV3alpha1CreateDocumentOperationMetadata.decode(
      value,
      options
    )
  end
