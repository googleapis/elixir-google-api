...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestionResult do
  @moduledoc """
  ...
  *   `generateSuggestionsResponse` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2GenerateSuggestionsResponse.t`, *default:* `nil`) - Suggestions generated using generators triggered by customer or agent messages.
  ...
  *   `suggestKnowledgeAssistResponse` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse.t`, *default:* `nil`) - SuggestKnowledgeAssistResponse if request is for KNOWLEDGE_ASSIST.
  *   `suggestSmartRepliesResponse` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestSmartRepliesResponse.t`, *default:* `nil`) - SuggestSmartRepliesResponse if request is for SMART_REPLY.
  ...
  field(:generateSuggestionsResponse,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2GenerateSuggestionsResponse
  )

  field(:suggestArticlesResponse,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestArticlesResponse
  )
  ...
  field(:suggestKnowledgeAssistResponse,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestKnowledgeAssistResponse
  )
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestionResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestionResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SuggestionResult do
