...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestCase do
  @moduledoc """
  ...
  *   `testConfig` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestConfig.t`, *default:* `nil`) - Config for the test case.
  ...
  field(:lastTestResult, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestCaseResult)
  ...
  field(:testConfig, as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestConfig)
end

defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestCase do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestCase.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3TestCase do
