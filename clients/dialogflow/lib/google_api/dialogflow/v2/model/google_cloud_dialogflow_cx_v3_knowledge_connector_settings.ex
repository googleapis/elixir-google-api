...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3KnowledgeConnectorSettings do
  @moduledoc """
  The Knowledge Connector settings for this page or flow. This includes information such as the attached Knowledge Bases, and the way to execute fulfillment.

  ## Attributes

  *   `dataStoreConnections` (*type:* `list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection.t)`, *default:* `nil`) - Optional. List of related data store connections.
  ...
  *   `triggerFulfillment` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3Fulfillment.t`, *default:* `nil`) - The fulfillment to be triggered. When the answers from the Knowledge Connector are selected by Dialogflow, you can utitlize the request scoped parameter `$request.knowledge.answers` (contains up to the 5 highest confidence answers) and `$request.knowledge.questions` (contains the corresponding questions) to construct the fulfillment.
  ...
  @type t :: %__MODULE__{
          :dataStoreConnections =>
            list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection.t())
            | nil,
          :enabled => boolean() | nil,
  ...
  field(:dataStoreConnections,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3DataStoreConnection,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3KnowledgeConnectorSettings do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3KnowledgeConnectorSettings.decode(
      value,
      options
    )
  end
