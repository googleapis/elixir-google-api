...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata.decode(
      value,
      options
    )
  end
