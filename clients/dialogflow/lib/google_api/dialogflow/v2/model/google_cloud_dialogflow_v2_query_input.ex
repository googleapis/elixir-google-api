...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2QueryInput do
  ...
  - audioConfig (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2InputAudioConfig.t): Instructs the speech recognizer how to process the speech audio. Defaults to `nil`.
  - event (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EventInput.t): The event to be processed. Defaults to `nil`.
  - text (GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2TextInput.t): The natural language text to be processed. Defaults to `nil`.
  """
