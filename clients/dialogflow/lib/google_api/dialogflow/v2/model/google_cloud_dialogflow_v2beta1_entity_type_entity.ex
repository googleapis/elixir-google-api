...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EntityTypeEntity do
  ...
  - synonyms (list(String.t)): Required. A collection of value synonyms. For example, if the entity type
  is *vegetable*, and `value` is *scallions*, a synonym could be *green
  onions*.

  For `KIND_LIST` entity types:

  *   This collection must contain exactly one synonym equal to `value`. Defaults to `nil`.
  - value (String.t): Required. The primary value associated with this entity entry.
  ...
  *   A string that can contain references to other entity types (with or
    without aliases). Defaults to `nil`.
  """
