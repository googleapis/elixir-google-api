...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ToolCall do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ToolCall do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ToolCall.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ToolCall do
