...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2InputAudioConfig do
  ...
  - modelVariant (String.t): Optional. Which variant of the Speech model to use. Defaults to: `null`.
    - Enum - one of [SPEECH_MODEL_VARIANT_UNSPECIFIED, USE_BEST_AVAILABLE, USE_STANDARD, USE_ENHANCED]
