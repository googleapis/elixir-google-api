...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestArticlesResponse do
  @moduledoc """
  ...
  *   `latestMessage` (*type:* `String.t`, *default:* `nil`) - The name of the latest conversation message used to compile suggestion for. Format: `projects//locations//conversations//messages/`.
  ...
  @type t :: %__MODULE__{
          :articleAnswers =>
            list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1ArticleAnswer.t())
            | nil,
  ...
  field(:articleAnswers,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1ArticleAnswer,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestArticlesResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestArticlesResponse.decode(
      value,
      options
    )
  end
