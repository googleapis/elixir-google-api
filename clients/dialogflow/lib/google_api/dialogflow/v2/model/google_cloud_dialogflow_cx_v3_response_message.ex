  ...
  *   `text` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageText.t`, *default:* `nil`) - Returns a text response.
  ...
  @type t :: %__MODULE__{
          ...
          :endInteraction =>
            ...
            | nil,
          :knowledgeInfoCard =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageKnowledgeInfoCard.t()
            | nil,
          :liveAgentHandoff =>
  ...
  field(:knowledgeInfoCard,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ResponseMessageKnowledgeInfoCard
  )
