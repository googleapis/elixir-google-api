...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2SearchAgentsResponse do
  ...
  - agents ([GoogleCloudDialogflowV2Agent]): The list of agents. There will be a maximum number of items returned based on the page_size field in the request. Defaults to: `null`.
