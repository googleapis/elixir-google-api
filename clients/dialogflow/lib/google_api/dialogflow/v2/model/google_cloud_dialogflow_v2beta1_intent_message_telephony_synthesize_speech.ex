...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1IntentMessageTelephonySynthesizeSpeech do
  ...
  - ssml (String.t): The SSML to be synthesized. For more information, see
  [SSML](https://developers.google.com/actions/reference/ssml). Defaults to `nil`.
  - text (String.t): The raw text to be synthesized. Defaults to `nil`.
  """
