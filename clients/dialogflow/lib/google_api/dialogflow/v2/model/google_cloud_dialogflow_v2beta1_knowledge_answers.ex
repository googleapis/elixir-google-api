...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1KnowledgeAnswers do
  ...
  - answers (list(GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1KnowledgeAnswersAnswer.t)): A list of answers from Knowledge Connector. Defaults to `nil`.
  """
