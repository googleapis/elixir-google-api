...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EncryptionSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EncryptionSpec do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EncryptionSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EncryptionSpec do
