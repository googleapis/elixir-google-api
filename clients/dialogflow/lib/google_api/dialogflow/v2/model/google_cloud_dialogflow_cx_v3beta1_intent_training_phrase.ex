...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase do
  @moduledoc """
  ...
  *   `repeatCount` (*type:* `integer()`, *default:* `nil`) - Indicates how many times this example was added to the intent.
  ...
  field(:parts,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePart,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase.decode(
      value,
      options
    )
  end
