...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ContinuousTestResult do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ContinuousTestResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ContinuousTestResult.decode(
      value,
      options
    )
  end
