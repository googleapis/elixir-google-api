...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo do
  ...
  - followupIntentName (String.t): The unique identifier of the followup intent.
  Format: `projects/<Project ID>/agent/intents/<Intent ID>`. Defaults to `nil`.
  - parentFollowupIntentName (String.t): The unique identifier of the followup intent's parent.
  Format: `projects/<Project ID>/agent/intents/<Intent ID>`. Defaults to `nil`.
  """
