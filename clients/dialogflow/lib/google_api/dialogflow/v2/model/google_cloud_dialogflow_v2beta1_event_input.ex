...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1EventInput do
  ...
  - languageCode (String.t): Required. The language of this query. See [Language
  Support](https://cloud.google.com/dialogflow-enterprise/docs/reference/language)
  for a list of the currently supported language codes. Note that queries in
  the same session do not necessarily need to specify the same language. Defaults to `nil`.
  - name (String.t): Required. The unique identifier of the event. Defaults to `nil`.
  - parameters (map()): Optional. The collection of parameters associated with the event. Defaults to `nil`.
  """
