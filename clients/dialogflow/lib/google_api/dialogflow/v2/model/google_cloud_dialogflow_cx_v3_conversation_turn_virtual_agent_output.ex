...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput do
  ...
  *   `currentPage` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3Page.t`, *default:* `nil`) - The Page on which the utterance was spoken. Only some fields such as name and displayname will be set.
  ...
  *   `triggeredIntent` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3Intent.t`, *default:* `nil`) - The Intent that triggered the response. Only some fields such as name and displayname will be set.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :currentPage => GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3Page.t(),
          :diagnosticInfo => map(),
          :differences =>
          ...
          :triggeredIntent => GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3Intent.t()
        }
