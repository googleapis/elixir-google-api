...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestionResult do
  ...
  *   `suggestKnowledgeAssistResponse` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse.t`, *default:* `nil`) - SuggestKnowledgeAssistResponse if request is for KNOWLEDGE_ASSIST.
  *   `suggestSmartRepliesResponse` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestSmartRepliesResponse.t`, *default:* `nil`) - SuggestSmartRepliesResponse if request is for SMART_REPLY.
  ...
  @type t :: %__MODULE__{
          ...
          :suggestKnowledgeAssistResponse =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse.t()
            | nil,
  ...
  field(:suggestKnowledgeAssistResponse,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse
  )
