...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1AutoApproveSmartMessagingEntriesResponse do
  @moduledoc """
  ...
  *   `unreviewedCount` (*type:* `integer()`, *default:* `nil`) - Number of smart messaging entries unreviewed.
  ...
  field(:disabledCount)
  field(:enabledCount)
  field(:unreviewedCount)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1AutoApproveSmartMessagingEntriesResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2beta1AutoApproveSmartMessagingEntriesResponse.decode(
      value,
      options
    )
  end
