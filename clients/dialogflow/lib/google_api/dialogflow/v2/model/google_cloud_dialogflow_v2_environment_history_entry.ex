...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EnvironmentHistoryEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EnvironmentHistoryEntry do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2EnvironmentHistoryEntry.decode(
      value,
      options
    )
  end
