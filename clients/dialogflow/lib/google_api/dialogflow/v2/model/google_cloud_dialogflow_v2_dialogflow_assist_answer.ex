...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2DialogflowAssistAnswer do
  @moduledoc """
  ...
  *   `queryResult` (*type:* `GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2QueryResult.t`, *default:* `nil`) - Result from v2 agent.
  ...
  @type t :: %__MODULE__{
          ...
          :intentSuggestion =>
            GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentSuggestion.t() | nil,
          :queryResult =>
  ...
  field(:intentSuggestion,
    as: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2IntentSuggestion
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2DialogflowAssistAnswer do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2DialogflowAssistAnswer.decode(
      value,
      options
    )
  end
