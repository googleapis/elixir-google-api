...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1LanguageInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1LanguageInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowCxV3beta1LanguageInfo.decode(
      value,
      options
    )
  end
