...
defmodule GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ImportConversationDataOperationResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ImportConversationDataOperationResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V2.Model.GoogleCloudDialogflowV2ImportConversationDataOperationResponse.decode(
      value,
      options
    )
  end
