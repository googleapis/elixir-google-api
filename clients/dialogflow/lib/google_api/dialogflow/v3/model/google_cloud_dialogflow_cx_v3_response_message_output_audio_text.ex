...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageOutputAudioText do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageOutputAudioText do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageOutputAudioText.decode(
      value,
      options
    )
  end
