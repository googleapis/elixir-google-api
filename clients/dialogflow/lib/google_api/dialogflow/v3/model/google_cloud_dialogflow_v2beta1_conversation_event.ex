...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ConversationEvent do
  @moduledoc """
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. The type of the event that this notification refers to.
  ...
  @type t :: %__MODULE__{
          ...
          :newMessagePayload =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message.t() | nil,
          :newRecognitionResultPayload =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1StreamingRecognitionResult.t()
            | nil,
          :type => String.t() | nil
        }
  ...
  field(:newMessagePayload, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message)

  field(:newRecognitionResultPayload,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1StreamingRecognitionResult
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ConversationEvent do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ConversationEvent.decode(
      value,
      options
    )
  end
