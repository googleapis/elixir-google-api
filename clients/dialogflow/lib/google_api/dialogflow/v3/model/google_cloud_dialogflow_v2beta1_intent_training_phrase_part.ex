...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentTrainingPhrasePart.decode(
      value,
      options
    )
  end
