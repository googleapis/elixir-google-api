...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SetSuggestionFeatureConfigOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SetSuggestionFeatureConfigOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SetSuggestionFeatureConfigOperationMetadata.decode(
      value,
      options
    )
  end
