...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2OriginalDetectIntentRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2OriginalDetectIntentRequest do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2OriginalDetectIntentRequest.decode(
      value,
      options
    )
  end
