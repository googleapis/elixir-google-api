...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportAgentResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportAgentResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportAgentResponse.decode(
      value,
      options
    )
  end
