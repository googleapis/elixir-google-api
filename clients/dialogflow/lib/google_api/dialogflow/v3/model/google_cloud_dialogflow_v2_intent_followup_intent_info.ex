...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo.decode(
      value,
      options
    )
  end
