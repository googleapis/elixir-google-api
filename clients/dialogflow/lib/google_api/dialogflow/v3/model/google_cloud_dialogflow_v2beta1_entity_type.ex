...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityType do
  @moduledoc """
  ...
  *   `entities` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityTypeEntity.t)`, *default:* `nil`) - Optional. The collection of entity entries associated with the entity type.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The unique identifier of the entity type. Required for EntityTypes.UpdateEntityType and EntityTypes.BatchUpdateEntityTypes methods. Supported formats: - `projects//agent/entityTypes/` - `projects//locations//agent/entityTypes/`
  ...
  @type t :: %__MODULE__{
          ...
          :entities =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityTypeEntity.t())
            | nil,
          :kind => String.t() | nil,
          :name => String.t() | nil
        }
  ...
  field(:entities,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityTypeEntity,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityType do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityType.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EntityType do
