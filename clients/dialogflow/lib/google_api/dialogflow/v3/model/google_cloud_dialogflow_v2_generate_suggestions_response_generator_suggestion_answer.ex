...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2GenerateSuggestionsResponseGeneratorSuggestionAnswer do
  @moduledoc """
  ...
  *   `sourceGenerator` (*type:* `String.t`, *default:* `nil`) - The name of the generator used to generate this suggestion. Format: `projects//locations//generators/`.
  ...
  @type t :: %__MODULE__{
          ...
          :generatorSuggestion =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2GeneratorSuggestion.t() | nil,
  ...
  field(:generatorSuggestion,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2GeneratorSuggestion
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2GenerateSuggestionsResponseGeneratorSuggestionAnswer do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2GenerateSuggestionsResponseGeneratorSuggestionAnswer.decode(
      value,
      options
    )
  end
