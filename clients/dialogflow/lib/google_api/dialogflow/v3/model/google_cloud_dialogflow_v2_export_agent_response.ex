...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ExportAgentResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ExportAgentResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ExportAgentResponse.decode(
      value,
      options
    )
  end
