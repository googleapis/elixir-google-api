...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrasePart do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrasePart do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrasePart.decode(
      value,
      options
    )
  end
