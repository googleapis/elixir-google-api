...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ImportDocumentsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ImportDocumentsResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ImportDocumentsResponse.decode(
      value,
      options
    )
  end
