...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2Intent do
  @moduledoc """
  ...
  *   `followupIntentInfo` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo.t)`, *default:* `nil`) - Output only. Read-only. Information about all followup intents that have this intent as a direct or indirect parent. We populate this field only in the output.
  ...
  *   `messages` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessage.t)`, *default:* `nil`) - Optional. The collection of rich messages corresponding to the `Response` field in the Dialogflow console.
  ...
  *   `trainingPhrases` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrase.t)`, *default:* `nil`) - Optional. The collection of examples that the agent is trained on.
  *   `webhookState` (*type:* `String.t`, *default:* `nil`) - Optional. Indicates whether webhooks are enabled for the intent.
  ...
  @type t :: %__MODULE__{
          ...
          :followupIntentInfo =>
            list(
              GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo.t()
            )
            | nil,
          ...
          :parameters =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentParameter.t()) | nil,
          :parentFollowupIntentName => String.t() | nil,
          :priority => integer() | nil,
          :resetContexts => boolean() | nil,
          :rootFollowupIntentName => String.t() | nil,
          :trainingPhrases =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrase.t())
            | nil,
  ...
  field(:followupIntentInfo,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentFollowupIntentInfo,
    type: :list
  )
  ...
  field(:parameters,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentParameter,
    type: :list
  )
  ...
  field(:trainingPhrases,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentTrainingPhrase,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2Intent do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2Intent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2Intent do
