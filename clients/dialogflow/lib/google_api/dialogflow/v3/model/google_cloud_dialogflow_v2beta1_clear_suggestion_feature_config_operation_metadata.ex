...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata.decode(
      value,
      options
    )
  end
