...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3TestCaseResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3TestCaseResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3TestCaseResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3TestCaseResult do
