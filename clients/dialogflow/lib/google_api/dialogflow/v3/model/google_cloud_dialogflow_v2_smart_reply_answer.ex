...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer do
