...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettingsSpeechSettings.decode(
      value,
      options
    )
  end
