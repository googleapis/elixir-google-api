...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResult do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResultError.t`, *default:* `nil`) - The tool call's error.
  ...
  *   `tool` (*type:* `String.t`, *default:* `nil`) - Required. The tool associated with this call. Format: `projects//locations//tools/`.
  ...
  @type t :: %__MODULE__{
          ...
          :error =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResultError.t()
            | nil,
  ...
  field(:error, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResultError)
  field(:rawContent)
  field(:tool)
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ToolCallResult.decode(
      value,
      options
    )
  end
