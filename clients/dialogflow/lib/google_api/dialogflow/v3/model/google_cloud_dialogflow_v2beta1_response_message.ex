...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessage do
  @moduledoc """
  ...
  *   `text` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageText.t`, *default:* `nil`) - Returns a text response.
  ...
  @type t :: %__MODULE__{
          :endInteraction =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageEndInteraction.t()
            | nil,
          :liveAgentHandoff =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff.t()
            | nil,
          :mixedAudio =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageMixedAudio.t()
            | nil,
          :payload => map() | nil,
          :telephonyTransferCall =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageTelephonyTransferCall.t()
            | nil,
          :text =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageText.t()
            | nil
        }

  field(:endInteraction,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageEndInteraction
  )

  field(:liveAgentHandoff,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff
  )

  field(:mixedAudio,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageMixedAudio
  )
  ...
  field(:telephonyTransferCall,
    as:
      GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageTelephonyTransferCall
  )

  field(:text, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessageText)
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessage do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1ResponseMessage.decode(
      value,
      options
    )
  end
