...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EntityType do
  @moduledoc """
  ...
  *   `entities` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EntityTypeEntity.t)`, *default:* `nil`) - Optional. The collection of entity entries associated with the entity type.
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EntityType do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EntityType.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EntityType do
