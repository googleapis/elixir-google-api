...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1TurnSignals do
  @moduledoc """
  ...
  *   `webhookStatuses` (*type:* `list(String.t)`, *default:* `nil`) - Human-readable statuses of the webhooks triggered during this turn.
  ...
  field(:triggeredAbandonmentEvent)
  field(:userEscalated)
  field(:webhookStatuses, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1TurnSignals do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1TurnSignals.decode(value, options)
  end
end
