...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1Page do
  ...
  *   `advancedSettings` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings.t`, *default:* `nil`) - Hierarchical advanced settings for this page. The settings exposed at the lower level overrides the settings exposed at the higher level.
  ...
  *   `knowledgeConnectorSettings` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettings.t`, *default:* `nil`) - Optional. Knowledge connector configuration.
  ...
  *   `transitionRoutes` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TransitionRoute.t)`, *default:* `nil`) - A list of transitions for the transition rules of this page. They route the conversation to another page in the same flow, or another flow. When we are in a certain page, the TransitionRoutes are evalauted in the following order: * TransitionRoutes defined in the page with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in flow with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in the page with only condition specified. * TransitionRoutes defined in the transition route groups with only condition specified.
  ...
  @type t :: %__MODULE__{
          :advancedSettings =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings.t() | nil,
          ...
          :knowledgeConnectorSettings =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettings.t()
            | nil,
          :name => String.t() | nil,
  ...
  field(:advancedSettings,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings
  )
  ...
  field(:knowledgeConnectorSettings,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettings
  )
