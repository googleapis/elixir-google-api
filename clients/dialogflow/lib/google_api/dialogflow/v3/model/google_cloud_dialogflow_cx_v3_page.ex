...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Page do
  @moduledoc """
  ...
  *   `advancedSettings` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3AdvancedSettings.t`, *default:* `nil`) - Hierarchical advanced settings for this page. The settings exposed at the lower level overrides the settings exposed at the higher level.
  ...
  *   `transitionRoutes` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3TransitionRoute.t)`, *default:* `nil`) - A list of transitions for the transition rules of this page. They route the conversation to another page in the same flow, or another flow. When we are in a certain page, the TransitionRoutes are evalauted in the following order: * TransitionRoutes defined in the page with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in flow with intent specified. * TransitionRoutes defined in the transition route groups with intent specified. * TransitionRoutes defined in the page with only condition specified. * TransitionRoutes defined in the transition route groups with only condition specified.
  ...
  @type t :: %__MODULE__{
          ...
          :form => GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Form.t() | nil,
  ...
  field(:description)
  field(:displayName)
  field(:entryFulfillment, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Fulfillment)
  ...
  field(:form, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Form)
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Page do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Page.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3Page do
