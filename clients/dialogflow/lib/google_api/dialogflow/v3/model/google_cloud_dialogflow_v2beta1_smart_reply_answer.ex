...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SmartReplyAnswer.decode(
      value,
      options
    )
  end
