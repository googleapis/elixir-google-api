...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent do
  @moduledoc """
  ...
  *   `title` (*type:* `String.t`, *default:* `nil`) - Optional. Title of the card (at most 200 bytes). At least one of the title, description or media must be set.
  ...
  field(:media,
    as:
      GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCardContentRbmMedia
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent.decode(
      value,
      options
    )
  end
