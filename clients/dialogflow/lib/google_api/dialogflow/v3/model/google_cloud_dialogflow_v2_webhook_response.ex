...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2WebhookResponse do
  @moduledoc """
  ...
  *   `followupEventInput` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EventInput.t`, *default:* `nil`) - Optional. Invokes the supplied events. When this field is set, Dialogflow ignores the `fulfillment_text`, `fulfillment_messages`, and `payload` fields.
  *   `fulfillmentMessages` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessage.t)`, *default:* `nil`) - Optional. The rich response messages intended for the end-user. When provided, Dialogflow uses this field to populate QueryResult.fulfillment_messages sent to the integration or API caller.
  ...
  *   `source` (*type:* `String.t`, *default:* `nil`) - Optional. A custom field used to identify the webhook source. Arbitrary strings are supported. When provided, Dialogflow uses this field to populate QueryResult.webhook_source sent to the integration or API caller.
  ...
  @type t :: %__MODULE__{
          :followupEventInput =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EventInput.t() | nil,
          :fulfillmentMessages =>
          ...
          :payload => map() | nil,
          :sessionEntityTypes =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SessionEntityType.t()) | nil,
          :source => String.t() | nil
        }

  field(:followupEventInput, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2EventInput)
  ...
  field(:sessionEntityTypes,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SessionEntityType,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2WebhookResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2WebhookResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2WebhookResponse do
