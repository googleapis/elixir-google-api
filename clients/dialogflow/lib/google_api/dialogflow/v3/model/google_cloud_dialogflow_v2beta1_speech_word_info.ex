...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo.decode(
      value,
      options
    )
  end
