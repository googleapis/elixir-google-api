...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1WebhookResponse do
  @moduledoc """
  ...
  *   `followupEventInput` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EventInput.t`, *default:* `nil`) - Optional. Invokes the supplied events. When this field is set, Dialogflow ignores the `fulfillment_text`, `fulfillment_messages`, and `payload` fields.
  *   `fulfillmentMessages` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessage.t)`, *default:* `nil`) - Optional. The rich response messages intended for the end-user. When provided, Dialogflow uses this field to populate QueryResult.fulfillment_messages sent to the integration or API caller.
  ...
  *   `liveAgentHandoff` (*type:* `boolean()`, *default:* `nil`) - Indicates that a live agent should be brought in to handle the interaction with the user. In most cases, when you set this flag to true, you would also want to set end_interaction to true as well. Default is false.
  ...
  *   `source` (*type:* `String.t`, *default:* `nil`) - Optional. A custom field used to identify the webhook source. Arbitrary strings are supported. When provided, Dialogflow uses this field to populate QueryResult.webhook_source sent to the integration or API caller.
  ...
  @type t :: %__MODULE__{
          ...
          :followupEventInput =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EventInput.t() | nil,
          :fulfillmentMessages =>
          ...
          :payload => map() | nil,
          :sessionEntityTypes =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SessionEntityType.t())
            | nil,
          :source => String.t() | nil
        }
  ...
  field(:followupEventInput,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1EventInput
  )
  ...
  field(:sessionEntityTypes,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SessionEntityType,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1WebhookResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1WebhookResponse.decode(
      value,
      options
    )
  end
