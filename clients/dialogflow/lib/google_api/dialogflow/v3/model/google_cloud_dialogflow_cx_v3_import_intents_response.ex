...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportIntentsResponse do
  @moduledoc """
  ...
  *   `intents` (*type:* `list(String.t)`, *default:* `nil`) - The unique identifier of the imported intents. Format: `projects//locations//agents//intents/`.
  ...
  field(:conflictingResources,
    as:
      GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportIntentsResponseConflictingResources
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportIntentsResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportIntentsResponse.decode(
      value,
      options
    )
  end
