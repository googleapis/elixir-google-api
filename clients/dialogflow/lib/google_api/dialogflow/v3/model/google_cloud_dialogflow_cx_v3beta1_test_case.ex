...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCase do
  @moduledoc """
  ...
  *   `testConfig` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestConfig.t`, *default:* `nil`) - Config for the test case.
  ...
  @type t :: %__MODULE__{
          ...
          :lastTestResult =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCaseResult.t() | nil,
          :name => String.t() | nil,
          :notes => String.t() | nil,
          :tags => list(String.t()) | nil,
          :testCaseConversationTurns =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurn.t())
            | nil,
          :testConfig =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestConfig.t() | nil
        }
  ...
  field(:lastTestResult,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCaseResult
  )
  ...
  field(:testCaseConversationTurns,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurn,
    type: :list
  )

  field(:testConfig, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestConfig)
end

defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCase do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCase.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1TestCase do
