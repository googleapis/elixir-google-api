...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV3alpha1ImportDocumentsResponse.decode(
      value,
      options
    )
  end
