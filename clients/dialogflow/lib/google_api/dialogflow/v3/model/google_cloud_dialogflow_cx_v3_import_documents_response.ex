...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportDocumentsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportDocumentsResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ImportDocumentsResponse.decode(
      value,
      options
    )
  end
