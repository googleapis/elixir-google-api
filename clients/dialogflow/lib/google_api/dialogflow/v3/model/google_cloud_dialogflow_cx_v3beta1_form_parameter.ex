...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameter do
  @moduledoc """
  Represents a form parameter.

  ## Attributes

  *   `advancedSettings` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1AdvancedSettings.t`, *default:* `nil`) - Hierarchical advanced settings for this parameter. The settings exposed at the lower level overrides the settings exposed at the higher level.
  ...
  *   `fillBehavior` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior.t`, *default:* `nil`) - Required. Defines fill behavior for the parameter.
  ...
  *   `required` (*type:* `boolean()`, *default:* `nil`) - Indicates whether the parameter is required. Optional parameters will not trigger prompts; however, they are filled if the user specifies them. Required parameters must be filled before form filling concludes.
  ...
  @type t :: %__MODULE__{
          ...
          :fillBehavior =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior.t()
            | nil,
          :isList => boolean() | nil,
          :redact => boolean() | nil,
  ...
  field(:fillBehavior,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameter do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1FormParameter.decode(
      value,
      options
    )
  end
