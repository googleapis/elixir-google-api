...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SuggestSmartRepliesResponse do
  @moduledoc """
  ...
  *   `smartReplyAnswers` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer.t)`, *default:* `nil`) - Output only. Multiple reply options provided by smart reply service. The order is based on the rank of the model prediction. The maximum number of the returned replies is set in SmartReplyConfig.
  ...
  @type t :: %__MODULE__{
          ...
          :smartReplyAnswers =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer.t()) | nil
        }
  ...
  field(:smartReplyAnswers,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SmartReplyAnswer,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SuggestSmartRepliesResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2SuggestSmartRepliesResponse.decode(
      value,
      options
    )
  end
