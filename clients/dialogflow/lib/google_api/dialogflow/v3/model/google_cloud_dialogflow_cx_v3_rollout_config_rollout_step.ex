...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3RolloutConfigRolloutStep do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3RolloutConfigRolloutStep do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3RolloutConfigRolloutStep.decode(
      value,
      options
    )
  end
