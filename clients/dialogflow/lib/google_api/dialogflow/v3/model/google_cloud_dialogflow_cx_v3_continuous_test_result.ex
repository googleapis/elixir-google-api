...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ContinuousTestResult do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ContinuousTestResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ContinuousTestResult.decode(
      value,
      options
    )
  end
