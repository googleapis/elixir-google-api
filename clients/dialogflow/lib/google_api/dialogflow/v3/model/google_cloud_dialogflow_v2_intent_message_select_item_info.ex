...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSelectItemInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSelectItemInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSelectItemInfo.decode(
      value,
      options
    )
  end
