...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1OriginalDetectIntentRequest.decode(
      value,
      options
    )
  end
