...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1WebhookGenericWebService do
  @moduledoc """
  ...
  *   `webhookType` (*type:* `String.t`, *default:* `nil`) - Optional. Type of the webhook.
  ...
  @type t :: %__MODULE__{
          ...
          :secretVersionsForRequestHeaders =>
            %{
              optional(String.t()) =>
                GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceSecretVersionHeaderValue.t()
            }
            | nil,
  ...
  field(:secretVersionsForRequestHeaders,
    as:
      GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1WebhookGenericWebServiceSecretVersionHeaderValue,
    type: :map
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1WebhookGenericWebService do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1WebhookGenericWebService.decode(
      value,
      options
    )
  end
