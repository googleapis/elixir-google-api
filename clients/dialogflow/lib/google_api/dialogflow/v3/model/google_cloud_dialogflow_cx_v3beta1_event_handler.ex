...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1EventHandler do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1EventHandler do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1EventHandler.decode(
      value,
      options
    )
  end
