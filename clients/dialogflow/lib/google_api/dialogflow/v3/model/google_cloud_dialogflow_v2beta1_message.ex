...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message do
  @moduledoc """
  ...
  *   `sentimentAnalysis` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SentimentAnalysisResult.t`, *default:* `nil`) - Output only. The sentiment analysis result for the message.
  ...
  @type t :: %__MODULE__{
          ...
          :messageAnnotation =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1MessageAnnotation.t() | nil,
          :name => String.t() | nil,
  ...
  field(:messageAnnotation,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1MessageAnnotation
  )
...
defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1Message do
