...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3AudioInput do
  @moduledoc """
  ...
  *   `config` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3InputAudioConfig.t`, *default:* `nil`) - Required. Instructs the speech recognizer how to process the speech audio.
  ...
  @type t :: %__MODULE__{
          :audio => String.t() | nil,
          :config =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3InputAudioConfig.t() | nil
        }

  field(:audio)
  field(:config, as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3InputAudioConfig)
end

defimpl Poison.Decoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3AudioInput do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3AudioInput.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3AudioInput do
