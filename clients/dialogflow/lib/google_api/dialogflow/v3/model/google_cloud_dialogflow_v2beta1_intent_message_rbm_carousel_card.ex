...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard do
  @moduledoc """
  ...
  *   `cardContents` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCardContent.t)`, *default:* `nil`) - Required. The cards in the carousel. A carousel must have at least 2 cards and at most 10.
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentMessageRbmCarouselCard.decode(
      value,
      options
    )
  end
