...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2UndeployConversationModelOperationMetadata.decode(
      value,
      options
    )
  end
