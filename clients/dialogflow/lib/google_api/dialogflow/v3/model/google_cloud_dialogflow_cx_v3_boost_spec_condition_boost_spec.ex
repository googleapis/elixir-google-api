...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3BoostSpecConditionBoostSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3BoostSpecConditionBoostSpec do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3BoostSpecConditionBoostSpec.decode(
      value,
      options
    )
  end
