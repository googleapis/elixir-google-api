...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1IntentFollowupIntentInfo.decode(
      value,
      options
    )
  end
