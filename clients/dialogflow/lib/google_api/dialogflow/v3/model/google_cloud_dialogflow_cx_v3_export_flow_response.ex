...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportFlowResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportFlowResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ExportFlowResponse.decode(
      value,
      options
    )
  end
