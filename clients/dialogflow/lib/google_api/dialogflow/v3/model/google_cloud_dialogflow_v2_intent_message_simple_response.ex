...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSimpleResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSimpleResponse do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2IntentMessageSimpleResponse.decode(
      value,
      options
    )
  end
