...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment.decode(
      value,
      options
    )
  end
