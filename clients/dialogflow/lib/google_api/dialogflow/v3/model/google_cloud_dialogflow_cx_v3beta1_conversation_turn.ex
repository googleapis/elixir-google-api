...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurn do
  @moduledoc """
  ...
  *   `virtualAgentOutput` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutput.t`, *default:* `nil`) - The virtual agent output.
  ...
  field(:userInput,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput
  )

  field(:virtualAgentOutput,
    as:
      GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurnVirtualAgentOutput
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurn do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3beta1ConversationTurn.decode(
      value,
      options
    )
  end
