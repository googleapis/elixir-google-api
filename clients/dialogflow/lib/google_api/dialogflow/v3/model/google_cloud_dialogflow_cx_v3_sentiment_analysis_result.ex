...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3SentimentAnalysisResult do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3SentimentAnalysisResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3SentimentAnalysisResult.decode(
      value,
      options
    )
  end
