...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ConversationModel do
  @moduledoc """
  Represents a conversation model.

  ## Attributes

  *   `articleSuggestionModelMetadata` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ArticleSuggestionModelMetadata.t`, *default:* `nil`) - Metadata for article suggestion models.
  *   `createTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Creation time of this model.
  *   `datasets` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2InputDataset.t)`, *default:* `nil`) - Required. Datasets used to create model.
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. State of the model. A model can only serve prediction requests after it gets deployed.
  ...
  @type t :: %__MODULE__{
          :articleSuggestionModelMetadata =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ArticleSuggestionModelMetadata.t()
            | nil,
          :createTime => DateTime.t() | nil,
          :datasets =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2InputDataset.t()) | nil,
  ...
  field(:articleSuggestionModelMetadata,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ArticleSuggestionModelMetadata
  )

  field(:createTime, as: DateTime)

  field(:datasets,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2InputDataset,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ConversationModel do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2ConversationModel.decode(value, options)
  end
end
