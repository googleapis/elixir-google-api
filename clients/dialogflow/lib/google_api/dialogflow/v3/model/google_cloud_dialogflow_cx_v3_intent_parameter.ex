...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3IntentParameter do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3IntentParameter do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowCxV3IntentParameter.decode(value, options)
  end
end
