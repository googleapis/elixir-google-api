...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1StreamingRecognitionResult do
  @moduledoc """
  ...
  *   `dtmfDigits` (*type:* `GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1TelephonyDtmfEvents.t`, *default:* `nil`) - DTMF digits. Populated if and only if `message_type` = `DTMF_DIGITS`.
  ...
  *   `speechWordInfo` (*type:* `list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo.t)`, *default:* `nil`) - Word-specific information for the words recognized by Speech in transcript. Populated if and only if `message_type` = `TRANSCRIPT` and [InputAudioConfig.enable_word_info] is set.
  ...
  *   `transcript` (*type:* `String.t`, *default:* `nil`) - Transcript text representing the words that the user spoke. Populated if and only if `message_type` = `TRANSCRIPT`.
  ...
  @type t :: %__MODULE__{
          ...
          :dtmfDigits =>
            GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1TelephonyDtmfEvents.t()
            | nil,
          :isFinal => boolean() | nil,
          ...
          :speechWordInfo =>
            list(GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo.t())
            | nil,
  ...
  field(:dtmfDigits,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1TelephonyDtmfEvents
  )
  ...
  field(:speechWordInfo,
    as: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1SpeechWordInfo,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1StreamingRecognitionResult do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2beta1StreamingRecognitionResult.decode(
      value,
      options
    )
  end
