...
defmodule GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2CreateConversationModelEvaluationOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2CreateConversationModelEvaluationOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dialogflow.V3.Model.GoogleCloudDialogflowV2CreateConversationModelEvaluationOperationMetadata.decode(
      value,
      options
    )
  end
