...
defmodule GoogleApi.ServiceDirectory.V1beta1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_registration_policies_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def servicedirectory_projects_locations_registration_policies_get_iam_policy(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_registration_policies_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def servicedirectory_projects_locations_registration_policies_set_iam_policy(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_registration_policies_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def servicedirectory_projects_locations_registration_policies_test_iam_permissions(
        connection,
        resource,
        optional_params \\ [],
        opts \\ []
