...
defmodule GoogleApi.ServiceDirectory.V1beta1.Api.Projects do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:pageSize` (*type:* `integer()`) - Optional. The maximum number of items to return. The default value is 100.
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_namespaces_workloads_get_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_namespaces_workloads_set_iam_policy(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  *   `{:error, info}` on failure
  """
  @spec servicedirectory_projects_locations_namespaces_workloads_test_iam_permissions(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
