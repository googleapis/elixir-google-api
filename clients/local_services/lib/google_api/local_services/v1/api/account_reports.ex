...
defmodule GoogleApi.LocalServices.V1.Api.AccountReports do
  @moduledoc """
  API calls for all endpoints tagged `AccountReports`.
  """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:pageToken` (*type:* `String.t`) - The `next_page_token` value returned from a previous request to SearchAccountReports that indicates where listing should continue. Optional.
  ...
  *   `{:ok, %GoogleApi.LocalServices.V1.Model.GoogleAdsHomeservicesLocalservicesV1SearchAccountReportsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec localservices_account_reports_search(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok,
  ...
  def localservices_account_reports_search(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/accountReports:search", %{})
