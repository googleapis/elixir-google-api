...
defmodule GoogleApi.CloudIdentity.V1.Model.AddIdpCredentialOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudIdentity.V1.Model.AddIdpCredentialOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudIdentity.V1.Model.AddIdpCredentialOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudIdentity.V1.Model.AddIdpCredentialOperationMetadata do
