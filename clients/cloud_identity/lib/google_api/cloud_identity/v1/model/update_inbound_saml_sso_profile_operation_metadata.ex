...
defmodule GoogleApi.CloudIdentity.V1.Model.UpdateInboundSamlSsoProfileOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudIdentity.V1.Model.UpdateInboundSamlSsoProfileOperationMetadata do
  def decode(value, options) do
    GoogleApi.CloudIdentity.V1.Model.UpdateInboundSamlSsoProfileOperationMetadata.decode(
      value,
      options
    )
  end
