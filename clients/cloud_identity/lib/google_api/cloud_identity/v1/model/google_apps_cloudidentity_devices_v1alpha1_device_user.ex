...
defmodule GoogleApi.CloudIdentity.V1.Model.GoogleAppsCloudidentityDevicesV1alpha1DeviceUser do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudIdentity.V1.Model.GoogleAppsCloudidentityDevicesV1alpha1DeviceUser do
  def decode(value, options) do
    GoogleApi.CloudIdentity.V1.Model.GoogleAppsCloudidentityDevicesV1alpha1DeviceUser.decode(
      value,
      options
    )
  end
