...
defimpl Poison.Decoder, for: GoogleApi.CloudIdentity.V1.Model.EndpointApp do
  def decode(value, options) do
    GoogleApi.CloudIdentity.V1.Model.EndpointApp.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudIdentity.V1.Model.EndpointApp do
