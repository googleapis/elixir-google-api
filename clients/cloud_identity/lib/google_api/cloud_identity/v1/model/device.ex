...
defmodule GoogleApi.CloudIdentity.V1.Model.Device do
  @moduledoc """
  A Device within the Cloud Identity Devices API. Represents a Device known to Google Cloud, independent of the device ownership, type, and whether it is assigned or in use by a user.

  ## Attributes

  *   `androidSpecificAttributes` (*type:* `GoogleApi.CloudIdentity.V1.Model.AndroidAttributes.t`, *default:* `nil`) - Output only. Attributes specific to Android devices.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}`, where device_id is the unique id assigned to the Device.
  ...
  *   `wifiMacAddresses` (*type:* `list(String.t)`, *default:* `nil`) - WiFi MAC addresses of device.
  ...
  @type t :: %__MODULE__{
          :androidSpecificAttributes => GoogleApi.CloudIdentity.V1.Model.AndroidAttributes.t(),
          :assetTag => String.t(),
  ...
  field(:androidSpecificAttributes, as: GoogleApi.CloudIdentity.V1.Model.AndroidAttributes)
  field(:assetTag)
...
defimpl Poison.Decoder, for: GoogleApi.CloudIdentity.V1.Model.Device do
  def decode(value, options) do
    GoogleApi.CloudIdentity.V1.Model.Device.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudIdentity.V1.Model.Device do
