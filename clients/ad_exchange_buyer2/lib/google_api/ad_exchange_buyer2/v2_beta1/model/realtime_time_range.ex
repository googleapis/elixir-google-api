...
defmodule GoogleApi.AdExchangeBuyer2.V2BETA1.Model.RealtimeTimeRange do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer2.V2BETA1.Model.RealtimeTimeRange do
