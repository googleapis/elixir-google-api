...
defmodule GoogleApi.PlayIntegrity.V1.Api.DeviceRecall do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec playintegrity_device_recall_write(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def playintegrity_device_recall_write(
        connection,
        package_name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+packageName}/deviceRecall:write", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallResponse{}]
    )
  end
end
