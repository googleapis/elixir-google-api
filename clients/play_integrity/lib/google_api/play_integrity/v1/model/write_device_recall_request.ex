...
defmodule GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallRequest do
  @moduledoc """
  ...
  *   `newValues` (*type:* `GoogleApi.PlayIntegrity.V1.Model.Values.t`, *default:* `nil`) - Required. The new values for the device recall bits to be written.
  ...
  field(:newValues, as: GoogleApi.PlayIntegrity.V1.Model.Values)
end

defimpl Poison.Decoder, for: GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallRequest do
  def decode(value, options) do
    GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.PlayIntegrity.V1.Model.WriteDeviceRecallRequest do
