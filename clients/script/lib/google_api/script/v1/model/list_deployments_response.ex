...
defmodule GoogleApi.Script.V1.Model.ListDeploymentsResponse do
  ...
  - deployments (list(GoogleApi.Script.V1.Model.Deployment.t)): The list of deployments. Defaults to `nil`.
  - nextPageToken (String.t): The token that can be used in the next call to get the next page of
