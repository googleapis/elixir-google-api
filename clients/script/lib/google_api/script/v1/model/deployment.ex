...
defmodule GoogleApi.Script.V1.Model.Deployment do
  ...
  - deploymentId (String.t): The deployment ID for this deployment. Defaults to `nil`.
  - entryPoints (list(GoogleApi.Script.V1.Model.EntryPoint.t)): The deployment's entry points. Defaults to `nil`.
  - updateTime (DateTime.t): Last modified date time stamp. Defaults to `nil`.
  """
