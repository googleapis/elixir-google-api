...
defmodule GoogleApi.Script.V1.Model.DeploymentConfig do
  ...
  - description (String.t): The description for this deployment. Defaults to `nil`.
  - manifestFileName (String.t): The manifest file name for this deployment. Defaults to `nil`.
  - scriptId (String.t): The script project's Drive ID. Defaults to `nil`.
  - versionNumber (integer()): The version number on which this deployment is based. Defaults to `nil`.
  """
