...
defmodule GoogleApi.Script.V1.Model.EntryPoint do
  ...
  - addOn (GoogleApi.Script.V1.Model.GoogleAppsScriptTypeAddOnEntryPoint.t): Add-on properties. Defaults to `nil`.
  - entryPointType (String.t): The type of the entry point. Defaults to `nil`.
  - executionApi (GoogleApi.Script.V1.Model.GoogleAppsScriptTypeExecutionApiEntryPoint.t): An entry point specification for Apps Script API execution calls. Defaults to `nil`.
  - webApp (GoogleApi.Script.V1.Model.GoogleAppsScriptTypeWebAppEntryPoint.t): An entry point specification for web apps. Defaults to `nil`.
  """
