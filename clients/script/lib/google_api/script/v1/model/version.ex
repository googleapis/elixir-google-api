...
defmodule GoogleApi.Script.V1.Model.Version do
  ...
  - createTime (DateTime.t): When the version was created. Defaults to `nil`.
  - description (String.t): The description for this version. Defaults to `nil`.
  ...
  created. This is system assigned number and is immutable once created. Defaults to `nil`.
  """
