...
defmodule GoogleApi.Script.V1.Model.ExecutionError do
  ...
  - errorMessage (String.t): The error message thrown by Apps Script, usually localized into the user's
  language. Defaults to `nil`.
  - errorType (String.t): The error type, for example `TypeError` or `ReferenceError`. If the error
  type is unavailable, this field is not included. Defaults to `nil`.
  - scriptStackTraceElements (list(GoogleApi.Script.V1.Model.ScriptStackTraceElement.t)): An array of objects that provide a stack trace through the script to show
  where the execution failed, with the deepest call first. Defaults to `nil`.
  """
