...
defmodule GoogleApi.Script.Mixfile do
  ...
  def project() do
    [
      ...
      package: package(),
      deps: deps(),
      source_url: "https://github.com/googleapis/elixir-google-api/tree/master/clients/script"
    ]
  end
  ...
  defp description() do
    """
    Client library for Apps Script API from Google. Manages and executes Google Apps Script projects.
