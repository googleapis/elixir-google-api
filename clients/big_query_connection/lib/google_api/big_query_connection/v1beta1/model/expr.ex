...
defmodule GoogleApi.BigQueryConnection.V1beta1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigQueryConnection.V1beta1.Model.Expr do
  def decode(value, options) do
    GoogleApi.BigQueryConnection.V1beta1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQueryConnection.V1beta1.Model.Expr do
