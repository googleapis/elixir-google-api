...
defmodule GoogleApi.AdExperienceReport.V1.Model.ViolatingSitesResponse do
  ...
  *   `violatingSites` (*type:* `list(GoogleApi.AdExperienceReport.V1.Model.SiteSummaryResponse.t)`, *default:* `nil`) - The list of violating sites.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdExperienceReport.V1.Model.ViolatingSitesResponse do
  def decode(value, options) do
    GoogleApi.AdExperienceReport.V1.Model.ViolatingSitesResponse.decode(value, options)
  end
end
