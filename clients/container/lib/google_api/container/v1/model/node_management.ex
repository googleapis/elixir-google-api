...
defmodule GoogleApi.Container.V1.Model.NodeManagement do
  ...
  up to date with the latest release version of Kubernetes. Defaults to `nil`.
  - upgradeOptions (GoogleApi.Container.V1.Model.AutoUpgradeOptions.t): Specifies the Auto Upgrade knobs for the node pool. Defaults to `nil`.
  """
