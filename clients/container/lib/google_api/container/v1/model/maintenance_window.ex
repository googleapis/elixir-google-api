...
defmodule GoogleApi.Container.V1.Model.MaintenanceWindow do
  ...
  - dailyMaintenanceWindow (GoogleApi.Container.V1.Model.DailyMaintenanceWindow.t): DailyMaintenanceWindow specifies a daily maintenance operation window. Defaults to `nil`.
  """
