...
defmodule GoogleApi.Container.V1.Model.NodePoolAutoscaling do
  ...
  *   `maxNodeCount` (*type:* `integer()`, *default:* `nil`) - Maximum number of nodes in the NodePool. Must be >= min_node_count. There has to be enough quota to scale up the cluster.
