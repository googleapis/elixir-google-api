...
defmodule GoogleApi.Container.V1.Model.RBACBindingConfig do
  @moduledoc """
  ...
  *   `enableInsecureBindingSystemUnauthenticated` (*type:* `boolean()`, *default:* `nil`) - Setting this to true will allow any ClusterRoleBinding and RoleBinding with subjets system:anonymous or system:unauthenticated.
  ...
  field(:enableInsecureBindingSystemAuthenticated)
  field(:enableInsecureBindingSystemUnauthenticated)
end

defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.RBACBindingConfig do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.RBACBindingConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.RBACBindingConfig do
