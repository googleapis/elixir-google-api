...
defmodule GoogleApi.Container.V1.Model.IPAllocationPolicy do
  ...
  *   `defaultPodIpv4RangeUtilization` (*type:* `float()`, *default:* `nil`) - Output only. [Output only] The utilization of the cluster default IPv4 range for the pod. The ratio is Usage/[Total number of IPs in the secondary range], Usage=numNodes*numZones*podIPsPerNode.
  ...
  *   `servicesIpv6CidrBlock` (*type:* `String.t`, *default:* `nil`) - Output only. [Output only] The services IPv6 CIDR block for the cluster.
  ...
  *   `subnetIpv6CidrBlock` (*type:* `String.t`, *default:* `nil`) - Output only. [Output only] The subnet's IPv6 CIDR block used by nodes and pods.
