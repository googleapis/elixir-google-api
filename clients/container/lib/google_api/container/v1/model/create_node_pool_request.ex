...
defmodule GoogleApi.Container.V1.Model.CreateNodePoolRequest do
  ...
  *   `parent` (*type:* `String.t`, *default:* `nil`) - The parent (project, location, cluster id) where the node pool will be created. Specified in the format `projects/*/locations/*/clusters/*`.
