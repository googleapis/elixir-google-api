...
defmodule GoogleApi.Container.V1.Model.RollbackNodePoolUpgradeRequest do
  ...
  - clusterId (String.t): Deprecated. The name of the cluster to rollback. This field has been deprecated and replaced by the name field. Defaults to: `null`.
  - name (String.t): The name (project, location, cluster, node pool id) of the node poll to rollback upgrade. Specified in the format &#39;projects/*/locations/*/clusters/*/nodePools/*&#39;. Defaults to: `null`.
  - nodePoolId (String.t): Deprecated. The name of the node pool to rollback. This field has been deprecated and replaced by the name field. Defaults to: `null`.
