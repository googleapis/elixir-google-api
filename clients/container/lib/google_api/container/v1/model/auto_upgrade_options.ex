...
defmodule GoogleApi.Container.V1.Model.AutoUpgradeOptions do
  ...
  - autoUpgradeStartTime (String.t): [Output only] This field is set when upgrades are about to commence
  with the approximate start time for the upgrades, in
  [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) text format. Defaults to `nil`.
  - description (String.t): [Output only] This field is set when upgrades are about to commence
  with the description of the upgrade. Defaults to `nil`.
  """
