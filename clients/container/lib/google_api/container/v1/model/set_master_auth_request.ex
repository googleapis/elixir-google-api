...
defmodule GoogleApi.Container.V1.Model.SetMasterAuthRequest do
  ...
  - action (String.t): The exact form of action to be taken on the master auth. Defaults to: `null`.
    - Enum - one of [UNKNOWN, SET_PASSWORD, GENERATE_PASSWORD, SET_USERNAME]
  ...
  - name (String.t): The name (project, location, cluster) of the cluster to set auth. Specified in the format &#39;projects/*/locations/*/clusters/*&#39;. Defaults to: `null`.
