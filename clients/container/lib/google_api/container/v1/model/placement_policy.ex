...
defmodule GoogleApi.Container.V1.Model.PlacementPolicy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.PlacementPolicy do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.PlacementPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.PlacementPolicy do
