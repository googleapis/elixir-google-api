...
defmodule GoogleApi.Container.V1.Model.SetLegacyAbacRequest do
  ...
  - name (String.t): The name (project, location, cluster id) of the cluster to set legacy abac. Specified in the format &#39;projects/*/locations/*/clusters/*&#39;. Defaults to: `null`.
