...
defmodule GoogleApi.Container.V1.Model.SetLegacyAbacRequest do
  ...
  *   `enabled` (*type:* `boolean()`, *default:* `nil`) - Required. Whether ABAC authorization will be enabled in the cluster.
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name (project, location, cluster name) of the cluster to set legacy abac. Specified in the format `projects/*/locations/*/clusters/*`.
