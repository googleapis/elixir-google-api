...
defmodule GoogleApi.Container.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.Status do
