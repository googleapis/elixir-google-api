...
defmodule GoogleApi.Container.V1.Model.SetLoggingServiceRequest do
  ...
  - loggingService (String.t): The logging service the cluster should use to write metrics. Currently available options:  * \&quot;logging.googleapis.com\&quot; - the Google Cloud Logging service * \&quot;none\&quot; - no metrics will be exported from the cluster Defaults to: `null`.
  - name (String.t): The name (project, location, cluster) of the cluster to set logging. Specified in the format &#39;projects/*/locations/*/clusters/*&#39;. Defaults to: `null`.
