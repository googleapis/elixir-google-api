...
defmodule GoogleApi.Container.V1.Model.CloudRunConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.CloudRunConfig do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.CloudRunConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.CloudRunConfig do
