...
defmodule GoogleApi.Container.V1.Model.ListNodePoolsResponse do
  ...
  - nodePools (list(GoogleApi.Container.V1.Model.NodePool.t)): A list of node pools for a cluster. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.ListNodePoolsResponse do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.ListNodePoolsResponse.decode(value, options)
  end
end
