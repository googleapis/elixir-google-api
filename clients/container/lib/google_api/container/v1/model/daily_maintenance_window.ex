...
defmodule GoogleApi.Container.V1.Model.DailyMaintenanceWindow do
  ...
  *   `duration` (*type:* `String.t`, *default:* `nil`) - [Output only] Duration of the time window, automatically chosen to be
      smallest possible in the given scenario.
      Duration will be in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt)
      format "PTnHnMnS".
  *   `startTime` (*type:* `String.t`, *default:* `nil`) - Time within the maintenance window to start the maintenance operations.
