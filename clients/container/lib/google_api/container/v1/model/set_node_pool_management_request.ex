...
defmodule GoogleApi.Container.V1.Model.SetNodePoolManagementRequest do
  ...
  - clusterId (String.t): Deprecated. The name of the cluster to update. This field has been deprecated and replaced by the name field. Defaults to: `null`.
  - management (NodeManagement): NodeManagement configuration for the node pool. Defaults to: `null`.
  - name (String.t): The name (project, location, cluster, node pool id) of the node pool to set management properties. Specified in the format &#39;projects/*/locations/*/clusters/*/nodePools/*&#39;. Defaults to: `null`.
  - nodePoolId (String.t): Deprecated. The name of the node pool to update. This field has been deprecated and replaced by the name field. Defaults to: `null`.
