...
defmodule GoogleApi.Container.V1.Model.ParentProductConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.ParentProductConfig do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.ParentProductConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.ParentProductConfig do
