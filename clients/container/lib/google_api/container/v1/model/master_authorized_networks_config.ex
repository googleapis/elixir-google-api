...
defmodule GoogleApi.Container.V1.Model.MasterAuthorizedNetworksConfig do
  ...
  - cidrBlocks (list(GoogleApi.Container.V1.Model.CidrBlock.t)): cidr_blocks define up to 50 external networks that could access
  Kubernetes master through HTTPS. Defaults to `nil`.
  - enabled (boolean()): Whether or not master authorized networks is enabled. Defaults to `nil`.
  """
