...
defmodule GoogleApi.Container.V1.Model.NodePoolUpgradeInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Container.V1.Model.NodePoolUpgradeInfo do
  def decode(value, options) do
    GoogleApi.Container.V1.Model.NodePoolUpgradeInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Container.V1.Model.NodePoolUpgradeInfo do
