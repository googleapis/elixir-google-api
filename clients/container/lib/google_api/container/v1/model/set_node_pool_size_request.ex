...
defmodule GoogleApi.Container.V1.Model.SetNodePoolSizeRequest do
  ...
  - name (String.t): The name (project, location, cluster, node pool id) of the node pool to set size. Specified in the format &#39;projects/*/locations/*/clusters/*/nodePools/*&#39;. Defaults to: `null`.
