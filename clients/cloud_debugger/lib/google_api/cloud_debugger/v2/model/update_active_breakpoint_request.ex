...
defmodule GoogleApi.CloudDebugger.V2.Model.UpdateActiveBreakpointRequest do
  ...
  - breakpoint (Breakpoint): Updated breakpoint information. The field &#x60;id&#x60; must be set. The agent must echo all Breakpoint specification fields in the update. Defaults to: `null`.
  """
