...
defmodule GoogleApi.CloudDebugger.V2.Model.RepoId do
  ...
  - projectRepoId (ProjectRepoId): A combination of a project ID and a repo name. Defaults to: `null`.
  - uid (String.t): A server-assigned, globally unique identifier. Defaults to: `null`.
  """
