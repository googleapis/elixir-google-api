...
defmodule GoogleApi.SQLAdmin.V1beta4.Api.Projects do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:parent` (*type:* `String.t`) - The parent resource where Cloud SQL verifies this database instance
  ...
  *   `{:error, info}` on failure
  """
  @spec sql_projects_locations_instances_start_external_sync(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def sql_projects_locations_instances_start_external_sync(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/sql/v1beta4/{+parent}/startExternalSync", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec sql_projects_locations_instances_verify_external_sync_settings(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def sql_projects_locations_instances_verify_external_sync_settings(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/sql/v1beta4/{+parent}/verifyExternalSyncSettings", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
