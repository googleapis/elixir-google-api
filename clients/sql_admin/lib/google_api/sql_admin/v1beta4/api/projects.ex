...
defmodule GoogleApi.SQLAdmin.V1beta4.Api.Projects do
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetDiskShrinkConfigResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec sql_projects_instances_get_disk_shrink_config(
          ...
          {:ok, GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetDiskShrinkConfigResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_projects_instances_get_disk_shrink_config(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetDiskShrinkConfigResponse{}]
    )
  end
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetLatestRecoveryTimeResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_projects_instances_get_latest_recovery_time(
          ...
          {:ok, GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetLatestRecoveryTimeResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_projects_instances_get_latest_recovery_time(
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesGetLatestRecoveryTimeResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.PerformDiskShrinkContext.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_projects_instances_perform_disk_shrink(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/sql/v1beta4/projects/{project}/instances/{instance}/performDiskShrink", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesResetReplicaSizeRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_projects_instances_reset_replica_size(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/sql/v1beta4/projects/{project}/instances/{instance}/resetReplicaSize", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
