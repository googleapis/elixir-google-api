...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.DatabaseFlags do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of the flag. These flags are passed at instance startup, so include both server options and system variables for MySQL. Flags are specified with underscores, not hyphens. For more information, see Configuring Database Flags in the Cloud SQL documentation.
