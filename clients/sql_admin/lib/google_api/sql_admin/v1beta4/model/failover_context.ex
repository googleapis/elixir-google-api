...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.FailoverContext do
  ...
  - kind (String.t): This is always sql#failoverContext. Defaults to: `null`.
  - settingsVersion (String.t): The current settings version of this instance. Request will be rejected if this version doesn&#39;t match the current settings version. Defaults to: `null`.
  """
