...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.MySqlReplicaConfiguration do
  ...
  *   `dumpFilePath` (*type:* `String.t`, *default:* `nil`) - Path to a SQL dump file in Google Cloud Storage from which the replica
  ...
  *   `verifyServerCertificate` (*type:* `boolean()`, *default:* `nil`) - Whether or not to check the master's Common Name value in the certificate
