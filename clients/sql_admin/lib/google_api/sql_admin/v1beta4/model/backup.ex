...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.Backup do
  ...
  *   `instanceSettings` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.DatabaseInstance.t`, *default:* `nil`) - Optional. Output only. Instance setting of the source instance that's associated with this backup.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Output only. The type of this backup. The type can be "AUTOMATED", "ON_DEMAND", or “FINAL”.
  ...
  @type t :: %__MODULE__{
          ...
          :instanceSettings => GoogleApi.SQLAdmin.V1beta4.Model.DatabaseInstance.t() | nil,
          :kind => String.t() | nil,
          :kmsKey => String.t() | nil,
  ...
  field(:instanceSettings, as: GoogleApi.SQLAdmin.V1beta4.Model.DatabaseInstance)
  field(:kind)
  field(:kmsKey)
  field(:kmsKeyVersion)
  field(:location)
