...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.InsightsConfig do
  ...
  *   `queryPlansPerMinute` (*type:* `integer()`, *default:* `nil`) - Number of query plans generated by Insights per minute. Default is 5. Changing this will restart the database.
