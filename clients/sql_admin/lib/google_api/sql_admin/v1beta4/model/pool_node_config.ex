...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.PoolNodeConfig do
  @moduledoc """
  ...
  *   `dnsNames` (*type:* `list(GoogleApi.SQLAdmin.V1beta4.Model.DnsNameMapping.t)`, *default:* `nil`) - Output only. The list of DNS names used by this node.
  *   `gceZone` (*type:* `String.t`, *default:* `nil`) - Output only. The serving zone of the node.
  *   `ipAddresses` (*type:* `list(GoogleApi.SQLAdmin.V1beta4.Model.IpMapping.t)`, *default:* `nil`) - Output only. Mappings containing IP addresses that can be used to connect to the node.
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.PoolNodeConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.PoolNodeConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.PoolNodeConfig do
