...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesVerifyExternalSyncSettingsRequest do
  @moduledoc """


  ## Attributes

  *   `migrationType` (*type:* `String.t`, *default:* `nil`) - Optional. MigrationType field decides if the migration is a physical file based migration or logical migration
...
defimpl Poison.Decoder,
  for: GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesVerifyExternalSyncSettingsRequest do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.SqlInstancesVerifyExternalSyncSettingsRequest.decode(
      value,
      options
    )
  end
