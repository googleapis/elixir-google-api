...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.ConnectionPoolFlags do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.ConnectionPoolFlags do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.ConnectionPoolFlags.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.ConnectionPoolFlags do
