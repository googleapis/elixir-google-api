...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.OperationError do
  ...
  - code (String.t): Identifies the specific error that occurred. Defaults to: `null`.
  - kind (String.t): This is always sql#operationError. Defaults to: `null`.
  - message (String.t): Additional information about the error encountered. Defaults to: `null`.
  """
