...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.SqlActiveDirectoryConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.SqlActiveDirectoryConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.SqlActiveDirectoryConfig do
