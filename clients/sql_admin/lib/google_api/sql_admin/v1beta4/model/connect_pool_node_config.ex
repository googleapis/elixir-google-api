...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.ConnectPoolNodeConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.ConnectPoolNodeConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.ConnectPoolNodeConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.ConnectPoolNodeConfig do
