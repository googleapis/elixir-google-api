...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.InstancesDemoteRequest do
  @moduledoc """
  ...
  *   `demoteContext` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.DemoteContext.t`, *default:* `nil`) - Required. This context is used to demote an existing standalone instance to be a Cloud SQL read replica for an external database server.
  ...
  field(:demoteContext, as: GoogleApi.SQLAdmin.V1beta4.Model.DemoteContext)
end

defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.InstancesDemoteRequest do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.InstancesDemoteRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.InstancesDemoteRequest do
