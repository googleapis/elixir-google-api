...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.ImportContextSqlImportOptionsPostgresImportOptions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SQLAdmin.V1beta4.Model.ImportContextSqlImportOptionsPostgresImportOptions do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.ImportContextSqlImportOptionsPostgresImportOptions.decode(
      value,
      options
    )
  end
