...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.SslCertsInsertResponse do
  ...
  *   `clientCert` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.SslCertDetail.t`, *default:* `nil`) - The new client certificate and private key. For First Generation instances, the new certificate does not take effect until the instance is restarted.
  *   `kind` (*type:* `String.t`, *default:* `sql#sslCertsInsert`) - This is always sql#sslCertsInsert.
