...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.UserPasswordValidationPolicy do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.SQLAdmin.V1beta4.Model.PasswordStatus.t`, *default:* `nil`) - Output only. Read-only password status.
  ...
  field(:status, as: GoogleApi.SQLAdmin.V1beta4.Model.PasswordStatus)
end

defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.UserPasswordValidationPolicy do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.UserPasswordValidationPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.UserPasswordValidationPolicy do
