...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.SslCertDetail do
  ...
  - certPrivateKey (String.t): The private key for the client cert, in pem format. Keep private in order to protect your security. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.SslCertDetail do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.SslCertDetail.decode(value, options)
  end
end
