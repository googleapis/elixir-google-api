...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1beta4.Model.Interval do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1beta4.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1beta4.Model.Interval do
