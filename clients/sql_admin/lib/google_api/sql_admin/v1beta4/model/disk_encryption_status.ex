...
defmodule GoogleApi.SQLAdmin.V1beta4.Model.DiskEncryptionStatus do
  ...
  - kind (String.t): This is always sql#diskEncryptionStatus. Defaults to: `null`.
  - kmsKeyVersionName (String.t): KMS key version used to encrypt the Cloud SQL instance disk Defaults to: `null`.
  """
