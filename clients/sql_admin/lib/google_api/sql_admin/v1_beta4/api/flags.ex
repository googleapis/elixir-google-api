...
defmodule GoogleApi.SQLAdmin.V1BETA4.Api.Flags do
  ...
  """
  @spec sql_flags_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.SQLAdmin.V1BETA4.Model.FlagsListResponse.t} | {:error, Tesla.Env.t}
  def sql_flags_list(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.SQLAdmin.V1BETA4.Model.FlagsListResponse{})
  end
end
