...
defmodule GoogleApi.SQLAdmin.V1.Model.PasswordValidationPolicy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.PasswordValidationPolicy do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.PasswordValidationPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.PasswordValidationPolicy do
