...
defmodule GoogleApi.SQLAdmin.V1.Model.SqlOutOfDiskReport do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.SqlOutOfDiskReport do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.SqlOutOfDiskReport.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.SqlOutOfDiskReport do
