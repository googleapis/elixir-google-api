...
defmodule GoogleApi.SQLAdmin.V1.Model.ConnectSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.ConnectSettings do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ConnectSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.ConnectSettings do
