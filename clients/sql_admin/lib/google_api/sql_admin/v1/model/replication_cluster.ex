...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.ReplicationCluster do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ReplicationCluster.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.ReplicationCluster do
