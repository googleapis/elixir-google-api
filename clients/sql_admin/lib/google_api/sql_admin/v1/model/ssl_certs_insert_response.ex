...
defmodule GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse do
  @moduledoc """
  ...
  *   `serverCaCert` (*type:* `GoogleApi.SQLAdmin.V1.Model.SslCert.t`, *default:* `nil`) - The server Certificate Authority's certificate. If this is missing you can force a new one to be generated by calling resetSslConfig method on instances resource.
  ...
  field(:clientCert, as: GoogleApi.SQLAdmin.V1.Model.SslCertDetail)
  field(:kind)
  field(:operation, as: GoogleApi.SQLAdmin.V1.Model.Operation)
  field(:serverCaCert, as: GoogleApi.SQLAdmin.V1.Model.SslCert)
end

defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse do
