...
defmodule GoogleApi.SQLAdmin.V1.Model.ReplicaConfiguration do
  @moduledoc """
  ...
  *   `mysqlReplicaConfiguration` (*type:* `GoogleApi.SQLAdmin.V1.Model.MySqlReplicaConfiguration.t`, *default:* `nil`) - MySQL specific configuration when replicating from a MySQL on-premises primary instance. Replication configuration information such as the username, password, certificates, and keys are not stored in the instance metadata. The configuration information is used only to set up the replication connection and is stored by MySQL in a file named `master.info` in the data directory.
  ...
  @type t :: %__MODULE__{
          ...
          :mysqlReplicaConfiguration =>
            GoogleApi.SQLAdmin.V1.Model.MySqlReplicaConfiguration.t() | nil
        }

  field(:cascadableReplica)
  field(:failoverTarget)
  field(:kind)
  field(:mysqlReplicaConfiguration, as: GoogleApi.SQLAdmin.V1.Model.MySqlReplicaConfiguration)
end

defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.ReplicaConfiguration do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ReplicaConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.ReplicaConfiguration do
