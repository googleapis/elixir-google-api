...
defmodule GoogleApi.SQLAdmin.V1.Model.BackupContext do
  @moduledoc """
  Backup context.
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.BackupContext do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.BackupContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.BackupContext do
