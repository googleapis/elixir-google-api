...
defmodule GoogleApi.SQLAdmin.V1.Model.ExportContextSqlExportOptionsPostgresExportOptions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SQLAdmin.V1.Model.ExportContextSqlExportOptionsPostgresExportOptions do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ExportContextSqlExportOptionsPostgresExportOptions.decode(
      value,
      options
    )
  end
