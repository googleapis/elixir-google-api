...
defmodule GoogleApi.SQLAdmin.V1.Model.DatabaseInstance do
  ...
  *   `geminiConfig` (*type:* `GoogleApi.SQLAdmin.V1.Model.GeminiInstanceConfig.t`, *default:* `nil`) - Gemini configuration.
  ...
  *   `replicationCluster` (*type:* `GoogleApi.SQLAdmin.V1.Model.ReplicationCluster.t`, *default:* `nil`) - Optional. The pair of a primary instance and disaster recovery (DR) replica. A DR replica is a cross-region replica that you designate for failover in the event that the primary instance has regional failure.
