...
defmodule GoogleApi.SQLAdmin.V1.Model.DatabaseInstance do
  ...
  *   `upgradableDatabaseVersions` (*type:* `list(GoogleApi.SQLAdmin.V1.Model.AvailableDatabaseVersion.t)`, *default:* `nil`) - Output only. All database versions that are available for upgrade.
  ...
  *   `primaryDnsName` (*type:* `String.t`, *default:* `nil`) - Output only. DEPRECATED: please use write_endpoint instead.
  ...
  @type t :: %__MODULE__{
          ...
          :upgradableDatabaseVersions =>
            list(GoogleApi.SQLAdmin.V1.Model.AvailableDatabaseVersion.t()) | nil,
  ...
  field(:upgradableDatabaseVersions,
    as: GoogleApi.SQLAdmin.V1.Model.AvailableDatabaseVersion,
    type: :list
  )
