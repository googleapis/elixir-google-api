...
defmodule GoogleApi.SQLAdmin.V1.Model.SslCert do
  @moduledoc """
  SslCerts Resource
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.SslCert do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.SslCert.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.SslCert do
