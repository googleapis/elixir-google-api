...
defmodule GoogleApi.SQLAdmin.V1.Model.ImportContextBakImportOptionsEncryptionOptions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SQLAdmin.V1.Model.ImportContextBakImportOptionsEncryptionOptions do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ImportContextBakImportOptionsEncryptionOptions.decode(
      value,
      options
    )
  end
