...
defmodule GoogleApi.SQLAdmin.V1.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.Interval do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.Interval do
