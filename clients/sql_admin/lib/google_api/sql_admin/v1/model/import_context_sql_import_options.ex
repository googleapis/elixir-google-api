...
defmodule GoogleApi.SQLAdmin.V1.Model.ImportContextSqlImportOptions do
  @moduledoc """
  ...
  *   `threads` (*type:* `integer()`, *default:* `nil`) - Optional. The number of threads to use for parallel import.
  ...
  field(:postgresImportOptions,
    as: GoogleApi.SQLAdmin.V1.Model.ImportContextSqlImportOptionsPostgresImportOptions
  )

  field(:threads)
end

defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.ImportContextSqlImportOptions do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ImportContextSqlImportOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.ImportContextSqlImportOptions do
