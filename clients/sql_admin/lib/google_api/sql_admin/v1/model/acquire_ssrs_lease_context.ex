...
defmodule GoogleApi.SQLAdmin.V1.Model.AcquireSsrsLeaseContext do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.AcquireSsrsLeaseContext do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.AcquireSsrsLeaseContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.AcquireSsrsLeaseContext do
