...
defmodule GoogleApi.SQLAdmin.V1.Model.Settings do
  ...
  *   `connectionPoolConfig` (*type:* `GoogleApi.SQLAdmin.V1.Model.ConnectionPoolConfig.t`, *default:* `nil`) - Optional. The managed connection pooling configuration for the instance.
  ...
  *   `crashSafeReplicationEnabled` (*type:* `boolean()`, *default:* `nil`) - Configuration specific to read replica instances. Indicates whether database flags for crash-safe replication are enabled. This property was only applicable to First Generation instances.
  ...
  @type t :: %__MODULE__{
          ...
          :connectionPoolConfig => GoogleApi.SQLAdmin.V1.Model.ConnectionPoolConfig.t() | nil,
  ...
  field(:connectionPoolConfig, as: GoogleApi.SQLAdmin.V1.Model.ConnectionPoolConfig)
