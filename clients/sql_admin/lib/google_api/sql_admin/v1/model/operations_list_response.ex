...
defmodule GoogleApi.SQLAdmin.V1.Model.OperationsListResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.OperationsListResponse do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.OperationsListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.OperationsListResponse do
