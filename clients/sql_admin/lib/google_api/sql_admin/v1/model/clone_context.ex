...
defmodule GoogleApi.SQLAdmin.V1.Model.CloneContext do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.CloneContext do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.CloneContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.CloneContext do
