...
defmodule GoogleApi.SQLAdmin.V1.Model.Flag do
  @moduledoc """
  A flag resource.
  ...
  *   `recommendedIntValue` (*type:* `String.t`, *default:* `nil`) - Recommended int value in integer format for UI display.
  *   `recommendedStringValue` (*type:* `String.t`, *default:* `nil`) - Recommended string value in string format for UI display.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - The type of the flag. Flags are typed to being `BOOLEAN`, `STRING`, `INTEGER` or `NONE`. `NONE` is used for flags that do not take a value, such as `skip_grant_tables`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.Flag do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.Flag.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.Flag do
