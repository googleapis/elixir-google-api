...
defmodule GoogleApi.SQLAdmin.V1.Model.GeminiInstanceConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.GeminiInstanceConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.GeminiInstanceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.GeminiInstanceConfig do
