...
defmodule GoogleApi.SQLAdmin.V1.Model.RotateServerCertificateContext do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.RotateServerCertificateContext do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.RotateServerCertificateContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.RotateServerCertificateContext do
