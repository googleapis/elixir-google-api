...
defmodule GoogleApi.SQLAdmin.V1.Model.SyncFlags do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.SyncFlags do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.SyncFlags.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.SyncFlags do
