...
defmodule GoogleApi.SQLAdmin.V1.Model.FailoverContext do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.FailoverContext do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.FailoverContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.FailoverContext do
