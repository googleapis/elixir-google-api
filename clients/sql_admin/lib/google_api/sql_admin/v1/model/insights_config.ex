...
defmodule GoogleApi.SQLAdmin.V1.Model.InsightsConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.InsightsConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.InsightsConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.InsightsConfig do
