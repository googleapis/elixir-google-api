...
defmodule GoogleApi.SQLAdmin.V1.Model.PscAutoConnectionConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.PscAutoConnectionConfig do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.PscAutoConnectionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.PscAutoConnectionConfig do
