...
defmodule GoogleApi.SQLAdmin.V1.Model.DemoteMasterMySqlReplicaConfiguration do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.DemoteMasterMySqlReplicaConfiguration do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.DemoteMasterMySqlReplicaConfiguration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.DemoteMasterMySqlReplicaConfiguration do
