...
defmodule GoogleApi.SQLAdmin.V1.Model.ExportContextTdeExportOptions do
  @moduledoc """
  Optional. Export parameters specific to SQL Server TDE certificates

  ## Attributes

  *   `certificatePath` (*type:* `String.t`, *default:* `nil`) - Required. Path to the TDE certificate public key in the form gs://bucketName/fileName. The instance must have write access to the bucket. Applicable only for SQL Server instances.
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.ExportContextTdeExportOptions do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.ExportContextTdeExportOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.ExportContextTdeExportOptions do
