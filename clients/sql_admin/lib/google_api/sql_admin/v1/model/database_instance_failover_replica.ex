...
defmodule GoogleApi.SQLAdmin.V1.Model.DatabaseInstanceFailoverReplica do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SQLAdmin.V1.Model.DatabaseInstanceFailoverReplica do
  def decode(value, options) do
    GoogleApi.SQLAdmin.V1.Model.DatabaseInstanceFailoverReplica.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SQLAdmin.V1.Model.DatabaseInstanceFailoverReplica do
