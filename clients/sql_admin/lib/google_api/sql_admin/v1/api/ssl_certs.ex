...
defmodule GoogleApi.SQLAdmin.V1.Api.SslCerts do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.SslCertsCreateEphemeralRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.SslCert{}}` on success
  *   `{:error, info}` on failure
  ...
  @spec sql_ssl_certs_create_ephemeral(
          ...
          {:ok, GoogleApi.SQLAdmin.V1.Model.SslCert.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_ssl_certs_create_ephemeral(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/createEphemeral", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.SslCert{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def sql_ssl_certs_delete(
    ...
    request =
      ...
      |> Request.url("/v1/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1),
        "sha1Fingerprint" => URI.encode(sha1_fingerprint, &(URI.char_unreserved?(&1) || &1 == ?/))
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.SslCertsInsertRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_ssl_certs_insert(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_ssl_certs_insert(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/sslCerts", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.SslCertsInsertResponse{}])
  end
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.SslCertsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_ssl_certs_list(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.SslCertsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_ssl_certs_list(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.SslCertsListResponse{}])
  end
end
