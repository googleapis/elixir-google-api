...
defmodule GoogleApi.SQLAdmin.V1.Api.Flags do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.FlagsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_flags_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.FlagsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_flags_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/flags", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.FlagsListResponse{}])
  end
end
