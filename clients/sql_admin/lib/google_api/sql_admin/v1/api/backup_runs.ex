...
defmodule GoogleApi.SQLAdmin.V1.Api.BackupRuns do
  @moduledoc """
  ...
  *   `id` (*type:* `String.t`) - The ID of the backup run to delete. To find a backup run ID, use the [list](https://cloud.google.com/sql/docs/mysql/admin-api/rest/v1/backupRuns/list) method.
  ...
  *   `{:error, info}` on failure
  ...
  def sql_backup_runs_delete(connection, project, instance, id, optional_params \\ [], opts \\ []) do
    ...
    request =
      ...
      |> Request.url("/v1/projects/{project}/instances/{instance}/backupRuns/{id}", %{
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.BackupRun{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_backup_runs_get(
          ...
          {:ok, GoogleApi.SQLAdmin.V1.Model.BackupRun.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_backup_runs_get(connection, project, instance, id, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.BackupRun{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.BackupRun.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_backup_runs_insert(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/backupRuns", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.BackupRunsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_backup_runs_list(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.BackupRunsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_backup_runs_list(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.BackupRunsListResponse{}])
  end
end
