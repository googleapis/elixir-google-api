...
defmodule GoogleApi.SQLAdmin.V1.Api.Operations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def sql_operations_get(connection, project, operation, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/projects/{project}/operations/{operation}", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.OperationsListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_operations_list(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.OperationsListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_operations_list(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/projects/{project}/operations", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.OperationsListResponse{}])
  end
end
