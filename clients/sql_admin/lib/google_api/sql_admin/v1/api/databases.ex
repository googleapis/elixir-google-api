...
defmodule GoogleApi.SQLAdmin.V1.Api.Databases do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def sql_databases_delete(
    ...
    request =
      ...
      |> Request.url("/v1/projects/{project}/instances/{instance}/databases/{database}", %{
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.Database{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_databases_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.SQLAdmin.V1.Model.Database.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_databases_get(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.Database{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.Database.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_databases_insert(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/databases", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.DatabasesListResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_databases_list(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SQLAdmin.V1.Model.DatabasesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_databases_list(connection, project, instance, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.SQLAdmin.V1.Model.DatabasesListResponse{}])
  end
