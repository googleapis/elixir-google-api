...
defmodule GoogleApi.SQLAdmin.V1.Api.Projects do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.SqlInstancesRescheduleMaintenanceRequestBody.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_projects_instances_reschedule_maintenance(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/rescheduleMaintenance", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.SqlInstancesStartExternalSyncRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def sql_projects_instances_start_external_sync(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/startExternalSync", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.SQLAdmin.V1.Model.SqlInstancesVerifyExternalSyncSettingsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.SQLAdmin.V1.Model.SqlInstancesVerifyExternalSyncSettingsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec sql_projects_instances_verify_external_sync_settings(
          ...
          {:ok, GoogleApi.SQLAdmin.V1.Model.SqlInstancesVerifyExternalSyncSettingsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def sql_projects_instances_verify_external_sync_settings(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/projects/{project}/instances/{instance}/verifyExternalSyncSettings", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "instance" => URI.encode(instance, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
    ...
    |> Response.decode(
      opts ++
        [struct: %GoogleApi.SQLAdmin.V1.Model.SqlInstancesVerifyExternalSyncSettingsResponse{}]
    )
  end
end
