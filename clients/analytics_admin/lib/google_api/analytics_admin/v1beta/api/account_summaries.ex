...
defmodule GoogleApi.AnalyticsAdmin.V1beta.Api.AccountSummaries do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaListAccountSummariesResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec analyticsadmin_account_summaries_list(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok,
           GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaListAccountSummariesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def analyticsadmin_account_summaries_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1beta/accountSummaries", %{})
