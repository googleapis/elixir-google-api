...
defmodule GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaAccountSummary do
  @moduledoc """
  ...
  *   `propertySummaries` (*type:* `list(GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaPropertySummary.t)`, *default:* `nil`) - List of summaries for child accounts of this account.
  ...
  @type t :: %__MODULE__{
          ...
          :propertySummaries =>
            list(
              GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaPropertySummary.t()
            )
            | nil
        }
  ...
  field(:propertySummaries,
    as: GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaPropertySummary,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaAccountSummary do
  def decode(value, options) do
    GoogleApi.AnalyticsAdmin.V1beta.Model.GoogleAnalyticsAdminV1betaAccountSummary.decode(
      value,
      options
    )
  end
