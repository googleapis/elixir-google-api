...
defmodule GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEvent do
  @moduledoc """
  ...
  *   `defaultValue` (*type:* `GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEventDefaultValue.t`, *default:* `nil`) - Optional. Defines a default value/currency for a key event.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. Resource name of this key event. Format: properties/{property}/keyEvents/{key_event}
  ...
  @type t :: %__MODULE__{
          ...
          :custom => boolean() | nil,
          :defaultValue =>
            GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEventDefaultValue.t()
            | nil,
  ...
  field(:defaultValue,
    as: GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEventDefaultValue
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEvent do
  def decode(value, options) do
    GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaKeyEvent.decode(
      value,
      options
    )
  end
