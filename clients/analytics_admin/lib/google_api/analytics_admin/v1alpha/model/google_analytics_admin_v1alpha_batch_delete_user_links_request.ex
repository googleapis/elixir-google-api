...
defmodule GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaBatchDeleteUserLinksRequest do
  ...
  *   `requests` (*type:* `list(GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaDeleteUserLinkRequest.t)`, *default:* `nil`) - The requests specifying the user links to update. A maximum of 1000 user links can be updated in a batch.
  """
