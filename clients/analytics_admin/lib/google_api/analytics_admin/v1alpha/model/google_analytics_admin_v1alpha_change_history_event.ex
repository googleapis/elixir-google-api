...
defmodule GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaChangeHistoryEvent do
  @moduledoc """
  ...
  *   `userActorEmail` (*type:* `String.t`, *default:* `nil`) - Email address of the Google account that made the change. This will be a valid email address if the actor field is set to USER, and empty otherwise. Google accounts that have been deleted will cause an error.
  ...
  @type t :: %__MODULE__{
          ...
          :changes =>
            list(
              GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaChangeHistoryChange.t()
            ),
          :changesFiltered => boolean(),
          :id => String.t(),
          :userActorEmail => String.t()
        }
  ...
  field(:changes,
    as: GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaChangeHistoryChange,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaChangeHistoryEvent do
  def decode(value, options) do
    GoogleApi.AnalyticsAdmin.V1alpha.Model.GoogleAnalyticsAdminV1alphaChangeHistoryEvent.decode(
      value,
      options
    )
  end
