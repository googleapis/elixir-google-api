...
defmodule GoogleApi.CloudDeploy.V1.Model.RenderMetadata do
  @moduledoc """
  ...
  *   `custom` (*type:* `GoogleApi.CloudDeploy.V1.Model.CustomMetadata.t`, *default:* `nil`) - Output only. Custom metadata provided by user-defined render operation.
  ...
  field(:cloudRun, as: GoogleApi.CloudDeploy.V1.Model.CloudRunRenderMetadata)
  field(:custom, as: GoogleApi.CloudDeploy.V1.Model.CustomMetadata)
end

defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.RenderMetadata do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.RenderMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.RenderMetadata do
