...
defmodule GoogleApi.CloudDeploy.V1.Model.SkaffoldGCBRepoSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.SkaffoldGCBRepoSource do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.SkaffoldGCBRepoSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.SkaffoldGCBRepoSource do
