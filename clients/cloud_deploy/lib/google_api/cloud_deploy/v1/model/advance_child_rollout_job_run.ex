...
defmodule GoogleApi.CloudDeploy.V1.Model.AdvanceChildRolloutJobRun do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.AdvanceChildRolloutJobRun do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.AdvanceChildRolloutJobRun.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.AdvanceChildRolloutJobRun do
