...
defmodule GoogleApi.CloudDeploy.V1.Model.AdvanceRolloutOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.AdvanceRolloutOperation do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.AdvanceRolloutOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.AdvanceRolloutOperation do
