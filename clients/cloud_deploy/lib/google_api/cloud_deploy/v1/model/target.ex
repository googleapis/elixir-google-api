...
defmodule GoogleApi.CloudDeploy.V1.Model.Target do
  ...
  *   `annotations` (*type:* `map()`, *default:* `nil`) - Optional. User annotations. These attributes can only be set and used by the user, and not by Google Cloud Deploy. See https://google.aip.dev/128#annotations for more details such as format and size limitations.
  ...
  *   `gke` (*type:* `GoogleApi.CloudDeploy.V1.Model.GkeCluster.t`, *default:* `nil`) - Information specifying a GKE Cluster.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Optional. Name of the `Target`. Format is projects/{project}/locations/{location}/ deliveryPipelines/{deliveryPipeline}/targets/a-z{0,62}.
