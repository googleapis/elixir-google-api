...
defmodule GoogleApi.CloudDeploy.V1.Model.Target do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Identifier. Name of the `Target`. Format is `projects/{project}/locations/{location}/targets/{target}`. The `target` component must match `[a-z]([a-z0-9-]{0,61}[a-z0-9])?`
