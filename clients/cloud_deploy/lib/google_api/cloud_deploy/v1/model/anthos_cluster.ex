...
defmodule GoogleApi.CloudDeploy.V1.Model.AnthosCluster do
  ...
  *   `membership` (*type:* `String.t`, *default:* `nil`) - Membership of the GKE Hub registered cluster that the Skaffold configuration should be applied to. Format is `projects/{project}/locations/{location}/memberships/{membership_name}`.
  """
