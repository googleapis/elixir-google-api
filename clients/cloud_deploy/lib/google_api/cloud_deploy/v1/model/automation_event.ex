...
defmodule GoogleApi.CloudDeploy.V1.Model.AutomationEvent do
  @moduledoc """
  Payload proto for "clouddeploy.googleapis.com/automation" Platform Log event that describes the Automation related events.

  ## Attributes

  *   `automation` (*type:* `String.t`, *default:* `nil`) - The name of the `AutomationRun`.
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.AutomationEvent do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.AutomationEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.AutomationEvent do
