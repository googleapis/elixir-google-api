...
defmodule GoogleApi.CloudDeploy.V1.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.AuditLogConfig do
