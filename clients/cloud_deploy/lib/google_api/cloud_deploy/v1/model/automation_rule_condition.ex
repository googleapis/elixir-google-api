...
defmodule GoogleApi.CloudDeploy.V1.Model.AutomationRuleCondition do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.AutomationRuleCondition do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.AutomationRuleCondition.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.AutomationRuleCondition do
