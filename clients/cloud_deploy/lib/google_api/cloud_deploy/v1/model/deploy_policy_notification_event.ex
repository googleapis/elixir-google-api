...
defmodule GoogleApi.CloudDeploy.V1.Model.DeployPolicyNotificationEvent do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudDeploy.V1.Model.DeployPolicyNotificationEvent do
  def decode(value, options) do
    GoogleApi.CloudDeploy.V1.Model.DeployPolicyNotificationEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudDeploy.V1.Model.DeployPolicyNotificationEvent do
