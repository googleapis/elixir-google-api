...
defmodule GoogleApi.HealthCare.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_deidentify(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+sourceDataset}:deidentify", %{
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_check_data_access(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+consentStore}:checkDataAccess", %{
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/consentStores", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_evaluate_user_consents(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+consentStore}:evaluateUserConsents", %{
        "consentStore" => URI.encode(consent_store, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.HealthCare.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Identifier. Resource name of the consent store, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/consentStores/{consent_store_id}`. Cannot be changed after creation.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_query_accessible_data(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+consentStore}:queryAccessibleData", %{
        "consentStore" => URI.encode(consent_store, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_attribute_definitions_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/attributeDefinitions", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_consent_artifacts_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/consentArtifacts", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_consents_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/consents", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_consent_stores_user_data_mappings_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/userDataMappings", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_dicom_stores_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/dicomStores", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_dicom_stores_deidentify(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+sourceStore}:deidentify", %{
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.DicomStoreMetrics{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_dicom_stores_get_dicom_store_metrics(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.DicomStoreMetrics.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_dicom_stores_get_dicom_store_metrics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}:getDICOMStoreMetrics", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.DicomStoreMetrics{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_dicom_stores_search_for_instances(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}/dicomWeb/{+dicomWebPath}", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1),
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.HealthCare.V1.Model.SetBlobStorageSettingsRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_dicom_stores_set_blob_storage_settings(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+resource}:setBlobStorageSettings", %{
        "resource" => URI.encode(resource, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.StudyMetrics{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_get_study_metrics(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.StudyMetrics.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_get_study_metrics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+study}:getStudyMetrics", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.StudyMetrics{}])
  end
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.SeriesMetrics{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_get_series_metrics(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.SeriesMetrics.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_get_series_metrics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+series}:getSeriesMetrics", %{
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.SeriesMetrics{}])
  end
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.StorageInfo{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_instances_get_storage_info(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.StorageInfo.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_instances_get_storage_info(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+resource}:getStorageInfo", %{
        "resource" => URI.encode(resource, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.StorageInfo{}])
  end
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/fhirStores", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.FhirStoreMetrics{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_fhir_stores_get_fhir_store_metrics(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.FhirStoreMetrics.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_fhir_stores_get_fhir_store_metrics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}:getFHIRStoreMetrics", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.FhirStoreMetrics{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.HealthCare.V1.Model.RollbackFhirResourcesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir__binary_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/fhir/Binary", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:end` (*type:* `String.t`) - Optional. The response includes records prior to the end date. The date uses the format YYYY-MM-DD. If no end date is provided, all records subsequent to the start date are in scope.
      *   `:start` (*type:* `String.t`) - Optional. The response includes records subsequent to the start date. The date uses the format YYYY-MM-DD. If no start date is provided, all records prior to the end date are in scope.
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir__patient_everything(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}/$everything", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir__resource_validate(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/fhir/{+type}/$validate", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir_capabilities(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}/fhir/metadata", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir_conditional_delete(
    ...
    request =
      Request.new()
      |> Request.method(:delete)
      |> Request.url("/v1/{+parent}/fhir/{+type}", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1),
        "type" => URI.encode(type, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir_search(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/fhir/_search", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_fhir_stores_fhir_search_type(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/fhir/{resourceType}/_search", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1),
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_hl7_v2_stores_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/hl7V2Stores", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.HealthCare.V1.Model.ExportMessagesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:ok, %GoogleApi.HealthCare.V1.Model.Hl7V2StoreMetrics{}}` on success
  *   `{:error, info}` on failure
  """
  @spec healthcare_projects_locations_datasets_hl7_v2_stores_get_hl7v2_store_metrics(
          ...
          {:ok, GoogleApi.HealthCare.V1.Model.Hl7V2StoreMetrics.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def healthcare_projects_locations_datasets_hl7_v2_stores_get_hl7v2_store_metrics(
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}:getHL7v2StoreMetrics", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.HealthCare.V1.Model.Hl7V2StoreMetrics{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.HealthCare.V1.Model.ImportMessagesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.HealthCare.V1.Model.RollbackHl7V2MessagesRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_datasets_hl7_v2_stores_messages_ingest(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/messages:ingest", %{
        "parent" => URI.encode(parent, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `connection` (*type:* `GoogleApi.HealthCare.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Output only. Resource name of the Message, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/hl7V2Stores/{hl7_v2_store_id}/messages/{message_id}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:error, info}` on failure
  ...
  def healthcare_projects_locations_services_nlp_analyze_entities(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+nlpService}:analyzeEntities", %{
