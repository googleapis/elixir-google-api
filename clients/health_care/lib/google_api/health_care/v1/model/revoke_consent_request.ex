...
defmodule GoogleApi.HealthCare.V1.Model.RevokeConsentRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.RevokeConsentRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.RevokeConsentRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.RevokeConsentRequest do
