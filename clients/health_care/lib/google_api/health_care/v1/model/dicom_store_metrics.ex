...
defmodule GoogleApi.HealthCare.V1.Model.DicomStoreMetrics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.DicomStoreMetrics do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.DicomStoreMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.DicomStoreMetrics do
