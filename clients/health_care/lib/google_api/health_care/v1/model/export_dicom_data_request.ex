...
defmodule GoogleApi.HealthCare.V1.Model.ExportDicomDataRequest do
  ...
  *   `bigqueryDestination` (*type:* `GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomBigQueryDestination.t`, *default:* `nil`) - The BigQuery output destination.
  ...
  *   `gcsDestination` (*type:* `GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomGcsDestination.t`, *default:* `nil`) - The Cloud Storage output destination.
