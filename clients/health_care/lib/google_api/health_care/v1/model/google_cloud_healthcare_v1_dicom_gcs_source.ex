...
defmodule GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomGcsSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomGcsSource do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomGcsSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1DicomGcsSource do
