...
defmodule GoogleApi.HealthCare.V1.Model.FhirStore do
  ...
  *   `notificationConfig` (*type:* `GoogleApi.HealthCare.V1.Model.NotificationConfig.t`, *default:* `nil`) - If non-empty, publish all resource modifications of this FHIR store to
  ...
  *   `streamConfigs` (*type:* `list(GoogleApi.HealthCare.V1.Model.StreamConfig.t)`, *default:* `nil`) - A list of streaming configs that configure the destinations of streaming
