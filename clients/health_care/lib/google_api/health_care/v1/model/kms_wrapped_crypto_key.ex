...
defmodule GoogleApi.HealthCare.V1.Model.KmsWrappedCryptoKey do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.KmsWrappedCryptoKey do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.KmsWrappedCryptoKey.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.KmsWrappedCryptoKey do
