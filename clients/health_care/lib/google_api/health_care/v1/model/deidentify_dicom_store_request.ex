...
defmodule GoogleApi.HealthCare.V1.Model.DeidentifyDicomStoreRequest do
  ...
  *   `config` (*type:* `GoogleApi.HealthCare.V1.Model.DeidentifyConfig.t`, *default:* `nil`) - De-identify configuration.
  *   `destinationStore` (*type:* `String.t`, *default:* `nil`) - The name of the DICOM store to create and write the redacted data to.
      For example,
