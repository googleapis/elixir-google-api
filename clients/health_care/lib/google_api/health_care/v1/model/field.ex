...
defmodule GoogleApi.HealthCare.V1.Model.Field do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.Field do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.Field.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.Field do
