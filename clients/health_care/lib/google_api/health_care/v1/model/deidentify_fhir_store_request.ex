...
defmodule GoogleApi.HealthCare.V1.Model.DeidentifyFhirStoreRequest do
  ...
  *   `resourceFilter` (*type:* `GoogleApi.HealthCare.V1.Model.FhirFilter.t`, *default:* `nil`) - A filter specifying the resources to include in the output. If not
  ...
  @type t :: %__MODULE__{
          ...
          :resourceFilter => GoogleApi.HealthCare.V1.Model.FhirFilter.t()
        }
