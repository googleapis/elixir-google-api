...
defmodule GoogleApi.HealthCare.V1.Model.SchemaGroup do
  @moduledoc """
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of this group. For example, "ORDER_DETAIL".
  ...
  @type t :: %__MODULE__{
          ...
          :members => list(GoogleApi.HealthCare.V1.Model.GroupOrSegment.t()) | nil,
  ...
  field(:choice)
  field(:maxOccurs)
  field(:members, as: GoogleApi.HealthCare.V1.Model.GroupOrSegment, type: :list)
  field(:minOccurs)
  field(:name)
end

defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.SchemaGroup do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.SchemaGroup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.SchemaGroup do
