...
defmodule GoogleApi.HealthCare.V1.Model.InfoTypeTransformation do
  @moduledoc """
  ...
  *   `infoTypes` (*type:* `list(String.t)`, *default:* `nil`) - InfoTypes to apply this transformation to. If this is not specified, the
  ...
  *   `replaceWithInfoTypeConfig` (*type:* `GoogleApi.HealthCare.V1.Model.ReplaceWithInfoTypeConfig.t`, *default:* `nil`) - Config for replace with InfoType.
  ...
  field(:cryptoHashConfig, as: GoogleApi.HealthCare.V1.Model.CryptoHashConfig)
  field(:dateShiftConfig, as: GoogleApi.HealthCare.V1.Model.DateShiftConfig)
  field(:infoTypes, type: :list)
  field(:redactConfig, as: GoogleApi.HealthCare.V1.Model.RedactConfig)
  field(:replaceWithInfoTypeConfig, as: GoogleApi.HealthCare.V1.Model.ReplaceWithInfoTypeConfig)
end

defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.InfoTypeTransformation do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.InfoTypeTransformation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.InfoTypeTransformation do
