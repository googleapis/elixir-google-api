...
defmodule GoogleApi.HealthCare.V1.Model.QueryAccessibleDataRequest do
  @moduledoc """
  ...
  *   `gcsDestination` (*type:* `GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1ConsentGcsDestination.t`, *default:* `nil`) - The Cloud Storage destination. The Cloud Healthcare API service account must have the `roles/storage.objectAdmin` Cloud IAM role for this Cloud Storage location.
  ...
  *   `resourceAttributes` (*type:* `map()`, *default:* `nil`) - Optional. The values of resource attributes associated with the type of resources being requested. If no values are specified, then all resource types are included in the output.
  ...
  @type t :: %__MODULE__{
          :gcsDestination =>
            GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1ConsentGcsDestination.t() | nil,
          :requestAttributes => map() | nil,
          :resourceAttributes => map() | nil
        }

  field(:gcsDestination,
    as: GoogleApi.HealthCare.V1.Model.GoogleCloudHealthcareV1ConsentGcsDestination
  )
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.QueryAccessibleDataRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.QueryAccessibleDataRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.QueryAccessibleDataRequest do
