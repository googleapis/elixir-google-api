...
defmodule GoogleApi.HealthCare.V1.Model.Hl7V2Store do
  ...
  *   `notificationConfigs` (*type:* `list(GoogleApi.HealthCare.V1.Model.Hl7V2NotificationConfig.t)`, *default:* `nil`) - A list of notification configs. Each configuration uses a filter to
  ...
  *   `parserConfig` (*type:* `GoogleApi.HealthCare.V1.Model.ParserConfig.t`, *default:* `nil`) - The configuration for the parser. It determines how the server parses the
      messages.
  *   `rejectDuplicateMessage` (*type:* `boolean()`, *default:* `nil`) - Determines whether to reject duplicate messages. A duplicate
  ...
  @type t :: %__MODULE__{
          :labels => map(),
          :name => String.t(),
          :notificationConfigs => list(GoogleApi.HealthCare.V1.Model.Hl7V2NotificationConfig.t()),
          :parserConfig => GoogleApi.HealthCare.V1.Model.ParserConfig.t(),
