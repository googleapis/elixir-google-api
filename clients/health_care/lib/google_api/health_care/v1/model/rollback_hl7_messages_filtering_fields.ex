...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.RollbackHL7MessagesFilteringFields do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.RollbackHL7MessagesFilteringFields.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.RollbackHL7MessagesFilteringFields do
