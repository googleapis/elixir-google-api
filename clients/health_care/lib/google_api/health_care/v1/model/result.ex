...
defmodule GoogleApi.HealthCare.V1.Model.Result do
  @moduledoc """
  ...
  *   `dataId` (*type:* `String.t`, *default:* `nil`) - The unique identifier of the evaluated resource.
  ...
  @type t :: %__MODULE__{
          :consentDetails => %{
            optional(String.t()) => GoogleApi.HealthCare.V1.Model.ConsentEvaluation.t()
          },
          :consented => boolean(),
          :dataId => String.t()
        }
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.Result do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.Result.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.Result do
