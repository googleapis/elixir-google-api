...
defmodule GoogleApi.HealthCare.V1.Model.RejectConsentRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.RejectConsentRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.RejectConsentRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.RejectConsentRequest do
