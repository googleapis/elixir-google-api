...
defmodule GoogleApi.HealthCare.V1.Model.ImportDicomDataRequest do
  ...
  *   `blobStorageSettings` (*type:* `GoogleApi.HealthCare.V1.Model.BlobStorageSettings.t`, *default:* `nil`) - Optional. The blob storage settings for the data imported by this operation.
