...
defmodule GoogleApi.HealthCare.V1.Model.DeidentifiedStoreDestination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.DeidentifiedStoreDestination do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.DeidentifiedStoreDestination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.DeidentifiedStoreDestination do
