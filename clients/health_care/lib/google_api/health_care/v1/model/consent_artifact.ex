...
defmodule GoogleApi.HealthCare.V1.Model.ConsentArtifact do
  @moduledoc """
  ...
  *   `witnessSignature` (*type:* `GoogleApi.HealthCare.V1.Model.Signature.t`, *default:* `nil`) - Optional. A signature from a witness.
  ...
  @type t :: %__MODULE__{
          :consentContentScreenshots => list(GoogleApi.HealthCare.V1.Model.Image.t()),
          :consentContentVersion => String.t(),
          :guardianSignature => GoogleApi.HealthCare.V1.Model.Signature.t(),
          :metadata => map(),
          :name => String.t(),
          :userId => String.t(),
          :userSignature => GoogleApi.HealthCare.V1.Model.Signature.t(),
          :witnessSignature => GoogleApi.HealthCare.V1.Model.Signature.t()
        }

  field(:consentContentScreenshots, as: GoogleApi.HealthCare.V1.Model.Image, type: :list)
  field(:consentContentVersion)
  field(:guardianSignature, as: GoogleApi.HealthCare.V1.Model.Signature)
  field(:metadata, type: :map)
  field(:name)
  field(:userId)
  field(:userSignature, as: GoogleApi.HealthCare.V1.Model.Signature)
  field(:witnessSignature, as: GoogleApi.HealthCare.V1.Model.Signature)
end

defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1.Model.ConsentArtifact do
  def decode(value, options) do
    GoogleApi.HealthCare.V1.Model.ConsentArtifact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1.Model.ConsentArtifact do
