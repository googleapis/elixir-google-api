...
defmodule GoogleApi.HealthCare.V1beta1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.Status do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.Status do
