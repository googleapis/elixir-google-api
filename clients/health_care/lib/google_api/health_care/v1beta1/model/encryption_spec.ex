...
defmodule GoogleApi.HealthCare.V1beta1.Model.EncryptionSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.EncryptionSpec do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.EncryptionSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.EncryptionSpec do
