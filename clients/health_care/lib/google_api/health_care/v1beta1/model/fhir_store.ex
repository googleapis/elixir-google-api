...
defmodule GoogleApi.HealthCare.V1beta1.Model.FhirStore do
  ...
  *   `enableHistoryModifications` (*type:* `boolean()`, *default:* `nil`) - Optional. Whether to allow ExecuteBundle to accept history bundles, and directly insert and overwrite historical resource versions into the FHIR store. If set to false, using history bundles fails with an error. Defaults to false.
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Required. Immutable. The FHIR specification version that this FHIR store supports natively. This field is immutable after store creation. Requests are rejected if they contain FHIR resources of a different version. Version is required for every FHIR store.
  ...
  field(:consentConfig, as: GoogleApi.HealthCare.V1beta1.Model.ConsentConfig)
  field(:defaultSearchHandlingStrict)
  field(:disableReferentialIntegrity)
  field(:disableResourceVersioning)
  field(:enableHistoryModifications)
