...
defmodule GoogleApi.HealthCare.V1beta1.Model.RollbackHl7V2MessagesRequest do
  @moduledoc """
  ...
  *   `rollbackTime` (*type:* `DateTime.t`, *default:* `nil`) - Required. Times point to rollback to.
  ...
  @type t :: %__MODULE__{
          ...
          :filteringFields =>
            GoogleApi.HealthCare.V1beta1.Model.RollbackHL7MessagesFilteringFields.t() | nil,
          :force => boolean() | nil,
  ...
  field(:filteringFields,
    as: GoogleApi.HealthCare.V1beta1.Model.RollbackHL7MessagesFilteringFields
  )
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.RollbackHl7V2MessagesRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.RollbackHl7V2MessagesRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.RollbackHl7V2MessagesRequest do
