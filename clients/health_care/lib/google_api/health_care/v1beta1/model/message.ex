...
defmodule GoogleApi.HealthCare.V1beta1.Model.Message do
  ...
  *   `schematizedData` (*type:* `GoogleApi.HealthCare.V1beta1.Model.SchematizedData.t`, *default:* `nil`) - The parsed version of the raw message data schematized according to this store's schemas and type definitions.
