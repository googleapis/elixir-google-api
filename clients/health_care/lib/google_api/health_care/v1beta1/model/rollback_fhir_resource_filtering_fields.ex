...
defmodule GoogleApi.HealthCare.V1beta1.Model.RollbackFhirResourceFilteringFields do
  @moduledoc """
  ...
  *   `operationIds` (*type:* `list(String.t)`, *default:* `nil`) - Optional. A list of operation IDs to roll back. Only changes made by these operations will be rolled back.
  """
...
defimpl Poison.Decoder,
  for: GoogleApi.HealthCare.V1beta1.Model.RollbackFhirResourceFilteringFields do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.RollbackFhirResourceFilteringFields.decode(value, options)
  end
end
