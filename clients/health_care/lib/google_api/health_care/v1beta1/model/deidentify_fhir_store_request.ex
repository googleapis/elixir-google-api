...
defmodule GoogleApi.HealthCare.V1beta1.Model.DeidentifyFhirStoreRequest do
  @moduledoc """
  ...
  *   `skipModifiedResources` (*type:* `boolean()`, *default:* `nil`) - If true, skips resources that are created or modified after the de-identify operation is created.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :skipModifiedResources => boolean() | nil
        }
  ...
  field(:skipModifiedResources)
end

defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.DeidentifyFhirStoreRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.DeidentifyFhirStoreRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.DeidentifyFhirStoreRequest do
