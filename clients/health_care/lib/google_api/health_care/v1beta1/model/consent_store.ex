...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.ConsentStore do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.ConsentStore.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.ConsentStore do
