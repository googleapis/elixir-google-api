...
defmodule GoogleApi.HealthCare.V1beta1.Model.AnnotationStore do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Resource name of the Annotation store, of the form `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}`.
  """
