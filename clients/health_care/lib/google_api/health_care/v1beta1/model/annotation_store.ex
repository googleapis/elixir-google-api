...
defmodule GoogleApi.HealthCare.V1beta1.Model.AnnotationStore do
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Optional. User-supplied key-value pairs used to organize Annotation stores.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Resource name of the Annotation store, of the form
