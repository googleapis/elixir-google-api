...
defmodule GoogleApi.HealthCare.V1beta1.Model.Hl7V2StoreMetric do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.Hl7V2StoreMetric do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.Hl7V2StoreMetric.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.Hl7V2StoreMetric do
