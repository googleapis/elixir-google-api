...
defmodule GoogleApi.HealthCare.V1beta1.Model.ProgressCounter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.ProgressCounter do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.ProgressCounter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.ProgressCounter do
