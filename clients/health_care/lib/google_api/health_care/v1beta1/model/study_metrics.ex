...
defmodule GoogleApi.HealthCare.V1beta1.Model.StudyMetrics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.StudyMetrics do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.StudyMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.StudyMetrics do
