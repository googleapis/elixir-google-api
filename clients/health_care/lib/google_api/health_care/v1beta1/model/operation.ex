...
defmodule GoogleApi.HealthCare.V1beta1.Model.Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.HealthCare.V1beta1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.Operation do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.Operation do
