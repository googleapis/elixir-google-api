...
defimpl Poison.Decoder, for: GoogleApi.HealthCare.V1beta1.Model.ImportResourcesRequest do
  def decode(value, options) do
    GoogleApi.HealthCare.V1beta1.Model.ImportResourcesRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.HealthCare.V1beta1.Model.ImportResourcesRequest do
