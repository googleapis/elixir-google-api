...
defmodule GoogleApi.HealthCare.V1beta1.Model.ListDicomStoresResponse do
  ...
  *   `dicomStores` (*type:* `list(GoogleApi.HealthCare.V1beta1.Model.DicomStore.t)`, *default:* `nil`) - The returned DICOM stores. Won't be more DICOM stores than the value of
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Token to retrieve the next page of results or empty if there are no more
  ...
  @type t :: %__MODULE__{
          :dicomStores => list(GoogleApi.HealthCare.V1beta1.Model.DicomStore.t()),
