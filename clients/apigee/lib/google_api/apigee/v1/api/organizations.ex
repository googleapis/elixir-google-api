...
defmodule GoogleApi.Apigee.V1.Api.Organizations do
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Name of the organization in which to create the environment group in the
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the environment group in the following format:
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Name of the organization for which to list environment groups in the
      following format: `organizations/{org}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the environment group to update in the format:
      `organizations/{org}/envgroups/{envgroup}.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - EnvironmentGroup under which to create the attachment in the following
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the environment group attachment to delete in the following format:
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Name of the environment group attachment in the following format:
      `organizations/{org}/envgroups/{envgroup}/attachments/{attachment}`
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
  ...
  *   `connection` (*type:* `GoogleApi.Apigee.V1.Connection.t`) - Connection to server
  *   `parent` (*type:* `String.t`) - Name of the organization in the following format: `organizations/{org}`.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
