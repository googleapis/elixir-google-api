...
defmodule GoogleApi.Apigee.V1.Api.Organizations do
  ...
  *   `{:error, info}` on failure
  ...
  @spec apigee_organizations_environments_get_api_security_runtime_config(
          ...
          {:ok, GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiSecurityRuntimeConfig.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def apigee_organizations_environments_get_api_security_runtime_config(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiSecurityRuntimeConfig{}]
    )
  end
