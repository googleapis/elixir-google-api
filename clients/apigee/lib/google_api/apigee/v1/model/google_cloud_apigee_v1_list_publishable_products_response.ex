...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListPublishableProductsResponse do
  @moduledoc """
  ...
  *   `status` (*type:* `String.t`, *default:* `nil`) - Status of the operation.
  ...
  @type t :: %__MODULE__{
          :data => list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1PortalApiProduct.t()),
          :errorCode => String.t(),
          :message => String.t(),
          :requestId => String.t(),
          :status => String.t()
  ...
  field(:data, as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1PortalApiProduct, type: :list)
  field(:errorCode)
  field(:message)
  field(:requestId)
  field(:status)
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListPublishableProductsResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListPublishableProductsResponse.decode(
      value,
      options
    )
  end
