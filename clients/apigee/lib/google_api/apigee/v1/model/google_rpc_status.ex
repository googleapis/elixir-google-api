...
defmodule GoogleApi.Apigee.V1.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Apigee.V1.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Apigee.V1.Model.GoogleRpcStatus do
