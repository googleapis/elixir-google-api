...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Stats do
  ...
  *   `metaData` (*type:* `GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Metadata.t`, *default:* `nil`) - This field contains the metadata information
  ...
  field(:environments,
    as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1StatsEnvironmentStats,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Stats do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Stats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Stats do
