...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDebugSessionsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDebugSessionsResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDebugSessionsResponse.decode(value, options)
  end
end
