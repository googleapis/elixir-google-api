...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1AsyncQueryResult do
  ...
  *   `self` (*type:* `String.t`, *default:* `nil`) - Self link of the query results. Example: `/organizations/myorg/environments/myenv/queries/9cfc0d85-0f30-46d6-ae6f-318d0cb961bd/result`
  """
