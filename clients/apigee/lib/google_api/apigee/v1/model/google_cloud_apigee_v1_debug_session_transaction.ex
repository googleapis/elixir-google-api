...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1DebugSessionTransaction do
  ...
  *   `point` (*type:* `list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Point.t)`, *default:* `nil`) - List of debug data collected by runtime plane at various defined points in
      the flow.
  """
