...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Instance do
  ...
  *   `diskEncryptionKeyName` (*type:* `String.t`, *default:* `nil`) - Optional. Customer Managed Encryption Key (CMEK) used for disk and volume encryption. If not specified, a Google-Managed encryption key will be used. Use the following format: `projects/([^/]+)/locations/([^/]+)/keyRings/([^/]+)/cryptoKeys/([^/]+)`
