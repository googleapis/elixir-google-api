...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListNatAddressesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListNatAddressesResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListNatAddressesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListNatAddressesResponse do
