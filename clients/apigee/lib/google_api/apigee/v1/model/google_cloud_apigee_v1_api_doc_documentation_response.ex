...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiDocDocumentationResponse do
  @moduledoc """
  ...
  *   `status` (*type:* `String.t`, *default:* `nil`) - Output only. Status of the operation.
  ...
  @type t :: %__MODULE__{
          :data => GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiDocDocumentation.t() | nil,
  ...
  field(:data, as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiDocDocumentation)
  field(:errorCode)
  field(:message)
  field(:requestId)
  field(:status)
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiDocDocumentationResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiDocDocumentationResponse.decode(
      value,
      options
    )
  end
