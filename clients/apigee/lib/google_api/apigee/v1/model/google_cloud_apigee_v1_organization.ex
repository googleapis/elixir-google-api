...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Organization do
  ...
  *   `addonsConfig` (*type:* `GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1AddonsConfig.t`, *default:* `nil`) - Optional. Addon configurations of the Apigee organization.
  ...
  *   `apiConsumerDataEncryptionKeyName` (*type:* `String.t`, *default:* `nil`) - Optional. Cloud KMS key name used for encrypting API consumer data. If not specified or [BillingType](#BillingType) is `EVALUATION`, a Google-Managed encryption key will be used. Format: `projects/*/locations/*/keyRings/*/cryptoKeys/*`
  *   `apiConsumerDataLocation` (*type:* `String.t`, *default:* `nil`) - Optional. This field is needed only for customers using non-default data residency regions. Apigee stores some control plane data only in single region. This field determines which single region Apigee should use. For example: "us-west1" when control plane is in US or "europe-west2" when control plane is in EU.
  ...
  *   `description` (*type:* `String.t`, *default:* `nil`) - Optional. Description of the Apigee organization.
  ...
  *   `displayName` (*type:* `String.t`, *default:* `nil`) - Optional. Display name for the Apigee organization. Unused, but reserved for future use.
