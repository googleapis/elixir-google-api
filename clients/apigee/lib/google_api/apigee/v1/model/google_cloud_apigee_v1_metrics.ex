...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Metrics do
  @moduledoc """
  ...
  *   `status` (*type:* `String.t`, *default:* `nil`) - Status of the operation.
  ...
  @type t :: %__MODULE__{
          :data => GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1MetricsData.t(),
          :errorCode => String.t(),
          :message => String.t(),
          :requestId => String.t(),
          :status => String.t()
  ...
  field(:data, as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1MetricsData)
  field(:errorCode)
  field(:message)
  field(:requestId)
  field(:status)
...
defimpl Poison.Decoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Metrics do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Metrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Metrics do
