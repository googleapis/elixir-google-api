...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Result do
  ...
  *   `ActionResult` (*type:* `String.t`, *default:* `nil`) - Type of the action result. Can be one of the five: DebugInfo,
      RequestMessage, ResponseMessage, ErrorMessage, VariableAccess
  *   `accessList` (*type:* `list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Access.t)`, *default:* `nil`) - A list of variable access actions agaist the api proxy.
      Supported values: Get, Set, Remove.
  *   `content` (*type:* `String.t`, *default:* `nil`) - Error message content. for example,
      "content" : "{\\"fault\\":{\\"faultstring\\":\\"API timed
      out\\",\\"detail\\":{\\"errorcode\\":\\"flow.APITimedOut\\"}}}"
  *   `headers` (*type:* `list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Property.t)`, *default:* `nil`) - A list of HTTP headers.
      for example,
      '"headers" : [ {
        "name" : "Content-Length",
        "value" : "83"
  ...
  *   `timestamp` (*type:* `String.t`, *default:* `nil`) - Timestamp of when the result is recorded. Its format is dd-mm-yy
      hh:mm:ss:xxx. For example, `"timestamp" : "12-08-19 00:31:59:960"`
  *   `uRI` (*type:* `String.t`, *default:* `nil`) - The relative path of the api proxy.
