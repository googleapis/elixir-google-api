...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ApiProduct do
  ...
  *   `approvalType` (*type:* `String.t`, *default:* `nil`) - Specifies how API keys are approved to access the APIs defined by the API
      product.
  ...
  *   `attributes` (*type:* `list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1Attribute.t)`, *default:* `nil`) - Array of attributes that may be used to extend the default API product
      ...
      charges</a>.
  *   `createdAt` (*type:* `String.t`, *default:* `nil`) - Response only. Creation time of this environment as milliseconds since
      epoch.
  *   `description` (*type:* `String.t`, *default:* `nil`) - An overview of the API product. Include key information about the API
      product that is not captured by other fields.
  *   `displayName` (*type:* `String.t`, *default:* `nil`) - The name to be displayed in the UI or developer portal to developers
      registering for API access.
  *   `environments` (*type:* `list(String.t)`, *default:* `nil`) - A comma-separated list of environment names to which the API product is
      ...
      'test'.
  *   `lastModifiedAt` (*type:* `String.t`, *default:* `nil`) - Response only. Modified time of this environment as milliseconds since
      epoch.
  *   `name` (*type:* `String.t`, *default:* `nil`) - The internal name of the API Product. Characters you can use in the name
  ...
  *   `proxies` (*type:* `list(String.t)`, *default:* `nil`) - A comma-separated list of API proxy names to which this API product is
      ...
      creation.</aside>
  *   `quota` (*type:* `String.t`, *default:* `nil`) - The number of request messages permitted per app by this API product for
  ...
  *   `quotaTimeUnit` (*type:* `String.t`, *default:* `nil`) - The time unit defined for the `quotaInterval`. Valid values include minute,
      hour, day, or month.
  *   `scopes` (*type:* `list(String.t)`, *default:* `nil`) - A comma-separated list of OAuth scopes that are validated at runtime.
