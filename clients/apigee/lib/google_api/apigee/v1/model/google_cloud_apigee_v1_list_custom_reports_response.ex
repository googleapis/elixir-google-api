...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListCustomReportsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListCustomReportsResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListCustomReportsResponse.decode(value, options)
  end
end
