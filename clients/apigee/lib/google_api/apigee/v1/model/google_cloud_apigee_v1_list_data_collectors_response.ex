...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDataCollectorsResponse do
  @moduledoc """
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Page token that you can include in a ListDataCollectors request to retrieve the next page. If omitted, no subsequent pages exist.
  ...
  field(:dataCollectors,
    as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1DataCollector,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDataCollectorsResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListDataCollectorsResponse.decode(value, options)
  end
end
