...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityProfileEnvironmentAssociation do
  @moduledoc """
  ...
  *   `securityProfileRevisionId` (*type:* `String.t`, *default:* `nil`) - Revision ID of the security profile.
  ...
  field(:name)
  field(:securityProfileRevisionId)
end

defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityProfileEnvironmentAssociation do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityProfileEnvironmentAssociation.decode(
      value,
      options
    )
  end
