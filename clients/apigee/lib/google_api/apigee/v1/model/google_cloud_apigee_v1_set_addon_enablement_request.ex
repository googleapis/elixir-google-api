...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SetAddonEnablementRequest do
  @moduledoc """
  ...
  *   `apiSecurityEnabled` (*type:* `boolean()`, *default:* `nil`) - If the API Security should be enabled in the environment.
  ...
  field(:apiSecurityEnabled)
end

defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SetAddonEnablementRequest do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SetAddonEnablementRequest.decode(value, options)
  end
end
