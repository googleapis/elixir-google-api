...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityProfilesResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityProfilesResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityProfilesResponse.decode(
      value,
      options
    )
  end
