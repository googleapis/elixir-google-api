...
defmodule GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityReportsResponse do
  @moduledoc """
  ...
  *   `securityReports` (*type:* `list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityReport.t)`, *default:* `nil`) - The security reports belong to requested resource name.
  ...
  @type t :: %__MODULE__{
          ...
          :securityReports =>
            list(GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityReport.t()) | nil
        }

  field(:nextPageToken)

  field(:securityReports,
    as: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1SecurityReport,
    type: :list
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityReportsResponse do
  def decode(value, options) do
    GoogleApi.Apigee.V1.Model.GoogleCloudApigeeV1ListSecurityReportsResponse.decode(
      value,
      options
    )
  end
