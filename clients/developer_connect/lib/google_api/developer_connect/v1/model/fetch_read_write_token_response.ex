...
defmodule GoogleApi.DeveloperConnect.V1.Model.FetchReadWriteTokenResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DeveloperConnect.V1.Model.FetchReadWriteTokenResponse do
  def decode(value, options) do
    GoogleApi.DeveloperConnect.V1.Model.FetchReadWriteTokenResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DeveloperConnect.V1.Model.FetchReadWriteTokenResponse do
