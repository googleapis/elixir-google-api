...
defmodule GoogleApi.DeveloperConnect.V1.Model.ProcessGitLabEnterpriseWebhookRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DeveloperConnect.V1.Model.ProcessGitLabEnterpriseWebhookRequest do
  def decode(value, options) do
    GoogleApi.DeveloperConnect.V1.Model.ProcessGitLabEnterpriseWebhookRequest.decode(
      value,
      options
    )
  end
