...
defmodule GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketCloudWebhookRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketCloudWebhookRequest do
  def decode(value, options) do
    GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketCloudWebhookRequest.decode(value, options)
  end
end
