...
defmodule GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketDataCenterWebhookRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketDataCenterWebhookRequest do
  def decode(value, options) do
    GoogleApi.DeveloperConnect.V1.Model.ProcessBitbucketDataCenterWebhookRequest.decode(
      value,
      options
    )
  end
