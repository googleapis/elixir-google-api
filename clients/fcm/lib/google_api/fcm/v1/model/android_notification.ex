...
defmodule GoogleApi.FCM.V1.Model.AndroidNotification do
  ...
  *   `body` (*type:* `String.t`, *default:* `nil`) - The notification's body text. If present, it will override
      google.firebase.fcm.v1.Notification.body.
  *   `bodyLocArgs` (*type:* `list(String.t)`, *default:* `nil`) - Variable string values to be used in place of the format specifiers in
      body_loc_key to use to localize the body text to the user's current
      localization.
      See [Formatting and Styling](https://goo.gl/MalYE3) for more information.
  *   `bodyLocKey` (*type:* `String.t`, *default:* `nil`) - The key to the body string in the app's string resources to use to localize
      the body text to the user's current localization.
      See [String Resources](https://goo.gl/NdFZGI) for more information.
  *   `channelId` (*type:* `String.t`, *default:* `nil`) - The [notification's channel
      ...
      manifest.
  *   `clickAction` (*type:* `String.t`, *default:* `nil`) - The action associated with a user click on the notification.
  ...
  *   `defaultLightSettings` (*type:* `boolean()`, *default:* `nil`) - If set to true, use the Android framework's default LED light settings for
      ...
      default value.
  *   `defaultSound` (*type:* `boolean()`, *default:* `nil`) - If set to true, use the Android framework's default sound for the
      notification. Default values are specified in
      [config.xml](https://android.googlesource.com/platform/frameworks/base/+/master/core/res/res/values/config.xml).
  *   `defaultVibrateTimings` (*type:* `boolean()`, *default:* `nil`) - If set to true, use the Android framework's default vibrate pattern for the
      notification. Default values are specified in
      [config.xml](https://android.googlesource.com/platform/frameworks/base/+/master/core/res/res/values/config.xml).
      ...
      `vibrate_timings`.
  *   `eventTime` (*type:* `DateTime.t`, *default:* `nil`) - Set the time that the event in the notification occurred. Notifications in
  ...
  *   `icon` (*type:* `String.t`, *default:* `nil`) - The notification's icon.
  ...
  *   `lightSettings` (*type:* `GoogleApi.FCM.V1.Model.LightSettings.t`, *default:* `nil`) - Settings to control the notification's LED blinking rate and color if LED
      is available on the device. The total blinking time is controlled by the
      OS.
  *   `localOnly` (*type:* `boolean()`, *default:* `nil`) - Set whether or not this notification is relevant only to the current
  ...
  *   `notificationCount` (*type:* `integer()`, *default:* `nil`) - Sets the number of items this notification represents. May be displayed as
  ...
  *   `notificationPriority` (*type:* `String.t`, *default:* `nil`) - Set the relative priority for this notification. Priority is an indication
  ...
  *   `sound` (*type:* `String.t`, *default:* `nil`) - The sound to play when the device receives the notification.
      Supports "default" or the filename of a sound resource bundled in the app.
      Sound files must reside in /res/raw/.
  *   `sticky` (*type:* `boolean()`, *default:* `nil`) - When set to false or unset, the notification is automatically
      dismissed when the user clicks it in the panel. When set to true, the
      notification persists even when the user clicks it.
  *   `tag` (*type:* `String.t`, *default:* `nil`) - Identifier used to replace existing notifications in the notification
      drawer.
      If not specified, each request creates a new notification.
      If specified and a notification with the same tag is already being shown,
      the new notification replaces the existing one in the notification drawer.
  *   `ticker` (*type:* `String.t`, *default:* `nil`) - Sets the "ticker" text, which is sent to accessibility services.
      Prior to API level 21 (`Lollipop`), sets the text that is displayed in the
      status bar when the notification first arrives.
  *   `title` (*type:* `String.t`, *default:* `nil`) - The notification's title. If present, it will override
      google.firebase.fcm.v1.Notification.title.
  *   `titleLocArgs` (*type:* `list(String.t)`, *default:* `nil`) - Variable string values to be used in place of the format specifiers in
      title_loc_key to use to localize the title text to the user's current
      localization.
      See [Formatting and Styling](https://goo.gl/MalYE3) for more information.
  *   `titleLocKey` (*type:* `String.t`, *default:* `nil`) - The key to the title string in the app's string resources to use to
      localize the title text to the user's current localization.
      See [String Resources](https://goo.gl/NdFZGI) for more information.
  *   `vibrateTimings` (*type:* `list(String.t)`, *default:* `nil`) - Set the vibration pattern to use. Pass in an array of
  ...
  *   `visibility` (*type:* `String.t`, *default:* `nil`) - Set the
  ...
  @type t :: %__MODULE__{
          :body => String.t(),
          :bodyLocArgs => list(String.t()),
          :bodyLocKey => String.t(),
          :channelId => String.t(),
          :clickAction => String.t(),
          :color => String.t(),
          ...
          :icon => String.t(),
          :image => String.t(),
          :lightSettings => GoogleApi.FCM.V1.Model.LightSettings.t(),
          :localOnly => boolean(),
          :notificationCount => integer(),
          :notificationPriority => String.t(),
          :sound => String.t(),
          :sticky => boolean(),
          :tag => String.t(),
          :ticker => String.t(),
          :title => String.t(),
          :titleLocArgs => list(String.t()),
          :titleLocKey => String.t(),
          :vibrateTimings => list(String.t()),
          :visibility => String.t()
        }
