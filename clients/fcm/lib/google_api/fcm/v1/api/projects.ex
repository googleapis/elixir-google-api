...
defmodule GoogleApi.FCM.V1.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.FCM.V1.Connection
  ...
  *   `{:error, info}` on failure
  ...
  def fcm_projects_messages_send(connection, parent, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1/{+parent}/messages:send", %{
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.FCM.V1.Model.Message{}])
  end
end
