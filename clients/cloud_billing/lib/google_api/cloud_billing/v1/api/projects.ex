...
defmodule GoogleApi.CloudBilling.V1.Api.Projects do
  ...
  - name (String.t): The resource name of the project for which billing information is
  ...
  *open* billing account.
  ...
  - connection (GoogleApi.CloudBilling.V1.Connection): Connection to server
  - name (String.t): The resource name of the project associated with the billing information
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.CloudBilling.V1.Model.ProjectBillingInfo.t): 
