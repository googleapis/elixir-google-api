...
defmodule GoogleApi.APIGateway.V1.Model.ApigatewayLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayLocation do
  def decode(value, options) do
    GoogleApi.APIGateway.V1.Model.ApigatewayLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayLocation do
