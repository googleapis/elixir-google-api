...
defmodule GoogleApi.APIGateway.V1.Model.ApigatewayStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayStatus do
  def decode(value, options) do
    GoogleApi.APIGateway.V1.Model.ApigatewayStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayStatus do
