...
defmodule GoogleApi.APIGateway.V1.Model.ApigatewayAuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayAuditLogConfig do
  def decode(value, options) do
    GoogleApi.APIGateway.V1.Model.ApigatewayAuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayAuditLogConfig do
