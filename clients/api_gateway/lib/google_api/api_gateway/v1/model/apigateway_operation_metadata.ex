...
defmodule GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadata do
  @moduledoc """
  ...
  *   `diagnostics` (*type:* `list(GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadataDiagnostic.t)`, *default:* `nil`) - Output only. Diagnostics generated during processing of configuration source files.
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :diagnostics =>
            list(GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadataDiagnostic.t()) | nil,
  ...
  field(:diagnostics,
    as: GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadataDiagnostic,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadata do
  def decode(value, options) do
    GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayOperationMetadata do
