...
defmodule GoogleApi.APIGateway.V1.Model.ApigatewayExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayExpr do
  def decode(value, options) do
    GoogleApi.APIGateway.V1.Model.ApigatewayExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.APIGateway.V1.Model.ApigatewayExpr do
