...
defmodule GoogleApi.APIGateway.V1alpha2.Model.ApigatewayTestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.APIGateway.V1alpha2.Model.ApigatewayTestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.APIGateway.V1alpha2.Model.ApigatewayTestIamPermissionsRequest.decode(value, options)
  end
end
