...
defmodule GoogleApi.Monitoring.V3.Model.UptimeCheckIp do
  ...
  - ipAddress (String.t): The IP address from which the uptime check originates. This is a full IP address (not an IP address range). Most IP addresses, as of this publication, are in IPv4 format; however, one should not rely on the IP addresses being in IPv4 format indefinitely and should support interpreting this field in either IPv4 or IPv6 format. Defaults to `nil`.
  - location (String.t): A more specific location within the region that typically encodes a particular city/town/metro (and its containing state/province or country) within the broader umbrella region category. Defaults to `nil`.
  - region (String.t): A broad region category in which the IP address is located. Defaults to `nil`.
  """
