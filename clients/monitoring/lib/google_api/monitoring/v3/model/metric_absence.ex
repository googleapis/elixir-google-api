...
defmodule GoogleApi.Monitoring.V3.Model.MetricAbsence do
  ...
  - trigger (GoogleApi.Monitoring.V3.Model.Trigger.t): The number/percent of time series for which the comparison must hold in order for the condition to trigger. If unspecified, then the condition will trigger if the comparison is true for any of the time series that have been identified by filter and aggregations. Defaults to `nil`.
  """
