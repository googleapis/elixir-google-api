...
defmodule GoogleApi.Monitoring.V3.Model.ListAlertPoliciesResponse do
  ...
  - alertPolicies (list(GoogleApi.Monitoring.V3.Model.AlertPolicy.t)): The returned alert policies. Defaults to `nil`.
  - nextPageToken (String.t): If there might be more results than were returned, then this field is set to a non-empty value. To see the additional results, use that value as pageToken in the next call to this method. Defaults to `nil`.
  """
