...
defmodule GoogleApi.Monitoring.V3.Model.ResourceGroup do
  ...
  - groupId (String.t): The group of resources being monitored. Should be only the group_id, not projects/<project_id>/groups/<group_id>. Defaults to `nil`.
  - resourceType (String.t): The resource type of the group members. Defaults to `nil`.
  """
