...
defmodule GoogleApi.Monitoring.V3.Model.AlertPolicy do
  ...
  *   `combiner` (*type:* `String.t`, *default:* `nil`) - How to combine the results of multiple conditions to determine if an incident should be opened.
  *   `conditions` (*type:* `list(GoogleApi.Monitoring.V3.Model.Condition.t)`, *default:* `nil`) - A list of conditions for the policy. The conditions are combined by AND or OR according to the combiner field. If the combined conditions evaluate to true, then an incident is created. A policy can have from one to six conditions.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Required if the policy exists. The resource name for this policy. The syntax is:
