...
defmodule GoogleApi.Monitoring.V3.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Monitoring.V3.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Monitoring.V3.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Monitoring.V3.Model.OperationMetadata do
