...
defmodule GoogleApi.Monitoring.V3.Model.ListGroupMembersResponse do
  ...
  - members (list(GoogleApi.Monitoring.V3.Model.MonitoredResource.t)): A set of monitored resources in the group. Defaults to `nil`.
  ...
  - totalSize (integer()): The total number of elements matching this request. Defaults to `nil`.
  """
