...
defmodule GoogleApi.Monitoring.V3.Model.MonitoredResourceDescriptor do
  ...
  *   `labels` (*type:* `list(GoogleApi.Monitoring.V3.Model.LabelDescriptor.t)`, *default:* `nil`) - Required. A set of labels used to describe instances of this monitored resource type. The label key name must follow:
