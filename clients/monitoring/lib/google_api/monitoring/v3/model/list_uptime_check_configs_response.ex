...
defmodule GoogleApi.Monitoring.V3.Model.ListUptimeCheckConfigsResponse do
  ...
  - nextPageToken (String.t): This field represents the pagination token to retrieve the next page of results. If the value is empty, it means no further results for the request. To retrieve the next page of results, the value of the next_page_token is passed to the subsequent List method call (in the request message's page_token field). Defaults to `nil`.
  - totalSize (integer()): The total number of uptime check configurations for the project, irrespective of any pagination. Defaults to `nil`.
  - uptimeCheckConfigs (list(GoogleApi.Monitoring.V3.Model.UptimeCheckConfig.t)): The returned uptime check configurations. Defaults to `nil`.
  """
