...
defmodule GoogleApi.Monitoring.V3.Model.CreateCollectdTimeSeriesResponse do
  ...
  - payloadErrors (list(GoogleApi.Monitoring.V3.Model.CollectdPayloadError.t)): Records the error status for points that were not written due to an error.Failed requests for which nothing is written will return an error response instead. Defaults to `nil`.
  """
