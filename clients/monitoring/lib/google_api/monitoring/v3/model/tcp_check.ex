...
defmodule GoogleApi.Monitoring.V3.Model.TcpCheck do
  ...
  - port (integer()): The port to the page to run the check against. Will be combined with host (specified within the MonitoredResource) to construct the full URL. Required. Defaults to `nil`.
  """
