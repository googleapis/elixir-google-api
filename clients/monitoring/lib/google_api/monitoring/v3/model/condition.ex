...
defmodule GoogleApi.Monitoring.V3.Model.Condition do
  ...
  *   `conditionTimeSeriesQueryLanguage` (*type:* `GoogleApi.Monitoring.V3.Model.TimeSeriesQueryLanguageCondition.t`, *default:* `nil`) - A condition that uses the Monitoring Query Language to define alerts. If set, no other conditions can be present.
