...
defimpl Poison.Decoder, for: GoogleApi.Monitoring.V3.Model.BucketOptions do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"explicitBuckets", :struct, GoogleApi.Monitoring.V3.Model.Explicit, options)
    |> deserialize(:"exponentialBuckets", :struct, GoogleApi.Monitoring.V3.Model.Exponential, options)
    |> deserialize(:"linearBuckets", :struct, GoogleApi.Monitoring.V3.Model.Linear, options)
  end
end
