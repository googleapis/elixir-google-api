...
defmodule GoogleApi.Monitoring.V3.Model.TimeSeries do
  ...
  *   `unit` (*type:* `String.t`, *default:* `nil`) - The units in which the metric value is reported. It is only applicable if the value_type is INT64, DOUBLE, or DISTRIBUTION. The unit defines the representation of the stored metric values. This field can only be changed through CreateTimeSeries when it is empty or "1".
