...
defmodule GoogleApi.Monitoring.V3.Model.TimeSeries do
  ...
  *   `metadata` (*type:* `GoogleApi.Monitoring.V3.Model.MonitoredResourceMetadata.t`, *default:* `nil`) - Output only. The associated monitored resource metadata. When reading a a timeseries, this field will include metadata labels that are explicitly named in the reduction. When creating a timeseries, this field is ignored.
  ...
  *   `resource` (*type:* `GoogleApi.Monitoring.V3.Model.MonitoredResource.t`, *default:* `nil`) - The associated monitored resource. Custom metrics can use only certain monitored resource types in their time series data.
