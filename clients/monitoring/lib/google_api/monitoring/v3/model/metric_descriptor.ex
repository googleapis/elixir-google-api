...
defmodule GoogleApi.Monitoring.V3.Model.MetricDescriptor do
  ...
  - labels (list(GoogleApi.Monitoring.V3.Model.LabelDescriptor.t)): The set of labels that can be used to describe a specific instance of this metric type. For example, the appengine.googleapis.com/http/server/response_latencies metric type has a label for the HTTP response code, response_code, so you can look at latencies for successful responses or just for responses that failed. Defaults to `nil`.
  - launchStage (String.t): Optional. The launch stage of the metric definition. Defaults to `nil`.
  - metadata (GoogleApi.Monitoring.V3.Model.MetricDescriptorMetadata.t): Optional. Metadata which can be used to guide usage of the metric. Defaults to `nil`.
