...
defmodule GoogleApi.Monitoring.V3.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Monitoring.V3.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.Monitoring.V3.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Monitoring.V3.Model.TimeOfDay do
