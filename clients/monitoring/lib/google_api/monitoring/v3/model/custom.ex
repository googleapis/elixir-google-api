...
defimpl Poison.Decoder, for: GoogleApi.Monitoring.V3.Model.Custom do
  def decode(value, options) do
    GoogleApi.Monitoring.V3.Model.Custom.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Monitoring.V3.Model.Custom do
