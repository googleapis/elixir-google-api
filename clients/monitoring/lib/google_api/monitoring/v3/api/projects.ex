...
defmodule GoogleApi.Monitoring.V3.Api.Projects do
  ...
  @doc """
  Validates a new uptime check configuration, and also executes the Uptime check. The results of the Uptime check are returned, but not stored.

  ## Parameters

  *   `connection` (*type:* `GoogleApi.Monitoring.V3.Connection.t`) - Connection to server
  *   `projects_id` (*type:* `String.t`) - Part of `parent`. The project for the uptime check. The format is projects/[PROJECT_ID].
  ...
  *   `{:ok, %GoogleApi.Monitoring.V3.Model.ValidateUptimeCheckConfigResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec monitoring_projects_validate_uptime_check_config(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.Monitoring.V3.Model.ValidateUptimeCheckConfigResponse.t()}
          | {:error, Tesla.Env.t()}
  def monitoring_projects_validate_uptime_check_config(
        connection,
        projects_id,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v3/projects/{projectsId}:validateUptimeCheckConfig", %{
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.Monitoring.V3.Model.ValidateUptimeCheckConfigResponse{}]
    )
  end
