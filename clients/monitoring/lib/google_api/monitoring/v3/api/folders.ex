...
defmodule GoogleApi.Monitoring.V3.Api.Folders do
  ...
  *   `folders_id` (*type:* `String.t`) - Part of `name`. Required. The project, organization or folder on which to execute the request. The format is: projects/[PROJECT_ID_OR_NUMBER] organizations/[ORGANIZATION_ID] folders/[FOLDER_ID] 
