defmodule GoogleApi.Monitoring.V3.Mixfile do
  use Mix.Project
  ...
  def project do
    [app: :google_api_monitoring,
     ...
     package: package(),
     deps: deps(),
     source_url: "https://github.com/GoogleCloudPlatform/elixir-google-api/tree/master/clients/monitoring"
    ]
  end
  ...
  defp package() do
    [
      ...
      licenses: ["Apache 2.0"],
      links: %{
        "GitHub" => "https://github.com/GoogleCloudPlatform/elixir-google-api/tree/master/clients/monitoring",
