...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListFilteredBidRequestsResponse do
  ...
  - calloutStatusRows ([CalloutStatusRow]): List of rows, with counts of filtered bid requests aggregated by callout status. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve the next page of results. Pass this value in the ListFilteredBidRequestsRequest.pageToken field in the subsequent call to the filteredBidRequests.list method to retrieve the next page of results. Defaults to: `null`.
  """
