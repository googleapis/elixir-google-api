...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.InventorySizeTargeting do
  ...
  - excludedInventorySizes ([AdSize]): A list of inventory sizes to be excluded. Defaults to: `null`.
  - targetedInventorySizes ([AdSize]): A list of inventory sizes to be included. Defaults to: `null`.
  """
