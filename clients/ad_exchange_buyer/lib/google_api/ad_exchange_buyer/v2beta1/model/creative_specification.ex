...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.CreativeSpecification do
  ...
  - creativeCompanionSizes ([AdSize]): Companion sizes may be filled in only when this is a video creative. Defaults to: `null`.
  - creativeSize (AdSize): The size of the creative. Defaults to: `null`.
  """
