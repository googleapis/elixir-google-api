...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.DayPart do
  ...
  - dayOfWeek (String.t): The day of the week to target. If unspecified, applicable to all days. Defaults to: `null`.
    - Enum - one of [DAY_OF_WEEK_UNSPECIFIED, MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY]
  - endTime (TimeOfDay): The ending time of the day for the ad to show (minute level granularity). The end time is exclusive. This field is not available for filtering in PQL queries. Defaults to: `null`.
  - startTime (TimeOfDay): The starting time of day for the ad to show (minute level granularity). The start time is inclusive. This field is not available for filtering in PQL queries. Defaults to: `null`.
  """
