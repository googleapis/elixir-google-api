...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListBidMetricsResponse do
  ...
  - bidMetricsRows ([BidMetricsRow]): List of rows, each containing a set of bid metrics. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve the next page of results. Pass this value in the ListBidMetricsRequest.pageToken field in the subsequent call to the bidMetrics.list method to retrieve the next page of results. Defaults to: `null`.
  """
