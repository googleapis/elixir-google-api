...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.Client do
  ...
  - clientAccountId (String.t): The globally-unique numerical ID of the client.
  The value of this field is ignored in create and update operations. Defaults to `nil`.
  - clientName (String.t): Name used to represent this client to publishers.
  You may have multiple clients that map to the same entity,
  but for each client the combination of `clientName` and entity
  must be unique.
  You can specify this field as empty. Defaults to `nil`.
  - entityId (String.t): Numerical identifier of the client entity.
  ...
  - entityName (String.t): The name of the entity. This field is automatically fetched based on
  the type and ID.
  The value of this field is ignored in create and update operations. Defaults to `nil`.
  - entityType (String.t): The type of the client entity: `ADVERTISER`, `BRAND`, or `AGENCY`. Defaults to `nil`.
  - partnerClientId (String.t): Optional arbitrary unique identifier of this client buyer from the
  ...
  Ad Exchange sponsor buyer. Defaults to `nil`.
  - role (String.t): The role which is assigned to the client buyer. Each role implies a set of
  permissions granted to the client. Must be one of `CLIENT_DEAL_VIEWER`,
  `CLIENT_DEAL_NEGOTIATOR` or `CLIENT_DEAL_APPROVER`. Defaults to `nil`.
  - status (String.t): The status of the client buyer. Defaults to `nil`.
  - visibleToSeller (boolean()): Whether the client buyer will be visible to sellers. Defaults to `nil`.
  """
