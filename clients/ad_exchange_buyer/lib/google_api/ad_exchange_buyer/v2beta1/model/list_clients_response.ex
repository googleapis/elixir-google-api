...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListClientsResponse do
  ...
  - clients ([Client]): The returned list of clients. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve the next page of results. Pass this value in the ListClientsRequest.pageToken field in the subsequent call to the accounts.clients.list method to retrieve the next page of results. Defaults to: `null`.
  """
