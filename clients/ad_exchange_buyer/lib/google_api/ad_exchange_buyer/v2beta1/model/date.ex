...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.Date do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V2beta1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.Date do
