...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListNonBillableWinningBidsResponse do
  ...
  - nonBillableWinningBidStatusRows (list(GoogleApi.AdExchangeBuyer.V2beta1.Model.NonBillableWinningBidStatusRow.t)): List of rows, with counts of bids not billed aggregated by reason. Defaults to `nil`.
  """
