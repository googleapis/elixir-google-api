...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.CreativeDealAssociation do
  ...
  - accountId (String.t): The account the creative belongs to. Defaults to: `null`.
  - creativeId (String.t): The ID of the creative associated with the deal. Defaults to: `null`.
  - dealsId (String.t): The externalDealId for the deal associated with the creative. Defaults to: `null`.
  """
