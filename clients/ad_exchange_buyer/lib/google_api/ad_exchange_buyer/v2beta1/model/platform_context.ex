...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.PlatformContext do
  ...
  - platforms ([String.t]): The platforms this restriction applies to. Defaults to: `null`.
    - Enum - one of 
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.PlatformContext do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V2beta1.Model.PlatformContext.decode(value, options)
  end
end
