...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListFilterSetsResponse do
  ...
  - filterSets ([FilterSet]): The filter sets belonging to the buyer. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve the next page of results. Pass this value in the ListFilterSetsRequest.pageToken field in the subsequent call to the accounts.filterSets.list method to retrieve the next page of results. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V2beta1.Model.ListFilterSetsResponse do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V2beta1.Model.ListFilterSetsResponse.decode(value, options)
  end
end
