...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.FirstPartyMobileApplicationTargeting do
  ...
  - excludedAppIds ([String.t]): A list of application IDs to be excluded. Defaults to: `null`.
  - targetedAppIds ([String.t]): A list of application IDs to be included. Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :excludedAppIds => list(any()),
          :targetedAppIds => list(any())
        }
