...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.AdTechnologyProviders do
  ...
  *   `detectedProviderIds` (*type:* `list(String.t)`, *default:* `nil`) - The detected ad technology provider IDs for this creative.
  ...
  *   `hasUnidentifiedProvider` (*type:* `boolean()`, *default:* `nil`) - Whether the creative contains an unidentified ad technology provider.
