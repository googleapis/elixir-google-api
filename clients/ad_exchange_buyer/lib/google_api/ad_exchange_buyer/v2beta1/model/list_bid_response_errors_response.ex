...
defmodule GoogleApi.AdExchangeBuyer.V2beta1.Model.ListBidResponseErrorsResponse do
  ...
  - calloutStatusRows ([CalloutStatusRow]): List of rows, with counts of bid responses aggregated by callout status. Defaults to: `null`.
  - nextPageToken (String.t): A token to retrieve the next page of results. Pass this value in the ListBidResponseErrorsRequest.pageToken field in the subsequent call to the bidResponseErrors.list method to retrieve the next page of results. Defaults to: `null`.
  """
