...
defmodule GoogleApi.AdExchangeBuyer.V14.Api.Marketplaceprivateauction do
  ...
  """
  @spec adexchangebuyer_marketplaceprivateauction_updateproposal(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def adexchangebuyer_marketplaceprivateauction_updateproposal(connection, private_auction_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
