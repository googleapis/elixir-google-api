...
defmodule GoogleApi.AdExchangeBuyer.V14.Api.BillingInfo do
  ...
  """
  @spec adexchangebuyer_billing_info_get(Tesla.Env.client, Integer.t, keyword()) :: {:ok, GoogleApi.AdExchangeBuyer.V14.Model.BillingInfo.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec adexchangebuyer_billing_info_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.AdExchangeBuyer.V14.Model.BillingInfoList.t} | {:error, Tesla.Env.t}
