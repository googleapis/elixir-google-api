...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.CreativesList do
  ...
  - items ([Creative]): A list of creatives. Defaults to: `null`.
  - kind (String.t): Resource type. Defaults to: `null`.
  - nextPageToken (String.t): Continuation token used to page through creatives. To retrieve the next page of results, set the next request&#39;s \&quot;pageToken\&quot; value to this. Defaults to: `null`.
  """
