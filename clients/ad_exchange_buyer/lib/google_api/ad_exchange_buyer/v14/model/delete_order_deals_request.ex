...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.DeleteOrderDealsRequest do
  ...
  - dealIds ([String.t]): List of deals to delete for a given proposal Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V14.Model.DeleteOrderDealsRequest do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V14.Model.DeleteOrderDealsRequest.decode(value, options)
  end
end
