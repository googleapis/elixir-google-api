...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.PrivateData do
  ...
  - referenceId (String.t):  Defaults to: `null`.
  - referencePayload (binary()):  Defaults to: `null`.
  """
  ...
  field(:referenceId)
  field(:referencePayload)
end

defimpl Poison.Decoder, for: GoogleApi.AdExchangeBuyer.V14.Model.PrivateData do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V14.Model.PrivateData.decode(value, options)
  end
end
