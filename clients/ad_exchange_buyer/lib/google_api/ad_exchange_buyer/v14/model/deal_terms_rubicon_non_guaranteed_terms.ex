...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.DealTermsRubiconNonGuaranteedTerms do
  ...
  field(:standardPrice, as: GoogleApi.AdExchangeBuyer.V14.Model.Price)
end

defimpl Poison.Decoder,
  for: GoogleApi.AdExchangeBuyer.V14.Model.DealTermsRubiconNonGuaranteedTerms do
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V14.Model.DealTermsRubiconNonGuaranteedTerms.decode(value, options)
  end
end
