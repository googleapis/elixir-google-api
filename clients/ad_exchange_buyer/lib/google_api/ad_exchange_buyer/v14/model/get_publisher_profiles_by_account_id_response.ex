...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.GetPublisherProfilesByAccountIdResponse do
  ...
  - profiles ([PublisherProfileApiProto]): Profiles for the requested publisher Defaults to: `null`.
  """
...
defimpl Poison.Decoder,
  ...
  def decode(value, options) do
    GoogleApi.AdExchangeBuyer.V14.Model.GetPublisherProfilesByAccountIdResponse.decode(
      value,
      options
    )
  end
