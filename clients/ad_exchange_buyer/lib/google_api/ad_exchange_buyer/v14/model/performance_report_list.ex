...
defmodule GoogleApi.AdExchangeBuyer.V14.Model.PerformanceReportList do
  ...
  - kind (String.t): Resource type. Defaults to `adexchangebuyer#performanceReportList`.
  - performanceReport (list(GoogleApi.AdExchangeBuyer.V14.Model.PerformanceReport.t)): A list of performance reports relevant for the account. Defaults to `nil`.
  """
