...
defmodule GoogleApi.DNS.V1.Api.DnsKeys do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:digestType` (*type:* `String.t`) - An optional comma-separated list of digest types to compute and display for key signing keys. If omitted, the recommended digest type is computed and displayed.
    ...
    request =
      ...
      |> Request.url(
        ...
        %{
          ...
          "dnsKeyId" => URI.encode(dns_key_id, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
