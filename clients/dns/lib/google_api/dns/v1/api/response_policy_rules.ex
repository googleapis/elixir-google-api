...
defmodule GoogleApi.DNS.V1.Api.ResponsePolicyRules do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_create(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResponsePolicyRule.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_response_policy_rules_create(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules", %{
        "project" => URI.encode(project, &URI.char_unreserved?/1),
        "responsePolicy" => URI.encode(response_policy, &URI.char_unreserved?/1)
      })
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DNS.V1.Model.ResponsePolicyRule{}])
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
    ...
    request =
      ...
      |> Request.url(
        ...
        %{
          ...
          "responsePolicy" => URI.encode(response_policy, &URI.char_unreserved?/1),
          "responsePolicyRule" =>
            URI.encode(response_policy_rule, &(URI.char_unreserved?(&1) || &1 == ?/))
        }
      )
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_list(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResponsePolicyRulesListResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_response_policy_rules_list(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DNS.V1.Model.ResponsePolicyRulesListResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResponsePolicyRulesPatchResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_response_policy_rules_patch(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DNS.V1.Model.ResponsePolicyRulesPatchResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_response_policy_rules_update(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResponsePolicyRulesUpdateResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_response_policy_rules_update(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DNS.V1.Model.ResponsePolicyRulesUpdateResponse{}]
    )
  end
end
