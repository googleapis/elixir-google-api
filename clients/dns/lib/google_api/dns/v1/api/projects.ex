...
defmodule GoogleApi.DNS.V1.Api.Projects do
  ...
  """
  @spec dns_projects_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DNS.V1.Model.Project.t} | {:error, Tesla.Env.t}
  def dns_projects_get(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.DNS.V1.Model.Project{})
  end
end
