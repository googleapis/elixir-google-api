...
defmodule GoogleApi.DNS.V1.Api.Projects do
  ...
  *   `{:error, info}` on failure
  ...
  def dns_projects_get(connection, project, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/dns/v1/projects/{project}", %{
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:clientOperationId` (*type:* `String.t`) - For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
      *   `:body` (*type:* `GoogleApi.DNS.V1.Model.ResourceRecordSet.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.DNS.V1.Model.ResourceRecordSet{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dns_projects_managed_zones_rrsets_create(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResourceRecordSet.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_projects_managed_zones_rrsets_create(
        connection,
        project,
        managed_zone,
        optional_params \\ [],
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.DNS.V1.Model.ResourceRecordSet{}])
  end
  ...
  *   `project` (*type:* `String.t`) - Identifies the project addressed by this request.
  *   `managed_zone` (*type:* `String.t`) - Identifies the managed zone addressed by this request. Can be the managed zone name or ID.
  *   `name` (*type:* `String.t`) - Fully qualified domain name.
  *   `type` (*type:* `String.t`) - RRSet type.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.DNS.V1.Model.ResourceRecordSetsDeleteResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec dns_projects_managed_zones_rrsets_delete(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, GoogleApi.DNS.V1.Model.ResourceRecordSetsDeleteResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def dns_projects_managed_zones_rrsets_delete(
        connection,
        project,
        managed_zone,
        name,
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.DNS.V1.Model.ResourceRecordSetsDeleteResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_projects_managed_zones_rrsets_get(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def dns_projects_managed_zones_rrsets_get(
        connection,
        project,
        managed_zone,
        name,
  ...
  *   `{:error, info}` on failure
  """
  @spec dns_projects_managed_zones_rrsets_patch(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, list()}
          | {:error, any()}
  def dns_projects_managed_zones_rrsets_patch(
        connection,
        project,
        managed_zone,
        name,
