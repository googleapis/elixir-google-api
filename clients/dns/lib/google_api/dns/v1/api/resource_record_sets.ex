...
defmodule GoogleApi.DNS.V1.Api.ResourceRecordSets do
  ...
  """
  @spec dns_resource_record_sets_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DNS.V1.Model.ResourceRecordSetsListResponse.t} | {:error, Tesla.Env.t}
  def dns_resource_record_sets_list(connection, project, managed_zone, opts \\ []) do
    ...
    |> decode(%GoogleApi.DNS.V1.Model.ResourceRecordSetsListResponse{})
  end
end
