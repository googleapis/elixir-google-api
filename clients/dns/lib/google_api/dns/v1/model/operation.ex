...
defmodule GoogleApi.DNS.V1.Model.Operation do
  ...
  *   `id` (*type:* `String.t`, *default:* `nil`) - Unique identifier for the resource. This is the client_operation_id if
  ...
  *   `startTime` (*type:* `String.t`, *default:* `nil`) - The time that this operation was started by the server. This is in RFC3339
      text format (output only).
  *   `status` (*type:* `String.t`, *default:* `nil`) - Status of the operation. Can be one of the following: "PENDING" or "DONE"
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Type of the operation. Operations include insert, update, and delete
      (output only).
  *   `user` (*type:* `String.t`, *default:* `nil`) - User who requested the operation, for example: user@example.com.
