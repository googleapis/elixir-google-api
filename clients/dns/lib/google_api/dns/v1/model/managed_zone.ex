...
defmodule GoogleApi.DNS.V1.Model.ManagedZone do
  ...
  - privateVisibilityConfig (ManagedZonePrivateVisibilityConfig): For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from. Defaults to: `null`.
  - visibility (String.t): The zone&#39;s visibility: public zones are exposed to the Internet, while private zones are visible only to Virtual Private Cloud resources. Defaults to: `null`.
