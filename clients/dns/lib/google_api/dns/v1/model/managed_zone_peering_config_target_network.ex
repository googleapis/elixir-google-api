...
defmodule GoogleApi.DNS.V1.Model.ManagedZonePeeringConfigTargetNetwork do
  ...
  *   `deactivateTime` (*type:* `String.t`, *default:* `nil`) - The time at which the zone was deactivated, in RFC 3339 date-time
  ...
  *   `networkUrl` (*type:* `String.t`, *default:* `nil`) - The fully qualified URL of the VPC network to forward queries to.
