...
defmodule GoogleApi.DNS.V1.Model.ManagedZonePeeringConfigTargetNetwork do
  ...
  *   `deactivateTime` (*type:* `String.t`, *default:* `nil`) - 
  *   `kind` (*type:* `String.t`, *default:* `dns#managedZonePeeringConfigTargetNetwork`) - Identifies what kind of resource this is. Value: the fixed string "dns#managedZonePeeringConfigTargetNetwork".
