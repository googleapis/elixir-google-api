...
defmodule GoogleApi.DNS.V1.Model.Quota do
  ...
  - managedZonesPerNetwork (integer()): Maximum allowed number of managed zones which can be attached to a network. Defaults to: `null`.
  - networksPerManagedZone (integer()): Maximum allowed number of networks to which a privately scoped zone can be attached. Defaults to: `null`.
