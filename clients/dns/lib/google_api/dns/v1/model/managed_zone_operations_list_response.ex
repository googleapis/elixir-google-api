...
defmodule GoogleApi.DNS.V1.Model.ManagedZoneOperationsListResponse do
  ...
  - kind (String.t): Type of resource. Defaults to `dns#managedZoneOperationsListResponse`.
  ...
  - operations (list(GoogleApi.DNS.V1.Model.Operation.t)): The operation resources. Defaults to `nil`.
  """
