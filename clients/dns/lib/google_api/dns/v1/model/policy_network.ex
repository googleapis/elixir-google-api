...
defmodule GoogleApi.DNS.V1.Model.PolicyNetwork do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DNS.V1.Model.PolicyNetwork do
  def decode(value, options) do
    GoogleApi.DNS.V1.Model.PolicyNetwork.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DNS.V1.Model.PolicyNetwork do
