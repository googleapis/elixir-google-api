...
defmodule GoogleApi.DNS.V1.Model.GoogleIamV1AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DNS.V1.Model.GoogleIamV1AuditLogConfig do
  def decode(value, options) do
    GoogleApi.DNS.V1.Model.GoogleIamV1AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DNS.V1.Model.GoogleIamV1AuditLogConfig do
