...
defmodule GoogleApi.Partners.V2.Model.RecaptchaChallenge do
  ...
  - id (String.t): The ID of the reCaptcha challenge. Defaults to: `null`.
  - response (String.t): The response to the reCaptcha challenge. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Partners.V2.Model.RecaptchaChallenge do
  def decode(value, options) do
    GoogleApi.Partners.V2.Model.RecaptchaChallenge.decode(value, options)
  end
end
