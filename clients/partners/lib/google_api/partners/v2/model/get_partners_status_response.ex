...
defimpl Poison.Decoder, for: GoogleApi.Partners.V2.Model.GetPartnersStatusResponse do
  def decode(value, options) do
    GoogleApi.Partners.V2.Model.GetPartnersStatusResponse.decode(value, options)
  end
end
