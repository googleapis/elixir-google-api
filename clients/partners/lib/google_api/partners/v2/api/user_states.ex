...
defmodule GoogleApi.Partners.V2.Api.UserStates do
  ...
  """
  @spec partners_user_states_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Partners.V2.Model.ListUserStatesResponse.t} | {:error, Tesla.Env.t}
  def partners_user_states_list(connection, opts \\ []) do
    optional_params = %{
      :"$.xgafv" => :query,
      :"callback" => :query,
      :"alt" => :query,
    ...
    |> decode(%GoogleApi.Partners.V2.Model.ListUserStatesResponse{})
  end
end
