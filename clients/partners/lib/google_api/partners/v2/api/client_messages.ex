...
defmodule GoogleApi.Partners.V2.Api.ClientMessages do
  @moduledoc """
  ...
  {:ok, %GoogleApi.Partners.V2.Model.LogMessageResponse{}} on success
  {:error, info} on failure
  """
  @spec partners_client_messages_log(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Partners.V2.Model.LogMessageResponse.t} | {:error, Tesla.Env.t}
  def partners_client_messages_log(connection, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v2/clientMessages:log")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Partners.V2.Model.LogMessageResponse{})
  end
end
