...
defmodule GoogleApi.Partners.V2.Api.Leads do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :order_by (String): How to order Leads. Currently, only &#x60;create_time&#x60; and &#x60;create_time desc&#x60; are supported
    ...
    - :page_token (String): A token identifying a page of results that the server returns. Typically, this is the value of &#x60;ListLeadsResponse.next_page_token&#x60; returned from the previous call to ListLeads.
    - :page_size (Integer): Requested page size. Server may return fewer leads than requested. If unspecified, server picks an appropriate default.
  ...
  """
  @spec partners_leads_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.Partners.V2.Model.ListLeadsResponse.t} | {:error, Tesla.Env.t}
  def partners_leads_list(connection, opts \\ []) do
    optional_params = %{
      :"$.xgafv" => :query,
      :"callback" => :query,
      :"alt" => :query,
    ...
    |> decode(%GoogleApi.Partners.V2.Model.ListLeadsResponse{})
  end
end
