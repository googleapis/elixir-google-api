...
defmodule GoogleApi.IAMCredentials.V1.Api.Projects do
  ...
  *   `connection` (*type:* `GoogleApi.IAMCredentials.V1.Connection.t`) - Connection to server
  *   `name` (*type:* `String.t`) - Required. Resource name of service account.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      *   `:alt` (*type:* `String.t`) - Data format for response.
  ...
  *   `{:ok, %GoogleApi.IAMCredentials.V1.Model.ServiceAccountAllowedLocations{}}` on success
  *   `{:error, info}` on failure
  """
  @spec iamcredentials_projects_service_accounts_get_allowed_locations(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
        ) ::
          {:ok, GoogleApi.IAMCredentials.V1.Model.ServiceAccountAllowedLocations.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def iamcredentials_projects_service_accounts_get_allowed_locations(
        connection,
        name,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+name}/allowedLocations", %{
        "name" => URI.encode(name, &URI.char_unreserved?/1)
      })
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.IAMCredentials.V1.Model.ServiceAccountAllowedLocations{}]
    )
  end
