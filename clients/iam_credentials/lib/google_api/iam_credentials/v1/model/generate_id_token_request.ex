...
defmodule GoogleApi.IAMCredentials.V1.Model.GenerateIdTokenRequest do
  ...
  - audience (String.t): The audience for the token, such as the API or account that this token
  grants access to. Defaults to `nil`.
  ...
  - includeEmail (boolean()): Include the service account email in the token. If set to `true`, the
  token will contain `email` and `email_verified` claims. Defaults to `nil`.
  """
