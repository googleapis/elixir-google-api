...
defmodule GoogleApi.IAMCredentials.V1.Model.GenerateAccessTokenResponse do
  ...
  - accessToken (String.t): The OAuth 2.0 access token. Defaults to: `null`.
  - expireTime (DateTime.t): Token expiration time. The expiration time is always set. Defaults to: `null`.
  """
