...
defmodule GoogleApi.IAMCredentials.V1.Model.GenerateAccessTokenRequest do
  ...
  *   `lifetime` (*type:* `String.t`, *default:* `nil`) - The desired lifetime duration of the access token in seconds. Must be set to a value less than or equal to 3600 (1 hour). If a value is not specified, the token's lifetime will be set to a default value of one hour.
