...
defmodule GoogleApi.DeploymentManager.V2.Model.OperationErrorErrors do
  ...
  *   `message` (*type:* `String.t`, *default:* `nil`) - [Output Only] An optional, human-readable error message.
  ...
  @type t :: %__MODULE__{
          ...
          :errorDetails =>
            list(GoogleApi.DeploymentManager.V2.Model.OperationErrorErrorsErrorDetails.t()) | nil,
  ...
  field(:errorDetails,
    as: GoogleApi.DeploymentManager.V2.Model.OperationErrorErrorsErrorDetails,
    type: :list
  )
