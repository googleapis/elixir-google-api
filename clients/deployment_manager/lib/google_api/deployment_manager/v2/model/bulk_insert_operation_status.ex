...
defmodule GoogleApi.DeploymentManager.V2.Model.BulkInsertOperationStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DeploymentManager.V2.Model.BulkInsertOperationStatus do
  def decode(value, options) do
    GoogleApi.DeploymentManager.V2.Model.BulkInsertOperationStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DeploymentManager.V2.Model.BulkInsertOperationStatus do
