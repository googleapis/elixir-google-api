...
defmodule GoogleApi.DeploymentManager.V2.Model.Type do
  ...
  - name (String.t): Name of the type. Defaults to `nil`.
  - operation (GoogleApi.DeploymentManager.V2.Model.Operation.t): Output only. The Operation that most recently ran, or is currently running, on this type. Defaults to `nil`.
