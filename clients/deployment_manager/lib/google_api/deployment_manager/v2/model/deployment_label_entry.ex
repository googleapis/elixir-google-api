...
defimpl Poison.Decoder, for: GoogleApi.DeploymentManager.V2.Model.DeploymentLabelEntry do
  def decode(value, options) do
    GoogleApi.DeploymentManager.V2.Model.DeploymentLabelEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DeploymentManager.V2.Model.DeploymentLabelEntry do
