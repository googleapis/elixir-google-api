...
defimpl Poison.Decoder, for: GoogleApi.DeploymentManager.V2.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.DeploymentManager.V2.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DeploymentManager.V2.Model.AuditLogConfig do
