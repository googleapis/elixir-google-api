...
defmodule GoogleApi.DeploymentManager.V2.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DeploymentManager.V2.Model.Status do
  def decode(value, options) do
    GoogleApi.DeploymentManager.V2.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DeploymentManager.V2.Model.Status do
