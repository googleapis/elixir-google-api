...
defimpl Poison.Decoder, for: GoogleApi.DeploymentManager.V2.Model.Rule do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"conditions", :list, GoogleApi.DeploymentManager.V2.Model.Condition, options)
    |> deserialize(:"logConfigs", :list, GoogleApi.DeploymentManager.V2.Model.LogConfig, options)
  end
end
