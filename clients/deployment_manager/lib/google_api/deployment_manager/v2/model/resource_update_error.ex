...
defmodule GoogleApi.DeploymentManager.V2.Model.ResourceUpdateError do
  ...
  - errors (list(GoogleApi.DeploymentManager.V2.Model.ResourceUpdateErrorErrors.t)): [Output Only] The array of errors encountered while processing this operation. Defaults to `nil`.
  """
