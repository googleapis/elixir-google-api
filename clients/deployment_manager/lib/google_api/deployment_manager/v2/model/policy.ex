...
defmodule GoogleApi.DeploymentManager.V2.Model.Policy do
  ...
  *   `auditConfigs` (*type:* `list(GoogleApi.DeploymentManager.V2.Model.AuditConfig.t)`, *default:* `nil`) - Specifies cloud audit logging configuration for this policy.
  *   `bindings` (*type:* `list(GoogleApi.DeploymentManager.V2.Model.Binding.t)`, *default:* `nil`) - Associates a list of `members` to a `role`. Optionally, may specify a `condition` that determines how and when the `bindings` are applied. Each of the `bindings` must contain at least one member.
