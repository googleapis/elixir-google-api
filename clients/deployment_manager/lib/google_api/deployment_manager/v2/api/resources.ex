...
defmodule GoogleApi.DeploymentManager.V2.Api.Resources do
  ...
  """
  @spec deploymentmanager_resources_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.DeploymentManager.V2.Model.Resource.t} | {:error, Tesla.Env.t}
  def deploymentmanager_resources_get(connection, project, deployment, resource, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/deployments/#{deployment}/resources/#{resource}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DeploymentManager.V2.Model.Resource{})
  end
  ...
  {:error, info} on failure
  """
  @spec deploymentmanager_resources_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DeploymentManager.V2.Model.ResourcesListResponse.t} | {:error, Tesla.Env.t}
  def deploymentmanager_resources_list(connection, project, deployment, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/deployments/#{deployment}/resources")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DeploymentManager.V2.Model.ResourcesListResponse{})
  end
end
