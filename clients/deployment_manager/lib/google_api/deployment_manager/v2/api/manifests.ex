...
defmodule GoogleApi.DeploymentManager.V2.Api.Manifests do
  ...
  """
  @spec deploymentmanager_manifests_get(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, GoogleApi.DeploymentManager.V2.Model.Manifest.t} | {:error, Tesla.Env.t}
  def deploymentmanager_manifests_get(connection, project, deployment, manifest, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/deployments/#{deployment}/manifests/#{manifest}")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DeploymentManager.V2.Model.Manifest{})
  end
  ...
  {:error, info} on failure
  """
  @spec deploymentmanager_manifests_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, GoogleApi.DeploymentManager.V2.Model.ManifestsListResponse.t} | {:error, Tesla.Env.t}
  def deploymentmanager_manifests_list(connection, project, deployment, opts \\ []) do
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/deployments/#{deployment}/manifests")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DeploymentManager.V2.Model.ManifestsListResponse{})
  end
end
