...
defmodule GoogleApi.DeploymentManager.V2.Api.Types do
  @moduledoc """
  ...
  {:ok, %GoogleApi.DeploymentManager.V2.Model.TypesListResponse{}} on success
  {:error, info} on failure
  """
  @spec deploymentmanager_types_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.DeploymentManager.V2.Model.TypesListResponse.t} | {:error, Tesla.Env.t}
  def deploymentmanager_types_list(connection, project, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    %{}
    |> method(:get)
    |> url("/#{project}/global/types")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.DeploymentManager.V2.Model.TypesListResponse{})
  end
end
