...
defmodule GoogleApi.DeploymentManager.V2.Api.Deployments do
  ...
  def deploymentmanager_deployments_get(connection, project, deployment, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.DeploymentManager.V2.Model.Deployment{})
  end
  ...
  def deploymentmanager_deployments_get_iam_policy(connection, project, resource, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.DeploymentManager.V2.Model.Policy{})
  end
  ...
  def deploymentmanager_deployments_list(connection, project, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.DeploymentManager.V2.Model.DeploymentsListResponse{})
  end
  ...
  def deploymentmanager_deployments_test_iam_permissions(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.DeploymentManager.V2.Model.TestPermissionsResponse{})
  end
