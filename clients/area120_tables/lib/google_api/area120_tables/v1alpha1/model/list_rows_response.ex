...
defmodule GoogleApi.Area120Tables.V1alpha1.Model.ListRowsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Area120Tables.V1alpha1.Model.ListRowsResponse do
  def decode(value, options) do
    GoogleApi.Area120Tables.V1alpha1.Model.ListRowsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Area120Tables.V1alpha1.Model.ListRowsResponse do
