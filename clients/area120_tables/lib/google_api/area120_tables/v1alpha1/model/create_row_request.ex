...
defmodule GoogleApi.Area120Tables.V1alpha1.Model.CreateRowRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Area120Tables.V1alpha1.Model.CreateRowRequest do
  def decode(value, options) do
    GoogleApi.Area120Tables.V1alpha1.Model.CreateRowRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Area120Tables.V1alpha1.Model.CreateRowRequest do
