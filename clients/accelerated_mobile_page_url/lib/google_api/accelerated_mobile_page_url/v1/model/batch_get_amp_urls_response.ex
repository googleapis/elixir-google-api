...
defmodule GoogleApi.AcceleratedMobilePageUrl.V1.Model.BatchGetAmpUrlsResponse do
  ...
  - ampUrls ([AmpUrl]): For each URL in BatchAmpUrlsRequest, the URL response. The response might not be in the same order as URLs in the batch request. If BatchAmpUrlsRequest contains duplicate URLs, AmpUrl is generated only once. Defaults to: `null`.
  - urlErrors ([AmpUrlError]): The errors for requested URLs that have no AMP URL. Defaults to: `null`.
  """
