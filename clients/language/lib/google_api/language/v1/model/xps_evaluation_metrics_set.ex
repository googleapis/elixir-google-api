...
defmodule GoogleApi.Language.V1.Model.XPSEvaluationMetricsSet do
  @moduledoc """
  ...
  *   `numEvaluationMetrics` (*type:* `String.t`, *default:* `nil`) - Number of the evaluation metrics (usually one per label plus overall).
  ...
  @type t :: %__MODULE__{
          :evaluationMetrics => list(GoogleApi.Language.V1.Model.XPSEvaluationMetrics.t()) | nil,
          :fileSpec => GoogleApi.Language.V1.Model.XPSFileSpec.t() | nil,
          :numEvaluationMetrics => String.t() | nil
        }

  field(:evaluationMetrics, as: GoogleApi.Language.V1.Model.XPSEvaluationMetrics, type: :list)
  field(:fileSpec, as: GoogleApi.Language.V1.Model.XPSFileSpec)
  field(:numEvaluationMetrics)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSEvaluationMetricsSet do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSEvaluationMetricsSet.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSEvaluationMetricsSet do
