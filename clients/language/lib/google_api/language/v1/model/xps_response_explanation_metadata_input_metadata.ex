...
defmodule GoogleApi.Language.V1.Model.XPSResponseExplanationMetadataInputMetadata do
  @moduledoc """
  ...
  *   `visualizationConfig` (*type:* `GoogleApi.Language.V1.Model.XPSVisualization.t`, *default:* `nil`) - Visualization configurations for image explanation.
  ...
  field(:modality)
  field(:visualizationConfig, as: GoogleApi.Language.V1.Model.XPSVisualization)
end

defimpl Poison.Decoder,
  for: GoogleApi.Language.V1.Model.XPSResponseExplanationMetadataInputMetadata do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSResponseExplanationMetadataInputMetadata.decode(value, options)
  end
end
