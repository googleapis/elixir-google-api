...
defmodule GoogleApi.Language.V1.Model.XPSTablesRegressionMetrics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSTablesRegressionMetrics do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSTablesRegressionMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSTablesRegressionMetrics do
