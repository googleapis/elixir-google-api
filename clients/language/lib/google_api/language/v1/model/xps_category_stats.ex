...
defmodule GoogleApi.Language.V1.Model.XPSCategoryStats do
  @moduledoc """
  ...
  *   `topCategoryStats` (*type:* `list(GoogleApi.Language.V1.Model.XPSCategoryStatsSingleCategoryStats.t)`, *default:* `nil`) - The statistics of the top 20 CATEGORY values, ordered by CategoryStats.SingleCategoryStats.count.
  ...
  @type t :: %__MODULE__{
          ...
          :topCategoryStats =>
            list(GoogleApi.Language.V1.Model.XPSCategoryStatsSingleCategoryStats.t()) | nil
        }

  field(:commonStats, as: GoogleApi.Language.V1.Model.XPSCommonStats)

  field(:topCategoryStats,
    as: GoogleApi.Language.V1.Model.XPSCategoryStatsSingleCategoryStats,
    type: :list
  )
end

defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSCategoryStats do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSCategoryStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSCategoryStats do
