...
defmodule GoogleApi.Language.V1.Model.XPSRow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSRow do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSRow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSRow do
