...
defmodule GoogleApi.Language.V1.Model.XPSTablesTrainingOperationMetadata do
  @moduledoc """
  ...
  *   `trainingObjectivePoints` (*type:* `list(GoogleApi.Language.V1.Model.XPSTrainingObjectivePoint.t)`, *default:* `nil`) - This field records the training objective value with respect to time, giving insight into how the model architecture search is performing as training time elapses.
  *   `trainingStartTime` (*type:* `DateTime.t`, *default:* `nil`) - Timestamp when training process starts.
  ...
  @type t :: %__MODULE__{
          ...
          :topTrials => list(GoogleApi.Language.V1.Model.XPSTuningTrial.t()) | nil,
          :trainBudgetMilliNodeHours => String.t() | nil,
          :trainingObjectivePoints =>
            list(GoogleApi.Language.V1.Model.XPSTrainingObjectivePoint.t()) | nil,
          :trainingStartTime => DateTime.t() | nil
        }

  field(:createModelStage)
  field(:optimizationObjective)
  field(:topTrials, as: GoogleApi.Language.V1.Model.XPSTuningTrial, type: :list)
  field(:trainBudgetMilliNodeHours)

  field(:trainingObjectivePoints,
    as: GoogleApi.Language.V1.Model.XPSTrainingObjectivePoint,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSTablesTrainingOperationMetadata do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSTablesTrainingOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSTablesTrainingOperationMetadata do
