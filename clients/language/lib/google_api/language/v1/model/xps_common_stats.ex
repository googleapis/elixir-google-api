...
defmodule GoogleApi.Language.V1.Model.XPSCommonStats do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSCommonStats do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSCommonStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSCommonStats do
