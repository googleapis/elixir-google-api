...
defmodule GoogleApi.Language.V1.Model.XPSImageObjectDetectionModelSpec do
  @moduledoc """
  ...
  *   `exportModelSpec` (*type:* `GoogleApi.Language.V1.Model.XPSImageExportModelSpec.t`, *default:* `nil`) - 
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSImageObjectDetectionModelSpec do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSImageObjectDetectionModelSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSImageObjectDetectionModelSpec do
