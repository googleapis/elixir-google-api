...
defmodule GoogleApi.Language.V1.Model.XPSArrayStats do
  @moduledoc """
  ...
  *   `memberStats` (*type:* `GoogleApi.Language.V1.Model.XPSDataStats.t`, *default:* `nil`) - Stats of all the values of all arrays, as if they were a single long series of data. The type depends on the element type of the array.
  ...
  @type t :: %__MODULE__{
          ...
          :memberStats => GoogleApi.Language.V1.Model.XPSDataStats.t() | nil
        }

  field(:commonStats, as: GoogleApi.Language.V1.Model.XPSCommonStats)
  field(:memberStats, as: GoogleApi.Language.V1.Model.XPSDataStats)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSArrayStats do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSArrayStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSArrayStats do
