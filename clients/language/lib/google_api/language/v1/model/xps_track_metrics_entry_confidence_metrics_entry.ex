...
defmodule GoogleApi.Language.V1.Model.XPSTrackMetricsEntryConfidenceMetricsEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V1.Model.XPSTrackMetricsEntryConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSTrackMetricsEntryConfidenceMetricsEntry.decode(value, options)
  end
end
