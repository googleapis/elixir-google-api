...
defmodule GoogleApi.Language.V1.Model.XPSExampleSet do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSExampleSet do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSExampleSet.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSExampleSet do
