...
defmodule GoogleApi.Language.V1.Model.XPSConfidenceMetricsEntry do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSConfidenceMetricsEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSConfidenceMetricsEntry do
