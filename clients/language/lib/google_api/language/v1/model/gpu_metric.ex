...
defmodule GoogleApi.Language.V1.Model.GpuMetric do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.GpuMetric do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.GpuMetric.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.GpuMetric do
