...
defmodule GoogleApi.Language.V1.Model.XPSTablesConfidenceMetricsEntry do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSTablesConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSTablesConfidenceMetricsEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSTablesConfidenceMetricsEntry do
