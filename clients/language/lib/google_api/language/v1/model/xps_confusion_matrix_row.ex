...
defmodule GoogleApi.Language.V1.Model.XPSConfusionMatrixRow do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSConfusionMatrixRow do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSConfusionMatrixRow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSConfusionMatrixRow do
