...
defmodule GoogleApi.Language.V1.Model.XPSImageModelServingSpecModelThroughputEstimation do
  @moduledoc """
  ...
  *   `servomaticPartitionType` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:computeEngineAcceleratorType)
  field(:latencyInMilliseconds)
  field(:nodeQps)
  field(:servomaticPartitionType)
end

defimpl Poison.Decoder,
  for: GoogleApi.Language.V1.Model.XPSImageModelServingSpecModelThroughputEstimation do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSImageModelServingSpecModelThroughputEstimation.decode(
      value,
      options
    )
  end
