...
defmodule GoogleApi.Language.V1.Model.XPSImageModelServingSpec do
  @moduledoc """
  ...
  *   `tfRuntimeVersion` (*type:* `String.t`, *default:* `nil`) - ## The fields below are only populated under uCAIP request scope. https://cloud.google.com/ml-engine/docs/runtime-version-list
  ...
  field(:modelThroughputEstimation,
    as: GoogleApi.Language.V1.Model.XPSImageModelServingSpecModelThroughputEstimation,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSImageModelServingSpec do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSImageModelServingSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSImageModelServingSpec do
