...
defmodule GoogleApi.Language.V1.Model.XPSDockerFormat do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSDockerFormat do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSDockerFormat.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSDockerFormat do
