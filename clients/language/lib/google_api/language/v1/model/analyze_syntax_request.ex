...
defmodule GoogleApi.Language.V1.Model.AnalyzeSyntaxRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.AnalyzeSyntaxRequest do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.AnalyzeSyntaxRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.AnalyzeSyntaxRequest do
