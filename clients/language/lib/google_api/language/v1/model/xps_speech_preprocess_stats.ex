...
defmodule GoogleApi.Language.V1.Model.XPSSpeechPreprocessStats do
  @moduledoc """


  ## Attributes

  *   `dataErrors` (*type:* `list(GoogleApi.Language.V1.Model.XPSDataErrors.t)`, *default:* `nil`) - Different types of data errors and the counts associated with them.
  ...
  *   `trainWordsCount` (*type:* `integer()`, *default:* `nil`) - The number of words in the training data set.
  ...
  @type t :: %__MODULE__{
          :dataErrors => list(GoogleApi.Language.V1.Model.XPSDataErrors.t()) | nil,
  ...
  field(:dataErrors, as: GoogleApi.Language.V1.Model.XPSDataErrors, type: :list)
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSSpeechPreprocessStats do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSSpeechPreprocessStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSSpeechPreprocessStats do
