...
defmodule GoogleApi.Language.V1.Model.Color do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.Color do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.Color.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.Color do
