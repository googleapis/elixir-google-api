...
defmodule GoogleApi.Language.V1.Model.XPSExportModelOutputConfig do
  @moduledoc """
  ...
  *   `tfSavedModelFormat` (*type:* `GoogleApi.Language.V1.Model.XPSTfSavedModelFormat.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          ...
          :edgeTpuTfLiteFormat => GoogleApi.Language.V1.Model.XPSEdgeTpuTfLiteFormat.t() | nil,
          ...
          :tfSavedModelFormat => GoogleApi.Language.V1.Model.XPSTfSavedModelFormat.t() | nil
        }

  field(:coreMlFormat, as: GoogleApi.Language.V1.Model.XPSCoreMlFormat)
  field(:dockerFormat, as: GoogleApi.Language.V1.Model.XPSDockerFormat)
  field(:edgeTpuTfLiteFormat, as: GoogleApi.Language.V1.Model.XPSEdgeTpuTfLiteFormat)
  field(:exportFirebaseAuxiliaryInfo)
  field(:outputGcrUri)
  field(:outputGcsUri)
  field(:tfJsFormat, as: GoogleApi.Language.V1.Model.XPSTfJsFormat)
  field(:tfLiteFormat, as: GoogleApi.Language.V1.Model.XPSTfLiteFormat)
  field(:tfSavedModelFormat, as: GoogleApi.Language.V1.Model.XPSTfSavedModelFormat)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V1.Model.XPSExportModelOutputConfig do
  def decode(value, options) do
    GoogleApi.Language.V1.Model.XPSExportModelOutputConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V1.Model.XPSExportModelOutputConfig do
