...
defmodule GoogleApi.Language.V2.Model.XPSSpeechModelSpecSubModelSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSSpeechModelSpecSubModelSpec do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSSpeechModelSpecSubModelSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSSpeechModelSpecSubModelSpec do
