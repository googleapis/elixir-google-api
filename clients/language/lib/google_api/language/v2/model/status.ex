...
defmodule GoogleApi.Language.V2.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.Status do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.Status do
