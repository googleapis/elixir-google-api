...
defmodule GoogleApi.Language.V2.Model.ModerateTextRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.ModerateTextRequest do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.ModerateTextRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.ModerateTextRequest do
