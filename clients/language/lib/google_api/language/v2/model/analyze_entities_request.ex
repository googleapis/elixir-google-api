...
defmodule GoogleApi.Language.V2.Model.AnalyzeEntitiesRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.AnalyzeEntitiesRequest do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.AnalyzeEntitiesRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.AnalyzeEntitiesRequest do
