...
defmodule GoogleApi.Language.V2.Model.XPSImageObjectDetectionModelSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSImageObjectDetectionModelSpec do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSImageObjectDetectionModelSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSImageObjectDetectionModelSpec do
