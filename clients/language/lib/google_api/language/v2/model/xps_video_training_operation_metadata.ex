...
defmodule GoogleApi.Language.V2.Model.XPSVideoTrainingOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSVideoTrainingOperationMetadata do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSVideoTrainingOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSVideoTrainingOperationMetadata do
