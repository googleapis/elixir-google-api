...
defmodule GoogleApi.Language.V2.Model.XPSTimestampStats do
  @moduledoc """
  ...
  *   `medianTimestampNanos` (*type:* `String.t`, *default:* `nil`) - 
  ...
  @type t :: %__MODULE__{
          ...
          :granularStats =>
            %{
              optional(String.t()) =>
                GoogleApi.Language.V2.Model.XPSTimestampStatsGranularStats.t()
            }
            | nil,
  ...
  field(:granularStats, as: GoogleApi.Language.V2.Model.XPSTimestampStatsGranularStats, type: :map)

  field(:medianTimestampNanos)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSTimestampStats do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSTimestampStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSTimestampStats do
