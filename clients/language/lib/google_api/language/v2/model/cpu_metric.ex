...
defmodule GoogleApi.Language.V2.Model.CpuMetric do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.CpuMetric do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.CpuMetric.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.CpuMetric do
