...
defmodule GoogleApi.Language.V2.Model.XPSMetricEntry do
  @moduledoc """
  ...
  *   `systemLabels` (*type:* `list(GoogleApi.Language.V2.Model.XPSMetricEntryLabel.t)`, *default:* `nil`) - Billing system labels for this (metric, value) pair.
  ...
  @type t :: %__MODULE__{
          ...
          :systemLabels => list(GoogleApi.Language.V2.Model.XPSMetricEntryLabel.t()) | nil
        }
  ...
  field(:int64Value)
  field(:metricName)
  field(:systemLabels, as: GoogleApi.Language.V2.Model.XPSMetricEntryLabel, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSMetricEntry do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSMetricEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSMetricEntry do
