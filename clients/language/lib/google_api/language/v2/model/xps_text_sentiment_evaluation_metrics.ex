...
defmodule GoogleApi.Language.V2.Model.XPSTextSentimentEvaluationMetrics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSTextSentimentEvaluationMetrics do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSTextSentimentEvaluationMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSTextSentimentEvaluationMetrics do
