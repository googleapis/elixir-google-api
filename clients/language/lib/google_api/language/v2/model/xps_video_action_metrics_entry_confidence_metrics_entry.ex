...
defmodule GoogleApi.Language.V2.Model.XPSVideoActionMetricsEntryConfidenceMetricsEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSVideoActionMetricsEntryConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSVideoActionMetricsEntryConfidenceMetricsEntry.decode(
      value,
      options
    )
  end
