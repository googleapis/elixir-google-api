...
defmodule GoogleApi.Language.V2.Model.RamMetric do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.RamMetric do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.RamMetric.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.RamMetric do
