...
defmodule GoogleApi.Language.V2.Model.XPSVideoExportModelSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSVideoExportModelSpec do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSVideoExportModelSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSVideoExportModelSpec do
