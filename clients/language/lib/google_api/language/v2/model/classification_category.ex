...
defmodule GoogleApi.Language.V2.Model.ClassificationCategory do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.ClassificationCategory do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.ClassificationCategory.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.ClassificationCategory do
