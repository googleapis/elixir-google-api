...
defmodule GoogleApi.Language.V2.Model.XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry do
  @moduledoc """
  ...
  *   `confusionMatrix` (*type:* `GoogleApi.Language.V2.Model.XPSConfusionMatrix.t`, *default:* `nil`) - Confusion matrix of the per confidence_threshold evaluation. Pixel counts are set here. Only set for model level evaluation, not for evaluation per label.
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry.decode(
      value,
      options
    )
  end
