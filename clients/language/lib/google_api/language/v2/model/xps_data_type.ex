...
defmodule GoogleApi.Language.V2.Model.XPSDataType do
  @moduledoc """
  ...
  *   `typeCode` (*type:* `String.t`, *default:* `nil`) - Required. The TypeCode for this type.
  ...
  @type t :: %__MODULE__{
          :compatibleDataTypes => list(GoogleApi.Language.V2.Model.XPSDataType.t()) | nil,
          :listElementType => GoogleApi.Language.V2.Model.XPSDataType.t() | nil,
  ...
  field(:compatibleDataTypes, as: GoogleApi.Language.V2.Model.XPSDataType, type: :list)
  field(:listElementType, as: GoogleApi.Language.V2.Model.XPSDataType)
  field(:nullable)
  field(:structType, as: GoogleApi.Language.V2.Model.XPSStructType)
  field(:timeFormat)
  field(:typeCode)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSDataType do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSDataType.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSDataType do
