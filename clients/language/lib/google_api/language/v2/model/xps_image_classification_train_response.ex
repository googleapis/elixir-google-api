...
defmodule GoogleApi.Language.V2.Model.XPSImageClassificationTrainResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSImageClassificationTrainResponse do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSImageClassificationTrainResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSImageClassificationTrainResponse do
