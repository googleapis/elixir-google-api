...
defmodule GoogleApi.Language.V2.Model.XPSBoundingBoxMetricsEntryConfidenceMetricsEntry do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSBoundingBoxMetricsEntryConfidenceMetricsEntry do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSBoundingBoxMetricsEntryConfidenceMetricsEntry.decode(
      value,
      options
    )
  end
