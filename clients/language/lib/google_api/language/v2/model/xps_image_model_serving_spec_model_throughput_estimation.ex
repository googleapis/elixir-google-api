...
defmodule GoogleApi.Language.V2.Model.XPSImageModelServingSpecModelThroughputEstimation do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSImageModelServingSpecModelThroughputEstimation do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSImageModelServingSpecModelThroughputEstimation.decode(
      value,
      options
    )
  end
