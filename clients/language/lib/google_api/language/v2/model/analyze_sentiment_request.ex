...
defmodule GoogleApi.Language.V2.Model.AnalyzeSentimentRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.AnalyzeSentimentRequest do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.AnalyzeSentimentRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.AnalyzeSentimentRequest do
