...
defmodule GoogleApi.Language.V2.Model.Sentiment do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.Sentiment do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.Sentiment.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.Sentiment do
