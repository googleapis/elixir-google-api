...
defmodule GoogleApi.Language.V2.Model.XPSTablesModelStructureModelParametersParameter do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSTablesModelStructureModelParametersParameter do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSTablesModelStructureModelParametersParameter.decode(
      value,
      options
    )
  end
