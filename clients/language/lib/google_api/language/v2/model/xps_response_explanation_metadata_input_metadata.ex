...
defmodule GoogleApi.Language.V2.Model.XPSResponseExplanationMetadataInputMetadata do
  @moduledoc """
  ...
  *   `visualizationConfig` (*type:* `GoogleApi.Language.V2.Model.XPSVisualization.t`, *default:* `nil`) - Visualization configurations for image explanation.
  ...
  field(:modality)
  field(:visualizationConfig, as: GoogleApi.Language.V2.Model.XPSVisualization)
end

defimpl Poison.Decoder,
  for: GoogleApi.Language.V2.Model.XPSResponseExplanationMetadataInputMetadata do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSResponseExplanationMetadataInputMetadata.decode(value, options)
  end
end
