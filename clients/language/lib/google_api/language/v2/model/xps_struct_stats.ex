...
defmodule GoogleApi.Language.V2.Model.XPSStructStats do
  @moduledoc """
  ...
  *   `fieldStats` (*type:* `%{optional(String.t) => GoogleApi.Language.V2.Model.XPSDataStats.t}`, *default:* `nil`) - Map from a field name of the struct to data stats aggregated over series of all data in that field across all the structs.
  ...
  @type t :: %__MODULE__{
          ...
          :fieldStats =>
            %{optional(String.t()) => GoogleApi.Language.V2.Model.XPSDataStats.t()} | nil
        }

  field(:commonStats, as: GoogleApi.Language.V2.Model.XPSCommonStats)
  field(:fieldStats, as: GoogleApi.Language.V2.Model.XPSDataStats, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSStructStats do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSStructStats.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSStructStats do
