...
defmodule GoogleApi.Language.V2.Model.XPSVisualization do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Language.V2.Model.XPSVisualization do
  def decode(value, options) do
    GoogleApi.Language.V2.Model.XPSVisualization.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Language.V2.Model.XPSVisualization do
