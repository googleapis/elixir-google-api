...
defmodule GoogleApi.Plus.V1.Api.Comments do
  ...
  """
  @spec plus_comments_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Plus.V1.Model.Comment.t} | {:error, Tesla.Env.t}
  def plus_comments_get(connection, comment_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> decode(%GoogleApi.Plus.V1.Model.Comment{})
  end
  ...
  {:error, info} on failure
  """
  @spec plus_comments_list(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.Plus.V1.Model.CommentFeed.t} | {:error, Tesla.Env.t}
  def plus_comments_list(connection, activity_id, opts \\ []) do
    optional_params = %{
      :"alt" => :query,
      :"fields" => :query,
      :"key" => :query,
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.Plus.V1.Model.CommentFeed{})
  end
end
