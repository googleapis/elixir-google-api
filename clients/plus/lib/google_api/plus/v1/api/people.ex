...
defmodule GoogleApi.Plus.V1.Api.People do
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_people_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_people_list(Tesla.Env.client(), String.t(), String.t(), keyword(), keyword()) ::
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_people_list_by_activity(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
  ...
  *   `{:error, info}` on failure
  """
  @spec plus_people_search(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.Plus.V1.Model.PeopleFeed.t()} | {:error, Tesla.Env.t()}
