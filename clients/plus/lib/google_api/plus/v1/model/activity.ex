...
defimpl Poison.Decoder, for: GoogleApi.Plus.V1.Model.Activity do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"actor", :struct, GoogleApi.Plus.V1.Model.Activity_actor, options)
    |> deserialize(:"location", :struct, GoogleApi.Plus.V1.Model.Place, options)
    |> deserialize(:"object", :struct, GoogleApi.Plus.V1.Model.Activity_object, options)
    |> deserialize(:"provider", :struct, GoogleApi.Plus.V1.Model.Activity_provider, options)
  end
end
