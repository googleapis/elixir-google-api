...
defmodule GoogleApi.Plus.V1.Model.ActivityActor do
  ...
  - displayName (String): The name of the actor, suitable for display. Defaults to: `null`.
  - id (String): The ID of the actor&#39;s Person resource. Defaults to: `null`.
  - image (ActivityActorImage):  Defaults to: `null`.
  - name (ActivityActorName):  Defaults to: `null`.
  - url (String): The link to the actor&#39;s Google profile. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.Plus.V1.Model.ActivityActor do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"image", :struct, GoogleApi.Plus.V1.Model.ActivityActorImage, options)
    |> deserialize(:"name", :struct, GoogleApi.Plus.V1.Model.ActivityActorName, options)
