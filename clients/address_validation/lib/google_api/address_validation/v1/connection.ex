...
defmodule GoogleApi.AddressValidation.V1.Connection do
  @moduledoc """
  Handle Tesla connections for GoogleApi.AddressValidation.V1.
  """
  ...
  use GoogleApi.Gax.Connection,
    ...
    otp_app: :google_api_address_validation,
