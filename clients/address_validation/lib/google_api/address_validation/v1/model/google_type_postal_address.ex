...
defmodule GoogleApi.AddressValidation.V1.Model.GoogleTypePostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AddressValidation.V1.Model.GoogleTypePostalAddress do
  def decode(value, options) do
    GoogleApi.AddressValidation.V1.Model.GoogleTypePostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AddressValidation.V1.Model.GoogleTypePostalAddress do
