...
defmodule GoogleApi.AppState.V1.Model.WriteResult do
  ...
  - currentStateVersion (String.t): The version of the data for this key on the server. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string appstate#writeResult. Defaults to: `null`.
