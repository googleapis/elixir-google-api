...
defmodule GoogleApi.AppState.V1.Model.ListResponse do
  ...
  - items ([GetResponse]): The app state data. Defaults to: `null`.
  - kind (String.t): Uniquely identifies the type of this resource. Value is always the fixed string appstate#listResponse. Defaults to: `null`.
