...
defmodule GoogleApi.ServiceControl.V2.Model.V2LogEntryOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.V2LogEntryOperation do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.V2LogEntryOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.V2LogEntryOperation do
