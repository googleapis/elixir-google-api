...
defmodule GoogleApi.ServiceControl.V2.Model.AuditLog do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.ServiceControl.V2.Model.Status.t`, *default:* `nil`) - The status of the overall operation.
  ...
  @type t :: %__MODULE__{
          :authenticationInfo => GoogleApi.ServiceControl.V2.Model.AuthenticationInfo.t(),
          :authorizationInfo => list(GoogleApi.ServiceControl.V2.Model.AuthorizationInfo.t()),
          :metadata => map(),
          :methodName => String.t(),
          :numResponseItems => String.t(),
          :request => map(),
          :requestMetadata => GoogleApi.ServiceControl.V2.Model.RequestMetadata.t(),
          :resourceLocation => GoogleApi.ServiceControl.V2.Model.ResourceLocation.t(),
  ...
  field(:authenticationInfo, as: GoogleApi.ServiceControl.V2.Model.AuthenticationInfo)
  field(:authorizationInfo, as: GoogleApi.ServiceControl.V2.Model.AuthorizationInfo, type: :list)
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.AuditLog do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.AuditLog.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.AuditLog do
