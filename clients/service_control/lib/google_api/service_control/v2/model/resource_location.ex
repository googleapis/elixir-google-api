...
defmodule GoogleApi.ServiceControl.V2.Model.ResourceLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.ResourceLocation do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.ResourceLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.ResourceLocation do
