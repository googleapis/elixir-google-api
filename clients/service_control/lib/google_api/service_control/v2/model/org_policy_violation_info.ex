...
defmodule GoogleApi.ServiceControl.V2.Model.OrgPolicyViolationInfo do
  @moduledoc """
  ...
  *   `violationInfo` (*type:* `list(GoogleApi.ServiceControl.V2.Model.ViolationInfo.t)`, *default:* `nil`) - Optional. Policy violations
  ...
  @type t :: %__MODULE__{
          ...
          :violationInfo => list(GoogleApi.ServiceControl.V2.Model.ViolationInfo.t()) | nil
        }

  field(:payload, type: :map)
  field(:resourceTags, type: :map)
  field(:resourceType)
  field(:violationInfo, as: GoogleApi.ServiceControl.V2.Model.ViolationInfo, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.OrgPolicyViolationInfo do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.OrgPolicyViolationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.OrgPolicyViolationInfo do
