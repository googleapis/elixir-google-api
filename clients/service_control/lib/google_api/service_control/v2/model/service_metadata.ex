...
defmodule GoogleApi.ServiceControl.V2.Model.ServiceMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.ServiceMetadata do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.ServiceMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.ServiceMetadata do
