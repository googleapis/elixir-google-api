...
defmodule GoogleApi.ServiceControl.V2.Model.AuthenticationInfo do
  @moduledoc """
  ...
  *   `principalEmail` (*type:* `String.t`, *default:* `nil`) - The email address of the authenticated user (or service account on behalf of third party principal) making the request. For privacy reasons, the principal email address is redacted for all read-only operations that fail with a "permission denied" error.
  ...
  *   `thirdPartyPrincipal` (*type:* `map()`, *default:* `nil`) - The third party identification (if any) of the authenticated user making the request. When the JSON object represented here has a proto equivalent, the proto name will be indicated in the `@type` property.
  ...
  field(:serviceAccountDelegationInfo,
    as: GoogleApi.ServiceControl.V2.Model.ServiceAccountDelegationInfo,
    type: :list
  )
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V2.Model.AuthenticationInfo do
  def decode(value, options) do
    GoogleApi.ServiceControl.V2.Model.AuthenticationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V2.Model.AuthenticationInfo do
