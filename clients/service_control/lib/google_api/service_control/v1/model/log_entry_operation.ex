...
defmodule GoogleApi.ServiceControl.V1.Model.LogEntryOperation do
  ...
  same identifier are assumed to be part of the same operation. Defaults to `nil`.
  ...
  `"MyDivision.MyBigCompany.com"`, `"github.com/MyProject/MyApplication"`. Defaults to `nil`.
  """
