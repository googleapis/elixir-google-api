...
defmodule GoogleApi.ServiceControl.V1.Model.ServiceAccountDelegationInfo do
  ...
  *   `thirdPartyPrincipal` (*type:* `GoogleApi.ServiceControl.V1.Model.ThirdPartyPrincipal.t`, *default:* `nil`) - Third party identity as the real authority.
  ...
  @type t :: %__MODULE__{
          :firstPartyPrincipal => GoogleApi.ServiceControl.V1.Model.FirstPartyPrincipal.t() | nil,
          :principalSubject => String.t() | nil,
          :thirdPartyPrincipal => GoogleApi.ServiceControl.V1.Model.ThirdPartyPrincipal.t() | nil
        }
