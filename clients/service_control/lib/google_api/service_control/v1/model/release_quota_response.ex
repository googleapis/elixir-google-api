...
defmodule GoogleApi.ServiceControl.V1.Model.ReleaseQuotaResponse do
  ...
  @type t :: %__MODULE__{
          ...
          :releaseErrors => list(GoogleApi.ServiceControl.V1.Model.QuotaError.t()),
          :serviceConfigId => any()
        }

  field(:operationId)
  field(:quotaMetrics, as: GoogleApi.ServiceControl.V1.Model.MetricValueSet, type: :list)
  field(:releaseErrors, as: GoogleApi.ServiceControl.V1.Model.QuotaError, type: :list)
  field(:serviceConfigId)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.ReleaseQuotaResponse do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.ReleaseQuotaResponse.decode(value, options)
  end
end
