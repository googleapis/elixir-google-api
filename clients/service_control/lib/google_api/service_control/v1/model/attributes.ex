...
defmodule GoogleApi.ServiceControl.V1.Model.Attributes do
  ...
  *   `attributeMap` (*type:* `%{optional(String.t) => GoogleApi.ServiceControl.V1.Model.AttributeValue.t}`, *default:* `nil`) - The set of attributes. Each attribute's key can be up to 128 bytes
  ...
  *   `droppedAttributesCount` (*type:* `integer()`, *default:* `nil`) - The number of attributes that were discarded. Attributes can be discarded
  ...
  @type t :: %__MODULE__{
          :attributeMap => %{
            optional(String.t()) => GoogleApi.ServiceControl.V1.Model.AttributeValue.t()
          },
