...
defmodule GoogleApi.ServiceControl.V1.Model.ReportInfo do
  ...
  - operationId (String.t): The Operation.operation_id value from the request. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.ReportInfo do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.ReportInfo.decode(value, options)
  end
end
