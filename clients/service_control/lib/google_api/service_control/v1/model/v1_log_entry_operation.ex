...
defmodule GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation do
