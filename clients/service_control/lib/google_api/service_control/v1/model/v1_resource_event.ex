...
defmodule GoogleApi.ServiceControl.V1.Model.V1ResourceEvent do
  @moduledoc """
  ...
  *   `resource` (*type:* `GoogleApi.ServiceControl.V1.Model.Resource.t`, *default:* `nil`) - The resource associated with the event.
  *   `type` (*type:* `String.t`, *default:* `nil`) - The resource event type determines how the backend service should process the event.
  ...
  @type t :: %__MODULE__{
          ...
          :path => String.t() | nil,
          :payload => map() | nil,
          :resource => GoogleApi.ServiceControl.V1.Model.Resource.t() | nil,
          :type => String.t() | nil
        }
  ...
  field(:resource, as: GoogleApi.ServiceControl.V1.Model.Resource)
  field(:type)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.V1ResourceEvent do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.V1ResourceEvent.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V1.Model.V1ResourceEvent do
