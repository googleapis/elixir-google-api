...
defmodule GoogleApi.ServiceControl.V1.Model.V1HttpRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.V1HttpRequest do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.V1HttpRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V1.Model.V1HttpRequest do
