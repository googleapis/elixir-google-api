...
defmodule GoogleApi.ServiceControl.V1.Model.V1LogEntry do
  @moduledoc """
  An individual log entry.

  ## Attributes

  *   `httpRequest` (*type:* `GoogleApi.ServiceControl.V1.Model.V1HttpRequest.t`, *default:* `nil`) - Optional. Information about the HTTP request associated with this log entry, if applicable.
  ...
  *   `operation` (*type:* `GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation.t`, *default:* `nil`) - Optional. Information about an operation associated with the log entry, if applicable.
  ...
  *   `sourceLocation` (*type:* `GoogleApi.ServiceControl.V1.Model.V1LogEntrySourceLocation.t`, *default:* `nil`) - Optional. Source code location information associated with the log entry, if any.
  ...
  *   `trace` (*type:* `String.t`, *default:* `nil`) - Optional. Resource name of the trace associated with the log entry, if any. If this field contains a relative resource name, you can assume the name is relative to `//tracing.googleapis.com`. Example: `projects/my-projectid/traces/06796866738c859f2f19b7cfb3214824`
  ...
  @type t :: %__MODULE__{
          :httpRequest => GoogleApi.ServiceControl.V1.Model.V1HttpRequest.t() | nil,
          :insertId => String.t() | nil,
          :labels => map() | nil,
          :monitoredResourceLabels => map() | nil,
          :name => String.t() | nil,
          :operation => GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation.t() | nil,
          :protoPayload => map() | nil,
          :severity => String.t() | nil,
          :sourceLocation => GoogleApi.ServiceControl.V1.Model.V1LogEntrySourceLocation.t() | nil,
  ...
  field(:httpRequest, as: GoogleApi.ServiceControl.V1.Model.V1HttpRequest)
  field(:insertId)
  field(:labels, type: :map)
  field(:monitoredResourceLabels, type: :map)
  field(:name)
  field(:operation, as: GoogleApi.ServiceControl.V1.Model.V1LogEntryOperation)
  field(:protoPayload, type: :map)
  field(:severity)
  field(:sourceLocation, as: GoogleApi.ServiceControl.V1.Model.V1LogEntrySourceLocation)
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.V1LogEntry do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.V1LogEntry.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V1.Model.V1LogEntry do
