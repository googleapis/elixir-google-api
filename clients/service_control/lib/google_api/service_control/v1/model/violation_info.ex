...
defmodule GoogleApi.ServiceControl.V1.Model.ViolationInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceControl.V1.Model.ViolationInfo do
  def decode(value, options) do
    GoogleApi.ServiceControl.V1.Model.ViolationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceControl.V1.Model.ViolationInfo do
