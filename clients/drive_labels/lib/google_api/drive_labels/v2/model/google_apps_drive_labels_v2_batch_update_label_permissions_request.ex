...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest do
  @moduledoc """
  ...
  *   `useAdminAccess` (*type:* `boolean()`, *default:* `nil`) - Set to `true` in order to use the user's admin credentials. The server will verify the user is an admin for the Label before allowing access. If this is set, the use_admin_access field in the UpdateLabelPermissionRequest messages must either be empty or match this field.
  ...
  field(:requests,
    as: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2UpdateLabelPermissionRequest,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest.decode(
      value,
      options
    )
  end
