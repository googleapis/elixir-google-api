...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldSchemaCapabilities do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldSchemaCapabilities do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldSchemaCapabilities.decode(
      value,
      options
    )
  end
