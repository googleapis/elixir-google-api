...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2PublishLabelRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2PublishLabelRequest do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2PublishLabelRequest.decode(
      value,
      options
    )
  end
