...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldUserOptions do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldUserOptions do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldUserOptions.decode(value, options)
  end
end
