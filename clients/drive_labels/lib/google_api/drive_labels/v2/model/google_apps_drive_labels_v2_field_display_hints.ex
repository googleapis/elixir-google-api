...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldDisplayHints do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldDisplayHints do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2FieldDisplayHints.decode(value, options)
  end
end
