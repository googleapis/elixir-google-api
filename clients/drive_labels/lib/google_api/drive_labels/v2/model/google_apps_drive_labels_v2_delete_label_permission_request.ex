...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest.decode(
      value,
      options
    )
  end
