...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LifecycleDisabledPolicy do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LifecycleDisabledPolicy do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LifecycleDisabledPolicy.decode(
      value,
      options
    )
  end
