...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2EnableLabelRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2EnableLabelRequest do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2EnableLabelRequest.decode(
      value,
      options
    )
  end
