...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LabelSchemaCapabilities do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LabelSchemaCapabilities do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleAppsDriveLabelsV2LabelSchemaCapabilities.decode(
      value,
      options
    )
  end
