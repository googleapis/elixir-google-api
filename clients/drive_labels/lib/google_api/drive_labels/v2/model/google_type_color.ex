...
defmodule GoogleApi.DriveLabels.V2.Model.GoogleTypeColor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DriveLabels.V2.Model.GoogleTypeColor do
  def decode(value, options) do
    GoogleApi.DriveLabels.V2.Model.GoogleTypeColor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DriveLabels.V2.Model.GoogleTypeColor do
