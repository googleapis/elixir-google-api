...
defmodule GoogleApi.NetworkSecurity.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.NetworkSecurity.V1.Model.GoogleIamV1TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.NetworkSecurity.V1.Model.GoogleIamV1TestIamPermissionsRequest.decode(value, options)
  end
end
