...
defmodule GoogleApi.NetworkSecurity.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.NetworkSecurity.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.NetworkSecurity.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.NetworkSecurity.V1.Model.Expr do
