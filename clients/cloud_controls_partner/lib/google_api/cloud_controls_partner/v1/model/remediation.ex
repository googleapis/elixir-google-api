...
defmodule GoogleApi.CloudControlsPartner.V1.Model.Remediation do
  @moduledoc """
  ...
  *   `remediationType` (*type:* `String.t`, *default:* `nil`) - Output only. Remediation type based on the type of org policy values violated
  ...
  field(:instructions, as: GoogleApi.CloudControlsPartner.V1.Model.Instructions)
  field(:remediationType)
end

defimpl Poison.Decoder, for: GoogleApi.CloudControlsPartner.V1.Model.Remediation do
  def decode(value, options) do
    GoogleApi.CloudControlsPartner.V1.Model.Remediation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudControlsPartner.V1.Model.Remediation do
