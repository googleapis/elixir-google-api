...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.ServiceIdentity do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.ServiceIdentity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.ServiceIdentity do
