...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.Quota do
  ...
  - limits (list(GoogleApi.ServiceConsumerManagement.V1.Model.QuotaLimit.t)): List of `QuotaLimit` definitions for the service. Defaults to `nil`.
  - metricRules (list(GoogleApi.ServiceConsumerManagement.V1.Model.MetricRule.t)): List of `MetricRule` definitions, each one mapping a selected method to one
