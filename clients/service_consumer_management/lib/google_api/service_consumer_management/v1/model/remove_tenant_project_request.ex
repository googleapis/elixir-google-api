...
defimpl Poison.Decoder,
  for: GoogleApi.ServiceConsumerManagement.V1.Model.RemoveTenantProjectRequest do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.RemoveTenantProjectRequest.decode(value, options)
  end
end
