...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.AuthProvider do
  ...
  *   `jwtLocations` (*type:* `list(GoogleApi.ServiceConsumerManagement.V1.Model.JwtLocation.t)`, *default:* `nil`) - Defines the locations to extract the JWT.
  ...
  @type t :: %__MODULE__{
          ...
          :issuer => String.t(),
          :jwksUri => String.t(),
          :jwtLocations => list(GoogleApi.ServiceConsumerManagement.V1.Model.JwtLocation.t())
        }
  ...
  field(:issuer)
  field(:jwksUri)
  field(:jwtLocations, as: GoogleApi.ServiceConsumerManagement.V1.Model.JwtLocation, type: :list)
end
