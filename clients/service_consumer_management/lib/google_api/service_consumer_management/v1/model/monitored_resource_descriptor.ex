...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.MonitoredResourceDescriptor do
  @moduledoc """
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceConsumerManagement.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - Required. A set of labels used to describe instances of this monitored resource type. For example, an individual Google Cloud SQL database is identified by values for the labels `"database_id"` and `"zone"`.
  ...
  *   `type` (*type:* `String.t`, *default:* `nil`) - Required. The monitored resource type. For example, the type `"cloudsql_database"` represents databases in Google Cloud SQL.
  ...
  @type t :: %__MODULE__{
          ...
          :labels => list(GoogleApi.ServiceConsumerManagement.V1.Model.LabelDescriptor.t()) | nil,
...
defimpl Poison.Decoder,
  for: GoogleApi.ServiceConsumerManagement.V1.Model.MonitoredResourceDescriptor do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.MonitoredResourceDescriptor.decode(
      value,
      options
    )
  end
