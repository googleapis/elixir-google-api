...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.V1Beta1QuotaOverride do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the producer override. An example name would be: `services/compute.googleapis.com/projects/123/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/producerOverrides/4a3f2c1d`
