...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.ExperimentalFeatures do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.ExperimentalFeatures do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.ExperimentalFeatures.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.ExperimentalFeatures do
