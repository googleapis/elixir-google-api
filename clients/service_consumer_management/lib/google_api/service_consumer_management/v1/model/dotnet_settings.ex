...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.DotnetSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.DotnetSettings do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.DotnetSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.DotnetSettings do
