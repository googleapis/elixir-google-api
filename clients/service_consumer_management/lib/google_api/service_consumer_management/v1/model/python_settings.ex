...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.PythonSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.PythonSettings do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.PythonSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.PythonSettings do
