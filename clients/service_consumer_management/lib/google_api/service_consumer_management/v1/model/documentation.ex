...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.Documentation do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.Documentation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.Documentation do
