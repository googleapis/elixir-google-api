...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.ApplyTenantProjectConfigRequest do
  ...
  - projectConfig (TenantProjectConfig): Configuration that should be applied to the existing tenant project. Defaults to: `null`.
  - tag (String.t): Tag of the project. Must be less than 128 characters. Required. Defaults to: `null`.
  """
