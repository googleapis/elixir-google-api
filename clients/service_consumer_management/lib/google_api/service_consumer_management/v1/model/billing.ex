...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.Billing do
  ...
  - consumerDestinations (list(GoogleApi.ServiceConsumerManagement.V1.Model.BillingDestination.t)): Billing configurations for sending metrics to the consumer project.
