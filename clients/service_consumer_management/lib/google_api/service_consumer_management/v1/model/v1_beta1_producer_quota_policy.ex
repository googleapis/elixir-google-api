...
defmodule GoogleApi.ServiceConsumerManagement.V1.Model.V1Beta1ProducerQuotaPolicy do
  ...
  *   `container` (*type:* `String.t`, *default:* `nil`) - The cloud resource container at which the quota policy is created. The
  ...
  *   `dimensions` (*type:* `map()`, *default:* `nil`) - 
      ...
      *   If any valid key other than "region" or "zone" appears in the map, then
          ...
          map.
  *   `metric` (*type:* `String.t`, *default:* `nil`) - The name of the metric to which this policy applies.

      An example name would be:
      `compute.googleapis.com/cpus`
  *   `name` (*type:* `String.t`, *default:* `nil`) - The resource name of the producer policy.
      An example name would be:
  ...
  *   `policyValue` (*type:* `String.t`, *default:* `nil`) - The quota policy value.
      Can be any nonnegative integer, or -1 (unlimited quota).
  *   `unit` (*type:* `String.t`, *default:* `nil`) - The limit unit of the limit to which this policy applies.
