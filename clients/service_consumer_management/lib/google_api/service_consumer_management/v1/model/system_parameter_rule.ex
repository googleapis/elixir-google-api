...
defimpl Poison.Decoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.SystemParameterRule do
  def decode(value, options) do
    GoogleApi.ServiceConsumerManagement.V1.Model.SystemParameterRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceConsumerManagement.V1.Model.SystemParameterRule do
