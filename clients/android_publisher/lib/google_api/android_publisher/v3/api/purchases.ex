...
defmodule GoogleApi.AndroidPublisher.V3.Api.Purchases do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.AndroidPublisher.V3.Model.ProductPurchasesAcknowledgeRequest.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.AndroidPublisher.V3.Model.SubscriptionPurchasesAcknowledgeRequest.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :quotaUser (String.t): An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    - :userIp (String.t): Deprecated. Please use quotaUser instead.
    - :body (GoogleApi.AndroidPublisher.V3.Model.SubscriptionPurchasesDeferRequest.t): 
