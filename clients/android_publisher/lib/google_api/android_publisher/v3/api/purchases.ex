...
defmodule GoogleApi.AndroidPublisher.V3.Api.Purchases do
  ...
  *   `{:error, info}` on failure
  """
  @spec androidpublisher_purchases_products_consume(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  *   `connection` (*type:* `GoogleApi.AndroidPublisher.V3.Connection.t`) - Connection to server
  *   `package_name` (*type:* `String.t`) - Required. The package of the application for which this subscription was purchased (for example, 'com.some.thing').
  *   `token` (*type:* `String.t`) - Required. The token provided to the user's device when the subscription was purchased.
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      *   `:"$.xgafv"` (*type:* `String.t`) - V1 error format.
      *   `:access_token` (*type:* `String.t`) - OAuth access token.
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.AndroidPublisher.V3.Model.RevokeSubscriptionPurchaseRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.AndroidPublisher.V3.Model.RevokeSubscriptionPurchaseResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec androidpublisher_purchases_subscriptionsv2_revoke(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          keyword(),
          ...
          {:ok, GoogleApi.AndroidPublisher.V3.Model.RevokeSubscriptionPurchaseResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def androidpublisher_purchases_subscriptionsv2_revoke(
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.AndroidPublisher.V3.Model.RevokeSubscriptionPurchaseResponse{}]
    )
  end
