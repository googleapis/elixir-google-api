...
defmodule GoogleApi.AndroidPublisher.V3.Model.InappproductsListResponse do
  ...
  - inappproduct (list(GoogleApi.AndroidPublisher.V3.Model.InAppProduct.t)):  Defaults to `nil`.
  ...
  @type t :: %__MODULE__{
          :inappproduct => list(GoogleApi.AndroidPublisher.V3.Model.InAppProduct.t()),
          :kind => String.t(),
