...
defmodule GoogleApi.AndroidPublisher.V3.Model.Variant do
  ...
  *   `variantId` (*type:* `integer()`, *default:* `nil`) - 
  """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidPublisher.V3.Model.Variant do
  def decode(value, options) do
    GoogleApi.AndroidPublisher.V3.Model.Variant.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidPublisher.V3.Model.Variant do
