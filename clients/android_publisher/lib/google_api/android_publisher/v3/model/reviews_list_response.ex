...
defmodule GoogleApi.AndroidPublisher.V3.Model.ReviewsListResponse do
  ...
  field(:reviews, as: GoogleApi.AndroidPublisher.V3.Model.Review, type: :list)
  field(:tokenPagination, as: GoogleApi.AndroidPublisher.V3.Model.TokenPagination)
end

defimpl Poison.Decoder, for: GoogleApi.AndroidPublisher.V3.Model.ReviewsListResponse do
  def decode(value, options) do
    GoogleApi.AndroidPublisher.V3.Model.ReviewsListResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidPublisher.V3.Model.ReviewsListResponse do
