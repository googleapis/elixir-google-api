...
defmodule GoogleApi.AndroidPublisher.V3.Model.Season do
  ...
  - end (GoogleApi.AndroidPublisher.V3.Model.MonthDay.t): Inclusive end date of the recurrence period. Defaults to `nil`.
  - prorations (list(GoogleApi.AndroidPublisher.V3.Model.Prorate.t)): Optionally present list of prorations for the season. Each proration is a one-off discounted entry into a subscription. Each proration contains the first date on which the discount is available and the new pricing information. Defaults to `nil`.
  - start (GoogleApi.AndroidPublisher.V3.Model.MonthDay.t): Inclusive start date of the recurrence period. Defaults to `nil`.
  """
