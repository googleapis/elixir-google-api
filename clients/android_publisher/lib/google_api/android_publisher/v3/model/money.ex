...
defmodule GoogleApi.AndroidPublisher.V3.Model.Money do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidPublisher.V3.Model.Money do
  def decode(value, options) do
    GoogleApi.AndroidPublisher.V3.Model.Money.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidPublisher.V3.Model.Money do
