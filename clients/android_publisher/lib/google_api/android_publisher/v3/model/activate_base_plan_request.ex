...
defmodule GoogleApi.AndroidPublisher.V3.Model.ActivateBasePlanRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidPublisher.V3.Model.ActivateBasePlanRequest do
  def decode(value, options) do
    GoogleApi.AndroidPublisher.V3.Model.ActivateBasePlanRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AndroidPublisher.V3.Model.ActivateBasePlanRequest do
