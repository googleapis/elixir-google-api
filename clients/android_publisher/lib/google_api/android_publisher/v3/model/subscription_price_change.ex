...
defmodule GoogleApi.AndroidPublisher.V3.Model.SubscriptionPriceChange do
  ...
  - newPrice (GoogleApi.AndroidPublisher.V3.Model.Price.t): The new price the subscription will renew with if the price change is accepted by the user. Defaults to `nil`.
