...
defmodule GoogleApi.AndroidPublisher.V2.Model.BundlesListResponse do
  ...
  - bundles ([Bundle]):  Defaults to: `null`.
  - kind (String.t): Identifies what kind of resource this is. Value: the fixed string \&quot;androidpublisher#bundlesListResponse\&quot;. Defaults to: `null`.
  """
