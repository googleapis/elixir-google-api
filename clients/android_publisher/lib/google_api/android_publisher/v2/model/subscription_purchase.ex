...
defmodule GoogleApi.AndroidPublisher.V2.Model.SubscriptionPurchase do
  ...
  *   `cancelSurveyResult` (*type:* `GoogleApi.AndroidPublisher.V2.Model.SubscriptionCancelSurveyResult.t`, *default:* `nil`) - Information provided by the user when they complete the subscription cancellation flow (cancellation reason survey).
  ...
  *   `priceChange` (*type:* `GoogleApi.AndroidPublisher.V2.Model.SubscriptionPriceChange.t`, *default:* `nil`) - The latest price change information available. This is present only when there is an upcoming price change for the subscription yet to be applied.
