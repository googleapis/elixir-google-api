...
defmodule GoogleApi.AndroidPublisher.V2.Model.SubscriptionPurchase do
  ...
  - cancelSurveyResult (GoogleApi.AndroidPublisher.V2.Model.SubscriptionCancelSurveyResult.t): Information provided by the user when they complete the subscription cancellation flow (cancellation reason survey). Defaults to `nil`.
  ...
  - priceChange (GoogleApi.AndroidPublisher.V2.Model.SubscriptionPriceChange.t): The latest price change information available. This is present only when there is an upcoming price change for the subscription yet to be applied.
