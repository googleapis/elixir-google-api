...
defmodule GoogleApi.Looker.V1.Model.EncryptionConfig do
  @moduledoc """
  ...
  *   `kmsKeyState` (*type:* `String.t`, *default:* `nil`) - Output only. Status of the CMEK key.
  ...
  field(:kmsKeyName)
  field(:kmsKeyNameVersion)
  field(:kmsKeyState)
end

defimpl Poison.Decoder, for: GoogleApi.Looker.V1.Model.EncryptionConfig do
  def decode(value, options) do
    GoogleApi.Looker.V1.Model.EncryptionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Looker.V1.Model.EncryptionConfig do
