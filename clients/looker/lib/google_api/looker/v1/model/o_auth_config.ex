...
defmodule GoogleApi.Looker.V1.Model.OAuthConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Looker.V1.Model.OAuthConfig do
  def decode(value, options) do
    GoogleApi.Looker.V1.Model.OAuthConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Looker.V1.Model.OAuthConfig do
