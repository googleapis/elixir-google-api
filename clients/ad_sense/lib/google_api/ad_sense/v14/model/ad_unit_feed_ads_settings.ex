...
defmodule GoogleApi.AdSense.V14.Model.AdUnitFeedAdsSettings do
  ...
  - adPosition (String.t): The position of the ads relative to the feed entries. Defaults to: `null`.
  ...
  - type (String.t): The type of ads which should appear. Defaults to: `null`.
  """
