...
defmodule GoogleApi.AdSense.V14.Model.AdClients do
  ...
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - Continuation token used to page through ad clients. To retrieve the next page of results, set the next request's "pageToken" value to this.
  ...
  @type t :: %__MODULE__{
          :etag => String.t() | nil,
          :items => list(GoogleApi.AdSense.V14.Model.AdClient.t()) | nil,
          :kind => String.t() | nil,
          :nextPageToken => String.t() | nil
        }

  field(:etag)
  field(:items, as: GoogleApi.AdSense.V14.Model.AdClient, type: :list)
  field(:kind)
  field(:nextPageToken)
end
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.AdClients do
  def decode(value, options) do
    GoogleApi.AdSense.V14.Model.AdClients.decode(value, options)
  end
end
