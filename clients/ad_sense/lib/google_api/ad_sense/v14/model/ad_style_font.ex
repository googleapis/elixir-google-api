...
defmodule GoogleApi.AdSense.V14.Model.AdStyleFont do
  ...
  - family (String.t): The family of the font. Defaults to: `null`.
  - size (String.t): The size of the font. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V14.Model.AdStyleFont do
  def decode(value, options) do
    GoogleApi.AdSense.V14.Model.AdStyleFont.decode(value, options)
  end
end
