...
defmodule GoogleApi.AdSense.V14.Api.Alerts do
  ...
  """
  @spec adsense_alerts_delete(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec adsense_alerts_list(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.AdSense.V14.Model.Alerts.t} | {:error, Tesla.Env.t}
