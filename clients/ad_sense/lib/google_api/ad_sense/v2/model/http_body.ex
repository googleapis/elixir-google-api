...
defmodule GoogleApi.AdSense.V2.Model.HttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AdSense.V2.Model.HttpBody do
  def decode(value, options) do
    GoogleApi.AdSense.V2.Model.HttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AdSense.V2.Model.HttpBody do
