...
defmodule GoogleApi.CloudRun.V1alpha1.Model.ResourceRecord do
  ...
  - name (String.t): Relative name of the object affected by this record. Only applicable for
  `CNAME` records. Example: 'www'. Defaults to `nil`.
  - rrdata (String.t): Data for this record. Values vary by record type, as defined in RFC 1035
  (section 5) and RFC 1034 (section 3.6.1). Defaults to `nil`.
