...
defmodule GoogleApi.CloudRun.V1alpha1.Model.SubscriberSpec do
  ...
  - ref (ObjectReference): Reference to an object that will be used to find the target endpoint, which should implement the Addressable duck type. For example, this could be a reference to a Route resource or a Knative Service resource. Defaults to: `null`.
  - uri (String.t): Reference to a &#39;known&#39; endpoint where no resolving is done. http://k8s-service for example http://myexternalhandler.example.com/foo/bar Defaults to: `null`.
  """
