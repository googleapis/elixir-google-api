...
defmodule GoogleApi.CloudRun.V1alpha1.Model.ListCloudAuditLogsSourcesResponse do
  ...
  *   `unreachable` (*type:* `list(String.t)`, *default:* `nil`) - Locations that could not be reached.
  ...
  @type t :: %__MODULE__{
          :apiVersion => String.t(),
          :items => list(GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource.t()),
          :kind => String.t(),
  ...
  field(:apiVersion)
  field(:items, as: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource, type: :list)
  field(:kind)
  field(:metadata, as: GoogleApi.CloudRun.V1alpha1.Model.ListMeta)
  field(:unreachable, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.ListCloudAuditLogsSourcesResponse do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.ListCloudAuditLogsSourcesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.ListCloudAuditLogsSourcesResponse do
