...
defmodule GoogleApi.CloudRun.V1alpha1.Model.RevisionTemplate do
  ...
  - metadata (GoogleApi.CloudRun.V1alpha1.Model.ObjectMeta.t): Optional metadata for this Revision, including labels and annotations. Name
  will be generated by the Configuration. Defaults to `nil`.
