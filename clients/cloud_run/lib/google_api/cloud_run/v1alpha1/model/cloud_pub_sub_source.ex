...
defmodule GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSource do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceStatus.t`, *default:* `nil`) - Status represents the current state of the CloudPubSubSource. This data may
  ...
  @type t :: %__MODULE__{
          ...
          :spec => GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec.t(),
          :status => GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceStatus.t()
        }

  field(:apiVersion)
  field(:kind)
  field(:metadata, as: GoogleApi.CloudRun.V1alpha1.Model.ObjectMeta)
  field(:spec, as: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec)
  field(:status, as: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceStatus)
end

defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSource do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSource do
