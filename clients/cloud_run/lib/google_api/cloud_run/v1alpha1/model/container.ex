...
defmodule GoogleApi.CloudRun.V1alpha1.Model.Container do
  ...
  precedence. Cannot be updated. +optional Defaults to `nil`.
  - image (String.t): Docker image name.
  More info: https://kubernetes.io/docs/concepts/containers/images Defaults to `nil`.
  ...
  lifecycle events. Cannot be updated. +optional Defaults to `nil`.
  ...
  result in EOF. Default is false. +optional Defaults to `nil`.
  ...
  reads from stdin will never receive an EOF. Default is false +optional Defaults to `nil`.
  ...
  'stdin' to be true. Default is false. +optional Defaults to `nil`.
