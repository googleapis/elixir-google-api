...
defmodule GoogleApi.CloudRun.V1alpha1.Model.Configuration do
  ...
  *   `metadata` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.ObjectMeta.t`, *default:* `nil`) - Metadata associated with this Configuration, including name, namespace, labels, and annotations.
  ...
  *   `status` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.ConfigurationStatus.t`, *default:* `nil`) - Status communicates the observed state of the Configuration (from the controller).
  """
  ...
  @type t :: %__MODULE__{
          ...
          :spec => GoogleApi.CloudRun.V1alpha1.Model.ConfigurationSpec.t() | nil,
          :status => GoogleApi.CloudRun.V1alpha1.Model.ConfigurationStatus.t() | nil
        }
