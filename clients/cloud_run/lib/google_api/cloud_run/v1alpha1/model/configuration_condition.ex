...
defmodule GoogleApi.CloudRun.V1alpha1.Model.ConfigurationCondition do
  ...
  - type (String.t): ConfigurationConditionType is used to communicate the status of the reconciliation process. See also: https://github.com/knative/serving/blob/master/docs/spec/errors.md#error-conditions-and-reporting Types include:\&quot;Ready\&quot; Defaults to: `null`.
  """
