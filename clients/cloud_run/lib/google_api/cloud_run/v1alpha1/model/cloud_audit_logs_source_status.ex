...
defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus do
