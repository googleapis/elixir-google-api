...
defmodule GoogleApi.CloudRun.V1alpha1.Model.StorageSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.StorageSpec do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.StorageSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.StorageSpec do
