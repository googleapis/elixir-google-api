...
defmodule GoogleApi.CloudRun.V1alpha1.Model.Service do
  ...
  *   `metadata` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.ObjectMeta.t`, *default:* `nil`) - Metadata associated with this Service, including name, namespace, labels, and annotations.
  ...
  *   `status` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.ServiceStatus.t`, *default:* `nil`) - Status communicates the observed state of the Service (from the controller).
  """
  ...
  @type t :: %__MODULE__{
          ...
          :spec => GoogleApi.CloudRun.V1alpha1.Model.ServiceSpec.t() | nil,
          :status => GoogleApi.CloudRun.V1alpha1.Model.ServiceStatus.t() | nil
        }
