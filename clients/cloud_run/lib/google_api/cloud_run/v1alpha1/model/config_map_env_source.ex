...
defmodule GoogleApi.CloudRun.V1alpha1.Model.ConfigMapEnvSource do
  ...
  - localObjectReference (LocalObjectReference): The ConfigMap to select from. Defaults to: `null`.
  - optional (boolean()): Specify whether the ConfigMap must be defined +optional Defaults to: `null`.
  """
