...
defmodule GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudPubSubSourceSpec do
