...
defmodule GoogleApi.CloudRun.V1alpha1.Model.RouteStatus do
  ...
  *   `conditions` (*type:* `list(GoogleApi.CloudRun.V1alpha1.Model.RouteCondition.t)`, *default:* `nil`) - Conditions communicates information about ongoing/complete reconciliation processes that bring the "spec" inline with the observed state of the world.
  *   `domain` (*type:* `String.t`, *default:* `nil`) - Deprecated - use url instead. Domain holds the top-level domain that will distribute traffic over the provided targets.
  *   `domainInternal` (*type:* `String.t`, *default:* `nil`) - Deprecated - use address instead. For Cloud Run, identifical to domain.
  ...
  *   `traffic` (*type:* `list(GoogleApi.CloudRun.V1alpha1.Model.TrafficTarget.t)`, *default:* `nil`) - Traffic holds the configured traffic distribution. These entries will always contain RevisionName references. When ConfigurationName appears in the spec, this will hold the LatestReadyRevisionName that we last observed.
