...
defmodule GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource do
  @moduledoc """
  ...
  *   `status` (*type:* `GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus.t`, *default:* `nil`) - Status represents the current state of the CloudAuditLogsSource. This data
  ...
  @type t :: %__MODULE__{
          ...
          :spec => GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceSpec.t(),
          :status => GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus.t()
        }

  field(:apiVersion)
  field(:kind)
  field(:metadata, as: GoogleApi.CloudRun.V1alpha1.Model.ObjectMeta)
  field(:spec, as: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceSpec)
  field(:status, as: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSourceStatus)
end

defimpl Poison.Decoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource do
  def decode(value, options) do
    GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudRun.V1alpha1.Model.CloudAuditLogsSource do
