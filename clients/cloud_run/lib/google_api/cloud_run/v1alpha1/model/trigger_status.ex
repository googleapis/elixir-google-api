...
defmodule GoogleApi.CloudRun.V1alpha1.Model.TriggerStatus do
  ...
  - conditions ([TriggerCondition]): Array of observed TriggerConditions, indicating the current state of the Trigger. Defaults to: `null`.
  - observedGeneration (integer()): ObservedGeneration is the &#39;Generation&#39; of the Trigger that was last processed by the controller. Defaults to: `null`.
  - subscriberUri (String.t): SubscriberURI is the resolved URI of the receiver for this Trigger. Defaults to: `null`.
  """
