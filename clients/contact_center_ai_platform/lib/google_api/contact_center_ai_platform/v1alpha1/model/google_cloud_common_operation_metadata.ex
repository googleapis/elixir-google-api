...
defmodule GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.GoogleCloudCommonOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.GoogleCloudCommonOperationMetadata do
  def decode(value, options) do
    GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.GoogleCloudCommonOperationMetadata.decode(
      value,
      options
    )
  end
