...
defmodule GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.OperationMetadata do
  @moduledoc """
  ...
  *   `contactCenter` (*type:* `GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.ContactCenter.t`, *default:* `nil`) - Contact center information for this request
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :contactCenter =>
            GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.ContactCenter.t() | nil,
  ...
  field(:apiVersion)
  field(:contactCenter, as: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.ContactCenter)
...
defimpl Poison.Decoder, for: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.OperationMetadata do
