...
defmodule GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ContactCenterAIPlatform.V1alpha1.Model.TimeOfDay do
