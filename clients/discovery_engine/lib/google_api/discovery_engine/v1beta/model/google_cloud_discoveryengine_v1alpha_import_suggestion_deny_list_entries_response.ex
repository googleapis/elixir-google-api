...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesResponse do
  @moduledoc """
  ...
  *   `importedEntriesCount` (*type:* `String.t`, *default:* `nil`) - Count of deny list entries successfully imported.
  ...
  field(:failedEntriesCount)
  field(:importedEntriesCount)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesResponse do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaImportSuggestionDenyListEntriesResponse.decode(
      value,
      options
    )
  end
