...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleRpcStatus do
