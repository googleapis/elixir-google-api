...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportCompletionSuggestionsRequest do
  @moduledoc """
  ...
  *   `inlineSource` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportCompletionSuggestionsRequestInlineSource.t`, *default:* `nil`) - The Inline source for suggestion entries.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :gcsSource =>
            ...
            | nil,
          :inlineSource =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportCompletionSuggestionsRequestInlineSource.t()
            | nil
        }
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportCompletionSuggestionsRequest do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportCompletionSuggestionsRequest.decode(
      value,
      options
    )
  end
