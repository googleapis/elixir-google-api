...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SearchRequestContentSearchSpecExtractiveContentSpec do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SearchRequestContentSearchSpecExtractiveContentSpec do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SearchRequestContentSearchSpecExtractiveContentSpec.decode(
      value,
      options
    )
  end
