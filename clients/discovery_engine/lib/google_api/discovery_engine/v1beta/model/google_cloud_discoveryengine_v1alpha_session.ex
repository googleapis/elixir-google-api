...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSession do
  @moduledoc """
  ...
  *   `userPseudoId` (*type:* `String.t`, *default:* `nil`) - A unique identifier for tracking users.
  ...
  @type t :: %__MODULE__{
          ...
          :turns =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSessionTurn.t()
            )
            | nil,
  ...
  field(:turns,
    as: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSessionTurn,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSession do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSession.decode(
      value,
      options
    )
  end
