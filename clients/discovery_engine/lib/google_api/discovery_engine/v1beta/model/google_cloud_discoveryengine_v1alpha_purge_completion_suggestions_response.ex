...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaPurgeCompletionSuggestionsResponse do
  @moduledoc """
  ...
  *   `purgeSucceeded` (*type:* `boolean()`, *default:* `nil`) - Whether the completion suggestions were successfully purged.
  ...
  field(:purgeSucceeded)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaPurgeCompletionSuggestionsResponse do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaPurgeCompletionSuggestionsResponse.decode(
      value,
      options
    )
  end
