...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleTypeDate do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleTypeDate do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleTypeDate.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleTypeDate do
