...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec do
  @moduledoc """
  ...
  *   `interpolationType` (*type:* `String.t`, *default:* `nil`) - Optional. The interpolation type to be applied to connect the control points listed below.
  ...
  @type t :: %__MODULE__{
          ...
          :controlPoints =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpecControlPoint.t()
            )
            | nil,
  ...
  field(:controlPoints,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpecControlPoint,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec.decode(
      value,
      options
    )
  end
