...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlPromoteAction do
  @moduledoc """
  ...
  *   `searchLinkPromotion` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SearchLinkPromotion.t`, *default:* `nil`) - Required. Promotion attached to this action.
  ...
  @type t :: %__MODULE__{
          ...
          :searchLinkPromotion =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SearchLinkPromotion.t()
            | nil
        }
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlPromoteAction do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlPromoteAction.decode(
      value,
      options
    )
  end
