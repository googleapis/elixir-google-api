...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleApiMonitoredResourceMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleApiMonitoredResourceMetadata do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleApiMonitoredResourceMetadata.decode(
      value,
      options
    )
  end
