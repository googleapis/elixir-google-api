...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaIdentityMappingStore do
  @moduledoc """
  Identity Mapping Store which contains Identity Mapping Entries.

  ## Attributes

  *   `cmekConfig` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaCmekConfig.t`, *default:* `nil`) - Output only. CMEK-related information for the Identity Mapping Store.
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaIdentityMappingStore do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaIdentityMappingStore.decode(
      value,
      options
    )
  end
