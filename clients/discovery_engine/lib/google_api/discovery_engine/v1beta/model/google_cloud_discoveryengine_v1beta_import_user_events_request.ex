...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequest do
  @moduledoc """
  ...
  *   `inlineSource` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequestInlineSource.t`, *default:* `nil`) - The Inline source for the input content for UserEvents.
  ...
  @type t :: %__MODULE__{
          ...
          :gcsSource =>
            ...
            | nil,
          :inlineSource =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequestInlineSource.t()
            | nil
        }
  ...
  field(:inlineSource,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequestInlineSource
  )
end

defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequest do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaImportUserEventsRequest.decode(
      value,
      options
    )
  end
