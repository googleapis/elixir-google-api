...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaFeedback do
  @moduledoc """
  ...
  *   `conversationInfo` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaFeedbackConversationInfo.t`, *default:* `nil`) - The related conversation information when user gives feedback.
  ...
  *   `reasons` (*type:* `list(String.t)`, *default:* `nil`) - Optional. The reason if user gives a thumb down.
  ...
  @type t :: %__MODULE__{
          ...
          :conversationInfo =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaFeedbackConversationInfo.t()
            | nil,
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaFeedback do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaFeedback.decode(
      value,
      options
    )
  end
