...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSite do
  @moduledoc """
  ...
  *   `failureReason` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSiteFailureReason.t`, *default:* `nil`) - Output only. Failure reason.
  ...
  *   `siteVerificationInfo` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SiteVerificationInfo.t`, *default:* `nil`) - Output only. Site ownership and validity verification status.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The target site's last updated time.
  ...
  @type t :: %__MODULE__{
          ...
          :failureReason =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSiteFailureReason.t()
            | nil,
          ...
          :siteVerificationInfo =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SiteVerificationInfo.t()
            | nil,
          :type => String.t() | nil,
  ...
  field(:failureReason,
    as: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSiteFailureReason
  )
  ...
  field(:siteVerificationInfo,
    as: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1SiteVerificationInfo
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSite do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1TargetSite.decode(
      value,
      options
    )
  end
