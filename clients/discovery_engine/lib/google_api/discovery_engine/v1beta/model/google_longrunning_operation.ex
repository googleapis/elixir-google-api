...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleLongrunningOperation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleRpcStatus.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleLongrunningOperation do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleLongrunningOperation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleLongrunningOperation do
