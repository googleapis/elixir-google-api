...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ServingConfig do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. ServingConfig updated timestamp.
  ...
  field(:genericConfig,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ServingConfigGenericConfig
  )
  ...
  field(:mediaConfig,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ServingConfigMediaConfig
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ServingConfig do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ServingConfig.decode(
      value,
      options
    )
  end
