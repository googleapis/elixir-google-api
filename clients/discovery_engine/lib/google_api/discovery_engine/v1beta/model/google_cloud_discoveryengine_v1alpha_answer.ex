...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswer do
  ...
  *   `blobAttachments` (*type:* `list(GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerBlobAttachment.t)`, *default:* `nil`) - List of blob attachments in the answer.
  ...
  *   `groundingSupports` (*type:* `list(GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport.t)`, *default:* `nil`) - Optional. Grounding supports.
  ...
  *   `safetyRatings` (*type:* `list(GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSafetyRating.t)`, *default:* `nil`) - Optional. Safety ratings.
  ...
  *   `steps` (*type:* `list(GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerStep.t)`, *default:* `nil`) - Answer generation steps.
  ...
  @type t :: %__MODULE__{
          ...
          :blobAttachments =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerBlobAttachment.t()
            )
            | nil,
          :citations =>
            list(
          ...
          :groundingSupports =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport.t()
            )
            | nil,
          :name => String.t() | nil,
          ...
          :safetyRatings =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSafetyRating.t()
            )
            | nil,
          :state => String.t() | nil,
          :steps =>
  ...
  field(:blobAttachments,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerBlobAttachment,
    type: :list
  )
  ...
  field(:groundingSupports,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport,
    type: :list
  )
  ...
  field(:safetyRatings,
    as: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaSafetyRating,
    type: :list
  )
