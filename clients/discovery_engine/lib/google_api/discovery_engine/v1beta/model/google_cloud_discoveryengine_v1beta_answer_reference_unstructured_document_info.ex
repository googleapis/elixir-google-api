...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaAnswerReferenceUnstructuredDocumentInfo do
  @moduledoc """
  ...
  *   `uri` (*type:* `String.t`, *default:* `nil`) - URI for the document.
  ...
  field(:chunkContents,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaAnswerReferenceUnstructuredDocumentInfoChunkContent,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaAnswerReferenceUnstructuredDocumentInfo do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1betaAnswerReferenceUnstructuredDocumentInfo.decode(
      value,
      options
    )
  end
