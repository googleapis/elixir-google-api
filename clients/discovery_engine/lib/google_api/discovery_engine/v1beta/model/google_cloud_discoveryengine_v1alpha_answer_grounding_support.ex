...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport do
  @moduledoc """
  ...
  *   `sources` (*type:* `list(GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerCitationSource.t)`, *default:* `nil`) - Optional. Citation sources for the claim.
  *   `startIndex` (*type:* `String.t`, *default:* `nil`) - Required. Index indicates the start of the claim, measured in bytes (UTF-8 unicode).
  ...
  @type t :: %__MODULE__{
          ...
          :sources =>
            list(
              GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerCitationSource.t()
            )
            | nil,
  ...
  field(:sources,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerCitationSource,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1alphaAnswerGroundingSupport.decode(
      value,
      options
    )
  end
