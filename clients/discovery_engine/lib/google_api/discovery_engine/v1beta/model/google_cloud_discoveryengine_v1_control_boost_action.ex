...
defmodule GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostAction do
  @moduledoc """
  ...
  *   `interpolationBoostSpec` (*type:* `GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec.t`, *default:* `nil`) - Optional. Complex specification for custom ranking based on customer defined attribute value.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :interpolationBoostSpec =>
            GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec.t()
            | nil
        }
  ...
  field(:interpolationBoostSpec,
    as:
      GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostActionInterpolationBoostSpec
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostAction do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1beta.Model.GoogleCloudDiscoveryengineV1ControlBoostAction.decode(
      value,
      options
    )
  end
