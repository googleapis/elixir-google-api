...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TypedValue do
  @moduledoc """
  ...
  *   `stringValue` (*type:* `String.t`, *default:* `nil`) - A variable-length string value.
  ...
  field(:boolValue)
  field(:distributionValue, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiDistribution)
  field(:doubleValue)
  field(:int64Value)
  field(:stringValue)
end

defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TypedValue do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TypedValue.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TypedValue do
