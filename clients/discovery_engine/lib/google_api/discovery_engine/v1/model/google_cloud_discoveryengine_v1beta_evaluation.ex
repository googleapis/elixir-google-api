...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaEvaluation do
  @moduledoc """
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The state of the evaluation.
  ...
  field(:evaluationSpec,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaEvaluationEvaluationSpec
  )

  field(:name)

  field(:qualityMetrics,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaQualityMetrics
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaEvaluation do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaEvaluation.decode(
      value,
      options
    )
  end
