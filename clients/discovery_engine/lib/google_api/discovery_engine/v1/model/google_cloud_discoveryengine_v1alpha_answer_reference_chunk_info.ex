...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfo do
  @moduledoc """
  Chunk information.
  ...
  *   `relevanceScore` (*type:* `number()`, *default:* `nil`) - The relevance of the chunk for a given query. Values range from 0.0 (completely irrelevant) to 1.0 (completely relevant). This value is for informational purpose only. It may change for the same query and chunk at any time due to a model retraining or change in implementation.
  ...
  @type t :: %__MODULE__{
          ...
          :documentMetadata =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfoDocumentMetadata.t()
            | nil,
  ...
  field(:documentMetadata,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfoDocumentMetadata
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfo do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfo.decode(
      value,
      options
    )
  end
