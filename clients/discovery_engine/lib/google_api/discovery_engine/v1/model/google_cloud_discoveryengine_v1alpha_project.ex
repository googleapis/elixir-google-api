...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaProject do
  @moduledoc """
  ...
  *   `serviceTermsMap` (*type:* `%{optional(String.t) => GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaProjectServiceTerms.t}`, *default:* `nil`) - Output only. A map of terms of services. The key is the `id` of ServiceTerms.
  ...
  field(:serviceTermsMap,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaProjectServiceTerms,
    type: :map
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaProject do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaProject.decode(
      value,
      options
    )
  end
