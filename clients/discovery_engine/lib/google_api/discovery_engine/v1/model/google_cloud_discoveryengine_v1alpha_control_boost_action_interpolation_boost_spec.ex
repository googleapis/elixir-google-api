...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec do
  @moduledoc """
  ...
  *   `interpolationType` (*type:* `String.t`, *default:* `nil`) - Optional. The interpolation type to be applied to connect the control points listed below.
  ...
  @type t :: %__MODULE__{
          ...
          :controlPoints =>
            list(
              GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpecControlPoint.t()
            )
            | nil,
  ...
  field(:controlPoints,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpecControlPoint,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec.decode(
      value,
      options
    )
  end
