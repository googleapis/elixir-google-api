...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTargetSite do
  @moduledoc """
  ...
  *   `siteVerificationInfo` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo.t`, *default:* `nil`) - Output only. Site ownership and validity verification status.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The target site's last updated time.
  ...
  @type t :: %__MODULE__{
          ...
          :failureReason =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason.t()
            | nil,
          ...
          :siteVerificationInfo =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo.t()
            | nil,
          :type => String.t() | nil,
  ...
  field(:failureReason,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason
  )
  ...
  field(:siteVerificationInfo,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTargetSite do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTargetSite.decode(
      value,
      options
    )
  end
