...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1BigQuerySource do
  @moduledoc """
  ...
  *   `tableId` (*type:* `String.t`, *default:* `nil`) - Required. The BigQuery table to copy the data from with a length limit of 1,024 characters.
  ...
  @type t :: %__MODULE__{
          ...
          :partitionDate => GoogleApi.DiscoveryEngine.V1.Model.GoogleTypeDate.t() | nil,
  ...
  field(:datasetId)
  field(:gcsStagingDir)
  field(:partitionDate, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleTypeDate)
  field(:projectId)
  field(:tableId)
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1BigQuerySource do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1BigQuerySource.decode(
      value,
      options
    )
  end
