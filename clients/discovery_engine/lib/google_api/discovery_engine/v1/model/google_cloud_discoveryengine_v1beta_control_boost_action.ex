...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostAction do
  @moduledoc """
  ...
  *   `interpolationBoostSpec` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec.t`, *default:* `nil`) - Optional. Complex specification for custom ranking based on customer defined attribute value.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :interpolationBoostSpec =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec.t()
            | nil
        }
  ...
  field(:interpolationBoostSpec,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostActionInterpolationBoostSpec
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostAction do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaControlBoostAction.decode(
      value,
      options
    )
  end
