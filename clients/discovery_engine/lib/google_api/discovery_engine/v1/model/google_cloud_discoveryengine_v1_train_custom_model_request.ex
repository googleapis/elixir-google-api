...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1TrainCustomModelRequest do
  @moduledoc """
  ...
  *   `modelType` (*type:* `String.t`, *default:* `nil`) - Model to be trained. Supported values are: * **search-tuning**: Fine tuning the search system based on data provided.
  ...
  field(:gcsTrainingInput,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1TrainCustomModelRequestGcsTrainingInput
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1TrainCustomModelRequest do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1TrainCustomModelRequest.decode(
      value,
      options
    )
  end
