...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TimeSeries do
  @moduledoc """
  ...
  *   `metric` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMetric.t`, *default:* `nil`) - The associated metric. A fully-specified metric used to identify the time series.
  ...
  *   `valueType` (*type:* `String.t`, *default:* `nil`) - The value type of the time series. When listing time series, this value type might be different from the value type of the associated metric if this time series is an alignment or reduction of other time series. When creating a time series, this field is optional. If present, it must be the same as the type of the data in the `points` field.
  ...
  @type t :: %__MODULE__{
          ...
          :metadata =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMonitoredResourceMetadata.t() | nil,
          :metric => GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMetric.t() | nil,
          :metricKind => String.t() | nil,
          :points => list(GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3Point.t()) | nil,
          :resource => GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMonitoredResource.t() | nil,
          :unit => String.t() | nil,
          :valueType => String.t() | nil
        }

  field(:description)
  field(:metadata, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMonitoredResourceMetadata)
  field(:metric, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMetric)
  field(:metricKind)
  field(:points, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3Point, type: :list)
  field(:resource, as: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiMonitoredResource)
  field(:unit)
  field(:valueType)
end

defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TimeSeries do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TimeSeries.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleMonitoringV3TimeSeries do
