...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSite do
  @moduledoc """
  ...
  *   `failureReason` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason.t`, *default:* `nil`) - Output only. Failure reason.
  ...
  *   `siteVerificationInfo` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSiteVerificationInfo.t`, *default:* `nil`) - Output only. Site ownership and validity verification status.
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The target site's last updated time.
  ...
  @type t :: %__MODULE__{
          ...
          :failureReason =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason.t()
            | nil,
          ...
          :siteVerificationInfo =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSiteVerificationInfo.t()
            | nil,
          :type => String.t() | nil,
  ...
  field(:failureReason,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason
  )
  ...
  field(:siteVerificationInfo,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSiteVerificationInfo
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSite do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaTargetSite.decode(
      value,
      options
    )
  end
