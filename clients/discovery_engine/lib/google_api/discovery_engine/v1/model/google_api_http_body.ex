...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleApiHttpBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiHttpBody do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleApiHttpBody.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DiscoveryEngine.V1.Model.GoogleApiHttpBody do
