...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaCmekConfig do
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. The states of the CmekConfig.
  ...
  @type t :: %__MODULE__{
          ...
          :singleRegionKeys =>
            list(
              GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaSingleRegionKey.t()
            )
            | nil,
          :state => String.t() | nil
        }
  ...
  field(:singleRegionKeys,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaSingleRegionKey,
    type: :list
  )
