...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostAction do
  @moduledoc """
  ...
  *   `interpolationBoostSpec` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec.t`, *default:* `nil`) - Optional. Complex specification for custom ranking based on customer defined attribute value.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :interpolationBoostSpec =>
            GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec.t()
            | nil
        }
  ...
  field(:interpolationBoostSpec,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostActionInterpolationBoostSpec
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostAction do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaControlBoostAction.decode(
      value,
      options
    )
  end
