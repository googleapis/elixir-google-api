...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfoDocumentMetadata do
  @moduledoc """
  Document metadata.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfoDocumentMetadata do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfoDocumentMetadata.decode(
      value,
      options
    )
  end
