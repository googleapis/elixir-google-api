...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReference do
  @moduledoc """
  Reference.
  ...
  *   `unstructuredDocumentInfo` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReferenceUnstructuredDocumentInfo.t`, *default:* `nil`) - Unstructured document information.
  ...
  field(:unstructuredDocumentInfo,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReferenceUnstructuredDocumentInfo
  )
end

defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReference do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1AnswerReference.decode(
      value,
      options
    )
  end
