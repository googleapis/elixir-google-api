...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResult do
  @moduledoc """
  ...
  *   `uri` (*type:* `String.t`, *default:* `nil`) - URI for the document.
  ...
  @type t :: %__MODULE__{
          :chunkInfo =>
            list(
              GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResultChunkInfo.t()
            )
            | nil,
          :document => String.t() | nil,
          :snippetInfo =>
            list(
              GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResultSnippetInfo.t()
            )
            | nil,
          :structData => map() | nil,
          :title => String.t() | nil,
  ...
  field(:chunkInfo,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResultChunkInfo,
    type: :list
  )
  ...
  field(:snippetInfo,
    as:
      GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResultSnippetInfo,
    type: :list
  )
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResult do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResult.decode(
      value,
      options
    )
  end
