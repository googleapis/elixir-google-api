...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTrainCustomModelResponse do
  @moduledoc """
  Response of the TrainCustomModelRequest. This message is returned by the google.longrunning.Operations.response field.

  ## Attributes

  *   `errorConfig` (*type:* `GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaImportErrorConfig.t`, *default:* `nil`) - Echoes the destination for the complete errors in the request if set.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTrainCustomModelResponse do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaTrainCustomModelResponse.decode(
      value,
      options
    )
  end
