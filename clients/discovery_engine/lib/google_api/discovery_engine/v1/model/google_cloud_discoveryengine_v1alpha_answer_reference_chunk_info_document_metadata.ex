...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfoDocumentMetadata do
  @moduledoc """
  Document metadata.
...
defimpl Poison.Decoder,
  for:
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfoDocumentMetadata do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1alphaAnswerReferenceChunkInfoDocumentMetadata.decode(
      value,
      options
    )
  end
