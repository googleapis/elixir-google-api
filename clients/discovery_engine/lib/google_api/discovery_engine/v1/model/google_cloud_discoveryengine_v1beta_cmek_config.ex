...
defmodule GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaCmekConfig do
  @moduledoc """
  ...
  *   `singleRegionKeys` (*type:* `list(GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSingleRegionKey.t)`, *default:* `nil`) - Optional. Single-regional CMEKs that are required for some VAIS features.
  *   `state` (*type:* `String.t`, *default:* `nil`) - Output only. State of the CmekConfig.
  ...
  @type t :: %__MODULE__{
          ...
          :singleRegionKeys =>
            list(
              GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSingleRegionKey.t()
            )
            | nil,
          :state => String.t() | nil
        }
  ...
  field(:singleRegionKeys,
    as: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaSingleRegionKey,
    type: :list
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaCmekConfig do
  def decode(value, options) do
    GoogleApi.DiscoveryEngine.V1.Model.GoogleCloudDiscoveryengineV1betaCmekConfig.decode(
      value,
      options
    )
  end
