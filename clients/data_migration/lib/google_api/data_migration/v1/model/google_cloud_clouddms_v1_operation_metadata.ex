...
defmodule GoogleApi.DataMigration.V1.Model.GoogleCloudClouddmsV1OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.DataMigration.V1.Model.GoogleCloudClouddmsV1OperationMetadata do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.GoogleCloudClouddmsV1OperationMetadata.decode(value, options)
  end
end
