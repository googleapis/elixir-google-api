...
defmodule GoogleApi.DataMigration.V1.Model.CloudSqlSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.CloudSqlSettings do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.CloudSqlSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.CloudSqlSettings do
