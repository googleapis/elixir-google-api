...
defmodule GoogleApi.DataMigration.V1.Model.Binding do
  @moduledoc """
  ...
  *   `role` (*type:* `String.t`, *default:* `nil`) - Role that is assigned to the list of `members`, or principals. For example, `roles/viewer`, `roles/editor`, or `roles/owner`.
  ...
  @type t :: %__MODULE__{
          :condition => GoogleApi.DataMigration.V1.Model.Expr.t() | nil,
          :members => list(String.t()) | nil,
          :role => String.t() | nil
        }

  field(:condition, as: GoogleApi.DataMigration.V1.Model.Expr)
  field(:members, type: :list)
  field(:role)
end

defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.Binding do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.Binding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.Binding do
