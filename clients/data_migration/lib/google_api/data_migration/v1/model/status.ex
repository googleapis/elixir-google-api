...
defmodule GoogleApi.DataMigration.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.Status do
