...
defmodule GoogleApi.DataMigration.V1.Model.SqlServerBackups do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.SqlServerBackups do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.SqlServerBackups.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.SqlServerBackups do
