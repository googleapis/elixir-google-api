...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.StaticIpConnectivity do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.StaticIpConnectivity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.StaticIpConnectivity do
