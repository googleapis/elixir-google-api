...
defmodule GoogleApi.DataMigration.V1.Model.Operation do
  @moduledoc """
  ...
  *   `error` (*type:* `GoogleApi.DataMigration.V1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.Operation do
