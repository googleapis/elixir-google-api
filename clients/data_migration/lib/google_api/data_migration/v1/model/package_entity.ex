...
defmodule GoogleApi.DataMigration.V1.Model.PackageEntity do
  @moduledoc """
  ...
  *   `packageSqlCode` (*type:* `String.t`, *default:* `nil`) - The SQL code which creates the package.
  ...
  field(:packageBody)
  field(:packageSqlCode)
end

defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.PackageEntity do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.PackageEntity.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.PackageEntity do
