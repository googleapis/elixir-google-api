...
defmodule GoogleApi.DataMigration.V1.Model.MigrationJobVerificationError do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.MigrationJobVerificationError do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.MigrationJobVerificationError.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.MigrationJobVerificationError do
