...
defmodule GoogleApi.DataMigration.V1.Model.ResumeMigrationJobRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1.Model.ResumeMigrationJobRequest do
  def decode(value, options) do
    GoogleApi.DataMigration.V1.Model.ResumeMigrationJobRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1.Model.ResumeMigrationJobRequest do
