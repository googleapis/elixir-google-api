...
defmodule GoogleApi.DataMigration.V1beta1.Model.SslConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1beta1.Model.SslConfig do
  def decode(value, options) do
    GoogleApi.DataMigration.V1beta1.Model.SslConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1beta1.Model.SslConfig do
