...
defmodule GoogleApi.DataMigration.V1beta1.Model.MySqlConnectionProfile do
  @moduledoc """
  ...
  *   `ssl` (*type:* `GoogleApi.DataMigration.V1beta1.Model.SslConfig.t`, *default:* `nil`) - SSL configuration for the destination to connect to the source database.
  *   `username` (*type:* `String.t`, *default:* `nil`) - Required. The username that Database Migration Service will use to connect to the database. The value is encrypted when stored in Database Migration Service.
  ...
  field(:passwordSet)
  field(:port)
  field(:ssl, as: GoogleApi.DataMigration.V1beta1.Model.SslConfig)
  field(:username)
end

defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1beta1.Model.MySqlConnectionProfile do
  def decode(value, options) do
    GoogleApi.DataMigration.V1beta1.Model.MySqlConnectionProfile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1beta1.Model.MySqlConnectionProfile do
