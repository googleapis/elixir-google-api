...
defmodule GoogleApi.DataMigration.V1beta1.Model.GenerateSshScriptRequest do
  @moduledoc """
  ...
  *   `vmSelectionConfig` (*type:* `GoogleApi.DataMigration.V1beta1.Model.VmSelectionConfig.t`, *default:* `nil`) - The VM selection configuration
  ...
  field(:vm)
  field(:vmCreationConfig, as: GoogleApi.DataMigration.V1beta1.Model.VmCreationConfig)
  field(:vmPort)
  field(:vmSelectionConfig, as: GoogleApi.DataMigration.V1beta1.Model.VmSelectionConfig)
end

defimpl Poison.Decoder, for: GoogleApi.DataMigration.V1beta1.Model.GenerateSshScriptRequest do
  def decode(value, options) do
    GoogleApi.DataMigration.V1beta1.Model.GenerateSshScriptRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DataMigration.V1beta1.Model.GenerateSshScriptRequest do
