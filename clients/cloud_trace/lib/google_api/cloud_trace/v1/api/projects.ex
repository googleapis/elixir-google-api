...
defmodule GoogleApi.CloudTrace.V1.Api.Projects do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.CloudTrace.V1.Model.Traces.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :endTime (DateTime.t): End of the time interval (inclusive) during which the trace data was
  collected from the application.
    - :filter (String.t): An optional filter against labels for the request.
  ...
  *   `url:VALUE`: Equivalent to `/http/url:VALUE`.
    - :orderBy (String.t): Field used to sort the returned traces. Optional.
  ...
  *   `start` (`start_time` field of the root span)
  ...
  return fewer traces than the requested page size. Optional.
    - :pageToken (String.t): Token identifying the page of results to return. If provided, use the
  value of the `next_page_token` field from a previous request. Optional.
    - :startTime (DateTime.t): Start of the time interval (inclusive) during which the trace data was
  collected from the application.
    - :view (String.t): Type of data returned for traces in the list. Optional. Default is
  `MINIMAL`.
