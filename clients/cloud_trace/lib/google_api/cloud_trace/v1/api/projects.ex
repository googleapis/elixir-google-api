...
defmodule GoogleApi.CloudTrace.V1.Api.Projects do
  ...
  def cloudtrace_projects_patch_traces(connection, project_id, opts \\ []) do
    ...
    |> Response.decode(struct: %GoogleApi.CloudTrace.V1.Model.Empty{})
  end
  ...
  def cloudtrace_projects_traces_get(connection, project_id, trace_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.CloudTrace.V1.Model.Trace{})
  end
  ...
  def cloudtrace_projects_traces_list(connection, project_id, opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(struct: %GoogleApi.CloudTrace.V1.Model.ListTracesResponse{})
  end
end
