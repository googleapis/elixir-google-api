...
defmodule GoogleApi.CloudTrace.V2.Model.StackFrames do
  ...
  If this value is 0, then no stack frames were dropped. Defaults to `nil`.
  - frame (list(GoogleApi.CloudTrace.V2.Model.StackFrame.t)): Stack frames in this call stack. Defaults to `nil`.
  """
