...
defmodule GoogleApi.CloudTrace.V2.Model.Annotation do
  ...
  - attributes (GoogleApi.CloudTrace.V2.Model.Attributes.t): A set of attributes on the annotation. You can have up to 4 attributes
  per Annotation. Defaults to `nil`.
  - description (GoogleApi.CloudTrace.V2.Model.TruncatableString.t): A user-supplied message describing the event. The maximum length for
  the description is 256 bytes. Defaults to `nil`.
  """
