...
defmodule GoogleApi.CloudTrace.V2.Model.BatchWriteSpansRequest do
  ...
  - spans (list(GoogleApi.CloudTrace.V2.Model.Span.t)): A list of new spans. The span names must not match existing
  spans, or the results are undefined. Defaults to `nil`.
  """
