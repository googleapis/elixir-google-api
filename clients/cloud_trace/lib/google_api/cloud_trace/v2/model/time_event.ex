...
defimpl Poison.Decoder, for: GoogleApi.CloudTrace.V2.Model.TimeEvent do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"annotation", :struct, GoogleApi.CloudTrace.V2.Model.Annotation, options)
    |> deserialize(:"networkEvent", :struct, GoogleApi.CloudTrace.V2.Model.NetworkEvent, options)
  end
end
