...
defmodule GoogleApi.CloudTrace.V2.Model.StackTrace do
  ...
  - stackFrames (GoogleApi.CloudTrace.V2.Model.StackFrames.t): Stack frames in this stack trace. A maximum of 128 frames are allowed. Defaults to `nil`.
  - stackTraceHashId (String.t): The hash ID is used to conserve network bandwidth for duplicate
  ...
  to that stack trace by only setting `stackTraceHashId`. Defaults to `nil`.
  """
