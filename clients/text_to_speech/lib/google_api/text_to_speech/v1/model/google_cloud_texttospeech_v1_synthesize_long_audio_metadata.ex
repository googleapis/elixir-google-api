...
defmodule GoogleApi.TextToSpeech.V1.Model.GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.TextToSpeech.V1.Model.GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata do
  def decode(value, options) do
    GoogleApi.TextToSpeech.V1.Model.GoogleCloudTexttospeechV1SynthesizeLongAudioMetadata.decode(
      value,
      options
    )
  end
