...
defmodule GoogleApi.TextToSpeech.V1.Model.Voice do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.TextToSpeech.V1.Model.Voice do
  def decode(value, options) do
    GoogleApi.TextToSpeech.V1.Model.Voice.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TextToSpeech.V1.Model.Voice do
