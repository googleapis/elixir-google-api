...
defmodule GoogleApi.TextToSpeech.V1.Api.Voices do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.TextToSpeech.V1.Model.ListVoicesResponse{}}` on success
  *   `{:error, info}` on failure
  ...
  def texttospeech_voices_list(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/voices", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)

    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.TextToSpeech.V1.Model.ListVoicesResponse{}])
  end
end
