...
defimpl Poison.Decoder, for: GoogleApi.TextToSpeech.V1beta1.Model.Turn do
  def decode(value, options) do
    GoogleApi.TextToSpeech.V1beta1.Model.Turn.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TextToSpeech.V1beta1.Model.Turn do
