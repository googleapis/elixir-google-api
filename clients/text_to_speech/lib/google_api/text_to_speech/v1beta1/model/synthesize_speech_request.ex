...
defmodule GoogleApi.TextToSpeech.V1beta1.Model.SynthesizeSpeechRequest do
  ...
  - audioConfig (GoogleApi.TextToSpeech.V1beta1.Model.AudioConfig.t): Required. The configuration of the synthesized audio. Defaults to `nil`.
  - input (GoogleApi.TextToSpeech.V1beta1.Model.SynthesisInput.t): Required. The Synthesizer requires either plain text or SSML as input. Defaults to `nil`.
  - voice (GoogleApi.TextToSpeech.V1beta1.Model.VoiceSelectionParams.t): Required. The desired voice of the synthesized audio. Defaults to `nil`.
  """
