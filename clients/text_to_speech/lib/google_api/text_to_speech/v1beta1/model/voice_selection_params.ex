...
defmodule GoogleApi.TextToSpeech.V1beta1.Model.VoiceSelectionParams do
  ...
  *   `voiceClone` (*type:* `GoogleApi.TextToSpeech.V1beta1.Model.VoiceCloneParams.t`, *default:* `nil`) - Optional. The configuration for a voice clone. If [VoiceCloneParams.voice_clone_key] is set, the service will choose the voice clone matching the specified configuration.
  """
