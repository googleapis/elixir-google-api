...
defmodule GoogleApi.TextToSpeech.V1beta1.Model.VoiceSelectionParams do
  ...
  *   `languageCode` (*type:* `String.t`, *default:* `nil`) - The language (and optionally also the region) of the voice expressed as a
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - The name of the voice. Optional; if not set, the service will choose a
      voice based on the other parameters such as language_code and gender.
  *   `ssmlGender` (*type:* `String.t`, *default:* `nil`) - The preferred gender of the voice. Optional; if not set, the service will
