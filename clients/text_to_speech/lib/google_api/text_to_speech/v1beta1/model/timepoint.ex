...
defimpl Poison.Decoder, for: GoogleApi.TextToSpeech.V1beta1.Model.Timepoint do
  def decode(value, options) do
    GoogleApi.TextToSpeech.V1beta1.Model.Timepoint.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.TextToSpeech.V1beta1.Model.Timepoint do
