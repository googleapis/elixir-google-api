...
defmodule GoogleApi.TextToSpeech.V1beta1.Api.Voices do
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.TextToSpeech.V1beta1.Model.GenerateVoiceCloningKeyRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options

  ## Returns

  *   `{:ok, %GoogleApi.TextToSpeech.V1beta1.Model.GenerateVoiceCloningKeyResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec texttospeech_voices_generate_voice_cloning_key(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.TextToSpeech.V1beta1.Model.GenerateVoiceCloningKeyResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def texttospeech_voices_generate_voice_cloning_key(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1beta1/voices:generateVoiceCloningKey", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.TextToSpeech.V1beta1.Model.GenerateVoiceCloningKeyResponse{}]
    )
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:languageCode` (*type:* `String.t`) - Optional. Recommended. [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt) language tag. If not specified, the API will return all supported voices. If specified, the ListVoices call will only return voices that can be used to synthesize this language_code. For example, if you specify `"en-NZ"`, all `"en-NZ"` voices will be returned. If you specify `"no"`, both `"no-\\*"` (Norwegian) and `"nb-\\*"` (Norwegian Bokmal) voices will be returned.
  *   `opts` (*type:* `keyword()`) - Call options
