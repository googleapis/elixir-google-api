...
defmodule GoogleApi.AnalyticsData.V1alpha.Model.Metadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1alpha.Model.Metadata do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1alpha.Model.Metadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1alpha.Model.Metadata do
