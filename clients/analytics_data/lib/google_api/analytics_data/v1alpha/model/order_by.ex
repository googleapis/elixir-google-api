...
defmodule GoogleApi.AnalyticsData.V1alpha.Model.OrderBy do
  @moduledoc """
  The sort options.
  ...
  *   `pivot` (*type:* `GoogleApi.AnalyticsData.V1alpha.Model.PivotOrderBy.t`, *default:* `nil`) - Sorts results by a metric's values within a pivot column group.
  ...
  field(:desc)
  field(:dimension, as: GoogleApi.AnalyticsData.V1alpha.Model.DimensionOrderBy)
  field(:metric, as: GoogleApi.AnalyticsData.V1alpha.Model.MetricOrderBy)
  field(:pivot, as: GoogleApi.AnalyticsData.V1alpha.Model.PivotOrderBy)
end

defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1alpha.Model.OrderBy do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1alpha.Model.OrderBy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1alpha.Model.OrderBy do
