...
defmodule GoogleApi.AnalyticsData.V1alpha.Model.BatchRunReportsRequest do
  @moduledoc """
  ...
  *   `requests` (*type:* `list(GoogleApi.AnalyticsData.V1alpha.Model.RunReportRequest.t)`, *default:* `nil`) - Individual requests. Each request has a separate report response. Each batch request is allowed up to 5 requests.
  ...
  field(:requests, as: GoogleApi.AnalyticsData.V1alpha.Model.RunReportRequest, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1alpha.Model.BatchRunReportsRequest do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1alpha.Model.BatchRunReportsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1alpha.Model.BatchRunReportsRequest do
