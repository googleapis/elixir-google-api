...
defmodule GoogleApi.AnalyticsData.V1alpha.Model.ConcatenateExpression do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1alpha.Model.ConcatenateExpression do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1alpha.Model.ConcatenateExpression.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1alpha.Model.ConcatenateExpression do
