...
defmodule GoogleApi.AnalyticsData.V1beta.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1beta.Model.Status do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1beta.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1beta.Model.Status do
