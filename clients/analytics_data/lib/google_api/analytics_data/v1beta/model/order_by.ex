...
defmodule GoogleApi.AnalyticsData.V1beta.Model.OrderBy do
  ...
  *   `pivot` (*type:* `GoogleApi.AnalyticsData.V1beta.Model.PivotOrderBy.t`, *default:* `nil`) - Sorts results by a metric's values within a pivot column group.
  ...
  field(:desc)
  field(:dimension, as: GoogleApi.AnalyticsData.V1beta.Model.DimensionOrderBy)
  field(:metric, as: GoogleApi.AnalyticsData.V1beta.Model.MetricOrderBy)
  field(:pivot, as: GoogleApi.AnalyticsData.V1beta.Model.PivotOrderBy)
end

defimpl Poison.Decoder, for: GoogleApi.AnalyticsData.V1beta.Model.OrderBy do
  def decode(value, options) do
    GoogleApi.AnalyticsData.V1beta.Model.OrderBy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AnalyticsData.V1beta.Model.OrderBy do
