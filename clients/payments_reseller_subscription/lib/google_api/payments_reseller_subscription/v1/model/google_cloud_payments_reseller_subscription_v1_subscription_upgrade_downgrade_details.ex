...
defmodule GoogleApi.PaymentsResellerSubscription.V1.Model.GoogleCloudPaymentsResellerSubscriptionV1SubscriptionUpgradeDowngradeDetails do
  @moduledoc """
  ...
  *   `previousSubscriptionId` (*type:* `String.t`, *default:* `nil`) - Required. The previous subscription id to be replaced. This is not the full resource name, use the subscription_id segment only.
  ...
  field(:billingCycleSpec)
  field(:previousSubscriptionId)
end

defimpl Poison.Decoder,
  for:
    GoogleApi.PaymentsResellerSubscription.V1.Model.GoogleCloudPaymentsResellerSubscriptionV1SubscriptionUpgradeDowngradeDetails do
  def decode(value, options) do
    GoogleApi.PaymentsResellerSubscription.V1.Model.GoogleCloudPaymentsResellerSubscriptionV1SubscriptionUpgradeDowngradeDetails.decode(
      value,
      options
    )
  end
