...
defmodule GoogleApi.Metastore.V1beta.Model.LimitConfig do
  @moduledoc """
  ...
  *   `minScalingFactor` (*type:* `number()`, *default:* `nil`) - Optional. The lowest scaling factor that the service should be autoscaled to.
  ...
  field(:maxScalingFactor)
  field(:minScalingFactor)
end

defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.LimitConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.LimitConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.LimitConfig do
