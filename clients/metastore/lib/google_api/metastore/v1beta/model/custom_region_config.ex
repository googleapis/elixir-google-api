...
defmodule GoogleApi.Metastore.V1beta.Model.CustomRegionConfig do
  @moduledoc """
  ...
  *   `readWriteRegions` (*type:* `list(String.t)`, *default:* `nil`) - Required. The list of read-write regions where the metastore service runs in. These regions should be part (or subset) of the multi-region.
  ...
  @type t :: %__MODULE__{
          :readOnlyRegions => list(String.t()) | nil,
          :readWriteRegions => list(String.t()) | nil
        }

  field(:readOnlyRegions, type: :list)
  field(:readWriteRegions, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.CustomRegionConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.CustomRegionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.CustomRegionConfig do
