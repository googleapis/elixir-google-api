...
defmodule GoogleApi.Metastore.V1beta.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.AuditLogConfig do
