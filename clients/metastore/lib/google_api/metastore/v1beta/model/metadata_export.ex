...
defmodule GoogleApi.Metastore.V1beta.Model.MetadataExport do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.MetadataExport do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.MetadataExport.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.MetadataExport do
