...
defmodule GoogleApi.Metastore.V1beta.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.OperationMetadata do
