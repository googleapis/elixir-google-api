...
defmodule GoogleApi.Metastore.V1beta.Model.MultiRegionMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.MultiRegionMetadata do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.MultiRegionMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.MultiRegionMetadata do
