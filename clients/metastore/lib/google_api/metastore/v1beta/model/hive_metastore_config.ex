...
defmodule GoogleApi.Metastore.V1beta.Model.HiveMetastoreConfig do
  ...
  *   `version` (*type:* `String.t`, *default:* `nil`) - Immutable. The Hive metastore schema version.
  ...
  @type t :: %__MODULE__{
          :auxiliaryVersions =>
            %{optional(String.t()) => GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig.t()}
            | nil,
  ...
  field(:auxiliaryVersions,
    as: GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig,
    type: :map
  )
