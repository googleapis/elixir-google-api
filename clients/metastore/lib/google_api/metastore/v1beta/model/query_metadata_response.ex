...
defmodule GoogleApi.Metastore.V1beta.Model.QueryMetadataResponse do
  @moduledoc """
  ...
  *   `resultManifestUri` (*type:* `String.t`, *default:* `nil`) - The manifest URI is link to a JSON instance in Cloud Storage. This instance manifests immediately along with QueryMetadataResponse. The content of the URI is not retriable until the long-running operation query against the metadata finishes.
  ...
  field(:resultManifestUri)
end

defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.QueryMetadataResponse do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.QueryMetadataResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.QueryMetadataResponse do
