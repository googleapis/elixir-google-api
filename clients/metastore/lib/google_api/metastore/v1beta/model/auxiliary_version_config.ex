...
defmodule GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1beta.Model.AuxiliaryVersionConfig do
