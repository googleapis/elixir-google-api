...
defmodule GoogleApi.Metastore.V1.Model.BackendMetastore do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.BackendMetastore do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.BackendMetastore.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.BackendMetastore do
