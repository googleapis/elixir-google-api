...
defmodule GoogleApi.Metastore.V1.Model.Service do
  ...
  *   `networkConfig` (*type:* `GoogleApi.Metastore.V1.Model.NetworkConfig.t`, *default:* `nil`) - The configuration specifying the network settings for the Dataproc Metastore service.
  ...
  *   `scalingConfig` (*type:* `GoogleApi.Metastore.V1.Model.ScalingConfig.t`, *default:* `nil`) - Scaling configuration of the metastore service.
  ...
  *   `telemetryConfig` (*type:* `GoogleApi.Metastore.V1.Model.TelemetryConfig.t`, *default:* `nil`) - The configuration specifying telemetry settings for the Dataproc Metastore service. If unspecified defaults to JSON.
