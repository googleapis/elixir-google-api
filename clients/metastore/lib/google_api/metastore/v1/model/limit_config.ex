...
defmodule GoogleApi.Metastore.V1.Model.LimitConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.LimitConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.LimitConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.LimitConfig do
