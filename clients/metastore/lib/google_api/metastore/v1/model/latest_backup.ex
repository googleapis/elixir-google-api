...
defmodule GoogleApi.Metastore.V1.Model.LatestBackup do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.LatestBackup do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.LatestBackup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.LatestBackup do
