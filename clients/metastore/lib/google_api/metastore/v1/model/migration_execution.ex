...
defmodule GoogleApi.Metastore.V1.Model.MigrationExecution do
  @moduledoc """
  ...
  *   `stateMessage` (*type:* `String.t`, *default:* `nil`) - Output only. Additional information about the current state of the migration execution.
  ...
  field(:cloudSqlMigrationConfig, as: GoogleApi.Metastore.V1.Model.CloudSQLMigrationConfig)
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.MigrationExecution do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.MigrationExecution.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.MigrationExecution do
