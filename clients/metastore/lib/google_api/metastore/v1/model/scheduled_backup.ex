...
defmodule GoogleApi.Metastore.V1.Model.ScheduledBackup do
  @moduledoc """
  ...
  *   `timeZone` (*type:* `String.t`, *default:* `nil`) - Optional. Specifies the time zone to be used when interpreting cron_schedule. Must be a time zone name from the time zone database (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones), e.g. America/Los_Angeles or Africa/Abidjan. If left unspecified, the default is UTC.
  ...
  field(:cronSchedule)
  field(:enabled)
  field(:latestBackup, as: GoogleApi.Metastore.V1.Model.LatestBackup)
  field(:nextScheduledTime, as: DateTime)
  field(:timeZone)
end

defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.ScheduledBackup do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.ScheduledBackup.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.ScheduledBackup do
