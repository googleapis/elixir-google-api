...
defmodule GoogleApi.Metastore.V1.Model.CloudSQLConnectionConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.CloudSQLConnectionConfig do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.CloudSQLConnectionConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.CloudSQLConnectionConfig do
