...
defmodule GoogleApi.Metastore.V1.Model.Expr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Metastore.V1.Model.Expr do
  def decode(value, options) do
    GoogleApi.Metastore.V1.Model.Expr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Metastore.V1.Model.Expr do
