...
defmodule GoogleApi.AppEngine.V1.Model.GoogleAppengineV1betaLocationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AppEngine.V1.Model.GoogleAppengineV1betaLocationMetadata do
  def decode(value, options) do
    GoogleApi.AppEngine.V1.Model.GoogleAppengineV1betaLocationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AppEngine.V1.Model.GoogleAppengineV1betaLocationMetadata do
