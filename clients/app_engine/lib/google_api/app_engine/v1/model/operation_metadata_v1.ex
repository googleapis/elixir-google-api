...
defmodule GoogleApi.AppEngine.V1.Model.OperationMetadataV1 do
  ...
  - createVersionMetadata (CreateVersionMetadataV1):  Defaults to: `null`.
  ...
  - method (String.t): API method that initiated this operation. Example: google.appengine.v1.Versions.CreateVersion.@OutputOnly Defaults to: `null`.
