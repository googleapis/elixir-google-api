...
defmodule GoogleApi.AppEngine.V1.Model.OperationMetadataV1Alpha do
  ...
  *   `createVersionMetadata` (*type:* `GoogleApi.AppEngine.V1.Model.CreateVersionMetadataV1Alpha.t`, *default:* `nil`) - 
  ...
  *   `method` (*type:* `String.t`, *default:* `nil`) - API method that initiated this operation. Example: google.appengine.v1alpha.Versions.CreateVersion.@OutputOnly
  ...
  *   `warning` (*type:* `list(String.t)`, *default:* `nil`) - Durable messages that persist on every operation poll. @OutputOnly
  ...
  @type t :: %__MODULE__{
          :createVersionMetadata => GoogleApi.AppEngine.V1.Model.CreateVersionMetadataV1Alpha.t(),
          :endTime => DateTime.t(),
  ...
  field(:createVersionMetadata, as: GoogleApi.AppEngine.V1.Model.CreateVersionMetadataV1Alpha)
...
defimpl Poison.Decoder, for: GoogleApi.AppEngine.V1.Model.OperationMetadataV1Alpha do
  def decode(value, options) do
    GoogleApi.AppEngine.V1.Model.OperationMetadataV1Alpha.decode(value, options)
  end
end
