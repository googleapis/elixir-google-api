...
defmodule GoogleApi.AppEngine.V1.Model.OperationMetadataV1Alpha do
  ...
  - createVersionMetadata (CreateVersionMetadataV1Alpha):  Defaults to: `null`.
  ...
  - method (String.t): API method that initiated this operation. Example: google.appengine.v1alpha.Versions.CreateVersion.@OutputOnly Defaults to: `null`.
