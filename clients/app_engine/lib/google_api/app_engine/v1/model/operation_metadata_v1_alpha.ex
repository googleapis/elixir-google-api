...
defmodule GoogleApi.AppEngine.V1.Model.OperationMetadataV1Alpha do
  ...
  - createVersionMetadata (GoogleApi.AppEngine.V1.Model.CreateVersionMetadataV1Alpha.t):  Defaults to `nil`.
  ...
  - method (String.t): API method that initiated this operation. Example: google.appengine.v1alpha.Versions.CreateVersion.@OutputOnly Defaults to `nil`.
