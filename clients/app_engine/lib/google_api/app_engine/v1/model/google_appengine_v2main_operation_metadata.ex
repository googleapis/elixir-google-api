...
defmodule GoogleApi.AppEngine.V1.Model.GoogleAppengineV2mainOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AppEngine.V1.Model.GoogleAppengineV2mainOperationMetadata do
  def decode(value, options) do
    GoogleApi.AppEngine.V1.Model.GoogleAppengineV2mainOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AppEngine.V1.Model.GoogleAppengineV2mainOperationMetadata do
