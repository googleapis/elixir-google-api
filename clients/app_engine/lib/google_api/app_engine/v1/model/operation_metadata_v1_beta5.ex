...
defmodule GoogleApi.AppEngine.V1.Model.OperationMetadataV1Beta5 do
  ...
  - method (String.t): API method name that initiated this operation. Example: google.appengine.v1beta5.Version.CreateVersion.@OutputOnly Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.AppEngine.V1.Model.OperationMetadataV1Beta5 do
  def decode(value, options) do
    GoogleApi.AppEngine.V1.Model.OperationMetadataV1Beta5.decode(value, options)
  end
end
