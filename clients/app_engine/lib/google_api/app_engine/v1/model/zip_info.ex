...
defmodule GoogleApi.AppEngine.V1.Model.ZipInfo do
  ...
  - sourceUrl (String.t): URL of the zip file to deploy from. Must be a URL to a resource in Google Cloud Storage in the form &#39;http(s)://storage.googleapis.com/&lt;bucket&gt;/&lt;object&gt;&#39;. Defaults to: `null`.
  """
