...
defmodule GoogleApi.Dataproc.V1.Model.SparkSqlJob do
  ...
  - jarFileUris (list(String.t)): Optional. HCFS URIs of jar files to be added to the Spark CLASSPATH. Defaults to `nil`.
  ...
  - properties (map()): Optional. A mapping of property names to values, used to configure Spark SQL's SparkConf. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Defaults to `nil`.
  - queryFileUri (String.t): The HCFS URI of the script that contains SQL queries. Defaults to `nil`.
  - queryList (GoogleApi.Dataproc.V1.Model.QueryList.t): A list of queries. Defaults to `nil`.
  - scriptVariables (map()): Optional. Mapping of query variable names to values (equivalent to the Spark SQL command: SET name="value";). Defaults to `nil`.
  """
