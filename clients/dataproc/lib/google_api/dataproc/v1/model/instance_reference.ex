...
defmodule GoogleApi.Dataproc.V1.Model.InstanceReference do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.InstanceReference do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.InstanceReference.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.InstanceReference do
