...
defmodule GoogleApi.Dataproc.V1.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.Interval do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.Interval do
