...
defmodule GoogleApi.Dataproc.V1.Model.StageShufflePushReadMetrics do
  @moduledoc """
  ...
  *   `remoteMergedReqsDuration` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:corruptMergedBlockChunks)
  field(:localMergedBlocksFetched)
  field(:localMergedBytesRead)
  field(:localMergedChunksFetched)
  field(:mergedFetchFallbackCount)
  field(:remoteMergedBlocksFetched)
  field(:remoteMergedBytesRead)
  field(:remoteMergedChunksFetched)
  field(:remoteMergedReqsDuration)
end

defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.StageShufflePushReadMetrics do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.StageShufflePushReadMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.StageShufflePushReadMetrics do
