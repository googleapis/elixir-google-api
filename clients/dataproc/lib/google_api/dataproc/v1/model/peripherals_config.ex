...
defmodule GoogleApi.Dataproc.V1.Model.PeripheralsConfig do
  @moduledoc """
  ...
  *   `sparkHistoryServerConfig` (*type:* `GoogleApi.Dataproc.V1.Model.SparkHistoryServerConfig.t`, *default:* `nil`) - Optional. The Spark History Server configuration for the workload.
  ...
  field(:metastoreService)
  field(:sparkHistoryServerConfig, as: GoogleApi.Dataproc.V1.Model.SparkHistoryServerConfig)
end

defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.PeripheralsConfig do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.PeripheralsConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.PeripheralsConfig do
