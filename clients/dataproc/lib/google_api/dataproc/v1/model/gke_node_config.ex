...
defmodule GoogleApi.Dataproc.V1.Model.GkeNodeConfig do
  ...
  *   `preemptible` (*type:* `boolean()`, *default:* `nil`) - Optional. Whether the nodes are created as preemptible VM instances (https://cloud.google.com/compute/docs/instances/preemptible).
