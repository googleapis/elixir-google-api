...
defmodule GoogleApi.Dataproc.V1.Model.GceNodePoolOperationMetadata do
  @moduledoc """
  Metadata describing the Compute Engine node pool operation.

  ## Attributes

  *   `clusterUuid` (*type:* `String.t`, *default:* `nil`) - Output only. Cluster UUID associated with the Compute Engine node pool operation.
  *   `description` (*type:* `String.t`, *default:* `nil`) - Output only. Short description of operation.
  *   `gceNodePoolId` (*type:* `String.t`, *default:* `nil`) - Output only. Compute Engine node pool ID for the operation.
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.GceNodePoolOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.GceNodePoolOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.GceNodePoolOperationMetadata do
