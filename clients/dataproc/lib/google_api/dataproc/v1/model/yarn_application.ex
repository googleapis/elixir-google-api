...
defmodule GoogleApi.Dataproc.V1.Model.YarnApplication do
  ...
  - name (String.t): Required. The application name. Defaults to `nil`.
  - progress (number()): Required. The numerical progress of the application, from 1 to 100. Defaults to `nil`.
  - state (String.t): Required. The application state. Defaults to `nil`.
  - trackingUrl (String.t): Optional. The HTTP URL of the ApplicationMaster, HistoryServer, or TimelineServer that provides application-specific information. The URL uses the internal hostname, and requires a proxy server for resolution and, possibly, access. Defaults to `nil`.
  """
