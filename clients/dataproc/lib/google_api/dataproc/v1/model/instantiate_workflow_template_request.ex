...
defmodule GoogleApi.Dataproc.V1.Model.InstantiateWorkflowTemplateRequest do
  ...
  *   `parameters` (*type:* `map()`, *default:* `nil`) - Optional. Map from parameter names to values that should be used for those parameters. Values may not exceed 100 characters.
