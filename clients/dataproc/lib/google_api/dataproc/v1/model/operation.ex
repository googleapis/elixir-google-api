...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.Operation do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"error", :struct, GoogleApi.Dataproc.V1.Model.Status, options)
    |> deserialize(:"metadata", :struct, GoogleApi.Dataproc.V1.Model.Object, options)
    |> deserialize(:"response", :struct, GoogleApi.Dataproc.V1.Model.Object, options)
  end
end
