...
defmodule GoogleApi.Dataproc.V1.Model.SparkJob do
  ...
  *   `fileUris` (*type:* `list(String.t)`, *default:* `nil`) - Optional. HCFS URIs of files to be copied to the working directory of Spark drivers and distributed tasks. Useful for naively parallel tasks.
