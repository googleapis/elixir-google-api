...
defmodule GoogleApi.Dataproc.V1.Model.ClusterOperation do
  ...
  *   `done` (*type:* `boolean()`, *default:* `nil`) - Output only. Indicates the operation is done.
  *   `error` (*type:* `String.t`, *default:* `nil`) - Output only. Error, if operation failed.
  *   `operationId` (*type:* `String.t`, *default:* `nil`) - Output only. The id of the cluster operation.
  """
