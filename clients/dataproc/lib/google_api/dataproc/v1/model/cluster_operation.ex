...
defmodule GoogleApi.Dataproc.V1.Model.ClusterOperation do
  ...
  - done (boolean()): Output only. Indicates the operation is done. Defaults to `nil`.
  - error (String.t): Output only. Error, if operation failed. Defaults to `nil`.
  - operationId (String.t): Output only. The id of the cluster operation. Defaults to `nil`.
  """
