...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.ConfidentialInstanceConfig do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.ConfidentialInstanceConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.ConfidentialInstanceConfig do
