...
defmodule GoogleApi.Dataproc.V1.Model.EncryptionConfig do
  ...
  *   `gcePdKmsKeyName` (*type:* `String.t`, *default:* `nil`) - Optional. The Cloud KMS key name to use for PD disk encryption for all instances in the cluster.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :gcePdKmsKeyName => String.t()
        }
