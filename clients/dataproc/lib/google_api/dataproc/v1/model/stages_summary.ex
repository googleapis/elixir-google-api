...
defmodule GoogleApi.Dataproc.V1.Model.StagesSummary do
  @moduledoc """
  ...
  *   `numSkippedStages` (*type:* `integer()`, *default:* `nil`) - 
  ...
  field(:numPendingStages)
  field(:numSkippedStages)
end

defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.StagesSummary do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.StagesSummary.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.StagesSummary do
