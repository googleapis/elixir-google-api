...
defmodule GoogleApi.Dataproc.V1.Model.OrderedJob do
  ...
  *   `prestoJob` (*type:* `GoogleApi.Dataproc.V1.Model.PrestoJob.t`, *default:* `nil`) - Presto job
  ...
  *   `sparkRJob` (*type:* `GoogleApi.Dataproc.V1.Model.SparkRJob.t`, *default:* `nil`) - Spark R job
