...
defmodule GoogleApi.Dataproc.V1.Model.Policy do
  ...
  *   `bindings` (*type:* `list(GoogleApi.Dataproc.V1.Model.Binding.t)`, *default:* `nil`) - Associates a list of members to a role. bindings with no members will result in an error.
