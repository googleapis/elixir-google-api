...
defmodule GoogleApi.Dataproc.V1.Model.PrestoJob do
  ...
  *   `clientTags` (*type:* `list(String.t)`, *default:* `nil`) - Optional. Presto client tags to attach to this query
  ...
  *   `outputFormat` (*type:* `String.t`, *default:* `nil`) - Optional. The format in which query output will be displayed. See the Presto documentation for supported output formats
  *   `properties` (*type:* `map()`, *default:* `nil`) - Optional. A mapping of property names to values. Used to set Presto session properties (https://prestodb.io/docs/current/sql/set-session.html) Equivalent to using the --session flag in the Presto CLI
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.PrestoJob do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.PrestoJob.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.PrestoJob do
