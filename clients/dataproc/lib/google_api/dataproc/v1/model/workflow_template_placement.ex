...
defmodule GoogleApi.Dataproc.V1.Model.WorkflowTemplatePlacement do
  ...
  - clusterSelector (ClusterSelector): Optional. A selector that chooses target cluster for jobs based on metadata.The selector is evaluated at the time each job is submitted. Defaults to: `null`.
  - managedCluster (ManagedCluster): Optional. A cluster that is managed by the workflow. Defaults to: `null`.
  """
