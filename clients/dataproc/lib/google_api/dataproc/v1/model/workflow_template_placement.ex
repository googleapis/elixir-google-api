...
defmodule GoogleApi.Dataproc.V1.Model.WorkflowTemplatePlacement do
  ...
  - clusterSelector (GoogleApi.Dataproc.V1.Model.ClusterSelector.t): Optional. A selector that chooses target cluster for jobs based on metadata.The selector is evaluated at the time each job is submitted. Defaults to `nil`.
  - managedCluster (GoogleApi.Dataproc.V1.Model.ManagedCluster.t): Optional. A cluster that is managed by the workflow. Defaults to `nil`.
  """
