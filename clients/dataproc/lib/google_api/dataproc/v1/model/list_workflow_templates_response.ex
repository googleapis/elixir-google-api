...
defmodule GoogleApi.Dataproc.V1.Model.ListWorkflowTemplatesResponse do
  ...
  - nextPageToken (String.t): Output only. This token is included in the response if there are more results to fetch. To fetch additional results, provide this value as the page_token in a subsequent &lt;code&gt;ListWorkflowTemplatesRequest&lt;/code&gt;. Defaults to: `null`.
  - templates ([WorkflowTemplate]): Output only. WorkflowTemplates list. Defaults to: `null`.
  """
