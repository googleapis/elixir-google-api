...
defmodule GoogleApi.Dataproc.V1.Model.StateOperatorProgress do
  @moduledoc """
  ...
  *   `operatorName` (*type:* `String.t`, *default:* `nil`) - 
  ...
  field(:allRemovalsTimeMs)
  field(:allUpdatesTimeMs)
  field(:commitTimeMs)
  field(:customMetrics, type: :map)
  field(:memoryUsedBytes)
  field(:numRowsDroppedByWatermark)
  field(:numRowsRemoved)
  field(:numRowsTotal)
  field(:numRowsUpdated)
  field(:numShufflePartitions)
  field(:numStateStoreInstances)
  field(:operatorName)
end

defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.StateOperatorProgress do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.StateOperatorProgress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.StateOperatorProgress do
