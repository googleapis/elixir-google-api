...
defmodule GoogleApi.Dataproc.V1.Model.SessionOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.SessionOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.SessionOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.SessionOperationMetadata do
