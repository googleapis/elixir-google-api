...
defmodule GoogleApi.Dataproc.V1.Model.SparkRBatch do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.SparkRBatch do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.SparkRBatch.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.SparkRBatch do
