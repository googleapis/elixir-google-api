...
defmodule GoogleApi.Dataproc.V1.Model.SearchSessionSparkApplicationStageAttemptsResponse do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.Dataproc.V1.Model.SearchSessionSparkApplicationStageAttemptsResponse do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.SearchSessionSparkApplicationStageAttemptsResponse.decode(
      value,
      options
    )
  end
