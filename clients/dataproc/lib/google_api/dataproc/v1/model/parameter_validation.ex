...
defmodule GoogleApi.Dataproc.V1.Model.ParameterValidation do
  ...
  - regex (GoogleApi.Dataproc.V1.Model.RegexValidation.t): Validation based on regular expressions. Defaults to `nil`.
  - values (GoogleApi.Dataproc.V1.Model.ValueValidation.t): Validation based on a list of allowed values. Defaults to `nil`.
  """
