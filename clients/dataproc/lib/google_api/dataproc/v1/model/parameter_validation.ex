...
defmodule GoogleApi.Dataproc.V1.Model.ParameterValidation do
  ...
  - regex (RegexValidation): Validation based on regular expressions. Defaults to: `null`.
  - values (ValueValidation): Validation based on a list of allowed values. Defaults to: `null`.
  """
