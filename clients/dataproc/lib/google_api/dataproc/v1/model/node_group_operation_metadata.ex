...
defmodule GoogleApi.Dataproc.V1.Model.NodeGroupOperationMetadata do
  @moduledoc """
  Metadata describing the node group operation.

  ## Attributes

  *   `clusterUuid` (*type:* `String.t`, *default:* `nil`) - Output only. Cluster UUID associated with the node group operation.
  ...
  *   `nodeGroupId` (*type:* `String.t`, *default:* `nil`) - Output only. Node group ID for the operation.
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.NodeGroupOperationMetadata do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.NodeGroupOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.NodeGroupOperationMetadata do
