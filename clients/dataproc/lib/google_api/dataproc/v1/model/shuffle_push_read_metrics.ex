...
defmodule GoogleApi.Dataproc.V1.Model.ShufflePushReadMetrics do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Dataproc.V1.Model.ShufflePushReadMetrics do
  def decode(value, options) do
    GoogleApi.Dataproc.V1.Model.ShufflePushReadMetrics.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Dataproc.V1.Model.ShufflePushReadMetrics do
