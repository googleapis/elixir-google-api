...
defmodule GoogleApi.Dataproc.V1.Model.ManagedGroupConfig do
  ...
  - instanceGroupManagerName (String.t): Output only. The name of the Instance Group Manager for this group. Defaults to `nil`.
  - instanceTemplateName (String.t): Output only. The name of the Instance Template used for the Managed Instance Group. Defaults to `nil`.
  """
