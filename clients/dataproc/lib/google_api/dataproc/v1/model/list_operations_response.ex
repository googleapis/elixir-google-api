...
defmodule GoogleApi.Dataproc.V1.Model.ListOperationsResponse do
  ...
  - operations (list(GoogleApi.Dataproc.V1.Model.Operation.t)): A list of operations that matches the specified filter in the request. Defaults to `nil`.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :operations => list(GoogleApi.Dataproc.V1.Model.Operation.t())
        }
