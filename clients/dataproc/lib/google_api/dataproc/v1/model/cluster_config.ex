...
defmodule GoogleApi.Dataproc.V1.Model.ClusterConfig do
  ...
  *   `gkeClusterConfig` (*type:* `GoogleApi.Dataproc.V1.Model.GkeClusterConfig.t`, *default:* `nil`) - Optional. BETA. The Kubernetes Engine config for Dataproc clusters deployed to The Kubernetes Engine config for Dataproc clusters deployed to Kubernetes. These config settings are mutually exclusive with Compute Engine-based options, such as gce_cluster_config, master_config, worker_config, secondary_worker_config, and autoscaling_config.
