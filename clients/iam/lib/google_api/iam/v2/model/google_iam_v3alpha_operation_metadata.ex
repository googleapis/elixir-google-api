...
defmodule GoogleApi.IAM.V2.Model.GoogleIamV3alphaOperationMetadata do
  @moduledoc """
  ...
  *   `target` (*type:* `String.t`, *default:* `nil`) - Output only. Server-defined resource path for the target of the
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3alphaOperationMetadata do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleIamV3alphaOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3alphaOperationMetadata do
