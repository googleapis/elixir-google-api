...
defmodule GoogleApi.IAM.V2.Model.GoogleIamV3mainOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3mainOperationMetadata do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleIamV3mainOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3mainOperationMetadata do
