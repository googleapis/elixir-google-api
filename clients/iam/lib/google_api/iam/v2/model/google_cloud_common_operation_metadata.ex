...
defmodule GoogleApi.IAM.V2.Model.GoogleCloudCommonOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleCloudCommonOperationMetadata do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleCloudCommonOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleCloudCommonOperationMetadata do
