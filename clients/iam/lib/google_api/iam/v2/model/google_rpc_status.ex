...
defmodule GoogleApi.IAM.V2.Model.GoogleRpcStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleRpcStatus do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleRpcStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleRpcStatus do
