...
defmodule GoogleApi.IAM.V2.Model.GoogleIamV3OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3OperationMetadata do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleIamV3OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleIamV3OperationMetadata do
