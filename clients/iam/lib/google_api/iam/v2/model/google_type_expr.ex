...
defmodule GoogleApi.IAM.V2.Model.GoogleTypeExpr do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V2.Model.GoogleTypeExpr do
  def decode(value, options) do
    GoogleApi.IAM.V2.Model.GoogleTypeExpr.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V2.Model.GoogleTypeExpr do
