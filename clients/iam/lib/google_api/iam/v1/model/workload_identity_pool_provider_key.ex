...
defmodule GoogleApi.IAM.V1.Model.WorkloadIdentityPoolProviderKey do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V1.Model.WorkloadIdentityPoolProviderKey do
  def decode(value, options) do
    GoogleApi.IAM.V1.Model.WorkloadIdentityPoolProviderKey.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V1.Model.WorkloadIdentityPoolProviderKey do
