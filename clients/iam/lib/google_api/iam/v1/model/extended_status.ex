...
defmodule GoogleApi.IAM.V1.Model.ExtendedStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V1.Model.ExtendedStatus do
  def decode(value, options) do
    GoogleApi.IAM.V1.Model.ExtendedStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V1.Model.ExtendedStatus do
