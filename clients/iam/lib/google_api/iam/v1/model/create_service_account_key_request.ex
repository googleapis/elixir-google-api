...
defmodule GoogleApi.IAM.V1.Model.CreateServiceAccountKeyRequest do
  ...
  - keyAlgorithm (String.t): Which type of key and algorithm to use for the key.
  The default is currently a 2K RSA key.  However this may change in the
  future. Defaults to `nil`.
  - privateKeyType (String.t): The output format of the private key. The default value is
