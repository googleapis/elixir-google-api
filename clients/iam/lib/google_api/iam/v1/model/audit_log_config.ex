...
defmodule GoogleApi.IAM.V1.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V1.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.IAM.V1.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V1.Model.AuditLogConfig do
