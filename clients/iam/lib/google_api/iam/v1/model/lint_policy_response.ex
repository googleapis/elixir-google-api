...
defmodule GoogleApi.IAM.V1.Model.LintPolicyResponse do
  ...
  - lintResults (list(GoogleApi.IAM.V1.Model.LintResult.t)): List of lint results sorted by a composite <severity, binding_ordinal> key,
  ...
  binding ordinal number(s). Defaults to `nil`.
  """
