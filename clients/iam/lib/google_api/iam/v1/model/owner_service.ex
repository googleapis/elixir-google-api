...
defmodule GoogleApi.IAM.V1.Model.OwnerService do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V1.Model.OwnerService do
  def decode(value, options) do
    GoogleApi.IAM.V1.Model.OwnerService.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V1.Model.OwnerService do
