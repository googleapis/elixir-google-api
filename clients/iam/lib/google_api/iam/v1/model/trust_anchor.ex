...
defmodule GoogleApi.IAM.V1.Model.TrustAnchor do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.IAM.V1.Model.TrustAnchor do
  def decode(value, options) do
    GoogleApi.IAM.V1.Model.TrustAnchor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.IAM.V1.Model.TrustAnchor do
