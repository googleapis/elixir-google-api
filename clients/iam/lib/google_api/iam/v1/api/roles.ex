...
defmodule GoogleApi.IAM.V1.Api.Roles do
  ...
  - roles_id (String.t): Part of `name`. The resource name of the role in one of the following formats:
  `roles/{ROLE_NAME}`
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :parent (String.t): The resource name of the parent resource in one of the following formats:
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.IAM.V1.Model.QueryGrantableRolesRequest.t): 
