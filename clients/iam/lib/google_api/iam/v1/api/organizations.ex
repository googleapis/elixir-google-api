...
defmodule GoogleApi.IAM.V1.Api.Organizations do
  ...
  - organizations_id (String.t): Part of `parent`. The resource name of the parent resource in one of the following formats:
  ...
  - connection (GoogleApi.IAM.V1.Connection): Connection to server
  - organizations_id (String.t): Part of `name`. The resource name of the role in one of the following formats:
