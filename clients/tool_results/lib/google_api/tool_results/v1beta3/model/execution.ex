...
defmodule GoogleApi.ToolResults.V1beta3.Model.Execution do
  ...
  *   `creationTime` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Timestamp.t`, *default:* `nil`) - The time when the Execution was created.
      ...
      - In create/update request: never set
  *   `dimensionDefinitions` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.MatrixDimensionDefinition.t)`, *default:* `nil`) - The dimensions along which different steps in this execution may vary.
