...
defmodule GoogleApi.ToolResults.V1beta3.Model.Execution do
  ...
  - completionTime (GoogleApi.ToolResults.V1beta3.Model.Timestamp.t): The time when the Execution status transitioned to COMPLETE.

  This value will be set automatically when state transitions to COMPLETE.

  - In response: set if the execution state is COMPLETE. - In create/update request: never set Defaults to `nil`.
  - creationTime (GoogleApi.ToolResults.V1beta3.Model.Timestamp.t): The time when the Execution was created.
  ...
  - executionId (String.t): A unique identifier within a History for this Execution.

  Returns INVALID_ARGUMENT if this field is set or overwritten by the caller.

  - In response always set - In create/update request: never set Defaults to `nil`.
  - outcome (GoogleApi.ToolResults.V1beta3.Model.Outcome.t): Classify the result, for example into SUCCESS or FAILURE

  - In response: present if set by create/update request - In create/update request: optional Defaults to `nil`.
  - specification (GoogleApi.ToolResults.V1beta3.Model.Specification.t): Lightweight information about execution request.

  - In response: present if set by create - In create: optional - In update: optional Defaults to `nil`.
  - state (String.t): The initial state is IN_PROGRESS.
  ...
  - testExecutionMatrixId (String.t): TestExecution Matrix ID that the TestExecutionService uses.

  - In response: present if set by create - In create: optional - In update: never set Defaults to `nil`.
  """
