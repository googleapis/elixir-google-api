...
defmodule GoogleApi.ToolResults.V1beta3.Model.Execution do
  ...
  - executionId (String.t): A unique identifier within a History for this Execution.  Returns INVALID_ARGUMENT if this field is set or overwritten by the caller.  - In response always set - In create/update request: never set Defaults to: `null`.
  ...
  - testExecutionMatrixId (String.t): TestExecution Matrix ID that the TestExecutionService uses.  - In response: present if set by create - In create: optional - In update: never set Defaults to: `null`.
  """
