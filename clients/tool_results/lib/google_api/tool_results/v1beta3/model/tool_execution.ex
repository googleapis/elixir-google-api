...
defmodule GoogleApi.ToolResults.V1beta3.Model.ToolExecution do
  ...
  - commandLineArguments ([String.t]): The full tokenized command line including the program name (equivalent to argv in a C program).  - In response: present if set by create request - In create request: optional - In update request: never set Defaults to: `null`.
