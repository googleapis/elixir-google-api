...
defmodule GoogleApi.ToolResults.V1beta3.Model.AppStartTime do
  ...
  *   `fullyDrawnTime` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Duration.t`, *default:* `nil`) - Optional. The time from app start to reaching the developer-reported
  ...
  *   `initialDisplayTime` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Duration.t`, *default:* `nil`) - The time from app start to the first displayed activity being drawn,
