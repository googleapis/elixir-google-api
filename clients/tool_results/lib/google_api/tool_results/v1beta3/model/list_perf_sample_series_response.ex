...
defmodule GoogleApi.ToolResults.V1beta3.Model.ListPerfSampleSeriesResponse do
  ...
  - perfSampleSeries (list(GoogleApi.ToolResults.V1beta3.Model.PerfSampleSeries.t)): The resulting PerfSampleSeries sorted by id Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1beta3.Model.ListPerfSampleSeriesResponse do
  def decode(value, options) do
    GoogleApi.ToolResults.V1beta3.Model.ListPerfSampleSeriesResponse.decode(value, options)
  end
end
