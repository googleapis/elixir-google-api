...
defmodule GoogleApi.ToolResults.V1beta3.Model.Image do
  ...
  - error (GoogleApi.ToolResults.V1beta3.Model.Status.t): An error explaining why the thumbnail could not be rendered. Defaults to `nil`.
  - sourceImage (GoogleApi.ToolResults.V1beta3.Model.ToolOutputReference.t): A reference to the full-size, original image.

  This is the same as the tool_outputs entry for the image under its Step.

  Always set. Defaults to `nil`.
  - stepId (String.t): The step to which the image is attached.

  Always set. Defaults to `nil`.
  - thumbnail (GoogleApi.ToolResults.V1beta3.Model.Thumbnail.t): The thumbnail. Defaults to `nil`.
  """
