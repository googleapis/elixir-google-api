...
defmodule GoogleApi.ToolResults.V1beta3.Model.AndroidAppInfo do
  ...
  - name (String.t): The name of the app. Optional Defaults to `nil`.
  - packageName (String.t): The package name of the app. Required. Defaults to `nil`.
  - versionCode (String.t): The internal version code of the app. Optional. Defaults to `nil`.
  - versionName (String.t): The version name of the app. Optional. Defaults to `nil`.
  """
