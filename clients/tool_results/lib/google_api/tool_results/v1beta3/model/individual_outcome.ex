...
defmodule GoogleApi.ToolResults.V1beta3.Model.IndividualOutcome do
  ...
  - outcomeSummary (String.t):  Defaults to `nil`.
  - runDuration (GoogleApi.ToolResults.V1beta3.Model.Duration.t): How long it took for this step to run. Defaults to `nil`.
  - stepId (String.t):  Defaults to `nil`.
  """
