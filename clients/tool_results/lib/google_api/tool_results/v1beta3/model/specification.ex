...
defmodule GoogleApi.ToolResults.V1beta3.Model.Specification do
  ...
  - androidTest (GoogleApi.ToolResults.V1beta3.Model.AndroidTest.t): An Android mobile test execution specification. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1beta3.Model.Specification do
  def decode(value, options) do
    GoogleApi.ToolResults.V1beta3.Model.Specification.decode(value, options)
  end
end
