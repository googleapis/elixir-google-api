...
defmodule GoogleApi.ToolResults.V1beta3.Model.SuccessDetail do
  ...
  *   `otherNativeCrash` (*type:* `boolean()`, *default:* `nil`) - If a native process other than the app crashed.
  """
...
defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1beta3.Model.SuccessDetail do
  def decode(value, options) do
    GoogleApi.ToolResults.V1beta3.Model.SuccessDetail.decode(value, options)
  end
end
