...
defmodule GoogleApi.ToolResults.V1beta3.Model.TestIssue do
  ...
  - type (String.t): Type of issue. Required. Defaults to: `null`.
    - Enum - one of [anr, compatibleWithOrchestrator, completeRoboScriptExecution, failedToInstall, fatalException, incompleteRoboScriptExecution, launcherActivityNotFound, nativeCrash, startActivityNotFound, unspecifiedType, unusedRoboDirective]
