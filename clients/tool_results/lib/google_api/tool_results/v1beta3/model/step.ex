...
defmodule GoogleApi.ToolResults.V1beta3.Model.Step do
  ...
  *   `creationTime` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Timestamp.t`, *default:* `nil`) - The time when the step was created.

      - In response: always set - In create/update request: never set
  *   `description` (*type:* `String.t`, *default:* `nil`) - A description of this tool For example: mvn clean package -D skipTests=true

      - In response: present if set by create/update request - In create/update request: optional
  *   `deviceUsageDuration` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Duration.t`, *default:* `nil`) - How much the device resource is used to perform the test.
  ...
  *   `dimensionValue` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.StepDimensionValueEntry.t)`, *default:* `nil`) - If the execution containing this step has any dimension_definition set, then this field allows the child to specify the values of the dimensions.
  ...
  *   `hasImages` (*type:* `boolean()`, *default:* `nil`) - Whether any of the outputs of this step are images whose thumbnails can be fetched with ListThumbnails.

      - In response: always set - In create/update request: never set
  *   `labels` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.StepLabelsEntry.t)`, *default:* `nil`) - Arbitrary user-supplied key/value pairs that are associated with the step.
  ...
  *   `multiStep` (*type:* `GoogleApi.ToolResults.V1beta3.Model.MultiStep.t`, *default:* `nil`) - Details when multiple steps are run with the same configuration as a group. These details can be used identify which group this step is part of. It also identifies the groups 'primary step' which indexes all the group members.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - A short human-readable name to display in the UI. Maximum of 100 characters. For example: Clean build
  ...
  *   `outcome` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Outcome.t`, *default:* `nil`) - Classification of the result, for example into SUCCESS or FAILURE
  ...
  *   `state` (*type:* `String.t`, *default:* `nil`) - The initial state is IN_PROGRESS. The only legal state transitions are * IN_PROGRESS -> COMPLETE
  ...
  *   `stepId` (*type:* `String.t`, *default:* `nil`) - A unique identifier within a Execution for this Step.
