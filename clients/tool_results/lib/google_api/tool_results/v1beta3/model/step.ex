...
defmodule GoogleApi.ToolResults.V1beta3.Model.Step do
  ...
  *   `creationTime` (*type:* `GoogleApi.ToolResults.V1beta3.Model.Timestamp.t`, *default:* `nil`) - The time when the step was created.
      ...
      - In create/update request: never set
  *   `description` (*type:* `String.t`, *default:* `nil`) - A description of this tool
  ...
  *   `dimensionValue` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.StepDimensionValueEntry.t)`, *default:* `nil`) - If the execution containing this step has any dimension_definition set,
  ...
  *   `hasImages` (*type:* `boolean()`, *default:* `nil`) - Whether any of the outputs of this step are images whose
      thumbnails can be fetched with ListThumbnails.

      - In response: always set
      - In create/update request: never set
  *   `labels` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.StepLabelsEntry.t)`, *default:* `nil`) - Arbitrary user-supplied key/value pairs that are associated with the
      step.
  ...
  *   `multiStep` (*type:* `GoogleApi.ToolResults.V1beta3.Model.MultiStep.t`, *default:* `nil`) - Details when multiple steps are run with the same configuration as a group.
      ...
      once.
      - In update request: optional
  *   `name` (*type:* `String.t`, *default:* `nil`) - A short human-readable name to display in the UI.
