...
defmodule GoogleApi.ToolResults.V1beta3.Model.ToolOutputReference do
  ...
  - creationTime (GoogleApi.ToolResults.V1beta3.Model.Timestamp.t): The creation time of the file.

  - In response: present if set by create/update request - In create/update request: optional Defaults to `nil`.
  - output (GoogleApi.ToolResults.V1beta3.Model.FileReference.t): A FileReference to an output file.

  - In response: always set - In create/update request: always set Defaults to `nil`.
  - testCase (GoogleApi.ToolResults.V1beta3.Model.TestCaseReference.t): The test case to which this output file belongs.
