...
defmodule GoogleApi.ToolResults.V1beta3.Model.ListStepAccessibilityClustersResponse do
  ...
  *   `clusters` (*type:* `list(GoogleApi.ToolResults.V1beta3.Model.SuggestionClusterProto.t)`, *default:* `nil`) - A sequence of accessibility suggestions, grouped into clusters.
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - A full resource name of the step.
