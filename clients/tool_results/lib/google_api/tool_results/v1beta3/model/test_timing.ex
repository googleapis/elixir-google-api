...
defmodule GoogleApi.ToolResults.V1beta3.Model.TestTiming do
  ...
  - testProcessDuration (GoogleApi.ToolResults.V1beta3.Model.Duration.t): How long it took to run the test process.

  - In response: present if previously set. - In create/update request: optional Defaults to `nil`.
  """
