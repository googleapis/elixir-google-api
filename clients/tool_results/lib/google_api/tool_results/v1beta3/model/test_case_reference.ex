...
defmodule GoogleApi.ToolResults.V1beta3.Model.TestCaseReference do
  ...
  - className (String.t): The name of the class. Defaults to `nil`.
  - name (String.t): The name of the test case.

  Required. Defaults to `nil`.
  - testSuiteName (String.t): The name of the test suite to which this test case belongs. Defaults to `nil`.
  """
