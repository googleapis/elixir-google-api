...
defmodule GoogleApi.ToolResults.V1beta3.Model.CPUInfo do
  ...
  - cpuProcessor (String.t): description of the device processor ie '1.8 GHz hexa core 64-bit ARMv8-A' Defaults to `nil`.
  - cpuSpeedInGhz (number()): the CPU clock speed in GHz Defaults to `nil`.
  - numberOfCores (integer()): the number of CPU cores Defaults to `nil`.
  """
