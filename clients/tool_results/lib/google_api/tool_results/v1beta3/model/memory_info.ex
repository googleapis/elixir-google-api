...
defmodule GoogleApi.ToolResults.V1beta3.Model.MemoryInfo do
  ...
  - memoryCapInKibibyte (String.t): Maximum memory that can be allocated to the process in KiB Defaults to `nil`.
  - memoryTotalInKibibyte (String.t): Total memory available on the device in KiB Defaults to `nil`.
  """
  ...
  field(:memoryTotalInKibibyte)
end

defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1beta3.Model.MemoryInfo do
  def decode(value, options) do
    GoogleApi.ToolResults.V1beta3.Model.MemoryInfo.decode(value, options)
  end
end
