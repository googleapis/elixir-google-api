...
defmodule GoogleApi.ToolResults.V1beta3.Model.Status do
  ...
  - details (List[Any]): A list of messages that carry the error details. There is a common set of message types for APIs to use. Defaults to: `null`.
...
defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1beta3.Model.Status do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"details", :list, GoogleApi.ToolResults.V1beta3.Model.Any, options)
  end
end
