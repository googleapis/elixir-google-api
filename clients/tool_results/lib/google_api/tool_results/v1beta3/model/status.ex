...
defmodule GoogleApi.ToolResults.V1beta3.Model.Status do
  ...
  - details (list(GoogleApi.ToolResults.V1beta3.Model.Any.t)): A list of messages that carry the error details. There is a common set of message types for APIs to use. Defaults to `nil`.
