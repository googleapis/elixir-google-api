...
defmodule GoogleApi.ToolResults.V1beta3.Model.AndroidInstrumentationTest do
  ...
  - testPackageId (String.t): The java package for the test to be executed. Required Defaults to `nil`.
  - testRunnerClass (String.t): The InstrumentationTestRunner class. Required Defaults to `nil`.
  - testTargets (list(String.t)): Each target must be fully qualified with the package name or class name, in one of these formats: - "package package_name" - "class package_name.class_name" - "class package_name.class_name#method_name"

  If empty, all targets in the module will be run. Defaults to `nil`.
  - useOrchestrator (boolean()): The flag indicates whether Android Test Orchestrator will be used to run test or not. Defaults to `nil`.
  """
