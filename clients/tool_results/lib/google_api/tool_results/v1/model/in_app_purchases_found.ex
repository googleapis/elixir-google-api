...
defmodule GoogleApi.ToolResults.V1.Model.InAppPurchasesFound do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ToolResults.V1.Model.InAppPurchasesFound do
  def decode(value, options) do
    GoogleApi.ToolResults.V1.Model.InAppPurchasesFound.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ToolResults.V1.Model.InAppPurchasesFound do
