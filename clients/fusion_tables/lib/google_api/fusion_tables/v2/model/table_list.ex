...
defmodule GoogleApi.FusionTables.V2.Model.TableList do
  ...
  - items (list(GoogleApi.FusionTables.V2.Model.Table.t)): List of all requested tables. Defaults to `nil`.
  - kind (String.t): The kind of item this is. For table list, this is always fusiontables#tableList. Defaults to `fusiontables#tableList`.
