...
defmodule GoogleApi.FusionTables.V2.Model.TableList do
  ...
  - items ([Table]): List of all requested tables. Defaults to: `null`.
  - kind (String.t): The kind of item this is. For table list, this is always fusiontables#tableList. Defaults to: `null`.
