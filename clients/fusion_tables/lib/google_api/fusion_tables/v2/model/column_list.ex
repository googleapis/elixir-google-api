...
defmodule GoogleApi.FusionTables.V2.Model.ColumnList do
  ...
  *   `items` (*type:* `list(GoogleApi.FusionTables.V2.Model.Column.t)`, *default:* `nil`) - List of all requested columns.
  *   `kind` (*type:* `String.t`, *default:* `fusiontables#columnList`) - The kind of item this is. For a column list, this is always fusiontables#columnList.
  ...
  *   `totalItems` (*type:* `integer()`, *default:* `nil`) - Total number of columns for the table.
  """
