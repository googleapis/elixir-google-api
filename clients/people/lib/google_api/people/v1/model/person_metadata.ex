...
defmodule GoogleApi.People.V1.Model.PersonMetadata do
  ...
  *   `deleted` (*type:* `boolean()`, *default:* `nil`) - Output only. True if the person resource has been deleted. Populated only for [`connections.list`](/people/api/rest/v1/people.connections/list) and [`otherContacts.list`](/people/api/rest/v1/otherContacts/list) requests that include a sync token.
