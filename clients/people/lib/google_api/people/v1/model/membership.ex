...
defimpl Poison.Decoder, for: GoogleApi.People.V1.Model.Membership do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"contactGroupMembership", :struct, GoogleApi.People.V1.Model.ContactGroupMembership, options)
    |> deserialize(:"domainMembership", :struct, GoogleApi.People.V1.Model.DomainMembership, options)
