...
defmodule GoogleApi.People.V1.Model.UserDefined do
  ...
  - key (String.t): The end user specified key of the user defined data. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the user defined data. Defaults to `nil`.
  - value (String.t): The end user specified value of the user defined data. Defaults to `nil`.
  """
