...
defmodule GoogleApi.People.V1.Model.PersonResponse do
  ...
  (http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html). Defaults to `nil`.
  - person (GoogleApi.People.V1.Model.Person.t): The person. Defaults to `nil`.
  - requestedResourceName (String.t): The original requested resource name. May be different than the resource
  name on the returned person.

  The resource name can change when adding or removing fields that link a
  contact and profile such as a verified email, verified phone number, or a
  profile URL. Defaults to `nil`.
  - status (GoogleApi.People.V1.Model.Status.t): The status of the response. Defaults to `nil`.
  """
