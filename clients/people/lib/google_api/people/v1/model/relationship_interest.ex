...
defmodule GoogleApi.People.V1.Model.RelationshipInterest do
  ...
  - formattedValue (String.t): The value of the relationship interest translated and formatted in the
  viewer's account locale or the locale specified in the Accept-Language
  HTTP header. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the relationship interest. Defaults to `nil`.
  - value (String.t): The kind of relationship the person is looking for. The value can be custom
  or one of these predefined values:

  * `friend`
  * `date`
  * `relationship`
  * `networking` Defaults to `nil`.
  """
