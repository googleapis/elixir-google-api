...
defmodule GoogleApi.People.V1.Model.Birthday do
  ...
  - date (GoogleApi.People.V1.Model.Date.t): The date of the birthday. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the birthday. Defaults to `nil`.
  - text (String.t): A free-form string representing the user's birthday. Defaults to `nil`.
  """
