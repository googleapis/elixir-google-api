...
defmodule GoogleApi.People.V1.Model.SipAddress do
  ...
  - formattedType (String.t): The read-only type of the SIP address translated and formatted in the
  viewer's account locale or the `Accept-Language` HTTP header locale. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the SIP address. Defaults to `nil`.
  - type (String.t): The type of the SIP address. The type can be custom or or one of these
  predefined values:
  ...
  * `other` Defaults to `nil`.
  - value (String.t): The SIP address in the
