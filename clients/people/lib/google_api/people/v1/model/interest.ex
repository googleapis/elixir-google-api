...
defmodule GoogleApi.People.V1.Model.Interest do
  ...
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the interest. Defaults to `nil`.
  - value (String.t): The interest; for example, `stargazing`. Defaults to `nil`.
  """
