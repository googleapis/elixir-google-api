...
defmodule GoogleApi.People.V1.Model.Source do
  ...
  *   `profileMetadata` (*type:* `GoogleApi.People.V1.Model.ProfileMetadata.t`, *default:* `nil`) - Output only. **Only populated in `person.metadata.sources`.**

      Metadata about a source of type PROFILE.
  *   `type` (*type:* `String.t`, *default:* `nil`) - The source type.
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. **Only populated in `person.metadata.sources`.**
