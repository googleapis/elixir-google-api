...
defmodule GoogleApi.People.V1.Model.Source do
  ...
  *   `etag` (*type:* `String.t`, *default:* `nil`) - **Only populated in `person.metadata.sources`.** The [HTTP entity tag](https://en.wikipedia.org/wiki/HTTP_ETag) of the source. Used for web cache validation.
