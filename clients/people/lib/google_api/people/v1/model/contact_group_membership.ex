...
defmodule GoogleApi.People.V1.Model.ContactGroupMembership do
  ...
  - contactGroupId (String.t): The read-only contact group ID for the contact group membership. Defaults to `nil`.
  - contactGroupResourceName (String.t): The resource name for the contact group, assigned by the server. An ASCII
  ...
  contact must always have at least one contact group membership. Defaults to `nil`.
  """
