...
defmodule GoogleApi.People.V1.Model.Locale do
  ...
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the locale. Defaults to `nil`.
  - value (String.t): The well-formed [IETF BCP 47](https://tools.ietf.org/html/bcp47)
  language tag representing the locale. Defaults to `nil`.
  """
