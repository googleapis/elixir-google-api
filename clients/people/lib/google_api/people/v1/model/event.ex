...
defmodule GoogleApi.People.V1.Model.Event do
  ...
  - date (GoogleApi.People.V1.Model.Date.t): The date of the event. Defaults to `nil`.
  - formattedType (String.t): The read-only type of the event translated and formatted in the
  viewer's account locale or the `Accept-Language` HTTP header locale. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the event. Defaults to `nil`.
  - type (String.t): The type of the event. The type can be custom or one of these predefined
  values:
