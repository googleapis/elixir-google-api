...
defmodule GoogleApi.People.V1.Model.Photo do
  ...
  false if the photo is a user-provided photo. Defaults to `nil`.
  - metadata (GoogleApi.People.V1.Model.FieldMetadata.t): Metadata about the photo. Defaults to `nil`.
  - url (String.t): The URL of the photo. You can change the desired size by appending a query
  parameter `sz=`<var>size</var> at the end of the url. Example:
  `https://lh3.googleusercontent.com/-T_wVWLlmg7w/AAAAAAAAAAI/AAAAAAAABa8/00gzXvDBYqw/s100/photo.jpg?sz=50` Defaults to `nil`.
  """
