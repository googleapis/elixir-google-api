...
defmodule GoogleApi.People.V1.Model.BraggingRights do
  ...
  - metadata (FieldMetadata): Metadata about the bragging rights. Defaults to: `null`.
  - value (String.t): The bragging rights; for example, &#x60;climbed mount everest&#x60;. Defaults to: `null`.
  """
