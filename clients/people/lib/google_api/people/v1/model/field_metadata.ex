...
defmodule GoogleApi.People.V1.Model.FieldMetadata do
  ...
  - source (GoogleApi.People.V1.Model.Source.t): The source of the field. Defaults to `nil`.
  - verified (boolean()): True if the field is verified; false if the field is unverified. A
  verified field is typically a name, email address, phone number, or
  website that has been confirmed to be owned by the person. Defaults to `nil`.
  """
