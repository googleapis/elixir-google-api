...
defmodule GoogleApi.People.V1.Api.People do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.People.V1.Model.Person.t): 
  ...
  - connection (GoogleApi.People.V1.Connection): Connection to server
  - people_id (String.t): Part of `resourceName`. The resource name of the person to provide information about.
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :personFields (String.t): **Required.** A field mask to restrict which fields on the person are
  ...
  * urls
  * userDefined
    - :requestMask.includeField (String.t): **Required.** Comma-separated list of person fields to be included in the
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :personFields (String.t): **Required.** A field mask to restrict which fields on each person are
  returned. Multiple fields can be specified by separating them with commas.
  Valid values are:
  ...
  * userDefined
  ...
  response. Each path should start with `person.`: for example,
  `person.names` or `person.photos`.
    - :resourceNames (list(String.t)): The resource names of the people to provide information about.
  ...
  - connection (GoogleApi.People.V1.Connection): Connection to server
  - people_id (String.t): Part of `person.resourceName`. The resource name for the person, assigned by the server. An ASCII string
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :updatePersonFields (String.t): **Required.** A field mask to restrict which fields on the person are
  ...
  * userDefined
  ...
  `request_sync_token` have an additional rate limit.
    - :sortOrder (String.t): The order in which the connections should be sorted. Defaults to
  `LAST_MODIFIED_ASCENDING`.
    - :syncToken (String.t): A sync token returned by a previous call to `people.connections.list`.
