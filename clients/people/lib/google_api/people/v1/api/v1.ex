...
defmodule GoogleApi.People.V1.Api.V1 do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec people_other_contacts(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.People.V1.Model.ListOtherContactsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def people_other_contacts(connection, optional_params \\ [], opts \\ []) do
