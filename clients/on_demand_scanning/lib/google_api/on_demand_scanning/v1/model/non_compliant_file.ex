...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.NonCompliantFile do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.NonCompliantFile.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.NonCompliantFile do
