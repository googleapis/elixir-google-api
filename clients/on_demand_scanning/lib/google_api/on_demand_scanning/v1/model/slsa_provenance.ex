...
defmodule GoogleApi.OnDemandScanning.V1.Model.SlsaProvenance do
  @moduledoc """
  ...
  *   `recipe` (*type:* `GoogleApi.OnDemandScanning.V1.Model.SlsaRecipe.t`, *default:* `nil`) - Identifies the configuration used for the build. When combined with materials, this SHOULD fully describe the build, such that re-running this recipe results in bit-for-bit identical output (if the build is reproducible). required
  ...
  @type t :: %__MODULE__{
          ...
          :materials => list(GoogleApi.OnDemandScanning.V1.Model.Material.t()) | nil,
  ...
  field(:builder, as: GoogleApi.OnDemandScanning.V1.Model.SlsaBuilder)
  field(:materials, as: GoogleApi.OnDemandScanning.V1.Model.Material, type: :list)
  field(:metadata, as: GoogleApi.OnDemandScanning.V1.Model.SlsaMetadata)
  field(:recipe, as: GoogleApi.OnDemandScanning.V1.Model.SlsaRecipe)
end

defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.SlsaProvenance do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.SlsaProvenance.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.SlsaProvenance do
