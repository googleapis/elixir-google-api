...
defmodule GoogleApi.OnDemandScanning.V1.Model.FileLocation do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.FileLocation do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.FileLocation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.FileLocation do
