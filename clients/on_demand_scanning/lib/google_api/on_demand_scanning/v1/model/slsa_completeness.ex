...
defmodule GoogleApi.OnDemandScanning.V1.Model.SlsaCompleteness do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.SlsaCompleteness do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.SlsaCompleteness.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.SlsaCompleteness do
