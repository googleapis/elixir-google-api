...
defmodule GoogleApi.OnDemandScanning.V1.Model.GerritSourceContext do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.GerritSourceContext do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.GerritSourceContext.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.GerritSourceContext do
