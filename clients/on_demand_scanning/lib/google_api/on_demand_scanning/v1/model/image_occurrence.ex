...
defmodule GoogleApi.OnDemandScanning.V1.Model.ImageOccurrence do
  @moduledoc """
  ...
  *   `layerInfo` (*type:* `list(GoogleApi.OnDemandScanning.V1.Model.Layer.t)`, *default:* `nil`) - This contains layer-specific metadata, if populated it has length "distance" and is ordered with [distance] being the layer immediately following the base image and [1] being the final layer.
  ...
  @type t :: %__MODULE__{
          ...
          :layerInfo => list(GoogleApi.OnDemandScanning.V1.Model.Layer.t()) | nil
        }

  field(:baseResourceUrl)
  field(:distance)
  field(:fingerprint, as: GoogleApi.OnDemandScanning.V1.Model.Fingerprint)
  field(:layerInfo, as: GoogleApi.OnDemandScanning.V1.Model.Layer, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.ImageOccurrence do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.ImageOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.ImageOccurrence do
