...
defmodule GoogleApi.OnDemandScanning.V1.Model.Layer do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.Layer do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.Layer.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.Layer do
