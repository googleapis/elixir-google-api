...
defmodule GoogleApi.OnDemandScanning.V1.Model.BuildOccurrence do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.BuildOccurrence do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.BuildOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.BuildOccurrence do
