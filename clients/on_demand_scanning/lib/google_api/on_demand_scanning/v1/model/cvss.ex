...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.CVSS do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.CVSS.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.CVSS do
