...
defmodule GoogleApi.OnDemandScanning.V1.Model.Metadata do
  @moduledoc """
  ...
  *   `completeness` (*type:* `GoogleApi.OnDemandScanning.V1.Model.Completeness.t`, *default:* `nil`) - Indicates that the builder claims certain fields in this message to be complete.
  *   `reproducible` (*type:* `boolean()`, *default:* `nil`) - If true, the builder claims that running the recipe on materials will produce bit-for-bit identical output.
  ...
  @type t :: %__MODULE__{
          ...
          :completeness => GoogleApi.OnDemandScanning.V1.Model.Completeness.t() | nil,
  ...
  field(:completeness, as: GoogleApi.OnDemandScanning.V1.Model.Completeness)
  field(:reproducible)
end

defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.Metadata do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.Metadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.Metadata do
