...
defmodule GoogleApi.OnDemandScanning.V1.Model.DeploymentOccurrence do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.DeploymentOccurrence do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.DeploymentOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.DeploymentOccurrence do
