...
defmodule GoogleApi.OnDemandScanning.V1.Model.Command do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.Command do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.Command.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.Command do
