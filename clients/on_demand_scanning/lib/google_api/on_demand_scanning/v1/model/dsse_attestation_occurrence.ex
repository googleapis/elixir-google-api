...
defmodule GoogleApi.OnDemandScanning.V1.Model.DSSEAttestationOccurrence do
  @moduledoc """
  ...
  *   `statement` (*type:* `GoogleApi.OnDemandScanning.V1.Model.InTotoStatement.t`, *default:* `nil`) - 
  ...
  field(:statement, as: GoogleApi.OnDemandScanning.V1.Model.InTotoStatement)
end

defimpl Poison.Decoder, for: GoogleApi.OnDemandScanning.V1.Model.DSSEAttestationOccurrence do
  def decode(value, options) do
    GoogleApi.OnDemandScanning.V1.Model.DSSEAttestationOccurrence.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OnDemandScanning.V1.Model.DSSEAttestationOccurrence do
