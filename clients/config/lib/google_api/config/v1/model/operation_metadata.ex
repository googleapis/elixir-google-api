...
defmodule GoogleApi.Config.V1.Model.OperationMetadata do
  @moduledoc """
  ...
  *   `deploymentMetadata` (*type:* `GoogleApi.Config.V1.Model.DeploymentOperationMetadata.t`, *default:* `nil`) - Output only. Metadata about the deployment operation state.
  *   `endTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. Time when the operation finished running.
  *   `previewMetadata` (*type:* `GoogleApi.Config.V1.Model.PreviewOperationMetadata.t`, *default:* `nil`) - Output only. Metadata about the preview operation state.
  ...
  *   `verb` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the verb executed by the operation.
  ...
  @type t :: %__MODULE__{
          ...
          :deploymentMetadata => GoogleApi.Config.V1.Model.DeploymentOperationMetadata.t() | nil,
          :endTime => DateTime.t() | nil,
          :previewMetadata => GoogleApi.Config.V1.Model.PreviewOperationMetadata.t() | nil,
  ...
  field(:deploymentMetadata, as: GoogleApi.Config.V1.Model.DeploymentOperationMetadata)
  field(:endTime, as: DateTime)
  field(:previewMetadata, as: GoogleApi.Config.V1.Model.PreviewOperationMetadata)
...
defimpl Poison.Decoder, for: GoogleApi.Config.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.Config.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Config.V1.Model.OperationMetadata do
