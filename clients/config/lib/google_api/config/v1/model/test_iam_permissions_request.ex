...
defmodule GoogleApi.Config.V1.Model.TestIamPermissionsRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Config.V1.Model.TestIamPermissionsRequest do
  def decode(value, options) do
    GoogleApi.Config.V1.Model.TestIamPermissionsRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Config.V1.Model.TestIamPermissionsRequest do
