...
defmodule GoogleApi.VectorTile.V1.Model.BasemapZOrder do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VectorTile.V1.Model.BasemapZOrder do
  def decode(value, options) do
    GoogleApi.VectorTile.V1.Model.BasemapZOrder.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VectorTile.V1.Model.BasemapZOrder do
