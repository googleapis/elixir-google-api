...
defmodule GoogleApi.BigQueryReservation.V1.Model.Operation do
  @moduledoc """
  ...
  *   `done` (*type:* `boolean()`, *default:* `nil`) - If the value is `false`, it means the operation is still in progress.
      ...
      available.
  *   `error` (*type:* `GoogleApi.BigQueryReservation.V1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
  ...
  *   `response` (*type:* `map()`, *default:* `nil`) - The normal response of the operation in case of success.  If the original
  ...
  @type t :: %__MODULE__{
          :done => boolean(),
          :error => GoogleApi.BigQueryReservation.V1.Model.Status.t(),
          :metadata => map(),
          :name => String.t(),
          :response => map()
        }
...
defimpl Poison.Decoder, for: GoogleApi.BigQueryReservation.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.BigQueryReservation.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQueryReservation.V1.Model.Operation do
