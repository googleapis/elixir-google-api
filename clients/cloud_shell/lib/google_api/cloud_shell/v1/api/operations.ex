...
defmodule GoogleApi.CloudShell.V1.Api.Operations do
  @moduledoc """
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.CloudShell.V1.Model.CancelOperationRequest.t): 

  ## Returns

  {:ok, %GoogleApi.CloudShell.V1.Model.Empty{}} on success
  {:error, info} on failure
  """
  @spec cloudshell_operations_cancel(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def cloudshell_operations_cancel(connection, name, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudShell.V1.Model.Empty{}])
  end
  ...
  {:error, info} on failure
  """
  @spec cloudshell_operations_delete(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, GoogleApi.CloudShell.V1.Model.Empty.t()} | {:error, Tesla.Env.t()}
  ...
  {:error, info} on failure
  """
  @spec cloudshell_operations_get(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  {:ok, %GoogleApi.CloudShell.V1.Model.ListOperationsResponse{}} on success
  {:error, info} on failure
  """
  @spec cloudshell_operations_list(Tesla.Env.client(), String.t(), keyword()) ::
  ...
  def cloudshell_operations_list(connection, name, optional_params \\ [], opts \\ []) do
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudShell.V1.Model.ListOperationsResponse{}])
  end
end
