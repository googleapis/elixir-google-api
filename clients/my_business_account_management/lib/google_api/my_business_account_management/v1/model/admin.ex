...
defmodule GoogleApi.MyBusinessAccountManagement.V1.Model.Admin do
  ...
  *   `account` (*type:* `String.t`, *default:* `nil`) - Immutable. The name of the Account resource that this Admin refers to. Used when calling CreateAccountAdmin or CreateLocationAdmin to invite UserGroups or LocationGroups as admins, respectively. If both this field and `admin` are set on `CREATE` requests, this field takes precedence and the email address in `admin` will be ignored. Format: `accounts/{account}`.
