...
defmodule GoogleApi.MyBusinessAccountManagement.V1.Model.PostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.MyBusinessAccountManagement.V1.Model.PostalAddress do
  def decode(value, options) do
    GoogleApi.MyBusinessAccountManagement.V1.Model.PostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.MyBusinessAccountManagement.V1.Model.PostalAddress do
