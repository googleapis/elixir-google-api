...
defmodule GoogleApi.CloudProfiler.V2.Model.Deployment do
  ...
  *   `labels` (*type:* `map()`, *default:* `nil`) - Labels identify the deployment within the user universe and same target.
      ...
      "us-central".
  *   `projectId` (*type:* `String.t`, *default:* `nil`) - Project ID is the ID of a cloud project.
      Validation regex: `^a-z{4,61}[a-z0-9]$`.
  *   `target` (*type:* `String.t`, *default:* `nil`) - Target is the service name used to group related deployments:
