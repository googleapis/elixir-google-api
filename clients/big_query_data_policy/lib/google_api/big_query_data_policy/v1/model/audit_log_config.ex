...
defmodule GoogleApi.BigQueryDataPolicy.V1.Model.AuditLogConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.BigQueryDataPolicy.V1.Model.AuditLogConfig do
  def decode(value, options) do
    GoogleApi.BigQueryDataPolicy.V1.Model.AuditLogConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.BigQueryDataPolicy.V1.Model.AuditLogConfig do
