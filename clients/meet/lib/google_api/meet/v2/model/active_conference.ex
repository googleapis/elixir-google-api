...
defmodule GoogleApi.Meet.V2.Model.ActiveConference do
  @moduledoc """
  Active conference.
...
defimpl Poison.Decoder, for: GoogleApi.Meet.V2.Model.ActiveConference do
  def decode(value, options) do
    GoogleApi.Meet.V2.Model.ActiveConference.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Meet.V2.Model.ActiveConference do
