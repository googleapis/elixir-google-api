...
defmodule GoogleApi.APIKeys.V2.Api.Operations do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec apikeys_operations_get(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.APIKeys.V2.Model.Operation.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def apikeys_operations_get(connection, name, optional_params \\ [], opts \\ []) do
