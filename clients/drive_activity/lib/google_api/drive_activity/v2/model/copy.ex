...
defmodule GoogleApi.DriveActivity.V2.Model.Copy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DriveActivity.V2.Model.Copy do
  def decode(value, options) do
    GoogleApi.DriveActivity.V2.Model.Copy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DriveActivity.V2.Model.Copy do
