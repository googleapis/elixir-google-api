...
defmodule GoogleApi.DriveActivity.V2.Model.QueryDriveActivityResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.DriveActivity.V2.Model.QueryDriveActivityResponse do
  def decode(value, options) do
    GoogleApi.DriveActivity.V2.Model.QueryDriveActivityResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.DriveActivity.V2.Model.QueryDriveActivityResponse do
