...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.UpdateDataSourceRequest do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.UpdateDataSourceRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.UpdateDataSourceRequest do
