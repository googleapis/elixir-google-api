...
defmodule GoogleApi.Sheets.V4.Model.BatchUpdateValuesResponse do
  ...
  - responses (list(GoogleApi.Sheets.V4.Model.UpdateValuesResponse.t)): One UpdateValuesResponse per requested range, in the same order as
  the requests appeared. Defaults to `nil`.
  - spreadsheetId (String.t): The spreadsheet the updates were applied to. Defaults to `nil`.
  - totalUpdatedCells (integer()): The total number of cells updated. Defaults to `nil`.
  - totalUpdatedColumns (integer()): The total number of columns where at least one cell in the column was
  updated. Defaults to `nil`.
  - totalUpdatedRows (integer()): The total number of rows where at least one cell in the row was updated. Defaults to `nil`.
