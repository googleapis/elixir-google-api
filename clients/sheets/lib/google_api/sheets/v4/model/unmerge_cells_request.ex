...
defmodule GoogleApi.Sheets.V4.Model.UnmergeCellsRequest do
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range within which all cells should be unmerged.
  If the range spans multiple merges, all will be unmerged.
  The range must not partially span any merge. Defaults to `nil`.
  """
