...
defmodule GoogleApi.Sheets.V4.Model.PivotGroup do
  ...
  *   `label` (*type:* `String.t`, *default:* `nil`) - The labels to use for the row/column groups which can be customized. For
      ...
      pivot table with same parameters.
          ...
          +--------------+---------+-------+
  *   `repeatHeadings` (*type:* `boolean()`, *default:* `nil`) - True if the headings in this pivot group should be repeated.
