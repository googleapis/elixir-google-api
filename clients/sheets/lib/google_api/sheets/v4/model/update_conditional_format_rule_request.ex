...
defmodule GoogleApi.Sheets.V4.Model.UpdateConditionalFormatRuleRequest do
  ...
  - index (integer()): The zero-based index of the rule that should be replaced or moved. Defaults to `nil`.
  - newIndex (integer()): The zero-based new index the rule should end up at. Defaults to `nil`.
  - rule (GoogleApi.Sheets.V4.Model.ConditionalFormatRule.t): The rule that should replace the rule at the given index. Defaults to `nil`.
  - sheetId (integer()): The sheet of the rule to move.  Required if new_index is set,
  unused otherwise. Defaults to `nil`.
  """
