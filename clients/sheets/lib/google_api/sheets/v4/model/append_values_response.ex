...
defmodule GoogleApi.Sheets.V4.Model.AppendValuesResponse do
  ...
  - tableRange (String.t): The range (in A1 notation) of the table that values are being appended to
  (before the values were appended).
  Empty if no table was found. Defaults to `nil`.
  - updates (GoogleApi.Sheets.V4.Model.UpdateValuesResponse.t): Information about the updates that were applied. Defaults to `nil`.
  """
