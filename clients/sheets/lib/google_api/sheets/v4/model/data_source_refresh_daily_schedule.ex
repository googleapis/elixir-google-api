...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.DataSourceRefreshDailySchedule do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.DataSourceRefreshDailySchedule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.DataSourceRefreshDailySchedule do
