...
defmodule GoogleApi.Sheets.V4.Model.OrgChartSpec do
  ...
  - labels (GoogleApi.Sheets.V4.Model.ChartData.t): The data containing the labels for all the nodes in the chart.  Labels
  must be unique. Defaults to `nil`.
  - nodeColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the org chart nodes. Defaults to `nil`.
  - nodeSize (String.t): The size of the org chart nodes. Defaults to `nil`.
  - parentLabels (GoogleApi.Sheets.V4.Model.ChartData.t): The data containing the label of the parent for the corresponding node.
  A blank value indicates that the node has no parent and is a top-level
  node.
  This field is optional. Defaults to `nil`.
  - selectedNodeColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the selected org chart nodes. Defaults to `nil`.
  - tooltips (GoogleApi.Sheets.V4.Model.ChartData.t): The data containing the tooltip for the corresponding node.  A blank value
