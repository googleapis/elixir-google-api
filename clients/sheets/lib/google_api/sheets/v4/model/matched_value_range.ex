...
defmodule GoogleApi.Sheets.V4.Model.MatchedValueRange do
  ...
  - dataFilters (list(GoogleApi.Sheets.V4.Model.DataFilter.t)): The DataFilters from the request that matched the range of
  values. Defaults to `nil`.
  - valueRange (GoogleApi.Sheets.V4.Model.ValueRange.t): The values matched by the DataFilter. Defaults to `nil`.
  """
