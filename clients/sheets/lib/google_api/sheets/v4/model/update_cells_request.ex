...
defmodule GoogleApi.Sheets.V4.Model.UpdateCellsRequest do
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range to write data to.

  If the data in rows does not cover the entire requested range,
  the fields matching those set in fields will be cleared. Defaults to `nil`.
  - rows (list(GoogleApi.Sheets.V4.Model.RowData.t)): The data to write. Defaults to `nil`.
  - start (GoogleApi.Sheets.V4.Model.GridCoordinate.t): The coordinate to start writing data at.
  Any number of rows and columns (including a different number of
  columns per row) may be written. Defaults to `nil`.
  """
