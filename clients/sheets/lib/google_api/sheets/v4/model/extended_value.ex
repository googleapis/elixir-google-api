...
defmodule GoogleApi.Sheets.V4.Model.ExtendedValue do
  ...
  - errorValue (GoogleApi.Sheets.V4.Model.ErrorValue.t): Represents an error.
  This field is read-only. Defaults to `nil`.
  - formulaValue (String.t): Represents a formula. Defaults to `nil`.
  - numberValue (float()): Represents a double value.
  Note: Dates, Times and DateTimes are represented as doubles in
  "serial number" format. Defaults to `nil`.
  - stringValue (String.t): Represents a string value.
