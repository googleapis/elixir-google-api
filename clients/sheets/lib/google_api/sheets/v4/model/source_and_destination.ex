...
defmodule GoogleApi.Sheets.V4.Model.SourceAndDestination do
  ...
  - dimension (String.t): The dimension that data should be filled into. Defaults to `nil`.
  - fillLength (integer()): The number of rows or columns that data should be filled into.
  Positive numbers expand beyond the last row or last column
  of the source.  Negative numbers expand before the first row
  or first column of the source. Defaults to `nil`.
  - source (GoogleApi.Sheets.V4.Model.GridRange.t): The location of the data to use as the source of the autofill. Defaults to `nil`.
  """
