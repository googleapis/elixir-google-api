...
defmodule GoogleApi.Sheets.V4.Model.PivotGroupRule do
  ...
  - dateTimeRule (GoogleApi.Sheets.V4.Model.DateTimeRule.t): A DateTimeRule. Defaults to `nil`.
  - histogramRule (GoogleApi.Sheets.V4.Model.HistogramRule.t): A HistogramRule. Defaults to `nil`.
  - manualRule (GoogleApi.Sheets.V4.Model.ManualRule.t): A ManualRule. Defaults to `nil`.
  """
