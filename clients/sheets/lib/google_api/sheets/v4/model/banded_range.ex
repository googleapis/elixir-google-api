...
defmodule GoogleApi.Sheets.V4.Model.BandedRange do
  ...
  - bandedRangeId (integer()): The id of the banded range. Defaults to `nil`.
  - columnProperties (GoogleApi.Sheets.V4.Model.BandingProperties.t): Properties for column bands. These properties are applied on a column-
  by-column basis throughout all the columns in the range. At least one of
  row_properties or column_properties must be specified. Defaults to `nil`.
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range over which these properties are applied. Defaults to `nil`.
  - rowProperties (GoogleApi.Sheets.V4.Model.BandingProperties.t): Properties for row bands. These properties are applied on a row-by-row
