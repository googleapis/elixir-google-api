...
defmodule GoogleApi.Sheets.V4.Model.BandedRange do
  ...
  *   `columnProperties` (*type:* `GoogleApi.Sheets.V4.Model.BandingProperties.t`, *default:* `nil`) - Properties for column bands. These properties are applied on a column-
  ...
  *   `rowProperties` (*type:* `GoogleApi.Sheets.V4.Model.BandingProperties.t`, *default:* `nil`) - Properties for row bands. These properties are applied on a row-by-row
