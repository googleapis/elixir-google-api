...
defmodule GoogleApi.Sheets.V4.Model.CancelDataSourceRefreshRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.CancelDataSourceRefreshRequest do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.CancelDataSourceRefreshRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.CancelDataSourceRefreshRequest do
