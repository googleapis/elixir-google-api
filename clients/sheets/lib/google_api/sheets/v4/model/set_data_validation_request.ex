...
defmodule GoogleApi.Sheets.V4.Model.SetDataValidationRequest do
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range the data validation rule should apply to. Defaults to `nil`.
  - rule (GoogleApi.Sheets.V4.Model.DataValidationRule.t): The data validation rule to set on each cell in the range,
  or empty to clear the data validation in the range. Defaults to `nil`.
  """
