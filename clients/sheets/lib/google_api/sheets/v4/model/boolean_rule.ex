...
defmodule GoogleApi.Sheets.V4.Model.BooleanRule do
  ...
  - condition (GoogleApi.Sheets.V4.Model.BooleanCondition.t): The condition of the rule. If the condition evaluates to true,
  the format is applied. Defaults to `nil`.
  - format (GoogleApi.Sheets.V4.Model.CellFormat.t): The format to apply.
  Conditional formatting can only apply a subset of formatting:
  bold, italic,
  strikethrough,
  foreground color &
  background color. Defaults to `nil`.
  """
