...
defmodule GoogleApi.Sheets.V4.Model.HistogramSeries do
  ...
  - barColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the column representing this series in each bucket.
  This field is optional. Defaults to `nil`.
  - data (GoogleApi.Sheets.V4.Model.ChartData.t): The data for this histogram series. Defaults to `nil`.
  """
