...
defmodule GoogleApi.Sheets.V4.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.TimeOfDay do
