...
defmodule GoogleApi.Sheets.V4.Model.Interval do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.Interval do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.Interval.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.Interval do
