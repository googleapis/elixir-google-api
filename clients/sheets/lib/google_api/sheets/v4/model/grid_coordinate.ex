...
defmodule GoogleApi.Sheets.V4.Model.GridCoordinate do
  ...
  - columnIndex (integer()): The column index of the coordinate. Defaults to `nil`.
  - rowIndex (integer()): The row index of the coordinate. Defaults to `nil`.
  - sheetId (integer()): The sheet this coordinate is on. Defaults to `nil`.
  """
