...
defmodule GoogleApi.Sheets.V4.Model.TextToColumnsRequest do
  ...
  - delimiter (String.t): The delimiter to use. Used only if delimiterType is
  CUSTOM. Defaults to `nil`.
  - delimiterType (String.t): The delimiter type to use. Defaults to `nil`.
  - source (GoogleApi.Sheets.V4.Model.GridRange.t): The source data range.  This must span exactly one column. Defaults to `nil`.
  """
