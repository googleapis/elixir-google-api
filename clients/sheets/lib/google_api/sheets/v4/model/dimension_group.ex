...
defmodule GoogleApi.Sheets.V4.Model.DimensionGroup do
  ...
  this field is false. Defaults to `nil`.
  - depth (integer()): The depth of the group, representing how many groups have a range that
  wholly contains the range of this group. Defaults to `nil`.
  - range (GoogleApi.Sheets.V4.Model.DimensionRange.t): The range over which this group exists. Defaults to `nil`.
  """
