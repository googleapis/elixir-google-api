...
defmodule GoogleApi.Sheets.V4.Model.WaterfallChartCustomSubtotal do
  ...
  the subtotal will be computed and appear after the data point. Defaults to `nil`.
  - label (String.t): A label for the subtotal column. Defaults to `nil`.
  ...
  what data points they are associated with. Defaults to `nil`.
  """
