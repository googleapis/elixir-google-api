...
defmodule GoogleApi.Sheets.V4.Model.WaterfallChartCustomSubtotal do
  ...
  *   `dataIsSubtotal` (*type:* `boolean()`, *default:* `nil`) - True if the data point at subtotal_index is the subtotal. If false,
  ...
  *   `subtotalIndex` (*type:* `integer()`, *default:* `nil`) - The 0-based index of a data point within the series. If
