...
defmodule GoogleApi.Sheets.V4.Model.DuplicateSheetRequest do
  ...
  The index of all sheets after this are incremented. Defaults to `nil`.
  - newSheetId (integer()): If set, the ID of the new sheet. If not set, an ID is chosen.
  If set, the ID must not conflict with any existing sheet ID.
  If set, it must be non-negative. Defaults to `nil`.
  - newSheetName (String.t): The name of the new sheet.  If empty, a new name is chosen for you. Defaults to `nil`.
  - sourceSheetId (integer()): The sheet to duplicate. Defaults to `nil`.
  """
