...
defmodule GoogleApi.Sheets.V4.Model.SearchDeveloperMetadataResponse do
  ...
  - matchedDeveloperMetadata (list(GoogleApi.Sheets.V4.Model.MatchedDeveloperMetadata.t)): The metadata matching the criteria of the search request. Defaults to `nil`.
  """
