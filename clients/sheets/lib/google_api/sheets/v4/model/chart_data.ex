...
defmodule GoogleApi.Sheets.V4.Model.ChartData do
  ...
  *   `sourceRange` (*type:* `GoogleApi.Sheets.V4.Model.ChartSourceRange.t`, *default:* `nil`) - The source ranges of the data.
  ...
  @type t :: %__MODULE__{
          ...
          :columnReference => GoogleApi.Sheets.V4.Model.DataSourceColumnReference.t() | nil,
          :groupRule => GoogleApi.Sheets.V4.Model.ChartGroupRule.t() | nil,
          :sourceRange => GoogleApi.Sheets.V4.Model.ChartSourceRange.t() | nil
        }
