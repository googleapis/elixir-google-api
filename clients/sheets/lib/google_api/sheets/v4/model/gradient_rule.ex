...
defmodule GoogleApi.Sheets.V4.Model.GradientRule do
  ...
  - maxpoint (GoogleApi.Sheets.V4.Model.InterpolationPoint.t): The final interpolation point. Defaults to `nil`.
  - midpoint (GoogleApi.Sheets.V4.Model.InterpolationPoint.t): An optional midway interpolation point. Defaults to `nil`.
  - minpoint (GoogleApi.Sheets.V4.Model.InterpolationPoint.t): The starting interpolation point. Defaults to `nil`.
  """
