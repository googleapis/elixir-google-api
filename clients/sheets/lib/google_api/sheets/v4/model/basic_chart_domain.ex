...
defmodule GoogleApi.Sheets.V4.Model.BasicChartDomain do
  ...
  - domain (GoogleApi.Sheets.V4.Model.ChartData.t): The data of the domain. For example, if charting stock prices over time,
  this is the data representing the dates. Defaults to `nil`.
