...
defmodule GoogleApi.Sheets.V4.Model.ConditionValue do
  ...
  - relativeDate (String.t): A relative date (based on the current date).
  ...
  conditional filters. Defaults to `nil`.
  - userEnteredValue (String.t): A value the condition is based on.
  The value is parsed as if the user typed into a cell.
  Formulas are supported (and must begin with an `=` or a '+'). Defaults to `nil`.
  """
