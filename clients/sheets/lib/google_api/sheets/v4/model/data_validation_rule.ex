...
defmodule GoogleApi.Sheets.V4.Model.DataValidationRule do
  ...
  - condition (GoogleApi.Sheets.V4.Model.BooleanCondition.t): The condition that data in the cell must match. Defaults to `nil`.
  - inputMessage (String.t): A message to show the user when adding data to the cell. Defaults to `nil`.
  - showCustomUi (boolean()): True if the UI should be customized based on the kind of condition.
  If true, "List" conditions will show a dropdown. Defaults to `nil`.
  - strict (boolean()): True if invalid data should be rejected. Defaults to `nil`.
  """
