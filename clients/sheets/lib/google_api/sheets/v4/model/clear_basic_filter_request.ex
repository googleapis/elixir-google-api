...
defmodule GoogleApi.Sheets.V4.Model.ClearBasicFilterRequest do
  ...
  *   `sheetId` (*type:* `integer()`, *default:* `nil`) - The sheet ID on which the basic filter should be cleared.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.ClearBasicFilterRequest do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.ClearBasicFilterRequest.decode(value, options)
  end
end
