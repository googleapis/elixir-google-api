...
defmodule GoogleApi.Sheets.V4.Model.Spreadsheet do
  ...
  - developerMetadata (list(GoogleApi.Sheets.V4.Model.DeveloperMetadata.t)): The developer metadata associated with a spreadsheet. Defaults to `nil`.
  - namedRanges (list(GoogleApi.Sheets.V4.Model.NamedRange.t)): The named ranges defined in a spreadsheet. Defaults to `nil`.
  - properties (GoogleApi.Sheets.V4.Model.SpreadsheetProperties.t): Overall properties of a spreadsheet. Defaults to `nil`.
  - sheets (list(GoogleApi.Sheets.V4.Model.Sheet.t)): The sheets that are part of a spreadsheet. Defaults to `nil`.
  - spreadsheetId (String.t): The ID of the spreadsheet.
  This field is read-only. Defaults to `nil`.
  - spreadsheetUrl (String.t): The url of the spreadsheet.
  This field is read-only. Defaults to `nil`.
  """
