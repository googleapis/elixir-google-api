...
defmodule GoogleApi.Sheets.V4.Model.AutoFillRequest do
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range to autofill. This will examine the range and detect
  the location that has data and automatically fill that data
  in to the rest of the range. Defaults to `nil`.
  - sourceAndDestination (GoogleApi.Sheets.V4.Model.SourceAndDestination.t): The source and destination areas to autofill.
  This explicitly lists the source of the autofill and where to
  extend that data. Defaults to `nil`.
  - useAlternateSeries (boolean()): True if we should generate data with the "alternate" series.
  This differs based on the type and amount of source data. Defaults to `nil`.
  """
