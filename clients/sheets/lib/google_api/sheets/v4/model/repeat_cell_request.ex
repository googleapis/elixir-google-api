...
defmodule GoogleApi.Sheets.V4.Model.RepeatCellRequest do
  ...
  - cell (GoogleApi.Sheets.V4.Model.CellData.t): The data to write. Defaults to `nil`.
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range to repeat the cell in. Defaults to `nil`.
  """
