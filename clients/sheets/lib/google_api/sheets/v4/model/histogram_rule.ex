...
defmodule GoogleApi.Sheets.V4.Model.HistogramRule do
  ...
  - end (float()): The maximum value at which items are placed into buckets
  of constant size. Values above end are lumped into a single bucket.
  This field is optional. Defaults to `nil`.
  - interval (float()): The size of the buckets that are created. Must be positive. Defaults to `nil`.
  - start (float()): The minimum value at which items are placed into buckets
