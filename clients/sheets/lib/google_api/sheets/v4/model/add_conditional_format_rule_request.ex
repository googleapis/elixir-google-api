...
defmodule GoogleApi.Sheets.V4.Model.AddConditionalFormatRuleRequest do
  ...
  - index (integer()): The zero-based index where the rule should be inserted. Defaults to `nil`.
  - rule (GoogleApi.Sheets.V4.Model.ConditionalFormatRule.t): The rule to add. Defaults to `nil`.
  """
