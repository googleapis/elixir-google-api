...
defmodule GoogleApi.Sheets.V4.Model.MergeCellsRequest do
  ...
  - mergeType (String.t): How the cells should be merged. Defaults to `nil`.
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range of cells to merge. Defaults to `nil`.
  """
