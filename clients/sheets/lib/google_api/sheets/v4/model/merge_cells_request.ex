...
defmodule GoogleApi.Sheets.V4.Model.MergeCellsRequest do
  ...
  *   `mergeType` (*type:* `String.t`, *default:* `nil`) - How the cells should be merged.
  *   `range` (*type:* `GoogleApi.Sheets.V4.Model.GridRange.t`, *default:* `nil`) - The range of cells to merge.
  """
