...
defmodule GoogleApi.Sheets.V4.Model.FilterCriteria do
  ...
  - condition (GoogleApi.Sheets.V4.Model.BooleanCondition.t): A condition that must be true for values to be shown.
  (This does not override hiddenValues -- if a value is listed there,
  it will still be hidden.) Defaults to `nil`.
  - hiddenValues (list(String.t)): Values that should be hidden. Defaults to `nil`.
  """
