...
defmodule GoogleApi.Sheets.V4.Model.PivotGroupSortValueBucket do
  ...
  - buckets (list(GoogleApi.Sheets.V4.Model.ExtendedValue.t)): Determines the bucket from which values are chosen to sort.
  ...
  this would correspond to using the "Total" of that bucket. Defaults to `nil`.
  - valuesIndex (integer()): The offset in the PivotTable.values list which the values in this
  grouping should be sorted by. Defaults to `nil`.
  """
