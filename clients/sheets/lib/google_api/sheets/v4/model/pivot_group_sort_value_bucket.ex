...
defmodule GoogleApi.Sheets.V4.Model.PivotGroupSortValueBucket do
  ...
  *   `buckets` (*type:* `list(GoogleApi.Sheets.V4.Model.ExtendedValue.t)`, *default:* `nil`) - Determines the bucket from which values are chosen to sort.
  ...
  *   `valuesIndex` (*type:* `integer()`, *default:* `nil`) - The offset in the PivotTable.values list which the values in this
