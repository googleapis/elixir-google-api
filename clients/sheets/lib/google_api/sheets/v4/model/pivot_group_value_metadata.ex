...
defmodule GoogleApi.Sheets.V4.Model.PivotGroupValueMetadata do
  ...
  - collapsed (boolean()): True if the data corresponding to the value is collapsed. Defaults to `nil`.
  - value (GoogleApi.Sheets.V4.Model.ExtendedValue.t): The calculated value the metadata corresponds to.
  (Note that formulaValue is not valid,
  because the values will be calculated.) Defaults to `nil`.
  """
