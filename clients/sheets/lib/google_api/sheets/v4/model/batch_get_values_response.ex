...
defmodule GoogleApi.Sheets.V4.Model.BatchGetValuesResponse do
  ...
  - spreadsheetId (String.t): The ID of the spreadsheet the data was retrieved from. Defaults to `nil`.
  - valueRanges (list(GoogleApi.Sheets.V4.Model.ValueRange.t)): The requested values. The order of the ValueRanges is the same as the
  order of the requested ranges. Defaults to `nil`.
  """
