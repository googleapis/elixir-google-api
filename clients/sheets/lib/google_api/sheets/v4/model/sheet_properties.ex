...
defmodule GoogleApi.Sheets.V4.Model.SheetProperties do
  ...
  - gridProperties (GoogleApi.Sheets.V4.Model.GridProperties.t): Additional properties of the sheet if this sheet is a grid.
  (If the sheet is an object sheet, containing a chart or image, then
  this field will be absent.)
  When writing it is an error to set any grid properties on non-grid sheets. Defaults to `nil`.
  - hidden (boolean()): True if the sheet is hidden in the UI, false if it's visible. Defaults to `nil`.
  ...
  index is equal to the current sheet index + 1. Defaults to `nil`.
  - rightToLeft (boolean()): True if the sheet is an RTL sheet instead of an LTR sheet. Defaults to `nil`.
  - sheetId (integer()): The ID of the sheet. Must be non-negative.
  This field cannot be changed once set. Defaults to `nil`.
  - sheetType (String.t): The type of sheet. Defaults to GRID.
  This field cannot be changed once set. Defaults to `nil`.
  - tabColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the tab in the UI. Defaults to `nil`.
  - title (String.t): The name of the sheet. Defaults to `nil`.
  """
