...
defmodule GoogleApi.Sheets.V4.Model.UpdateDimensionGroupRequest do
  ...
  - dimensionGroup (GoogleApi.Sheets.V4.Model.DimensionGroup.t): The group whose state should be updated. The range and depth of the group
  should specify a valid group on the sheet, and all other fields updated. Defaults to `nil`.
