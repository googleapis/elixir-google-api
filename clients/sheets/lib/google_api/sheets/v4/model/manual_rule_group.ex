...
defmodule GoogleApi.Sheets.V4.Model.ManualRuleGroup do
  ...
  - groupName (GoogleApi.Sheets.V4.Model.ExtendedValue.t): The group name, which must be a string. Each group in a given
  ManualRule must have a unique group name. Defaults to `nil`.
  - items (list(GoogleApi.Sheets.V4.Model.ExtendedValue.t)): The items in the source data that should be placed into this group. Each
  ...
  group will appear on their own. Defaults to `nil`.
  """
