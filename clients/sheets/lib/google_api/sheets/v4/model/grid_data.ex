...
defmodule GoogleApi.Sheets.V4.Model.GridData do
  ...
  - columnMetadata (list(GoogleApi.Sheets.V4.Model.DimensionProperties.t)): Metadata about the requested columns in the grid, starting with the column
  in start_column. Defaults to `nil`.
  - rowData (list(GoogleApi.Sheets.V4.Model.RowData.t)): The data in the grid, one entry per row,
  starting with the row in startRow.
  The values in RowData will correspond to columns starting
  at start_column. Defaults to `nil`.
  - rowMetadata (list(GoogleApi.Sheets.V4.Model.DimensionProperties.t)): Metadata about the requested rows in the grid, starting with the row
  in start_row. Defaults to `nil`.
  - startColumn (integer()): The first column this GridData refers to, zero-based. Defaults to `nil`.
  - startRow (integer()): The first row this GridData refers to, zero-based. Defaults to `nil`.
  """
