...
defmodule GoogleApi.Sheets.V4.Model.ColorStyle do
  @moduledoc """
  A color value.
  ...
  *   `themeColor` (*type:* `String.t`, *default:* `nil`) - Theme color.
  ...
  field(:rgbColor, as: GoogleApi.Sheets.V4.Model.Color)
  field(:themeColor)
end

defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.Model.ColorStyle do
  def decode(value, options) do
    GoogleApi.Sheets.V4.Model.ColorStyle.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Sheets.V4.Model.ColorStyle do
