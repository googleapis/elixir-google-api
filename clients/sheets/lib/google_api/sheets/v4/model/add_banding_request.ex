...
defmodule GoogleApi.Sheets.V4.Model.AddBandingRequest do
  ...
  - bandedRange (GoogleApi.Sheets.V4.Model.BandedRange.t): The banded range to add. The bandedRangeId
  field is optional; if one is not set, an id will be randomly generated. (It
  is an error to specify the ID of a range that already exists.) Defaults to `nil`.
  """
