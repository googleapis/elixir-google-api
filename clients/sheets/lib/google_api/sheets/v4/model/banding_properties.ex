...
defmodule GoogleApi.Sheets.V4.Model.BandingProperties do
  ...
  * row_properties takes priority over column_properties.
  ...
  - firstBandColor (GoogleApi.Sheets.V4.Model.Color.t): The first color that is alternating. (Required) Defaults to `nil`.
  - footerColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the last row or column. If this field is not set, the last
  row or column will be filled with either first_band_color or
  second_band_color, depending on the color of the previous row or
  column. Defaults to `nil`.
  - headerColor (GoogleApi.Sheets.V4.Model.Color.t): The color of the first row or column. If this field is set, the first
  row or column will be filled with this color and the colors will
  alternate between first_band_color and second_band_color starting
  from the second row or column. Otherwise, the first row or column will be
  filled with first_band_color and the colors will proceed to alternate
  as they normally would. Defaults to `nil`.
  - secondBandColor (GoogleApi.Sheets.V4.Model.Color.t): The second color that is alternating. (Required) Defaults to `nil`.
  """
