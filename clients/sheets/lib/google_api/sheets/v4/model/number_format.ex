...
defmodule GoogleApi.Sheets.V4.Model.NumberFormat do
  ...
  - pattern (String.t): Pattern string used for formatting.  If not set, a default pattern based on
  the user's locale will be used if necessary for the given type.
  See the [Date and Number Formats guide](/sheets/api/guides/formats) for
  more information about the supported patterns. Defaults to `nil`.
  - type (String.t): The type of the number format.
  When writing, this field must be set. Defaults to `nil`.
  """
