...
defmodule GoogleApi.Sheets.V4.Model.CandlestickChartSpec do
  ...
  - data (list(GoogleApi.Sheets.V4.Model.CandlestickData.t)): The Candlestick chart data.
  Only one CandlestickData is supported. Defaults to `nil`.
  - domain (GoogleApi.Sheets.V4.Model.CandlestickDomain.t): The domain data (horizontal axis) for the candlestick chart.  String data
  will be treated as discrete labels, other data will be treated as
  continuous values. Defaults to `nil`.
  """
