...
defmodule GoogleApi.Sheets.V4.Model.DeleteDeveloperMetadataRequest do
  @moduledoc """
  A request to delete developer metadata.

  ## Attributes

  - dataFilter (GoogleApi.Sheets.V4.Model.DataFilter.t): The data filter describing the criteria used to select which developer
  metadata entry to delete. Defaults to `nil`.
  """
