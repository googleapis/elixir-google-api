...
defmodule GoogleApi.Sheets.V4.Model.InterpolationPoint do
  ...
  - color (GoogleApi.Sheets.V4.Model.Color.t): The color this interpolation point should use. Defaults to `nil`.
  - type (String.t): How the value should be interpreted. Defaults to `nil`.
  - value (String.t): The value this interpolation point uses.  May be a formula.
