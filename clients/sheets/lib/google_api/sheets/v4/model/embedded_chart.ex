...
defmodule GoogleApi.Sheets.V4.Model.EmbeddedChart do
  ...
  - chartId (integer()): The ID of the chart. Defaults to `nil`.
  - position (GoogleApi.Sheets.V4.Model.EmbeddedObjectPosition.t): The position of the chart. Defaults to `nil`.
  - spec (GoogleApi.Sheets.V4.Model.ChartSpec.t): The specification of the chart. Defaults to `nil`.
  """
