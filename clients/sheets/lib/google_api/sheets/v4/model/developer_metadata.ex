...
defmodule GoogleApi.Sheets.V4.Model.DeveloperMetadata do
  ...
  - location (GoogleApi.Sheets.V4.Model.DeveloperMetadataLocation.t): The location where the metadata is associated. Defaults to `nil`.
  - metadataId (integer()): The spreadsheet-scoped unique ID that identifies the metadata. IDs may be
  specified when metadata is created, otherwise one will be randomly
  generated and assigned. Must be positive. Defaults to `nil`.
  - metadataKey (String.t): The metadata key. There may be multiple metadata in a spreadsheet with the
  same key.  Developer metadata must always have a key specified. Defaults to `nil`.
  - metadataValue (String.t): Data associated with the metadata's key. Defaults to `nil`.
  - visibility (String.t): The metadata visibility.  Developer metadata must always have a visibility
