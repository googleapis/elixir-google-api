...
defmodule GoogleApi.Sheets.V4.Model.AddChartRequest do
  ...
  *   `chart` (*type:* `GoogleApi.Sheets.V4.Model.EmbeddedChart.t`, *default:* `nil`) - The chart that should be added to the spreadsheet, including the position where it should be placed. The chartId field is optional; if one is not set, an id will be randomly generated. (It is an error to specify the ID of an embedded object that already exists.)
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :chart => GoogleApi.Sheets.V4.Model.EmbeddedChart.t() | nil
        }
