...
defmodule GoogleApi.Sheets.V4.Model.ErrorValue do
  ...
  - message (String.t): A message with more information about the error
  (in the spreadsheet's locale). Defaults to `nil`.
  - type (String.t): The type of error. Defaults to `nil`.
  """
