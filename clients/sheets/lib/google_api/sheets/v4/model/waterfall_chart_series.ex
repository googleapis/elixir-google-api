...
defmodule GoogleApi.Sheets.V4.Model.WaterfallChartSeries do
  ...
  - customSubtotals (list(GoogleApi.Sheets.V4.Model.WaterfallChartCustomSubtotal.t)): Custom subtotal columns appearing in this series. The order in which
  subtotals are defined is not significant. Only one subtotal may be
  defined for each data point. Defaults to `nil`.
  - data (GoogleApi.Sheets.V4.Model.ChartData.t): The data being visualized in this series. Defaults to `nil`.
  - hideTrailingSubtotal (boolean()): True to hide the subtotal column from the end of the series. By default,
  a subtotal column will appear at the end of each series. Setting this
  field to true will hide that subtotal column for this series. Defaults to `nil`.
  - negativeColumnsStyle (GoogleApi.Sheets.V4.Model.WaterfallChartColumnStyle.t): Styles for all columns in this series with negative values. Defaults to `nil`.
  - positiveColumnsStyle (GoogleApi.Sheets.V4.Model.WaterfallChartColumnStyle.t): Styles for all columns in this series with positive values. Defaults to `nil`.
  - subtotalColumnsStyle (GoogleApi.Sheets.V4.Model.WaterfallChartColumnStyle.t): Styles for all subtotal columns in this series. Defaults to `nil`.
  """
