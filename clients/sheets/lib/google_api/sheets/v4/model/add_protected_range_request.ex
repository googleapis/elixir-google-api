...
defmodule GoogleApi.Sheets.V4.Model.AddProtectedRangeRequest do
  ...
  - protectedRange (GoogleApi.Sheets.V4.Model.ProtectedRange.t): The protected range to be added. The
  protectedRangeId field is optional; if
  one is not set, an id will be randomly generated. (It is an error to
  specify the ID of a range that already exists.) Defaults to `nil`.
  """
