...
defmodule GoogleApi.Sheets.V4.Model.DeleteSheetRequest do
  @moduledoc """
  Deletes the requested sheet.

  ## Attributes

  *   `sheetId` (*type:* `integer()`, *default:* `nil`) - The ID of the sheet to delete. If the sheet is of DATA_SOURCE type, the associated DataSource is also deleted.
  """
