...
defmodule GoogleApi.Sheets.V4.Model.ConditionalFormatRule do
  ...
  - booleanRule (GoogleApi.Sheets.V4.Model.BooleanRule.t): The formatting is either "on" or "off" according to the rule. Defaults to `nil`.
  - gradientRule (GoogleApi.Sheets.V4.Model.GradientRule.t): The formatting will vary based on the gradients in the rule. Defaults to `nil`.
  - ranges (list(GoogleApi.Sheets.V4.Model.GridRange.t)): The ranges that are formatted if the condition is true.
  All the ranges must be on the same grid. Defaults to `nil`.
  """
