...
defmodule GoogleApi.Sheets.V4.Model.InsertRangeRequest do
  ...
  - range (GoogleApi.Sheets.V4.Model.GridRange.t): The range to insert new cells into. Defaults to `nil`.
  - shiftDimension (String.t): The dimension which will be shifted when inserting cells.
  If ROWS, existing cells will be shifted down.
  If COLUMNS, existing cells will be shifted right. Defaults to `nil`.
  """
