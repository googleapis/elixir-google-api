...
defmodule GoogleApi.Sheets.V4.Model.ManualRule do
  ...
  - groups (list(GoogleApi.Sheets.V4.Model.ManualRuleGroup.t)): The list of group names and the corresponding items from the source data
  that map to each group name. Defaults to `nil`.
  """
