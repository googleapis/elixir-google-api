...
defmodule GoogleApi.Sheets.V4.Model.BatchUpdateValuesByDataFilterRequest do
  ...
  *   `responseDateTimeRenderOption` (*type:* `String.t`, *default:* `nil`) - Determines how dates, times, and durations in the response should be rendered. This is ignored if response_value_render_option is FORMATTED_VALUE. The default dateTime render option is SERIAL_NUMBER.
  *   `responseValueRenderOption` (*type:* `String.t`, *default:* `nil`) - Determines how values in the response should be rendered. The default render option is FORMATTED_VALUE.
  *   `valueInputOption` (*type:* `String.t`, *default:* `nil`) - How the input data should be interpreted.
  ...
  @type t :: %__MODULE__{
          :data => list(GoogleApi.Sheets.V4.Model.DataFilterValueRange.t()) | nil,
