...
defmodule GoogleApi.Sheets.V4.RequestBuilder do
  @moduledoc """
  ...
  def decode(%Tesla.Env{body: body}, struct, dataWrapped: true) do
    Poison.decode(body, as: %GoogleApi.Sheets.V4.RequestBuilder.DataWrapper{}, struct: struct)
    |> case do
...
defimpl Poison.Decoder, for: GoogleApi.Sheets.V4.RequestBuilder.DataWrapper do
