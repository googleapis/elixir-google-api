...
defmodule GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadProperties do
  @moduledoc """
  ...
  *   `softwareComponentVersions` (*type:* `list(GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadPropertiesSoftwareComponentProperties.t)`, *default:* `nil`) - Optional. A list of SAP software components and their versions running on the system.
  ...
  field(:productVersions,
    as: GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadPropertiesProductVersion,
    type: :list
  )

  field(:softwareComponentVersions,
    as:
...
defimpl Poison.Decoder, for: GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadProperties do
  def decode(value, options) do
    GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadProperties.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadProperties do
