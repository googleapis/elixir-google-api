...
defmodule GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadPropertiesSoftwareComponentProperties do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadPropertiesSoftwareComponentProperties do
  def decode(value, options) do
    GoogleApi.WorkloadManager.V1.Model.SapDiscoveryWorkloadPropertiesSoftwareComponentProperties.decode(
      value,
      options
    )
  end
