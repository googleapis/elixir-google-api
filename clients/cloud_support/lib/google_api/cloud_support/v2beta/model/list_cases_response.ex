...
defmodule GoogleApi.CloudSupport.V2beta.Model.ListCasesResponse do
  ...
  *   `cases` (*type:* `list(GoogleApi.CloudSupport.V2beta.Model.Case.t)`, *default:* `nil`) - The list of cases associated with the cloud resource, after any filters have been applied.
  *   `nextPageToken` (*type:* `String.t`, *default:* `nil`) - A token to retrieve the next page of results. This should be set in the `page_token` field of subsequent `ListCasesRequest` message that is issued. If unspecified, there are no more results to retrieve.
  """
