...
defmodule GoogleApi.CloudSupport.V2beta.Api.Media do
  ...
  *   `v2beta_id` (*type:* `String.t`) - Part of `name`. The name of the file attachment to download.
  ...
  *   `connection` (*type:* `GoogleApi.CloudSupport.V2beta.Connection.t`) - Connection to server
  *   `v2beta_id` (*type:* `String.t`) - Part of `parent`. Required. The name of the case or Cloud resource to which the attachment should be attached.
