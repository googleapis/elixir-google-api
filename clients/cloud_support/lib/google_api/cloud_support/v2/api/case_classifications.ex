...
defmodule GoogleApi.CloudSupport.V2.Api.CaseClassifications do
  @moduledoc """
  ...
  *   `{:ok, %GoogleApi.CloudSupport.V2.Model.SearchCaseClassificationsResponse{}}` on success
  *   `{:error, info}` on failure
  """
  @spec cloudsupport_case_classifications_search(Tesla.Env.client(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudSupport.V2.Model.SearchCaseClassificationsResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudsupport_case_classifications_search(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v2/caseClassifications:search", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.CloudSupport.V2.Model.SearchCaseClassificationsResponse{}]
    )
  end
end
