...
defmodule GoogleApi.CloudSupport.V2.Api.Media do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def cloudsupport_media_download(
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudSupport.V2.Model.Media{}])
  end
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:uploadType` (*type:* `String.t`) - Legacy upload protocol for media (e.g. "media", "multipart").
      *   `:upload_protocol` (*type:* `String.t`) - Upload protocol for media (e.g. "raw", "multipart").
      *   `:body` (*type:* `GoogleApi.CloudSupport.V2.Model.CreateAttachmentRequest.t`) - 
  *   `opts` (*type:* `keyword()`) - Call options
  ...
  *   `{:error, info}` on failure
  ...
  def cloudsupport_media_upload(
    ...
    connection
    |> Connection.execute(request)
    |> Response.decode(opts ++ [struct: %GoogleApi.CloudSupport.V2.Model.Attachment{}])
  end
