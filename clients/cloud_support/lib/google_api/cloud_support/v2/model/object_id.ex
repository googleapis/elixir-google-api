...
defmodule GoogleApi.CloudSupport.V2.Model.ObjectId do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSupport.V2.Model.ObjectId do
  def decode(value, options) do
    GoogleApi.CloudSupport.V2.Model.ObjectId.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSupport.V2.Model.ObjectId do
