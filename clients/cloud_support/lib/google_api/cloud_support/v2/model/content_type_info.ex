...
defmodule GoogleApi.CloudSupport.V2.Model.ContentTypeInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudSupport.V2.Model.ContentTypeInfo do
  def decode(value, options) do
    GoogleApi.CloudSupport.V2.Model.ContentTypeInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudSupport.V2.Model.ContentTypeInfo do
