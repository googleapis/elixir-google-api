...
defmodule GoogleApi.Firebase.V1beta1.Model.RemoveIosAppRequest do
  ...
  *   `immediate` (*type:* `boolean()`, *default:* `nil`) - Determines whether to _immediately_ delete the App. If set to true, the App is immediately deleted from the Project and cannot be restored to the Project. If not set, defaults to false, which means that the App may be restored to the Project within 30 days using UndeleteIosApp
