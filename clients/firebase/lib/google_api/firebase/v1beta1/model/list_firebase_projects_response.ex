...
defmodule GoogleApi.Firebase.V1beta1.Model.ListFirebaseProjectsResponse do
  @moduledoc """
  ...
  *   `results` (*type:* `list(GoogleApi.Firebase.V1beta1.Model.FirebaseProject.t)`, *default:* `nil`) - One page of the list of Projects that are accessible to the caller.
  ...
  field(:nextPageToken)
  field(:results, as: GoogleApi.Firebase.V1beta1.Model.FirebaseProject, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Firebase.V1beta1.Model.ListFirebaseProjectsResponse do
  def decode(value, options) do
    GoogleApi.Firebase.V1beta1.Model.ListFirebaseProjectsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firebase.V1beta1.Model.ListFirebaseProjectsResponse do
