...
defmodule GoogleApi.Firebase.V1beta1.Model.ListAndroidAppsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Firebase.V1beta1.Model.ListAndroidAppsResponse do
  def decode(value, options) do
    GoogleApi.Firebase.V1beta1.Model.ListAndroidAppsResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Firebase.V1beta1.Model.ListAndroidAppsResponse do
