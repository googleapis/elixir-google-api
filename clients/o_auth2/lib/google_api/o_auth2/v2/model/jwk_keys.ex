...
defmodule GoogleApi.OAuth2.V2.Model.JwkKeys do
  ...
  - alg (String.t):  Defaults to `RS256`.
  - e (String.t):  Defaults to `nil`.
  - kid (String.t):  Defaults to `nil`.
  - kty (String.t):  Defaults to `RSA`.
  - n (String.t):  Defaults to `nil`.
  - use (String.t):  Defaults to `sig`.
  """
