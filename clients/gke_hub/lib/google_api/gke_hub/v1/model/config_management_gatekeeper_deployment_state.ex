...
defmodule GoogleApi.GKEHub.V1.Model.ConfigManagementGatekeeperDeploymentState do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEHub.V1.Model.ConfigManagementGatekeeperDeploymentState do
  def decode(value, options) do
    GoogleApi.GKEHub.V1.Model.ConfigManagementGatekeeperDeploymentState.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEHub.V1.Model.ConfigManagementGatekeeperDeploymentState do
