...
defmodule GoogleApi.GKEHub.V1.Model.OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEHub.V1.Model.OperationMetadata do
  def decode(value, options) do
    GoogleApi.GKEHub.V1.Model.OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEHub.V1.Model.OperationMetadata do
