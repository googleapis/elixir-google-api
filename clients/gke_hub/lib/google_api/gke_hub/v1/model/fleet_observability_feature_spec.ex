...
defmodule GoogleApi.GKEHub.V1.Model.FleetObservabilityFeatureSpec do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.GKEHub.V1.Model.FleetObservabilityFeatureSpec do
  def decode(value, options) do
    GoogleApi.GKEHub.V1.Model.FleetObservabilityFeatureSpec.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.GKEHub.V1.Model.FleetObservabilityFeatureSpec do
