...
defmodule GoogleApi.Domains.V1alpha2.Model.TransferParameters do
  @moduledoc """
  ...
  *   `yearlyPrice` (*type:* `GoogleApi.Domains.V1alpha2.Model.Money.t`, *default:* `nil`) - Price to transfer or renew the domain for one year.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.TransferParameters do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.TransferParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.TransferParameters do
