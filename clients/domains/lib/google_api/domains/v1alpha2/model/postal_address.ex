...
defmodule GoogleApi.Domains.V1alpha2.Model.PostalAddress do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.PostalAddress do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.PostalAddress.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.PostalAddress do
