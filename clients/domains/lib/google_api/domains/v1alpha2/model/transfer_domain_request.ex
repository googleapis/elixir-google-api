...
defmodule GoogleApi.Domains.V1alpha2.Model.TransferDomainRequest do
  @moduledoc """
  ...
  *   `authorizationCode` (*type:* `GoogleApi.Domains.V1alpha2.Model.AuthorizationCode.t`, *default:* `nil`) - The domain's transfer authorization code. You can obtain this from the domain's current registrar.
  ...
  *   `yearlyPrice` (*type:* `GoogleApi.Domains.V1alpha2.Model.Money.t`, *default:* `nil`) - Required. Acknowledgement of the price to transfer or renew the domain for one year. Call `RetrieveTransferParameters` to obtain the price, which you must acknowledge.
  ...
  field(:authorizationCode, as: GoogleApi.Domains.V1alpha2.Model.AuthorizationCode)
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.TransferDomainRequest do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.TransferDomainRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.TransferDomainRequest do
