...
defmodule GoogleApi.Domains.V1alpha2.Model.GeoPolicyItem do
  @moduledoc """
  ...
  *   `signatureRrdata` (*type:* `list(String.t)`, *default:* `nil`) - DNSSEC generated signatures for all the `rrdata` within this item. If health checked targets are provided for DNSSEC enabled zones, there's a restriction of 1 IP address per item.
  ...
  @type t :: %__MODULE__{
          :healthCheckedTargets => GoogleApi.Domains.V1alpha2.Model.HealthCheckTargets.t() | nil,
          :location => String.t() | nil,
          :rrdata => list(String.t()) | nil,
          :signatureRrdata => list(String.t()) | nil
        }

  field(:healthCheckedTargets, as: GoogleApi.Domains.V1alpha2.Model.HealthCheckTargets)
  field(:location)
  field(:rrdata, type: :list)
  field(:signatureRrdata, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.GeoPolicyItem do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.GeoPolicyItem.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.GeoPolicyItem do
