...
defmodule GoogleApi.Domains.V1alpha2.Model.DomainForwarding do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.DomainForwarding do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.DomainForwarding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.DomainForwarding do
