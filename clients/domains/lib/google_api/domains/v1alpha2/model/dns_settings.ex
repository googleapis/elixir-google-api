...
defmodule GoogleApi.Domains.V1alpha2.Model.DnsSettings do
  @moduledoc """
  ...
  *   `googleDomainsDns` (*type:* `GoogleApi.Domains.V1alpha2.Model.GoogleDomainsDns.t`, *default:* `nil`) - The free DNS zone provided by [Google Domains](https://domains.google/).
  """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.DnsSettings do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.DnsSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.DnsSettings do
