...
defmodule GoogleApi.Domains.V1alpha2.Model.GoogleDomainsDns do
  @moduledoc """
  ...
  *   `dsRecords` (*type:* `list(GoogleApi.Domains.V1alpha2.Model.DsRecord.t)`, *default:* `nil`) - Output only. The list of DS records published for this domain. The list is automatically populated when `ds_state` is `DS_RECORDS_PUBLISHED`, otherwise it remains empty.
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.GoogleDomainsDns do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.GoogleDomainsDns.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.GoogleDomainsDns do
