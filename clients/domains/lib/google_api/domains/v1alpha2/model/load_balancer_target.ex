...
defmodule GoogleApi.Domains.V1alpha2.Model.LoadBalancerTarget do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1alpha2.Model.LoadBalancerTarget do
  def decode(value, options) do
    GoogleApi.Domains.V1alpha2.Model.LoadBalancerTarget.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1alpha2.Model.LoadBalancerTarget do
