...
defmodule GoogleApi.Domains.V1.Model.Registration do
  @moduledoc """
  ...
  *   `contactSettings` (*type:* `GoogleApi.Domains.V1.Model.ContactSettings.t`, *default:* `nil`) - Required. Settings for contact information linked to the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureContactSettings` method.
  *   `createTime` (*type:* `DateTime.t`, *default:* `nil`) - Output only. The creation timestamp of the `Registration` resource.
  *   `dnsSettings` (*type:* `GoogleApi.Domains.V1.Model.DnsSettings.t`, *default:* `nil`) - Settings controlling the DNS configuration of the `Registration`. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureDnsSettings` method.
  ...
  *   `managementSettings` (*type:* `GoogleApi.Domains.V1.Model.ManagementSettings.t`, *default:* `nil`) - Settings for management of the `Registration`, including renewal, billing, and transfer. You cannot update these with the `UpdateRegistration` method. To update these settings, use the `ConfigureManagementSettings` method.
  ...
  *   `transferFailureReason` (*type:* `String.t`, *default:* `nil`) - Output only. Deprecated: For more information, see [Cloud Domains feature deprecation](https://cloud.google.com/domains/docs/deprecations/feature-deprecations). The reason the domain transfer failed. Only set for domains in TRANSFER_FAILED state.
  ...
  @type t :: %__MODULE__{
          :contactSettings => GoogleApi.Domains.V1.Model.ContactSettings.t() | nil,
          :createTime => DateTime.t() | nil,
          :dnsSettings => GoogleApi.Domains.V1.Model.DnsSettings.t() | nil,
          :domainName => String.t() | nil,
          :domainProperties => list(String.t()) | nil,
          :expireTime => DateTime.t() | nil,
          :issues => list(String.t()) | nil,
          :labels => map() | nil,
          :managementSettings => GoogleApi.Domains.V1.Model.ManagementSettings.t() | nil,
          :name => String.t() | nil,
          :pendingContactSettings => GoogleApi.Domains.V1.Model.ContactSettings.t() | nil,
  ...
  field(:contactSettings, as: GoogleApi.Domains.V1.Model.ContactSettings)
  field(:createTime, as: DateTime)
  field(:dnsSettings, as: GoogleApi.Domains.V1.Model.DnsSettings)
  field(:domainName)
  field(:domainProperties, type: :list)
  field(:expireTime, as: DateTime)
  field(:issues, type: :list)
  field(:labels, type: :map)
  field(:managementSettings, as: GoogleApi.Domains.V1.Model.ManagementSettings)
  field(:name)
  field(:pendingContactSettings, as: GoogleApi.Domains.V1.Model.ContactSettings)
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.Registration do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.Registration.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.Registration do
