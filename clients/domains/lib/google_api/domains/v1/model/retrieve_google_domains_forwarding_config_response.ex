...
defmodule GoogleApi.Domains.V1.Model.RetrieveGoogleDomainsForwardingConfigResponse do
  @moduledoc """
  ...
  *   `emailForwardings` (*type:* `list(GoogleApi.Domains.V1.Model.EmailForwarding.t)`, *default:* `nil`) - The list of email forwarding configurations. A forwarding configuration might not work correctly if the required DNS records are not present in the domain's authoritative DNS zone.
  ...
  @type t :: %__MODULE__{
          :domainForwardings => list(GoogleApi.Domains.V1.Model.DomainForwarding.t()) | nil,
          :emailForwardings => list(GoogleApi.Domains.V1.Model.EmailForwarding.t()) | nil
        }

  field(:domainForwardings, as: GoogleApi.Domains.V1.Model.DomainForwarding, type: :list)
  field(:emailForwardings, as: GoogleApi.Domains.V1.Model.EmailForwarding, type: :list)
end

defimpl Poison.Decoder,
  for: GoogleApi.Domains.V1.Model.RetrieveGoogleDomainsForwardingConfigResponse do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.RetrieveGoogleDomainsForwardingConfigResponse.decode(
      value,
      options
    )
  end
