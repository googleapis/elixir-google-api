...
defmodule GoogleApi.Domains.V1.Model.RRSetRoutingPolicy do
  @moduledoc """
  ...
  *   `wrrPolicy` (*type:* `GoogleApi.Domains.V1.Model.WrrPolicy.t`, *default:* `nil`) - 
  ...
  field(:geo, as: GoogleApi.Domains.V1.Model.GeoPolicy)
  field(:geoPolicy, as: GoogleApi.Domains.V1.Model.GeoPolicy)
  field(:primaryBackup, as: GoogleApi.Domains.V1.Model.PrimaryBackupPolicy)
  field(:wrr, as: GoogleApi.Domains.V1.Model.WrrPolicy)
  field(:wrrPolicy, as: GoogleApi.Domains.V1.Model.WrrPolicy)
end

defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.RRSetRoutingPolicy do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.RRSetRoutingPolicy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.RRSetRoutingPolicy do
