...
defmodule GoogleApi.Domains.V1.Model.Location do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.Location do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.Location do
