...
defmodule GoogleApi.Domains.V1.Model.RegisterParameters do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.RegisterParameters do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.RegisterParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.RegisterParameters do
