...
defmodule GoogleApi.Domains.V1.Model.Contact do
  @moduledoc """
  ...
  *   `postalAddress` (*type:* `GoogleApi.Domains.V1.Model.PostalAddress.t`, *default:* `nil`) - Required. Postal address of the contact.
  ...
  field(:faxNumber)
  field(:phoneNumber)
  field(:postalAddress, as: GoogleApi.Domains.V1.Model.PostalAddress)
end

defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.Contact do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.Contact.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.Contact do
