...
defmodule GoogleApi.Domains.V1.Model.EmailForwarding do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.EmailForwarding do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.EmailForwarding.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.EmailForwarding do
