...
defmodule GoogleApi.Domains.V1.Model.RegisterDomainRequest do
  @moduledoc """
  ...
  *   `registration` (*type:* `GoogleApi.Domains.V1.Model.Registration.t`, *default:* `nil`) - Required. The complete `Registration` resource to be created.
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.RegisterDomainRequest do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.RegisterDomainRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.RegisterDomainRequest do
