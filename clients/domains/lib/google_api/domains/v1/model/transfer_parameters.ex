...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1.Model.TransferParameters do
  def decode(value, options) do
    GoogleApi.Domains.V1.Model.TransferParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1.Model.TransferParameters do
