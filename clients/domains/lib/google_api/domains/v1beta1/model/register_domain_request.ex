...
defmodule GoogleApi.Domains.V1beta1.Model.RegisterDomainRequest do
  @moduledoc """
  ...
  *   `registration` (*type:* `GoogleApi.Domains.V1beta1.Model.Registration.t`, *default:* `nil`) - Required. The complete `Registration` resource to be created.
  ...
  *   `yearlyPrice` (*type:* `GoogleApi.Domains.V1beta1.Model.Money.t`, *default:* `nil`) - Required. Yearly price to register or renew the domain. The value that should be put here can be obtained from RetrieveRegisterParameters or SearchDomains calls.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.RegisterDomainRequest do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.RegisterDomainRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.RegisterDomainRequest do
