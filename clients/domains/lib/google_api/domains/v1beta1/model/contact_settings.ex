...
defmodule GoogleApi.Domains.V1beta1.Model.ContactSettings do
  ...
  *   `technicalContact` (*type:* `GoogleApi.Domains.V1beta1.Model.Contact.t`, *default:* `nil`) - Required. The technical contact for the `Registration`.
  ...
  @type t :: %__MODULE__{
          :adminContact => GoogleApi.Domains.V1beta1.Model.Contact.t(),
          :privacy => String.t(),
          :registrantContact => GoogleApi.Domains.V1beta1.Model.Contact.t(),
          :technicalContact => GoogleApi.Domains.V1beta1.Model.Contact.t()
        }
