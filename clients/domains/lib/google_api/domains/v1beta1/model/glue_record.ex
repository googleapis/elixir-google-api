...
defmodule GoogleApi.Domains.V1beta1.Model.GlueRecord do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.GlueRecord do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.GlueRecord.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.GlueRecord do
