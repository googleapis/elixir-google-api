...
defmodule GoogleApi.Domains.V1beta1.Model.RegisterParameters do
  @moduledoc """
  ...
  *   `yearlyPrice` (*type:* `GoogleApi.Domains.V1beta1.Model.Money.t`, *default:* `nil`) - Price to register or renew the domain for one year.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.RegisterParameters do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.RegisterParameters.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.RegisterParameters do
