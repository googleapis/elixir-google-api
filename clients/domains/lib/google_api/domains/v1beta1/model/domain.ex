...
defmodule GoogleApi.Domains.V1beta1.Model.Domain do
  @moduledoc """
  ...
  *   `yearlyPrice` (*type:* `GoogleApi.Domains.V1beta1.Model.Money.t`, *default:* `nil`) - Price to renew the domain for one year. Only set when `resource_state` is `IMPORTABLE`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.Domain do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.Domain.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.Domain do
