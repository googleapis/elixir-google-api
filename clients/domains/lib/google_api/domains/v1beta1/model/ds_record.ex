...
defmodule GoogleApi.Domains.V1beta1.Model.DsRecord do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.DsRecord do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.DsRecord.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.DsRecord do
