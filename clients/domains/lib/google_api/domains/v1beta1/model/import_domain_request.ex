...
defimpl Poison.Decoder, for: GoogleApi.Domains.V1beta1.Model.ImportDomainRequest do
  def decode(value, options) do
    GoogleApi.Domains.V1beta1.Model.ImportDomainRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Domains.V1beta1.Model.ImportDomainRequest do
