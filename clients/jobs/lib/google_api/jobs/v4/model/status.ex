...
defmodule GoogleApi.Jobs.V4.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.Status do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.Status do
