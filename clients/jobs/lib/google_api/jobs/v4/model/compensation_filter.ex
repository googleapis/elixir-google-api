...
defmodule GoogleApi.Jobs.V4.Model.CompensationFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.CompensationFilter do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.CompensationFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.CompensationFilter do
