...
defmodule GoogleApi.Jobs.V4.Model.CommuteInfo do
  @moduledoc """
  ...
  *   `travelDuration` (*type:* `String.t`, *default:* `nil`) - The number of seconds required to travel to the job location from the query location. A duration of 0 seconds indicates that the job isn't reachable within the requested duration, but was returned as part of an expanded query.
  ...
  field(:jobLocation, as: GoogleApi.Jobs.V4.Model.Location)
  field(:travelDuration)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.CommuteInfo do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.CommuteInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.CommuteInfo do
