...
defmodule GoogleApi.Jobs.V4.Model.ProcessingOptions do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.ProcessingOptions do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.ProcessingOptions.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.ProcessingOptions do
