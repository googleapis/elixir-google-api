...
defmodule GoogleApi.Jobs.V4.Model.BatchOperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.BatchOperationMetadata do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.BatchOperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.BatchOperationMetadata do
