...
defmodule GoogleApi.Jobs.V4.Model.CompensationRange do
  @moduledoc """
  Compensation range.
  ...
  *   `minCompensation` (*type:* `GoogleApi.Jobs.V4.Model.Money.t`, *default:* `nil`) - The minimum amount of compensation. If left empty, the value is set to zero and the currency code is set to match the currency code of max_compensation.
  ...
  field(:maxCompensation, as: GoogleApi.Jobs.V4.Model.Money)
  field(:minCompensation, as: GoogleApi.Jobs.V4.Model.Money)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.CompensationRange do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.CompensationRange.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.CompensationRange do
