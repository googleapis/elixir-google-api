...
defmodule GoogleApi.Jobs.V4.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.TimeOfDay do
