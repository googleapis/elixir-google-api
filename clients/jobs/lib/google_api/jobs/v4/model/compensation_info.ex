...
defmodule GoogleApi.Jobs.V4.Model.CompensationInfo do
  @moduledoc """
  ...
  *   `entries` (*type:* `list(GoogleApi.Jobs.V4.Model.CompensationEntry.t)`, *default:* `nil`) - Job compensation information. At most one entry can be of type CompensationInfo.CompensationType.BASE, which is referred as **base compensation entry** for the job.
  ...
  @type t :: %__MODULE__{
          :annualizedBaseCompensationRange => GoogleApi.Jobs.V4.Model.CompensationRange.t() | nil,
          :annualizedTotalCompensationRange =>
            GoogleApi.Jobs.V4.Model.CompensationRange.t() | nil,
          :entries => list(GoogleApi.Jobs.V4.Model.CompensationEntry.t()) | nil
        }

  field(:annualizedBaseCompensationRange, as: GoogleApi.Jobs.V4.Model.CompensationRange)
  field(:annualizedTotalCompensationRange, as: GoogleApi.Jobs.V4.Model.CompensationRange)
  field(:entries, as: GoogleApi.Jobs.V4.Model.CompensationEntry, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V4.Model.CompensationInfo do
  def decode(value, options) do
    GoogleApi.Jobs.V4.Model.CompensationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V4.Model.CompensationInfo do
