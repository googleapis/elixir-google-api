...
defmodule GoogleApi.Jobs.V3.Model.SearchJobsRequest do
  ...
  *   `disableKeywordMatch` (*type:* `boolean()`, *default:* `nil`) - Optional. Controls whether to disable exact keyword match on Job.job_title,
      ...
      Defaults to false.
  *   `diversificationLevel` (*type:* `String.t`, *default:* `nil`) - Optional. Controls whether highly similar jobs are returned next to each other in
  ...
  *   `jobView` (*type:* `String.t`, *default:* `nil`) - Optional. The desired job attributes returned for jobs in the
  ...
  *   `orderBy` (*type:* `String.t`, *default:* `nil`) - Optional. The criteria determining how search results are sorted. Default is
      "relevance desc".
  ...
  *   `requestMetadata` (*type:* `GoogleApi.Jobs.V3.Model.RequestMetadata.t`, *default:* `nil`) - Required. The meta information collected about the job searcher, used to improve the
      search quality of the service. The identifiers (such as `user_id`) are
      provided by users, and must be unique and consistent.
  *   `requirePreciseResultSize` (*type:* `boolean()`, *default:* `nil`) - Optional. Controls if the search job request requires the return of a precise
      ...
      Defaults to false.
  *   `searchMode` (*type:* `String.t`, *default:* `nil`) - Optional. Mode of a search.
