...
defmodule GoogleApi.Jobs.V3.Model.BucketizedCount do
  @moduledoc """
  ...
  *   `range` (*type:* `GoogleApi.Jobs.V3.Model.BucketRange.t`, *default:* `nil`) - Bucket range on which histogram was performed for the numeric field,
  ...
  field(:count)
  field(:range, as: GoogleApi.Jobs.V3.Model.BucketRange)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.BucketizedCount do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.BucketizedCount.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.BucketizedCount do
