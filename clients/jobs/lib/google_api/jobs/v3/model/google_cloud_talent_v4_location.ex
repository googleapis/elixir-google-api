...
defmodule GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4Location do
  @moduledoc """
  ...
  *   `postalAddress` (*type:* `GoogleApi.Jobs.V3.Model.PostalAddress.t`, *default:* `nil`) - Postal address of the location that includes human readable information, such as postal delivery and payments addresses. Given a postal address, a postal service can deliver items to a premises, P.O. Box, or other delivery location.
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4Location do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4Location.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4Location do
