...
defmodule GoogleApi.Jobs.V3.Model.CompensationInfo do
  @moduledoc """
  ...
  *   `entries` (*type:* `list(GoogleApi.Jobs.V3.Model.CompensationEntry.t)`, *default:* `nil`) - Optional. Job compensation information.
  ...
  field(:annualizedTotalCompensationRange, as: GoogleApi.Jobs.V3.Model.CompensationRange)
  field(:entries, as: GoogleApi.Jobs.V3.Model.CompensationEntry, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.CompensationInfo do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.CompensationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.CompensationInfo do
