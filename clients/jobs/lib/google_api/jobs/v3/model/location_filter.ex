...
defmodule GoogleApi.Jobs.V3.Model.LocationFilter do
  ...
  *   `latLng` (*type:* `GoogleApi.Jobs.V3.Model.LatLng.t`, *default:* `nil`) - Optional. The latitude and longitude of the geographic center from which to
      search. This field's ignored if `address` is provided.
  *   `regionCode` (*type:* `String.t`, *default:* `nil`) - Optional. CLDR region code of the country/region of the address. This is used
  ...
  *   `telecommutePreference` (*type:* `String.t`, *default:* `nil`) - Optional. Allows the client to return jobs without a
