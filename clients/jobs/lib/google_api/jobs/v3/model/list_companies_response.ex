...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.ListCompaniesResponse do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.ListCompaniesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.ListCompaniesResponse do
