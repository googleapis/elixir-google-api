  ...
  *   `simpleHistogramResults` (*type:* `list(GoogleApi.Jobs.V3.Model.HistogramResult.t)`, *default:* `nil`) - Specifies histogram results that matches HistogramFacets.simple_histogram_facets.
  ...
  @type t :: %__MODULE__{
          :compensationHistogramResults =>
            list(GoogleApi.Jobs.V3.Model.CompensationHistogramResult.t()) | nil,
          :customAttributeHistogramResults =>
            list(GoogleApi.Jobs.V3.Model.CustomAttributeHistogramResult.t()) | nil,
          :simpleHistogramResults => list(GoogleApi.Jobs.V3.Model.HistogramResult.t()) | nil
        }

  field(:compensationHistogramResults,
    as: GoogleApi.Jobs.V3.Model.CompensationHistogramResult,
    type: :list
  )

  field(:customAttributeHistogramResults,
    as: GoogleApi.Jobs.V3.Model.CustomAttributeHistogramResult,
    type: :list
  )

  field(:simpleHistogramResults, as: GoogleApi.Jobs.V3.Model.HistogramResult, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.HistogramResults do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.HistogramResults.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.HistogramResults do
