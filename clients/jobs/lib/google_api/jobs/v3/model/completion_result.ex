...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.CompletionResult do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.CompletionResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.CompletionResult do
