...
defmodule GoogleApi.Jobs.V3.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.Status do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.Status do
