...
defmodule GoogleApi.Jobs.V3.Model.CompensationRange do
  @moduledoc """
  Compensation range.
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.CompensationRange do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.CompensationRange.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.CompensationRange do
