...
defmodule GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4JobApplicationInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4JobApplicationInfo do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4JobApplicationInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.GoogleCloudTalentV4JobApplicationInfo do
