...
defmodule GoogleApi.Jobs.V3.Model.JobDerivedInfo do
  ...
  *   `locations` (*type:* `list(GoogleApi.Jobs.V3.Model.Location.t)`, *default:* `nil`) - Structured locations of the job, resolved from Job.addresses. locations are exactly matched to Job.addresses in the same order.
  ...
  field(:locations, as: GoogleApi.Jobs.V3.Model.Location, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.Jobs.V3.Model.JobDerivedInfo do
  def decode(value, options) do
    GoogleApi.Jobs.V3.Model.JobDerivedInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Jobs.V3.Model.JobDerivedInfo do
