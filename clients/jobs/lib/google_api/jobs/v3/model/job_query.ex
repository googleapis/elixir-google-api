...
defmodule GoogleApi.Jobs.V3.Model.JobQuery do
  ...
  *   `commuteFilter` (*type:* `GoogleApi.Jobs.V3.Model.CommuteFilter.t`, *default:* `nil`) - Optional. Allows filtering jobs by commute time with different travel methods (for
  ...
  *   `compensationFilter` (*type:* `GoogleApi.Jobs.V3.Model.CompensationFilter.t`, *default:* `nil`) - Optional. This search filter is applied only to
  ...
  *   `jobCategories` (*type:* `list(String.t)`, *default:* `nil`) - Optional. The category filter specifies the categories of jobs to search against.
  ...
  *   `locationFilters` (*type:* `list(GoogleApi.Jobs.V3.Model.LocationFilter.t)`, *default:* `nil`) - Optional. The location filter specifies geo-regions containing the jobs to
  ...
  *   `publishTimeRange` (*type:* `GoogleApi.Jobs.V3.Model.TimestampRange.t`, *default:* `nil`) - Optional. Jobs published within a range specified by this filter are searched
      against.
  *   `query` (*type:* `String.t`, *default:* `nil`) - Optional. The query string that matches against the job title, description, and
      location fields.

      The maximum number of allowed characters is 255.
  *   `queryLanguageCode` (*type:* `String.t`, *default:* `nil`) - The language code of query. For example, "en-US". This field helps to
