...
defmodule GoogleApi.Jobs.V2.Model.CompensationHistogramResult do
  ...
  - result (NumericBucketingResult): Histogram result. Defaults to: `null`.
  - type (String.t): Type of the request, corresponding to CompensationHistogramRequest.type. Defaults to: `null`.
