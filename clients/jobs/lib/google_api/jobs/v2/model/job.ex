...
defmodule GoogleApi.Jobs.V2.Model.Job do
  ...
  - startDate (GoogleApi.Jobs.V2.Model.Date.t): Optional.

  The start date of the job in UTC time zone. Typically this field
  is used for contracting engagements.
  Dates prior to 1970/1/1 and invalid date formats are ignored. Defaults to `nil`.
  - benefits (list(String.t)): Optional.

  The benefits included with the job. Defaults to `nil`.
  - filterableCustomFields (%{optional(String.t) => GoogleApi.Jobs.V2.Model.CustomField.t}): Deprecated. Use custom_attributes instead.
  ...
  provided on job create or update, an error is returned. Defaults to `nil`.
  - companyTitle (String.t): Deprecated. Use company_display_name instead.

  Output only.

  The name of the company listing the job. Defaults to `nil`.
  - companyDisplayName (String.t): Output only.

  The name of the company listing the job. Defaults to `nil`.
  - applicationEmailList (list(String.t)): Optional but at least one of application_urls,
  ...
  The maximum number of allowed characters is 255. Defaults to `nil`.
  - companyName (String.t): Optional but one of company_name or distributor_company_id must be
  provided.

  The resource name of the company listing the job, such as
  /companies/foo. This field takes precedence over the
  distributor-assigned company identifier, distributor_company_id. Defaults to `nil`.
  - level (String.t): Optional.

  The experience level associated with the job, such as "Entry Level". Defaults to `nil`.
  - educationLevels (list(String.t)): Optional.

  The desired education level for the job, such as
  "Bachelors", "Masters", "Doctorate". Defaults to `nil`.
  ...
  defaults to 'en_US'. Defaults to `nil`.
  - extendedCompensationInfo (GoogleApi.Jobs.V2.Model.ExtendedCompensationInfo.t): Deprecated. Always use compensation_info.
  ...
  otherwise an exception is thrown. Defaults to `nil`.
  - applicationInstruction (String.t): Optional but at least one of application_urls,
  application_email_list or application_instruction must be
  specified.
  ...
  The maximum number of allowed characters is 3,000. Defaults to `nil`.
  - expiryDate (GoogleApi.Jobs.V2.Model.Date.t): Deprecated. Use expire_time instead.
  ...
  Otherwise the expiration date isn't updated. Defaults to `nil`.
  - distributorCompanyId (String.t): Optional but one of company_name or distributor_company_id must be
  provided.
  ...
  The maximum number of allowed characters is 255. Defaults to `nil`.
  - compensationInfo (GoogleApi.Jobs.V2.Model.CompensationInfo.t): Optional.

  Job compensation information. Defaults to `nil`.
  - applicationUrls (list(String.t)): Optional but at least one of application_urls,
  application_email_list or application_instruction must be
  specified.
  ...
  The maximum number of allowed characters is 2,000. Defaults to `nil`.
  - expireTime (DateTime.t): Optional but strongly recommended for the best service
  experience.
  ...
  update time. Otherwise the expiration date isn't updated. Defaults to `nil`.
  - department (String.t): Optional.

  The department or functional area within the company with the open
  position.

  The maximum number of allowed characters is 255. Defaults to `nil`.
  - endDate (GoogleApi.Jobs.V2.Model.Date.t): Optional.

  The end date of the job in UTC time zone. Typically this field
  is used for contracting engagements.
  Dates prior to 1970/1/1 and invalid date formats are ignored. Defaults to `nil`.
  - unindexedCustomFields (%{optional(String.t) => GoogleApi.Jobs.V2.Model.CustomField.t}): Deprecated. Use custom_attributes instead.
  ...
  The key of the map can be any valid string. Defaults to `nil`.
  - qualifications (String.t): Optional.
  ...
  The maximum number of allowed characters is 10,000. Defaults to `nil`.
  - responsibilities (String.t): Optional.
  ...
  The maximum number of allowed characters is 10,000. Defaults to `nil`.
  - publishDate (GoogleApi.Jobs.V2.Model.Date.t): Optional.

  The date this job was most recently published in UTC format. The default
  value is the time the request arrives at the server. Defaults to `nil`.
  - locations (list(String.t)): Optional but strongly recommended for the best service experience.
  ...
  - visibility (String.t): Optional.

  The visibility of the job.
  Defaults to JobVisibility.PRIVATE if not specified.
  Currently only JobVisibility.PRIVATE is supported. Defaults to `nil`.
  ...
  to the same location level as this field is strongly recommended. Defaults to `nil`.
  - jobTitle (String.t): Required.

  The title of the job, such as "Software Engineer"

  The maximum number of allowed characters is 500. Defaults to `nil`.
  - incentives (String.t): Optional.

  A description of bonus, commission, and other compensation
  incentives associated with the job not including salary or pay.

  The maximum number of allowed characters is 10,000. Defaults to `nil`.
  - promotionValue (integer()): Optional.
  ...
  Default value is 0, and negative values are treated as 0. Defaults to `nil`.
  - name (String.t): Required during job update.
  ...
  requisition_id since this value is unique. Defaults to `nil`.
  - referenceUrl (String.t): Output only.

  The URL of a web page that displays job details. Defaults to `nil`.
  - employmentTypes (list(String.t)): Optional.

  The employment type(s) of a job, for example,
  full time or
  part time. Defaults to `nil`.
  ...
  The maximum number of allowed characters is 100,000. Defaults to `nil`.
  - customAttributes (%{optional(String.t) => GoogleApi.Jobs.V2.Model.CustomAttribute.t}): Optional.
  ...
  is 50KB. Defaults to `nil`.
  - jobLocations (list(GoogleApi.Jobs.V2.Model.JobLocation.t)): Output only.

  Structured locations of the job, resolved from locations. Defaults to `nil`.
  - createTime (DateTime.t): Output only.

  The timestamp when this job was created. Defaults to `nil`.
  - updateTime (DateTime.t): Output only.

  The timestamp when this job was last updated. Defaults to `nil`.
  """
