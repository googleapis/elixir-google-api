...
defmodule GoogleApi.Jobs.V2.Model.CustomAttribute do
  ...
  Default is false. Defaults to `nil`.
  - longValue (String.t): Optional but at least one of string_values or long_value must
  be specified.

  This field is used to perform number range search.
  (`EQ`, `GT`, `GE`, `LE`, `LT`) over filterable `long_value`. For
  `long_value`, a value between Long.MIN and Long.MAX is allowed. Defaults to `nil`.
  - stringValues (GoogleApi.Jobs.V2.Model.StringValues.t): Optional but at least one of string_values or long_value must
  be specified.
  ...
  Empty strings are not allowed. Defaults to `nil`.
  """
