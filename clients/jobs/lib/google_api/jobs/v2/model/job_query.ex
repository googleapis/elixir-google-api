...
defmodule GoogleApi.Jobs.V2.Model.JobQuery do
  ...
  Currently we don't support sorting by commute time. Defaults to `nil`.
  - companyDisplayNames (list(String.t)): Optional.
  ...
  At most 20 company display name filters are allowed. Defaults to `nil`.
  ...
  any of the specified employment types. Defaults to `nil`.
  ...
  published date. Defaults to `nil`.
  - query (String.t): Optional.

  The query string that matches against the job title, description, and
  location fields.

  The maximum query size is 255 bytes. Defaults to `nil`.
  """
