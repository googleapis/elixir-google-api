...
defmodule GoogleApi.Jobs.V2.Model.UpdateJobRequest do
  ...
  address for the job. Defaults to `nil`.
  - job (GoogleApi.Jobs.V2.Model.Job.t): Required.

  The Job to be updated. Defaults to `nil`.
  ...
  flag is set. Defaults to `nil`.
  - updateJobFields (String.t): Optional but strongly recommended to be provided for the best service
  experience.
  ...
  * unindexedCustomFields (deprecated) Defaults to `nil`.
  """
