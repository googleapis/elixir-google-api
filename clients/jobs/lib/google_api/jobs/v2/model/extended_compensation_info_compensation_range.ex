...
defmodule GoogleApi.Jobs.V2.Model.ExtendedCompensationInfoCompensationRange do
  ...
  - max (ExtendedCompensationInfoDecimal): Required.  Maximum value. Defaults to: `null`.
  - min (ExtendedCompensationInfoDecimal): Required.  Minimum value. Defaults to: `null`.
  """
