...
defmodule GoogleApi.Jobs.V2.Model.CommutePreference do
  ...
  *   `method` (*type:* `String.t`, *default:* `nil`) - Required.

      The method of transportation for which to calculate the commute time.
  *   `roadTraffic` (*type:* `String.t`, *default:* `nil`) - Optional.

      Specifies the traffic density to use when calculating commute time.
      Must not be present if departure_hour_local is specified.
  *   `startLocation` (*type:* `GoogleApi.Jobs.V2.Model.LatLng.t`, *default:* `nil`) - Required.

      The latitude and longitude of the location from which to calculate the
      commute time.
  *   `travelTime` (*type:* `String.t`, *default:* `nil`) - Required.
