...
defmodule GoogleApi.Jobs.V2.Model.CommutePreference do
  ...
  - allowNonStreetLevelAddress (boolean()): Optional.
  If `true`, jobs without street level addresses may also be returned.
  For city level addresses, the city center is used. For state and coarser
  level addresses, text matching is used.
  If this field is set to `false` or is not specified, only jobs that include
  street level addresses will be returned by commute search. Defaults to `nil`.
  - departureHourLocal (integer()): Optional.
  ...
  start_location. Must not be present if road_traffic is specified. Defaults to `nil`.
  - method (String.t): Required.

  The method of transportation for which to calculate the commute time. Defaults to `nil`.
  - roadTraffic (String.t): Optional.

  Specifies the traffic density to use when calculating commute time.
  Must not be present if departure_hour_local is specified. Defaults to `nil`.
  - startLocation (GoogleApi.Jobs.V2.Model.LatLng.t): Required.

  The latitude and longitude of the location from which to calculate the
  commute time. Defaults to `nil`.
  - travelTime (String.t): Required.

  The maximum travel time in seconds. The maximum allowed value is `3600s`
  (one hour). Format is `123s`. Defaults to `nil`.
  """
