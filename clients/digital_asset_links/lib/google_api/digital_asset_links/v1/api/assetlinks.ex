...
defmodule GoogleApi.DigitalAssetLinks.V1.Api.Assetlinks do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :relation (String.t): Query string for the relation.
  ...
  `delegate_permission/common.handle_all_urls`.
    - :source.androidApp.certificate.sha256Fingerprint (String.t): The uppercase SHA-265 fingerprint of the certificate.  From the PEM
  ...
  representations of each octet, separated by colons).
    - :source.androidApp.packageName (String.t): Android App assets are naturally identified by their Java package name.
  For example, the Google Maps app uses the package name
  `com.google.android.apps.maps`.
  REQUIRED
    - :source.web.site (String.t): Web assets are identified by a URL that contains only the scheme, hostname
  ...
  *   `https://www.google.com:444/`  (port does not match)
  REQUIRED
    - :target.androidApp.certificate.sha256Fingerprint (String.t): The uppercase SHA-265 fingerprint of the certificate.  From the PEM
  certificate, it can be acquired like this:
  ...
  and represent the result as a hexstring (that is, uppercase hexadecimal
  representations of each octet, separated by colons).
    - :target.androidApp.packageName (String.t): Android App assets are naturally identified by their Java package name.
  For example, the Google Maps app uses the package name
  `com.google.android.apps.maps`.
  REQUIRED
    - :target.web.site (String.t): Web assets are identified by a URL that contains only the scheme, hostname
  and port parts.  The format is
