...
defmodule GoogleApi.DigitalAssetLinks.V1.Api.Statements do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :relation (String.t): Use only associations that match the specified relation.
  ...
  *   `https://www.google.com:444/`  (port does not match)
  ...
  def digitalassetlinks_statements_list(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(opts ++ [struct: %GoogleApi.DigitalAssetLinks.V1.Model.ListResponse{}])
  end
end
