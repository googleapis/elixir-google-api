...
defmodule GoogleApi.DigitalAssetLinks.V1.Model.CertificateInfo do
  ...
  - sha256Fingerprint (String.t): The uppercase SHA-265 fingerprint of the certificate.  From the PEM
  ...
  representations of each octet, separated by colons). Defaults to `nil`.
  """
