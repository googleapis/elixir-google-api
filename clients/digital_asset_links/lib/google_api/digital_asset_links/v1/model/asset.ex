...
defmodule GoogleApi.DigitalAssetLinks.V1.Model.Asset do
  ...
  - androidApp (GoogleApi.DigitalAssetLinks.V1.Model.AndroidAppAsset.t): Set if this is an Android App asset. Defaults to `nil`.
  - web (GoogleApi.DigitalAssetLinks.V1.Model.WebAsset.t): Set if this is a web asset. Defaults to `nil`.
  """
