...
defmodule GoogleApi.DigitalAssetLinks.V1.Model.ListResponse do
  ...
  - debugString (String.t): Human-readable message containing information intended to help end users
  ...
  programmatic access, use the error_code field below. Defaults to `nil`.
  - errorCode (list(String.t)): Error codes that describe the result of the List operation. Defaults to `nil`.
  - maxAge (String.t): From serving time, how much longer the response should be considered valid
  barring further updates.
  REQUIRED Defaults to `nil`.
  - statements (list(GoogleApi.DigitalAssetLinks.V1.Model.Statement.t)): A list of all the matching statements that have been found. Defaults to `nil`.
  """
