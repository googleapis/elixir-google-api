...
defmodule GoogleApi.DigitalAssetLinks.V1.Model.CheckResponse do
  ...
  - errorCode ([String.t]): Error codes that describe the result of the Check operation. Defaults to: `null`.
    - Enum - one of 
  - linked (boolean()): Set to true if the assets specified in the request are linked by the relation specified in the request. Defaults to: `null`.
