...
defmodule GoogleApi.DigitalAssetLinks.V1.Model.AndroidAppAsset do
  ...
  - certificate (GoogleApi.DigitalAssetLinks.V1.Model.CertificateInfo.t): Because there is no global enforcement of package name uniqueness, we also
  ...
  - packageName (String.t): Android App assets are naturally identified by their Java package name.
