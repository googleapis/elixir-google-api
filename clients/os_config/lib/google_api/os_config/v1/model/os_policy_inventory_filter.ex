...
defmodule GoogleApi.OSConfig.V1.Model.OSPolicyInventoryFilter do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OSConfig.V1.Model.OSPolicyInventoryFilter do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.OSPolicyInventoryFilter.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OSConfig.V1.Model.OSPolicyInventoryFilter do
