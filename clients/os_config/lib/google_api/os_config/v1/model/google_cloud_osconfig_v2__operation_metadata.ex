...
defmodule GoogleApi.OSConfig.V1.Model.GoogleCloudOsconfigV2_OperationMetadata do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OSConfig.V1.Model.GoogleCloudOsconfigV2_OperationMetadata do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.GoogleCloudOsconfigV2_OperationMetadata.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OSConfig.V1.Model.GoogleCloudOsconfigV2_OperationMetadata do
