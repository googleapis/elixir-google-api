...
defmodule GoogleApi.OSConfig.V1.Model.OSPolicyResourceRepositoryResourceZypperRepository do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.OSConfig.V1.Model.OSPolicyResourceRepositoryResourceZypperRepository do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.OSPolicyResourceRepositoryResourceZypperRepository.decode(
      value,
      options
    )
  end
