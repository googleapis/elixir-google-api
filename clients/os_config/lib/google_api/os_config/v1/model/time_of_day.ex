...
defmodule GoogleApi.OSConfig.V1.Model.TimeOfDay do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.OSConfig.V1.Model.TimeOfDay do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.TimeOfDay.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OSConfig.V1.Model.TimeOfDay do
