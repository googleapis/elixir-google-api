...
defimpl Poison.Decoder, for: GoogleApi.OSConfig.V1.Model.TimeZone do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.TimeZone.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OSConfig.V1.Model.TimeZone do
