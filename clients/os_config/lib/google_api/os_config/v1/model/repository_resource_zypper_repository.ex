...
defimpl Poison.Decoder, for: GoogleApi.OSConfig.V1.Model.RepositoryResourceZypperRepository do
  def decode(value, options) do
    GoogleApi.OSConfig.V1.Model.RepositoryResourceZypperRepository.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.OSConfig.V1.Model.RepositoryResourceZypperRepository do
