...
defmodule GoogleApi.PolicyAnalyzer.V1.Api.Folders do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  """
  @spec policyanalyzer_folders_locations_activity_types_activities_query(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def policyanalyzer_folders_locations_activity_types_activities_query(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
