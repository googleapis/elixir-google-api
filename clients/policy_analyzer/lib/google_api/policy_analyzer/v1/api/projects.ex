...
defmodule GoogleApi.PolicyAnalyzer.V1.Api.Projects do
  @moduledoc """
  API calls for all endpoints tagged `Projects`.
  """

  alias GoogleApi.PolicyAnalyzer.V1.Connection
  ...
  *   `{:error, info}` on failure
  """
  @spec policyanalyzer_projects_locations_activity_types_activities_query(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
          ...
          | {:ok, list()}
          | {:error, any()}
  def policyanalyzer_projects_locations_activity_types_activities_query(
        connection,
        parent,
        optional_params \\ [],
        opts \\ []
    ...
    request =
      Request.new()
      |> Request.method(:get)
      |> Request.url("/v1/{+parent}/activities:query", %{
