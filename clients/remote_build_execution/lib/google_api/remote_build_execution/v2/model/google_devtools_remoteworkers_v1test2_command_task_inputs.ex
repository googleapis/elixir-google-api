...
defmodule GoogleApi.RemoteBuildExecution.V2.Model.GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs do
  ...
  *   `arguments` (*type:* `list(String.t)`, *default:* `nil`) - The command itself to run (e.g., argv).
  ...
  *   `files` (*type:* `list(GoogleApi.RemoteBuildExecution.V2.Model.GoogleDevtoolsRemoteworkersV1test2Digest.t)`, *default:* `nil`) - The input filesystem to be set up prior to the task beginning. The
  ...
  *   `inlineBlobs` (*type:* `list(GoogleApi.RemoteBuildExecution.V2.Model.GoogleDevtoolsRemoteworkersV1test2Blob.t)`, *default:* `nil`) - Inline contents for blobs expected to be needed by the bot to execute the
      ...
      remote CAS server.
  *   `workingDirectory` (*type:* `String.t`, *default:* `nil`) - Directory from which a command is executed. It is a relative directory
