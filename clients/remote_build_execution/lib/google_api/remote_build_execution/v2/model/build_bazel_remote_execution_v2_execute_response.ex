...
defmodule GoogleApi.RemoteBuildExecution.V2.Model.BuildBazelRemoteExecutionV2ExecuteResponse do
  ...
  *   `message` (*type:* `String.t`, *default:* `nil`) - Freeform informational message with details on the execution of the action
  ...
  *   `serverLogs` (*type:* `%{optional(String.t) => GoogleApi.RemoteBuildExecution.V2.Model.BuildBazelRemoteExecutionV2LogFile.t}`, *default:* `nil`) - An optional list of additional log outputs the server wishes to provide. A
      ...
      to a user.
  *   `status` (*type:* `GoogleApi.RemoteBuildExecution.V2.Model.GoogleRpcStatus.t`, *default:* `nil`) - If the status has a code other than `OK`, it indicates that the action did
