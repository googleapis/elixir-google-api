...
defmodule GoogleApi.RemoteBuildExecution.V2.Model.GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest do
  ...
  *   `filter` (*type:* `String.t`, *default:* `nil`) - Optional. A filter expression that filters resources listed in
  ...
  *   `parent` (*type:* `String.t`, *default:* `nil`) - Resource name of the instance.
