...
defmodule GoogleApi.RemoteBuildExecution.V2.Api.Operations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.RemoteBuildExecution.V2.Model.BuildBazelRemoteExecutionV2WaitExecutionRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  """
  @spec remotebuildexecution_operations_wait_execution(
          Tesla.Env.client(),
          String.t(),
          keyword(),
          keyword()
  ...
  def remotebuildexecution_operations_wait_execution(
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v2/{+name}:waitExecution", %{
