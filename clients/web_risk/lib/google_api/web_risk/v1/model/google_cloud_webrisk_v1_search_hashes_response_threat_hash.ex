...
defmodule GoogleApi.WebRisk.V1.Model.GoogleCloudWebriskV1SearchHashesResponseThreatHash do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.WebRisk.V1.Model.GoogleCloudWebriskV1SearchHashesResponseThreatHash do
  def decode(value, options) do
    GoogleApi.WebRisk.V1.Model.GoogleCloudWebriskV1SearchHashesResponseThreatHash.decode(
      value,
      options
    )
  end
