...
defmodule GoogleApi.WebRisk.V1.Api.Uris do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  @spec webrisk_uris_search(Tesla.Env.client(), keyword(), keyword()) ::
          ...
          | {:ok, list()}
          | {:error, any()}
  def webrisk_uris_search(connection, optional_params \\ [], opts \\ []) do
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.WebRisk.V1.Model.GoogleCloudWebriskV1SearchUrisResponse{}]
    )
  end
end
