...
defmodule GoogleApi.CustomSearch.V1.Model.SearchSpelling do
  ...
  - correctedQuery (String.t):  Defaults to: `null`.
  - htmlCorrectedQuery (String.t):  Defaults to: `null`.
  """
  ...
  @type t :: %__MODULE__{
          :correctedQuery => any(),
          :htmlCorrectedQuery => any()
        }

  field(:correctedQuery)
  field(:htmlCorrectedQuery)
end

defimpl Poison.Decoder, for: GoogleApi.CustomSearch.V1.Model.SearchSpelling do
  def decode(value, options) do
    GoogleApi.CustomSearch.V1.Model.SearchSpelling.decode(value, options)
  end
end
