...
defmodule GoogleApi.CustomSearch.V1.Model.SearchQueriesPreviousPage do
  @moduledoc """
  Custom search request metadata.

  ## Attributes

  *   `googleHost` (*type:* `String.t`, *default:* `nil`) - Specifies the Google domain (for example, google.com, google.de, or
      google.fr) to which the search should be limited.
  *   `hq` (*type:* `String.t`, *default:* `nil`) - Appends the specified query terms to the query, as if they were combined
      with a logical AND operator.
  *   `startIndex` (*type:* `integer()`, *default:* `nil`) - The index of the current set of search results into the total set of
      results, where the index of the first result is 1.
  *   `safe` (*type:* `String.t`, *default:* `nil`) - Specifies the  SafeSearch level used for filtering out adult results.
  ...
  *   `relatedSite` (*type:* `String.t`, *default:* `nil`) - Specifies that all search results should be pages that are related to the
  ...
  *   `filter` (*type:* `String.t`, *default:* `nil`) - Activates or deactivates the automatic filtering of Google search
  ...
  *   `sort` (*type:* `String.t`, *default:* `nil`) - Specifies that results should be sorted according to the specified
      expression. For example, sort by date.
  *   `orTerms` (*type:* `String.t`, *default:* `nil`) - Provides additional search terms to check for in a document, where each
      ...
      this type of query.
  *   `gl` (*type:* `String.t`, *default:* `nil`) - Boosts search results whose country of origin matches the parameter
  ...
  *   `siteSearchFilter` (*type:* `String.t`, *default:* `nil`) - Specifies whether to include or exclude results from the site named in
  ...
  *   `imgSize` (*type:* `String.t`, *default:* `nil`) - Restricts results to images of a specified size. Supported values are:
      ...
      xxlarge (large)
      huge (extra-large)
  *   `fileType` (*type:* `String.t`, *default:* `nil`) - Restricts results to files of a specified extension. Filetypes supported
  ...
  *   `rights` (*type:* `String.t`, *default:* `nil`) - Filters based on licensing. Supported values include:
      ...
      cc_noncommercial
      cc_nonderived
  *   `disableCnTwTranslation` (*type:* `String.t`, *default:* `nil`) - Enables or disables the Simplified and Traditional Chinese Search
      feature. Supported values are: 0: enabled (default) 1: disabled
  *   `lowRange` (*type:* `String.t`, *default:* `nil`) - Specifies the starting value for a search range. Use cse:lowRange and
      cse:highrange to append an inclusive search range of lowRange...highRange
      to the query.
  *   `excludeTerms` (*type:* `String.t`, *default:* `nil`) - Identifies a word or phrase that should not appear in any documents in
      the search results.
  *   `imgColorType` (*type:* `String.t`, *default:* `nil`) - Restricts results to images of a specified color type. Supported values
      are: mono (black and white) gray (grayscale) color (color)
  *   `hl` (*type:* `String.t`, *default:* `nil`) - Specifies the interface language (host language) of your user interface.
      Explicitly setting this parameter improves the performance and the
      quality of your search results.
  *   `imgDominantColor` (*type:* `String.t`, *default:* `nil`) - Restricts results to images with a specific dominant color. Supported
      values are: red orange yellow green teal blue purple pink white gray
      black
      brown
  *   `startPage` (*type:* `integer()`, *default:* `nil`) - The page number of this set of results, where the page length is set by
      the count property.
  ...
  *   `cr` (*type:* `String.t`, *default:* `nil`) - Restricts search results to documents originating in a particular
      country. You may use Boolean operators in the cr parameter's value.
  *   `searchType` (*type:* `String.t`, *default:* `nil`) - Allowed values are web or image. If unspecified, results are limited to
      webpages.
  *   `highRange` (*type:* `String.t`, *default:* `nil`) - Specifies the ending value for a search range. Use cse:lowRange and
      cse:highrange to append an inclusive search range of lowRange...highRange
      to the query.
  """
...
defimpl Poison.Decoder, for: GoogleApi.CustomSearch.V1.Model.SearchQueriesPreviousPage do
  def decode(value, options) do
    GoogleApi.CustomSearch.V1.Model.SearchQueriesPreviousPage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CustomSearch.V1.Model.SearchQueriesPreviousPage do
