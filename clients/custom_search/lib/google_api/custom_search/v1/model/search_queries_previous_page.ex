...
defmodule GoogleApi.CustomSearch.V1.Model.SearchQueriesPreviousPage do
  ...
  *   `safe` (*type:* `String.t`, *default:* `nil`) - Specifies the [SafeSearch
  ...
  *   `rights` (*type:* `String.t`, *default:* `nil`) - Filters based on licensing. Supported values include:
      ...
      * `cc_nonderived`
  *   `disableCnTwTranslation` (*type:* `String.t`, *default:* `nil`) - Enables or disables the [Simplified and Traditional Chinese
  ...
  *   `searchType` (*type:* `String.t`, *default:* `nil`) - Allowed values are `web` or `image`. If unspecified, results are limited
      to webpages.
