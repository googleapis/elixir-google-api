...
defmodule GoogleApi.AndroidDeviceProvisioning.V1.Model.ClaimDevicesRequest do
  ...
  - claims ([PartnerClaim]): Required. A list of device claims. Defaults to: `null`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.AndroidDeviceProvisioning.V1.Model.ClaimDevicesRequest do
  def decode(value, options) do
    GoogleApi.AndroidDeviceProvisioning.V1.Model.ClaimDevicesRequest.decode(value, options)
  end
end
