...
defmodule GoogleApi.AndroidDeviceProvisioning.V1.Model.Company do
  ...
  - companyName (String.t): Required. The name of the company. For example _XYZ Corp_. Characters allowed are: Latin letters, numerals, hyphens, and spaces. Displayed to the customer&#39;s employees in the zero-touch enrollment portal. Defaults to: `null`.
