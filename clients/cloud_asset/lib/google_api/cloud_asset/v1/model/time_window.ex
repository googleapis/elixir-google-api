...
defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.TimeWindow do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.TimeWindow.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.TimeWindow do
