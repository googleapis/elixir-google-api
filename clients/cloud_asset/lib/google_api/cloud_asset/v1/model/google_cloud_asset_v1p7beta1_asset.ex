...
defmodule GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Asset do
  @moduledoc """
  ...
  *   `updateTime` (*type:* `DateTime.t`, *default:* `nil`) - The last update timestamp of an asset. update_time is updated when create/update/delete operation is performed.
  ...
  @type t :: %__MODULE__{
          ...
          :relatedAssets =>
            GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1RelatedAssets.t() | nil,
          :resource => GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Resource.t() | nil,
          :servicePerimeter =>
  ...
  field(:relatedAssets, as: GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1RelatedAssets)
  field(:resource, as: GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Resource)
...
defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Asset do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Asset.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1p7beta1Asset do
