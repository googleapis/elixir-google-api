...
defmodule GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1Rule do
  ...
  *   `values` (*type:* `GoogleApi.CloudAsset.V1.Model.GoogleCloudAssetV1StringValues.t`, *default:* `nil`) - List of values to be used for this PolicyRule. This field can be set only in Policies for list constraints.
  """
