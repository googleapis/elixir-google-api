...
defmodule GoogleApi.CloudAsset.V1.Model.WindowsQuickFixEngineeringPackage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.WindowsQuickFixEngineeringPackage do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.WindowsQuickFixEngineeringPackage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.WindowsQuickFixEngineeringPackage do
