...
defmodule GoogleApi.CloudAsset.V1.Model.SearchAllResourcesResponse do
  @moduledoc """
  ...
  *   `results` (*type:* `list(GoogleApi.CloudAsset.V1.Model.ResourceSearchResult.t)`, *default:* `nil`) - A list of Resources that match the search query. It contains the resource standard metadata information.
  ...
  field(:nextPageToken)
  field(:results, as: GoogleApi.CloudAsset.V1.Model.ResourceSearchResult, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.SearchAllResourcesResponse do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.SearchAllResourcesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.SearchAllResourcesResponse do
