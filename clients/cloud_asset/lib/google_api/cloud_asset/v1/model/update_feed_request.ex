...
defmodule GoogleApi.CloudAsset.V1.Model.UpdateFeedRequest do
  ...
  *   `feed` (*type:* `GoogleApi.CloudAsset.V1.Model.Feed.t`, *default:* `nil`) - Required. The new values of feed details. It must match an existing feed and the
      field `name` must be in the format of:
      projects/project_number/feeds/feed_id or
      folders/folder_number/feeds/feed_id or
      organizations/organization_number/feeds/feed_id.
  *   `updateMask` (*type:* `String.t`, *default:* `nil`) - Required. Only updates the `feed` fields indicated by this mask.
