...
defmodule GoogleApi.CloudAsset.V1.Model.GoogleIdentityAccesscontextmanagerV1MethodSelector do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.CloudAsset.V1.Model.GoogleIdentityAccesscontextmanagerV1MethodSelector do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.GoogleIdentityAccesscontextmanagerV1MethodSelector.decode(
      value,
      options
    )
  end
