...
defmodule GoogleApi.CloudAsset.V1.Model.OsInfo do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.OsInfo do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.OsInfo.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.OsInfo do
