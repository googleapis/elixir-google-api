...
defmodule GoogleApi.CloudAsset.V1.Model.WindowsUpdatePackage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.CloudAsset.V1.Model.WindowsUpdatePackage do
  def decode(value, options) do
    GoogleApi.CloudAsset.V1.Model.WindowsUpdatePackage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.CloudAsset.V1.Model.WindowsUpdatePackage do
