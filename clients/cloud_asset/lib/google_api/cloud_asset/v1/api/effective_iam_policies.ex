...
defmodule GoogleApi.CloudAsset.V1.Api.EffectiveIamPolicies do
  @moduledoc """
  API calls for all endpoints tagged `EffectiveIamPolicies`.
  """
  ...
  *   `{:error, info}` on failure
  ...
  @spec cloudasset_effective_iam_policies_batch_get(
          ...
          {:ok, GoogleApi.CloudAsset.V1.Model.BatchGetEffectiveIamPoliciesResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudasset_effective_iam_policies_batch_get(
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.CloudAsset.V1.Model.BatchGetEffectiveIamPoliciesResponse{}]
    )
  end
end
