...
defmodule GoogleApi.CloudAsset.V1.Api.Operations do
  @moduledoc """
  ...
  *   `optional_params` (*type:* `keyword()`) - Optional parameters
      ...
      *   `:body` (*type:* `GoogleApi.CloudAsset.V1.Model.CancelOperationRequest.t`) - 
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudasset_operations_cancel(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudAsset.V1.Model.Empty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudasset_operations_cancel(connection, name, optional_params \\ [], opts \\ []) do
  ...
  *   `{:error, info}` on failure
  """
  @spec cloudasset_operations_delete(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.CloudAsset.V1.Model.Empty.t()}
          | {:ok, Tesla.Env.t()}
          | {:ok, list()}
          | {:error, any()}
  def cloudasset_operations_delete(connection, name, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
