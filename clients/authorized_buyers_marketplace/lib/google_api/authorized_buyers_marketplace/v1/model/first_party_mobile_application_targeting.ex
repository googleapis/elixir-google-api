...
defmodule GoogleApi.AuthorizedBuyersMarketplace.V1.Model.FirstPartyMobileApplicationTargeting do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.AuthorizedBuyersMarketplace.V1.Model.FirstPartyMobileApplicationTargeting do
  def decode(value, options) do
    GoogleApi.AuthorizedBuyersMarketplace.V1.Model.FirstPartyMobileApplicationTargeting.decode(
      value,
      options
    )
  end
