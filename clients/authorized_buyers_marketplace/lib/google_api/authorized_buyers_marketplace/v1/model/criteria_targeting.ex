...
defmodule GoogleApi.AuthorizedBuyersMarketplace.V1.Model.CriteriaTargeting do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.AuthorizedBuyersMarketplace.V1.Model.CriteriaTargeting do
  def decode(value, options) do
    GoogleApi.AuthorizedBuyersMarketplace.V1.Model.CriteriaTargeting.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.AuthorizedBuyersMarketplace.V1.Model.CriteriaTargeting do
