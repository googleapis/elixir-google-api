...
defmodule GoogleApi.AuthorizedBuyersMarketplace.V1.Model.Deal do
  ...
  *   `flightStartTime` (*type:* `DateTime.t`, *default:* `nil`) - Proposed flight start time of the deal. This will generally be stored in the granularity of one second since deal serving starts at seconds boundary. Any time specified with more granularity (e.g., in milliseconds) will be truncated towards the start of time in seconds.
