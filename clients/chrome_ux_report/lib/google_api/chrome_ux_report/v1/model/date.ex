...
defmodule GoogleApi.ChromeUXReport.V1.Model.Date do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ChromeUXReport.V1.Model.Date do
  def decode(value, options) do
    GoogleApi.ChromeUXReport.V1.Model.Date.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ChromeUXReport.V1.Model.Date do
