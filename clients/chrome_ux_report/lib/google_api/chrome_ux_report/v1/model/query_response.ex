...
defmodule GoogleApi.ChromeUXReport.V1.Model.QueryResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ChromeUXReport.V1.Model.QueryResponse do
  def decode(value, options) do
    GoogleApi.ChromeUXReport.V1.Model.QueryResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ChromeUXReport.V1.Model.QueryResponse do
