...
defmodule GoogleApi.FCMData.V1beta1.Model.GoogleFirebaseFcmDataV1beta1MessageInsightPercents do
  @moduledoc """
  ...
  *   `priorityLowered` (*type:* `number()`, *default:* `nil`) - The percentage of accepted messages that had their priority lowered from high to normal. See [documentation for setting message priority](https://firebase.google.com/docs/cloud-messaging/android/message-priority).
  ...
  field(:priorityLowered)
end

defimpl Poison.Decoder,
  for: GoogleApi.FCMData.V1beta1.Model.GoogleFirebaseFcmDataV1beta1MessageInsightPercents do
  def decode(value, options) do
    GoogleApi.FCMData.V1beta1.Model.GoogleFirebaseFcmDataV1beta1MessageInsightPercents.decode(
      value,
      options
    )
  end
