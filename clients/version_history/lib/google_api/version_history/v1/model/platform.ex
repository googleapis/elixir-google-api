...
defmodule GoogleApi.VersionHistory.V1.Model.Platform do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VersionHistory.V1.Model.Platform do
  def decode(value, options) do
    GoogleApi.VersionHistory.V1.Model.Platform.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VersionHistory.V1.Model.Platform do
