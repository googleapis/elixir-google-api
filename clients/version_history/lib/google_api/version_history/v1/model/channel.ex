...
defmodule GoogleApi.VersionHistory.V1.Model.Channel do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.VersionHistory.V1.Model.Channel do
  def decode(value, options) do
    GoogleApi.VersionHistory.V1.Model.Channel.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.VersionHistory.V1.Model.Channel do
