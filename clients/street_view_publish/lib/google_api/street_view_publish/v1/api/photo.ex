...
defmodule GoogleApi.StreetViewPublish.V1.Api.Photo do
  ...
  """
  @spec streetviewpublish_photo_create(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.StreetViewPublish.V1.Model.Photo.t} | {:error, Tesla.Env.t}
  def streetviewpublish_photo_create(connection, opts \\ []) do
    ...
    |> decode(%GoogleApi.StreetViewPublish.V1.Model.Photo{})
  end
  ...
  {:error, info} on failure
  """
  @spec streetviewpublish_photo_delete(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.StreetViewPublish.V1.Model.Empty.t} | {:error, Tesla.Env.t}
  def streetviewpublish_photo_delete(connection, photo_id, opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.StreetViewPublish.V1.Model.Empty{})
  end

  @doc """
  Gets the metadata of the specified Photo.  This method returns the following error codes:  * google.rpc.Code.PERMISSION_DENIED if the requesting user did not create the requested Photo. * google.rpc.Code.NOT_FOUND if the requested Photo does not exist.
  ...
  {:error, info} on failure
  """
  @spec streetviewpublish_photo_get(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.StreetViewPublish.V1.Model.Photo.t} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec streetviewpublish_photo_start_upload(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.StreetViewPublish.V1.Model.UploadRef.t} | {:error, Tesla.Env.t}
  def streetviewpublish_photo_start_upload(connection, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v1/photo:startUpload")
    |> add_optional_params(optional_params, opts)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode(%GoogleApi.StreetViewPublish.V1.Model.UploadRef{})
  end
  ...
  {:error, info} on failure
  """
  @spec streetviewpublish_photo_update(Tesla.Env.client, String.t, keyword()) :: {:ok, GoogleApi.StreetViewPublish.V1.Model.Photo.t} | {:error, Tesla.Env.t}
