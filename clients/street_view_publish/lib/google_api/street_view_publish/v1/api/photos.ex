...
defmodule GoogleApi.StreetViewPublish.V1.Api.Photos do
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :body (GoogleApi.StreetViewPublish.V1.Model.BatchDeletePhotosRequest.t): 
  ...
  services is used.
    - :photoIds (list(String.t)): Required. IDs of the Photos. For HTTP
  GET requests, the URL query parameter should be
  `photoIds=<id1>&photoIds=<id2>&...`.
    - :view (String.t): Specifies if a download URL for the photo bytes should be returned in the
  Photo response.
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :body (GoogleApi.StreetViewPublish.V1.Model.BatchUpdatePhotosRequest.t): 
  ...
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :uploadType (String.t): Legacy upload protocol for media (e.g. "media", "multipart").
    - :upload_protocol (String.t): Upload protocol for media (e.g. "raw", "multipart").
    - :filter (String.t): The filter expression. For example: `placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw`.
  ...
  ListPhotos
  request, if any.
    - :view (String.t): Specifies if a download URL for the photos bytes should be returned in the
  Photos response.
