...
defmodule GoogleApi.StreetViewPublish.V1.Model.PhotoResponse do
  ...
  - photo (GoogleApi.StreetViewPublish.V1.Model.Photo.t): The Photo resource, if the request
  was successful. Defaults to `nil`.
  - status (GoogleApi.StreetViewPublish.V1.Model.Status.t): The status for the operation to get or update a single photo in the batch
