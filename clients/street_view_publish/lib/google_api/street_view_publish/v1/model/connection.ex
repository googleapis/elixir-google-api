...
defmodule GoogleApi.StreetViewPublish.V1.Model.Connection do
  ...
  - target (GoogleApi.StreetViewPublish.V1.Model.PhotoId.t): Required. The destination of the connection from the containing photo to
  another photo. Defaults to `nil`.
  """
