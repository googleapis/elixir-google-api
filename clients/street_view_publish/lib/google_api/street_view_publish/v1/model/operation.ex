...
defmodule GoogleApi.StreetViewPublish.V1.Model.Operation do
  @moduledoc """
  ...
  - error (GoogleApi.StreetViewPublish.V1.Model.Status.t): The error result of the operation in case of failure or cancellation. Defaults to `nil`.
  ...
  @type t :: %__MODULE__{
          :done => boolean(),
          :error => GoogleApi.StreetViewPublish.V1.Model.Status.t(),
          :metadata => map(),
          :name => String.t(),
          :response => map()
        }
  ...
  field(:done)
  field(:error, as: GoogleApi.StreetViewPublish.V1.Model.Status)
  field(:metadata, type: :map)
  field(:name)
  field(:response, type: :map)
end

defimpl Poison.Decoder, for: GoogleApi.StreetViewPublish.V1.Model.Operation do
  def decode(value, options) do
    GoogleApi.StreetViewPublish.V1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.StreetViewPublish.V1.Model.Operation do
