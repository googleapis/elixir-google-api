...
defmodule GoogleApi.StreetViewPublish.V1.Model.BatchDeletePhotosRequest do
  ...
  - photoIds (list(String.t)): Required. IDs of the Photos. HTTP
  GET requests require the following syntax for the URL query parameter:
  `photoIds=<id1>&photoIds=<id2>&...`. Defaults to `nil`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.StreetViewPublish.V1.Model.BatchDeletePhotosRequest do
  def decode(value, options) do
    GoogleApi.StreetViewPublish.V1.Model.BatchDeletePhotosRequest.decode(value, options)
  end
end
