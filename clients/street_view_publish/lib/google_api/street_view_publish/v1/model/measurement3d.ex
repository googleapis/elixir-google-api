...
defmodule GoogleApi.StreetViewPublish.V1.Model.Measurement3d do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.StreetViewPublish.V1.Model.Measurement3d do
  def decode(value, options) do
    GoogleApi.StreetViewPublish.V1.Model.Measurement3d.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.StreetViewPublish.V1.Model.Measurement3d do
