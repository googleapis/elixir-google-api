...
defmodule GoogleApi.SASPortal.V1alpha1.Model.SasPortalStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.SASPortal.V1alpha1.Model.SasPortalStatus do
  def decode(value, options) do
    GoogleApi.SASPortal.V1alpha1.Model.SasPortalStatus.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.SASPortal.V1alpha1.Model.SasPortalStatus do
