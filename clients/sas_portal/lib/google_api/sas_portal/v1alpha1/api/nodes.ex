...
defmodule GoogleApi.SASPortal.V1alpha1.Api.Nodes do
  ...
  *   `{:error, info}` on failure
  """
  @spec sasportal_nodes_devices_bulk(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SASPortal.V1alpha1.Model.SasPortalBulkCreateDeviceResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def sasportal_nodes_devices_bulk(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
  ...
  *   `{:error, info}` on failure
  """
  @spec sasportal_nodes_nodes_devices_bulk(Tesla.Env.client(), String.t(), keyword(), keyword()) ::
          {:ok, GoogleApi.SASPortal.V1alpha1.Model.SasPortalBulkCreateDeviceResponse.t()}
          | {:ok, Tesla.Env.t()}
          | {:error, any()}
  def sasportal_nodes_nodes_devices_bulk(connection, parent, optional_params \\ [], opts \\ []) do
    optional_params_config = %{
      :"$.xgafv" => :query,
      :access_token => :query,
      :alt => :query,
