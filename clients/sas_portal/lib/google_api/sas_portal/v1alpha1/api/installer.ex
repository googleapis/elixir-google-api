...
defmodule GoogleApi.SASPortal.V1alpha1.Api.Installer do
  @moduledoc """
  ...
  *   `{:error, info}` on failure
  ...
  def sasportal_installer_generate_secret(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1alpha1/installer:generateSecret", %{})
    ...
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SASPortal.V1alpha1.Model.SasPortalGenerateSecretResponse{}]
    )
  end
  ...
  *   `{:error, info}` on failure
  ...
  def sasportal_installer_validate(connection, optional_params \\ [], opts \\ []) do
    ...
    request =
      Request.new()
      |> Request.method(:post)
      |> Request.url("/v1alpha1/installer:validate", %{})
      |> Request.add_optional_params(optional_params_config, optional_params)
      |> Request.library_version(@library_version)
    ...
    |> Connection.execute(request)
    |> Response.decode(
      opts ++ [struct: %GoogleApi.SASPortal.V1alpha1.Model.SasPortalValidateInstallerResponse{}]
    )
  end
end
