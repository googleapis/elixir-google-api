...
defmodule GoogleApi.Vault.V1.Model.AccountCountError do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Vault.V1.Model.AccountCountError do
  def decode(value, options) do
    GoogleApi.Vault.V1.Model.AccountCountError.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vault.V1.Model.AccountCountError do
