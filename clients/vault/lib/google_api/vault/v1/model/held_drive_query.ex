...
defmodule GoogleApi.Vault.V1.Model.HeldDriveQuery do
  ...
  - includeSharedDriveFiles (boolean()): If true, include files in shared drives in the hold. Defaults to `nil`.
  - includeTeamDriveFiles (boolean()): If true, include files in Team Drives in the hold. Defaults to `nil`.
  """
