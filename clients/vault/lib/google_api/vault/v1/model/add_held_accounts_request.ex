...
defmodule GoogleApi.Vault.V1.Model.AddHeldAccountsRequest do
  ...
  - accountIds ([String.t]): Account ids to identify which accounts to add. Only account_ids or only emails should be specified, but not both. Defaults to: `null`.
  - emails ([String.t]): Emails to identify which accounts to add. Only emails or only account_ids should be specified, but not both. Defaults to: `null`.
  """
