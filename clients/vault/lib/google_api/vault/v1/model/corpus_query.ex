...
defmodule GoogleApi.Vault.V1.Model.CorpusQuery do
  ...
  - driveQuery (GoogleApi.Vault.V1.Model.HeldDriveQuery.t): Details pertaining to Drive holds. If set, corpus must be Drive. Defaults to `nil`.
  - groupsQuery (GoogleApi.Vault.V1.Model.HeldGroupsQuery.t): Details pertaining to Groups holds. If set, corpus must be Groups. Defaults to `nil`.
  - hangoutsChatQuery (GoogleApi.Vault.V1.Model.HeldHangoutsChatQuery.t): Details pertaining to Hangouts Chat holds. If set, corpus must be
  Hangouts Chat. Defaults to `nil`.
  - mailQuery (GoogleApi.Vault.V1.Model.HeldMailQuery.t): Details pertaining to mail holds. If set, corpus must be mail. Defaults to `nil`.
  """
