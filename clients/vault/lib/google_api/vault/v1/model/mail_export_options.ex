...
defmodule GoogleApi.Vault.V1.Model.MailExportOptions do
  ...
  - exportFormat (String.t): The export file format. Defaults to `nil`.
  - showConfidentialModeContent (boolean()): Set to true to export confidential mode content. Defaults to `nil`.
  """
