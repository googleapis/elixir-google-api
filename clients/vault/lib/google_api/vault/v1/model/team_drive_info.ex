...
defmodule GoogleApi.Vault.V1.Model.TeamDriveInfo do
  ...
  - teamDriveIds ([String.t]): List of Team Drive ids, as provided by &lt;a href&#x3D;\&quot;https://developers.google.com/drive\&quot;&gt;Drive API&lt;/a&gt;. Defaults to: `null`.
  """

  use GoogleApi.Gax.ModelBase

  @type t :: %__MODULE__{
          :teamDriveIds => list(any())
        }
