...
defmodule GoogleApi.Vault.V1.Model.GroupsCountResult do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Vault.V1.Model.GroupsCountResult do
  def decode(value, options) do
    GoogleApi.Vault.V1.Model.GroupsCountResult.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Vault.V1.Model.GroupsCountResult do
