...
defmodule GoogleApi.Vault.V1.Model.Matter do
  ...
  *   `matterId` (*type:* `String.t`, *default:* `nil`) - The matter ID which is generated by the server. Should be blank when creating a new matter.
  *   `matterPermissions` (*type:* `list(GoogleApi.Vault.V1.Model.MatterPermission.t)`, *default:* `nil`) - List of users and access to the matter. Currently there is no programmer defined limit on the number of permissions a matter can have.
