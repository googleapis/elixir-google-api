...
defmodule GoogleApi.Vault.V1.Model.HeldOrgUnit do
  ...
  - holdTime (DateTime.t): When the org unit was put on hold. This property is immutable. Defaults to: `null`.
  - orgUnitId (String.t): The org unit&#39;s immutable ID as provided by the Admin SDK. Defaults to: `null`.
  """
