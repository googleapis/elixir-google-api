...
defmodule GoogleApi.Vault.V1.Model.HeldOrgUnit do
  ...
  - holdTime (DateTime.t): When the org unit was put on hold. This property is immutable. Defaults to `nil`.
  - orgUnitId (String.t): The org unit's immutable ID as provided by the Admin SDK. Defaults to `nil`.
  """
