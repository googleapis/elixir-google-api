...
defmodule GoogleApi.Transcoder.V1beta1.Model.AudioStream do
  @moduledoc """
  ...
  *   `sampleRateHertz` (*type:* `integer()`, *default:* `nil`) - The audio sample rate in Hertz. The default is 48000 Hertz.
  ...
  @type t :: %__MODULE__{
          ...
          :codec => String.t() | nil,
          :mapping => list(GoogleApi.Transcoder.V1beta1.Model.AudioAtom.t()) | nil,
  ...
  field(:codec)
  field(:mapping, as: GoogleApi.Transcoder.V1beta1.Model.AudioAtom, type: :list)
  field(:sampleRateHertz)
end

defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.AudioStream do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.AudioStream.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.AudioStream do
