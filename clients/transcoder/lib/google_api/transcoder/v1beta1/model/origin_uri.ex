...
defmodule GoogleApi.Transcoder.V1beta1.Model.OriginUri do
  @moduledoc """
  The origin URI.
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.OriginUri do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.OriginUri.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.OriginUri do
