...
defmodule GoogleApi.Transcoder.V1beta1.Model.Manifest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.Manifest do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.Manifest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.Manifest do
