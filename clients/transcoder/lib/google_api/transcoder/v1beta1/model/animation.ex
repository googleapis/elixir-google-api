...
defmodule GoogleApi.Transcoder.V1beta1.Model.Animation do
  @moduledoc """
  Animation types.
  ...
  *   `animationStatic` (*type:* `GoogleApi.Transcoder.V1beta1.Model.AnimationStatic.t`, *default:* `nil`) - Display static overlay object.
  ...
  field(:animationEnd, as: GoogleApi.Transcoder.V1beta1.Model.AnimationEnd)
  field(:animationFade, as: GoogleApi.Transcoder.V1beta1.Model.AnimationFade)
  field(:animationStatic, as: GoogleApi.Transcoder.V1beta1.Model.AnimationStatic)
end

defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.Animation do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.Animation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.Animation do
