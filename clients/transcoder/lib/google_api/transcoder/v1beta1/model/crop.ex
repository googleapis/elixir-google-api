...
defmodule GoogleApi.Transcoder.V1beta1.Model.Crop do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.Crop do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.Crop.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.Crop do
