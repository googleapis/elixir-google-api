...
defmodule GoogleApi.Transcoder.V1beta1.Model.Denoise do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.Denoise do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.Denoise.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.Denoise do
