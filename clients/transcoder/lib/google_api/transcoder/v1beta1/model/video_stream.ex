...
defmodule GoogleApi.Transcoder.V1beta1.Model.VideoStream do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1beta1.Model.VideoStream do
  def decode(value, options) do
    GoogleApi.Transcoder.V1beta1.Model.VideoStream.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1beta1.Model.VideoStream do
