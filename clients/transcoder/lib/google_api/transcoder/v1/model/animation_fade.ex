...
defmodule GoogleApi.Transcoder.V1.Model.AnimationFade do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1.Model.AnimationFade do
  def decode(value, options) do
    GoogleApi.Transcoder.V1.Model.AnimationFade.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1.Model.AnimationFade do
