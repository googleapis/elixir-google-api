...
defmodule GoogleApi.Transcoder.V1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1.Model.Status do
  def decode(value, options) do
    GoogleApi.Transcoder.V1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1.Model.Status do
