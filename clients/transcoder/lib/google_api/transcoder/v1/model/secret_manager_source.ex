...
defmodule GoogleApi.Transcoder.V1.Model.SecretManagerSource do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1.Model.SecretManagerSource do
  def decode(value, options) do
    GoogleApi.Transcoder.V1.Model.SecretManagerSource.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1.Model.SecretManagerSource do
