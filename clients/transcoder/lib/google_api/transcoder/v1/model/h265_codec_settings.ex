...
defmodule GoogleApi.Transcoder.V1.Model.H265CodecSettings do
  ...
  *   `bFrameCount` (*type:* `integer()`, *default:* `nil`) - The number of consecutive B-frames. Must be greater than or equal to zero. Must be less than H265CodecSettings.gop_frame_count if set. The default is 0.
  ...
  *   `enableTwoPass` (*type:* `boolean()`, *default:* `nil`) - Use two-pass encoding strategy to achieve better video quality. H265CodecSettings.rate_control_mode must be `vbr`. The default is `false`.
  ...
  *   `hdr10` (*type:* `GoogleApi.Transcoder.V1.Model.H265ColorFormatHDR10.t`, *default:* `nil`) - Optional. HDR10 color format setting for H265.
  ...
  *   `hlg` (*type:* `GoogleApi.Transcoder.V1.Model.H265ColorFormatHLG.t`, *default:* `nil`) - Optional. HLG color format setting for H265.
  ...
  *   `sdr` (*type:* `GoogleApi.Transcoder.V1.Model.H265ColorFormatSDR.t`, *default:* `nil`) - Optional. SDR color format setting for H265.
  ...
  *   `vbvFullnessBits` (*type:* `integer()`, *default:* `nil`) - Initial fullness of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default is equal to 90% of H265CodecSettings.vbv_size_bits.
  ...
  *   `widthPixels` (*type:* `integer()`, *default:* `nil`) - The width of the video in pixels. Must be an even integer. When not specified, the width is adjusted to match the specified height and input aspect ratio. If both are omitted, the input width is used. For portrait videos that contain horizontal ASR and rotation metadata, provide the width, in pixels, per the horizontal ASR. The API calculates the height per the horizontal ASR. The API detects any rotation metadata and swaps the requested height and width for the output.
  ...
  @type t :: %__MODULE__{
          ...
          :hdr10 => GoogleApi.Transcoder.V1.Model.H265ColorFormatHDR10.t() | nil,
          :heightPixels => integer() | nil,
          :hlg => GoogleApi.Transcoder.V1.Model.H265ColorFormatHLG.t() | nil,
          :pixelFormat => String.t() | nil,
          :preset => String.t() | nil,
          :profile => String.t() | nil,
          :rateControlMode => String.t() | nil,
          :sdr => GoogleApi.Transcoder.V1.Model.H265ColorFormatSDR.t() | nil,
          :tune => String.t() | nil,
  ...
  field(:gopDuration)
  field(:gopFrameCount)
  field(:hdr10, as: GoogleApi.Transcoder.V1.Model.H265ColorFormatHDR10)
  field(:heightPixels)
  field(:hlg, as: GoogleApi.Transcoder.V1.Model.H265ColorFormatHLG)
  field(:pixelFormat)
  field(:preset)
  field(:profile)
  field(:rateControlMode)
  field(:sdr, as: GoogleApi.Transcoder.V1.Model.H265ColorFormatSDR)
  field(:tune)
