...
defmodule GoogleApi.Transcoder.V1.Model.BwdifConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Transcoder.V1.Model.BwdifConfig do
  def decode(value, options) do
    GoogleApi.Transcoder.V1.Model.BwdifConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Transcoder.V1.Model.BwdifConfig do
