...
defmodule GoogleApi.Testing.V1.Model.AndroidDevice do
  ...
  - androidModelId (String.t): Required. The id of the Android device to be used. Use the TestEnvironmentDiscoveryService to get supported options. Defaults to: `null`.
  - androidVersionId (String.t): Required. The id of the Android OS version to be used. Use the TestEnvironmentDiscoveryService to get supported options. Defaults to: `null`.
