...
defmodule GoogleApi.Testing.V1.Model.DeviceFile do
  ...
  - obbFile (GoogleApi.Testing.V1.Model.ObbFile.t): A reference to an opaque binary blob file. Defaults to `nil`.
  - regularFile (GoogleApi.Testing.V1.Model.RegularFile.t): A reference to a regular file. Defaults to `nil`.
  """
