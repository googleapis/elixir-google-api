...
defmodule GoogleApi.Testing.V1.Model.IosXcTest do
  ...
  - appBundleId (String.t): Output only. The bundle id for the application under test. Defaults to `nil`.
  - testsZip (GoogleApi.Testing.V1.Model.FileReference.t): Required. The .zip containing the .xctestrun file and the contents of the
  DerivedData/Build/Products directory.
  The .xctestrun file in this zip is ignored if the xctestrun field is
  specified. Defaults to `nil`.
  - xcodeVersion (String.t): The Xcode version that should be used for the test.
  Use the TestEnvironmentDiscoveryService to get supported options.
  Defaults to the latest Xcode version Firebase Test Lab supports. Defaults to `nil`.
  - xctestrun (GoogleApi.Testing.V1.Model.FileReference.t): An .xctestrun file that will override the .xctestrun file in the
  ...
  tests. Default is taken from the tests zip. Defaults to `nil`.
  """
