...
defmodule GoogleApi.Testing.V1.Model.IosXcTest do
  ...
  - xcodeVersion (String.t): The Xcode version that should be used for the test. Use the TestEnvironmentDiscoveryService to get supported options. Defaults to the latest Xcode version Firebase Test Lab supports. Defaults to: `null`.
