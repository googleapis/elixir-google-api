...
defmodule GoogleApi.Testing.V1.Model.ObbFile do
  ...
  - obb (GoogleApi.Testing.V1.Model.FileReference.t): Required. Opaque Binary Blob (OBB) file(s) to install on the device. Defaults to `nil`.
  - obbFileName (String.t): Required. OBB file name which must conform to the format as specified by
  Android
  e.g. [main|patch].0300110.com.example.android.obb
  which will be installed into
  \<shared-storage\>/Android/obb/\<package-name\>/
  on the device. Defaults to `nil`.
  """
