...
defmodule GoogleApi.Testing.V1.Model.Environment do
  ...
  - androidDevice (GoogleApi.Testing.V1.Model.AndroidDevice.t): An Android device which must be used with an Android test. Defaults to `nil`.
  - iosDevice (GoogleApi.Testing.V1.Model.IosDevice.t): An iOS device which must be used with an iOS test. Defaults to `nil`.
  """
