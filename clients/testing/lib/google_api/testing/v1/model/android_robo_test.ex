...
defmodule GoogleApi.Testing.V1.Model.AndroidRoboTest do
  ...
  *   `maxDepth` (*type:* `integer()`, *default:* `nil`) - The max depth of the traversal stack Robo can explore. Needs to be at least
      2 to make Robo explore the app beyond the first activity.
      Default is 50.
  *   `maxSteps` (*type:* `integer()`, *default:* `nil`) - The max number of steps Robo can execute.
      Default is no limit.
  *   `roboDirectives` (*type:* `list(GoogleApi.Testing.V1.Model.RoboDirective.t)`, *default:* `nil`) - A set of directives Robo should apply during the crawl.
      This allows users to customize the crawl. For example, the username and
      password for a test account can be provided.
  *   `roboScript` (*type:* `GoogleApi.Testing.V1.Model.FileReference.t`, *default:* `nil`) - A JSON file with a sequence of actions Robo should perform as a prologue
      for the crawl.
  *   `startingIntents` (*type:* `list(GoogleApi.Testing.V1.Model.RoboStartingIntent.t)`, *default:* `nil`) - The intents used to launch the app for the crawl.
