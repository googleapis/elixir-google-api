...
defmodule GoogleApi.Testing.V1.Model.EnvironmentMatrix do
  ...
  - androidDeviceList (GoogleApi.Testing.V1.Model.AndroidDeviceList.t): A list of Android devices; the test will be run only on the specified
  devices. Defaults to `nil`.
  - androidMatrix (GoogleApi.Testing.V1.Model.AndroidMatrix.t): A matrix of Android devices. Defaults to `nil`.
  - iosDeviceList (GoogleApi.Testing.V1.Model.IosDeviceList.t): A list of iOS devices. Defaults to `nil`.
  """
