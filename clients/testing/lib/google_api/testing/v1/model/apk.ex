...
defmodule GoogleApi.Testing.V1.Model.Apk do
  ...
  - location (GoogleApi.Testing.V1.Model.FileReference.t): The path to an APK to be installed on the device before the test begins. Defaults to `nil`.
  - packageName (String.t): The java package for the APK to be installed.
  Value is determined by examining the application's manifest. Defaults to `nil`.
  """
