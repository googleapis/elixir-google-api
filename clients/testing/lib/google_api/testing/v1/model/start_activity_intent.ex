...
defmodule GoogleApi.Testing.V1.Model.StartActivityIntent do
  ...
  - action (String.t): Action name.
  Required for START_ACTIVITY. Defaults to `nil`.
  - categories (list(String.t)): Intent categories to set on the intent. Defaults to `nil`.
  - uri (String.t): URI for the action. Defaults to `nil`.
  """
