...
defmodule GoogleApi.Testing.V1.Model.AndroidMatrix do
  ...
  - androidModelIds (list(String.t)): Required. The ids of the set of Android device to be used.
  Use the TestEnvironmentDiscoveryService to get supported options. Defaults to `nil`.
  - androidVersionIds (list(String.t)): Required. The ids of the set of Android OS version to be used.
  Use the TestEnvironmentDiscoveryService to get supported options. Defaults to `nil`.
  - locales (list(String.t)): Required. The set of locales the test device will enable for testing.
  Use the TestEnvironmentDiscoveryService to get supported options. Defaults to `nil`.
  - orientations (list(String.t)): Required. The set of orientations to test with.
  Use the TestEnvironmentDiscoveryService to get supported options. Defaults to `nil`.
  """
