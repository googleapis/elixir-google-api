...
defmodule GoogleApi.Testing.V1.Model.AndroidRuntimeConfiguration do
  ...
  - locales (list(GoogleApi.Testing.V1.Model.Locale.t)): The set of available locales. Defaults to `nil`.
  - orientations (list(GoogleApi.Testing.V1.Model.Orientation.t)): The set of available orientations. Defaults to `nil`.
  """
