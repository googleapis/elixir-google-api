...
defmodule GoogleApi.Testing.V1.Model.IosModel do
  ...
  - deviceCapabilities (list(String.t)): Device capabilities.
  Copied from
  https://developer.apple.com/library/archive/documentation/DeviceInformation/Reference/iOSDeviceCompatibility/DeviceCompatibilityMatrix/DeviceCompatibilityMatrix.html Defaults to `nil`.
  ...
  - name (String.t): The human-readable name for this device model.
  Examples: "iPhone 4s", "iPad Mini 2". Defaults to `nil`.
  - supportedVersionIds (list(String.t)): The set of iOS major software versions this device supports. Defaults to `nil`.
