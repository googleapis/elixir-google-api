...
defmodule GoogleApi.ServiceNetworking.V1.Model.Http do
  ...
  *   `rules` (*type:* `list(GoogleApi.ServiceNetworking.V1.Model.HttpRule.t)`, *default:* `nil`) - A list of HTTP configuration rules that apply to individual API methods. **NOTE:** All service configuration rules follow "last one wins" order.
  ...
  @type t :: %__MODULE__{
          ...
          :rules => list(GoogleApi.ServiceNetworking.V1.Model.HttpRule.t()) | nil
        }

  field(:fullyDecodeReservedExpansion)
  field(:rules, as: GoogleApi.ServiceNetworking.V1.Model.HttpRule, type: :list)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.Http do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.Http.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.Http do
