...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.MonitoringDestination do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.MonitoringDestination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.MonitoringDestination do
