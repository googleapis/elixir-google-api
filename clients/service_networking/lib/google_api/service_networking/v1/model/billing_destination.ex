...
defmodule GoogleApi.ServiceNetworking.V1.Model.BillingDestination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.BillingDestination do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.BillingDestination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.BillingDestination do
