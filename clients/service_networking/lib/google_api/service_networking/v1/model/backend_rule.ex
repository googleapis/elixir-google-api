...
defmodule GoogleApi.ServiceNetworking.V1.Model.BackendRule do
  @moduledoc """
  ...
  *   `protocol` (*type:* `String.t`, *default:* `nil`) - The protocol used for sending a request to the backend.
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.BackendRule do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.BackendRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.BackendRule do
