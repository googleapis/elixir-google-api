...
defmodule GoogleApi.ServiceNetworking.V1.Model.DeleteConnectionRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.DeleteConnectionRequest do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.DeleteConnectionRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.DeleteConnectionRequest do
