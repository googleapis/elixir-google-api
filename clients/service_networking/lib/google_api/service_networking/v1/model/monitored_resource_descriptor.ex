...
defmodule GoogleApi.ServiceNetworking.V1.Model.MonitoredResourceDescriptor do
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceNetworking.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - Required. A set of labels used to describe instances of this monitored
