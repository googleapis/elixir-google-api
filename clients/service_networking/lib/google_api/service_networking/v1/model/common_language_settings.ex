...
defmodule GoogleApi.ServiceNetworking.V1.Model.CommonLanguageSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.CommonLanguageSettings do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.CommonLanguageSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.CommonLanguageSettings do
