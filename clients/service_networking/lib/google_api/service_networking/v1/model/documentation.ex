...
defmodule GoogleApi.ServiceNetworking.V1.Model.Documentation do
  ...
  *   `sectionOverrides` (*type:* `list(GoogleApi.ServiceNetworking.V1.Model.Page.t)`, *default:* `nil`) - Specifies section and content to override the boilerplate content. Currently overrides following sections: 1. rest.service.client_libraries
