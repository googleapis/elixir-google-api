...
defmodule GoogleApi.ServiceNetworking.V1.Model.Connection do
  ...
  *   `network` (*type:* `String.t`, *default:* `nil`) - The name of service consumer's VPC network that's connected with service
  ...
  *   `peering` (*type:* `String.t`, *default:* `nil`) - Output only. The name of the VPC Network Peering connection that was created by the
      service producer.
  *   `reservedPeeringRanges` (*type:* `list(String.t)`, *default:* `nil`) - The name of one or more allocated IP address ranges for this service
  ...
  *   `service` (*type:* `String.t`, *default:* `nil`) - Output only. The name of the peering service that's associated with this connection, in
