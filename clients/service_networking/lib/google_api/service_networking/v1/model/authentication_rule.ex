...
defmodule GoogleApi.ServiceNetworking.V1.Model.AuthenticationRule do
  ...
  *   `selector` (*type:* `String.t`, *default:* `nil`) - Selects the methods to which this rule applies. Refer to selector for syntax details.
  ...
  @type t :: %__MODULE__{
          ...
          :oauth => GoogleApi.ServiceNetworking.V1.Model.OAuthRequirements.t() | nil,
          :requirements => list(GoogleApi.ServiceNetworking.V1.Model.AuthRequirement.t()) | nil,
          :selector => String.t() | nil
        }

  field(:allowWithoutCredential)
  field(:oauth, as: GoogleApi.ServiceNetworking.V1.Model.OAuthRequirements)
  field(:requirements, as: GoogleApi.ServiceNetworking.V1.Model.AuthRequirement, type: :list)
  field(:selector)
end

defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.AuthenticationRule do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.AuthenticationRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.AuthenticationRule do
