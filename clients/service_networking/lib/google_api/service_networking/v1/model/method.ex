...
defmodule GoogleApi.ServiceNetworking.V1.Model.Method do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.Method do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.Method.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.Method do
