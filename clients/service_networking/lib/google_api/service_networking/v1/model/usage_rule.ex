...
defmodule GoogleApi.ServiceNetworking.V1.Model.UsageRule do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.UsageRule do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.UsageRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.UsageRule do
