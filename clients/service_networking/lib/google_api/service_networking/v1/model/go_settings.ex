...
defmodule GoogleApi.ServiceNetworking.V1.Model.GoSettings do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.GoSettings do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.GoSettings.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.GoSettings do
