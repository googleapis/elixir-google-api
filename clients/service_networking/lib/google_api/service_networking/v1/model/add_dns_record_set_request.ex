...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.AddDnsRecordSetRequest do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.AddDnsRecordSetRequest.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.AddDnsRecordSetRequest do
