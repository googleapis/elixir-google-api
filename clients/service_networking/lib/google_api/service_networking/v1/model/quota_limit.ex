...
defmodule GoogleApi.ServiceNetworking.V1.Model.QuotaLimit do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.QuotaLimit do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.QuotaLimit.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.QuotaLimit do
