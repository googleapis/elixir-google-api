...
defmodule GoogleApi.ServiceNetworking.V1.Model.Control do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.Control do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.Control.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.Control do
