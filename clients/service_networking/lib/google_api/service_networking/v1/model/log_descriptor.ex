...
defmodule GoogleApi.ServiceNetworking.V1.Model.LogDescriptor do
  @moduledoc """
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceNetworking.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - The set of labels that are available to describe a specific log entry. Runtime requests that contain labels not specified here are considered invalid.
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.LogDescriptor do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.LogDescriptor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.LogDescriptor do
