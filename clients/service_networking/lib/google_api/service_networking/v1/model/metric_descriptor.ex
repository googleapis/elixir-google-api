...
defmodule GoogleApi.ServiceNetworking.V1.Model.MetricDescriptor do
  @moduledoc """
  ...
  *   `labels` (*type:* `list(GoogleApi.ServiceNetworking.V1.Model.LabelDescriptor.t)`, *default:* `nil`) - The set of labels that can be used to describe a specific instance of this metric type. The label key name must follow: * Only upper and lower-case letters, digits and underscores (_) are allowed. * Label name must start with a letter or digit. * The maximum length of a label name is 100 characters. For example, the `appengine.googleapis.com/http/server/response_latencies` metric type has a label for the HTTP response code, `response_code`, so you can look at latencies for successful responses or just for responses that failed.
  *   `launchStage` (*type:* `String.t`, *default:* `nil`) - Optional. The launch stage of the metric definition.
  *   `metadata` (*type:* `GoogleApi.ServiceNetworking.V1.Model.MetricDescriptorMetadata.t`, *default:* `nil`) - Optional. Metadata which can be used to guide usage of the metric.
  ...
  *   `valueType` (*type:* `String.t`, *default:* `nil`) - Whether the measurement is an integer, a floating-point number, etc. Some combinations of `metric_kind` and `value_type` might not be supported.
  ...
  @type t :: %__MODULE__{
          ...
          :metadata => GoogleApi.ServiceNetworking.V1.Model.MetricDescriptorMetadata.t(),
          :metricKind => String.t(),
  ...
  field(:description)
  field(:displayName)
  field(:labels, as: GoogleApi.ServiceNetworking.V1.Model.LabelDescriptor, type: :list)
  field(:launchStage)
  field(:metadata, as: GoogleApi.ServiceNetworking.V1.Model.MetricDescriptorMetadata)
  field(:metricKind)
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.MetricDescriptor do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.MetricDescriptor.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.MetricDescriptor do
