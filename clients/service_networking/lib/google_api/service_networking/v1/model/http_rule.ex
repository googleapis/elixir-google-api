...
defmodule GoogleApi.ServiceNetworking.V1.Model.HttpRule do
  @moduledoc """
  # gRPC Transcoding
  ...
  *   `body` (*type:* `String.t`, *default:* `nil`) - The name of the request field whose value is mapped to the HTTP request
      ...
      message type.
  *   `custom` (*type:* `GoogleApi.ServiceNetworking.V1.Model.CustomHttpPattern.t`, *default:* `nil`) - The custom pattern is used for specifying an HTTP method that is not
...
defimpl Poison.Decoder, for: GoogleApi.ServiceNetworking.V1.Model.HttpRule do
  def decode(value, options) do
    GoogleApi.ServiceNetworking.V1.Model.HttpRule.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.ServiceNetworking.V1.Model.HttpRule do
