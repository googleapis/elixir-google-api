...
defmodule GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatMatch do
  @moduledoc """
  ...
  *   `threatType` (*type:* `String.t`, *default:* `nil`) - The threat type matching this threat.
  ...
  field(:cacheDuration)
  field(:platformType)
  field(:threat, as: GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatEntry)

  field(:threatEntryMetadata,
    as: GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatEntryMetadata
  )
...
defimpl Poison.Decoder,
  for: GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatMatch do
  def decode(value, options) do
    GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatMatch.decode(value, options)
  end
end
