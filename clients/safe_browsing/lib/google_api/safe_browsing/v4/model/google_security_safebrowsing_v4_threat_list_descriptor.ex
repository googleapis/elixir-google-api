...
defmodule GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatListDescriptor do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatListDescriptor do
  def decode(value, options) do
    GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4ThreatListDescriptor.decode(
      value,
      options
    )
  end
