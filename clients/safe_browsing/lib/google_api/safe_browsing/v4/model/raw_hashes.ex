...
defmodule GoogleApi.SafeBrowsing.V4.Model.RawHashes do
  ...
  - rawHashes (binary()): The hashes, in binary format, concatenated into one long string. Hashes are sorted in lexicographic order. For JSON API users, hashes are base64-encoded. Defaults to: `null`.
  """
