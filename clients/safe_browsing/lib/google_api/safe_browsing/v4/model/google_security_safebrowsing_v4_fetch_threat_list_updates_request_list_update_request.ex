...
defmodule GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest do
  @moduledoc """
...
defimpl Poison.Decoder,
  for:
    GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest do
  def decode(value, options) do
    GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest.decode(
      value,
      options
    )
  end
