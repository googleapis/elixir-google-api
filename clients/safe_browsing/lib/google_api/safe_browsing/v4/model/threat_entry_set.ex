...
defmodule GoogleApi.SafeBrowsing.V4.Model.ThreatEntrySet do
  ...
  *   `riceHashes` (*type:* `GoogleApi.SafeBrowsing.V4.Model.RiceDeltaEncoding.t`, *default:* `nil`) - The encoded 4-byte prefixes of SHA256-formatted entries, using a Golomb-Rice encoding. The hashes are converted to uint32, sorted in ascending order, then delta encoded and stored as encoded_data.
  *   `riceIndices` (*type:* `GoogleApi.SafeBrowsing.V4.Model.RiceDeltaEncoding.t`, *default:* `nil`) - The encoded local, lexicographically-sorted list indices, using a Golomb-Rice encoding. Used for sending compressed removal indices. The removal indices (uint32) are sorted in ascending order, then delta encoded and stored as encoded_data.
  """
