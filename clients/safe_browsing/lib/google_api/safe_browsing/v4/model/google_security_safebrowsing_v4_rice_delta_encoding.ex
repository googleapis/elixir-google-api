...
defmodule GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4RiceDeltaEncoding do
  @moduledoc """
...
defimpl Poison.Decoder,
  for: GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4RiceDeltaEncoding do
  def decode(value, options) do
    GoogleApi.SafeBrowsing.V4.Model.GoogleSecuritySafebrowsingV4RiceDeltaEncoding.decode(
      value,
      options
    )
  end
