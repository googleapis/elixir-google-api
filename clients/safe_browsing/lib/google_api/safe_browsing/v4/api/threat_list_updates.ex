...
defmodule GoogleApi.SafeBrowsing.V4.Api.ThreatListUpdates do
  ...
  """
  @spec safebrowsing_threat_list_updates_fetch(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.SafeBrowsing.V4.Model.FetchThreatListUpdatesResponse.t} | {:error, Tesla.Env.t}
  def safebrowsing_threat_list_updates_fetch(connection, opts \\ []) do
    optional_params = %{
    ...
    %{}
    |> method(:post)
    |> url("/v4/threatListUpdates:fetch")
