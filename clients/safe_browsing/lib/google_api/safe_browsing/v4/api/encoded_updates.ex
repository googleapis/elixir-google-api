...
defmodule GoogleApi.SafeBrowsing.V4.Api.EncodedUpdates do
  ...
  - encoded_request (String.t): A serialized FetchThreatListUpdatesRequest proto.
  - optional_params (keyword()): [optional] Optional parameters
    ...
    - :clientId (String.t): A client ID that uniquely identifies the client implementation of the Safe
  Browsing API.
  ...
  """
  @spec safebrowsing_encoded_updates_get(Tesla.Env.client(), String.t(), keyword()) ::
