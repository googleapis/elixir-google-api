...
defmodule GoogleApi.SafeBrowsing.V4.Api.FullHashes do
  ...
  """
  @spec safebrowsing_full_hashes_find(Tesla.Env.client, keyword()) :: {:ok, GoogleApi.SafeBrowsing.V4.Model.FindFullHashesResponse.t} | {:error, Tesla.Env.t}
  def safebrowsing_full_hashes_find(connection, opts \\ []) do
    optional_params = %{
